...
const KPIS = [
    { label: "Total Registos", value: "3419", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4181", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€237K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "176906419", cells: ["GEO-3419", "Geospatial Analytics Item 1", "12/8/2026", "€6519"], status: "active" as const },
    { id: "176909990", cells: ["GEO-6990", "Geospatial Analytics Item 2", "27/3/2026", "€10 090"], status: "pending" as const },
    { id: "176913561", cells: ["GEO-1561", "Geospatial Analytics Item 3", "14/10/2026", "€13 661"], status: "completed" as const },
    { id: "176917132", cells: ["GEO-5132", "Geospatial Analytics Item 4", "1/5/2026", "€17 232"], status: "warning" as const },
    { id: "176920703", cells: ["GEO-8703", "Geospatial Analytics Item 5", "16/12/2026", "€20 803"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Geospatial Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Geospatial Analytics</p>
                    </div>
                </div>
