...
const PAGE = "Route";
const KPIS = [{"l":"Dashboards Ativos","v":"1.398","t":"+9.9%","d":"up"},{"l":"Queries/Dia","v":"2795","t":"+16.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.588","t":"+6.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.063","t":"+4.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3344","2026-02-01","7.871","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3189","2026-01-05","7.101","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3093","2026-01-02","5.188","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4804","2026-03-12","7.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2390","2026-01-15","876","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":756},{"label":"Mar","value":909},{"label":"Abr","value":976},{"label":"Mai","value":891},{"label":"Jun","value":713},{"label":"Jul","value":930},{"label":"Ago","value":919},{"label":"Set","value":965},{"label":"Out","value":776},{"label":"Nov","value":892},{"label":"Dez","value":811}];
const MX = 976;
