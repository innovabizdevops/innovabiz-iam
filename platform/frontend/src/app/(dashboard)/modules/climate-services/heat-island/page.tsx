...
/* ═══ Climate Services — Heat Island ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "310", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "306", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2548", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "688474110", cells: ["CLI-2110", "Heat Island Item 1", "3/7/2026", "€24 210"], status: "active" as const },
    { id: "688477681", cells: ["CLI-5681", "Heat Island Item 2", "18/2/2026", "€27 781"], status: "pending" as const },
    { id: "688481252", cells: ["CLI-9252", "Heat Island Item 3", "5/9/2026", "€31 352"], status: "completed" as const },
    { id: "688484823", cells: ["CLI-3823", "Heat Island Item 4", "20/4/2026", "€34 923"], status: "warning" as const },
    { id: "688488394", cells: ["CLI-7394", "Heat Island Item 5", "7/11/2026", "€38 494"], status: "active" as const },
];
...
export default function ClimateServicesHeatIslandPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Heat Island</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Heat Island</p>
                    </div>
                </div>
