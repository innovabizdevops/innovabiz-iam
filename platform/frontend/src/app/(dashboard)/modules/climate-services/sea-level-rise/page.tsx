...
/* ═══ Climate Services — Sea Level Rise ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "344", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "145", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "245", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1349836381", cells: ["CLI-8381", "Sea Level Rise Item 1", "6/2/2026", "€36 481"], status: "active" as const },
    { id: "1349839952", cells: ["CLI-2952", "Sea Level Rise Item 2", "21/9/2026", "€40 052"], status: "pending" as const },
    { id: "1349843523", cells: ["CLI-6523", "Sea Level Rise Item 3", "8/4/2026", "€43 623"], status: "completed" as const },
    { id: "1349847094", cells: ["CLI-1094", "Sea Level Rise Item 4", "23/11/2026", "€47 194"], status: "warning" as const },
    { id: "1349850665", cells: ["CLI-4665", "Sea Level Rise Item 5", "10/6/2026", "€765"], status: "active" as const },
];
...
export default function ClimateServicesSeaLevelRisePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sea Level Rise</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Sea Level Rise</p>
                    </div>
                </div>
