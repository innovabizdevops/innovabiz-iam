...
/* ═══ Climate Services — Loss Damage ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "1285", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "281", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1555", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "48476357", cells: ["CLI-3357", "Loss Damage Item 1", "14/6/2026", "€26 457"], status: "active" as const },
    { id: "48479928", cells: ["CLI-6928", "Loss Damage Item 2", "1/1/2026", "€30 028"], status: "pending" as const },
    { id: "48483499", cells: ["CLI-1499", "Loss Damage Item 3", "16/8/2026", "€33 599"], status: "completed" as const },
    { id: "48487070", cells: ["CLI-5070", "Loss Damage Item 4", "3/3/2026", "€37 170"], status: "warning" as const },
    { id: "48490641", cells: ["CLI-8641", "Loss Damage Item 5", "18/10/2026", "€40 741"], status: "active" as const },
];
...
export default function ClimateServicesLossDamagePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loss Damage</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Loss Damage</p>
                    </div>
                </div>
