...
/* ═══ Climate Services — Climate Finance Proj ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4566", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "271", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1857", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "88%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1254046011", cells: ["CLI-5011", "Climate Finance Proj Item 1", "16/4/2026", "€46 111"], status: "active" as const },
    { id: "1254049582", cells: ["CLI-8582", "Climate Finance Proj Item 2", "3/11/2026", "€49 682"], status: "pending" as const },
    { id: "1254053153", cells: ["CLI-3153", "Climate Finance Proj Item 3", "18/6/2026", "€3253"], status: "completed" as const },
    { id: "1254056724", cells: ["CLI-6724", "Climate Finance Proj Item 4", "5/1/2026", "€6824"], status: "warning" as const },
    { id: "1254060295", cells: ["CLI-1295", "Climate Finance Proj Item 5", "20/8/2026", "€10 395"], status: "active" as const },
];
...
export default function ClimateServicesClimateFinanceProjPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Climate Finance Proj</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Climate Finance Proj</p>
                    </div>
                </div>
