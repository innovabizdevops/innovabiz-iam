...
/* ═══ Climate Services — Resilience Index ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "251", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "202", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3616", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1787516758", cells: ["CLI-9758", "Resilience Index Item 1", "7/11/2026", "€16 858"], status: "active" as const },
    { id: "1787520329", cells: ["CLI-4329", "Resilience Index Item 2", "22/6/2026", "€20 429"], status: "pending" as const },
    { id: "1787523900", cells: ["CLI-7900", "Resilience Index Item 3", "9/1/2026", "€24 000"], status: "completed" as const },
    { id: "1787527471", cells: ["CLI-2471", "Resilience Index Item 4", "24/8/2026", "€27 571"], status: "warning" as const },
    { id: "1787531042", cells: ["CLI-6042", "Resilience Index Item 5", "11/3/2026", "€31 142"], status: "active" as const },
];
...
export default function ClimateServicesResilienceIndexPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Resilience Index</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Resilience Index</p>
                    </div>
                </div>
