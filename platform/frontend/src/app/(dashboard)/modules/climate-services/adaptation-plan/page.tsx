...
/* ═══ Climate Services — Adaptation Plan ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "864", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "149", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1806", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "51250353", cells: ["CLI-5353", "Adaptation Plan Item 1", "22/10/2026", "€453"], status: "active" as const },
    { id: "51253924", cells: ["CLI-8924", "Adaptation Plan Item 2", "9/5/2026", "€4024"], status: "pending" as const },
    { id: "51257495", cells: ["CLI-3495", "Adaptation Plan Item 3", "24/12/2026", "€7595"], status: "completed" as const },
    { id: "51261066", cells: ["CLI-7066", "Adaptation Plan Item 4", "11/7/2026", "€11 166"], status: "warning" as const },
    { id: "51264637", cells: ["CLI-1637", "Adaptation Plan Item 5", "26/2/2026", "€14 737"], status: "active" as const },
];
...
export default function ClimateServicesAdaptationPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Adaptation Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Adaptation Plan</p>
                    </div>
                </div>
