...
/* ═══ Climate Services — Climate Migration ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2650", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "160", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3434", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "141771852", cells: ["CLI-4852", "Climate Migration Item 1", "13/1/2026", "€21 952"], status: "active" as const },
    { id: "141775423", cells: ["CLI-8423", "Climate Migration Item 2", "28/8/2026", "€25 523"], status: "pending" as const },
    { id: "141778994", cells: ["CLI-2994", "Climate Migration Item 3", "15/3/2026", "€29 094"], status: "completed" as const },
    { id: "141782565", cells: ["CLI-6565", "Climate Migration Item 4", "2/10/2026", "€32 665"], status: "warning" as const },
    { id: "141786136", cells: ["CLI-1136", "Climate Migration Item 5", "17/5/2026", "€36 236"], status: "active" as const },
];
...
export default function ClimateServicesClimateMigrationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Climate Migration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Climate Migration</p>
                    </div>
                </div>
