...
/* ═══ Climate Services — Climate Model ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "4523", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "299", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "945", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1125710503", cells: ["CLI-9503", "Climate Model Item 1", "16/8/2026", "€10 603"], status: "active" as const },
    { id: "1125714074", cells: ["CLI-4074", "Climate Model Item 2", "3/3/2026", "€14 174"], status: "pending" as const },
    { id: "1125717645", cells: ["CLI-7645", "Climate Model Item 3", "18/10/2026", "€17 745"], status: "completed" as const },
    { id: "1125721216", cells: ["CLI-2216", "Climate Model Item 4", "5/5/2026", "€21 316"], status: "warning" as const },
    { id: "1125724787", cells: ["CLI-5787", "Climate Model Item 5", "20/12/2026", "€24 887"], status: "active" as const },
];
...
export default function ClimateServicesClimateModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Climate Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Climate Model</p>
                    </div>
                </div>
