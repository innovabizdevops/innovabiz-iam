...
/* ═══ Climate Services — Scenario Analysis ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total", value: "2071", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "9", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3000", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1357513829", cells: ["CLI-8829", "Scenario Analysis Item 1", "22/6/2026", "€13 929"], status: "active" as const },
    { id: "1357517400", cells: ["CLI-3400", "Scenario Analysis Item 2", "9/1/2026", "€17 500"], status: "pending" as const },
    { id: "1357520971", cells: ["CLI-6971", "Scenario Analysis Item 3", "24/8/2026", "€21 071"], status: "completed" as const },
    { id: "1357524542", cells: ["CLI-1542", "Scenario Analysis Item 4", "11/3/2026", "€24 642"], status: "warning" as const },
    { id: "1357528113", cells: ["CLI-5113", "Scenario Analysis Item 5", "26/10/2026", "€28 213"], status: "active" as const },
];
...
export default function ClimateServicesScenarioAnalysisPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Scenario Analysis</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Climate Services • Scenario Analysis</p>
                    </div>
                </div>
