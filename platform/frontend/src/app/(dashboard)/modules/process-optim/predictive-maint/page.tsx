...
/* ═══ Process Optimization — Predictive Maint ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "382", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "182", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1022", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "81%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1420541714", cells: ["PRO-9714", "Predictive Maint Item 1", "19/3/2026", "€41 814"], status: "active" as const },
    { id: "1420545285", cells: ["PRO-4285", "Predictive Maint Item 2", "6/10/2026", "€45 385"], status: "pending" as const },
    { id: "1420548856", cells: ["PRO-7856", "Predictive Maint Item 3", "21/5/2026", "€48 956"], status: "completed" as const },
    { id: "1420552427", cells: ["PRO-2427", "Predictive Maint Item 4", "8/12/2026", "€2527"], status: "warning" as const },
    { id: "1420555998", cells: ["PRO-5998", "Predictive Maint Item 5", "23/7/2026", "€6098"], status: "active" as const },
];
...
export default function ProcessOptimizationPredictiveMaintPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Predictive Maint</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Predictive Maint</p>
                    </div>
                </div>
