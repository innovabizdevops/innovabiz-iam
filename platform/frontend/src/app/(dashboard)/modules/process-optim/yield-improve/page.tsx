...
/* ═══ Process Optimization — Yield Improve ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2723", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "339", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1516", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "90%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1844965103", cells: ["PRO-2103", "Yield Improve Item 1", "24/12/2026", "€15 203"], status: "active" as const },
    { id: "1844968674", cells: ["PRO-5674", "Yield Improve Item 2", "11/7/2026", "€18 774"], status: "pending" as const },
    { id: "1844972245", cells: ["PRO-9245", "Yield Improve Item 3", "26/2/2026", "€22 345"], status: "completed" as const },
    { id: "1844975816", cells: ["PRO-3816", "Yield Improve Item 4", "13/9/2026", "€25 916"], status: "warning" as const },
    { id: "1844979387", cells: ["PRO-7387", "Yield Improve Item 5", "28/4/2026", "€29 487"], status: "active" as const },
];
...
export default function ProcessOptimizationYieldImprovePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Yield Improve</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Yield Improve</p>
                    </div>
                </div>
