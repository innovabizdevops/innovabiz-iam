...
/* ═══ Process Optimization — Six Sigma Chem ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "416", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "218", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "408", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "555252390", cells: ["PRO-7390", "Six Sigma Chem Item 1", "15/7/2026", "€2490"], status: "active" as const },
    { id: "555255961", cells: ["PRO-1961", "Six Sigma Chem Item 2", "2/2/2026", "€6061"], status: "pending" as const },
    { id: "555259532", cells: ["PRO-5532", "Six Sigma Chem Item 3", "17/9/2026", "€9632"], status: "completed" as const },
    { id: "555263103", cells: ["PRO-9103", "Six Sigma Chem Item 4", "4/4/2026", "€13 203"], status: "warning" as const },
    { id: "555266674", cells: ["PRO-3674", "Six Sigma Chem Item 5", "19/11/2026", "€16 774"], status: "active" as const },
];
...
export default function ProcessOptimizationSixSigmaChemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Six Sigma Chem</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Six Sigma Chem</p>
                    </div>
                </div>
