...
/* ═══ Process Optimization — Heat Integrate ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4083", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3618", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1149359851", cells: ["PRO-6851", "Heat Integrate Item 1", "4/8/2026", "€9951"], status: "active" as const },
    { id: "1149363422", cells: ["PRO-1422", "Heat Integrate Item 2", "19/3/2026", "€13 522"], status: "pending" as const },
    { id: "1149366993", cells: ["PRO-4993", "Heat Integrate Item 3", "6/10/2026", "€17 093"], status: "completed" as const },
    { id: "1149370564", cells: ["PRO-8564", "Heat Integrate Item 4", "21/5/2026", "€20 664"], status: "warning" as const },
    { id: "1149374135", cells: ["PRO-3135", "Heat Integrate Item 5", "8/12/2026", "€24 235"], status: "active" as const },
];
...
export default function ProcessOptimizationHeatIntegratePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Heat Integrate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Heat Integrate</p>
                    </div>
                </div>
