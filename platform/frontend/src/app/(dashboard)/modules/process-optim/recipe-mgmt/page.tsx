...
/* ═══ Process Optimization — Recipe Mgmt ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3949", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "197", trend: "-1%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3633", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "97591681", cells: ["PRO-5681", "Recipe Mgmt Item 1", "6/2/2026", "€41 781"], status: "active" as const },
    { id: "97595252", cells: ["PRO-9252", "Recipe Mgmt Item 2", "21/9/2026", "€45 352"], status: "pending" as const },
    { id: "97598823", cells: ["PRO-3823", "Recipe Mgmt Item 3", "8/4/2026", "€48 923"], status: "completed" as const },
    { id: "97602394", cells: ["PRO-7394", "Recipe Mgmt Item 4", "23/11/2026", "€2494"], status: "warning" as const },
    { id: "97605965", cells: ["PRO-1965", "Recipe Mgmt Item 5", "10/6/2026", "€6065"], status: "active" as const },
];
...
export default function ProcessOptimizationRecipeMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Recipe Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Recipe Mgmt</p>
                    </div>
                </div>
