...
const KPIS = [
    { label: "Total", value: "520", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "473", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1671", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "292230789", cells: ["PRO-1789", "Scale Up Item 1", "26/10/2026", "€30 889"], status: "active" as const },
    { id: "292234360", cells: ["PRO-5360", "Scale Up Item 2", "13/5/2026", "€34 460"], status: "pending" as const },
    { id: "292237931", cells: ["PRO-8931", "Scale Up Item 3", "28/12/2026", "€38 031"], status: "completed" as const },
    { id: "292241502", cells: ["PRO-3502", "Scale Up Item 4", "15/7/2026", "€41 602"], status: "warning" as const },
    { id: "292245073", cells: ["PRO-7073", "Scale Up Item 5", "2/2/2026", "€45 173"], status: "active" as const },
];
...
export default function ProcessOptimizationScaleUpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Scale Up</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Scale Up</p>
                    </div>
                </div>
