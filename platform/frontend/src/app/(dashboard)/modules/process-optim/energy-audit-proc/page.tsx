...
/* ═══ Process Optimization — Energy Audit Proc ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "230", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "99", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1927", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "72%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "971618975", cells: ["PRO-6975", "Energy Audit Proc Item 1", "20/12/2026", "€19 075"], status: "active" as const },
    { id: "971622546", cells: ["PRO-1546", "Energy Audit Proc Item 2", "7/7/2026", "€22 646"], status: "pending" as const },
    { id: "971626117", cells: ["PRO-5117", "Energy Audit Proc Item 3", "22/2/2026", "€26 217"], status: "completed" as const },
    { id: "971629688", cells: ["PRO-8688", "Energy Audit Proc Item 4", "9/9/2026", "€29 788"], status: "warning" as const },
    { id: "971633259", cells: ["PRO-3259", "Energy Audit Proc Item 5", "24/4/2026", "€33 359"], status: "active" as const },
];
...
export default function ProcessOptimizationEnergyAuditProcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Audit Proc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Energy Audit Proc</p>
                    </div>
                </div>
