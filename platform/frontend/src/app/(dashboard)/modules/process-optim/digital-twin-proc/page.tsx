...
/* ═══ Process Optimization — Digital Twin Proc ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4014", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "482", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1174", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "91%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "312113454", cells: ["PRO-3454", "Digital Twin Proc Item 1", "3/7/2026", "€13 554"], status: "active" as const },
    { id: "312117025", cells: ["PRO-7025", "Digital Twin Proc Item 2", "18/2/2026", "€17 125"], status: "pending" as const },
    { id: "312120596", cells: ["PRO-1596", "Digital Twin Proc Item 3", "5/9/2026", "€20 696"], status: "completed" as const },
    { id: "312124167", cells: ["PRO-5167", "Digital Twin Proc Item 4", "20/4/2026", "€24 267"], status: "warning" as const },
    { id: "312127738", cells: ["PRO-8738", "Digital Twin Proc Item 5", "7/11/2026", "€27 838"], status: "active" as const },
];
...
export default function ProcessOptimizationDigitalTwinProcPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Twin Proc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Digital Twin Proc</p>
                    </div>
                </div>
