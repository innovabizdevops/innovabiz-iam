...
/* ═══ Process Optimization — Process Sim ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4507", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "290", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3636", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1836414510", cells: ["PRO-1510", "Process Sim Item 1", "15/7/2026", "€14 610"], status: "active" as const },
    { id: "1836418081", cells: ["PRO-5081", "Process Sim Item 2", "2/2/2026", "€18 181"], status: "pending" as const },
    { id: "1836421652", cells: ["PRO-8652", "Process Sim Item 3", "17/9/2026", "€21 752"], status: "completed" as const },
    { id: "1836425223", cells: ["PRO-3223", "Process Sim Item 4", "4/4/2026", "€25 323"], status: "warning" as const },
    { id: "1836428794", cells: ["PRO-6794", "Process Sim Item 5", "19/11/2026", "€28 894"], status: "active" as const },
];
...
export default function ProcessOptimizationProcessSimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Process Sim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Process Sim</p>
                    </div>
                </div>
