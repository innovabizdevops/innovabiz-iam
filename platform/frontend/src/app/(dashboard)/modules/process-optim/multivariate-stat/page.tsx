...
/* ═══ Process Optimization — Multivariate Stat ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3360", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "477", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "232", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "96%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2054611049", cells: ["PRO-2049", "Multivariate Stat Item 1", "2/6/2026", "€11 149"], status: "active" as const },
    { id: "2054614620", cells: ["PRO-5620", "Multivariate Stat Item 2", "17/1/2026", "€14 720"], status: "pending" as const },
    { id: "2054618191", cells: ["PRO-9191", "Multivariate Stat Item 3", "4/8/2026", "€18 291"], status: "completed" as const },
    { id: "2054621762", cells: ["PRO-3762", "Multivariate Stat Item 4", "19/3/2026", "€21 862"], status: "warning" as const },
    { id: "2054625333", cells: ["PRO-7333", "Multivariate Stat Item 5", "6/10/2026", "€25 433"], status: "active" as const },
];
...
export default function ProcessOptimizationMultivariateStatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multivariate Stat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Process Optimization • Multivariate Stat</p>
                    </div>
                </div>
