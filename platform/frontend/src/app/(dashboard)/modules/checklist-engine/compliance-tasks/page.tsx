...
const PAGE = "Compliance Tasks";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.271","t":"+10.9%","d":"up"},{"l":"NC Abertas","v":"3.891","t":"+3.2%","d":"up"},{"l":"Conformidade (%)","v":"85.2%","t":"+4.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.985","t":"+8.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.109","74.3%","6.074","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","867","74.0%","617","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.901","87.2%","1.057","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.208","95.5%","7.485","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.753","84.8%","1.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":697},{"label":"Mar","value":793},{"label":"Abr","value":728},{"label":"Mai","value":966},{"label":"Jun","value":859},{"label":"Jul","value":649},{"label":"Ago","value":798},{"label":"Set","value":797},{"label":"Out","value":664},{"label":"Nov","value":686},{"label":"Dez","value":761}];
const MX = 978;
