...
const ACCENT = "#15803d";
const MODULE = "Checklist & Task Engine";
const PAGE = "Offline Mode";
const KPIS = [{"l":"Total Checklist Engine","v":"6.517","t":"-4.0%","d":"down"},{"l":"Offline Mode Ativos","v":"5.830","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.4%","d":"up"}];
const COLS = ["ID","Offline Mode","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Checklist Engine #001","Checklist Engine #002","484","7.738","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Checklist Engine #002","Checklist Engine #003","403","469","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Checklist Engine #003","Checklist Engine #004","5.835","3.033","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Checklist Engine #004","Checklist Engine #005","3.762","1.991","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Checklist Engine #005","Checklist Engine #001","6.023","8.661","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":649},{"label":"Mar","value":609},{"label":"Abr","value":673},{"label":"Mai","value":620},{"label":"Jun","value":497},{"label":"Jul","value":557},{"label":"Ago","value":530},{"label":"Set","value":477},{"label":"Out","value":595},{"label":"Nov","value":587},{"label":"Dez","value":508}];
const MX = 673;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>Mobile</span></h1>
                </div>
