...
const PAGE = "Scoring Templates";
const KPIS = [{"l":"Formulários Ativos","v":"3.516","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"1875","t":"+15.7%","d":"up"},{"l":"Documentos Gerados","v":"3.114","t":"+4.9%","d":"up"},{"l":"Templates","v":"925","t":"+7.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.928","2026-01-01","5.630","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.520","2026-01-24","6.139","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.659","2026-01-08","7.344","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.021","2026-01-15","8.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.646","2026-01-16","8.192","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":672},{"label":"Mar","value":510},{"label":"Abr","value":751},{"label":"Mai","value":645},{"label":"Jun","value":473},{"label":"Jul","value":674},{"label":"Ago","value":521},{"label":"Set","value":694},{"label":"Out","value":379},{"label":"Nov","value":659},{"label":"Dez","value":719}];
const MX = 751;
