...
const PAGE = "Audit Checklists";
const KPIS = [{"l":"Auditorias Realizadas","v":"901","t":"+6.5%","d":"up"},{"l":"NC Abertas","v":"7.943","t":"-3.4%","d":"down"},{"l":"Conformidade (%)","v":"69.9%","t":"+5.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.465","t":"+3.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.612","78.8%","5.086","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.696","91.3%","3.996","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.883","97.0%","2.548","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.553","96.5%","1.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.343","73.7%","6.542","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":783},{"label":"Mar","value":740},{"label":"Abr","value":772},{"label":"Mai","value":621},{"label":"Jun","value":533},{"label":"Jul","value":605},{"label":"Ago","value":647},{"label":"Set","value":757},{"label":"Out","value":604},{"label":"Nov","value":733},{"label":"Dez","value":686}];
const MX = 783;
