...
const PAGE = "Inspection Checklists";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.081","t":"-3.8%","d":"down"},{"l":"NC Abertas","v":"4.938","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"84.1%","t":"+8.1%","d":"up"},{"l":"CAPAs Pendentes","v":"5.029","t":"+10.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.106","73.2%","5.146","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.233","94.8%","8.365","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.866","79.5%","1.783","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.709","95.3%","2.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.561","83.5%","2.306","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":641},{"label":"Mar","value":747},{"label":"Abr","value":752},{"label":"Mai","value":916},{"label":"Jun","value":791},{"label":"Jul","value":1011},{"label":"Ago","value":645},{"label":"Set","value":1008},{"label":"Out","value":962},{"label":"Nov","value":625},{"label":"Dez","value":969}];
const MX = 1011;
