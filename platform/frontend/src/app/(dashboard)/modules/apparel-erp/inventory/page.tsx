...
const ACCENT = "#6366f1";
const MODULE = "Apparel ERP";
const PAGE = "Inventory";
const KPIS = [{"l":"Total Apparel Erp","v":"5.090","t":"-2.1%","d":"down"},{"l":"Inventory Ativos","v":"1.206","t":"+13.6%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"73","t":"+9.7%","d":"up"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apparel Erp #001","Apparel Erp #002","8.197","4.031","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Apparel Erp #002","Apparel Erp #003","5.051","567","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Apparel Erp #003","Apparel Erp #004","1.192","7.874","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Apparel Erp #004","Apparel Erp #005","8.729","1.371","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apparel Erp #005","Apparel Erp #001","8.060","8.583","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":475},{"label":"Mar","value":560},{"label":"Abr","value":547},{"label":"Mai","value":780},{"label":"Jun","value":745},{"label":"Jul","value":752},{"label":"Ago","value":669},{"label":"Set","value":634},{"label":"Out","value":631},{"label":"Nov","value":791},{"label":"Dez","value":808}];
const MX = 808;
