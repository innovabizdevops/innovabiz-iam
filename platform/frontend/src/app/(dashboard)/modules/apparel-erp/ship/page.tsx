...
const PAGE = "Ship";
const KPIS = [{"l":"Total Apparel Erp","v":"5.288","t":"+8.1%","d":"up"},{"l":"Ship Ativos","v":"8.144","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"85","t":"-0.8%","d":"down"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apparel Erp #001","Apparel Erp #002","616","4.010","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Apparel Erp #002","Apparel Erp #003","4.654","4.180","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Apparel Erp #003","Apparel Erp #004","5.016","533","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Apparel Erp #004","Apparel Erp #005","3.274","8.959","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apparel Erp #005","Apparel Erp #001","1.623","6.874","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":1005},{"label":"Mar","value":869},{"label":"Abr","value":930},{"label":"Mai","value":1018},{"label":"Jun","value":883},{"label":"Jul","value":970},{"label":"Ago","value":748},{"label":"Set","value":911},{"label":"Out","value":828},{"label":"Nov","value":775},{"label":"Dez","value":727}];
const MX = 1018;
