...
const PAGE = "Order";
const KPIS = [{"l":"Total Apparel Erp","v":"7.566","t":"+8.5%","d":"up"},{"l":"Order Ativos","v":"3.650","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"91.8%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+14.4%","d":"up"}];
const COLS = ["ID","Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Apparel Erp #001","Apparel Erp #002","6.381","3.878","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Apparel Erp #002","Apparel Erp #003","801","3.394","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Apparel Erp #003","Apparel Erp #004","8.955","6.120","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Apparel Erp #004","Apparel Erp #005","5.489","4.921","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Apparel Erp #005","Apparel Erp #001","8.312","1.582","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":684},{"label":"Mar","value":355},{"label":"Abr","value":521},{"label":"Mai","value":635},{"label":"Jun","value":564},{"label":"Jul","value":530},{"label":"Ago","value":720},{"label":"Set","value":653},{"label":"Out","value":488},{"label":"Nov","value":649},{"label":"Dez","value":418}];
const MX = 720;
