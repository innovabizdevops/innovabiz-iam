...
const ACCENT = "#9333ea";
const MODULE = "NGO CRM Platform";
const PAGE = "Segment";
const KPIS = [{"l":"Perfis Unificados","v":"4.438","t":"+12.8%","d":"up"},{"l":"Segmentos Ativos","v":"5.396","t":"-5.6%","d":"down"},{"l":"NPS Score","v":"57","t":"+17.6%","d":"up"},{"l":"Churn Previsto (%)","v":"66.4%","t":"+3.6%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.444","€ 47953.35","94.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.214","€ 30175.98","89.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.797","€ 35710.50","87.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.466","€ 49351.04","80.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","5.484","€ 33648.72","96.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":1004},{"label":"Mar","value":959},{"label":"Abr","value":997},{"label":"Mai","value":815},{"label":"Jun","value":956},{"label":"Jul","value":692},{"label":"Ago","value":821},{"label":"Set","value":820},{"label":"Out","value":762},{"label":"Nov","value":1072},{"label":"Dez","value":1069}];
const MX = 1072;
