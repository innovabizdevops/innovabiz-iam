...
/* ═══ NGO CRM Platform — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "9930", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1720", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€330K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1306156430", cells: ["NGO-5430", "NGO CRM Platform Item 1", "27/3/2026", "€6530"], status: "active" as const },
    { id: "1306160001", cells: ["NGO-9001", "NGO CRM Platform Item 2", "14/10/2026", "€10 101"], status: "pending" as const },
    { id: "1306163572", cells: ["NGO-3572", "NGO CRM Platform Item 3", "1/5/2026", "€13 672"], status: "completed" as const },
    { id: "1306167143", cells: ["NGO-7143", "NGO CRM Platform Item 4", "16/12/2026", "€17 243"], status: "warning" as const },
    { id: "1306170714", cells: ["NGO-1714", "NGO CRM Platform Item 5", "3/7/2026", "€20 814"], status: "active" as const },
];
...
export default function NgoCrmPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NGO CRM Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NGO CRM Platform</p>
                    </div>
                </div>
