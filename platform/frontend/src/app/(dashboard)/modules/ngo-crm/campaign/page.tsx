...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Ngo Crm","v":"7.437","t":"+5.9%","d":"up"},{"l":"Campaign Ativos","v":"4.115","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"74","t":"-1.9%","d":"down"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ngo Crm #001","Ngo Crm #002","8.204","7.250","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Ngo Crm #002","Ngo Crm #003","4.280","8.568","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Ngo Crm #003","Ngo Crm #004","6.594","5.040","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Ngo Crm #004","Ngo Crm #005","3.721","1.835","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ngo Crm #005","Ngo Crm #001","7.792","6.675","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":573},{"label":"Mar","value":515},{"label":"Abr","value":393},{"label":"Mai","value":601},{"label":"Jun","value":720},{"label":"Jul","value":549},{"label":"Ago","value":416},{"label":"Set","value":639},{"label":"Out","value":623},{"label":"Nov","value":492},{"label":"Dez","value":729}];
const MX = 729;
