...
const KPIS = [{"l":"Total Tunnel Ops","v":"8.828","t":"+10.2%","d":"up"},{"l":"Maintenance Ativos","v":"2.651","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"80","t":"-2.7%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Ops #001","Tunnel Ops #002","3.796","2.593","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Ops #002","Tunnel Ops #003","697","7.112","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Ops #003","Tunnel Ops #004","8.510","731","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Ops #004","Tunnel Ops #005","3.218","795","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Ops #005","Tunnel Ops #001","1.131","2.463","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":587},{"label":"Mar","value":322},{"label":"Abr","value":501},{"label":"Mai","value":297},{"label":"Jun","value":578},{"label":"Jul","value":366},{"label":"Ago","value":474},{"label":"Set","value":379},{"label":"Out","value":455},{"label":"Nov","value":418},{"label":"Dez","value":228}];
const MX = 597;
