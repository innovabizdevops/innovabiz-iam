...
const KPIS = [{"l":"Total Tunnel Ops","v":"1.106","t":"+4.7%","d":"up"},{"l":"Emergency Ativos","v":"5.074","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"92.0%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+9.6%","d":"up"}];
const COLS = ["ID","Emergency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Ops #001","Tunnel Ops #002","378","3.949","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Ops #002","Tunnel Ops #003","3.129","5.458","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Ops #003","Tunnel Ops #004","4.599","7.968","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Ops #004","Tunnel Ops #005","5.922","720","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Ops #005","Tunnel Ops #001","5.321","739","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":973},{"label":"Mar","value":905},{"label":"Abr","value":803},{"label":"Mai","value":729},{"label":"Jun","value":712},{"label":"Jul","value":662},{"label":"Ago","value":834},{"label":"Set","value":792},{"label":"Out","value":743},{"label":"Nov","value":984},{"label":"Dez","value":832}];
const MX = 984;
