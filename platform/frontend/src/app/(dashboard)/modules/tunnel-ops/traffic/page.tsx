...
const PAGE = "Traffic";
const KPIS = [{"l":"Total Tunnel Ops","v":"539","t":"+5.7%","d":"up"},{"l":"Traffic Ativos","v":"3.723","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"62","t":"-3.7%","d":"down"}];
const COLS = ["ID","Traffic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Ops #001","Tunnel Ops #002","140","6.209","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Ops #002","Tunnel Ops #003","5.246","7.879","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Ops #003","Tunnel Ops #004","5.653","5.684","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Ops #004","Tunnel Ops #005","4.778","6.893","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Ops #005","Tunnel Ops #001","7.855","8.010","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":412},{"label":"Mar","value":508},{"label":"Abr","value":670},{"label":"Mai","value":473},{"label":"Jun","value":505},{"label":"Jul","value":727},{"label":"Ago","value":613},{"label":"Set","value":563},{"label":"Out","value":512},{"label":"Nov","value":678},{"label":"Dez","value":370}];
const MX = 727;
