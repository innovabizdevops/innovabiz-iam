...
const PAGE = "Safety";
const KPIS = [{"l":"Total Tunnel Ops","v":"8.984","t":"+15.2%","d":"up"},{"l":"Safety Ativos","v":"1.903","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"77","t":"-0.3%","d":"down"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tunnel Ops #001","Tunnel Ops #002","2.264","8.308","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Tunnel Ops #002","Tunnel Ops #003","7.235","7.885","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Tunnel Ops #003","Tunnel Ops #004","6.348","4.445","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Tunnel Ops #004","Tunnel Ops #005","2.829","8.681","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tunnel Ops #005","Tunnel Ops #001","9.053","8.493","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":650},{"label":"Mar","value":523},{"label":"Abr","value":776},{"label":"Mai","value":710},{"label":"Jun","value":679},{"label":"Jul","value":792},{"label":"Ago","value":875},{"label":"Set","value":551},{"label":"Out","value":570},{"label":"Nov","value":667},{"label":"Dez","value":651}];
const MX = 875;
