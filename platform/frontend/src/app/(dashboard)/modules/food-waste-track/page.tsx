...
export default function FoodWasteTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Waste Track</h1><p className="text-sm text-muted-foreground">Food Waste Track • iBOS Enterprise</p></div>
