...
const ACCENT = "#059669";
const MODULE = "Food Waste Tracking";
const PAGE = "Reduction Plan";
const KPIS = [{"l":"Total Food Waste Track","v":"6.360","t":"+7.6%","d":"up"},{"l":"Reduction Plan Ativos","v":"3.860","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"57","t":"+17.8%","d":"up"}];
const COLS = ["ID","Reduction Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Waste Track #001","Food Waste Track #002","5.121","2.665","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Food Waste Track #002","Food Waste Track #003","3.586","9.011","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Waste Track #003","Food Waste Track #004","3.633","4.855","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Food Waste Track #004","Food Waste Track #005","2.479","5.194","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Waste Track #005","Food Waste Track #001","5.651","5.777","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":777},{"label":"Mar","value":578},{"label":"Abr","value":772},{"label":"Mai","value":762},{"label":"Jun","value":821},{"label":"Jul","value":592},{"label":"Ago","value":511},{"label":"Set","value":479},{"label":"Out","value":734},{"label":"Nov","value":684},{"label":"Dez","value":610}];
const MX = 821;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#059669'}}>ESG</span></h1>
                </div>
