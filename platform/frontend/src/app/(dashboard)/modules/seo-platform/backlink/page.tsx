...
const PAGE = "Backlink";
const KPIS = [{"l":"Formulários Ativos","v":"5.859","t":"+0.6%","d":"up"},{"l":"Submissões/Dia","v":"1798","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"4.491","t":"+12.6%","d":"up"},{"l":"Templates","v":"1.483","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.045","2026-03-08","5.953","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.099","2026-01-15","651","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.170","2026-01-18","2.421","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.590","2026-03-15","5.681","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.019","2026-03-22","2.042","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":384},{"label":"Fev","value":319},{"label":"Mar","value":536},{"label":"Abr","value":277},{"label":"Mai","value":371},{"label":"Jun","value":615},{"label":"Jul","value":523},{"label":"Ago","value":389},{"label":"Set","value":574},{"label":"Out","value":529},{"label":"Nov","value":637},{"label":"Dez","value":466}];
const MX = 637;
