...
const PAGE = "Keyword";
const KPIS = [{"l":"Formulários Ativos","v":"7.907","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"2009","t":"+15.4%","d":"up"},{"l":"Documentos Gerados","v":"4.573","t":"+1.7%","d":"up"},{"l":"Templates","v":"155","t":"+18.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.501","2026-01-19","4.872","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.379","2026-03-24","6.709","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.557","2026-01-20","7.911","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.677","2026-02-13","2.497","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.915","2026-01-01","5.262","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":740},{"label":"Mar","value":647},{"label":"Abr","value":774},{"label":"Mai","value":504},{"label":"Jun","value":664},{"label":"Jul","value":706},{"label":"Ago","value":439},{"label":"Set","value":612},{"label":"Out","value":604},{"label":"Nov","value":621},{"label":"Dez","value":615}];
const MX = 774;
