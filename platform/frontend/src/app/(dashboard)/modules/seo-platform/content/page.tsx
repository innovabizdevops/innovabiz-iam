...
const PAGE = "Content";
const KPIS = [{"l":"Formulários Ativos","v":"1.634","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"1230","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"5.099","t":"+12.9%","d":"up"},{"l":"Templates","v":"8.662","t":"+8.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.291","2026-01-23","4.291","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.997","2026-02-17","8.542","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","137","2026-02-08","5.881","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.381","2026-02-25","4.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.138","2026-01-23","8.899","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":520},{"label":"Mar","value":636},{"label":"Abr","value":493},{"label":"Mai","value":601},{"label":"Jun","value":732},{"label":"Jul","value":460},{"label":"Ago","value":561},{"label":"Set","value":658},{"label":"Out","value":541},{"label":"Nov","value":509},{"label":"Dez","value":616}];
const MX = 732;
