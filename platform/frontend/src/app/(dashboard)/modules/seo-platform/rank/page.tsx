...
const PAGE = "Rank Track";
const KPIS = [{"l":"Formulários Ativos","v":"9.067","t":"-3.1%","d":"down"},{"l":"Submissões/Dia","v":"3933","t":"+8.3%","d":"up"},{"l":"Documentos Gerados","v":"3.003","t":"-1.5%","d":"down"},{"l":"Templates","v":"3.347","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.837","2026-02-08","8.019","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.261","2026-02-27","178","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.824","2026-01-16","3.669","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.470","2026-02-05","929","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.508","2026-02-17","3.315","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":706},{"label":"Mar","value":925},{"label":"Abr","value":811},{"label":"Mai","value":856},{"label":"Jun","value":1004},{"label":"Jul","value":873},{"label":"Ago","value":955},{"label":"Set","value":779},{"label":"Out","value":1006},{"label":"Nov","value":801},{"label":"Dez","value":959}];
const MX = 1006;
