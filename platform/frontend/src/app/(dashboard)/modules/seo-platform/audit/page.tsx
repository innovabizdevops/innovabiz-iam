...
const ACCENT = "#6366f1";
const MODULE = "SEO Platform";
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.515","t":"+9.7%","d":"up"},{"l":"NC Abertas","v":"8.830","t":"+6.5%","d":"up"},{"l":"Conformidade (%)","v":"88.8%","t":"+13.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.686","t":"+6.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.248","75.7%","1.924","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.001","84.4%","1.171","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.520","96.2%","1.178","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","338","70.0%","7.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.692","77.7%","7.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":542},{"label":"Mar","value":434},{"label":"Abr","value":541},{"label":"Mai","value":566},{"label":"Jun","value":456},{"label":"Jul","value":578},{"label":"Ago","value":758},{"label":"Set","value":391},{"label":"Out","value":605},{"label":"Nov","value":536},{"label":"Dez","value":722}];
const MX = 758;
