...
export default function StatisticsBureauPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Statistics Bureau</h1><p className="text-sm text-muted-foreground">Statistics Bureau • iBOS Enterprise</p></div>
            </div>
