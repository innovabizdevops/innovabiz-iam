...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"4.737","t":"+14.1%","d":"up"},{"l":"Respostas/Semana","v":"3437","t":"+13.6%","d":"up"},{"l":"NPS Médio","v":"63","t":"+0.1%","d":"up"},{"l":"Taxa Resposta (%)","v":"70.8%","t":"+15.8%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","1.602","74","96.2%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.818","67","93.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","7.167","63","78.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","7.555","79","70.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","6.359","81","84.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":236},{"label":"Fev","value":432},{"label":"Mar","value":377},{"label":"Abr","value":580},{"label":"Mai","value":507},{"label":"Jun","value":294},{"label":"Jul","value":350},{"label":"Ago","value":349},{"label":"Set","value":243},{"label":"Out","value":264},{"label":"Nov","value":374},{"label":"Dez","value":511}];
const MX = 580;
