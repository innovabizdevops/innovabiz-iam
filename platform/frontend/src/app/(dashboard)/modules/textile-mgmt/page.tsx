...
/* ═══ Textile Management Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "9076", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1737", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€99K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "770743776", cells: ["TEX-2776", "Textile Management Platform Item 1", "13/1/2026", "€43 876"], status: "active" as const },
    { id: "770747347", cells: ["TEX-6347", "Textile Management Platform Item 2", "28/8/2026", "€47 447"], status: "pending" as const },
    { id: "770750918", cells: ["TEX-9918", "Textile Management Platform Item 3", "15/3/2026", "€1018"], status: "completed" as const },
    { id: "770754489", cells: ["TEX-4489", "Textile Management Platform Item 4", "2/10/2026", "€4589"], status: "warning" as const },
    { id: "770758060", cells: ["TEX-8060", "Textile Management Platform Item 5", "17/5/2026", "€8160"], status: "active" as const },
];
...
export default function TextileManagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Textile Management Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Textile Management Platform</p>
                    </div>
                </div>
