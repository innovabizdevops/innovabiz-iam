...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.498","t":"+4.0%","d":"up"},{"l":"NC Abertas","v":"603","t":"+5.0%","d":"up"},{"l":"Conformidade (%)","v":"84.5%","t":"+4.2%","d":"up"},{"l":"CAPAs Pendentes","v":"7.679","t":"+3.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.955","83.3%","6.111","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.587","98.1%","927","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.736","95.4%","4.518","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.373","70.2%","3.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.264","85.7%","8.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":693},{"label":"Mar","value":759},{"label":"Abr","value":704},{"label":"Mai","value":537},{"label":"Jun","value":578},{"label":"Jul","value":708},{"label":"Ago","value":733},{"label":"Set","value":694},{"label":"Out","value":522},{"label":"Nov","value":607},{"label":"Dez","value":609}];
const MX = 759;
