...
const ACCENT = "#be185d";
const MODULE = "Textile Management Platform";
const PAGE = "Weave";
const KPIS = [{"l":"Total Textile Mgmt","v":"3.871","t":"+12.1%","d":"up"},{"l":"Weave Ativos","v":"5.044","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"86","t":"-1.7%","d":"down"}];
const COLS = ["ID","Weave","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Textile Mgmt #001","Textile Mgmt #002","2.466","5.340","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Textile Mgmt #002","Textile Mgmt #003","7.108","3.488","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Textile Mgmt #003","Textile Mgmt #004","5.740","1.530","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Textile Mgmt #004","Textile Mgmt #005","6.454","8.689","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Textile Mgmt #005","Textile Mgmt #001","5.174","183","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":457},{"label":"Mar","value":700},{"label":"Abr","value":533},{"label":"Mai","value":453},{"label":"Jun","value":760},{"label":"Jul","value":518},{"label":"Ago","value":448},{"label":"Set","value":590},{"label":"Out","value":538},{"label":"Nov","value":362},{"label":"Dez","value":532}];
const MX = 760;
