...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"1.952","t":"+8.5%","d":"up"},{"l":"Chamadas/Hora","v":"2654","t":"-0.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+14.3%","d":"up"},{"l":"Latência Média (ms)","v":"188ms","t":"+7.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.643","1.469","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.542","6.070","75.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.378","3.594","83.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.853","6.966","91.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","699","3.146","90.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":620},{"label":"Mar","value":355},{"label":"Abr","value":645},{"label":"Mai","value":665},{"label":"Jun","value":600},{"label":"Jul","value":528},{"label":"Ago","value":360},{"label":"Set","value":389},{"label":"Out","value":635},{"label":"Nov","value":549},{"label":"Dez","value":596}];
const MX = 665;
