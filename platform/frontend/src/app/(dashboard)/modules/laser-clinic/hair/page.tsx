...
const ACCENT = "#ec4899";
const MODULE = "Laser Treatment Clinic";
const PAGE = "Hair Remove";
const KPIS = [{"l":"Total Laser Clinic","v":"440","t":"+0.1%","d":"up"},{"l":"Hair Remove Ativos","v":"4.040","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"84","t":"+6.3%","d":"up"}];
const COLS = ["ID","Hair Remove","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laser Clinic #001","Laser Clinic #002","7.367","2.407","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Laser Clinic #002","Laser Clinic #003","1.724","1.572","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Laser Clinic #003","Laser Clinic #004","6.637","1.036","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Laser Clinic #004","Laser Clinic #005","3.316","6.230","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laser Clinic #005","Laser Clinic #001","5.330","5.277","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":575},{"label":"Mar","value":687},{"label":"Abr","value":505},{"label":"Mai","value":736},{"label":"Jun","value":674},{"label":"Jul","value":784},{"label":"Ago","value":672},{"label":"Set","value":648},{"label":"Out","value":693},{"label":"Nov","value":626},{"label":"Dez","value":613}];
const MX = 784;
