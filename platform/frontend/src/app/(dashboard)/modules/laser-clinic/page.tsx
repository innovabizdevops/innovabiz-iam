...
/* ═══ Laser Treatment Clinic — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "3503", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2431", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€258K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1718593903", cells: ["LAS-8903", "Laser Treatment Clinic Item 1", "20/8/2026", "€44 003"], status: "active" as const },
    { id: "1718597474", cells: ["LAS-3474", "Laser Treatment Clinic Item 2", "7/3/2026", "€47 574"], status: "pending" as const },
    { id: "1718601045", cells: ["LAS-7045", "Laser Treatment Clinic Item 3", "22/10/2026", "€1145"], status: "completed" as const },
    { id: "1718604616", cells: ["LAS-1616", "Laser Treatment Clinic Item 4", "9/5/2026", "€4716"], status: "warning" as const },
    { id: "1718608187", cells: ["LAS-5187", "Laser Treatment Clinic Item 5", "24/12/2026", "€8287"], status: "active" as const },
];
...
export default function LaserTreatmentClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laser Treatment Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laser Treatment Clinic</p>
                    </div>
                </div>
