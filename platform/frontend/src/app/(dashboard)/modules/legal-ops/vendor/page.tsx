...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.615","t":"+7.2%","d":"up"},{"l":"Contratos (€M)","v":"€39.5M","t":"+9.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"84.5%","t":"+3.4%","d":"up"},{"l":"Score Médio","v":"85","t":"+1.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","70.1%","€ 39202.44","2.075","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","95.8%","€ 14276.35","8.860","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.8%","€ 2822.34","2.004","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","71.8%","€ 10018.83","3.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","75.7%","€ 2836.59","8.966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":754},{"label":"Mar","value":814},{"label":"Abr","value":877},{"label":"Mai","value":809},{"label":"Jun","value":648},{"label":"Jul","value":617},{"label":"Ago","value":618},{"label":"Set","value":823},{"label":"Out","value":617},{"label":"Nov","value":661},{"label":"Dez","value":919}];
const MX = 919;
