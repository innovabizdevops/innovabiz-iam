...
const PAGE = "Govern";
const KPIS = [{"l":"Integrações Ativas","v":"3.832","t":"+2.4%","d":"up"},{"l":"Chamadas/Hora","v":"3404","t":"+12.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.8%","t":"+1.0%","d":"up"},{"l":"Latência Média (ms)","v":"159ms","t":"+9.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.890","7.570","79.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.901","4.094","79.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.456","6.251","86.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.580","3.974","88.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.863","803","77.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":416},{"label":"Mar","value":346},{"label":"Abr","value":507},{"label":"Mai","value":533},{"label":"Jun","value":717},{"label":"Jul","value":676},{"label":"Ago","value":400},{"label":"Set","value":364},{"label":"Out","value":371},{"label":"Nov","value":601},{"label":"Dez","value":702}];
const MX = 717;
