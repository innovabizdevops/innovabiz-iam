...
const ACCENT = "#00a1e0";
const MODULE = "Integration Platform (MuleSoft)";
const PAGE = "Connector";
const KPIS = [{"l":"Integrações Ativas","v":"5.474","t":"+17.8%","d":"up"},{"l":"Chamadas/Hora","v":"859","t":"+2.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+6.0%","d":"up"},{"l":"Latência Média (ms)","v":"118ms","t":"-3.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.056","5.515","72.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.198","6.864","92.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.189","6.435","73.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.505","6.675","85.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.331","6.371","98.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":508},{"label":"Mar","value":208},{"label":"Abr","value":495},{"label":"Mai","value":239},{"label":"Jun","value":557},{"label":"Jul","value":505},{"label":"Ago","value":297},{"label":"Set","value":495},{"label":"Out","value":410},{"label":"Nov","value":593},{"label":"Dez","value":349}];
const MX = 593;
