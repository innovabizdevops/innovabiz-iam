...
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"407","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"1603","t":"+3.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.2%","t":"+11.8%","d":"up"},{"l":"Latência Média (ms)","v":"182ms","t":"+17.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.256","3.940","70.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.892","5.691","79.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.243","9.001","78.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.415","6.687","87.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.018","4.156","95.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":677},{"label":"Mar","value":617},{"label":"Abr","value":803},{"label":"Mai","value":863},{"label":"Jun","value":627},{"label":"Jul","value":881},{"label":"Ago","value":946},{"label":"Set","value":844},{"label":"Out","value":843},{"label":"Nov","value":894},{"label":"Dez","value":885}];
const MX = 946;
