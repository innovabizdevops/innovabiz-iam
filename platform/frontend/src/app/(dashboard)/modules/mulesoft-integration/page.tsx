...
/* ═══ Integration Platform (MuleSoft) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "6933", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1810", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€55K", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1028082233", cells: ["MUL-4233", "Integration Platform (MuleSoft) Item 1", "18/6/2026", "€32 333"], status: "active" as const },
    { id: "1028085804", cells: ["MUL-7804", "Integration Platform (MuleSoft) Item 2", "5/1/2026", "€35 904"], status: "pending" as const },
    { id: "1028089375", cells: ["MUL-2375", "Integration Platform (MuleSoft) Item 3", "20/8/2026", "€39 475"], status: "completed" as const },
    { id: "1028092946", cells: ["MUL-5946", "Integration Platform (MuleSoft) Item 4", "7/3/2026", "€43 046"], status: "warning" as const },
    { id: "1028096517", cells: ["MUL-9517", "Integration Platform (MuleSoft) Item 5", "22/10/2026", "€46 617"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 93 }, { label: "Fev", value: 22 }, { label: "Mar", value: 31 }, { label: "Abr", value: 40 }, { label: "Mai", value: 49 }, { label: "Jun", value: 58 }];
...
export default function IntegrationPlatformMulesoftPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Integration Platform (MuleSoft)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Integration Platform (MuleSoft)</p>
                    </div>
                </div>
