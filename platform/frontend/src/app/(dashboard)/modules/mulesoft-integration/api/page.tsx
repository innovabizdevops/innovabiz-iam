...
const PAGE = "API";
const KPIS = [{"l":"Integrações Ativas","v":"7.562","t":"+8.9%","d":"up"},{"l":"Chamadas/Hora","v":"4123","t":"+10.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.7%","t":"+14.1%","d":"up"},{"l":"Latência Média (ms)","v":"78ms","t":"+7.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.276","7.021","91.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.298","3.771","85.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.941","5.993","72.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","886","5.927","72.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.591","4.155","72.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":537},{"label":"Mar","value":817},{"label":"Abr","value":711},{"label":"Mai","value":598},{"label":"Jun","value":612},{"label":"Jul","value":887},{"label":"Ago","value":588},{"label":"Set","value":540},{"label":"Out","value":621},{"label":"Nov","value":567},{"label":"Dez","value":777}];
const MX = 887;
