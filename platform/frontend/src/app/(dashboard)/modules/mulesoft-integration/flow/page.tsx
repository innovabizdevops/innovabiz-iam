...
const PAGE = "Flow";
const KPIS = [{"l":"Integrações Ativas","v":"4.311","t":"+9.2%","d":"up"},{"l":"Chamadas/Hora","v":"1038","t":"+6.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.8%","t":"-1.9%","d":"down"},{"l":"Latência Média (ms)","v":"128ms","t":"+16.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.326","9.031","80.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.389","9.044","80.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.538","5.482","75.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.988","2.627","80.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","724","1.099","72.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":652},{"label":"Mar","value":598},{"label":"Abr","value":557},{"label":"Mai","value":871},{"label":"Jun","value":655},{"label":"Jul","value":737},{"label":"Ago","value":550},{"label":"Set","value":697},{"label":"Out","value":832},{"label":"Nov","value":763},{"label":"Dez","value":597}];
const MX = 871;
