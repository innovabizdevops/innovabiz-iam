...
const PAGE = "Mental";
const KPIS = [{"l":"Total Student Wellness","v":"1.824","t":"+3.9%","d":"up"},{"l":"Mental Ativos","v":"2.556","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"68","t":"+5.6%","d":"up"}];
const COLS = ["ID","Mental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Wellness #001","Student Wellness #002","4.912","853","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Student Wellness #002","Student Wellness #003","1.482","4.768","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Wellness #003","Student Wellness #004","4.312","3.619","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Student Wellness #004","Student Wellness #005","1.055","7.458","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Wellness #005","Student Wellness #001","8.487","8.628","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":361},{"label":"Mar","value":230},{"label":"Abr","value":379},{"label":"Mai","value":478},{"label":"Jun","value":600},{"label":"Jul","value":505},{"label":"Ago","value":318},{"label":"Set","value":318},{"label":"Out","value":279},{"label":"Nov","value":530},{"label":"Dez","value":483}];
const MX = 600;
