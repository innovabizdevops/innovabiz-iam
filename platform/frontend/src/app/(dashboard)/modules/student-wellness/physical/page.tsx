...
const PAGE = "Physical";
const KPIS = [{"l":"Total Student Wellness","v":"4.376","t":"+2.6%","d":"up"},{"l":"Physical Ativos","v":"1.522","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"80","t":"+17.0%","d":"up"}];
const COLS = ["ID","Physical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Wellness #001","Student Wellness #002","5.470","3.312","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Student Wellness #002","Student Wellness #003","3.618","5.822","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Wellness #003","Student Wellness #004","3.017","8.244","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Student Wellness #004","Student Wellness #005","4.267","5.489","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Wellness #005","Student Wellness #001","5.585","1.177","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":602},{"label":"Mar","value":872},{"label":"Abr","value":820},{"label":"Mai","value":793},{"label":"Jun","value":680},{"label":"Jul","value":807},{"label":"Ago","value":860},{"label":"Set","value":950},{"label":"Out","value":573},{"label":"Nov","value":737},{"label":"Dez","value":668}];
const MX = 950;
