...
const PAGE = "Airspace Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"6.832","t":"+15.6%","d":"up"},{"l":"Sessões/Dia","v":"4178","t":"-4.5%","d":"down"},{"l":"MFA Adoção (%)","v":"81.9%","t":"-6.0%","d":"down"},{"l":"Tentativas Bloqueadas","v":"4.498","t":"-0.3%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.124","8.740","1.680","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.122","1.207","7.883","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.796","6.559","7.314","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.281","4.003","3.051","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","212","6.732","2.807","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":360},{"label":"Mar","value":654},{"label":"Abr","value":396},{"label":"Mai","value":322},{"label":"Jun","value":511},{"label":"Jul","value":368},{"label":"Ago","value":489},{"label":"Set","value":566},{"label":"Out","value":514},{"label":"Nov","value":455},{"label":"Dez","value":568}];
const MX = 654;
