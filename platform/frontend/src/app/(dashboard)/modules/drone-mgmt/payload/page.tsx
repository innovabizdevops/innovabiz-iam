...
const KPIS = [{"l":"Total Drone Mgmt","v":"461","t":"+4.5%","d":"up"},{"l":"Payload Mgmt Ativos","v":"5.194","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"81.3%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.4%","d":"up"}];
const COLS = ["ID","Payload Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Mgmt #001","Drone Mgmt #002","3.505","1.591","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Mgmt #002","Drone Mgmt #003","3.652","6.806","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Mgmt #003","Drone Mgmt #004","6.819","8.328","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Mgmt #004","Drone Mgmt #005","6.731","8.971","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Mgmt #005","Drone Mgmt #001","1.060","5.952","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":296},{"label":"Mar","value":642},{"label":"Abr","value":485},{"label":"Mai","value":300},{"label":"Jun","value":286},{"label":"Jul","value":391},{"label":"Ago","value":612},{"label":"Set","value":459},{"label":"Out","value":288},{"label":"Nov","value":563},{"label":"Dez","value":289}];
const MX = 642;
