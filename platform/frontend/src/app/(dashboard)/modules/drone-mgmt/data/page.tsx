...
const ACCENT = "#78350f";
const MODULE = "Drone Management";
const PAGE = "Data Process";
const KPIS = [{"l":"Total Drone Mgmt","v":"5.063","t":"+2.6%","d":"up"},{"l":"Data Process Ativos","v":"4.864","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"69","t":"+12.3%","d":"up"}];
const COLS = ["ID","Data Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Mgmt #001","2026-02-04","1.937","182","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Mgmt #002","2026-03-04","888","642","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Mgmt #003","2026-03-20","5.501","5.583","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Mgmt #004","2026-01-07","5.100","2.727","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Mgmt #005","2026-01-11","3.669","738","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":890},{"label":"Mar","value":642},{"label":"Abr","value":647},{"label":"Mai","value":740},{"label":"Jun","value":592},{"label":"Jul","value":716},{"label":"Ago","value":885},{"label":"Set","value":612},{"label":"Out","value":848},{"label":"Nov","value":625},{"label":"Dez","value":581}];
const MX = 890;
