...
const KPIS = [{"l":"Total Drone Mgmt","v":"5.065","t":"-0.5%","d":"down"},{"l":"Flight Plan Ativos","v":"3.175","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+11.9%","d":"up"}];
const COLS = ["ID","Flight Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drone Mgmt #001","Drone Mgmt #002","7.380","1.563","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Drone Mgmt #002","Drone Mgmt #003","1.746","442","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Drone Mgmt #003","Drone Mgmt #004","3.797","8.380","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Drone Mgmt #004","Drone Mgmt #005","8.416","7.750","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drone Mgmt #005","Drone Mgmt #001","1.674","4.229","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":639},{"label":"Mar","value":667},{"label":"Abr","value":499},{"label":"Mai","value":505},{"label":"Jun","value":471},{"label":"Jul","value":390},{"label":"Ago","value":633},{"label":"Set","value":664},{"label":"Out","value":537},{"label":"Nov","value":451},{"label":"Dez","value":661}];
const MX = 667;
