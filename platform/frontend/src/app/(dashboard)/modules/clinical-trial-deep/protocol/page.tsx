...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"2.721","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"2815","t":"-1.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"94.0%","t":"+6.9%","d":"up"},{"l":"Latência Média (ms)","v":"59ms","t":"+6.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.521","1.338","70.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.271","589","71.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.318","8.908","96.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.726","7.923","99.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.374","1.719","86.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":531},{"label":"Mar","value":381},{"label":"Abr","value":520},{"label":"Mai","value":462},{"label":"Jun","value":512},{"label":"Jul","value":616},{"label":"Ago","value":653},{"label":"Set","value":374},{"label":"Out","value":488},{"label":"Nov","value":419},{"label":"Dez","value":396}];
const MX = 653;
