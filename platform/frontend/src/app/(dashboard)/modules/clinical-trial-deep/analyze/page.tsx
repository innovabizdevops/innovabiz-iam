...
const ACCENT = "#9333ea";
const MODULE = "Clinical Trial Mgmt Deep";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"474","t":"+15.6%","d":"up"},{"l":"Queries/Dia","v":"4365","t":"+5.0%","d":"up"},{"l":"Dados Processados (GB)","v":"1.190","t":"+10.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.843","t":"+5.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3077","2026-03-14","286","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2813","2026-01-03","2.949","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3890","2026-02-23","1.640","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3246","2026-02-12","2.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1503","2026-03-05","2.610","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1034},{"label":"Fev","value":783},{"label":"Mar","value":704},{"label":"Abr","value":825},{"label":"Mai","value":1081},{"label":"Jun","value":1008},{"label":"Jul","value":695},{"label":"Ago","value":887},{"label":"Set","value":900},{"label":"Out","value":780},{"label":"Nov","value":935},{"label":"Dez","value":739}];
const MX = 1081;
