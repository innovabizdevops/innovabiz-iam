...
/* ═══ Clinical Trial Mgmt Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "1648", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3500", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€215K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "65381148", cells: ["CLI-6148", "Clinical Trial Mgmt Deep Item 1", "1/1/2026", "€31 248"], status: "active" as const },
    { id: "65384719", cells: ["CLI-9719", "Clinical Trial Mgmt Deep Item 2", "16/8/2026", "€34 819"], status: "pending" as const },
    { id: "65388290", cells: ["CLI-4290", "Clinical Trial Mgmt Deep Item 3", "3/3/2026", "€38 390"], status: "completed" as const },
    { id: "65391861", cells: ["CLI-7861", "Clinical Trial Mgmt Deep Item 4", "18/10/2026", "€41 961"], status: "warning" as const },
    { id: "65395432", cells: ["CLI-2432", "Clinical Trial Mgmt Deep Item 5", "5/5/2026", "€45 532"], status: "active" as const },
];
...
export default function ClinicalTrialMgmtDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clinical Trial Mgmt Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Clinical Trial Mgmt Deep</p>
                    </div>
                </div>
