...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Clinical Trial Deep","v":"8.769","t":"+6.8%","d":"up"},{"l":"Monitor Ativos","v":"6.436","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"70","t":"+15.8%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial Deep #001","Clinical Trial Deep #002","4.624","8.102","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial Deep #002","Clinical Trial Deep #003","1.432","7.575","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial Deep #003","Clinical Trial Deep #004","1.956","833","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial Deep #004","Clinical Trial Deep #005","3.368","755","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial Deep #005","Clinical Trial Deep #001","8.389","106","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":817},{"label":"Mar","value":1040},{"label":"Abr","value":1001},{"label":"Mai","value":761},{"label":"Jun","value":1070},{"label":"Jul","value":889},{"label":"Ago","value":755},{"label":"Set","value":1051},{"label":"Out","value":732},{"label":"Nov","value":715},{"label":"Dez","value":1054}];
const MX = 1070;
