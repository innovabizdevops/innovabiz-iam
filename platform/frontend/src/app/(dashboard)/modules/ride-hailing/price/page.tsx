...
const ACCENT = "#0ea5e9";
const MODULE = "Ride Hailing Platform";
const PAGE = "Price";
const KPIS = [{"l":"Total Ride Hailing","v":"5.374","t":"+12.3%","d":"up"},{"l":"Price Ativos","v":"4.848","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"71.1%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+4.9%","d":"up"}];
const COLS = ["ID","Price","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ride Hailing #001","Ride Hailing #002","9.018","1.772","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ride Hailing #002","Ride Hailing #003","1.121","2.053","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Ride Hailing #003","Ride Hailing #004","6.492","6.851","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Ride Hailing #004","Ride Hailing #005","8.156","5.539","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ride Hailing #005","Ride Hailing #001","1.598","8.073","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":732},{"label":"Mar","value":424},{"label":"Abr","value":723},{"label":"Mai","value":554},{"label":"Jun","value":599},{"label":"Jul","value":740},{"label":"Ago","value":460},{"label":"Set","value":638},{"label":"Out","value":535},{"label":"Nov","value":441},{"label":"Dez","value":511}];
const MX = 740;
