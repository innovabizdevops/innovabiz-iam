...
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"4.435","t":"-5.3%","d":"down"},{"l":"Treinos/Semana","v":"2986","t":"+17.4%","d":"up"},{"l":"Competições","v":"8.422","t":"+6.3%","d":"up"},{"l":"Performance Score","v":"86","t":"+8.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.883","2.812","2.264","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.060","1.293","2.142","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","923","1.902","8.832","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.054","5.909","2.954","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.697","3.811","4.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":527},{"label":"Mar","value":582},{"label":"Abr","value":605},{"label":"Mai","value":566},{"label":"Jun","value":504},{"label":"Jul","value":626},{"label":"Ago","value":604},{"label":"Set","value":795},{"label":"Out","value":835},{"label":"Nov","value":801},{"label":"Dez","value":747}];
const MX = 835;
