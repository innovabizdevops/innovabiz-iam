...
const PAGE = "CDMS";
const KPIS = [{"l":"Total Clinical Data","v":"311","t":"-3.4%","d":"down"},{"l":"CDMS Ativos","v":"8.972","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.6%","d":"up"}];
const COLS = ["ID","CDMS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Data #001","Clinical Data #002","3.760","5.279","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Data #002","Clinical Data #003","4.783","4.641","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Data #003","Clinical Data #004","576","6.739","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Data #004","Clinical Data #005","2.093","1.980","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Data #005","Clinical Data #001","5.854","7.425","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":480},{"label":"Mar","value":607},{"label":"Abr","value":667},{"label":"Mai","value":472},{"label":"Jun","value":629},{"label":"Jul","value":730},{"label":"Ago","value":434},{"label":"Set","value":378},{"label":"Out","value":676},{"label":"Nov","value":387},{"label":"Dez","value":479}];
const MX = 730;
...
export default function CdmsPage() {
    return (
