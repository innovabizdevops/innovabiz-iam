...
/* ═══ Clinical Data Mgmt — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "4605", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4112", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€110K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1275490805", cells: ["CLI-2805", "Clinical Data Mgmt Item 1", "2/6/2026", "€40 905"], status: "active" as const },
    { id: "1275494376", cells: ["CLI-6376", "Clinical Data Mgmt Item 2", "17/1/2026", "€44 476"], status: "pending" as const },
    { id: "1275497947", cells: ["CLI-9947", "Clinical Data Mgmt Item 3", "4/8/2026", "€48 047"], status: "completed" as const },
    { id: "1275501518", cells: ["CLI-4518", "Clinical Data Mgmt Item 4", "19/3/2026", "€1618"], status: "warning" as const },
    { id: "1275505089", cells: ["CLI-8089", "Clinical Data Mgmt Item 5", "6/10/2026", "€5189"], status: "active" as const },
];
...
export default function ClinicalDataMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clinical Data Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Clinical Data Mgmt</p>
                    </div>
                </div>
