...
const KPIS = [
    { label: "Total Registos", value: "5682", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2577", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€430K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "714389582", cells: ["MER-6582", "Merchandise Management Item 1", "19/3/2026", "€39 682"], status: "active" as const },
    { id: "714393153", cells: ["MER-1153", "Merchandise Management Item 2", "6/10/2026", "€43 253"], status: "pending" as const },
    { id: "714396724", cells: ["MER-4724", "Merchandise Management Item 3", "21/5/2026", "€46 824"], status: "completed" as const },
    { id: "714400295", cells: ["MER-8295", "Merchandise Management Item 4", "8/12/2026", "€395"], status: "warning" as const },
    { id: "714403866", cells: ["MER-2866", "Merchandise Management Item 5", "23/7/2026", "€3966"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Merchandise Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Merchandise Management</p>
                    </div>
                </div>
