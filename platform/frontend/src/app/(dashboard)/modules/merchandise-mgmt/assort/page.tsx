...
const ACCENT = "#ea580c";
const MODULE = "Merchandise Management";
const PAGE = "Assort";
const KPIS = [{"l":"Pedidos/Dia","v":"4979","t":"+13.4%","d":"up"},{"l":"GMV (€)","v":"€93267","t":"-0.1%","d":"down"},{"l":"Conversão (%)","v":"86.5%","t":"+9.8%","d":"up"},{"l":"AOV (€)","v":"€53703","t":"+1.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 20012.10","464","341","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 8393.53","7.492","628","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 48253.38","8.036","2.845","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 36209.85","7.389","3.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 34120.11","7.101","1.294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":431},{"label":"Mar","value":336},{"label":"Abr","value":619},{"label":"Mai","value":251},{"label":"Jun","value":431},{"label":"Jul","value":613},{"label":"Ago","value":332},{"label":"Set","value":542},{"label":"Out","value":297},{"label":"Nov","value":577},{"label":"Dez","value":376}];
const MX = 619;
