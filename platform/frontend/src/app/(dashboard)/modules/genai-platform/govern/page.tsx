...
const PAGE = "Govern";
const KPIS = [{"l":"Formulários Ativos","v":"7.862","t":"+14.2%","d":"up"},{"l":"Submissões/Dia","v":"1403","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"2.502","t":"+15.7%","d":"up"},{"l":"Templates","v":"1.851","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.696","2026-01-16","3.406","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.569","2026-03-02","4.452","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.174","2026-02-18","6.000","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.387","2026-01-03","6.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.364","2026-02-17","6.936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":519},{"label":"Mar","value":886},{"label":"Abr","value":559},{"label":"Mai","value":757},{"label":"Jun","value":770},{"label":"Jul","value":888},{"label":"Ago","value":691},{"label":"Set","value":850},{"label":"Out","value":633},{"label":"Nov","value":683},{"label":"Dez","value":499}];
const MX = 888;
