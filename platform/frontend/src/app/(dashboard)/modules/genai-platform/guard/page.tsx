...
const PAGE = "Guard";
const KPIS = [{"l":"Formulários Ativos","v":"5.716","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"3806","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"8.092","t":"+9.9%","d":"up"},{"l":"Templates","v":"2.622","t":"+3.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.650","2026-01-08","1.119","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","980","2026-03-23","7.536","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.887","2026-01-18","295","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.249","2026-02-26","5.140","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","199","2026-01-23","2.441","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":345},{"label":"Mar","value":394},{"label":"Abr","value":473},{"label":"Mai","value":449},{"label":"Jun","value":471},{"label":"Jul","value":483},{"label":"Ago","value":552},{"label":"Set","value":614},{"label":"Out","value":615},{"label":"Nov","value":701},{"label":"Dez","value":538}];
const MX = 701;
