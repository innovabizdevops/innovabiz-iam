...
/* ═══ GenAI Platform (Gartner) — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "1391", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1271", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€374K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "45016591", cells: ["GEN-8591", "GenAI Platform (Gartner) Item 1", "12/8/2026", "€16 691"], status: "active" as const },
    { id: "45020162", cells: ["GEN-3162", "GenAI Platform (Gartner) Item 2", "27/3/2026", "€20 262"], status: "pending" as const },
    { id: "45023733", cells: ["GEN-6733", "GenAI Platform (Gartner) Item 3", "14/10/2026", "€23 833"], status: "completed" as const },
    { id: "45027304", cells: ["GEN-1304", "GenAI Platform (Gartner) Item 4", "1/5/2026", "€27 404"], status: "warning" as const },
    { id: "45030875", cells: ["GEN-4875", "GenAI Platform (Gartner) Item 5", "16/12/2026", "€30 975"], status: "active" as const },
];
...
export default function GenaiPlatformGartnerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Platform (Gartner)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Platform (Gartner)</p>
                    </div>
                </div>
