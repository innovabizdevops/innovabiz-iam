...
const ACCENT = "#8b5cf6";
const MODULE = "GenAI Platform (Gartner)";
const PAGE = "Fine-Tune";
const KPIS = [{"l":"Formulários Ativos","v":"748","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"1862","t":"+4.8%","d":"up"},{"l":"Documentos Gerados","v":"2.993","t":"-3.1%","d":"down"},{"l":"Templates","v":"6.286","t":"+2.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.708","2026-01-25","5.614","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.738","2026-02-14","5.834","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.489","2026-01-02","6.065","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.729","2026-03-13","342","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.532","2026-02-16","2.128","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":411},{"label":"Mar","value":452},{"label":"Abr","value":652},{"label":"Mai","value":651},{"label":"Jun","value":324},{"label":"Jul","value":347},{"label":"Ago","value":509},{"label":"Set","value":535},{"label":"Out","value":539},{"label":"Nov","value":360},{"label":"Dez","value":600}];
const MX = 652;
