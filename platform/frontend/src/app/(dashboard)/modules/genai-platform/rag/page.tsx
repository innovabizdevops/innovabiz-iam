...
const PAGE = "RAG";
const KPIS = [{"l":"Formulários Ativos","v":"2.796","t":"+9.9%","d":"up"},{"l":"Submissões/Dia","v":"286","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"7.600","t":"+2.0%","d":"up"},{"l":"Templates","v":"1.569","t":"-2.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.667","2026-02-25","1.819","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.706","2026-03-22","5.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.404","2026-02-04","3.629","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.421","2026-02-12","1.259","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.910","2026-03-07","1.220","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":475},{"label":"Mar","value":527},{"label":"Abr","value":596},{"label":"Mai","value":832},{"label":"Jun","value":543},{"label":"Jul","value":528},{"label":"Ago","value":503},{"label":"Set","value":556},{"label":"Out","value":849},{"label":"Nov","value":500},{"label":"Dez","value":715}];
const MX = 849;
