...
const KPIS = [{"l":"Formulários Ativos","v":"6.707","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"3830","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"4.916","t":"+6.7%","d":"up"},{"l":"Templates","v":"3.661","t":"+0.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.898","2026-03-22","5.095","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.295","2026-02-13","1.862","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.556","2026-02-02","4.440","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.347","2026-03-22","7.743","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.605","2026-03-21","8.271","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":766},{"label":"Mar","value":896},{"label":"Abr","value":702},{"label":"Mai","value":851},{"label":"Jun","value":772},{"label":"Jul","value":726},{"label":"Ago","value":580},{"label":"Set","value":611},{"label":"Out","value":860},{"label":"Nov","value":658},{"label":"Dez","value":937}];
const MX = 937;
