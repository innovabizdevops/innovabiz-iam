...
const ACCENT = "#6366f1";
const MODULE = "Personalization Engine";
const PAGE = "Recommend";
const KPIS = [{"l":"Perfis Unificados","v":"2.322","t":"+13.5%","d":"up"},{"l":"Segmentos Ativos","v":"738","t":"-1.1%","d":"down"},{"l":"NPS Score","v":"92","t":"-0.6%","d":"down"},{"l":"Churn Previsto (%)","v":"89.5%","t":"+1.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.235","€ 20046.03","81.3%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.215","€ 32805.95","85.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.854","€ 40071.23","75.4%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.777","€ 7272.32","97.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.979","€ 4591.87","71.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":515},{"label":"Fev","value":343},{"label":"Mar","value":448},{"label":"Abr","value":351},{"label":"Mai","value":486},{"label":"Jun","value":475},{"label":"Jul","value":574},{"label":"Ago","value":343},{"label":"Set","value":631},{"label":"Out","value":345},{"label":"Nov","value":366},{"label":"Dez","value":378}];
const MX = 631;
