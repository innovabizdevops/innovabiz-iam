...
const KPIS = [
    ...
    { label: "Ativos", value: "3735", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "230885070", cells: ["PER-9070", "Personalization Engine Item 1", "11/7/2026", "€35 170"], status: "active" as const },
    { id: "230888641", cells: ["PER-3641", "Personalization Engine Item 2", "26/2/2026", "€38 741"], status: "pending" as const },
    { id: "230892212", cells: ["PER-7212", "Personalization Engine Item 3", "13/9/2026", "€42 312"], status: "completed" as const },
    { id: "230895783", cells: ["PER-1783", "Personalization Engine Item 4", "28/4/2026", "€45 883"], status: "warning" as const },
    { id: "230899354", cells: ["PER-5354", "Personalization Engine Item 5", "15/11/2026", "€49 454"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Personalization Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Personalization Engine</p>
                    </div>
                </div>
