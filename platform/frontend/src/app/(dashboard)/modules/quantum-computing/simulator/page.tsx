...
const PAGE = "Quantum Simulator";
const KPIS = [{"l":"Twins Ativos","v":"2.302","t":"-1.4%","d":"down"},{"l":"Simulações/Dia","v":"3589","t":"+17.9%","d":"up"},{"l":"Precisão Modelo (%)","v":"87.7%","t":"+9.0%","d":"up"},{"l":"Latência Sync (ms)","v":"142ms","t":"+7.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","79.1%","2026-02-18","990","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.9%","2026-01-07","2.133","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","90.5%","2026-02-10","6.226","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","92.2%","2026-03-03","2.722","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","72.6%","2026-03-04","834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":734},{"label":"Mar","value":700},{"label":"Abr","value":642},{"label":"Mai","value":739},{"label":"Jun","value":819},{"label":"Jul","value":639},{"label":"Ago","value":910},{"label":"Set","value":815},{"label":"Out","value":663},{"label":"Nov","value":682},{"label":"Dez","value":848}];
const MX = 910;
