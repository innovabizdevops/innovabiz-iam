...
const ACCENT = "#6d28d9";
const MODULE = "Quantum Computing";
const PAGE = "Quantum ML";
const KPIS = [{"l":"Total Quantum Computing","v":"4.769","t":"+7.3%","d":"up"},{"l":"Quantum ML Ativos","v":"5.677","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"66.4%","t":"-5.8%","d":"down"},{"l":"Score Performance","v":"73","t":"-1.0%","d":"down"}];
const COLS = ["ID","Quantum ML","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quantum Computing #001","Quantum Computing #002","3.453","4.175","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Quantum Computing #002","Quantum Computing #003","1.403","431","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Quantum Computing #003","Quantum Computing #004","2.371","5.736","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Quantum Computing #004","Quantum Computing #005","2.623","2.316","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quantum Computing #005","Quantum Computing #001","2.292","2.791","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":433},{"label":"Mar","value":424},{"label":"Abr","value":560},{"label":"Mai","value":398},{"label":"Jun","value":394},{"label":"Jul","value":598},{"label":"Ago","value":361},{"label":"Set","value":608},{"label":"Out","value":534},{"label":"Nov","value":567},{"label":"Dez","value":382}];
const MX = 676;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>QML</span></h1>
                </div>
