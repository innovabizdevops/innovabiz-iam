...
const KPIS = [{"l":"Tickets Abertos","v":"1.842","t":"+15.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.9%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"188h","t":"+5.2%","d":"up"},{"l":"Satisfação (%)","v":"84.7%","t":"+5.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","203","7.895","4.778","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.854","1.007","3.066","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.304","1.804","3.226","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.365","5.369","6.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","694","4.743","6.446","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":614},{"label":"Mar","value":699},{"label":"Abr","value":848},{"label":"Mai","value":819},{"label":"Jun","value":512},{"label":"Jul","value":652},{"label":"Ago","value":712},{"label":"Set","value":581},{"label":"Out","value":482},{"label":"Nov","value":494},{"label":"Dez","value":840}];
const MX = 848;
