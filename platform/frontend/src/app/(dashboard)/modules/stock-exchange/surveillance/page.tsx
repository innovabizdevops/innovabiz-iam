...
const ACCENT = "#dc2626";
const MODULE = "Bolsa de Valores";
const PAGE = "Surveillance";
const KPIS = [{"l":"Total Stock Exchange","v":"3.735","t":"+10.6%","d":"up"},{"l":"Surveillance Ativos","v":"9.018","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"61","t":"-1.3%","d":"down"}];
const COLS = ["ID","Surveillance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stock Exchange #001","Stock Exchange #002","3.661","1.627","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Stock Exchange #002","Stock Exchange #003","1.090","3.460","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Stock Exchange #003","Stock Exchange #004","3.025","6.310","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Stock Exchange #004","Stock Exchange #005","1.984","2.889","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stock Exchange #005","Stock Exchange #001","342","4.175","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":932},{"label":"Fev","value":991},{"label":"Mar","value":723},{"label":"Abr","value":639},{"label":"Mai","value":1016},{"label":"Jun","value":948},{"label":"Jul","value":902},{"label":"Ago","value":992},{"label":"Set","value":862},{"label":"Out","value":775},{"label":"Nov","value":936},{"label":"Dez","value":880}];
const MX = 1016;
