...
const PAGE = "Index";
const KPIS = [{"l":"Total Stock Exchange","v":"2.271","t":"+0.8%","d":"up"},{"l":"Index Ativos","v":"7.691","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+8.3%","d":"up"}];
const COLS = ["ID","Index","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stock Exchange #001","Stock Exchange #002","6.912","710","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Stock Exchange #002","Stock Exchange #003","8.064","7.124","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Stock Exchange #003","Stock Exchange #004","5.730","4.834","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Stock Exchange #004","Stock Exchange #005","8.940","2.990","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stock Exchange #005","Stock Exchange #001","6.599","5.245","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":777},{"label":"Mar","value":733},{"label":"Abr","value":844},{"label":"Mai","value":690},{"label":"Jun","value":660},{"label":"Jul","value":902},{"label":"Ago","value":725},{"label":"Set","value":793},{"label":"Out","value":661},{"label":"Nov","value":751},{"label":"Dez","value":542}];
const MX = 902;
