...
/* ═══ Bolsa de Valores — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8073", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1716", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€155K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "697413473", cells: ["STO-4473", "Bolsa de Valores Item 1", "2/6/2026", "€13 573"], status: "active" as const },
    { id: "697417044", cells: ["STO-8044", "Bolsa de Valores Item 2", "17/1/2026", "€17 144"], status: "pending" as const },
    { id: "697420615", cells: ["STO-2615", "Bolsa de Valores Item 3", "4/8/2026", "€20 715"], status: "completed" as const },
    { id: "697424186", cells: ["STO-6186", "Bolsa de Valores Item 4", "19/3/2026", "€24 286"], status: "warning" as const },
    { id: "697427757", cells: ["STO-9757", "Bolsa de Valores Item 5", "6/10/2026", "€27 857"], status: "active" as const },
];
...
export default function BolsaDeValoresPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bolsa de Valores</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Bolsa de Valores</p>
                    </div>
                </div>
