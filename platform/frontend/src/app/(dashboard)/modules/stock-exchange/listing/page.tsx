...
const PAGE = "Listing";
const KPIS = [{"l":"Total Stock Exchange","v":"6.713","t":"-2.2%","d":"down"},{"l":"Listing Ativos","v":"3.208","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.7%","d":"up"}];
const COLS = ["ID","Listing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stock Exchange #001","Stock Exchange #002","4.946","3.889","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Stock Exchange #002","Stock Exchange #003","7.461","8.915","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Stock Exchange #003","Stock Exchange #004","4.042","7.125","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Stock Exchange #004","Stock Exchange #005","7.467","776","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stock Exchange #005","Stock Exchange #001","7.474","1.185","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":922},{"label":"Mar","value":706},{"label":"Abr","value":864},{"label":"Mai","value":638},{"label":"Jun","value":856},{"label":"Jul","value":856},{"label":"Ago","value":714},{"label":"Set","value":925},{"label":"Out","value":911},{"label":"Nov","value":917},{"label":"Dez","value":669}];
const MX = 925;
