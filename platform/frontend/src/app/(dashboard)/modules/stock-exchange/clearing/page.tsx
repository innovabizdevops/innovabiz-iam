...
const PAGE = "Clearing";
const KPIS = [{"l":"Total Stock Exchange","v":"4.564","t":"-1.7%","d":"down"},{"l":"Clearing Ativos","v":"3.084","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"88.7%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"60","t":"+16.3%","d":"up"}];
const COLS = ["ID","Clearing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Stock Exchange #001","Stock Exchange #002","4.190","1.183","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Stock Exchange #002","Stock Exchange #003","3.619","2.026","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Stock Exchange #003","Stock Exchange #004","8.284","1.684","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Stock Exchange #004","Stock Exchange #005","5.415","6.504","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Stock Exchange #005","Stock Exchange #001","3.873","1.020","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":292},{"label":"Mar","value":365},{"label":"Abr","value":496},{"label":"Mai","value":434},{"label":"Jun","value":574},{"label":"Jul","value":457},{"label":"Ago","value":539},{"label":"Set","value":581},{"label":"Out","value":405},{"label":"Nov","value":494},{"label":"Dez","value":576}];
const MX = 581;
