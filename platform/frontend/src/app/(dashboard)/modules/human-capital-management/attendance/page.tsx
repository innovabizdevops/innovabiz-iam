...
const PAGE = "Time &amp; Attendance";
const KPIS = [{"l":"Projetos Melhoria","v":"5.128","t":"+3.2%","d":"up"},{"l":"Savings (€)","v":"€55422","t":"-5.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.7%","t":"+8.8%","d":"up"},{"l":"Ciclos PDCA","v":"7.225","t":"+13.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.632","€ 47405.15","9.062","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.409","€ 30474.19","8.170","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.244","€ 38565.32","623","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.277","€ 45564.03","5.833","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","429","€ 950.25","2.499","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":802},{"label":"Mar","value":985},{"label":"Abr","value":887},{"label":"Mai","value":899},{"label":"Jun","value":1019},{"label":"Jul","value":932},{"label":"Ago","value":829},{"label":"Set","value":790},{"label":"Out","value":956},{"label":"Nov","value":854},{"label":"Dez","value":856}];
const MX = 1019;
