...
const PAGE = "Talent Acquisition";
const KPIS = [{"l":"eNPS","v":"84","t":"+4.8%","d":"up"},{"l":"Engagement (%)","v":"80.1%","t":"+13.8%","d":"up"},{"l":"Turnover (%)","v":"90.1%","t":"+2.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"9.043","t":"+8.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.468","2026-03-06","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.963","2026-03-03","70","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.090","2026-02-26","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.595","2026-02-17","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.207","2026-02-27","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":629},{"label":"Mar","value":705},{"label":"Abr","value":786},{"label":"Mai","value":644},{"label":"Jun","value":600},{"label":"Jul","value":855},{"label":"Ago","value":675},{"label":"Set","value":651},{"label":"Out","value":632},{"label":"Nov","value":636},{"label":"Dez","value":721}];
const MX = 855;
...
export default function TalentAcquisitionPeopleHrPage() {
    return (
