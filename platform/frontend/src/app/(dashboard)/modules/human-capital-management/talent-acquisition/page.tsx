...
const PAGE = "Talent Lifecycle";
const KPIS = [{"l":"Projetos Melhoria","v":"1.252","t":"-4.2%","d":"down"},{"l":"Savings (€)","v":"€13025","t":"-2.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"93.6%","t":"+17.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.932","t":"+0.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.207","€ 24562.48","2.945","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.648","€ 33998.65","1.953","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.979","€ 47216.38","8.536","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","934","€ 41654.23","5.571","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.691","€ 24739.34","7.122","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":916},{"label":"Mar","value":834},{"label":"Abr","value":898},{"label":"Mai","value":702},{"label":"Jun","value":741},{"label":"Jul","value":897},{"label":"Ago","value":840},{"label":"Set","value":885},{"label":"Out","value":977},{"label":"Nov","value":863},{"label":"Dez","value":871}];
const MX = 977;
