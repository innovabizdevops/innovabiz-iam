...
const PAGE = "Goals &amp; OKRs";
const KPIS = [{"l":"Projetos Melhoria","v":"2.912","t":"+3.9%","d":"up"},{"l":"Savings (€)","v":"€88912","t":"-0.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"78.9%","t":"-5.9%","d":"down"},{"l":"Ciclos PDCA","v":"4.000","t":"+11.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.151","€ 21861.33","1.160","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.094","€ 21596.56","799","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.422","€ 43405.86","2.342","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","413","€ 774.15","8.809","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.344","€ 49254.28","3.470","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":975},{"label":"Fev","value":752},{"label":"Mar","value":804},{"label":"Abr","value":683},{"label":"Mai","value":929},{"label":"Jun","value":853},{"label":"Jul","value":1053},{"label":"Ago","value":1037},{"label":"Set","value":869},{"label":"Out","value":660},{"label":"Nov","value":961},{"label":"Dez","value":814}];
const MX = 1053;
