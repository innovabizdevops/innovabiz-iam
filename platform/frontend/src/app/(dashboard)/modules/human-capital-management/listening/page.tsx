...
const PAGE = "Employee Listening";
const KPIS = [{"l":"eNPS","v":"63","t":"+7.9%","d":"up"},{"l":"Engagement (%)","v":"70.7%","t":"-2.2%","d":"down"},{"l":"Turnover (%)","v":"78.3%","t":"-5.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.434","t":"-4.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.015","2026-02-10","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.071","2026-02-09","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.205","2026-01-04","61","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.917","2026-01-06","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.607","2026-01-15","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":705},{"label":"Mar","value":765},{"label":"Abr","value":493},{"label":"Mai","value":493},{"label":"Jun","value":681},{"label":"Jul","value":568},{"label":"Ago","value":692},{"label":"Set","value":712},{"label":"Out","value":504},{"label":"Nov","value":459},{"label":"Dez","value":582}];
const MX = 765;
