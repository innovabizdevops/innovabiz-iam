...
const PAGE = "Contingent Workers";
const KPIS = [{"l":"Projetos Melhoria","v":"1.469","t":"+4.8%","d":"up"},{"l":"Savings (€)","v":"€14424","t":"-3.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"89.4%","t":"+5.3%","d":"up"},{"l":"Ciclos PDCA","v":"2.668","t":"+6.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.529","€ 39815.17","3.413","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.299","€ 28484.89","7.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.641","€ 41791.34","2.095","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.979","€ 36585.17","5.452","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.945","€ 14803.82","6.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":685},{"label":"Mar","value":498},{"label":"Abr","value":713},{"label":"Mai","value":655},{"label":"Jun","value":755},{"label":"Jul","value":623},{"label":"Ago","value":493},{"label":"Set","value":464},{"label":"Out","value":432},{"label":"Nov","value":548},{"label":"Dez","value":611}];
const MX = 755;
