...
const ACCENT = "#6366f1";
const MODULE = "Human Capital Management";
const PAGE = "L&amp;D Intelligence";
const KPIS = [{"l":"Projetos Melhoria","v":"8.011","t":"+3.2%","d":"up"},{"l":"Savings (€)","v":"€94127","t":"+13.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.4%","t":"-5.4%","d":"down"},{"l":"Ciclos PDCA","v":"2.859","t":"+17.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.608","€ 8277.47","1.584","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.660","€ 18413.00","9.062","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.781","€ 23391.38","2.472","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","593","€ 47280.51","7.120","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.806","€ 32473.07","5.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":919},{"label":"Mar","value":848},{"label":"Abr","value":920},{"label":"Mai","value":971},{"label":"Jun","value":656},{"label":"Jul","value":699},{"label":"Ago","value":646},{"label":"Set","value":847},{"label":"Out","value":698},{"label":"Nov","value":729},{"label":"Dez","value":729}];
const MX = 971;
...
export default function LdIntelligencePage() {
    return (
