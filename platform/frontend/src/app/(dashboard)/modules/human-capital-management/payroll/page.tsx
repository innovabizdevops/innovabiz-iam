...
const PAGE = "Workforce Operations";
const KPIS = [{"l":"eNPS","v":"85","t":"+13.8%","d":"up"},{"l":"Engagement (%)","v":"76.2%","t":"+5.0%","d":"up"},{"l":"Turnover (%)","v":"83.6%","t":"-0.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.216","t":"+1.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.501","2026-01-25","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.806","2026-03-05","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.099","2026-02-17","76","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.243","2026-02-13","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.521","2026-03-27","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":766},{"label":"Mar","value":802},{"label":"Abr","value":653},{"label":"Mai","value":542},{"label":"Jun","value":813},{"label":"Jul","value":833},{"label":"Ago","value":716},{"label":"Set","value":830},{"label":"Out","value":668},{"label":"Nov","value":744},{"label":"Dez","value":755}];
const MX = 833;
