...
const PAGE = "Skills Cloud";
const KPIS = [{"l":"Projetos Melhoria","v":"8.596","t":"+14.1%","d":"up"},{"l":"Savings (€)","v":"€9739","t":"+11.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.0%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"3.686","t":"+11.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.725","€ 43552.68","790","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.681","€ 41662.74","6.983","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","486","€ 48427.69","6.291","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.807","€ 13482.12","1.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.113","€ 2800.08","3.993","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":968},{"label":"Mar","value":856},{"label":"Abr","value":1041},{"label":"Mai","value":715},{"label":"Jun","value":730},{"label":"Jul","value":782},{"label":"Ago","value":891},{"label":"Set","value":724},{"label":"Out","value":922},{"label":"Nov","value":691},{"label":"Dez","value":989}];
const MX = 1041;
