...
const PAGE = "Employee Experience";
const KPIS = [{"l":"eNPS","v":"87","t":"+15.3%","d":"up"},{"l":"Engagement (%)","v":"84.0%","t":"+11.2%","d":"up"},{"l":"Turnover (%)","v":"84.9%","t":"+3.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.020","t":"+13.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","194","2026-03-06","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.981","2026-03-28","92","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.374","2026-03-15","95","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","165","2026-01-15","89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.226","2026-02-01","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":747},{"label":"Mar","value":793},{"label":"Abr","value":841},{"label":"Mai","value":616},{"label":"Jun","value":691},{"label":"Jul","value":935},{"label":"Ago","value":766},{"label":"Set","value":780},{"label":"Out","value":702},{"label":"Nov","value":835},{"label":"Dez","value":925}];
const MX = 935;
