...
const KPIS = [{"l":"Formulários Ativos","v":"6.978","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"3340","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"1.022","t":"+0.4%","d":"up"},{"l":"Templates","v":"1.760","t":"+16.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.496","2026-03-17","1.924","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.304","2026-03-24","9.026","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.612","2026-02-24","6.756","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","140","2026-02-21","2.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.508","2026-03-12","1.699","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":597},{"label":"Mar","value":644},{"label":"Abr","value":366},{"label":"Mai","value":431},{"label":"Jun","value":431},{"label":"Jul","value":674},{"label":"Ago","value":646},{"label":"Set","value":724},{"label":"Out","value":603},{"label":"Nov","value":657},{"label":"Dez","value":459}];
const MX = 724;
