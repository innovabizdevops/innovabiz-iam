...
const PAGE = "Workforce Planning";
const KPIS = [{"l":"eNPS","v":"76","t":"+1.4%","d":"up"},{"l":"Engagement (%)","v":"91.1%","t":"+17.3%","d":"up"},{"l":"Turnover (%)","v":"75.2%","t":"-5.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.124","t":"+6.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.411","2026-02-27","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.395","2026-02-12","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","331","2026-01-10","56","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.849","2026-01-02","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.509","2026-01-21","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":887},{"label":"Mar","value":664},{"label":"Abr","value":922},{"label":"Mai","value":685},{"label":"Jun","value":774},{"label":"Jul","value":1044},{"label":"Ago","value":784},{"label":"Set","value":739},{"label":"Out","value":996},{"label":"Nov","value":740},{"label":"Dez","value":964}];
const MX = 1044;
