...
const PAGE = "People Analytics";
const KPIS = [{"l":"eNPS","v":"89","t":"+17.5%","d":"up"},{"l":"Engagement (%)","v":"76.4%","t":"+16.4%","d":"up"},{"l":"Turnover (%)","v":"65.7%","t":"+0.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.002","t":"-5.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.688","2026-01-24","92","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.289","2026-01-05","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.598","2026-01-07","95","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.082","2026-03-23","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.595","2026-01-13","87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":858},{"label":"Mar","value":928},{"label":"Abr","value":748},{"label":"Mai","value":641},{"label":"Jun","value":703},{"label":"Jul","value":717},{"label":"Ago","value":770},{"label":"Set","value":933},{"label":"Out","value":579},{"label":"Nov","value":890},{"label":"Dez","value":597}];
const MX = 933;
...
export default function PeopleAnalyticsPeopleHrPage() {
    return (
