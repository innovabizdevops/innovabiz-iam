    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Human Capital Management</h1><p className="text-sm text-muted-foreground">Human Capital Management • iBOS Enterprise</p></div>
