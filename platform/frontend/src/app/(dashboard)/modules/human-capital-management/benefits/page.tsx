...
const PAGE = "Benefits Admin";
const KPIS = [{"l":"Projetos Melhoria","v":"4.548","t":"+0.4%","d":"up"},{"l":"Savings (€)","v":"€33803","t":"+3.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.4%","t":"+11.1%","d":"up"},{"l":"Ciclos PDCA","v":"2.839","t":"+3.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.367","€ 18297.34","242","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.187","€ 2129.10","8.436","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.827","€ 10878.42","4.395","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.174","€ 21652.00","7.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.385","€ 40197.13","8.117","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":433},{"label":"Mar","value":454},{"label":"Abr","value":359},{"label":"Mai","value":534},{"label":"Jun","value":478},{"label":"Jul","value":482},{"label":"Ago","value":680},{"label":"Set","value":426},{"label":"Out","value":749},{"label":"Nov","value":540},{"label":"Dez","value":562}];
const MX = 749;
