...
const PAGE = "Diversity Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.194","t":"+5.9%","d":"up"},{"l":"Queries/Dia","v":"3184","t":"-4.0%","d":"down"},{"l":"Dados Processados (GB)","v":"840","t":"+6.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.827","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","868","2026-02-13","7.946","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4435","2026-02-08","3.803","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2675","2026-01-11","647","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1480","2026-03-26","7.851","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4828","2026-02-19","7.577","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":436},{"label":"Fev","value":616},{"label":"Mar","value":463},{"label":"Abr","value":695},{"label":"Mai","value":654},{"label":"Jun","value":380},{"label":"Jul","value":646},{"label":"Ago","value":551},{"label":"Set","value":604},{"label":"Out","value":444},{"label":"Nov","value":463},{"label":"Dez","value":392}];
const MX = 695;
