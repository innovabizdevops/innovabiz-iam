...
const PAGE = "Compensation";
const KPIS = [{"l":"Projetos Melhoria","v":"4.316","t":"+16.6%","d":"up"},{"l":"Savings (€)","v":"€18598","t":"+13.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.0%","t":"+16.9%","d":"up"},{"l":"Ciclos PDCA","v":"754","t":"+9.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.832","€ 10337.36","488","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.630","€ 13238.50","7.322","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","230","€ 44920.01","6.105","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.847","€ 18445.18","6.252","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.114","€ 14723.84","123","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":816},{"label":"Mar","value":748},{"label":"Abr","value":645},{"label":"Mai","value":756},{"label":"Jun","value":875},{"label":"Jul","value":705},{"label":"Ago","value":718},{"label":"Set","value":670},{"label":"Out","value":578},{"label":"Nov","value":887},{"label":"Dez","value":713}];
const MX = 887;
