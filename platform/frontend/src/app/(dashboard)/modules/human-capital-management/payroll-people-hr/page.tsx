...
const PAGE = "Payroll Multi-Country";
const KPIS = [{"l":"eNPS","v":"83","t":"+2.2%","d":"up"},{"l":"Engagement (%)","v":"89.6%","t":"+4.7%","d":"up"},{"l":"Turnover (%)","v":"90.3%","t":"-2.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"2.934","t":"+12.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.875","2026-01-23","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.244","2026-02-15","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.965","2026-02-09","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.486","2026-03-09","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.134","2026-02-09","61","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":614},{"label":"Mar","value":993},{"label":"Abr","value":744},{"label":"Mai","value":703},{"label":"Jun","value":661},{"label":"Jul","value":840},{"label":"Ago","value":958},{"label":"Set","value":826},{"label":"Out","value":695},{"label":"Nov","value":872},{"label":"Dez","value":977}];
const MX = 993;
...
export default function PayrollPeopleHrPage() {
    return (
