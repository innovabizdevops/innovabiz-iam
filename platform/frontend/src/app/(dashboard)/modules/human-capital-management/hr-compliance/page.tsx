...
const PAGE = "HR Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.428","t":"-4.9%","d":"down"},{"l":"NC Abertas","v":"4.267","t":"+6.8%","d":"up"},{"l":"Conformidade (%)","v":"73.1%","t":"-0.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.297","t":"+5.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.185","89.2%","2.431","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.396","79.2%","3.588","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","162","85.3%","5.676","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.217","99.3%","7.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.108","92.8%","5.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":412},{"label":"Mar","value":370},{"label":"Abr","value":665},{"label":"Mai","value":501},{"label":"Jun","value":461},{"label":"Jul","value":588},{"label":"Ago","value":433},{"label":"Set","value":534},{"label":"Out","value":415},{"label":"Nov","value":270},{"label":"Dez","value":293}];
const MX = 665;
