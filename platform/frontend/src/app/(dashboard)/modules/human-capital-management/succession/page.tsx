...
const PAGE = "Succession Planning";
const KPIS = [{"l":"eNPS","v":"83","t":"-0.5%","d":"down"},{"l":"Engagement (%)","v":"80.5%","t":"+8.6%","d":"up"},{"l":"Turnover (%)","v":"85.0%","t":"-0.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"6.579","t":"-5.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.656","2026-02-06","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.551","2026-03-22","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","817","2026-01-19","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.645","2026-03-13","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.216","2026-01-07","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":548},{"label":"Mar","value":337},{"label":"Abr","value":365},{"label":"Mai","value":465},{"label":"Jun","value":579},{"label":"Jul","value":325},{"label":"Ago","value":532},{"label":"Set","value":325},{"label":"Out","value":285},{"label":"Nov","value":468},{"label":"Dez","value":296}];
const MX = 579;
