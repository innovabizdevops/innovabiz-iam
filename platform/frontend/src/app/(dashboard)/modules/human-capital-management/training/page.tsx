...
const PAGE = "Training &amp; LMS";
const KPIS = [{"l":"Projetos Melhoria","v":"2.596","t":"+11.0%","d":"up"},{"l":"Savings (€)","v":"€91744","t":"+7.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.9%","t":"+9.7%","d":"up"},{"l":"Ciclos PDCA","v":"7.774","t":"+16.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.257","€ 39676.71","1.254","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.306","€ 24669.62","7.234","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.673","€ 22119.39","2.958","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.733","€ 48539.90","6.455","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.240","€ 46129.37","8.492","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":628},{"label":"Mar","value":672},{"label":"Abr","value":400},{"label":"Mai","value":600},{"label":"Jun","value":682},{"label":"Jul","value":404},{"label":"Ago","value":517},{"label":"Set","value":532},{"label":"Out","value":382},{"label":"Nov","value":630},{"label":"Dez","value":505}];
const MX = 682;
