...
const PAGE = "Schedule";
const KPIS = [{"l":"eNPS","v":"95","t":"-3.3%","d":"down"},{"l":"Engagement (%)","v":"72.2%","t":"+13.3%","d":"up"},{"l":"Turnover (%)","v":"80.2%","t":"+1.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.856","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","795","2026-01-24","94","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","161","2026-03-14","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.245","2026-02-10","59","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.833","2026-03-16","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.917","2026-01-07","60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":537},{"label":"Mar","value":886},{"label":"Abr","value":647},{"label":"Mai","value":651},{"label":"Jun","value":523},{"label":"Jul","value":777},{"label":"Ago","value":899},{"label":"Set","value":856},{"label":"Out","value":883},{"label":"Nov","value":836},{"label":"Dez","value":607}];
const MX = 899;
