...
const PAGE = "Optimize";
const KPIS = [{"l":"eNPS","v":"65","t":"-2.7%","d":"down"},{"l":"Engagement (%)","v":"72.0%","t":"-4.2%","d":"down"},{"l":"Turnover (%)","v":"93.1%","t":"-5.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.540","t":"-2.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.526","2026-03-18","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.583","2026-02-06","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.603","2026-01-02","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.338","2026-02-22","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.400","2026-01-19","58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":700},{"label":"Mar","value":419},{"label":"Abr","value":521},{"label":"Mai","value":637},{"label":"Jun","value":612},{"label":"Jul","value":471},{"label":"Ago","value":421},{"label":"Set","value":457},{"label":"Out","value":653},{"label":"Nov","value":577},{"label":"Dez","value":715}];
const MX = 715;
