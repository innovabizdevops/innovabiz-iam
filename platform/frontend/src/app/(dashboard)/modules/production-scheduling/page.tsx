...
/* ═══ Production Scheduling (APS) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "3957", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3503", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€18K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1171292657", cells: ["PRO-6657", "Production Scheduling (APS) Item 1", "18/6/2026", "€42 757"], status: "active" as const },
    { id: "1171296228", cells: ["PRO-1228", "Production Scheduling (APS) Item 2", "5/1/2026", "€46 328"], status: "pending" as const },
    { id: "1171299799", cells: ["PRO-4799", "Production Scheduling (APS) Item 3", "20/8/2026", "€49 899"], status: "completed" as const },
    { id: "1171303370", cells: ["PRO-8370", "Production Scheduling (APS) Item 4", "7/3/2026", "€3470"], status: "warning" as const },
    { id: "1171306941", cells: ["PRO-2941", "Production Scheduling (APS) Item 5", "22/10/2026", "€7041"], status: "active" as const },
];
...
export default function ProductionSchedulingApsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Scheduling (APS)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Production Scheduling (APS)</p>
                    </div>
                </div>
