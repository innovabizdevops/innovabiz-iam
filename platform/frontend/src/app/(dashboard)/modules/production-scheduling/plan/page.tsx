...
const PAGE = "Plan";
const KPIS = [{"l":"eNPS","v":"92","t":"+5.8%","d":"up"},{"l":"Engagement (%)","v":"82.7%","t":"+4.3%","d":"up"},{"l":"Turnover (%)","v":"72.5%","t":"+12.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.900","t":"+5.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.834","2026-01-08","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.633","2026-01-06","76","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","377","2026-03-14","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.439","2026-01-03","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.933","2026-02-24","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":311},{"label":"Mar","value":558},{"label":"Abr","value":383},{"label":"Mai","value":341},{"label":"Jun","value":356},{"label":"Jul","value":469},{"label":"Ago","value":547},{"label":"Set","value":568},{"label":"Out","value":311},{"label":"Nov","value":444},{"label":"Dez","value":347}];
const MX = 568;
