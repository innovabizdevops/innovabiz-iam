...
const PAGE = "Sequence";
const KPIS = [{"l":"eNPS","v":"94","t":"+4.4%","d":"up"},{"l":"Engagement (%)","v":"65.4%","t":"-3.9%","d":"down"},{"l":"Turnover (%)","v":"73.2%","t":"-5.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"7.251","t":"+9.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.604","2026-02-11","72","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.052","2026-03-27","72","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.799","2026-01-05","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.130","2026-01-05","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","9.019","2026-01-09","56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":651},{"label":"Mar","value":652},{"label":"Abr","value":436},{"label":"Mai","value":435},{"label":"Jun","value":585},{"label":"Jul","value":423},{"label":"Ago","value":304},{"label":"Set","value":271},{"label":"Out","value":381},{"label":"Nov","value":517},{"label":"Dez","value":509}];
const MX = 652;
