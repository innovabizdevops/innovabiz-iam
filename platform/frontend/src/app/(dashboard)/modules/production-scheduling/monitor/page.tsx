...
const ACCENT = "#0891b2";
const MODULE = "Production Scheduling (APS)";
const PAGE = "Monitor";
const KPIS = [{"l":"eNPS","v":"66","t":"+2.6%","d":"up"},{"l":"Engagement (%)","v":"75.3%","t":"+17.8%","d":"up"},{"l":"Turnover (%)","v":"74.2%","t":"+4.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.965","t":"-3.5%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.939","2026-03-17","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.734","2026-01-10","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.044","2026-03-25","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.313","2026-03-19","65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.586","2026-03-14","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":321},{"label":"Mar","value":330},{"label":"Abr","value":339},{"label":"Mai","value":542},{"label":"Jun","value":313},{"label":"Jul","value":264},{"label":"Ago","value":518},{"label":"Set","value":468},{"label":"Out","value":518},{"label":"Nov","value":424},{"label":"Dez","value":559}];
const MX = 559;
