...
const PAGE = "Isolate";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.378","t":"+1.7%","d":"up"},{"l":"NC Abertas","v":"4.972","t":"+6.1%","d":"up"},{"l":"Conformidade (%)","v":"94.5%","t":"-5.6%","d":"down"},{"l":"CAPAs Pendentes","v":"8.680","t":"+15.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.338","87.4%","4.963","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.257","84.7%","3.130","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.731","70.5%","6.395","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.345","80.4%","7.169","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.304","78.4%","5.943","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":628},{"label":"Mar","value":791},{"label":"Abr","value":775},{"label":"Mai","value":748},{"label":"Jun","value":649},{"label":"Jul","value":444},{"label":"Ago","value":754},{"label":"Set","value":570},{"label":"Out","value":511},{"label":"Nov","value":524},{"label":"Dez","value":683}];
const MX = 791;
