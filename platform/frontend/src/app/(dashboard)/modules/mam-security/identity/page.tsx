...
const PAGE = "Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"3.399","t":"+11.3%","d":"up"},{"l":"Sessões/Dia","v":"1120","t":"+17.9%","d":"up"},{"l":"MFA Adoção (%)","v":"65.8%","t":"+2.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.666","t":"+14.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.110","7.469","5.136","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.789","2.370","7.033","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.634","3.776","381","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.168","2.966","8.345","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.104","5.094","7.576","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":474},{"label":"Fev","value":692},{"label":"Mar","value":518},{"label":"Abr","value":768},{"label":"Mai","value":655},{"label":"Jun","value":578},{"label":"Jul","value":542},{"label":"Ago","value":483},{"label":"Set","value":565},{"label":"Out","value":735},{"label":"Nov","value":680},{"label":"Dez","value":543}];
const MX = 768;
