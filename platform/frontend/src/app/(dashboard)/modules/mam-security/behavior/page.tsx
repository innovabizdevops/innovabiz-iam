...
const ACCENT = "#0369a1";
const MODULE = "MAM Agent Security";
const PAGE = "Behavior";
const KPIS = [{"l":"Total Mam Security","v":"148","t":"+16.0%","d":"up"},{"l":"Behavior Ativos","v":"2.110","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"93.0%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+12.3%","d":"up"}];
const COLS = ["ID","Behavior","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Security #001","Mam Security #002","3.726","1.293","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Security #002","Mam Security #003","6.340","8.670","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Security #003","Mam Security #004","2.806","756","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Security #004","Mam Security #005","4.255","2.303","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Security #005","Mam Security #001","6.598","7.919","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":710},{"label":"Mar","value":594},{"label":"Abr","value":721},{"label":"Mai","value":869},{"label":"Jun","value":930},{"label":"Jul","value":987},{"label":"Ago","value":681},{"label":"Set","value":870},{"label":"Out","value":925},{"label":"Nov","value":736},{"label":"Dez","value":769}];
const MX = 987;
