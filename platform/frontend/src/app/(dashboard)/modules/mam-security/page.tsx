...
/* ═══ MAM Agent Security — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "5397", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4560", trend: "+17%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1342356197", cells: ["MAM-7197", "MAM Agent Security Item 1", "22/6/2026", "€6297"], status: "active" as const },
    { id: "1342359768", cells: ["MAM-1768", "MAM Agent Security Item 2", "9/1/2026", "€9868"], status: "pending" as const },
    { id: "1342363339", cells: ["MAM-5339", "MAM Agent Security Item 3", "24/8/2026", "€13 439"], status: "completed" as const },
    { id: "1342366910", cells: ["MAM-8910", "MAM Agent Security Item 4", "11/3/2026", "€17 010"], status: "warning" as const },
    { id: "1342370481", cells: ["MAM-3481", "MAM Agent Security Item 5", "26/10/2026", "€20 581"], status: "active" as const },
];
...
export default function MamAgentSecurityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Agent Security</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Agent Security</p>
                    </div>
                </div>
