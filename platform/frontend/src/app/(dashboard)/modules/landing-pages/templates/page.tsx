...
const PAGE = "Template Gallery";
const KPIS = [{"l":"Formulários Ativos","v":"4.567","t":"+8.7%","d":"up"},{"l":"Submissões/Dia","v":"2799","t":"+12.3%","d":"up"},{"l":"Documentos Gerados","v":"1.905","t":"+10.6%","d":"up"},{"l":"Templates","v":"2.950","t":"+8.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.532","2026-02-04","146","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.836","2026-01-25","2.750","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.849","2026-02-09","6.036","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.828","2026-03-27","5.657","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.566","2026-01-16","8.882","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":536},{"label":"Mar","value":648},{"label":"Abr","value":531},{"label":"Mai","value":858},{"label":"Jun","value":701},{"label":"Jul","value":655},{"label":"Ago","value":832},{"label":"Set","value":588},{"label":"Out","value":750},{"label":"Nov","value":766},{"label":"Dez","value":526}];
const MX = 858;
