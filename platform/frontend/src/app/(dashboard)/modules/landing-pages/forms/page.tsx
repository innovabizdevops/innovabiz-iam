...
const PAGE = "Form Capture";
const KPIS = [{"l":"Formulários Ativos","v":"4.794","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"1384","t":"-3.5%","d":"down"},{"l":"Documentos Gerados","v":"313","t":"+12.3%","d":"up"},{"l":"Templates","v":"5.386","t":"-6.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.150","2026-01-07","4.977","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.075","2026-01-28","8.928","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.767","2026-03-21","3.603","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.547","2026-02-28","995","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.386","2026-01-15","828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":582},{"label":"Mar","value":392},{"label":"Abr","value":311},{"label":"Mai","value":411},{"label":"Jun","value":416},{"label":"Jul","value":510},{"label":"Ago","value":437},{"label":"Set","value":452},{"label":"Out","value":428},{"label":"Nov","value":581},{"label":"Dez","value":617}];
const MX = 617;
