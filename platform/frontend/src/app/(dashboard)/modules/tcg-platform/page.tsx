...
/* ═══ Trading Card Games — Dashboard ═══ */

const ACCENT = "#a16207";

const KPIS = [
    { label: "Total Registos", value: "6009", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1396", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€470K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "913469009", cells: ["TCG-6009", "Trading Card Games Item 1", "6/6/2026", "€19 109"], status: "active" as const },
    { id: "913472580", cells: ["TCG-9580", "Trading Card Games Item 2", "21/1/2026", "€22 680"], status: "pending" as const },
    { id: "913476151", cells: ["TCG-4151", "Trading Card Games Item 3", "8/8/2026", "€26 251"], status: "completed" as const },
    { id: "913479722", cells: ["TCG-7722", "Trading Card Games Item 4", "23/3/2026", "€29 822"], status: "warning" as const },
    { id: "913483293", cells: ["TCG-2293", "Trading Card Games Item 5", "10/10/2026", "€33 393"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trading Card Games</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Trading Card Games</p>
                    </div>
                </div>
