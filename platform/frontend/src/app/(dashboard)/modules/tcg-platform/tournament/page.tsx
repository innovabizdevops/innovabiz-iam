...
const KPIS = [{"l":"Formulários Ativos","v":"2.289","t":"+9.1%","d":"up"},{"l":"Submissões/Dia","v":"158","t":"+12.7%","d":"up"},{"l":"Documentos Gerados","v":"2.312","t":"-2.7%","d":"down"},{"l":"Templates","v":"5.083","t":"+7.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.974","2026-01-23","2.454","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.660","2026-02-11","8.152","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.444","2026-01-24","7.645","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.963","2026-01-10","2.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","461","2026-01-18","156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":730},{"label":"Mar","value":765},{"label":"Abr","value":720},{"label":"Mai","value":475},{"label":"Jun","value":781},{"label":"Jul","value":612},{"label":"Ago","value":499},{"label":"Set","value":656},{"label":"Out","value":668},{"label":"Nov","value":745},{"label":"Dez","value":508}];
const MX = 781;
