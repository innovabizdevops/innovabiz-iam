...
const PAGE = "Grade";
const KPIS = [{"l":"Formulários Ativos","v":"4.087","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"1238","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"2.389","t":"-0.3%","d":"down"},{"l":"Templates","v":"4.570","t":"+8.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.222","2026-03-22","249","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.854","2026-03-16","8.249","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.915","2026-03-03","1.181","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.986","2026-03-03","3.315","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.313","2026-03-08","5.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":268},{"label":"Mar","value":520},{"label":"Abr","value":487},{"label":"Mai","value":609},{"label":"Jun","value":391},{"label":"Jul","value":435},{"label":"Ago","value":384},{"label":"Set","value":499},{"label":"Out","value":313},{"label":"Nov","value":350},{"label":"Dez","value":585}];
const MX = 609;
