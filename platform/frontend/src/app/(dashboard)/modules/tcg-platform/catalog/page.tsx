...
const ACCENT = "#a16207";
const MODULE = "Trading Card Games";
const PAGE = "Catalog";
const KPIS = [{"l":"Formulários Ativos","v":"7.121","t":"-2.4%","d":"down"},{"l":"Submissões/Dia","v":"4650","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"3.087","t":"+8.5%","d":"up"},{"l":"Templates","v":"8.794","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.994","2026-02-28","6.812","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.872","2026-03-14","1.626","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.639","2026-03-26","8.231","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.967","2026-02-21","6.108","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","769","2026-01-23","5.981","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":549},{"label":"Mar","value":837},{"label":"Abr","value":768},{"label":"Mai","value":746},{"label":"Jun","value":687},{"label":"Jul","value":862},{"label":"Ago","value":621},{"label":"Set","value":594},{"label":"Out","value":704},{"label":"Nov","value":527},{"label":"Dez","value":678}];
const MX = 862;
