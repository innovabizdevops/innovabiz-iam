...
const PAGE = "Trade";
const KPIS = [{"l":"Formulários Ativos","v":"4.475","t":"+3.5%","d":"up"},{"l":"Submissões/Dia","v":"708","t":"-2.6%","d":"down"},{"l":"Documentos Gerados","v":"4.370","t":"+7.7%","d":"up"},{"l":"Templates","v":"925","t":"+16.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.906","2026-01-01","3.806","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.876","2026-03-07","1.966","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.043","2026-02-26","4.209","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.732","2026-02-04","1.469","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.078","2026-01-09","7.495","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":614},{"label":"Mar","value":423},{"label":"Abr","value":649},{"label":"Mai","value":621},{"label":"Jun","value":583},{"label":"Jul","value":542},{"label":"Ago","value":656},{"label":"Set","value":519},{"label":"Out","value":572},{"label":"Nov","value":366},{"label":"Dez","value":362}];
const MX = 656;
