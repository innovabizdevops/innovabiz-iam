...
const KPIS = [{"l":"Formulários Ativos","v":"7.372","t":"-1.4%","d":"down"},{"l":"Submissões/Dia","v":"3548","t":"+6.9%","d":"up"},{"l":"Documentos Gerados","v":"5.466","t":"+2.3%","d":"up"},{"l":"Templates","v":"8.555","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.873","2026-01-01","855","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.084","2026-03-15","2.279","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.425","2026-03-07","8.087","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.977","2026-02-04","6.298","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.273","2026-02-20","6.001","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":330},{"label":"Mar","value":601},{"label":"Abr","value":315},{"label":"Mai","value":240},{"label":"Jun","value":330},{"label":"Jul","value":230},{"label":"Ago","value":238},{"label":"Set","value":403},{"label":"Out","value":357},{"label":"Nov","value":234},{"label":"Dez","value":287}];
const MX = 601;
