...
const PAGE = "Cash Mgmt";
const KPIS = [{"l":"Total Corporate Banking","v":"3.453","t":"-0.8%","d":"down"},{"l":"Cash Mgmt Ativos","v":"7.989","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"70","t":"+1.4%","d":"up"}];
const COLS = ["ID","Cash Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Banking #001","Corporate Banking #002","5.374","7.001","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Banking #002","Corporate Banking #003","4.934","4.214","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Banking #003","Corporate Banking #004","7.581","1.791","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Banking #004","Corporate Banking #005","1.254","1.862","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Banking #005","Corporate Banking #001","2.806","1.744","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":377},{"label":"Mar","value":471},{"label":"Abr","value":377},{"label":"Mai","value":583},{"label":"Jun","value":396},{"label":"Jul","value":547},{"label":"Ago","value":347},{"label":"Set","value":263},{"label":"Out","value":483},{"label":"Nov","value":464},{"label":"Dez","value":437}];
const MX = 583;
