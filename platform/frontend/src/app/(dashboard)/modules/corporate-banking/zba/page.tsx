...
const ACCENT = "#78350f";
const MODULE = "Corporate Banking";
const PAGE = "ZBA";
const KPIS = [{"l":"Total Corporate Banking","v":"3.364","t":"+15.6%","d":"up"},{"l":"ZBA Ativos","v":"6.152","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"83","t":"+0.9%","d":"up"}];
const COLS = ["ID","ZBA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Banking #001","Corporate Banking #002","3.252","6.506","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Banking #002","Corporate Banking #003","1.873","6.617","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Banking #003","Corporate Banking #004","4.593","3.093","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Banking #004","Corporate Banking #005","8.934","1.637","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Banking #005","Corporate Banking #001","6.472","370","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":560},{"label":"Mar","value":533},{"label":"Abr","value":726},{"label":"Mai","value":422},{"label":"Jun","value":367},{"label":"Jul","value":487},{"label":"Ago","value":610},{"label":"Set","value":731},{"label":"Out","value":458},{"label":"Nov","value":496},{"label":"Dez","value":477}];
const MX = 731;
...
export default function ZbaPage() {
    return (
