...
/* ═══ Pulp & Paper Mill — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "905", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "359", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€369K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "212108305", cells: ["PUL-6305", "Pulp & Paper Mill Item 1", "18/2/2026", "€8405"], status: "active" as const },
    { id: "212111876", cells: ["PUL-9876", "Pulp & Paper Mill Item 2", "5/9/2026", "€11 976"], status: "pending" as const },
    { id: "212115447", cells: ["PUL-4447", "Pulp & Paper Mill Item 3", "20/4/2026", "€15 547"], status: "completed" as const },
    { id: "212119018", cells: ["PUL-8018", "Pulp & Paper Mill Item 4", "7/11/2026", "€19 118"], status: "warning" as const },
    { id: "212122589", cells: ["PUL-2589", "Pulp & Paper Mill Item 5", "22/6/2026", "€22 689"], status: "active" as const },
];
...
export default function PulpPaperMillPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pulp & Paper Mill</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pulp & Paper Mill</p>
                    </div>
                </div>
