...
const PAGE = "Chemical";
const KPIS = [{"l":"Total Pulp Paper","v":"4.491","t":"+9.9%","d":"up"},{"l":"Chemical Ativos","v":"5.833","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"66","t":"-1.8%","d":"down"}];
const COLS = ["ID","Chemical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Paper #001","Pulp Paper #002","8.509","3.099","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Paper #002","Pulp Paper #003","6.362","177","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Paper #003","Pulp Paper #004","1.795","1.386","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Paper #004","Pulp Paper #005","3.434","868","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Paper #005","Pulp Paper #001","3.609","2.967","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":607},{"label":"Mar","value":913},{"label":"Abr","value":880},{"label":"Mai","value":577},{"label":"Jun","value":775},{"label":"Jul","value":649},{"label":"Ago","value":860},{"label":"Set","value":915},{"label":"Out","value":818},{"label":"Nov","value":844},{"label":"Dez","value":777}];
const MX = 915;
