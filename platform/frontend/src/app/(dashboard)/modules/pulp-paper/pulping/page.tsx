...
const PAGE = "Pulping";
const KPIS = [{"l":"Total Pulp Paper","v":"3.290","t":"-5.3%","d":"down"},{"l":"Pulping Ativos","v":"8.591","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"61","t":"+16.0%","d":"up"}];
const COLS = ["ID","Pulping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Paper #001","Pulp Paper #002","4.695","4.468","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Paper #002","Pulp Paper #003","7.669","6.264","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Paper #003","Pulp Paper #004","295","1.987","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Paper #004","Pulp Paper #005","5.471","5.801","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Paper #005","Pulp Paper #001","8.390","277","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":772},{"label":"Mar","value":721},{"label":"Abr","value":747},{"label":"Mai","value":625},{"label":"Jun","value":906},{"label":"Jul","value":671},{"label":"Ago","value":933},{"label":"Set","value":877},{"label":"Out","value":610},{"label":"Nov","value":901},{"label":"Dez","value":866}];
const MX = 933;
