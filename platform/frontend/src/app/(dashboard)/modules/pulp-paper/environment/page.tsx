...
const KPIS = [{"l":"Total Pulp Paper","v":"5.376","t":"-5.3%","d":"down"},{"l":"Environment Ativos","v":"3.328","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+13.5%","d":"up"}];
const COLS = ["ID","Environment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Paper #001","Pulp Paper #002","8.563","7.003","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Paper #002","Pulp Paper #003","517","3.020","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Paper #003","Pulp Paper #004","8.634","1.707","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Paper #004","Pulp Paper #005","7.341","531","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Paper #005","Pulp Paper #001","2.307","6.351","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":706},{"label":"Mar","value":662},{"label":"Abr","value":700},{"label":"Mai","value":557},{"label":"Jun","value":522},{"label":"Jul","value":682},{"label":"Ago","value":557},{"label":"Set","value":545},{"label":"Out","value":569},{"label":"Nov","value":659},{"label":"Dez","value":720}];
const MX = 880;
