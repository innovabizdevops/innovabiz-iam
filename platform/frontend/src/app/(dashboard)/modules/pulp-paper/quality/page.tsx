...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.233","t":"+6.4%","d":"up"},{"l":"NC Abertas","v":"5.931","t":"+9.4%","d":"up"},{"l":"Conformidade (%)","v":"76.8%","t":"-1.8%","d":"down"},{"l":"CAPAs Pendentes","v":"5.710","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.634","80.5%","7.406","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.028","94.6%","2.952","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.698","74.7%","8.379","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.457","88.3%","8.164","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.795","76.9%","908","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":392},{"label":"Mar","value":318},{"label":"Abr","value":267},{"label":"Mai","value":633},{"label":"Jun","value":577},{"label":"Jul","value":513},{"label":"Ago","value":494},{"label":"Set","value":552},{"label":"Out","value":530},{"label":"Nov","value":560},{"label":"Dez","value":259}];
const MX = 633;
