...
const ACCENT = "#15803d";
const MODULE = "Pulp & Paper Mill";
const PAGE = "Paper Machine";
const KPIS = [{"l":"Total Pulp Paper","v":"8.369","t":"+14.3%","d":"up"},{"l":"Paper Machine Ativos","v":"3.653","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"91","t":"+16.4%","d":"up"}];
const COLS = ["ID","Paper Machine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Paper #001","Pulp Paper #002","6.727","4.418","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Paper #002","Pulp Paper #003","7.174","1.983","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Paper #003","Pulp Paper #004","6.757","3.427","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Paper #004","Pulp Paper #005","3.693","656","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Paper #005","Pulp Paper #001","2.268","6.735","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":367},{"label":"Fev","value":641},{"label":"Mar","value":343},{"label":"Abr","value":701},{"label":"Mai","value":573},{"label":"Jun","value":482},{"label":"Jul","value":667},{"label":"Ago","value":487},{"label":"Set","value":366},{"label":"Out","value":701},{"label":"Nov","value":581},{"label":"Dez","value":392}];
const MX = 701;
