...
const ACCENT = "#4338ca";
const MODULE = "DC Networking";
const PAGE = "Load Balance";
const KPIS = [{"l":"Total Dc Network","v":"6.584","t":"-0.2%","d":"down"},{"l":"Load Balance Ativos","v":"1.539","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+10.1%","d":"up"}];
const COLS = ["ID","Load Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Network #001","Dc Network #002","3.783","2.984","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Network #002","Dc Network #003","4.890","1.093","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Network #003","Dc Network #004","2.335","797","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Network #004","Dc Network #005","4.125","4.207","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Network #005","Dc Network #001","8.057","1.669","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":358},{"label":"Mar","value":674},{"label":"Abr","value":411},{"label":"Mai","value":378},{"label":"Jun","value":410},{"label":"Jul","value":481},{"label":"Ago","value":364},{"label":"Set","value":400},{"label":"Out","value":601},{"label":"Nov","value":468},{"label":"Dez","value":615}];
const MX = 674;
