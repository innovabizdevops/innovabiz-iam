...
const ACCENT = "#991b1b";
const MODULE = "S-AI Access Fabric";
const PAGE = "Context";
const KPIS = [{"l":"Total Sai Access Fabric","v":"8.691","t":"+3.5%","d":"up"},{"l":"Context Ativos","v":"650","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+12.1%","d":"up"}];
const COLS = ["ID","Context","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sai Access Fabric #001","Sai Access Fabric #002","2.481","8.523","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sai Access Fabric #002","Sai Access Fabric #003","3.926","7.395","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Sai Access Fabric #003","Sai Access Fabric #004","1.803","3.796","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Sai Access Fabric #004","Sai Access Fabric #005","3.965","2.147","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sai Access Fabric #005","Sai Access Fabric #001","7.556","7.609","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":891},{"label":"Mar","value":1000},{"label":"Abr","value":888},{"label":"Mai","value":890},{"label":"Jun","value":802},{"label":"Jul","value":998},{"label":"Ago","value":799},{"label":"Set","value":783},{"label":"Out","value":744},{"label":"Nov","value":807},{"label":"Dez","value":724}];
const MX = 1000;
