...
/* ═══ S-AI Access Fabric — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "3557", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3373", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€428K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1174430557", cells: ["SAI-3557", "S-AI Access Fabric Item 1", "14/2/2026", "€30 657"], status: "active" as const },
    { id: "1174434128", cells: ["SAI-7128", "S-AI Access Fabric Item 2", "1/9/2026", "€34 228"], status: "pending" as const },
    { id: "1174437699", cells: ["SAI-1699", "S-AI Access Fabric Item 3", "16/4/2026", "€37 799"], status: "completed" as const },
    { id: "1174441270", cells: ["SAI-5270", "S-AI Access Fabric Item 4", "3/11/2026", "€41 370"], status: "warning" as const },
    { id: "1174444841", cells: ["SAI-8841", "S-AI Access Fabric Item 5", "18/6/2026", "€44 941"], status: "active" as const },
];
...
export default function SaiAccessFabricPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Access Fabric</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Access Fabric</p>
                    </div>
                </div>
