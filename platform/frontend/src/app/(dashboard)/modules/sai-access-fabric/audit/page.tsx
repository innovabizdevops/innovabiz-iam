...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.841","t":"+6.1%","d":"up"},{"l":"NC Abertas","v":"5.847","t":"+11.7%","d":"up"},{"l":"Conformidade (%)","v":"74.1%","t":"+15.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.192","t":"-1.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.677","75.1%","3.239","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.084","80.2%","8.624","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.238","85.3%","4.562","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.520","73.8%","6.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.163","97.5%","1.145","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":540},{"label":"Mar","value":546},{"label":"Abr","value":676},{"label":"Mai","value":786},{"label":"Jun","value":817},{"label":"Jul","value":785},{"label":"Ago","value":454},{"label":"Set","value":838},{"label":"Out","value":619},{"label":"Nov","value":668},{"label":"Dez","value":800}];
const MX = 838;
