...
const KPIS = [{"l":"Total Mil Command","v":"3.598","t":"+10.7%","d":"up"},{"l":"After Action Ativos","v":"8.444","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.6%","d":"down"}];
const COLS = ["ID","After Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Command #001","Mil Command #002","6.693","6.026","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Command #002","Mil Command #003","7.403","2.143","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Command #003","Mil Command #004","846","7.093","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Command #004","Mil Command #005","8.790","6.594","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Command #005","Mil Command #001","2.416","4.944","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":768},{"label":"Mar","value":508},{"label":"Abr","value":607},{"label":"Mai","value":538},{"label":"Jun","value":694},{"label":"Jul","value":766},{"label":"Ago","value":439},{"label":"Set","value":670},{"label":"Out","value":402},{"label":"Nov","value":692},{"label":"Dez","value":743}];
const MX = 775;
