...
const PAGE = "Intel Fuse";
const KPIS = [{"l":"Total Mil Command","v":"5.961","t":"+12.2%","d":"up"},{"l":"Intel Fuse Ativos","v":"2.558","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"85","t":"+13.4%","d":"up"}];
const COLS = ["ID","Intel Fuse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Command #001","Mil Command #002","2.658","7.278","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Command #002","Mil Command #003","8.398","6.911","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Command #003","Mil Command #004","5.550","4.710","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Command #004","Mil Command #005","8.969","7.622","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Command #005","Mil Command #001","9.083","206","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":741},{"label":"Mar","value":922},{"label":"Abr","value":910},{"label":"Mai","value":886},{"label":"Jun","value":805},{"label":"Jul","value":643},{"label":"Ago","value":703},{"label":"Set","value":979},{"label":"Out","value":840},{"label":"Nov","value":859},{"label":"Dez","value":796}];
const MX = 979;
