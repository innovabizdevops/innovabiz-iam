...
const ACCENT = "#dc2626";
const MODULE = "Military Command";
const PAGE = "Blue Force";
const KPIS = [{"l":"Total Mil Command","v":"780","t":"-4.8%","d":"down"},{"l":"Blue Force Ativos","v":"5.136","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"88.5%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+0.7%","d":"up"}];
const COLS = ["ID","Blue Force","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Command #001","Mil Command #002","337","6.563","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Command #002","Mil Command #003","5.500","4.284","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Command #003","Mil Command #004","8.782","1.364","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Command #004","Mil Command #005","1.235","1.175","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Command #005","Mil Command #001","4.255","2.933","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":697},{"label":"Mar","value":375},{"label":"Abr","value":686},{"label":"Mai","value":726},{"label":"Jun","value":736},{"label":"Jul","value":650},{"label":"Ago","value":735},{"label":"Set","value":445},{"label":"Out","value":363},{"label":"Nov","value":526},{"label":"Dez","value":414}];
const MX = 736;
...
export default function BlueforcePage() {
    return (
