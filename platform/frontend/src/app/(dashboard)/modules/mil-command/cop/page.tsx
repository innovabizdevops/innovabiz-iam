...
const PAGE = "COP Display";
const KPIS = [{"l":"Total Mil Command","v":"8.191","t":"-5.8%","d":"down"},{"l":"COP Display Ativos","v":"521","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"80","t":"+3.4%","d":"up"}];
const COLS = ["ID","COP Display","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Command #001","Mil Command #002","2.133","7.824","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Command #002","Mil Command #003","8.702","7.989","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Command #003","Mil Command #004","3.648","2.425","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Command #004","Mil Command #005","8.765","4.202","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Command #005","Mil Command #001","5.777","5.972","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":447},{"label":"Mar","value":421},{"label":"Abr","value":657},{"label":"Mai","value":764},{"label":"Jun","value":600},{"label":"Jul","value":596},{"label":"Ago","value":452},{"label":"Set","value":461},{"label":"Out","value":569},{"label":"Nov","value":448},{"label":"Dez","value":785}];
const MX = 807;
