...
const KPIS = [{"l":"Total Mil Command","v":"8.528","t":"+14.8%","d":"up"},{"l":"Order Mgmt Ativos","v":"5.988","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"92","t":"-0.9%","d":"down"}];
const COLS = ["ID","Order Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mil Command #001","Mil Command #002","195","5.154","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Mil Command #002","Mil Command #003","1.629","8.659","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Mil Command #003","Mil Command #004","5.594","4.928","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mil Command #004","Mil Command #005","2.525","3.080","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mil Command #005","Mil Command #001","4.572","4.432","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":734},{"label":"Mar","value":895},{"label":"Abr","value":761},{"label":"Mai","value":818},{"label":"Jun","value":756},{"label":"Jul","value":789},{"label":"Ago","value":980},{"label":"Set","value":908},{"label":"Out","value":803},{"label":"Nov","value":953},{"label":"Dez","value":911}];
const MX = 980;
