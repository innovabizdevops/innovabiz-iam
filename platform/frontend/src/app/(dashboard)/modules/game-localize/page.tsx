...
export default function GameLocalizePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Game Localize</h1><p className="text-sm text-muted-foreground">Game Localize • iBOS Enterprise</p></div>
