...
const PAGE = "Voice Record";
const KPIS = [{"l":"Total Game Localize","v":"3.581","t":"-3.8%","d":"down"},{"l":"Voice Record Ativos","v":"8.762","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"68","t":"+12.1%","d":"up"}];
const COLS = ["ID","Voice Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Localize #001","Game Localize #002","2.929","3.336","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Game Localize #002","Game Localize #003","7.419","853","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Localize #003","Game Localize #004","8.225","8.704","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Game Localize #004","Game Localize #005","1.812","615","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Localize #005","Game Localize #001","5.546","4.428","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":787},{"label":"Mar","value":638},{"label":"Abr","value":786},{"label":"Mai","value":567},{"label":"Jun","value":674},{"label":"Jul","value":820},{"label":"Ago","value":467},{"label":"Set","value":531},{"label":"Out","value":636},{"label":"Nov","value":664},{"label":"Dez","value":492}];
const MX = 820;
