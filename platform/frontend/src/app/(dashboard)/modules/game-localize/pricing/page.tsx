...
const PAGE = "Region Price";
const KPIS = [{"l":"ARR (€M)","v":"€1.2M","t":"+11.6%","d":"up"},{"l":"MRR (€)","v":"€31975","t":"-3.2%","d":"down"},{"l":"Churn (%)","v":"91.0%","t":"+8.4%","d":"up"},{"l":"ARPU (€)","v":"€7397","t":"+0.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 14019.17","2.800","€ 12900.97","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1823.85","1.934","€ 4981.76","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7984.92","5.392","€ 26918.29","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3686.33","7.993","€ 7476.88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 38539.61","6.413","€ 9478.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":653},{"label":"Mar","value":443},{"label":"Abr","value":703},{"label":"Mai","value":523},{"label":"Jun","value":484},{"label":"Jul","value":479},{"label":"Ago","value":566},{"label":"Set","value":525},{"label":"Out","value":606},{"label":"Nov","value":810},{"label":"Dez","value":627}];
const MX = 811;
