...
const PAGE = "LQA Test";
const KPIS = [{"l":"Total Game Localize","v":"140","t":"+6.3%","d":"up"},{"l":"LQA Test Ativos","v":"7.167","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"92.4%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"85","t":"-4.9%","d":"down"}];
const COLS = ["ID","LQA Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Localize #001","Game Localize #002","7.686","7.700","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Game Localize #002","Game Localize #003","9.005","2.766","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Localize #003","Game Localize #004","1.072","3.731","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Game Localize #004","Game Localize #005","7.338","2.634","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Localize #005","Game Localize #001","789","8.511","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":950},{"label":"Fev","value":766},{"label":"Mar","value":927},{"label":"Abr","value":1023},{"label":"Mai","value":957},{"label":"Jun","value":852},{"label":"Jul","value":964},{"label":"Ago","value":694},{"label":"Set","value":764},{"label":"Out","value":884},{"label":"Nov","value":733},{"label":"Dez","value":818}];
const MX = 1023;
...
export default function LqaPage() {
    return (
