...
const ACCENT = "#dc2626";
const MODULE = "Game Localization";
const PAGE = "Cultural Adapt";
const KPIS = [{"l":"Total Game Localize","v":"7.753","t":"-2.9%","d":"down"},{"l":"Cultural Adapt Ativos","v":"5.427","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"88.9%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"79","t":"-4.2%","d":"down"}];
const COLS = ["ID","Cultural Adapt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Game Localize #001","Game Localize #002","1.600","1.857","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Game Localize #002","Game Localize #003","6.614","5.081","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Game Localize #003","Game Localize #004","106","4.957","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Game Localize #004","Game Localize #005","7.099","2.627","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Game Localize #005","Game Localize #001","3.996","8.210","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":384},{"label":"Mar","value":745},{"label":"Abr","value":541},{"label":"Mai","value":638},{"label":"Jun","value":642},{"label":"Jul","value":444},{"label":"Ago","value":634},{"label":"Set","value":736},{"label":"Out","value":550},{"label":"Nov","value":561},{"label":"Dez","value":520}];
const MX = 745;
