...
/* ═══ Agri Supply Chain — Livestock Track ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "2370", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "61", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3027", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1663571673", cells: ["AGR-3673", "Livestock Track Item 1", "2/10/2026", "€21 773"], status: "active" as const },
    { id: "1663575244", cells: ["AGR-7244", "Livestock Track Item 2", "17/5/2026", "€25 344"], status: "pending" as const },
    { id: "1663578815", cells: ["AGR-1815", "Livestock Track Item 3", "4/12/2026", "€28 915"], status: "completed" as const },
    { id: "1663582386", cells: ["AGR-5386", "Livestock Track Item 4", "19/7/2026", "€32 486"], status: "warning" as const },
    { id: "1663585957", cells: ["AGR-8957", "Livestock Track Item 5", "6/2/2026", "€36 057"], status: "active" as const },
];
...
export default function AgriSupplyChainLivestockTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Livestock Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Livestock Track</p>
                    </div>
                </div>
