...
/* ═══ Agri Supply Chain — Commodity Trade ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4274", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "455", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "358", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1393334403", cells: ["AGR-9403", "Commodity Trade Item 1", "28/4/2026", "€34 503"], status: "active" as const },
    { id: "1393337974", cells: ["AGR-3974", "Commodity Trade Item 2", "15/11/2026", "€38 074"], status: "pending" as const },
    { id: "1393341545", cells: ["AGR-7545", "Commodity Trade Item 3", "2/6/2026", "€41 645"], status: "completed" as const },
    { id: "1393345116", cells: ["AGR-2116", "Commodity Trade Item 4", "17/1/2026", "€45 216"], status: "warning" as const },
    { id: "1393348687", cells: ["AGR-5687", "Commodity Trade Item 5", "4/8/2026", "€48 787"], status: "active" as const },
];
...
export default function AgriSupplyChainCommodityTradePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commodity Trade</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Commodity Trade</p>
                    </div>
                </div>
