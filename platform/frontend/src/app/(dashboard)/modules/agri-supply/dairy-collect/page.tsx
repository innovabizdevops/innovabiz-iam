...
/* ═══ Agri Supply Chain — Dairy Collect ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4444", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "163", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1283", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1637812015", cells: ["AGR-2015", "Dairy Collect Item 1", "8/8/2026", "€12 115"], status: "active" as const },
    { id: "1637815586", cells: ["AGR-5586", "Dairy Collect Item 2", "23/3/2026", "€15 686"], status: "pending" as const },
    { id: "1637819157", cells: ["AGR-9157", "Dairy Collect Item 3", "10/10/2026", "€19 257"], status: "completed" as const },
    { id: "1637822728", cells: ["AGR-3728", "Dairy Collect Item 4", "25/5/2026", "€22 828"], status: "warning" as const },
    { id: "1637826299", cells: ["AGR-7299", "Dairy Collect Item 5", "12/12/2026", "€26 399"], status: "active" as const },
];
...
export default function AgriSupplyChainDairyCollectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dairy Collect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Dairy Collect</p>
                    </div>
                </div>
