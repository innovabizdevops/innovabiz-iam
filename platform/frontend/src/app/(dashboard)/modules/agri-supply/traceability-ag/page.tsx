...
/* ═══ Agri Supply Chain — Traceability Ag ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3017", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "375", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "485", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "292676595", cells: ["AGR-6595", "Traceability Ag Item 1", "16/4/2026", "€26 695"], status: "active" as const },
    { id: "292680166", cells: ["AGR-1166", "Traceability Ag Item 2", "3/11/2026", "€30 266"], status: "pending" as const },
    { id: "292683737", cells: ["AGR-4737", "Traceability Ag Item 3", "18/6/2026", "€33 837"], status: "completed" as const },
    { id: "292687308", cells: ["AGR-8308", "Traceability Ag Item 4", "5/1/2026", "€37 408"], status: "warning" as const },
    { id: "292690879", cells: ["AGR-2879", "Traceability Ag Item 5", "20/8/2026", "€40 979"], status: "active" as const },
];
...
export default function AgriSupplyChainTraceabilityAgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Traceability Ag</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Traceability Ag</p>
                    </div>
                </div>
