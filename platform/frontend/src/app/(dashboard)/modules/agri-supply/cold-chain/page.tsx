...
/* ═══ Agri Supply Chain — Cold Chain ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4027", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "321", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1236", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "326189773", cells: ["AGR-3773", "Cold Chain Item 1", "22/2/2026", "€39 873"], status: "active" as const },
    { id: "326193344", cells: ["AGR-7344", "Cold Chain Item 2", "9/9/2026", "€43 444"], status: "pending" as const },
    { id: "326196915", cells: ["AGR-1915", "Cold Chain Item 3", "24/4/2026", "€47 015"], status: "completed" as const },
    { id: "326200486", cells: ["AGR-5486", "Cold Chain Item 4", "11/11/2026", "€586"], status: "warning" as const },
    { id: "326204057", cells: ["AGR-9057", "Cold Chain Item 5", "26/6/2026", "€4157"], status: "active" as const },
];
...
export default function AgriSupplyChainColdChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cold Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Cold Chain</p>
                    </div>
                </div>
