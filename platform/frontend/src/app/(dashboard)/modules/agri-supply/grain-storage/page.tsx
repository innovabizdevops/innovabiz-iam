...
/* ═══ Agri Supply Chain — Grain Storage ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "1462", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "300", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "102", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1784783400", cells: ["AGR-3400", "Grain Storage Item 1", "9/1/2026", "€33 500"], status: "active" as const },
    { id: "1784786971", cells: ["AGR-6971", "Grain Storage Item 2", "24/8/2026", "€37 071"], status: "pending" as const },
    { id: "1784790542", cells: ["AGR-1542", "Grain Storage Item 3", "11/3/2026", "€40 642"], status: "completed" as const },
    { id: "1784794113", cells: ["AGR-5113", "Grain Storage Item 4", "26/10/2026", "€44 213"], status: "warning" as const },
    { id: "1784797684", cells: ["AGR-8684", "Grain Storage Item 5", "13/5/2026", "€47 784"], status: "active" as const },
];
...
export default function AgriSupplyChainGrainStoragePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grain Storage</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Grain Storage</p>
                    </div>
                </div>
