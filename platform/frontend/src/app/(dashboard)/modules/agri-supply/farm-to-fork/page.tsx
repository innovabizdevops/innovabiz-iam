...
/* ═══ Agri Supply Chain — Farm To Fork ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3567", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "63", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1617", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1914699947", cells: ["AGR-4947", "Farm To Fork Item 1", "28/12/2026", "€50 047"], status: "active" as const },
    { id: "1914703518", cells: ["AGR-8518", "Farm To Fork Item 2", "15/7/2026", "€3618"], status: "pending" as const },
    { id: "1914707089", cells: ["AGR-3089", "Farm To Fork Item 3", "2/2/2026", "€7189"], status: "completed" as const },
    { id: "1914710660", cells: ["AGR-6660", "Farm To Fork Item 4", "17/9/2026", "€10 760"], status: "warning" as const },
    { id: "1914714231", cells: ["AGR-1231", "Farm To Fork Item 5", "4/4/2026", "€14 331"], status: "active" as const },
];
...
export default function AgriSupplyChainFarmToForkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Farm To Fork</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Farm To Fork</p>
                    </div>
                </div>
