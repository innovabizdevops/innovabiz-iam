...
/* ═══ Agri Supply Chain — Cooperative Mgmt ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "3871", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "296", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3774", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "81%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "852218084", cells: ["AGR-9084", "Cooperative Mgmt Item 1", "5/9/2026", "€18 184"], status: "active" as const },
    { id: "852221655", cells: ["AGR-3655", "Cooperative Mgmt Item 2", "20/4/2026", "€21 755"], status: "pending" as const },
    { id: "852225226", cells: ["AGR-7226", "Cooperative Mgmt Item 3", "7/11/2026", "€25 326"], status: "completed" as const },
    { id: "852228797", cells: ["AGR-1797", "Cooperative Mgmt Item 4", "22/6/2026", "€28 897"], status: "warning" as const },
    { id: "852232368", cells: ["AGR-5368", "Cooperative Mgmt Item 5", "9/1/2026", "€32 468"], status: "active" as const },
];
...
export default function AgriSupplyChainCooperativeMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cooperative Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Cooperative Mgmt</p>
                    </div>
                </div>
