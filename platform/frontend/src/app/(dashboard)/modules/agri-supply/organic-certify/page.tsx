...
/* ═══ Agri Supply Chain — Organic Certify ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "4824", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "409", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1678", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "728490997", cells: ["AGR-4997", "Organic Certify Item 1", "18/2/2026", "€41 097"], status: "active" as const },
    { id: "728494568", cells: ["AGR-8568", "Organic Certify Item 2", "5/9/2026", "€44 668"], status: "pending" as const },
    { id: "728498139", cells: ["AGR-3139", "Organic Certify Item 3", "20/4/2026", "€48 239"], status: "completed" as const },
    { id: "728501710", cells: ["AGR-6710", "Organic Certify Item 4", "7/11/2026", "€1810"], status: "warning" as const },
    { id: "728505281", cells: ["AGR-1281", "Organic Certify Item 5", "22/6/2026", "€5381"], status: "active" as const },
];
...
export default function AgriSupplyChainOrganicCertifyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Organic Certify</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Organic Certify</p>
                    </div>
                </div>
