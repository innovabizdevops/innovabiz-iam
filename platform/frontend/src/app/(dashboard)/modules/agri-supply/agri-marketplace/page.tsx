...
/* ═══ Agri Supply Chain — Agri Marketplace ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total", value: "1973", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "266", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2784", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "99%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1793007542", cells: ["AGR-1542", "Agri Marketplace Item 1", "19/3/2026", "€7642"], status: "active" as const },
    { id: "1793011113", cells: ["AGR-5113", "Agri Marketplace Item 2", "6/10/2026", "€11 213"], status: "pending" as const },
    { id: "1793014684", cells: ["AGR-8684", "Agri Marketplace Item 3", "21/5/2026", "€14 784"], status: "completed" as const },
    { id: "1793018255", cells: ["AGR-3255", "Agri Marketplace Item 4", "8/12/2026", "€18 355"], status: "warning" as const },
    { id: "1793021826", cells: ["AGR-6826", "Agri Marketplace Item 5", "23/7/2026", "€21 926"], status: "active" as const },
];
...
export default function AgriSupplyChainAgriMarketplacePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Agri Marketplace</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Agri Supply Chain • Agri Marketplace</p>
                    </div>
                </div>
