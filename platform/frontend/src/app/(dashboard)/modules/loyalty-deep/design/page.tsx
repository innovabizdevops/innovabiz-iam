...
const ACCENT = "#be185d";
const MODULE = "Loyalty Program Deep";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"4.088","t":"+2.4%","d":"up"},{"l":"Submissões/Dia","v":"3394","t":"+8.2%","d":"up"},{"l":"Documentos Gerados","v":"6.367","t":"+6.5%","d":"up"},{"l":"Templates","v":"1.722","t":"+16.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.884","2026-03-09","1.376","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.426","2026-01-21","6.732","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.205","2026-02-03","4.127","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.233","2026-01-23","7.231","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.654","2026-01-13","8.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":751},{"label":"Mar","value":1054},{"label":"Abr","value":978},{"label":"Mai","value":763},{"label":"Jun","value":1030},{"label":"Jul","value":1040},{"label":"Ago","value":1002},{"label":"Set","value":695},{"label":"Out","value":681},{"label":"Nov","value":769},{"label":"Dez","value":681}];
const MX = 1054;
