...
const PAGE = "Tier";
const KPIS = [{"l":"ARR (€M)","v":"€44.7M","t":"+1.8%","d":"up"},{"l":"MRR (€)","v":"€52816","t":"-5.2%","d":"down"},{"l":"Churn (%)","v":"93.7%","t":"-3.5%","d":"down"},{"l":"ARPU (€)","v":"€93923","t":"-0.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49604.73","4.650","€ 4814.87","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 12172.62","4.398","€ 12611.35","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7412.43","7.140","€ 11194.78","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6578.29","489","€ 14755.20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14103.78","5.602","€ 23793.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":983},{"label":"Mar","value":770},{"label":"Abr","value":922},{"label":"Mai","value":732},{"label":"Jun","value":916},{"label":"Jul","value":818},{"label":"Ago","value":1036},{"label":"Set","value":735},{"label":"Out","value":800},{"label":"Nov","value":911},{"label":"Dez","value":991}];
const MX = 1036;
