...
const KPIS = [{"l":"Dashboards Ativos","v":"6.850","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"4693","t":"-0.1%","d":"down"},{"l":"Dados Processados (GB)","v":"4.253","t":"-1.9%","d":"down"},{"l":"Utilizadores Analytics","v":"5.072","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2665","2026-03-16","6.600","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1712","2026-01-01","7.712","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4531","2026-02-27","7.802","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1104","2026-01-06","689","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4636","2026-02-06","7.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":336},{"label":"Mar","value":556},{"label":"Abr","value":475},{"label":"Mai","value":408},{"label":"Jun","value":548},{"label":"Jul","value":404},{"label":"Ago","value":240},{"label":"Set","value":420},{"label":"Out","value":431},{"label":"Nov","value":389},{"label":"Dez","value":297}];
const MX = 556;
