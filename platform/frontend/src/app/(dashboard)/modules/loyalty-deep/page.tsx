...
/* ═══ Loyalty Program Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3182", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3871", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€302K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "791725882", cells: ["LOY-5882", "Loyalty Program Deep Item 1", "11/11/2026", "€25 982"], status: "active" as const },
    { id: "791729453", cells: ["LOY-9453", "Loyalty Program Deep Item 2", "26/6/2026", "€29 553"], status: "pending" as const },
    { id: "791733024", cells: ["LOY-4024", "Loyalty Program Deep Item 3", "13/1/2026", "€33 124"], status: "completed" as const },
    { id: "791736595", cells: ["LOY-7595", "Loyalty Program Deep Item 4", "28/8/2026", "€36 695"], status: "warning" as const },
    { id: "791740166", cells: ["LOY-2166", "Loyalty Program Deep Item 5", "15/3/2026", "€40 266"], status: "active" as const },
];
...
export default function LoyaltyProgramDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loyalty Program Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Loyalty Program Deep</p>
                    </div>
                </div>
