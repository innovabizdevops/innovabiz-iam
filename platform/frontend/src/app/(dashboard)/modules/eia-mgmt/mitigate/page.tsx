...
const PAGE = "Mitigate";
const KPIS = [{"l":"Total Eia Mgmt","v":"8.993","t":"+17.1%","d":"up"},{"l":"Mitigate Ativos","v":"8.386","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"67.3%","t":"+16.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+18.0%","d":"up"}];
const COLS = ["ID","Mitigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Eia Mgmt #001","Eia Mgmt #002","5.396","3.784","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Eia Mgmt #002","Eia Mgmt #003","5.969","1.271","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Eia Mgmt #003","Eia Mgmt #004","1.559","4.547","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Eia Mgmt #004","Eia Mgmt #005","3.232","1.820","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Eia Mgmt #005","Eia Mgmt #001","150","985","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":566},{"label":"Mar","value":600},{"label":"Abr","value":684},{"label":"Mai","value":953},{"label":"Jun","value":648},{"label":"Jul","value":864},{"label":"Ago","value":821},{"label":"Set","value":808},{"label":"Out","value":571},{"label":"Nov","value":893},{"label":"Dez","value":902}];
const MX = 953;
