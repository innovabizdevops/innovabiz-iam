...
const PAGE = "Baseline";
const KPIS = [{"l":"Total Eia Mgmt","v":"5.067","t":"+5.3%","d":"up"},{"l":"Baseline Ativos","v":"1.253","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+13.1%","d":"up"}];
const COLS = ["ID","Baseline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Eia Mgmt #001","Eia Mgmt #002","5.112","3.103","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Eia Mgmt #002","Eia Mgmt #003","1.261","7.399","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Eia Mgmt #003","Eia Mgmt #004","2.104","3.114","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Eia Mgmt #004","Eia Mgmt #005","6.068","7.527","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Eia Mgmt #005","Eia Mgmt #001","4.125","5.697","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":815},{"label":"Fev","value":715},{"label":"Mar","value":697},{"label":"Abr","value":821},{"label":"Mai","value":833},{"label":"Jun","value":711},{"label":"Jul","value":584},{"label":"Ago","value":646},{"label":"Set","value":660},{"label":"Out","value":677},{"label":"Nov","value":852},{"label":"Dez","value":767}];
const MX = 852;
