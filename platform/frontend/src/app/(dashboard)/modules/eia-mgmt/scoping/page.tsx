...
const PAGE = "Scoping";
const KPIS = [{"l":"Total Eia Mgmt","v":"1.200","t":"+12.8%","d":"up"},{"l":"Scoping Ativos","v":"2.609","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.5%","d":"up"}];
const COLS = ["ID","Scoping","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Eia Mgmt #001","Eia Mgmt #002","1.882","6.491","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Eia Mgmt #002","Eia Mgmt #003","3.059","2.541","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Eia Mgmt #003","Eia Mgmt #004","1.323","7.716","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Eia Mgmt #004","Eia Mgmt #005","5.325","1.408","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Eia Mgmt #005","Eia Mgmt #001","4.711","2.256","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":697},{"label":"Mar","value":640},{"label":"Abr","value":664},{"label":"Mai","value":636},{"label":"Jun","value":459},{"label":"Jul","value":452},{"label":"Ago","value":486},{"label":"Set","value":580},{"label":"Out","value":448},{"label":"Nov","value":595},{"label":"Dez","value":614}];
const MX = 697;
