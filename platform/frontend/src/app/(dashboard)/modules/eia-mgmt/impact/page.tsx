...
const ACCENT = "#6366f1";
const MODULE = "EIA Management";
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"3.904","t":"+0.8%","d":"up"},{"l":"Beneficiários","v":"3.613","t":"-0.7%","d":"down"},{"l":"Investimento CSR (€)","v":"€14213","t":"+13.7%","d":"up"},{"l":"Score Impacto","v":"60","t":"+0.9%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.733","€ 46193.94","300","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.805","€ 36652.36","6.472","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.206","€ 11512.01","1.987","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.866","€ 45988.08","1.659","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.031","€ 19586.52","3.992","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":764},{"label":"Mar","value":793},{"label":"Abr","value":729},{"label":"Mai","value":615},{"label":"Jun","value":619},{"label":"Jul","value":902},{"label":"Ago","value":613},{"label":"Set","value":660},{"label":"Out","value":684},{"label":"Nov","value":652},{"label":"Dez","value":697}];
const MX = 902;
