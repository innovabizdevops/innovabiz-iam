...
const PAGE = "Report";
const KPIS = [{"l":"Total Eia Mgmt","v":"6.195","t":"+12.1%","d":"up"},{"l":"Report Ativos","v":"5.821","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"81","t":"+14.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Eia Mgmt #001","Eia Mgmt #002","6.983","6.883","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Eia Mgmt #002","Eia Mgmt #003","2.094","916","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Eia Mgmt #003","Eia Mgmt #004","3.090","2.609","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Eia Mgmt #004","Eia Mgmt #005","396","5.074","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Eia Mgmt #005","Eia Mgmt #001","5.595","7.935","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":677},{"label":"Mar","value":757},{"label":"Abr","value":1048},{"label":"Mai","value":877},{"label":"Jun","value":936},{"label":"Jul","value":705},{"label":"Ago","value":718},{"label":"Set","value":703},{"label":"Out","value":763},{"label":"Nov","value":844},{"label":"Dez","value":770}];
const MX = 1048;
