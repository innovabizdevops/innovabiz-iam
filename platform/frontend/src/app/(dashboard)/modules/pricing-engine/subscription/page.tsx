...
const PAGE = "Subscription Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€50.1M","t":"+6.4%","d":"up"},{"l":"MRR (€)","v":"€65310","t":"-3.4%","d":"down"},{"l":"Churn (%)","v":"89.1%","t":"+16.0%","d":"up"},{"l":"ARPU (€)","v":"€41658","t":"+16.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 22983.96","2.527","€ 32931.62","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5580.27","1.428","€ 6786.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17268.48","7.375","€ 22477.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 39087.56","6.046","€ 42795.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45513.63","4.940","€ 33742.45","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":354},{"label":"Mar","value":546},{"label":"Abr","value":634},{"label":"Mai","value":651},{"label":"Jun","value":518},{"label":"Jul","value":605},{"label":"Ago","value":345},{"label":"Set","value":377},{"label":"Out","value":438},{"label":"Nov","value":329},{"label":"Dez","value":390}];
const MX = 651;
