...
const PAGE = "Geo-Pricing Rules";
const KPIS = [{"l":"ARR (€M)","v":"€4.6M","t":"-4.3%","d":"down"},{"l":"MRR (€)","v":"€64697","t":"+16.3%","d":"up"},{"l":"Churn (%)","v":"70.3%","t":"+14.6%","d":"up"},{"l":"ARPU (€)","v":"€80236","t":"-1.2%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 7081.10","1.449","€ 25548.12","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13127.70","5.993","€ 49917.25","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46659.32","1.037","€ 11773.59","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 8859.10","4.036","€ 40579.55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31736.04","6.065","€ 9298.30","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":948},{"label":"Fev","value":749},{"label":"Mar","value":888},{"label":"Abr","value":713},{"label":"Mai","value":756},{"label":"Jun","value":902},{"label":"Jul","value":770},{"label":"Ago","value":822},{"label":"Set","value":654},{"label":"Out","value":924},{"label":"Nov","value":877},{"label":"Dez","value":1011}];
const MX = 1011;
