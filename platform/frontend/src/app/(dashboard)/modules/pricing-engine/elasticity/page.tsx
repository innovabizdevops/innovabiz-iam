...
const PAGE = "Elasticity Analysis AI";
const KPIS = [{"l":"ARR (€M)","v":"€9.3M","t":"-3.0%","d":"down"},{"l":"MRR (€)","v":"€80268","t":"-5.8%","d":"down"},{"l":"Churn (%)","v":"70.7%","t":"+11.4%","d":"up"},{"l":"ARPU (€)","v":"€76130","t":"+3.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15828.93","466","€ 13996.35","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 1439.70","6.926","€ 23853.18","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40729.38","6.768","€ 32016.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15303.88","2.938","€ 37500.33","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29450.06","5.923","€ 43830.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":967},{"label":"Fev","value":749},{"label":"Mar","value":877},{"label":"Abr","value":824},{"label":"Mai","value":700},{"label":"Jun","value":682},{"label":"Jul","value":813},{"label":"Ago","value":648},{"label":"Set","value":891},{"label":"Out","value":902},{"label":"Nov","value":698},{"label":"Dez","value":901}];
const MX = 967;
