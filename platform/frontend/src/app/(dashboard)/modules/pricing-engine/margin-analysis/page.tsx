...
const PAGE = "Margin Analysis";
const KPIS = [{"l":"ARR (€M)","v":"€13.2M","t":"-5.0%","d":"down"},{"l":"MRR (€)","v":"€65617","t":"-6.0%","d":"down"},{"l":"Churn (%)","v":"84.0%","t":"-5.4%","d":"down"},{"l":"ARPU (€)","v":"€66267","t":"+10.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32971.01","8.781","€ 18010.60","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38161.09","425","€ 48639.01","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25336.11","4.892","€ 39928.00","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43642.81","223","€ 19429.45","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49742.95","8.985","€ 21766.43","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":827},{"label":"Mar","value":638},{"label":"Abr","value":508},{"label":"Mai","value":710},{"label":"Jun","value":838},{"label":"Jul","value":731},{"label":"Ago","value":667},{"label":"Set","value":566},{"label":"Out","value":627},{"label":"Nov","value":584},{"label":"Dez","value":652}];
const MX = 838;
