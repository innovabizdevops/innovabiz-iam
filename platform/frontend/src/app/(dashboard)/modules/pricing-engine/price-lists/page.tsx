...
const PAGE = "Price Lists";
const KPIS = [{"l":"ARR (€M)","v":"€26.2M","t":"+14.3%","d":"up"},{"l":"MRR (€)","v":"€72808","t":"+15.7%","d":"up"},{"l":"Churn (%)","v":"89.5%","t":"+15.2%","d":"up"},{"l":"ARPU (€)","v":"€66203","t":"+0.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 35239.83","1.430","€ 20279.34","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33306.66","2.702","€ 10743.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 46596.81","6.424","€ 36151.99","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5201.44","3.811","€ 29716.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13110.13","8.326","€ 32523.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":554},{"label":"Mar","value":501},{"label":"Abr","value":660},{"label":"Mai","value":836},{"label":"Jun","value":668},{"label":"Jul","value":869},{"label":"Ago","value":613},{"label":"Set","value":777},{"label":"Out","value":525},{"label":"Nov","value":719},{"label":"Dez","value":640}];
const MX = 869;
