...
const PAGE = "Bundle Pricing";
const KPIS = [{"l":"ARR (€M)","v":"€24.8M","t":"+15.7%","d":"up"},{"l":"MRR (€)","v":"€70582","t":"+0.7%","d":"up"},{"l":"Churn (%)","v":"81.3%","t":"+15.2%","d":"up"},{"l":"ARPU (€)","v":"€38731","t":"+0.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 36470.85","5.590","€ 46539.92","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41245.16","6.468","€ 35232.33","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30570.75","4.391","€ 5697.75","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1032.58","1.587","€ 14010.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 42871.84","5.394","€ 9860.88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":352},{"label":"Mar","value":659},{"label":"Abr","value":331},{"label":"Mai","value":572},{"label":"Jun","value":518},{"label":"Jul","value":351},{"label":"Ago","value":298},{"label":"Set","value":532},{"label":"Out","value":279},{"label":"Nov","value":273},{"label":"Dez","value":508}];
const MX = 659;
