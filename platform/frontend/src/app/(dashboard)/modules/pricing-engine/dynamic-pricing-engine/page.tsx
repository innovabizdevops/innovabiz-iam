...
const KPIS = [{"l":"ARR (€M)","v":"€2.6M","t":"+7.2%","d":"up"},{"l":"MRR (€)","v":"€94561","t":"+16.4%","d":"up"},{"l":"Churn (%)","v":"94.7%","t":"+13.6%","d":"up"},{"l":"ARPU (€)","v":"€46350","t":"+9.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28767.44","194","€ 5678.84","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44933.79","3.146","€ 28063.45","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2771.58","1.205","€ 44706.35","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 29069.11","7.021","€ 32523.25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 19128.85","5.420","€ 17894.01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":771},{"label":"Mar","value":679},{"label":"Abr","value":556},{"label":"Mai","value":403},{"label":"Jun","value":488},{"label":"Jul","value":760},{"label":"Ago","value":721},{"label":"Set","value":768},{"label":"Out","value":614},{"label":"Nov","value":590},{"label":"Dez","value":467}];
const MX = 771;
