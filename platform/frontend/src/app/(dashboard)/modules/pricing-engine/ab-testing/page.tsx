...
const PAGE = "A/B Price Testing";
const KPIS = [{"l":"ARR (€M)","v":"€2.6M","t":"+6.0%","d":"up"},{"l":"MRR (€)","v":"€18559","t":"+11.8%","d":"up"},{"l":"Churn (%)","v":"73.3%","t":"+0.1%","d":"up"},{"l":"ARPU (€)","v":"€32478","t":"+0.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 47015.76","3.437","€ 7306.69","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7086.69","8.584","€ 12885.48","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 22834.82","8.570","€ 2175.22","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46746.24","2.270","€ 31529.96","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 50002.45","2.110","€ 21489.20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":282},{"label":"Mar","value":390},{"label":"Abr","value":295},{"label":"Mai","value":319},{"label":"Jun","value":208},{"label":"Jul","value":371},{"label":"Ago","value":563},{"label":"Set","value":382},{"label":"Out","value":258},{"label":"Nov","value":339},{"label":"Dez","value":229}];
const MX = 563;
