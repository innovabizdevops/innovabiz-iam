...
const ACCENT = "#e11d48";
const MODULE = "Pricing & Revenue Mgmt";
const PAGE = "Dynamic Pricing AI";
const KPIS = [{"l":"ARR (€M)","v":"€24.9M","t":"+11.7%","d":"up"},{"l":"MRR (€)","v":"€12071","t":"-2.4%","d":"down"},{"l":"Churn (%)","v":"73.6%","t":"-0.3%","d":"down"},{"l":"ARPU (€)","v":"€22884","t":"+12.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 39383.48","4.621","€ 39106.31","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24907.75","9.058","€ 28483.94","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27160.62","6.834","€ 35468.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 31826.26","7.095","€ 28874.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3123.34","1.754","€ 36711.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":815},{"label":"Mar","value":1014},{"label":"Abr","value":1003},{"label":"Mai","value":743},{"label":"Jun","value":848},{"label":"Jul","value":1050},{"label":"Ago","value":1018},{"label":"Set","value":776},{"label":"Out","value":962},{"label":"Nov","value":848},{"label":"Dez","value":898}];
const MX = 1050;
