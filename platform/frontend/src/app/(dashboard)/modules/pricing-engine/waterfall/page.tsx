...
const PAGE = "Price Waterfall";
const KPIS = [{"l":"ARR (€M)","v":"€28.8M","t":"+11.1%","d":"up"},{"l":"MRR (€)","v":"€89468","t":"-5.7%","d":"down"},{"l":"Churn (%)","v":"68.0%","t":"+14.6%","d":"up"},{"l":"ARPU (€)","v":"€33631","t":"+7.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 46570.64","1.536","€ 48380.65","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 6400.39","4.035","€ 48868.20","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44349.36","8.863","€ 38593.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 21996.14","1.239","€ 47923.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31912.16","3.887","€ 14010.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":698},{"label":"Mar","value":478},{"label":"Abr","value":595},{"label":"Mai","value":713},{"label":"Jun","value":471},{"label":"Jul","value":513},{"label":"Ago","value":779},{"label":"Set","value":692},{"label":"Out","value":488},{"label":"Nov","value":631},{"label":"Dez","value":722}];
const MX = 799;
