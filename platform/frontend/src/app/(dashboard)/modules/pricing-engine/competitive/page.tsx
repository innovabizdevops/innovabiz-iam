...
const KPIS = [{"l":"ARR (€M)","v":"€41.1M","t":"+16.7%","d":"up"},{"l":"MRR (€)","v":"€35088","t":"+9.4%","d":"up"},{"l":"Churn (%)","v":"76.7%","t":"+16.8%","d":"up"},{"l":"ARPU (€)","v":"€69216","t":"+8.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 33413.92","2.766","€ 47481.44","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8803.24","5.150","€ 3604.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9655.40","4.328","€ 20625.81","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16244.90","8.485","€ 3072.97","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 21807.58","7.188","€ 41880.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":911},{"label":"Mar","value":773},{"label":"Abr","value":909},{"label":"Mai","value":687},{"label":"Jun","value":707},{"label":"Jul","value":1065},{"label":"Ago","value":963},{"label":"Set","value":984},{"label":"Out","value":720},{"label":"Nov","value":759},{"label":"Dez","value":718}];
const MX = 1065;
