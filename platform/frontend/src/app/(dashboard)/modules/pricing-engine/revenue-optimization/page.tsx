...
const KPIS = [{"l":"ARR (€M)","v":"€46.8M","t":"-1.8%","d":"down"},{"l":"MRR (€)","v":"€91987","t":"+13.0%","d":"up"},{"l":"Churn (%)","v":"76.0%","t":"-1.9%","d":"down"},{"l":"ARPU (€)","v":"€30547","t":"-0.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 36731.36","6.195","€ 20534.87","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 14366.27","1.235","€ 353.38","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 18938.71","2.369","€ 31187.78","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 464.25","7.223","€ 23864.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 11595.83","4.808","€ 13645.83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":703},{"label":"Mar","value":486},{"label":"Abr","value":493},{"label":"Mai","value":524},{"label":"Jun","value":628},{"label":"Jul","value":615},{"label":"Ago","value":477},{"label":"Set","value":733},{"label":"Out","value":759},{"label":"Nov","value":592},{"label":"Dez","value":604}];
const MX = 759;
