...
const PAGE = "Discount Rules";
const KPIS = [{"l":"ARR (€M)","v":"€30.0M","t":"+6.9%","d":"up"},{"l":"MRR (€)","v":"€92575","t":"+4.1%","d":"up"},{"l":"Churn (%)","v":"87.9%","t":"+10.5%","d":"up"},{"l":"ARPU (€)","v":"€39967","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30690.36","7.049","€ 4942.51","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 19595.76","3.911","€ 16159.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 47958.65","3.760","€ 22721.47","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3986.44","1.208","€ 31389.64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31475.35","8.977","€ 19234.75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":485},{"label":"Mar","value":605},{"label":"Abr","value":742},{"label":"Mai","value":633},{"label":"Jun","value":754},{"label":"Jul","value":621},{"label":"Ago","value":518},{"label":"Set","value":663},{"label":"Out","value":571},{"label":"Nov","value":670},{"label":"Dez","value":626}];
const MX = 754;
