...
const PAGE = "AI Price Elasticity";
const KPIS = [{"l":"ARR (€M)","v":"€11.0M","t":"+2.6%","d":"up"},{"l":"MRR (€)","v":"€63953","t":"+8.3%","d":"up"},{"l":"Churn (%)","v":"85.8%","t":"+9.9%","d":"up"},{"l":"ARPU (€)","v":"€68394","t":"+7.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30087.65","2.177","€ 40455.94","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41873.30","3.574","€ 16931.02","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 29327.94","4.336","€ 38644.44","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2009.55","7.298","€ 12336.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4148.45","176","€ 21343.83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":873},{"label":"Fev","value":729},{"label":"Mar","value":875},{"label":"Abr","value":758},{"label":"Mai","value":654},{"label":"Jun","value":621},{"label":"Jul","value":721},{"label":"Ago","value":643},{"label":"Set","value":839},{"label":"Out","value":610},{"label":"Nov","value":644},{"label":"Dez","value":847}];
const MX = 875;
...
export default function ElasticityPricingEnginePage() {
    return (
