...
const PAGE = "Competitor Pricing AI";
const KPIS = [{"l":"ARR (€M)","v":"€5.1M","t":"+9.1%","d":"up"},{"l":"MRR (€)","v":"€65852","t":"-3.1%","d":"down"},{"l":"Churn (%)","v":"81.5%","t":"+17.0%","d":"up"},{"l":"ARPU (€)","v":"€62912","t":"-5.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24055.41","4.428","€ 46298.68","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33700.05","668","€ 38035.14","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 39971.44","8.106","€ 11770.43","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 36876.44","2.097","€ 47123.29","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 103.07","6.938","€ 22390.50","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1091},{"label":"Fev","value":845},{"label":"Mar","value":1082},{"label":"Abr","value":988},{"label":"Mai","value":797},{"label":"Jun","value":883},{"label":"Jul","value":839},{"label":"Ago","value":955},{"label":"Set","value":747},{"label":"Out","value":719},{"label":"Nov","value":936},{"label":"Dez","value":834}];
const MX = 1091;
