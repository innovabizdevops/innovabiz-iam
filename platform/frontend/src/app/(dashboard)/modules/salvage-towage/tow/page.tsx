...
const PAGE = "Tow Plan";
const KPIS = [{"l":"Total Salvage Towage","v":"7.684","t":"+8.7%","d":"up"},{"l":"Tow Plan Ativos","v":"6.600","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"92","t":"-1.9%","d":"down"}];
const COLS = ["ID","Tow Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Towage #001","Salvage Towage #002","8.887","268","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Towage #002","Salvage Towage #003","7.211","1.447","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Towage #003","Salvage Towage #004","7.701","6.657","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Towage #004","Salvage Towage #005","6.162","4.335","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Towage #005","Salvage Towage #001","8.432","920","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":482},{"label":"Mar","value":448},{"label":"Abr","value":575},{"label":"Mai","value":487},{"label":"Jun","value":450},{"label":"Jul","value":269},{"label":"Ago","value":634},{"label":"Set","value":328},{"label":"Out","value":347},{"label":"Nov","value":629},{"label":"Dez","value":438}];
const MX = 634;
