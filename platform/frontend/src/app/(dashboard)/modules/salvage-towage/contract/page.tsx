...
const PAGE = "Salvage Contract";
const KPIS = [{"l":"Contratos Ativos","v":"7.434","t":"+15.6%","d":"up"},{"l":"Valor Total (€M)","v":"€17.0M","t":"+-0.0%","d":"up"},{"l":"Renovações Próx. 30d","v":"2.596","t":"+4.6%","d":"up"},{"l":"Obrigações Pendentes","v":"894","t":"+2.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 5098.60","2026-03-09","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 30066.07","2026-01-18","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 30757.46","2026-02-19","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 20106.31","2026-02-23","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 47833.11","2026-01-28","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":1001},{"label":"Mar","value":936},{"label":"Abr","value":629},{"label":"Mai","value":685},{"label":"Jun","value":1009},{"label":"Jul","value":673},{"label":"Ago","value":980},{"label":"Set","value":919},{"label":"Out","value":832},{"label":"Nov","value":718},{"label":"Dez","value":757}];
const MX = 1009;
