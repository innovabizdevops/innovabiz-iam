...
export default function SalvageTowagePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Salvage Towage</h1><p className="text-sm text-muted-foreground">Salvage Towage • iBOS Enterprise</p></div>
