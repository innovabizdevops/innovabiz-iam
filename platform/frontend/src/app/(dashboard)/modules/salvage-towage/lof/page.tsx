...
const PAGE = "LOF Agreement";
const KPIS = [{"l":"Total Salvage Towage","v":"2.038","t":"+4.0%","d":"up"},{"l":"LOF Agreement Ativos","v":"6.316","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"69","t":"+0.5%","d":"up"}];
const COLS = ["ID","LOF Agreement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Towage #001","Salvage Towage #002","5.485","1.419","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Towage #002","Salvage Towage #003","2.143","5.629","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Towage #003","Salvage Towage #004","7.223","4.741","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Towage #004","Salvage Towage #005","9.027","5.975","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Towage #005","Salvage Towage #001","1.915","3.499","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":716},{"label":"Fev","value":838},{"label":"Mar","value":634},{"label":"Abr","value":602},{"label":"Mai","value":721},{"label":"Jun","value":751},{"label":"Jul","value":919},{"label":"Ago","value":741},{"label":"Set","value":926},{"label":"Out","value":907},{"label":"Nov","value":632},{"label":"Dez","value":692}];
const MX = 926;
...
export default function LofPage() {
    return (
