...
const ACCENT = "#dc2626";
const MODULE = "Salvage & Towage";
const PAGE = "Environ Protect";
const KPIS = [{"l":"Total Salvage Towage","v":"3.757","t":"+10.7%","d":"up"},{"l":"Environ Protect Ativos","v":"6.455","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"93","t":"+17.5%","d":"up"}];
const COLS = ["ID","Environ Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Towage #001","Salvage Towage #002","3.089","8.428","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Towage #002","Salvage Towage #003","3.182","8.918","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Towage #003","Salvage Towage #004","5.627","8.867","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Towage #004","Salvage Towage #005","7.176","4.623","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Towage #005","Salvage Towage #001","920","356","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":545},{"label":"Mar","value":512},{"label":"Abr","value":642},{"label":"Mai","value":509},{"label":"Jun","value":607},{"label":"Jul","value":534},{"label":"Ago","value":472},{"label":"Set","value":615},{"label":"Out","value":529},{"label":"Nov","value":452},{"label":"Dez","value":737}];
const MX = 760;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#dc2626'}}>ESG</span></h1>
                </div>
