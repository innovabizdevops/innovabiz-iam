...
const PAGE = "Wreck Removal";
const KPIS = [{"l":"Total Salvage Towage","v":"7.012","t":"+14.3%","d":"up"},{"l":"Wreck Removal Ativos","v":"8.779","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+6.6%","d":"up"}];
const COLS = ["ID","Wreck Removal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salvage Towage #001","Salvage Towage #002","5.640","2.442","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Salvage Towage #002","Salvage Towage #003","2.524","2.304","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Salvage Towage #003","Salvage Towage #004","5.283","9.034","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Salvage Towage #004","Salvage Towage #005","5.188","7.090","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salvage Towage #005","Salvage Towage #001","8.065","4.003","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":590},{"label":"Mar","value":336},{"label":"Abr","value":299},{"label":"Mai","value":636},{"label":"Jun","value":307},{"label":"Jul","value":423},{"label":"Ago","value":436},{"label":"Set","value":271},{"label":"Out","value":402},{"label":"Nov","value":585},{"label":"Dez","value":581}];
const MX = 636;
...
export default function WreckPage() {
    return (
