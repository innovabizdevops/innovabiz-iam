...
const ACCENT = "#6366f1";
const MODULE = "SIP & VoIP";
const PAGE = "Trunk";
const KPIS = [{"l":"Total Sip Voip","v":"6.692","t":"+3.1%","d":"up"},{"l":"Trunk Ativos","v":"1.465","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"89","t":"-4.8%","d":"down"}];
const COLS = ["ID","Trunk","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sip Voip #001","Sip Voip #002","284","7.849","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Sip Voip #002","Sip Voip #003","389","2.106","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Sip Voip #003","Sip Voip #004","8.363","4.989","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sip Voip #004","Sip Voip #005","2.844","294","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sip Voip #005","Sip Voip #001","2.766","6.238","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":692},{"label":"Mar","value":671},{"label":"Abr","value":862},{"label":"Mai","value":624},{"label":"Jun","value":808},{"label":"Jul","value":888},{"label":"Ago","value":882},{"label":"Set","value":875},{"label":"Out","value":623},{"label":"Nov","value":604},{"label":"Dez","value":669}];
const MX = 888;
