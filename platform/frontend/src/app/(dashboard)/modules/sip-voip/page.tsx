...
export default function SipVoipPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sip Voip</h1><p className="text-sm text-muted-foreground">Sip Voip • iBOS Enterprise</p></div>
