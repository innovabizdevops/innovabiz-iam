...
const PAGE = "UC";
const KPIS = [{"l":"Total Sip Voip","v":"1.568","t":"-2.9%","d":"down"},{"l":"UC Ativos","v":"1.172","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"58","t":"-0.8%","d":"down"}];
const COLS = ["ID","UC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sip Voip #001","Sip Voip #002","884","6.961","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Sip Voip #002","Sip Voip #003","4.148","8.697","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Sip Voip #003","Sip Voip #004","2.501","1.879","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Sip Voip #004","Sip Voip #005","1.496","5.552","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sip Voip #005","Sip Voip #001","6.044","7.392","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":531},{"label":"Mar","value":387},{"label":"Abr","value":689},{"label":"Mai","value":561},{"label":"Jun","value":433},{"label":"Jul","value":444},{"label":"Ago","value":369},{"label":"Set","value":696},{"label":"Out","value":490},{"label":"Nov","value":730},{"label":"Dez","value":693}];
const MX = 730;
