...
const PAGE = "IVR";
const KPIS = [{"l":"Total Sip Voip","v":"2.509","t":"+4.9%","d":"up"},{"l":"IVR Ativos","v":"2.662","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"94","t":"+10.8%","d":"up"}];
const COLS = ["ID","IVR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sip Voip #001","Sip Voip #002","7.067","4.413","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sip Voip #002","Sip Voip #003","1.962","4.735","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Sip Voip #003","Sip Voip #004","1.418","287","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Sip Voip #004","Sip Voip #005","4.524","7.078","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sip Voip #005","Sip Voip #001","4.725","9.008","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":605},{"label":"Mar","value":375},{"label":"Abr","value":345},{"label":"Mai","value":492},{"label":"Jun","value":554},{"label":"Jul","value":405},{"label":"Ago","value":412},{"label":"Set","value":344},{"label":"Out","value":416},{"label":"Nov","value":466},{"label":"Dez","value":468}];
const MX = 691;
