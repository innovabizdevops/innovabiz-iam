...
const PAGE = "PBX";
const KPIS = [{"l":"Total Sip Voip","v":"4.676","t":"+15.0%","d":"up"},{"l":"PBX Ativos","v":"4.954","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"74","t":"+17.4%","d":"up"}];
const COLS = ["ID","PBX","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sip Voip #001","Sip Voip #002","4.002","6.682","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Sip Voip #002","Sip Voip #003","7.888","2.543","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Sip Voip #003","Sip Voip #004","800","8.213","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Sip Voip #004","Sip Voip #005","2.878","2.933","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sip Voip #005","Sip Voip #001","2.218","507","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":544},{"label":"Mar","value":464},{"label":"Abr","value":304},{"label":"Mai","value":386},{"label":"Jun","value":655},{"label":"Jul","value":371},{"label":"Ago","value":341},{"label":"Set","value":640},{"label":"Out","value":532},{"label":"Nov","value":367},{"label":"Dez","value":361}];
const MX = 673;
