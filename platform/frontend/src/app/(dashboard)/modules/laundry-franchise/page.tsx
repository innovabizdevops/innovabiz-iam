...
/* ═══ Laundry Franchise — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "8496", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2450", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€164K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "847685996", cells: ["LAU-3996", "Laundry Franchise Item 1", "25/9/2026", "€36 096"], status: "active" as const },
    { id: "847689567", cells: ["LAU-7567", "Laundry Franchise Item 2", "12/4/2026", "€39 667"], status: "pending" as const },
    { id: "847693138", cells: ["LAU-2138", "Laundry Franchise Item 3", "27/11/2026", "€43 238"], status: "completed" as const },
    { id: "847696709", cells: ["LAU-5709", "Laundry Franchise Item 4", "14/6/2026", "€46 809"], status: "warning" as const },
    { id: "847700280", cells: ["LAU-9280", "Laundry Franchise Item 5", "1/1/2026", "€380"], status: "active" as const },
];
...
export default function LaundryFranchisePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laundry Franchise</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laundry Franchise</p>
                    </div>
                </div>
