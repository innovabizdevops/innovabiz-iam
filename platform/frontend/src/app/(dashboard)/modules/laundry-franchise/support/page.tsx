...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"7.738","t":"+8.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.9%","t":"+10.9%","d":"up"},{"l":"MTTR (h)","v":"116h","t":"+8.1%","d":"up"},{"l":"Satisfação (%)","v":"87.7%","t":"+18.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.288","7.250","5.931","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.424","6.380","1.765","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","223","8.287","5.845","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.262","1.648","246","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.338","1.015","2.789","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":768},{"label":"Mar","value":680},{"label":"Abr","value":717},{"label":"Mai","value":640},{"label":"Jun","value":767},{"label":"Jul","value":1023},{"label":"Ago","value":813},{"label":"Set","value":747},{"label":"Out","value":932},{"label":"Nov","value":992},{"label":"Dez","value":701}];
const MX = 1023;
