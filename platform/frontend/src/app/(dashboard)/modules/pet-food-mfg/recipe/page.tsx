...
const PAGE = "Recipe";
const KPIS = [{"l":"Total Pet Food Mfg","v":"2.734","t":"+0.6%","d":"up"},{"l":"Recipe Ativos","v":"5.069","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+17.2%","d":"up"}];
const COLS = ["ID","Recipe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Food Mfg #001","Pet Food Mfg #002","7.638","2.111","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Food Mfg #002","Pet Food Mfg #003","8.270","3.081","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Food Mfg #003","Pet Food Mfg #004","5.808","1.133","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Food Mfg #004","Pet Food Mfg #005","1.040","6.641","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Food Mfg #005","Pet Food Mfg #001","339","2.828","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":599},{"label":"Mar","value":531},{"label":"Abr","value":570},{"label":"Mai","value":583},{"label":"Jun","value":793},{"label":"Jul","value":533},{"label":"Ago","value":534},{"label":"Set","value":776},{"label":"Out","value":658},{"label":"Nov","value":721},{"label":"Dez","value":478}];
const MX = 793;
