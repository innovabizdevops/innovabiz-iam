...
/* ═══ Pet Food Manufacturing — Dashboard ═══ */

const ACCENT = "#f97316";

const KPIS = [
    { label: "Total Registos", value: "464", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2207", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€253K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2024352364", cells: ["PET-1364", "Pet Food Manufacturing Item 1", "21/5/2026", "€2464"], status: "active" as const },
    { id: "2024355935", cells: ["PET-4935", "Pet Food Manufacturing Item 2", "8/12/2026", "€6035"], status: "pending" as const },
    { id: "2024359506", cells: ["PET-8506", "Pet Food Manufacturing Item 3", "23/7/2026", "€9606"], status: "completed" as const },
    { id: "2024363077", cells: ["PET-3077", "Pet Food Manufacturing Item 4", "10/2/2026", "€13 177"], status: "warning" as const },
    { id: "2024366648", cells: ["PET-6648", "Pet Food Manufacturing Item 5", "25/9/2026", "€16 748"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Food Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Food Manufacturing</p>
                    </div>
                </div>
