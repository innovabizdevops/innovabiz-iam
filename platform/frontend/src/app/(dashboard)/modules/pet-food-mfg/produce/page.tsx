...
const PAGE = "Produce";
const KPIS = [{"l":"Total Pet Food Mfg","v":"450","t":"+5.3%","d":"up"},{"l":"Produce Ativos","v":"8.507","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"78.9%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+2.0%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Food Mfg #001","Pet Food Mfg #002","8.684","6.944","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Food Mfg #002","Pet Food Mfg #003","2.964","1.768","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Food Mfg #003","Pet Food Mfg #004","5.782","7.996","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Food Mfg #004","Pet Food Mfg #005","9.014","8.187","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Food Mfg #005","Pet Food Mfg #001","1.804","2.181","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":743},{"label":"Mar","value":1024},{"label":"Abr","value":831},{"label":"Mai","value":897},{"label":"Jun","value":711},{"label":"Jul","value":987},{"label":"Ago","value":857},{"label":"Set","value":763},{"label":"Out","value":978},{"label":"Nov","value":916},{"label":"Dez","value":884}];
const MX = 1024;
