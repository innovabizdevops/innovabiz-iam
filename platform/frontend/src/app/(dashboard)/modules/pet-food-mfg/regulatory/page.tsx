...
const ACCENT = "#f97316";
const MODULE = "Pet Food Manufacturing";
const PAGE = "Regulatory";
const KPIS = [{"l":"Total Pet Food Mfg","v":"1.331","t":"+14.7%","d":"up"},{"l":"Regulatory Ativos","v":"6.074","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"80.7%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"63","t":"+1.8%","d":"up"}];
const COLS = ["ID","Regulatory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Food Mfg #001","Pet Food Mfg #002","2.534","4.242","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Food Mfg #002","Pet Food Mfg #003","4.668","1.902","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Food Mfg #003","Pet Food Mfg #004","6.730","8.506","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Food Mfg #004","Pet Food Mfg #005","1.340","4.881","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Food Mfg #005","Pet Food Mfg #001","7.203","8.617","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":677},{"label":"Mar","value":593},{"label":"Abr","value":441},{"label":"Mai","value":432},{"label":"Jun","value":762},{"label":"Jul","value":644},{"label":"Ago","value":605},{"label":"Set","value":530},{"label":"Out","value":738},{"label":"Nov","value":535},{"label":"Dez","value":572}];
const MX = 762;
