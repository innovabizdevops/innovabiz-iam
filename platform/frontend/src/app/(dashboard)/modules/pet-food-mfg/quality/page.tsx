...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.169","t":"-5.5%","d":"down"},{"l":"NC Abertas","v":"5.283","t":"+12.0%","d":"up"},{"l":"Conformidade (%)","v":"67.3%","t":"+5.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.097","t":"+7.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","722","82.6%","7.358","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","626","81.6%","921","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.372","72.2%","8.920","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.357","77.3%","2.514","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.650","95.8%","304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":255},{"label":"Fev","value":282},{"label":"Mar","value":285},{"label":"Abr","value":474},{"label":"Mai","value":407},{"label":"Jun","value":487},{"label":"Jul","value":279},{"label":"Ago","value":367},{"label":"Set","value":565},{"label":"Out","value":544},{"label":"Nov","value":292},{"label":"Dez","value":413}];
const MX = 565;
