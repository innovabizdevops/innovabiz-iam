...
const PAGE = "Meter";
const KPIS = [{"l":"ARR (€M)","v":"€5.0M","t":"-2.1%","d":"down"},{"l":"MRR (€)","v":"€73685","t":"-2.5%","d":"down"},{"l":"Churn (%)","v":"69.1%","t":"+10.1%","d":"up"},{"l":"ARPU (€)","v":"€43279","t":"+9.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32609.31","3.207","€ 30550.61","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 3063.86","156","€ 49216.95","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 47261.17","7.978","€ 34729.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16001.15","8.006","€ 9001.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3933.35","350","€ 4165.33","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":670},{"label":"Mar","value":598},{"label":"Abr","value":667},{"label":"Mai","value":822},{"label":"Jun","value":765},{"label":"Jul","value":785},{"label":"Ago","value":526},{"label":"Set","value":860},{"label":"Out","value":812},{"label":"Nov","value":639},{"label":"Dez","value":823}];
const MX = 860;
