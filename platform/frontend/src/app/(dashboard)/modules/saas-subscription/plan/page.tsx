...
const PAGE = "Plan";
const KPIS = [{"l":"ARR (€M)","v":"€37.1M","t":"-2.6%","d":"down"},{"l":"MRR (€)","v":"€36413","t":"-3.7%","d":"down"},{"l":"Churn (%)","v":"68.9%","t":"-3.4%","d":"down"},{"l":"ARPU (€)","v":"€15132","t":"-5.3%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24491.56","3.622","€ 10847.56","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 5109.00","8.692","€ 10525.84","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 22668.47","5.168","€ 39373.00","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1710.54","6.256","€ 153.81","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23315.06","5.542","€ 16340.42","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":688},{"label":"Mar","value":663},{"label":"Abr","value":628},{"label":"Mai","value":588},{"label":"Jun","value":835},{"label":"Jul","value":514},{"label":"Ago","value":547},{"label":"Set","value":555},{"label":"Out","value":865},{"label":"Nov","value":747},{"label":"Dez","value":644}];
const MX = 865;
