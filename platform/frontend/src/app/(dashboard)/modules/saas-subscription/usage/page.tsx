...
const PAGE = "Usage";
const KPIS = [{"l":"ARR (€M)","v":"€21.7M","t":"+9.2%","d":"up"},{"l":"MRR (€)","v":"€10390","t":"+12.7%","d":"up"},{"l":"Churn (%)","v":"89.6%","t":"+15.9%","d":"up"},{"l":"ARPU (€)","v":"€99799","t":"+11.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 4053.58","8.339","€ 31094.72","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43331.26","1.787","€ 38745.83","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 10121.24","4.352","€ 11881.15","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 29473.78","1.313","€ 41588.60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 41306.31","198","€ 19522.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":799},{"label":"Mar","value":937},{"label":"Abr","value":865},{"label":"Mai","value":545},{"label":"Jun","value":840},{"label":"Jul","value":662},{"label":"Ago","value":642},{"label":"Set","value":698},{"label":"Out","value":868},{"label":"Nov","value":749},{"label":"Dez","value":826}];
const MX = 937;
