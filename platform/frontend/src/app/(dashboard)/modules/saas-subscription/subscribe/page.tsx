...
const KPIS = [{"l":"ARR (€M)","v":"€43.7M","t":"-1.8%","d":"down"},{"l":"MRR (€)","v":"€42051","t":"-4.5%","d":"down"},{"l":"Churn (%)","v":"81.8%","t":"+7.5%","d":"up"},{"l":"ARPU (€)","v":"€32551","t":"+7.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1087.81","3.439","€ 28034.58","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 40977.87","154","€ 6740.95","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45532.53","4.940","€ 15771.75","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38697.75","9.034","€ 44524.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13432.24","3.827","€ 47225.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":725},{"label":"Mar","value":704},{"label":"Abr","value":419},{"label":"Mai","value":663},{"label":"Jun","value":388},{"label":"Jul","value":475},{"label":"Ago","value":613},{"label":"Set","value":543},{"label":"Out","value":672},{"label":"Nov","value":641},{"label":"Dez","value":734}];
const MX = 757;
