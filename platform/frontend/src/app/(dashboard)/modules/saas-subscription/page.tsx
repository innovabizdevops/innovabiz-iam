...
/* ═══ SaaS Subscription Mgmt — Dashboard ═══ */

const ACCENT = "#0070f3";

const KPIS = [
    { label: "Total Registos", value: "9093", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4701", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€434K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1933874993", cells: ["SAA-9993", "SaaS Subscription Mgmt Item 1", "2/6/2026", "€25 093"], status: "active" as const },
    { id: "1933878564", cells: ["SAA-4564", "SaaS Subscription Mgmt Item 2", "17/1/2026", "€28 664"], status: "pending" as const },
    { id: "1933882135", cells: ["SAA-8135", "SaaS Subscription Mgmt Item 3", "4/8/2026", "€32 235"], status: "completed" as const },
    { id: "1933885706", cells: ["SAA-2706", "SaaS Subscription Mgmt Item 4", "19/3/2026", "€35 806"], status: "warning" as const },
    { id: "1933889277", cells: ["SAA-6277", "SaaS Subscription Mgmt Item 5", "6/10/2026", "€39 377"], status: "active" as const },
];
...
export default function SaasSubscriptionMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SaaS Subscription Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SaaS Subscription Mgmt</p>
                    </div>
                </div>
