...
const ACCENT = "#0070f3";
const MODULE = "SaaS Subscription Mgmt";
const PAGE = "Churn";
const KPIS = [{"l":"ARR (€M)","v":"€6.1M","t":"+6.2%","d":"up"},{"l":"MRR (€)","v":"€6429","t":"+9.1%","d":"up"},{"l":"Churn (%)","v":"74.2%","t":"+12.5%","d":"up"},{"l":"ARPU (€)","v":"€59552","t":"+12.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3514.54","2.956","€ 48631.79","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 10197.66","200","€ 6651.53","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 44635.88","6.679","€ 30736.67","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 42432.45","2.110","€ 45951.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 23180.44","5.233","€ 10461.12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":717},{"label":"Mar","value":670},{"label":"Abr","value":943},{"label":"Mai","value":948},{"label":"Jun","value":733},{"label":"Jul","value":954},{"label":"Ago","value":747},{"label":"Set","value":852},{"label":"Out","value":675},{"label":"Nov","value":737},{"label":"Dez","value":792}];
const MX = 954;
