...
const PAGE = "Config";
const KPIS = [{"l":"Configurações","v":"8.215","t":"+1.6%","d":"up"},{"l":"Últimas Alterações","v":"1.360","t":"-4.5%","d":"down"},{"l":"Ambientes","v":"4.127","t":"+2.8%","d":"up"},{"l":"Versão Config","v":"1.463","t":"-0.6%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 12563.74","8.028","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 21437.97","5.493","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 45400.44","8.711","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 17599.51","6.892","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 32498.96","6.962","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":598},{"label":"Mar","value":637},{"label":"Abr","value":617},{"label":"Mai","value":656},{"label":"Jun","value":748},{"label":"Jul","value":529},{"label":"Ago","value":657},{"label":"Set","value":704},{"label":"Out","value":574},{"label":"Nov","value":647},{"label":"Dez","value":819}];
const MX = 819;
