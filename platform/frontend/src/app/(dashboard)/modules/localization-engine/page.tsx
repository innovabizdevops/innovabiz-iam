...
/* ═══ Localization Engine — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "8801", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3522", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€346K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "951755101", cells: ["LOC-6101", "Localization Engine Item 1", "18/2/2026", "€5201"], status: "active" as const },
    { id: "951758672", cells: ["LOC-9672", "Localization Engine Item 2", "5/9/2026", "€8772"], status: "pending" as const },
    { id: "951762243", cells: ["LOC-4243", "Localization Engine Item 3", "20/4/2026", "€12 343"], status: "completed" as const },
    { id: "951765814", cells: ["LOC-7814", "Localization Engine Item 4", "7/11/2026", "€15 914"], status: "warning" as const },
    { id: "951769385", cells: ["LOC-2385", "Localization Engine Item 5", "22/6/2026", "€19 485"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Localization Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Localization Engine</p>
                    </div>
                </div>
