...
const PAGE = "Shelf Analytics";
const KPIS = [{"l":"Pedidos/Dia","v":"2266","t":"+7.5%","d":"up"},{"l":"GMV (€)","v":"€39378","t":"+14.7%","d":"up"},{"l":"Conversão (%)","v":"93.2%","t":"-0.2%","d":"down"},{"l":"AOV (€)","v":"€42359","t":"-4.3%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 32005.78","1.926","471","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 37195.56","2.959","3.588","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41714.67","8.832","638","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 23959.73","8.790","530","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 7879.07","3.826","6.906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":585},{"label":"Mar","value":319},{"label":"Abr","value":602},{"label":"Mai","value":305},{"label":"Jun","value":532},{"label":"Jul","value":490},{"label":"Ago","value":642},{"label":"Set","value":651},{"label":"Out","value":280},{"label":"Nov","value":328},{"label":"Dez","value":644}];
const MX = 651;
