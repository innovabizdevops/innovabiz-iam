...
const ACCENT = "#be185d";
const MODULE = "RetailTech & POS";
const PAGE = "Price Optimization";
const KPIS = [{"l":"Pedidos/Dia","v":"871","t":"+15.0%","d":"up"},{"l":"GMV (€)","v":"€44334","t":"+4.7%","d":"up"},{"l":"Conversão (%)","v":"67.0%","t":"+2.3%","d":"up"},{"l":"AOV (€)","v":"€33680","t":"+17.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43729.52","3.373","209","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 17020.63","8.449","7.445","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41964.66","2.285","3.606","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 28931.11","2.989","3.883","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39186.51","6.976","3.901","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":315},{"label":"Fev","value":452},{"label":"Mar","value":339},{"label":"Abr","value":625},{"label":"Mai","value":679},{"label":"Jun","value":486},{"label":"Jul","value":364},{"label":"Ago","value":634},{"label":"Set","value":361},{"label":"Out","value":510},{"label":"Nov","value":519},{"label":"Dez","value":574}];
const MX = 679;
