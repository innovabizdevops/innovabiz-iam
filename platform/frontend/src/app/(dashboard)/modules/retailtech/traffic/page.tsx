...
const PAGE = "Customer Traffic";
const KPIS = [{"l":"Pedidos/Dia","v":"3354","t":"+13.2%","d":"up"},{"l":"GMV (€)","v":"€45266","t":"+16.8%","d":"up"},{"l":"Conversão (%)","v":"79.3%","t":"+3.5%","d":"up"},{"l":"AOV (€)","v":"€29848","t":"+6.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 16723.07","171","2.042","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12500.40","180","6.745","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 15162.88","7.168","3.664","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 8793.30","7.230","8.264","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 41564.04","1.193","4.985","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":274},{"label":"Mar","value":452},{"label":"Abr","value":473},{"label":"Mai","value":461},{"label":"Jun","value":343},{"label":"Jul","value":390},{"label":"Ago","value":478},{"label":"Set","value":521},{"label":"Out","value":281},{"label":"Nov","value":522},{"label":"Dez","value":542}];
const MX = 629;
