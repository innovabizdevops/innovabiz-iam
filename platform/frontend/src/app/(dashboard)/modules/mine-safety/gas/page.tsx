...
const ACCENT = "#dc2626";
const MODULE = "Mine Safety";
const PAGE = "Gas Monitor";
const KPIS = [{"l":"Total Mine Safety","v":"3.625","t":"+8.6%","d":"up"},{"l":"Gas Monitor Ativos","v":"895","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.8%","d":"up"}];
const COLS = ["ID","Gas Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Safety #001","Mine Safety #002","227","1.137","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Safety #002","Mine Safety #003","427","8.115","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Safety #003","Mine Safety #004","3.485","8.642","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Safety #004","Mine Safety #005","1.953","3.600","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Safety #005","Mine Safety #001","1.618","1.316","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":654},{"label":"Mar","value":829},{"label":"Abr","value":569},{"label":"Mai","value":894},{"label":"Jun","value":647},{"label":"Jul","value":601},{"label":"Ago","value":736},{"label":"Set","value":901},{"label":"Out","value":719},{"label":"Nov","value":772},{"label":"Dez","value":550}];
const MX = 901;
