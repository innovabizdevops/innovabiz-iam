...
const PAGE = "Escape Routes";
const KPIS = [{"l":"Total Mine Safety","v":"2.125","t":"+15.5%","d":"up"},{"l":"Escape Routes Ativos","v":"1.963","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"61","t":"-1.6%","d":"down"}];
const COLS = ["ID","Escape Routes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Safety #001","Mine Safety #002","534","4.688","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Safety #002","Mine Safety #003","7.428","893","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Safety #003","Mine Safety #004","6.542","8.790","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Safety #004","Mine Safety #005","7.077","5.720","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Safety #005","Mine Safety #001","8.069","3.697","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":700},{"label":"Mar","value":833},{"label":"Abr","value":683},{"label":"Mai","value":864},{"label":"Jun","value":594},{"label":"Jul","value":760},{"label":"Ago","value":720},{"label":"Set","value":893},{"label":"Out","value":568},{"label":"Nov","value":671},{"label":"Dez","value":939}];
const MX = 939;
