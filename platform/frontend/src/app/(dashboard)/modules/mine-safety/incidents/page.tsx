...
const KPIS = [{"l":"Tickets Abertos","v":"5.214","t":"+8.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.7%","t":"+13.4%","d":"up"},{"l":"MTTR (h)","v":"52h","t":"-5.1%","d":"down"},{"l":"Satisfação (%)","v":"73.0%","t":"+2.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.855","7.447","652","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","652","8.004","6.279","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.433","3.033","4.675","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","930","578","1.196","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.719","844","1.342","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":855},{"label":"Mar","value":630},{"label":"Abr","value":843},{"label":"Mai","value":757},{"label":"Jun","value":891},{"label":"Jul","value":697},{"label":"Ago","value":761},{"label":"Set","value":636},{"label":"Out","value":821},{"label":"Nov","value":966},{"label":"Dez","value":802}];
const MX = 966;
