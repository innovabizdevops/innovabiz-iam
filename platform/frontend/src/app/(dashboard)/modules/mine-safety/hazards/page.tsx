...
const PAGE = "Hazard Board";
const KPIS = [{"l":"Teams Ativos","v":"1.534","t":"+6.2%","d":"up"},{"l":"Reuniões/Semana","v":"4599","t":"+3.5%","d":"up"},{"l":"Mensagens/Dia","v":"2756","t":"+3.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"5.285","t":"-1.8%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","6.558","119","6.313","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.813","3618","4.271","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.170","342","628","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.053","335","3.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","755","4178","8.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":832},{"label":"Mar","value":808},{"label":"Abr","value":593},{"label":"Mai","value":476},{"label":"Jun","value":537},{"label":"Jul","value":837},{"label":"Ago","value":748},{"label":"Set","value":657},{"label":"Out","value":821},{"label":"Nov","value":506},{"label":"Dez","value":804}];
const MX = 837;
