...
const PAGE = "Rule";
const KPIS = [{"l":"Dispositivos Online","v":"3.447","t":"+16.6%","d":"up"},{"l":"Dados/Min (MB)","v":"365","t":"-2.4%","d":"down"},{"l":"Alertas Ativos","v":"800","t":"-3.8%","d":"down"},{"l":"Uptime (%)","v":"87.9%","t":"-3.9%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.823","1.758","1.256","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","768","1.240","1.632","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.835","7.123","5.841","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.371","3.588","7.243","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.910","7.584","6.510","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":690},{"label":"Mar","value":989},{"label":"Abr","value":804},{"label":"Mai","value":939},{"label":"Jun","value":880},{"label":"Jul","value":827},{"label":"Ago","value":878},{"label":"Set","value":682},{"label":"Out","value":679},{"label":"Nov","value":991},{"label":"Dez","value":656}];
const MX = 991;
