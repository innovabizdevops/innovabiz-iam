...
const PAGE = "Connect";
const KPIS = [{"l":"Dispositivos Online","v":"7.186","t":"+1.1%","d":"up"},{"l":"Dados/Min (MB)","v":"1.273","t":"-3.5%","d":"down"},{"l":"Alertas Ativos","v":"4.282","t":"+0.9%","d":"up"},{"l":"Uptime (%)","v":"69.9%","t":"+0.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.557","5.926","3.621","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.693","4.708","2.083","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.180","7.636","920","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","445","2.940","4.263","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.309","2.921","3.606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":743},{"label":"Mar","value":799},{"label":"Abr","value":710},{"label":"Mai","value":653},{"label":"Jun","value":724},{"label":"Jul","value":928},{"label":"Ago","value":906},{"label":"Set","value":615},{"label":"Out","value":814},{"label":"Nov","value":667},{"label":"Dez","value":659}];
const MX = 928;
