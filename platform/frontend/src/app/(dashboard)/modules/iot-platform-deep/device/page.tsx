...
const PAGE = "Device";
const KPIS = [{"l":"Dispositivos Online","v":"127","t":"+8.1%","d":"up"},{"l":"Dados/Min (MB)","v":"7.127","t":"+3.4%","d":"up"},{"l":"Alertas Ativos","v":"4.229","t":"-1.5%","d":"down"},{"l":"Uptime (%)","v":"78.0%","t":"+17.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.332","224","4.115","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.776","4.509","1.570","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.758","4.303","6.652","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.153","8.006","4.450","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","946","1.899","2.910","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":365},{"label":"Mar","value":668},{"label":"Abr","value":577},{"label":"Mai","value":638},{"label":"Jun","value":358},{"label":"Jul","value":697},{"label":"Ago","value":315},{"label":"Set","value":384},{"label":"Out","value":541},{"label":"Nov","value":439},{"label":"Dez","value":461}];
const MX = 697;
