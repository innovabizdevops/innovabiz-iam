...
/* ═══ IoT Platform Deep — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "2198", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1454", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€118K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "232820398", cells: ["IOT-9398", "IoT Platform Deep Item 1", "7/11/2026", "€20 498"], status: "active" as const },
    { id: "232823969", cells: ["IOT-3969", "IoT Platform Deep Item 2", "22/6/2026", "€24 069"], status: "pending" as const },
    { id: "232827540", cells: ["IOT-7540", "IoT Platform Deep Item 3", "9/1/2026", "€27 640"], status: "completed" as const },
    { id: "232831111", cells: ["IOT-2111", "IoT Platform Deep Item 4", "24/8/2026", "€31 211"], status: "warning" as const },
    { id: "232834682", cells: ["IOT-5682", "IoT Platform Deep Item 5", "11/3/2026", "€34 782"], status: "active" as const },
];
...
export default function IotPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IoT Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IoT Platform Deep</p>
                    </div>
                </div>
