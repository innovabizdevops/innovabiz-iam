...
const PAGE = "Twin";
const KPIS = [{"l":"Dispositivos Online","v":"5.972","t":"+2.6%","d":"up"},{"l":"Dados/Min (MB)","v":"2.354","t":"+16.3%","d":"up"},{"l":"Alertas Ativos","v":"7.954","t":"+1.9%","d":"up"},{"l":"Uptime (%)","v":"86.6%","t":"+14.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","209","7.170","2.386","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.103","2.851","2.002","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.745","7.725","4.545","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.961","2.829","3.000","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.029","3.083","1.054","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":718},{"label":"Mar","value":902},{"label":"Abr","value":749},{"label":"Mai","value":677},{"label":"Jun","value":1020},{"label":"Jul","value":1000},{"label":"Ago","value":916},{"label":"Set","value":869},{"label":"Out","value":1027},{"label":"Nov","value":753},{"label":"Dez","value":958}];
const MX = 1027;
