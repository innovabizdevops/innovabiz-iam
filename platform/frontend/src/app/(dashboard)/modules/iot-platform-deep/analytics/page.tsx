...
const ACCENT = "#8b5cf6";
const MODULE = "IoT Platform Deep";
const PAGE = "Analytics";
const KPIS = [{"l":"Dispositivos Online","v":"3.391","t":"+16.8%","d":"up"},{"l":"Dados/Min (MB)","v":"1.567","t":"+6.4%","d":"up"},{"l":"Alertas Ativos","v":"2.750","t":"-1.4%","d":"down"},{"l":"Uptime (%)","v":"86.0%","t":"+6.8%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.930","7.757","2.673","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.190","4.327","5.202","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.513","4.632","5.347","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.982","6.754","7.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.331","5.437","3.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":880},{"label":"Mar","value":705},{"label":"Abr","value":622},{"label":"Mai","value":965},{"label":"Jun","value":877},{"label":"Jul","value":982},{"label":"Ago","value":670},{"label":"Set","value":792},{"label":"Out","value":885},{"label":"Nov","value":972},{"label":"Dez","value":628}];
const MX = 982;
