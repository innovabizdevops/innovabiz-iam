...
const PAGE = "Observe";
const KPIS = [{"l":"Total Cosmos Chaos","v":"5.228","t":"-5.2%","d":"down"},{"l":"Observe Ativos","v":"8.426","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+3.5%","d":"up"}];
const COLS = ["ID","Observe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Chaos #001","Cosmos Chaos #002","2.066","3.110","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Chaos #002","Cosmos Chaos #003","4.117","7.011","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Chaos #003","Cosmos Chaos #004","8.363","8.565","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Chaos #004","Cosmos Chaos #005","6.682","548","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Chaos #005","Cosmos Chaos #001","4.892","2.367","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":591},{"label":"Mar","value":495},{"label":"Abr","value":460},{"label":"Mai","value":426},{"label":"Jun","value":537},{"label":"Jul","value":512},{"label":"Ago","value":623},{"label":"Set","value":482},{"label":"Out","value":448},{"label":"Nov","value":591},{"label":"Dez","value":547}];
const MX = 623;
