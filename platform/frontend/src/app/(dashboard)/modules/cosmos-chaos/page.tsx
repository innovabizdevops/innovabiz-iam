...
/* ═══ COSMOS Chaos Engineering — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "9716", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "334", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€12K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2109650116", cells: ["COS-6116", "COSMOS Chaos Engineering Item 1", "1/5/2026", "€216"], status: "active" as const },
    { id: "2109653687", cells: ["COS-9687", "COSMOS Chaos Engineering Item 2", "16/12/2026", "€3787"], status: "pending" as const },
    { id: "2109657258", cells: ["COS-4258", "COSMOS Chaos Engineering Item 3", "3/7/2026", "€7358"], status: "completed" as const },
    { id: "2109660829", cells: ["COS-7829", "COSMOS Chaos Engineering Item 4", "18/2/2026", "€10 929"], status: "warning" as const },
    { id: "2109664400", cells: ["COS-2400", "COSMOS Chaos Engineering Item 5", "5/9/2026", "€14 500"], status: "active" as const },
];
...
export default function CosmosChaosEngineeringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Chaos Engineering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Chaos Engineering</p>
                    </div>
                </div>
