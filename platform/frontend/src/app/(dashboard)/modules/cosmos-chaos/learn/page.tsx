...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Chaos Engineering";
const PAGE = "Learn";
const KPIS = [{"l":"Total Cosmos Chaos","v":"5.459","t":"+6.2%","d":"up"},{"l":"Learn Ativos","v":"6.034","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.9%","d":"up"}];
const COLS = ["ID","Learn","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Chaos #001","Cosmos Chaos #002","2.346","2.610","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Chaos #002","Cosmos Chaos #003","7.296","3.697","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Chaos #003","Cosmos Chaos #004","3.592","7.073","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Chaos #004","Cosmos Chaos #005","6.912","6.831","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Chaos #005","Cosmos Chaos #001","2.750","3.393","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":358},{"label":"Mar","value":350},{"label":"Abr","value":511},{"label":"Mai","value":461},{"label":"Jun","value":522},{"label":"Jul","value":673},{"label":"Ago","value":623},{"label":"Set","value":343},{"label":"Out","value":662},{"label":"Nov","value":558},{"label":"Dez","value":451}];
const MX = 673;
