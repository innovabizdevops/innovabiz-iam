...
export default function MasterDataMdmPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Master Data Mdm</h1><p className="text-sm text-muted-foreground">Master Data Mdm • iBOS Enterprise</p></div>
