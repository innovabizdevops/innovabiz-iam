...
/* ═══ Transport Infra — Toll System ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "1192", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "343", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "298", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "720627347", cells: ["TRA-7347", "Toll System Item 1", "28/12/2026", "€27 447"], status: "active" as const },
    { id: "720630918", cells: ["TRA-1918", "Toll System Item 2", "15/7/2026", "€31 018"], status: "pending" as const },
    { id: "720634489", cells: ["TRA-5489", "Toll System Item 3", "2/2/2026", "€34 589"], status: "completed" as const },
    { id: "720638060", cells: ["TRA-9060", "Toll System Item 4", "17/9/2026", "€38 160"], status: "warning" as const },
    { id: "720641631", cells: ["TRA-3631", "Toll System Item 5", "4/4/2026", "€41 731"], status: "active" as const },
];
...
export default function TransportInfraTollSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Toll System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Toll System</p>
                    </div>
                </div>
