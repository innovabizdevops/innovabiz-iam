...
/* ═══ Transport Infra — Intermodal ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "3652", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "98", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1583", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "869516878", cells: ["TRA-9878", "Intermodal Item 1", "7/11/2026", "€16 978"], status: "active" as const },
    { id: "869520449", cells: ["TRA-4449", "Intermodal Item 2", "22/6/2026", "€20 549"], status: "pending" as const },
    { id: "869524020", cells: ["TRA-8020", "Intermodal Item 3", "9/1/2026", "€24 120"], status: "completed" as const },
    { id: "869527591", cells: ["TRA-2591", "Intermodal Item 4", "24/8/2026", "€27 691"], status: "warning" as const },
    { id: "869531162", cells: ["TRA-6162", "Intermodal Item 5", "11/3/2026", "€31 262"], status: "active" as const },
];
...
export default function TransportInfraIntermodalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Intermodal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Intermodal</p>
                    </div>
                </div>
