...
/* ═══ Transport Infra — Metro Ops ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "1713", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "30", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3442", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "7139466", cells: ["TRA-3466", "Metro Ops Item 1", "27/7/2026", "€39 566"], status: "active" as const },
    { id: "7143037", cells: ["TRA-7037", "Metro Ops Item 2", "14/2/2026", "€43 137"], status: "pending" as const },
    { id: "7146608", cells: ["TRA-1608", "Metro Ops Item 3", "1/9/2026", "€46 708"], status: "completed" as const },
    { id: "7150179", cells: ["TRA-5179", "Metro Ops Item 4", "16/4/2026", "€279"], status: "warning" as const },
    { id: "7153750", cells: ["TRA-8750", "Metro Ops Item 5", "3/11/2026", "€3850"], status: "active" as const },
];
...
export default function TransportInfraMetroOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metro Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Metro Ops</p>
                    </div>
                </div>
