...
/* ═══ Transport Infra — Smart Highway ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "1916", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "457", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "180", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1448362133", cells: ["TRA-2133", "Smart Highway Item 1", "2/6/2026", "€12 233"], status: "active" as const },
    { id: "1448365704", cells: ["TRA-5704", "Smart Highway Item 2", "17/1/2026", "€15 804"], status: "pending" as const },
    { id: "1448369275", cells: ["TRA-9275", "Smart Highway Item 3", "4/8/2026", "€19 375"], status: "completed" as const },
    { id: "1448372846", cells: ["TRA-3846", "Smart Highway Item 4", "19/3/2026", "€22 946"], status: "warning" as const },
    { id: "1448376417", cells: ["TRA-7417", "Smart Highway Item 5", "6/10/2026", "€26 517"], status: "active" as const },
];
...
export default function TransportInfraSmartHighwayPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Highway</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Smart Highway</p>
                    </div>
                </div>
