...
/* ═══ Transport Infra — Bus Rapid ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "565", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "287", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2675", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1564522683", cells: ["TRA-8683", "Bus Rapid Item 1", "4/4/2026", "€22 783"], status: "active" as const },
    { id: "1564526254", cells: ["TRA-3254", "Bus Rapid Item 2", "19/11/2026", "€26 354"], status: "pending" as const },
    { id: "1564529825", cells: ["TRA-6825", "Bus Rapid Item 3", "6/6/2026", "€29 925"], status: "completed" as const },
    { id: "1564533396", cells: ["TRA-1396", "Bus Rapid Item 4", "21/1/2026", "€33 496"], status: "warning" as const },
    { id: "1564536967", cells: ["TRA-4967", "Bus Rapid Item 5", "8/8/2026", "€37 067"], status: "active" as const },
];
...
export default function TransportInfraBusRapidPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bus Rapid</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Bus Rapid</p>
                    </div>
                </div>
