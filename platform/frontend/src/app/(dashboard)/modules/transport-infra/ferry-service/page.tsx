...
/* ═══ Transport Infra — Ferry Service ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2138", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "370", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "352", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "72884110", cells: ["TRA-3110", "Ferry Service Item 1", "27/11/2026", "€34 210"], status: "active" as const },
    { id: "72887681", cells: ["TRA-6681", "Ferry Service Item 2", "14/6/2026", "€37 781"], status: "pending" as const },
    { id: "72891252", cells: ["TRA-1252", "Ferry Service Item 3", "1/1/2026", "€41 352"], status: "completed" as const },
    { id: "72894823", cells: ["TRA-4823", "Ferry Service Item 4", "16/8/2026", "€44 923"], status: "warning" as const },
    { id: "72898394", cells: ["TRA-8394", "Ferry Service Item 5", "3/3/2026", "€48 494"], status: "active" as const },
];
...
export default function TransportInfraFerryServicePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ferry Service</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Ferry Service</p>
                    </div>
                </div>
