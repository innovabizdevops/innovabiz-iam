...
/* ═══ Transport Infra — Cable Car ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "1792", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "164", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3032", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "750678320", cells: ["TRA-7320", "Cable Car Item 1", "1/9/2026", "€28 420"], status: "active" as const },
    { id: "750681891", cells: ["TRA-1891", "Cable Car Item 2", "16/4/2026", "€31 991"], status: "pending" as const },
    { id: "750685462", cells: ["TRA-5462", "Cable Car Item 3", "3/11/2026", "€35 562"], status: "completed" as const },
    { id: "750689033", cells: ["TRA-9033", "Cable Car Item 4", "18/6/2026", "€39 133"], status: "warning" as const },
    { id: "750692604", cells: ["TRA-3604", "Cable Car Item 5", "5/1/2026", "€42 704"], status: "active" as const },
];
...
export default function TransportInfraCableCarPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cable Car</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Cable Car</p>
                    </div>
                </div>
