...
/* ═══ Transport Infra — Freight Rail ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "841", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "292", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "605", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "886932624", cells: ["TRA-1624", "Freight Rail Item 1", "5/1/2026", "€32 724"], status: "active" as const },
    { id: "886936195", cells: ["TRA-5195", "Freight Rail Item 2", "20/8/2026", "€36 295"], status: "pending" as const },
    { id: "886939766", cells: ["TRA-8766", "Freight Rail Item 3", "7/3/2026", "€39 866"], status: "completed" as const },
    { id: "886943337", cells: ["TRA-3337", "Freight Rail Item 4", "22/10/2026", "€43 437"], status: "warning" as const },
    { id: "886946908", cells: ["TRA-6908", "Freight Rail Item 5", "9/5/2026", "€47 008"], status: "active" as const },
];
...
export default function TransportInfraFreightRailPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Freight Rail</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Freight Rail</p>
                    </div>
                </div>
