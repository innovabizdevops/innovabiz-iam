...
/* ═══ Transport Infra — Traffic Signal ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "3340", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "200", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "45", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1402553300", cells: ["TRA-3300", "Traffic Signal Item 1", "9/9/2026", "€3400"], status: "active" as const },
    { id: "1402556871", cells: ["TRA-6871", "Traffic Signal Item 2", "24/4/2026", "€6971"], status: "pending" as const },
    { id: "1402560442", cells: ["TRA-1442", "Traffic Signal Item 3", "11/11/2026", "€10 542"], status: "completed" as const },
    { id: "1402564013", cells: ["TRA-5013", "Traffic Signal Item 4", "26/6/2026", "€14 113"], status: "warning" as const },
    { id: "1402567584", cells: ["TRA-8584", "Traffic Signal Item 5", "13/1/2026", "€17 684"], status: "active" as const },
];
...
export default function TransportInfraTrafficSignalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Traffic Signal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Traffic Signal</p>
                    </div>
                </div>
