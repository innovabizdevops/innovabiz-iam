...
/* ═══ Transport Infra — Parking Mgmt ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total", value: "2744", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "190", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2488", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "634930794", cells: ["TRA-8794", "Parking Mgmt Item 1", "23/7/2026", "€30 894"], status: "active" as const },
    { id: "634934365", cells: ["TRA-3365", "Parking Mgmt Item 2", "10/2/2026", "€34 465"], status: "pending" as const },
    { id: "634937936", cells: ["TRA-6936", "Parking Mgmt Item 3", "25/9/2026", "€38 036"], status: "completed" as const },
    { id: "634941507", cells: ["TRA-1507", "Parking Mgmt Item 4", "12/4/2026", "€41 607"], status: "warning" as const },
    { id: "634945078", cells: ["TRA-5078", "Parking Mgmt Item 5", "27/11/2026", "€45 178"], status: "active" as const },
];
...
export default function TransportInfraParkingMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Parking Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Transport Infra • Parking Mgmt</p>
                    </div>
                </div>
