...
const ACCENT = "#6366f1";
const MODULE = "HR Compliance";
const PAGE = "Policy";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.823","t":"+0.9%","d":"up"},{"l":"NC Abertas","v":"7.861","t":"+10.8%","d":"up"},{"l":"Conformidade (%)","v":"77.3%","t":"+11.4%","d":"up"},{"l":"CAPAs Pendentes","v":"1.677","t":"-3.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.560","74.0%","8.689","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.677","95.2%","6.668","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.695","92.1%","7.288","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","239","94.8%","6.328","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.674","81.9%","5.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":698},{"label":"Mar","value":773},{"label":"Abr","value":838},{"label":"Mai","value":775},{"label":"Jun","value":911},{"label":"Jul","value":778},{"label":"Ago","value":1059},{"label":"Set","value":869},{"label":"Out","value":1032},{"label":"Nov","value":785},{"label":"Dez","value":913}];
const MX = 1059;
