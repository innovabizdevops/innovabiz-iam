...
const PAGE = "I-9";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.118","t":"+9.2%","d":"up"},{"l":"NC Abertas","v":"6.843","t":"+2.5%","d":"up"},{"l":"Conformidade (%)","v":"81.5%","t":"+7.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.310","t":"-3.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.565","71.4%","7.674","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.058","90.9%","1.679","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.115","77.4%","2.845","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.156","79.8%","7.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.768","89.7%","7.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":296},{"label":"Mar","value":526},{"label":"Abr","value":321},{"label":"Mai","value":338},{"label":"Jun","value":615},{"label":"Jul","value":509},{"label":"Ago","value":630},{"label":"Set","value":327},{"label":"Out","value":627},{"label":"Nov","value":371},{"label":"Dez","value":644}];
const MX = 644;
