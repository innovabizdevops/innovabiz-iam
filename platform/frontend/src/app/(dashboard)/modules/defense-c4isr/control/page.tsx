...
const PAGE = "Control";
const KPIS = [{"l":"Total Defense C4isr","v":"6.190","t":"+6.2%","d":"up"},{"l":"Control Ativos","v":"4.758","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"80.5%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"74","t":"+4.7%","d":"up"}];
const COLS = ["ID","Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense C4isr #001","Defense C4isr #002","4.420","6.838","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Defense C4isr #002","Defense C4isr #003","764","7.479","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense C4isr #003","Defense C4isr #004","855","648","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Defense C4isr #004","Defense C4isr #005","8.856","3.434","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense C4isr #005","Defense C4isr #001","6.089","7.112","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":670},{"label":"Mar","value":315},{"label":"Abr","value":387},{"label":"Mai","value":314},{"label":"Jun","value":402},{"label":"Jul","value":346},{"label":"Ago","value":476},{"label":"Set","value":505},{"label":"Out","value":462},{"label":"Nov","value":454},{"label":"Dez","value":437}];
const MX = 670;
