...
const PAGE = "Intel";
const KPIS = [{"l":"Total Defense C4isr","v":"994","t":"+7.2%","d":"up"},{"l":"Intel Ativos","v":"6.519","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"68.6%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+2.4%","d":"up"}];
const COLS = ["ID","Intel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense C4isr #001","Defense C4isr #002","6.741","2.483","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Defense C4isr #002","Defense C4isr #003","8.856","6.381","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense C4isr #003","Defense C4isr #004","6.876","7.156","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Defense C4isr #004","Defense C4isr #005","4.907","3.870","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense C4isr #005","Defense C4isr #001","6.328","4.497","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":566},{"label":"Mar","value":429},{"label":"Abr","value":520},{"label":"Mai","value":383},{"label":"Jun","value":528},{"label":"Jul","value":370},{"label":"Ago","value":680},{"label":"Set","value":422},{"label":"Out","value":583},{"label":"Nov","value":418},{"label":"Dez","value":499}];
const MX = 680;
