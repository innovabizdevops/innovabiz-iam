...
const PAGE = "Command";
const KPIS = [{"l":"Total Defense C4isr","v":"8.351","t":"+13.6%","d":"up"},{"l":"Command Ativos","v":"7.764","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"83.8%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"91","t":"-4.0%","d":"down"}];
const COLS = ["ID","Command","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense C4isr #001","Defense C4isr #002","2.996","1.615","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Defense C4isr #002","Defense C4isr #003","2.160","1.403","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense C4isr #003","Defense C4isr #004","4.533","7.468","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Defense C4isr #004","Defense C4isr #005","2.518","4.898","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense C4isr #005","Defense C4isr #001","481","4.120","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":767},{"label":"Mar","value":896},{"label":"Abr","value":898},{"label":"Mai","value":886},{"label":"Jun","value":717},{"label":"Jul","value":1036},{"label":"Ago","value":962},{"label":"Set","value":944},{"label":"Out","value":887},{"label":"Nov","value":1041},{"label":"Dez","value":719}];
const MX = 1041;
