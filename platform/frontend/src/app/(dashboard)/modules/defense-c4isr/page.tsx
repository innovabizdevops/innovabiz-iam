...
const KPIS = [
    { label: "Total Registos", value: "3371", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4469", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "41642671", cells: ["DEF-9671", "C4ISR Platform Item 1", "8/8/2026", "€42 771"], status: "active" as const },
    { id: "41646242", cells: ["DEF-4242", "C4ISR Platform Item 2", "23/3/2026", "€46 342"], status: "pending" as const },
    { id: "41649813", cells: ["DEF-7813", "C4ISR Platform Item 3", "10/10/2026", "€49 913"], status: "completed" as const },
    { id: "41653384", cells: ["DEF-2384", "C4ISR Platform Item 4", "25/5/2026", "€3484"], status: "warning" as const },
    { id: "41656955", cells: ["DEF-5955", "C4ISR Platform Item 5", "12/12/2026", "€7055"], status: "active" as const },
];
