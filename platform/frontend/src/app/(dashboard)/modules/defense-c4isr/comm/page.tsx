...
const PAGE = "Comm";
const KPIS = [{"l":"Total Defense C4isr","v":"5.095","t":"+12.8%","d":"up"},{"l":"Comm Ativos","v":"5.771","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+2.8%","d":"up"}];
const COLS = ["ID","Comm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense C4isr #001","Defense C4isr #002","4.617","5.687","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Defense C4isr #002","Defense C4isr #003","8.658","8.737","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense C4isr #003","Defense C4isr #004","4.647","482","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Defense C4isr #004","Defense C4isr #005","4.748","8.506","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense C4isr #005","Defense C4isr #001","8.506","2.077","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":467},{"label":"Mar","value":460},{"label":"Abr","value":746},{"label":"Mai","value":539},{"label":"Jun","value":542},{"label":"Jul","value":396},{"label":"Ago","value":577},{"label":"Set","value":565},{"label":"Out","value":639},{"label":"Nov","value":381},{"label":"Dez","value":699}];
const MX = 746;
