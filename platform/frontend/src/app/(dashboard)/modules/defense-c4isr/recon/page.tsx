...
const PAGE = "Recon";
const KPIS = [{"l":"Total Defense C4isr","v":"6.684","t":"+4.6%","d":"up"},{"l":"Recon Ativos","v":"6.745","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"68","t":"-5.3%","d":"down"}];
const COLS = ["ID","Recon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense C4isr #001","Defense C4isr #002","8.958","7.144","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Defense C4isr #002","Defense C4isr #003","2.879","8.029","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense C4isr #003","Defense C4isr #004","7.051","4.778","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Defense C4isr #004","Defense C4isr #005","3.044","9.037","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense C4isr #005","Defense C4isr #001","625","8.038","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":237},{"label":"Fev","value":393},{"label":"Mar","value":239},{"label":"Abr","value":507},{"label":"Mai","value":605},{"label":"Jun","value":365},{"label":"Jul","value":507},{"label":"Ago","value":532},{"label":"Set","value":437},{"label":"Out","value":367},{"label":"Nov","value":374},{"label":"Dez","value":307}];
const MX = 605;
