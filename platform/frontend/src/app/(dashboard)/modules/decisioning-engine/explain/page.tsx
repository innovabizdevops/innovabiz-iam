...
const ACCENT = "#6366f1";
const MODULE = "AI Decisioning Engine";
const PAGE = "Explain";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.846","t":"+3.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.2%","t":"+4.0%","d":"up"},{"l":"Tempo Médio (h)","v":"174h","t":"+14.8%","d":"up"},{"l":"Rejeitadas (%)","v":"83.0%","t":"+15.5%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.247","€ 30844.61","3.282","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.359","€ 38423.36","2.680","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.457","€ 8807.56","7.271","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.806","€ 5081.21","1.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.507","€ 41397.53","7.535","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":664},{"label":"Mar","value":455},{"label":"Abr","value":375},{"label":"Mai","value":656},{"label":"Jun","value":625},{"label":"Jul","value":712},{"label":"Ago","value":594},{"label":"Set","value":656},{"label":"Out","value":676},{"label":"Nov","value":562},{"label":"Dez","value":448}];
const MX = 712;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>XAI</span></h1>
                </div>
