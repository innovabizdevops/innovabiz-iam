...
const PAGE = "Decision";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.786","t":"+7.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.1%","t":"+5.3%","d":"up"},{"l":"Tempo Médio (h)","v":"110h","t":"+5.8%","d":"up"},{"l":"Rejeitadas (%)","v":"68.5%","t":"+5.5%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.100","€ 3919.89","6.874","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.520","€ 34969.03","7.945","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","1.392","€ 40883.07","9.061","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.656","€ 41908.95","8.241","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","4.561","€ 26687.93","7.507","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":536},{"label":"Mar","value":394},{"label":"Abr","value":487},{"label":"Mai","value":299},{"label":"Jun","value":513},{"label":"Jul","value":318},{"label":"Ago","value":457},{"label":"Set","value":329},{"label":"Out","value":426},{"label":"Nov","value":277},{"label":"Dez","value":518}];
const MX = 536;
