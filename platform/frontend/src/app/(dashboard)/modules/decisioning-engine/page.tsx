...
/* ═══ AI Decisioning Engine — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "1708", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2351", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "681973008", cells: ["DEC-8008", "AI Decisioning Engine Item 1", "25/1/2026", "€23 108"], status: "active" as const },
    { id: "681976579", cells: ["DEC-2579", "AI Decisioning Engine Item 2", "12/8/2026", "€26 679"], status: "pending" as const },
    { id: "681980150", cells: ["DEC-6150", "AI Decisioning Engine Item 3", "27/3/2026", "€30 250"], status: "completed" as const },
    { id: "681983721", cells: ["DEC-9721", "AI Decisioning Engine Item 4", "14/10/2026", "€33 821"], status: "warning" as const },
    { id: "681987292", cells: ["DEC-4292", "AI Decisioning Engine Item 5", "1/5/2026", "€37 392"], status: "active" as const },
];
...
export default function AiDecisioningEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Decisioning Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Decisioning Engine</p>
                    </div>
                </div>
