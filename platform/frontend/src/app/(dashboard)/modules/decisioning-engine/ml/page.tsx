...
const PAGE = "ML Model";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.941","t":"+2.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.0%","t":"+15.9%","d":"up"},{"l":"Tempo Médio (h)","v":"54h","t":"-2.0%","d":"down"},{"l":"Rejeitadas (%)","v":"79.9%","t":"+14.2%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.081","€ 35254.83","8.036","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.496","€ 34453.89","6.013","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.814","€ 23897.22","4.426","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.785","€ 2144.98","1.303","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","3.849","€ 30296.90","1.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":739},{"label":"Mar","value":505},{"label":"Abr","value":736},{"label":"Mai","value":481},{"label":"Jun","value":523},{"label":"Jul","value":660},{"label":"Ago","value":717},{"label":"Set","value":723},{"label":"Out","value":640},{"label":"Nov","value":655},{"label":"Dez","value":477}];
const MX = 739;
