...
const PAGE = "Rules";
const KPIS = [{"l":"Aprovações Pendentes","v":"6.514","t":"+4.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.6%","t":"+7.8%","d":"up"},{"l":"Tempo Médio (h)","v":"121h","t":"+10.2%","d":"up"},{"l":"Rejeitadas (%)","v":"70.7%","t":"-1.5%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","4.441","€ 17750.26","526","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","806","€ 19526.26","1.351","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.363","€ 20367.56","2.136","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.130","€ 1490.28","7.951","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.608","€ 4543.89","3.295","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":571},{"label":"Mar","value":488},{"label":"Abr","value":368},{"label":"Mai","value":315},{"label":"Jun","value":373},{"label":"Jul","value":662},{"label":"Ago","value":463},{"label":"Set","value":566},{"label":"Out","value":494},{"label":"Nov","value":458},{"label":"Dez","value":528}];
const MX = 662;
