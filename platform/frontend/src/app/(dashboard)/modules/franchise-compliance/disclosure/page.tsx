...
const KPIS = [{"l":"Auditorias Realizadas","v":"303","t":"+1.8%","d":"up"},{"l":"NC Abertas","v":"5.800","t":"+3.7%","d":"up"},{"l":"Conformidade (%)","v":"73.6%","t":"+17.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.482","t":"+4.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.312","93.8%","3.285","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.626","88.2%","6.562","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.757","70.8%","8.476","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.875","92.4%","5.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.209","89.7%","7.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":244},{"label":"Fev","value":443},{"label":"Mar","value":584},{"label":"Abr","value":210},{"label":"Mai","value":535},{"label":"Jun","value":594},{"label":"Jul","value":329},{"label":"Ago","value":282},{"label":"Set","value":230},{"label":"Out","value":308},{"label":"Nov","value":232},{"label":"Dez","value":439}];
const MX = 594;
