...
/* ═══ Franchise Compliance — Dashboard ═══ */

const ACCENT = "#1d4ed8";

const KPIS = [
    { label: "Total Registos", value: "2806", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1845", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€298K", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1539621006", cells: ["FRA-1006", "Franchise Compliance Item 1", "15/7/2026", "€21 106"], status: "active" as const },
    { id: "1539624577", cells: ["FRA-4577", "Franchise Compliance Item 2", "2/2/2026", "€24 677"], status: "pending" as const },
    { id: "1539628148", cells: ["FRA-8148", "Franchise Compliance Item 3", "17/9/2026", "€28 248"], status: "completed" as const },
    { id: "1539631719", cells: ["FRA-2719", "Franchise Compliance Item 4", "4/4/2026", "€31 819"], status: "warning" as const },
    { id: "1539635290", cells: ["FRA-6290", "Franchise Compliance Item 5", "19/11/2026", "€35 390"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Compliance</p>
                    </div>
                </div>
