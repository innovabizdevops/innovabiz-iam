...
const ACCENT = "#1d4ed8";
const MODULE = "Franchise Compliance";
const PAGE = "State";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.482","t":"-4.0%","d":"down"},{"l":"NC Abertas","v":"1.349","t":"+3.3%","d":"up"},{"l":"Conformidade (%)","v":"77.6%","t":"+2.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.674","t":"+4.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.301","93.0%","2.364","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.385","90.5%","7.249","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.366","92.0%","4.411","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","229","96.4%","5.673","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.351","76.6%","6.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":670},{"label":"Mar","value":512},{"label":"Abr","value":740},{"label":"Mai","value":551},{"label":"Jun","value":515},{"label":"Jul","value":790},{"label":"Ago","value":754},{"label":"Set","value":472},{"label":"Out","value":827},{"label":"Nov","value":540},{"label":"Dez","value":540}];
const MX = 827;
