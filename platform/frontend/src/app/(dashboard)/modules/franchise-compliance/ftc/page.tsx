...
const PAGE = "FTC";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.863","t":"-5.3%","d":"down"},{"l":"NC Abertas","v":"7.500","t":"+6.9%","d":"up"},{"l":"Conformidade (%)","v":"90.7%","t":"+0.6%","d":"up"},{"l":"CAPAs Pendentes","v":"5.877","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.284","71.5%","3.366","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.337","91.8%","8.670","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.372","81.9%","4.706","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.836","79.0%","4.229","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.817","83.6%","6.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":794},{"label":"Mar","value":946},{"label":"Abr","value":875},{"label":"Mai","value":825},{"label":"Jun","value":679},{"label":"Jul","value":650},{"label":"Ago","value":830},{"label":"Set","value":636},{"label":"Out","value":680},{"label":"Nov","value":904},{"label":"Dez","value":689}];
const MX = 946;
