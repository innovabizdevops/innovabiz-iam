...
const PAGE = "Brand Guidelines AI";
const KPIS = [{"l":"Artigos Publicados","v":"6.718","t":"-3.4%","d":"down"},{"l":"Views/Semana","v":"4294","t":"-3.4%","d":"down"},{"l":"Feedback Útil (%)","v":"87.7%","t":"+9.3%","d":"up"},{"l":"Artigos Desatualizados","v":"1.646","t":"+16.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.980","71.9%","8.496","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.415","82.6%","5.048","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.089","70.3%","3.182","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.464","76.1%","8.767","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.871","74.4%","8.082","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":811},{"label":"Mar","value":478},{"label":"Abr","value":627},{"label":"Mai","value":491},{"label":"Jun","value":729},{"label":"Jul","value":597},{"label":"Ago","value":471},{"label":"Set","value":705},{"label":"Out","value":562},{"label":"Nov","value":553},{"label":"Dez","value":790}];
const MX = 811;
