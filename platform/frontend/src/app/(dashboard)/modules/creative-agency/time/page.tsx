...
const PAGE = "Time Tracking";
const KPIS = [{"l":"Total Creative Agency","v":"1.588","t":"+6.6%","d":"up"},{"l":"Time Tracking Ativos","v":"985","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"82","t":"-3.3%","d":"down"}];
const COLS = ["ID","Time Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Creative Agency #001","Creative Agency #002","4.519","7.813","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Creative Agency #002","Creative Agency #003","2.797","5.526","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Creative Agency #003","Creative Agency #004","8.732","1.973","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Creative Agency #004","Creative Agency #005","3.978","6.528","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Creative Agency #005","Creative Agency #001","5.936","7.756","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":833},{"label":"Mar","value":845},{"label":"Abr","value":980},{"label":"Mai","value":750},{"label":"Jun","value":633},{"label":"Jul","value":927},{"label":"Ago","value":979},{"label":"Set","value":686},{"label":"Out","value":879},{"label":"Nov","value":691},{"label":"Dez","value":901}];
const MX = 980;
