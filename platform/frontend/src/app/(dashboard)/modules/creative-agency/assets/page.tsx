...
const PAGE = "Asset Library";
const KPIS = [{"l":"Ativos Registados","v":"247","t":"+13.9%","d":"up"},{"l":"Valor Total (€M)","v":"€44.3M","t":"-5.1%","d":"down"},{"l":"Depreciação Anual (€)","v":"€23239","t":"-4.8%","d":"down"},{"l":"Ativos em Garantia","v":"5.103","t":"+8.7%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 11696.66","2.629","€ 7245.38","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 38884.91","1.105","€ 44184.78","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 32040.69","8.897","€ 46716.93","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 14514.15","5.189","€ 9925.18","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 35643.57","3.475","€ 34431.40","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":459},{"label":"Mar","value":421},{"label":"Abr","value":462},{"label":"Mai","value":723},{"label":"Jun","value":631},{"label":"Jul","value":807},{"label":"Ago","value":736},{"label":"Set","value":802},{"label":"Out","value":525},{"label":"Nov","value":792},{"label":"Dez","value":782}];
const MX = 807;
