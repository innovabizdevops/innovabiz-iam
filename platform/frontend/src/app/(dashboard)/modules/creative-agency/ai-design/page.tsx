...
const ACCENT = "#c026d3";
const MODULE = "Creative Agency";
const PAGE = "AI Design Assist";
const KPIS = [{"l":"Formulários Ativos","v":"5.993","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"4485","t":"+16.8%","d":"up"},{"l":"Documentos Gerados","v":"7.917","t":"+2.9%","d":"up"},{"l":"Templates","v":"218","t":"+1.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.103","2026-01-23","7.867","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.844","2026-03-06","2.795","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.990","2026-03-22","7.492","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.312","2026-01-09","1.175","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.691","2026-03-28","3.050","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":908},{"label":"Mar","value":718},{"label":"Abr","value":846},{"label":"Mai","value":919},{"label":"Jun","value":694},{"label":"Jul","value":926},{"label":"Ago","value":893},{"label":"Set","value":836},{"label":"Out","value":652},{"label":"Nov","value":741},{"label":"Dez","value":757}];
const MX = 926;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c026d3'}}>AI</span></h1>
                </div>
