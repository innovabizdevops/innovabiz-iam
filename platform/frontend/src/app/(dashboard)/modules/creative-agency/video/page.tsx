...
const PAGE = "Video Production";
const KPIS = [{"l":"Total Creative Agency","v":"1.570","t":"+7.5%","d":"up"},{"l":"Video Production Ativos","v":"3.013","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+3.2%","d":"up"}];
const COLS = ["ID","Video Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Creative Agency #001","Creative Agency #002","2.992","6.243","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Creative Agency #002","Creative Agency #003","612","8.265","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Creative Agency #003","Creative Agency #004","5.650","2.426","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Creative Agency #004","Creative Agency #005","1.314","3.298","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Creative Agency #005","Creative Agency #001","384","6.575","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":571},{"label":"Mar","value":686},{"label":"Abr","value":646},{"label":"Mai","value":788},{"label":"Jun","value":589},{"label":"Jul","value":661},{"label":"Ago","value":840},{"label":"Set","value":586},{"label":"Out","value":788},{"label":"Nov","value":706},{"label":"Dez","value":651}];
const MX = 905;
