...
const PAGE = "Filing";
const KPIS = [{"l":"Total Arbitration Mgmt","v":"2.688","t":"+3.6%","d":"up"},{"l":"Filing Ativos","v":"2.874","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"70","t":"-2.3%","d":"down"}];
const COLS = ["ID","Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arbitration Mgmt #001","Arbitration Mgmt #002","8.395","8.887","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Arbitration Mgmt #002","Arbitration Mgmt #003","6.572","6.980","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Arbitration Mgmt #003","Arbitration Mgmt #004","2.052","5.546","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Arbitration Mgmt #004","Arbitration Mgmt #005","3.811","4.066","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arbitration Mgmt #005","Arbitration Mgmt #001","1.725","2.782","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1065},{"label":"Fev","value":851},{"label":"Mar","value":830},{"label":"Abr","value":959},{"label":"Mai","value":854},{"label":"Jun","value":690},{"label":"Jul","value":763},{"label":"Ago","value":682},{"label":"Set","value":1026},{"label":"Out","value":916},{"label":"Nov","value":684},{"label":"Dez","value":862}];
const MX = 1065;
