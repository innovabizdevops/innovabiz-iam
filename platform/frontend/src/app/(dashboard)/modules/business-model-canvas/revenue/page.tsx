...
const PAGE = "Revenue Model";
const KPIS = [{"l":"ARR (€M)","v":"€48.1M","t":"+11.8%","d":"up"},{"l":"MRR (€)","v":"€98875","t":"-0.2%","d":"down"},{"l":"Churn (%)","v":"73.9%","t":"+3.5%","d":"up"},{"l":"ARPU (€)","v":"€41201","t":"+11.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27157.34","8.635","€ 1635.88","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30567.48","2.141","€ 39191.30","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26159.86","578","€ 31091.79","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 9104.82","691","€ 10703.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 614.07","7.641","€ 49938.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":465},{"label":"Mar","value":660},{"label":"Abr","value":611},{"label":"Mai","value":461},{"label":"Jun","value":665},{"label":"Jul","value":725},{"label":"Ago","value":554},{"label":"Set","value":672},{"label":"Out","value":468},{"label":"Nov","value":499},{"label":"Dez","value":733}];
const MX = 733;
