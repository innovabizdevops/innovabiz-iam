...
const KPIS = [
    { label: "Total Registos", value: "1272", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2562", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€482K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1436659472", cells: ["BUS-8472", "Business Model Canvas Item 1", "25/9/2026", "€9572"], status: "active" as const },
    { id: "1436663043", cells: ["BUS-3043", "Business Model Canvas Item 2", "12/4/2026", "€13 143"], status: "pending" as const },
    { id: "1436666614", cells: ["BUS-6614", "Business Model Canvas Item 3", "27/11/2026", "€16 714"], status: "completed" as const },
    { id: "1436670185", cells: ["BUS-1185", "Business Model Canvas Item 4", "14/6/2026", "€20 285"], status: "warning" as const },
    { id: "1436673756", cells: ["BUS-4756", "Business Model Canvas Item 5", "1/1/2026", "€23 856"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business Model Canvas</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Business Model Canvas</p>
                    </div>
                </div>
