...
const ACCENT = "#2563eb";
const MODULE = "Business Model Canvas";
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"8.534","t":"+2.0%","d":"up"},{"l":"Simulações/Dia","v":"2570","t":"+14.5%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.2%","t":"+16.6%","d":"up"},{"l":"Latência Sync (ms)","v":"29ms","t":"+3.6%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","99.8%","2026-01-22","8.672","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","82.6%","2026-02-07","5.239","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.7%","2026-03-11","8.831","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.8%","2026-03-14","3.250","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","95.8%","2026-02-22","3.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":679},{"label":"Mar","value":752},{"label":"Abr","value":523},{"label":"Mai","value":841},{"label":"Jun","value":707},{"label":"Jul","value":769},{"label":"Ago","value":709},{"label":"Set","value":622},{"label":"Out","value":541},{"label":"Nov","value":485},{"label":"Dez","value":712}];
const MX = 841;
