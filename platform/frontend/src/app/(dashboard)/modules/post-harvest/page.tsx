...
/* ═══ Post-Harvest Management — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "3829", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1273", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€372K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1432504029", cells: ["POS-2029", "Post-Harvest Management Item 1", "6/10/2026", "€4129"], status: "active" as const },
    { id: "1432507600", cells: ["POS-5600", "Post-Harvest Management Item 2", "21/5/2026", "€7700"], status: "pending" as const },
    { id: "1432511171", cells: ["POS-9171", "Post-Harvest Management Item 3", "8/12/2026", "€11 271"], status: "completed" as const },
    { id: "1432514742", cells: ["POS-3742", "Post-Harvest Management Item 4", "23/7/2026", "€14 842"], status: "warning" as const },
    { id: "1432518313", cells: ["POS-7313", "Post-Harvest Management Item 5", "10/2/2026", "€18 413"], status: "active" as const },
];
...
export default function PostharvestManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Post-Harvest Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Post-Harvest Management</p>
                    </div>
                </div>
