...
const PAGE = "Loss";
const KPIS = [{"l":"Pedidos/Dia","v":"4986","t":"+7.0%","d":"up"},{"l":"GMV (€)","v":"€25709","t":"-1.7%","d":"down"},{"l":"Conversão (%)","v":"77.4%","t":"+0.1%","d":"up"},{"l":"AOV (€)","v":"€36036","t":"+2.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 5334.11","6.643","4.742","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 40021.48","3.004","7.698","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 40337.72","6.028","1.640","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 23490.98","3.374","5.616","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 34291.31","2.228","3.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":891},{"label":"Fev","value":706},{"label":"Mar","value":925},{"label":"Abr","value":974},{"label":"Mai","value":954},{"label":"Jun","value":724},{"label":"Jul","value":835},{"label":"Ago","value":1013},{"label":"Set","value":986},{"label":"Out","value":1094},{"label":"Nov","value":1015},{"label":"Dez","value":815}];
const MX = 1094;
