...
const ACCENT = "#166534";
const MODULE = "Post-Harvest Management";
const PAGE = "Store";
const KPIS = [{"l":"Pedidos/Dia","v":"4218","t":"-3.8%","d":"down"},{"l":"GMV (€)","v":"€64307","t":"-3.7%","d":"down"},{"l":"Conversão (%)","v":"88.7%","t":"+16.5%","d":"up"},{"l":"AOV (€)","v":"€61074","t":"+-0.0%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 44165.92","5.205","1.343","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 41875.52","7.665","7.297","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 27828.70","4.163","6.846","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 35122.95","4.986","5.393","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4215.32","5.929","432","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":351},{"label":"Mar","value":292},{"label":"Abr","value":583},{"label":"Mai","value":461},{"label":"Jun","value":354},{"label":"Jul","value":606},{"label":"Ago","value":609},{"label":"Set","value":281},{"label":"Out","value":525},{"label":"Nov","value":460},{"label":"Dez","value":443}];
const MX = 609;
