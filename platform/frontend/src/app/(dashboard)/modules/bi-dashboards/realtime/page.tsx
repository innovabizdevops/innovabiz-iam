...
const PAGE = "Real-Time Feeds";
const KPIS = [{"l":"Dashboards Ativos","v":"8.685","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"496","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.919","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.929","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","550","2026-01-20","683","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3326","2026-01-03","8.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2217","2026-03-01","1.379","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2287","2026-01-18","4.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3568","2026-02-01","2.593","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":896},{"label":"Mar","value":919},{"label":"Abr","value":678},{"label":"Mai","value":589},{"label":"Jun","value":882},{"label":"Jul","value":849},{"label":"Ago","value":769},{"label":"Set","value":829},{"label":"Out","value":600},{"label":"Nov","value":784},{"label":"Dez","value":668}];
const MX = 919;
