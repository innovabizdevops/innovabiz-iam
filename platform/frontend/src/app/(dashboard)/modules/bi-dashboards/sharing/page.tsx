...
const PAGE = "Sharing &amp; Access";
const KPIS = [{"l":"Dashboards Ativos","v":"859","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"4726","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"1.747","t":"+10.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.407","t":"+6.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1019","2026-03-17","386","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1039","2026-03-26","8.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3966","2026-01-27","1.526","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4046","2026-01-14","6.861","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","916","2026-01-24","5.285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":655},{"label":"Fev","value":520},{"label":"Mar","value":835},{"label":"Abr","value":605},{"label":"Mai","value":833},{"label":"Jun","value":828},{"label":"Jul","value":594},{"label":"Ago","value":874},{"label":"Set","value":907},{"label":"Out","value":639},{"label":"Nov","value":769},{"label":"Dez","value":548}];
const MX = 907;
