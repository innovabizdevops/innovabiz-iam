...
const PAGE = "Data Annotation";
const KPIS = [{"l":"Dashboards Ativos","v":"344","t":"-2.8%","d":"down"},{"l":"Queries/Dia","v":"3541","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"9.083","t":"+3.9%","d":"up"},{"l":"Utilizadores Analytics","v":"201","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2417","2026-03-04","5.667","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1966","2026-02-18","9.090","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1810","2026-03-23","6.139","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2750","2026-02-10","3.868","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1676","2026-01-21","5.206","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":557},{"label":"Mar","value":642},{"label":"Abr","value":405},{"label":"Mai","value":459},{"label":"Jun","value":458},{"label":"Jul","value":554},{"label":"Ago","value":654},{"label":"Set","value":710},{"label":"Out","value":502},{"label":"Nov","value":385},{"label":"Dez","value":537}];
const MX = 710;
