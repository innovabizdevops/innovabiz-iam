...
const PAGE = "Alert Rules";
const KPIS = [{"l":"Dashboards Ativos","v":"6.533","t":"+11.2%","d":"up"},{"l":"Queries/Dia","v":"1975","t":"+3.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.862","t":"+17.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.422","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3536","2026-01-24","3.775","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5069","2026-02-21","4.877","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","459","2026-02-27","2.738","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","790","2026-03-01","8.415","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1385","2026-03-24","5.393","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":934},{"label":"Mar","value":736},{"label":"Abr","value":612},{"label":"Mai","value":968},{"label":"Jun","value":673},{"label":"Jul","value":962},{"label":"Ago","value":920},{"label":"Set","value":709},{"label":"Out","value":673},{"label":"Nov","value":661},{"label":"Dez","value":954}];
const MX = 968;
