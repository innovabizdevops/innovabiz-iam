...
const KPIS = [{"l":"Dashboards Ativos","v":"1.328","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"1327","t":"+16.2%","d":"up"},{"l":"Dados Processados (GB)","v":"8.290","t":"+8.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.968","t":"-4.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3889","2026-01-10","4.626","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1426","2026-02-28","1.186","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2343","2026-03-19","2.224","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1506","2026-02-06","7.064","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","190","2026-02-03","4.680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":720},{"label":"Mar","value":795},{"label":"Abr","value":703},{"label":"Mai","value":643},{"label":"Jun","value":564},{"label":"Jul","value":695},{"label":"Ago","value":881},{"label":"Set","value":561},{"label":"Out","value":762},{"label":"Nov","value":749},{"label":"Dez","value":927}];
const MX = 927;
