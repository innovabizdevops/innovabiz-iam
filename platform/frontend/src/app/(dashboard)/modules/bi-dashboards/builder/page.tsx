...
const ACCENT = "#1e40af";
const MODULE = "BI Dashboards";
const PAGE = "Dashboard Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"5.040","t":"+16.8%","d":"up"},{"l":"Queries/Dia","v":"4355","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"6.313","t":"+1.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.764","t":"-1.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","281","2026-02-23","8.299","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","398","2026-01-12","4.856","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3139","2026-02-13","6.951","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","539","2026-03-08","964","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3667","2026-01-10","5.031","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":506},{"label":"Mar","value":500},{"label":"Abr","value":712},{"label":"Mai","value":709},{"label":"Jun","value":715},{"label":"Jul","value":754},{"label":"Ago","value":383},{"label":"Set","value":622},{"label":"Out","value":551},{"label":"Nov","value":508},{"label":"Dez","value":404}];
const MX = 754;
