...
const PAGE = "Mobile View";
const KPIS = [{"l":"Dashboards Ativos","v":"2.233","t":"+9.3%","d":"up"},{"l":"Queries/Dia","v":"4164","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.632","t":"+6.9%","d":"up"},{"l":"Utilizadores Analytics","v":"1.866","t":"-1.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1833","2026-01-12","4.570","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3405","2026-02-15","2.408","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2696","2026-03-16","6.934","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3960","2026-01-08","5.930","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2196","2026-02-24","4.673","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":791},{"label":"Mar","value":880},{"label":"Abr","value":892},{"label":"Mai","value":602},{"label":"Jun","value":647},{"label":"Jul","value":812},{"label":"Ago","value":571},{"label":"Set","value":710},{"label":"Out","value":834},{"label":"Nov","value":653},{"label":"Dez","value":771}];
const MX = 892;
