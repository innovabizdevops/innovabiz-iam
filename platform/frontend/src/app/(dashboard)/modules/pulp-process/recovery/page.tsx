...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.414","t":"+1.8%","d":"up"},{"l":"RTO Médio (h)","v":"186h","t":"+4.0%","d":"up"},{"l":"RPO Médio (h)","v":"139h","t":"+12.9%","d":"up"},{"l":"Testes DR (YTD)","v":"3.492","t":"+10.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","137h","187h","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","105h","145h","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","42h","170h","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","209h","61h","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","152h","40h","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":756},{"label":"Mar","value":778},{"label":"Abr","value":816},{"label":"Mai","value":661},{"label":"Jun","value":483},{"label":"Jul","value":766},{"label":"Ago","value":691},{"label":"Set","value":657},{"label":"Out","value":559},{"label":"Nov","value":690},{"label":"Dez","value":493}];
const MX = 816;
