...
export default function PulpProcessPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pulp Process</h1><p className="text-sm text-muted-foreground">Pulp Process • iBOS Enterprise</p></div>
