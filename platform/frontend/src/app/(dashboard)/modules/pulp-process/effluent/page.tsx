...
const PAGE = "Effluent";
const KPIS = [{"l":"Total Pulp Process","v":"2.898","t":"+0.6%","d":"up"},{"l":"Effluent Ativos","v":"3.807","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"62","t":"+12.0%","d":"up"}];
const COLS = ["ID","Effluent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Process #001","Pulp Process #002","5.666","7.490","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Process #002","Pulp Process #003","3.550","6.158","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Process #003","Pulp Process #004","3.689","5.750","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Process #004","Pulp Process #005","1.811","8.803","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Process #005","Pulp Process #001","253","298","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":737},{"label":"Mar","value":515},{"label":"Abr","value":438},{"label":"Mai","value":591},{"label":"Jun","value":720},{"label":"Jul","value":383},{"label":"Ago","value":670},{"label":"Set","value":582},{"label":"Out","value":547},{"label":"Nov","value":465},{"label":"Dez","value":375}];
const MX = 737;
...
export default function EffluentPage() {
    return (
