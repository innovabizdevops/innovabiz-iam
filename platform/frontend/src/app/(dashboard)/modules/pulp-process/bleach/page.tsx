...
const PAGE = "Bleaching";
const KPIS = [{"l":"Total Pulp Process","v":"1.480","t":"+8.8%","d":"up"},{"l":"Bleaching Ativos","v":"1.162","t":"+9.6%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"94","t":"-5.0%","d":"down"}];
const COLS = ["ID","Bleaching","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Process #001","Pulp Process #002","4.850","7.762","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Process #002","Pulp Process #003","6.198","6.073","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Process #003","Pulp Process #004","1.236","4.297","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Process #004","Pulp Process #005","2.709","5.356","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Process #005","Pulp Process #001","919","7.118","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":819},{"label":"Mar","value":745},{"label":"Abr","value":982},{"label":"Mai","value":792},{"label":"Jun","value":698},{"label":"Jul","value":803},{"label":"Ago","value":884},{"label":"Set","value":1020},{"label":"Out","value":891},{"label":"Nov","value":718},{"label":"Dez","value":926}];
const MX = 1020;
...
export default function BleachPage() {
    return (
