...
const PAGE = "Chip Handle";
const KPIS = [{"l":"Total Pulp Process","v":"4.443","t":"+6.9%","d":"up"},{"l":"Chip Handle Ativos","v":"5.111","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"68.1%","t":"+16.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+7.1%","d":"up"}];
const COLS = ["ID","Chip Handle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Process #001","Pulp Process #002","2.358","6.129","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Process #002","Pulp Process #003","7.023","766","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Process #003","Pulp Process #004","8.618","388","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Process #004","Pulp Process #005","1.610","3.272","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Process #005","Pulp Process #001","2.261","7.603","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":928},{"label":"Fev","value":601},{"label":"Mar","value":904},{"label":"Abr","value":812},{"label":"Mai","value":866},{"label":"Jun","value":788},{"label":"Jul","value":635},{"label":"Ago","value":659},{"label":"Set","value":710},{"label":"Out","value":673},{"label":"Nov","value":685},{"label":"Dez","value":585}];
const MX = 928;
