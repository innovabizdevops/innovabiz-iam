...
const ACCENT = "#0e7490";
const MODULE = "Pulp Processing";
const PAGE = "Digester";
const KPIS = [{"l":"Total Pulp Process","v":"6.237","t":"+3.9%","d":"up"},{"l":"Digester Ativos","v":"6.572","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"64","t":"-2.0%","d":"down"}];
const COLS = ["ID","Digester","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pulp Process #001","Pulp Process #002","6.939","8.442","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pulp Process #002","Pulp Process #003","8.100","4.878","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pulp Process #003","Pulp Process #004","4.688","6.099","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pulp Process #004","Pulp Process #005","7.259","3.472","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pulp Process #005","Pulp Process #001","7.962","3.984","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":834},{"label":"Mar","value":708},{"label":"Abr","value":685},{"label":"Mai","value":589},{"label":"Jun","value":886},{"label":"Jul","value":709},{"label":"Ago","value":682},{"label":"Set","value":612},{"label":"Out","value":675},{"label":"Nov","value":725},{"label":"Dez","value":863}];
const MX = 886;
...
export default function DigesterPage() {
    return (
