...
export default function BlueprintMgmtPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Blueprint Mgmt</h1><p className="text-sm text-muted-foreground">Blueprint Mgmt • iBOS Enterprise</p></div>
