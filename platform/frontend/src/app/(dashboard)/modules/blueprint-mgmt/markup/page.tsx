...
const ACCENT = "#7c3aed";
const MODULE = "Blueprint Management";
const PAGE = "Markup Tools";
const KPIS = [{"l":"Total Blueprint Mgmt","v":"5.764","t":"+13.0%","d":"up"},{"l":"Markup Tools Ativos","v":"7.546","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+8.5%","d":"up"}];
const COLS = ["ID","Markup Tools","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blueprint Mgmt #001","Blueprint Mgmt #002","1.110","4.716","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Blueprint Mgmt #002","Blueprint Mgmt #003","3.749","437","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Blueprint Mgmt #003","Blueprint Mgmt #004","3.114","1.446","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Blueprint Mgmt #004","Blueprint Mgmt #005","1.625","6.886","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blueprint Mgmt #005","Blueprint Mgmt #001","569","6.924","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":998},{"label":"Fev","value":1047},{"label":"Mar","value":964},{"label":"Abr","value":954},{"label":"Mai","value":694},{"label":"Jun","value":708},{"label":"Jul","value":1061},{"label":"Ago","value":1068},{"label":"Set","value":932},{"label":"Out","value":994},{"label":"Nov","value":947},{"label":"Dez","value":867}];
const MX = 1068;
