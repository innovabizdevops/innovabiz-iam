...
const KPIS = [{"l":"Formulários Ativos","v":"4.232","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"384","t":"+2.8%","d":"up"},{"l":"Documentos Gerados","v":"737","t":"+9.3%","d":"up"},{"l":"Templates","v":"5.781","t":"+2.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.747","2026-02-27","6.233","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","353","2026-02-02","5.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.856","2026-03-27","4.753","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.362","2026-02-24","4.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.643","2026-01-06","1.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":640},{"label":"Mar","value":777},{"label":"Abr","value":443},{"label":"Mai","value":741},{"label":"Jun","value":600},{"label":"Jul","value":774},{"label":"Ago","value":748},{"label":"Set","value":548},{"label":"Out","value":761},{"label":"Nov","value":775},{"label":"Dez","value":764}];
const MX = 777;
