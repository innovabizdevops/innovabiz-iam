...
const PAGE = "Archive";
const KPIS = [{"l":"Total Blueprint Mgmt","v":"5.833","t":"+16.4%","d":"up"},{"l":"Archive Ativos","v":"8.978","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"77.5%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"72","t":"+5.2%","d":"up"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blueprint Mgmt #001","Blueprint Mgmt #002","829","8.962","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Blueprint Mgmt #002","Blueprint Mgmt #003","1.740","8.004","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Blueprint Mgmt #003","Blueprint Mgmt #004","1.462","8.721","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Blueprint Mgmt #004","Blueprint Mgmt #005","7.108","5.946","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blueprint Mgmt #005","Blueprint Mgmt #001","2.664","4.412","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":347},{"label":"Mar","value":562},{"label":"Abr","value":593},{"label":"Mai","value":488},{"label":"Jun","value":663},{"label":"Jul","value":483},{"label":"Ago","value":649},{"label":"Set","value":706},{"label":"Out","value":585},{"label":"Nov","value":719},{"label":"Dez","value":453}];
const MX = 719;
