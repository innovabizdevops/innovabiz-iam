...
const ACCENT = "#15803d";
const MODULE = "Multi-Currency Engine";
const PAGE = "Exchange Rates";
const KPIS = [{"l":"Total Multi Currency","v":"6.439","t":"+0.4%","d":"up"},{"l":"Exchange Rates Ativos","v":"6.250","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"55","t":"+15.8%","d":"up"}];
const COLS = ["ID","Exchange Rates","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Currency #001","Multi Currency #002","5.508","357","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Currency #002","Multi Currency #003","2.475","8.720","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Currency #003","Multi Currency #004","7.423","588","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Currency #004","Multi Currency #005","2.284","8.607","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Currency #005","Multi Currency #001","1.650","3.808","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":854},{"label":"Mar","value":738},{"label":"Abr","value":932},{"label":"Mai","value":675},{"label":"Jun","value":704},{"label":"Jul","value":658},{"label":"Ago","value":940},{"label":"Set","value":657},{"label":"Out","value":928},{"label":"Nov","value":751},{"label":"Dez","value":906}];
const MX = 940;
