...
const PAGE = "Currency Conversion";
const KPIS = [{"l":"Formulários Ativos","v":"5.993","t":"+10.8%","d":"up"},{"l":"Submissões/Dia","v":"3523","t":"+4.7%","d":"up"},{"l":"Documentos Gerados","v":"8.110","t":"+8.3%","d":"up"},{"l":"Templates","v":"918","t":"-0.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.009","2026-03-06","2.698","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.764","2026-03-14","4.011","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.981","2026-03-01","8.132","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.048","2026-01-14","1.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.710","2026-01-10","5.282","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":500},{"label":"Mar","value":661},{"label":"Abr","value":759},{"label":"Mai","value":724},{"label":"Jun","value":506},{"label":"Jul","value":660},{"label":"Ago","value":639},{"label":"Set","value":742},{"label":"Out","value":447},{"label":"Nov","value":724},{"label":"Dez","value":479}];
const MX = 766;
