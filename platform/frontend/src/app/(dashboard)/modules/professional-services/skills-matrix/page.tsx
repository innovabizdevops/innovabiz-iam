...
const PAGE = "Skills Matrix";
const KPIS = [{"l":"Total Professional Services","v":"7.677","t":"+3.6%","d":"up"},{"l":"Skills Matrix Ativos","v":"4.390","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"67.6%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+11.7%","d":"up"}];
const COLS = ["ID","Skills Matrix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Professional Services #001","Professional Services #002","4.620","5.077","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Professional Services #002","Professional Services #003","2.340","2.680","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Professional Services #003","Professional Services #004","4.370","2.416","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Professional Services #004","Professional Services #005","8.336","4.089","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Professional Services #005","Professional Services #001","3.176","5.907","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":583},{"label":"Mar","value":413},{"label":"Abr","value":614},{"label":"Mai","value":585},{"label":"Jun","value":275},{"label":"Jul","value":620},{"label":"Ago","value":529},{"label":"Set","value":553},{"label":"Out","value":253},{"label":"Nov","value":292},{"label":"Dez","value":280}];
const MX = 620;
