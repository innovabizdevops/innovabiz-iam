...
const PAGE = "Revenue Forecasting";
const KPIS = [{"l":"ARR (€M)","v":"€20.5M","t":"-3.3%","d":"down"},{"l":"MRR (€)","v":"€39647","t":"+14.8%","d":"up"},{"l":"Churn (%)","v":"84.5%","t":"-2.0%","d":"down"},{"l":"ARPU (€)","v":"€10063","t":"+1.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49058.53","3.131","€ 36306.76","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 10735.32","3.612","€ 29381.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13413.26","5.376","€ 41847.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1468.27","4.149","€ 35175.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16422.22","1.307","€ 6648.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":763},{"label":"Mar","value":498},{"label":"Abr","value":797},{"label":"Mai","value":641},{"label":"Jun","value":711},{"label":"Jul","value":736},{"label":"Ago","value":460},{"label":"Set","value":843},{"label":"Out","value":514},{"label":"Nov","value":477},{"label":"Dez","value":629}];
const MX = 843;
