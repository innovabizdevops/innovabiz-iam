...
const ACCENT = "#6d28d9";
const MODULE = "Professional Services";
const PAGE = "Profitability Chart";
const KPIS = [{"l":"Total Professional Services","v":"2.135","t":"+4.4%","d":"up"},{"l":"Profitability Chart Ativos","v":"5.243","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"66","t":"+4.1%","d":"up"}];
const COLS = ["ID","Profitability Chart","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Professional Services #001","Professional Services #002","5.429","5.375","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional Services #002","Professional Services #003","2.081","1.780","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Professional Services #003","Professional Services #004","6.077","5.725","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Professional Services #004","Professional Services #005","1.928","1.022","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Professional Services #005","Professional Services #001","6.928","9.069","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":833},{"label":"Mar","value":801},{"label":"Abr","value":765},{"label":"Mai","value":792},{"label":"Jun","value":701},{"label":"Jul","value":779},{"label":"Ago","value":670},{"label":"Set","value":611},{"label":"Out","value":913},{"label":"Nov","value":902},{"label":"Dez","value":636}];
const MX = 913;
...
export default function ProfitabilityProfessionalServicesPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>Chart</span></h1>
                </div>
