...
const KPIS = [{"l":"eNPS","v":"58","t":"+0.6%","d":"up"},{"l":"Engagement (%)","v":"73.2%","t":"+7.1%","d":"up"},{"l":"Turnover (%)","v":"87.7%","t":"-3.0%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.348","t":"+8.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.941","2026-01-14","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","628","2026-03-11","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.085","2026-02-15","85","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.125","2026-01-09","84","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.129","2026-03-02","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":553},{"label":"Mar","value":336},{"label":"Abr","value":591},{"label":"Mai","value":365},{"label":"Jun","value":501},{"label":"Jul","value":395},{"label":"Ago","value":418},{"label":"Set","value":540},{"label":"Out","value":459},{"label":"Nov","value":444},{"label":"Dez","value":568}];
const MX = 591;
