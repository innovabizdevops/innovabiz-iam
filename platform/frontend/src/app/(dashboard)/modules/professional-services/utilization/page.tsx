...
const PAGE = "Utilization Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"1.465","t":"+10.1%","d":"up"},{"l":"Queries/Dia","v":"5092","t":"+1.6%","d":"up"},{"l":"Dados Processados (GB)","v":"2.262","t":"+11.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.311","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","582","2026-01-17","8.116","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2694","2026-01-13","8.305","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2363","2026-02-18","1.776","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2549","2026-01-24","2.759","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1173","2026-02-13","2.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":837},{"label":"Fev","value":592},{"label":"Mar","value":501},{"label":"Abr","value":634},{"label":"Mai","value":467},{"label":"Jun","value":709},{"label":"Jul","value":529},{"label":"Ago","value":545},{"label":"Set","value":795},{"label":"Out","value":794},{"label":"Nov","value":659},{"label":"Dez","value":736}];
const MX = 837;
