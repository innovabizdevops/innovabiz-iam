...
const PAGE = "Knowledge Sharing";
const KPIS = [{"l":"Artigos Publicados","v":"2.469","t":"+13.5%","d":"up"},{"l":"Views/Semana","v":"1078","t":"-5.7%","d":"down"},{"l":"Feedback Útil (%)","v":"73.1%","t":"-0.7%","d":"down"},{"l":"Artigos Desatualizados","v":"3.487","t":"+15.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.237","71.3%","6.956","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","688","84.4%","3.685","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.596","86.8%","8.042","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.629","78.8%","331","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.979","94.1%","2.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":276},{"label":"Mar","value":466},{"label":"Abr","value":547},{"label":"Mai","value":296},{"label":"Jun","value":290},{"label":"Jul","value":288},{"label":"Ago","value":279},{"label":"Set","value":442},{"label":"Out","value":432},{"label":"Nov","value":370},{"label":"Dez","value":273}];
const MX = 547;
