...
const PAGE = "Resource Planning";
const KPIS = [{"l":"Total Professional Services","v":"676","t":"+3.5%","d":"up"},{"l":"Resource Planning Ativos","v":"7.224","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"65","t":"+4.5%","d":"up"}];
const COLS = ["ID","Resource Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Professional Services #001","Professional Services #002","8.455","7.655","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Professional Services #002","Professional Services #003","1.349","3.388","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Professional Services #003","Professional Services #004","8.835","2.484","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Professional Services #004","Professional Services #005","5.225","7.951","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Professional Services #005","Professional Services #001","1.098","7.117","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":817},{"label":"Mar","value":977},{"label":"Abr","value":726},{"label":"Mai","value":921},{"label":"Jun","value":842},{"label":"Jul","value":831},{"label":"Ago","value":984},{"label":"Set","value":782},{"label":"Out","value":754},{"label":"Nov","value":836},{"label":"Dez","value":851}];
const MX = 984;
