...
const ACCENT = "#854d0e";
const MODULE = "Glass Packaging";
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"1.071","t":"+13.7%","d":"up"},{"l":"Submissões/Dia","v":"2472","t":"+3.6%","d":"up"},{"l":"Documentos Gerados","v":"8.389","t":"+5.7%","d":"up"},{"l":"Templates","v":"8.481","t":"+7.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.762","2026-01-01","6.797","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.864","2026-03-01","5.811","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","309","2026-01-09","4.417","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.539","2026-01-21","6.158","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.317","2026-02-27","7.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":780},{"label":"Mar","value":823},{"label":"Abr","value":570},{"label":"Mai","value":636},{"label":"Jun","value":730},{"label":"Jul","value":748},{"label":"Ago","value":596},{"label":"Set","value":850},{"label":"Out","value":916},{"label":"Nov","value":772},{"label":"Dez","value":646}];
const MX = 916;
