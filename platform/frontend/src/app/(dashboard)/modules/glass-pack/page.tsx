...
/* ═══ Glass Packaging — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "4349", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1871", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€29K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1569292849", cells: ["GLA-8849", "Glass Packaging Item 1", "6/2/2026", "€42 949"], status: "active" as const },
    { id: "1569296420", cells: ["GLA-3420", "Glass Packaging Item 2", "21/9/2026", "€46 520"], status: "pending" as const },
    { id: "1569299991", cells: ["GLA-6991", "Glass Packaging Item 3", "8/4/2026", "€50 091"], status: "completed" as const },
    { id: "1569303562", cells: ["GLA-1562", "Glass Packaging Item 4", "23/11/2026", "€3662"], status: "warning" as const },
    { id: "1569307133", cells: ["GLA-5133", "Glass Packaging Item 5", "10/6/2026", "€7233"], status: "active" as const },
];
...
export default function GlassPackagingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Glass Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Glass Packaging</p>
                    </div>
                </div>
