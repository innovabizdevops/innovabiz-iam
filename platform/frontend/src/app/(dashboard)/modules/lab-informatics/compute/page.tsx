...
const ACCENT = "#dc2626";
const MODULE = "Lab Informatics";
const PAGE = "Scientific Compute";
const KPIS = [{"l":"Formulários Ativos","v":"5.861","t":"-0.4%","d":"down"},{"l":"Submissões/Dia","v":"1432","t":"-0.2%","d":"down"},{"l":"Documentos Gerados","v":"395","t":"+4.0%","d":"up"},{"l":"Templates","v":"4.839","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.301","2026-01-15","7.740","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.565","2026-01-26","6.590","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.640","2026-02-23","4.177","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.662","2026-03-16","7.567","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.752","2026-02-23","7.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":399},{"label":"Mar","value":352},{"label":"Abr","value":311},{"label":"Mai","value":312},{"label":"Jun","value":256},{"label":"Jul","value":296},{"label":"Ago","value":279},{"label":"Set","value":599},{"label":"Out","value":291},{"label":"Nov","value":469},{"label":"Dez","value":276}];
const MX = 599;
