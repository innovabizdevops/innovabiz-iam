...
export default function LabInformaticsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lab Informatics</h1><p className="text-sm text-muted-foreground">Lab Informatics • iBOS Enterprise</p></div>
