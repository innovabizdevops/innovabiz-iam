...
const PAGE = "Data Lake";
const KPIS = [{"l":"Formulários Ativos","v":"7.110","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"899","t":"+12.6%","d":"up"},{"l":"Documentos Gerados","v":"191","t":"+12.8%","d":"up"},{"l":"Templates","v":"5.092","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.463","2026-02-07","2.894","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.463","2026-01-09","7.415","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.757","2026-02-05","1.315","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.748","2026-03-03","3.975","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.018","2026-01-25","6.391","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":929},{"label":"Mar","value":772},{"label":"Abr","value":818},{"label":"Mai","value":987},{"label":"Jun","value":631},{"label":"Jul","value":790},{"label":"Ago","value":627},{"label":"Set","value":615},{"label":"Out","value":857},{"label":"Nov","value":763},{"label":"Dez","value":680}];
const MX = 987;
