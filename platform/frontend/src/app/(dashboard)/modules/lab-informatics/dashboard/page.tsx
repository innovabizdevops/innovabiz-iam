...
const KPIS = [{"l":"Formulários Ativos","v":"1.158","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"4476","t":"+11.7%","d":"up"},{"l":"Documentos Gerados","v":"7.700","t":"+8.8%","d":"up"},{"l":"Templates","v":"5.859","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.040","2026-01-20","6.750","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.164","2026-03-14","8.212","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.556","2026-02-04","6.216","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","776","2026-02-21","3.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.534","2026-02-13","8.524","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":341},{"label":"Mar","value":391},{"label":"Abr","value":589},{"label":"Mai","value":302},{"label":"Jun","value":637},{"label":"Jul","value":287},{"label":"Ago","value":291},{"label":"Set","value":379},{"label":"Out","value":404},{"label":"Nov","value":258},{"label":"Dez","value":311}];
const MX = 637;
