...
const PAGE = "Instrument Integ";
const KPIS = [{"l":"Formulários Ativos","v":"7.700","t":"+11.8%","d":"up"},{"l":"Submissões/Dia","v":"3653","t":"+14.3%","d":"up"},{"l":"Documentos Gerados","v":"4.025","t":"-0.8%","d":"down"},{"l":"Templates","v":"6.526","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.236","2026-01-06","5.922","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.621","2026-01-25","5.206","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.898","2026-02-08","3.609","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.594","2026-03-07","301","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.409","2026-03-06","8.728","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":487},{"label":"Mar","value":451},{"label":"Abr","value":446},{"label":"Mai","value":622},{"label":"Jun","value":510},{"label":"Jul","value":454},{"label":"Ago","value":413},{"label":"Set","value":381},{"label":"Out","value":626},{"label":"Nov","value":697},{"label":"Dez","value":372}];
const MX = 697;
