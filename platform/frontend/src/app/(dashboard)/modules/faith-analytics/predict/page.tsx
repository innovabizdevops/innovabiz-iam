...
const ACCENT = "#4c1d95";
const MODULE = "Faith Organization Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.406","t":"+9.6%","d":"up"},{"l":"Queries/Dia","v":"3697","t":"-2.7%","d":"down"},{"l":"Dados Processados (GB)","v":"4.608","t":"-0.3%","d":"down"},{"l":"Utilizadores Analytics","v":"7.263","t":"+5.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4159","2026-03-25","2.945","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4196","2026-03-17","9.020","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2275","2026-02-11","3.804","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1357","2026-01-21","4.266","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2450","2026-01-21","7.459","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":901},{"label":"Mar","value":925},{"label":"Abr","value":673},{"label":"Mai","value":861},{"label":"Jun","value":665},{"label":"Jul","value":897},{"label":"Ago","value":723},{"label":"Set","value":842},{"label":"Out","value":888},{"label":"Nov","value":669},{"label":"Dez","value":688}];
const MX = 970;
