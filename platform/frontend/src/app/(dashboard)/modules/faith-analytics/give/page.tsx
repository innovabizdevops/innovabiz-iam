...
const PAGE = "Give";
const KPIS = [{"l":"Dashboards Ativos","v":"8.953","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"1246","t":"+16.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.916","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.009","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1549","2026-02-26","4.368","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3672","2026-02-21","7.427","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3156","2026-02-05","4.044","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","618","2026-01-06","9.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1158","2026-02-22","3.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":458},{"label":"Mar","value":661},{"label":"Abr","value":641},{"label":"Mai","value":407},{"label":"Jun","value":636},{"label":"Jul","value":528},{"label":"Ago","value":538},{"label":"Set","value":605},{"label":"Out","value":477},{"label":"Nov","value":596},{"label":"Dez","value":621}];
const MX = 661;
