...
/* ═══ Faith Organization Analytics — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "9954", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "829", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€383K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "701038754", cells: ["FAI-2754", "Faith Organization Analytics Item 1", "11/3/2026", "€38 854"], status: "active" as const },
    { id: "701042325", cells: ["FAI-6325", "Faith Organization Analytics Item 2", "26/10/2026", "€42 425"], status: "pending" as const },
    { id: "701045896", cells: ["FAI-9896", "Faith Organization Analytics Item 3", "13/5/2026", "€45 996"], status: "completed" as const },
    { id: "701049467", cells: ["FAI-4467", "Faith Organization Analytics Item 4", "28/12/2026", "€49 567"], status: "warning" as const },
    { id: "701053038", cells: ["FAI-8038", "Faith Organization Analytics Item 5", "15/7/2026", "€3138"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 54 }, { label: "Fev", value: 63 }, { label: "Mar", value: 72 }, { label: "Abr", value: 81 }, { label: "Mai", value: 90 }, { label: "Jun", value: 99 }];
...
export default function FaithOrganizationAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Faith Organization Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Faith Organization Analytics</p>
                    </div>
                </div>
