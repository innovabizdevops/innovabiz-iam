...
const PAGE = "Engage";
const KPIS = [{"l":"Dashboards Ativos","v":"634","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"1849","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.818","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"5.804","t":"+14.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2315","2026-01-25","3.385","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","545","2026-03-23","3.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1615","2026-03-24","7.788","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2805","2026-01-22","3.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4500","2026-03-17","2.627","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":910},{"label":"Mar","value":739},{"label":"Abr","value":926},{"label":"Mai","value":976},{"label":"Jun","value":904},{"label":"Jul","value":669},{"label":"Ago","value":769},{"label":"Set","value":987},{"label":"Out","value":718},{"label":"Nov","value":837},{"label":"Dez","value":898}];
const MX = 987;
