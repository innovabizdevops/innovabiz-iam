...
const PAGE = "Growth";
const KPIS = [{"l":"Dashboards Ativos","v":"5.856","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"867","t":"-3.9%","d":"down"},{"l":"Dados Processados (GB)","v":"939","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"1.943","t":"+11.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4808","2026-03-13","4.081","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4584","2026-02-04","8.620","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2745","2026-03-12","6.059","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4792","2026-01-26","5.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2686","2026-01-26","2.234","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":775},{"label":"Mar","value":814},{"label":"Abr","value":696},{"label":"Mai","value":565},{"label":"Jun","value":603},{"label":"Jul","value":602},{"label":"Ago","value":513},{"label":"Set","value":589},{"label":"Out","value":527},{"label":"Nov","value":780},{"label":"Dez","value":535}];
const MX = 814;
