...
const PAGE = "Volunteer";
const KPIS = [{"l":"Dashboards Ativos","v":"4.577","t":"-1.0%","d":"down"},{"l":"Queries/Dia","v":"1203","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"1.063","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"3.377","t":"+1.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2671","2026-02-13","4.584","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1749","2026-02-26","1.855","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1031","2026-01-23","8.611","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1027","2026-01-11","2.884","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4725","2026-01-17","8.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":759},{"label":"Mar","value":775},{"label":"Abr","value":932},{"label":"Mai","value":757},{"label":"Jun","value":625},{"label":"Jul","value":620},{"label":"Ago","value":797},{"label":"Set","value":590},{"label":"Out","value":809},{"label":"Nov","value":905},{"label":"Dez","value":884}];
const MX = 932;
