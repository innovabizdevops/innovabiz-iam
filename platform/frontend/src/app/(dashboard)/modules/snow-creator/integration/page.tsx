...
const PAGE = "Integration Hub";
const KPIS = [{"l":"Integrações Ativas","v":"8.614","t":"+10.6%","d":"up"},{"l":"Chamadas/Hora","v":"1832","t":"+9.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.4%","t":"-3.0%","d":"down"},{"l":"Latência Média (ms)","v":"41ms","t":"+17.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.332","8.414","78.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.077","1.526","88.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.190","8.488","81.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.734","3.736","81.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.986","2.211","82.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":675},{"label":"Mar","value":583},{"label":"Abr","value":361},{"label":"Mai","value":673},{"label":"Jun","value":371},{"label":"Jul","value":402},{"label":"Ago","value":535},{"label":"Set","value":522},{"label":"Out","value":603},{"label":"Nov","value":393},{"label":"Dez","value":585}];
const MX = 675;
