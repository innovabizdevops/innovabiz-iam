...
const ACCENT = "#81b5a1";
const MODULE = "Creator Workflow (SNOW)";
const PAGE = "Document AI";
const KPIS = [{"l":"Formulários Ativos","v":"8.789","t":"-0.3%","d":"down"},{"l":"Submissões/Dia","v":"2922","t":"+13.4%","d":"up"},{"l":"Documentos Gerados","v":"5.991","t":"+10.8%","d":"up"},{"l":"Templates","v":"4.493","t":"-3.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.446","2026-02-12","4.689","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","622","2026-02-17","7.548","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.733","2026-01-07","2.262","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.947","2026-01-09","4.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.567","2026-03-18","6.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":366},{"label":"Mar","value":343},{"label":"Abr","value":429},{"label":"Mai","value":567},{"label":"Jun","value":488},{"label":"Jul","value":663},{"label":"Ago","value":662},{"label":"Set","value":545},{"label":"Out","value":583},{"label":"Nov","value":408},{"label":"Dez","value":486}];
const MX = 663;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#81b5a1'}}>AI</span></h1>
                </div>
