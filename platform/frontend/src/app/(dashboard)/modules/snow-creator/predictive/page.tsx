...
const KPIS = [{"l":"Integrações Ativas","v":"3.554","t":"-4.7%","d":"down"},{"l":"Chamadas/Hora","v":"869","t":"+2.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.6%","t":"-5.3%","d":"down"},{"l":"Latência Média (ms)","v":"63ms","t":"-2.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.997","2.405","89.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.683","882","81.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.899","178","81.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.626","7.376","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.945","3.380","78.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":929},{"label":"Mar","value":862},{"label":"Abr","value":653},{"label":"Mai","value":716},{"label":"Jun","value":741},{"label":"Jul","value":920},{"label":"Ago","value":991},{"label":"Set","value":739},{"label":"Out","value":732},{"label":"Nov","value":785},{"label":"Dez","value":697}];
const MX = 994;
