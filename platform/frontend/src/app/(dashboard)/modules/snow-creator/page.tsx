...
/* ═══ Creator Workflow (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "3603", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1355", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€19K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "46949303", cells: ["SNO-6303", "Creator Workflow (SNOW) Item 1", "24/12/2026", "€49 403"], status: "active" as const },
    { id: "46952874", cells: ["SNO-9874", "Creator Workflow (SNOW) Item 2", "11/7/2026", "€2974"], status: "pending" as const },
    { id: "46956445", cells: ["SNO-4445", "Creator Workflow (SNOW) Item 3", "26/2/2026", "€6545"], status: "completed" as const },
    { id: "46960016", cells: ["SNO-8016", "Creator Workflow (SNOW) Item 4", "13/9/2026", "€10 116"], status: "warning" as const },
    { id: "46963587", cells: ["SNO-2587", "Creator Workflow (SNOW) Item 5", "28/4/2026", "€13 687"], status: "active" as const },
];
...
export default function CreatorWorkflowSnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Creator Workflow (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Creator Workflow (SNOW)</p>
                    </div>
                </div>
