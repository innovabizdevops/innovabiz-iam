...
const PAGE = "EV Fleet";
const KPIS = [{"l":"Projetos Melhoria","v":"3.516","t":"-2.7%","d":"down"},{"l":"Savings (€)","v":"€76585","t":"+4.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.6%","t":"+11.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.826","t":"+0.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.953","€ 32439.87","5.051","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.345","€ 11699.76","6.741","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.902","€ 1213.24","2.111","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","463","€ 22569.08","4.909","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.559","€ 34070.92","3.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":751},{"label":"Mar","value":909},{"label":"Abr","value":809},{"label":"Mai","value":1034},{"label":"Jun","value":861},{"label":"Jul","value":1000},{"label":"Ago","value":1040},{"label":"Set","value":742},{"label":"Out","value":708},{"label":"Nov","value":732},{"label":"Dez","value":760}];
const MX = 1040;
