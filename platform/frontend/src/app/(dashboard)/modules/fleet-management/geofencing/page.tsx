...
const KPIS = [{"l":"Projetos Melhoria","v":"2.031","t":"-3.1%","d":"down"},{"l":"Savings (€)","v":"€78451","t":"-3.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.3%","t":"-4.1%","d":"down"},{"l":"Ciclos PDCA","v":"2.629","t":"+2.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.724","€ 24215.61","507","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.300","€ 25468.96","1.874","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.789","€ 11080.58","1.175","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.244","€ 3580.32","3.282","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.488","€ 2363.82","3.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":960},{"label":"Mar","value":721},{"label":"Abr","value":638},{"label":"Mai","value":902},{"label":"Jun","value":728},{"label":"Jul","value":984},{"label":"Ago","value":617},{"label":"Set","value":799},{"label":"Out","value":747},{"label":"Nov","value":712},{"label":"Dez","value":988}];
const MX = 988;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#b45309'}}>GIS</span></h1>
                </div>
