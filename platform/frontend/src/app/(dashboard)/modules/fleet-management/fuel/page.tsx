...
const PAGE = "Fuel Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.961","t":"+12.1%","d":"up"},{"l":"Savings (€)","v":"€95743","t":"+14.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.1%","t":"+0.5%","d":"up"},{"l":"Ciclos PDCA","v":"3.563","t":"+6.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.441","€ 30680.35","7.132","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.665","€ 27338.62","6.557","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.444","€ 20889.69","6.698","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","947","€ 31076.71","7.454","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.541","€ 32878.63","4.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":467},{"label":"Fev","value":418},{"label":"Mar","value":557},{"label":"Abr","value":438},{"label":"Mai","value":399},{"label":"Jun","value":417},{"label":"Jul","value":703},{"label":"Ago","value":373},{"label":"Set","value":469},{"label":"Out","value":627},{"label":"Nov","value":569},{"label":"Dez","value":631}];
const MX = 703;
