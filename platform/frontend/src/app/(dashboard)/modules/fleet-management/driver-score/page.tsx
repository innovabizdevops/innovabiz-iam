...
const PAGE = "Driver Scoring";
const KPIS = [{"l":"Projetos Melhoria","v":"7.278","t":"+14.3%","d":"up"},{"l":"Savings (€)","v":"€43431","t":"+12.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"82.9%","t":"-3.8%","d":"down"},{"l":"Ciclos PDCA","v":"5.220","t":"-3.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.180","€ 3466.72","2.082","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.884","€ 24276.32","621","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.049","€ 12321.88","8.039","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.294","€ 26159.21","409","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","347","€ 47655.33","7.358","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":829},{"label":"Mar","value":831},{"label":"Abr","value":848},{"label":"Mai","value":523},{"label":"Jun","value":745},{"label":"Jul","value":451},{"label":"Ago","value":458},{"label":"Set","value":503},{"label":"Out","value":599},{"label":"Nov","value":519},{"label":"Dez","value":650}];
const MX = 848;
