...
const PAGE = "Route Optimization";
const KPIS = [{"l":"Projetos Melhoria","v":"6.929","t":"+2.5%","d":"up"},{"l":"Savings (€)","v":"€33631","t":"+0.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.9%","t":"-3.6%","d":"down"},{"l":"Ciclos PDCA","v":"4.960","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.264","€ 29572.75","7.914","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.425","€ 46803.04","2.221","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.231","€ 18714.81","2.167","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.006","€ 47903.85","3.157","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.212","€ 22581.33","2.452","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":476},{"label":"Mar","value":526},{"label":"Abr","value":623},{"label":"Mai","value":599},{"label":"Jun","value":511},{"label":"Jul","value":507},{"label":"Ago","value":437},{"label":"Set","value":591},{"label":"Out","value":537},{"label":"Nov","value":394},{"label":"Dez","value":541}];
const MX = 623;
