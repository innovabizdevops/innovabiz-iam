...
const PAGE = "Maintenance Schedule";
const KPIS = [{"l":"Projetos Melhoria","v":"1.359","t":"+12.9%","d":"up"},{"l":"Savings (€)","v":"€93255","t":"+16.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.2%","t":"+1.6%","d":"up"},{"l":"Ciclos PDCA","v":"4.409","t":"+12.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.147","€ 30375.30","2.366","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","507","€ 31322.61","5.073","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.068","€ 12962.65","5.882","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.054","€ 31575.34","6.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.234","€ 45273.74","7.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":763},{"label":"Mar","value":479},{"label":"Abr","value":494},{"label":"Mai","value":816},{"label":"Jun","value":484},{"label":"Jul","value":526},{"label":"Ago","value":554},{"label":"Set","value":555},{"label":"Out","value":663},{"label":"Nov","value":813},{"label":"Dez","value":552}];
const MX = 816;
