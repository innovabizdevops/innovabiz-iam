...
const KPIS = [{"l":"Projetos Melhoria","v":"3.123","t":"+5.7%","d":"up"},{"l":"Savings (€)","v":"€34857","t":"+0.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.0%","t":"+7.8%","d":"up"},{"l":"Ciclos PDCA","v":"8.677","t":"+3.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.156","€ 38745.29","5.278","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.302","€ 45533.00","2.611","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.564","€ 9585.69","6.624","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.012","€ 19471.69","5.884","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.106","€ 24318.84","5.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":1025},{"label":"Mar","value":898},{"label":"Abr","value":796},{"label":"Mai","value":906},{"label":"Jun","value":772},{"label":"Jul","value":1019},{"label":"Ago","value":880},{"label":"Set","value":792},{"label":"Out","value":1024},{"label":"Nov","value":874},{"label":"Dez","value":904}];
const MX = 1025;
