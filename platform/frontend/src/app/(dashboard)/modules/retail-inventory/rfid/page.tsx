...
const ACCENT = "#6366f1";
const MODULE = "Retail Inventory";
const PAGE = "RFID";
const KPIS = [{"l":"Pedidos/Dia","v":"4301","t":"+4.3%","d":"up"},{"l":"GMV (€)","v":"€64014","t":"+6.5%","d":"up"},{"l":"Conversão (%)","v":"74.1%","t":"+16.6%","d":"up"},{"l":"AOV (€)","v":"€96342","t":"+1.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 13491.48","8.546","2.427","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35622.59","6.539","3.362","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 49095.39","2.184","6.399","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 12437.79","8.708","6.949","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 36142.07","6.232","7.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":727},{"label":"Mar","value":634},{"label":"Abr","value":404},{"label":"Mai","value":340},{"label":"Jun","value":646},{"label":"Jul","value":432},{"label":"Ago","value":623},{"label":"Set","value":356},{"label":"Out","value":642},{"label":"Nov","value":353},{"label":"Dez","value":590}];
const MX = 727;
