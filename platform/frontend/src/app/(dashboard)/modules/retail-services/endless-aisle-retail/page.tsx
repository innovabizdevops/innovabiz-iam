...
const KPIS = [{"l":"Pedidos/Dia","v":"2256","t":"-1.9%","d":"down"},{"l":"GMV (€)","v":"€51558","t":"+8.3%","d":"up"},{"l":"Conversão (%)","v":"90.4%","t":"+4.4%","d":"up"},{"l":"AOV (€)","v":"€64196","t":"+16.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 2793.59","8.484","4.572","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20359.74","2.559","7.542","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 5139.98","8.138","8.438","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 39807.80","2.720","3.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 6779.29","7.969","5.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":734},{"label":"Mar","value":817},{"label":"Abr","value":709},{"label":"Mai","value":922},{"label":"Jun","value":597},{"label":"Jul","value":944},{"label":"Ago","value":742},{"label":"Set","value":873},{"label":"Out","value":733},{"label":"Nov","value":856},{"label":"Dez","value":959}];
const MX = 959;
...
export default function EndlessAisleRetailPage() {
    return (
