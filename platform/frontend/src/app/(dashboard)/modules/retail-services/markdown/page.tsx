...
const PAGE = "Markdown Optimization";
const KPIS = [{"l":"Pedidos/Dia","v":"481","t":"+5.6%","d":"up"},{"l":"GMV (€)","v":"€15624","t":"+11.9%","d":"up"},{"l":"Conversão (%)","v":"74.8%","t":"+5.0%","d":"up"},{"l":"AOV (€)","v":"€96416","t":"+5.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 37792.61","4.908","3.001","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 37570.84","5.995","6.747","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 19473.01","4.457","3.446","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 44653.56","446","2.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 10721.59","293","1.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":668},{"label":"Mar","value":333},{"label":"Abr","value":453},{"label":"Mai","value":351},{"label":"Jun","value":476},{"label":"Jul","value":318},{"label":"Ago","value":306},{"label":"Set","value":394},{"label":"Out","value":631},{"label":"Nov","value":465},{"label":"Dez","value":547}];
const MX = 668;
