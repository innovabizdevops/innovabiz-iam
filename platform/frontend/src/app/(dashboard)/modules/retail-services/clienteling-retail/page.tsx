...
const PAGE = "Clienteling AI";
const KPIS = [{"l":"Pedidos/Dia","v":"2909","t":"+14.4%","d":"up"},{"l":"GMV (€)","v":"€15793","t":"+3.9%","d":"up"},{"l":"Conversão (%)","v":"92.0%","t":"-4.9%","d":"down"},{"l":"AOV (€)","v":"€37203","t":"+16.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 33508.47","7.472","969","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 7150.69","8.143","7.531","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 40195.44","895","1.614","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 41414.40","3.549","6.109","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 12634.12","8.505","3.657","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":392},{"label":"Mar","value":473},{"label":"Abr","value":469},{"label":"Mai","value":409},{"label":"Jun","value":240},{"label":"Jul","value":216},{"label":"Ago","value":327},{"label":"Set","value":575},{"label":"Out","value":349},{"label":"Nov","value":535},{"label":"Dez","value":568}];
const MX = 575;
...
export default function ClientelingRetailPage() {
    return (
