...
const PAGE = "Planogram AI";
const KPIS = [{"l":"Pedidos/Dia","v":"256","t":"-4.3%","d":"down"},{"l":"GMV (€)","v":"€71913","t":"+10.1%","d":"up"},{"l":"Conversão (%)","v":"66.3%","t":"+14.1%","d":"up"},{"l":"AOV (€)","v":"€68954","t":"+5.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 11760.98","7.782","9.082","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 48203.24","4.084","6.926","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 6321.34","4.417","243","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 11151.78","4.936","6.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 21858.91","6.257","936","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":500},{"label":"Fev","value":792},{"label":"Mar","value":557},{"label":"Abr","value":545},{"label":"Mai","value":872},{"label":"Jun","value":748},{"label":"Jul","value":823},{"label":"Ago","value":767},{"label":"Set","value":823},{"label":"Out","value":835},{"label":"Nov","value":746},{"label":"Dez","value":562}];
const MX = 872;
...
export default function PlanogramRetailPage() {
    return (
