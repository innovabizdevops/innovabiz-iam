...
const ACCENT = "#6366f1";
const MODULE = "Retail Services";
const PAGE = "Dynamic Markdown";
const KPIS = [{"l":"Pedidos/Dia","v":"2999","t":"+9.9%","d":"up"},{"l":"GMV (€)","v":"€44460","t":"-5.6%","d":"down"},{"l":"Conversão (%)","v":"82.9%","t":"+4.7%","d":"up"},{"l":"AOV (€)","v":"€63739","t":"+2.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 27701.61","8.581","2.365","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 5787.53","8.026","4.523","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 34958.73","6.806","1.968","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 49269.09","4.575","2.712","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20275.94","5.103","3.179","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":889},{"label":"Mar","value":611},{"label":"Abr","value":659},{"label":"Mai","value":751},{"label":"Jun","value":568},{"label":"Jul","value":596},{"label":"Ago","value":802},{"label":"Set","value":641},{"label":"Out","value":911},{"label":"Nov","value":573},{"label":"Dez","value":809}];
const MX = 911;
...
export default function MarkdownRetailPage() {
    return (
