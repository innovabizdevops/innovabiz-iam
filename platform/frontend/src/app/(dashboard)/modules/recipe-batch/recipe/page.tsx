...
const PAGE = "Recipe";
const KPIS = [{"l":"Total Recipe Batch","v":"2.886","t":"+0.1%","d":"up"},{"l":"Recipe Ativos","v":"167","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"93","t":"+12.5%","d":"up"}];
const COLS = ["ID","Recipe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Batch #001","Recipe Batch #002","4.995","874","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Batch #002","Recipe Batch #003","6.848","1.388","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Batch #003","Recipe Batch #004","7.842","3.022","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Batch #004","Recipe Batch #005","9.058","1.368","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Batch #005","Recipe Batch #001","4.306","609","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":968},{"label":"Mar","value":808},{"label":"Abr","value":1042},{"label":"Mai","value":952},{"label":"Jun","value":1001},{"label":"Jul","value":714},{"label":"Ago","value":772},{"label":"Set","value":705},{"label":"Out","value":957},{"label":"Nov","value":828},{"label":"Dez","value":854}];
const MX = 1042;
