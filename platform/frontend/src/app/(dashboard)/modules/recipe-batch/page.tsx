...
export default function RecipeBatchPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Recipe Batch</h1><p className="text-sm text-muted-foreground">Recipe Batch • iBOS Enterprise</p></div>
