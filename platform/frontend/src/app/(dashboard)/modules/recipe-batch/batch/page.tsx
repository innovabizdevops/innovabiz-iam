...
const PAGE = "Batch";
const KPIS = [{"l":"Total Recipe Batch","v":"3.934","t":"+17.2%","d":"up"},{"l":"Batch Ativos","v":"2.074","t":"+11.5%","d":"up"},{"l":"Eficiência (%)","v":"87.6%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"55","t":"+7.9%","d":"up"}];
const COLS = ["ID","Batch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Batch #001","Recipe Batch #002","3.008","8.775","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Batch #002","Recipe Batch #003","1.393","1.923","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Batch #003","Recipe Batch #004","4.079","7.237","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Batch #004","Recipe Batch #005","3.930","7.710","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Batch #005","Recipe Batch #001","8.904","4.792","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":653},{"label":"Mar","value":861},{"label":"Abr","value":763},{"label":"Mai","value":848},{"label":"Jun","value":874},{"label":"Jul","value":676},{"label":"Ago","value":762},{"label":"Set","value":548},{"label":"Out","value":741},{"label":"Nov","value":837},{"label":"Dez","value":578}];
const MX = 874;
