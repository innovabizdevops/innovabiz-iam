...
const KPIS = [{"l":"Configurações","v":"5.851","t":"+17.5%","d":"up"},{"l":"Últimas Alterações","v":"352","t":"+9.1%","d":"up"},{"l":"Ambientes","v":"1.958","t":"+2.7%","d":"up"},{"l":"Versão Config","v":"6.920","t":"+3.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 6211.10","4.133","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 23896.67","5.771","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 10857.53","8.585","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 49733.63","7.852","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 15719.35","9.021","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":737},{"label":"Mar","value":642},{"label":"Abr","value":481},{"label":"Mai","value":646},{"label":"Jun","value":743},{"label":"Jul","value":667},{"label":"Ago","value":394},{"label":"Set","value":625},{"label":"Out","value":566},{"label":"Nov","value":602},{"label":"Dez","value":568}];
const MX = 743;
