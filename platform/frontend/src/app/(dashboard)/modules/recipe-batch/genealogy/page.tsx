...
const ACCENT = "#6366f1";
const MODULE = "Recipe & Batch";
const PAGE = "Genealogy";
const KPIS = [{"l":"Total Recipe Batch","v":"2.164","t":"-4.4%","d":"down"},{"l":"Genealogy Ativos","v":"3.497","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"84","t":"+9.9%","d":"up"}];
const COLS = ["ID","Genealogy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recipe Batch #001","Recipe Batch #002","247","8.880","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Recipe Batch #002","Recipe Batch #003","437","3.839","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Recipe Batch #003","Recipe Batch #004","2.569","3.869","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Recipe Batch #004","Recipe Batch #005","475","3.511","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recipe Batch #005","Recipe Batch #001","7.407","7.693","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":626},{"label":"Mar","value":707},{"label":"Abr","value":361},{"label":"Mai","value":501},{"label":"Jun","value":695},{"label":"Jul","value":559},{"label":"Ago","value":613},{"label":"Set","value":438},{"label":"Out","value":527},{"label":"Nov","value":427},{"label":"Dez","value":731}];
const MX = 731;
