...
/* ═══ Composable ERP — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "7002", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "997", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1093442102", cells: ["COM-6102", "Composable ERP Item 1", "19/3/2026", "€42 202"], status: "active" as const },
    { id: "1093445673", cells: ["COM-9673", "Composable ERP Item 2", "6/10/2026", "€45 773"], status: "pending" as const },
    { id: "1093449244", cells: ["COM-4244", "Composable ERP Item 3", "21/5/2026", "€49 344"], status: "completed" as const },
    { id: "1093452815", cells: ["COM-7815", "Composable ERP Item 4", "8/12/2026", "€2915"], status: "warning" as const },
    { id: "1093456386", cells: ["COM-2386", "Composable ERP Item 5", "23/7/2026", "€6486"], status: "active" as const },
];
...
export default function ComposableErpPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Composable ERP</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Composable ERP</p>
                    </div>
                </div>
