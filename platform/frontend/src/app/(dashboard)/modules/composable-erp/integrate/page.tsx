...
const ACCENT = "#00bcf2";
const MODULE = "Composable ERP";
const PAGE = "Integrate";
const KPIS = [{"l":"Pedidos/Dia","v":"3584","t":"+4.7%","d":"up"},{"l":"GMV (€)","v":"€78496","t":"+14.0%","d":"up"},{"l":"Conversão (%)","v":"74.2%","t":"+10.6%","d":"up"},{"l":"AOV (€)","v":"€4779","t":"+6.7%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 33148.90","4.889","315","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 31173.48","2.073","468","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 26514.50","5.459","392","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 4243.10","2.736","7.141","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 39748.67","7.677","6.633","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":645},{"label":"Mar","value":456},{"label":"Abr","value":590},{"label":"Mai","value":716},{"label":"Jun","value":627},{"label":"Jul","value":657},{"label":"Ago","value":643},{"label":"Set","value":744},{"label":"Out","value":540},{"label":"Nov","value":582},{"label":"Dez","value":784}];
const MX = 784;
