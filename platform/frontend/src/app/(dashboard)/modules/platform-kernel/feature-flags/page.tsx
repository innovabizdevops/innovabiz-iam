...
const PAGE = "Feature Flags";
const KPIS = [{"l":"Formulários Ativos","v":"5.671","t":"+17.8%","d":"up"},{"l":"Submissões/Dia","v":"1745","t":"+2.5%","d":"up"},{"l":"Documentos Gerados","v":"7.081","t":"+13.7%","d":"up"},{"l":"Templates","v":"2.734","t":"+12.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.288","2026-03-07","8.285","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.043","2026-03-01","8.551","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.689","2026-03-02","2.350","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.708","2026-01-22","456","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.569","2026-03-20","2.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":659},{"label":"Mar","value":887},{"label":"Abr","value":770},{"label":"Mai","value":719},{"label":"Jun","value":803},{"label":"Jul","value":892},{"label":"Ago","value":798},{"label":"Set","value":961},{"label":"Out","value":812},{"label":"Nov","value":596},{"label":"Dez","value":650}];
const MX = 961;
