...
const PAGE = "API Rate Limiting";
const KPIS = [{"l":"Formulários Ativos","v":"2.651","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"4364","t":"-4.0%","d":"down"},{"l":"Documentos Gerados","v":"2.316","t":"+17.0%","d":"up"},{"l":"Templates","v":"2.113","t":"+2.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.089","2026-02-18","1.078","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.343","2026-03-09","1.251","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.673","2026-03-19","8.190","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.542","2026-01-06","4.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.873","2026-01-27","6.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":755},{"label":"Mar","value":727},{"label":"Abr","value":768},{"label":"Mai","value":787},{"label":"Jun","value":884},{"label":"Jul","value":786},{"label":"Ago","value":630},{"label":"Set","value":838},{"label":"Out","value":781},{"label":"Nov","value":564},{"label":"Dez","value":558}];
const MX = 884;
