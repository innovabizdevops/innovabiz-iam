...
const ACCENT = "#1e40af";
const MODULE = "Platform Kernel";
const PAGE = "Multi-Tenant Config";
const KPIS = [{"l":"Formulários Ativos","v":"5.127","t":"+13.0%","d":"up"},{"l":"Submissões/Dia","v":"1175","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"6.058","t":"+8.1%","d":"up"},{"l":"Templates","v":"5.572","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.864","2026-01-02","6.204","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.994","2026-03-15","4.051","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.562","2026-01-06","8.959","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","259","2026-02-11","1.694","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.177","2026-02-22","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":713},{"label":"Mar","value":683},{"label":"Abr","value":679},{"label":"Mai","value":660},{"label":"Jun","value":702},{"label":"Jul","value":400},{"label":"Ago","value":598},{"label":"Set","value":587},{"label":"Out","value":453},{"label":"Nov","value":697},{"label":"Dez","value":786}];
const MX = 786;
