...
/* ═══ Event Technology — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "1848", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1515", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€414K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2051727248", cells: ["EVE-7248", "Event Technology Item 1", "5/9/2026", "€27 348"], status: "active" as const },
    { id: "2051730819", cells: ["EVE-1819", "Event Technology Item 2", "20/4/2026", "€30 919"], status: "pending" as const },
    { id: "2051734390", cells: ["EVE-5390", "Event Technology Item 3", "7/11/2026", "€34 490"], status: "completed" as const },
    { id: "2051737961", cells: ["EVE-8961", "Event Technology Item 4", "22/6/2026", "€38 061"], status: "warning" as const },
    { id: "2051741532", cells: ["EVE-3532", "Event Technology Item 5", "9/1/2026", "€41 632"], status: "active" as const },
];
...
export default function EventTechnologyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Technology</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Technology</p>
                    </div>
                </div>
