...
const PAGE = "LED";
const KPIS = [{"l":"Eventos Planeados","v":"1.718","t":"+1.4%","d":"up"},{"l":"Participantes","v":"3.777","t":"+4.4%","d":"up"},{"l":"NPS Evento","v":"56","t":"+9.3%","d":"up"},{"l":"Receita (€)","v":"€86990","t":"+13.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-11","4.620","1.343","€ 4634.09","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-15","4.955","6.555","€ 31732.80","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-16","6.742","4.107","€ 313.91","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-03","8.003","5.437","€ 10164.23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-08","7.551","6.565","€ 6871.80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":401},{"label":"Mar","value":385},{"label":"Abr","value":277},{"label":"Mai","value":323},{"label":"Jun","value":384},{"label":"Jul","value":550},{"label":"Ago","value":294},{"label":"Set","value":383},{"label":"Out","value":540},{"label":"Nov","value":590},{"label":"Dez","value":387}];
const MX = 590;
