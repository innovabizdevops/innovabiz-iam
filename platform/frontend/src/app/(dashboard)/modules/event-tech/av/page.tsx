...
const PAGE = "AV";
const KPIS = [{"l":"Eventos Planeados","v":"2.666","t":"+10.7%","d":"up"},{"l":"Participantes","v":"8.673","t":"+5.4%","d":"up"},{"l":"NPS Evento","v":"74","t":"+11.4%","d":"up"},{"l":"Receita (€)","v":"€11487","t":"+0.5%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-28","2.767","8.065","€ 37239.12","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-07","4.158","1.898","€ 43918.67","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-19","8.631","6.168","€ 40587.08","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-02","903","6.808","€ 7725.05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-22","7.411","2.689","€ 40726.11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":997},{"label":"Mar","value":1023},{"label":"Abr","value":743},{"label":"Mai","value":812},{"label":"Jun","value":711},{"label":"Jul","value":968},{"label":"Ago","value":910},{"label":"Set","value":794},{"label":"Out","value":720},{"label":"Nov","value":1053},{"label":"Dez","value":915}];
const MX = 1053;
