...
const PAGE = "Stream";
const KPIS = [{"l":"Eventos Planeados","v":"1.676","t":"+17.7%","d":"up"},{"l":"Participantes","v":"3.958","t":"+10.8%","d":"up"},{"l":"NPS Evento","v":"60","t":"+17.0%","d":"up"},{"l":"Receita (€)","v":"€78662","t":"+1.5%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-12","1.213","167","€ 6189.63","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-20","913","6.276","€ 10621.12","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-06","426","5.449","€ 21411.94","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-13","1.352","2.767","€ 10962.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-02","156","900","€ 49157.75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":667},{"label":"Mar","value":630},{"label":"Abr","value":735},{"label":"Mai","value":751},{"label":"Jun","value":462},{"label":"Jul","value":666},{"label":"Ago","value":662},{"label":"Set","value":588},{"label":"Out","value":598},{"label":"Nov","value":761},{"label":"Dez","value":620}];
const MX = 761;
