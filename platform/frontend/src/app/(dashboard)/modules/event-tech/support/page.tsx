...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"7.303","t":"+9.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.9%","t":"+7.9%","d":"up"},{"l":"MTTR (h)","v":"195h","t":"+10.5%","d":"up"},{"l":"Satisfação (%)","v":"85.2%","t":"+15.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.588","6.639","1.253","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.854","1.055","9.059","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.432","2.928","6.713","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.826","5.067","8.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.885","9.042","7.704","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":464},{"label":"Mar","value":469},{"label":"Abr","value":715},{"label":"Mai","value":419},{"label":"Jun","value":384},{"label":"Jul","value":474},{"label":"Ago","value":535},{"label":"Set","value":493},{"label":"Out","value":355},{"label":"Nov","value":580},{"label":"Dez","value":362}];
const MX = 715;
