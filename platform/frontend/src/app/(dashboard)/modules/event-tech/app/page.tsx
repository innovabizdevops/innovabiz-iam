...
const ACCENT = "#be185d";
const MODULE = "Event Technology";
const PAGE = "App";
const KPIS = [{"l":"Eventos Planeados","v":"555","t":"-4.3%","d":"down"},{"l":"Participantes","v":"3.495","t":"+12.0%","d":"up"},{"l":"NPS Evento","v":"90","t":"+7.6%","d":"up"},{"l":"Receita (€)","v":"€48668","t":"+17.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-24","6.510","7.625","€ 5396.37","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-20","5.143","8.494","€ 47986.30","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-09","8.818","5.276","€ 14786.52","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-27","5.685","2.461","€ 8261.53","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-10","6.093","8.819","€ 16215.27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":531},{"label":"Mar","value":451},{"label":"Abr","value":483},{"label":"Mai","value":425},{"label":"Jun","value":429},{"label":"Jul","value":424},{"label":"Ago","value":483},{"label":"Set","value":350},{"label":"Out","value":403},{"label":"Nov","value":513},{"label":"Dez","value":446}];
const MX = 531;
