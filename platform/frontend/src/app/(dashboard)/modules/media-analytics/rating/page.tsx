...
const PAGE = "Rating";
const KPIS = [{"l":"Dashboards Ativos","v":"6.396","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"1187","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.031","t":"+12.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.234","t":"-5.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","135","2026-01-11","2.168","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3814","2026-01-22","5.302","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1856","2026-02-11","2.078","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2083","2026-02-17","1.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4689","2026-03-03","7.946","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":473},{"label":"Mar","value":685},{"label":"Abr","value":679},{"label":"Mai","value":579},{"label":"Jun","value":753},{"label":"Jul","value":663},{"label":"Ago","value":597},{"label":"Set","value":713},{"label":"Out","value":777},{"label":"Nov","value":667},{"label":"Dez","value":677}];
const MX = 802;
