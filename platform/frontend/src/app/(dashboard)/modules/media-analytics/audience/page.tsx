...
const PAGE = "Audience";
const KPIS = [{"l":"Dashboards Ativos","v":"900","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"1366","t":"+9.5%","d":"up"},{"l":"Dados Processados (GB)","v":"2.735","t":"+12.1%","d":"up"},{"l":"Utilizadores Analytics","v":"465","t":"-1.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1550","2026-01-27","8.995","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2394","2026-01-11","3.956","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3890","2026-01-04","400","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3285","2026-03-11","8.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3057","2026-01-05","8.511","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":438},{"label":"Mar","value":724},{"label":"Abr","value":664},{"label":"Mai","value":534},{"label":"Jun","value":692},{"label":"Jul","value":466},{"label":"Ago","value":777},{"label":"Set","value":610},{"label":"Out","value":794},{"label":"Nov","value":668},{"label":"Dez","value":665}];
const MX = 794;
