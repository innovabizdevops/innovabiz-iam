...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"6.605","t":"+5.5%","d":"up"},{"l":"Queries/Dia","v":"3572","t":"-5.5%","d":"down"},{"l":"Dados Processados (GB)","v":"7.689","t":"+17.5%","d":"up"},{"l":"Utilizadores Analytics","v":"1.985","t":"+12.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3255","2026-02-28","2.351","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1481","2026-01-23","8.817","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2650","2026-02-02","8.834","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","744","2026-01-18","338","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3794","2026-02-07","7.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":572},{"label":"Mar","value":417},{"label":"Abr","value":546},{"label":"Mai","value":577},{"label":"Jun","value":518},{"label":"Jul","value":719},{"label":"Ago","value":449},{"label":"Set","value":646},{"label":"Out","value":671},{"label":"Nov","value":433},{"label":"Dez","value":351}];
const MX = 719;
