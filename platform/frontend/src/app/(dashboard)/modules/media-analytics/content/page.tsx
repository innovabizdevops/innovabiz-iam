...
const ACCENT = "#6366f1";
const MODULE = "Media Analytics";
const PAGE = "Content";
const KPIS = [{"l":"Dashboards Ativos","v":"3.542","t":"-3.8%","d":"down"},{"l":"Queries/Dia","v":"840","t":"+17.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.829","t":"+11.8%","d":"up"},{"l":"Utilizadores Analytics","v":"3.011","t":"+5.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4904","2026-02-03","7.987","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4013","2026-02-12","4.742","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","283","2026-01-28","6.750","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3249","2026-01-21","2.538","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","433","2026-02-08","547","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":243},{"label":"Mar","value":374},{"label":"Abr","value":386},{"label":"Mai","value":481},{"label":"Jun","value":582},{"label":"Jul","value":541},{"label":"Ago","value":515},{"label":"Set","value":397},{"label":"Out","value":253},{"label":"Nov","value":497},{"label":"Dez","value":425}];
const MX = 582;
