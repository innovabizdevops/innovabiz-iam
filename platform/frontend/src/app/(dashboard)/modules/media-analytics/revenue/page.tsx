...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€4.6M","t":"+14.0%","d":"up"},{"l":"MRR (€)","v":"€41385","t":"+4.6%","d":"up"},{"l":"Churn (%)","v":"76.6%","t":"+6.2%","d":"up"},{"l":"ARPU (€)","v":"€15518","t":"+7.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10561.55","3.534","€ 17693.78","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33321.74","5.582","€ 30967.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7309.43","3.088","€ 6540.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38730.63","2.967","€ 19394.14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40126.34","7.311","€ 27583.28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":364},{"label":"Fev","value":386},{"label":"Mar","value":373},{"label":"Abr","value":594},{"label":"Mai","value":250},{"label":"Jun","value":571},{"label":"Jul","value":360},{"label":"Ago","value":471},{"label":"Set","value":596},{"label":"Out","value":494},{"label":"Nov","value":565},{"label":"Dez","value":328}];
const MX = 596;
