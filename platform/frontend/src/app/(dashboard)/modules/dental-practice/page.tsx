...
const KPIS = [
    { label: "Total Registos", value: "2879", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2638", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€206K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1137057379", cells: ["DEN-7379", "Dental Practice Management Item 1", "4/8/2026", "€7479"], status: "active" as const },
    { id: "1137060950", cells: ["DEN-1950", "Dental Practice Management Item 2", "19/3/2026", "€11 050"], status: "pending" as const },
    { id: "1137064521", cells: ["DEN-5521", "Dental Practice Management Item 3", "6/10/2026", "€14 621"], status: "completed" as const },
    { id: "1137068092", cells: ["DEN-9092", "Dental Practice Management Item 4", "21/5/2026", "€18 192"], status: "warning" as const },
    { id: "1137071663", cells: ["DEN-3663", "Dental Practice Management Item 5", "8/12/2026", "€21 763"], status: "active" as const },
];
...
export default function DentalPracticeManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dental Practice Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Dental Practice Management</p>
                    </div>
                </div>
