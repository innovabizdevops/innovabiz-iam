...
const ACCENT = "#22d3ee";
const MODULE = "Customer 360";
const PAGE = "Next Best Action";
const KPIS = [{"l":"Total Customer 360","v":"€16678","t":"+1.7%","d":"up"},{"l":"Next Best Action Ativos","v":"3.552","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"59","t":"+4.0%","d":"up"}];
const COLS = ["ID","Next Best Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer 360 #001","Customer 360 #002","3.053","4.959","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Customer 360 #002","Customer 360 #003","7.307","3.899","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer 360 #003","Customer 360 #004","1.483","4.891","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Customer 360 #004","Customer 360 #005","3.626","5.440","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer 360 #005","Customer 360 #001","8.486","1.786","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":714},{"label":"Mar","value":658},{"label":"Abr","value":776},{"label":"Mai","value":710},{"label":"Jun","value":641},{"label":"Jul","value":715},{"label":"Ago","value":465},{"label":"Set","value":565},{"label":"Out","value":686},{"label":"Nov","value":785},{"label":"Dez","value":740}];
const MX = 785;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#22d3ee'}}>AI</span></h1>
                </div>
