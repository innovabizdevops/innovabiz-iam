...
const PAGE = "Social Profile";
const KPIS = [{"l":"Perfis Unificados","v":"1.871","t":"+12.5%","d":"up"},{"l":"Segmentos Ativos","v":"7.513","t":"+16.1%","d":"up"},{"l":"NPS Score","v":"69","t":"-1.5%","d":"down"},{"l":"Churn Previsto (%)","v":"75.7%","t":"-5.1%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.099","€ 7217.57","78.8%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.110","€ 8514.43","70.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.230","€ 8444.70","78.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","6.722","€ 6694.62","78.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.784","€ 119.74","86.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":329},{"label":"Mar","value":637},{"label":"Abr","value":338},{"label":"Mai","value":436},{"label":"Jun","value":443},{"label":"Jul","value":662},{"label":"Ago","value":491},{"label":"Set","value":297},{"label":"Out","value":497},{"label":"Nov","value":575},{"label":"Dez","value":318}];
const MX = 662;
