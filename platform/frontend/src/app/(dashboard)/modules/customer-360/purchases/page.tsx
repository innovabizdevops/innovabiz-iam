...
const PAGE = "Purchase History";
const KPIS = [{"l":"Total Customer 360","v":"€86191","t":"+14.4%","d":"up"},{"l":"Purchase History Ativos","v":"8.452","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"63","t":"+3.0%","d":"up"}];
const COLS = ["ID","Purchase History","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer 360 #001","Customer 360 #002","7.313","8.760","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Customer 360 #002","Customer 360 #003","3.368","6.536","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer 360 #003","Customer 360 #004","1.092","3.436","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Customer 360 #004","Customer 360 #005","4.278","2.574","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer 360 #005","Customer 360 #001","6.435","852","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":829},{"label":"Mar","value":787},{"label":"Abr","value":840},{"label":"Mai","value":891},{"label":"Jun","value":585},{"label":"Jul","value":818},{"label":"Ago","value":744},{"label":"Set","value":815},{"label":"Out","value":856},{"label":"Nov","value":613},{"label":"Dez","value":529}];
const MX = 891;
