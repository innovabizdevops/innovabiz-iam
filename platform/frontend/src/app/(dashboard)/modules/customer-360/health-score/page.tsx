...
const PAGE = "Customer Health Score";
const KPIS = [{"l":"Total Customer 360","v":"€56341","t":"-0.3%","d":"down"},{"l":"Customer Health Score Ativos","v":"€1666","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"63","t":"+17.1%","d":"up"}];
const COLS = ["ID","Customer Health Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customer 360 #001","€ 16818.02","9.022","3.368","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Customer 360 #002","€ 42684.69","8.035","5.261","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Customer 360 #003","€ 47851.20","3.640","4.057","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Customer 360 #004","€ 49825.49","4.348","5.015","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customer 360 #005","€ 11068.32","863","1.550","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":504},{"label":"Mar","value":677},{"label":"Abr","value":643},{"label":"Mai","value":821},{"label":"Jun","value":476},{"label":"Jul","value":705},{"label":"Ago","value":576},{"label":"Set","value":519},{"label":"Out","value":697},{"label":"Nov","value":477},{"label":"Dez","value":784}];
const MX = 821;
