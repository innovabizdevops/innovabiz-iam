...
const KPIS = [{"l":"ARR (€M)","v":"€24.0M","t":"+3.8%","d":"up"},{"l":"MRR (€)","v":"€80001","t":"+15.4%","d":"up"},{"l":"Churn (%)","v":"76.1%","t":"+7.0%","d":"up"},{"l":"ARPU (€)","v":"€21033","t":"+1.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43558.85","8.329","€ 44818.18","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 41569.39","5.720","€ 49775.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42809.90","6.000","€ 18872.13","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11040.25","4.216","€ 8334.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 2756.94","1.809","€ 20438.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":690},{"label":"Mar","value":957},{"label":"Abr","value":885},{"label":"Mai","value":643},{"label":"Jun","value":857},{"label":"Jul","value":668},{"label":"Ago","value":795},{"label":"Set","value":814},{"label":"Out","value":680},{"label":"Nov","value":977},{"label":"Dez","value":734}];
const MX = 977;
