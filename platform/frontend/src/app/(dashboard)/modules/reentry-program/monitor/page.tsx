...
const ACCENT = "#831843";
const MODULE = "Reentry Program";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Reentry Program","v":"8.982","t":"+8.7%","d":"up"},{"l":"Monitor Ativos","v":"8.966","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.2%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reentry Program #001","Reentry Program #002","4.907","1.603","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Reentry Program #002","Reentry Program #003","1.647","5.287","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Reentry Program #003","Reentry Program #004","1.490","4.372","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Reentry Program #004","Reentry Program #005","8.836","1.955","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reentry Program #005","Reentry Program #001","7.021","6.566","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":579},{"label":"Mar","value":504},{"label":"Abr","value":636},{"label":"Mai","value":712},{"label":"Jun","value":575},{"label":"Jul","value":656},{"label":"Ago","value":530},{"label":"Set","value":735},{"label":"Out","value":713},{"label":"Nov","value":726},{"label":"Dez","value":755}];
const MX = 755;
