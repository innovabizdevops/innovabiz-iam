...
/* ═══ Reentry Program — Dashboard ═══ */

const ACCENT = "#831843";

const KPIS = [
    { label: "Total Registos", value: "2405", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "727", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€343K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1061727805", cells: ["REE-7805", "Reentry Program Item 1", "6/2/2026", "€27 905"], status: "active" as const },
    { id: "1061731376", cells: ["REE-2376", "Reentry Program Item 2", "21/9/2026", "€31 476"], status: "pending" as const },
    { id: "1061734947", cells: ["REE-5947", "Reentry Program Item 3", "8/4/2026", "€35 047"], status: "completed" as const },
    { id: "1061738518", cells: ["REE-9518", "Reentry Program Item 4", "23/11/2026", "€38 618"], status: "warning" as const },
    { id: "1061742089", cells: ["REE-4089", "Reentry Program Item 5", "10/6/2026", "€42 189"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reentry Program</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Reentry Program</p>
                    </div>
                </div>
