...
const PAGE = "Plan";
const KPIS = [{"l":"Total Reentry Program","v":"326","t":"+13.7%","d":"up"},{"l":"Plan Ativos","v":"2.082","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"68","t":"+12.4%","d":"up"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reentry Program #001","Reentry Program #002","2.959","3.930","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Reentry Program #002","Reentry Program #003","6.691","3.427","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Reentry Program #003","Reentry Program #004","1.723","377","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Reentry Program #004","Reentry Program #005","3.915","3.756","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reentry Program #005","Reentry Program #001","813","745","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":490},{"label":"Mar","value":605},{"label":"Abr","value":582},{"label":"Mai","value":721},{"label":"Jun","value":742},{"label":"Jul","value":639},{"label":"Ago","value":821},{"label":"Set","value":741},{"label":"Out","value":462},{"label":"Nov","value":618},{"label":"Dez","value":752}];
const MX = 821;
