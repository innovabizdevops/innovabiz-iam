...
const PAGE = "Housing";
const KPIS = [{"l":"Total Reentry Program","v":"8.254","t":"+14.5%","d":"up"},{"l":"Housing Ativos","v":"7.843","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"88","t":"+15.0%","d":"up"}];
const COLS = ["ID","Housing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reentry Program #001","Reentry Program #002","3.986","5.618","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Reentry Program #002","Reentry Program #003","5.339","8.707","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Reentry Program #003","Reentry Program #004","2.641","816","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Reentry Program #004","Reentry Program #005","1.478","1.818","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reentry Program #005","Reentry Program #001","7.820","512","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":263},{"label":"Fev","value":524},{"label":"Mar","value":266},{"label":"Abr","value":400},{"label":"Mai","value":625},{"label":"Jun","value":519},{"label":"Jul","value":590},{"label":"Ago","value":408},{"label":"Set","value":242},{"label":"Out","value":483},{"label":"Nov","value":385},{"label":"Dez","value":288}];
const MX = 625;
