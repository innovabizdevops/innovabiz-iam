...
const PAGE = "Monetize";
const KPIS = [{"l":"ARR (€M)","v":"€36.3M","t":"+12.4%","d":"up"},{"l":"MRR (€)","v":"€86317","t":"+0.1%","d":"up"},{"l":"Churn (%)","v":"93.1%","t":"+0.4%","d":"up"},{"l":"ARPU (€)","v":"€65512","t":"+9.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 15505.31","6.866","€ 47178.27","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27189.20","2.229","€ 12554.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17828.87","8.859","€ 44386.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46139.79","3.559","€ 20707.04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44270.32","3.501","€ 26277.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":643},{"label":"Mar","value":769},{"label":"Abr","value":775},{"label":"Mai","value":564},{"label":"Jun","value":480},{"label":"Jul","value":491},{"label":"Ago","value":695},{"label":"Set","value":679},{"label":"Out","value":492},{"label":"Nov","value":725},{"label":"Dez","value":484}];
const MX = 775;
