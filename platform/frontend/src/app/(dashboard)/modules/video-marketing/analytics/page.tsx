...
const KPIS = [{"l":"Dashboards Ativos","v":"5.735","t":"+6.7%","d":"up"},{"l":"Queries/Dia","v":"4559","t":"-1.7%","d":"down"},{"l":"Dados Processados (GB)","v":"3.362","t":"+15.0%","d":"up"},{"l":"Utilizadores Analytics","v":"3.163","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","919","2026-02-05","7.429","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","490","2026-01-17","1.998","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3957","2026-02-03","3.374","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3931","2026-02-21","4.181","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4251","2026-01-28","7.052","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":475},{"label":"Mar","value":368},{"label":"Abr","value":415},{"label":"Mai","value":437},{"label":"Jun","value":458},{"label":"Jul","value":621},{"label":"Ago","value":493},{"label":"Set","value":481},{"label":"Out","value":514},{"label":"Nov","value":341},{"label":"Dez","value":306}];
const MX = 621;
