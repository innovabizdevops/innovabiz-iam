...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.191","t":"+16.7%","d":"up"},{"l":"NC Abertas","v":"1.758","t":"+5.8%","d":"up"},{"l":"Conformidade (%)","v":"74.1%","t":"-5.4%","d":"down"},{"l":"CAPAs Pendentes","v":"2.760","t":"+16.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.365","91.6%","8.432","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.241","85.7%","291","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.507","87.5%","7.172","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.883","72.9%","6.223","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","397","81.1%","673","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":605},{"label":"Mar","value":599},{"label":"Abr","value":589},{"label":"Mai","value":520},{"label":"Jun","value":529},{"label":"Jul","value":525},{"label":"Ago","value":476},{"label":"Set","value":550},{"label":"Out","value":515},{"label":"Nov","value":761},{"label":"Dez","value":624}];
const MX = 761;
