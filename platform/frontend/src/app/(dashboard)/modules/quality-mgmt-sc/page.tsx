...
export default function QualityMgmtScPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Quality Mgmt Sc</h1><p className="text-sm text-muted-foreground">Quality Mgmt Sc • iBOS Enterprise</p></div>
