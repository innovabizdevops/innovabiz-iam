...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.118","t":"+13.7%","d":"up"},{"l":"NC Abertas","v":"2.057","t":"+5.9%","d":"up"},{"l":"Conformidade (%)","v":"68.6%","t":"+13.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.532","t":"-5.4%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.892","87.1%","1.090","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.691","83.3%","8.886","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.118","81.9%","2.081","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.597","83.2%","3.109","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.931","91.4%","667","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":812},{"label":"Mar","value":990},{"label":"Abr","value":840},{"label":"Mai","value":814},{"label":"Jun","value":1007},{"label":"Jul","value":816},{"label":"Ago","value":707},{"label":"Set","value":1004},{"label":"Out","value":793},{"label":"Nov","value":726},{"label":"Dez","value":890}];
const MX = 1007;
