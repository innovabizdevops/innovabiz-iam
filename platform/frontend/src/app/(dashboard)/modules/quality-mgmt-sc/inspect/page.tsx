...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.743","t":"+3.1%","d":"up"},{"l":"NC Abertas","v":"447","t":"+11.9%","d":"up"},{"l":"Conformidade (%)","v":"90.0%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"3.015","t":"-0.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.358","86.5%","7.089","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.010","87.2%","4.776","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.075","73.1%","3.201","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.719","78.8%","5.766","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.743","79.6%","6.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":797},{"label":"Mar","value":655},{"label":"Abr","value":533},{"label":"Mai","value":722},{"label":"Jun","value":526},{"label":"Jul","value":804},{"label":"Ago","value":808},{"label":"Set","value":497},{"label":"Out","value":745},{"label":"Nov","value":628},{"label":"Dez","value":638}];
const MX = 808;
