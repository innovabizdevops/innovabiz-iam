...
const PAGE = "Document";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.027","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"8.637","t":"+12.2%","d":"up"},{"l":"Conformidade (%)","v":"69.7%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"7.241","t":"+3.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.278","83.8%","1.562","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.309","90.8%","2.172","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","953","80.6%","7.252","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.533","97.3%","5.828","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.869","71.0%","3.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":908},{"label":"Mar","value":706},{"label":"Abr","value":588},{"label":"Mai","value":610},{"label":"Jun","value":805},{"label":"Jul","value":824},{"label":"Ago","value":714},{"label":"Set","value":594},{"label":"Out","value":773},{"label":"Nov","value":908},{"label":"Dez","value":628}];
const MX = 908;
