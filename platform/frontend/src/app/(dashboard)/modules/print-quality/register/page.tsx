...
const KPIS = [{"l":"Auditorias Realizadas","v":"709","t":"+11.3%","d":"up"},{"l":"NC Abertas","v":"2.845","t":"+2.3%","d":"up"},{"l":"Conformidade (%)","v":"67.4%","t":"+5.4%","d":"up"},{"l":"CAPAs Pendentes","v":"7.341","t":"+9.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","246","83.0%","2.873","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.379","95.0%","4.909","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.309","73.8%","5.665","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.967","79.6%","6.562","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.544","96.2%","6.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":521},{"label":"Mar","value":578},{"label":"Abr","value":567},{"label":"Mai","value":834},{"label":"Jun","value":558},{"label":"Jul","value":796},{"label":"Ago","value":893},{"label":"Set","value":880},{"label":"Out","value":909},{"label":"Nov","value":910},{"label":"Dez","value":712}];
const MX = 910;
