...
const ACCENT = "#6366f1";
const MODULE = "Print Quality";
const PAGE = "Densitometry";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.962","t":"+1.8%","d":"up"},{"l":"NC Abertas","v":"3.425","t":"-5.4%","d":"down"},{"l":"Conformidade (%)","v":"81.0%","t":"-4.6%","d":"down"},{"l":"CAPAs Pendentes","v":"3.224","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","495","97.6%","7.348","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.091","95.3%","7.426","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.136","77.2%","5.521","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","553","88.6%","1.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","269","76.9%","3.248","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":579},{"label":"Mar","value":384},{"label":"Abr","value":589},{"label":"Mai","value":407},{"label":"Jun","value":336},{"label":"Jul","value":415},{"label":"Ago","value":675},{"label":"Set","value":391},{"label":"Out","value":696},{"label":"Nov","value":617},{"label":"Dez","value":698}];
const MX = 698;
