...
const PAGE = "Dot Gain";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.950","t":"+13.7%","d":"up"},{"l":"NC Abertas","v":"6.369","t":"+4.9%","d":"up"},{"l":"Conformidade (%)","v":"84.8%","t":"+7.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.561","t":"-3.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.615","86.1%","6.043","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.350","96.8%","3.675","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.798","88.2%","2.583","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.447","89.2%","6.537","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.692","85.6%","6.180","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":493},{"label":"Mar","value":801},{"label":"Abr","value":763},{"label":"Mai","value":824},{"label":"Jun","value":705},{"label":"Jul","value":771},{"label":"Ago","value":495},{"label":"Set","value":516},{"label":"Out","value":836},{"label":"Nov","value":693},{"label":"Dez","value":511}];
const MX = 836;
