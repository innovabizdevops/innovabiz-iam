...
const PAGE = "Spectro";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.591","t":"+9.0%","d":"up"},{"l":"NC Abertas","v":"6.925","t":"+7.8%","d":"up"},{"l":"Conformidade (%)","v":"86.6%","t":"+9.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.836","t":"-1.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.020","97.6%","4.295","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.842","77.1%","1.928","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.910","79.7%","139","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.849","95.3%","7.294","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.249","78.3%","8.136","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":896},{"label":"Mar","value":801},{"label":"Abr","value":642},{"label":"Mai","value":661},{"label":"Jun","value":818},{"label":"Jul","value":740},{"label":"Ago","value":841},{"label":"Set","value":916},{"label":"Out","value":691},{"label":"Nov","value":671},{"label":"Dez","value":797}];
const MX = 963;
