...
const PAGE = "Dispute";
const KPIS = [{"l":"Total Tax Law","v":"5.594","t":"-2.1%","d":"down"},{"l":"Dispute Ativos","v":"6.867","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"69","t":"+12.2%","d":"up"}];
const COLS = ["ID","Dispute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Law #001","Tax Law #002","4.196","2.760","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Law #002","Tax Law #003","7.092","8.332","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Law #003","Tax Law #004","2.357","1.502","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Law #004","Tax Law #005","1.230","5.227","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Law #005","Tax Law #001","5.565","264","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":536},{"label":"Mar","value":827},{"label":"Abr","value":806},{"label":"Mai","value":929},{"label":"Jun","value":879},{"label":"Jul","value":852},{"label":"Ago","value":701},{"label":"Set","value":602},{"label":"Out","value":632},{"label":"Nov","value":757},{"label":"Dez","value":900}];
const MX = 929;
