...
const ACCENT = "#6366f1";
const MODULE = "Tax Law";
const PAGE = "Transfer Price";
const KPIS = [{"l":"Total Tax Law","v":"7.795","t":"-0.2%","d":"down"},{"l":"Transfer Price Ativos","v":"3.523","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"89","t":"-5.9%","d":"down"}];
const COLS = ["ID","Transfer Price","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Law #001","Tax Law #002","2.168","7.436","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Law #002","Tax Law #003","1.677","3.658","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Law #003","Tax Law #004","3.554","4.202","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Law #004","Tax Law #005","6.861","1.485","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Law #005","Tax Law #001","7.203","3.222","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":364},{"label":"Mar","value":281},{"label":"Abr","value":405},{"label":"Mai","value":575},{"label":"Jun","value":275},{"label":"Jul","value":421},{"label":"Ago","value":531},{"label":"Set","value":413},{"label":"Out","value":415},{"label":"Nov","value":393},{"label":"Dez","value":542}];
const MX = 575;
