...
const PAGE = "Opinion";
const KPIS = [{"l":"Total Tax Law","v":"6.173","t":"+1.4%","d":"up"},{"l":"Opinion Ativos","v":"8.196","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"87","t":"+0.0%","d":"up"}];
const COLS = ["ID","Opinion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Law #001","Tax Law #002","6.340","7.704","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Law #002","Tax Law #003","7.620","1.541","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Law #003","Tax Law #004","178","7.841","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Law #004","Tax Law #005","4.801","1.705","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Law #005","Tax Law #001","3.538","3.396","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":654},{"label":"Mar","value":764},{"label":"Abr","value":623},{"label":"Mai","value":797},{"label":"Jun","value":732},{"label":"Jul","value":530},{"label":"Ago","value":725},{"label":"Set","value":588},{"label":"Out","value":450},{"label":"Nov","value":718},{"label":"Dez","value":604}];
const MX = 797;
