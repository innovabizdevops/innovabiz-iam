...
const KPIS = [{"l":"ARR (€M)","v":"€23.4M","t":"+9.1%","d":"up"},{"l":"MRR (€)","v":"€14195","t":"-0.6%","d":"down"},{"l":"Churn (%)","v":"72.8%","t":"+6.9%","d":"up"},{"l":"ARPU (€)","v":"€49778","t":"-3.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20204.35","7.918","€ 6627.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 25545.09","7.310","€ 31872.22","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26569.13","8.779","€ 40628.27","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37136.12","8.229","€ 26024.10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 40914.95","7.667","€ 15489.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":529},{"label":"Mar","value":709},{"label":"Abr","value":818},{"label":"Mai","value":464},{"label":"Jun","value":600},{"label":"Jul","value":779},{"label":"Ago","value":624},{"label":"Set","value":755},{"label":"Out","value":501},{"label":"Nov","value":509},{"label":"Dez","value":760}];
const MX = 818;
