...
const ACCENT = "#6366f1";
const MODULE = "Partner Management";
const PAGE = "Channel Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"4.822","t":"+14.5%","d":"up"},{"l":"Queries/Dia","v":"1345","t":"+12.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.536","t":"-1.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.904","t":"+5.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1223","2026-02-07","5.909","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2372","2026-03-04","1.548","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","385","2026-01-03","2.007","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3896","2026-02-26","8.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5004","2026-01-10","7.325","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":807},{"label":"Mar","value":752},{"label":"Abr","value":656},{"label":"Mai","value":1031},{"label":"Jun","value":767},{"label":"Jul","value":939},{"label":"Ago","value":968},{"label":"Set","value":657},{"label":"Out","value":922},{"label":"Nov","value":742},{"label":"Dez","value":744}];
const MX = 1031;
