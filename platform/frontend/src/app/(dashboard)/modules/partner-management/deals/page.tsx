...
const KPIS = [{"l":"Eventos Planeados","v":"1.721","t":"+13.8%","d":"up"},{"l":"Participantes","v":"5.604","t":"+14.8%","d":"up"},{"l":"NPS Evento","v":"73","t":"+11.5%","d":"up"},{"l":"Receita (€)","v":"€68684","t":"+5.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-09","3.561","251","€ 22826.37","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-07","6.288","2.993","€ 5870.10","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-14","1.308","7.237","€ 40688.01","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-09","8.626","8.059","€ 34312.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-28","8.828","7.829","€ 12697.49","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":611},{"label":"Mar","value":619},{"label":"Abr","value":673},{"label":"Mai","value":585},{"label":"Jun","value":625},{"label":"Jul","value":591},{"label":"Ago","value":894},{"label":"Set","value":959},{"label":"Out","value":700},{"label":"Nov","value":769},{"label":"Dez","value":639}];
const MX = 959;
