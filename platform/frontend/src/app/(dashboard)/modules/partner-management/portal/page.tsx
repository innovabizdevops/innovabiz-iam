...
const KPIS = [{"l":"Projetos Melhoria","v":"6.035","t":"-2.4%","d":"down"},{"l":"Savings (€)","v":"€1407","t":"+2.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.3%","t":"+10.2%","d":"up"},{"l":"Ciclos PDCA","v":"6.271","t":"-3.3%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.439","€ 34376.90","5.677","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.218","€ 24440.10","8.039","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.317","€ 36651.89","2.098","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.639","€ 38869.46","6.666","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.911","€ 27311.18","4.360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":943},{"label":"Mar","value":676},{"label":"Abr","value":857},{"label":"Mai","value":699},{"label":"Jun","value":815},{"label":"Jul","value":727},{"label":"Ago","value":769},{"label":"Set","value":594},{"label":"Out","value":857},{"label":"Nov","value":603},{"label":"Dez","value":869}];
const MX = 943;
