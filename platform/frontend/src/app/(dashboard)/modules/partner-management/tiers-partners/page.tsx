...
const PAGE = "Partner Tiers";
const KPIS = [{"l":"ARR (€M)","v":"€20.3M","t":"+11.2%","d":"up"},{"l":"MRR (€)","v":"€33333","t":"+1.9%","d":"up"},{"l":"Churn (%)","v":"80.7%","t":"+7.3%","d":"up"},{"l":"ARPU (€)","v":"€38088","t":"+12.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3849.71","8.752","€ 44999.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7324.25","579","€ 1949.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 11613.82","635","€ 12720.86","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 17802.56","8.668","€ 30379.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 17530.93","4.576","€ 50081.60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":501},{"label":"Mar","value":527},{"label":"Abr","value":698},{"label":"Mai","value":524},{"label":"Jun","value":560},{"label":"Jul","value":661},{"label":"Ago","value":627},{"label":"Set","value":756},{"label":"Out","value":852},{"label":"Nov","value":493},{"label":"Dez","value":753}];
const MX = 852;
...
export default function TiersPartnersPage() {
    return (
