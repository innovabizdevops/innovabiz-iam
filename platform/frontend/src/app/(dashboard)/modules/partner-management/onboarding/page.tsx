...
const PAGE = "Partner Onboarding";
const KPIS = [{"l":"eNPS","v":"85","t":"-3.7%","d":"down"},{"l":"Engagement (%)","v":"78.8%","t":"+15.9%","d":"up"},{"l":"Turnover (%)","v":"65.0%","t":"+1.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.587","t":"+2.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.974","2026-02-12","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.606","2026-01-18","75","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.728","2026-03-26","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","938","2026-03-05","89","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.893","2026-02-12","69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":672},{"label":"Mar","value":683},{"label":"Abr","value":403},{"label":"Mai","value":424},{"label":"Jun","value":664},{"label":"Jul","value":447},{"label":"Ago","value":352},{"label":"Set","value":565},{"label":"Out","value":569},{"label":"Nov","value":318},{"label":"Dez","value":398}];
const MX = 683;
