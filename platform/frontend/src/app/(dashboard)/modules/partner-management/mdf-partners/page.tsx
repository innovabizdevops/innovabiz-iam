...
const PAGE = "MDF &amp; Co-Marketing";
const KPIS = [{"l":"Projetos Melhoria","v":"8.021","t":"+3.0%","d":"up"},{"l":"Savings (€)","v":"€93481","t":"+10.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.9%","t":"+4.5%","d":"up"},{"l":"Ciclos PDCA","v":"8.969","t":"-0.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.097","€ 35800.43","1.018","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.076","€ 9444.10","1.913","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.067","€ 23330.21","2.055","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.366","€ 2037.13","4.139","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.588","€ 27621.75","3.464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":746},{"label":"Mar","value":533},{"label":"Abr","value":713},{"label":"Mai","value":525},{"label":"Jun","value":353},{"label":"Jul","value":469},{"label":"Ago","value":520},{"label":"Set","value":555},{"label":"Out","value":586},{"label":"Nov","value":389},{"label":"Dez","value":358}];
const MX = 746;
...
export default function MdfPartnersPage() {
    return (
