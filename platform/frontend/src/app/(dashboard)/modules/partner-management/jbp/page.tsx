...
const PAGE = "Joint Business Planning";
const KPIS = [{"l":"Projetos Melhoria","v":"7.559","t":"+6.8%","d":"up"},{"l":"Savings (€)","v":"€16579","t":"-1.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"85.2%","t":"-1.4%","d":"down"},{"l":"Ciclos PDCA","v":"187","t":"+10.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","680","€ 46620.60","7.386","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.303","€ 12145.79","3.765","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.507","€ 10361.43","6.488","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.141","€ 37454.78","2.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","182","€ 40414.96","2.600","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":285},{"label":"Mar","value":331},{"label":"Abr","value":448},{"label":"Mai","value":433},{"label":"Jun","value":498},{"label":"Jul","value":491},{"label":"Ago","value":466},{"label":"Set","value":640},{"label":"Out","value":525},{"label":"Nov","value":577},{"label":"Dez","value":256}];
const MX = 640;
