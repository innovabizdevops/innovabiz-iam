...
const PAGE = "Partner Portal CMS";
const KPIS = [{"l":"Projetos Melhoria","v":"479","t":"+17.9%","d":"up"},{"l":"Savings (€)","v":"€33947","t":"-4.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"68.3%","t":"+14.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.810","t":"+13.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.606","€ 34253.80","7.286","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.975","€ 26605.44","2.400","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.722","€ 14313.40","3.710","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.934","€ 23065.24","5.241","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.363","€ 10771.32","8.250","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":671},{"label":"Mar","value":811},{"label":"Abr","value":604},{"label":"Mai","value":928},{"label":"Jun","value":687},{"label":"Jul","value":710},{"label":"Ago","value":851},{"label":"Set","value":608},{"label":"Out","value":980},{"label":"Nov","value":752},{"label":"Dez","value":649}];
const MX = 980;
