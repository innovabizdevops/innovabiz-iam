...
const PAGE = "MDF Management";
const KPIS = [{"l":"Projetos Melhoria","v":"5.518","t":"+4.3%","d":"up"},{"l":"Savings (€)","v":"€61634","t":"+6.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.7%","t":"+17.6%","d":"up"},{"l":"Ciclos PDCA","v":"7.392","t":"-4.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.778","€ 29012.46","7.508","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.606","€ 13481.84","1.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.200","€ 50082.34","7.987","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.187","€ 14706.69","5.804","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.089","€ 16474.39","4.676","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":533},{"label":"Mar","value":557},{"label":"Abr","value":491},{"label":"Mai","value":690},{"label":"Jun","value":492},{"label":"Jul","value":320},{"label":"Ago","value":523},{"label":"Set","value":519},{"label":"Out","value":425},{"label":"Nov","value":625},{"label":"Dez","value":553}];
const MX = 690;
