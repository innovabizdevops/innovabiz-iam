...
const PAGE = "Ecosystem";
const KPIS = [{"l":"Projetos Melhoria","v":"5.852","t":"+14.0%","d":"up"},{"l":"Savings (€)","v":"€9801","t":"+8.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.8%","t":"-1.7%","d":"down"},{"l":"Ciclos PDCA","v":"2.425","t":"+11.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","994","€ 30835.62","7.630","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.491","€ 27162.25","5.538","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.623","€ 30937.86","456","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.984","€ 49284.76","1.187","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","544","€ 40069.16","8.331","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":554},{"label":"Mar","value":405},{"label":"Abr","value":690},{"label":"Mai","value":433},{"label":"Jun","value":476},{"label":"Jul","value":682},{"label":"Ago","value":494},{"label":"Set","value":616},{"label":"Out","value":711},{"label":"Nov","value":380},{"label":"Dez","value":554}];
const MX = 711;
