...
const PAGE = "Insight";
const KPIS = [{"l":"Ideias Submetidas","v":"7.054","t":"-1.4%","d":"down"},{"l":"Patentes (YTD)","v":"6.558","t":"-5.0%","d":"down"},{"l":"Projetos Innovation Lab","v":"5.325","t":"+9.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€9.4M","t":"+1.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.784","75.1%","4.759","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.278","71.4%","3.659","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.007","72.1%","2.829","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.128","82.9%","1.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.986","91.7%","5.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":564},{"label":"Mar","value":615},{"label":"Abr","value":557},{"label":"Mai","value":693},{"label":"Jun","value":873},{"label":"Jul","value":709},{"label":"Ago","value":916},{"label":"Set","value":633},{"label":"Out","value":850},{"label":"Nov","value":814},{"label":"Dez","value":545}];
const MX = 916;
