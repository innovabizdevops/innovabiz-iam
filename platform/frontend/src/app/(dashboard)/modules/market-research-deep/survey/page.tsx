...
const PAGE = "Survey";
const KPIS = [{"l":"Ideias Submetidas","v":"3.224","t":"-0.7%","d":"down"},{"l":"Patentes (YTD)","v":"2.024","t":"+13.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.216","t":"+0.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€27.6M","t":"+7.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.944","98.8%","258","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.645","96.2%","940","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","222","72.6%","1.701","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.150","71.9%","173","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.135","90.1%","7.229","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":802},{"label":"Mar","value":773},{"label":"Abr","value":820},{"label":"Mai","value":753},{"label":"Jun","value":903},{"label":"Jul","value":601},{"label":"Ago","value":761},{"label":"Set","value":587},{"label":"Out","value":670},{"label":"Nov","value":820},{"label":"Dez","value":733}];
const MX = 903;
