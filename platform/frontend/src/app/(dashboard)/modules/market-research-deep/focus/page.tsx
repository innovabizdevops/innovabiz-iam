...
const PAGE = "Focus Group";
const KPIS = [{"l":"Ideias Submetidas","v":"7.559","t":"+17.7%","d":"up"},{"l":"Patentes (YTD)","v":"6.211","t":"+3.6%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.241","t":"+17.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€17.2M","t":"+17.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.684","74.7%","3.498","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.339","96.9%","1.569","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.814","81.3%","3.046","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.695","83.2%","5.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.369","83.4%","253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":824},{"label":"Mar","value":725},{"label":"Abr","value":532},{"label":"Mai","value":584},{"label":"Jun","value":874},{"label":"Jul","value":559},{"label":"Ago","value":487},{"label":"Set","value":798},{"label":"Out","value":570},{"label":"Nov","value":816},{"label":"Dez","value":541}];
const MX = 874;
