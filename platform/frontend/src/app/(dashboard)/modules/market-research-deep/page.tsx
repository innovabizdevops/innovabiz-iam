...
/* ═══ Market Research Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "6048", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1649", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€388K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "92630348", cells: ["MAR-3348", "Market Research Deep Item 1", "21/9/2026", "€30 448"], status: "active" as const },
    { id: "92633919", cells: ["MAR-6919", "Market Research Deep Item 2", "8/4/2026", "€34 019"], status: "pending" as const },
    { id: "92637490", cells: ["MAR-1490", "Market Research Deep Item 3", "23/11/2026", "€37 590"], status: "completed" as const },
    { id: "92641061", cells: ["MAR-5061", "Market Research Deep Item 4", "10/6/2026", "€41 161"], status: "warning" as const },
    { id: "92644632", cells: ["MAR-8632", "Market Research Deep Item 5", "25/1/2026", "€44 732"], status: "active" as const },
];
...
export default function MarketResearchDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Market Research Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Market Research Deep</p>
                    </div>
                </div>
