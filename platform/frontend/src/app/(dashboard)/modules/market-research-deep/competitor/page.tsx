...
const KPIS = [{"l":"Ideias Submetidas","v":"6.490","t":"+6.5%","d":"up"},{"l":"Patentes (YTD)","v":"4.698","t":"+6.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.873","t":"-1.5%","d":"down"},{"l":"Budget I&D (€M)","v":"€40.6M","t":"-1.7%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.746","75.7%","8.547","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.264","74.2%","8.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.600","76.8%","9.031","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.895","71.8%","6.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.291","70.7%","7.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":367},{"label":"Mar","value":387},{"label":"Abr","value":343},{"label":"Mai","value":677},{"label":"Jun","value":442},{"label":"Jul","value":531},{"label":"Ago","value":393},{"label":"Set","value":456},{"label":"Out","value":375},{"label":"Nov","value":664},{"label":"Dez","value":388}];
const MX = 677;
