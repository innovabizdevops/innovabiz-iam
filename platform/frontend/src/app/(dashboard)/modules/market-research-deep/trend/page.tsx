...
const ACCENT = "#1e40af";
const MODULE = "Market Research Deep";
const PAGE = "Trend";
const KPIS = [{"l":"Ideias Submetidas","v":"8.236","t":"+10.3%","d":"up"},{"l":"Patentes (YTD)","v":"8.477","t":"+1.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"9.044","t":"+11.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€33.9M","t":"-1.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","9.085","87.7%","7.215","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.284","97.2%","1.757","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.022","78.9%","7.573","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","508","95.1%","6.500","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","7.057","76.9%","4.266","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":523},{"label":"Mar","value":567},{"label":"Abr","value":560},{"label":"Mai","value":828},{"label":"Jun","value":735},{"label":"Jul","value":722},{"label":"Ago","value":580},{"label":"Set","value":539},{"label":"Out","value":752},{"label":"Nov","value":675},{"label":"Dez","value":598}];
const MX = 857;
