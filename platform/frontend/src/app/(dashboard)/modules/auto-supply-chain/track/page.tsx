...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Supply Chain Deep";
const PAGE = "Track";
const KPIS = [{"l":"Total Auto Supply Chain","v":"1.579","t":"+17.9%","d":"up"},{"l":"Track Ativos","v":"5.309","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"66.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"62","t":"-1.0%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Supply Chain #001","Auto Supply Chain #002","8.148","1.298","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Supply Chain #002","Auto Supply Chain #003","8.215","9.098","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Supply Chain #003","Auto Supply Chain #004","1.031","834","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Supply Chain #004","Auto Supply Chain #005","6.303","6.863","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Supply Chain #005","Auto Supply Chain #001","8.765","3.496","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":1000},{"label":"Mar","value":1016},{"label":"Abr","value":851},{"label":"Mai","value":952},{"label":"Jun","value":806},{"label":"Jul","value":745},{"label":"Ago","value":963},{"label":"Set","value":1035},{"label":"Out","value":968},{"label":"Nov","value":1015},{"label":"Dez","value":825}];
const MX = 1035;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>RTM</span></h1>
                </div>
