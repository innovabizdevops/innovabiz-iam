...
/* ═══ Auto Supply Chain Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1396", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1337", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€358K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "683675496", cells: ["AUT-9496", "Auto Supply Chain Deep Item 1", "1/1/2026", "€25 596"], status: "active" as const },
    { id: "683679067", cells: ["AUT-4067", "Auto Supply Chain Deep Item 2", "16/8/2026", "€29 167"], status: "pending" as const },
    { id: "683682638", cells: ["AUT-7638", "Auto Supply Chain Deep Item 3", "3/3/2026", "€32 738"], status: "completed" as const },
    { id: "683686209", cells: ["AUT-2209", "Auto Supply Chain Deep Item 4", "18/10/2026", "€36 309"], status: "warning" as const },
    { id: "683689780", cells: ["AUT-5780", "Auto Supply Chain Deep Item 5", "5/5/2026", "€39 880"], status: "active" as const },
];
...
export default function AutoSupplyChainDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Supply Chain Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Supply Chain Deep</p>
                    </div>
                </div>
