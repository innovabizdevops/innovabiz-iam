...
const PAGE = "Tier";
const KPIS = [{"l":"ARR (€M)","v":"€14.3M","t":"+1.3%","d":"up"},{"l":"MRR (€)","v":"€1833","t":"+-0.0%","d":"up"},{"l":"Churn (%)","v":"95.0%","t":"+8.6%","d":"up"},{"l":"ARPU (€)","v":"€68864","t":"+16.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 12001.98","6.273","€ 24441.59","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7701.46","4.386","€ 41257.27","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28455.88","1.332","€ 10451.95","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 40998.21","2.230","€ 31712.28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15120.67","5.366","€ 3091.69","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":500},{"label":"Mar","value":614},{"label":"Abr","value":664},{"label":"Mai","value":416},{"label":"Jun","value":361},{"label":"Jul","value":407},{"label":"Ago","value":538},{"label":"Set","value":740},{"label":"Out","value":683},{"label":"Nov","value":360},{"label":"Dez","value":445}];
const MX = 744;
