...
const PAGE = "Patient Registry";
const KPIS = [{"l":"Total Drug Development","v":"896","t":"-0.5%","d":"down"},{"l":"Patient Registry Ativos","v":"1.214","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"77.9%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.0%","d":"up"}];
const COLS = ["ID","Patient Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","4.341","4.233","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","2.554","7.886","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","288","6.220","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","7.167","172","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","9.029","2.926","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":739},{"label":"Mar","value":632},{"label":"Abr","value":752},{"label":"Mai","value":787},{"label":"Jun","value":795},{"label":"Jul","value":960},{"label":"Ago","value":818},{"label":"Set","value":957},{"label":"Out","value":748},{"label":"Nov","value":875},{"label":"Dez","value":827}];
const MX = 960;
