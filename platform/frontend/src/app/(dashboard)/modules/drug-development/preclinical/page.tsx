...
const PAGE = "Pre-Clinical";
const KPIS = [{"l":"Total Drug Development","v":"6.100","t":"-2.8%","d":"down"},{"l":"Pre Clinical Ativos","v":"5.921","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"88","t":"+17.8%","d":"up"}];
const COLS = ["ID","Pre Clinical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","8.159","6.772","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","1.597","1.094","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","8.739","6.557","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","3.457","8.792","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","1.884","254","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":918},{"label":"Mar","value":814},{"label":"Abr","value":983},{"label":"Mai","value":891},{"label":"Jun","value":694},{"label":"Jul","value":741},{"label":"Ago","value":797},{"label":"Set","value":633},{"label":"Out","value":786},{"label":"Nov","value":912},{"label":"Dez","value":930}];
const MX = 983;
