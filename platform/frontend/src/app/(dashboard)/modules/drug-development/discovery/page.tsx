...
const KPIS = [{"l":"Total Drug Development","v":"8.321","t":"+15.2%","d":"up"},{"l":"Discovery Ativos","v":"6.428","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.1%","d":"up"}];
const COLS = ["ID","Discovery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","748","1.188","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","1.293","1.581","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","2.263","2.531","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","429","6.432","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","8.740","348","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":606},{"label":"Mar","value":607},{"label":"Abr","value":852},{"label":"Mai","value":530},{"label":"Jun","value":486},{"label":"Jul","value":575},{"label":"Ago","value":824},{"label":"Set","value":514},{"label":"Out","value":829},{"label":"Nov","value":600},{"label":"Dez","value":790}];
const MX = 852;
