...
const ACCENT = "#1e40af";
const MODULE = "Drug Development";
const PAGE = "Real World Evidence";
const KPIS = [{"l":"Total Drug Development","v":"7.998","t":"+17.6%","d":"up"},{"l":"Real World Evidence Ativos","v":"8.594","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"92.3%","t":"+4.6%","d":"up"},{"l":"Score Performance","v":"94","t":"-3.8%","d":"down"}];
const COLS = ["ID","Real World Evidence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","1.042","8.999","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","7.948","2.694","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","6.833","6.245","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","4.931","6.940","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","689","946","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":914},{"label":"Mar","value":717},{"label":"Abr","value":847},{"label":"Mai","value":571},{"label":"Jun","value":739},{"label":"Jul","value":628},{"label":"Ago","value":638},{"label":"Set","value":565},{"label":"Out","value":882},{"label":"Nov","value":891},{"label":"Dez","value":911}];
const MX = 914;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>AI</span></h1>
                </div>
