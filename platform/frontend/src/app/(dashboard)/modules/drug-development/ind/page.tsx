...
const PAGE = "IND Filing";
const KPIS = [{"l":"Total Drug Development","v":"7.350","t":"+9.1%","d":"up"},{"l":"IND Filing Ativos","v":"7.854","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.1%","d":"down"}];
const COLS = ["ID","IND Filing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","5.967","9.089","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","6.180","3.944","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","6.234","8.187","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","4.766","4.368","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","7.904","1.634","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":752},{"label":"Mar","value":771},{"label":"Abr","value":866},{"label":"Mai","value":587},{"label":"Jun","value":775},{"label":"Jul","value":638},{"label":"Ago","value":516},{"label":"Set","value":646},{"label":"Out","value":727},{"label":"Nov","value":870},{"label":"Dez","value":848}];
const MX = 870;
