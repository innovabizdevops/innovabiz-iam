...
const PAGE = "NDA Submit";
const KPIS = [{"l":"Total Drug Development","v":"4.841","t":"+15.0%","d":"up"},{"l":"NDA Submit Ativos","v":"2.812","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"76.5%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"58","t":"+11.2%","d":"up"}];
const COLS = ["ID","NDA Submit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Drug Development #001","Drug Development #002","2.161","5.215","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Drug Development #002","Drug Development #003","2.722","7.508","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Drug Development #003","Drug Development #004","2.531","4.873","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Drug Development #004","Drug Development #005","1.120","4.523","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Drug Development #005","Drug Development #001","3.432","1.826","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":472},{"label":"Mar","value":576},{"label":"Abr","value":549},{"label":"Mai","value":439},{"label":"Jun","value":382},{"label":"Jul","value":537},{"label":"Ago","value":498},{"label":"Set","value":399},{"label":"Out","value":401},{"label":"Nov","value":310},{"label":"Dez","value":480}];
const MX = 576;
