...
const ACCENT = "#92400e";
const MODULE = "Insurance Compliance Deep";
const PAGE = "IFRS 17";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.436","t":"+1.0%","d":"up"},{"l":"NC Abertas","v":"5.145","t":"+11.9%","d":"up"},{"l":"Conformidade (%)","v":"92.6%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"1.851","t":"-1.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.379","71.7%","8.014","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.361","72.3%","956","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","254","82.7%","1.413","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.183","99.6%","7.142","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.609","75.9%","8.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":754},{"label":"Mar","value":905},{"label":"Abr","value":790},{"label":"Mai","value":584},{"label":"Jun","value":847},{"label":"Jul","value":887},{"label":"Ago","value":841},{"label":"Set","value":663},{"label":"Out","value":853},{"label":"Nov","value":896},{"label":"Dez","value":692}];
const MX = 905;
