...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.524","t":"+8.9%","d":"up"},{"l":"NC Abertas","v":"3.176","t":"-1.6%","d":"down"},{"l":"Conformidade (%)","v":"86.4%","t":"+16.2%","d":"up"},{"l":"CAPAs Pendentes","v":"7.143","t":"-4.1%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.215","92.8%","8.499","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.703","78.0%","6.259","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.350","99.3%","9.086","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.032","83.8%","1.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.119","82.5%","5.430","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":330},{"label":"Mar","value":582},{"label":"Abr","value":324},{"label":"Mai","value":469},{"label":"Jun","value":548},{"label":"Jul","value":548},{"label":"Ago","value":306},{"label":"Set","value":341},{"label":"Out","value":251},{"label":"Nov","value":274},{"label":"Dez","value":466}];
const MX = 582;
