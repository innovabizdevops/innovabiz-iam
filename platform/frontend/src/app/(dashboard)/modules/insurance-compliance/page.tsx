...
/* ═══ Insurance Compliance Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8933", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "167", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€248K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1212392533", cells: ["INS-3533", "Insurance Compliance Deep Item 1", "10/2/2026", "€42 633"], status: "active" as const },
    { id: "1212396104", cells: ["INS-7104", "Insurance Compliance Deep Item 2", "25/9/2026", "€46 204"], status: "pending" as const },
    { id: "1212399675", cells: ["INS-1675", "Insurance Compliance Deep Item 3", "12/4/2026", "€49 775"], status: "completed" as const },
    { id: "1212403246", cells: ["INS-5246", "Insurance Compliance Deep Item 4", "27/11/2026", "€3346"], status: "warning" as const },
    { id: "1212406817", cells: ["INS-8817", "Insurance Compliance Deep Item 5", "14/6/2026", "€6917"], status: "active" as const },
];
...
export default function InsuranceComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Compliance Deep</p>
                    </div>
                </div>
