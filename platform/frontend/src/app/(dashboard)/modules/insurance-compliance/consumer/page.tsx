...
const PAGE = "Consumer";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.150","t":"+16.6%","d":"up"},{"l":"NC Abertas","v":"1.824","t":"+10.8%","d":"up"},{"l":"Conformidade (%)","v":"86.5%","t":"+0.5%","d":"up"},{"l":"CAPAs Pendentes","v":"7.597","t":"+17.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.507","98.0%","3.308","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.949","71.9%","202","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.854","91.9%","4.713","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.858","81.2%","497","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.831","91.0%","5.679","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":578},{"label":"Mar","value":252},{"label":"Abr","value":265},{"label":"Mai","value":377},{"label":"Jun","value":453},{"label":"Jul","value":516},{"label":"Ago","value":325},{"label":"Set","value":583},{"label":"Out","value":338},{"label":"Nov","value":441},{"label":"Dez","value":507}];
const MX = 583;
