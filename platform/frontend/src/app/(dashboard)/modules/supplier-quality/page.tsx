...
/* ═══ Supplier Quality Mgmt — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "5761", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4938", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€28K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1227823461", cells: ["SUP-8461", "Supplier Quality Mgmt Item 1", "26/10/2026", "€23 561"], status: "active" as const },
    { id: "1227827032", cells: ["SUP-3032", "Supplier Quality Mgmt Item 2", "13/5/2026", "€27 132"], status: "pending" as const },
    { id: "1227830603", cells: ["SUP-6603", "Supplier Quality Mgmt Item 3", "28/12/2026", "€30 703"], status: "completed" as const },
    { id: "1227834174", cells: ["SUP-1174", "Supplier Quality Mgmt Item 4", "15/7/2026", "€34 274"], status: "warning" as const },
    { id: "1227837745", cells: ["SUP-4745", "Supplier Quality Mgmt Item 5", "2/2/2026", "€37 845"], status: "active" as const },
];
...
export default function SupplierQualityMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Quality Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supplier Quality Mgmt</p>
                    </div>
                </div>
