...
const ACCENT = "#b45309";
const MODULE = "Supplier Quality Mgmt";
const PAGE = "Score";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.476","t":"+14.2%","d":"up"},{"l":"NC Abertas","v":"3.042","t":"-2.3%","d":"down"},{"l":"Conformidade (%)","v":"81.3%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"8.249","t":"+14.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.052","98.2%","6.116","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.909","91.3%","1.333","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.604","77.1%","3.053","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.075","95.6%","3.519","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.564","84.9%","2.721","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":867},{"label":"Mar","value":770},{"label":"Abr","value":861},{"label":"Mai","value":638},{"label":"Jun","value":994},{"label":"Jul","value":956},{"label":"Ago","value":1016},{"label":"Set","value":807},{"label":"Out","value":658},{"label":"Nov","value":920},{"label":"Dez","value":652}];
const MX = 1016;
