...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.242","t":"+6.4%","d":"up"},{"l":"NC Abertas","v":"2.529","t":"-1.5%","d":"down"},{"l":"Conformidade (%)","v":"75.0%","t":"-0.3%","d":"down"},{"l":"CAPAs Pendentes","v":"8.342","t":"+7.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.135","76.0%","8.106","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.069","89.5%","3.815","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","230","97.3%","7.146","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.602","71.9%","798","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.671","73.9%","8.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":863},{"label":"Mar","value":858},{"label":"Abr","value":754},{"label":"Mai","value":838},{"label":"Jun","value":627},{"label":"Jul","value":763},{"label":"Ago","value":904},{"label":"Set","value":547},{"label":"Out","value":927},{"label":"Nov","value":855},{"label":"Dez","value":826}];
const MX = 927;
