...
const PAGE = "Inspect";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.030","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"8.577","t":"+6.9%","d":"up"},{"l":"Conformidade (%)","v":"72.8%","t":"-2.2%","d":"down"},{"l":"CAPAs Pendentes","v":"1.545","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.617","96.5%","2.251","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.424","80.3%","662","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.947","72.9%","4.457","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.444","75.9%","3.268","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.464","92.4%","8.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":272},{"label":"Mar","value":490},{"label":"Abr","value":345},{"label":"Mai","value":598},{"label":"Jun","value":312},{"label":"Jul","value":403},{"label":"Ago","value":384},{"label":"Set","value":471},{"label":"Out","value":258},{"label":"Nov","value":485},{"label":"Dez","value":387}];
const MX = 598;
