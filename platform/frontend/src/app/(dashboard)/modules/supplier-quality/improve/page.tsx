...
const PAGE = "Improve";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.584","t":"+14.4%","d":"up"},{"l":"NC Abertas","v":"5.924","t":"-0.8%","d":"down"},{"l":"Conformidade (%)","v":"68.1%","t":"+11.3%","d":"up"},{"l":"CAPAs Pendentes","v":"2.638","t":"+12.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","681","71.9%","8.823","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.924","85.5%","4.495","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.274","98.0%","4.889","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.130","84.4%","445","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.719","95.6%","756","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":599},{"label":"Mar","value":448},{"label":"Abr","value":411},{"label":"Mai","value":534},{"label":"Jun","value":442},{"label":"Jul","value":412},{"label":"Ago","value":294},{"label":"Set","value":545},{"label":"Out","value":465},{"label":"Nov","value":396},{"label":"Dez","value":555}];
const MX = 607;
