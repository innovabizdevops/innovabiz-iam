...
const PAGE = "Permission Matrix";
const KPIS = [{"l":"Riscos Identificados","v":"643","t":"-1.0%","d":"down"},{"l":"Mitigações Ativas","v":"129","t":"+5.4%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"+11.7%","d":"up"},{"l":"Incidentes YTD","v":"3.213","t":"+5.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.485","1.654","6.472","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.777","516","7.993","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.349","921","1.488","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","751","6.199","1.608","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.352","4.521","4.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":369},{"label":"Mar","value":627},{"label":"Abr","value":389},{"label":"Mai","value":578},{"label":"Jun","value":314},{"label":"Jul","value":276},{"label":"Ago","value":443},{"label":"Set","value":595},{"label":"Out","value":495},{"label":"Nov","value":300},{"label":"Dez","value":372}];
const MX = 627;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>Matrix</span></h1>
                </div>
