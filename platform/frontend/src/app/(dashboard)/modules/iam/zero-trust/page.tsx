...
const ACCENT = "#7c3aed";
const MODULE = "Identity & Access";
const PAGE = "Zero Trust Engine";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.932","t":"+5.1%","d":"up"},{"l":"Sessões/Dia","v":"2064","t":"+9.2%","d":"up"},{"l":"MFA Adoção (%)","v":"84.2%","t":"-4.4%","d":"down"},{"l":"Tentativas Bloqueadas","v":"4.120","t":"+8.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.099","2.859","5.985","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.777","6.283","2.881","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.428","2.135","5.580","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","2.281","3.104","1.393","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.217","1.744","7.280","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":432},{"label":"Mar","value":512},{"label":"Abr","value":599},{"label":"Mai","value":538},{"label":"Jun","value":402},{"label":"Jul","value":659},{"label":"Ago","value":583},{"label":"Set","value":622},{"label":"Out","value":614},{"label":"Nov","value":416},{"label":"Dez","value":599}];
const MX = 659;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>ZTA</span></h1>
                </div>
