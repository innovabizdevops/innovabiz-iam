...
const PAGE = "Privileged Access Mgmt";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.304","t":"+2.2%","d":"up"},{"l":"Sessões/Dia","v":"3659","t":"+6.0%","d":"up"},{"l":"MFA Adoção (%)","v":"92.4%","t":"-4.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.797","t":"+16.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.240","1.466","6.921","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.956","3.869","1.786","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.737","4.711","8.505","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.742","5.257","7.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.548","2.059","1.318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":905},{"label":"Mar","value":791},{"label":"Abr","value":608},{"label":"Mai","value":575},{"label":"Jun","value":874},{"label":"Jul","value":540},{"label":"Ago","value":818},{"label":"Set","value":537},{"label":"Out","value":544},{"label":"Nov","value":615},{"label":"Dez","value":844}];
const MX = 925;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>PAM</span></h1>
                </div>
