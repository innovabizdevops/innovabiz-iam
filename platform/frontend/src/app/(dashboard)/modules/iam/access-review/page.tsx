...
const PAGE = "Access Review Form";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.127","t":"-1.7%","d":"down"},{"l":"Sessões/Dia","v":"1224","t":"+0.9%","d":"up"},{"l":"MFA Adoção (%)","v":"90.4%","t":"-1.6%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.035","t":"+1.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","421","8.534","5.546","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.958","8.780","5.120","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.454","8.477","6.886","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.110","6.521","7.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.504","4.454","2.988","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":409},{"label":"Mar","value":420},{"label":"Abr","value":510},{"label":"Mai","value":576},{"label":"Jun","value":540},{"label":"Jul","value":404},{"label":"Ago","value":679},{"label":"Set","value":650},{"label":"Out","value":319},{"label":"Nov","value":610},{"label":"Dez","value":609}];
const MX = 679;
