...
const PAGE = "Identity Analytics";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.520","t":"+13.0%","d":"up"},{"l":"Sessões/Dia","v":"3187","t":"+2.7%","d":"up"},{"l":"MFA Adoção (%)","v":"86.7%","t":"-3.5%","d":"down"},{"l":"Tentativas Bloqueadas","v":"374","t":"+1.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","908","7.573","746","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.500","5.863","7.729","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.120","3.243","5.168","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.751","8.176","1.530","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.089","7.017","5.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":865},{"label":"Mar","value":823},{"label":"Abr","value":956},{"label":"Mai","value":863},{"label":"Jun","value":844},{"label":"Jul","value":895},{"label":"Ago","value":781},{"label":"Set","value":964},{"label":"Out","value":1070},{"label":"Nov","value":948},{"label":"Dez","value":722}];
const MX = 1070;
