...
const PAGE = "User Registration Form";
const KPIS = [{"l":"Utilizadores Ativos","v":"1.002","t":"+8.4%","d":"up"},{"l":"Sessões/Dia","v":"176","t":"+0.8%","d":"up"},{"l":"MFA Adoção (%)","v":"89.2%","t":"+10.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.996","t":"+2.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.095","5.504","5.050","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.845","9.063","8.606","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","7.382","4.117","291","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.885","6.950","766","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.931","8.442","4.396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":292},{"label":"Mar","value":347},{"label":"Abr","value":591},{"label":"Mai","value":647},{"label":"Jun","value":341},{"label":"Jul","value":663},{"label":"Ago","value":623},{"label":"Set","value":436},{"label":"Out","value":352},{"label":"Nov","value":643},{"label":"Dez","value":382}];
const MX = 663;
