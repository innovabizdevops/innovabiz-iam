...
const PAGE = "SASE Gateway";
const KPIS = [{"l":"Utilizadores Ativos","v":"683","t":"+13.7%","d":"up"},{"l":"Sessões/Dia","v":"583","t":"+2.4%","d":"up"},{"l":"MFA Adoção (%)","v":"88.1%","t":"-4.6%","d":"down"},{"l":"Tentativas Bloqueadas","v":"8.299","t":"+17.0%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.145","4.483","8.071","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.968","8.780","1.479","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","748","587","4.321","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.084","6.837","2.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.881","8.978","4.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":672},{"label":"Mar","value":468},{"label":"Abr","value":302},{"label":"Mai","value":568},{"label":"Jun","value":388},{"label":"Jul","value":485},{"label":"Ago","value":370},{"label":"Set","value":487},{"label":"Out","value":284},{"label":"Nov","value":551},{"label":"Dez","value":303}];
const MX = 672;
