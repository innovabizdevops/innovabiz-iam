...
const KPIS = [{"l":"Projetos Sociais","v":"2.828","t":"+1.5%","d":"up"},{"l":"Beneficiários","v":"1.751","t":"+12.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€80312","t":"-2.5%","d":"down"},{"l":"Score Impacto","v":"92","t":"+4.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.926","€ 23562.83","732","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","1.739","€ 15155.36","7.137","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.791","€ 47751.72","7.231","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.741","€ 16186.86","8.230","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.319","€ 2344.28","3.362","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":987},{"label":"Mar","value":824},{"label":"Abr","value":958},{"label":"Mai","value":641},{"label":"Jun","value":761},{"label":"Jul","value":733},{"label":"Ago","value":1010},{"label":"Set","value":624},{"label":"Out","value":961},{"label":"Nov","value":853},{"label":"Dez","value":774}];
const MX = 1010;
