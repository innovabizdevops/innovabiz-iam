...
const ACCENT = "#cbd5e1";
const MODULE = "Biodiversity Mgmt";
const PAGE = "Species Track";
const KPIS = [{"l":"Total Biodiversity Mgmt","v":"6.537","t":"+12.1%","d":"up"},{"l":"Species Track Ativos","v":"7.265","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"67.9%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"80","t":"+4.8%","d":"up"}];
const COLS = ["ID","Species Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biodiversity Mgmt #001","Biodiversity Mgmt #002","2.589","8.401","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Biodiversity Mgmt #002","Biodiversity Mgmt #003","7.659","6.499","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Biodiversity Mgmt #003","Biodiversity Mgmt #004","1.509","7.568","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Biodiversity Mgmt #004","Biodiversity Mgmt #005","8.378","5.089","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biodiversity Mgmt #005","Biodiversity Mgmt #001","6.939","4.784","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":523},{"label":"Mar","value":605},{"label":"Abr","value":730},{"label":"Mai","value":551},{"label":"Jun","value":461},{"label":"Jul","value":702},{"label":"Ago","value":492},{"label":"Set","value":679},{"label":"Out","value":578},{"label":"Nov","value":583},{"label":"Dez","value":553}];
const MX = 730;
