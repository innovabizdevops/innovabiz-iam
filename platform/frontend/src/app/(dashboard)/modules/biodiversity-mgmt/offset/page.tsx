...
const PAGE = "Offset Credit";
const KPIS = [{"l":"Integrações Ativas","v":"7.927","t":"+7.2%","d":"up"},{"l":"Chamadas/Hora","v":"1195","t":"+9.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.8%","t":"+2.9%","d":"up"},{"l":"Latência Média (ms)","v":"11ms","t":"-4.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.913","2.742","83.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.901","4.478","76.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.673","3.314","79.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.552","5.006","75.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.742","5.409","94.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":808},{"label":"Mar","value":932},{"label":"Abr","value":954},{"label":"Mai","value":666},{"label":"Jun","value":609},{"label":"Jul","value":798},{"label":"Ago","value":656},{"label":"Set","value":610},{"label":"Out","value":577},{"label":"Nov","value":578},{"label":"Dez","value":604}];
const MX = 954;
