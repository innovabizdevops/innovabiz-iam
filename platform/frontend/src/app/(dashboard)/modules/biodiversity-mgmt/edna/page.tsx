...
const PAGE = "eDNA Sampling";
const KPIS = [{"l":"Total Biodiversity Mgmt","v":"5.173","t":"+10.1%","d":"up"},{"l":"EDNA Sampling Ativos","v":"2.696","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"86","t":"+9.7%","d":"up"}];
const COLS = ["ID","EDNA Sampling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biodiversity Mgmt #001","Biodiversity Mgmt #002","6.872","9.054","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Biodiversity Mgmt #002","Biodiversity Mgmt #003","3.818","1.959","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Biodiversity Mgmt #003","Biodiversity Mgmt #004","8.016","3.312","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Biodiversity Mgmt #004","Biodiversity Mgmt #005","1.970","2.082","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biodiversity Mgmt #005","Biodiversity Mgmt #001","8.803","4.221","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":626},{"label":"Mar","value":592},{"label":"Abr","value":883},{"label":"Mai","value":819},{"label":"Jun","value":551},{"label":"Jul","value":837},{"label":"Ago","value":713},{"label":"Set","value":718},{"label":"Out","value":745},{"label":"Nov","value":666},{"label":"Dez","value":842}];
const MX = 883;
