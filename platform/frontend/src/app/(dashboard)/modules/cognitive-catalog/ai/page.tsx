...
const ACCENT = "#312e81";
const MODULE = "Cognitive Service Catalog";
const PAGE = "AI Service";
const KPIS = [{"l":"Dashboards Ativos","v":"5.993","t":"+14.2%","d":"up"},{"l":"Queries/Dia","v":"2625","t":"-0.6%","d":"down"},{"l":"Dados Processados (GB)","v":"6.554","t":"+4.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.121","t":"-5.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3048","2026-01-15","3.796","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","792","2026-02-03","3.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4072","2026-03-22","1.854","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4230","2026-03-27","1.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2728","2026-03-03","4.658","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":289},{"label":"Fev","value":366},{"label":"Mar","value":339},{"label":"Abr","value":318},{"label":"Mai","value":533},{"label":"Jun","value":514},{"label":"Jul","value":251},{"label":"Ago","value":438},{"label":"Set","value":575},{"label":"Out","value":264},{"label":"Nov","value":603},{"label":"Dez","value":609}];
const MX = 609;
