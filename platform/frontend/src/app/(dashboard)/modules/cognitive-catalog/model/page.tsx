...
const PAGE = "Model";
const KPIS = [{"l":"Dashboards Ativos","v":"807","t":"+8.0%","d":"up"},{"l":"Queries/Dia","v":"1531","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.869","t":"+15.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.746","t":"+16.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4507","2026-01-27","4.626","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","617","2026-02-14","1.303","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4045","2026-03-09","1.552","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3508","2026-03-06","7.865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4176","2026-03-05","2.449","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":414},{"label":"Mar","value":632},{"label":"Abr","value":693},{"label":"Mai","value":503},{"label":"Jun","value":606},{"label":"Jul","value":608},{"label":"Ago","value":586},{"label":"Set","value":691},{"label":"Out","value":515},{"label":"Nov","value":594},{"label":"Dez","value":676}];
const MX = 693;
