...
const PAGE = "Pipeline";
const KPIS = [{"l":"Dashboards Ativos","v":"6.394","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"2733","t":"+11.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.843","t":"-3.8%","d":"down"},{"l":"Utilizadores Analytics","v":"3.605","t":"-3.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1411","2026-01-24","7.851","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","824","2026-02-05","8.727","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2722","2026-01-16","2.449","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2412","2026-03-06","1.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2030","2026-03-20","893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":471},{"label":"Fev","value":755},{"label":"Mar","value":614},{"label":"Abr","value":490},{"label":"Mai","value":579},{"label":"Jun","value":470},{"label":"Jul","value":758},{"label":"Ago","value":761},{"label":"Set","value":685},{"label":"Out","value":613},{"label":"Nov","value":763},{"label":"Dez","value":607}];
const MX = 763;
