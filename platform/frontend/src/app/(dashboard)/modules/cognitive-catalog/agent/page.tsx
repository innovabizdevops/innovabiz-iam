...
const PAGE = "Agent";
const KPIS = [{"l":"Dashboards Ativos","v":"3.138","t":"-1.3%","d":"down"},{"l":"Queries/Dia","v":"3021","t":"+3.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.888","t":"+8.5%","d":"up"},{"l":"Utilizadores Analytics","v":"4.663","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2858","2026-03-02","4.683","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2977","2026-01-07","8.166","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4660","2026-02-13","3.582","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1807","2026-01-06","7.608","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3392","2026-03-18","5.361","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":398},{"label":"Mar","value":478},{"label":"Abr","value":452},{"label":"Mai","value":578},{"label":"Jun","value":255},{"label":"Jul","value":386},{"label":"Ago","value":247},{"label":"Set","value":611},{"label":"Out","value":295},{"label":"Nov","value":366},{"label":"Dez","value":553}];
const MX = 611;
