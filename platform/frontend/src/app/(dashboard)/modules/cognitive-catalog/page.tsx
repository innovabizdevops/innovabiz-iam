...
/* ═══ Cognitive Service Catalog — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "3165", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4754", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1903485965", cells: ["COG-4965", "Cognitive Service Catalog Item 1", "18/6/2026", "€36 065"], status: "active" as const },
    { id: "1903489536", cells: ["COG-8536", "Cognitive Service Catalog Item 2", "5/1/2026", "€39 636"], status: "pending" as const },
    { id: "1903493107", cells: ["COG-3107", "Cognitive Service Catalog Item 3", "20/8/2026", "€43 207"], status: "completed" as const },
    { id: "1903496678", cells: ["COG-6678", "Cognitive Service Catalog Item 4", "7/3/2026", "€46 778"], status: "warning" as const },
    { id: "1903500249", cells: ["COG-1249", "Cognitive Service Catalog Item 5", "22/10/2026", "€349"], status: "active" as const },
];
...
export default function CognitiveServiceCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cognitive Service Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cognitive Service Catalog</p>
                    </div>
                </div>
