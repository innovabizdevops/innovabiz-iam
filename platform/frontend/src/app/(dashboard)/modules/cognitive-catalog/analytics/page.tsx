...
const KPIS = [{"l":"Dashboards Ativos","v":"6.029","t":"+14.0%","d":"up"},{"l":"Queries/Dia","v":"654","t":"-5.4%","d":"down"},{"l":"Dados Processados (GB)","v":"6.241","t":"-0.5%","d":"down"},{"l":"Utilizadores Analytics","v":"1.153","t":"+3.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2523","2026-03-23","1.174","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2971","2026-03-11","6.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3777","2026-03-22","5.043","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3352","2026-01-19","2.458","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2610","2026-03-13","3.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":413},{"label":"Mar","value":539},{"label":"Abr","value":448},{"label":"Mai","value":491},{"label":"Jun","value":492},{"label":"Jul","value":565},{"label":"Ago","value":465},{"label":"Set","value":542},{"label":"Out","value":516},{"label":"Nov","value":462},{"label":"Dez","value":539}];
const MX = 576;
