...
/* ═══ Upstream Ops — Field Development ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "4555", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "44", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2649", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1045760504", cells: ["UPS-6504", "Field Development Item 1", "13/9/2026", "€10 604"], status: "active" as const },
    { id: "1045764075", cells: ["UPS-1075", "Field Development Item 2", "28/4/2026", "€14 175"], status: "pending" as const },
    { id: "1045767646", cells: ["UPS-4646", "Field Development Item 3", "15/11/2026", "€17 746"], status: "completed" as const },
    { id: "1045771217", cells: ["UPS-8217", "Field Development Item 4", "2/6/2026", "€21 317"], status: "warning" as const },
    { id: "1045774788", cells: ["UPS-2788", "Field Development Item 5", "17/1/2026", "€24 888"], status: "active" as const },
];
...
export default function UpstreamOpsFieldDevelopmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Field Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Field Development</p>
                    </div>
                </div>
