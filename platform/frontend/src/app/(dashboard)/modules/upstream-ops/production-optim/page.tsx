...
/* ═══ Upstream Ops — Production Optim ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1152", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "71", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3866", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "754219171", cells: ["UPS-2171", "Production Optim Item 1", "28/8/2026", "€19 271"], status: "active" as const },
    { id: "754222742", cells: ["UPS-5742", "Production Optim Item 2", "15/3/2026", "€22 842"], status: "pending" as const },
    { id: "754226313", cells: ["UPS-9313", "Production Optim Item 3", "2/10/2026", "€26 413"], status: "completed" as const },
    { id: "754229884", cells: ["UPS-3884", "Production Optim Item 4", "17/5/2026", "€29 984"], status: "warning" as const },
    { id: "754233455", cells: ["UPS-7455", "Production Optim Item 5", "4/12/2026", "€33 555"], status: "active" as const },
];
...
export default function UpstreamOpsProductionOptimPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Production Optim</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Production Optim</p>
                    </div>
                </div>
