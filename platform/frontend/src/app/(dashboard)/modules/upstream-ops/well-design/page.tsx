...
/* ═══ Upstream Ops — Well Design ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "777", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "103", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2932", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1102784195", cells: ["UPS-6195", "Well Design Item 1", "24/12/2026", "€34 295"], status: "active" as const },
    { id: "1102787766", cells: ["UPS-9766", "Well Design Item 2", "11/7/2026", "€37 866"], status: "pending" as const },
    { id: "1102791337", cells: ["UPS-4337", "Well Design Item 3", "26/2/2026", "€41 437"], status: "completed" as const },
    { id: "1102794908", cells: ["UPS-7908", "Well Design Item 4", "13/9/2026", "€45 008"], status: "warning" as const },
    { id: "1102798479", cells: ["UPS-2479", "Well Design Item 5", "28/4/2026", "€48 579"], status: "active" as const },
];
...
export default function UpstreamOpsWellDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Well Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Well Design</p>
                    </div>
                </div>
