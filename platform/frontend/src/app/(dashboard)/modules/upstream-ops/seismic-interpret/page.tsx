...
/* ═══ Upstream Ops — Seismic Interpret ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "1998", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "25", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1538", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "640832533", cells: ["UPS-6533", "Seismic Interpret Item 1", "6/2/2026", "€32 633"], status: "active" as const },
    { id: "640836104", cells: ["UPS-1104", "Seismic Interpret Item 2", "21/9/2026", "€36 204"], status: "pending" as const },
    { id: "640839675", cells: ["UPS-4675", "Seismic Interpret Item 3", "8/4/2026", "€39 775"], status: "completed" as const },
    { id: "640843246", cells: ["UPS-8246", "Seismic Interpret Item 4", "23/11/2026", "€43 346"], status: "warning" as const },
    { id: "640846817", cells: ["UPS-2817", "Seismic Interpret Item 5", "10/6/2026", "€46 917"], status: "active" as const },
];
...
export default function UpstreamOpsSeismicInterpretPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Seismic Interpret</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Seismic Interpret</p>
                    </div>
                </div>
