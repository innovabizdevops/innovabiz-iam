...
/* ═══ Upstream Ops — Completion Mgmt ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "270", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "236", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "217", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2130224520", cells: ["UPS-6520", "Completion Mgmt Item 1", "5/1/2026", "€24 620"], status: "active" as const },
    { id: "2130228091", cells: ["UPS-1091", "Completion Mgmt Item 2", "20/8/2026", "€28 191"], status: "pending" as const },
    { id: "2130231662", cells: ["UPS-4662", "Completion Mgmt Item 3", "7/3/2026", "€31 762"], status: "completed" as const },
    { id: "2130235233", cells: ["UPS-8233", "Completion Mgmt Item 4", "22/10/2026", "€35 333"], status: "warning" as const },
    { id: "2130238804", cells: ["UPS-2804", "Completion Mgmt Item 5", "9/5/2026", "€38 904"], status: "active" as const },
];
...
export default function UpstreamOpsCompletionMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Completion Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Completion Mgmt</p>
                    </div>
                </div>
