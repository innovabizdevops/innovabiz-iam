...
/* ═══ Upstream Ops — Artificial Lift ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "4612", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "392", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1724", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1440768804", cells: ["UPS-4804", "Artificial Lift Item 1", "21/1/2026", "€18 904"], status: "active" as const },
    { id: "1440772375", cells: ["UPS-8375", "Artificial Lift Item 2", "8/8/2026", "€22 475"], status: "pending" as const },
    { id: "1440775946", cells: ["UPS-2946", "Artificial Lift Item 3", "23/3/2026", "€26 046"], status: "completed" as const },
    { id: "1440779517", cells: ["UPS-6517", "Artificial Lift Item 4", "10/10/2026", "€29 617"], status: "warning" as const },
    { id: "1440783088", cells: ["UPS-1088", "Artificial Lift Item 5", "25/5/2026", "€33 188"], status: "active" as const },
];
...
export default function UpstreamOpsArtificialLiftPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Artificial Lift</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Artificial Lift</p>
                    </div>
                </div>
