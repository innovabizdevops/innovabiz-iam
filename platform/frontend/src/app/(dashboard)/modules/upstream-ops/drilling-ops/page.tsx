...
/* ═══ Upstream Ops — Drilling Ops ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "3445", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "318", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "819", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1595143770", cells: ["UPS-2770", "Drilling Ops Item 1", "11/7/2026", "€43 870"], status: "active" as const },
    { id: "1595147341", cells: ["UPS-6341", "Drilling Ops Item 2", "26/2/2026", "€47 441"], status: "pending" as const },
    { id: "1595150912", cells: ["UPS-9912", "Drilling Ops Item 3", "13/9/2026", "€1012"], status: "completed" as const },
    { id: "1595154483", cells: ["UPS-4483", "Drilling Ops Item 4", "28/4/2026", "€4583"], status: "warning" as const },
    { id: "1595158054", cells: ["UPS-8054", "Drilling Ops Item 5", "15/11/2026", "€8154"], status: "active" as const },
];
...
export default function UpstreamOpsDrillingOpsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drilling Ops</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Drilling Ops</p>
                    </div>
                </div>
