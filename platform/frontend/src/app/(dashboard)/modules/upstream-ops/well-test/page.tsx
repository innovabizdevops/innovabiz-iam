...
/* ═══ Upstream Ops — Well Test ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "206", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "283", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1153", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "238495447", cells: ["UPS-5447", "Well Test Item 1", "16/8/2026", "€45 547"], status: "active" as const },
    { id: "238499018", cells: ["UPS-9018", "Well Test Item 2", "3/3/2026", "€49 118"], status: "pending" as const },
    { id: "238502589", cells: ["UPS-3589", "Well Test Item 3", "18/10/2026", "€2689"], status: "completed" as const },
    { id: "238506160", cells: ["UPS-7160", "Well Test Item 4", "5/5/2026", "€6260"], status: "warning" as const },
    { id: "238509731", cells: ["UPS-1731", "Well Test Item 5", "20/12/2026", "€9831"], status: "active" as const },
];
...
export default function UpstreamOpsWellTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Well Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Well Test</p>
                    </div>
                </div>
