...
/* ═══ Upstream Ops — Reservoir Model ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "3044", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "479", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "406", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "565281771", cells: ["UPS-1771", "Reservoir Model Item 1", "20/4/2026", "€31 871"], status: "active" as const },
    { id: "565285342", cells: ["UPS-5342", "Reservoir Model Item 2", "7/11/2026", "€35 442"], status: "pending" as const },
    { id: "565288913", cells: ["UPS-8913", "Reservoir Model Item 3", "22/6/2026", "€39 013"], status: "completed" as const },
    { id: "565292484", cells: ["UPS-3484", "Reservoir Model Item 4", "9/1/2026", "€42 584"], status: "warning" as const },
    { id: "565296055", cells: ["UPS-7055", "Reservoir Model Item 5", "24/8/2026", "€46 155"], status: "active" as const },
];
...
export default function UpstreamOpsReservoirModelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reservoir Model</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Reservoir Model</p>
                    </div>
                </div>
