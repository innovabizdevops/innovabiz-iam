...
/* ═══ Upstream Ops — Reservoir Monitor ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total", value: "4613", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "32", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1037", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "89%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "2079268252", cells: ["UPS-8252", "Reservoir Monitor Item 1", "13/5/2026", "€18 352"], status: "active" as const },
    { id: "2079271823", cells: ["UPS-2823", "Reservoir Monitor Item 2", "28/12/2026", "€21 923"], status: "pending" as const },
    { id: "2079275394", cells: ["UPS-6394", "Reservoir Monitor Item 3", "15/7/2026", "€25 494"], status: "completed" as const },
    { id: "2079278965", cells: ["UPS-9965", "Reservoir Monitor Item 4", "2/2/2026", "€29 065"], status: "warning" as const },
    { id: "2079282536", cells: ["UPS-4536", "Reservoir Monitor Item 5", "17/9/2026", "€32 636"], status: "active" as const },
];
...
export default function UpstreamOpsReservoirMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Reservoir Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Upstream Ops • Reservoir Monitor</p>
                    </div>
                </div>
