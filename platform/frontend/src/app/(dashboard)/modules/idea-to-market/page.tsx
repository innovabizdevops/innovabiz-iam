...
/* ═══ Idea-to-Market E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "7465", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2783", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€353K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1981640865", cells: ["IDE-3865", "Idea-to-Market E2E Item 1", "2/10/2026", "€40 965"], status: "active" as const },
    { id: "1981644436", cells: ["IDE-7436", "Idea-to-Market E2E Item 2", "17/5/2026", "€44 536"], status: "pending" as const },
    { id: "1981648007", cells: ["IDE-2007", "Idea-to-Market E2E Item 3", "4/12/2026", "€48 107"], status: "completed" as const },
    { id: "1981651578", cells: ["IDE-5578", "Idea-to-Market E2E Item 4", "19/7/2026", "€1678"], status: "warning" as const },
    { id: "1981655149", cells: ["IDE-9149", "Idea-to-Market E2E Item 5", "6/2/2026", "€5249"], status: "active" as const },
];
...
export default function IdeatomarketE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Idea-to-Market E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Idea-to-Market E2E</p>
                    </div>
                </div>
