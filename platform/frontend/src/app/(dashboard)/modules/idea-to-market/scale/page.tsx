...
const PAGE = "Scale";
const KPIS = [{"l":"Ideias Submetidas","v":"6.413","t":"-2.5%","d":"down"},{"l":"Patentes (YTD)","v":"3.077","t":"+15.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.373","t":"-3.1%","d":"down"},{"l":"Budget I&D (€M)","v":"€29.4M","t":"+5.0%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.380","74.0%","4.859","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.683","77.4%","5.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.533","75.8%","8.644","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.339","86.5%","2.398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.411","85.5%","827","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":439},{"label":"Mar","value":476},{"label":"Abr","value":224},{"label":"Mai","value":548},{"label":"Jun","value":449},{"label":"Jul","value":574},{"label":"Ago","value":230},{"label":"Set","value":450},{"label":"Out","value":457},{"label":"Nov","value":350},{"label":"Dez","value":287}];
const MX = 574;
