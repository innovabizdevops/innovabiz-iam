...
const PAGE = "Ideate";
const KPIS = [{"l":"Ideias Submetidas","v":"3.462","t":"-5.4%","d":"down"},{"l":"Patentes (YTD)","v":"7.673","t":"+15.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.430","t":"+2.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€33.5M","t":"+5.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.698","71.9%","1.177","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.005","90.8%","6.246","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.030","80.5%","3.736","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.440","83.4%","4.489","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.608","92.8%","2.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":868},{"label":"Mar","value":714},{"label":"Abr","value":744},{"label":"Mai","value":800},{"label":"Jun","value":590},{"label":"Jul","value":811},{"label":"Ago","value":896},{"label":"Set","value":591},{"label":"Out","value":609},{"label":"Nov","value":811},{"label":"Dez","value":724}];
const MX = 896;
