...
const ACCENT = "#06b6d4";
const MODULE = "Idea-to-Market E2E";
const PAGE = "Launch";
const KPIS = [{"l":"Ideias Submetidas","v":"2.350","t":"-2.7%","d":"down"},{"l":"Patentes (YTD)","v":"5.766","t":"-1.5%","d":"down"},{"l":"Projetos Innovation Lab","v":"2.128","t":"+4.1%","d":"up"},{"l":"Budget I&D (€M)","v":"€35.4M","t":"+16.0%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","9.083","75.8%","7.457","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.524","70.7%","6.681","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.802","97.0%","7.317","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.735","82.1%","8.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.337","80.5%","3.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":645},{"label":"Mar","value":514},{"label":"Abr","value":818},{"label":"Mai","value":783},{"label":"Jun","value":674},{"label":"Jul","value":675},{"label":"Ago","value":875},{"label":"Set","value":848},{"label":"Out","value":673},{"label":"Nov","value":550},{"label":"Dez","value":582}];
const MX = 875;
