...
const PAGE = "Validate";
const KPIS = [{"l":"Ideias Submetidas","v":"5.454","t":"-3.3%","d":"down"},{"l":"Patentes (YTD)","v":"850","t":"-2.3%","d":"down"},{"l":"Projetos Innovation Lab","v":"2.478","t":"-5.1%","d":"down"},{"l":"Budget I&D (€M)","v":"€36.5M","t":"+6.8%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","1.955","90.6%","634","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.551","85.1%","4.399","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.326","95.6%","1.715","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.084","75.8%","2.575","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.118","94.6%","6.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":887},{"label":"Mar","value":820},{"label":"Abr","value":1049},{"label":"Mai","value":893},{"label":"Jun","value":858},{"label":"Jul","value":663},{"label":"Ago","value":1030},{"label":"Set","value":696},{"label":"Out","value":848},{"label":"Nov","value":928},{"label":"Dez","value":871}];
const MX = 1049;
