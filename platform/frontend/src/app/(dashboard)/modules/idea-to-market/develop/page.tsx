...
const PAGE = "Develop";
const KPIS = [{"l":"Ideias Submetidas","v":"4.426","t":"+17.5%","d":"up"},{"l":"Patentes (YTD)","v":"8.865","t":"-3.1%","d":"down"},{"l":"Projetos Innovation Lab","v":"6.859","t":"+7.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€23.7M","t":"+15.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.114","89.4%","5.936","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.831","92.3%","1.501","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.712","93.8%","1.383","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","827","76.1%","4.848","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.108","77.8%","8.655","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":706},{"label":"Mar","value":888},{"label":"Abr","value":671},{"label":"Mai","value":703},{"label":"Jun","value":918},{"label":"Jul","value":720},{"label":"Ago","value":786},{"label":"Set","value":679},{"label":"Out","value":786},{"label":"Nov","value":865},{"label":"Dez","value":737}];
const MX = 918;
