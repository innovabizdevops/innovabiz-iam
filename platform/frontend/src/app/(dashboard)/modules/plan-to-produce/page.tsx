...
/* ═══ Plan-to-Produce E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "3695", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2024", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€240K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "930494695", cells: ["PLA-3695", "Plan-to-Produce E2E Item 1", "12/8/2026", "€44 795"], status: "active" as const },
    { id: "930498266", cells: ["PLA-7266", "Plan-to-Produce E2E Item 2", "27/3/2026", "€48 366"], status: "pending" as const },
    { id: "930501837", cells: ["PLA-1837", "Plan-to-Produce E2E Item 3", "14/10/2026", "€1937"], status: "completed" as const },
    { id: "930505408", cells: ["PLA-5408", "Plan-to-Produce E2E Item 4", "1/5/2026", "€5508"], status: "warning" as const },
    { id: "930508979", cells: ["PLA-8979", "Plan-to-Produce E2E Item 5", "16/12/2026", "€9079"], status: "active" as const },
];
...
export default function PlantoproduceE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Plan-to-Produce E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Plan-to-Produce E2E</p>
                    </div>
                </div>
