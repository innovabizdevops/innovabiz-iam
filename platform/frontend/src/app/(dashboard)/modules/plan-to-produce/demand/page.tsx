...
const ACCENT = "#06b6d4";
const MODULE = "Plan-to-Produce E2E";
const PAGE = "Demand";
const KPIS = [{"l":"Total Plan To Produce","v":"3.722","t":"+10.8%","d":"up"},{"l":"Demand Ativos","v":"4.398","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"86","t":"-0.4%","d":"down"}];
const COLS = ["ID","Demand","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plan To Produce #001","Plan To Produce #002","6.860","5.459","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Plan To Produce #002","Plan To Produce #003","117","320","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Plan To Produce #003","Plan To Produce #004","8.416","9.058","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Plan To Produce #004","Plan To Produce #005","8.403","1.415","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plan To Produce #005","Plan To Produce #001","5.750","273","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":530},{"label":"Mar","value":702},{"label":"Abr","value":428},{"label":"Mai","value":615},{"label":"Jun","value":742},{"label":"Jul","value":656},{"label":"Ago","value":443},{"label":"Set","value":485},{"label":"Out","value":482},{"label":"Nov","value":726},{"label":"Dez","value":545}];
const MX = 742;
