...
const PAGE = "Execute";
const KPIS = [{"l":"Total Plan To Produce","v":"6.476","t":"+0.8%","d":"up"},{"l":"Execute Ativos","v":"4.006","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"78.7%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"70","t":"+6.8%","d":"up"}];
const COLS = ["ID","Execute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plan To Produce #001","Plan To Produce #002","4.828","1.819","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Plan To Produce #002","Plan To Produce #003","2.231","8.559","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Plan To Produce #003","Plan To Produce #004","1.001","656","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Plan To Produce #004","Plan To Produce #005","7.607","4.023","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plan To Produce #005","Plan To Produce #001","3.881","2.435","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":258},{"label":"Fev","value":243},{"label":"Mar","value":460},{"label":"Abr","value":493},{"label":"Mai","value":345},{"label":"Jun","value":364},{"label":"Jul","value":572},{"label":"Ago","value":288},{"label":"Set","value":294},{"label":"Out","value":329},{"label":"Nov","value":421},{"label":"Dez","value":248}];
const MX = 572;
