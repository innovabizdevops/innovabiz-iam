...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.310","t":"+11.5%","d":"up"},{"l":"NC Abertas","v":"1.893","t":"+6.0%","d":"up"},{"l":"Conformidade (%)","v":"78.5%","t":"+10.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.414","t":"+12.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.653","81.4%","1.495","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.833","88.8%","8.513","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.792","76.3%","1.935","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.106","72.3%","5.050","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.070","78.6%","5.225","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":633},{"label":"Mar","value":857},{"label":"Abr","value":801},{"label":"Mai","value":776},{"label":"Jun","value":812},{"label":"Jul","value":884},{"label":"Ago","value":587},{"label":"Set","value":911},{"label":"Out","value":832},{"label":"Nov","value":845},{"label":"Dez","value":719}];
const MX = 911;
