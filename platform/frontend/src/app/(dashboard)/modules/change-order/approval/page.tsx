...
const KPIS = [{"l":"Aprovações Pendentes","v":"7.749","t":"+0.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.6%","t":"+3.4%","d":"up"},{"l":"Tempo Médio (h)","v":"104h","t":"-5.5%","d":"down"},{"l":"Rejeitadas (%)","v":"82.6%","t":"+11.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","2.859","€ 22950.01","1.748","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.054","€ 27569.91","132","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.855","€ 5492.54","2.404","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.499","€ 8376.05","4.227","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.169","€ 33494.06","3.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":790},{"label":"Mar","value":851},{"label":"Abr","value":695},{"label":"Mai","value":956},{"label":"Jun","value":729},{"label":"Jul","value":721},{"label":"Ago","value":1000},{"label":"Set","value":753},{"label":"Out","value":824},{"label":"Nov","value":811},{"label":"Dez","value":635}];
const MX = 1000;
