...
const PAGE = "Request Form";
const KPIS = [{"l":"Formulários Ativos","v":"5.363","t":"-6.0%","d":"down"},{"l":"Submissões/Dia","v":"2861","t":"+11.3%","d":"up"},{"l":"Documentos Gerados","v":"3.844","t":"+1.9%","d":"up"},{"l":"Templates","v":"7.952","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.548","2026-02-15","216","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.191","2026-03-02","2.061","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.277","2026-01-21","1.871","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","265","2026-02-01","5.367","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","165","2026-03-07","2.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":763},{"label":"Mar","value":911},{"label":"Abr","value":695},{"label":"Mai","value":646},{"label":"Jun","value":925},{"label":"Jul","value":832},{"label":"Ago","value":596},{"label":"Set","value":702},{"label":"Out","value":758},{"label":"Nov","value":736},{"label":"Dez","value":832}];
const MX = 925;
