...
const PAGE = "Cost Adjust";
const KPIS = [{"l":"Total Change Order","v":"6.891","t":"+17.5%","d":"up"},{"l":"Cost Adjust Ativos","v":"6.547","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"65","t":"-0.4%","d":"down"}];
const COLS = ["ID","Cost Adjust","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Change Order #001","Change Order #002","110","8.953","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Change Order #002","Change Order #003","7.130","4.244","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Change Order #003","Change Order #004","8.256","6.786","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Change Order #004","Change Order #005","3.204","3.791","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Change Order #005","Change Order #001","7.949","9.012","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":440},{"label":"Mar","value":504},{"label":"Abr","value":457},{"label":"Mai","value":641},{"label":"Jun","value":739},{"label":"Jul","value":529},{"label":"Ago","value":735},{"label":"Set","value":569},{"label":"Out","value":656},{"label":"Nov","value":498},{"label":"Dez","value":666}];
const MX = 739;
