...
const ACCENT = "#ec4899";
const MODULE = "Change Order";
const PAGE = "Impact Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.050","t":"+17.8%","d":"up"},{"l":"Queries/Dia","v":"1006","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"436","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"7.124","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2824","2026-01-03","5.497","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2677","2026-02-17","4.680","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3760","2026-02-28","3.048","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2021","2026-03-13","5.226","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2437","2026-03-09","2.911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":503},{"label":"Mar","value":514},{"label":"Abr","value":598},{"label":"Mai","value":716},{"label":"Jun","value":554},{"label":"Jul","value":444},{"label":"Ago","value":766},{"label":"Set","value":514},{"label":"Out","value":759},{"label":"Nov","value":568},{"label":"Dez","value":631}];
const MX = 766;
