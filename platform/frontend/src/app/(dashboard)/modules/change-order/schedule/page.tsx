...
const PAGE = "Schedule Impact";
const KPIS = [{"l":"Projetos Sociais","v":"5.428","t":"+7.6%","d":"up"},{"l":"Beneficiários","v":"4.440","t":"-1.1%","d":"down"},{"l":"Investimento CSR (€)","v":"€50435","t":"+6.7%","d":"up"},{"l":"Score Impacto","v":"61","t":"+11.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","579","€ 10149.64","3.040","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","7.977","€ 14781.61","8.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.221","€ 29119.93","5.075","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.037","€ 7632.02","2.095","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.103","€ 40907.35","3.015","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":415},{"label":"Mar","value":608},{"label":"Abr","value":484},{"label":"Mai","value":596},{"label":"Jun","value":563},{"label":"Jul","value":416},{"label":"Ago","value":666},{"label":"Set","value":544},{"label":"Out","value":427},{"label":"Nov","value":667},{"label":"Dez","value":652}];
const MX = 667;
