...
const ACCENT = "#8b5cf6";
const MODULE = "Knowledge Graph Platform";
const PAGE = "Reason";
const KPIS = [{"l":"Artigos Publicados","v":"4.550","t":"-3.3%","d":"down"},{"l":"Views/Semana","v":"5089","t":"+4.1%","d":"up"},{"l":"Feedback Útil (%)","v":"73.3%","t":"+15.6%","d":"up"},{"l":"Artigos Desatualizados","v":"2.457","t":"+2.2%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.926","83.3%","7.119","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.840","74.1%","7.878","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","5.025","98.5%","6.570","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.933","79.8%","5.959","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","771","75.2%","2.189","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":427},{"label":"Mar","value":673},{"label":"Abr","value":349},{"label":"Mai","value":474},{"label":"Jun","value":642},{"label":"Jul","value":687},{"label":"Ago","value":422},{"label":"Set","value":390},{"label":"Out","value":571},{"label":"Nov","value":356},{"label":"Dez","value":389}];
const MX = 687;
