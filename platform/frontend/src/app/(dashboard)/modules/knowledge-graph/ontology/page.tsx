...
const PAGE = "Ontology";
const KPIS = [{"l":"Artigos Publicados","v":"5.906","t":"+5.5%","d":"up"},{"l":"Views/Semana","v":"4578","t":"+4.0%","d":"up"},{"l":"Feedback Útil (%)","v":"71.5%","t":"+8.9%","d":"up"},{"l":"Artigos Desatualizados","v":"1.911","t":"+0.5%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.999","77.1%","5.465","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.644","71.9%","6.760","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","6.980","70.3%","7.834","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.576","85.0%","375","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.662","72.3%","3.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":706},{"label":"Mar","value":708},{"label":"Abr","value":736},{"label":"Mai","value":959},{"label":"Jun","value":861},{"label":"Jul","value":786},{"label":"Ago","value":862},{"label":"Set","value":618},{"label":"Out","value":880},{"label":"Nov","value":601},{"label":"Dez","value":730}];
const MX = 959;
