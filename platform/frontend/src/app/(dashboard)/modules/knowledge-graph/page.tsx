...
/* ═══ Knowledge Graph Platform — Dashboard ═══ */

const ACCENT = "#8b5cf6";

const KPIS = [
    { label: "Total Registos", value: "3034", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "230", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€499K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "150433434", cells: ["KNO-8434", "Knowledge Graph Platform Item 1", "19/7/2026", "€33 534"], status: "active" as const },
    { id: "150437005", cells: ["KNO-3005", "Knowledge Graph Platform Item 2", "6/2/2026", "€37 105"], status: "pending" as const },
    { id: "150440576", cells: ["KNO-6576", "Knowledge Graph Platform Item 3", "21/9/2026", "€40 676"], status: "completed" as const },
    { id: "150444147", cells: ["KNO-1147", "Knowledge Graph Platform Item 4", "8/4/2026", "€44 247"], status: "warning" as const },
    { id: "150447718", cells: ["KNO-4718", "Knowledge Graph Platform Item 5", "23/11/2026", "€47 818"], status: "active" as const },
];
...
export default function KnowledgeGraphPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Knowledge Graph Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Knowledge Graph Platform</p>
                    </div>
                </div>
