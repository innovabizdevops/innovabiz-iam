...
const PAGE = "Ingest";
const KPIS = [{"l":"Artigos Publicados","v":"1.137","t":"+11.1%","d":"up"},{"l":"Views/Semana","v":"2587","t":"+13.2%","d":"up"},{"l":"Feedback Útil (%)","v":"87.2%","t":"+8.6%","d":"up"},{"l":"Artigos Desatualizados","v":"8.510","t":"-1.4%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","9.027","86.1%","2.822","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.252","78.3%","6.955","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.079","99.8%","2.080","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.937","97.3%","2.163","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.386","84.7%","4.141","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":704},{"label":"Mar","value":571},{"label":"Abr","value":512},{"label":"Mai","value":544},{"label":"Jun","value":856},{"label":"Jul","value":887},{"label":"Ago","value":494},{"label":"Set","value":836},{"label":"Out","value":773},{"label":"Nov","value":811},{"label":"Dez","value":666}];
const MX = 887;
