...
const PAGE = "Query";
const KPIS = [{"l":"Artigos Publicados","v":"5.325","t":"+1.3%","d":"up"},{"l":"Views/Semana","v":"1026","t":"-2.6%","d":"down"},{"l":"Feedback Útil (%)","v":"92.4%","t":"+12.8%","d":"up"},{"l":"Artigos Desatualizados","v":"5.414","t":"-4.3%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.604","70.6%","6.409","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.525","98.1%","2.934","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","848","90.0%","6.526","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.304","75.2%","6.435","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","7.062","95.8%","2.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":963},{"label":"Mar","value":743},{"label":"Abr","value":867},{"label":"Mai","value":965},{"label":"Jun","value":641},{"label":"Jul","value":959},{"label":"Ago","value":954},{"label":"Set","value":800},{"label":"Out","value":985},{"label":"Nov","value":952},{"label":"Dez","value":988}];
const MX = 988;
