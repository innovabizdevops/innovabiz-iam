...
const KPIS = [{"l":"Dashboards Ativos","v":"8.872","t":"+14.2%","d":"up"},{"l":"Queries/Dia","v":"2339","t":"+0.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.801","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.856","t":"+14.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3453","2026-02-18","5.981","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","320","2026-03-06","5.210","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","283","2026-03-16","694","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","829","2026-02-21","601","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5071","2026-01-01","6.369","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":723},{"label":"Mar","value":398},{"label":"Abr","value":356},{"label":"Mai","value":638},{"label":"Jun","value":368},{"label":"Jul","value":715},{"label":"Ago","value":527},{"label":"Set","value":747},{"label":"Out","value":463},{"label":"Nov","value":357},{"label":"Dez","value":473}];
const MX = 747;
