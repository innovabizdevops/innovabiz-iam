...
const PAGE = "Market Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"5.002","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"4290","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"4.275","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.491","t":"+12.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","210","2026-02-04","8.200","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2733","2026-01-24","6.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","842","2026-03-18","4.505","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3155","2026-02-06","5.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2133","2026-01-19","7.765","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":874},{"label":"Fev","value":919},{"label":"Mar","value":892},{"label":"Abr","value":780},{"label":"Mai","value":713},{"label":"Jun","value":830},{"label":"Jul","value":1055},{"label":"Ago","value":987},{"label":"Set","value":992},{"label":"Out","value":792},{"label":"Nov","value":872},{"label":"Dez","value":704}];
const MX = 1055;
