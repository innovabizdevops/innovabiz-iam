...
const ACCENT = "#78350f";
const MODULE = "Book Publishing";
const PAGE = "AI Editing";
const KPIS = [{"l":"Integrações Ativas","v":"1.559","t":"+6.3%","d":"up"},{"l":"Chamadas/Hora","v":"3944","t":"+10.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.9%","t":"+12.1%","d":"up"},{"l":"Latência Média (ms)","v":"31ms","t":"+12.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.005","797","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.656","6.215","90.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.048","6.967","86.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.848","157","91.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.021","2.981","84.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":377},{"label":"Mar","value":393},{"label":"Abr","value":354},{"label":"Mai","value":331},{"label":"Jun","value":464},{"label":"Jul","value":418},{"label":"Ago","value":620},{"label":"Set","value":360},{"label":"Out","value":454},{"label":"Nov","value":453},{"label":"Dez","value":403}];
const MX = 620;
