...
const PAGE = "Editorial Flow";
const KPIS = [{"l":"Integrações Ativas","v":"3.842","t":"+9.1%","d":"up"},{"l":"Chamadas/Hora","v":"4062","t":"+8.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"84.0%","t":"+8.8%","d":"up"},{"l":"Latência Média (ms)","v":"169ms","t":"+0.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.930","4.972","92.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.495","7.515","95.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.237","5.617","96.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.517","1.816","72.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","924","5.485","76.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":531},{"label":"Mar","value":650},{"label":"Abr","value":635},{"label":"Mai","value":383},{"label":"Jun","value":485},{"label":"Jul","value":390},{"label":"Ago","value":500},{"label":"Set","value":420},{"label":"Out","value":505},{"label":"Nov","value":389},{"label":"Dez","value":425}];
const MX = 737;
