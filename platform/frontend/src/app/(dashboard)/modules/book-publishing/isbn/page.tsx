...
const PAGE = "ISBN Mgmt";
const KPIS = [{"l":"Total Book Publishing","v":"3.402","t":"+5.4%","d":"up"},{"l":"ISBN Mgmt Ativos","v":"4.218","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"65","t":"+16.7%","d":"up"}];
const COLS = ["ID","ISBN Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Publishing #001","Book Publishing #002","8.980","1.904","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Book Publishing #002","Book Publishing #003","7.551","6.728","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Publishing #003","Book Publishing #004","7.601","2.897","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Book Publishing #004","Book Publishing #005","2.031","6.719","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Publishing #005","Book Publishing #001","3.013","7.015","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":502},{"label":"Mar","value":759},{"label":"Abr","value":493},{"label":"Mai","value":649},{"label":"Jun","value":446},{"label":"Jul","value":608},{"label":"Ago","value":510},{"label":"Set","value":565},{"label":"Out","value":648},{"label":"Nov","value":593},{"label":"Dez","value":490}];
const MX = 759;
