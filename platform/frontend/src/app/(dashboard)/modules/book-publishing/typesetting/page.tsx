...
const PAGE = "Typesetting";
const KPIS = [{"l":"Configurações","v":"7.439","t":"-0.1%","d":"down"},{"l":"Últimas Alterações","v":"4.146","t":"-5.8%","d":"down"},{"l":"Ambientes","v":"2.058","t":"+16.4%","d":"up"},{"l":"Versão Config","v":"1.160","t":"+2.8%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 32878.59","1.505","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 14059.63","1.002","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 2932.69","1.019","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 49315.88","5.199","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 19647.42","4.199","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":852},{"label":"Mar","value":953},{"label":"Abr","value":1026},{"label":"Mai","value":964},{"label":"Jun","value":855},{"label":"Jul","value":831},{"label":"Ago","value":1000},{"label":"Set","value":854},{"label":"Out","value":831},{"label":"Nov","value":709},{"label":"Dez","value":804}];
const MX = 1026;
