...
const PAGE = "Cover Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.796","t":"+9.0%","d":"up"},{"l":"Submissões/Dia","v":"2598","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"5.273","t":"+9.1%","d":"up"},{"l":"Templates","v":"8.272","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.513","2026-03-01","6.625","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.445","2026-01-15","8.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.838","2026-01-26","8.562","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.124","2026-03-16","3.763","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.933","2026-03-10","3.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":871},{"label":"Mar","value":594},{"label":"Abr","value":696},{"label":"Mai","value":685},{"label":"Jun","value":889},{"label":"Jul","value":827},{"label":"Ago","value":763},{"label":"Set","value":679},{"label":"Out","value":873},{"label":"Nov","value":735},{"label":"Dez","value":783}];
const MX = 889;
