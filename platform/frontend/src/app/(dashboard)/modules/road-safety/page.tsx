...
/* ═══ Road Safety Authority — Dashboard ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total Registos", value: "2842", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3483", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€370K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1860687942", cells: ["ROA-1942", "Road Safety Authority Item 1", "23/7/2026", "€38 042"], status: "active" as const },
    { id: "1860691513", cells: ["ROA-5513", "Road Safety Authority Item 2", "10/2/2026", "€41 613"], status: "pending" as const },
    { id: "1860695084", cells: ["ROA-9084", "Road Safety Authority Item 3", "25/9/2026", "€45 184"], status: "completed" as const },
    { id: "1860698655", cells: ["ROA-3655", "Road Safety Authority Item 4", "12/4/2026", "€48 755"], status: "warning" as const },
    { id: "1860702226", cells: ["ROA-7226", "Road Safety Authority Item 5", "27/11/2026", "€2326"], status: "active" as const },
];
...
export default function RoadSafetyAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Road Safety Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Road Safety Authority</p>
                    </div>
                </div>
