...
const PAGE = "Itinerary Builder";
const KPIS = [{"l":"Total Travel Mgmt","v":"3.306","t":"+4.3%","d":"up"},{"l":"Itinerary Builder Ativos","v":"8.028","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"78.2%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.6%","d":"up"}];
const COLS = ["ID","Itinerary Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Mgmt #001","Travel Mgmt #002","1.978","4.389","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Mgmt #002","Travel Mgmt #003","6.987","4.046","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Mgmt #003","Travel Mgmt #004","1.704","7.440","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Mgmt #004","Travel Mgmt #005","4.332","4.037","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Mgmt #005","Travel Mgmt #001","2.823","9.031","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":295},{"label":"Mar","value":467},{"label":"Abr","value":540},{"label":"Mai","value":459},{"label":"Jun","value":494},{"label":"Jul","value":459},{"label":"Ago","value":387},{"label":"Set","value":543},{"label":"Out","value":541},{"label":"Nov","value":656},{"label":"Dez","value":643}];
const MX = 656;
