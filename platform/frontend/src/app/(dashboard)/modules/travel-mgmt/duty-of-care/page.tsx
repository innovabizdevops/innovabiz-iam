...
const PAGE = "Duty of Care";
const KPIS = [{"l":"Total Travel Mgmt","v":"738","t":"-0.2%","d":"down"},{"l":"Duty Of Care Ativos","v":"6.949","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"61","t":"+2.4%","d":"up"}];
const COLS = ["ID","Duty Of Care","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Mgmt #001","Travel Mgmt #002","4.951","8.738","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Mgmt #002","Travel Mgmt #003","2.020","5.737","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Mgmt #003","Travel Mgmt #004","6.868","3.355","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Mgmt #004","Travel Mgmt #005","746","5.436","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Mgmt #005","Travel Mgmt #001","5.479","8.809","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":599},{"label":"Mar","value":236},{"label":"Abr","value":417},{"label":"Mai","value":303},{"label":"Jun","value":309},{"label":"Jul","value":388},{"label":"Ago","value":241},{"label":"Set","value":517},{"label":"Out","value":339},{"label":"Nov","value":584},{"label":"Dez","value":545}];
const MX = 599;
