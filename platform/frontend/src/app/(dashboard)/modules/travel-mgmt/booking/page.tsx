...
const KPIS = [{"l":"Quartos Ocupados","v":"1.864","t":"+6.3%","d":"up"},{"l":"RevPAR (€)","v":"€84205","t":"+11.3%","d":"up"},{"l":"Ocupação (%)","v":"79.6%","t":"-2.4%","d":"down"},{"l":"Guest Satisfaction","v":"7.302","t":"+12.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","9.028","2026-02-08","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.066","2026-02-13","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.528","2026-01-21","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.489","2026-03-25","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.702","2026-02-24","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":434},{"label":"Mar","value":402},{"label":"Abr","value":616},{"label":"Mai","value":784},{"label":"Jun","value":542},{"label":"Jul","value":469},{"label":"Ago","value":557},{"label":"Set","value":510},{"label":"Out","value":476},{"label":"Nov","value":540},{"label":"Dez","value":546}];
const MX = 784;
