...
const PAGE = "Trip Request Form";
const KPIS = [{"l":"Formulários Ativos","v":"5.712","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"2193","t":"+6.0%","d":"up"},{"l":"Documentos Gerados","v":"4.600","t":"+11.9%","d":"up"},{"l":"Templates","v":"283","t":"+8.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.919","2026-03-15","6.103","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.362","2026-01-25","6.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.372","2026-01-27","3.766","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.789","2026-01-20","6.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","670","2026-03-18","6.765","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":926},{"label":"Fev","value":610},{"label":"Mar","value":794},{"label":"Abr","value":838},{"label":"Mai","value":932},{"label":"Jun","value":948},{"label":"Jul","value":846},{"label":"Ago","value":810},{"label":"Set","value":976},{"label":"Out","value":681},{"label":"Nov","value":868},{"label":"Dez","value":899}];
const MX = 976;
