...
const ACCENT = "#0284c7";
const MODULE = "Travel Management";
const PAGE = "Carbon Offset";
const KPIS = [{"l":"Total Travel Mgmt","v":"7.635","t":"-2.2%","d":"down"},{"l":"Carbon Offset Ativos","v":"5.120","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"75.3%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"81","t":"+1.9%","d":"up"}];
const COLS = ["ID","Carbon Offset","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Mgmt #001","Travel Mgmt #002","7.911","2.424","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Mgmt #002","Travel Mgmt #003","836","8.109","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Mgmt #003","Travel Mgmt #004","6.478","4.933","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Mgmt #004","Travel Mgmt #005","3.413","5.398","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Mgmt #005","Travel Mgmt #001","1.183","4.234","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":249},{"label":"Mar","value":241},{"label":"Abr","value":351},{"label":"Mai","value":252},{"label":"Jun","value":515},{"label":"Jul","value":415},{"label":"Ago","value":584},{"label":"Set","value":427},{"label":"Out","value":624},{"label":"Nov","value":527},{"label":"Dez","value":450}];
const MX = 624;
