...
const PAGE = "Travel Policy";
const KPIS = [{"l":"Total Travel Mgmt","v":"6.109","t":"+3.8%","d":"up"},{"l":"Travel Policy Ativos","v":"1.631","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"58","t":"+17.0%","d":"up"}];
const COLS = ["ID","Travel Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Mgmt #001","Travel Mgmt #002","8.815","7.519","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Mgmt #002","Travel Mgmt #003","1.563","442","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Mgmt #003","Travel Mgmt #004","7.019","549","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Mgmt #004","Travel Mgmt #005","4.138","4.748","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Mgmt #005","Travel Mgmt #001","5.787","1.719","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":853},{"label":"Mar","value":794},{"label":"Abr","value":931},{"label":"Mai","value":665},{"label":"Jun","value":775},{"label":"Jul","value":726},{"label":"Ago","value":940},{"label":"Set","value":827},{"label":"Out","value":616},{"label":"Nov","value":930},{"label":"Dez","value":910}];
const MX = 940;
