...
const PAGE = "Family Plan";
const KPIS = [{"l":"Total Subscriber Mgmt","v":"2.037","t":"+16.7%","d":"up"},{"l":"Family Plan Ativos","v":"5.060","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"87","t":"-5.0%","d":"down"}];
const COLS = ["ID","Family Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Subscriber Mgmt #001","Subscriber Mgmt #002","1.806","7.398","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Subscriber Mgmt #002","Subscriber Mgmt #003","3.345","4.717","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Subscriber Mgmt #003","Subscriber Mgmt #004","6.785","1.896","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Subscriber Mgmt #004","Subscriber Mgmt #005","8.150","7.266","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Subscriber Mgmt #005","Subscriber Mgmt #001","7.449","5.468","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":813},{"label":"Mar","value":815},{"label":"Abr","value":722},{"label":"Mai","value":773},{"label":"Jun","value":611},{"label":"Jul","value":863},{"label":"Ago","value":880},{"label":"Set","value":658},{"label":"Out","value":690},{"label":"Nov","value":504},{"label":"Dez","value":863}];
const MX = 880;
