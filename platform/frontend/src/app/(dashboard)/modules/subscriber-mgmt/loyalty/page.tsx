...
const PAGE = "Loyalty";
const KPIS = [{"l":"Total Subscriber Mgmt","v":"7.665","t":"+7.9%","d":"up"},{"l":"Loyalty Ativos","v":"7.573","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"75","t":"+12.9%","d":"up"}];
const COLS = ["ID","Loyalty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Subscriber Mgmt #001","Subscriber Mgmt #002","7.164","4.176","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Subscriber Mgmt #002","Subscriber Mgmt #003","516","4.452","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Subscriber Mgmt #003","Subscriber Mgmt #004","5.361","8.408","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Subscriber Mgmt #004","Subscriber Mgmt #005","6.034","1.253","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Subscriber Mgmt #005","Subscriber Mgmt #001","4.559","1.651","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":279},{"label":"Fev","value":616},{"label":"Mar","value":327},{"label":"Abr","value":539},{"label":"Mai","value":369},{"label":"Jun","value":394},{"label":"Jul","value":295},{"label":"Ago","value":448},{"label":"Set","value":354},{"label":"Out","value":544},{"label":"Nov","value":419},{"label":"Dez","value":365}];
const MX = 616;
