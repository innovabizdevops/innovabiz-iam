...
const ACCENT = "#7c3aed";
const MODULE = "Subscriber Management";
const PAGE = "Churn AI";
const KPIS = [{"l":"ARR (€M)","v":"€8.0M","t":"+7.2%","d":"up"},{"l":"MRR (€)","v":"€20999","t":"+7.4%","d":"up"},{"l":"Churn (%)","v":"85.7%","t":"+7.9%","d":"up"},{"l":"ARPU (€)","v":"€24770","t":"+17.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28947.58","169","€ 43512.16","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 43636.56","7.757","€ 22519.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4822.71","7.896","€ 7195.33","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43920.88","8.084","€ 23394.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47002.55","7.937","€ 38800.10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":804},{"label":"Mar","value":994},{"label":"Abr","value":1034},{"label":"Mai","value":887},{"label":"Jun","value":878},{"label":"Jul","value":768},{"label":"Ago","value":817},{"label":"Set","value":1008},{"label":"Out","value":950},{"label":"Nov","value":840},{"label":"Dez","value":992}];
const MX = 1034;
