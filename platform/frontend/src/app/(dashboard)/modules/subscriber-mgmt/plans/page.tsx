...
const PAGE = "Plan Mgmt";
const KPIS = [{"l":"Total Subscriber Mgmt","v":"1.677","t":"+14.7%","d":"up"},{"l":"Plan Mgmt Ativos","v":"2.945","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+17.6%","d":"up"}];
const COLS = ["ID","Plan Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Subscriber Mgmt #001","Subscriber Mgmt #002","6.809","3.974","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Subscriber Mgmt #002","Subscriber Mgmt #003","674","2.282","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Subscriber Mgmt #003","Subscriber Mgmt #004","5.927","5.180","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Subscriber Mgmt #004","Subscriber Mgmt #005","2.091","3.016","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Subscriber Mgmt #005","Subscriber Mgmt #001","3.040","4.065","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":480},{"label":"Mar","value":410},{"label":"Abr","value":480},{"label":"Mai","value":428},{"label":"Jun","value":543},{"label":"Jul","value":400},{"label":"Ago","value":464},{"label":"Set","value":277},{"label":"Out","value":555},{"label":"Nov","value":496},{"label":"Dez","value":379}];
const MX = 555;
