...
const PAGE = "Number Port";
const KPIS = [{"l":"Total Subscriber Mgmt","v":"3.843","t":"+16.2%","d":"up"},{"l":"Number Port Ativos","v":"5.269","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.9%","d":"up"}];
const COLS = ["ID","Number Port","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Subscriber Mgmt #001","Subscriber Mgmt #002","3.599","4.604","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Subscriber Mgmt #002","Subscriber Mgmt #003","7.432","6.098","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Subscriber Mgmt #003","Subscriber Mgmt #004","3.702","7.134","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Subscriber Mgmt #004","Subscriber Mgmt #005","4.200","1.804","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Subscriber Mgmt #005","Subscriber Mgmt #001","3.693","4.893","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":426},{"label":"Fev","value":359},{"label":"Mar","value":297},{"label":"Abr","value":472},{"label":"Mai","value":274},{"label":"Jun","value":267},{"label":"Jul","value":590},{"label":"Ago","value":304},{"label":"Set","value":554},{"label":"Out","value":405},{"label":"Nov","value":299},{"label":"Dez","value":544}];
const MX = 590;
