...
const PAGE = "NL Query";
const KPIS = [{"l":"Dashboards Ativos","v":"5.989","t":"+2.6%","d":"up"},{"l":"Queries/Dia","v":"4893","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"5.279","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.413","t":"+9.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3570","2026-03-23","1.068","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","978","2026-03-22","3.608","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3701","2026-03-06","8.339","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2197","2026-01-10","2.102","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2737","2026-01-09","2.017","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":310},{"label":"Mar","value":445},{"label":"Abr","value":384},{"label":"Mai","value":397},{"label":"Jun","value":487},{"label":"Jul","value":540},{"label":"Ago","value":301},{"label":"Set","value":626},{"label":"Out","value":347},{"label":"Nov","value":606},{"label":"Dez","value":347}];
const MX = 626;
