...
/* ═══ GenAI Analytics Engine — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "3048", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3001", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€290K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "564372248", cells: ["GEN-1248", "GenAI Analytics Engine Item 1", "21/9/2026", "€22 348"], status: "active" as const },
    { id: "564375819", cells: ["GEN-4819", "GenAI Analytics Engine Item 2", "8/4/2026", "€25 919"], status: "pending" as const },
    { id: "564379390", cells: ["GEN-8390", "GenAI Analytics Engine Item 3", "23/11/2026", "€29 490"], status: "completed" as const },
    { id: "564382961", cells: ["GEN-2961", "GenAI Analytics Engine Item 4", "10/6/2026", "€33 061"], status: "warning" as const },
    { id: "564386532", cells: ["GEN-6532", "GenAI Analytics Engine Item 5", "25/1/2026", "€36 632"], status: "active" as const },
];
...
export default function GenaiAnalyticsEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Analytics Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Analytics Engine</p>
                    </div>
                </div>
