...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Analytics Engine";
const PAGE = "Auto Report";
const KPIS = [{"l":"Dashboards Ativos","v":"2.883","t":"+3.8%","d":"up"},{"l":"Queries/Dia","v":"4200","t":"+1.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.708","t":"+3.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.085","t":"+17.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1007","2026-01-28","3.203","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2934","2026-03-21","1.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4405","2026-03-21","6.855","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1144","2026-03-11","6.699","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4563","2026-03-12","1.643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":429},{"label":"Mar","value":442},{"label":"Abr","value":474},{"label":"Mai","value":654},{"label":"Jun","value":701},{"label":"Jul","value":593},{"label":"Ago","value":443},{"label":"Set","value":573},{"label":"Out","value":671},{"label":"Nov","value":709},{"label":"Dez","value":726}];
const MX = 726;
