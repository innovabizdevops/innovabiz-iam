...
const KPIS = [{"l":"Dashboards Ativos","v":"802","t":"+10.6%","d":"up"},{"l":"Queries/Dia","v":"4684","t":"-4.8%","d":"down"},{"l":"Dados Processados (GB)","v":"1.684","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"4.813","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1049","2026-02-03","1.555","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3240","2026-01-28","1.197","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2117","2026-01-10","7.563","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","565","2026-03-10","9.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2316","2026-02-19","1.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":651},{"label":"Fev","value":295},{"label":"Mar","value":337},{"label":"Abr","value":416},{"label":"Mai","value":610},{"label":"Jun","value":423},{"label":"Jul","value":383},{"label":"Ago","value":423},{"label":"Set","value":450},{"label":"Out","value":633},{"label":"Nov","value":653},{"label":"Dez","value":465}];
const MX = 653;
