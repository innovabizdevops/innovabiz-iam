...
const PAGE = "Explain";
const KPIS = [{"l":"Dashboards Ativos","v":"2.500","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"4207","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"3.909","t":"-1.9%","d":"down"},{"l":"Utilizadores Analytics","v":"2.012","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3080","2026-02-12","1.879","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1424","2026-03-27","7.751","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3900","2026-01-16","2.934","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4723","2026-03-11","5.048","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2981","2026-01-23","3.680","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":559},{"label":"Mar","value":812},{"label":"Abr","value":727},{"label":"Mai","value":700},{"label":"Jun","value":523},{"label":"Jul","value":691},{"label":"Ago","value":698},{"label":"Set","value":750},{"label":"Out","value":753},{"label":"Nov","value":880},{"label":"Dez","value":666}];
const MX = 880;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>XAI</span></h1>
                </div>
