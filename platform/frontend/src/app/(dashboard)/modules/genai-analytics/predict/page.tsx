...
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"4.299","t":"+5.0%","d":"up"},{"l":"Queries/Dia","v":"3061","t":"+7.5%","d":"up"},{"l":"Dados Processados (GB)","v":"9.005","t":"+0.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.087","t":"+5.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1112","2026-03-21","4.195","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","213","2026-01-23","2.222","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2997","2026-03-15","8.592","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3168","2026-02-22","5.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1548","2026-01-03","360","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":899},{"label":"Mar","value":853},{"label":"Abr","value":703},{"label":"Mai","value":754},{"label":"Jun","value":919},{"label":"Jul","value":894},{"label":"Ago","value":710},{"label":"Set","value":744},{"label":"Out","value":992},{"label":"Nov","value":778},{"label":"Dez","value":813}];
const MX = 992;
