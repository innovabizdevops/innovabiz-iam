...
const ROWS = [
  { id: "001", c: ["Process Narrative-001", "Process Narrative Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Process Narrative-002", "Process Narrative Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Process Narrative-003", "Process Narrative Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Process Narrative-004", "Process Narrative Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Process Narrative-005", "Process Narrative Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Process Narrative", ts: "Há 2min", a: "Sistema" },
...
export default function ProcessNarrativePage() {
  return (
