...
const ROWS = [
  { id: "001", c: ["Access Review Ctrl-001", "Access Review Ctrl Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Access Review Ctrl-002", "Access Review Ctrl Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Access Review Ctrl-003", "Access Review Ctrl Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Access Review Ctrl-004", "Access Review Ctrl Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Access Review Ctrl-005", "Access Review Ctrl Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Access Review Ctrl", ts: "Há 2min", a: "Sistema" },
...
export default function AccessReviewCtrlPage() {
  return (
