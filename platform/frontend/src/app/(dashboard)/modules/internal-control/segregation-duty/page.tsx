...
const ROWS = [
  { id: "001", c: ["Segregation Duty-001", "Segregation Duty Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Segregation Duty-002", "Segregation Duty Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Segregation Duty-003", "Segregation Duty Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Segregation Duty-004", "Segregation Duty Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Segregation Duty-005", "Segregation Duty Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Segregation Duty", ts: "Há 2min", a: "Sistema" },
...
export default function SegregationDutyPage() {
  return (
