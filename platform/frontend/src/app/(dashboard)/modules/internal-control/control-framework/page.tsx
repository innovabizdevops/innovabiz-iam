...
const ROWS = [
  { id: "001", c: ["Control Framework-001", "Control Framework Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Control Framework-002", "Control Framework Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Control Framework-003", "Control Framework Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Control Framework-004", "Control Framework Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Control Framework-005", "Control Framework Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Control Framework", ts: "Há 2min", a: "Sistema" },
...
export default function ControlFrameworkPage() {
  return (
