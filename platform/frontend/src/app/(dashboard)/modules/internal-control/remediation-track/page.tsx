...
const ROWS = [
  { id: "001", c: ["Remediation Track-001", "Remediation Track Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Remediation Track-002", "Remediation Track Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Remediation Track-003", "Remediation Track Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Remediation Track-004", "Remediation Track Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Remediation Track-005", "Remediation Track Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Remediation Track", ts: "Há 2min", a: "Sistema" },
...
export default function RemediationTrackPage() {
  return (
