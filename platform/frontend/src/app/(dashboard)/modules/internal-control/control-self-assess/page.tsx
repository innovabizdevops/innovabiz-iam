...
const PAGE = "Control Self Assess";
...
const ROWS = [
  { id: "001", c: ["Control Self Assess-001", "Control Self Assess Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Control Self Assess-002", "Control Self Assess Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Control Self Assess-003", "Control Self Assess Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Control Self Assess-004", "Control Self Assess Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Control Self Assess-005", "Control Self Assess Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Control Self Assess", ts: "Há 2min", a: "Sistema" },
...
export default function ControlSelfAssessPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Internal Control — iBOS Enterprise</p>
        </div>
