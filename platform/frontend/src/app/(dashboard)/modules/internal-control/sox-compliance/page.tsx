...
const ROWS = [
  { id: "001", c: ["Sox Compliance-001", "Sox Compliance Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Sox Compliance-002", "Sox Compliance Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Sox Compliance-003", "Sox Compliance Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Sox Compliance-004", "Sox Compliance Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Sox Compliance-005", "Sox Compliance Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Sox Compliance", ts: "Há 2min", a: "Sistema" },
