...
const PAGE = "Report";
const KPIS = [{"l":"Total Security Awareness","v":"6.089","t":"+10.8%","d":"up"},{"l":"Report Ativos","v":"766","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"81","t":"+4.3%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Awareness #001","Security Awareness #002","1.796","1.491","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Security Awareness #002","Security Awareness #003","2.031","1.373","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Awareness #003","Security Awareness #004","4.444","7.380","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Security Awareness #004","Security Awareness #005","4.546","6.862","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Awareness #005","Security Awareness #001","1.040","250","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":235},{"label":"Mar","value":382},{"label":"Abr","value":508},{"label":"Mai","value":551},{"label":"Jun","value":428},{"label":"Jul","value":394},{"label":"Ago","value":568},{"label":"Set","value":362},{"label":"Out","value":295},{"label":"Nov","value":616},{"label":"Dez","value":262}];
const MX = 616;
