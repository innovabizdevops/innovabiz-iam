...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"4.891","t":"-3.8%","d":"down"},{"l":"Simulações/Dia","v":"4107","t":"+4.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"93.7%","t":"+14.4%","d":"up"},{"l":"Latência Sync (ms)","v":"53ms","t":"+10.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","78.4%","2026-03-28","1.973","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","89.4%","2026-01-09","3.195","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.2%","2026-01-07","1.656","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","93.3%","2026-03-28","4.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.9%","2026-01-24","1.623","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":476},{"label":"Mar","value":720},{"label":"Abr","value":811},{"label":"Mai","value":734},{"label":"Jun","value":662},{"label":"Jul","value":503},{"label":"Ago","value":593},{"label":"Set","value":485},{"label":"Out","value":737},{"label":"Nov","value":511},{"label":"Dez","value":529}];
const MX = 811;
