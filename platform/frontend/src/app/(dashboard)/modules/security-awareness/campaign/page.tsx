...
const PAGE = "Campaign";
const KPIS = [{"l":"Total Security Awareness","v":"2.511","t":"+14.7%","d":"up"},{"l":"Campaign Ativos","v":"1.118","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+13.1%","d":"up"}];
const COLS = ["ID","Campaign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Awareness #001","Security Awareness #002","5.231","232","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Security Awareness #002","Security Awareness #003","6.354","5.600","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Awareness #003","Security Awareness #004","8.211","6.045","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Security Awareness #004","Security Awareness #005","8.578","6.100","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Awareness #005","Security Awareness #001","287","1.083","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":220},{"label":"Mar","value":436},{"label":"Abr","value":528},{"label":"Mai","value":468},{"label":"Jun","value":365},{"label":"Jul","value":249},{"label":"Ago","value":256},{"label":"Set","value":475},{"label":"Out","value":455},{"label":"Nov","value":277},{"label":"Dez","value":324}];
const MX = 528;
