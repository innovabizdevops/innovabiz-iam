...
const ACCENT = "#7f1d1d";
const MODULE = "Security Awareness Training";
const PAGE = "Measure";
const KPIS = [{"l":"Total Security Awareness","v":"4.459","t":"-2.9%","d":"down"},{"l":"Measure Ativos","v":"5.001","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.2%","d":"up"}];
const COLS = ["ID","Measure","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Security Awareness #001","Security Awareness #002","2.949","8.272","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Security Awareness #002","Security Awareness #003","5.064","7.276","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Security Awareness #003","Security Awareness #004","1.902","9.007","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Security Awareness #004","Security Awareness #005","5.913","7.662","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Security Awareness #005","Security Awareness #001","6.026","8.605","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":618},{"label":"Mar","value":950},{"label":"Abr","value":916},{"label":"Mai","value":609},{"label":"Jun","value":805},{"label":"Jul","value":670},{"label":"Ago","value":639},{"label":"Set","value":718},{"label":"Out","value":901},{"label":"Nov","value":946},{"label":"Dez","value":883}];
const MX = 950;
