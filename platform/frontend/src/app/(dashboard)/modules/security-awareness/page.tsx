...
const KPIS = [
    { label: "Total Registos", value: "4265", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3912", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€434K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1609516465", cells: ["SEC-2465", "Security Awareness Training Item 1", "26/2/2026", "€16 565"], status: "active" as const },
    { id: "1609520036", cells: ["SEC-6036", "Security Awareness Training Item 2", "13/9/2026", "€20 136"], status: "pending" as const },
    { id: "1609523607", cells: ["SEC-9607", "Security Awareness Training Item 3", "28/4/2026", "€23 707"], status: "completed" as const },
    { id: "1609527178", cells: ["SEC-4178", "Security Awareness Training Item 4", "15/11/2026", "€27 278"], status: "warning" as const },
    { id: "1609530749", cells: ["SEC-7749", "Security Awareness Training Item 5", "2/6/2026", "€30 849"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Awareness Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Security Awareness Training</p>
                    </div>
                </div>
