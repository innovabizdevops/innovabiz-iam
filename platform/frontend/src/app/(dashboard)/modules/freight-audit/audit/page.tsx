...
const ACCENT = "#6366f1";
const MODULE = "Freight Audit";
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.474","t":"+12.2%","d":"up"},{"l":"NC Abertas","v":"7.875","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"83.4%","t":"+7.0%","d":"up"},{"l":"CAPAs Pendentes","v":"5.330","t":"+13.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.731","92.4%","8.192","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.667","96.8%","5.825","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.964","93.9%","3.939","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.935","84.8%","670","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.797","98.1%","3.287","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":575},{"label":"Mar","value":721},{"label":"Abr","value":691},{"label":"Mai","value":612},{"label":"Jun","value":687},{"label":"Jul","value":472},{"label":"Ago","value":504},{"label":"Set","value":583},{"label":"Out","value":572},{"label":"Nov","value":370},{"label":"Dez","value":393}];
const MX = 721;
