...
const PAGE = "Pay";
const KPIS = [{"l":"Auditorias Realizadas","v":"103","t":"-5.0%","d":"down"},{"l":"NC Abertas","v":"483","t":"-3.4%","d":"down"},{"l":"Conformidade (%)","v":"73.5%","t":"+17.7%","d":"up"},{"l":"CAPAs Pendentes","v":"6.415","t":"+2.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.169","82.3%","532","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.978","99.0%","4.453","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.532","80.2%","366","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.922","100.0%","5.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.299","88.7%","7.655","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":1000},{"label":"Mar","value":701},{"label":"Abr","value":1021},{"label":"Mai","value":1010},{"label":"Jun","value":721},{"label":"Jul","value":937},{"label":"Ago","value":978},{"label":"Set","value":969},{"label":"Out","value":915},{"label":"Nov","value":765},{"label":"Dez","value":992}];
const MX = 1021;
