...
const PAGE = "Capture";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.308","t":"+17.5%","d":"up"},{"l":"NC Abertas","v":"945","t":"-3.4%","d":"down"},{"l":"Conformidade (%)","v":"91.1%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"6.757","t":"+16.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.083","99.7%","6.024","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.694","87.9%","5.450","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.795","85.5%","522","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.507","97.4%","2.836","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","541","75.1%","2.341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":849},{"label":"Mar","value":697},{"label":"Abr","value":954},{"label":"Mai","value":883},{"label":"Jun","value":888},{"label":"Jul","value":940},{"label":"Ago","value":883},{"label":"Set","value":886},{"label":"Out","value":645},{"label":"Nov","value":590},{"label":"Dez","value":812}];
const MX = 954;
