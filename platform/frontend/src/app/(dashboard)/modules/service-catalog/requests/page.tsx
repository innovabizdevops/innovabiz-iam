...
const PAGE = "Request Portal";
const KPIS = [{"l":"Dashboards Ativos","v":"1.783","t":"+12.3%","d":"up"},{"l":"Queries/Dia","v":"3972","t":"+9.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.731","t":"-1.8%","d":"down"},{"l":"Utilizadores Analytics","v":"110","t":"+15.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3644","2026-01-20","742","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4170","2026-03-26","2.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3152","2026-02-24","4.821","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2887","2026-01-12","7.207","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2072","2026-03-19","7.989","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":824},{"label":"Mar","value":813},{"label":"Abr","value":520},{"label":"Mai","value":670},{"label":"Jun","value":665},{"label":"Jul","value":556},{"label":"Ago","value":544},{"label":"Set","value":639},{"label":"Out","value":718},{"label":"Nov","value":618},{"label":"Dez","value":871}];
const MX = 871;
