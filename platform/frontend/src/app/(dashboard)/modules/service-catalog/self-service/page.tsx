...
const KPIS = [{"l":"Dashboards Ativos","v":"5.554","t":"-2.8%","d":"down"},{"l":"Queries/Dia","v":"3918","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.496","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.442","t":"-3.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4106","2026-03-11","4.434","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","247","2026-03-03","1.805","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4579","2026-03-25","3.346","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2007","2026-01-10","7.839","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3777","2026-03-25","7.890","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":663},{"label":"Mar","value":286},{"label":"Abr","value":589},{"label":"Mai","value":403},{"label":"Jun","value":266},{"label":"Jul","value":594},{"label":"Ago","value":555},{"label":"Set","value":367},{"label":"Out","value":521},{"label":"Nov","value":268},{"label":"Dez","value":501}];
const MX = 663;
