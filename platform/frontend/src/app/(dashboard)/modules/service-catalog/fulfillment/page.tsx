...
const ACCENT = "#7c3aed";
const MODULE = "Service Catalog";
const PAGE = "Fulfillment Rules";
const KPIS = [{"l":"Dashboards Ativos","v":"4.044","t":"+15.8%","d":"up"},{"l":"Queries/Dia","v":"1350","t":"+16.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.266","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"4.785","t":"-3.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1900","2026-02-23","2.970","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3162","2026-01-09","1.049","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4617","2026-03-22","1.632","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","634","2026-02-25","3.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1585","2026-01-27","5.918","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":646},{"label":"Mar","value":540},{"label":"Abr","value":352},{"label":"Mai","value":410},{"label":"Jun","value":710},{"label":"Jul","value":706},{"label":"Ago","value":533},{"label":"Set","value":689},{"label":"Out","value":718},{"label":"Nov","value":519},{"label":"Dez","value":599}];
const MX = 718;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>ITIL</span></h1>
                </div>
