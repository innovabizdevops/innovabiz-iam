...
const KPIS = [{"l":"Dashboards Ativos","v":"8.511","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"472","t":"+5.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.107","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"527","t":"+10.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1918","2026-03-07","6.304","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2163","2026-01-03","3.770","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2482","2026-02-14","4.569","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4033","2026-01-10","1.891","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1008","2026-01-03","8.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":730},{"label":"Mar","value":752},{"label":"Abr","value":618},{"label":"Mai","value":712},{"label":"Jun","value":626},{"label":"Jul","value":673},{"label":"Ago","value":563},{"label":"Set","value":593},{"label":"Out","value":565},{"label":"Nov","value":527},{"label":"Dez","value":549}];
const MX = 836;
