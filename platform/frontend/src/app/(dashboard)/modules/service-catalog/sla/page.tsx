...
const PAGE = "SLA Definitions";
const KPIS = [{"l":"Tickets Abertos","v":"4.693","t":"-0.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.8%","t":"+7.1%","d":"up"},{"l":"MTTR (h)","v":"102h","t":"-0.7%","d":"down"},{"l":"Satisfação (%)","v":"89.7%","t":"+2.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","628","4.702","2.673","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.980","9.057","7.034","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.686","5.771","4.658","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.303","7.934","3.219","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.117","8.223","7.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":514},{"label":"Mar","value":597},{"label":"Abr","value":384},{"label":"Mai","value":444},{"label":"Jun","value":430},{"label":"Jul","value":477},{"label":"Ago","value":518},{"label":"Set","value":674},{"label":"Out","value":390},{"label":"Nov","value":425},{"label":"Dez","value":592}];
const MX = 731;
