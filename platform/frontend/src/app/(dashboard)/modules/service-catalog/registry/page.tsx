...
const PAGE = "Service Registry";
const KPIS = [{"l":"Dashboards Ativos","v":"5.430","t":"+7.1%","d":"up"},{"l":"Queries/Dia","v":"4699","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.690","t":"-3.9%","d":"down"},{"l":"Utilizadores Analytics","v":"1.303","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2353","2026-03-05","646","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1159","2026-02-23","1.067","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2834","2026-02-19","6.700","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","229","2026-03-06","899","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1721","2026-03-10","3.611","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":539},{"label":"Mar","value":410},{"label":"Abr","value":395},{"label":"Mai","value":733},{"label":"Jun","value":523},{"label":"Jul","value":742},{"label":"Ago","value":576},{"label":"Set","value":515},{"label":"Out","value":622},{"label":"Nov","value":728},{"label":"Dez","value":402}];
const MX = 742;
