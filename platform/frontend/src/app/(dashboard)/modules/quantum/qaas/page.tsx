...
const PAGE = "Quantum-as-a-Service";
const KPIS = [{"l":"Total Quantum","v":"1.054","t":"+2.9%","d":"up"},{"l":"Quantum As A Service Ativos","v":"4.413","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"93","t":"-0.8%","d":"down"}];
const COLS = ["ID","Quantum As A Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quantum #001","Quantum #002","2.019","8.058","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Quantum #002","Quantum #003","7.154","8.562","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Quantum #003","Quantum #004","7.264","3.210","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Quantum #004","Quantum #005","2.076","1.145","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quantum #005","Quantum #001","4.505","7.986","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":687},{"label":"Mar","value":812},{"label":"Abr","value":748},{"label":"Mai","value":788},{"label":"Jun","value":511},{"label":"Jul","value":629},{"label":"Ago","value":593},{"label":"Set","value":499},{"label":"Out","value":827},{"label":"Nov","value":848},{"label":"Dez","value":706}];
const MX = 848;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>Cloud</span></h1>
                </div>
