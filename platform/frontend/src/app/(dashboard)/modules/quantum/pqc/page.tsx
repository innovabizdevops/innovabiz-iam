...
const PAGE = "Cryptography (PQC)";
const KPIS = [{"l":"Total Quantum","v":"8.614","t":"+10.8%","d":"up"},{"l":"Cryptography (PQC) Ativos","v":"3.699","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+2.8%","d":"up"}];
const COLS = ["ID","Cryptography (PQC)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quantum #001","Quantum #002","1.823","3.005","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Quantum #002","Quantum #003","6.853","829","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Quantum #003","Quantum #004","2.249","1.002","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Quantum #004","Quantum #005","1.784","5.841","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quantum #005","Quantum #001","8.636","6.850","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":467},{"label":"Mar","value":358},{"label":"Abr","value":496},{"label":"Mai","value":632},{"label":"Jun","value":454},{"label":"Jul","value":426},{"label":"Ago","value":474},{"label":"Set","value":443},{"label":"Out","value":631},{"label":"Nov","value":306},{"label":"Dez","value":481}];
const MX = 632;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>Security</span></h1>
                </div>
