...
const PAGE = "Optimization Problems";
const KPIS = [{"l":"Tickets Abertos","v":"3.449","t":"-1.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"88.5%","t":"+10.9%","d":"up"},{"l":"MTTR (h)","v":"60h","t":"+17.9%","d":"up"},{"l":"Satisfação (%)","v":"70.0%","t":"+9.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.451","8.469","1.538","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.079","7.675","1.645","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.036","800","6.625","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.007","6.856","6.776","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.851","1.641","797","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":618},{"label":"Mar","value":774},{"label":"Abr","value":546},{"label":"Mai","value":631},{"label":"Jun","value":598},{"label":"Jul","value":735},{"label":"Ago","value":854},{"label":"Set","value":802},{"label":"Out","value":853},{"label":"Nov","value":858},{"label":"Dez","value":803}];
const MX = 858;
