...
const PAGE = "Hybrid Computing";
const KPIS = [{"l":"Total Quantum","v":"887","t":"-1.8%","d":"down"},{"l":"Hybrid Computing Ativos","v":"8.144","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"90.8%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+2.5%","d":"up"}];
const COLS = ["ID","Hybrid Computing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quantum #001","Quantum #002","6.787","1.109","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Quantum #002","Quantum #003","7.166","6.380","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Quantum #003","Quantum #004","2.018","6.191","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Quantum #004","Quantum #005","4.178","8.641","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quantum #005","Quantum #001","3.340","4.617","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":806},{"label":"Mar","value":1048},{"label":"Abr","value":842},{"label":"Mai","value":995},{"label":"Jun","value":767},{"label":"Jul","value":903},{"label":"Ago","value":949},{"label":"Set","value":734},{"label":"Out","value":891},{"label":"Nov","value":837},{"label":"Dez","value":1013}];
const MX = 1048;
