...
const PAGE = "Quantum Simulation";
const KPIS = [{"l":"Twins Ativos","v":"6.317","t":"-0.1%","d":"down"},{"l":"Simulações/Dia","v":"500","t":"+1.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"86.1%","t":"+15.3%","d":"up"},{"l":"Latência Sync (ms)","v":"45ms","t":"-2.2%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","98.3%","2026-01-04","7.050","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","73.6%","2026-02-14","8.832","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","93.3%","2026-01-02","7.807","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","86.7%","2026-01-14","7.495","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","81.6%","2026-03-04","6.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":573},{"label":"Mar","value":684},{"label":"Abr","value":570},{"label":"Mai","value":738},{"label":"Jun","value":664},{"label":"Jul","value":587},{"label":"Ago","value":686},{"label":"Set","value":586},{"label":"Out","value":579},{"label":"Nov","value":727},{"label":"Dez","value":597}];
const MX = 738;
