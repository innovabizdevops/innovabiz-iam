...
const KPIS = [{"l":"Aprovações Pendentes","v":"1.446","t":"+9.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.1%","t":"-0.2%","d":"down"},{"l":"Tempo Médio (h)","v":"153h","t":"+13.9%","d":"up"},{"l":"Rejeitadas (%)","v":"87.3%","t":"+5.4%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.886","€ 3515.74","2.770","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.800","€ 7394.53","2.722","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","8.615","€ 41987.49","8.268","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.718","€ 12744.79","8.953","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","8.761","€ 12225.05","4.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":839},{"label":"Mar","value":570},{"label":"Abr","value":849},{"label":"Mai","value":613},{"label":"Jun","value":703},{"label":"Jul","value":489},{"label":"Ago","value":552},{"label":"Set","value":531},{"label":"Out","value":712},{"label":"Nov","value":644},{"label":"Dez","value":837}];
const MX = 849;
