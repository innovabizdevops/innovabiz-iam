...
const ACCENT = "#4338ca";
const MODULE = "Change Advisory Board";
const PAGE = "Impact Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.237","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"4195","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.359","t":"-0.9%","d":"down"},{"l":"Utilizadores Analytics","v":"1.415","t":"+16.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","551","2026-03-09","4.128","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","626","2026-03-09","1.123","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1294","2026-02-23","6.396","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2019","2026-01-06","8.119","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","983","2026-03-03","643","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":696},{"label":"Mar","value":820},{"label":"Abr","value":568},{"label":"Mai","value":726},{"label":"Jun","value":606},{"label":"Jul","value":720},{"label":"Ago","value":741},{"label":"Set","value":600},{"label":"Out","value":505},{"label":"Nov","value":492},{"label":"Dez","value":766}];
const MX = 820;
