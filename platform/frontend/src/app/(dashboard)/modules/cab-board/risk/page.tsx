...
const KPIS = [{"l":"Riscos Identificados","v":"8.869","t":"+17.4%","d":"up"},{"l":"Mitigações Ativas","v":"6.231","t":"+14.0%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+12.7%","d":"up"},{"l":"Incidentes YTD","v":"4.822","t":"+3.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.135","8.510","8.432","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.511","1.493","5.829","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.880","2.708","4.648","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.111","823","1.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.399","8.642","7.518","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":281},{"label":"Mar","value":446},{"label":"Abr","value":484},{"label":"Mai","value":609},{"label":"Jun","value":591},{"label":"Jul","value":522},{"label":"Ago","value":465},{"label":"Set","value":629},{"label":"Out","value":451},{"label":"Nov","value":544},{"label":"Dez","value":377}];
const MX = 629;
