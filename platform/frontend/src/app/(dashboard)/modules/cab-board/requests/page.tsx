...
const KPIS = [{"l":"Teams Ativos","v":"1.411","t":"+8.4%","d":"up"},{"l":"Reuniões/Semana","v":"3152","t":"+7.8%","d":"up"},{"l":"Mensagens/Dia","v":"4940","t":"+0.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.251","t":"+7.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.239","4269","2.580","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.864","3923","8.752","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.890","2866","1.867","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.821","1763","7.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","6.321","4482","2.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":529},{"label":"Mar","value":731},{"label":"Abr","value":821},{"label":"Mai","value":897},{"label":"Jun","value":573},{"label":"Jul","value":688},{"label":"Ago","value":778},{"label":"Set","value":644},{"label":"Out","value":598},{"label":"Nov","value":574},{"label":"Dez","value":761}];
const MX = 897;
