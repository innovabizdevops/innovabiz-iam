...
const PAGE = "CAB Calendar";
const KPIS = [{"l":"Teams Ativos","v":"3.507","t":"+17.3%","d":"up"},{"l":"Reuniões/Semana","v":"2397","t":"-1.3%","d":"down"},{"l":"Mensagens/Dia","v":"4573","t":"+2.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.304","t":"+16.4%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","3.974","1861","921","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","5.107","3024","6.230","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.131","4438","9.076","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.651","2394","2.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.898","4032","8.933","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":436},{"label":"Mar","value":316},{"label":"Abr","value":575},{"label":"Mai","value":356},{"label":"Jun","value":468},{"label":"Jul","value":576},{"label":"Ago","value":526},{"label":"Set","value":694},{"label":"Out","value":642},{"label":"Nov","value":329},{"label":"Dez","value":551}];
const MX = 694;
