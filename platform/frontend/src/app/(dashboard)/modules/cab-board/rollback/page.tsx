...
const PAGE = "Rollback Plans";
const KPIS = [{"l":"Teams Ativos","v":"7.535","t":"+13.8%","d":"up"},{"l":"Reuniões/Semana","v":"982","t":"+14.8%","d":"up"},{"l":"Mensagens/Dia","v":"3525","t":"+14.2%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.301","t":"+2.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","2.211","3502","1.399","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.403","3695","1.092","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.174","4518","7.903","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","4.510","3931","1.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","8.453","4050","4.365","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":643},{"label":"Mar","value":490},{"label":"Abr","value":716},{"label":"Mai","value":579},{"label":"Jun","value":437},{"label":"Jul","value":803},{"label":"Ago","value":570},{"label":"Set","value":605},{"label":"Out","value":455},{"label":"Nov","value":817},{"label":"Dez","value":537}];
const MX = 817;
