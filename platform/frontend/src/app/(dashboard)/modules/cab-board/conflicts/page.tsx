...
const PAGE = "Scheduling Conflict";
const KPIS = [{"l":"eNPS","v":"81","t":"-3.6%","d":"down"},{"l":"Engagement (%)","v":"66.4%","t":"-2.9%","d":"down"},{"l":"Turnover (%)","v":"69.3%","t":"-5.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.322","t":"+3.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.159","2026-02-03","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.796","2026-01-14","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.320","2026-03-18","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","9.084","2026-02-20","73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","153","2026-02-07","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":500},{"label":"Mar","value":693},{"label":"Abr","value":511},{"label":"Mai","value":668},{"label":"Jun","value":509},{"label":"Jul","value":565},{"label":"Ago","value":622},{"label":"Set","value":581},{"label":"Out","value":343},{"label":"Nov","value":564},{"label":"Dez","value":508}];
const MX = 693;
