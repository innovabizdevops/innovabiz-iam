...
/* ═══ Military Health — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "8765", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3024", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€416K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1279514365", cells: ["MIL-3365", "Military Health Item 1", "18/2/2026", "€14 465"], status: "active" as const },
    { id: "1279517936", cells: ["MIL-6936", "Military Health Item 2", "5/9/2026", "€18 036"], status: "pending" as const },
    { id: "1279521507", cells: ["MIL-1507", "Military Health Item 3", "20/4/2026", "€21 607"], status: "completed" as const },
    { id: "1279525078", cells: ["MIL-5078", "Military Health Item 4", "7/11/2026", "€25 178"], status: "warning" as const },
    { id: "1279528649", cells: ["MIL-8649", "Military Health Item 5", "22/6/2026", "€28 749"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Military Health</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Military Health</p>
                    </div>
                </div>
