...
const PAGE = "Combat Medic";
const KPIS = [{"l":"Integrações Ativas","v":"7.816","t":"-4.9%","d":"down"},{"l":"Chamadas/Hora","v":"4391","t":"+0.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"69.0%","t":"+10.3%","d":"up"},{"l":"Latência Média (ms)","v":"63ms","t":"+16.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.026","3.525","83.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.796","916","98.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.414","2.455","74.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.576","5.669","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.824","2.810","75.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":853},{"label":"Mar","value":744},{"label":"Abr","value":549},{"label":"Mai","value":498},{"label":"Jun","value":646},{"label":"Jul","value":824},{"label":"Ago","value":586},{"label":"Set","value":716},{"label":"Out","value":568},{"label":"Nov","value":694},{"label":"Dez","value":805}];
const MX = 856;
