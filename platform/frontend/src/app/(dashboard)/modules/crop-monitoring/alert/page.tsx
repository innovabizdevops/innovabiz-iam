...
const ACCENT = "#166534";
const MODULE = "Crop Monitoring (AI/Sat)";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"7.131","t":"+15.4%","d":"up"},{"l":"Taxa Entrega (%)","v":"81.6%","t":"-0.6%","d":"down"},{"l":"Taxa Abertura (%)","v":"89.0%","t":"+14.4%","d":"up"},{"l":"Escalações","v":"4.959","t":"-1.3%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","875","85.6%","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.237","81.6%","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.159","81.3%","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.224","79.0%","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.570","75.0%","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":414},{"label":"Mar","value":382},{"label":"Abr","value":732},{"label":"Mai","value":590},{"label":"Jun","value":681},{"label":"Jul","value":574},{"label":"Ago","value":732},{"label":"Set","value":560},{"label":"Out","value":562},{"label":"Nov","value":476},{"label":"Dez","value":518}];
const MX = 732;
