...
/* ═══ Crop Monitoring (AI/Sat) — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1912", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2498", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€481K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-20%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "496665012", cells: ["CRO-1012", "Crop Monitoring (AI/Sat) Item 1", "5/1/2026", "€15 112"], status: "active" as const },
    { id: "496668583", cells: ["CRO-4583", "Crop Monitoring (AI/Sat) Item 2", "20/8/2026", "€18 683"], status: "pending" as const },
    { id: "496672154", cells: ["CRO-8154", "Crop Monitoring (AI/Sat) Item 3", "7/3/2026", "€22 254"], status: "completed" as const },
    { id: "496675725", cells: ["CRO-2725", "Crop Monitoring (AI/Sat) Item 4", "22/10/2026", "€25 825"], status: "warning" as const },
    { id: "496679296", cells: ["CRO-6296", "Crop Monitoring (AI/Sat) Item 5", "9/5/2026", "€29 396"], status: "active" as const },
];
...
export default function CropMonitoringAisatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crop Monitoring (AI/Sat)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crop Monitoring (AI/Sat)</p>
                    </div>
                </div>
