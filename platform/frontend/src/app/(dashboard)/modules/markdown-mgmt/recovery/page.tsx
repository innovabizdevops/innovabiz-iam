...
const PAGE = "Recovery Rate";
const KPIS = [{"l":"BCP Plans Ativos","v":"8.926","t":"-5.8%","d":"down"},{"l":"RTO Médio (h)","v":"207h","t":"-3.4%","d":"down"},{"l":"RPO Médio (h)","v":"131h","t":"+3.5%","d":"up"},{"l":"Testes DR (YTD)","v":"1.173","t":"-1.7%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","180h","67h","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","173h","12h","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","102h","58h","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","22h","135h","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","145h","158h","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":835},{"label":"Mar","value":816},{"label":"Abr","value":943},{"label":"Mai","value":744},{"label":"Jun","value":749},{"label":"Jul","value":836},{"label":"Ago","value":845},{"label":"Set","value":630},{"label":"Out","value":813},{"label":"Nov","value":824},{"label":"Dez","value":760}];
const MX = 943;
