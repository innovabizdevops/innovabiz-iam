...
const PAGE = "Inventory Age";
const KPIS = [{"l":"Total Markdown Mgmt","v":"4.255","t":"+16.8%","d":"up"},{"l":"Inventory Age Ativos","v":"1.617","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.6%","d":"down"}];
const COLS = ["ID","Inventory Age","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Markdown Mgmt #001","Markdown Mgmt #002","3.541","4.226","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Markdown Mgmt #002","Markdown Mgmt #003","6.895","7.876","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Markdown Mgmt #003","Markdown Mgmt #004","4.561","1.669","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Markdown Mgmt #004","Markdown Mgmt #005","6.227","3.730","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Markdown Mgmt #005","Markdown Mgmt #001","6.670","7.002","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":582},{"label":"Mar","value":391},{"label":"Abr","value":566},{"label":"Mai","value":500},{"label":"Jun","value":436},{"label":"Jul","value":628},{"label":"Ago","value":637},{"label":"Set","value":616},{"label":"Out","value":716},{"label":"Nov","value":475},{"label":"Dez","value":460}];
const MX = 716;
