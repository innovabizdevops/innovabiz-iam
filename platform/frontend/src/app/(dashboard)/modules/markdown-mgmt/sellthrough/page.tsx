...
const ACCENT = "#78350f";
const MODULE = "Markdown Management";
const PAGE = "Sell-Through";
const KPIS = [{"l":"Total Markdown Mgmt","v":"1.242","t":"+15.7%","d":"up"},{"l":"Sell Through Ativos","v":"1.489","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"75.2%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"58","t":"-3.4%","d":"down"}];
const COLS = ["ID","Sell Through","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Markdown Mgmt #001","Markdown Mgmt #002","2.034","348","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Markdown Mgmt #002","Markdown Mgmt #003","760","605","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Markdown Mgmt #003","Markdown Mgmt #004","5.065","8.687","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Markdown Mgmt #004","Markdown Mgmt #005","3.722","2.000","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Markdown Mgmt #005","Markdown Mgmt #001","3.253","7.447","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":696},{"label":"Mar","value":764},{"label":"Abr","value":809},{"label":"Mai","value":720},{"label":"Jun","value":735},{"label":"Jul","value":672},{"label":"Ago","value":957},{"label":"Set","value":601},{"label":"Out","value":761},{"label":"Nov","value":775},{"label":"Dez","value":771}];
const MX = 957;
