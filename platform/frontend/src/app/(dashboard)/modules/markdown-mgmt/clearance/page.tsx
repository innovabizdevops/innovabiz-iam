...
const PAGE = "Clearance Rule";
const KPIS = [{"l":"Total Markdown Mgmt","v":"1.601","t":"-2.2%","d":"down"},{"l":"Clearance Rule Ativos","v":"6.235","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"61","t":"+17.0%","d":"up"}];
const COLS = ["ID","Clearance Rule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Markdown Mgmt #001","Markdown Mgmt #002","8.764","4.826","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Markdown Mgmt #002","Markdown Mgmt #003","2.391","8.184","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Markdown Mgmt #003","Markdown Mgmt #004","252","3.647","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Markdown Mgmt #004","Markdown Mgmt #005","7.045","5.745","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Markdown Mgmt #005","Markdown Mgmt #001","577","518","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":858},{"label":"Mar","value":806},{"label":"Abr","value":649},{"label":"Mai","value":742},{"label":"Jun","value":779},{"label":"Jul","value":759},{"label":"Ago","value":918},{"label":"Set","value":602},{"label":"Out","value":621},{"label":"Nov","value":762},{"label":"Dez","value":604}];
const MX = 918;
