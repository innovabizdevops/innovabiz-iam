...
const PAGE = "Markdown Sched";
const KPIS = [{"l":"Total Markdown Mgmt","v":"991","t":"+2.4%","d":"up"},{"l":"Markdown Sched Ativos","v":"7.033","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+10.9%","d":"up"}];
const COLS = ["ID","Markdown Sched","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Markdown Mgmt #001","Markdown Mgmt #002","2.130","6.231","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Markdown Mgmt #002","Markdown Mgmt #003","2.055","9.049","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Markdown Mgmt #003","Markdown Mgmt #004","7.002","8.074","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Markdown Mgmt #004","Markdown Mgmt #005","6.450","1.868","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Markdown Mgmt #005","Markdown Mgmt #001","214","5.486","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":716},{"label":"Mar","value":655},{"label":"Abr","value":764},{"label":"Mai","value":775},{"label":"Jun","value":720},{"label":"Jul","value":696},{"label":"Ago","value":763},{"label":"Set","value":455},{"label":"Out","value":672},{"label":"Nov","value":434},{"label":"Dez","value":747}];
const MX = 775;
