...
const KPIS = [
    ...
    { label: "Ativos", value: "3626", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€415K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "729403365", cells: ["VEN-8365", "Vendor Risk Management Item 1", "6/10/2026", "€3465"], status: "active" as const },
    { id: "729406936", cells: ["VEN-2936", "Vendor Risk Management Item 2", "21/5/2026", "€7036"], status: "pending" as const },
    { id: "729410507", cells: ["VEN-6507", "Vendor Risk Management Item 3", "8/12/2026", "€10 607"], status: "completed" as const },
    { id: "729414078", cells: ["VEN-1078", "Vendor Risk Management Item 4", "23/7/2026", "€14 178"], status: "warning" as const },
    { id: "729417649", cells: ["VEN-4649", "Vendor Risk Management Item 5", "10/2/2026", "€17 749"], status: "active" as const },
];
...
export default function VendorRiskManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vendor Risk Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Vendor Risk Management</p>
                    </div>
                </div>
