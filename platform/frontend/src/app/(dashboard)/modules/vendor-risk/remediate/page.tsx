...
const KPIS = [{"l":"Riscos Identificados","v":"2.659","t":"-3.7%","d":"down"},{"l":"Mitigações Ativas","v":"4.363","t":"-0.6%","d":"down"},{"l":"Score Risco Geral","v":"69","t":"+17.5%","d":"up"},{"l":"Incidentes YTD","v":"2.569","t":"-3.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.799","3.966","2.465","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.238","1.275","5.501","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.015","5.887","7.626","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.864","8.437","8.156","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.456","3.718","5.106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":703},{"label":"Mar","value":526},{"label":"Abr","value":505},{"label":"Mai","value":573},{"label":"Jun","value":577},{"label":"Jul","value":747},{"label":"Ago","value":833},{"label":"Set","value":633},{"label":"Out","value":601},{"label":"Nov","value":542},{"label":"Dez","value":747}];
const MX = 833;
