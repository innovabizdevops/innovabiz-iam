...
const PAGE = "Report";
const KPIS = [{"l":"Riscos Identificados","v":"661","t":"+4.8%","d":"up"},{"l":"Mitigações Ativas","v":"6.336","t":"+0.2%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+8.1%","d":"up"},{"l":"Incidentes YTD","v":"7.636","t":"+7.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.860","3.658","1.325","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.141","1.429","6.036","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.656","7.413","6.747","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.466","1.333","5.292","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.848","5.099","3.550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":808},{"label":"Mar","value":665},{"label":"Abr","value":565},{"label":"Mai","value":706},{"label":"Jun","value":664},{"label":"Jul","value":570},{"label":"Ago","value":755},{"label":"Set","value":643},{"label":"Out","value":675},{"label":"Nov","value":854},{"label":"Dez","value":587}];
const MX = 854;
