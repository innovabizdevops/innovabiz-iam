...
const PAGE = "Incident";
const KPIS = [{"l":"Riscos Identificados","v":"487","t":"+8.1%","d":"up"},{"l":"Mitigações Ativas","v":"199","t":"+10.1%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+11.3%","d":"up"},{"l":"Incidentes YTD","v":"4.054","t":"+12.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.401","8.053","6.486","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.154","3.676","2.747","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.730","8.595","6.033","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.676","8.464","5.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.425","2.290","2.756","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":845},{"label":"Mar","value":550},{"label":"Abr","value":603},{"label":"Mai","value":482},{"label":"Jun","value":625},{"label":"Jul","value":536},{"label":"Ago","value":832},{"label":"Set","value":598},{"label":"Out","value":753},{"label":"Nov","value":806},{"label":"Dez","value":867}];
const MX = 867;
