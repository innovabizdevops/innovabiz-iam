...
const PAGE = "Assess";
const KPIS = [{"l":"Riscos Identificados","v":"7.011","t":"+5.4%","d":"up"},{"l":"Mitigações Ativas","v":"8.730","t":"+14.1%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"+9.4%","d":"up"},{"l":"Incidentes YTD","v":"282","t":"+7.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.615","8.842","5.782","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.753","396","4.855","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.719","8.892","6.744","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.211","7.970","7.046","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.598","4.609","2.289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":555},{"label":"Mar","value":445},{"label":"Abr","value":595},{"label":"Mai","value":470},{"label":"Jun","value":522},{"label":"Jul","value":429},{"label":"Ago","value":406},{"label":"Set","value":459},{"label":"Out","value":703},{"label":"Nov","value":470},{"label":"Dez","value":537}];
const MX = 703;
