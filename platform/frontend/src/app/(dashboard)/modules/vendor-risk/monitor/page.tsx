...
const ACCENT = "#64748b";
const MODULE = "Vendor Risk Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Riscos Identificados","v":"6.272","t":"+7.2%","d":"up"},{"l":"Mitigações Ativas","v":"8.515","t":"+7.1%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-3.7%","d":"down"},{"l":"Incidentes YTD","v":"3.746","t":"+17.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.206","1.949","1.397","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.247","8.379","1.551","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.896","5.697","4.149","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.680","6.831","1.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","344","6.928","7.430","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":685},{"label":"Mar","value":536},{"label":"Abr","value":699},{"label":"Mai","value":626},{"label":"Jun","value":399},{"label":"Jul","value":677},{"label":"Ago","value":326},{"label":"Set","value":689},{"label":"Out","value":601},{"label":"Nov","value":508},{"label":"Dez","value":329}];
const MX = 699;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#64748b'}}>RTM</span></h1>
                </div>
