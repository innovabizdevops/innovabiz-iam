...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"1.103","t":"-2.8%","d":"down"},{"l":"Taxa Entrega (%)","v":"88.9%","t":"+5.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"80.9%","t":"+14.9%","d":"up"},{"l":"Escalações","v":"5.156","t":"+4.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.131","73.3%","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.941","97.8%","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.535","75.3%","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.720","78.9%","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","122","77.3%","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":870},{"label":"Mar","value":1031},{"label":"Abr","value":821},{"label":"Mai","value":756},{"label":"Jun","value":925},{"label":"Jul","value":1034},{"label":"Ago","value":847},{"label":"Set","value":884},{"label":"Out","value":795},{"label":"Nov","value":994},{"label":"Dez","value":772}];
const MX = 1034;
