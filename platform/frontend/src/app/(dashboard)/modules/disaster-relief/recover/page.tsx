...
const PAGE = "Recover";
const KPIS = [{"l":"BCP Plans Ativos","v":"497","t":"-3.5%","d":"down"},{"l":"RTO Médio (h)","v":"170h","t":"-5.0%","d":"down"},{"l":"RPO Médio (h)","v":"135h","t":"+8.7%","d":"up"},{"l":"Testes DR (YTD)","v":"445","t":"+2.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","75h","177h","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","53h","156h","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","116h","159h","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","202h","137h","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","77h","40h","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":550},{"label":"Mar","value":532},{"label":"Abr","value":859},{"label":"Mai","value":891},{"label":"Jun","value":677},{"label":"Jul","value":911},{"label":"Ago","value":605},{"label":"Set","value":574},{"label":"Out","value":746},{"label":"Nov","value":744},{"label":"Dez","value":584}];
const MX = 911;
