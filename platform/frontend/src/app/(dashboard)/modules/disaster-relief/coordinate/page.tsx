...
const KPIS = [{"l":"BCP Plans Ativos","v":"2.083","t":"-0.1%","d":"down"},{"l":"RTO Médio (h)","v":"142h","t":"+15.9%","d":"up"},{"l":"RPO Médio (h)","v":"135h","t":"+15.8%","d":"up"},{"l":"Testes DR (YTD)","v":"7.786","t":"+7.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","174h","71h","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","46h","155h","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","49h","132h","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","67h","104h","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","114h","128h","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":701},{"label":"Mar","value":977},{"label":"Abr","value":783},{"label":"Mai","value":890},{"label":"Jun","value":686},{"label":"Jul","value":853},{"label":"Ago","value":721},{"label":"Set","value":1001},{"label":"Out","value":790},{"label":"Nov","value":772},{"label":"Dez","value":862}];
const MX = 1001;
