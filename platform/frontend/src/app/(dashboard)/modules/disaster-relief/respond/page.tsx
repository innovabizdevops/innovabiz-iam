...
const PAGE = "Respond";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.915","t":"+11.8%","d":"up"},{"l":"RTO Médio (h)","v":"23h","t":"-0.2%","d":"down"},{"l":"RPO Médio (h)","v":"86h","t":"+9.0%","d":"up"},{"l":"Testes DR (YTD)","v":"4.251","t":"-0.3%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","123h","117h","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","84h","142h","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","165h","33h","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","21h","198h","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","165h","49h","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":810},{"label":"Mar","value":828},{"label":"Abr","value":829},{"label":"Mai","value":715},{"label":"Jun","value":909},{"label":"Jul","value":943},{"label":"Ago","value":708},{"label":"Set","value":1037},{"label":"Out","value":698},{"label":"Nov","value":1040},{"label":"Dez","value":713}];
const MX = 1040;
