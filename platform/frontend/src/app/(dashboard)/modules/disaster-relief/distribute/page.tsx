...
const ACCENT = "#6366f1";
const MODULE = "Disaster Relief";
const PAGE = "Distribute";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.464","t":"+5.0%","d":"up"},{"l":"RTO Médio (h)","v":"18h","t":"+1.6%","d":"up"},{"l":"RPO Médio (h)","v":"31h","t":"+14.4%","d":"up"},{"l":"Testes DR (YTD)","v":"8.499","t":"-2.7%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","175h","54h","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","44h","176h","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","174h","171h","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","100h","150h","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","107h","124h","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":534},{"label":"Mar","value":526},{"label":"Abr","value":843},{"label":"Mai","value":512},{"label":"Jun","value":525},{"label":"Jul","value":671},{"label":"Ago","value":868},{"label":"Set","value":513},{"label":"Out","value":698},{"label":"Nov","value":567},{"label":"Dez","value":565}];
const MX = 868;
