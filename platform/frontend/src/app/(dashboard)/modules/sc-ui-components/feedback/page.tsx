...
const PAGE = "Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"7.553","t":"-3.3%","d":"down"},{"l":"Respostas/Semana","v":"3231","t":"+6.5%","d":"up"},{"l":"NPS Médio","v":"61","t":"+18.0%","d":"up"},{"l":"Taxa Resposta (%)","v":"89.6%","t":"+8.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.454","82","81.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","8.608","55","88.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","1.558","83","79.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","2.999","70","93.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","148","78","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":525},{"label":"Mar","value":657},{"label":"Abr","value":516},{"label":"Mai","value":573},{"label":"Jun","value":874},{"label":"Jul","value":595},{"label":"Ago","value":654},{"label":"Set","value":544},{"label":"Out","value":714},{"label":"Nov","value":733},{"label":"Dez","value":870}];
const MX = 874;
