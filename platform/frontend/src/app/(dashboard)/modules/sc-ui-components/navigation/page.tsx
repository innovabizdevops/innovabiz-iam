...
const ACCENT = "#0284c7";
const MODULE = "SC: UI Component Library";
const PAGE = "Navigation";
const KPIS = [{"l":"Total Sc Ui Components","v":"6.642","t":"+11.7%","d":"up"},{"l":"Navigation Ativos","v":"5.319","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"95","t":"+14.4%","d":"up"}];
const COLS = ["ID","Navigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Ui Components #001","Sc Ui Components #002","5.970","6.773","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Ui Components #002","Sc Ui Components #003","3.576","4.668","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Ui Components #003","Sc Ui Components #004","5.757","7.794","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Ui Components #004","Sc Ui Components #005","9.096","3.162","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Ui Components #005","Sc Ui Components #001","6.896","3.088","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":993},{"label":"Fev","value":928},{"label":"Mar","value":639},{"label":"Abr","value":777},{"label":"Mai","value":642},{"label":"Jun","value":811},{"label":"Jul","value":1007},{"label":"Ago","value":806},{"label":"Set","value":660},{"label":"Out","value":1002},{"label":"Nov","value":650},{"label":"Dez","value":840}];
const MX = 1007;
