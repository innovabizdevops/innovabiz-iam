...
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"737","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"2894","t":"+16.6%","d":"up"},{"l":"Documentos Gerados","v":"2.752","t":"-4.2%","d":"down"},{"l":"Templates","v":"5.476","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.768","2026-02-18","2.846","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.416","2026-02-14","3.444","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.953","2026-03-23","2.538","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.289","2026-01-09","4.102","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.446","2026-01-06","5.886","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":799},{"label":"Mar","value":691},{"label":"Abr","value":570},{"label":"Mai","value":675},{"label":"Jun","value":516},{"label":"Jul","value":536},{"label":"Ago","value":567},{"label":"Set","value":786},{"label":"Out","value":586},{"label":"Nov","value":619},{"label":"Dez","value":780}];
const MX = 799;
