...
/* ═══ SC: UI Component Library — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "2959", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1074", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€149K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "715782759", cells: ["SC-4759", "SC: UI Component Library Item 1", "28/4/2026", "€32 859"], status: "active" as const },
    { id: "715786330", cells: ["SC-8330", "SC: UI Component Library Item 2", "15/11/2026", "€36 430"], status: "pending" as const },
    { id: "715789901", cells: ["SC-2901", "SC: UI Component Library Item 3", "2/6/2026", "€40 001"], status: "completed" as const },
    { id: "715793472", cells: ["SC-6472", "SC: UI Component Library Item 4", "17/1/2026", "€43 572"], status: "warning" as const },
    { id: "715797043", cells: ["SC-1043", "SC: UI Component Library Item 5", "4/8/2026", "€47 143"], status: "active" as const },
];
...
export default function ScUiComponentLibraryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: UI Component Library</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: UI Component Library</p>
                    </div>
                </div>
