...
const PAGE = "Agile";
const KPIS = [{"l":"Total Snow Itbm","v":"7.315","t":"+7.5%","d":"up"},{"l":"Agile Ativos","v":"5.602","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"66","t":"+14.5%","d":"up"}];
const COLS = ["ID","Agile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itbm #001","Snow Itbm #002","8.661","2.879","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itbm #002","Snow Itbm #003","6.115","6.064","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itbm #003","Snow Itbm #004","7.765","6.863","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itbm #004","Snow Itbm #005","1.557","2.991","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itbm #005","Snow Itbm #001","398","2.354","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":862},{"label":"Mar","value":1024},{"label":"Abr","value":703},{"label":"Mai","value":690},{"label":"Jun","value":824},{"label":"Jul","value":680},{"label":"Ago","value":710},{"label":"Set","value":865},{"label":"Out","value":850},{"label":"Nov","value":712},{"label":"Dez","value":999}];
const MX = 1024;
