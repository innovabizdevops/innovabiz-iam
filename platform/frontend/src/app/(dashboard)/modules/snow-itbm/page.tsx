...
/* ═══ IT Business Mgmt (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "6641", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4399", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€16K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1294065241", cells: ["SNO-1241", "IT Business Mgmt (SNOW) Item 1", "22/2/2026", "€15 341"], status: "active" as const },
    { id: "1294068812", cells: ["SNO-4812", "IT Business Mgmt (SNOW) Item 2", "9/9/2026", "€18 912"], status: "pending" as const },
    { id: "1294072383", cells: ["SNO-8383", "IT Business Mgmt (SNOW) Item 3", "24/4/2026", "€22 483"], status: "completed" as const },
    { id: "1294075954", cells: ["SNO-2954", "IT Business Mgmt (SNOW) Item 4", "11/11/2026", "€26 054"], status: "warning" as const },
    { id: "1294079525", cells: ["SNO-6525", "IT Business Mgmt (SNOW) Item 5", "26/6/2026", "€29 625"], status: "active" as const },
];
...
export default function ItBusinessMgmtSnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IT Business Mgmt (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IT Business Mgmt (SNOW)</p>
                    </div>
                </div>
