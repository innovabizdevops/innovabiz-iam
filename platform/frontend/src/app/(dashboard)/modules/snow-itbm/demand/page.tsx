...
const PAGE = "Demand";
const KPIS = [{"l":"Total Snow Itbm","v":"8.640","t":"+16.7%","d":"up"},{"l":"Demand Ativos","v":"7.798","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"59","t":"+4.5%","d":"up"}];
const COLS = ["ID","Demand","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itbm #001","Snow Itbm #002","6.029","3.346","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itbm #002","Snow Itbm #003","3.999","2.022","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itbm #003","Snow Itbm #004","8.704","4.024","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itbm #004","Snow Itbm #005","1.615","4.552","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itbm #005","Snow Itbm #001","5.903","7.011","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":431},{"label":"Mar","value":649},{"label":"Abr","value":705},{"label":"Mai","value":579},{"label":"Jun","value":425},{"label":"Jul","value":573},{"label":"Ago","value":458},{"label":"Set","value":555},{"label":"Out","value":519},{"label":"Nov","value":677},{"label":"Dez","value":460}];
const MX = 705;
