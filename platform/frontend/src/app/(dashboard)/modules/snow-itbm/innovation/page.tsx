...
const KPIS = [{"l":"Ideias Submetidas","v":"4.758","t":"+2.4%","d":"up"},{"l":"Patentes (YTD)","v":"1.764","t":"+16.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"1.638","t":"+10.0%","d":"up"},{"l":"Budget I&D (€M)","v":"€10.0M","t":"-5.5%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","240","82.9%","7.960","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.481","74.7%","6.621","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.028","85.1%","8.786","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.782","99.6%","2.632","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.452","89.8%","2.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":492},{"label":"Mar","value":519},{"label":"Abr","value":614},{"label":"Mai","value":674},{"label":"Jun","value":599},{"label":"Jul","value":461},{"label":"Ago","value":408},{"label":"Set","value":516},{"label":"Out","value":594},{"label":"Nov","value":423},{"label":"Dez","value":427}];
const MX = 674;
