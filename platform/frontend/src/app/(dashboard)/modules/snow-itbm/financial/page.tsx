...
const ACCENT = "#81b5a1";
const MODULE = "IT Business Mgmt (SNOW)";
const PAGE = "Financial";
const KPIS = [{"l":"Total Snow Itbm","v":"2.803","t":"+1.3%","d":"up"},{"l":"Financial Ativos","v":"7.505","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.0%","d":"up"}];
const COLS = ["ID","Financial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snow Itbm #001","Snow Itbm #002","5.160","3.780","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Snow Itbm #002","Snow Itbm #003","6.521","4.884","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Snow Itbm #003","Snow Itbm #004","2.349","1.947","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Snow Itbm #004","Snow Itbm #005","2.986","9.009","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snow Itbm #005","Snow Itbm #001","7.542","6.027","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":893},{"label":"Mar","value":807},{"label":"Abr","value":831},{"label":"Mai","value":567},{"label":"Jun","value":754},{"label":"Jul","value":600},{"label":"Ago","value":887},{"label":"Set","value":816},{"label":"Out","value":590},{"label":"Nov","value":693},{"label":"Dez","value":709}];
const MX = 893;
