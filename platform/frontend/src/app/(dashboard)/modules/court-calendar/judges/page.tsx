...
const PAGE = "Judge Assign";
const KPIS = [{"l":"Total Court Calendar","v":"1.353","t":"+4.3%","d":"up"},{"l":"Judge Assign Ativos","v":"5.343","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.5%","d":"down"}];
const COLS = ["ID","Judge Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Court Calendar #001","Court Calendar #002","1.294","3.162","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Court Calendar #002","Court Calendar #003","6.142","2.648","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Court Calendar #003","Court Calendar #004","6.512","5.756","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Court Calendar #004","Court Calendar #005","6.874","5.269","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Court Calendar #005","Court Calendar #001","3.594","2.356","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":508},{"label":"Mar","value":392},{"label":"Abr","value":232},{"label":"Mai","value":210},{"label":"Jun","value":396},{"label":"Jul","value":314},{"label":"Ago","value":465},{"label":"Set","value":542},{"label":"Out","value":437},{"label":"Nov","value":532},{"label":"Dez","value":348}];
const MX = 542;
