...
const PAGE = "Respond";
const KPIS = [{"l":"Total Product Review","v":"4.177","t":"+17.5%","d":"up"},{"l":"Respond Ativos","v":"3.555","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"84","t":"+3.5%","d":"up"}];
const COLS = ["ID","Respond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Review #001","Product Review #002","2.830","7.130","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Product Review #002","Product Review #003","7.937","4.512","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Review #003","Product Review #004","4.703","6.110","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Product Review #004","Product Review #005","5.714","1.249","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Review #005","Product Review #001","4.756","8.308","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":596},{"label":"Mar","value":763},{"label":"Abr","value":659},{"label":"Mai","value":747},{"label":"Jun","value":800},{"label":"Jul","value":524},{"label":"Ago","value":685},{"label":"Set","value":624},{"label":"Out","value":685},{"label":"Nov","value":633},{"label":"Dez","value":508}];
const MX = 800;
