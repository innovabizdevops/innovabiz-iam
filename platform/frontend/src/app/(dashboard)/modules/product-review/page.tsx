...
/* ═══ Product Review Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3649", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2583", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€63K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1880845149", cells: ["PRO-8149", "Product Review Platform Item 1", "2/10/2026", "€45 249"], status: "active" as const },
    { id: "1880848720", cells: ["PRO-2720", "Product Review Platform Item 2", "17/5/2026", "€48 820"], status: "pending" as const },
    { id: "1880852291", cells: ["PRO-6291", "Product Review Platform Item 3", "4/12/2026", "€2391"], status: "completed" as const },
    { id: "1880855862", cells: ["PRO-9862", "Product Review Platform Item 4", "19/7/2026", "€5962"], status: "warning" as const },
    { id: "1880859433", cells: ["PRO-4433", "Product Review Platform Item 5", "6/2/2026", "€9533"], status: "active" as const },
];
...
export default function ProductReviewPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Review Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Product Review Platform</p>
                    </div>
                </div>
