...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"643","t":"+16.0%","d":"up"},{"l":"Queries/Dia","v":"2509","t":"+4.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.733","t":"+6.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.202","t":"+2.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","703","2026-01-24","4.512","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4800","2026-03-05","2.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","462","2026-02-06","6.289","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4714","2026-03-14","7.985","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4937","2026-01-04","1.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":630},{"label":"Mar","value":699},{"label":"Abr","value":374},{"label":"Mai","value":487},{"label":"Jun","value":586},{"label":"Jul","value":391},{"label":"Ago","value":594},{"label":"Set","value":528},{"label":"Out","value":440},{"label":"Nov","value":344},{"label":"Dez","value":346}];
const MX = 699;
