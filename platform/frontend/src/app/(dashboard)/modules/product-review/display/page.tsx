...
const PAGE = "Display";
const KPIS = [{"l":"Total Product Review","v":"4.809","t":"-1.0%","d":"down"},{"l":"Display Ativos","v":"1.431","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+9.9%","d":"up"}];
const COLS = ["ID","Display","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Review #001","Product Review #002","7.833","6.641","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Product Review #002","Product Review #003","3.946","7.283","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Review #003","Product Review #004","3.136","7.267","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Product Review #004","Product Review #005","1.187","5.634","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Review #005","Product Review #001","2.245","1.023","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":679},{"label":"Mar","value":985},{"label":"Abr","value":850},{"label":"Mai","value":615},{"label":"Jun","value":823},{"label":"Jul","value":852},{"label":"Ago","value":786},{"label":"Set","value":636},{"label":"Out","value":724},{"label":"Nov","value":670},{"label":"Dez","value":842}];
const MX = 985;
