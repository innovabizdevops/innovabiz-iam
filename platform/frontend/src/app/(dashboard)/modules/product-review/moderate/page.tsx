...
const ACCENT = "#be185d";
const MODULE = "Product Review Platform";
const PAGE = "Moderate";
const KPIS = [{"l":"Total Product Review","v":"8.468","t":"+16.9%","d":"up"},{"l":"Moderate Ativos","v":"8.539","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+8.5%","d":"up"}];
const COLS = ["ID","Moderate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Review #001","Product Review #002","4.823","7.976","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Product Review #002","Product Review #003","4.598","2.068","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Review #003","Product Review #004","7.212","2.993","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Product Review #004","Product Review #005","2.229","8.014","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Review #005","Product Review #001","8.845","1.128","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":515},{"label":"Mar","value":460},{"label":"Abr","value":491},{"label":"Mai","value":524},{"label":"Jun","value":484},{"label":"Jul","value":400},{"label":"Ago","value":552},{"label":"Set","value":584},{"label":"Out","value":242},{"label":"Nov","value":361},{"label":"Dez","value":461}];
const MX = 584;
