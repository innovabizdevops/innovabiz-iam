...
const PAGE = "Fire";
const KPIS = [{"l":"Projetos Melhoria","v":"7.860","t":"+5.6%","d":"up"},{"l":"Savings (€)","v":"€20607","t":"+12.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.6%","t":"+10.4%","d":"up"},{"l":"Ciclos PDCA","v":"8.911","t":"-1.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.526","€ 34812.40","5.404","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.153","€ 43838.89","4.474","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.189","€ 37274.26","449","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.938","€ 10900.65","3.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.494","€ 5120.37","6.443","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":365},{"label":"Mar","value":401},{"label":"Abr","value":475},{"label":"Mai","value":531},{"label":"Jun","value":621},{"label":"Jul","value":500},{"label":"Ago","value":632},{"label":"Set","value":557},{"label":"Out","value":607},{"label":"Nov","value":383},{"label":"Dez","value":670}];
const MX = 670;
