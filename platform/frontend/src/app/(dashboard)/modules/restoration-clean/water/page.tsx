...
const PAGE = "Water";
const KPIS = [{"l":"Projetos Melhoria","v":"2.081","t":"+0.2%","d":"up"},{"l":"Savings (€)","v":"€67035","t":"+16.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"65.3%","t":"+13.0%","d":"up"},{"l":"Ciclos PDCA","v":"6.216","t":"+16.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.424","€ 27128.55","1.711","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.112","€ 1215.48","3.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.289","€ 13160.39","7.550","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.596","€ 32796.18","5.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.032","€ 47632.81","730","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":361},{"label":"Mar","value":623},{"label":"Abr","value":518},{"label":"Mai","value":401},{"label":"Jun","value":339},{"label":"Jul","value":447},{"label":"Ago","value":613},{"label":"Set","value":402},{"label":"Out","value":364},{"label":"Nov","value":463},{"label":"Dez","value":286}];
const MX = 623;
