...
const ACCENT = "#164e63";
const MODULE = "Restoration Cleaning";
const PAGE = "Billing";
const KPIS = [{"l":"Projetos Melhoria","v":"3.350","t":"-3.7%","d":"down"},{"l":"Savings (€)","v":"€34865","t":"+16.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"79.5%","t":"-5.7%","d":"down"},{"l":"Ciclos PDCA","v":"1.623","t":"+8.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.191","€ 3480.14","458","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.958","€ 1546.08","8.579","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.352","€ 15081.31","8.444","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.992","€ 31614.41","4.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.938","€ 23853.51","7.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":727},{"label":"Mar","value":1002},{"label":"Abr","value":768},{"label":"Mai","value":1005},{"label":"Jun","value":858},{"label":"Jul","value":901},{"label":"Ago","value":697},{"label":"Set","value":718},{"label":"Out","value":904},{"label":"Nov","value":843},{"label":"Dez","value":937}];
const MX = 1005;
