...
const PAGE = "Assess";
const KPIS = [{"l":"Projetos Melhoria","v":"6.763","t":"-2.5%","d":"down"},{"l":"Savings (€)","v":"€39532","t":"+12.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.4%","t":"+16.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.820","t":"+17.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.761","€ 8265.55","7.390","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.277","€ 26786.14","8.604","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.032","€ 17628.06","8.003","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.223","€ 28802.56","8.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.529","€ 4060.02","4.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":710},{"label":"Mar","value":775},{"label":"Abr","value":499},{"label":"Mai","value":412},{"label":"Jun","value":708},{"label":"Jul","value":571},{"label":"Ago","value":532},{"label":"Set","value":781},{"label":"Out","value":648},{"label":"Nov","value":765},{"label":"Dez","value":633}];
const MX = 781;
