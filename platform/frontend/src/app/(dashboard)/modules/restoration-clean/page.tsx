...
/* ═══ Restoration Cleaning — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "9007", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3188", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€327K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1192038207", cells: ["RES-7207", "Restoration Cleaning Item 1", "4/4/2026", "€38 307"], status: "active" as const },
    { id: "1192041778", cells: ["RES-1778", "Restoration Cleaning Item 2", "19/11/2026", "€41 878"], status: "pending" as const },
    { id: "1192045349", cells: ["RES-5349", "Restoration Cleaning Item 3", "6/6/2026", "€45 449"], status: "completed" as const },
    { id: "1192048920", cells: ["RES-8920", "Restoration Cleaning Item 4", "21/1/2026", "€49 020"], status: "warning" as const },
    { id: "1192052491", cells: ["RES-3491", "Restoration Cleaning Item 5", "8/8/2026", "€2591"], status: "active" as const },
];
...
export default function RestorationCleaningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Restoration Cleaning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Restoration Cleaning</p>
                    </div>
                </div>
