...
const PAGE = "Mold";
const KPIS = [{"l":"Projetos Melhoria","v":"4.643","t":"-1.9%","d":"down"},{"l":"Savings (€)","v":"€49160","t":"-4.0%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.5%","t":"+8.7%","d":"up"},{"l":"Ciclos PDCA","v":"4.855","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","976","€ 2973.49","8.645","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.608","€ 16453.19","2.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.025","€ 37808.75","7.597","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.414","€ 33239.74","2.626","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.244","€ 20153.34","4.004","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":832},{"label":"Mar","value":809},{"label":"Abr","value":883},{"label":"Mai","value":573},{"label":"Jun","value":605},{"label":"Jul","value":507},{"label":"Ago","value":650},{"label":"Set","value":865},{"label":"Out","value":865},{"label":"Nov","value":693},{"label":"Dez","value":893}];
const MX = 893;
