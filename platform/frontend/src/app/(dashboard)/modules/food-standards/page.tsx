...
/* ═══ Food Standards Agency — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "214", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3268", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€138K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1897681614", cells: ["FOO-5614", "Food Standards Agency Item 1", "11/7/2026", "€31 714"], status: "active" as const },
    { id: "1897685185", cells: ["FOO-9185", "Food Standards Agency Item 2", "26/2/2026", "€35 285"], status: "pending" as const },
    { id: "1897688756", cells: ["FOO-3756", "Food Standards Agency Item 3", "13/9/2026", "€38 856"], status: "completed" as const },
    { id: "1897692327", cells: ["FOO-7327", "Food Standards Agency Item 4", "28/4/2026", "€42 427"], status: "warning" as const },
    { id: "1897695898", cells: ["FOO-1898", "Food Standards Agency Item 5", "15/11/2026", "€45 998"], status: "active" as const },
];
...
export default function FoodStandardsAgencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Standards Agency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Standards Agency</p>
                    </div>
                </div>
