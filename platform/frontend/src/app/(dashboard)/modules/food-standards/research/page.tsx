...
const ACCENT = "#059669";
const MODULE = "Food Standards Agency";
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"3.995","t":"+1.9%","d":"up"},{"l":"Patentes (YTD)","v":"3.092","t":"-2.5%","d":"down"},{"l":"Projetos Innovation Lab","v":"1.017","t":"+10.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€36.9M","t":"+5.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.205","83.4%","2.775","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.236","82.8%","2.379","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","111","74.6%","550","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","7.801","71.7%","281","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.409","86.1%","6.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":584},{"label":"Mar","value":727},{"label":"Abr","value":684},{"label":"Mai","value":796},{"label":"Jun","value":929},{"label":"Jul","value":959},{"label":"Ago","value":713},{"label":"Set","value":972},{"label":"Out","value":835},{"label":"Nov","value":800},{"label":"Dez","value":788}];
const MX = 972;
