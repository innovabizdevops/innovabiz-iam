...
const ACCENT = "#6366f1";
const MODULE = "Military Comms";
const PAGE = "EW Protect";
const KPIS = [{"l":"Total Military Comms","v":"2.707","t":"+6.2%","d":"up"},{"l":"EW Protect Ativos","v":"8.389","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"76","t":"-3.3%","d":"down"}];
const COLS = ["ID","EW Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Military Comms #001","Military Comms #002","4.883","7.530","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Military Comms #002","Military Comms #003","4.827","3.848","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Military Comms #003","Military Comms #004","5.450","4.185","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Military Comms #004","Military Comms #005","6.030","7.816","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Military Comms #005","Military Comms #001","3.708","5.808","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":853},{"label":"Mar","value":931},{"label":"Abr","value":670},{"label":"Mai","value":986},{"label":"Jun","value":1001},{"label":"Jul","value":1004},{"label":"Ago","value":809},{"label":"Set","value":967},{"label":"Out","value":727},{"label":"Nov","value":917},{"label":"Dez","value":904}];
const MX = 1004;
...
export default function EwprotectPage() {
    return (
