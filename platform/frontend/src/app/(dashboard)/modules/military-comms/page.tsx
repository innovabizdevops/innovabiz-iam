...
export default function MilitaryCommsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Military Comms</h1><p className="text-sm text-muted-foreground">Military Comms • iBOS Enterprise</p></div>
