...
const ACCENT = "#b45309";
const MODULE = "Chaos Engineering";
const PAGE = "CPU Stress";
const KPIS = [{"l":"Total Chaos Engineering","v":"6.827","t":"-4.5%","d":"down"},{"l":"CPU Stress Ativos","v":"8.204","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"94.8%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"82","t":"+11.0%","d":"up"}];
const COLS = ["ID","CPU Stress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chaos Engineering #001","Chaos Engineering #002","3.109","1.925","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Chaos Engineering #002","Chaos Engineering #003","2.634","6.663","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Chaos Engineering #003","Chaos Engineering #004","740","2.666","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Chaos Engineering #004","Chaos Engineering #005","8.502","8.743","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chaos Engineering #005","Chaos Engineering #001","302","1.987","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":329},{"label":"Mar","value":395},{"label":"Abr","value":383},{"label":"Mai","value":407},{"label":"Jun","value":599},{"label":"Jul","value":495},{"label":"Ago","value":532},{"label":"Set","value":542},{"label":"Out","value":560},{"label":"Nov","value":377},{"label":"Dez","value":463}];
const MX = 599;
...
export default function CpuStressPage() {
    return (
