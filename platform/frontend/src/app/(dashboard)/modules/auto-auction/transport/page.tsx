...
const KPIS = [{"l":"Atletas Registados","v":"3.239","t":"+17.8%","d":"up"},{"l":"Treinos/Semana","v":"1483","t":"-5.6%","d":"down"},{"l":"Competições","v":"8.329","t":"+17.9%","d":"up"},{"l":"Performance Score","v":"75","t":"-2.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.846","8.979","8.083","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.925","6.621","8.935","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.236","6.416","4.876","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.830","4.502","4.210","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","575","4.510","1.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":595},{"label":"Mar","value":663},{"label":"Abr","value":683},{"label":"Mai","value":717},{"label":"Jun","value":721},{"label":"Jul","value":590},{"label":"Ago","value":696},{"label":"Set","value":562},{"label":"Out","value":427},{"label":"Nov","value":532},{"label":"Dez","value":678}];
const MX = 721;
