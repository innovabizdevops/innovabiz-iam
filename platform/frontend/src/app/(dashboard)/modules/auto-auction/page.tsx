...
/* ═══ Auto Auction — Dashboard ═══ */

const ACCENT = "#854d0e";

const KPIS = [
    { label: "Total Registos", value: "6860", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4966", trend: "-5%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€93K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2025734860", cells: ["AUT-6860", "Auto Auction Item 1", "17/5/2026", "€34 960"], status: "active" as const },
    { id: "2025738431", cells: ["AUT-1431", "Auto Auction Item 2", "4/12/2026", "€38 531"], status: "pending" as const },
    { id: "2025742002", cells: ["AUT-5002", "Auto Auction Item 3", "19/7/2026", "€42 102"], status: "completed" as const },
    { id: "2025745573", cells: ["AUT-8573", "Auto Auction Item 4", "6/2/2026", "€45 673"], status: "warning" as const },
    { id: "2025749144", cells: ["AUT-3144", "Auto Auction Item 5", "21/9/2026", "€49 244"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Auction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Auction</p>
                    </div>
                </div>
