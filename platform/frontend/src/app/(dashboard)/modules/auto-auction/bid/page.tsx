...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"5.233","t":"+0.8%","d":"up"},{"l":"Contratos (€M)","v":"€37.5M","t":"+18.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.2%","t":"+4.0%","d":"up"},{"l":"Score Médio","v":"80","t":"+4.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","84.5%","€ 13939.72","6.425","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.7%","€ 27021.70","3.017","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.0%","€ 38198.14","7.639","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.9%","€ 38459.27","6.747","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","88.9%","€ 43868.85","7.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":504},{"label":"Mar","value":493},{"label":"Abr","value":648},{"label":"Mai","value":712},{"label":"Jun","value":498},{"label":"Jul","value":414},{"label":"Ago","value":514},{"label":"Set","value":469},{"label":"Out","value":500},{"label":"Nov","value":801},{"label":"Dez","value":513}];
const MX = 801;
