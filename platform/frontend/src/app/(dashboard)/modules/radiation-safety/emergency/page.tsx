...
const PAGE = "Emergency";
const KPIS = [{"l":"Total Radiation Safety","v":"1.634","t":"-4.5%","d":"down"},{"l":"Emergency Ativos","v":"851","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+1.4%","d":"up"}];
const COLS = ["ID","Emergency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiation Safety #001","Radiation Safety #002","5.004","5.086","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Radiation Safety #002","Radiation Safety #003","4.311","2.953","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiation Safety #003","Radiation Safety #004","3.603","5.697","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Radiation Safety #004","Radiation Safety #005","7.944","7.691","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiation Safety #005","Radiation Safety #001","3.547","5.395","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":609},{"label":"Mar","value":879},{"label":"Abr","value":791},{"label":"Mai","value":804},{"label":"Jun","value":810},{"label":"Jul","value":593},{"label":"Ago","value":702},{"label":"Set","value":762},{"label":"Out","value":673},{"label":"Nov","value":558},{"label":"Dez","value":697}];
const MX = 879;
