...
/* ═══ Radiation Safety Authority — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "4775", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4017", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€136K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "939098875", cells: ["RAD-3875", "Radiation Safety Authority Item 1", "16/8/2026", "€48 975"], status: "active" as const },
    { id: "939102446", cells: ["RAD-7446", "Radiation Safety Authority Item 2", "3/3/2026", "€2546"], status: "pending" as const },
    { id: "939106017", cells: ["RAD-2017", "Radiation Safety Authority Item 3", "18/10/2026", "€6117"], status: "completed" as const },
    { id: "939109588", cells: ["RAD-5588", "Radiation Safety Authority Item 4", "5/5/2026", "€9688"], status: "warning" as const },
    { id: "939113159", cells: ["RAD-9159", "Radiation Safety Authority Item 5", "20/12/2026", "€13 259"], status: "active" as const },
];
...
export default function RadiationSafetyAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Radiation Safety Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Radiation Safety Authority</p>
                    </div>
                </div>
