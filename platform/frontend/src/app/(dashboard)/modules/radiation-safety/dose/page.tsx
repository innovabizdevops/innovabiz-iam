...
const PAGE = "Dose Track";
const KPIS = [{"l":"Total Radiation Safety","v":"1.999","t":"+17.9%","d":"up"},{"l":"Dose Track Ativos","v":"8.265","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"68","t":"+3.6%","d":"up"}];
const COLS = ["ID","Dose Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiation Safety #001","Radiation Safety #002","7.719","4.001","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Radiation Safety #002","Radiation Safety #003","392","6.343","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiation Safety #003","Radiation Safety #004","7.887","3.344","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Radiation Safety #004","Radiation Safety #005","646","3.890","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiation Safety #005","Radiation Safety #001","1.450","6.394","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":707},{"label":"Mar","value":711},{"label":"Abr","value":993},{"label":"Mai","value":882},{"label":"Jun","value":1028},{"label":"Jul","value":728},{"label":"Ago","value":1035},{"label":"Set","value":760},{"label":"Out","value":1055},{"label":"Nov","value":867},{"label":"Dez","value":978}];
const MX = 1055;
