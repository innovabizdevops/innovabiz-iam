...
const ACCENT = "#f59e0b";
const MODULE = "Radiation Safety Authority";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Radiation Safety","v":"3.581","t":"-3.3%","d":"down"},{"l":"Monitor Ativos","v":"2.367","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"83","t":"-3.3%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Radiation Safety #001","Radiation Safety #002","2.055","7.074","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Radiation Safety #002","Radiation Safety #003","8.477","3.521","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Radiation Safety #003","Radiation Safety #004","7.680","6.697","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Radiation Safety #004","Radiation Safety #005","7.630","5.115","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Radiation Safety #005","Radiation Safety #001","2.916","6.567","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":872},{"label":"Mar","value":806},{"label":"Abr","value":778},{"label":"Mai","value":582},{"label":"Jun","value":832},{"label":"Jul","value":515},{"label":"Ago","value":683},{"label":"Set","value":592},{"label":"Out","value":736},{"label":"Nov","value":632},{"label":"Dez","value":679}];
const MX = 872;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>IoT</span></h1>
                </div>
