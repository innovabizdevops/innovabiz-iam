...
const ACCENT = "#9f1239";
const MODULE = "Hospital Operations";
const PAGE = "OR Schedule";
const KPIS = [{"l":"Total Hospital Ops","v":"5.853","t":"+17.7%","d":"up"},{"l":"OR Schedule Ativos","v":"8.703","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.9%","d":"up"}];
const COLS = ["ID","OR Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospital Ops #001","Hospital Ops #002","7.651","8.471","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Hospital Ops #002","Hospital Ops #003","1.085","1.918","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospital Ops #003","Hospital Ops #004","3.329","7.706","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Hospital Ops #004","Hospital Ops #005","5.278","2.430","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospital Ops #005","Hospital Ops #001","7.535","1.694","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":665},{"label":"Mar","value":736},{"label":"Abr","value":452},{"label":"Mai","value":472},{"label":"Jun","value":637},{"label":"Jul","value":445},{"label":"Ago","value":765},{"label":"Set","value":791},{"label":"Out","value":638},{"label":"Nov","value":530},{"label":"Dez","value":423}];
const MX = 791;
