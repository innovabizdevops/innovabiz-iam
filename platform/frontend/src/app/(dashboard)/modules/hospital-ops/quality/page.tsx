...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.403","t":"+8.2%","d":"up"},{"l":"NC Abertas","v":"3.579","t":"+10.1%","d":"up"},{"l":"Conformidade (%)","v":"92.3%","t":"-4.8%","d":"down"},{"l":"CAPAs Pendentes","v":"7.615","t":"+14.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.508","89.4%","7.385","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.835","97.2%","6.933","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.840","80.4%","5.364","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.611","81.3%","7.971","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.645","74.7%","464","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":467},{"label":"Mar","value":388},{"label":"Abr","value":606},{"label":"Mai","value":340},{"label":"Jun","value":606},{"label":"Jul","value":337},{"label":"Ago","value":313},{"label":"Set","value":392},{"label":"Out","value":411},{"label":"Nov","value":637},{"label":"Dez","value":479}];
const MX = 645;
