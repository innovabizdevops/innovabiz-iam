...
const KPIS = [
    { label: "Total Registos", value: "5554", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3458", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€189K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1001350854", cells: ["HOS-2854", "Hospital Operations Item 1", "15/7/2026", "€954"], status: "active" as const },
    { id: "1001354425", cells: ["HOS-6425", "Hospital Operations Item 2", "2/2/2026", "€4525"], status: "pending" as const },
    { id: "1001357996", cells: ["HOS-9996", "Hospital Operations Item 3", "17/9/2026", "€8096"], status: "completed" as const },
    { id: "1001361567", cells: ["HOS-4567", "Hospital Operations Item 4", "4/4/2026", "€11 667"], status: "warning" as const },
    { id: "1001365138", cells: ["HOS-8138", "Hospital Operations Item 5", "19/11/2026", "€15 238"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hospital Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hospital Operations</p>
                    </div>
                </div>
