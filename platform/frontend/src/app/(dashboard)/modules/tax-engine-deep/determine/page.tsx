...
const PAGE = "Determine";
const KPIS = [{"l":"Riscos Identificados","v":"8.925","t":"+13.8%","d":"up"},{"l":"Mitigações Ativas","v":"5.011","t":"+1.5%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+8.5%","d":"up"},{"l":"Incidentes YTD","v":"1.072","t":"-4.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.388","6.433","7.551","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.696","4.631","1.231","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.106","5.822","6.170","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.134","7.849","7.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.902","521","1.660","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":830},{"label":"Fev","value":540},{"label":"Mar","value":602},{"label":"Abr","value":886},{"label":"Mai","value":794},{"label":"Jun","value":536},{"label":"Jul","value":858},{"label":"Ago","value":622},{"label":"Set","value":668},{"label":"Out","value":881},{"label":"Nov","value":873},{"label":"Dez","value":822}];
const MX = 886;
