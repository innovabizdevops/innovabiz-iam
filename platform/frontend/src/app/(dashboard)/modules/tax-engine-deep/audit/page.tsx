...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.160","t":"+2.6%","d":"up"},{"l":"NC Abertas","v":"1.944","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"67.7%","t":"+1.5%","d":"up"},{"l":"CAPAs Pendentes","v":"6.998","t":"+7.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.479","92.8%","7.610","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.648","85.2%","7.609","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.968","91.2%","5.409","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.890","87.2%","8.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.362","76.5%","4.727","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":885},{"label":"Mar","value":652},{"label":"Abr","value":783},{"label":"Mai","value":731},{"label":"Jun","value":927},{"label":"Jul","value":865},{"label":"Ago","value":787},{"label":"Set","value":660},{"label":"Out","value":891},{"label":"Nov","value":752},{"label":"Dez","value":706}];
const MX = 927;
