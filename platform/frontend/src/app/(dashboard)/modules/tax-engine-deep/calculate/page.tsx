...
const ACCENT = "#0d9488";
const MODULE = "Tax Engine Deep (Multi-Jur)";
const PAGE = "Calculate";
const KPIS = [{"l":"Total Tax Engine Deep","v":"7.689","t":"-0.1%","d":"down"},{"l":"Calculate Ativos","v":"2.538","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"55","t":"-0.2%","d":"down"}];
const COLS = ["ID","Calculate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tax Engine Deep #001","Tax Engine Deep #002","3.915","5.936","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Tax Engine Deep #002","Tax Engine Deep #003","636","460","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Tax Engine Deep #003","Tax Engine Deep #004","6.696","5.750","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Tax Engine Deep #004","Tax Engine Deep #005","4.285","4.281","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tax Engine Deep #005","Tax Engine Deep #001","5.395","3.005","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":511},{"label":"Mar","value":428},{"label":"Abr","value":430},{"label":"Mai","value":620},{"label":"Jun","value":490},{"label":"Jul","value":436},{"label":"Ago","value":631},{"label":"Set","value":358},{"label":"Out","value":605},{"label":"Nov","value":325},{"label":"Dez","value":334}];
const MX = 631;
