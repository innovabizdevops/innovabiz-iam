...
/* ═══ Tax Engine Deep (Multi-Jur) — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "4352", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1637", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€63K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "855898852", cells: ["TAX-8852", "Tax Engine Deep (Multi-Jur) Item 1", "5/5/2026", "€48 952"], status: "active" as const },
    { id: "855902423", cells: ["TAX-3423", "Tax Engine Deep (Multi-Jur) Item 2", "20/12/2026", "€2523"], status: "pending" as const },
    { id: "855905994", cells: ["TAX-6994", "Tax Engine Deep (Multi-Jur) Item 3", "7/7/2026", "€6094"], status: "completed" as const },
    { id: "855909565", cells: ["TAX-1565", "Tax Engine Deep (Multi-Jur) Item 4", "22/2/2026", "€9665"], status: "warning" as const },
    { id: "855913136", cells: ["TAX-5136", "Tax Engine Deep (Multi-Jur) Item 5", "9/9/2026", "€13 236"], status: "active" as const },
];
...
export default function TaxEngineDeepMultijurPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tax Engine Deep (Multi-Jur)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tax Engine Deep (Multi-Jur)</p>
                    </div>
                </div>
