...
const ACCENT = "#ec4899";
const MODULE = "Help Desk";
const PAGE = "Auto-Route";
const KPIS = [{"l":"Artigos Publicados","v":"8.663","t":"+0.3%","d":"up"},{"l":"Views/Semana","v":"3225","t":"-1.3%","d":"down"},{"l":"Feedback Útil (%)","v":"65.9%","t":"+0.3%","d":"up"},{"l":"Artigos Desatualizados","v":"8.297","t":"+16.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.825","89.2%","5.270","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.016","75.8%","1.985","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","3.603","76.5%","5.145","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.261","80.6%","1.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.936","81.7%","6.450","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":675},{"label":"Mar","value":560},{"label":"Abr","value":805},{"label":"Mai","value":762},{"label":"Jun","value":715},{"label":"Jul","value":533},{"label":"Ago","value":739},{"label":"Set","value":514},{"label":"Out","value":686},{"label":"Nov","value":536},{"label":"Dez","value":803}];
const MX = 805;
