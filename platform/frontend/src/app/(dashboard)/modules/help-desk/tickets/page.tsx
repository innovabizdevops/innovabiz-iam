...
const KPIS = [{"l":"Tickets Abertos","v":"2.834","t":"+6.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"82.8%","t":"+8.3%","d":"up"},{"l":"MTTR (h)","v":"24h","t":"+10.3%","d":"up"},{"l":"Satisfação (%)","v":"90.2%","t":"+7.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.076","7.474","9.096","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.438","6.780","6.967","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.328","2.199","7.975","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.260","7.986","1.542","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.411","8.249","6.171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":630},{"label":"Mar","value":628},{"label":"Abr","value":520},{"label":"Mai","value":527},{"label":"Jun","value":546},{"label":"Jul","value":822},{"label":"Ago","value":679},{"label":"Set","value":555},{"label":"Out","value":736},{"label":"Nov","value":755},{"label":"Dez","value":528}];
const MX = 822;
