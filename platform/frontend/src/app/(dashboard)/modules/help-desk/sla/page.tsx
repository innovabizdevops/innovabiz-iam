...
const KPIS = [{"l":"Tickets Abertos","v":"589","t":"+15.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.2%","t":"+11.3%","d":"up"},{"l":"MTTR (h)","v":"33h","t":"+5.4%","d":"up"},{"l":"Satisfação (%)","v":"73.8%","t":"+6.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.635","4.968","3.585","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.724","5.960","1.008","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.541","5.441","5.765","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","383","7.033","2.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.279","5.537","4.995","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":476},{"label":"Mar","value":489},{"label":"Abr","value":410},{"label":"Mai","value":677},{"label":"Jun","value":661},{"label":"Jul","value":670},{"label":"Ago","value":499},{"label":"Set","value":619},{"label":"Out","value":453},{"label":"Nov","value":643},{"label":"Dez","value":421}];
const MX = 677;
