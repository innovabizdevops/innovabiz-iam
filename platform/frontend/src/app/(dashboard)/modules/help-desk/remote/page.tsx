...
const KPIS = [{"l":"Tickets Abertos","v":"2.601","t":"+6.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.3%","t":"+1.7%","d":"up"},{"l":"MTTR (h)","v":"47h","t":"+8.4%","d":"up"},{"l":"Satisfação (%)","v":"90.6%","t":"+0.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.467","4.216","4.322","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.188","8.720","953","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.712","1.153","2.921","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.537","172","5.392","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.215","8.257","8.027","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":767},{"label":"Mar","value":669},{"label":"Abr","value":728},{"label":"Mai","value":553},{"label":"Jun","value":609},{"label":"Jul","value":779},{"label":"Ago","value":942},{"label":"Set","value":771},{"label":"Out","value":631},{"label":"Nov","value":751},{"label":"Dez","value":853}];
const MX = 942;
