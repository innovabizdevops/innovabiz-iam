...
const PAGE = "Canned Response";
const KPIS = [{"l":"Artigos Publicados","v":"7.974","t":"+15.8%","d":"up"},{"l":"Views/Semana","v":"4301","t":"+9.8%","d":"up"},{"l":"Feedback Útil (%)","v":"86.0%","t":"+17.8%","d":"up"},{"l":"Artigos Desatualizados","v":"864","t":"-4.5%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","1.380","93.3%","3.055","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.495","89.8%","640","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","736","91.9%","2.918","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.628","81.9%","3.922","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.934","75.6%","4.541","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":725},{"label":"Mar","value":700},{"label":"Abr","value":551},{"label":"Mai","value":351},{"label":"Jun","value":706},{"label":"Jul","value":564},{"label":"Ago","value":550},{"label":"Set","value":643},{"label":"Out","value":566},{"label":"Nov","value":387},{"label":"Dez","value":615}];
const MX = 725;
