...
const KPIS = [{"l":"Artigos Publicados","v":"2.922","t":"-5.7%","d":"down"},{"l":"Views/Semana","v":"3936","t":"+15.2%","d":"up"},{"l":"Feedback Útil (%)","v":"73.7%","t":"+9.3%","d":"up"},{"l":"Artigos Desatualizados","v":"6.684","t":"+14.2%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.326","83.6%","7.274","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","6.969","93.3%","4.704","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","572","94.6%","3.550","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.954","94.2%","7.251","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","7.326","72.6%","5.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":850},{"label":"Mar","value":834},{"label":"Abr","value":824},{"label":"Mai","value":641},{"label":"Jun","value":757},{"label":"Jul","value":660},{"label":"Ago","value":916},{"label":"Set","value":938},{"label":"Out","value":710},{"label":"Nov","value":657},{"label":"Dez","value":703}];
const MX = 946;
