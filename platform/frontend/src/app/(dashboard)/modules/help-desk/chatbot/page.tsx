...
const PAGE = "Chat Bot";
const KPIS = [{"l":"Artigos Publicados","v":"1.162","t":"+10.0%","d":"up"},{"l":"Views/Semana","v":"4596","t":"+1.3%","d":"up"},{"l":"Feedback Útil (%)","v":"83.0%","t":"-1.1%","d":"down"},{"l":"Artigos Desatualizados","v":"6.116","t":"+15.0%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.802","98.9%","7.791","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","2.093","78.3%","518","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","3.784","97.4%","2.066","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","7.002","76.3%","3.989","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.509","83.3%","6.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":863},{"label":"Mar","value":1013},{"label":"Abr","value":913},{"label":"Mai","value":725},{"label":"Jun","value":887},{"label":"Jul","value":785},{"label":"Ago","value":1041},{"label":"Set","value":670},{"label":"Out","value":1000},{"label":"Nov","value":806},{"label":"Dez","value":957}];
const MX = 1041;
