...
const PAGE = "Apply";
const KPIS = [{"l":"Total Kosher Certify","v":"5.604","t":"+4.4%","d":"up"},{"l":"Apply Ativos","v":"5.818","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"78.6%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"77","t":"-4.6%","d":"down"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kosher Certify #001","Kosher Certify #002","1.061","854","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Kosher Certify #002","Kosher Certify #003","5.261","7.287","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Kosher Certify #003","Kosher Certify #004","8.251","4.930","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Kosher Certify #004","Kosher Certify #005","6.366","5.398","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kosher Certify #005","Kosher Certify #001","2.362","2.602","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":617},{"label":"Mar","value":868},{"label":"Abr","value":852},{"label":"Mai","value":847},{"label":"Jun","value":598},{"label":"Jul","value":705},{"label":"Ago","value":761},{"label":"Set","value":858},{"label":"Out","value":925},{"label":"Nov","value":700},{"label":"Dez","value":851}];
const MX = 925;
