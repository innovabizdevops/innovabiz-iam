...
/* ═══ Kosher Certification — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "3884", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1304", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€352K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1917673384", cells: ["KOS-8384", "Kosher Certification Item 1", "5/5/2026", "€23 484"], status: "active" as const },
    { id: "1917676955", cells: ["KOS-2955", "Kosher Certification Item 2", "20/12/2026", "€27 055"], status: "pending" as const },
    { id: "1917680526", cells: ["KOS-6526", "Kosher Certification Item 3", "7/7/2026", "€30 626"], status: "completed" as const },
    { id: "1917684097", cells: ["KOS-1097", "Kosher Certification Item 4", "22/2/2026", "€34 197"], status: "warning" as const },
    { id: "1917687668", cells: ["KOS-4668", "Kosher Certification Item 5", "9/9/2026", "€37 768"], status: "active" as const },
];
...
export default function KosherCertificationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Kosher Certification</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Kosher Certification</p>
                    </div>
                </div>
