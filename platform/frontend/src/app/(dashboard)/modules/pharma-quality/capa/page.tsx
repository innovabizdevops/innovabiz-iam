...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.242","t":"-5.2%","d":"down"},{"l":"NC Abertas","v":"4.042","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"81.5%","t":"-5.6%","d":"down"},{"l":"CAPAs Pendentes","v":"2.891","t":"+3.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.734","95.1%","7.000","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","237","73.9%","7.388","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.882","98.8%","5.363","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.423","97.1%","5.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.549","77.1%","2.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":698},{"label":"Mar","value":784},{"label":"Abr","value":696},{"label":"Mai","value":541},{"label":"Jun","value":609},{"label":"Jul","value":811},{"label":"Ago","value":750},{"label":"Set","value":801},{"label":"Out","value":886},{"label":"Nov","value":777},{"label":"Dez","value":672}];
const MX = 886;
