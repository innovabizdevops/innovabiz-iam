...
const ACCENT = "#7c3aed";
const MODULE = "Pharma Quality";
const PAGE = "Stability";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.419","t":"+15.5%","d":"up"},{"l":"NC Abertas","v":"3.695","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"76.7%","t":"+4.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.989","t":"+0.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.362","92.8%","2.236","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.351","91.5%","4.442","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.353","76.3%","4.126","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.515","72.0%","3.810","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.532","77.1%","209","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":670},{"label":"Mar","value":724},{"label":"Abr","value":879},{"label":"Mai","value":852},{"label":"Jun","value":720},{"label":"Jul","value":671},{"label":"Ago","value":802},{"label":"Set","value":635},{"label":"Out","value":624},{"label":"Nov","value":651},{"label":"Dez","value":1005}];
const MX = 1005;
