...
/* ═══ Pharma Quality — Dashboard ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total Registos", value: "7210", trend: "-11%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3288", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€452K", trend: "+24%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "145844010", cells: ["PHA-9010", "Pharma Quality Item 1", "19/7/2026", "€44 110"], status: "active" as const },
    { id: "145847581", cells: ["PHA-3581", "Pharma Quality Item 2", "6/2/2026", "€47 681"], status: "pending" as const },
    { id: "145851152", cells: ["PHA-7152", "Pharma Quality Item 3", "21/9/2026", "€1252"], status: "completed" as const },
    { id: "145854723", cells: ["PHA-1723", "Pharma Quality Item 4", "8/4/2026", "€4823"], status: "warning" as const },
    { id: "145858294", cells: ["PHA-5294", "Pharma Quality Item 5", "23/11/2026", "€8394"], status: "active" as const },
];
...
export default function PharmaQualityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Quality</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Quality</p>
                    </div>
                </div>
