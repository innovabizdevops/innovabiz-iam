...
const PAGE = "OOS";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.286","t":"-0.2%","d":"down"},{"l":"NC Abertas","v":"5.042","t":"-3.3%","d":"down"},{"l":"Conformidade (%)","v":"73.2%","t":"+2.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.769","t":"+3.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.051","89.7%","1.609","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.726","95.2%","8.451","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.032","79.4%","8.615","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.295","93.0%","4.584","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.005","71.3%","1.684","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1038},{"label":"Fev","value":759},{"label":"Mar","value":902},{"label":"Abr","value":805},{"label":"Mai","value":914},{"label":"Jun","value":1016},{"label":"Jul","value":980},{"label":"Ago","value":790},{"label":"Set","value":1062},{"label":"Out","value":813},{"label":"Nov","value":981},{"label":"Dez","value":762}];
const MX = 1062;
