...
const ACCENT = "#16a34a";
const MODULE = "Dance Studio";
const PAGE = "Student";
const KPIS = [{"l":"Total Dance Studio","v":"3.640","t":"-0.2%","d":"down"},{"l":"Student Ativos","v":"2.673","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"78","t":"+0.7%","d":"up"}];
const COLS = ["ID","Student","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dance Studio #001","Dance Studio #002","4.968","7.757","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Dance Studio #002","Dance Studio #003","6.845","642","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Dance Studio #003","Dance Studio #004","1.544","8.315","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Dance Studio #004","Dance Studio #005","8.452","8.483","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dance Studio #005","Dance Studio #001","8.280","5.071","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":699},{"label":"Mar","value":567},{"label":"Abr","value":367},{"label":"Mai","value":476},{"label":"Jun","value":681},{"label":"Jul","value":441},{"label":"Ago","value":633},{"label":"Set","value":718},{"label":"Out","value":566},{"label":"Nov","value":620},{"label":"Dez","value":488}];
const MX = 718;
