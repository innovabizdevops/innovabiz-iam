...
const PAGE = "Billing";
const KPIS = [{"l":"Total Dance Studio","v":"8.300","t":"-2.7%","d":"down"},{"l":"Billing Ativos","v":"423","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.1%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dance Studio #001","Dance Studio #002","3.519","1.033","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Dance Studio #002","Dance Studio #003","3.686","9.010","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Dance Studio #003","Dance Studio #004","2.379","8.998","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Dance Studio #004","Dance Studio #005","1.238","8.462","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dance Studio #005","Dance Studio #001","8.625","305","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":1018},{"label":"Mar","value":689},{"label":"Abr","value":653},{"label":"Mai","value":726},{"label":"Jun","value":827},{"label":"Jul","value":657},{"label":"Ago","value":775},{"label":"Set","value":759},{"label":"Out","value":717},{"label":"Nov","value":814},{"label":"Dez","value":797}];
const MX = 1018;
