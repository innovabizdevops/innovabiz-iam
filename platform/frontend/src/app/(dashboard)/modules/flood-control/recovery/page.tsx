...
const PAGE = "Recovery";
const KPIS = [{"l":"BCP Plans Ativos","v":"1.628","t":"+16.4%","d":"up"},{"l":"RTO Médio (h)","v":"136h","t":"+0.5%","d":"up"},{"l":"RPO Médio (h)","v":"46h","t":"+10.8%","d":"up"},{"l":"Testes DR (YTD)","v":"647","t":"+12.9%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","145h","209h","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","81h","197h","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","24h","149h","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","164h","112h","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","87h","186h","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":422},{"label":"Mar","value":623},{"label":"Abr","value":351},{"label":"Mai","value":366},{"label":"Jun","value":557},{"label":"Jul","value":432},{"label":"Ago","value":490},{"label":"Set","value":639},{"label":"Out","value":532},{"label":"Nov","value":545},{"label":"Dez","value":340}];
const MX = 639;
