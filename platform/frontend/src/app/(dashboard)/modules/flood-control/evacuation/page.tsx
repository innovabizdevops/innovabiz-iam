...
const KPIS = [{"l":"Total Flood Control","v":"2.374","t":"-4.2%","d":"down"},{"l":"Evacuation Ativos","v":"8.936","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+8.0%","d":"up"}];
const COLS = ["ID","Evacuation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Control #001","Flood Control #002","8.672","7.695","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Control #002","Flood Control #003","4.904","7.656","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Control #003","Flood Control #004","7.912","3.666","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Control #004","Flood Control #005","122","2.459","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Control #005","Flood Control #001","3.871","8.396","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":600},{"label":"Mar","value":713},{"label":"Abr","value":623},{"label":"Mai","value":449},{"label":"Jun","value":416},{"label":"Jul","value":746},{"label":"Ago","value":801},{"label":"Set","value":725},{"label":"Out","value":556},{"label":"Nov","value":583},{"label":"Dez","value":467}];
const MX = 803;
