...
const ACCENT = "#6366f1";
const MODULE = "Flood Control";
const PAGE = "Pump Station";
const KPIS = [{"l":"Total Flood Control","v":"4.266","t":"+3.9%","d":"up"},{"l":"Pump Station Ativos","v":"2.580","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.9%","d":"up"}];
const COLS = ["ID","Pump Station","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flood Control #001","Flood Control #002","2.261","8.920","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Flood Control #002","Flood Control #003","5.126","3.104","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Flood Control #003","Flood Control #004","3.567","7.069","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Flood Control #004","Flood Control #005","1.327","8.021","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flood Control #005","Flood Control #001","3.641","6.171","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":683},{"label":"Mar","value":867},{"label":"Abr","value":840},{"label":"Mai","value":981},{"label":"Jun","value":836},{"label":"Jul","value":755},{"label":"Ago","value":776},{"label":"Set","value":594},{"label":"Out","value":942},{"label":"Nov","value":980},{"label":"Dez","value":879}];
const MX = 981;
