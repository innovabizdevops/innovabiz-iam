...
const PAGE = "Air-Gap";
const KPIS = [{"l":"BCP Plans Ativos","v":"118","t":"+14.3%","d":"up"},{"l":"RTO Médio (h)","v":"182h","t":"-4.3%","d":"down"},{"l":"RPO Médio (h)","v":"32h","t":"+2.5%","d":"up"},{"l":"Testes DR (YTD)","v":"1.074","t":"-3.7%","d":"down"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","64h","112h","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","37h","70h","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","134h","179h","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","134h","74h","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","124h","52h","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":908},{"label":"Mar","value":805},{"label":"Abr","value":593},{"label":"Mai","value":597},{"label":"Jun","value":620},{"label":"Jul","value":982},{"label":"Ago","value":615},{"label":"Set","value":885},{"label":"Out","value":654},{"label":"Nov","value":801},{"label":"Dez","value":726}];
const MX = 982;
