...
const ACCENT = "#78350f";
const MODULE = "Backup & DR";
const PAGE = "Backup Policy";
const KPIS = [{"l":"BCP Plans Ativos","v":"2.040","t":"+9.4%","d":"up"},{"l":"RTO Médio (h)","v":"40h","t":"-4.3%","d":"down"},{"l":"RPO Médio (h)","v":"71h","t":"-4.0%","d":"down"},{"l":"Testes DR (YTD)","v":"2.720","t":"+8.4%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","57h","147h","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","43h","197h","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","64h","189h","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","51h","47h","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","137h","28h","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":725},{"label":"Mar","value":859},{"label":"Abr","value":619},{"label":"Mai","value":931},{"label":"Jun","value":870},{"label":"Jul","value":824},{"label":"Ago","value":910},{"label":"Set","value":717},{"label":"Out","value":735},{"label":"Nov","value":825},{"label":"Dez","value":643}];
const MX = 931;
