...
const PAGE = "RTO/RPO Test";
const KPIS = [{"l":"BCP Plans Ativos","v":"9.036","t":"+8.4%","d":"up"},{"l":"RTO Médio (h)","v":"198h","t":"+1.1%","d":"up"},{"l":"RPO Médio (h)","v":"98h","t":"-0.7%","d":"down"},{"l":"Testes DR (YTD)","v":"8.820","t":"+11.2%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","164h","73h","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","54h","55h","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","58h","65h","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","31h","140h","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","107h","26h","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":792},{"label":"Mar","value":662},{"label":"Abr","value":711},{"label":"Mai","value":574},{"label":"Jun","value":699},{"label":"Jul","value":534},{"label":"Ago","value":803},{"label":"Set","value":711},{"label":"Out","value":726},{"label":"Nov","value":705},{"label":"Dez","value":527}];
const MX = 893;
