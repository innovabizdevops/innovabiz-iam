...
const PAGE = "DR Runbook";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.364","t":"+14.4%","d":"up"},{"l":"RTO Médio (h)","v":"149h","t":"+0.9%","d":"up"},{"l":"RPO Médio (h)","v":"112h","t":"-5.1%","d":"down"},{"l":"Testes DR (YTD)","v":"6.717","t":"+9.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","137h","90h","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","41h","186h","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","117h","121h","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","182h","127h","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","170h","201h","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":585},{"label":"Mar","value":886},{"label":"Abr","value":755},{"label":"Mai","value":608},{"label":"Jun","value":799},{"label":"Jul","value":888},{"label":"Ago","value":648},{"label":"Set","value":631},{"label":"Out","value":918},{"label":"Nov","value":590},{"label":"Dez","value":949}];
const MX = 949;
