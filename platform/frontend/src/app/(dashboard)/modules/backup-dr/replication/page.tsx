...
const PAGE = "Replication";
const KPIS = [{"l":"BCP Plans Ativos","v":"3.191","t":"+11.7%","d":"up"},{"l":"RTO Médio (h)","v":"30h","t":"-3.3%","d":"down"},{"l":"RPO Médio (h)","v":"38h","t":"+14.4%","d":"up"},{"l":"Testes DR (YTD)","v":"5.092","t":"+4.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","177h","113h","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","193h","115h","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","133h","204h","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","20h","44h","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","54h","103h","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":392},{"label":"Mar","value":623},{"label":"Abr","value":607},{"label":"Mai","value":317},{"label":"Jun","value":480},{"label":"Jul","value":673},{"label":"Ago","value":302},{"label":"Set","value":412},{"label":"Out","value":668},{"label":"Nov","value":365},{"label":"Dez","value":422}];
const MX = 673;
