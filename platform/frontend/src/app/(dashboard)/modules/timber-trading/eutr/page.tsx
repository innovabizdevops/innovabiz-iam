...
const ACCENT = "#15803d";
const MODULE = "Timber Trading";
const PAGE = "EUTR";
const KPIS = [{"l":"Total Timber Trading","v":"8.348","t":"+3.3%","d":"up"},{"l":"EUTR Ativos","v":"7.041","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"71.1%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"77","t":"+3.7%","d":"up"}];
const COLS = ["ID","EUTR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Trading #001","Timber Trading #002","4.059","2.701","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Trading #002","Timber Trading #003","6.083","7.582","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Trading #003","Timber Trading #004","391","6.913","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Trading #004","Timber Trading #005","3.099","7.506","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Trading #005","Timber Trading #001","1.046","7.447","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":495},{"label":"Mar","value":691},{"label":"Abr","value":439},{"label":"Mai","value":682},{"label":"Jun","value":585},{"label":"Jul","value":610},{"label":"Ago","value":556},{"label":"Set","value":803},{"label":"Out","value":433},{"label":"Nov","value":792},{"label":"Dez","value":700}];
const MX = 803;
...
export default function EutrPage() {
    return (
