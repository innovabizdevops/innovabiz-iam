...
const PAGE = "Grade";
const KPIS = [{"l":"Total Timber Trading","v":"7.955","t":"+11.3%","d":"up"},{"l":"Grade Ativos","v":"3.903","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"95","t":"+0.7%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Trading #001","Timber Trading #002","4.873","768","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Trading #002","Timber Trading #003","7.390","2.567","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Trading #003","Timber Trading #004","8.950","7.388","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Trading #004","Timber Trading #005","7.123","5.077","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Trading #005","Timber Trading #001","861","6.494","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":635},{"label":"Mar","value":649},{"label":"Abr","value":293},{"label":"Mai","value":407},{"label":"Jun","value":314},{"label":"Jul","value":509},{"label":"Ago","value":573},{"label":"Set","value":601},{"label":"Out","value":421},{"label":"Nov","value":391},{"label":"Dez","value":448}];
const MX = 649;
