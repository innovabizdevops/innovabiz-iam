...
const KPIS = [{"l":"Total Timber Trading","v":"6.588","t":"+12.1%","d":"up"},{"l":"Logistics Ativos","v":"6.489","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.2%","d":"down"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Trading #001","Timber Trading #002","6.506","5.994","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Trading #002","Timber Trading #003","8.106","5.807","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Trading #003","Timber Trading #004","2.449","2.679","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Trading #004","Timber Trading #005","7.529","1.893","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Trading #005","Timber Trading #001","6.795","3.757","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":574},{"label":"Mar","value":797},{"label":"Abr","value":573},{"label":"Mai","value":473},{"label":"Jun","value":728},{"label":"Jul","value":691},{"label":"Ago","value":649},{"label":"Set","value":496},{"label":"Out","value":565},{"label":"Nov","value":461},{"label":"Dez","value":628}];
const MX = 797;
