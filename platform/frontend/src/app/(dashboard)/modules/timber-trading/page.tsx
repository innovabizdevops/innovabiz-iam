...
/* ═══ Timber Trading — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "4150", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1654", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€429K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "91%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1181163150", cells: ["TIM-4150", "Timber Trading Item 1", "7/7/2026", "€13 250"], status: "active" as const },
    { id: "1181166721", cells: ["TIM-7721", "Timber Trading Item 2", "22/2/2026", "€16 821"], status: "pending" as const },
    { id: "1181170292", cells: ["TIM-2292", "Timber Trading Item 3", "9/9/2026", "€20 392"], status: "completed" as const },
    { id: "1181173863", cells: ["TIM-5863", "Timber Trading Item 4", "24/4/2026", "€23 963"], status: "warning" as const },
    { id: "1181177434", cells: ["TIM-9434", "Timber Trading Item 5", "11/11/2026", "€27 534"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Timber Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Timber Trading</p>
                    </div>
                </div>
