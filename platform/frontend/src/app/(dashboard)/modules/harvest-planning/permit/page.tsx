...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"8.678","t":"+11.1%","d":"up"},{"l":"Mitigações Ativas","v":"1.043","t":"+15.4%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"+4.1%","d":"up"},{"l":"Incidentes YTD","v":"3.915","t":"-5.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.358","3.020","3.821","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","603","8.733","2.398","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.610","8.272","6.798","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.441","4.244","1.614","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.408","2.015","2.048","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":704},{"label":"Mar","value":351},{"label":"Abr","value":573},{"label":"Mai","value":551},{"label":"Jun","value":493},{"label":"Jul","value":594},{"label":"Ago","value":624},{"label":"Set","value":476},{"label":"Out","value":561},{"label":"Nov","value":566},{"label":"Dez","value":353}];
const MX = 704;
