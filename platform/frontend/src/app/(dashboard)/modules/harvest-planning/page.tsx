...
const KPIS = [
    { label: "Total Registos", value: "5716", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4204", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€482K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2000221416", cells: ["HAR-8416", "Harvest Planning Item 1", "5/1/2026", "€21 516"], status: "active" as const },
    { id: "2000224987", cells: ["HAR-2987", "Harvest Planning Item 2", "20/8/2026", "€25 087"], status: "pending" as const },
    { id: "2000228558", cells: ["HAR-6558", "Harvest Planning Item 3", "7/3/2026", "€28 658"], status: "completed" as const },
    { id: "2000232129", cells: ["HAR-1129", "Harvest Planning Item 4", "22/10/2026", "€32 229"], status: "warning" as const },
    { id: "2000235700", cells: ["HAR-4700", "Harvest Planning Item 5", "9/5/2026", "€35 800"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Harvest Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Harvest Planning</p>
                    </div>
                </div>
