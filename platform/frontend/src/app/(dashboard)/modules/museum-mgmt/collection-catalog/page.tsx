...
/* ═══ Museum Mgmt — Collection Catalog ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4545", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "578", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "445579880", cells: ["MUS-8880", "Collection Catalog Item 1", "5/9/2026", "€29 980"], status: "active" as const },
    { id: "445583451", cells: ["MUS-3451", "Collection Catalog Item 2", "20/4/2026", "€33 551"], status: "pending" as const },
    { id: "445587022", cells: ["MUS-7022", "Collection Catalog Item 3", "7/11/2026", "€37 122"], status: "completed" as const },
    { id: "445590593", cells: ["MUS-1593", "Collection Catalog Item 4", "22/6/2026", "€40 693"], status: "warning" as const },
    { id: "445594164", cells: ["MUS-5164", "Collection Catalog Item 5", "9/1/2026", "€44 264"], status: "active" as const },
];
...
export default function MuseumMgmtCollectionCatalogPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Collection Catalog</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Collection Catalog</p>
                    </div>
                </div>
