...
/* ═══ Museum Mgmt — Provenance Research ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4123", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "825", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "94%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "916478217", cells: ["MUS-9217", "Provenance Research Item 1", "26/10/2026", "€28 317"], status: "active" as const },
    { id: "916481788", cells: ["MUS-3788", "Provenance Research Item 2", "13/5/2026", "€31 888"], status: "pending" as const },
    { id: "916485359", cells: ["MUS-7359", "Provenance Research Item 3", "28/12/2026", "€35 459"], status: "completed" as const },
    { id: "916488930", cells: ["MUS-1930", "Provenance Research Item 4", "15/7/2026", "€39 030"], status: "warning" as const },
    { id: "916492501", cells: ["MUS-5501", "Provenance Research Item 5", "2/2/2026", "€42 601"], status: "active" as const },
];
...
export default function MuseumMgmtProvenanceResearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Provenance Research</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Provenance Research</p>
                    </div>
                </div>
