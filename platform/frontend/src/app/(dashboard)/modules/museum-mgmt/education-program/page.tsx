...
/* ═══ Museum Mgmt — Education Program ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2051", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "9", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1247", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1168813605", cells: ["MUS-2605", "Education Program Item 1", "2/10/2026", "€13 705"], status: "active" as const },
    { id: "1168817176", cells: ["MUS-6176", "Education Program Item 2", "17/5/2026", "€17 276"], status: "pending" as const },
    { id: "1168820747", cells: ["MUS-9747", "Education Program Item 3", "4/12/2026", "€20 847"], status: "completed" as const },
    { id: "1168824318", cells: ["MUS-4318", "Education Program Item 4", "19/7/2026", "€24 418"], status: "warning" as const },
    { id: "1168827889", cells: ["MUS-7889", "Education Program Item 5", "6/2/2026", "€27 989"], status: "active" as const },
];
...
export default function MuseumMgmtEducationProgramPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Education Program</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Education Program</p>
                    </div>
                </div>
