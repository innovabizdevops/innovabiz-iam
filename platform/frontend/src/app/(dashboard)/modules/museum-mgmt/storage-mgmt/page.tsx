...
/* ═══ Museum Mgmt — Storage Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4999", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "379", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3547", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1973377559", cells: ["MUS-2559", "Storage Mgmt Item 1", "28/12/2026", "€27 659"], status: "active" as const },
    { id: "1973381130", cells: ["MUS-6130", "Storage Mgmt Item 2", "15/7/2026", "€31 230"], status: "pending" as const },
    { id: "1973384701", cells: ["MUS-9701", "Storage Mgmt Item 3", "2/2/2026", "€34 801"], status: "completed" as const },
    { id: "1973388272", cells: ["MUS-4272", "Storage Mgmt Item 4", "17/9/2026", "€38 372"], status: "warning" as const },
    { id: "1973391843", cells: ["MUS-7843", "Storage Mgmt Item 5", "4/4/2026", "€41 943"], status: "active" as const },
];
...
export default function MuseumMgmtStorageMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Storage Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Storage Mgmt</p>
                    </div>
                </div>
