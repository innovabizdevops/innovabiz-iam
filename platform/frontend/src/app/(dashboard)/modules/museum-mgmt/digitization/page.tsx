...
/* ═══ Museum Mgmt — Digitization ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "2919", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "348", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "400", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "179164488", cells: ["MUS-2488", "Digitization Item 1", "21/1/2026", "€14 588"], status: "active" as const },
    { id: "179168059", cells: ["MUS-6059", "Digitization Item 2", "8/8/2026", "€18 159"], status: "pending" as const },
    { id: "179171630", cells: ["MUS-9630", "Digitization Item 3", "23/3/2026", "€21 730"], status: "completed" as const },
    { id: "179175201", cells: ["MUS-4201", "Digitization Item 4", "10/10/2026", "€25 301"], status: "warning" as const },
    { id: "179178772", cells: ["MUS-7772", "Digitization Item 5", "25/5/2026", "€28 872"], status: "active" as const },
];
...
export default function MuseumMgmtDigitizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digitization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Digitization</p>
                    </div>
                </div>
