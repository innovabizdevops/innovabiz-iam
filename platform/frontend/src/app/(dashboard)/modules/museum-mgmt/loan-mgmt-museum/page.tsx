...
/* ═══ Museum Mgmt — Loan Mgmt Museum ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3346", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "306", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1867", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "501052078", cells: ["MUS-5078", "Loan Mgmt Museum Item 1", "3/11/2026", "€2178"], status: "active" as const },
    { id: "501055649", cells: ["MUS-8649", "Loan Mgmt Museum Item 2", "18/6/2026", "€5749"], status: "pending" as const },
    { id: "501059220", cells: ["MUS-3220", "Loan Mgmt Museum Item 3", "5/1/2026", "€9320"], status: "completed" as const },
    { id: "501062791", cells: ["MUS-6791", "Loan Mgmt Museum Item 4", "20/8/2026", "€12 891"], status: "warning" as const },
    { id: "501066362", cells: ["MUS-1362", "Loan Mgmt Museum Item 5", "7/3/2026", "€16 462"], status: "active" as const },
];
...
export default function MuseumMgmtLoanMgmtMuseumPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Loan Mgmt Museum</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Loan Mgmt Museum</p>
                    </div>
                </div>
