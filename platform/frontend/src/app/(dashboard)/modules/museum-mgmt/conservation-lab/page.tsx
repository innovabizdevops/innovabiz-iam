...
/* ═══ Museum Mgmt — Conservation Lab ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3497", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "175", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1003", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1493098075", cells: ["MUS-8075", "Conservation Lab Item 1", "8/8/2026", "€48 175"], status: "active" as const },
    { id: "1493101646", cells: ["MUS-2646", "Conservation Lab Item 2", "23/3/2026", "€1746"], status: "pending" as const },
    { id: "1493105217", cells: ["MUS-6217", "Conservation Lab Item 3", "10/10/2026", "€5317"], status: "completed" as const },
    { id: "1493108788", cells: ["MUS-9788", "Conservation Lab Item 4", "25/5/2026", "€8888"], status: "warning" as const },
    { id: "1493112359", cells: ["MUS-4359", "Conservation Lab Item 5", "12/12/2026", "€12 459"], status: "active" as const },
];
...
export default function MuseumMgmtConservationLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conservation Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Conservation Lab</p>
                    </div>
                </div>
