...
/* ═══ Museum Mgmt — Exhibition Plan ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3546", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "219", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2182", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2004741463", cells: ["MUS-1463", "Exhibition Plan Item 1", "12/8/2026", "€41 563"], status: "active" as const },
    { id: "2004745034", cells: ["MUS-5034", "Exhibition Plan Item 2", "27/3/2026", "€45 134"], status: "pending" as const },
    { id: "2004748605", cells: ["MUS-8605", "Exhibition Plan Item 3", "14/10/2026", "€48 705"], status: "completed" as const },
    { id: "2004752176", cells: ["MUS-3176", "Exhibition Plan Item 4", "1/5/2026", "€2276"], status: "warning" as const },
    { id: "2004755747", cells: ["MUS-6747", "Exhibition Plan Item 5", "16/12/2026", "€5847"], status: "active" as const },
];
...
export default function MuseumMgmtExhibitionPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Exhibition Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Exhibition Plan</p>
                    </div>
                </div>
