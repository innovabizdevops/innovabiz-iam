...
/* ═══ Museum Mgmt — Acquisition Deac ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "411", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "365", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3616", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "268466329", cells: ["MUS-6329", "Acquisition Deac Item 1", "6/2/2026", "€16 429"], status: "active" as const },
    { id: "268469900", cells: ["MUS-9900", "Acquisition Deac Item 2", "21/9/2026", "€20 000"], status: "pending" as const },
    { id: "268473471", cells: ["MUS-4471", "Acquisition Deac Item 3", "8/4/2026", "€23 571"], status: "completed" as const },
    { id: "268477042", cells: ["MUS-8042", "Acquisition Deac Item 4", "23/11/2026", "€27 142"], status: "warning" as const },
    { id: "268480613", cells: ["MUS-2613", "Acquisition Deac Item 5", "10/6/2026", "€30 713"], status: "active" as const },
];
...
export default function MuseumMgmtAcquisitionDeacPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Acquisition Deac</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Acquisition Deac</p>
                    </div>
                </div>
