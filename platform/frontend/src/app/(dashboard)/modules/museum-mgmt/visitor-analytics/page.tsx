...
/* ═══ Museum Mgmt — Visitor Analytics ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3804", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "193", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "43", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "88%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1949851101", cells: ["MUS-2101", "Visitor Analytics Item 1", "10/10/2026", "€1201"], status: "active" as const },
    { id: "1949854672", cells: ["MUS-5672", "Visitor Analytics Item 2", "25/5/2026", "€4772"], status: "pending" as const },
    { id: "1949858243", cells: ["MUS-9243", "Visitor Analytics Item 3", "12/12/2026", "€8343"], status: "completed" as const },
    { id: "1949861814", cells: ["MUS-3814", "Visitor Analytics Item 4", "27/7/2026", "€11 914"], status: "warning" as const },
    { id: "1949865385", cells: ["MUS-7385", "Visitor Analytics Item 5", "14/2/2026", "€15 485"], status: "active" as const },
];
...
export default function MuseumMgmtVisitorAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Visitor Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Museum Mgmt • Visitor Analytics</p>
                    </div>
                </div>
