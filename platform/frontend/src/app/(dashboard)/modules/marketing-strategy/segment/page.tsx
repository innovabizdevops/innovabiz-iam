...
const PAGE = "Segment";
const KPIS = [{"l":"Perfis Unificados","v":"6.448","t":"+14.6%","d":"up"},{"l":"Segmentos Ativos","v":"4.183","t":"+8.3%","d":"up"},{"l":"NPS Score","v":"74","t":"+17.2%","d":"up"},{"l":"Churn Previsto (%)","v":"83.4%","t":"-5.5%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.445","€ 41199.89","73.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.728","€ 41246.05","95.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.827","€ 40775.97","92.7%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","887","€ 41989.80","85.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.097","€ 24457.96","95.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":703},{"label":"Mar","value":671},{"label":"Abr","value":705},{"label":"Mai","value":656},{"label":"Jun","value":546},{"label":"Jul","value":601},{"label":"Ago","value":715},{"label":"Set","value":489},{"label":"Out","value":623},{"label":"Nov","value":436},{"label":"Dez","value":561}];
const MX = 715;
