...
const ACCENT = "#2563eb";
const MODULE = "Marketing Strategy (APQC 3.2)";
const PAGE = "Channel Mix";
const KPIS = [{"l":"Total Marketing Strategy","v":"1.853","t":"+5.6%","d":"up"},{"l":"Channel Mix Ativos","v":"7.186","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"66","t":"+0.3%","d":"up"}];
const COLS = ["ID","Channel Mix","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Strategy #001","Marketing Strategy #002","3.345","5.626","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Strategy #002","Marketing Strategy #003","2.471","2.590","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Strategy #003","Marketing Strategy #004","5.557","7.641","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Strategy #004","Marketing Strategy #005","7.749","2.881","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Strategy #005","Marketing Strategy #001","795","3.668","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":890},{"label":"Mar","value":958},{"label":"Abr","value":618},{"label":"Mai","value":696},{"label":"Jun","value":703},{"label":"Jul","value":847},{"label":"Ago","value":684},{"label":"Set","value":900},{"label":"Out","value":670},{"label":"Nov","value":685},{"label":"Dez","value":940}];
const MX = 958;
