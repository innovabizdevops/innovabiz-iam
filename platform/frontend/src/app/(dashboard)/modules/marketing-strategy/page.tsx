...
/* ═══ Marketing Strategy (APQC 3.2) — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "9507", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "975", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€353K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1129639007", cells: ["MAR-5007", "Marketing Strategy (APQC 3.2) Item 1", "8/12/2026", "€39 107"], status: "active" as const },
    { id: "1129642578", cells: ["MAR-8578", "Marketing Strategy (APQC 3.2) Item 2", "23/7/2026", "€42 678"], status: "pending" as const },
    { id: "1129646149", cells: ["MAR-3149", "Marketing Strategy (APQC 3.2) Item 3", "10/2/2026", "€46 249"], status: "completed" as const },
    { id: "1129649720", cells: ["MAR-6720", "Marketing Strategy (APQC 3.2) Item 4", "25/9/2026", "€49 820"], status: "warning" as const },
    { id: "1129653291", cells: ["MAR-1291", "Marketing Strategy (APQC 3.2) Item 5", "12/4/2026", "€3391"], status: "active" as const },
];
...
export default function MarketingStrategyApqc32Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Strategy (APQC 3.2)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Strategy (APQC 3.2)</p>
                    </div>
                </div>
