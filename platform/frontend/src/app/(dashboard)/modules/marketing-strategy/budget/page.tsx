...
const PAGE = "Budget";
const KPIS = [{"l":"Total Marketing Strategy","v":"2.300","t":"+5.0%","d":"up"},{"l":"Budget Ativos","v":"€38456","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"-6.0%","d":"down"},{"l":"Score Performance","v":"63","t":"+16.3%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Strategy #001","€ 40535.22","9.065","3.712","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Strategy #002","€ 35620.32","8.865","4.922","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Strategy #003","€ 41947.07","1.857","3.176","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Strategy #004","€ 46428.50","1.798","4.808","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Strategy #005","€ 41291.49","6.698","8.541","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":593},{"label":"Mar","value":455},{"label":"Abr","value":498},{"label":"Mai","value":780},{"label":"Jun","value":748},{"label":"Jul","value":654},{"label":"Ago","value":463},{"label":"Set","value":645},{"label":"Out","value":567},{"label":"Nov","value":663},{"label":"Dez","value":521}];
const MX = 780;
