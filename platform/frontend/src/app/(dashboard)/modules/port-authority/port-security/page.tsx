...
/* ═══ Port Authority — Port Security ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "1275", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "477", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1606", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1927339433", cells: ["POR-8433", "Port Security Item 1", "6/6/2026", "€39 533"], status: "active" as const },
    { id: "1927343004", cells: ["POR-3004", "Port Security Item 2", "21/1/2026", "€43 104"], status: "pending" as const },
    { id: "1927346575", cells: ["POR-6575", "Port Security Item 3", "8/8/2026", "€46 675"], status: "completed" as const },
    { id: "1927350146", cells: ["POR-1146", "Port Security Item 4", "23/3/2026", "€246"], status: "warning" as const },
    { id: "1927353717", cells: ["POR-4717", "Port Security Item 5", "10/10/2026", "€3817"], status: "active" as const },
];
...
export default function PortAuthorityPortSecurityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Port Security</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Port Security</p>
                    </div>
                </div>
