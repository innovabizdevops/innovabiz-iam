...
/* ═══ Port Authority — Pilot Schedule ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4166", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "185", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3383", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1967175381", cells: ["POR-1381", "Pilot Schedule Item 1", "18/10/2026", "€25 481"], status: "active" as const },
    { id: "1967178952", cells: ["POR-4952", "Pilot Schedule Item 2", "5/5/2026", "€29 052"], status: "pending" as const },
    { id: "1967182523", cells: ["POR-8523", "Pilot Schedule Item 3", "20/12/2026", "€32 623"], status: "completed" as const },
    { id: "1967186094", cells: ["POR-3094", "Pilot Schedule Item 4", "7/7/2026", "€36 194"], status: "warning" as const },
    { id: "1967189665", cells: ["POR-6665", "Pilot Schedule Item 5", "22/2/2026", "€39 765"], status: "active" as const },
];
...
export default function PortAuthorityPilotSchedulePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pilot Schedule</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Pilot Schedule</p>
                    </div>
                </div>
