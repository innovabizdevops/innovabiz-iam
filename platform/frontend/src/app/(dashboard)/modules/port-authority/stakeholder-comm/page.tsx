...
/* ═══ Port Authority — Stakeholder Comm ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "1467", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "176", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2755", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "158760860", cells: ["POR-1860", "Stakeholder Comm Item 1", "21/9/2026", "€10 960"], status: "active" as const },
    { id: "158764431", cells: ["POR-5431", "Stakeholder Comm Item 2", "8/4/2026", "€14 531"], status: "pending" as const },
    { id: "158768002", cells: ["POR-9002", "Stakeholder Comm Item 3", "23/11/2026", "€18 102"], status: "completed" as const },
    { id: "158771573", cells: ["POR-3573", "Stakeholder Comm Item 4", "10/6/2026", "€21 673"], status: "warning" as const },
    { id: "158775144", cells: ["POR-7144", "Stakeholder Comm Item 5", "25/1/2026", "€25 244"], status: "active" as const },
];
...
export default function PortAuthorityStakeholderCommPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stakeholder Comm</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Stakeholder Comm</p>
                    </div>
                </div>
