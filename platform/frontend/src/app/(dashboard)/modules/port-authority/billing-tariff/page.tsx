...
/* ═══ Port Authority — Billing Tariff ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "3799", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "147", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2419", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "757494335", cells: ["POR-1335", "Billing Tariff Item 1", "4/12/2026", "€44 435"], status: "active" as const },
    { id: "757497906", cells: ["POR-4906", "Billing Tariff Item 2", "19/7/2026", "€48 006"], status: "pending" as const },
    { id: "757501477", cells: ["POR-8477", "Billing Tariff Item 3", "6/2/2026", "€1577"], status: "completed" as const },
    { id: "757505048", cells: ["POR-3048", "Billing Tariff Item 4", "21/9/2026", "€5148"], status: "warning" as const },
    { id: "757508619", cells: ["POR-6619", "Billing Tariff Item 5", "8/4/2026", "€8719"], status: "active" as const },
];
...
export default function PortAuthorityBillingTariffPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Billing Tariff</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Billing Tariff</p>
                    </div>
                </div>
