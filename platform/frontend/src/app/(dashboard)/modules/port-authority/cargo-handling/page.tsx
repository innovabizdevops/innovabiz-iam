...
/* ═══ Port Authority — Cargo Handling ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "2643", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "147", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2379", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1949526175", cells: ["POR-1175", "Cargo Handling Item 1", "24/8/2026", "€26 275"], status: "active" as const },
    { id: "1949529746", cells: ["POR-4746", "Cargo Handling Item 2", "11/3/2026", "€29 846"], status: "pending" as const },
    { id: "1949533317", cells: ["POR-8317", "Cargo Handling Item 3", "26/10/2026", "€33 417"], status: "completed" as const },
    { id: "1949536888", cells: ["POR-2888", "Cargo Handling Item 4", "13/5/2026", "€36 988"], status: "warning" as const },
    { id: "1949540459", cells: ["POR-6459", "Cargo Handling Item 5", "28/12/2026", "€40 559"], status: "active" as const },
];
...
export default function PortAuthorityCargoHandlingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cargo Handling</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Cargo Handling</p>
                    </div>
                </div>
