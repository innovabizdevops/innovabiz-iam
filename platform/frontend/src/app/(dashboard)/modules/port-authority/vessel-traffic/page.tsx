...
/* ═══ Port Authority — Vessel Traffic ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "2105", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "91", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3631", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1990698583", cells: ["POR-7583", "Vessel Traffic Item 1", "28/8/2026", "€48 683"], status: "active" as const },
    { id: "1990702154", cells: ["POR-2154", "Vessel Traffic Item 2", "15/3/2026", "€2254"], status: "pending" as const },
    { id: "1990705725", cells: ["POR-5725", "Vessel Traffic Item 3", "2/10/2026", "€5825"], status: "completed" as const },
    { id: "1990709296", cells: ["POR-9296", "Vessel Traffic Item 4", "17/5/2026", "€9396"], status: "warning" as const },
    { id: "1990712867", cells: ["POR-3867", "Vessel Traffic Item 5", "4/12/2026", "€12 967"], status: "active" as const },
];
...
export default function PortAuthorityVesselTrafficPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Vessel Traffic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Vessel Traffic</p>
                    </div>
                </div>
