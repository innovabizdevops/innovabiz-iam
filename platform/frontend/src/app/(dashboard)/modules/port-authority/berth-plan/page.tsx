...
/* ═══ Port Authority — Berth Plan ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "3554", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "120", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "724", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1442012996", cells: ["POR-6996", "Berth Plan Item 1", "5/9/2026", "€13 096"], status: "active" as const },
    { id: "1442016567", cells: ["POR-1567", "Berth Plan Item 2", "20/4/2026", "€16 667"], status: "pending" as const },
    { id: "1442020138", cells: ["POR-5138", "Berth Plan Item 3", "7/11/2026", "€20 238"], status: "completed" as const },
    { id: "1442023709", cells: ["POR-8709", "Berth Plan Item 4", "22/6/2026", "€23 809"], status: "warning" as const },
    { id: "1442027280", cells: ["POR-3280", "Berth Plan Item 5", "9/1/2026", "€27 380"], status: "active" as const },
];
...
export default function PortAuthorityBerthPlanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Berth Plan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Berth Plan</p>
                    </div>
                </div>
