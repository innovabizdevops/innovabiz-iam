...
/* ═══ Port Authority — Hazmat Mgmt ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "523", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "496", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2852", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "689057100", cells: ["POR-9100", "Hazmat Mgmt Item 1", "5/1/2026", "€7200"], status: "active" as const },
    { id: "689060671", cells: ["POR-3671", "Hazmat Mgmt Item 2", "20/8/2026", "€10 771"], status: "pending" as const },
    { id: "689064242", cells: ["POR-7242", "Hazmat Mgmt Item 3", "7/3/2026", "€14 342"], status: "completed" as const },
    { id: "689067813", cells: ["POR-1813", "Hazmat Mgmt Item 4", "22/10/2026", "€17 913"], status: "warning" as const },
    { id: "689071384", cells: ["POR-5384", "Hazmat Mgmt Item 5", "9/5/2026", "€21 484"], status: "active" as const },
];
...
export default function PortAuthorityHazmatMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hazmat Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Hazmat Mgmt</p>
                    </div>
                </div>
