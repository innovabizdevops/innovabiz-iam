...
/* ═══ Port Authority — Customs Clear ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "1437", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "43", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "509", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "691792583", cells: ["POR-8583", "Customs Clear Item 1", "28/12/2026", "€42 683"], status: "active" as const },
    { id: "691796154", cells: ["POR-3154", "Customs Clear Item 2", "15/7/2026", "€46 254"], status: "pending" as const },
    { id: "691799725", cells: ["POR-6725", "Customs Clear Item 3", "2/2/2026", "€49 825"], status: "completed" as const },
    { id: "691803296", cells: ["POR-1296", "Customs Clear Item 4", "17/9/2026", "€3396"], status: "warning" as const },
    { id: "691806867", cells: ["POR-4867", "Customs Clear Item 5", "4/4/2026", "€6967"], status: "active" as const },
];
...
export default function PortAuthorityCustomsClearPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customs Clear</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Customs Clear</p>
                    </div>
                </div>
