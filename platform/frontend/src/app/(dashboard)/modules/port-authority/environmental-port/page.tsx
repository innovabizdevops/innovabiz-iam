...
/* ═══ Port Authority — Environmental Port ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total", value: "4684", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "379", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3800", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "98%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "458988871", cells: ["POR-7871", "Environmental Port Item 1", "20/8/2026", "€38 971"], status: "active" as const },
    { id: "458992442", cells: ["POR-2442", "Environmental Port Item 2", "7/3/2026", "€42 542"], status: "pending" as const },
    { id: "458996013", cells: ["POR-6013", "Environmental Port Item 3", "22/10/2026", "€46 113"], status: "completed" as const },
    { id: "458999584", cells: ["POR-9584", "Environmental Port Item 4", "9/5/2026", "€49 684"], status: "warning" as const },
    { id: "459003155", cells: ["POR-4155", "Environmental Port Item 5", "24/12/2026", "€3255"], status: "active" as const },
];
...
export default function PortAuthorityEnvironmentalPortPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Environmental Port</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Port Authority • Environmental Port</p>
                    </div>
                </div>
