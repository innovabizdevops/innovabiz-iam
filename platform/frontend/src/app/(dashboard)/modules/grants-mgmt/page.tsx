...
const KPIS = [
    { label: "Total Registos", value: "8494", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2616", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€421K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1396452894", cells: ["GRA-4894", "Grants Management Item 1", "19/7/2026", "€2994"], status: "active" as const },
    { id: "1396456465", cells: ["GRA-8465", "Grants Management Item 2", "6/2/2026", "€6565"], status: "pending" as const },
    { id: "1396460036", cells: ["GRA-3036", "Grants Management Item 3", "21/9/2026", "€10 136"], status: "completed" as const },
    { id: "1396463607", cells: ["GRA-6607", "Grants Management Item 4", "8/4/2026", "€13 707"], status: "warning" as const },
    { id: "1396467178", cells: ["GRA-1178", "Grants Management Item 5", "23/11/2026", "€17 278"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Grants Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Grants Management</p>
                    </div>
                </div>
