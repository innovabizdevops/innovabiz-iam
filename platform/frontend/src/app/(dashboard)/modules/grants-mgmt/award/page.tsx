...
const PAGE = "Award";
const KPIS = [{"l":"Total Grants Mgmt","v":"2.977","t":"+5.7%","d":"up"},{"l":"Award Ativos","v":"4.614","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"78.4%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"86","t":"+15.0%","d":"up"}];
const COLS = ["ID","Award","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grants Mgmt #001","Grants Mgmt #002","2.041","6.617","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Grants Mgmt #002","Grants Mgmt #003","7.951","4.688","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Grants Mgmt #003","Grants Mgmt #004","1.883","5.345","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Grants Mgmt #004","Grants Mgmt #005","3.892","3.700","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grants Mgmt #005","Grants Mgmt #001","7.945","1.449","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":888},{"label":"Mar","value":694},{"label":"Abr","value":813},{"label":"Mai","value":721},{"label":"Jun","value":671},{"label":"Jul","value":735},{"label":"Ago","value":706},{"label":"Set","value":701},{"label":"Out","value":552},{"label":"Nov","value":766},{"label":"Dez","value":717}];
const MX = 888;
