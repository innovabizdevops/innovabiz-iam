...
const ACCENT = "#64748b";
const MODULE = "Grants Management";
const PAGE = "Opportunity";
const KPIS = [{"l":"Total Grants Mgmt","v":"4.429","t":"+7.0%","d":"up"},{"l":"Opportunity Ativos","v":"7.497","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"88","t":"-5.3%","d":"down"}];
const COLS = ["ID","Opportunity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grants Mgmt #001","Grants Mgmt #002","1.582","2.018","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Grants Mgmt #002","Grants Mgmt #003","3.986","2.905","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Grants Mgmt #003","Grants Mgmt #004","2.372","3.553","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Grants Mgmt #004","Grants Mgmt #005","2.800","1.625","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grants Mgmt #005","Grants Mgmt #001","4.851","7.286","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":979},{"label":"Mar","value":732},{"label":"Abr","value":974},{"label":"Mai","value":663},{"label":"Jun","value":763},{"label":"Jul","value":929},{"label":"Ago","value":813},{"label":"Set","value":1013},{"label":"Out","value":1000},{"label":"Nov","value":743},{"label":"Dez","value":654}];
const MX = 1013;
