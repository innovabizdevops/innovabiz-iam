...
const PAGE = "Report";
const KPIS = [{"l":"Total Grants Mgmt","v":"3.660","t":"+4.7%","d":"up"},{"l":"Report Ativos","v":"1.822","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"67.9%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.1%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grants Mgmt #001","Grants Mgmt #002","4.283","7.547","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Grants Mgmt #002","Grants Mgmt #003","8.362","6.548","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Grants Mgmt #003","Grants Mgmt #004","7.616","6.899","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Grants Mgmt #004","Grants Mgmt #005","7.634","1.977","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grants Mgmt #005","Grants Mgmt #001","8.905","630","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":765},{"label":"Mar","value":863},{"label":"Abr","value":987},{"label":"Mai","value":965},{"label":"Jun","value":1008},{"label":"Jul","value":748},{"label":"Ago","value":809},{"label":"Set","value":699},{"label":"Out","value":958},{"label":"Nov","value":774},{"label":"Dez","value":951}];
const MX = 1008;
