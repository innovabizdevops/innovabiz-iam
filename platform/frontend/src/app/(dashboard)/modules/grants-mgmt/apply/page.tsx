...
const PAGE = "Apply";
const KPIS = [{"l":"Total Grants Mgmt","v":"6.369","t":"+11.4%","d":"up"},{"l":"Apply Ativos","v":"5.300","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"77","t":"+15.1%","d":"up"}];
const COLS = ["ID","Apply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grants Mgmt #001","Grants Mgmt #002","850","826","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Grants Mgmt #002","Grants Mgmt #003","1.894","7.172","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Grants Mgmt #003","Grants Mgmt #004","8.627","5.767","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Grants Mgmt #004","Grants Mgmt #005","3.762","4.890","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grants Mgmt #005","Grants Mgmt #001","219","5.841","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":273},{"label":"Mar","value":319},{"label":"Abr","value":257},{"label":"Mai","value":233},{"label":"Jun","value":453},{"label":"Jul","value":239},{"label":"Ago","value":532},{"label":"Set","value":311},{"label":"Out","value":587},{"label":"Nov","value":549},{"label":"Dez","value":553}];
const MX = 587;
