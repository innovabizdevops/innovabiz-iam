...
const KPIS = [{"l":"Artigos Publicados","v":"1.075","t":"+1.5%","d":"up"},{"l":"Views/Semana","v":"1187","t":"+1.5%","d":"up"},{"l":"Feedback Útil (%)","v":"68.8%","t":"-2.7%","d":"down"},{"l":"Artigos Desatualizados","v":"6.071","t":"+9.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","9.008","78.1%","1.229","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","168","83.8%","6.411","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","9.082","96.6%","829","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","1.744","86.2%","3.919","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.547","77.8%","420","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":428},{"label":"Mar","value":445},{"label":"Abr","value":367},{"label":"Mai","value":350},{"label":"Jun","value":444},{"label":"Jul","value":437},{"label":"Ago","value":551},{"label":"Set","value":335},{"label":"Out","value":480},{"label":"Nov","value":533},{"label":"Dez","value":398}];
const MX = 551;
