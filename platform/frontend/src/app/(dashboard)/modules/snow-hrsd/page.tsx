...
/* ═══ HR Service Delivery (SNOW) — Dashboard ═══ */

const ACCENT = "#81b5a1";

const KPIS = [
    { label: "Total Registos", value: "2268", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "434", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€102K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "985398668", cells: ["SNO-7668", "HR Service Delivery (SNOW) Item 1", "17/9/2026", "€48 768"], status: "active" as const },
    { id: "985402239", cells: ["SNO-2239", "HR Service Delivery (SNOW) Item 2", "4/4/2026", "€2339"], status: "pending" as const },
    { id: "985405810", cells: ["SNO-5810", "HR Service Delivery (SNOW) Item 3", "19/11/2026", "€5910"], status: "completed" as const },
    { id: "985409381", cells: ["SNO-9381", "HR Service Delivery (SNOW) Item 4", "6/6/2026", "€9481"], status: "warning" as const },
    { id: "985412952", cells: ["SNO-3952", "HR Service Delivery (SNOW) Item 5", "21/1/2026", "€13 052"], status: "active" as const },
];
...
export default function HrServiceDeliverySnowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HR Service Delivery (SNOW)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HR Service Delivery (SNOW)</p>
                    </div>
                </div>
