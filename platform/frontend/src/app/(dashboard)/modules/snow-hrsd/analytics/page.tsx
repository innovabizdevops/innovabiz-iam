...
const ACCENT = "#81b5a1";
const MODULE = "HR Service Delivery (SNOW)";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"658","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"1563","t":"+7.3%","d":"up"},{"l":"Dados Processados (GB)","v":"5.365","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"6.380","t":"-4.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1150","2026-03-23","7.549","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3595","2026-01-08","1.786","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","783","2026-03-19","175","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1326","2026-02-16","6.882","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3090","2026-01-16","2.434","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":660},{"label":"Mar","value":541},{"label":"Abr","value":563},{"label":"Mai","value":532},{"label":"Jun","value":455},{"label":"Jul","value":351},{"label":"Ago","value":355},{"label":"Set","value":454},{"label":"Out","value":573},{"label":"Nov","value":448},{"label":"Dez","value":307}];
const MX = 660;
