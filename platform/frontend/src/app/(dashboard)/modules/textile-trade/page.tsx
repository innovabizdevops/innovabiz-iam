...
export default function TextileTradePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Textile Trade</h1><p className="text-sm text-muted-foreground">Textile Trade • iBOS Enterprise</p></div>
