...
const ACCENT = "#78350f";
const MODULE = "Airport Infrastructure";
const PAGE = "Taxiway";
const KPIS = [{"l":"Total Airport Infra","v":"2.756","t":"-1.6%","d":"down"},{"l":"Taxiway Ativos","v":"6.215","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"68.8%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+3.1%","d":"up"}];
const COLS = ["ID","Taxiway","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Infra #001","Airport Infra #002","6.933","7.287","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Infra #002","Airport Infra #003","2.633","3.601","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Infra #003","Airport Infra #004","4.270","3.928","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Infra #004","Airport Infra #005","161","7.818","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Infra #005","Airport Infra #001","6.814","6.379","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":322},{"label":"Mar","value":520},{"label":"Abr","value":316},{"label":"Mai","value":561},{"label":"Jun","value":305},{"label":"Jul","value":581},{"label":"Ago","value":258},{"label":"Set","value":455},{"label":"Out","value":583},{"label":"Nov","value":316},{"label":"Dez","value":518}];
const MX = 583;
...
export default function TaxiwayPage() {
    return (
