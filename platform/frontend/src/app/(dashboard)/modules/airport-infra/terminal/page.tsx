...
const PAGE = "Terminal Bldg";
const KPIS = [{"l":"Riscos Identificados","v":"8.502","t":"+10.4%","d":"up"},{"l":"Mitigações Ativas","v":"8.375","t":"+7.5%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"+3.5%","d":"up"},{"l":"Incidentes YTD","v":"782","t":"+0.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.847","8.854","4.809","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.627","8.361","3.461","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","576","3.900","8.063","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.392","7.197","3.216","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.036","4.933","5.428","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":414},{"label":"Mar","value":607},{"label":"Abr","value":313},{"label":"Mai","value":459},{"label":"Jun","value":247},{"label":"Jul","value":285},{"label":"Ago","value":492},{"label":"Set","value":546},{"label":"Out","value":418},{"label":"Nov","value":331},{"label":"Dez","value":287}];
const MX = 607;
