...
const KPIS = [{"l":"Total Airport Infra","v":"8.886","t":"-1.2%","d":"down"},{"l":"Expansion Ativos","v":"3.285","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"77.2%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.6%","d":"up"}];
const COLS = ["ID","Expansion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Infra #001","Airport Infra #002","3.501","2.858","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Infra #002","Airport Infra #003","4.625","5.446","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Infra #003","Airport Infra #004","2.807","3.220","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Infra #004","Airport Infra #005","8.715","3.996","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Infra #005","Airport Infra #001","4.085","450","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":657},{"label":"Mar","value":382},{"label":"Abr","value":638},{"label":"Mai","value":389},{"label":"Jun","value":544},{"label":"Jul","value":317},{"label":"Ago","value":676},{"label":"Set","value":432},{"label":"Out","value":323},{"label":"Nov","value":575},{"label":"Dez","value":348}];
const MX = 676;
