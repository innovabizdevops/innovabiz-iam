...
const ACCENT = "#6366f1";
const MODULE = "NOC Operations";
const PAGE = "Escalation";
const KPIS = [{"l":"Notificações Enviadas","v":"940","t":"-3.2%","d":"down"},{"l":"Taxa Entrega (%)","v":"89.0%","t":"+15.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"78.4%","t":"+6.8%","d":"up"},{"l":"Escalações","v":"6.104","t":"-0.6%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.667","94.1%","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.553","92.8%","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.349","82.8%","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.979","76.6%","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.568","77.6%","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":771},{"label":"Mar","value":874},{"label":"Abr","value":690},{"label":"Mai","value":763},{"label":"Jun","value":994},{"label":"Jul","value":873},{"label":"Ago","value":1041},{"label":"Set","value":915},{"label":"Out","value":1013},{"label":"Nov","value":960},{"label":"Dez","value":944}];
const MX = 1041;
