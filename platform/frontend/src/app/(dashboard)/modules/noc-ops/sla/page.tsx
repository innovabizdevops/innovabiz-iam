...
const PAGE = "SLA";
const KPIS = [{"l":"Tickets Abertos","v":"824","t":"+12.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.6%","t":"+7.7%","d":"up"},{"l":"MTTR (h)","v":"59h","t":"+14.5%","d":"up"},{"l":"Satisfação (%)","v":"68.5%","t":"+16.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.026","1.905","6.381","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.627","8.490","516","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.664","786","2.370","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.381","4.216","7.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.900","7.073","642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":227},{"label":"Fev","value":501},{"label":"Mar","value":448},{"label":"Abr","value":295},{"label":"Mai","value":481},{"label":"Jun","value":586},{"label":"Jul","value":459},{"label":"Ago","value":339},{"label":"Set","value":236},{"label":"Out","value":521},{"label":"Nov","value":240},{"label":"Dez","value":231}];
const MX = 586;
