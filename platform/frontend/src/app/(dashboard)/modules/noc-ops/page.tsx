...
export default function NocOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Noc Ops</h1><p className="text-sm text-muted-foreground">Noc Ops • iBOS Enterprise</p></div>
