...
const KPIS = [{"l":"Teams Ativos","v":"1.623","t":"-3.3%","d":"down"},{"l":"Reuniões/Semana","v":"3590","t":"+11.1%","d":"up"},{"l":"Mensagens/Dia","v":"3340","t":"-2.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"6.869","t":"+6.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.242","2391","193","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.799","1890","2.650","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","2.533","2416","7.627","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","265","4717","2.134","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.762","3258","4.291","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":871},{"label":"Mar","value":681},{"label":"Abr","value":624},{"label":"Mai","value":638},{"label":"Jun","value":911},{"label":"Jul","value":630},{"label":"Ago","value":881},{"label":"Set","value":571},{"label":"Out","value":693},{"label":"Nov","value":844},{"label":"Dez","value":660}];
const MX = 911;
