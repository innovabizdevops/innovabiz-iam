...
const PAGE = "Govern";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.740","t":"-3.5%","d":"down"},{"l":"Sessões/Dia","v":"1907","t":"+16.0%","d":"up"},{"l":"MFA Adoção (%)","v":"83.6%","t":"+8.7%","d":"up"},{"l":"Tentativas Bloqueadas","v":"730","t":"-2.8%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.992","6.665","2.057","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","9.087","1.265","6.324","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","9.069","557","8.342","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.304","1.437","1.555","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.246","8.593","6.411","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":433},{"label":"Mar","value":314},{"label":"Abr","value":450},{"label":"Mai","value":345},{"label":"Jun","value":611},{"label":"Jul","value":626},{"label":"Ago","value":601},{"label":"Set","value":623},{"label":"Out","value":449},{"label":"Nov","value":290},{"label":"Dez","value":628}];
const MX = 628;
