...
const PAGE = "Certify";
const KPIS = [{"l":"Utilizadores Ativos","v":"172","t":"+17.1%","d":"up"},{"l":"Sessões/Dia","v":"2728","t":"+1.4%","d":"up"},{"l":"MFA Adoção (%)","v":"69.0%","t":"-2.4%","d":"down"},{"l":"Tentativas Bloqueadas","v":"5.918","t":"+15.8%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.465","3.851","673","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.453","631","6.204","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.071","1.630","4.713","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.862","4.194","3.788","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.379","8.023","2.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":918},{"label":"Fev","value":938},{"label":"Mar","value":916},{"label":"Abr","value":1074},{"label":"Mai","value":980},{"label":"Jun","value":942},{"label":"Jul","value":983},{"label":"Ago","value":702},{"label":"Set","value":818},{"label":"Out","value":946},{"label":"Nov","value":836},{"label":"Dez","value":738}];
const MX = 1074;
