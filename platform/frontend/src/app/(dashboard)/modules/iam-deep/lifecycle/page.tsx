...
const KPIS = [{"l":"Utilizadores Ativos","v":"4.337","t":"+5.2%","d":"up"},{"l":"Sessões/Dia","v":"1130","t":"+16.4%","d":"up"},{"l":"MFA Adoção (%)","v":"70.9%","t":"+12.3%","d":"up"},{"l":"Tentativas Bloqueadas","v":"7.868","t":"+17.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.560","3.964","2.181","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.545","5.449","4.279","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.196","7.900","7.289","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","920","3.723","7.525","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","2.026","5.169","3.083","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":666},{"label":"Mar","value":703},{"label":"Abr","value":754},{"label":"Mai","value":760},{"label":"Jun","value":459},{"label":"Jul","value":579},{"label":"Ago","value":379},{"label":"Set","value":653},{"label":"Out","value":664},{"label":"Nov","value":376},{"label":"Dez","value":434}];
const MX = 760;
