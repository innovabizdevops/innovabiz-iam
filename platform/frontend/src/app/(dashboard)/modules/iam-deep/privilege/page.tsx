...
const ACCENT = "#7f1d1d";
const MODULE = "IAM Platform Deep";
const PAGE = "Privilege";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.099","t":"-2.9%","d":"down"},{"l":"Sessões/Dia","v":"4114","t":"+3.8%","d":"up"},{"l":"MFA Adoção (%)","v":"85.2%","t":"+0.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"6.252","t":"+15.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.971","5.273","1.035","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.574","8.743","1.874","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.055","1.904","438","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.719","5.902","5.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.330","7.490","2.101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":664},{"label":"Mar","value":639},{"label":"Abr","value":616},{"label":"Mai","value":497},{"label":"Jun","value":671},{"label":"Jul","value":734},{"label":"Ago","value":495},{"label":"Set","value":499},{"label":"Out","value":593},{"label":"Nov","value":623},{"label":"Dez","value":404}];
const MX = 734;
