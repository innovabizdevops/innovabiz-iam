...
/* ═══ IAM Platform Deep — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "205", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2225", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€482K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1304513205", cells: ["IAM-9205", "IAM Platform Deep Item 1", "10/10/2026", "€13 305"], status: "active" as const },
    { id: "1304516776", cells: ["IAM-3776", "IAM Platform Deep Item 2", "25/5/2026", "€16 876"], status: "pending" as const },
    { id: "1304520347", cells: ["IAM-7347", "IAM Platform Deep Item 3", "12/12/2026", "€20 447"], status: "completed" as const },
    { id: "1304523918", cells: ["IAM-1918", "IAM Platform Deep Item 4", "27/7/2026", "€24 018"], status: "warning" as const },
    { id: "1304527489", cells: ["IAM-5489", "IAM Platform Deep Item 5", "14/2/2026", "€27 589"], status: "active" as const },
];
...
export default function IamPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">IAM Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • IAM Platform Deep</p>
                    </div>
                </div>
