...
const PAGE = "Access";
const KPIS = [{"l":"Utilizadores Ativos","v":"2.820","t":"+9.7%","d":"up"},{"l":"Sessões/Dia","v":"4347","t":"+5.0%","d":"up"},{"l":"MFA Adoção (%)","v":"87.2%","t":"+13.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.690","t":"+7.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.297","4.205","1.969","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","4.016","4.313","3.400","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.282","4.713","1.143","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.130","7.132","1.029","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","3.722","3.390","6.574","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":503},{"label":"Mar","value":455},{"label":"Abr","value":732},{"label":"Mai","value":472},{"label":"Jun","value":581},{"label":"Jul","value":602},{"label":"Ago","value":556},{"label":"Set","value":500},{"label":"Out","value":676},{"label":"Nov","value":568},{"label":"Dez","value":669}];
const MX = 732;
