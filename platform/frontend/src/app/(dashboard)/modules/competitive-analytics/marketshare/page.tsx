...
const PAGE = "Market Share";
const KPIS = [{"l":"Dashboards Ativos","v":"3.739","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"4538","t":"-4.9%","d":"down"},{"l":"Dados Processados (GB)","v":"3.666","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.969","t":"+16.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","474","2026-02-23","7.541","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2925","2026-03-09","4.407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4118","2026-01-15","7.101","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","757","2026-01-10","6.946","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2342","2026-02-25","1.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":814},{"label":"Mar","value":586},{"label":"Abr","value":635},{"label":"Mai","value":610},{"label":"Jun","value":925},{"label":"Jul","value":572},{"label":"Ago","value":896},{"label":"Set","value":636},{"label":"Out","value":944},{"label":"Nov","value":649},{"label":"Dez","value":717}];
const MX = 944;
