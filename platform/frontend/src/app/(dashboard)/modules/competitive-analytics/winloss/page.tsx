...
const PAGE = "Win/Loss";
const KPIS = [{"l":"Dashboards Ativos","v":"7.805","t":"+4.3%","d":"up"},{"l":"Queries/Dia","v":"3155","t":"+7.0%","d":"up"},{"l":"Dados Processados (GB)","v":"3.131","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"7.273","t":"+8.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3624","2026-01-14","4.445","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1321","2026-03-10","7.655","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5092","2026-03-17","2.436","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3735","2026-02-19","5.664","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1453","2026-03-07","4.842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":802},{"label":"Mar","value":922},{"label":"Abr","value":779},{"label":"Mai","value":920},{"label":"Jun","value":770},{"label":"Jul","value":647},{"label":"Ago","value":668},{"label":"Set","value":713},{"label":"Out","value":650},{"label":"Nov","value":765},{"label":"Dez","value":843}];
const MX = 922;
