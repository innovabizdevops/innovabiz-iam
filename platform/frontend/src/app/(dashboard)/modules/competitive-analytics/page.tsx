...
/* ═══ Competitive Analytics Deep — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "2183", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2444", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€381K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "411614383", cells: ["COM-9383", "Competitive Analytics Deep Item 1", "20/8/2026", "€14 483"], status: "active" as const },
    { id: "411617954", cells: ["COM-3954", "Competitive Analytics Deep Item 2", "7/3/2026", "€18 054"], status: "pending" as const },
    { id: "411621525", cells: ["COM-7525", "Competitive Analytics Deep Item 3", "22/10/2026", "€21 625"], status: "completed" as const },
    { id: "411625096", cells: ["COM-2096", "Competitive Analytics Deep Item 4", "9/5/2026", "€25 196"], status: "warning" as const },
    { id: "411628667", cells: ["COM-5667", "Competitive Analytics Deep Item 5", "24/12/2026", "€28 767"], status: "active" as const },
];
...
export default function CompetitiveAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Competitive Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Competitive Analytics Deep</p>
                    </div>
                </div>
