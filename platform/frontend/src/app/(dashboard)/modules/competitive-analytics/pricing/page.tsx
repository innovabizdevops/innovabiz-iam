...
const PAGE = "Pricing Intel";
const KPIS = [{"l":"ARR (€M)","v":"€44.2M","t":"-1.7%","d":"down"},{"l":"MRR (€)","v":"€83996","t":"+2.3%","d":"up"},{"l":"Churn (%)","v":"87.0%","t":"+3.9%","d":"up"},{"l":"ARPU (€)","v":"€64655","t":"+10.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3248.65","8.377","€ 27355.37","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 26024.87","5.683","€ 23042.08","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23551.84","6.863","€ 40599.65","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 41196.56","1.792","€ 43126.28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 27474.68","3.973","€ 36807.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":671},{"label":"Mar","value":617},{"label":"Abr","value":566},{"label":"Mai","value":381},{"label":"Jun","value":565},{"label":"Jul","value":430},{"label":"Ago","value":671},{"label":"Set","value":573},{"label":"Out","value":382},{"label":"Nov","value":548},{"label":"Dez","value":441}];
const MX = 671;
