...
const ACCENT = "#4338ca";
const MODULE = "Competitive Analytics Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Dashboards Ativos","v":"1.233","t":"+12.2%","d":"up"},{"l":"Queries/Dia","v":"1014","t":"+12.7%","d":"up"},{"l":"Dados Processados (GB)","v":"1.518","t":"+0.5%","d":"up"},{"l":"Utilizadores Analytics","v":"2.124","t":"-2.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2080","2026-03-14","2.144","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1549","2026-01-19","3.629","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2302","2026-01-17","7.237","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3519","2026-02-23","4.332","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","859","2026-01-08","2.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":543},{"label":"Mar","value":705},{"label":"Abr","value":670},{"label":"Mai","value":786},{"label":"Jun","value":507},{"label":"Jul","value":658},{"label":"Ago","value":581},{"label":"Set","value":735},{"label":"Out","value":540},{"label":"Nov","value":569},{"label":"Dez","value":623}];
const MX = 786;
