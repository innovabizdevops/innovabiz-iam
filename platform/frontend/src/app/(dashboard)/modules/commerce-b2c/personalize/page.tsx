...
const ACCENT = "#00a1e0";
const MODULE = "Commerce B2C (Salesforce B2C)";
const PAGE = "Personalize";
const KPIS = [{"l":"Pedidos/Dia","v":"3875","t":"+12.4%","d":"up"},{"l":"GMV (€)","v":"€85912","t":"+9.8%","d":"up"},{"l":"Conversão (%)","v":"66.4%","t":"+5.7%","d":"up"},{"l":"AOV (€)","v":"€21678","t":"+6.3%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 8079.92","5.276","6.117","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 19903.84","7.363","5.481","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 38908.72","496","2.133","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20895.02","7.879","2.217","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 31123.09","1.499","6.632","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":1004},{"label":"Mar","value":865},{"label":"Abr","value":660},{"label":"Mai","value":973},{"label":"Jun","value":906},{"label":"Jul","value":897},{"label":"Ago","value":794},{"label":"Set","value":839},{"label":"Out","value":680},{"label":"Nov","value":943},{"label":"Dez","value":700}];
const MX = 1004;
