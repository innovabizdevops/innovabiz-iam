...
const PAGE = "Cart";
const KPIS = [{"l":"Pedidos/Dia","v":"866","t":"+5.8%","d":"up"},{"l":"GMV (€)","v":"€7604","t":"+11.9%","d":"up"},{"l":"Conversão (%)","v":"75.7%","t":"+1.0%","d":"up"},{"l":"AOV (€)","v":"€97303","t":"-1.1%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 23887.38","5.663","6.462","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 32761.49","216","4.508","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41181.69","3.361","5.811","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 47375.28","159","6.911","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20556.44","595","6.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":610},{"label":"Mar","value":425},{"label":"Abr","value":640},{"label":"Mai","value":549},{"label":"Jun","value":534},{"label":"Jul","value":568},{"label":"Ago","value":698},{"label":"Set","value":644},{"label":"Out","value":491},{"label":"Nov","value":603},{"label":"Dez","value":560}];
const MX = 698;
