...
/* ═══ Commerce B2C (Salesforce B2C) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "5148", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3475", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€326K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "383293448", cells: ["COM-2448", "Commerce B2C (Salesforce B2C) Item 1", "21/9/2026", "€43 548"], status: "active" as const },
    { id: "383297019", cells: ["COM-6019", "Commerce B2C (Salesforce B2C) Item 2", "8/4/2026", "€47 119"], status: "pending" as const },
    { id: "383300590", cells: ["COM-9590", "Commerce B2C (Salesforce B2C) Item 3", "23/11/2026", "€690"], status: "completed" as const },
    { id: "383304161", cells: ["COM-4161", "Commerce B2C (Salesforce B2C) Item 4", "10/6/2026", "€4261"], status: "warning" as const },
    { id: "383307732", cells: ["COM-7732", "Commerce B2C (Salesforce B2C) Item 5", "25/1/2026", "€7832"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 28 }, { label: "Fev", value: 37 }, { label: "Mar", value: 46 }, { label: "Abr", value: 55 }, { label: "Mai", value: 64 }, { label: "Jun", value: 73 }];
...
export default function CommerceB2cSalesforceB2cPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Commerce B2C (Salesforce B2C)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Commerce B2C (Salesforce B2C)</p>
                    </div>
                </div>
