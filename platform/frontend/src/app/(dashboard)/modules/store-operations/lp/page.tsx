...
const PAGE = "Loss Prevent";
const KPIS = [{"l":"Pedidos/Dia","v":"4707","t":"-3.2%","d":"down"},{"l":"GMV (€)","v":"€61379","t":"+0.4%","d":"up"},{"l":"Conversão (%)","v":"78.3%","t":"+5.4%","d":"up"},{"l":"AOV (€)","v":"€47597","t":"-5.2%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 34257.13","8.565","5.816","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27766.09","1.340","483","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 7355.68","8.543","6.539","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 17379.26","7.667","4.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 10662.27","7.754","4.606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":704},{"label":"Mar","value":672},{"label":"Abr","value":321},{"label":"Mai","value":399},{"label":"Jun","value":335},{"label":"Jul","value":545},{"label":"Ago","value":486},{"label":"Set","value":569},{"label":"Out","value":598},{"label":"Nov","value":421},{"label":"Dez","value":653}];
const MX = 704;
