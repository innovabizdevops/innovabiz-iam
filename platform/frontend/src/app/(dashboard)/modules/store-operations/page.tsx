...
const KPIS = [
    { label: "Total Registos", value: "2833", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1528", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€500K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "817495233", cells: ["STO-8233", "Store Operations Item 1", "10/10/2026", "€45 333"], status: "active" as const },
    { id: "817498804", cells: ["STO-2804", "Store Operations Item 2", "25/5/2026", "€48 904"], status: "pending" as const },
    { id: "817502375", cells: ["STO-6375", "Store Operations Item 3", "12/12/2026", "€2475"], status: "completed" as const },
    { id: "817505946", cells: ["STO-9946", "Store Operations Item 4", "27/7/2026", "€6046"], status: "warning" as const },
    { id: "817509517", cells: ["STO-4517", "Store Operations Item 5", "14/2/2026", "€9617"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Store Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Store Operations</p>
                    </div>
                </div>
