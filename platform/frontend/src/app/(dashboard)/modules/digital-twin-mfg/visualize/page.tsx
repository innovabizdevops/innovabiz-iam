...
const KPIS = [{"l":"Twins Ativos","v":"9.061","t":"+5.4%","d":"up"},{"l":"Simulações/Dia","v":"1831","t":"+12.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"83.5%","t":"-3.0%","d":"down"},{"l":"Latência Sync (ms)","v":"147ms","t":"+12.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","88.4%","2026-03-16","6.398","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.9%","2026-03-05","9.091","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","91.0%","2026-01-16","5.095","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","76.4%","2026-02-05","7.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","73.8%","2026-01-26","3.706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":382},{"label":"Mar","value":621},{"label":"Abr","value":341},{"label":"Mai","value":405},{"label":"Jun","value":330},{"label":"Jul","value":507},{"label":"Ago","value":263},{"label":"Set","value":618},{"label":"Out","value":541},{"label":"Nov","value":577},{"label":"Dez","value":311}];
const MX = 621;
