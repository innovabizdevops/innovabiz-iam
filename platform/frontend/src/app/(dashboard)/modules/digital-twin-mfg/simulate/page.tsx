...
const PAGE = "Simulate";
const KPIS = [{"l":"Twins Ativos","v":"2.348","t":"-2.4%","d":"down"},{"l":"Simulações/Dia","v":"4233","t":"-4.5%","d":"down"},{"l":"Precisão Modelo (%)","v":"77.4%","t":"+3.9%","d":"up"},{"l":"Latência Sync (ms)","v":"79ms","t":"-3.3%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.1%","2026-01-21","6.491","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","76.0%","2026-03-12","7.316","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","84.8%","2026-03-11","3.617","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","96.3%","2026-03-20","657","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","80.7%","2026-03-17","4.927","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":633},{"label":"Mar","value":615},{"label":"Abr","value":720},{"label":"Mai","value":855},{"label":"Jun","value":844},{"label":"Jul","value":950},{"label":"Ago","value":793},{"label":"Set","value":805},{"label":"Out","value":969},{"label":"Nov","value":612},{"label":"Dez","value":716}];
const MX = 969;
