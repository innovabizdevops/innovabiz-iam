...
const PAGE = "Optimize";
const KPIS = [{"l":"Twins Ativos","v":"3.256","t":"+6.2%","d":"up"},{"l":"Simulações/Dia","v":"2564","t":"+4.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"93.7%","t":"+3.3%","d":"up"},{"l":"Latência Sync (ms)","v":"33ms","t":"+12.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","79.0%","2026-03-26","3.070","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.5%","2026-01-21","6.951","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","94.0%","2026-03-27","2.015","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","86.0%","2026-02-05","6.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","89.6%","2026-01-11","8.635","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":579},{"label":"Mar","value":764},{"label":"Abr","value":733},{"label":"Mai","value":781},{"label":"Jun","value":639},{"label":"Jul","value":770},{"label":"Ago","value":545},{"label":"Set","value":708},{"label":"Out","value":536},{"label":"Nov","value":493},{"label":"Dez","value":531}];
const MX = 781;
