...
const PAGE = "Model";
const KPIS = [{"l":"Twins Ativos","v":"8.789","t":"+3.5%","d":"up"},{"l":"Simulações/Dia","v":"5040","t":"+4.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"65.9%","t":"-2.0%","d":"down"},{"l":"Latência Sync (ms)","v":"59ms","t":"+7.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","96.9%","2026-03-28","1.750","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","93.4%","2026-03-20","2.163","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.2%","2026-01-23","654","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","74.7%","2026-02-02","4.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","97.2%","2026-02-19","4.592","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":757},{"label":"Mar","value":418},{"label":"Abr","value":730},{"label":"Mai","value":452},{"label":"Jun","value":734},{"label":"Jul","value":773},{"label":"Ago","value":646},{"label":"Set","value":497},{"label":"Out","value":472},{"label":"Nov","value":764},{"label":"Dez","value":569}];
const MX = 773;
