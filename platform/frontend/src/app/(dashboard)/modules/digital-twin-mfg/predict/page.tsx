...
const ACCENT = "#6366f1";
const MODULE = "Digital Twin Mfg";
const PAGE = "Predict";
const KPIS = [{"l":"Twins Ativos","v":"1.551","t":"-0.9%","d":"down"},{"l":"Simulações/Dia","v":"5057","t":"+12.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"84.4%","t":"+1.1%","d":"up"},{"l":"Latência Sync (ms)","v":"12ms","t":"+6.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","81.8%","2026-03-03","2.345","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","83.4%","2026-02-26","4.279","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","74.5%","2026-02-28","8.600","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","82.9%","2026-01-05","817","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","87.4%","2026-03-09","1.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":391},{"label":"Mar","value":220},{"label":"Abr","value":420},{"label":"Mai","value":526},{"label":"Jun","value":388},{"label":"Jul","value":358},{"label":"Ago","value":412},{"label":"Set","value":508},{"label":"Out","value":358},{"label":"Nov","value":599},{"label":"Dez","value":533}];
const MX = 599;
