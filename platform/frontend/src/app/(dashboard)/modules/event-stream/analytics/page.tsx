...
const ACCENT = "#6366f1";
const MODULE = "Event Streaming";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"8.572","t":"+4.2%","d":"up"},{"l":"Queries/Dia","v":"4396","t":"+12.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.553","t":"-0.1%","d":"down"},{"l":"Utilizadores Analytics","v":"1.081","t":"+10.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1534","2026-02-13","7.222","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2643","2026-01-15","1.006","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","261","2026-02-02","1.238","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4152","2026-03-15","8.023","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4895","2026-02-28","6.602","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":863},{"label":"Mar","value":858},{"label":"Abr","value":750},{"label":"Mai","value":908},{"label":"Jun","value":845},{"label":"Jul","value":602},{"label":"Ago","value":955},{"label":"Set","value":628},{"label":"Out","value":831},{"label":"Nov","value":980},{"label":"Dez","value":670}];
const MX = 980;
