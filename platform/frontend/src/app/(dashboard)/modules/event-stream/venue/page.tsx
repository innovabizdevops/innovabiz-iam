...
const PAGE = "Virtual Venue";
const KPIS = [{"l":"Eventos Planeados","v":"4.290","t":"+3.8%","d":"up"},{"l":"Participantes","v":"3.199","t":"+6.9%","d":"up"},{"l":"NPS Evento","v":"67","t":"-4.9%","d":"down"},{"l":"Receita (€)","v":"€78289","t":"+4.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-24","4.307","6.067","€ 8184.52","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-09","8.281","610","€ 28997.87","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-19","2.509","1.686","€ 23238.44","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-02","1.153","381","€ 22212.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-28","5.782","481","€ 5955.36","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":772},{"label":"Mar","value":1032},{"label":"Abr","value":825},{"label":"Mai","value":768},{"label":"Jun","value":905},{"label":"Jul","value":865},{"label":"Ago","value":804},{"label":"Set","value":1017},{"label":"Out","value":740},{"label":"Nov","value":857},{"label":"Dez","value":963}];
const MX = 1032;
