...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"733","t":"+17.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.5%","t":"+12.8%","d":"up"},{"l":"MTTR (h)","v":"193h","t":"+3.1%","d":"up"},{"l":"Satisfação (%)","v":"74.5%","t":"+13.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.678","442","2.411","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.269","8.483","9.070","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.395","8.489","3.917","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.896","289","3.981","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.643","9.060","1.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":902},{"label":"Mar","value":640},{"label":"Abr","value":618},{"label":"Mai","value":825},{"label":"Jun","value":740},{"label":"Jul","value":811},{"label":"Ago","value":893},{"label":"Set","value":667},{"label":"Out","value":700},{"label":"Nov","value":815},{"label":"Dez","value":914}];
const MX = 914;
