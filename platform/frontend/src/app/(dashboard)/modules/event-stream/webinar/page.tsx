...
const PAGE = "Webinar";
const KPIS = [{"l":"Eventos Planeados","v":"3.915","t":"+6.2%","d":"up"},{"l":"Participantes","v":"5.390","t":"+7.8%","d":"up"},{"l":"NPS Evento","v":"67","t":"+5.5%","d":"up"},{"l":"Receita (€)","v":"€56783","t":"+9.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-24","2.132","269","€ 9288.72","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-26","3.158","6.821","€ 47691.56","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-05","8.298","1.909","€ 22925.47","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-25","3.383","286","€ 41162.44","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-20","3.663","5.419","€ 15560.54","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":449},{"label":"Fev","value":628},{"label":"Mar","value":532},{"label":"Abr","value":720},{"label":"Mai","value":742},{"label":"Jun","value":675},{"label":"Jul","value":620},{"label":"Ago","value":617},{"label":"Set","value":677},{"label":"Out","value":532},{"label":"Nov","value":404},{"label":"Dez","value":537}];
const MX = 742;
