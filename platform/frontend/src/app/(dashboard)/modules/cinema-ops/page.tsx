...
export default function CinemaOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cinema Ops</h1><p className="text-sm text-muted-foreground">Cinema Ops • iBOS Enterprise</p></div>
