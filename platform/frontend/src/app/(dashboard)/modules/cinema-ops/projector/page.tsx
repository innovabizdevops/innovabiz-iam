...
const ACCENT = "#6366f1";
const MODULE = "Cinema Operations";
const PAGE = "Projector";
const KPIS = [{"l":"Total Cinema Ops","v":"706","t":"+5.3%","d":"up"},{"l":"Projector Ativos","v":"3.149","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"62","t":"+9.8%","d":"up"}];
const COLS = ["ID","Projector","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cinema Ops #001","Cinema Ops #002","6.002","368","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Cinema Ops #002","Cinema Ops #003","115","4.274","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cinema Ops #003","Cinema Ops #004","8.368","433","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Cinema Ops #004","Cinema Ops #005","8.503","7.385","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cinema Ops #005","Cinema Ops #001","8.504","4.435","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":764},{"label":"Mar","value":492},{"label":"Abr","value":682},{"label":"Mai","value":712},{"label":"Jun","value":494},{"label":"Jul","value":714},{"label":"Ago","value":675},{"label":"Set","value":506},{"label":"Out","value":569},{"label":"Nov","value":541},{"label":"Dez","value":512}];
const MX = 764;
