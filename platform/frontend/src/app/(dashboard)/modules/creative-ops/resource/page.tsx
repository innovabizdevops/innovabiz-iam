...
const ACCENT = "#b45309";
const MODULE = "Creative Operations";
const PAGE = "Resource Book";
const KPIS = [{"l":"Total Creative Ops","v":"6.835","t":"+11.2%","d":"up"},{"l":"Resource Book Ativos","v":"8.488","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"62","t":"-3.3%","d":"down"}];
const COLS = ["ID","Resource Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Creative Ops #001","Creative Ops #002","2.127","3.750","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Creative Ops #002","Creative Ops #003","3.048","1.555","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Creative Ops #003","Creative Ops #004","3.835","6.771","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Creative Ops #004","Creative Ops #005","1.511","313","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Creative Ops #005","Creative Ops #001","1.671","5.283","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":742},{"label":"Mar","value":526},{"label":"Abr","value":749},{"label":"Mai","value":824},{"label":"Jun","value":746},{"label":"Jul","value":645},{"label":"Ago","value":796},{"label":"Set","value":750},{"label":"Out","value":631},{"label":"Nov","value":596},{"label":"Dez","value":620}];
const MX = 824;
