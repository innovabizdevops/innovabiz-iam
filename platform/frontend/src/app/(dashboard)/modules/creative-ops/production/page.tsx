...
const KPIS = [{"l":"Total Creative Ops","v":"6.218","t":"+8.8%","d":"up"},{"l":"Production Ativos","v":"2.343","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"78","t":"+14.6%","d":"up"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Creative Ops #001","Creative Ops #002","8.125","4.651","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Creative Ops #002","Creative Ops #003","6.411","6.493","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Creative Ops #003","Creative Ops #004","5.985","3.564","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Creative Ops #004","Creative Ops #005","2.046","808","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Creative Ops #005","Creative Ops #001","4.421","3.464","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":480},{"label":"Mar","value":596},{"label":"Abr","value":245},{"label":"Mai","value":493},{"label":"Jun","value":272},{"label":"Jul","value":323},{"label":"Ago","value":592},{"label":"Set","value":401},{"label":"Out","value":585},{"label":"Nov","value":295},{"label":"Dez","value":399}];
const MX = 596;
