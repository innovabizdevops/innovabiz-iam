...
const PAGE = "DAM Link";
const KPIS = [{"l":"Total Creative Ops","v":"550","t":"+7.8%","d":"up"},{"l":"DAM Link Ativos","v":"2.503","t":"+9.9%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"59","t":"+2.5%","d":"up"}];
const COLS = ["ID","DAM Link","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Creative Ops #001","Creative Ops #002","2.764","5.996","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Creative Ops #002","Creative Ops #003","492","4.246","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Creative Ops #003","Creative Ops #004","9.052","1.511","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Creative Ops #004","Creative Ops #005","6.697","5.993","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Creative Ops #005","Creative Ops #001","6.600","1.232","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":845},{"label":"Mar","value":1032},{"label":"Abr","value":938},{"label":"Mai","value":660},{"label":"Jun","value":648},{"label":"Jul","value":993},{"label":"Ago","value":920},{"label":"Set","value":756},{"label":"Out","value":948},{"label":"Nov","value":917},{"label":"Dez","value":790}];
const MX = 1032;
