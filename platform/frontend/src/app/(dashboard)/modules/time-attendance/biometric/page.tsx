...
const PAGE = "Biometric Reader";
const KPIS = [{"l":"Total Time Attendance","v":"6.493","t":"+16.2%","d":"up"},{"l":"Biometric Reader Ativos","v":"5.561","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.7%","d":"up"}];
const COLS = ["ID","Biometric Reader","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Attendance #001","Time Attendance #002","3.851","1.837","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Time Attendance #002","Time Attendance #003","7.519","4.095","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Attendance #003","Time Attendance #004","871","2.300","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Time Attendance #004","Time Attendance #005","6.136","539","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Attendance #005","Time Attendance #001","4.079","1.335","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":406},{"label":"Mar","value":760},{"label":"Abr","value":594},{"label":"Mai","value":516},{"label":"Jun","value":649},{"label":"Jul","value":660},{"label":"Ago","value":762},{"label":"Set","value":558},{"label":"Out","value":743},{"label":"Nov","value":779},{"label":"Dez","value":780}];
const MX = 780;
