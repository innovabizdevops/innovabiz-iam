...
const PAGE = "Geo-Fence";
const KPIS = [{"l":"Total Time Attendance","v":"3.012","t":"+6.2%","d":"up"},{"l":"Geo Fence Ativos","v":"8.760","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"71","t":"-5.2%","d":"down"}];
const COLS = ["ID","Geo Fence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Attendance #001","Time Attendance #002","6.017","5.352","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Time Attendance #002","Time Attendance #003","4.465","6.899","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Attendance #003","Time Attendance #004","1.292","4.291","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Time Attendance #004","Time Attendance #005","6.633","8.507","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Attendance #005","Time Attendance #001","8.261","4.626","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":696},{"label":"Mar","value":738},{"label":"Abr","value":491},{"label":"Mai","value":453},{"label":"Jun","value":448},{"label":"Jul","value":458},{"label":"Ago","value":781},{"label":"Set","value":738},{"label":"Out","value":550},{"label":"Nov","value":610},{"label":"Dez","value":497}];
const MX = 781;
