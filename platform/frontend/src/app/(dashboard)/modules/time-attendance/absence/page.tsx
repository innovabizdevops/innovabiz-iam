...
const ACCENT = "#475569";
const MODULE = "Time & Attendance";
const PAGE = "Absence Pattern";
const KPIS = [{"l":"Total Time Attendance","v":"689","t":"+8.4%","d":"up"},{"l":"Absence Pattern Ativos","v":"3.217","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"89","t":"+0.3%","d":"up"}];
const COLS = ["ID","Absence Pattern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Time Attendance #001","Time Attendance #002","2.155","7.561","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Time Attendance #002","Time Attendance #003","4.892","6.180","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Time Attendance #003","Time Attendance #004","5.543","6.625","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Time Attendance #004","Time Attendance #005","4.041","3.329","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Time Attendance #005","Time Attendance #001","2.017","5.583","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":546},{"label":"Mar","value":627},{"label":"Abr","value":627},{"label":"Mai","value":724},{"label":"Jun","value":745},{"label":"Jul","value":572},{"label":"Ago","value":654},{"label":"Set","value":901},{"label":"Out","value":623},{"label":"Nov","value":657},{"label":"Dez","value":522}];
const MX = 901;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#475569'}}>AI</span></h1>
                </div>
