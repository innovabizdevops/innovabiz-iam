...
const PAGE = "Revenue Mgmt";
const KPIS = [{"l":"ARR (€M)","v":"€3.4M","t":"+9.2%","d":"up"},{"l":"MRR (€)","v":"€52776","t":"+15.0%","d":"up"},{"l":"Churn (%)","v":"83.4%","t":"+9.5%","d":"up"},{"l":"ARPU (€)","v":"€89200","t":"+5.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30049.27","7.371","€ 39214.22","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27860.08","5.012","€ 10606.20","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 31232.67","2.551","€ 33338.90","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 18233.02","2.235","€ 41585.74","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 3120.16","502","€ 13993.55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":412},{"label":"Mar","value":693},{"label":"Abr","value":464},{"label":"Mai","value":703},{"label":"Jun","value":407},{"label":"Jul","value":761},{"label":"Ago","value":745},{"label":"Set","value":479},{"label":"Out","value":761},{"label":"Nov","value":533},{"label":"Dez","value":489}];
const MX = 761;
