...
const PAGE = "PMS (Property Mgmt)";
const KPIS = [{"l":"Quartos Ocupados","v":"5.649","t":"+2.6%","d":"up"},{"l":"RevPAR (€)","v":"€93001","t":"-4.6%","d":"down"},{"l":"Ocupação (%)","v":"75.6%","t":"+12.5%","d":"up"},{"l":"Guest Satisfaction","v":"6.936","t":"+3.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.889","2026-03-15","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.678","2026-02-16","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.663","2026-01-16","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.905","2026-02-17","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.121","2026-03-11","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":776},{"label":"Mar","value":719},{"label":"Abr","value":783},{"label":"Mai","value":696},{"label":"Jun","value":632},{"label":"Jul","value":811},{"label":"Ago","value":534},{"label":"Set","value":871},{"label":"Out","value":735},{"label":"Nov","value":625},{"label":"Dez","value":772}];
const MX = 871;
