...
const PAGE = "Revenue Per Available Room";
const KPIS = [{"l":"ARR (€M)","v":"€49.9M","t":"+9.5%","d":"up"},{"l":"MRR (€)","v":"€60835","t":"+7.7%","d":"up"},{"l":"Churn (%)","v":"85.5%","t":"+13.1%","d":"up"},{"l":"ARPU (€)","v":"€2926","t":"+17.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 28815.34","8.026","€ 45536.11","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37467.58","6.427","€ 19132.72","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40723.46","3.263","€ 6048.30","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6655.50","1.565","€ 3798.70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 8885.53","5.104","€ 16639.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":409},{"label":"Mar","value":621},{"label":"Abr","value":306},{"label":"Mai","value":674},{"label":"Jun","value":540},{"label":"Jul","value":285},{"label":"Ago","value":628},{"label":"Set","value":309},{"label":"Out","value":499},{"label":"Nov","value":326},{"label":"Dez","value":404}];
const MX = 674;
...
export default function RevparPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>KPI</span></h1>
                </div>
