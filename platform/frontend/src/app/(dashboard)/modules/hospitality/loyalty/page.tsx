...
const PAGE = "Loyalty Engine";
const KPIS = [{"l":"Total Hospitality","v":"284","t":"+12.8%","d":"up"},{"l":"Loyalty Engine Ativos","v":"2.367","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"66.9%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"86","t":"-2.3%","d":"down"}];
const COLS = ["ID","Loyalty Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospitality #001","Hospitality #002","2.361","2.360","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Hospitality #002","Hospitality #003","2.551","8.356","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospitality #003","Hospitality #004","5.333","4.019","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Hospitality #004","Hospitality #005","877","958","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospitality #005","Hospitality #001","4.654","4.680","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":747},{"label":"Mar","value":866},{"label":"Abr","value":1065},{"label":"Mai","value":906},{"label":"Jun","value":833},{"label":"Jul","value":907},{"label":"Ago","value":859},{"label":"Set","value":959},{"label":"Out","value":961},{"label":"Nov","value":1080},{"label":"Dez","value":1014}];
const MX = 1080;
