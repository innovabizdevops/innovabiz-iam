...
const KPIS = [{"l":"ARR (€M)","v":"€7.8M","t":"-3.7%","d":"down"},{"l":"MRR (€)","v":"€2393","t":"+13.5%","d":"up"},{"l":"Churn (%)","v":"91.9%","t":"+2.7%","d":"up"},{"l":"ARPU (€)","v":"€66090","t":"+12.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 39370.39","4.297","€ 12840.22","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27356.12","8.711","€ 24106.93","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 27949.64","7.157","€ 8580.73","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 36510.31","579","€ 43988.73","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 9097.63","1.158","€ 43529.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":379},{"label":"Mar","value":469},{"label":"Abr","value":381},{"label":"Mai","value":348},{"label":"Jun","value":422},{"label":"Jul","value":372},{"label":"Ago","value":304},{"label":"Set","value":284},{"label":"Out","value":446},{"label":"Nov","value":567},{"label":"Dez","value":400}];
const MX = 567;
