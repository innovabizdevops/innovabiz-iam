...
const KPIS = [{"l":"Total Hospitality","v":"8.978","t":"+15.9%","d":"up"},{"l":"Event & Banquet Ativos","v":"3.882","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"64","t":"+0.2%","d":"up"}];
const COLS = ["ID","Event & Banquet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospitality #001","Hospitality #002","5.814","5.717","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Hospitality #002","Hospitality #003","5.813","1.820","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospitality #003","Hospitality #004","3.151","3.148","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Hospitality #004","Hospitality #005","4.755","7.841","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospitality #005","Hospitality #001","1.798","7.748","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":566},{"label":"Mar","value":388},{"label":"Abr","value":347},{"label":"Mai","value":369},{"label":"Jun","value":391},{"label":"Jul","value":293},{"label":"Ago","value":546},{"label":"Set","value":471},{"label":"Out","value":356},{"label":"Nov","value":659},{"label":"Dez","value":450}];
const MX = 659;
