...
const KPIS = [{"l":"Quartos Ocupados","v":"9.054","t":"+16.4%","d":"up"},{"l":"RevPAR (€)","v":"€69250","t":"+5.7%","d":"up"},{"l":"Ocupação (%)","v":"67.5%","t":"+6.3%","d":"up"},{"l":"Guest Satisfaction","v":"4.597","t":"-0.8%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.462","2026-03-14","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.956","2026-01-17","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.652","2026-01-01","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.072","2026-03-15","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.653","2026-03-20","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":516},{"label":"Mar","value":533},{"label":"Abr","value":411},{"label":"Mai","value":579},{"label":"Jun","value":469},{"label":"Jul","value":631},{"label":"Ago","value":293},{"label":"Set","value":671},{"label":"Out","value":439},{"label":"Nov","value":484},{"label":"Dez","value":337}];
const MX = 671;
