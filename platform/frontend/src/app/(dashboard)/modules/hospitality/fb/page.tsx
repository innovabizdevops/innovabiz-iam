...
const PAGE = "F&amp;B Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.590","t":"-2.1%","d":"down"},{"l":"Savings (€)","v":"€3200","t":"+3.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.1%","t":"+6.5%","d":"up"},{"l":"Ciclos PDCA","v":"7.108","t":"+4.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","644","€ 22864.55","8.282","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.040","€ 47954.95","8.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.804","€ 15005.50","8.408","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.704","€ 15462.02","4.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.522","€ 43804.41","5.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":860},{"label":"Mar","value":677},{"label":"Abr","value":653},{"label":"Mai","value":575},{"label":"Jun","value":798},{"label":"Jul","value":690},{"label":"Ago","value":635},{"label":"Set","value":781},{"label":"Out","value":686},{"label":"Nov","value":806},{"label":"Dez","value":730}];
const MX = 860;
