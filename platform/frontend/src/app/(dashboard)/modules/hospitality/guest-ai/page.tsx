...
const PAGE = "Guest Experience AI";
const KPIS = [{"l":"Perfis Unificados","v":"5.164","t":"+5.2%","d":"up"},{"l":"Segmentos Ativos","v":"5.049","t":"-4.8%","d":"down"},{"l":"NPS Score","v":"71","t":"+16.2%","d":"up"},{"l":"Churn Previsto (%)","v":"70.3%","t":"+0.0%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.449","€ 41919.33","77.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.651","€ 14599.76","99.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.628","€ 28088.45","70.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.689","€ 13675.33","85.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.019","€ 32669.91","97.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":1080},{"label":"Mar","value":834},{"label":"Abr","value":833},{"label":"Mai","value":1002},{"label":"Jun","value":886},{"label":"Jul","value":810},{"label":"Ago","value":776},{"label":"Set","value":948},{"label":"Out","value":1062},{"label":"Nov","value":940},{"label":"Dez","value":908}];
const MX = 1080;
