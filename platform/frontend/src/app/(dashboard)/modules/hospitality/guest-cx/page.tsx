...
const ACCENT = "#9333ea";
const MODULE = "Hospitality & Tourism";
const PAGE = "Guest Experience";
const KPIS = [{"l":"Perfis Unificados","v":"2.730","t":"+17.0%","d":"up"},{"l":"Segmentos Ativos","v":"4.667","t":"+1.9%","d":"up"},{"l":"NPS Score","v":"93","t":"-0.2%","d":"down"},{"l":"Churn Previsto (%)","v":"75.5%","t":"-4.2%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.737","€ 26328.44","74.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.584","€ 34213.69","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","558","€ 3527.87","92.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","7.721","€ 24694.56","82.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","416","€ 43182.94","75.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":575},{"label":"Mar","value":856},{"label":"Abr","value":934},{"label":"Mai","value":596},{"label":"Jun","value":888},{"label":"Jul","value":638},{"label":"Ago","value":646},{"label":"Set","value":572},{"label":"Out","value":812},{"label":"Nov","value":683},{"label":"Dez","value":770}];
const MX = 934;
...
export default function GuestCxPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#9333ea'}}>CX</span></h1>
                </div>
