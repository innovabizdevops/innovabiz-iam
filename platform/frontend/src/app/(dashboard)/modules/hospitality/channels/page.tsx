...
const KPIS = [{"l":"Total Hospitality","v":"6.428","t":"+4.9%","d":"up"},{"l":"Channel Manager Ativos","v":"8.059","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"78","t":"+6.4%","d":"up"}];
const COLS = ["ID","Channel Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospitality #001","Hospitality #002","1.184","2.018","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Hospitality #002","Hospitality #003","7.345","3.082","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospitality #003","Hospitality #004","8.633","4.111","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Hospitality #004","Hospitality #005","8.913","2.359","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospitality #005","Hospitality #001","1.305","4.973","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":1027},{"label":"Mar","value":864},{"label":"Abr","value":872},{"label":"Mai","value":806},{"label":"Jun","value":960},{"label":"Jul","value":764},{"label":"Ago","value":910},{"label":"Set","value":867},{"label":"Out","value":712},{"label":"Nov","value":782},{"label":"Dez","value":1024}];
const MX = 1027;
