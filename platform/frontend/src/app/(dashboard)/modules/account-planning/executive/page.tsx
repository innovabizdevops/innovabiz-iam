...
const PAGE = "Executive";
const KPIS = [{"l":"Total Account Planning","v":"4.004","t":"+5.6%","d":"up"},{"l":"Executive Ativos","v":"992","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"86","t":"-1.5%","d":"down"}];
const COLS = ["ID","Executive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Account Planning #001","Account Planning #002","2.661","7.592","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Account Planning #002","Account Planning #003","2.939","2.117","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Account Planning #003","Account Planning #004","1.494","6.109","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Account Planning #004","Account Planning #005","8.805","3.999","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Account Planning #005","Account Planning #001","3.803","6.953","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":664},{"label":"Mar","value":854},{"label":"Abr","value":847},{"label":"Mai","value":915},{"label":"Jun","value":799},{"label":"Jul","value":895},{"label":"Ago","value":942},{"label":"Set","value":940},{"label":"Out","value":633},{"label":"Nov","value":870},{"label":"Dez","value":887}];
const MX = 942;
