...
const PAGE = "Whitespace";
const KPIS = [{"l":"Quartos Ocupados","v":"5.476","t":"+4.0%","d":"up"},{"l":"RevPAR (€)","v":"€43647","t":"-1.4%","d":"down"},{"l":"Ocupação (%)","v":"76.9%","t":"+5.8%","d":"up"},{"l":"Guest Satisfaction","v":"6.899","t":"+3.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","129","2026-03-22","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.278","2026-01-15","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.951","2026-02-14","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.938","2026-03-12","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.748","2026-02-05","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1043},{"label":"Fev","value":996},{"label":"Mar","value":851},{"label":"Abr","value":749},{"label":"Mai","value":733},{"label":"Jun","value":1001},{"label":"Jul","value":697},{"label":"Ago","value":720},{"label":"Set","value":736},{"label":"Out","value":890},{"label":"Nov","value":1054},{"label":"Dez","value":840}];
const MX = 1054;
