...
const PAGE = "360 View";
const KPIS = [{"l":"Total Account Planning","v":"3.751","t":"+6.9%","d":"up"},{"l":"360 View Ativos","v":"4.397","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"92","t":"-0.3%","d":"down"}];
const COLS = ["ID","360 View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Account Planning #001","Account Planning #002","546","7.615","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Account Planning #002","Account Planning #003","8.560","2.969","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Account Planning #003","Account Planning #004","3.788","657","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Account Planning #004","Account Planning #005","1.835","3.822","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Account Planning #005","Account Planning #001","8.596","8.570","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":518},{"label":"Mar","value":646},{"label":"Abr","value":576},{"label":"Mai","value":307},{"label":"Jun","value":286},{"label":"Jul","value":445},{"label":"Ago","value":523},{"label":"Set","value":360},{"label":"Out","value":572},{"label":"Nov","value":651},{"label":"Dez","value":626}];
const MX = 651;
