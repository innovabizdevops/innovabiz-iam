...
const KPIS = [
    { label: "Total Registos", value: "4320", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "877", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€74K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "795568220", cells: ["ACC-5220", "Account Planning Item 1", "21/9/2026", "€18 320"], status: "active" as const },
    { id: "795571791", cells: ["ACC-8791", "Account Planning Item 2", "8/4/2026", "€21 891"], status: "pending" as const },
    { id: "795575362", cells: ["ACC-3362", "Account Planning Item 3", "23/11/2026", "€25 462"], status: "completed" as const },
    { id: "795578933", cells: ["ACC-6933", "Account Planning Item 4", "10/6/2026", "€29 033"], status: "warning" as const },
    { id: "795582504", cells: ["ACC-1504", "Account Planning Item 5", "25/1/2026", "€32 604"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Account Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Account Planning</p>
                    </div>
                </div>
