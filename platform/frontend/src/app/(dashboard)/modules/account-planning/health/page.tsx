...
const ACCENT = "#00a1e0";
const MODULE = "Account Planning";
const PAGE = "Health Score";
const KPIS = [{"l":"Total Account Planning","v":"6.181","t":"+0.5%","d":"up"},{"l":"Health Score Ativos","v":"61","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+2.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+10.4%","d":"up"}];
const COLS = ["ID","Health Score","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Account Planning #001","79.9%","6.288","453","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Account Planning #002","79.8%","2.553","5.071","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Account Planning #003","92.4%","1.049","3.337","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Account Planning #004","80.2%","6.254","3.253","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Account Planning #005","78.0%","4.164","5.897","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":897},{"label":"Mar","value":794},{"label":"Abr","value":893},{"label":"Mai","value":629},{"label":"Jun","value":503},{"label":"Jul","value":682},{"label":"Ago","value":786},{"label":"Set","value":845},{"label":"Out","value":723},{"label":"Nov","value":803},{"label":"Dez","value":587}];
const MX = 897;
