...
const PAGE = "Action Plan";
const KPIS = [{"l":"Total Account Planning","v":"6.311","t":"+2.7%","d":"up"},{"l":"Action Plan Ativos","v":"7.603","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.2%","d":"down"}];
const COLS = ["ID","Action Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Account Planning #001","Account Planning #002","5.489","121","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Account Planning #002","Account Planning #003","4.860","7.390","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Account Planning #003","Account Planning #004","5.584","4.168","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Account Planning #004","Account Planning #005","1.003","4.951","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Account Planning #005","Account Planning #001","6.549","5.424","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":1045},{"label":"Mar","value":742},{"label":"Abr","value":662},{"label":"Mai","value":828},{"label":"Jun","value":789},{"label":"Jul","value":1013},{"label":"Ago","value":965},{"label":"Set","value":729},{"label":"Out","value":1003},{"label":"Nov","value":683},{"label":"Dez","value":882}];
const MX = 1045;
