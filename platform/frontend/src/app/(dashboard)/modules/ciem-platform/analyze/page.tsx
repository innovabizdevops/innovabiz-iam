...
const ACCENT = "#7f1d1d";
const MODULE = "CIEM Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Formulários Ativos","v":"393","t":"-3.2%","d":"down"},{"l":"Submissões/Dia","v":"1257","t":"+0.8%","d":"up"},{"l":"Documentos Gerados","v":"1.286","t":"-0.8%","d":"down"},{"l":"Templates","v":"6.604","t":"+9.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.750","2026-02-17","6.228","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.365","2026-02-08","5.945","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.451","2026-02-09","3.732","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.133","2026-03-01","8.716","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.719","2026-02-14","8.088","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":872},{"label":"Mar","value":885},{"label":"Abr","value":776},{"label":"Mai","value":624},{"label":"Jun","value":670},{"label":"Jul","value":581},{"label":"Ago","value":521},{"label":"Set","value":681},{"label":"Out","value":713},{"label":"Nov","value":876},{"label":"Dez","value":763}];
const MX = 885;
