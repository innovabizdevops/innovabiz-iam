...
const PAGE = "Enforce";
const KPIS = [{"l":"Formulários Ativos","v":"2.788","t":"+15.3%","d":"up"},{"l":"Submissões/Dia","v":"290","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"6.772","t":"+7.7%","d":"up"},{"l":"Templates","v":"8.696","t":"+9.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.880","2026-01-10","4.430","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.225","2026-03-04","3.661","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.083","2026-01-22","1.638","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","791","2026-01-06","6.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.402","2026-03-10","4.471","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":541},{"label":"Mar","value":436},{"label":"Abr","value":469},{"label":"Mai","value":406},{"label":"Jun","value":560},{"label":"Jul","value":783},{"label":"Ago","value":667},{"label":"Set","value":467},{"label":"Out","value":607},{"label":"Nov","value":657},{"label":"Dez","value":443}];
const MX = 783;
