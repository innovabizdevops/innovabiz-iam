...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"2.286","t":"+14.2%","d":"up"},{"l":"Submissões/Dia","v":"4343","t":"+11.9%","d":"up"},{"l":"Documentos Gerados","v":"6.878","t":"+7.9%","d":"up"},{"l":"Templates","v":"5.493","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.073","2026-03-13","8.262","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.675","2026-03-09","2.140","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.306","2026-01-10","5.057","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.155","2026-02-12","1.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.812","2026-02-15","4.858","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":759},{"label":"Mar","value":1038},{"label":"Abr","value":972},{"label":"Mai","value":943},{"label":"Jun","value":736},{"label":"Jul","value":884},{"label":"Ago","value":943},{"label":"Set","value":1061},{"label":"Out","value":678},{"label":"Nov","value":731},{"label":"Dez","value":999}];
const MX = 1061;
