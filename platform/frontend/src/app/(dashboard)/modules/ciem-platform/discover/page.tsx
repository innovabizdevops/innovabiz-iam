...
const PAGE = "Discover";
const KPIS = [{"l":"Formulários Ativos","v":"8.589","t":"+11.1%","d":"up"},{"l":"Submissões/Dia","v":"308","t":"+11.0%","d":"up"},{"l":"Documentos Gerados","v":"250","t":"-1.8%","d":"down"},{"l":"Templates","v":"7.578","t":"+5.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.567","2026-01-06","3.989","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.005","2026-03-05","3.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.057","2026-01-01","5.433","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","619","2026-02-22","3.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.642","2026-03-15","901","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":480},{"label":"Mar","value":273},{"label":"Abr","value":567},{"label":"Mai","value":552},{"label":"Jun","value":514},{"label":"Jul","value":336},{"label":"Ago","value":437},{"label":"Set","value":429},{"label":"Out","value":359},{"label":"Nov","value":303},{"label":"Dez","value":290}];
const MX = 567;
