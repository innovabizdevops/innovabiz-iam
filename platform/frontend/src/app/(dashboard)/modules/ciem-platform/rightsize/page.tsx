...
const KPIS = [{"l":"Formulários Ativos","v":"7.303","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"2679","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"4.599","t":"-3.4%","d":"down"},{"l":"Templates","v":"8.199","t":"-1.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.086","2026-01-27","8.443","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.531","2026-02-07","5.862","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.792","2026-01-27","8.039","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.106","2026-01-22","2.248","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.141","2026-02-24","7.905","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":775},{"label":"Mar","value":774},{"label":"Abr","value":886},{"label":"Mai","value":834},{"label":"Jun","value":644},{"label":"Jul","value":777},{"label":"Ago","value":642},{"label":"Set","value":942},{"label":"Out","value":955},{"label":"Nov","value":688},{"label":"Dez","value":719}];
const MX = 955;
