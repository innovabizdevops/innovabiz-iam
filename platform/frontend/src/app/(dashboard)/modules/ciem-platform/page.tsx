...
/* ═══ CIEM Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "4497", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2699", trend: "+17%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "972669497", cells: ["CIE-4497", "CIEM Platform Item 1", "10/6/2026", "€19 597"], status: "active" as const },
    { id: "972673068", cells: ["CIE-8068", "CIEM Platform Item 2", "25/1/2026", "€23 168"], status: "pending" as const },
    { id: "972676639", cells: ["CIE-2639", "CIEM Platform Item 3", "12/8/2026", "€26 739"], status: "completed" as const },
    { id: "972680210", cells: ["CIE-6210", "CIEM Platform Item 4", "27/3/2026", "€30 310"], status: "warning" as const },
    { id: "972683781", cells: ["CIE-9781", "CIEM Platform Item 5", "14/10/2026", "€33 881"], status: "active" as const },
];
...
export default function CiemPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CIEM Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CIEM Platform</p>
                    </div>
                </div>
