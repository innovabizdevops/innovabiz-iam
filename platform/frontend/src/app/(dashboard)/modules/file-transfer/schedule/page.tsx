...
const ACCENT = "#475569";
const MODULE = "Managed File Transfer";
const PAGE = "Schedule Jobs";
const KPIS = [{"l":"Total File Transfer","v":"595","t":"+13.4%","d":"up"},{"l":"Schedule Jobs Ativos","v":"2.720","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+16.8%","d":"up"}];
const COLS = ["ID","Schedule Jobs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["File Transfer #001","File Transfer #002","5.932","7.968","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["File Transfer #002","File Transfer #003","5.771","5.743","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["File Transfer #003","File Transfer #004","7.299","1.324","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["File Transfer #004","File Transfer #005","7.165","5.628","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["File Transfer #005","File Transfer #001","5.939","1.940","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":658},{"label":"Mar","value":628},{"label":"Abr","value":785},{"label":"Mai","value":523},{"label":"Jun","value":726},{"label":"Jul","value":782},{"label":"Ago","value":656},{"label":"Set","value":613},{"label":"Out","value":829},{"label":"Nov","value":539},{"label":"Dez","value":571}];
const MX = 829;
