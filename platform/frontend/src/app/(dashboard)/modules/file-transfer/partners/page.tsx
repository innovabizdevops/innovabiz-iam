...
const PAGE = "Partner Config";
const KPIS = [{"l":"Configurações","v":"1.305","t":"+6.2%","d":"up"},{"l":"Últimas Alterações","v":"6.196","t":"+7.4%","d":"up"},{"l":"Ambientes","v":"8.731","t":"+2.7%","d":"up"},{"l":"Versão Config","v":"8.921","t":"-3.9%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 5400.98","2.795","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 48337.12","4.210","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 1605.98","8.494","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 47139.01","1.395","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 33776.72","2.209","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":480},{"label":"Mar","value":537},{"label":"Abr","value":795},{"label":"Mai","value":661},{"label":"Jun","value":566},{"label":"Jul","value":638},{"label":"Ago","value":725},{"label":"Set","value":601},{"label":"Out","value":782},{"label":"Nov","value":614},{"label":"Dez","value":713}];
const MX = 795;
