...
const KPIS = [{"l":"Auditorias Realizadas","v":"2.020","t":"-2.8%","d":"down"},{"l":"NC Abertas","v":"1.094","t":"+1.9%","d":"up"},{"l":"Conformidade (%)","v":"87.1%","t":"+15.4%","d":"up"},{"l":"CAPAs Pendentes","v":"5.760","t":"-4.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.810","91.0%","2.328","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.208","70.8%","8.268","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.916","85.0%","204","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","229","80.1%","2.591","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.364","89.1%","5.302","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":999},{"label":"Mar","value":985},{"label":"Abr","value":626},{"label":"Mai","value":641},{"label":"Jun","value":708},{"label":"Jul","value":770},{"label":"Ago","value":635},{"label":"Set","value":877},{"label":"Out","value":611},{"label":"Nov","value":661},{"label":"Dez","value":933}];
const MX = 999;
