...
const KPIS = [{"l":"Total File Transfer","v":"8.749","t":"+6.4%","d":"up"},{"l":"Encryption Ativos","v":"7.354","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"82.0%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"84","t":"-1.5%","d":"down"}];
const COLS = ["ID","Encryption","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["File Transfer #001","File Transfer #002","8.599","324","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["File Transfer #002","File Transfer #003","682","8.013","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["File Transfer #003","File Transfer #004","6.310","569","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["File Transfer #004","File Transfer #005","8.083","218","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["File Transfer #005","File Transfer #001","7.784","4.537","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":878},{"label":"Mar","value":604},{"label":"Abr","value":541},{"label":"Mai","value":919},{"label":"Jun","value":693},{"label":"Jul","value":672},{"label":"Ago","value":576},{"label":"Set","value":763},{"label":"Out","value":639},{"label":"Nov","value":624},{"label":"Dez","value":537}];
const MX = 919;
