...
const KPIS = [
    { label: "Total Registos", value: "9426", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "837", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€58K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "106028426", cells: ["PRO-9426", "Product Traceability Item 1", "15/3/2026", "€28 526"], status: "active" as const },
    { id: "106031997", cells: ["PRO-3997", "Product Traceability Item 2", "2/10/2026", "€32 097"], status: "pending" as const },
    { id: "106035568", cells: ["PRO-7568", "Product Traceability Item 3", "17/5/2026", "€35 668"], status: "completed" as const },
    { id: "106039139", cells: ["PRO-2139", "Product Traceability Item 4", "4/12/2026", "€39 239"], status: "warning" as const },
    { id: "106042710", cells: ["PRO-5710", "Product Traceability Item 5", "19/7/2026", "€42 810"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Product Traceability</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Product Traceability</p>
                    </div>
                </div>
