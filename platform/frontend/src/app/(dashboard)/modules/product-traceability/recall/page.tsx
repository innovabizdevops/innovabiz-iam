...
const PAGE = "Recall";
const KPIS = [{"l":"Total Product Traceability","v":"8.394","t":"+9.2%","d":"up"},{"l":"Recall Ativos","v":"1.043","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"68","t":"-5.8%","d":"down"}];
const COLS = ["ID","Recall","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Traceability #001","Product Traceability #002","5.440","3.872","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Product Traceability #002","Product Traceability #003","6.170","1.765","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Traceability #003","Product Traceability #004","6.408","1.001","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Product Traceability #004","Product Traceability #005","3.363","4.947","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Traceability #005","Product Traceability #001","7.577","8.440","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":452},{"label":"Mar","value":673},{"label":"Abr","value":480},{"label":"Mai","value":485},{"label":"Jun","value":511},{"label":"Jul","value":457},{"label":"Ago","value":650},{"label":"Set","value":345},{"label":"Out","value":553},{"label":"Nov","value":471},{"label":"Dez","value":542}];
const MX = 721;
