...
const ACCENT = "#b45309";
const MODULE = "Product Traceability";
const PAGE = "Track";
const KPIS = [{"l":"Total Product Traceability","v":"3.101","t":"+1.7%","d":"up"},{"l":"Track Ativos","v":"4.840","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"86","t":"-3.6%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Traceability #001","Product Traceability #002","6.455","8.845","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Product Traceability #002","Product Traceability #003","3.145","1.517","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Traceability #003","Product Traceability #004","7.496","7.445","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Product Traceability #004","Product Traceability #005","2.925","7.073","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Traceability #005","Product Traceability #001","8.183","2.040","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":654},{"label":"Mar","value":591},{"label":"Abr","value":579},{"label":"Mai","value":739},{"label":"Jun","value":807},{"label":"Jul","value":916},{"label":"Ago","value":718},{"label":"Set","value":902},{"label":"Out","value":861},{"label":"Nov","value":588},{"label":"Dez","value":635}];
const MX = 916;
