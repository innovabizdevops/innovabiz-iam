...
const PAGE = "Reclaim";
const KPIS = [{"l":"Total Ink Mgmt","v":"2.064","t":"-5.7%","d":"down"},{"l":"Reclaim Ativos","v":"8.263","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"74.5%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"73","t":"+16.9%","d":"up"}];
const COLS = ["ID","Reclaim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ink Mgmt #001","Ink Mgmt #002","7.913","6.750","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Ink Mgmt #002","Ink Mgmt #003","2.867","8.450","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Ink Mgmt #003","Ink Mgmt #004","5.131","4.417","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Ink Mgmt #004","Ink Mgmt #005","8.104","4.237","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ink Mgmt #005","Ink Mgmt #001","2.336","5.954","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":481},{"label":"Fev","value":265},{"label":"Mar","value":540},{"label":"Abr","value":352},{"label":"Mai","value":340},{"label":"Jun","value":566},{"label":"Jul","value":242},{"label":"Ago","value":445},{"label":"Set","value":544},{"label":"Out","value":508},{"label":"Nov","value":530},{"label":"Dez","value":573}];
const MX = 573;
