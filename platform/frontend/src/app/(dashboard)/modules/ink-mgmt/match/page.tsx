...
const PAGE = "Match";
const KPIS = [{"l":"Atletas Registados","v":"591","t":"+15.9%","d":"up"},{"l":"Treinos/Semana","v":"1269","t":"-1.1%","d":"down"},{"l":"Competições","v":"4.059","t":"+17.4%","d":"up"},{"l":"Performance Score","v":"65","t":"+12.9%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.036","3.867","1.086","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.912","5.750","5.790","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.134","3.512","2.980","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.304","584","3.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.322","1.844","3.088","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":585},{"label":"Mar","value":687},{"label":"Abr","value":647},{"label":"Mai","value":380},{"label":"Jun","value":637},{"label":"Jul","value":579},{"label":"Ago","value":556},{"label":"Set","value":566},{"label":"Out","value":633},{"label":"Nov","value":542},{"label":"Dez","value":363}];
const MX = 705;
