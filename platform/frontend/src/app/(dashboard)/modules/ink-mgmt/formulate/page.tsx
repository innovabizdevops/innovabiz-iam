...
const ACCENT = "#6366f1";
const MODULE = "Ink Management";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"6.459","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"4702","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"4.662","t":"-5.9%","d":"down"},{"l":"Templates","v":"1.331","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.654","2026-03-23","153","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.735","2026-03-26","8.351","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.488","2026-02-08","2.445","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.680","2026-01-19","6.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","188","2026-01-04","7.718","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":447},{"label":"Mar","value":375},{"label":"Abr","value":543},{"label":"Mai","value":456},{"label":"Jun","value":467},{"label":"Jul","value":343},{"label":"Ago","value":367},{"label":"Set","value":466},{"label":"Out","value":340},{"label":"Nov","value":393},{"label":"Dez","value":314}];
const MX = 543;
