...
const PAGE = "Feature";
const KPIS = [{"l":"Integrações Ativas","v":"4.840","t":"+11.5%","d":"up"},{"l":"Chamadas/Hora","v":"804","t":"+17.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.0%","t":"+16.2%","d":"up"},{"l":"Latência Média (ms)","v":"198ms","t":"+4.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.210","1.372","92.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.508","1.637","81.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.879","7.383","80.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.324","4.646","96.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.963","7.187","97.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":487},{"label":"Mar","value":452},{"label":"Abr","value":708},{"label":"Mai","value":527},{"label":"Jun","value":412},{"label":"Jul","value":546},{"label":"Ago","value":630},{"label":"Set","value":500},{"label":"Out","value":611},{"label":"Nov","value":447},{"label":"Dez","value":687}];
const MX = 708;
