...
const PAGE = "Action";
const KPIS = [{"l":"Integrações Ativas","v":"5.117","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"3088","t":"+7.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.2%","t":"-5.2%","d":"down"},{"l":"Latência Média (ms)","v":"194ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.796","2.863","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.619","704","91.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.185","7.357","84.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.620","1.414","89.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","283","8.201","75.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":834},{"label":"Mar","value":688},{"label":"Abr","value":749},{"label":"Mai","value":541},{"label":"Jun","value":630},{"label":"Jul","value":515},{"label":"Ago","value":911},{"label":"Set","value":530},{"label":"Out","value":888},{"label":"Nov","value":521},{"label":"Dez","value":819}];
const MX = 911;
