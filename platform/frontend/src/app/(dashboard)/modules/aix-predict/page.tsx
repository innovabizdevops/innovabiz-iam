...
/* ═══ AIX Predictive Intelligence — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "5009", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3891", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€12K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1756779709", cells: ["AIX-7709", "AIX Predictive Intelligence Item 1", "14/2/2026", "€29 809"], status: "active" as const },
    { id: "1756783280", cells: ["AIX-2280", "AIX Predictive Intelligence Item 2", "1/9/2026", "€33 380"], status: "pending" as const },
    { id: "1756786851", cells: ["AIX-5851", "AIX Predictive Intelligence Item 3", "16/4/2026", "€36 951"], status: "completed" as const },
    { id: "1756790422", cells: ["AIX-9422", "AIX Predictive Intelligence Item 4", "3/11/2026", "€40 522"], status: "warning" as const },
    { id: "1756793993", cells: ["AIX-3993", "AIX Predictive Intelligence Item 5", "18/6/2026", "€44 093"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 49 }, { label: "Fev", value: 58 }, { label: "Mar", value: 67 }, { label: "Abr", value: 76 }, { label: "Mai", value: 85 }, { label: "Jun", value: 94 }];
...
export default function AixPredictiveIntelligencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AIX Predictive Intelligence</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AIX Predictive Intelligence</p>
                    </div>
                </div>
