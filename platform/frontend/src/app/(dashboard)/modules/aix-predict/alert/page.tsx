...
const ACCENT = "#4f46e5";
const MODULE = "AIX Predictive Intelligence";
const PAGE = "Alert";
const KPIS = [{"l":"Integrações Ativas","v":"3.823","t":"+6.9%","d":"up"},{"l":"Chamadas/Hora","v":"3403","t":"-3.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"78.3%","t":"+5.7%","d":"up"},{"l":"Latência Média (ms)","v":"183ms","t":"-1.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.218","4.600","90.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.300","5.346","89.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.093","5.316","71.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.744","1.740","83.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.406","7.529","99.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":272},{"label":"Mar","value":519},{"label":"Abr","value":560},{"label":"Mai","value":424},{"label":"Jun","value":494},{"label":"Jul","value":413},{"label":"Ago","value":411},{"label":"Set","value":480},{"label":"Out","value":513},{"label":"Nov","value":302},{"label":"Dez","value":277}];
const MX = 560;
