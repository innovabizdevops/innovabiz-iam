...
const PAGE = "Forecast";
const KPIS = [{"l":"Integrações Ativas","v":"1.569","t":"+6.2%","d":"up"},{"l":"Chamadas/Hora","v":"2906","t":"+10.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.8%","t":"+13.2%","d":"up"},{"l":"Latência Média (ms)","v":"105ms","t":"+17.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.360","7.139","77.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.336","6.641","72.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.570","650","80.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.438","2.304","83.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.134","2.227","83.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":810},{"label":"Fev","value":923},{"label":"Mar","value":1018},{"label":"Abr","value":1003},{"label":"Mai","value":800},{"label":"Jun","value":674},{"label":"Jul","value":748},{"label":"Ago","value":752},{"label":"Set","value":748},{"label":"Out","value":764},{"label":"Nov","value":767},{"label":"Dez","value":949}];
const MX = 1018;
