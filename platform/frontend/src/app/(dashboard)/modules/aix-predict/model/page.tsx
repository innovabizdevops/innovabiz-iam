...
const PAGE = "Model";
const KPIS = [{"l":"Integrações Ativas","v":"5.604","t":"+1.0%","d":"up"},{"l":"Chamadas/Hora","v":"1448","t":"+13.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.3%","t":"+5.3%","d":"up"},{"l":"Latência Média (ms)","v":"68ms","t":"+13.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.021","3.975","87.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.879","5.170","92.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.461","3.603","81.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.454","8.293","73.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.238","5.813","82.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":921},{"label":"Mar","value":897},{"label":"Abr","value":879},{"label":"Mai","value":659},{"label":"Jun","value":701},{"label":"Jul","value":570},{"label":"Ago","value":675},{"label":"Set","value":655},{"label":"Out","value":932},{"label":"Nov","value":745},{"label":"Dez","value":753}];
const MX = 952;
