...
const PAGE = "Facility";
const KPIS = [{"l":"Total Faith Camp","v":"818","t":"+2.3%","d":"up"},{"l":"Facility Ativos","v":"5.771","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"67.9%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+15.8%","d":"up"}];
const COLS = ["ID","Facility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Camp #001","Faith Camp #002","5.714","2.083","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Camp #002","Faith Camp #003","6.896","7.157","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Camp #003","Faith Camp #004","8.692","6.306","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Camp #004","Faith Camp #005","1.188","6.555","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Camp #005","Faith Camp #001","8.009","3.596","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":626},{"label":"Mar","value":619},{"label":"Abr","value":732},{"label":"Mai","value":749},{"label":"Jun","value":562},{"label":"Jul","value":522},{"label":"Ago","value":715},{"label":"Set","value":589},{"label":"Out","value":412},{"label":"Nov","value":630},{"label":"Dez","value":724}];
const MX = 749;
