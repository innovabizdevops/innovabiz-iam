...
const PAGE = "Register";
const KPIS = [{"l":"Total Faith Camp","v":"2.100","t":"+8.9%","d":"up"},{"l":"Register Ativos","v":"7.530","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"85","t":"+15.8%","d":"up"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Camp #001","Faith Camp #002","1.254","8.426","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Camp #002","Faith Camp #003","7.506","293","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Camp #003","Faith Camp #004","6.976","8.561","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Camp #004","Faith Camp #005","1.969","8.966","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Camp #005","Faith Camp #001","219","5.297","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":620},{"label":"Mar","value":519},{"label":"Abr","value":471},{"label":"Mai","value":490},{"label":"Jun","value":698},{"label":"Jul","value":521},{"label":"Ago","value":709},{"label":"Set","value":455},{"label":"Out","value":390},{"label":"Nov","value":422},{"label":"Dez","value":357}];
const MX = 709;
