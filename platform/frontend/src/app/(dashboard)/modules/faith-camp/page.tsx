...
/* ═══ Faith Camp & Retreat — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "1003", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1900", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€73K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "548312403", cells: ["FAI-6403", "Faith Camp & Retreat Item 1", "24/4/2026", "€12 503"], status: "active" as const },
    { id: "548315974", cells: ["FAI-9974", "Faith Camp & Retreat Item 2", "11/11/2026", "€16 074"], status: "pending" as const },
    { id: "548319545", cells: ["FAI-4545", "Faith Camp & Retreat Item 3", "26/6/2026", "€19 645"], status: "completed" as const },
    { id: "548323116", cells: ["FAI-8116", "Faith Camp & Retreat Item 4", "13/1/2026", "€23 216"], status: "warning" as const },
    { id: "548326687", cells: ["FAI-2687", "Faith Camp & Retreat Item 5", "28/8/2026", "€26 787"], status: "active" as const },
];
...
export default function FaithCampRetreatPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Faith Camp & Retreat</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Faith Camp & Retreat</p>
                    </div>
                </div>
