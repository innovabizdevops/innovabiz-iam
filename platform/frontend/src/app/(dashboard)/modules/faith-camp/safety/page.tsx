...
const PAGE = "Safety";
const KPIS = [{"l":"Total Faith Camp","v":"5.503","t":"+4.4%","d":"up"},{"l":"Safety Ativos","v":"410","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"61","t":"+17.6%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Camp #001","Faith Camp #002","1.838","5.261","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Camp #002","Faith Camp #003","7.761","6.650","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Camp #003","Faith Camp #004","7.773","7.298","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Camp #004","Faith Camp #005","1.964","7.268","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Camp #005","Faith Camp #001","1.335","8.947","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":824},{"label":"Fev","value":1029},{"label":"Mar","value":643},{"label":"Abr","value":661},{"label":"Mai","value":1008},{"label":"Jun","value":687},{"label":"Jul","value":867},{"label":"Ago","value":713},{"label":"Set","value":673},{"label":"Out","value":755},{"label":"Nov","value":847},{"label":"Dez","value":892}];
const MX = 1029;
