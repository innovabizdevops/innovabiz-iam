...
const PAGE = "Staff";
const KPIS = [{"l":"Total Faith Camp","v":"9.070","t":"+16.8%","d":"up"},{"l":"Staff Ativos","v":"6.554","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+10.6%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.0%","d":"down"}];
const COLS = ["ID","Staff","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Camp #001","Faith Camp #002","7.317","1.127","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Camp #002","Faith Camp #003","6.325","702","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Camp #003","Faith Camp #004","2.890","2.701","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Camp #004","Faith Camp #005","4.328","5.671","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Camp #005","Faith Camp #001","5.368","7.424","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":921},{"label":"Mar","value":800},{"label":"Abr","value":726},{"label":"Mai","value":845},{"label":"Jun","value":939},{"label":"Jul","value":672},{"label":"Ago","value":860},{"label":"Set","value":818},{"label":"Out","value":781},{"label":"Nov","value":589},{"label":"Dez","value":838}];
const MX = 939;
