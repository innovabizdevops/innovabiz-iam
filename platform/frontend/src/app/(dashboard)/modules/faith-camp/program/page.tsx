...
const ACCENT = "#4c1d95";
const MODULE = "Faith Camp & Retreat";
const PAGE = "Program";
const KPIS = [{"l":"Total Faith Camp","v":"2.408","t":"-1.8%","d":"down"},{"l":"Program Ativos","v":"3.211","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+15.3%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Faith Camp #001","Faith Camp #002","1.844","1.220","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Faith Camp #002","Faith Camp #003","2.811","2.562","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Faith Camp #003","Faith Camp #004","1.129","5.541","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Faith Camp #004","Faith Camp #005","6.250","2.915","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Faith Camp #005","Faith Camp #001","2.229","5.155","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":356},{"label":"Fev","value":526},{"label":"Mar","value":463},{"label":"Abr","value":421},{"label":"Mai","value":597},{"label":"Jun","value":271},{"label":"Jul","value":276},{"label":"Ago","value":381},{"label":"Set","value":494},{"label":"Out","value":360},{"label":"Nov","value":566},{"label":"Dez","value":636}];
const MX = 636;
