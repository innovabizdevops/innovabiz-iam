...
const PAGE = "Grades";
const KPIS = [{"l":"Total Student Info","v":"6.596","t":"+17.8%","d":"up"},{"l":"Grades Ativos","v":"7.469","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"70.5%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"91","t":"+13.6%","d":"up"}];
const COLS = ["ID","Grades","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Info #001","Student Info #002","4.080","2.427","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Student Info #002","Student Info #003","3.596","3.914","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Info #003","Student Info #004","3.323","2.934","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Student Info #004","Student Info #005","125","5.835","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Info #005","Student Info #001","5.986","877","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":762},{"label":"Mar","value":892},{"label":"Abr","value":753},{"label":"Mai","value":840},{"label":"Jun","value":775},{"label":"Jul","value":596},{"label":"Ago","value":875},{"label":"Set","value":576},{"label":"Out","value":851},{"label":"Nov","value":771},{"label":"Dez","value":868}];
const MX = 892;
