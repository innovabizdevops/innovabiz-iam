...
const KPIS = [{"l":"Total Student Info","v":"2.712","t":"-1.0%","d":"down"},{"l":"Transcript Ativos","v":"1.313","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"94.2%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+6.1%","d":"up"}];
const COLS = ["ID","Transcript","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Info #001","Student Info #002","709","1.601","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Student Info #002","Student Info #003","1.624","2.709","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Info #003","Student Info #004","4.702","2.742","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Student Info #004","Student Info #005","8.512","1.780","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Info #005","Student Info #001","2.500","5.535","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":768},{"label":"Mar","value":564},{"label":"Abr","value":417},{"label":"Mai","value":562},{"label":"Jun","value":644},{"label":"Jul","value":727},{"label":"Ago","value":448},{"label":"Set","value":432},{"label":"Out","value":639},{"label":"Nov","value":747},{"label":"Dez","value":734}];
const MX = 768;
