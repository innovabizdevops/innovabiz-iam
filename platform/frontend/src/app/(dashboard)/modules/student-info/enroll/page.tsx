...
const KPIS = [{"l":"Total Student Info","v":"4.599","t":"-4.8%","d":"down"},{"l":"Enrollment Ativos","v":"1.893","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"71","t":"+6.4%","d":"up"}];
const COLS = ["ID","Enrollment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Student Info #001","Student Info #002","7.612","2.552","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Student Info #002","Student Info #003","1.777","8.414","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Student Info #003","Student Info #004","7.461","6.051","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Student Info #004","Student Info #005","6.349","5.636","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Student Info #005","Student Info #001","6.532","8.537","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":399},{"label":"Mar","value":372},{"label":"Abr","value":578},{"label":"Mai","value":232},{"label":"Jun","value":589},{"label":"Jul","value":480},{"label":"Ago","value":306},{"label":"Set","value":337},{"label":"Out","value":408},{"label":"Nov","value":585},{"label":"Dez","value":367}];
const MX = 589;
