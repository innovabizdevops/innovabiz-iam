...
const PAGE = "Doc";
const KPIS = [{"l":"Formulários Ativos","v":"8.815","t":"+8.0%","d":"up"},{"l":"Submissões/Dia","v":"1436","t":"-1.3%","d":"down"},{"l":"Documentos Gerados","v":"4.604","t":"-3.8%","d":"down"},{"l":"Templates","v":"4.721","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.744","2026-01-18","6.592","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.626","2026-02-25","3.758","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.282","2026-01-16","8.845","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.416","2026-03-05","7.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","323","2026-01-15","1.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":734},{"label":"Mar","value":686},{"label":"Abr","value":440},{"label":"Mai","value":693},{"label":"Jun","value":620},{"label":"Jul","value":629},{"label":"Ago","value":635},{"label":"Set","value":743},{"label":"Out","value":506},{"label":"Nov","value":806},{"label":"Dez","value":560}];
const MX = 806;
