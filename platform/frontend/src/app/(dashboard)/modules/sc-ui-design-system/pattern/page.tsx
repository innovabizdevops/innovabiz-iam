...
const PAGE = "Pattern";
const KPIS = [{"l":"Formulários Ativos","v":"4.129","t":"-0.5%","d":"down"},{"l":"Submissões/Dia","v":"2742","t":"+13.9%","d":"up"},{"l":"Documentos Gerados","v":"1.173","t":"+13.3%","d":"up"},{"l":"Templates","v":"3.816","t":"+3.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.484","2026-01-05","402","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","872","2026-01-06","5.913","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.550","2026-01-13","8.923","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.355","2026-02-19","6.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","140","2026-01-08","6.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":563},{"label":"Mar","value":821},{"label":"Abr","value":520},{"label":"Mai","value":581},{"label":"Jun","value":498},{"label":"Jul","value":621},{"label":"Ago","value":858},{"label":"Set","value":774},{"label":"Out","value":649},{"label":"Nov","value":827},{"label":"Dez","value":854}];
const MX = 858;
