...
const PAGE = "Theme";
const KPIS = [{"l":"Formulários Ativos","v":"1.136","t":"+10.0%","d":"up"},{"l":"Submissões/Dia","v":"3323","t":"+6.1%","d":"up"},{"l":"Documentos Gerados","v":"729","t":"-1.0%","d":"down"},{"l":"Templates","v":"5.902","t":"-3.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.453","2026-02-24","4.112","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.367","2026-02-23","5.224","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.346","2026-02-24","411","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.590","2026-01-24","5.754","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.140","2026-03-27","8.318","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":686},{"label":"Fev","value":503},{"label":"Mar","value":513},{"label":"Abr","value":590},{"label":"Mai","value":684},{"label":"Jun","value":643},{"label":"Jul","value":801},{"label":"Ago","value":564},{"label":"Set","value":711},{"label":"Out","value":573},{"label":"Nov","value":872},{"label":"Dez","value":644}];
const MX = 872;
