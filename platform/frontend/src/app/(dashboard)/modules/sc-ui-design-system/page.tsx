...
/* ═══ SC: UI Design System — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "7197", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3167", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€363K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "726469097", cells: ["SC-8097", "SC: UI Design System Item 1", "26/6/2026", "€19 197"], status: "active" as const },
    { id: "726472668", cells: ["SC-2668", "SC: UI Design System Item 2", "13/1/2026", "€22 768"], status: "pending" as const },
    { id: "726476239", cells: ["SC-6239", "SC: UI Design System Item 3", "28/8/2026", "€26 339"], status: "completed" as const },
    { id: "726479810", cells: ["SC-9810", "SC: UI Design System Item 4", "15/3/2026", "€29 910"], status: "warning" as const },
    { id: "726483381", cells: ["SC-4381", "SC: UI Design System Item 5", "2/10/2026", "€33 481"], status: "active" as const },
];
...
export default function ScUiDesignSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: UI Design System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: UI Design System</p>
                    </div>
                </div>
