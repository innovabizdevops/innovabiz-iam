...
const ACCENT = "#0284c7";
const MODULE = "SC: UI Design System";
const PAGE = "Token";
const KPIS = [{"l":"Formulários Ativos","v":"7.631","t":"-5.2%","d":"down"},{"l":"Submissões/Dia","v":"1840","t":"+2.2%","d":"up"},{"l":"Documentos Gerados","v":"8.623","t":"+10.9%","d":"up"},{"l":"Templates","v":"6.908","t":"-4.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.100","2026-01-07","5.482","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.034","2026-03-06","7.841","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.722","2026-01-07","322","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.892","2026-01-22","5.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.524","2026-01-13","6.176","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":760},{"label":"Mar","value":625},{"label":"Abr","value":433},{"label":"Mai","value":588},{"label":"Jun","value":426},{"label":"Jul","value":621},{"label":"Ago","value":772},{"label":"Set","value":377},{"label":"Out","value":476},{"label":"Nov","value":439},{"label":"Dez","value":378}];
const MX = 772;
