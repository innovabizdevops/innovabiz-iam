...
const KPIS = [{"l":"Formulários Ativos","v":"2.511","t":"+14.4%","d":"up"},{"l":"Submissões/Dia","v":"1882","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"3.317","t":"+2.6%","d":"up"},{"l":"Templates","v":"4.972","t":"+10.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.059","2026-03-14","8.383","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.794","2026-01-10","6.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.376","2026-01-04","7.418","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.139","2026-01-17","8.151","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.770","2026-01-28","4.547","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":422},{"label":"Mar","value":643},{"label":"Abr","value":550},{"label":"Mai","value":431},{"label":"Jun","value":709},{"label":"Jul","value":722},{"label":"Ago","value":485},{"label":"Set","value":422},{"label":"Out","value":706},{"label":"Nov","value":689},{"label":"Dez","value":532}];
const MX = 722;
