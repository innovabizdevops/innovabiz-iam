...
const PAGE = "LCR/NSFR";
const KPIS = [{"l":"Total Reg Reporting Bank","v":"5.602","t":"+16.1%","d":"up"},{"l":"LCR/NSFR Ativos","v":"3.571","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"70.8%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"56","t":"+3.3%","d":"up"}];
const COLS = ["ID","LCR/NSFR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Reporting Bank #001","Reg Reporting Bank #002","6.543","7.966","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Reporting Bank #002","Reg Reporting Bank #003","8.700","7.324","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Reporting Bank #003","Reg Reporting Bank #004","2.825","6.524","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Reporting Bank #004","Reg Reporting Bank #005","6.133","763","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Reporting Bank #005","Reg Reporting Bank #001","781","5.506","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":315},{"label":"Fev","value":570},{"label":"Mar","value":571},{"label":"Abr","value":363},{"label":"Mai","value":493},{"label":"Jun","value":325},{"label":"Jul","value":243},{"label":"Ago","value":592},{"label":"Set","value":598},{"label":"Out","value":415},{"label":"Nov","value":437},{"label":"Dez","value":510}];
const MX = 598;
