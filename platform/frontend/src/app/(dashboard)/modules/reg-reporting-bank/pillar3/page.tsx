...
const PAGE = "Pillar 3";
const KPIS = [{"l":"Total Reg Reporting Bank","v":"4.311","t":"+16.7%","d":"up"},{"l":"Pillar 3 Ativos","v":"6.521","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+17.1%","d":"up"}];
const COLS = ["ID","Pillar 3","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Reporting Bank #001","Reg Reporting Bank #002","3.380","4.207","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Reporting Bank #002","Reg Reporting Bank #003","5.756","2.195","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Reporting Bank #003","Reg Reporting Bank #004","8.239","8.957","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Reporting Bank #004","Reg Reporting Bank #005","2.677","7.534","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Reporting Bank #005","Reg Reporting Bank #001","2.640","5.664","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":931},{"label":"Mar","value":733},{"label":"Abr","value":573},{"label":"Mai","value":715},{"label":"Jun","value":605},{"label":"Jul","value":637},{"label":"Ago","value":830},{"label":"Set","value":653},{"label":"Out","value":583},{"label":"Nov","value":810},{"label":"Dez","value":745}];
const MX = 931;
