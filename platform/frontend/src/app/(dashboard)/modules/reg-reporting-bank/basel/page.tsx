...
const PAGE = "Basel III/IV";
const KPIS = [{"l":"Total Reg Reporting Bank","v":"6.985","t":"+7.4%","d":"up"},{"l":"Basel III/IV Ativos","v":"9.001","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"65.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"75","t":"-3.4%","d":"down"}];
const COLS = ["ID","Basel III/IV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Reporting Bank #001","Reg Reporting Bank #002","7.826","2.790","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Reporting Bank #002","Reg Reporting Bank #003","8.428","720","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Reporting Bank #003","Reg Reporting Bank #004","872","6.971","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Reporting Bank #004","Reg Reporting Bank #005","296","1.024","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Reporting Bank #005","Reg Reporting Bank #001","8.682","8.554","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":671},{"label":"Mar","value":1006},{"label":"Abr","value":713},{"label":"Mai","value":844},{"label":"Jun","value":648},{"label":"Jul","value":991},{"label":"Ago","value":894},{"label":"Set","value":749},{"label":"Out","value":847},{"label":"Nov","value":690},{"label":"Dez","value":958}];
const MX = 1006;
