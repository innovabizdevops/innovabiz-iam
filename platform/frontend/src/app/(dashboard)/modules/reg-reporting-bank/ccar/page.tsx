...
const ACCENT = "#dc2626";
const MODULE = "Regulatory Reporting";
const PAGE = "CCAR/DFAST";
const KPIS = [{"l":"Total Reg Reporting Bank","v":"5.857","t":"+12.4%","d":"up"},{"l":"CCAR/DFAST Ativos","v":"2.540","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"90.7%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+8.1%","d":"up"}];
const COLS = ["ID","CCAR/DFAST","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Reporting Bank #001","Reg Reporting Bank #002","4.755","3.978","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Reporting Bank #002","Reg Reporting Bank #003","4.922","3.783","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Reporting Bank #003","Reg Reporting Bank #004","5.393","6.851","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Reporting Bank #004","Reg Reporting Bank #005","7.388","6.897","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Reporting Bank #005","Reg Reporting Bank #001","2.184","2.403","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":628},{"label":"Mar","value":643},{"label":"Abr","value":784},{"label":"Mai","value":730},{"label":"Jun","value":681},{"label":"Jul","value":654},{"label":"Ago","value":649},{"label":"Set","value":731},{"label":"Out","value":797},{"label":"Nov","value":709},{"label":"Dez","value":716}];
const MX = 876;
...
export default function CcarPage() {
    return (
