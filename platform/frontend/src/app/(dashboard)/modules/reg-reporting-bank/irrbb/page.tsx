...
const PAGE = "IRRBB";
const KPIS = [{"l":"Total Reg Reporting Bank","v":"4.642","t":"-4.2%","d":"down"},{"l":"IRRBB Ativos","v":"7.400","t":"+8.0%","d":"up"},{"l":"Eficiência (%)","v":"91.4%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"56","t":"+2.3%","d":"up"}];
const COLS = ["ID","IRRBB","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Reg Reporting Bank #001","Reg Reporting Bank #002","3.853","6.823","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Reg Reporting Bank #002","Reg Reporting Bank #003","8.006","6.874","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Reg Reporting Bank #003","Reg Reporting Bank #004","2.091","2.979","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Reg Reporting Bank #004","Reg Reporting Bank #005","1.712","8.908","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Reg Reporting Bank #005","Reg Reporting Bank #001","4.536","2.356","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":775},{"label":"Mar","value":1012},{"label":"Abr","value":790},{"label":"Mai","value":927},{"label":"Jun","value":828},{"label":"Jul","value":1011},{"label":"Ago","value":804},{"label":"Set","value":986},{"label":"Out","value":974},{"label":"Nov","value":1075},{"label":"Dez","value":904}];
const MX = 1075;
...
export default function IrrbbPage() {
    return (
