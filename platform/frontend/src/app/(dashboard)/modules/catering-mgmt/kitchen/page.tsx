...
const PAGE = "Kitchen Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"7.482","t":"-2.6%","d":"down"},{"l":"RevPAR (€)","v":"€66886","t":"-2.7%","d":"down"},{"l":"Ocupação (%)","v":"70.0%","t":"+2.6%","d":"up"},{"l":"Guest Satisfaction","v":"5.272","t":"+10.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.785","2026-02-02","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.286","2026-02-20","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.557","2026-03-09","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","928","2026-03-24","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.542","2026-01-10","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":933},{"label":"Mar","value":1044},{"label":"Abr","value":777},{"label":"Mai","value":914},{"label":"Jun","value":782},{"label":"Jul","value":792},{"label":"Ago","value":768},{"label":"Set","value":690},{"label":"Out","value":1056},{"label":"Nov","value":1013},{"label":"Dez","value":956}];
const MX = 1056;
