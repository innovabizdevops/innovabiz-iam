...
const PAGE = "Menu Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"639","t":"-5.2%","d":"down"},{"l":"RevPAR (€)","v":"€99511","t":"+8.9%","d":"up"},{"l":"Ocupação (%)","v":"72.6%","t":"-1.3%","d":"down"},{"l":"Guest Satisfaction","v":"2.207","t":"+13.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.786","2026-03-19","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.641","2026-03-16","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.085","2026-01-18","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.635","2026-03-07","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.705","2026-01-19","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":898},{"label":"Fev","value":853},{"label":"Mar","value":572},{"label":"Abr","value":913},{"label":"Mai","value":910},{"label":"Jun","value":915},{"label":"Jul","value":645},{"label":"Ago","value":659},{"label":"Set","value":665},{"label":"Out","value":841},{"label":"Nov","value":745},{"label":"Dez","value":698}];
const MX = 915;
