...
const ACCENT = "#4338ca";
const MODULE = "Catering Management";
const PAGE = "Event Catering";
const KPIS = [{"l":"Total Catering Mgmt","v":"1.610","t":"+0.5%","d":"up"},{"l":"Event Catering Ativos","v":"2.290","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"65","t":"-3.3%","d":"down"}];
const COLS = ["ID","Event Catering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catering Mgmt #001","Catering Mgmt #002","7.405","168","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Catering Mgmt #002","Catering Mgmt #003","4.884","3.939","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Catering Mgmt #003","Catering Mgmt #004","1.199","5.644","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Catering Mgmt #004","Catering Mgmt #005","8.517","3.591","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catering Mgmt #005","Catering Mgmt #001","5.977","3.756","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":559},{"label":"Mar","value":366},{"label":"Abr","value":463},{"label":"Mai","value":433},{"label":"Jun","value":631},{"label":"Jul","value":594},{"label":"Ago","value":529},{"label":"Set","value":605},{"label":"Out","value":723},{"label":"Nov","value":590},{"label":"Dez","value":642}];
const MX = 726;
