...
const PAGE = "Delivery Route";
const KPIS = [{"l":"Total Catering Mgmt","v":"4.598","t":"-3.4%","d":"down"},{"l":"Delivery Route Ativos","v":"7.307","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"72.5%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.8%","d":"up"}];
const COLS = ["ID","Delivery Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catering Mgmt #001","Catering Mgmt #002","204","6.819","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Catering Mgmt #002","Catering Mgmt #003","4.347","1.687","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Catering Mgmt #003","Catering Mgmt #004","6.234","6.095","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Catering Mgmt #004","Catering Mgmt #005","4.757","3.207","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catering Mgmt #005","Catering Mgmt #001","2.941","1.192","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":702},{"label":"Mar","value":372},{"label":"Abr","value":722},{"label":"Mai","value":724},{"label":"Jun","value":730},{"label":"Jul","value":414},{"label":"Ago","value":696},{"label":"Set","value":632},{"label":"Out","value":741},{"label":"Nov","value":390},{"label":"Dez","value":486}];
const MX = 741;
