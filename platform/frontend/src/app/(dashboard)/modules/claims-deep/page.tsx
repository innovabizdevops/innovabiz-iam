...
/* ═══ Claims Management Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "6609", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1111", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€443K", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1218231209", cells: ["CLA-1209", "Claims Management Deep Item 1", "14/6/2026", "€31 309"], status: "active" as const },
    { id: "1218234780", cells: ["CLA-4780", "Claims Management Deep Item 2", "1/1/2026", "€34 880"], status: "pending" as const },
    { id: "1218238351", cells: ["CLA-8351", "Claims Management Deep Item 3", "16/8/2026", "€38 451"], status: "completed" as const },
    { id: "1218241922", cells: ["CLA-2922", "Claims Management Deep Item 4", "3/3/2026", "€42 022"], status: "warning" as const },
    { id: "1218245493", cells: ["CLA-6493", "Claims Management Deep Item 5", "18/10/2026", "€45 593"], status: "active" as const },
];
...
export default function ClaimsManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Claims Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Claims Management Deep</p>
                    </div>
                </div>
