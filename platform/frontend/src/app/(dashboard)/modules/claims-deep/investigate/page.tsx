...
const ACCENT = "#92400e";
const MODULE = "Claims Management Deep";
const PAGE = "Investigate";
const KPIS = [{"l":"Total Claims Deep","v":"8.170","t":"-2.3%","d":"down"},{"l":"Investigate Ativos","v":"3.334","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"74","t":"-0.7%","d":"down"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Deep #001","Claims Deep #002","4.529","5.095","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Deep #002","Claims Deep #003","3.145","5.339","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Deep #003","Claims Deep #004","4.648","763","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Deep #004","Claims Deep #005","3.714","5.554","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Deep #005","Claims Deep #001","8.710","2.786","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":692},{"label":"Mar","value":752},{"label":"Abr","value":550},{"label":"Mai","value":716},{"label":"Jun","value":662},{"label":"Jul","value":584},{"label":"Ago","value":540},{"label":"Set","value":707},{"label":"Out","value":552},{"label":"Nov","value":536},{"label":"Dez","value":537}];
const MX = 752;
