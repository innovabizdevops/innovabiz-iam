...
const PAGE = "Recover";
const KPIS = [{"l":"Total Claims Deep","v":"6.191","t":"+12.2%","d":"up"},{"l":"Recover Ativos","v":"7.415","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"73","t":"+11.5%","d":"up"}];
const COLS = ["ID","Recover","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Deep #001","Claims Deep #002","9.018","6.446","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Deep #002","Claims Deep #003","433","6.863","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Deep #003","Claims Deep #004","6.994","386","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Deep #004","Claims Deep #005","4.102","3.480","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Deep #005","Claims Deep #001","448","729","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":346},{"label":"Mar","value":349},{"label":"Abr","value":369},{"label":"Mai","value":266},{"label":"Jun","value":427},{"label":"Jul","value":564},{"label":"Ago","value":244},{"label":"Set","value":442},{"label":"Out","value":337},{"label":"Nov","value":371},{"label":"Dez","value":365}];
const MX = 564;
