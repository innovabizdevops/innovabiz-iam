...
export default function WeaponsSystemPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Weapons System</h1><p className="text-sm text-muted-foreground">Weapons System • iBOS Enterprise</p></div>
