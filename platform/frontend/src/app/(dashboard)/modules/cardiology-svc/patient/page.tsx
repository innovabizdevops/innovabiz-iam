...
const PAGE = "Patient";
const KPIS = [{"l":"Total Cardiology Svc","v":"3.109","t":"+15.9%","d":"up"},{"l":"Patient Ativos","v":"8.697","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"94.6%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"55","t":"+14.4%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cardiology Svc #001","Cardiology Svc #002","5.003","3.912","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Cardiology Svc #002","Cardiology Svc #003","4.867","1.717","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Cardiology Svc #003","Cardiology Svc #004","1.984","5.162","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Cardiology Svc #004","Cardiology Svc #005","7.554","3.778","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cardiology Svc #005","Cardiology Svc #001","4.067","3.605","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":803},{"label":"Mar","value":1023},{"label":"Abr","value":938},{"label":"Mai","value":1085},{"label":"Jun","value":934},{"label":"Jul","value":890},{"label":"Ago","value":1035},{"label":"Set","value":974},{"label":"Out","value":968},{"label":"Nov","value":910},{"label":"Dez","value":1087}];
const MX = 1087;
