...
const PAGE = "Rehab";
const KPIS = [{"l":"Total Cardiology Svc","v":"3.694","t":"+14.1%","d":"up"},{"l":"Rehab Ativos","v":"8.461","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"61","t":"-4.7%","d":"down"}];
const COLS = ["ID","Rehab","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cardiology Svc #001","Cardiology Svc #002","4.525","7.078","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Cardiology Svc #002","Cardiology Svc #003","5.129","7.662","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cardiology Svc #003","Cardiology Svc #004","3.909","569","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cardiology Svc #004","Cardiology Svc #005","2.687","1.521","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cardiology Svc #005","Cardiology Svc #001","6.729","6.409","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":1072},{"label":"Mar","value":936},{"label":"Abr","value":976},{"label":"Mai","value":935},{"label":"Jun","value":791},{"label":"Jul","value":1071},{"label":"Ago","value":1073},{"label":"Set","value":901},{"label":"Out","value":1035},{"label":"Nov","value":815},{"label":"Dez","value":687}];
const MX = 1073;
