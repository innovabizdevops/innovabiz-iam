...
/* ═══ Cardiology Services — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "3083", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1554", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€152K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "677549083", cells: ["CAR-3083", "Cardiology Services Item 1", "16/8/2026", "€49 183"], status: "active" as const },
    { id: "677552654", cells: ["CAR-6654", "Cardiology Services Item 2", "3/3/2026", "€2754"], status: "pending" as const },
    { id: "677556225", cells: ["CAR-1225", "Cardiology Services Item 3", "18/10/2026", "€6325"], status: "completed" as const },
    { id: "677559796", cells: ["CAR-4796", "Cardiology Services Item 4", "5/5/2026", "€9896"], status: "warning" as const },
    { id: "677563367", cells: ["CAR-8367", "Cardiology Services Item 5", "20/12/2026", "€13 467"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cardiology Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cardiology Services</p>
                    </div>
                </div>
