...
const PAGE = "ECG/Echo";
const KPIS = [{"l":"Total Cardiology Svc","v":"5.290","t":"+7.3%","d":"up"},{"l":"ECG/Echo Ativos","v":"8.415","t":"-5.8%","d":"down"},{"l":"Eficiência (%)","v":"66.2%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.3%","d":"up"}];
const COLS = ["ID","ECG/Echo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cardiology Svc #001","Cardiology Svc #002","2.801","9.070","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Cardiology Svc #002","Cardiology Svc #003","2.970","8.461","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cardiology Svc #003","Cardiology Svc #004","3.183","8.466","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Cardiology Svc #004","Cardiology Svc #005","1.632","2.252","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cardiology Svc #005","Cardiology Svc #001","383","7.236","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":700},{"label":"Mar","value":752},{"label":"Abr","value":780},{"label":"Mai","value":645},{"label":"Jun","value":481},{"label":"Jul","value":436},{"label":"Ago","value":668},{"label":"Set","value":726},{"label":"Out","value":803},{"label":"Nov","value":542},{"label":"Dez","value":464}];
const MX = 803;
