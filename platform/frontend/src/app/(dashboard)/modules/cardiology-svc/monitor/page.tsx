...
const ACCENT = "#dc2626";
const MODULE = "Cardiology Services";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Cardiology Svc","v":"3.460","t":"-2.9%","d":"down"},{"l":"Monitor Ativos","v":"8.723","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"89.0%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+9.9%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cardiology Svc #001","Cardiology Svc #002","4.232","6.019","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cardiology Svc #002","Cardiology Svc #003","6.350","8.197","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Cardiology Svc #003","Cardiology Svc #004","7.662","878","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cardiology Svc #004","Cardiology Svc #005","1.298","2.710","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cardiology Svc #005","Cardiology Svc #001","6.315","1.721","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":803},{"label":"Mar","value":851},{"label":"Abr","value":854},{"label":"Mai","value":939},{"label":"Jun","value":800},{"label":"Jul","value":617},{"label":"Ago","value":569},{"label":"Set","value":572},{"label":"Out","value":823},{"label":"Nov","value":797},{"label":"Dez","value":644}];
const MX = 939;
