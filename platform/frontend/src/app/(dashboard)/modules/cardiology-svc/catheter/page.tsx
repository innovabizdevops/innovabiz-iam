...
const PAGE = "Catheter";
const KPIS = [{"l":"Total Cardiology Svc","v":"5.110","t":"+7.5%","d":"up"},{"l":"Catheter Ativos","v":"6.680","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"89","t":"-3.1%","d":"down"}];
const COLS = ["ID","Catheter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cardiology Svc #001","Cardiology Svc #002","2.971","3.311","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cardiology Svc #002","Cardiology Svc #003","2.700","6.108","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cardiology Svc #003","Cardiology Svc #004","5.410","7.887","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cardiology Svc #004","Cardiology Svc #005","165","6.999","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cardiology Svc #005","Cardiology Svc #001","1.688","6.969","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":704},{"label":"Mar","value":540},{"label":"Abr","value":542},{"label":"Mai","value":623},{"label":"Jun","value":438},{"label":"Jul","value":698},{"label":"Ago","value":445},{"label":"Set","value":435},{"label":"Out","value":357},{"label":"Nov","value":332},{"label":"Dez","value":488}];
const MX = 704;
...
export default function CatheterPage() {
    return (
