...
const PAGE = "Registry";
const KPIS = [{"l":"Total Carbon Exchange","v":"7.704","t":"+6.0%","d":"up"},{"l":"Registry Ativos","v":"8.541","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"87.9%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"79","t":"+2.4%","d":"up"}];
const COLS = ["ID","Registry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Exchange #001","Carbon Exchange #002","3.868","4.365","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Exchange #002","Carbon Exchange #003","3.517","4.008","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Exchange #003","Carbon Exchange #004","7.516","8.539","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Exchange #004","Carbon Exchange #005","5.944","7.870","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Exchange #005","Carbon Exchange #001","5.028","1.687","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":684},{"label":"Mar","value":848},{"label":"Abr","value":902},{"label":"Mai","value":605},{"label":"Jun","value":881},{"label":"Jul","value":946},{"label":"Ago","value":673},{"label":"Set","value":671},{"label":"Out","value":794},{"label":"Nov","value":668},{"label":"Dez","value":576}];
const MX = 946;
