...
const ACCENT = "#6366f1";
const MODULE = "Carbon Exchange";
const PAGE = "Trading";
const KPIS = [{"l":"Total Carbon Exchange","v":"1.703","t":"+4.8%","d":"up"},{"l":"Trading Ativos","v":"2.700","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"70","t":"-5.0%","d":"down"}];
const COLS = ["ID","Trading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Exchange #001","Carbon Exchange #002","4.785","8.134","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Exchange #002","Carbon Exchange #003","4.485","2.136","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Exchange #003","Carbon Exchange #004","8.575","4.519","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Exchange #004","Carbon Exchange #005","3.803","8.487","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Exchange #005","Carbon Exchange #001","8.175","6.682","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":322},{"label":"Mar","value":499},{"label":"Abr","value":579},{"label":"Mai","value":654},{"label":"Jun","value":635},{"label":"Jul","value":342},{"label":"Ago","value":370},{"label":"Set","value":595},{"label":"Out","value":448},{"label":"Nov","value":496},{"label":"Dez","value":383}];
const MX = 654;
