...
const PAGE = "Offset";
const KPIS = [{"l":"Total Carbon Exchange","v":"8.863","t":"+6.5%","d":"up"},{"l":"Offset Ativos","v":"7.281","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"86.5%","t":"+1.4%","d":"up"},{"l":"Score Performance","v":"66","t":"-0.9%","d":"down"}];
const COLS = ["ID","Offset","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Carbon Exchange #001","Carbon Exchange #002","488","4.007","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Carbon Exchange #002","Carbon Exchange #003","6.264","2.589","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Carbon Exchange #003","Carbon Exchange #004","8.792","5.130","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Carbon Exchange #004","Carbon Exchange #005","5.024","616","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carbon Exchange #005","Carbon Exchange #001","5.951","1.336","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":630},{"label":"Mar","value":736},{"label":"Abr","value":955},{"label":"Mai","value":871},{"label":"Jun","value":909},{"label":"Jul","value":834},{"label":"Ago","value":917},{"label":"Set","value":564},{"label":"Out","value":854},{"label":"Nov","value":822},{"label":"Dez","value":773}];
const MX = 955;
