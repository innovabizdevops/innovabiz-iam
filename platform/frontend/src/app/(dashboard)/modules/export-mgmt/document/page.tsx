...
const ACCENT = "#6366f1";
const MODULE = "Export Management";
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"4.386","t":"-4.6%","d":"down"},{"l":"Submissões/Dia","v":"1136","t":"-3.1%","d":"down"},{"l":"Documentos Gerados","v":"1.659","t":"+0.6%","d":"up"},{"l":"Templates","v":"297","t":"+6.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.591","2026-02-02","5.732","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.517","2026-01-10","523","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.965","2026-02-14","4.867","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.595","2026-03-15","8.867","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.802","2026-03-18","3.586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":794},{"label":"Mar","value":745},{"label":"Abr","value":716},{"label":"Mai","value":683},{"label":"Jun","value":630},{"label":"Jul","value":930},{"label":"Ago","value":873},{"label":"Set","value":687},{"label":"Out","value":995},{"label":"Nov","value":618},{"label":"Dez","value":856}];
const MX = 995;
