...
const PAGE = "Comply";
const KPIS = [{"l":"Total Export Mgmt","v":"792","t":"+17.4%","d":"up"},{"l":"Comply Ativos","v":"1.471","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"62","t":"+7.3%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Export Mgmt #001","Export Mgmt #002","4.515","2.780","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Export Mgmt #002","Export Mgmt #003","2.561","2.880","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Export Mgmt #003","Export Mgmt #004","8.923","966","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Export Mgmt #004","Export Mgmt #005","1.116","4.737","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Export Mgmt #005","Export Mgmt #001","4.374","722","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":544},{"label":"Mar","value":455},{"label":"Abr","value":617},{"label":"Mai","value":647},{"label":"Jun","value":608},{"label":"Jul","value":546},{"label":"Ago","value":621},{"label":"Set","value":343},{"label":"Out","value":376},{"label":"Nov","value":500},{"label":"Dez","value":324}];
const MX = 647;
