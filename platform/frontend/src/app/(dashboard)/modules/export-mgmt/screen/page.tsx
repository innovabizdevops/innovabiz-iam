...
const PAGE = "Screen";
const KPIS = [{"l":"Total Export Mgmt","v":"4.553","t":"+0.4%","d":"up"},{"l":"Screen Ativos","v":"7.301","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"92","t":"+17.5%","d":"up"}];
const COLS = ["ID","Screen","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Export Mgmt #001","Export Mgmt #002","8.403","1.590","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Export Mgmt #002","Export Mgmt #003","533","8.685","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Export Mgmt #003","Export Mgmt #004","1.459","514","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Export Mgmt #004","Export Mgmt #005","1.354","2.803","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Export Mgmt #005","Export Mgmt #001","995","4.381","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":569},{"label":"Mar","value":681},{"label":"Abr","value":657},{"label":"Mai","value":575},{"label":"Jun","value":588},{"label":"Jul","value":551},{"label":"Ago","value":629},{"label":"Set","value":521},{"label":"Out","value":475},{"label":"Nov","value":466},{"label":"Dez","value":624}];
const MX = 742;
