...
const PAGE = "Report";
const KPIS = [{"l":"Total Export Mgmt","v":"4.678","t":"+15.8%","d":"up"},{"l":"Report Ativos","v":"7.316","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"87.5%","t":"+11.5%","d":"up"},{"l":"Score Performance","v":"65","t":"-0.7%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Export Mgmt #001","Export Mgmt #002","2.662","6.280","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Export Mgmt #002","Export Mgmt #003","375","4.050","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Export Mgmt #003","Export Mgmt #004","363","8.196","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Export Mgmt #004","Export Mgmt #005","376","1.625","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Export Mgmt #005","Export Mgmt #001","7.574","4.521","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":663},{"label":"Mar","value":514},{"label":"Abr","value":537},{"label":"Mai","value":651},{"label":"Jun","value":630},{"label":"Jul","value":545},{"label":"Ago","value":370},{"label":"Set","value":410},{"label":"Out","value":644},{"label":"Nov","value":671},{"label":"Dez","value":576}];
const MX = 671;
