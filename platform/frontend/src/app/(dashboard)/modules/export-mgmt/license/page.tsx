...
const PAGE = "License";
const KPIS = [{"l":"Total Export Mgmt","v":"5.856","t":"+17.3%","d":"up"},{"l":"License Ativos","v":"2.653","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"67.4%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.8%","d":"down"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Export Mgmt #001","Export Mgmt #002","4.394","2.311","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Export Mgmt #002","Export Mgmt #003","8.466","5.531","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Export Mgmt #003","Export Mgmt #004","7.153","8.197","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Export Mgmt #004","Export Mgmt #005","2.530","2.056","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Export Mgmt #005","Export Mgmt #001","5.182","1.412","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":290},{"label":"Fev","value":532},{"label":"Mar","value":554},{"label":"Abr","value":302},{"label":"Mai","value":404},{"label":"Jun","value":662},{"label":"Jul","value":655},{"label":"Ago","value":513},{"label":"Set","value":651},{"label":"Out","value":564},{"label":"Nov","value":565},{"label":"Dez","value":676}];
const MX = 676;
