...
const PAGE = "SLA Monitor";
const KPIS = [{"l":"Tickets Abertos","v":"4.693","t":"+6.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"65.6%","t":"+13.0%","d":"up"},{"l":"MTTR (h)","v":"207h","t":"+7.4%","d":"up"},{"l":"Satisfação (%)","v":"68.0%","t":"-4.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.895","3.691","6.816","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.540","3.731","7.474","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.355","3.519","3.690","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.034","6.785","3.598","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.611","3.304","8.608","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":604},{"label":"Mar","value":516},{"label":"Abr","value":854},{"label":"Mai","value":622},{"label":"Jun","value":779},{"label":"Jul","value":527},{"label":"Ago","value":752},{"label":"Set","value":856},{"label":"Out","value":862},{"label":"Nov","value":694},{"label":"Dez","value":610}];
const MX = 862;
