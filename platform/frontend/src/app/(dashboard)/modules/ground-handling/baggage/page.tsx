...
const ACCENT = "#059669";
const MODULE = "Ground Handling";
const PAGE = "Baggage Sort";
const KPIS = [{"l":"Total Ground Handling","v":"6.570","t":"-5.1%","d":"down"},{"l":"Baggage Sort Ativos","v":"4.264","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-0.4%","d":"down"}];
const COLS = ["ID","Baggage Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ground Handling #001","Ground Handling #002","3.549","3.296","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Ground Handling #002","Ground Handling #003","2.251","3.929","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Ground Handling #003","Ground Handling #004","5.522","1.567","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Ground Handling #004","Ground Handling #005","5.063","8.162","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ground Handling #005","Ground Handling #001","4.797","8.326","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":809},{"label":"Mar","value":784},{"label":"Abr","value":903},{"label":"Mai","value":838},{"label":"Jun","value":788},{"label":"Jul","value":849},{"label":"Ago","value":813},{"label":"Set","value":802},{"label":"Out","value":654},{"label":"Nov","value":821},{"label":"Dez","value":574}];
const MX = 903;
