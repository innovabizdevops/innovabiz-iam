...
const PAGE = "Turnaround";
const KPIS = [{"l":"Total Ground Handling","v":"3.343","t":"+17.6%","d":"up"},{"l":"Turnaround Ativos","v":"1.471","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"89.7%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"59","t":"+13.5%","d":"up"}];
const COLS = ["ID","Turnaround","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ground Handling #001","Ground Handling #002","1.706","3.487","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Ground Handling #002","Ground Handling #003","5.794","5.256","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Ground Handling #003","Ground Handling #004","6.734","4.550","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Ground Handling #004","Ground Handling #005","6.725","3.960","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ground Handling #005","Ground Handling #001","7.404","7.310","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":572},{"label":"Mar","value":590},{"label":"Abr","value":379},{"label":"Mai","value":443},{"label":"Jun","value":554},{"label":"Jul","value":721},{"label":"Ago","value":740},{"label":"Set","value":669},{"label":"Out","value":562},{"label":"Nov","value":510},{"label":"Dez","value":481}];
const MX = 740;
