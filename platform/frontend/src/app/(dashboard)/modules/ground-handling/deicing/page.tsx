...
const PAGE = "De-Icing";
const KPIS = [{"l":"Projetos Sociais","v":"3.434","t":"+15.0%","d":"up"},{"l":"Beneficiários","v":"8.279","t":"+16.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€48210","t":"+4.9%","d":"up"},{"l":"Score Impacto","v":"56","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.730","€ 33908.93","1.098","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.005","€ 10089.13","3.432","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","6.404","€ 18046.93","5.334","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.864","€ 112.23","6.602","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.939","€ 41316.65","6.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":575},{"label":"Mar","value":553},{"label":"Abr","value":852},{"label":"Mai","value":741},{"label":"Jun","value":604},{"label":"Jul","value":678},{"label":"Ago","value":704},{"label":"Set","value":754},{"label":"Out","value":843},{"label":"Nov","value":815},{"label":"Dez","value":827}];
const MX = 852;
