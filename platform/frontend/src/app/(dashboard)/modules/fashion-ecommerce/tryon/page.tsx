...
const ACCENT = "#be185d";
const MODULE = "Fashion E-Commerce Deep";
const PAGE = "Virtual Try";
const KPIS = [{"l":"Pedidos/Dia","v":"325","t":"+6.9%","d":"up"},{"l":"GMV (€)","v":"€13097","t":"+14.0%","d":"up"},{"l":"Conversão (%)","v":"81.0%","t":"+15.3%","d":"up"},{"l":"AOV (€)","v":"€61021","t":"+6.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 21610.84","786","7.023","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 11873.75","5.393","5.062","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 16030.29","6.011","4.934","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 48495.05","3.595","1.805","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 756.14","7.884","2.771","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":908},{"label":"Mar","value":655},{"label":"Abr","value":663},{"label":"Mai","value":696},{"label":"Jun","value":705},{"label":"Jul","value":733},{"label":"Ago","value":809},{"label":"Set","value":938},{"label":"Out","value":842},{"label":"Nov","value":814},{"label":"Dez","value":796}];
const MX = 962;
