...
/* ═══ Fashion E-Commerce Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "5514", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4672", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€182K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "738684014", cells: ["FAS-1014", "Fashion E-Commerce Deep Item 1", "27/3/2026", "€34 114"], status: "active" as const },
    { id: "738687585", cells: ["FAS-4585", "Fashion E-Commerce Deep Item 2", "14/10/2026", "€37 685"], status: "pending" as const },
    { id: "738691156", cells: ["FAS-8156", "Fashion E-Commerce Deep Item 3", "1/5/2026", "€41 256"], status: "completed" as const },
    { id: "738694727", cells: ["FAS-2727", "Fashion E-Commerce Deep Item 4", "16/12/2026", "€44 827"], status: "warning" as const },
    { id: "738698298", cells: ["FAS-6298", "Fashion E-Commerce Deep Item 5", "3/7/2026", "€48 398"], status: "active" as const },
];
...
export default function FashionEcommerceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion E-Commerce Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion E-Commerce Deep</p>
                    </div>
                </div>
