...
const KPIS = [{"l":"Dashboards Ativos","v":"4.880","t":"+8.6%","d":"up"},{"l":"Queries/Dia","v":"455","t":"-1.9%","d":"down"},{"l":"Dados Processados (GB)","v":"3.667","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"104","t":"+10.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3750","2026-03-25","3.361","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4787","2026-03-17","8.355","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1877","2026-02-08","1.782","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","573","2026-03-19","8.260","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2630","2026-02-15","4.662","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":349},{"label":"Mar","value":405},{"label":"Abr","value":648},{"label":"Mai","value":672},{"label":"Jun","value":538},{"label":"Jul","value":359},{"label":"Ago","value":655},{"label":"Set","value":379},{"label":"Out","value":630},{"label":"Nov","value":506},{"label":"Dez","value":385}];
const MX = 672;
