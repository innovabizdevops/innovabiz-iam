...
const KPIS = [
    { label: "Total Registos", value: "8299", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4127", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€484K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2113588899", cells: ["FRA-2899", "Franchise Marketing Item 1", "24/4/2026", "€38 999"], status: "active" as const },
    { id: "2113592470", cells: ["FRA-6470", "Franchise Marketing Item 2", "11/11/2026", "€42 570"], status: "pending" as const },
    { id: "2113596041", cells: ["FRA-1041", "Franchise Marketing Item 3", "26/6/2026", "€46 141"], status: "completed" as const },
    { id: "2113599612", cells: ["FRA-4612", "Franchise Marketing Item 4", "13/1/2026", "€49 712"], status: "warning" as const },
    { id: "2113603183", cells: ["FRA-8183", "Franchise Marketing Item 5", "28/8/2026", "€3283"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Marketing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Marketing</p>
                    </div>
                </div>
