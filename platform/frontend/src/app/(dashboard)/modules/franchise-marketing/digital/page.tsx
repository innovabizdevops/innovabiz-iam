...
const ACCENT = "#60a5fa";
const MODULE = "Franchise Marketing";
const PAGE = "Digital";
const KPIS = [{"l":"Total Franchise Marketing","v":"7.419","t":"-3.6%","d":"down"},{"l":"Digital Ativos","v":"3.199","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"73.5%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"94","t":"-3.7%","d":"down"}];
const COLS = ["ID","Digital","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Franchise Marketing #001","Franchise Marketing #002","6.311","1.389","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Franchise Marketing #002","Franchise Marketing #003","2.554","4.533","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Franchise Marketing #003","Franchise Marketing #004","2.755","2.825","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Franchise Marketing #004","Franchise Marketing #005","6.812","7.128","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Franchise Marketing #005","Franchise Marketing #001","2.431","1.066","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":468},{"label":"Mar","value":464},{"label":"Abr","value":417},{"label":"Mai","value":386},{"label":"Jun","value":440},{"label":"Jul","value":505},{"label":"Ago","value":387},{"label":"Set","value":495},{"label":"Out","value":597},{"label":"Nov","value":441},{"label":"Dez","value":577}];
const MX = 597;
