...
/* ═══ SOC Center — Threat Hunt ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1337", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "365", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "173", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1244713369", cells: ["SOC-5369", "Threat Hunt Item 1", "26/2/2026", "€13 469"], status: "active" as const },
    { id: "1244716940", cells: ["SOC-8940", "Threat Hunt Item 2", "13/9/2026", "€17 040"], status: "pending" as const },
    { id: "1244720511", cells: ["SOC-3511", "Threat Hunt Item 3", "28/4/2026", "€20 611"], status: "completed" as const },
    { id: "1244724082", cells: ["SOC-7082", "Threat Hunt Item 4", "15/11/2026", "€24 182"], status: "warning" as const },
    { id: "1244727653", cells: ["SOC-1653", "Threat Hunt Item 5", "2/6/2026", "€27 753"], status: "active" as const },
];
...
export default function SocCenterThreatHuntPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Threat Hunt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Threat Hunt</p>
                    </div>
                </div>
