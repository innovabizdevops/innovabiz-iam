...
/* ═══ SOC Center — Threat Intel ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1023", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "70", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3796", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "69311618", cells: ["SOC-3618", "Threat Intel Item 1", "27/3/2026", "€11 718"], status: "active" as const },
    { id: "69315189", cells: ["SOC-7189", "Threat Intel Item 2", "14/10/2026", "€15 289"], status: "pending" as const },
    { id: "69318760", cells: ["SOC-1760", "Threat Intel Item 3", "1/5/2026", "€18 860"], status: "completed" as const },
    { id: "69322331", cells: ["SOC-5331", "Threat Intel Item 4", "16/12/2026", "€22 431"], status: "warning" as const },
    { id: "69325902", cells: ["SOC-8902", "Threat Intel Item 5", "3/7/2026", "€26 002"], status: "active" as const },
];
...
export default function SocCenterThreatIntelPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Threat Intel</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Threat Intel</p>
                    </div>
                </div>
