...
/* ═══ SOC Center — Dark Web Monitor ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1267", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "174", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3140", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1909034250", cells: ["SOC-9250", "Dark Web Monitor Item 1", "19/7/2026", "€34 350"], status: "active" as const },
    { id: "1909037821", cells: ["SOC-3821", "Dark Web Monitor Item 2", "6/2/2026", "€37 921"], status: "pending" as const },
    { id: "1909041392", cells: ["SOC-7392", "Dark Web Monitor Item 3", "21/9/2026", "€41 492"], status: "completed" as const },
    { id: "1909044963", cells: ["SOC-1963", "Dark Web Monitor Item 4", "8/4/2026", "€45 063"], status: "warning" as const },
    { id: "1909048534", cells: ["SOC-5534", "Dark Web Monitor Item 5", "23/11/2026", "€48 634"], status: "active" as const },
];
...
export default function SocCenterDarkWebMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dark Web Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Dark Web Monitor</p>
                    </div>
                </div>
