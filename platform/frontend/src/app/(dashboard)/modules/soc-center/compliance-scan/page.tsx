...
/* ═══ SOC Center — Compliance Scan ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1129", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "356", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "221", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "784762640", cells: ["SOC-8640", "Compliance Scan Item 1", "5/9/2026", "€12 740"], status: "active" as const },
    { id: "784766211", cells: ["SOC-3211", "Compliance Scan Item 2", "20/4/2026", "€16 311"], status: "pending" as const },
    { id: "784769782", cells: ["SOC-6782", "Compliance Scan Item 3", "7/11/2026", "€19 882"], status: "completed" as const },
    { id: "784773353", cells: ["SOC-1353", "Compliance Scan Item 4", "22/6/2026", "€23 453"], status: "warning" as const },
    { id: "784776924", cells: ["SOC-4924", "Compliance Scan Item 5", "9/1/2026", "€27 024"], status: "active" as const },
];
...
export default function SocCenterComplianceScanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Scan</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Compliance Scan</p>
                    </div>
                </div>
