...
/* ═══ SOC Center — Executive Brief ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "4927", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "84", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2688", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "804859792", cells: ["SOC-8792", "Executive Brief Item 1", "17/5/2026", "€9892"], status: "active" as const },
    { id: "804863363", cells: ["SOC-3363", "Executive Brief Item 2", "4/12/2026", "€13 463"], status: "pending" as const },
    { id: "804866934", cells: ["SOC-6934", "Executive Brief Item 3", "19/7/2026", "€17 034"], status: "completed" as const },
    { id: "804870505", cells: ["SOC-1505", "Executive Brief Item 4", "6/2/2026", "€20 605"], status: "warning" as const },
    { id: "804874076", cells: ["SOC-5076", "Executive Brief Item 5", "21/9/2026", "€24 176"], status: "active" as const },
];
...
export default function SocCenterExecutiveBriefPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Executive Brief</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Executive Brief</p>
                    </div>
                </div>
