...
/* ═══ SOC Center — Incident Response ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "1223", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "17", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "309", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1740890589", cells: ["SOC-3589", "Incident Response Item 1", "26/10/2026", "€40 689"], status: "active" as const },
    { id: "1740894160", cells: ["SOC-7160", "Incident Response Item 2", "13/5/2026", "€44 260"], status: "pending" as const },
    { id: "1740897731", cells: ["SOC-1731", "Incident Response Item 3", "28/12/2026", "€47 831"], status: "completed" as const },
    { id: "1740901302", cells: ["SOC-5302", "Incident Response Item 4", "15/7/2026", "€1402"], status: "warning" as const },
    { id: "1740904873", cells: ["SOC-8873", "Incident Response Item 5", "2/2/2026", "€4973"], status: "active" as const },
];
...
export default function SocCenterIncidentResponsePage() {
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Incident Response</p>
                    </div>
                </div>
