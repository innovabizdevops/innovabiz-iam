...
/* ═══ SOC Center — Penetration Test ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "4334", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "171", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1896", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "540786503", cells: ["SOC-4503", "Penetration Test Item 1", "20/12/2026", "€36 603"], status: "active" as const },
    { id: "540790074", cells: ["SOC-8074", "Penetration Test Item 2", "7/7/2026", "€40 174"], status: "pending" as const },
    { id: "540793645", cells: ["SOC-2645", "Penetration Test Item 3", "22/2/2026", "€43 745"], status: "completed" as const },
    { id: "540797216", cells: ["SOC-6216", "Penetration Test Item 4", "9/9/2026", "€47 316"], status: "warning" as const },
    { id: "540800787", cells: ["SOC-9787", "Penetration Test Item 5", "24/4/2026", "€887"], status: "active" as const },
];
...
export default function SocCenterPenetrationTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Penetration Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Penetration Test</p>
                    </div>
                </div>
