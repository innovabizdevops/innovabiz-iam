...
/* ═══ SOC Center — Forensic Lab ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total", value: "3382", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "94", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "121", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "974167418", cells: ["SOC-8418", "Forensic Lab Item 1", "15/3/2026", "€17 518"], status: "active" as const },
    { id: "974170989", cells: ["SOC-2989", "Forensic Lab Item 2", "2/10/2026", "€21 089"], status: "pending" as const },
    { id: "974174560", cells: ["SOC-6560", "Forensic Lab Item 3", "17/5/2026", "€24 660"], status: "completed" as const },
    { id: "974178131", cells: ["SOC-1131", "Forensic Lab Item 4", "4/12/2026", "€28 231"], status: "warning" as const },
    { id: "974181702", cells: ["SOC-4702", "Forensic Lab Item 5", "19/7/2026", "€31 802"], status: "active" as const },
];
...
export default function SocCenterForensicLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forensic Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">SOC Center • Forensic Lab</p>
                    </div>
                </div>
