...
const KPIS = [{"l":"Total Equestrian Mgmt","v":"8.539","t":"+13.7%","d":"up"},{"l":"Competition Ativos","v":"5.870","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"83.6%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"72","t":"-3.4%","d":"down"}];
const COLS = ["ID","Competition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equestrian Mgmt #001","Equestrian Mgmt #002","8.109","6.837","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Equestrian Mgmt #002","Equestrian Mgmt #003","3.406","2.973","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Equestrian Mgmt #003","Equestrian Mgmt #004","5.292","3.578","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Equestrian Mgmt #004","Equestrian Mgmt #005","8.400","448","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equestrian Mgmt #005","Equestrian Mgmt #001","5.368","8.483","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":832},{"label":"Mar","value":730},{"label":"Abr","value":549},{"label":"Mai","value":678},{"label":"Jun","value":766},{"label":"Jul","value":805},{"label":"Ago","value":765},{"label":"Set","value":648},{"label":"Out","value":759},{"label":"Nov","value":573},{"label":"Dez","value":883}];
const MX = 883;
