...
const PAGE = "Horse";
const KPIS = [{"l":"Total Equestrian Mgmt","v":"2.948","t":"+4.5%","d":"up"},{"l":"Horse Ativos","v":"1.434","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"58","t":"+4.5%","d":"up"}];
const COLS = ["ID","Horse","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equestrian Mgmt #001","Equestrian Mgmt #002","1.183","8.706","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Equestrian Mgmt #002","Equestrian Mgmt #003","5.663","849","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Equestrian Mgmt #003","Equestrian Mgmt #004","4.867","1.814","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Equestrian Mgmt #004","Equestrian Mgmt #005","7.404","2.423","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equestrian Mgmt #005","Equestrian Mgmt #001","1.014","7.928","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":449},{"label":"Mar","value":559},{"label":"Abr","value":451},{"label":"Mai","value":422},{"label":"Jun","value":458},{"label":"Jul","value":572},{"label":"Ago","value":551},{"label":"Set","value":694},{"label":"Out","value":371},{"label":"Nov","value":405},{"label":"Dez","value":670}];
const MX = 694;
