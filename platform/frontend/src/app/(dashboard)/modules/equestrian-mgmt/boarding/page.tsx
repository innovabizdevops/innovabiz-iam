...
const PAGE = "Boarding";
const KPIS = [{"l":"Teams Ativos","v":"2.569","t":"+2.4%","d":"up"},{"l":"Reuniões/Semana","v":"2988","t":"+13.3%","d":"up"},{"l":"Mensagens/Dia","v":"1200","t":"+9.3%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.582","t":"+8.5%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.710","686","827","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.611","3159","5.495","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","7.961","122","2.083","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","637","4108","5.374","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.507","466","2.586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":936},{"label":"Fev","value":634},{"label":"Mar","value":760},{"label":"Abr","value":734},{"label":"Mai","value":691},{"label":"Jun","value":544},{"label":"Jul","value":708},{"label":"Ago","value":727},{"label":"Set","value":883},{"label":"Out","value":861},{"label":"Nov","value":564},{"label":"Dez","value":788}];
const MX = 936;
