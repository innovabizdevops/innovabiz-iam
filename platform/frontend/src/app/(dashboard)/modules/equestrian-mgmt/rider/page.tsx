...
const ACCENT = "#15803d";
const MODULE = "Equestrian Mgmt";
const PAGE = "Rider";
const KPIS = [{"l":"Total Equestrian Mgmt","v":"5.146","t":"+13.5%","d":"up"},{"l":"Rider Ativos","v":"550","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+17.7%","d":"up"}];
const COLS = ["ID","Rider","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Equestrian Mgmt #001","Equestrian Mgmt #002","3.257","1.028","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Equestrian Mgmt #002","Equestrian Mgmt #003","3.994","1.730","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Equestrian Mgmt #003","Equestrian Mgmt #004","2.261","6.541","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Equestrian Mgmt #004","Equestrian Mgmt #005","2.739","962","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Equestrian Mgmt #005","Equestrian Mgmt #001","7.941","108","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":836},{"label":"Mar","value":902},{"label":"Abr","value":959},{"label":"Mai","value":884},{"label":"Jun","value":688},{"label":"Jul","value":741},{"label":"Ago","value":920},{"label":"Set","value":759},{"label":"Out","value":753},{"label":"Nov","value":709},{"label":"Dez","value":1023}];
const MX = 1023;
