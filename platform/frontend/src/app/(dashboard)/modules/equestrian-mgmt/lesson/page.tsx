...
const PAGE = "Lesson";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.512","t":"+13.5%","d":"up"},{"l":"Sessões/Dia","v":"3324","t":"+9.3%","d":"up"},{"l":"MFA Adoção (%)","v":"75.9%","t":"+10.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"3.893","t":"-2.6%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.210","493","2.755","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","8.731","3.938","5.867","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.884","8.540","1.441","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.888","6.049","5.084","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.558","8.019","7.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":946},{"label":"Mar","value":914},{"label":"Abr","value":1025},{"label":"Mai","value":1015},{"label":"Jun","value":1032},{"label":"Jul","value":738},{"label":"Ago","value":891},{"label":"Set","value":875},{"label":"Out","value":885},{"label":"Nov","value":716},{"label":"Dez","value":667}];
const MX = 1032;
