...
const PAGE = "Report";
const KPIS = [{"l":"ARR (€M)","v":"€22.1M","t":"+13.6%","d":"up"},{"l":"MRR (€)","v":"€27735","t":"+1.9%","d":"up"},{"l":"Churn (%)","v":"72.7%","t":"+14.6%","d":"up"},{"l":"ARPU (€)","v":"€5599","t":"+14.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 49346.11","6.351","€ 8387.34","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11293.25","8.043","€ 826.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23603.77","4.906","€ 28334.10","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30615.50","2.799","€ 36458.83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45972.87","2.859","€ 30516.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":979},{"label":"Fev","value":967},{"label":"Mar","value":1019},{"label":"Abr","value":1025},{"label":"Mai","value":981},{"label":"Jun","value":856},{"label":"Jul","value":997},{"label":"Ago","value":990},{"label":"Set","value":797},{"label":"Out","value":807},{"label":"Nov","value":1054},{"label":"Dez","value":790}];
const MX = 1054;
