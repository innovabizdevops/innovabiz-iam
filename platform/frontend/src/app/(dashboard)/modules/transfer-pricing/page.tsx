...
/* ═══ Transfer Pricing Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8683", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2952", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€327K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "810254283", cells: ["TRA-3283", "Transfer Pricing Deep Item 1", "28/4/2026", "€4383"], status: "active" as const },
    { id: "810257854", cells: ["TRA-6854", "Transfer Pricing Deep Item 2", "15/11/2026", "€7954"], status: "pending" as const },
    { id: "810261425", cells: ["TRA-1425", "Transfer Pricing Deep Item 3", "2/6/2026", "€11 525"], status: "completed" as const },
    { id: "810264996", cells: ["TRA-4996", "Transfer Pricing Deep Item 4", "17/1/2026", "€15 096"], status: "warning" as const },
    { id: "810268567", cells: ["TRA-8567", "Transfer Pricing Deep Item 5", "4/8/2026", "€18 667"], status: "active" as const },
];
...
export default function TransferPricingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Transfer Pricing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Transfer Pricing Deep</p>
                    </div>
                </div>
