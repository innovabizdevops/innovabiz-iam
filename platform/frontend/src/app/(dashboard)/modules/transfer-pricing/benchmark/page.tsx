...
const ACCENT = "#dc2626";
const MODULE = "Transfer Pricing Deep";
const PAGE = "Benchmark";
const KPIS = [{"l":"ARR (€M)","v":"€20.2M","t":"+4.2%","d":"up"},{"l":"MRR (€)","v":"€77615","t":"+7.6%","d":"up"},{"l":"Churn (%)","v":"65.3%","t":"+15.7%","d":"up"},{"l":"ARPU (€)","v":"€36353","t":"+13.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17649.78","4.024","€ 20397.25","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27153.95","7.036","€ 6452.68","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 15245.16","2.067","€ 31377.69","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 16526.16","2.502","€ 22674.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 14232.74","6.050","€ 10236.29","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":425},{"label":"Mar","value":364},{"label":"Abr","value":333},{"label":"Mai","value":657},{"label":"Jun","value":437},{"label":"Jul","value":614},{"label":"Ago","value":678},{"label":"Set","value":639},{"label":"Out","value":530},{"label":"Nov","value":663},{"label":"Dez","value":663}];
const MX = 678;
