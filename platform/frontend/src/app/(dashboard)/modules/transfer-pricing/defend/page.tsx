...
const PAGE = "Defend";
const KPIS = [{"l":"ARR (€M)","v":"€19.6M","t":"+10.9%","d":"up"},{"l":"MRR (€)","v":"€66207","t":"-1.2%","d":"down"},{"l":"Churn (%)","v":"85.8%","t":"+5.5%","d":"up"},{"l":"ARPU (€)","v":"€96772","t":"-4.9%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 48595.98","190","€ 18704.51","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 542.37","8.154","€ 39193.08","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38021.42","7.383","€ 46748.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 2756.05","402","€ 19153.69","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 10033.65","3.912","€ 38816.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":668},{"label":"Mar","value":934},{"label":"Abr","value":855},{"label":"Mai","value":761},{"label":"Jun","value":619},{"label":"Jul","value":844},{"label":"Ago","value":702},{"label":"Set","value":635},{"label":"Out","value":903},{"label":"Nov","value":830},{"label":"Dez","value":609}];
const MX = 934;
