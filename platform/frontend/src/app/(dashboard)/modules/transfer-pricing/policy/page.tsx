...
const PAGE = "Policy";
const KPIS = [{"l":"ARR (€M)","v":"€5.7M","t":"+1.5%","d":"up"},{"l":"MRR (€)","v":"€24047","t":"+15.5%","d":"up"},{"l":"Churn (%)","v":"68.4%","t":"+6.5%","d":"up"},{"l":"ARPU (€)","v":"€27591","t":"+8.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 50027.95","7.428","€ 46028.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 44665.22","387","€ 35599.01","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17673.31","1.686","€ 36933.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43803.71","7.221","€ 429.36","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 37748.72","6.218","€ 11940.45","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":729},{"label":"Mar","value":676},{"label":"Abr","value":891},{"label":"Mai","value":572},{"label":"Jun","value":809},{"label":"Jul","value":735},{"label":"Ago","value":876},{"label":"Set","value":915},{"label":"Out","value":710},{"label":"Nov","value":811},{"label":"Dez","value":838}];
const MX = 915;
