...
const PAGE = "Document";
const KPIS = [{"l":"ARR (€M)","v":"€26.9M","t":"+8.7%","d":"up"},{"l":"MRR (€)","v":"€72648","t":"-2.6%","d":"down"},{"l":"Churn (%)","v":"85.0%","t":"+2.5%","d":"up"},{"l":"ARPU (€)","v":"€96267","t":"+-0.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32071.96","3.827","€ 30106.14","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8027.23","3.119","€ 36295.24","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26789.92","1.480","€ 42640.79","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46340.77","8.932","€ 45827.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 45909.27","8.605","€ 27257.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":582},{"label":"Mar","value":372},{"label":"Abr","value":267},{"label":"Mai","value":300},{"label":"Jun","value":613},{"label":"Jul","value":321},{"label":"Ago","value":493},{"label":"Set","value":276},{"label":"Out","value":345},{"label":"Nov","value":428},{"label":"Dez","value":487}];
const MX = 613;
