...
const PAGE = "Predict";
const KPIS = [{"l":"Integrações Ativas","v":"923","t":"+2.8%","d":"up"},{"l":"Chamadas/Hora","v":"4018","t":"+10.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.1%","t":"+2.8%","d":"up"},{"l":"Latência Média (ms)","v":"131ms","t":"+1.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.970","5.701","77.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.400","6.024","95.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.429","3.141","76.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.119","6.232","91.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.928","8.409","80.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":552},{"label":"Mar","value":877},{"label":"Abr","value":874},{"label":"Mai","value":679},{"label":"Jun","value":517},{"label":"Jul","value":788},{"label":"Ago","value":792},{"label":"Set","value":675},{"label":"Out","value":549},{"label":"Nov","value":759},{"label":"Dez","value":538}];
const MX = 894;
