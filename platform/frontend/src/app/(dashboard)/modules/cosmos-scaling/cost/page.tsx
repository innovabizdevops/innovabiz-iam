...
const PAGE = "Cost";
const KPIS = [{"l":"Total Cosmos Scaling","v":"3.451","t":"-1.5%","d":"down"},{"l":"Cost Ativos","v":"7.354","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"73.4%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"73","t":"-3.5%","d":"down"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Scaling #001","Cosmos Scaling #002","5.389","7.309","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Scaling #002","Cosmos Scaling #003","7.992","8.976","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Scaling #003","Cosmos Scaling #004","6.744","5.365","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Scaling #004","Cosmos Scaling #005","7.658","1.340","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Scaling #005","Cosmos Scaling #001","7.015","1.009","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":645},{"label":"Mar","value":390},{"label":"Abr","value":521},{"label":"Mai","value":540},{"label":"Jun","value":712},{"label":"Jul","value":674},{"label":"Ago","value":648},{"label":"Set","value":620},{"label":"Out","value":643},{"label":"Nov","value":486},{"label":"Dez","value":530}];
const MX = 765;
