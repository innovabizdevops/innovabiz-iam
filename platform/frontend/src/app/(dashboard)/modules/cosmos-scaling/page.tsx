...
/* ═══ COSMOS Auto-Scaling Engine — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "2921", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4277", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€209K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "854452021", cells: ["COS-2021", "COSMOS Auto-Scaling Engine Item 1", "18/2/2026", "€2121"], status: "active" as const },
    { id: "854455592", cells: ["COS-5592", "COSMOS Auto-Scaling Engine Item 2", "5/9/2026", "€5692"], status: "pending" as const },
    { id: "854459163", cells: ["COS-9163", "COSMOS Auto-Scaling Engine Item 3", "20/4/2026", "€9263"], status: "completed" as const },
    { id: "854462734", cells: ["COS-3734", "COSMOS Auto-Scaling Engine Item 4", "7/11/2026", "€12 834"], status: "warning" as const },
    { id: "854466305", cells: ["COS-7305", "COSMOS Auto-Scaling Engine Item 5", "22/6/2026", "€16 405"], status: "active" as const },
];
...
export default function CosmosAutoscalingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Auto-Scaling Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Auto-Scaling Engine</p>
                    </div>
                </div>
