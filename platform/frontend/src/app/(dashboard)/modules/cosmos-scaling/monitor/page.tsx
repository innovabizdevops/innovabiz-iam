...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Auto-Scaling Engine";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Cosmos Scaling","v":"1.469","t":"+2.4%","d":"up"},{"l":"Monitor Ativos","v":"7.047","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+6.8%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Scaling #001","Cosmos Scaling #002","5.509","7.232","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Scaling #002","Cosmos Scaling #003","8.119","389","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Scaling #003","Cosmos Scaling #004","7.500","8.567","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Scaling #004","Cosmos Scaling #005","330","4.291","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Scaling #005","Cosmos Scaling #001","6.395","1.080","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":244},{"label":"Fev","value":443},{"label":"Mar","value":492},{"label":"Abr","value":373},{"label":"Mai","value":278},{"label":"Jun","value":466},{"label":"Jul","value":419},{"label":"Ago","value":294},{"label":"Set","value":600},{"label":"Out","value":521},{"label":"Nov","value":600},{"label":"Dez","value":220}];
const MX = 600;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e1b4b'}}>RTM</span></h1>
                </div>
