...
const PAGE = "Scale";
const KPIS = [{"l":"Total Cosmos Scaling","v":"2.373","t":"+6.1%","d":"up"},{"l":"Scale Ativos","v":"4.834","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"56","t":"+14.0%","d":"up"}];
const COLS = ["ID","Scale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Scaling #001","Cosmos Scaling #002","113","1.393","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Scaling #002","Cosmos Scaling #003","4.329","3.165","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Scaling #003","Cosmos Scaling #004","3.558","903","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Scaling #004","Cosmos Scaling #005","646","2.628","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Scaling #005","Cosmos Scaling #001","3.643","3.214","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":369},{"label":"Fev","value":526},{"label":"Mar","value":341},{"label":"Abr","value":435},{"label":"Mai","value":468},{"label":"Jun","value":340},{"label":"Jul","value":621},{"label":"Ago","value":504},{"label":"Set","value":476},{"label":"Out","value":408},{"label":"Nov","value":537},{"label":"Dez","value":497}];
const MX = 621;
