...
const PAGE = "Balance";
const KPIS = [{"l":"Total Cosmos Scaling","v":"6.293","t":"+17.5%","d":"up"},{"l":"Balance Ativos","v":"6.403","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+17.0%","d":"up"}];
const COLS = ["ID","Balance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Scaling #001","Cosmos Scaling #002","6.369","1.489","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Scaling #002","Cosmos Scaling #003","1.995","2.492","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Scaling #003","Cosmos Scaling #004","5.452","344","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Scaling #004","Cosmos Scaling #005","1.579","2.838","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Scaling #005","Cosmos Scaling #001","394","1.452","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":392},{"label":"Mar","value":489},{"label":"Abr","value":525},{"label":"Mai","value":532},{"label":"Jun","value":559},{"label":"Jul","value":360},{"label":"Ago","value":658},{"label":"Set","value":653},{"label":"Out","value":389},{"label":"Nov","value":490},{"label":"Dez","value":491}];
const MX = 658;
