...
const KPIS = [{"l":"Total Condition Monitor","v":"1.977","t":"+10.9%","d":"up"},{"l":"Temperature Ativos","v":"6.823","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+14.4%","d":"up"}];
const COLS = ["ID","Temperature","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condition Monitor #001","Condition Monitor #002","4.181","7.239","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Condition Monitor #002","Condition Monitor #003","2.772","7.735","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Condition Monitor #003","Condition Monitor #004","5.653","7.420","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Condition Monitor #004","Condition Monitor #005","5.513","3.682","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condition Monitor #005","Condition Monitor #001","7.216","6.223","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":992},{"label":"Fev","value":999},{"label":"Mar","value":915},{"label":"Abr","value":796},{"label":"Mai","value":758},{"label":"Jun","value":1017},{"label":"Jul","value":939},{"label":"Ago","value":740},{"label":"Set","value":799},{"label":"Out","value":733},{"label":"Nov","value":926},{"label":"Dez","value":782}];
const MX = 1017;
