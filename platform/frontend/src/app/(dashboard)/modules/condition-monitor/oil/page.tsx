...
const PAGE = "Oil Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"3.051","t":"+1.8%","d":"up"},{"l":"Queries/Dia","v":"4860","t":"+8.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.104","t":"+16.2%","d":"up"},{"l":"Utilizadores Analytics","v":"6.527","t":"+4.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3826","2026-01-19","868","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2719","2026-01-09","5.147","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","209","2026-01-27","3.795","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3697","2026-03-01","1.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1375","2026-01-25","820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":768},{"label":"Mar","value":884},{"label":"Abr","value":760},{"label":"Mai","value":1033},{"label":"Jun","value":1010},{"label":"Jul","value":912},{"label":"Ago","value":881},{"label":"Set","value":972},{"label":"Out","value":939},{"label":"Nov","value":704},{"label":"Dez","value":863}];
const MX = 1033;
