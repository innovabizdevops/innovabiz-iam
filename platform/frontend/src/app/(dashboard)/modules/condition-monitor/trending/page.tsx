...
const PAGE = "Trending";
const KPIS = [{"l":"Total Condition Monitor","v":"5.907","t":"+9.4%","d":"up"},{"l":"Trending Ativos","v":"6.340","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+13.9%","d":"up"}];
const COLS = ["ID","Trending","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condition Monitor #001","Condition Monitor #002","9.018","2.758","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Condition Monitor #002","Condition Monitor #003","1.051","6.287","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Condition Monitor #003","Condition Monitor #004","7.621","3.993","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Condition Monitor #004","Condition Monitor #005","3.726","1.009","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condition Monitor #005","Condition Monitor #001","3.726","5.372","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":842},{"label":"Mar","value":613},{"label":"Abr","value":859},{"label":"Mai","value":639},{"label":"Jun","value":536},{"label":"Jul","value":548},{"label":"Ago","value":812},{"label":"Set","value":574},{"label":"Out","value":869},{"label":"Nov","value":878},{"label":"Dez","value":503}];
const MX = 878;
