...
const ACCENT = "#0e7490";
const MODULE = "Condition Monitoring";
const PAGE = "Vibration";
const KPIS = [{"l":"Total Condition Monitor","v":"8.045","t":"+2.5%","d":"up"},{"l":"Vibration Ativos","v":"2.303","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"87","t":"+6.1%","d":"up"}];
const COLS = ["ID","Vibration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condition Monitor #001","Condition Monitor #002","2.541","4.790","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Condition Monitor #002","Condition Monitor #003","7.451","9.031","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Condition Monitor #003","Condition Monitor #004","1.150","4.235","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Condition Monitor #004","Condition Monitor #005","7.469","6.324","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condition Monitor #005","Condition Monitor #001","4.521","1.108","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":349},{"label":"Mar","value":319},{"label":"Abr","value":439},{"label":"Mai","value":474},{"label":"Jun","value":413},{"label":"Jul","value":644},{"label":"Ago","value":553},{"label":"Set","value":624},{"label":"Out","value":374},{"label":"Nov","value":471},{"label":"Dez","value":362}];
const MX = 644;
