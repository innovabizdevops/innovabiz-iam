...
const PAGE = "Ultrasound";
const KPIS = [{"l":"Total Condition Monitor","v":"8.836","t":"+11.5%","d":"up"},{"l":"Ultrasound Ativos","v":"6.252","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"83.0%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"66","t":"+17.5%","d":"up"}];
const COLS = ["ID","Ultrasound","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Condition Monitor #001","Condition Monitor #002","2.847","7.481","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Condition Monitor #002","Condition Monitor #003","8.798","2.979","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Condition Monitor #003","Condition Monitor #004","4.495","2.354","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Condition Monitor #004","Condition Monitor #005","699","2.200","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Condition Monitor #005","Condition Monitor #001","5.312","6.345","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":649},{"label":"Mar","value":769},{"label":"Abr","value":731},{"label":"Mai","value":653},{"label":"Jun","value":680},{"label":"Jul","value":562},{"label":"Ago","value":862},{"label":"Set","value":870},{"label":"Out","value":628},{"label":"Nov","value":878},{"label":"Dez","value":657}];
const MX = 878;
