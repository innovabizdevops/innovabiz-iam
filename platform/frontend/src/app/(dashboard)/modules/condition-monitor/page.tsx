...
export default function ConditionMonitorPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Condition Monitor</h1><p className="text-sm text-muted-foreground">Condition Monitor • iBOS Enterprise</p></div>
