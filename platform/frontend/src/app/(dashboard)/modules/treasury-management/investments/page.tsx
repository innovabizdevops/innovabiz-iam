...
const PAGE = "Investments";
const KPIS = [{"l":"Projetos Melhoria","v":"3.885","t":"-1.2%","d":"down"},{"l":"Savings (€)","v":"€40769","t":"+-0.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.5%","t":"+17.2%","d":"up"},{"l":"Ciclos PDCA","v":"1.089","t":"+8.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.609","€ 2325.04","8.316","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.457","€ 24635.13","205","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.761","€ 43595.53","3.013","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.303","€ 21721.98","3.552","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.393","€ 8458.04","2.687","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":743},{"label":"Mar","value":823},{"label":"Abr","value":835},{"label":"Mai","value":749},{"label":"Jun","value":647},{"label":"Jul","value":511},{"label":"Ago","value":578},{"label":"Set","value":827},{"label":"Out","value":794},{"label":"Nov","value":551},{"label":"Dez","value":557}];
const MX = 835;
