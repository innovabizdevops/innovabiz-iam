...
const PAGE = "AI Treasury";
const KPIS = [{"l":"Projetos Melhoria","v":"8.554","t":"+12.0%","d":"up"},{"l":"Savings (€)","v":"€16318","t":"+9.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.1%","t":"-2.0%","d":"down"},{"l":"Ciclos PDCA","v":"6.614","t":"+9.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.266","€ 43195.01","3.996","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.002","€ 36233.34","2.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.905","€ 6097.63","6.607","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.117","€ 40793.79","536","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.653","€ 31209.12","2.223","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":344},{"label":"Fev","value":578},{"label":"Mar","value":518},{"label":"Abr","value":302},{"label":"Mai","value":474},{"label":"Jun","value":499},{"label":"Jul","value":511},{"label":"Ago","value":680},{"label":"Set","value":292},{"label":"Out","value":299},{"label":"Nov","value":578},{"label":"Dez","value":536}];
const MX = 680;
