...
const PAGE = "FX &amp; Hedging";
const KPIS = [{"l":"Projetos Melhoria","v":"6.662","t":"+10.1%","d":"up"},{"l":"Savings (€)","v":"€28141","t":"+3.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.7%","t":"-4.2%","d":"down"},{"l":"Ciclos PDCA","v":"6.682","t":"+14.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.303","€ 18710.24","8.943","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","960","€ 344.27","8.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.871","€ 18416.52","5.066","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.750","€ 29338.17","6.643","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","705","€ 39535.35","5.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":438},{"label":"Mar","value":598},{"label":"Abr","value":700},{"label":"Mai","value":565},{"label":"Jun","value":495},{"label":"Jul","value":603},{"label":"Ago","value":357},{"label":"Set","value":534},{"label":"Out","value":569},{"label":"Nov","value":419},{"label":"Dez","value":348}];
const MX = 700;
