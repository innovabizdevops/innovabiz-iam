...
const PAGE = "Cash Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.355","t":"+0.1%","d":"up"},{"l":"Savings (€)","v":"€37348","t":"+0.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"76.6%","t":"-5.8%","d":"down"},{"l":"Ciclos PDCA","v":"2.338","t":"+5.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.546","€ 12990.28","7.096","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","9.014","€ 15868.77","5.772","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.281","€ 33431.96","3.378","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","350","€ 9105.15","1.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.266","€ 14770.96","4.782","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":315},{"label":"Mar","value":423},{"label":"Abr","value":477},{"label":"Mai","value":321},{"label":"Jun","value":339},{"label":"Jul","value":350},{"label":"Ago","value":542},{"label":"Set","value":576},{"label":"Out","value":489},{"label":"Nov","value":401},{"label":"Dez","value":276}];
const MX = 576;
