...
const PAGE = "Liquidity";
const KPIS = [{"l":"Projetos Melhoria","v":"3.221","t":"+1.7%","d":"up"},{"l":"Savings (€)","v":"€70494","t":"-3.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.8%","t":"+4.4%","d":"up"},{"l":"Ciclos PDCA","v":"3.845","t":"+2.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.245","€ 38521.05","7.619","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.280","€ 33087.84","2.918","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.594","€ 47085.26","5.634","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.108","€ 29992.70","8.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","947","€ 40135.12","7.330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":678},{"label":"Mar","value":849},{"label":"Abr","value":853},{"label":"Mai","value":786},{"label":"Jun","value":554},{"label":"Jul","value":585},{"label":"Ago","value":837},{"label":"Set","value":491},{"label":"Out","value":822},{"label":"Nov","value":663},{"label":"Dez","value":743}];
const MX = 853;
