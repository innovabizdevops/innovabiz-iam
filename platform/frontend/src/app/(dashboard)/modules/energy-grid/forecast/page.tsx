...
const ACCENT = "#6366f1";
const MODULE = "Energy Grid Analytics";
const PAGE = "Load Forecast";
const KPIS = [{"l":"Total Energy Grid","v":"307","t":"+5.4%","d":"up"},{"l":"Load Forecast Ativos","v":"7.671","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"74","t":"+16.2%","d":"up"}];
const COLS = ["ID","Load Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Grid #001","Energy Grid #002","210","433","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Grid #002","Energy Grid #003","6.559","1.664","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Grid #003","Energy Grid #004","4.229","4.271","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Grid #004","Energy Grid #005","8.846","6.555","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Grid #005","Energy Grid #001","8.725","5.756","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":434},{"label":"Mar","value":562},{"label":"Abr","value":346},{"label":"Mai","value":482},{"label":"Jun","value":709},{"label":"Jul","value":521},{"label":"Ago","value":441},{"label":"Set","value":384},{"label":"Out","value":576},{"label":"Nov","value":642},{"label":"Dez","value":623}];
const MX = 709;
