...
const PAGE = "DER Mgmt";
const KPIS = [{"l":"Total Energy Grid","v":"8.974","t":"+6.8%","d":"up"},{"l":"DER Mgmt Ativos","v":"6.497","t":"+13.3%","d":"up"},{"l":"Eficiência (%)","v":"68.1%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"87","t":"+1.1%","d":"up"}];
const COLS = ["ID","DER Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Grid #001","Energy Grid #002","5.196","7.456","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Grid #002","Energy Grid #003","5.095","8.799","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Grid #003","Energy Grid #004","1.703","5.228","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Grid #004","Energy Grid #005","3.772","7.977","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Grid #005","Energy Grid #001","3.816","1.676","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":627},{"label":"Mar","value":572},{"label":"Abr","value":470},{"label":"Mai","value":593},{"label":"Jun","value":766},{"label":"Jul","value":536},{"label":"Ago","value":541},{"label":"Set","value":575},{"label":"Out","value":776},{"label":"Nov","value":714},{"label":"Dez","value":737}];
const MX = 776;
