...
const PAGE = "Outage";
const KPIS = [{"l":"Total Energy Grid","v":"6.092","t":"+14.5%","d":"up"},{"l":"Outage Ativos","v":"227","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"69","t":"+10.2%","d":"up"}];
const COLS = ["ID","Outage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Grid #001","Energy Grid #002","1.503","6.860","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Grid #002","Energy Grid #003","9.047","1.814","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Grid #003","Energy Grid #004","3.246","3.488","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Grid #004","Energy Grid #005","6.663","8.946","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Grid #005","Energy Grid #001","4.872","5.527","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":412},{"label":"Mar","value":576},{"label":"Abr","value":316},{"label":"Mai","value":456},{"label":"Jun","value":429},{"label":"Jul","value":371},{"label":"Ago","value":386},{"label":"Set","value":695},{"label":"Out","value":350},{"label":"Nov","value":352},{"label":"Dez","value":567}];
const MX = 695;
