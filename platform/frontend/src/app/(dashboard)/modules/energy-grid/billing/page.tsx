...
const PAGE = "Billing";
const KPIS = [{"l":"Total Energy Grid","v":"2.596","t":"+3.9%","d":"up"},{"l":"Billing Ativos","v":"2.101","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"76.3%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+8.6%","d":"up"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Grid #001","Energy Grid #002","3.738","5.444","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Grid #002","Energy Grid #003","6.590","7.502","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Grid #003","Energy Grid #004","2.894","995","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Grid #004","Energy Grid #005","7.301","2.521","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Grid #005","Energy Grid #001","6.016","4.565","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":789},{"label":"Mar","value":682},{"label":"Abr","value":823},{"label":"Mai","value":561},{"label":"Jun","value":694},{"label":"Jul","value":651},{"label":"Ago","value":597},{"label":"Set","value":601},{"label":"Out","value":743},{"label":"Nov","value":682},{"label":"Dez","value":581}];
const MX = 823;
