...
const PAGE = "Topology";
const KPIS = [{"l":"Total Energy Grid","v":"7.202","t":"+5.4%","d":"up"},{"l":"Topology Ativos","v":"1.027","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"82","t":"+8.8%","d":"up"}];
const COLS = ["ID","Topology","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Energy Grid #001","Energy Grid #002","1.413","8.376","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Energy Grid #002","Energy Grid #003","959","5.130","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Energy Grid #003","Energy Grid #004","3.178","2.012","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Energy Grid #004","Energy Grid #005","4.109","3.559","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Energy Grid #005","Energy Grid #001","8.004","4.645","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":809},{"label":"Mar","value":513},{"label":"Abr","value":758},{"label":"Mai","value":810},{"label":"Jun","value":543},{"label":"Jul","value":510},{"label":"Ago","value":575},{"label":"Set","value":723},{"label":"Out","value":737},{"label":"Nov","value":552},{"label":"Dez","value":814}];
const MX = 854;
