...
const PAGE = "Hive Mind";
const KPIS = [{"l":"eNPS","v":"88","t":"+4.5%","d":"up"},{"l":"Engagement (%)","v":"67.4%","t":"-2.3%","d":"down"},{"l":"Turnover (%)","v":"65.2%","t":"+8.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.013","t":"-5.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.424","2026-02-13","81","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.636","2026-03-13","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.589","2026-01-09","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.116","2026-02-06","55","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.602","2026-02-27","65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":260},{"label":"Mar","value":328},{"label":"Abr","value":403},{"label":"Mai","value":412},{"label":"Jun","value":293},{"label":"Jul","value":247},{"label":"Ago","value":546},{"label":"Set","value":521},{"label":"Out","value":571},{"label":"Nov","value":408},{"label":"Dez","value":250}];
const MX = 571;
