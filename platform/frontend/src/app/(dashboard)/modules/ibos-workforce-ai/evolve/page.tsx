...
const ACCENT = "#312e81";
const MODULE = "iBOS AI Workforce (4516)";
const PAGE = "Evolve";
const KPIS = [{"l":"eNPS","v":"59","t":"+13.4%","d":"up"},{"l":"Engagement (%)","v":"65.6%","t":"+1.7%","d":"up"},{"l":"Turnover (%)","v":"73.3%","t":"-0.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.448","t":"+14.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.929","2026-03-20","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.191","2026-01-02","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.289","2026-01-11","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","404","2026-01-08","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.758","2026-03-08","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":574},{"label":"Mar","value":733},{"label":"Abr","value":527},{"label":"Mai","value":655},{"label":"Jun","value":781},{"label":"Jul","value":565},{"label":"Ago","value":483},{"label":"Set","value":599},{"label":"Out","value":791},{"label":"Nov","value":690},{"label":"Dez","value":491}];
const MX = 795;
