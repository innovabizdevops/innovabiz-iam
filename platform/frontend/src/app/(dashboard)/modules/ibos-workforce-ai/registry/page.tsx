...
const PAGE = "Registry";
const KPIS = [{"l":"eNPS","v":"76","t":"+2.2%","d":"up"},{"l":"Engagement (%)","v":"77.6%","t":"+1.2%","d":"up"},{"l":"Turnover (%)","v":"85.3%","t":"+0.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.932","t":"+5.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.955","2026-02-07","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.384","2026-03-11","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.127","2026-03-12","92","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.427","2026-03-11","76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.196","2026-02-19","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":705},{"label":"Mar","value":619},{"label":"Abr","value":650},{"label":"Mai","value":840},{"label":"Jun","value":663},{"label":"Jul","value":873},{"label":"Ago","value":634},{"label":"Set","value":827},{"label":"Out","value":631},{"label":"Nov","value":792},{"label":"Dez","value":658}];
const MX = 873;
