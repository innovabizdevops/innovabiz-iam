...
const PAGE = "Gen-2";
const KPIS = [{"l":"eNPS","v":"58","t":"+0.3%","d":"up"},{"l":"Engagement (%)","v":"67.3%","t":"-2.5%","d":"down"},{"l":"Turnover (%)","v":"91.3%","t":"+0.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.976","t":"-2.1%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.060","2026-03-15","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.114","2026-03-28","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","669","2026-02-24","72","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.890","2026-03-05","57","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.596","2026-03-03","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":389},{"label":"Mar","value":576},{"label":"Abr","value":722},{"label":"Mai","value":564},{"label":"Jun","value":351},{"label":"Jul","value":703},{"label":"Ago","value":638},{"label":"Set","value":557},{"label":"Out","value":490},{"label":"Nov","value":499},{"label":"Dez","value":648}];
const MX = 722;
