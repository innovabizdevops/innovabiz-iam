...
/* ═══ iBOS AI Workforce (4516) — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "6014", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "664", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€288K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1867215214", cells: ["IBO-4214", "iBOS AI Workforce (4516) Item 1", "19/11/2026", "€15 314"], status: "active" as const },
    { id: "1867218785", cells: ["IBO-7785", "iBOS AI Workforce (4516) Item 2", "6/6/2026", "€18 885"], status: "pending" as const },
    { id: "1867222356", cells: ["IBO-2356", "iBOS AI Workforce (4516) Item 3", "21/1/2026", "€22 456"], status: "completed" as const },
    { id: "1867225927", cells: ["IBO-5927", "iBOS AI Workforce (4516) Item 4", "8/8/2026", "€26 027"], status: "warning" as const },
    { id: "1867229498", cells: ["IBO-9498", "iBOS AI Workforce (4516) Item 5", "23/3/2026", "€29 598"], status: "active" as const },
];
...
export default function IbosAiWorkforce4516Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">iBOS AI Workforce (4516)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • iBOS AI Workforce (4516)</p>
                    </div>
                </div>
