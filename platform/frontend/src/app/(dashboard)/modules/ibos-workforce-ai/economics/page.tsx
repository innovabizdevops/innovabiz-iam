...
const PAGE = "Economics";
const KPIS = [{"l":"eNPS","v":"55","t":"-4.7%","d":"down"},{"l":"Engagement (%)","v":"78.8%","t":"+13.9%","d":"up"},{"l":"Turnover (%)","v":"94.2%","t":"+1.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.085","t":"-1.4%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.306","2026-03-22","85","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","565","2026-01-09","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.190","2026-03-03","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.366","2026-03-02","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","474","2026-03-22","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":836},{"label":"Mar","value":777},{"label":"Abr","value":907},{"label":"Mai","value":835},{"label":"Jun","value":882},{"label":"Jul","value":851},{"label":"Ago","value":844},{"label":"Set","value":709},{"label":"Out","value":675},{"label":"Nov","value":655},{"label":"Dez","value":903}];
const MX = 907;
