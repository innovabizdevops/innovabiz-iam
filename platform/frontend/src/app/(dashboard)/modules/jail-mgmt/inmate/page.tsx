...
const PAGE = "Inmate";
const KPIS = [{"l":"Total Jail Mgmt","v":"5.229","t":"+4.7%","d":"up"},{"l":"Inmate Ativos","v":"3.022","t":"+14.9%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.1%","d":"down"}];
const COLS = ["ID","Inmate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jail Mgmt #001","Jail Mgmt #002","3.955","763","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Jail Mgmt #002","Jail Mgmt #003","8.203","8.473","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Jail Mgmt #003","Jail Mgmt #004","1.462","5.686","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Jail Mgmt #004","Jail Mgmt #005","273","2.535","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jail Mgmt #005","Jail Mgmt #001","3.622","1.153","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":426},{"label":"Mar","value":577},{"label":"Abr","value":393},{"label":"Mai","value":428},{"label":"Jun","value":725},{"label":"Jul","value":717},{"label":"Ago","value":634},{"label":"Set","value":732},{"label":"Out","value":705},{"label":"Nov","value":703},{"label":"Dez","value":434}];
const MX = 732;
