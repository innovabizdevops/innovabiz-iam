...
const PAGE = "Release";
const KPIS = [{"l":"Total Jail Mgmt","v":"5.629","t":"-2.0%","d":"down"},{"l":"Release Ativos","v":"648","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"90.8%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+14.0%","d":"up"}];
const COLS = ["ID","Release","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jail Mgmt #001","Jail Mgmt #002","1.226","1.513","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Jail Mgmt #002","Jail Mgmt #003","7.814","5.312","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Jail Mgmt #003","Jail Mgmt #004","9.097","2.294","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Jail Mgmt #004","Jail Mgmt #005","5.693","1.144","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jail Mgmt #005","Jail Mgmt #001","7.762","8.774","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":896},{"label":"Mar","value":646},{"label":"Abr","value":752},{"label":"Mai","value":881},{"label":"Jun","value":534},{"label":"Jul","value":796},{"label":"Ago","value":522},{"label":"Set","value":518},{"label":"Out","value":603},{"label":"Nov","value":653},{"label":"Dez","value":648}];
const MX = 896;
