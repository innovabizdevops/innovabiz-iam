...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"4.173","t":"+0.9%","d":"up"},{"l":"RevPAR (€)","v":"€17108","t":"+3.2%","d":"up"},{"l":"Ocupação (%)","v":"70.1%","t":"+11.5%","d":"up"},{"l":"Guest Satisfaction","v":"999","t":"+4.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.485","2026-03-05","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.202","2026-03-07","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.273","2026-01-08","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.510","2026-03-15","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.193","2026-02-06","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":787},{"label":"Mar","value":649},{"label":"Abr","value":805},{"label":"Mai","value":671},{"label":"Jun","value":843},{"label":"Jul","value":924},{"label":"Ago","value":710},{"label":"Set","value":748},{"label":"Out","value":950},{"label":"Nov","value":1022},{"label":"Dez","value":661}];
const MX = 1022;
