...
const ACCENT = "#6366f1";
const MODULE = "Jail Management";
const PAGE = "Classification";
const KPIS = [{"l":"Total Jail Mgmt","v":"8.946","t":"+11.6%","d":"up"},{"l":"Classification Ativos","v":"5.160","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.9%","d":"up"}];
const COLS = ["ID","Classification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jail Mgmt #001","Jail Mgmt #002","2.445","2.807","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Jail Mgmt #002","Jail Mgmt #003","462","5.746","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Jail Mgmt #003","Jail Mgmt #004","2.296","7.535","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Jail Mgmt #004","Jail Mgmt #005","8.058","9.021","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jail Mgmt #005","Jail Mgmt #001","1.003","5.792","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":357},{"label":"Mar","value":460},{"label":"Abr","value":475},{"label":"Mai","value":498},{"label":"Jun","value":405},{"label":"Jul","value":315},{"label":"Ago","value":429},{"label":"Set","value":445},{"label":"Out","value":414},{"label":"Nov","value":292},{"label":"Dez","value":317}];
const MX = 498;
