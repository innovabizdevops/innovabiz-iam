...
const PAGE = "Commissary";
const KPIS = [{"l":"Total Jail Mgmt","v":"7.306","t":"+5.7%","d":"up"},{"l":"Commissary Ativos","v":"6.860","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"88","t":"-1.7%","d":"down"}];
const COLS = ["ID","Commissary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jail Mgmt #001","Jail Mgmt #002","2.814","1.527","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Jail Mgmt #002","Jail Mgmt #003","6.749","7.063","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Jail Mgmt #003","Jail Mgmt #004","3.092","7.018","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Jail Mgmt #004","Jail Mgmt #005","560","314","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jail Mgmt #005","Jail Mgmt #001","5.732","8.905","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1019},{"label":"Fev","value":816},{"label":"Mar","value":730},{"label":"Abr","value":714},{"label":"Mai","value":936},{"label":"Jun","value":754},{"label":"Jul","value":922},{"label":"Ago","value":1067},{"label":"Set","value":1072},{"label":"Out","value":710},{"label":"Nov","value":1023},{"label":"Dez","value":758}];
const MX = 1072;
