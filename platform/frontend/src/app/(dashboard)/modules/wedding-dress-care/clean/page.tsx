...
const PAGE = "Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"7.786","t":"-4.6%","d":"down"},{"l":"Savings (€)","v":"€71640","t":"+6.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.1%","t":"+10.1%","d":"up"},{"l":"Ciclos PDCA","v":"5.503","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.880","€ 17951.24","3.946","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","949","€ 23088.96","1.537","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.942","€ 7883.79","5.719","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","9.090","€ 2040.35","220","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.603","€ 33254.79","1.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":779},{"label":"Mar","value":929},{"label":"Abr","value":875},{"label":"Mai","value":583},{"label":"Jun","value":847},{"label":"Jul","value":785},{"label":"Ago","value":818},{"label":"Set","value":750},{"label":"Out","value":862},{"label":"Nov","value":680},{"label":"Dez","value":898}];
const MX = 929;
