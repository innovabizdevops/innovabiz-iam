...
const ACCENT = "#164e63";
const MODULE = "Wedding & Specialty";
const PAGE = "Deliver";
const KPIS = [{"l":"Total Wedding Dress Care","v":"8.800","t":"+11.3%","d":"up"},{"l":"Deliver Ativos","v":"2.303","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"63","t":"+9.5%","d":"up"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wedding Dress Care #001","Wedding Dress Care #002","2.357","2.979","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Wedding Dress Care #002","Wedding Dress Care #003","5.741","6.320","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Wedding Dress Care #003","Wedding Dress Care #004","3.672","1.728","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Wedding Dress Care #004","Wedding Dress Care #005","2.873","6.240","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wedding Dress Care #005","Wedding Dress Care #001","1.687","2.781","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":784},{"label":"Mar","value":610},{"label":"Abr","value":684},{"label":"Mai","value":798},{"label":"Jun","value":839},{"label":"Jul","value":653},{"label":"Ago","value":835},{"label":"Set","value":561},{"label":"Out","value":676},{"label":"Nov","value":720},{"label":"Dez","value":533}];
const MX = 839;
