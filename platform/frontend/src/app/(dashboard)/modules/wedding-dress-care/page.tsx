...
/* ═══ Wedding & Specialty — Dashboard ═══ */

const ACCENT = "#164e63";

const KPIS = [
    { label: "Total Registos", value: "8205", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "772", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€194K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2025825305", cells: ["WED-7305", "Wedding & Specialty Item 1", "22/6/2026", "€25 405"], status: "active" as const },
    { id: "2025828876", cells: ["WED-1876", "Wedding & Specialty Item 2", "9/1/2026", "€28 976"], status: "pending" as const },
    { id: "2025832447", cells: ["WED-5447", "Wedding & Specialty Item 3", "24/8/2026", "€32 547"], status: "completed" as const },
    { id: "2025836018", cells: ["WED-9018", "Wedding & Specialty Item 4", "11/3/2026", "€36 118"], status: "warning" as const },
    { id: "2025839589", cells: ["WED-3589", "Wedding & Specialty Item 5", "26/10/2026", "€39 689"], status: "active" as const },
];
...
export default function WeddingSpecialtyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Wedding & Specialty</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Wedding & Specialty</p>
                    </div>
                </div>
