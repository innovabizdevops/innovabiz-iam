...
const PAGE = "Feeding";
const KPIS = [{"l":"Integrações Ativas","v":"7.958","t":"+13.4%","d":"up"},{"l":"Chamadas/Hora","v":"192","t":"-0.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"79.4%","t":"+8.3%","d":"up"},{"l":"Latência Média (ms)","v":"170ms","t":"-0.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.725","4.500","89.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.683","2.505","97.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.264","592","75.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.852","217","94.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.008","8.031","77.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":692},{"label":"Mar","value":544},{"label":"Abr","value":417},{"label":"Mai","value":746},{"label":"Jun","value":482},{"label":"Jul","value":405},{"label":"Ago","value":799},{"label":"Set","value":787},{"label":"Out","value":632},{"label":"Nov","value":796},{"label":"Dez","value":402}];
const MX = 799;
