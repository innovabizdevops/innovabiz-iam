...
const PAGE = "Life Cycle";
const KPIS = [{"l":"Formulários Ativos","v":"1.865","t":"-0.3%","d":"down"},{"l":"Submissões/Dia","v":"3525","t":"-4.3%","d":"down"},{"l":"Documentos Gerados","v":"7.736","t":"+7.2%","d":"up"},{"l":"Templates","v":"8.191","t":"+3.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.761","2026-01-25","4.665","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","469","2026-03-24","5.852","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.051","2026-03-18","8.656","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.669","2026-02-27","1.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.222","2026-02-25","979","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":490},{"label":"Mar","value":688},{"label":"Abr","value":830},{"label":"Mai","value":673},{"label":"Jun","value":719},{"label":"Jul","value":606},{"label":"Ago","value":808},{"label":"Set","value":755},{"label":"Out","value":874},{"label":"Nov","value":493},{"label":"Dez","value":831}];
const MX = 874;
