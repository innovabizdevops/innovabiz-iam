...
const PAGE = "Disassembly";
const KPIS = [{"l":"Formulários Ativos","v":"2.709","t":"+13.8%","d":"up"},{"l":"Submissões/Dia","v":"191","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"7.640","t":"-2.5%","d":"down"},{"l":"Templates","v":"8.248","t":"+10.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.359","2026-03-12","7.695","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.402","2026-02-05","1.487","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.061","2026-02-25","278","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.568","2026-02-06","8.704","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.902","2026-02-05","724","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":760},{"label":"Mar","value":870},{"label":"Abr","value":516},{"label":"Mai","value":718},{"label":"Jun","value":572},{"label":"Jul","value":609},{"label":"Ago","value":682},{"label":"Set","value":583},{"label":"Out","value":824},{"label":"Nov","value":736},{"label":"Dez","value":716}];
const MX = 870;
