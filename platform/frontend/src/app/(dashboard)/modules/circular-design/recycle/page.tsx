...
const PAGE = "Recyclability";
const KPIS = [{"l":"Formulários Ativos","v":"6.244","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"3958","t":"+17.0%","d":"up"},{"l":"Documentos Gerados","v":"6.366","t":"+5.8%","d":"up"},{"l":"Templates","v":"7.743","t":"+12.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.943","2026-02-17","2.661","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.991","2026-03-20","2.246","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.789","2026-03-19","6.342","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.836","2026-01-03","6.193","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.345","2026-03-05","5.010","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":773},{"label":"Mar","value":933},{"label":"Abr","value":943},{"label":"Mai","value":955},{"label":"Jun","value":894},{"label":"Jul","value":625},{"label":"Ago","value":856},{"label":"Set","value":703},{"label":"Out","value":638},{"label":"Nov","value":714},{"label":"Dez","value":843}];
const MX = 955;
