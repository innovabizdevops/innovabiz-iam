...
const PAGE = "Repair Index";
const KPIS = [{"l":"Formulários Ativos","v":"3.850","t":"+2.0%","d":"up"},{"l":"Submissões/Dia","v":"1532","t":"+17.1%","d":"up"},{"l":"Documentos Gerados","v":"5.854","t":"+8.2%","d":"up"},{"l":"Templates","v":"1.542","t":"+3.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.733","2026-02-18","4.366","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.340","2026-01-26","419","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.693","2026-01-25","4.038","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.239","2026-03-04","112","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","463","2026-03-04","7.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":832},{"label":"Mar","value":766},{"label":"Abr","value":697},{"label":"Mai","value":780},{"label":"Jun","value":682},{"label":"Jul","value":585},{"label":"Ago","value":589},{"label":"Set","value":592},{"label":"Out","value":735},{"label":"Nov","value":902},{"label":"Dez","value":803}];
const MX = 902;
