...
const ACCENT = "#7c3aed";
const MODULE = "Circular Design";
const PAGE = "Material Select";
const KPIS = [{"l":"Formulários Ativos","v":"8.225","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"4050","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"1.373","t":"+15.6%","d":"up"},{"l":"Templates","v":"4.650","t":"-4.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.905","2026-02-21","7.134","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.714","2026-02-07","1.686","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.765","2026-01-23","1.657","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.447","2026-02-03","598","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.550","2026-01-09","4.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":473},{"label":"Mar","value":395},{"label":"Abr","value":312},{"label":"Mai","value":440},{"label":"Jun","value":445},{"label":"Jul","value":280},{"label":"Ago","value":625},{"label":"Set","value":590},{"label":"Out","value":297},{"label":"Nov","value":570},{"label":"Dez","value":511}];
const MX = 625;
