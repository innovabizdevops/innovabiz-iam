...
const ACCENT = "#6366f1";
const MODULE = "Guest Experience";
const PAGE = "Concierge AI";
const KPIS = [{"l":"Perfis Unificados","v":"8.957","t":"+12.5%","d":"up"},{"l":"Segmentos Ativos","v":"808","t":"+14.2%","d":"up"},{"l":"NPS Score","v":"62","t":"+15.4%","d":"up"},{"l":"Churn Previsto (%)","v":"91.7%","t":"+2.3%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","3.405","€ 35460.47","85.9%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.576","€ 20032.64","76.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","4.323","€ 26817.82","77.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","9.099","€ 24223.69","73.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","468","€ 20436.25","77.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":1019},{"label":"Mar","value":656},{"label":"Abr","value":966},{"label":"Mai","value":898},{"label":"Jun","value":879},{"label":"Jul","value":634},{"label":"Ago","value":926},{"label":"Set","value":791},{"label":"Out","value":878},{"label":"Nov","value":858},{"label":"Dez","value":849}];
const MX = 1019;
