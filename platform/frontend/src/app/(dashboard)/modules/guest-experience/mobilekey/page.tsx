...
const PAGE = "Mobile Key";
const KPIS = [{"l":"Perfis Unificados","v":"4.051","t":"+4.9%","d":"up"},{"l":"Segmentos Ativos","v":"390","t":"-4.6%","d":"down"},{"l":"NPS Score","v":"69","t":"+17.3%","d":"up"},{"l":"Churn Previsto (%)","v":"79.9%","t":"+8.8%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.046","€ 7255.55","72.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.196","€ 33465.76","88.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","1.408","€ 31199.34","89.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.363","€ 41255.95","75.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","5.567","€ 14911.95","77.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":555},{"label":"Mar","value":311},{"label":"Abr","value":320},{"label":"Mai","value":592},{"label":"Jun","value":602},{"label":"Jul","value":617},{"label":"Ago","value":521},{"label":"Set","value":586},{"label":"Out","value":392},{"label":"Nov","value":489},{"label":"Dez","value":375}];
const MX = 617;
