...
const ACCENT = "#1e3a5f";
const MODULE = "Rail Management Platform";
const PAGE = "Track";
const KPIS = [{"l":"Veículos Operação","v":"704","t":"+5.1%","d":"up"},{"l":"Viagens/Dia","v":"187","t":"+6.3%","d":"up"},{"l":"Pontualidade (%)","v":"82.8%","t":"-2.9%","d":"down"},{"l":"Passageiros/Dia","v":"945","t":"+11.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-09","2026-03-01","1.398","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-14","2026-02-28","8.649","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-24","2026-02-27","2.532","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-26","2026-03-08","5.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-19","2026-02-07","8.852","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":622},{"label":"Mar","value":784},{"label":"Abr","value":869},{"label":"Mai","value":636},{"label":"Jun","value":641},{"label":"Jul","value":576},{"label":"Ago","value":624},{"label":"Set","value":928},{"label":"Out","value":610},{"label":"Nov","value":833},{"label":"Dez","value":743}];
const MX = 928;
