...
const PAGE = "Safety";
const KPIS = [{"l":"Veículos Operação","v":"5.605","t":"-4.0%","d":"down"},{"l":"Viagens/Dia","v":"2330","t":"+10.9%","d":"up"},{"l":"Pontualidade (%)","v":"73.8%","t":"+0.4%","d":"up"},{"l":"Passageiros/Dia","v":"4838","t":"+5.7%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-09","2026-03-21","6.032","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-26","2026-03-17","7.270","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-06","2026-03-16","4.512","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-15","2026-03-21","7.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-01","2026-01-20","1.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":798},{"label":"Mar","value":502},{"label":"Abr","value":552},{"label":"Mai","value":767},{"label":"Jun","value":719},{"label":"Jul","value":688},{"label":"Ago","value":776},{"label":"Set","value":739},{"label":"Out","value":709},{"label":"Nov","value":673},{"label":"Dez","value":704}];
const MX = 798;
