...
/* ═══ Rail Management Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1071", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "395", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€456K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "84%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "641619971", cells: ["RAI-1971", "Rail Management Platform Item 1", "28/12/2026", "€20 071"], status: "active" as const },
    { id: "641623542", cells: ["RAI-5542", "Rail Management Platform Item 2", "15/7/2026", "€23 642"], status: "pending" as const },
    { id: "641627113", cells: ["RAI-9113", "Rail Management Platform Item 3", "2/2/2026", "€27 213"], status: "completed" as const },
    { id: "641630684", cells: ["RAI-3684", "Rail Management Platform Item 4", "17/9/2026", "€30 784"], status: "warning" as const },
    { id: "641634255", cells: ["RAI-7255", "Rail Management Platform Item 5", "4/4/2026", "€34 355"], status: "active" as const },
];
...
export default function RailManagementPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rail Management Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rail Management Platform</p>
                    </div>
                </div>
