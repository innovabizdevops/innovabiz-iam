...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"3.728","t":"+14.4%","d":"up"},{"l":"Valor Total (€M)","v":"€29.0M","t":"+16.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€60070","t":"+2.5%","d":"up"},{"l":"Ativos em Garantia","v":"4.884","t":"-3.3%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 29726.88","4.309","€ 6810.04","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 37902.60","6.285","€ 8325.02","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 2688.09","4.158","€ 10837.19","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 32902.50","8.658","€ 9800.57","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 21374.17","4.163","€ 1564.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":376},{"label":"Mar","value":631},{"label":"Abr","value":492},{"label":"Mai","value":496},{"label":"Jun","value":653},{"label":"Jul","value":456},{"label":"Ago","value":762},{"label":"Set","value":747},{"label":"Out","value":590},{"label":"Nov","value":368},{"label":"Dez","value":712}];
const MX = 762;
