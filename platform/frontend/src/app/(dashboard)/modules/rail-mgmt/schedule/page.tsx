...
const PAGE = "Schedule";
const KPIS = [{"l":"Veículos Operação","v":"4.155","t":"-2.8%","d":"down"},{"l":"Viagens/Dia","v":"1651","t":"+7.5%","d":"up"},{"l":"Pontualidade (%)","v":"76.1%","t":"+12.9%","d":"up"},{"l":"Passageiros/Dia","v":"334","t":"+1.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-13","2026-03-27","8.745","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-20","2026-02-15","2.019","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-15","2026-01-18","352","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-14","2026-02-20","5.844","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-16","2026-02-14","8.514","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":497},{"label":"Mar","value":309},{"label":"Abr","value":597},{"label":"Mai","value":540},{"label":"Jun","value":670},{"label":"Jul","value":608},{"label":"Ago","value":659},{"label":"Set","value":422},{"label":"Out","value":348},{"label":"Nov","value":643},{"label":"Dez","value":626}];
const MX = 670;
