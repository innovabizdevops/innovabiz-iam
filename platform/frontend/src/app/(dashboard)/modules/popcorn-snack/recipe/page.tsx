...
const ACCENT = "#f59e0b";
const MODULE = "Popcorn & Snack Mfg";
const PAGE = "Recipe";
const KPIS = [{"l":"Total Popcorn Snack","v":"2.529","t":"-0.8%","d":"down"},{"l":"Recipe Ativos","v":"5.880","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"61","t":"+14.7%","d":"up"}];
const COLS = ["ID","Recipe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Popcorn Snack #001","Popcorn Snack #002","7.626","2.390","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Popcorn Snack #002","Popcorn Snack #003","4.184","1.422","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Popcorn Snack #003","Popcorn Snack #004","6.139","3.658","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Popcorn Snack #004","Popcorn Snack #005","934","4.130","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Popcorn Snack #005","Popcorn Snack #001","1.970","2.142","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":735},{"label":"Mar","value":558},{"label":"Abr","value":679},{"label":"Mai","value":630},{"label":"Jun","value":602},{"label":"Jul","value":772},{"label":"Ago","value":670},{"label":"Set","value":543},{"label":"Out","value":819},{"label":"Nov","value":585},{"label":"Dez","value":782}];
const MX = 819;
