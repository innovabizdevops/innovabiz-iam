...
/* ═══ Popcorn & Snack Mfg — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "5521", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3816", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€156K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "257633121", cells: ["POP-9121", "Popcorn & Snack Mfg Item 1", "26/10/2026", "€33 221"], status: "active" as const },
    { id: "257636692", cells: ["POP-3692", "Popcorn & Snack Mfg Item 2", "13/5/2026", "€36 792"], status: "pending" as const },
    { id: "257640263", cells: ["POP-7263", "Popcorn & Snack Mfg Item 3", "28/12/2026", "€40 363"], status: "completed" as const },
    { id: "257643834", cells: ["POP-1834", "Popcorn & Snack Mfg Item 4", "15/7/2026", "€43 934"], status: "warning" as const },
    { id: "257647405", cells: ["POP-5405", "Popcorn & Snack Mfg Item 5", "2/2/2026", "€47 505"], status: "active" as const },
];
...
export default function PopcornSnackMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Popcorn & Snack Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Popcorn & Snack Mfg</p>
                    </div>
                </div>
