...
export default function RealWorldDataPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Real World Data</h1><p className="text-sm text-muted-foreground">Real World Data • iBOS Enterprise</p></div>
