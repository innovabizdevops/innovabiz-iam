...
const PAGE = "Visual";
const KPIS = [{"l":"Dashboards Ativos","v":"6.019","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"4710","t":"-4.7%","d":"down"},{"l":"Dados Processados (GB)","v":"7.415","t":"+10.3%","d":"up"},{"l":"Utilizadores Analytics","v":"5.092","t":"+10.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2730","2026-02-16","3.018","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1764","2026-03-21","8.540","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4243","2026-02-27","3.716","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3524","2026-03-10","1.356","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","757","2026-02-06","8.229","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":694},{"label":"Mar","value":567},{"label":"Abr","value":655},{"label":"Mai","value":760},{"label":"Jun","value":902},{"label":"Jul","value":702},{"label":"Ago","value":732},{"label":"Set","value":567},{"label":"Out","value":591},{"label":"Nov","value":612},{"label":"Dez","value":612}];
const MX = 902;
