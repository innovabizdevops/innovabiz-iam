...
/* ═══ Test Automation Deep — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "8298", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4744", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€135K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1714222898", cells: ["TES-2898", "Test Automation Deep Item 1", "11/3/2026", "€22 998"], status: "active" as const },
    { id: "1714226469", cells: ["TES-6469", "Test Automation Deep Item 2", "26/10/2026", "€26 569"], status: "pending" as const },
    { id: "1714230040", cells: ["TES-1040", "Test Automation Deep Item 3", "13/5/2026", "€30 140"], status: "completed" as const },
    { id: "1714233611", cells: ["TES-4611", "Test Automation Deep Item 4", "28/12/2026", "€33 711"], status: "warning" as const },
    { id: "1714237182", cells: ["TES-8182", "Test Automation Deep Item 5", "15/7/2026", "€37 282"], status: "active" as const },
];
...
export default function TestAutomationDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Test Automation Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Test Automation Deep</p>
                    </div>
                </div>
