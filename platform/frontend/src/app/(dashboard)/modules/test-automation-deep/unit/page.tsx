...
const PAGE = "Unit";
const KPIS = [{"l":"Total Test Automation Deep","v":"5.660","t":"+1.9%","d":"up"},{"l":"Unit Ativos","v":"238","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"65.4%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"79","t":"+11.4%","d":"up"}];
const COLS = ["ID","Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Automation Deep #001","Test Automation Deep #002","2.740","4.755","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Test Automation Deep #002","Test Automation Deep #003","2.757","9.076","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Automation Deep #003","Test Automation Deep #004","2.076","5.529","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Test Automation Deep #004","Test Automation Deep #005","7.424","5.858","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Automation Deep #005","Test Automation Deep #001","3.610","6.784","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":817},{"label":"Fev","value":648},{"label":"Mar","value":759},{"label":"Abr","value":943},{"label":"Mai","value":636},{"label":"Jun","value":961},{"label":"Jul","value":839},{"label":"Ago","value":730},{"label":"Set","value":891},{"label":"Out","value":871},{"label":"Nov","value":921},{"label":"Dez","value":727}];
const MX = 961;
