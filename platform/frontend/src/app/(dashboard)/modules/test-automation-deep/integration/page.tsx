...
const KPIS = [{"l":"Integrações Ativas","v":"3.856","t":"+5.4%","d":"up"},{"l":"Chamadas/Hora","v":"3226","t":"+15.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.9%","t":"+7.6%","d":"up"},{"l":"Latência Média (ms)","v":"31ms","t":"+4.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.092","2.097","71.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.730","7.024","82.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.555","5.556","93.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.767","8.054","97.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","875","5.751","86.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":678},{"label":"Mar","value":702},{"label":"Abr","value":672},{"label":"Mai","value":735},{"label":"Jun","value":477},{"label":"Jul","value":500},{"label":"Ago","value":673},{"label":"Set","value":394},{"label":"Out","value":479},{"label":"Nov","value":782},{"label":"Dez","value":613}];
const MX = 782;
