...
const ACCENT = "#1e40af";
const MODULE = "Test Automation Deep";
const PAGE = "E2E";
const KPIS = [{"l":"Total Test Automation Deep","v":"8.781","t":"+6.0%","d":"up"},{"l":"E2E Ativos","v":"3.803","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"57","t":"-5.6%","d":"down"}];
const COLS = ["ID","E2E","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Test Automation Deep #001","Test Automation Deep #002","5.997","8.316","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Test Automation Deep #002","Test Automation Deep #003","3.546","5.320","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Test Automation Deep #003","Test Automation Deep #004","9.037","8.962","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Test Automation Deep #004","Test Automation Deep #005","2.525","5.135","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Test Automation Deep #005","Test Automation Deep #001","6.656","5.591","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":382},{"label":"Mar","value":771},{"label":"Abr","value":374},{"label":"Mai","value":379},{"label":"Jun","value":618},{"label":"Jul","value":694},{"label":"Ago","value":613},{"label":"Set","value":605},{"label":"Out","value":434},{"label":"Nov","value":732},{"label":"Dez","value":671}];
const MX = 771;
