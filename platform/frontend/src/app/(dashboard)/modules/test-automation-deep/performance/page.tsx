...
const KPIS = [{"l":"Formulários Ativos","v":"7.486","t":"-3.3%","d":"down"},{"l":"Submissões/Dia","v":"1348","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"5.494","t":"+2.5%","d":"up"},{"l":"Templates","v":"5.307","t":"+7.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.023","2026-02-02","2.188","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.256","2026-03-07","3.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.961","2026-01-13","8.235","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.271","2026-03-15","1.110","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.838","2026-02-05","4.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":648},{"label":"Mar","value":968},{"label":"Abr","value":1015},{"label":"Mai","value":759},{"label":"Jun","value":645},{"label":"Jul","value":838},{"label":"Ago","value":1005},{"label":"Set","value":933},{"label":"Out","value":716},{"label":"Nov","value":909},{"label":"Dez","value":916}];
const MX = 1015;
