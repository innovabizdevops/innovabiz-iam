...
const PAGE = "Review";
const KPIS = [{"l":"Total Vfx Pipeline","v":"231","t":"-2.9%","d":"down"},{"l":"Review Ativos","v":"3.349","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.0%","d":"up"}];
const COLS = ["ID","Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Pipeline #001","Vfx Pipeline #002","7.659","3.575","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Pipeline #002","Vfx Pipeline #003","2.688","5.546","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Pipeline #003","Vfx Pipeline #004","2.009","6.541","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Pipeline #004","Vfx Pipeline #005","4.554","338","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Pipeline #005","Vfx Pipeline #001","5.701","980","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":428},{"label":"Fev","value":692},{"label":"Mar","value":397},{"label":"Abr","value":441},{"label":"Mai","value":329},{"label":"Jun","value":651},{"label":"Jul","value":403},{"label":"Ago","value":539},{"label":"Set","value":515},{"label":"Out","value":530},{"label":"Nov","value":423},{"label":"Dez","value":553}];
const MX = 692;
