...
const PAGE = "Track";
const KPIS = [{"l":"Total Vfx Pipeline","v":"8.196","t":"+17.2%","d":"up"},{"l":"Track Ativos","v":"2.711","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+6.2%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Pipeline #001","Vfx Pipeline #002","6.853","1.664","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Pipeline #002","Vfx Pipeline #003","8.511","4.167","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Pipeline #003","Vfx Pipeline #004","1.136","7.095","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Pipeline #004","Vfx Pipeline #005","7.578","3.518","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Pipeline #005","Vfx Pipeline #001","7.673","5.870","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1077},{"label":"Fev","value":802},{"label":"Mar","value":898},{"label":"Abr","value":835},{"label":"Mai","value":746},{"label":"Jun","value":755},{"label":"Jul","value":920},{"label":"Ago","value":748},{"label":"Set","value":923},{"label":"Out","value":759},{"label":"Nov","value":684},{"label":"Dez","value":921}];
const MX = 1077;
