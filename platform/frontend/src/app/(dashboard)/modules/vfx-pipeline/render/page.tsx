...
const PAGE = "Render Farm";
const KPIS = [{"l":"Total Vfx Pipeline","v":"3.128","t":"+14.3%","d":"up"},{"l":"Render Farm Ativos","v":"7.094","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"95","t":"-5.4%","d":"down"}];
const COLS = ["ID","Render Farm","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Pipeline #001","Vfx Pipeline #002","8.974","5.680","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Pipeline #002","Vfx Pipeline #003","6.020","1.598","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Pipeline #003","Vfx Pipeline #004","8.889","2.198","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Pipeline #004","Vfx Pipeline #005","8.274","7.771","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Pipeline #005","Vfx Pipeline #001","6.986","5.546","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":631},{"label":"Mar","value":699},{"label":"Abr","value":755},{"label":"Mai","value":523},{"label":"Jun","value":622},{"label":"Jul","value":642},{"label":"Ago","value":524},{"label":"Set","value":502},{"label":"Out","value":729},{"label":"Nov","value":614},{"label":"Dez","value":813}];
const MX = 813;
