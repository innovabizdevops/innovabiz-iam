...
const ACCENT = "#6366f1";
const MODULE = "VFX Pipeline";
const PAGE = "3D Model";
const KPIS = [{"l":"Total Vfx Pipeline","v":"2.079","t":"-1.9%","d":"down"},{"l":"3D Model Ativos","v":"2.483","t":"+7.4%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"88","t":"+0.4%","d":"up"}];
const COLS = ["ID","3D Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vfx Pipeline #001","Vfx Pipeline #002","7.167","3.296","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Vfx Pipeline #002","Vfx Pipeline #003","4.491","5.527","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Vfx Pipeline #003","Vfx Pipeline #004","2.619","9.094","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Vfx Pipeline #004","Vfx Pipeline #005","2.835","515","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vfx Pipeline #005","Vfx Pipeline #001","772","4.478","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":862},{"label":"Mar","value":825},{"label":"Abr","value":741},{"label":"Mai","value":749},{"label":"Jun","value":849},{"label":"Jul","value":796},{"label":"Ago","value":763},{"label":"Set","value":839},{"label":"Out","value":901},{"label":"Nov","value":968},{"label":"Dez","value":752}];
const MX = 968;
