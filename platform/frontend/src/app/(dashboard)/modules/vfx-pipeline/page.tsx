...
export default function VfxPipelinePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Vfx Pipeline</h1><p className="text-sm text-muted-foreground">Vfx Pipeline • iBOS Enterprise</p></div>
