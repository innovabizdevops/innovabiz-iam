...
/* ═══ Franchise Development — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "3652", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "458", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1784151852", cells: ["FRA-1852", "Franchise Development Item 1", "1/1/2026", "€1952"], status: "active" as const },
    { id: "1784155423", cells: ["FRA-5423", "Franchise Development Item 2", "16/8/2026", "€5523"], status: "pending" as const },
    { id: "1784158994", cells: ["FRA-8994", "Franchise Development Item 3", "3/3/2026", "€9094"], status: "completed" as const },
    { id: "1784162565", cells: ["FRA-3565", "Franchise Development Item 4", "18/10/2026", "€12 665"], status: "warning" as const },
    { id: "1784166136", cells: ["FRA-7136", "Franchise Development Item 5", "5/5/2026", "€16 236"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Development</p>
                    </div>
                </div>
