...
const KPIS = [{"l":"Vendas YTD (€)","v":"€64899","t":"+17.4%","d":"up"},{"l":"Pipeline (€)","v":"€29238","t":"-4.7%","d":"down"},{"l":"Atingimento Quota (%)","v":"91.6%","t":"-2.6%","d":"down"},{"l":"Win Rate (%)","v":"92.3%","t":"+10.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39868.15","€ 16817.36","€ 17462.60","92.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 4743.41","€ 30995.20","€ 25958.97","98.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 38384.87","€ 47488.23","€ 17850.87","75.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47779.64","€ 42603.83","€ 40012.71","76.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 10193.68","€ 11016.57","€ 1944.79","71.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":714},{"label":"Mar","value":633},{"label":"Abr","value":588},{"label":"Mai","value":503},{"label":"Jun","value":600},{"label":"Jul","value":541},{"label":"Ago","value":709},{"label":"Set","value":685},{"label":"Out","value":617},{"label":"Nov","value":528},{"label":"Dez","value":579}];
const MX = 714;
