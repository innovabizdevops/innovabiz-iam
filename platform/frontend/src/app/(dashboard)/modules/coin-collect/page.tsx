...
/* ═══ Coin & Numismatics — Dashboard ═══ */

const ACCENT = "#eab308";

const KPIS = [
    { label: "Total Registos", value: "5245", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2598", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€33K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1363324245", cells: ["COI-5245", "Coin & Numismatics Item 1", "18/10/2026", "€24 345"], status: "active" as const },
    { id: "1363327816", cells: ["COI-8816", "Coin & Numismatics Item 2", "5/5/2026", "€27 916"], status: "pending" as const },
    { id: "1363331387", cells: ["COI-3387", "Coin & Numismatics Item 3", "20/12/2026", "€31 487"], status: "completed" as const },
    { id: "1363334958", cells: ["COI-6958", "Coin & Numismatics Item 4", "7/7/2026", "€35 058"], status: "warning" as const },
    { id: "1363338529", cells: ["COI-1529", "Coin & Numismatics Item 5", "22/2/2026", "€38 629"], status: "active" as const },
];
...
export default function CoinNumismaticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coin & Numismatics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coin & Numismatics</p>
                    </div>
                </div>
