...
const PAGE = "Grade";
const KPIS = [{"l":"Total Coin Collect","v":"258","t":"+16.9%","d":"up"},{"l":"Grade Ativos","v":"6.112","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.5%","d":"up"}];
const COLS = ["ID","Grade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coin Collect #001","Coin Collect #002","8.196","1.997","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Coin Collect #002","Coin Collect #003","8.693","315","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Coin Collect #003","Coin Collect #004","8.525","2.241","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Coin Collect #004","Coin Collect #005","5.311","3.520","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coin Collect #005","Coin Collect #001","2.189","2.982","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":494},{"label":"Mar","value":595},{"label":"Abr","value":499},{"label":"Mai","value":500},{"label":"Jun","value":697},{"label":"Jul","value":477},{"label":"Ago","value":779},{"label":"Set","value":563},{"label":"Out","value":785},{"label":"Nov","value":543},{"label":"Dez","value":491}];
const MX = 785;
