...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"515","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"609","t":"+0.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.353","t":"+5.5%","d":"up"},{"l":"Utilizadores Analytics","v":"6.295","t":"+12.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4249","2026-03-05","2.110","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4248","2026-03-07","3.285","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3605","2026-01-09","2.001","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2188","2026-02-17","2.917","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","340","2026-02-02","4.501","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":961},{"label":"Mar","value":677},{"label":"Abr","value":818},{"label":"Mai","value":850},{"label":"Jun","value":804},{"label":"Jul","value":858},{"label":"Ago","value":913},{"label":"Set","value":809},{"label":"Out","value":736},{"label":"Nov","value":658},{"label":"Dez","value":841}];
const MX = 996;
