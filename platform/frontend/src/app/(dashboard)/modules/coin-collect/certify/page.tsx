...
const PAGE = "Certify";
const KPIS = [{"l":"Total Coin Collect","v":"3.466","t":"+16.2%","d":"up"},{"l":"Certify Ativos","v":"2.047","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"93","t":"+7.5%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coin Collect #001","Coin Collect #002","6.125","3.325","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Coin Collect #002","Coin Collect #003","4.224","701","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Coin Collect #003","Coin Collect #004","8.490","6.865","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Coin Collect #004","Coin Collect #005","7.851","6.697","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coin Collect #005","Coin Collect #001","1.011","7.083","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":1066},{"label":"Mar","value":807},{"label":"Abr","value":830},{"label":"Mai","value":743},{"label":"Jun","value":949},{"label":"Jul","value":810},{"label":"Ago","value":1051},{"label":"Set","value":789},{"label":"Out","value":864},{"label":"Nov","value":877},{"label":"Dez","value":990}];
const MX = 1066;
