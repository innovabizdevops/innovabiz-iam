...
const PAGE = "Trade";
const KPIS = [{"l":"Total Coin Collect","v":"2.670","t":"+1.9%","d":"up"},{"l":"Trade Ativos","v":"8.780","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"86","t":"+4.4%","d":"up"}];
const COLS = ["ID","Trade","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coin Collect #001","Coin Collect #002","1.967","7.224","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Coin Collect #002","Coin Collect #003","4.736","4.131","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Coin Collect #003","Coin Collect #004","4.060","7.075","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Coin Collect #004","Coin Collect #005","5.192","5.919","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coin Collect #005","Coin Collect #001","1.330","6.627","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":861},{"label":"Mar","value":851},{"label":"Abr","value":753},{"label":"Mai","value":877},{"label":"Jun","value":699},{"label":"Jul","value":745},{"label":"Ago","value":862},{"label":"Set","value":727},{"label":"Out","value":731},{"label":"Nov","value":986},{"label":"Dez","value":931}];
const MX = 986;
