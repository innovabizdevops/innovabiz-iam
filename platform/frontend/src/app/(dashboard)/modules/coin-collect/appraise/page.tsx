...
const ACCENT = "#eab308";
const MODULE = "Coin & Numismatics";
const PAGE = "Appraise";
const KPIS = [{"l":"Total Coin Collect","v":"1.843","t":"-3.2%","d":"down"},{"l":"Appraise Ativos","v":"2.239","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"90.3%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"91","t":"+5.3%","d":"up"}];
const COLS = ["ID","Appraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coin Collect #001","Coin Collect #002","636","6.764","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Coin Collect #002","Coin Collect #003","6.450","4.556","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Coin Collect #003","Coin Collect #004","3.605","8.260","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Coin Collect #004","Coin Collect #005","4.610","1.130","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coin Collect #005","Coin Collect #001","275","5.490","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":751},{"label":"Mar","value":738},{"label":"Abr","value":804},{"label":"Mai","value":780},{"label":"Jun","value":529},{"label":"Jul","value":561},{"label":"Ago","value":512},{"label":"Set","value":771},{"label":"Out","value":865},{"label":"Nov","value":502},{"label":"Dez","value":730}];
const MX = 865;
