...
/* ═══ H&S Management (ISO 45001) — Dashboard ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total Registos", value: "7309", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3303", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€216K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1917904509", cells: ["HEA-5509", "H&S Management (ISO 45001) Item 1", "18/10/2026", "€4609"], status: "active" as const },
    { id: "1917908080", cells: ["HEA-9080", "H&S Management (ISO 45001) Item 2", "5/5/2026", "€8180"], status: "pending" as const },
    { id: "1917911651", cells: ["HEA-3651", "H&S Management (ISO 45001) Item 3", "20/12/2026", "€11 751"], status: "completed" as const },
    { id: "1917915222", cells: ["HEA-7222", "H&S Management (ISO 45001) Item 4", "7/7/2026", "€15 322"], status: "warning" as const },
    { id: "1917918793", cells: ["HEA-1793", "H&S Management (ISO 45001) Item 5", "22/2/2026", "€18 893"], status: "active" as const },
];
...
export default function HsManagementIso45001Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">H&S Management (ISO 45001)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • H&S Management (ISO 45001)</p>
                    </div>
                </div>
