...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.760","t":"-3.0%","d":"down"},{"l":"NC Abertas","v":"3.939","t":"+9.4%","d":"up"},{"l":"Conformidade (%)","v":"76.8%","t":"-0.9%","d":"down"},{"l":"CAPAs Pendentes","v":"8.413","t":"+0.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.360","72.0%","6.841","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.571","71.4%","6.180","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.345","94.7%","6.868","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.034","87.0%","4.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.263","97.2%","4.481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":512},{"label":"Mar","value":352},{"label":"Abr","value":299},{"label":"Mai","value":319},{"label":"Jun","value":318},{"label":"Jul","value":346},{"label":"Ago","value":647},{"label":"Set","value":317},{"label":"Out","value":322},{"label":"Nov","value":346},{"label":"Dez","value":612}];
const MX = 647;
