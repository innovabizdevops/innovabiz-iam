...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"1.848","t":"+14.2%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.3%","t":"+5.0%","d":"up"},{"l":"MTTR (h)","v":"157h","t":"+4.4%","d":"up"},{"l":"Satisfação (%)","v":"79.7%","t":"+8.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","956","3.095","3.624","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.991","4.916","7.706","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.882","7.503","5.589","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.401","7.893","4.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.648","3.043","3.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":645},{"label":"Mar","value":671},{"label":"Abr","value":612},{"label":"Mai","value":455},{"label":"Jun","value":458},{"label":"Jul","value":557},{"label":"Ago","value":372},{"label":"Set","value":695},{"label":"Out","value":647},{"label":"Nov","value":385},{"label":"Dez","value":433}];
const MX = 695;
