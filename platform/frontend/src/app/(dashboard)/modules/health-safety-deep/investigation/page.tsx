...
const ACCENT = "#047857";
const MODULE = "H&S Management (ISO 45001)";
const PAGE = "Investigation";
const KPIS = [{"l":"Total Health Safety Deep","v":"7.762","t":"+0.0%","d":"up"},{"l":"Investigation Ativos","v":"7.650","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"72.7%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"61","t":"+12.8%","d":"up"}];
const COLS = ["ID","Investigation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Health Safety Deep #001","Health Safety Deep #002","7.978","8.194","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Health Safety Deep #002","Health Safety Deep #003","6.900","8.489","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Health Safety Deep #003","Health Safety Deep #004","7.212","7.161","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Health Safety Deep #004","Health Safety Deep #005","2.893","1.686","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Health Safety Deep #005","Health Safety Deep #001","1.675","7.760","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":840},{"label":"Mar","value":851},{"label":"Abr","value":871},{"label":"Mai","value":943},{"label":"Jun","value":750},{"label":"Jul","value":799},{"label":"Ago","value":812},{"label":"Set","value":639},{"label":"Out","value":901},{"label":"Nov","value":693},{"label":"Dez","value":615}];
const MX = 943;
