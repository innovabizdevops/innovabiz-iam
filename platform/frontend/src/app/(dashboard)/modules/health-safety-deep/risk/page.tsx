...
const KPIS = [{"l":"Riscos Identificados","v":"819","t":"+14.9%","d":"up"},{"l":"Mitigações Ativas","v":"4.280","t":"+3.0%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"-3.1%","d":"down"},{"l":"Incidentes YTD","v":"7.827","t":"-2.0%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.215","7.986","539","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.451","8.736","6.251","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.431","3.604","8.233","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.807","2.604","6.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.376","7.970","6.110","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":840},{"label":"Mar","value":641},{"label":"Abr","value":839},{"label":"Mai","value":578},{"label":"Jun","value":615},{"label":"Jul","value":478},{"label":"Ago","value":533},{"label":"Set","value":566},{"label":"Out","value":771},{"label":"Nov","value":649},{"label":"Dez","value":807}];
const MX = 840;
