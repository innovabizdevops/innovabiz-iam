...
/* ═══ Health Cloud — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "1078", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4353", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€236K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1685287878", cells: ["IND-2878", "Health Cloud Item 1", "23/7/2026", "€37 978"], status: "active" as const },
    { id: "1685291449", cells: ["IND-6449", "Health Cloud Item 2", "10/2/2026", "€41 549"], status: "pending" as const },
    { id: "1685295020", cells: ["IND-1020", "Health Cloud Item 3", "25/9/2026", "€45 120"], status: "completed" as const },
    { id: "1685298591", cells: ["IND-4591", "Health Cloud Item 4", "12/4/2026", "€48 691"], status: "warning" as const },
    { id: "1685302162", cells: ["IND-8162", "Health Cloud Item 5", "27/11/2026", "€2262"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Health Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Health Cloud</p>
                    </div>
                </div>
