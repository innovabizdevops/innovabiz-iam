...
const ACCENT = "#00a1e0";
const MODULE = "Health Cloud";
const PAGE = "Patient 360";
const KPIS = [{"l":"Total Industry Health Cloud","v":"9.044","t":"+13.1%","d":"up"},{"l":"Patient 360 Ativos","v":"2.571","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.5%","d":"up"}];
const COLS = ["ID","Patient 360","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Health Cloud #001","Industry Health Cloud #002","1.286","2.722","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Health Cloud #002","Industry Health Cloud #003","4.664","5.536","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Health Cloud #003","Industry Health Cloud #004","5.419","7.681","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Health Cloud #004","Industry Health Cloud #005","6.737","6.090","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Health Cloud #005","Industry Health Cloud #001","120","3.307","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":805},{"label":"Mar","value":672},{"label":"Abr","value":661},{"label":"Mai","value":692},{"label":"Jun","value":670},{"label":"Jul","value":664},{"label":"Ago","value":708},{"label":"Set","value":660},{"label":"Out","value":995},{"label":"Nov","value":670},{"label":"Dez","value":648}];
const MX = 995;
