...
const KPIS = [{"l":"Integrações Ativas","v":"2.246","t":"+3.0%","d":"up"},{"l":"Chamadas/Hora","v":"2574","t":"+10.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.0%","t":"+14.5%","d":"up"},{"l":"Latência Média (ms)","v":"18ms","t":"+0.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.092","707","80.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.257","8.353","92.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.073","1.950","90.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.175","4.078","75.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.163","4.178","75.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":849},{"label":"Mar","value":736},{"label":"Abr","value":571},{"label":"Mai","value":511},{"label":"Jun","value":488},{"label":"Jul","value":761},{"label":"Ago","value":801},{"label":"Set","value":489},{"label":"Out","value":834},{"label":"Nov","value":796},{"label":"Dez","value":861}];
const MX = 861;
