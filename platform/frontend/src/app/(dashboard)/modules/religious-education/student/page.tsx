...
const PAGE = "Student";
const KPIS = [{"l":"Total Religious Education","v":"8.321","t":"+0.1%","d":"up"},{"l":"Student Ativos","v":"5.973","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.5%","d":"up"}];
const COLS = ["ID","Student","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Education #001","Religious Education #002","7.340","6.219","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Education #002","Religious Education #003","6.018","5.014","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Education #003","Religious Education #004","4.872","708","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Education #004","Religious Education #005","3.962","8.120","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Education #005","Religious Education #001","7.522","8.135","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":929},{"label":"Mar","value":872},{"label":"Abr","value":576},{"label":"Mai","value":665},{"label":"Jun","value":867},{"label":"Jul","value":858},{"label":"Ago","value":851},{"label":"Set","value":664},{"label":"Out","value":642},{"label":"Nov","value":599},{"label":"Dez","value":774}];
const MX = 929;
