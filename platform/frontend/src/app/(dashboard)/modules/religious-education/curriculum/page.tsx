...
const KPIS = [{"l":"Total Religious Education","v":"6.327","t":"+8.3%","d":"up"},{"l":"Curriculum Ativos","v":"3.356","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"91.7%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+11.6%","d":"up"}];
const COLS = ["ID","Curriculum","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Education #001","Religious Education #002","4.800","4.290","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Education #002","Religious Education #003","7.366","2.460","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Education #003","Religious Education #004","2.172","4.832","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Education #004","Religious Education #005","8.372","4.286","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Education #005","Religious Education #001","8.406","3.446","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":810},{"label":"Mar","value":734},{"label":"Abr","value":643},{"label":"Mai","value":921},{"label":"Jun","value":890},{"label":"Jul","value":778},{"label":"Ago","value":848},{"label":"Set","value":815},{"label":"Out","value":626},{"label":"Nov","value":902},{"label":"Dez","value":938}];
const MX = 964;
