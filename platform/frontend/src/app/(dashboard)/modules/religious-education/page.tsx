...
const KPIS = [
    { label: "Total Registos", value: "1935", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2732", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€281K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1542520835", cells: ["REL-2835", "Religious Education Item 1", "24/12/2026", "€20 935"], status: "active" as const },
    { id: "1542524406", cells: ["REL-6406", "Religious Education Item 2", "11/7/2026", "€24 506"], status: "pending" as const },
    { id: "1542527977", cells: ["REL-9977", "Religious Education Item 3", "26/2/2026", "€28 077"], status: "completed" as const },
    { id: "1542531548", cells: ["REL-4548", "Religious Education Item 4", "13/9/2026", "€31 648"], status: "warning" as const },
    { id: "1542535119", cells: ["REL-8119", "Religious Education Item 5", "28/4/2026", "€35 219"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Religious Education</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Religious Education</p>
                    </div>
                </div>
