...
const PAGE = "Course";
const KPIS = [{"l":"Total Religious Education","v":"1.289","t":"-3.1%","d":"down"},{"l":"Course Ativos","v":"7.309","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"68","t":"-1.8%","d":"down"}];
const COLS = ["ID","Course","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Education #001","Religious Education #002","1.143","8.871","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Education #002","Religious Education #003","3.194","2.087","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Education #003","Religious Education #004","8.807","2.384","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Education #004","Religious Education #005","8.784","4.666","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Education #005","Religious Education #001","4.337","3.303","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":531},{"label":"Mar","value":364},{"label":"Abr","value":531},{"label":"Mai","value":707},{"label":"Jun","value":386},{"label":"Jul","value":413},{"label":"Ago","value":638},{"label":"Set","value":652},{"label":"Out","value":652},{"label":"Nov","value":593},{"label":"Dez","value":430}];
const MX = 707;
