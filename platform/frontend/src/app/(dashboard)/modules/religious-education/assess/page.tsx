...
const ACCENT = "#7c3aed";
const MODULE = "Religious Education";
const PAGE = "Assess";
const KPIS = [{"l":"Total Religious Education","v":"1.760","t":"-3.9%","d":"down"},{"l":"Assess Ativos","v":"3.294","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"69.8%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"79","t":"-4.1%","d":"down"}];
const COLS = ["ID","Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Education #001","Religious Education #002","1.622","4.466","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Education #002","Religious Education #003","5.111","3.035","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Education #003","Religious Education #004","6.665","6.129","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Education #004","Religious Education #005","560","7.345","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Education #005","Religious Education #001","7.313","1.427","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":826},{"label":"Mar","value":785},{"label":"Abr","value":769},{"label":"Mai","value":767},{"label":"Jun","value":520},{"label":"Jul","value":578},{"label":"Ago","value":631},{"label":"Set","value":492},{"label":"Out","value":528},{"label":"Nov","value":698},{"label":"Dez","value":529}];
const MX = 826;
