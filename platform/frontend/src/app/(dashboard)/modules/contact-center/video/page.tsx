...
const PAGE = "Video Support";
const KPIS = [{"l":"Tickets Abertos","v":"5.857","t":"+11.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.0%","t":"+4.6%","d":"up"},{"l":"MTTR (h)","v":"167h","t":"+16.7%","d":"up"},{"l":"Satisfação (%)","v":"70.2%","t":"+6.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","9.034","6.372","1.300","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.188","6.960","4.370","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.893","2.755","8.575","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.630","6.713","9.014","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.308","8.043","6.583","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":353},{"label":"Fev","value":318},{"label":"Mar","value":482},{"label":"Abr","value":608},{"label":"Mai","value":316},{"label":"Jun","value":507},{"label":"Jul","value":323},{"label":"Ago","value":468},{"label":"Set","value":365},{"label":"Out","value":375},{"label":"Nov","value":433},{"label":"Dez","value":557}];
const MX = 608;
