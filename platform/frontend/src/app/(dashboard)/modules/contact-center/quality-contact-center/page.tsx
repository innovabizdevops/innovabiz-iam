...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.820","t":"+10.9%","d":"up"},{"l":"NC Abertas","v":"5.916","t":"+14.8%","d":"up"},{"l":"Conformidade (%)","v":"79.0%","t":"+5.3%","d":"up"},{"l":"CAPAs Pendentes","v":"4.764","t":"+13.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.872","77.3%","3.984","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.326","98.9%","8.218","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.570","89.4%","8.627","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.345","89.5%","4.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.718","97.7%","289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":945},{"label":"Mar","value":892},{"label":"Abr","value":987},{"label":"Mai","value":770},{"label":"Jun","value":859},{"label":"Jul","value":952},{"label":"Ago","value":730},{"label":"Set","value":618},{"label":"Out","value":833},{"label":"Nov","value":748},{"label":"Dez","value":674}];
const MX = 987;
...
export default function QualityContactCenterPage() {
    return (
