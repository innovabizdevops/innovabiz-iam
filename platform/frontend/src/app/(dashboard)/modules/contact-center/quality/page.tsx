...
const PAGE = "Quality &amp; WFM";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.021","t":"-4.9%","d":"down"},{"l":"NC Abertas","v":"2.355","t":"-0.6%","d":"down"},{"l":"Conformidade (%)","v":"71.5%","t":"-1.6%","d":"down"},{"l":"CAPAs Pendentes","v":"8.978","t":"-0.7%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.098","99.7%","4.142","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","575","90.0%","6.087","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.659","70.4%","6.049","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.822","95.6%","5.489","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.516","77.2%","1.548","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":671},{"label":"Mar","value":817},{"label":"Abr","value":460},{"label":"Mai","value":735},{"label":"Jun","value":784},{"label":"Jul","value":580},{"label":"Ago","value":714},{"label":"Set","value":822},{"label":"Out","value":635},{"label":"Nov","value":623},{"label":"Dez","value":464}];
const MX = 822;
