...
const PAGE = "Workforce Engagement";
const KPIS = [{"l":"eNPS","v":"64","t":"+3.1%","d":"up"},{"l":"Engagement (%)","v":"74.3%","t":"-2.8%","d":"down"},{"l":"Turnover (%)","v":"90.7%","t":"-3.3%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.884","t":"+12.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.764","2026-03-21","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.396","2026-03-15","71","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.546","2026-02-06","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.274","2026-03-06","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.035","2026-02-17","78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":369},{"label":"Mar","value":363},{"label":"Abr","value":346},{"label":"Mai","value":345},{"label":"Jun","value":572},{"label":"Jul","value":711},{"label":"Ago","value":397},{"label":"Set","value":741},{"label":"Out","value":409},{"label":"Nov","value":502},{"label":"Dez","value":738}];
const MX = 741;
...
export default function WorkforceEngagementPage() {
    return (
