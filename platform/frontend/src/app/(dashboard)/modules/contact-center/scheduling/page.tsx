...
const PAGE = "Agent Scheduling";
const KPIS = [{"l":"eNPS","v":"56","t":"+14.5%","d":"up"},{"l":"Engagement (%)","v":"83.5%","t":"+16.5%","d":"up"},{"l":"Turnover (%)","v":"94.1%","t":"+10.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.603","t":"+9.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.452","2026-02-19","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.441","2026-03-27","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","775","2026-03-11","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.135","2026-02-22","79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.340","2026-02-06","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":780},{"label":"Mar","value":1013},{"label":"Abr","value":840},{"label":"Mai","value":865},{"label":"Jun","value":989},{"label":"Jul","value":1000},{"label":"Ago","value":746},{"label":"Set","value":915},{"label":"Out","value":915},{"label":"Nov","value":907},{"label":"Dez","value":947}];
const MX = 1013;
