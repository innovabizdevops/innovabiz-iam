...
const PAGE = "Agent Desktop";
const KPIS = [{"l":"Total Contact Center","v":"3.020","t":"+5.5%","d":"up"},{"l":"Agent Desktop Ativos","v":"6.878","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.1%","d":"up"}];
const COLS = ["ID","Agent Desktop","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","2.897","2.107","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","5.877","7.794","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","8.724","3.935","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","2.747","8.048","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","397","5.747","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":624},{"label":"Mar","value":654},{"label":"Abr","value":847},{"label":"Mai","value":628},{"label":"Jun","value":901},{"label":"Jul","value":591},{"label":"Ago","value":562},{"label":"Set","value":854},{"label":"Out","value":716},{"label":"Nov","value":725},{"label":"Dez","value":945}];
const MX = 945;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>Omni</span></h1>
                </div>
