...
const PAGE = "Real-Time Coaching";
const KPIS = [{"l":"Total Contact Center","v":"8.437","t":"+8.6%","d":"up"},{"l":"Real Time Coaching Ativos","v":"7.524","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"76.5%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"80","t":"+10.9%","d":"up"}];
const COLS = ["ID","Real Time Coaching","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","1.570","6.659","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","6.854","5.597","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","4.316","7.857","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","3.954","8.929","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","5.617","2.718","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":719},{"label":"Mar","value":835},{"label":"Abr","value":699},{"label":"Mai","value":656},{"label":"Jun","value":694},{"label":"Jul","value":598},{"label":"Ago","value":611},{"label":"Set","value":639},{"label":"Out","value":940},{"label":"Nov","value":872},{"label":"Dez","value":748}];
const MX = 940;
