...
const PAGE = "IVR Builder";
const KPIS = [{"l":"Total Contact Center","v":"8.192","t":"+3.1%","d":"up"},{"l":"IVR Builder Ativos","v":"913","t":"+3.0%","d":"up"},{"l":"Eficiência (%)","v":"75.7%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"66","t":"+13.9%","d":"up"}];
const COLS = ["ID","IVR Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","249","2.048","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","2.205","3.311","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","518","6.837","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","2.220","8.799","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","1.958","5.818","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":653},{"label":"Mar","value":474},{"label":"Abr","value":464},{"label":"Mai","value":565},{"label":"Jun","value":676},{"label":"Jul","value":767},{"label":"Ago","value":450},{"label":"Set","value":776},{"label":"Out","value":711},{"label":"Nov","value":430},{"label":"Dez","value":507}];
const MX = 776;
