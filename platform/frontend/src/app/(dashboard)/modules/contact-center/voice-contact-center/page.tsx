...
const PAGE = "Voice AI";
const KPIS = [{"l":"Total Contact Center","v":"3.718","t":"+7.4%","d":"up"},{"l":"Voice AI Ativos","v":"1.641","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"66.0%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"71","t":"-3.3%","d":"down"}];
const COLS = ["ID","Voice AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","3.765","3.457","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","5.245","8.688","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","3.882","7.225","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","8.764","5.652","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","1.943","3.673","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":629},{"label":"Mar","value":627},{"label":"Abr","value":364},{"label":"Mai","value":621},{"label":"Jun","value":473},{"label":"Jul","value":593},{"label":"Ago","value":342},{"label":"Set","value":530},{"label":"Out","value":273},{"label":"Nov","value":331},{"label":"Dez","value":523}];
const MX = 629;
...
export default function VoiceContactCenterPage() {
    return (
