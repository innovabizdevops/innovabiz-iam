...
const PAGE = "Agent Assist AI";
const KPIS = [{"l":"Total Contact Center","v":"713","t":"+8.5%","d":"up"},{"l":"Agent Assist AI Ativos","v":"7.330","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.0%","d":"up"}];
const COLS = ["ID","Agent Assist AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","2.338","2.508","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","9.003","3.890","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","1.046","8.749","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","2.665","1.011","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","5.105","6.124","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":372},{"label":"Mar","value":385},{"label":"Abr","value":392},{"label":"Mai","value":414},{"label":"Jun","value":671},{"label":"Jul","value":607},{"label":"Ago","value":324},{"label":"Set","value":690},{"label":"Out","value":696},{"label":"Nov","value":593},{"label":"Dez","value":384}];
const MX = 696;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>GenAI</span></h1>
                </div>
