...
const ACCENT = "#7c3aed";
const MODULE = "Contact Center";
const PAGE = "Conversational IVR";
const KPIS = [{"l":"Total Contact Center","v":"5.405","t":"+14.7%","d":"up"},{"l":"Conversational IVR Ativos","v":"8.516","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"-2.0%","d":"down"},{"l":"Score Performance","v":"65","t":"+16.6%","d":"up"}];
const COLS = ["ID","Conversational IVR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Contact Center #001","Contact Center #002","4.255","8.905","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Contact Center #002","Contact Center #003","2.913","5.287","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Contact Center #003","Contact Center #004","3.209","6.969","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Contact Center #004","Contact Center #005","8.993","1.710","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Contact Center #005","Contact Center #001","6.696","1.757","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":689},{"label":"Mar","value":650},{"label":"Abr","value":789},{"label":"Mai","value":528},{"label":"Jun","value":652},{"label":"Jul","value":677},{"label":"Ago","value":666},{"label":"Set","value":664},{"label":"Out","value":720},{"label":"Nov","value":736},{"label":"Dez","value":489}];
const MX = 789;
...
export default function ConversationalIvrPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>AI</span></h1>
                </div>
