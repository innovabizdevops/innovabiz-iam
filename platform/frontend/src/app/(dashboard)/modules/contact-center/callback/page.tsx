...
const PAGE = "Callback Management";
const KPIS = [{"l":"Projetos Melhoria","v":"6.505","t":"+14.7%","d":"up"},{"l":"Savings (€)","v":"€27086","t":"+5.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.4%","t":"-1.3%","d":"down"},{"l":"Ciclos PDCA","v":"4.190","t":"+15.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.700","€ 24505.65","8.332","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.086","€ 13624.44","3.445","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","224","€ 20170.13","8.189","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.878","€ 11094.99","3.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.239","€ 32484.64","3.313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":217},{"label":"Mar","value":504},{"label":"Abr","value":219},{"label":"Mai","value":276},{"label":"Jun","value":570},{"label":"Jul","value":491},{"label":"Ago","value":322},{"label":"Set","value":221},{"label":"Out","value":282},{"label":"Nov","value":271},{"label":"Dez","value":504}];
const MX = 570;
