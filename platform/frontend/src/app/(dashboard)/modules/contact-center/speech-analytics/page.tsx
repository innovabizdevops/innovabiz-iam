...
const PAGE = "Speech Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.971","t":"-5.9%","d":"down"},{"l":"Queries/Dia","v":"4870","t":"+11.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.329","t":"+5.5%","d":"up"},{"l":"Utilizadores Analytics","v":"454","t":"+6.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","719","2026-01-04","5.518","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3569","2026-01-13","7.919","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3081","2026-02-22","3.858","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3641","2026-02-17","4.883","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1219","2026-03-28","4.843","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":1003},{"label":"Mar","value":719},{"label":"Abr","value":628},{"label":"Mai","value":740},{"label":"Jun","value":765},{"label":"Jul","value":931},{"label":"Ago","value":969},{"label":"Set","value":683},{"label":"Out","value":879},{"label":"Nov","value":958},{"label":"Dez","value":1019}];
const MX = 1019;
