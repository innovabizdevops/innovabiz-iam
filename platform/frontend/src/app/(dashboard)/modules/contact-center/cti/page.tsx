...
const PAGE = "CTI Integration";
const KPIS = [{"l":"Integrações Ativas","v":"3.135","t":"-4.9%","d":"down"},{"l":"Chamadas/Hora","v":"3973","t":"+14.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.7%","t":"+12.5%","d":"up"},{"l":"Latência Média (ms)","v":"130ms","t":"+11.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.601","1.542","81.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.439","5.279","94.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.572","907","87.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.757","1.137","91.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.393","2.874","85.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":549},{"label":"Mar","value":584},{"label":"Abr","value":458},{"label":"Mai","value":436},{"label":"Jun","value":424},{"label":"Jul","value":376},{"label":"Ago","value":545},{"label":"Set","value":493},{"label":"Out","value":457},{"label":"Nov","value":395},{"label":"Dez","value":491}];
const MX = 636;
