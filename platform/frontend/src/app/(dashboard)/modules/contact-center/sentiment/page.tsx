...
const KPIS = [{"l":"Dashboards Ativos","v":"4.324","t":"+11.3%","d":"up"},{"l":"Queries/Dia","v":"2143","t":"+9.8%","d":"up"},{"l":"Dados Processados (GB)","v":"2.038","t":"-3.1%","d":"down"},{"l":"Utilizadores Analytics","v":"6.693","t":"+17.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2858","2026-01-04","3.755","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4409","2026-03-09","326","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3812","2026-02-16","3.272","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","676","2026-03-01","907","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1884","2026-01-07","7.631","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":881},{"label":"Fev","value":699},{"label":"Mar","value":869},{"label":"Abr","value":922},{"label":"Mai","value":638},{"label":"Jun","value":624},{"label":"Jul","value":697},{"label":"Ago","value":665},{"label":"Set","value":744},{"label":"Out","value":837},{"label":"Nov","value":646},{"label":"Dez","value":790}];
const MX = 922;
