...
const PAGE = "Knowledge Assist AI";
const KPIS = [{"l":"Artigos Publicados","v":"5.767","t":"-4.6%","d":"down"},{"l":"Views/Semana","v":"3257","t":"+17.4%","d":"up"},{"l":"Feedback Útil (%)","v":"68.2%","t":"+14.8%","d":"up"},{"l":"Artigos Desatualizados","v":"9.056","t":"-0.2%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.078","74.9%","356","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.209","94.5%","1.649","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.746","94.1%","3.408","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.862","77.2%","3.663","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.735","89.8%","5.239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":597},{"label":"Mar","value":891},{"label":"Abr","value":705},{"label":"Mai","value":901},{"label":"Jun","value":949},{"label":"Jul","value":655},{"label":"Ago","value":989},{"label":"Set","value":676},{"label":"Out","value":742},{"label":"Nov","value":760},{"label":"Dez","value":701}];
const MX = 989;
