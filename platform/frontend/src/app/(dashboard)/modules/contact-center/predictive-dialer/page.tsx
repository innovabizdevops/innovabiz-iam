...
const PAGE = "Predictive Dialer";
const KPIS = [{"l":"Integrações Ativas","v":"5.168","t":"+6.6%","d":"up"},{"l":"Chamadas/Hora","v":"2257","t":"+17.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"93.7%","t":"+15.5%","d":"up"},{"l":"Latência Média (ms)","v":"110ms","t":"+5.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.280","8.571","97.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.563","5.838","84.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.490","1.613","78.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.723","244","82.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.286","934","72.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":849},{"label":"Mar","value":602},{"label":"Abr","value":749},{"label":"Mai","value":601},{"label":"Jun","value":718},{"label":"Jul","value":729},{"label":"Ago","value":761},{"label":"Set","value":928},{"label":"Out","value":777},{"label":"Nov","value":624},{"label":"Dez","value":659}];
const MX = 928;
