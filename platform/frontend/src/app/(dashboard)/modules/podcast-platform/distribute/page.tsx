...
const ACCENT = "#6366f1";
const MODULE = "Podcast Platform";
const PAGE = "Distribute";
const KPIS = [{"l":"Formulários Ativos","v":"4.259","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"2837","t":"+10.5%","d":"up"},{"l":"Documentos Gerados","v":"4.979","t":"-2.7%","d":"down"},{"l":"Templates","v":"7.004","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.761","2026-01-05","413","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.394","2026-03-11","7.645","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.994","2026-02-05","1.405","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.188","2026-02-23","5.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.659","2026-03-10","3.484","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":753},{"label":"Mar","value":970},{"label":"Abr","value":1001},{"label":"Mai","value":909},{"label":"Jun","value":982},{"label":"Jul","value":792},{"label":"Ago","value":987},{"label":"Set","value":688},{"label":"Out","value":852},{"label":"Nov","value":934},{"label":"Dez","value":1056}];
const MX = 1056;
