...
const PAGE = "Record";
const KPIS = [{"l":"Formulários Ativos","v":"6.326","t":"+6.6%","d":"up"},{"l":"Submissões/Dia","v":"2129","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"4.834","t":"+12.6%","d":"up"},{"l":"Templates","v":"724","t":"+2.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.912","2026-02-17","4.339","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.421","2026-01-08","313","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","833","2026-02-03","3.919","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.677","2026-02-14","6.490","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.115","2026-03-22","1.174","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1007},{"label":"Fev","value":740},{"label":"Mar","value":759},{"label":"Abr","value":884},{"label":"Mai","value":1077},{"label":"Jun","value":938},{"label":"Jul","value":971},{"label":"Ago","value":1078},{"label":"Set","value":1048},{"label":"Out","value":935},{"label":"Nov","value":788},{"label":"Dez","value":1027}];
const MX = 1078;
