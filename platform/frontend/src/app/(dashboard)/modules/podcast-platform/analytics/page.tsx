...
const KPIS = [{"l":"Formulários Ativos","v":"214","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"1237","t":"+7.4%","d":"up"},{"l":"Documentos Gerados","v":"3.698","t":"+8.2%","d":"up"},{"l":"Templates","v":"2.681","t":"+1.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.364","2026-02-21","1.508","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.016","2026-01-25","4.381","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.691","2026-01-09","8.805","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.325","2026-01-20","1.492","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.231","2026-03-27","2.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":459},{"label":"Fev","value":578},{"label":"Mar","value":633},{"label":"Abr","value":556},{"label":"Mai","value":507},{"label":"Jun","value":607},{"label":"Jul","value":458},{"label":"Ago","value":613},{"label":"Set","value":602},{"label":"Out","value":560},{"label":"Nov","value":340},{"label":"Dez","value":308}];
const MX = 633;
