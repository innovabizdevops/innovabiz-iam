...
const PAGE = "Edit";
const KPIS = [{"l":"Formulários Ativos","v":"1.460","t":"+9.2%","d":"up"},{"l":"Submissões/Dia","v":"477","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"7.174","t":"+11.6%","d":"up"},{"l":"Templates","v":"7.832","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.236","2026-01-02","3.925","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","9.020","2026-03-23","7.621","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.912","2026-02-03","2.897","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.774","2026-02-13","6.587","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","743","2026-01-22","5.153","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":1082},{"label":"Mar","value":966},{"label":"Abr","value":875},{"label":"Mai","value":999},{"label":"Jun","value":1038},{"label":"Jul","value":738},{"label":"Ago","value":896},{"label":"Set","value":806},{"label":"Out","value":1030},{"label":"Nov","value":748},{"label":"Dez","value":1000}];
const MX = 1082;
