...
export default function PodcastPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Podcast Platform</h1><p className="text-sm text-muted-foreground">Podcast Platform • iBOS Enterprise</p></div>
