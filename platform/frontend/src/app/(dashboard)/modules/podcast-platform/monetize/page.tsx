...
const PAGE = "Monetize";
const KPIS = [{"l":"ARR (€M)","v":"€32.7M","t":"+17.9%","d":"up"},{"l":"MRR (€)","v":"€47692","t":"+7.2%","d":"up"},{"l":"Churn (%)","v":"83.7%","t":"+14.6%","d":"up"},{"l":"ARPU (€)","v":"€53842","t":"+5.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20067.86","5.071","€ 36463.51","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11205.28","3.386","€ 20680.11","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30150.08","5.912","€ 36636.58","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 474.94","1.175","€ 6549.43","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22881.42","7.012","€ 41016.02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":532},{"label":"Mar","value":457},{"label":"Abr","value":356},{"label":"Mai","value":425},{"label":"Jun","value":714},{"label":"Jul","value":624},{"label":"Ago","value":436},{"label":"Set","value":569},{"label":"Out","value":606},{"label":"Nov","value":515},{"label":"Dez","value":473}];
const MX = 714;
