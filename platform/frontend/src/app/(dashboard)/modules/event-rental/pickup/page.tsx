...
const PAGE = "Pickup";
const KPIS = [{"l":"Eventos Planeados","v":"7.500","t":"+16.1%","d":"up"},{"l":"Participantes","v":"7.662","t":"+0.6%","d":"up"},{"l":"NPS Evento","v":"63","t":"+13.4%","d":"up"},{"l":"Receita (€)","v":"€2461","t":"+5.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-20","3.940","8.554","€ 45746.24","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-10","8.475","4.932","€ 41499.90","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-01","2.105","1.292","€ 26062.38","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-14","5.326","902","€ 5071.72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-19","7.628","412","€ 38303.97","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":862},{"label":"Mar","value":923},{"label":"Abr","value":891},{"label":"Mai","value":674},{"label":"Jun","value":687},{"label":"Jul","value":810},{"label":"Ago","value":780},{"label":"Set","value":830},{"label":"Out","value":921},{"label":"Nov","value":809},{"label":"Dez","value":555}];
const MX = 923;
