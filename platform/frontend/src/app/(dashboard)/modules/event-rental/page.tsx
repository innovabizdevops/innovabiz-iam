...
/* ═══ Event Rental Company — Dashboard ═══ */

const ACCENT = "#ec4899";

const KPIS = [
    { label: "Total Registos", value: "4494", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2549", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€129K", trend: "-8%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "819189794", cells: ["EVE-1794", "Event Rental Company Item 1", "11/3/2026", "€39 894"], status: "active" as const },
    { id: "819193365", cells: ["EVE-5365", "Event Rental Company Item 2", "26/10/2026", "€43 465"], status: "pending" as const },
    { id: "819196936", cells: ["EVE-8936", "Event Rental Company Item 3", "13/5/2026", "€47 036"], status: "completed" as const },
    { id: "819200507", cells: ["EVE-3507", "Event Rental Company Item 4", "28/12/2026", "€607"], status: "warning" as const },
    { id: "819204078", cells: ["EVE-7078", "Event Rental Company Item 5", "15/7/2026", "€4178"], status: "active" as const },
];
...
export default function EventRentalCompanyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Rental Company</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Rental Company</p>
                    </div>
                </div>
