...
const PAGE = "Deliver";
const KPIS = [{"l":"Eventos Planeados","v":"6.239","t":"-4.2%","d":"down"},{"l":"Participantes","v":"3.620","t":"+13.9%","d":"up"},{"l":"NPS Evento","v":"80","t":"+16.0%","d":"up"},{"l":"Receita (€)","v":"€42237","t":"-4.0%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-12","1.085","6.632","€ 19818.45","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-05","3.002","2.851","€ 10523.92","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-10","4.254","6.343","€ 40347.04","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-16","5.801","678","€ 33006.54","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-04","1.118","5.262","€ 36507.90","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1036},{"label":"Fev","value":847},{"label":"Mar","value":809},{"label":"Abr","value":671},{"label":"Mai","value":880},{"label":"Jun","value":829},{"label":"Jul","value":848},{"label":"Ago","value":876},{"label":"Set","value":963},{"label":"Out","value":910},{"label":"Nov","value":733},{"label":"Dez","value":1036}];
const MX = 1036;
