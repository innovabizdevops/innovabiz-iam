...
const ACCENT = "#ec4899";
const MODULE = "Event Rental Company";
const PAGE = "Inventory";
const KPIS = [{"l":"Eventos Planeados","v":"3.339","t":"-5.5%","d":"down"},{"l":"Participantes","v":"8.371","t":"+6.0%","d":"up"},{"l":"NPS Evento","v":"75","t":"+0.9%","d":"up"},{"l":"Receita (€)","v":"€84400","t":"+14.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-16","7.564","4.822","€ 43535.58","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-10","4.469","3.034","€ 45158.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-04","3.647","4.662","€ 13176.96","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-23","5.559","3.412","€ 36356.22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-23","3.169","5.070","€ 21026.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":403},{"label":"Mar","value":466},{"label":"Abr","value":388},{"label":"Mai","value":280},{"label":"Jun","value":355},{"label":"Jul","value":443},{"label":"Ago","value":445},{"label":"Set","value":556},{"label":"Out","value":477},{"label":"Nov","value":470},{"label":"Dez","value":477}];
const MX = 556;
