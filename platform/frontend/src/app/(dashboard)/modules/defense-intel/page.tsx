...
/* ═══ Defense Intelligence Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "768", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "96", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€153K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1686713168", cells: ["DEF-6168", "Defense Intelligence Platform Item 1", "1/9/2026", "€13 268"], status: "active" as const },
    { id: "1686716739", cells: ["DEF-9739", "Defense Intelligence Platform Item 2", "16/4/2026", "€16 839"], status: "pending" as const },
    { id: "1686720310", cells: ["DEF-4310", "Defense Intelligence Platform Item 3", "3/11/2026", "€20 410"], status: "completed" as const },
    { id: "1686723881", cells: ["DEF-7881", "Defense Intelligence Platform Item 4", "18/6/2026", "€23 981"], status: "warning" as const },
    { id: "1686727452", cells: ["DEF-2452", "Defense Intelligence Platform Item 5", "5/1/2026", "€27 552"], status: "active" as const },
];
...
export default function DefenseIntelligencePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Defense Intelligence Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Defense Intelligence Platform</p>
                    </div>
                </div>
