...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"6.795","t":"+12.5%","d":"up"},{"l":"Queries/Dia","v":"2983","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"4.277","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"884","t":"+12.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3436","2026-01-21","1.633","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1544","2026-02-22","8.851","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2243","2026-01-21","1.143","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1882","2026-02-12","1.174","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3774","2026-02-07","7.472","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":312},{"label":"Mar","value":258},{"label":"Abr","value":502},{"label":"Mai","value":322},{"label":"Jun","value":298},{"label":"Jul","value":306},{"label":"Ago","value":245},{"label":"Set","value":399},{"label":"Out","value":374},{"label":"Nov","value":588},{"label":"Dez","value":412}];
const MX = 588;
