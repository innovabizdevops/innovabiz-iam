...
const ACCENT = "#1e3a5f";
const MODULE = "Defense Intelligence Platform";
const PAGE = "Process";
const KPIS = [{"l":"Total Defense Intel","v":"1.055","t":"+10.4%","d":"up"},{"l":"Process Ativos","v":"7.074","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"81.2%","t":"+0.0%","d":"up"},{"l":"Score Performance","v":"56","t":"+11.6%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Intel #001","Defense Intel #002","6.365","8.850","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Intel #002","Defense Intel #003","4.617","2.405","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Intel #003","Defense Intel #004","4.241","5.127","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Intel #004","Defense Intel #005","4.906","4.800","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Intel #005","Defense Intel #001","2.892","7.305","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":436},{"label":"Mar","value":467},{"label":"Abr","value":650},{"label":"Mai","value":651},{"label":"Jun","value":393},{"label":"Jul","value":562},{"label":"Ago","value":623},{"label":"Set","value":522},{"label":"Out","value":361},{"label":"Nov","value":646},{"label":"Dez","value":728}];
const MX = 728;
