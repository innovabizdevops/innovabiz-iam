...
const PAGE = "Disseminate";
const KPIS = [{"l":"Total Defense Intel","v":"3.456","t":"-1.8%","d":"down"},{"l":"Disseminate Ativos","v":"5.242","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+15.7%","d":"up"}];
const COLS = ["ID","Disseminate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Intel #001","Defense Intel #002","1.477","4.274","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Intel #002","Defense Intel #003","2.311","8.855","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Intel #003","Defense Intel #004","1.931","1.496","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Intel #004","Defense Intel #005","2.772","724","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Intel #005","Defense Intel #001","3.442","6.206","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":935},{"label":"Mar","value":865},{"label":"Abr","value":761},{"label":"Mai","value":608},{"label":"Jun","value":687},{"label":"Jul","value":918},{"label":"Ago","value":682},{"label":"Set","value":745},{"label":"Out","value":865},{"label":"Nov","value":850},{"label":"Dez","value":953}];
const MX = 953;
...
export default function DisseminatePage() {
    return (
