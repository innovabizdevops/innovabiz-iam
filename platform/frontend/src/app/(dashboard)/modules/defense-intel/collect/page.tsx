...
const PAGE = "Collect";
const KPIS = [{"l":"Total Defense Intel","v":"8.311","t":"-5.3%","d":"down"},{"l":"Collect Ativos","v":"8.582","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+3.9%","d":"up"}];
const COLS = ["ID","Collect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Defense Intel #001","Defense Intel #002","5.557","6.648","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Defense Intel #002","Defense Intel #003","5.488","5.022","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Defense Intel #003","Defense Intel #004","2.984","6.414","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Defense Intel #004","Defense Intel #005","8.364","131","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Defense Intel #005","Defense Intel #001","7.295","1.893","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":985},{"label":"Fev","value":913},{"label":"Mar","value":754},{"label":"Abr","value":962},{"label":"Mai","value":845},{"label":"Jun","value":826},{"label":"Jul","value":963},{"label":"Ago","value":893},{"label":"Set","value":790},{"label":"Out","value":932},{"label":"Nov","value":817},{"label":"Dez","value":704}];
const MX = 985;
