...
const KPIS = [{"l":"Vendas YTD (€)","v":"€22851","t":"+4.2%","d":"up"},{"l":"Pipeline (€)","v":"€56615","t":"-1.8%","d":"down"},{"l":"Atingimento Quota (%)","v":"79.5%","t":"+5.5%","d":"up"},{"l":"Win Rate (%)","v":"69.4%","t":"+7.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 4098.68","€ 22950.81","€ 6541.68","97.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 12654.50","€ 45826.91","€ 17254.66","81.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11179.38","€ 45132.10","€ 816.45","78.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 33166.79","€ 9369.09","€ 40057.82","90.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 22061.60","€ 6683.06","€ 47864.53","98.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":258},{"label":"Mar","value":474},{"label":"Abr","value":367},{"label":"Mai","value":543},{"label":"Jun","value":295},{"label":"Jul","value":503},{"label":"Ago","value":602},{"label":"Set","value":359},{"label":"Out","value":332},{"label":"Nov","value":457},{"label":"Dez","value":461}];
const MX = 602;
