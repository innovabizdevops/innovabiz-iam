...
const ACCENT = "#6366f1";
const MODULE = "Travel Agency";
const PAGE = "Insurance";
const KPIS = [{"l":"Total Travel Agency","v":"5.267","t":"+7.3%","d":"up"},{"l":"Insurance Ativos","v":"6.059","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"75.6%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.8%","d":"down"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Travel Agency #001","Travel Agency #002","6.838","8.122","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Travel Agency #002","Travel Agency #003","5.434","3.030","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Travel Agency #003","Travel Agency #004","2.729","8.469","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Travel Agency #004","Travel Agency #005","6.663","5.703","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Travel Agency #005","Travel Agency #001","2.132","4.452","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":729},{"label":"Mar","value":474},{"label":"Abr","value":608},{"label":"Mai","value":742},{"label":"Jun","value":439},{"label":"Jul","value":645},{"label":"Ago","value":406},{"label":"Set","value":389},{"label":"Out","value":664},{"label":"Nov","value":778},{"label":"Dez","value":568}];
const MX = 778;
