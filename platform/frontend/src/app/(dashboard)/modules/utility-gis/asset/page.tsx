...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"5.787","t":"-5.9%","d":"down"},{"l":"Valor Total (€M)","v":"€25.4M","t":"-4.3%","d":"down"},{"l":"Depreciação Anual (€)","v":"€41971","t":"-0.3%","d":"down"},{"l":"Ativos em Garantia","v":"6.679","t":"+8.7%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 24000.71","6.841","€ 17227.19","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48233.52","8.515","€ 37124.42","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 27324.85","9.049","€ 45633.36","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 24162.79","3.636","€ 22945.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 35599.52","8.344","€ 37077.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":257},{"label":"Mar","value":322},{"label":"Abr","value":591},{"label":"Mai","value":313},{"label":"Jun","value":467},{"label":"Jul","value":492},{"label":"Ago","value":523},{"label":"Set","value":557},{"label":"Out","value":493},{"label":"Nov","value":624},{"label":"Dez","value":363}];
const MX = 624;
