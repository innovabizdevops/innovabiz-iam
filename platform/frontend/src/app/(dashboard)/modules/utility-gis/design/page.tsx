...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.634","t":"+9.7%","d":"up"},{"l":"Submissões/Dia","v":"1133","t":"+13.3%","d":"up"},{"l":"Documentos Gerados","v":"7.217","t":"+2.2%","d":"up"},{"l":"Templates","v":"7.899","t":"-4.2%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.838","2026-02-22","8.107","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.500","2026-01-15","4.155","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.213","2026-02-04","1.556","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.769","2026-03-18","2.177","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.315","2026-02-07","4.406","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":772},{"label":"Mar","value":832},{"label":"Abr","value":998},{"label":"Mai","value":816},{"label":"Jun","value":837},{"label":"Jul","value":645},{"label":"Ago","value":678},{"label":"Set","value":889},{"label":"Out","value":885},{"label":"Nov","value":767},{"label":"Dez","value":949}];
const MX = 998;
