...
const PAGE = "Digitize";
const KPIS = [{"l":"Total Cultural Heritage Digital","v":"5.816","t":"+0.3%","d":"up"},{"l":"Digitize Ativos","v":"1.559","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"68.7%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"73","t":"-5.6%","d":"down"}];
const COLS = ["ID","Digitize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cultural Heritage Digital #001","Cultural Heritage Digital #002","7.211","7.056","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cultural Heritage Digital #002","Cultural Heritage Digital #003","8.169","4.963","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Cultural Heritage Digital #003","Cultural Heritage Digital #004","2.462","2.819","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cultural Heritage Digital #004","Cultural Heritage Digital #005","5.287","5.151","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cultural Heritage Digital #005","Cultural Heritage Digital #001","8.352","7.578","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":796},{"label":"Mar","value":701},{"label":"Abr","value":911},{"label":"Mai","value":1001},{"label":"Jun","value":671},{"label":"Jul","value":695},{"label":"Ago","value":784},{"label":"Set","value":840},{"label":"Out","value":698},{"label":"Nov","value":977},{"label":"Dez","value":694}];
const MX = 1001;
