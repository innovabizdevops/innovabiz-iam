...
/* ═══ Cultural Heritage Digital — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "9604", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4775", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€74K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1482980004", cells: ["CUL-6004", "Cultural Heritage Digital Item 1", "17/1/2026", "€30 104"], status: "active" as const },
    { id: "1482983575", cells: ["CUL-9575", "Cultural Heritage Digital Item 2", "4/8/2026", "€33 675"], status: "pending" as const },
    { id: "1482987146", cells: ["CUL-4146", "Cultural Heritage Digital Item 3", "19/3/2026", "€37 246"], status: "completed" as const },
    { id: "1482990717", cells: ["CUL-7717", "Cultural Heritage Digital Item 4", "6/10/2026", "€40 817"], status: "warning" as const },
    { id: "1482994288", cells: ["CUL-2288", "Cultural Heritage Digital Item 5", "21/5/2026", "€44 388"], status: "active" as const },
];
...
export default function CulturalHeritageDigitalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cultural Heritage Digital</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cultural Heritage Digital</p>
                    </div>
                </div>
