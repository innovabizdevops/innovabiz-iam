...
const PAGE = "Preserve";
const KPIS = [{"l":"Total Cultural Heritage Digital","v":"5.151","t":"-2.3%","d":"down"},{"l":"Preserve Ativos","v":"7.268","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"87.2%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"67","t":"-4.4%","d":"down"}];
const COLS = ["ID","Preserve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cultural Heritage Digital #001","Cultural Heritage Digital #002","2.589","8.221","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Cultural Heritage Digital #002","Cultural Heritage Digital #003","5.282","9.091","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cultural Heritage Digital #003","Cultural Heritage Digital #004","8.488","4.502","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cultural Heritage Digital #004","Cultural Heritage Digital #005","7.201","511","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cultural Heritage Digital #005","Cultural Heritage Digital #001","6.157","6.968","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":918},{"label":"Mar","value":757},{"label":"Abr","value":976},{"label":"Mai","value":658},{"label":"Jun","value":849},{"label":"Jul","value":996},{"label":"Ago","value":936},{"label":"Set","value":899},{"label":"Out","value":684},{"label":"Nov","value":824},{"label":"Dez","value":944}];
const MX = 996;
