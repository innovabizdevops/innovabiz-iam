...
const ACCENT = "#6d28d9";
const MODULE = "Cultural Heritage Digital";
const PAGE = "3D Scan";
const KPIS = [{"l":"Total Cultural Heritage Digital","v":"3.986","t":"+9.7%","d":"up"},{"l":"3D Scan Ativos","v":"8.683","t":"-3.3%","d":"down"},{"l":"Eficiência (%)","v":"75.6%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"82","t":"+15.4%","d":"up"}];
const COLS = ["ID","3D Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cultural Heritage Digital #001","Cultural Heritage Digital #002","729","628","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cultural Heritage Digital #002","Cultural Heritage Digital #003","1.141","2.937","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cultural Heritage Digital #003","Cultural Heritage Digital #004","1.974","6.208","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cultural Heritage Digital #004","Cultural Heritage Digital #005","6.320","4.370","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cultural Heritage Digital #005","Cultural Heritage Digital #001","3.683","8.795","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":287},{"label":"Mar","value":274},{"label":"Abr","value":340},{"label":"Mai","value":460},{"label":"Jun","value":453},{"label":"Jul","value":514},{"label":"Ago","value":317},{"label":"Set","value":571},{"label":"Out","value":396},{"label":"Nov","value":572},{"label":"Dez","value":427}];
const MX = 572;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>3D</span></h1>
                </div>
