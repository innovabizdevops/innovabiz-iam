...
export default function AutoTruckingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Auto Trucking</h1><p className="text-sm text-muted-foreground">Auto Trucking • iBOS Enterprise</p></div>
