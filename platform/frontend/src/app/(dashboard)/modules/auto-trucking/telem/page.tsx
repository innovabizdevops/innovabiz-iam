...
const ACCENT = "#ea580c";
const MODULE = "Autonomous Trucking";
const PAGE = "Telemetry";
const KPIS = [{"l":"Total Auto Trucking","v":"2.247","t":"+2.7%","d":"up"},{"l":"Telemetry Ativos","v":"5.851","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"91","t":"-2.5%","d":"down"}];
const COLS = ["ID","Telemetry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Trucking #001","Auto Trucking #002","1.487","3.055","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Trucking #002","Auto Trucking #003","8.501","7.870","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Trucking #003","Auto Trucking #004","8.285","6.619","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Trucking #004","Auto Trucking #005","5.473","339","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Trucking #005","Auto Trucking #001","7.668","5.434","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":452},{"label":"Mar","value":580},{"label":"Abr","value":282},{"label":"Mai","value":246},{"label":"Jun","value":246},{"label":"Jul","value":480},{"label":"Ago","value":471},{"label":"Set","value":464},{"label":"Out","value":585},{"label":"Nov","value":340},{"label":"Dez","value":448}];
const MX = 585;
...
export default function TelemPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ea580c'}}>IoT</span></h1>
                </div>
