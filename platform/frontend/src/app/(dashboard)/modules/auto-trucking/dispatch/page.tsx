...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.902","t":"-3.9%","d":"down"},{"l":"Viagens/Dia","v":"3154","t":"+3.7%","d":"up"},{"l":"Pontualidade (%)","v":"77.4%","t":"-0.7%","d":"down"},{"l":"Passageiros/Dia","v":"752","t":"-2.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-20","2026-01-20","414","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-13","2026-03-07","7.957","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-20","2026-01-22","5.311","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-16","2026-03-03","5.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-12","2026-01-25","5.427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":846},{"label":"Fev","value":912},{"label":"Mar","value":973},{"label":"Abr","value":746},{"label":"Mai","value":863},{"label":"Jun","value":1005},{"label":"Jul","value":807},{"label":"Ago","value":871},{"label":"Set","value":670},{"label":"Out","value":698},{"label":"Nov","value":891},{"label":"Dez","value":865}];
const MX = 1005;
