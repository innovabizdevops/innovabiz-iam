...
const PAGE = "Advertiser";
const KPIS = [{"l":"Total Ad Network","v":"1.787","t":"-4.4%","d":"down"},{"l":"Advertiser Ativos","v":"1.911","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"86","t":"+2.7%","d":"up"}];
const COLS = ["ID","Advertiser","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Network #001","Ad Network #002","8.575","110","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Network #002","Ad Network #003","3.171","7.712","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Network #003","Ad Network #004","5.836","1.154","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Network #004","Ad Network #005","3.705","3.265","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Network #005","Ad Network #001","5.478","7.209","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":779},{"label":"Mar","value":898},{"label":"Abr","value":722},{"label":"Mai","value":629},{"label":"Jun","value":894},{"label":"Jul","value":649},{"label":"Ago","value":908},{"label":"Set","value":899},{"label":"Out","value":706},{"label":"Nov","value":1012},{"label":"Dez","value":998}];
const MX = 1012;
