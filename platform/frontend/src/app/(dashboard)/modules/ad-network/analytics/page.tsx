...
const KPIS = [{"l":"Dashboards Ativos","v":"9.079","t":"+9.4%","d":"up"},{"l":"Queries/Dia","v":"1566","t":"+0.7%","d":"up"},{"l":"Dados Processados (GB)","v":"432","t":"+17.8%","d":"up"},{"l":"Utilizadores Analytics","v":"166","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","443","2026-02-11","7.726","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1058","2026-03-18","8.047","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","374","2026-01-14","1.064","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","483","2026-01-25","3.550","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3647","2026-02-27","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":511},{"label":"Mar","value":612},{"label":"Abr","value":584},{"label":"Mai","value":472},{"label":"Jun","value":637},{"label":"Jul","value":287},{"label":"Ago","value":392},{"label":"Set","value":302},{"label":"Out","value":508},{"label":"Nov","value":571},{"label":"Dez","value":525}];
const MX = 637;
