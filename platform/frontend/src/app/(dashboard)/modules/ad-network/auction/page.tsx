...
const ACCENT = "#6366f1";
const MODULE = "Ad Network";
const PAGE = "Auction";
const KPIS = [{"l":"Total Ad Network","v":"3.225","t":"+9.1%","d":"up"},{"l":"Auction Ativos","v":"3.690","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"89","t":"-5.5%","d":"down"}];
const COLS = ["ID","Auction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Network #001","Ad Network #002","4.964","6.567","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Network #002","Ad Network #003","199","6.050","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Network #003","Ad Network #004","5.398","7.583","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Network #004","Ad Network #005","4.322","6.946","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Network #005","Ad Network #001","5.544","7.495","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":784},{"label":"Mar","value":631},{"label":"Abr","value":904},{"label":"Mai","value":711},{"label":"Jun","value":815},{"label":"Jul","value":620},{"label":"Ago","value":907},{"label":"Set","value":551},{"label":"Out","value":594},{"label":"Nov","value":631},{"label":"Dez","value":562}];
const MX = 907;
