...
const KPIS = [{"l":"Total Ad Network","v":"3.317","t":"+16.6%","d":"up"},{"l":"Publisher Ativos","v":"7.708","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"68.2%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"87","t":"+17.5%","d":"up"}];
const COLS = ["ID","Publisher","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ad Network #001","Ad Network #002","3.446","4.926","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Ad Network #002","Ad Network #003","6.722","800","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Ad Network #003","Ad Network #004","3.933","7.053","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Ad Network #004","Ad Network #005","2.826","6.227","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ad Network #005","Ad Network #001","8.243","1.525","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":564},{"label":"Mar","value":587},{"label":"Abr","value":549},{"label":"Mai","value":313},{"label":"Jun","value":566},{"label":"Jul","value":681},{"label":"Ago","value":387},{"label":"Set","value":453},{"label":"Out","value":626},{"label":"Nov","value":572},{"label":"Dez","value":409}];
const MX = 681;
