...
const PAGE = "Reviews";
const KPIS = [{"l":"Total Wellness Retreat","v":"7.794","t":"+8.1%","d":"up"},{"l":"Reviews Ativos","v":"8.094","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"90.2%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+4.3%","d":"up"}];
const COLS = ["ID","Reviews","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Retreat #001","Wellness Retreat #002","5.537","7.963","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Retreat #002","Wellness Retreat #003","2.441","8.784","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Retreat #003","Wellness Retreat #004","459","4.864","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Retreat #004","Wellness Retreat #005","1.777","1.170","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Retreat #005","Wellness Retreat #001","7.035","1.627","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":700},{"label":"Mar","value":733},{"label":"Abr","value":621},{"label":"Mai","value":655},{"label":"Jun","value":434},{"label":"Jul","value":512},{"label":"Ago","value":675},{"label":"Set","value":535},{"label":"Out","value":407},{"label":"Nov","value":729},{"label":"Dez","value":582}];
const MX = 733;
