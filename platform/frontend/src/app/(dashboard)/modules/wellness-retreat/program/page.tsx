...
const PAGE = "Program";
const KPIS = [{"l":"Total Wellness Retreat","v":"4.497","t":"+13.4%","d":"up"},{"l":"Program Ativos","v":"879","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"65.6%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+18.0%","d":"up"}];
const COLS = ["ID","Program","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Retreat #001","Wellness Retreat #002","5.557","5.465","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Retreat #002","Wellness Retreat #003","4.959","4.131","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Retreat #003","Wellness Retreat #004","5.921","180","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Retreat #004","Wellness Retreat #005","5.234","424","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Retreat #005","Wellness Retreat #001","3.001","2.648","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":575},{"label":"Mar","value":663},{"label":"Abr","value":741},{"label":"Mai","value":800},{"label":"Jun","value":505},{"label":"Jul","value":528},{"label":"Ago","value":826},{"label":"Set","value":697},{"label":"Out","value":483},{"label":"Nov","value":634},{"label":"Dez","value":641}];
const MX = 826;
