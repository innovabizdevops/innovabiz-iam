...
const ACCENT = "#6366f1";
const MODULE = "Wellness Retreat";
const PAGE = "Practitioner";
const KPIS = [{"l":"Total Wellness Retreat","v":"2.020","t":"-2.7%","d":"down"},{"l":"Practitioner Ativos","v":"1.593","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"76","t":"+16.3%","d":"up"}];
const COLS = ["ID","Practitioner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wellness Retreat #001","Wellness Retreat #002","7.186","6.936","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Wellness Retreat #002","Wellness Retreat #003","391","3.979","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Wellness Retreat #003","Wellness Retreat #004","7.014","1.815","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Wellness Retreat #004","Wellness Retreat #005","6.720","7.193","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wellness Retreat #005","Wellness Retreat #001","3.118","768","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":317},{"label":"Mar","value":375},{"label":"Abr","value":558},{"label":"Mai","value":618},{"label":"Jun","value":598},{"label":"Jul","value":458},{"label":"Ago","value":365},{"label":"Set","value":463},{"label":"Out","value":643},{"label":"Nov","value":277},{"label":"Dez","value":298}];
const MX = 643;
