...
const KPIS = [{"l":"Dashboards Ativos","v":"813","t":"+5.7%","d":"up"},{"l":"Queries/Dia","v":"3177","t":"+5.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.392","t":"+8.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.642","t":"+11.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2903","2026-03-03","4.045","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3175","2026-03-12","7.771","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3156","2026-01-08","8.116","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4458","2026-01-24","1.293","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3215","2026-01-12","6.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":529},{"label":"Mar","value":700},{"label":"Abr","value":574},{"label":"Mai","value":545},{"label":"Jun","value":652},{"label":"Jul","value":677},{"label":"Ago","value":665},{"label":"Set","value":660},{"label":"Out","value":815},{"label":"Nov","value":570},{"label":"Dez","value":554}];
const MX = 815;
