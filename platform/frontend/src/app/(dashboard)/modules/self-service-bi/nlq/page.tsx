...
const ACCENT = "#7c3aed";
const MODULE = "Self-Service BI";
const PAGE = "Natural Query";
const KPIS = [{"l":"Total Self Service Bi","v":"3.391","t":"+4.8%","d":"up"},{"l":"Natural Query Ativos","v":"6.363","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.7%","d":"up"}];
const COLS = ["ID","Natural Query","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Self Service Bi #001","Self Service Bi #002","4.303","7.176","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Self Service Bi #002","Self Service Bi #003","4.287","2.101","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Self Service Bi #003","Self Service Bi #004","5.493","7.551","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Self Service Bi #004","Self Service Bi #005","5.075","2.139","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Self Service Bi #005","Self Service Bi #001","2.062","1.570","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":625},{"label":"Mar","value":723},{"label":"Abr","value":853},{"label":"Mai","value":698},{"label":"Jun","value":709},{"label":"Jul","value":806},{"label":"Ago","value":806},{"label":"Set","value":841},{"label":"Out","value":694},{"label":"Nov","value":806},{"label":"Dez","value":686}];
const MX = 853;
