...
const PAGE = "Security";
const KPIS = [{"l":"Total Airport Mgmt","v":"7.121","t":"+3.1%","d":"up"},{"l":"Security Ativos","v":"839","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.8%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Mgmt #001","Airport Mgmt #002","6.412","1.308","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Mgmt #002","Airport Mgmt #003","906","268","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Mgmt #003","Airport Mgmt #004","5.271","5.555","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Mgmt #004","Airport Mgmt #005","4.908","7.257","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Mgmt #005","Airport Mgmt #001","3.137","2.872","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":318},{"label":"Mar","value":361},{"label":"Abr","value":406},{"label":"Mai","value":290},{"label":"Jun","value":388},{"label":"Jul","value":642},{"label":"Ago","value":367},{"label":"Set","value":575},{"label":"Out","value":331},{"label":"Nov","value":363},{"label":"Dez","value":459}];
const MX = 642;
