...
const PAGE = "Terminal";
const KPIS = [{"l":"Riscos Identificados","v":"4.650","t":"-4.7%","d":"down"},{"l":"Mitigações Ativas","v":"9.028","t":"+6.2%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"+14.9%","d":"up"},{"l":"Incidentes YTD","v":"1.738","t":"+12.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.146","7.899","829","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.641","8.038","4.949","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.832","8.201","957","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.033","6.380","7.859","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.795","4.280","8.526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":582},{"label":"Mar","value":399},{"label":"Abr","value":562},{"label":"Mai","value":388},{"label":"Jun","value":348},{"label":"Jul","value":450},{"label":"Ago","value":556},{"label":"Set","value":634},{"label":"Out","value":504},{"label":"Nov","value":522},{"label":"Dez","value":674}];
const MX = 674;
