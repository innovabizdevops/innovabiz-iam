...
const PAGE = "Gate";
const KPIS = [{"l":"Total Airport Mgmt","v":"1.522","t":"+11.5%","d":"up"},{"l":"Gate Ativos","v":"8.067","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"56","t":"+2.2%","d":"up"}];
const COLS = ["ID","Gate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Mgmt #001","Airport Mgmt #002","6.282","4.130","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Mgmt #002","Airport Mgmt #003","6.757","3.216","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Mgmt #003","Airport Mgmt #004","938","3.512","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Mgmt #004","Airport Mgmt #005","1.261","2.025","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Mgmt #005","Airport Mgmt #001","5.642","1.457","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":616},{"label":"Mar","value":787},{"label":"Abr","value":867},{"label":"Mai","value":635},{"label":"Jun","value":759},{"label":"Jul","value":607},{"label":"Ago","value":783},{"label":"Set","value":978},{"label":"Out","value":979},{"label":"Nov","value":916},{"label":"Dez","value":936}];
const MX = 979;
