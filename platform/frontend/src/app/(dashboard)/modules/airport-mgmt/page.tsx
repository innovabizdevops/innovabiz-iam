...
const KPIS = [
    { label: "Total Registos", value: "4598", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2443", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€376K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1994755498", cells: ["AIR-5498", "Airport Management Item 1", "23/11/2026", "€5598"], status: "active" as const },
    { id: "1994759069", cells: ["AIR-9069", "Airport Management Item 2", "10/6/2026", "€9169"], status: "pending" as const },
    { id: "1994762640", cells: ["AIR-3640", "Airport Management Item 3", "25/1/2026", "€12 740"], status: "completed" as const },
    { id: "1994766211", cells: ["AIR-7211", "Airport Management Item 4", "12/8/2026", "€16 311"], status: "warning" as const },
    { id: "1994769782", cells: ["AIR-1782", "Airport Management Item 5", "27/3/2026", "€19 882"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Airport Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Airport Management</p>
                    </div>
                </div>
