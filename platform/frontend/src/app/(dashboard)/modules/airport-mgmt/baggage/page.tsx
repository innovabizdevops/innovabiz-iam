...
const ACCENT = "#1e3a5f";
const MODULE = "Airport Management";
const PAGE = "Baggage";
const KPIS = [{"l":"Total Airport Mgmt","v":"1.163","t":"+16.9%","d":"up"},{"l":"Baggage Ativos","v":"5.959","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"94.0%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"81","t":"+17.0%","d":"up"}];
const COLS = ["ID","Baggage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Mgmt #001","Airport Mgmt #002","7.726","5.673","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Mgmt #002","Airport Mgmt #003","7.134","8.319","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Mgmt #003","Airport Mgmt #004","5.320","5.425","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Mgmt #004","Airport Mgmt #005","2.290","2.398","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Mgmt #005","Airport Mgmt #001","292","3.476","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":509},{"label":"Mar","value":566},{"label":"Abr","value":737},{"label":"Mai","value":482},{"label":"Jun","value":461},{"label":"Jul","value":679},{"label":"Ago","value":706},{"label":"Set","value":441},{"label":"Out","value":370},{"label":"Nov","value":411},{"label":"Dez","value":517}];
const MX = 737;
