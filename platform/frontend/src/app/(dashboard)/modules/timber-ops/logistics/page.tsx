...
const KPIS = [{"l":"Total Timber Ops","v":"4.161","t":"+0.2%","d":"up"},{"l":"Logistics Ativos","v":"3.101","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"73.7%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.9%","d":"up"}];
const COLS = ["ID","Logistics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Ops #001","Timber Ops #002","1.952","3.273","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Ops #002","Timber Ops #003","130","5.914","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Ops #003","Timber Ops #004","8.311","7.817","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Ops #004","Timber Ops #005","6.611","8.383","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Ops #005","Timber Ops #001","6.225","3.525","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":246},{"label":"Fev","value":612},{"label":"Mar","value":381},{"label":"Abr","value":499},{"label":"Mai","value":460},{"label":"Jun","value":467},{"label":"Jul","value":250},{"label":"Ago","value":404},{"label":"Set","value":304},{"label":"Out","value":374},{"label":"Nov","value":382},{"label":"Dez","value":495}];
const MX = 612;
