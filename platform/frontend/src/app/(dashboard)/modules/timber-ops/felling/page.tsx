...
const ACCENT = "#6366f1";
const MODULE = "Timber Operations";
const PAGE = "Felling";
const KPIS = [{"l":"Total Timber Ops","v":"2.727","t":"+10.4%","d":"up"},{"l":"Felling Ativos","v":"4.960","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"75.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+3.1%","d":"up"}];
const COLS = ["ID","Felling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Ops #001","Timber Ops #002","2.263","5.001","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Ops #002","Timber Ops #003","928","7.732","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Ops #003","Timber Ops #004","4.064","7.885","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Ops #004","Timber Ops #005","1.405","2.426","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Ops #005","Timber Ops #001","112","5.297","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":808},{"label":"Mar","value":633},{"label":"Abr","value":797},{"label":"Mai","value":1007},{"label":"Jun","value":906},{"label":"Jul","value":781},{"label":"Ago","value":781},{"label":"Set","value":716},{"label":"Out","value":691},{"label":"Nov","value":941},{"label":"Dez","value":741}];
const MX = 1007;
...
export default function FellingPage() {
    return (
