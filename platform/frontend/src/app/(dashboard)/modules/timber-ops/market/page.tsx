...
const PAGE = "Market";
const KPIS = [{"l":"Total Timber Ops","v":"5.588","t":"+3.4%","d":"up"},{"l":"Market Ativos","v":"5.534","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"90.2%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"79","t":"-1.3%","d":"down"}];
const COLS = ["ID","Market","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Ops #001","Timber Ops #002","2.661","4.801","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Ops #002","Timber Ops #003","6.509","6.930","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Ops #003","Timber Ops #004","6.276","3.164","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Ops #004","Timber Ops #005","4.655","7.521","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Ops #005","Timber Ops #001","6.408","6.208","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1060},{"label":"Fev","value":684},{"label":"Mar","value":731},{"label":"Abr","value":831},{"label":"Mai","value":812},{"label":"Jun","value":1067},{"label":"Jul","value":1023},{"label":"Ago","value":673},{"label":"Set","value":982},{"label":"Out","value":798},{"label":"Nov","value":736},{"label":"Dez","value":999}];
const MX = 1067;
