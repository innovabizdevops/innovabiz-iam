...
const KPIS = [{"l":"Total Timber Ops","v":"6.565","t":"+4.5%","d":"up"},{"l":"Processing Ativos","v":"1.903","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"63","t":"+14.6%","d":"up"}];
const COLS = ["ID","Processing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Ops #001","Timber Ops #002","4.857","3.542","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Ops #002","Timber Ops #003","6.893","6.115","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Ops #003","Timber Ops #004","6.109","5.415","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Ops #004","Timber Ops #005","156","3.925","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Ops #005","Timber Ops #001","2.038","195","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":806},{"label":"Mar","value":591},{"label":"Abr","value":751},{"label":"Mai","value":600},{"label":"Jun","value":533},{"label":"Jul","value":728},{"label":"Ago","value":866},{"label":"Set","value":678},{"label":"Out","value":567},{"label":"Nov","value":836},{"label":"Dez","value":530}];
const MX = 866;
