...
const PAGE = "Skidding";
const KPIS = [{"l":"Total Timber Ops","v":"5.870","t":"+15.3%","d":"up"},{"l":"Skidding Ativos","v":"3.585","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"72.5%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"73","t":"-4.1%","d":"down"}];
const COLS = ["ID","Skidding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Timber Ops #001","Timber Ops #002","7.099","1.679","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Timber Ops #002","Timber Ops #003","8.862","2.390","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Timber Ops #003","Timber Ops #004","8.949","7.763","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Timber Ops #004","Timber Ops #005","2.948","8.307","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Timber Ops #005","Timber Ops #001","477","6.267","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":658},{"label":"Mar","value":868},{"label":"Abr","value":625},{"label":"Mai","value":540},{"label":"Jun","value":771},{"label":"Jul","value":682},{"label":"Ago","value":551},{"label":"Set","value":581},{"label":"Out","value":745},{"label":"Nov","value":817},{"label":"Dez","value":870}];
const MX = 870;
...
export default function SkiddingPage() {
    return (
