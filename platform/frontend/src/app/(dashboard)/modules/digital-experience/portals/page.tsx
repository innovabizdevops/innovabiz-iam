...
const PAGE = "Portals &amp; Sites";
const KPIS = [{"l":"Perfis Unificados","v":"2.605","t":"+7.4%","d":"up"},{"l":"Segmentos Ativos","v":"881","t":"-5.9%","d":"down"},{"l":"NPS Score","v":"87","t":"-2.8%","d":"down"},{"l":"Churn Previsto (%)","v":"76.5%","t":"-4.8%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","949","€ 16326.87","72.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.152","€ 18578.52","72.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","5.513","€ 42074.15","90.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.005","€ 47878.21","78.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.460","€ 7784.63","77.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":341},{"label":"Fev","value":328},{"label":"Mar","value":642},{"label":"Abr","value":367},{"label":"Mai","value":588},{"label":"Jun","value":327},{"label":"Jul","value":408},{"label":"Ago","value":548},{"label":"Set","value":527},{"label":"Out","value":418},{"label":"Nov","value":642},{"label":"Dez","value":442}];
const MX = 642;
