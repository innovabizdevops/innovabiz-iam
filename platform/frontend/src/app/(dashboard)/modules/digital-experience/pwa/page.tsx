...
const PAGE = "Progressive Web App";
const KPIS = [{"l":"Perfis Unificados","v":"3.549","t":"-1.4%","d":"down"},{"l":"Segmentos Ativos","v":"118","t":"+11.8%","d":"up"},{"l":"NPS Score","v":"77","t":"+1.6%","d":"up"},{"l":"Churn Previsto (%)","v":"67.7%","t":"+5.3%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","6.326","€ 33784.19","76.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.717","€ 19716.06","79.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","3.344","€ 28121.15","73.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.096","€ 29797.62","81.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","8.538","€ 50059.05","87.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":663},{"label":"Mar","value":423},{"label":"Abr","value":725},{"label":"Mai","value":439},{"label":"Jun","value":736},{"label":"Jul","value":610},{"label":"Ago","value":576},{"label":"Set","value":578},{"label":"Out","value":440},{"label":"Nov","value":521},{"label":"Dez","value":490}];
const MX = 736;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>PWA</span></h1>
                </div>
