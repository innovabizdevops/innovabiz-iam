...
const PAGE = "Voice Experience";
const KPIS = [{"l":"Perfis Unificados","v":"1.798","t":"-4.0%","d":"down"},{"l":"Segmentos Ativos","v":"4.263","t":"+13.8%","d":"up"},{"l":"NPS Score","v":"74","t":"-1.3%","d":"down"},{"l":"Churn Previsto (%)","v":"84.4%","t":"+4.5%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","1.099","€ 14611.37","98.2%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","6.661","€ 16867.51","85.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","7.957","€ 3715.32","88.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.732","€ 22014.54","76.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.566","€ 34768.36","94.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":840},{"label":"Mar","value":769},{"label":"Abr","value":746},{"label":"Mai","value":925},{"label":"Jun","value":1009},{"label":"Jul","value":687},{"label":"Ago","value":676},{"label":"Set","value":956},{"label":"Out","value":682},{"label":"Nov","value":622},{"label":"Dez","value":934}];
const MX = 1009;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>VUI</span></h1>
                </div>
