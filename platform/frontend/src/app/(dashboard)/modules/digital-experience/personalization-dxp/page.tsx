...
const ACCENT = "#6366f1";
const MODULE = "Digital Experience";
const PAGE = "Personalization AI";
const KPIS = [{"l":"Perfis Unificados","v":"8.460","t":"+6.4%","d":"up"},{"l":"Segmentos Ativos","v":"397","t":"-1.4%","d":"down"},{"l":"NPS Score","v":"88","t":"+10.1%","d":"up"},{"l":"Churn Previsto (%)","v":"70.7%","t":"-5.3%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.458","€ 47166.38","94.0%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","2.272","€ 14367.15","79.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","697","€ 40129.68","89.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","8.922","€ 40222.16","77.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.378","€ 33668.56","93.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":304},{"label":"Mar","value":541},{"label":"Abr","value":220},{"label":"Mai","value":501},{"label":"Jun","value":261},{"label":"Jul","value":592},{"label":"Ago","value":383},{"label":"Set","value":315},{"label":"Out","value":446},{"label":"Nov","value":518},{"label":"Dez","value":301}];
const MX = 592;
...
export default function PersonalizationDxpPage() {
    return (
