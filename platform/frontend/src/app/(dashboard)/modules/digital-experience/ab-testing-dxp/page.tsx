...
const KPIS = [{"l":"Perfis Unificados","v":"5.493","t":"-2.4%","d":"down"},{"l":"Segmentos Ativos","v":"567","t":"+13.2%","d":"up"},{"l":"NPS Score","v":"66","t":"+9.4%","d":"up"},{"l":"Churn Previsto (%)","v":"94.4%","t":"+17.9%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","4.418","€ 37456.01","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.968","€ 35857.16","79.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.056","€ 19853.48","77.6%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.629","€ 17098.53","90.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","7.969","€ 43856.13","87.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":440},{"label":"Mar","value":571},{"label":"Abr","value":431},{"label":"Mai","value":637},{"label":"Jun","value":668},{"label":"Jul","value":443},{"label":"Ago","value":531},{"label":"Set","value":514},{"label":"Out","value":642},{"label":"Nov","value":432},{"label":"Dez","value":481}];
const MX = 668;
...
export default function AbTestingDxpPage() {
    return (
