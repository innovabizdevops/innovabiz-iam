...
const PAGE = "CMS";
const KPIS = [{"l":"Perfis Unificados","v":"8.159","t":"+1.2%","d":"up"},{"l":"Segmentos Ativos","v":"8.587","t":"+3.0%","d":"up"},{"l":"NPS Score","v":"71","t":"+7.6%","d":"up"},{"l":"Churn Previsto (%)","v":"77.4%","t":"-4.6%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.173","€ 29586.89","93.7%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","8.559","€ 8076.67","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","416","€ 46928.04","93.1%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.521","€ 25671.49","75.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","1.776","€ 1952.98","96.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":858},{"label":"Mar","value":694},{"label":"Abr","value":634},{"label":"Mai","value":614},{"label":"Jun","value":489},{"label":"Jul","value":639},{"label":"Ago","value":534},{"label":"Set","value":559},{"label":"Out","value":591},{"label":"Nov","value":798},{"label":"Dez","value":663}];
const MX = 858;
