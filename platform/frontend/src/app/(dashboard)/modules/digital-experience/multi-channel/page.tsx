...
const PAGE = "Multi-Channel";
const KPIS = [{"l":"Perfis Unificados","v":"2.088","t":"-4.7%","d":"down"},{"l":"Segmentos Ativos","v":"7.839","t":"+14.5%","d":"up"},{"l":"NPS Score","v":"56","t":"+3.8%","d":"up"},{"l":"Churn Previsto (%)","v":"78.7%","t":"+11.1%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","7.758","€ 36419.34","76.8%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","7.437","€ 38082.98","96.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","2.336","€ 19793.97","92.3%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","1.785","€ 17247.46","97.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.151","€ 40812.75","99.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":787},{"label":"Mar","value":577},{"label":"Abr","value":691},{"label":"Mai","value":544},{"label":"Jun","value":743},{"label":"Jul","value":552},{"label":"Ago","value":770},{"label":"Set","value":463},{"label":"Out","value":768},{"label":"Nov","value":829},{"label":"Dez","value":643}];
const MX = 829;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Omni</span></h1>
                </div>
