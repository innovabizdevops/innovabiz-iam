...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€6.1M","t":"+5.3%","d":"up"},{"l":"MRR (€)","v":"€12505","t":"+11.9%","d":"up"},{"l":"Churn (%)","v":"66.9%","t":"+4.9%","d":"up"},{"l":"ARPU (€)","v":"€37595","t":"+15.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 13369.62","2.598","€ 37493.72","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 45790.83","6.023","€ 47537.00","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 17487.32","696","€ 9473.49","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33154.55","6.670","€ 4805.02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 29696.57","3.788","€ 4400.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":576},{"label":"Mar","value":584},{"label":"Abr","value":654},{"label":"Mai","value":782},{"label":"Jun","value":726},{"label":"Jul","value":804},{"label":"Ago","value":771},{"label":"Set","value":612},{"label":"Out","value":524},{"label":"Nov","value":764},{"label":"Dez","value":714}];
const MX = 804;
