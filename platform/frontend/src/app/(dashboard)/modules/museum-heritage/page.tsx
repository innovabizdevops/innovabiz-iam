...
/* ═══ Museum & Heritage — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "3613", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2748", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€256K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "437246913", cells: ["MUS-9913", "Museum & Heritage Item 1", "6/10/2026", "€47 013"], status: "active" as const },
    { id: "437250484", cells: ["MUS-4484", "Museum & Heritage Item 2", "21/5/2026", "€584"], status: "pending" as const },
    { id: "437254055", cells: ["MUS-8055", "Museum & Heritage Item 3", "8/12/2026", "€4155"], status: "completed" as const },
    { id: "437257626", cells: ["MUS-2626", "Museum & Heritage Item 4", "23/7/2026", "€7726"], status: "warning" as const },
    { id: "437261197", cells: ["MUS-6197", "Museum & Heritage Item 5", "10/2/2026", "€11 297"], status: "active" as const },
];
...
export default function MuseumHeritagePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Museum & Heritage</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Museum & Heritage</p>
                    </div>
                </div>
