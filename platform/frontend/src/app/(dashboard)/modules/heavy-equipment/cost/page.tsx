...
const PAGE = "Cost";
const KPIS = [{"l":"Total Heavy Equipment","v":"1.251","t":"+9.9%","d":"up"},{"l":"Cost Ativos","v":"8.579","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"84.3%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"76","t":"-5.0%","d":"down"}];
const COLS = ["ID","Cost","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heavy Equipment #001","Heavy Equipment #002","1.557","4.330","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Heavy Equipment #002","Heavy Equipment #003","3.678","3.309","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Heavy Equipment #003","Heavy Equipment #004","6.174","5.040","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Heavy Equipment #004","Heavy Equipment #005","1.640","3.015","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heavy Equipment #005","Heavy Equipment #001","3.114","3.458","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":477},{"label":"Mar","value":770},{"label":"Abr","value":517},{"label":"Mai","value":638},{"label":"Jun","value":564},{"label":"Jul","value":784},{"label":"Ago","value":791},{"label":"Set","value":657},{"label":"Out","value":461},{"label":"Nov","value":705},{"label":"Dez","value":714}];
const MX = 791;
