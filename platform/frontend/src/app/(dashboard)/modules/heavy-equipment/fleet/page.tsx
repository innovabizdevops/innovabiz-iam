...
const ACCENT = "#6366f1";
const MODULE = "Heavy Equipment";
const PAGE = "Fleet";
const KPIS = [{"l":"Total Heavy Equipment","v":"1.583","t":"+4.5%","d":"up"},{"l":"Fleet Ativos","v":"5.175","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"64","t":"+2.1%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heavy Equipment #001","Heavy Equipment #002","3.436","6.861","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Heavy Equipment #002","Heavy Equipment #003","2.586","1.515","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Heavy Equipment #003","Heavy Equipment #004","2.775","6.726","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Heavy Equipment #004","Heavy Equipment #005","3.893","330","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heavy Equipment #005","Heavy Equipment #001","5.679","477","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":448},{"label":"Mar","value":633},{"label":"Abr","value":475},{"label":"Mai","value":476},{"label":"Jun","value":425},{"label":"Jul","value":449},{"label":"Ago","value":426},{"label":"Set","value":714},{"label":"Out","value":386},{"label":"Nov","value":411},{"label":"Dez","value":492}];
const MX = 714;
