...
const PAGE = "Rental";
const KPIS = [{"l":"Total Heavy Equipment","v":"6.961","t":"+2.9%","d":"up"},{"l":"Rental Ativos","v":"3.311","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"86","t":"+0.8%","d":"up"}];
const COLS = ["ID","Rental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heavy Equipment #001","Heavy Equipment #002","3.974","6.478","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Heavy Equipment #002","Heavy Equipment #003","3.723","838","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Heavy Equipment #003","Heavy Equipment #004","2.633","557","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Heavy Equipment #004","Heavy Equipment #005","2.191","300","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heavy Equipment #005","Heavy Equipment #001","7.584","4.367","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":476},{"label":"Mar","value":831},{"label":"Abr","value":794},{"label":"Mai","value":829},{"label":"Jun","value":564},{"label":"Jul","value":628},{"label":"Ago","value":832},{"label":"Set","value":483},{"label":"Out","value":659},{"label":"Nov","value":797},{"label":"Dez","value":611}];
const MX = 832;
