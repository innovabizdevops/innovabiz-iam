...
const ACCENT = "#1e40af";
const MODULE = "Status Page Platform";
const PAGE = "History";
const KPIS = [{"l":"Total Status Page","v":"3.171","t":"+15.6%","d":"up"},{"l":"History Ativos","v":"6.095","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"74.5%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"68","t":"-3.9%","d":"down"}];
const COLS = ["ID","History","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Status Page #001","Status Page #002","3.588","8.813","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Status Page #002","Status Page #003","6.584","2.869","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Status Page #003","Status Page #004","2.650","5.100","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Status Page #004","Status Page #005","6.690","8.892","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Status Page #005","Status Page #001","5.765","1.790","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":725},{"label":"Mar","value":772},{"label":"Abr","value":598},{"label":"Mai","value":827},{"label":"Jun","value":775},{"label":"Jul","value":825},{"label":"Ago","value":555},{"label":"Set","value":781},{"label":"Out","value":521},{"label":"Nov","value":510},{"label":"Dez","value":560}];
const MX = 827;
