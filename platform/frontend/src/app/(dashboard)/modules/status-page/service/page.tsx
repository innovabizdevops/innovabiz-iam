...
const PAGE = "Service";
const KPIS = [{"l":"Total Status Page","v":"7.872","t":"-4.5%","d":"down"},{"l":"Service Ativos","v":"3.015","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+15.6%","d":"up"}];
const COLS = ["ID","Service","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Status Page #001","Status Page #002","8.381","8.212","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Status Page #002","Status Page #003","4.455","2.439","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Status Page #003","Status Page #004","3.989","5.262","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Status Page #004","Status Page #005","8.838","2.941","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Status Page #005","Status Page #001","2.846","2.511","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":456},{"label":"Mar","value":394},{"label":"Abr","value":756},{"label":"Mai","value":371},{"label":"Jun","value":729},{"label":"Jul","value":590},{"label":"Ago","value":666},{"label":"Set","value":670},{"label":"Out","value":659},{"label":"Nov","value":680},{"label":"Dez","value":702}];
const MX = 756;
