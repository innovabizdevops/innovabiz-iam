...
const PAGE = "API";
const KPIS = [{"l":"Total Status Page","v":"1.115","t":"+12.2%","d":"up"},{"l":"API Ativos","v":"1.952","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"73","t":"+7.6%","d":"up"}];
const COLS = ["ID","API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Status Page #001","Status Page #002","2.502","7.766","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Status Page #002","Status Page #003","3.884","8.206","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Status Page #003","Status Page #004","9.093","7.225","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Status Page #004","Status Page #005","6.684","7.484","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Status Page #005","Status Page #001","4.021","494","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":395},{"label":"Mar","value":380},{"label":"Abr","value":256},{"label":"Mai","value":588},{"label":"Jun","value":468},{"label":"Jul","value":545},{"label":"Ago","value":343},{"label":"Set","value":542},{"label":"Out","value":259},{"label":"Nov","value":543},{"label":"Dez","value":363}];
const MX = 588;
