...
const KPIS = [{"l":"Total Status Page","v":"3.429","t":"+6.5%","d":"up"},{"l":"Subscribe Ativos","v":"8.268","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"83","t":"+0.4%","d":"up"}];
const COLS = ["ID","Subscribe","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Status Page #001","Status Page #002","5.689","7.779","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Status Page #002","Status Page #003","5.368","564","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Status Page #003","Status Page #004","6.861","1.108","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Status Page #004","Status Page #005","7.784","5.861","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Status Page #005","Status Page #001","3.850","3.052","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":404},{"label":"Fev","value":538},{"label":"Mar","value":551},{"label":"Abr","value":612},{"label":"Mai","value":545},{"label":"Jun","value":422},{"label":"Jul","value":645},{"label":"Ago","value":328},{"label":"Set","value":502},{"label":"Out","value":383},{"label":"Nov","value":514},{"label":"Dez","value":611}];
const MX = 645;
