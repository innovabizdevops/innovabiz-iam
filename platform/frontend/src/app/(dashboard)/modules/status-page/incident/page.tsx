...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.249","t":"+9.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.3%","t":"+1.5%","d":"up"},{"l":"MTTR (h)","v":"21h","t":"+5.4%","d":"up"},{"l":"Satisfação (%)","v":"94.1%","t":"+10.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.270","8.098","292","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.223","2.612","7.842","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","670","1.775","6.836","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.985","8.892","3.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.755","1.746","6.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":229},{"label":"Fev","value":393},{"label":"Mar","value":337},{"label":"Abr","value":510},{"label":"Mai","value":288},{"label":"Jun","value":221},{"label":"Jul","value":616},{"label":"Ago","value":372},{"label":"Set","value":403},{"label":"Out","value":432},{"label":"Nov","value":607},{"label":"Dez","value":545}];
const MX = 616;
