...
/* ═══ Status Page Platform — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "7459", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1501", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€210K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-17%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "860396559", cells: ["STA-6559", "Status Page Platform Item 1", "16/4/2026", "€46 659"], status: "active" as const },
    { id: "860400130", cells: ["STA-1130", "Status Page Platform Item 2", "3/11/2026", "€230"], status: "pending" as const },
    { id: "860403701", cells: ["STA-4701", "Status Page Platform Item 3", "18/6/2026", "€3801"], status: "completed" as const },
    { id: "860407272", cells: ["STA-8272", "Status Page Platform Item 4", "5/1/2026", "€7372"], status: "warning" as const },
    { id: "860410843", cells: ["STA-2843", "Status Page Platform Item 5", "20/8/2026", "€10 943"], status: "active" as const },
];
...
export default function StatusPagePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Status Page Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Status Page Platform</p>
                    </div>
                </div>
