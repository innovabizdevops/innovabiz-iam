...
const PAGE = "Smart Ball";
const KPIS = [{"l":"Atletas Registados","v":"237","t":"+3.1%","d":"up"},{"l":"Treinos/Semana","v":"814","t":"+1.8%","d":"up"},{"l":"Competições","v":"2.339","t":"-3.0%","d":"down"},{"l":"Performance Score","v":"81","t":"-0.8%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.862","4.013","7.081","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","909","6.584","3.448","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","920","9.017","2.644","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.766","8.077","7.973","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.614","4.801","630","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":369},{"label":"Mar","value":327},{"label":"Abr","value":271},{"label":"Mai","value":622},{"label":"Jun","value":645},{"label":"Jul","value":428},{"label":"Ago","value":515},{"label":"Set","value":467},{"label":"Out","value":546},{"label":"Nov","value":521},{"label":"Dez","value":378}];
const MX = 645;
