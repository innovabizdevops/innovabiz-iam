...
const PAGE = "Wearables";
const KPIS = [{"l":"Atletas Registados","v":"1.611","t":"+14.2%","d":"up"},{"l":"Treinos/Semana","v":"1598","t":"-0.3%","d":"down"},{"l":"Competições","v":"169","t":"-5.0%","d":"down"},{"l":"Performance Score","v":"71","t":"+8.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.070","4.539","6.737","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.349","728","821","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.060","3.363","7.507","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.715","2.277","8.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.653","5.734","7.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":547},{"label":"Mar","value":590},{"label":"Abr","value":479},{"label":"Mai","value":529},{"label":"Jun","value":661},{"label":"Jul","value":463},{"label":"Ago","value":477},{"label":"Set","value":608},{"label":"Out","value":777},{"label":"Nov","value":606},{"label":"Dez","value":403}];
const MX = 777;
