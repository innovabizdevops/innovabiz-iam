...
const PAGE = "VAR/Hawk";
const KPIS = [{"l":"Atletas Registados","v":"930","t":"+15.1%","d":"up"},{"l":"Treinos/Semana","v":"2997","t":"-0.2%","d":"down"},{"l":"Competições","v":"7.549","t":"-4.9%","d":"down"},{"l":"Performance Score","v":"85","t":"+3.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.823","8.492","809","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.881","3.460","7.546","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.619","5.967","7.094","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.698","1.933","5.655","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.250","6.830","2.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":735},{"label":"Mar","value":898},{"label":"Abr","value":735},{"label":"Mai","value":824},{"label":"Jun","value":909},{"label":"Jul","value":736},{"label":"Ago","value":778},{"label":"Set","value":876},{"label":"Out","value":837},{"label":"Nov","value":718},{"label":"Dez","value":796}];
const MX = 909;
