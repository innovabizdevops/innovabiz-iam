...
const ACCENT = "#6366f1";
const MODULE = "Sports Technology";
const PAGE = "AR Viewer";
const KPIS = [{"l":"Atletas Registados","v":"5.725","t":"-3.8%","d":"down"},{"l":"Treinos/Semana","v":"4256","t":"-0.2%","d":"down"},{"l":"Competições","v":"9.007","t":"-1.0%","d":"down"},{"l":"Performance Score","v":"64","t":"+1.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.060","3.514","8.921","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.627","8.222","1.369","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.641","2.201","5.831","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.001","1.023","8.160","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.803","5.478","3.246","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":432},{"label":"Mar","value":466},{"label":"Abr","value":565},{"label":"Mai","value":601},{"label":"Jun","value":378},{"label":"Jul","value":379},{"label":"Ago","value":444},{"label":"Set","value":478},{"label":"Out","value":414},{"label":"Nov","value":605},{"label":"Dez","value":575}];
const MX = 605;
