...
const ACCENT = "#6d28d9";
const MODULE = "Metaverse Platform";
const PAGE = "Social";
const KPIS = [{"l":"Twins Ativos","v":"8.634","t":"-4.7%","d":"down"},{"l":"Simulações/Dia","v":"1750","t":"+8.2%","d":"up"},{"l":"Precisão Modelo (%)","v":"75.2%","t":"-1.6%","d":"down"},{"l":"Latência Sync (ms)","v":"189ms","t":"+6.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","84.8%","2026-01-08","4.308","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","95.3%","2026-01-18","938","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","93.7%","2026-03-07","5.673","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","93.3%","2026-01-22","2.278","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","80.9%","2026-03-10","3.671","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":663},{"label":"Mar","value":661},{"label":"Abr","value":664},{"label":"Mai","value":930},{"label":"Jun","value":949},{"label":"Jul","value":925},{"label":"Ago","value":1023},{"label":"Set","value":699},{"label":"Out","value":670},{"label":"Nov","value":731},{"label":"Dez","value":914}];
const MX = 1023;
