...
const PAGE = "World";
const KPIS = [{"l":"Twins Ativos","v":"3.035","t":"+0.9%","d":"up"},{"l":"Simulações/Dia","v":"3344","t":"+11.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"75.9%","t":"+8.8%","d":"up"},{"l":"Latência Sync (ms)","v":"61ms","t":"+10.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","76.8%","2026-02-04","2.037","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.0%","2026-02-06","4.511","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","73.5%","2026-02-16","5.188","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.9%","2026-03-01","6.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","91.1%","2026-02-11","3.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":576},{"label":"Mar","value":787},{"label":"Abr","value":464},{"label":"Mai","value":667},{"label":"Jun","value":657},{"label":"Jul","value":614},{"label":"Ago","value":511},{"label":"Set","value":824},{"label":"Out","value":463},{"label":"Nov","value":802},{"label":"Dez","value":831}];
const MX = 831;
