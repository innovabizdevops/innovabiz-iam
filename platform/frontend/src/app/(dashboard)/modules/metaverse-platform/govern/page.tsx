...
const PAGE = "Govern";
const KPIS = [{"l":"Twins Ativos","v":"7.761","t":"+7.8%","d":"up"},{"l":"Simulações/Dia","v":"898","t":"+14.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"87.9%","t":"-5.6%","d":"down"},{"l":"Latência Sync (ms)","v":"31ms","t":"+4.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","98.1%","2026-02-04","2.190","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.5%","2026-02-23","5.518","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","78.7%","2026-01-11","2.170","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","90.7%","2026-02-12","3.477","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","90.9%","2026-02-22","2.950","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":516},{"label":"Mar","value":585},{"label":"Abr","value":282},{"label":"Mai","value":441},{"label":"Jun","value":403},{"label":"Jul","value":499},{"label":"Ago","value":562},{"label":"Set","value":595},{"label":"Out","value":308},{"label":"Nov","value":383},{"label":"Dez","value":469}];
const MX = 595;
