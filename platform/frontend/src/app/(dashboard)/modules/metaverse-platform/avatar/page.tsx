...
const PAGE = "Avatar";
const KPIS = [{"l":"Twins Ativos","v":"9.012","t":"+2.7%","d":"up"},{"l":"Simulações/Dia","v":"1021","t":"-5.7%","d":"down"},{"l":"Precisão Modelo (%)","v":"89.6%","t":"+11.6%","d":"up"},{"l":"Latência Sync (ms)","v":"71ms","t":"+13.8%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","86.3%","2026-03-13","7.805","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","71.4%","2026-03-10","1.600","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.4%","2026-01-07","7.414","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","79.2%","2026-01-10","1.907","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","95.2%","2026-01-09","101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":536},{"label":"Mar","value":469},{"label":"Abr","value":486},{"label":"Mai","value":582},{"label":"Jun","value":641},{"label":"Jul","value":403},{"label":"Ago","value":408},{"label":"Set","value":378},{"label":"Out","value":455},{"label":"Nov","value":381},{"label":"Dez","value":465}];
const MX = 641;
