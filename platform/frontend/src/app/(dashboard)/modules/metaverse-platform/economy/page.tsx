...
const PAGE = "Economy";
const KPIS = [{"l":"Twins Ativos","v":"152","t":"+2.0%","d":"up"},{"l":"Simulações/Dia","v":"3237","t":"+15.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.0%","t":"+13.3%","d":"up"},{"l":"Latência Sync (ms)","v":"111ms","t":"+10.0%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","70.5%","2026-02-23","1.347","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","97.1%","2026-01-14","2.191","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","95.1%","2026-03-04","1.074","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","89.3%","2026-01-16","455","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","71.7%","2026-01-26","4.867","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":640},{"label":"Mar","value":601},{"label":"Abr","value":527},{"label":"Mai","value":816},{"label":"Jun","value":494},{"label":"Jul","value":555},{"label":"Ago","value":715},{"label":"Set","value":852},{"label":"Out","value":731},{"label":"Nov","value":524},{"label":"Dez","value":683}];
const MX = 852;
