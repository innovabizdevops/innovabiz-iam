...
/* ═══ Metaverse Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "8103", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "503", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€332K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "937013303", cells: ["MET-6303", "Metaverse Platform Item 1", "24/12/2026", "€13 403"], status: "active" as const },
    { id: "937016874", cells: ["MET-9874", "Metaverse Platform Item 2", "11/7/2026", "€16 974"], status: "pending" as const },
    { id: "937020445", cells: ["MET-4445", "Metaverse Platform Item 3", "26/2/2026", "€20 545"], status: "completed" as const },
    { id: "937024016", cells: ["MET-8016", "Metaverse Platform Item 4", "13/9/2026", "€24 116"], status: "warning" as const },
    { id: "937027587", cells: ["MET-2587", "Metaverse Platform Item 5", "28/4/2026", "€27 687"], status: "active" as const },
];
...
export default function MetaversePlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metaverse Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metaverse Platform</p>
                    </div>
                </div>
