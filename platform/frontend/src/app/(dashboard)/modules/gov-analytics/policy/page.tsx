...
const PAGE = "Policy";
const KPIS = [{"l":"Dashboards Ativos","v":"581","t":"+17.0%","d":"up"},{"l":"Queries/Dia","v":"122","t":"+6.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.203","t":"+12.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.495","t":"-1.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","315","2026-02-12","7.863","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","633","2026-03-06","4.788","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","698","2026-02-28","6.659","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2598","2026-01-12","3.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4909","2026-03-03","3.937","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":565},{"label":"Mar","value":543},{"label":"Abr","value":360},{"label":"Mai","value":542},{"label":"Jun","value":327},{"label":"Jul","value":542},{"label":"Ago","value":304},{"label":"Set","value":418},{"label":"Out","value":459},{"label":"Nov","value":341},{"label":"Dez","value":449}];
const MX = 581;
