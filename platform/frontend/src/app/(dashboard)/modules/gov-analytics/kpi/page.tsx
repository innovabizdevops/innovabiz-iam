...
const PAGE = "KPI";
const KPIS = [{"l":"Dashboards Ativos","v":"7.890","t":"+0.6%","d":"up"},{"l":"Queries/Dia","v":"4119","t":"+4.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.485","t":"-3.5%","d":"down"},{"l":"Utilizadores Analytics","v":"4.312","t":"+15.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3668","2026-01-22","7.590","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1356","2026-02-21","3.764","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","907","2026-02-19","3.841","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3226","2026-01-07","6.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4351","2026-02-17","8.040","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":641},{"label":"Mar","value":672},{"label":"Abr","value":449},{"label":"Mai","value":544},{"label":"Jun","value":470},{"label":"Jul","value":500},{"label":"Ago","value":758},{"label":"Set","value":649},{"label":"Out","value":579},{"label":"Nov","value":457},{"label":"Dez","value":703}];
const MX = 758;
