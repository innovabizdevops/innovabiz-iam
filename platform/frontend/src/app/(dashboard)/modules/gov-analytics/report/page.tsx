...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"8.636","t":"-3.0%","d":"down"},{"l":"Queries/Dia","v":"2082","t":"+11.4%","d":"up"},{"l":"Dados Processados (GB)","v":"929","t":"+14.4%","d":"up"},{"l":"Utilizadores Analytics","v":"6.959","t":"+1.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4283","2026-02-24","4.547","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1924","2026-03-28","5.074","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1831","2026-01-12","1.565","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3299","2026-01-26","2.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2792","2026-03-08","3.829","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":694},{"label":"Mar","value":524},{"label":"Abr","value":501},{"label":"Mai","value":444},{"label":"Jun","value":453},{"label":"Jul","value":493},{"label":"Ago","value":630},{"label":"Set","value":492},{"label":"Out","value":753},{"label":"Nov","value":598},{"label":"Dez","value":616}];
const MX = 753;
