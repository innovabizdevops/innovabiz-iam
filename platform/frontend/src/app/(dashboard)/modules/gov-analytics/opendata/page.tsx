...
const KPIS = [{"l":"Dashboards Ativos","v":"6.012","t":"+15.1%","d":"up"},{"l":"Queries/Dia","v":"4366","t":"+12.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.907","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.082","t":"+16.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1032","2026-02-05","2.305","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4897","2026-02-08","7.353","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4972","2026-02-16","2.210","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","106","2026-03-12","6.926","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","489","2026-01-05","5.875","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":748},{"label":"Mar","value":906},{"label":"Abr","value":616},{"label":"Mai","value":616},{"label":"Jun","value":538},{"label":"Jul","value":869},{"label":"Ago","value":604},{"label":"Set","value":859},{"label":"Out","value":827},{"label":"Nov","value":724},{"label":"Dez","value":866}];
const MX = 906;
