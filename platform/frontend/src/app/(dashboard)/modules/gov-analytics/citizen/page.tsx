...
const ACCENT = "#6366f1";
const MODULE = "Gov Analytics";
const PAGE = "Citizen";
const KPIS = [{"l":"Dashboards Ativos","v":"6.894","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"2864","t":"+1.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.622","t":"+9.8%","d":"up"},{"l":"Utilizadores Analytics","v":"8.838","t":"+11.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2272","2026-02-20","1.029","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3407","2026-02-03","4.931","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2385","2026-01-21","3.963","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3767","2026-02-19","7.782","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","400","2026-01-18","4.213","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":677},{"label":"Mar","value":642},{"label":"Abr","value":491},{"label":"Mai","value":580},{"label":"Jun","value":577},{"label":"Jul","value":546},{"label":"Ago","value":699},{"label":"Set","value":788},{"label":"Out","value":640},{"label":"Nov","value":532},{"label":"Dez","value":688}];
const MX = 788;
