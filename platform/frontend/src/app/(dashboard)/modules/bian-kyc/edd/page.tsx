...
const PAGE = "EDD";
const KPIS = [{"l":"BCP Plans Ativos","v":"867","t":"+1.2%","d":"up"},{"l":"RTO Médio (h)","v":"18h","t":"+7.7%","d":"up"},{"l":"RPO Médio (h)","v":"132h","t":"+16.5%","d":"up"},{"l":"Testes DR (YTD)","v":"5.529","t":"+3.8%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","200h","133h","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","87h","128h","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","53h","107h","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","40h","169h","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","61h","82h","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":396},{"label":"Mar","value":372},{"label":"Abr","value":472},{"label":"Mai","value":435},{"label":"Jun","value":445},{"label":"Jul","value":498},{"label":"Ago","value":426},{"label":"Set","value":672},{"label":"Out","value":675},{"label":"Nov","value":555},{"label":"Dez","value":375}];
const MX = 675;
