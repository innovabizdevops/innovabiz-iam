...
const PAGE = "CDD";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.298","t":"-5.0%","d":"down"},{"l":"RTO Médio (h)","v":"85h","t":"+6.7%","d":"up"},{"l":"RPO Médio (h)","v":"74h","t":"-3.7%","d":"down"},{"l":"Testes DR (YTD)","v":"1.062","t":"+11.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","104h","131h","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","16h","177h","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","17h","121h","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","34h","140h","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","84h","72h","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":656},{"label":"Mar","value":755},{"label":"Abr","value":572},{"label":"Mai","value":775},{"label":"Jun","value":521},{"label":"Jul","value":692},{"label":"Ago","value":690},{"label":"Set","value":894},{"label":"Out","value":729},{"label":"Nov","value":757},{"label":"Dez","value":668}];
const MX = 894;
