...
/* ═══ KYC/AML (BIAN) — Dashboard ═══ */

const ACCENT = "#083344";

const KPIS = [
    { label: "Total Registos", value: "591", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2816", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€48K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "807385091", cells: ["BIA-5091", "KYC/AML (BIAN) Item 1", "24/12/2026", "€35 191"], status: "active" as const },
    { id: "807388662", cells: ["BIA-8662", "KYC/AML (BIAN) Item 2", "11/7/2026", "€38 762"], status: "pending" as const },
    { id: "807392233", cells: ["BIA-3233", "KYC/AML (BIAN) Item 3", "26/2/2026", "€42 333"], status: "completed" as const },
    { id: "807395804", cells: ["BIA-6804", "KYC/AML (BIAN) Item 4", "13/9/2026", "€45 904"], status: "warning" as const },
    { id: "807399375", cells: ["BIA-1375", "KYC/AML (BIAN) Item 5", "28/4/2026", "€49 475"], status: "active" as const },
];
...
export default function KycamlBianPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">KYC/AML (BIAN)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • KYC/AML (BIAN)</p>
                    </div>
                </div>
