...
const ACCENT = "#083344";
const MODULE = "KYC/AML (BIAN)";
const PAGE = "Screening";
const KPIS = [{"l":"BCP Plans Ativos","v":"6.236","t":"-5.8%","d":"down"},{"l":"RTO Médio (h)","v":"79h","t":"+0.2%","d":"up"},{"l":"RPO Médio (h)","v":"154h","t":"+10.0%","d":"up"},{"l":"Testes DR (YTD)","v":"5.065","t":"+12.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","129h","102h","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","80h","198h","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","158h","180h","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","48h","182h","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","93h","179h","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":728},{"label":"Mar","value":475},{"label":"Abr","value":590},{"label":"Mai","value":763},{"label":"Jun","value":870},{"label":"Jul","value":680},{"label":"Ago","value":671},{"label":"Set","value":722},{"label":"Out","value":593},{"label":"Nov","value":805},{"label":"Dez","value":634}];
const MX = 870;
