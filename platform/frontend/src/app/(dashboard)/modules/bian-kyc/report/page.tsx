...
const PAGE = "Report";
const KPIS = [{"l":"BCP Plans Ativos","v":"6.352","t":"+2.0%","d":"up"},{"l":"RTO Médio (h)","v":"118h","t":"-3.3%","d":"down"},{"l":"RPO Médio (h)","v":"198h","t":"+12.3%","d":"up"},{"l":"Testes DR (YTD)","v":"871","t":"+13.7%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","122h","99h","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","103h","147h","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","35h","16h","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","91h","20h","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","90h","31h","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":792},{"label":"Mar","value":924},{"label":"Abr","value":718},{"label":"Mai","value":672},{"label":"Jun","value":781},{"label":"Jul","value":814},{"label":"Ago","value":860},{"label":"Set","value":720},{"label":"Out","value":836},{"label":"Nov","value":789},{"label":"Dez","value":757}];
const MX = 924;
