...
const PAGE = "Monitor";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.369","t":"+5.5%","d":"up"},{"l":"RTO Médio (h)","v":"43h","t":"+5.8%","d":"up"},{"l":"RPO Médio (h)","v":"35h","t":"+16.5%","d":"up"},{"l":"Testes DR (YTD)","v":"2.462","t":"+17.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","44h","50h","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","129h","188h","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","159h","79h","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","196h","107h","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","89h","210h","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":624},{"label":"Mar","value":710},{"label":"Abr","value":681},{"label":"Mai","value":816},{"label":"Jun","value":633},{"label":"Jul","value":897},{"label":"Ago","value":821},{"label":"Set","value":828},{"label":"Out","value":835},{"label":"Nov","value":618},{"label":"Dez","value":862}];
const MX = 897;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#083344'}}>RTM</span></h1>
                </div>
