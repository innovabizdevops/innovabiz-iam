...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"9.088","t":"+14.6%","d":"up"},{"l":"NC Abertas","v":"2.850","t":"+13.4%","d":"up"},{"l":"Conformidade (%)","v":"68.5%","t":"-2.0%","d":"down"},{"l":"CAPAs Pendentes","v":"2.426","t":"+8.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.258","83.6%","8.901","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.438","92.8%","8.802","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.293","99.6%","8.140","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.540","80.4%","6.617","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.866","97.2%","1.887","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":721},{"label":"Mar","value":642},{"label":"Abr","value":841},{"label":"Mai","value":785},{"label":"Jun","value":896},{"label":"Jul","value":834},{"label":"Ago","value":683},{"label":"Set","value":695},{"label":"Out","value":1013},{"label":"Nov","value":782},{"label":"Dez","value":1014}];
const MX = 1014;
