...
/* ═══ Halal Certification — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "6336", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3612", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€266K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2116537136", cells: ["HAL-8136", "Halal Certification Item 1", "1/9/2026", "€37 236"], status: "active" as const },
    { id: "2116540707", cells: ["HAL-2707", "Halal Certification Item 2", "16/4/2026", "€40 807"], status: "pending" as const },
    { id: "2116544278", cells: ["HAL-6278", "Halal Certification Item 3", "3/11/2026", "€44 378"], status: "completed" as const },
    { id: "2116547849", cells: ["HAL-9849", "Halal Certification Item 4", "18/6/2026", "€47 949"], status: "warning" as const },
    { id: "2116551420", cells: ["HAL-4420", "Halal Certification Item 5", "5/1/2026", "€1520"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Halal Certification</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Halal Certification</p>
                    </div>
                </div>
