...
const KPIS = [{"l":"Total Lims Lab","v":"1.937","t":"+7.3%","d":"up"},{"l":"Method Valid Ativos","v":"8.191","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"81","t":"-3.2%","d":"down"}];
const COLS = ["ID","Method Valid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","1.862","8.160","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","1.985","2.359","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","8.673","3.702","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","1.318","9.038","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","3.009","1.510","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":533},{"label":"Mar","value":476},{"label":"Abr","value":715},{"label":"Mai","value":497},{"label":"Jun","value":428},{"label":"Jul","value":627},{"label":"Ago","value":728},{"label":"Set","value":659},{"label":"Out","value":620},{"label":"Nov","value":503},{"label":"Dez","value":708}];
const MX = 774;
