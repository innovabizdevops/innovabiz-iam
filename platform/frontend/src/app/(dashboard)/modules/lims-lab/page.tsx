...
export default function LimsLabPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Lims Lab</h1><p className="text-sm text-muted-foreground">Lims Lab • iBOS Enterprise</p></div>
