...
const ACCENT = "#1e40af";
const MODULE = "LIMS Laboratory";
const PAGE = "Instrument";
const KPIS = [{"l":"Total Lims Lab","v":"2.765","t":"+6.2%","d":"up"},{"l":"Instrument Ativos","v":"230","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"80.1%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"78","t":"+13.5%","d":"up"}];
const COLS = ["ID","Instrument","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","7.545","4.965","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","353","8.771","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","2.333","5.622","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","6.663","8.477","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","6.183","814","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":922},{"label":"Mar","value":871},{"label":"Abr","value":883},{"label":"Mai","value":902},{"label":"Jun","value":736},{"label":"Jul","value":750},{"label":"Ago","value":907},{"label":"Set","value":827},{"label":"Out","value":985},{"label":"Nov","value":779},{"label":"Dez","value":824}];
const MX = 985;
