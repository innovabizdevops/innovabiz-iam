...
const PAGE = "Test Assign";
const KPIS = [{"l":"Total Lims Lab","v":"958","t":"+12.8%","d":"up"},{"l":"Test Assign Ativos","v":"940","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"72","t":"+9.7%","d":"up"}];
const COLS = ["ID","Test Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","7.988","4.264","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","3.869","2.264","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","1.204","5.531","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","1.059","9.008","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","1.956","8.817","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":820},{"label":"Fev","value":743},{"label":"Mar","value":787},{"label":"Abr","value":911},{"label":"Mai","value":929},{"label":"Jun","value":735},{"label":"Jul","value":926},{"label":"Ago","value":851},{"label":"Set","value":717},{"label":"Out","value":967},{"label":"Nov","value":780},{"label":"Dez","value":749}];
const MX = 967;
