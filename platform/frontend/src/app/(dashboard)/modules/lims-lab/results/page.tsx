...
const KPIS = [{"l":"Total Lims Lab","v":"4.167","t":"+12.1%","d":"up"},{"l":"Result Review Ativos","v":"8.319","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"86.6%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+0.5%","d":"up"}];
const COLS = ["ID","Result Review","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","2.780","1.307","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","7.644","3.026","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","6.397","5.207","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","3.120","425","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","6.888","7.981","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":575},{"label":"Mar","value":640},{"label":"Abr","value":596},{"label":"Mai","value":568},{"label":"Jun","value":763},{"label":"Jul","value":653},{"label":"Ago","value":551},{"label":"Set","value":917},{"label":"Out","value":729},{"label":"Nov","value":814},{"label":"Dez","value":871}];
const MX = 917;
