...
const PAGE = "Sample Receive";
const KPIS = [{"l":"Total Lims Lab","v":"7.084","t":"+5.1%","d":"up"},{"l":"Sample Receive Ativos","v":"985","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"60","t":"+5.6%","d":"up"}];
const COLS = ["ID","Sample Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","5.861","5.682","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","6.534","1.790","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","2.815","1.260","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","8.553","4.222","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","992","2.150","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":619},{"label":"Mar","value":577},{"label":"Abr","value":689},{"label":"Mai","value":574},{"label":"Jun","value":542},{"label":"Jul","value":421},{"label":"Ago","value":744},{"label":"Set","value":720},{"label":"Out","value":486},{"label":"Nov","value":575},{"label":"Dez","value":496}];
const MX = 744;
