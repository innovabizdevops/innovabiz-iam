...
const PAGE = "COA Generate";
const KPIS = [{"l":"Total Lims Lab","v":"4.281","t":"-5.9%","d":"down"},{"l":"COA Generate Ativos","v":"1.586","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.3%","d":"up"}];
const COLS = ["ID","COA Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","7.924","8.804","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","3.362","6.216","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","6.133","4.474","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","7.354","5.693","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","6.571","5.784","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":853},{"label":"Mar","value":1076},{"label":"Abr","value":1053},{"label":"Mai","value":975},{"label":"Jun","value":980},{"label":"Jul","value":992},{"label":"Ago","value":817},{"label":"Set","value":724},{"label":"Out","value":973},{"label":"Nov","value":873},{"label":"Dez","value":1072}];
const MX = 1076;
