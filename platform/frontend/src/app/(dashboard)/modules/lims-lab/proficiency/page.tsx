...
const PAGE = "PT Proficiency";
const KPIS = [{"l":"Total Lims Lab","v":"4.606","t":"-1.9%","d":"down"},{"l":"PT Proficiency Ativos","v":"2.719","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"82.7%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"84","t":"+0.4%","d":"up"}];
const COLS = ["ID","PT Proficiency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Lims Lab #001","Lims Lab #002","8.136","6.693","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Lims Lab #002","Lims Lab #003","3.020","7.253","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Lims Lab #003","Lims Lab #004","1.630","927","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Lims Lab #004","Lims Lab #005","5.315","4.804","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Lims Lab #005","Lims Lab #001","795","8.323","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":802},{"label":"Mar","value":916},{"label":"Abr","value":782},{"label":"Mai","value":746},{"label":"Jun","value":672},{"label":"Jul","value":995},{"label":"Ago","value":814},{"label":"Set","value":939},{"label":"Out","value":633},{"label":"Nov","value":965},{"label":"Dez","value":829}];
const MX = 995;
