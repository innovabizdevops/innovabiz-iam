...
/* ═══ Smart City Hub — Citizen Portal ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3399", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "270", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2794", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "538324954", cells: ["SMA-8954", "Citizen Portal Item 1", "7/11/2026", "€25 054"], status: "active" as const },
    { id: "538328525", cells: ["SMA-3525", "Citizen Portal Item 2", "22/6/2026", "€28 625"], status: "pending" as const },
    { id: "538332096", cells: ["SMA-7096", "Citizen Portal Item 3", "9/1/2026", "€32 196"], status: "completed" as const },
    { id: "538335667", cells: ["SMA-1667", "Citizen Portal Item 4", "24/8/2026", "€35 767"], status: "warning" as const },
    { id: "538339238", cells: ["SMA-5238", "Citizen Portal Item 5", "11/3/2026", "€39 338"], status: "active" as const },
];
...
export default function SmartCityHubCitizenPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Citizen Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Citizen Portal</p>
                    </div>
                </div>
