...
/* ═══ Smart City Hub — Urban Planning ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "4807", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "229", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1388", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1839976225", cells: ["SMA-8225", "Urban Planning Item 1", "18/2/2026", "€26 325"], status: "active" as const },
    { id: "1839979796", cells: ["SMA-2796", "Urban Planning Item 2", "5/9/2026", "€29 896"], status: "pending" as const },
    { id: "1839983367", cells: ["SMA-6367", "Urban Planning Item 3", "20/4/2026", "€33 467"], status: "completed" as const },
    { id: "1839986938", cells: ["SMA-9938", "Urban Planning Item 4", "7/11/2026", "€37 038"], status: "warning" as const },
    { id: "1839990509", cells: ["SMA-4509", "Urban Planning Item 5", "22/6/2026", "€40 609"], status: "active" as const },
];
...
export default function SmartCityHubUrbanPlanningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Urban Planning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Urban Planning</p>
                    </div>
                </div>
