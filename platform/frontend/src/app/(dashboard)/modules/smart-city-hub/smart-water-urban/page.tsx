...
/* ═══ Smart City Hub — Smart Water Urban ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1307", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "224", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3411", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "73%", trend: "-9%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "55634076", cells: ["SMA-6076", "Smart Water Urban Item 1", "9/1/2026", "€34 176"], status: "active" as const },
    { id: "55637647", cells: ["SMA-9647", "Smart Water Urban Item 2", "24/8/2026", "€37 747"], status: "pending" as const },
    { id: "55641218", cells: ["SMA-4218", "Smart Water Urban Item 3", "11/3/2026", "€41 318"], status: "completed" as const },
    { id: "55644789", cells: ["SMA-7789", "Smart Water Urban Item 4", "26/10/2026", "€44 889"], status: "warning" as const },
    { id: "55648360", cells: ["SMA-2360", "Smart Water Urban Item 5", "13/5/2026", "€48 460"], status: "active" as const },
];
...
export default function SmartCityHubSmartWaterUrbanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Water Urban</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Smart Water Urban</p>
                    </div>
                </div>
