...
/* ═══ Smart City Hub — Noise Pollution ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1495", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "194", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2383", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2076396078", cells: ["SMA-7078", "Noise Pollution Item 1", "23/7/2026", "€46 178"], status: "active" as const },
    { id: "2076399649", cells: ["SMA-1649", "Noise Pollution Item 2", "10/2/2026", "€49 749"], status: "pending" as const },
    { id: "2076403220", cells: ["SMA-5220", "Noise Pollution Item 3", "25/9/2026", "€3320"], status: "completed" as const },
    { id: "2076406791", cells: ["SMA-8791", "Noise Pollution Item 4", "12/4/2026", "€6891"], status: "warning" as const },
    { id: "2076410362", cells: ["SMA-3362", "Noise Pollution Item 5", "27/11/2026", "€10 462"], status: "active" as const },
];
...
export default function SmartCityHubNoisePollutionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Noise Pollution</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Noise Pollution</p>
                    </div>
                </div>
