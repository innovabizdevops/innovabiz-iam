...
/* ═══ Smart City Hub — Smart Energy Urban ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3149", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "459", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "800", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "98%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "879956551", cells: ["SMA-9551", "Smart Energy Urban Item 1", "20/8/2026", "€6651"], status: "active" as const },
    { id: "879960122", cells: ["SMA-4122", "Smart Energy Urban Item 2", "7/3/2026", "€10 222"], status: "pending" as const },
    { id: "879963693", cells: ["SMA-7693", "Smart Energy Urban Item 3", "22/10/2026", "€13 793"], status: "completed" as const },
    { id: "879967264", cells: ["SMA-2264", "Smart Energy Urban Item 4", "9/5/2026", "€17 364"], status: "warning" as const },
    { id: "879970835", cells: ["SMA-5835", "Smart Energy Urban Item 5", "24/12/2026", "€20 935"], status: "active" as const },
];
...
export default function SmartCityHubSmartEnergyUrbanPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Energy Urban</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Smart Energy Urban</p>
                    </div>
                </div>
