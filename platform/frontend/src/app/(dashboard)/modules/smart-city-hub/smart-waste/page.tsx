...
/* ═══ Smart City Hub — Smart Waste ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1019", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "279", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3758", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "398301683", cells: ["SMA-7683", "Smart Waste Item 1", "4/12/2026", "€1783"], status: "active" as const },
    { id: "398305254", cells: ["SMA-2254", "Smart Waste Item 2", "19/7/2026", "€5354"], status: "pending" as const },
    { id: "398308825", cells: ["SMA-5825", "Smart Waste Item 3", "6/2/2026", "€8925"], status: "completed" as const },
    { id: "398312396", cells: ["SMA-9396", "Smart Waste Item 4", "21/9/2026", "€12 496"], status: "warning" as const },
    { id: "398315967", cells: ["SMA-3967", "Smart Waste Item 5", "8/4/2026", "€16 067"], status: "active" as const },
];
...
export default function SmartCityHubSmartWastePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Waste</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Smart Waste</p>
                    </div>
                </div>
