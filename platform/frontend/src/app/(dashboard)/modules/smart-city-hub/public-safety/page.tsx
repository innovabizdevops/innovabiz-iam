...
/* ═══ Smart City Hub — Public Safety ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "2996", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "449", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "207", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1995396557", cells: ["SMA-7557", "Public Safety Item 1", "22/6/2026", "€46 657"], status: "active" as const },
    { id: "1995400128", cells: ["SMA-2128", "Public Safety Item 2", "9/1/2026", "€228"], status: "pending" as const },
    { id: "1995403699", cells: ["SMA-5699", "Public Safety Item 3", "24/8/2026", "€3799"], status: "completed" as const },
    { id: "1995407270", cells: ["SMA-9270", "Public Safety Item 4", "11/3/2026", "€7370"], status: "warning" as const },
    { id: "1995410841", cells: ["SMA-3841", "Public Safety Item 5", "26/10/2026", "€10 941"], status: "active" as const },
];
...
export default function SmartCityHubPublicSafetyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Public Safety</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Public Safety</p>
                    </div>
                </div>
