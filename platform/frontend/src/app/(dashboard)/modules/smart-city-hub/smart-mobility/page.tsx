...
/* ═══ Smart City Hub — Smart Mobility ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3908", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "444", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3724", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "15425064", cells: ["SMA-9064", "Smart Mobility Item 1", "5/1/2026", "€25 164"], status: "active" as const },
    { id: "15428635", cells: ["SMA-3635", "Smart Mobility Item 2", "20/8/2026", "€28 735"], status: "pending" as const },
    { id: "15432206", cells: ["SMA-7206", "Smart Mobility Item 3", "7/3/2026", "€32 306"], status: "completed" as const },
    { id: "15435777", cells: ["SMA-1777", "Smart Mobility Item 4", "22/10/2026", "€35 877"], status: "warning" as const },
    { id: "15439348", cells: ["SMA-5348", "Smart Mobility Item 5", "9/5/2026", "€39 448"], status: "active" as const },
];
...
export default function SmartCityHubSmartMobilityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Smart Mobility</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Smart Mobility</p>
                    </div>
                </div>
