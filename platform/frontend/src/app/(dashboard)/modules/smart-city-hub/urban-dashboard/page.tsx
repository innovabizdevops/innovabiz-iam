...
/* ═══ Smart City Hub — Urban Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "1187", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "436", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2780", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1959232688", cells: ["SMA-5688", "Urban Dashboard Item 1", "1/9/2026", "€32 788"], status: "active" as const },
    { id: "1959236259", cells: ["SMA-9259", "Urban Dashboard Item 2", "16/4/2026", "€36 359"], status: "pending" as const },
    { id: "1959239830", cells: ["SMA-3830", "Urban Dashboard Item 3", "3/11/2026", "€39 930"], status: "completed" as const },
    { id: "1959243401", cells: ["SMA-7401", "Urban Dashboard Item 4", "18/6/2026", "€43 501"], status: "warning" as const },
    { id: "1959246972", cells: ["SMA-1972", "Urban Dashboard Item 5", "5/1/2026", "€47 072"], status: "active" as const },
];
...
export default function SmartCityHubUrbanDashboardPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Urban Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Urban Dashboard</p>
                    </div>
                </div>
