...
/* ═══ Smart City Hub — Open Data Portal ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total", value: "3631", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "210", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2918", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1726014750", cells: ["SMA-4750", "Open Data Portal Item 1", "27/7/2026", "€14 850"], status: "active" as const },
    { id: "1726018321", cells: ["SMA-8321", "Open Data Portal Item 2", "14/2/2026", "€18 421"], status: "pending" as const },
    { id: "1726021892", cells: ["SMA-2892", "Open Data Portal Item 3", "1/9/2026", "€21 992"], status: "completed" as const },
    { id: "1726025463", cells: ["SMA-6463", "Open Data Portal Item 4", "16/4/2026", "€25 563"], status: "warning" as const },
    { id: "1726029034", cells: ["SMA-1034", "Open Data Portal Item 5", "3/11/2026", "€29 134"], status: "active" as const },
];
...
export default function SmartCityHubOpenDataPortalPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Open Data Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Smart City Hub • Open Data Portal</p>
                    </div>
                </div>
