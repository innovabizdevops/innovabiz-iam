...
const PAGE = "AI Triage";
const KPIS = [{"l":"Integrações Ativas","v":"8.959","t":"-3.1%","d":"down"},{"l":"Chamadas/Hora","v":"3874","t":"+3.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.1%","t":"+6.6%","d":"up"},{"l":"Latência Média (ms)","v":"36ms","t":"+3.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.728","7.540","76.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.055","2.478","97.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.508","7.811","79.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","954","3.632","80.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.239","2.741","86.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":791},{"label":"Mar","value":566},{"label":"Abr","value":780},{"label":"Mai","value":637},{"label":"Jun","value":478},{"label":"Jul","value":517},{"label":"Ago","value":782},{"label":"Set","value":569},{"label":"Out","value":507},{"label":"Nov","value":487},{"label":"Dez","value":465}];
const MX = 791;
