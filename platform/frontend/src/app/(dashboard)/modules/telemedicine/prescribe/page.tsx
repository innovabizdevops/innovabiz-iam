...
const KPIS = [{"l":"Integrações Ativas","v":"2.616","t":"+5.7%","d":"up"},{"l":"Chamadas/Hora","v":"4486","t":"+8.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.2%","t":"+5.8%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"+17.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.220","2.979","78.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.635","1.944","87.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.829","4.796","87.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","739","8.580","75.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.915","2.216","93.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":535},{"label":"Mar","value":721},{"label":"Abr","value":703},{"label":"Mai","value":805},{"label":"Jun","value":617},{"label":"Jul","value":569},{"label":"Ago","value":595},{"label":"Set","value":723},{"label":"Out","value":893},{"label":"Nov","value":892},{"label":"Dez","value":888}];
const MX = 893;
