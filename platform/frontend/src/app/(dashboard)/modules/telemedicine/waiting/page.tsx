...
const PAGE = "Waiting Room";
const KPIS = [{"l":"Integrações Ativas","v":"1.815","t":"+2.0%","d":"up"},{"l":"Chamadas/Hora","v":"1554","t":"+3.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.9%","t":"+6.0%","d":"up"},{"l":"Latência Média (ms)","v":"116ms","t":"+15.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.743","5.566","95.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","984","7.149","75.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.780","8.685","86.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.363","559","84.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.987","6.395","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":824},{"label":"Mar","value":900},{"label":"Abr","value":807},{"label":"Mai","value":887},{"label":"Jun","value":764},{"label":"Jul","value":711},{"label":"Ago","value":728},{"label":"Set","value":1036},{"label":"Out","value":823},{"label":"Nov","value":979},{"label":"Dez","value":931}];
const MX = 1036;
