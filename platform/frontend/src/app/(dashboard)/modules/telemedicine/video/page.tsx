...
const PAGE = "Video Consult";
const KPIS = [{"l":"Integrações Ativas","v":"2.825","t":"+1.2%","d":"up"},{"l":"Chamadas/Hora","v":"3296","t":"+1.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.2%","t":"+1.0%","d":"up"},{"l":"Latência Média (ms)","v":"142ms","t":"+15.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.346","6.684","96.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.308","2.436","97.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.999","7.653","99.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.961","4.848","93.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.846","5.354","76.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":349},{"label":"Fev","value":522},{"label":"Mar","value":255},{"label":"Abr","value":384},{"label":"Mai","value":435},{"label":"Jun","value":402},{"label":"Jul","value":432},{"label":"Ago","value":549},{"label":"Set","value":593},{"label":"Out","value":412},{"label":"Nov","value":244},{"label":"Dez","value":513}];
const MX = 593;
