...
const KPIS = [{"l":"Integrações Ativas","v":"139","t":"+17.9%","d":"up"},{"l":"Chamadas/Hora","v":"2124","t":"+8.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.6%","t":"-4.9%","d":"down"},{"l":"Latência Média (ms)","v":"63ms","t":"+12.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.198","6.707","90.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.311","2.781","73.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.731","4.968","77.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.010","8.724","73.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.982","5.327","99.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":411},{"label":"Mar","value":618},{"label":"Abr","value":434},{"label":"Mai","value":322},{"label":"Jun","value":495},{"label":"Jul","value":381},{"label":"Ago","value":502},{"label":"Set","value":389},{"label":"Out","value":674},{"label":"Nov","value":368},{"label":"Dez","value":640}];
const MX = 674;
