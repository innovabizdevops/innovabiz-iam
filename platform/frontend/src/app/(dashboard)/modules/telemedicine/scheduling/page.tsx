...
const KPIS = [{"l":"eNPS","v":"81","t":"+0.1%","d":"up"},{"l":"Engagement (%)","v":"93.1%","t":"-0.7%","d":"down"},{"l":"Turnover (%)","v":"82.8%","t":"+15.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.984","t":"+15.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.722","2026-01-10","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.537","2026-02-05","74","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.489","2026-03-27","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.851","2026-03-03","88","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.500","2026-02-07","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":743},{"label":"Mar","value":783},{"label":"Abr","value":607},{"label":"Mai","value":517},{"label":"Jun","value":592},{"label":"Jul","value":593},{"label":"Ago","value":544},{"label":"Set","value":557},{"label":"Out","value":839},{"label":"Nov","value":524},{"label":"Dez","value":521}];
const MX = 839;
