...
const ACCENT = "#0e7490";
const MODULE = "Telemedicine";
const PAGE = "RPM Devices";
const KPIS = [{"l":"Dispositivos Online","v":"6.705","t":"+9.5%","d":"up"},{"l":"Dados/Min (MB)","v":"5.975","t":"+1.6%","d":"up"},{"l":"Alertas Ativos","v":"6.004","t":"+12.4%","d":"up"},{"l":"Uptime (%)","v":"65.6%","t":"+4.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.205","726","1.590","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.552","4.026","6.654","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.360","634","7.913","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.780","5.878","3.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.364","2.152","2.741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":528},{"label":"Mar","value":521},{"label":"Abr","value":524},{"label":"Mai","value":713},{"label":"Jun","value":509},{"label":"Jul","value":619},{"label":"Ago","value":542},{"label":"Set","value":473},{"label":"Out","value":727},{"label":"Nov","value":711},{"label":"Dez","value":623}];
const MX = 727;
