...
const PAGE = "Print Queue";
const KPIS = [{"l":"Total Additive Mfg","v":"179","t":"+3.9%","d":"up"},{"l":"Print Queue Ativos","v":"8.506","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"68.6%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"90","t":"-1.1%","d":"down"}];
const COLS = ["ID","Print Queue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Additive Mfg #001","Additive Mfg #002","3.654","5.211","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Additive Mfg #002","Additive Mfg #003","4.399","2.071","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Additive Mfg #003","Additive Mfg #004","1.125","5.385","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Additive Mfg #004","Additive Mfg #005","713","7.463","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Additive Mfg #005","Additive Mfg #001","5.138","1.932","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":585},{"label":"Mar","value":738},{"label":"Abr","value":786},{"label":"Mai","value":690},{"label":"Jun","value":775},{"label":"Jul","value":496},{"label":"Ago","value":435},{"label":"Set","value":574},{"label":"Out","value":809},{"label":"Nov","value":822},{"label":"Dez","value":726}];
const MX = 822;
