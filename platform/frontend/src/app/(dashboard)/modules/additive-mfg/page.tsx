...
export default function AdditiveMfgPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Additive Mfg</h1><p className="text-sm text-muted-foreground">Additive Mfg • iBOS Enterprise</p></div>
