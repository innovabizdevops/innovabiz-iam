...
const KPIS = [{"l":"Total Additive Mfg","v":"7.911","t":"+12.3%","d":"up"},{"l":"Material Select Ativos","v":"2.807","t":"-4.9%","d":"down"},{"l":"Eficiência (%)","v":"72.0%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"64","t":"-0.6%","d":"down"}];
const COLS = ["ID","Material Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Additive Mfg #001","Additive Mfg #002","2.975","3.474","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Additive Mfg #002","Additive Mfg #003","5.572","7.519","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Additive Mfg #003","Additive Mfg #004","8.061","1.831","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Additive Mfg #004","Additive Mfg #005","1.926","2.675","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Additive Mfg #005","Additive Mfg #001","8.846","1.784","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":946},{"label":"Mar","value":897},{"label":"Abr","value":707},{"label":"Mai","value":815},{"label":"Jun","value":878},{"label":"Jul","value":811},{"label":"Ago","value":832},{"label":"Set","value":799},{"label":"Out","value":960},{"label":"Nov","value":655},{"label":"Dez","value":1004}];
const MX = 1004;
