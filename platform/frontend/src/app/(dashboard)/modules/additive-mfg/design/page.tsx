...
const ACCENT = "#3c5a7f";
const MODULE = "Additive Manufacturing";
const PAGE = "Part Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.318","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"215","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"2.381","t":"-4.3%","d":"down"},{"l":"Templates","v":"2.338","t":"+10.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.431","2026-03-23","1.223","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.756","2026-01-10","2.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.018","2026-01-26","926","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.620","2026-03-19","466","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.354","2026-02-13","3.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1061},{"label":"Fev","value":886},{"label":"Mar","value":1085},{"label":"Abr","value":1017},{"label":"Mai","value":733},{"label":"Jun","value":812},{"label":"Jul","value":907},{"label":"Ago","value":1092},{"label":"Set","value":744},{"label":"Out","value":919},{"label":"Nov","value":1019},{"label":"Dez","value":1040}];
const MX = 1092;
