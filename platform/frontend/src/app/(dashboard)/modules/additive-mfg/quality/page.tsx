...
const PAGE = "Quality Inspect";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.144","t":"+9.3%","d":"up"},{"l":"NC Abertas","v":"6.564","t":"+10.8%","d":"up"},{"l":"Conformidade (%)","v":"75.6%","t":"+3.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.289","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.425","89.8%","7.664","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.420","83.7%","1.258","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.871","95.6%","5.055","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.021","88.5%","3.493","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.929","72.2%","4.903","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":799},{"label":"Mar","value":614},{"label":"Abr","value":555},{"label":"Mai","value":878},{"label":"Jun","value":579},{"label":"Jul","value":678},{"label":"Ago","value":725},{"label":"Set","value":619},{"label":"Out","value":824},{"label":"Nov","value":760},{"label":"Dez","value":676}];
const MX = 878;
