...
/* ═══ K-9 Security — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "1838", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2854", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€160K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "634987738", cells: ["K9-2738", "K-9 Security Item 1", "15/11/2026", "€37 838"], status: "active" as const },
    { id: "634991309", cells: ["K9-6309", "K-9 Security Item 2", "2/6/2026", "€41 409"], status: "pending" as const },
    { id: "634994880", cells: ["K9-9880", "K-9 Security Item 3", "17/1/2026", "€44 980"], status: "completed" as const },
    { id: "634998451", cells: ["K9-4451", "K-9 Security Item 4", "4/8/2026", "€48 551"], status: "warning" as const },
    { id: "635002022", cells: ["K9-8022", "K-9 Security Item 5", "19/3/2026", "€2122"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">K-9 Security</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • K-9 Security</p>
                    </div>
                </div>
