...
const PAGE = "Handler";
const KPIS = [{"l":"Total K9 Security","v":"6.474","t":"+2.4%","d":"up"},{"l":"Handler Ativos","v":"234","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"78.0%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"63","t":"+15.8%","d":"up"}];
const COLS = ["ID","Handler","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K9 Security #001","K9 Security #002","8.804","5.627","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["K9 Security #002","K9 Security #003","1.031","2.556","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["K9 Security #003","K9 Security #004","3.765","7.623","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["K9 Security #004","K9 Security #005","7.979","1.601","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["K9 Security #005","K9 Security #001","4.626","213","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":446},{"label":"Mar","value":405},{"label":"Abr","value":569},{"label":"Mai","value":550},{"label":"Jun","value":469},{"label":"Jul","value":655},{"label":"Ago","value":355},{"label":"Set","value":568},{"label":"Out","value":647},{"label":"Nov","value":591},{"label":"Dez","value":543}];
const MX = 655;
