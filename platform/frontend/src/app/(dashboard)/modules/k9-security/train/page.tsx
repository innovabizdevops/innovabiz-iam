...
const ACCENT = "#475569";
const MODULE = "K-9 Security";
const PAGE = "Train";
const KPIS = [{"l":"Total K9 Security","v":"7.446","t":"-0.9%","d":"down"},{"l":"Train Ativos","v":"6.402","t":"+14.3%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+7.4%","d":"up"}];
const COLS = ["ID","Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K9 Security #001","K9 Security #002","3.101","5.871","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["K9 Security #002","K9 Security #003","4.153","6.228","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["K9 Security #003","K9 Security #004","5.466","7.961","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["K9 Security #004","K9 Security #005","4.129","8.521","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["K9 Security #005","K9 Security #001","2.624","3.932","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":787},{"label":"Mar","value":721},{"label":"Abr","value":728},{"label":"Mai","value":604},{"label":"Jun","value":778},{"label":"Jul","value":447},{"label":"Ago","value":537},{"label":"Set","value":582},{"label":"Out","value":680},{"label":"Nov","value":715},{"label":"Dez","value":774}];
const MX = 787;
