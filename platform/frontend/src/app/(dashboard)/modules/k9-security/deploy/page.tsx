...
const PAGE = "Deploy";
const KPIS = [{"l":"Total K9 Security","v":"8.960","t":"-3.2%","d":"down"},{"l":"Deploy Ativos","v":"2.120","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+13.4%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["K9 Security #001","K9 Security #002","904","802","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["K9 Security #002","K9 Security #003","8.873","4.668","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["K9 Security #003","K9 Security #004","6.702","3.404","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["K9 Security #004","K9 Security #005","8.509","7.635","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["K9 Security #005","K9 Security #001","5.812","4.922","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":567},{"label":"Mar","value":610},{"label":"Abr","value":453},{"label":"Mai","value":706},{"label":"Jun","value":446},{"label":"Jul","value":449},{"label":"Ago","value":679},{"label":"Set","value":759},{"label":"Out","value":548},{"label":"Nov","value":620},{"label":"Dez","value":592}];
const MX = 809;
