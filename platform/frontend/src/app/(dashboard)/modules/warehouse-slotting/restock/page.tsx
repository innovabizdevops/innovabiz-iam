...
const PAGE = "Restock";
const KPIS = [{"l":"Total Warehouse Slotting","v":"4.509","t":"-0.9%","d":"down"},{"l":"Restock Ativos","v":"2.331","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+9.3%","d":"up"}];
const COLS = ["ID","Restock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Slotting #001","Warehouse Slotting #002","7.527","5.800","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Slotting #002","Warehouse Slotting #003","4.051","5.934","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Slotting #003","Warehouse Slotting #004","7.017","6.239","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Slotting #004","Warehouse Slotting #005","3.656","7.917","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Slotting #005","Warehouse Slotting #001","2.915","5.004","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":500},{"label":"Mar","value":800},{"label":"Abr","value":868},{"label":"Mai","value":740},{"label":"Jun","value":810},{"label":"Jul","value":629},{"label":"Ago","value":505},{"label":"Set","value":682},{"label":"Out","value":660},{"label":"Nov","value":831},{"label":"Dez","value":586}];
const MX = 868;
