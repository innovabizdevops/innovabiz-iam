...
const PAGE = "ABC Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"166","t":"+6.9%","d":"up"},{"l":"Queries/Dia","v":"1827","t":"-4.4%","d":"down"},{"l":"Dados Processados (GB)","v":"1.632","t":"+16.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.354","t":"-2.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4313","2026-02-28","8.746","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2508","2026-03-19","7.428","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3406","2026-01-05","8.855","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","810","2026-03-03","6.148","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1610","2026-02-19","6.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":771},{"label":"Mar","value":626},{"label":"Abr","value":503},{"label":"Mai","value":483},{"label":"Jun","value":526},{"label":"Jul","value":437},{"label":"Ago","value":664},{"label":"Set","value":717},{"label":"Out","value":791},{"label":"Nov","value":402},{"label":"Dez","value":620}];
const MX = 791;
