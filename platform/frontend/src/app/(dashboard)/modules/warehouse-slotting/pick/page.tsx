...
const ACCENT = "#6366f1";
const MODULE = "Warehouse Slotting";
const PAGE = "Pick Path";
const KPIS = [{"l":"Total Warehouse Slotting","v":"295","t":"+11.6%","d":"up"},{"l":"Pick Path Ativos","v":"9.050","t":"-1.5%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"80","t":"-0.1%","d":"down"}];
const COLS = ["ID","Pick Path","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Slotting #001","Warehouse Slotting #002","3.144","2.434","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Slotting #002","Warehouse Slotting #003","2.813","7.457","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Slotting #003","Warehouse Slotting #004","8.453","2.677","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Slotting #004","Warehouse Slotting #005","910","5.542","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Slotting #005","Warehouse Slotting #001","419","5.250","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":532},{"label":"Mar","value":766},{"label":"Abr","value":741},{"label":"Mai","value":674},{"label":"Jun","value":581},{"label":"Jul","value":534},{"label":"Ago","value":479},{"label":"Set","value":482},{"label":"Out","value":560},{"label":"Nov","value":697},{"label":"Dez","value":644}];
const MX = 766;
