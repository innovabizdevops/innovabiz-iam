...
const PAGE = "Seasonal";
const KPIS = [{"l":"Total Warehouse Slotting","v":"333","t":"+9.2%","d":"up"},{"l":"Seasonal Ativos","v":"487","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"92","t":"+0.5%","d":"up"}];
const COLS = ["ID","Seasonal","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Slotting #001","Warehouse Slotting #002","2.216","6.144","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Slotting #002","Warehouse Slotting #003","959","6.884","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Slotting #003","Warehouse Slotting #004","4.366","8.654","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Slotting #004","Warehouse Slotting #005","5.049","3.371","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Slotting #005","Warehouse Slotting #001","4.905","7.584","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":601},{"label":"Mar","value":659},{"label":"Abr","value":643},{"label":"Mai","value":811},{"label":"Jun","value":659},{"label":"Jul","value":878},{"label":"Ago","value":621},{"label":"Set","value":868},{"label":"Out","value":807},{"label":"Nov","value":828},{"label":"Dez","value":897}];
const MX = 947;
