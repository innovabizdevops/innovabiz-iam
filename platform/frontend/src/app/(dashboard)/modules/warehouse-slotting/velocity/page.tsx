...
const PAGE = "Velocity";
const KPIS = [{"l":"Total Warehouse Slotting","v":"8.593","t":"+16.3%","d":"up"},{"l":"Velocity Ativos","v":"5.561","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+4.7%","d":"up"},{"l":"Score Performance","v":"66","t":"-5.5%","d":"down"}];
const COLS = ["ID","Velocity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Slotting #001","Warehouse Slotting #002","677","492","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Slotting #002","Warehouse Slotting #003","2.741","1.674","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Slotting #003","Warehouse Slotting #004","4.044","6.195","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Slotting #004","Warehouse Slotting #005","997","3.719","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Slotting #005","Warehouse Slotting #001","6.664","8.303","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":445},{"label":"Mar","value":383},{"label":"Abr","value":615},{"label":"Mai","value":737},{"label":"Jun","value":421},{"label":"Jul","value":359},{"label":"Ago","value":397},{"label":"Set","value":439},{"label":"Out","value":619},{"label":"Nov","value":750},{"label":"Dez","value":565}];
const MX = 750;
