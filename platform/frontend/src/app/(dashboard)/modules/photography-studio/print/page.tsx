...
const PAGE = "Print";
const KPIS = [{"l":"Total Photography Studio","v":"3.819","t":"+5.0%","d":"up"},{"l":"Print Ativos","v":"2.555","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"67.8%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"64","t":"-4.8%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photography Studio #001","Photography Studio #002","5.337","7.110","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Photography Studio #002","Photography Studio #003","7.021","7.042","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Photography Studio #003","Photography Studio #004","6.914","3.692","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Photography Studio #004","Photography Studio #005","2.934","5.470","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photography Studio #005","Photography Studio #001","7.558","3.351","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":942},{"label":"Fev","value":890},{"label":"Mar","value":656},{"label":"Abr","value":772},{"label":"Mai","value":717},{"label":"Jun","value":602},{"label":"Jul","value":845},{"label":"Ago","value":641},{"label":"Set","value":815},{"label":"Out","value":823},{"label":"Nov","value":709},{"label":"Dez","value":827}];
const MX = 942;
