...
const KPIS = [
    { label: "Total Registos", value: "2749", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4086", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1893981549", cells: ["PHO-4549", "Photography Studio Item 1", "6/10/2026", "€31 649"], status: "active" as const },
    { id: "1893985120", cells: ["PHO-8120", "Photography Studio Item 2", "21/5/2026", "€35 220"], status: "pending" as const },
    { id: "1893988691", cells: ["PHO-2691", "Photography Studio Item 3", "8/12/2026", "€38 791"], status: "completed" as const },
    { id: "1893992262", cells: ["PHO-6262", "Photography Studio Item 4", "23/7/2026", "€42 362"], status: "warning" as const },
    { id: "1893995833", cells: ["PHO-9833", "Photography Studio Item 5", "10/2/2026", "€45 933"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Photography Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Photography Studio</p>
                    </div>
                </div>
