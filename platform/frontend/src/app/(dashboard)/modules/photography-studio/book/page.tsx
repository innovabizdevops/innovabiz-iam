...
const PAGE = "Book";
const KPIS = [{"l":"Total Photography Studio","v":"726","t":"-0.1%","d":"down"},{"l":"Book Ativos","v":"2.964","t":"+17.7%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"74","t":"+7.1%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photography Studio #001","Photography Studio #002","3.714","2.555","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Photography Studio #002","Photography Studio #003","3.740","6.742","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Photography Studio #003","Photography Studio #004","1.672","2.165","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Photography Studio #004","Photography Studio #005","5.218","8.134","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photography Studio #005","Photography Studio #001","8.207","2.185","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":710},{"label":"Mar","value":913},{"label":"Abr","value":743},{"label":"Mai","value":763},{"label":"Jun","value":893},{"label":"Jul","value":719},{"label":"Ago","value":592},{"label":"Set","value":754},{"label":"Out","value":634},{"label":"Nov","value":648},{"label":"Dez","value":714}];
const MX = 913;
