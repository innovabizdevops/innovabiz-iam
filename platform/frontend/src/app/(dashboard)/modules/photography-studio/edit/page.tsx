...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"5.595","t":"+11.2%","d":"up"},{"l":"Chamadas/Hora","v":"3651","t":"+5.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"89.9%","t":"+15.9%","d":"up"},{"l":"Latência Média (ms)","v":"67ms","t":"+15.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.955","3.234","81.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.534","2.084","90.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.640","7.457","94.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.323","8.374","89.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.982","6.673","74.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":613},{"label":"Mar","value":520},{"label":"Abr","value":497},{"label":"Mai","value":437},{"label":"Jun","value":363},{"label":"Jul","value":640},{"label":"Ago","value":578},{"label":"Set","value":433},{"label":"Out","value":656},{"label":"Nov","value":373},{"label":"Dez","value":646}];
const MX = 656;
