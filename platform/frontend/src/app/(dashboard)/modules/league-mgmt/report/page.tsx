...
const PAGE = "Report";
const KPIS = [{"l":"Atletas Registados","v":"7.699","t":"+0.8%","d":"up"},{"l":"Treinos/Semana","v":"3643","t":"+8.7%","d":"up"},{"l":"Competições","v":"4.219","t":"+6.6%","d":"up"},{"l":"Performance Score","v":"94","t":"+16.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.222","5.334","4.922","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.137","2.673","3.294","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.243","5.663","3.242","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.935","7.455","122","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.889","337","1.056","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":495},{"label":"Mar","value":705},{"label":"Abr","value":791},{"label":"Mai","value":712},{"label":"Jun","value":456},{"label":"Jul","value":684},{"label":"Ago","value":761},{"label":"Set","value":606},{"label":"Out","value":792},{"label":"Nov","value":792},{"label":"Dez","value":662}];
const MX = 792;
