...
/* ═══ League & Association Mgmt — Dashboard ═══ */

const ACCENT = "#b91c1c";

const KPIS = [
    { label: "Total Registos", value: "3550", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3059", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€143K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1773380550", cells: ["LEA-3550", "League & Association Mgmt Item 1", "19/7/2026", "€30 650"], status: "active" as const },
    { id: "1773384121", cells: ["LEA-7121", "League & Association Mgmt Item 2", "6/2/2026", "€34 221"], status: "pending" as const },
    { id: "1773387692", cells: ["LEA-1692", "League & Association Mgmt Item 3", "21/9/2026", "€37 792"], status: "completed" as const },
    { id: "1773391263", cells: ["LEA-5263", "League & Association Mgmt Item 4", "8/4/2026", "€41 363"], status: "warning" as const },
    { id: "1773394834", cells: ["LEA-8834", "League & Association Mgmt Item 5", "23/11/2026", "€44 934"], status: "active" as const },
];
...
export default function LeagueAssociationMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">League & Association Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • League & Association Mgmt</p>
                    </div>
                </div>
