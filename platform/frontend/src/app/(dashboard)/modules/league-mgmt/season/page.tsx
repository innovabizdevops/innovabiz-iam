...
const PAGE = "Season";
const KPIS = [{"l":"Atletas Registados","v":"8.341","t":"+8.4%","d":"up"},{"l":"Treinos/Semana","v":"2571","t":"+5.4%","d":"up"},{"l":"Competições","v":"8.488","t":"+1.0%","d":"up"},{"l":"Performance Score","v":"64","t":"+12.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.680","4.675","7.749","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.533","5.428","9.044","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.371","1.771","2.806","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.936","6.017","6.190","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.906","8.967","1.453","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":609},{"label":"Mar","value":231},{"label":"Abr","value":609},{"label":"Mai","value":221},{"label":"Jun","value":368},{"label":"Jul","value":239},{"label":"Ago","value":612},{"label":"Set","value":440},{"label":"Out","value":292},{"label":"Nov","value":428},{"label":"Dez","value":473}];
const MX = 612;
