...
const ACCENT = "#b91c1c";
const MODULE = "League & Association Mgmt";
const PAGE = "Schedule";
const KPIS = [{"l":"Atletas Registados","v":"3.170","t":"+10.1%","d":"up"},{"l":"Treinos/Semana","v":"1655","t":"+4.8%","d":"up"},{"l":"Competições","v":"7.290","t":"+5.6%","d":"up"},{"l":"Performance Score","v":"77","t":"+0.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.649","1.817","5.527","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.551","5.706","3.738","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","527","3.498","6.317","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.240","3.356","4.210","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.180","7.158","3.107","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":840},{"label":"Mar","value":909},{"label":"Abr","value":786},{"label":"Mai","value":914},{"label":"Jun","value":840},{"label":"Jul","value":806},{"label":"Ago","value":530},{"label":"Set","value":655},{"label":"Out","value":835},{"label":"Nov","value":861},{"label":"Dez","value":634}];
const MX = 914;
