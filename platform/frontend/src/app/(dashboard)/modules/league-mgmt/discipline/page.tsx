...
const KPIS = [{"l":"Atletas Registados","v":"1.630","t":"+11.0%","d":"up"},{"l":"Treinos/Semana","v":"5054","t":"+11.7%","d":"up"},{"l":"Competições","v":"3.799","t":"+16.4%","d":"up"},{"l":"Performance Score","v":"69","t":"+17.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.784","6.927","3.994","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.891","3.337","5.466","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","636","2.608","4.861","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.522","3.667","8.959","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.226","3.216","3.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":755},{"label":"Mar","value":662},{"label":"Abr","value":657},{"label":"Mai","value":530},{"label":"Jun","value":690},{"label":"Jul","value":783},{"label":"Ago","value":762},{"label":"Set","value":471},{"label":"Out","value":718},{"label":"Nov","value":483},{"label":"Dez","value":795}];
const MX = 795;
