...
const PAGE = "Officials";
const KPIS = [{"l":"Atletas Registados","v":"2.345","t":"-1.6%","d":"down"},{"l":"Treinos/Semana","v":"848","t":"+7.9%","d":"up"},{"l":"Competições","v":"4.020","t":"-5.3%","d":"down"},{"l":"Performance Score","v":"83","t":"+4.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.450","8.624","1.718","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.259","2.645","4.292","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.810","7.976","5.768","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.502","8.277","6.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","507","8.550","2.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":938},{"label":"Fev","value":884},{"label":"Mar","value":854},{"label":"Abr","value":633},{"label":"Mai","value":759},{"label":"Jun","value":922},{"label":"Jul","value":649},{"label":"Ago","value":1007},{"label":"Set","value":807},{"label":"Out","value":825},{"label":"Nov","value":927},{"label":"Dez","value":672}];
const MX = 1007;
