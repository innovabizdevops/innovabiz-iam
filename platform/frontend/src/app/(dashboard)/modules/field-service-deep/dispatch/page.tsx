...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"6.736","t":"-0.4%","d":"down"},{"l":"Viagens/Dia","v":"842","t":"-1.1%","d":"down"},{"l":"Pontualidade (%)","v":"87.2%","t":"+2.9%","d":"up"},{"l":"Passageiros/Dia","v":"603","t":"-4.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-23","2026-01-02","3.951","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-06","2026-01-19","4.291","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-19","2026-02-05","3.975","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-11","2026-03-10","6.262","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-04","2026-01-24","4.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":780},{"label":"Mar","value":574},{"label":"Abr","value":613},{"label":"Mai","value":591},{"label":"Jun","value":837},{"label":"Jul","value":741},{"label":"Ago","value":876},{"label":"Set","value":704},{"label":"Out","value":801},{"label":"Nov","value":598},{"label":"Dez","value":922}];
const MX = 922;
