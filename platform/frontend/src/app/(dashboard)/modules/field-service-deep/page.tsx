...
/* ═══ Field Service Deep (APQC 5.3) — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "8738", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2284", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€254K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "268734238", cells: ["FIE-4238", "Field Service Deep (APQC 5.3) Item 1", "11/11/2026", "€34 338"], status: "active" as const },
    { id: "268737809", cells: ["FIE-7809", "Field Service Deep (APQC 5.3) Item 2", "26/6/2026", "€37 909"], status: "pending" as const },
    { id: "268741380", cells: ["FIE-2380", "Field Service Deep (APQC 5.3) Item 3", "13/1/2026", "€41 480"], status: "completed" as const },
    { id: "268744951", cells: ["FIE-5951", "Field Service Deep (APQC 5.3) Item 4", "28/8/2026", "€45 051"], status: "warning" as const },
    { id: "268748522", cells: ["FIE-9522", "Field Service Deep (APQC 5.3) Item 5", "15/3/2026", "€48 622"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 98 }, { label: "Fev", value: 27 }, { label: "Mar", value: 36 }, { label: "Abr", value: 45 }, { label: "Mai", value: 54 }, { label: "Jun", value: 63 }];
...
export default function FieldServiceDeepApqc53Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Field Service Deep (APQC 5.3)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Field Service Deep (APQC 5.3)</p>
                    </div>
                </div>
