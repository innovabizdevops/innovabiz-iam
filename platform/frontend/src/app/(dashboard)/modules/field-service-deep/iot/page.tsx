...
const PAGE = "IoT";
const KPIS = [{"l":"Dispositivos Online","v":"1.893","t":"+17.6%","d":"up"},{"l":"Dados/Min (MB)","v":"1.866","t":"+7.4%","d":"up"},{"l":"Alertas Ativos","v":"4.744","t":"+9.1%","d":"up"},{"l":"Uptime (%)","v":"71.4%","t":"+6.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.867","2.762","6.247","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.998","8.981","7.760","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.419","856","5.514","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.642","2.789","7.453","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","119","4.162","3.792","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":739},{"label":"Mar","value":624},{"label":"Abr","value":728},{"label":"Mai","value":849},{"label":"Jun","value":922},{"label":"Jul","value":961},{"label":"Ago","value":752},{"label":"Set","value":911},{"label":"Out","value":963},{"label":"Nov","value":976},{"label":"Dez","value":839}];
const MX = 976;
