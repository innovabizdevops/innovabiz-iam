...
const ACCENT = "#059669";
const MODULE = "Field Service Deep (APQC 5.3)";
const PAGE = "Schedule";
const KPIS = [{"l":"Total Field Service Deep","v":"4.574","t":"+0.0%","d":"up"},{"l":"Schedule Ativos","v":"196","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+10.2%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Field Service Deep #001","Field Service Deep #002","8.979","2.931","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Field Service Deep #002","Field Service Deep #003","6.601","5.875","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Field Service Deep #003","Field Service Deep #004","6.087","8.959","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Field Service Deep #004","Field Service Deep #005","2.003","846","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Field Service Deep #005","Field Service Deep #001","7.610","1.650","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1011},{"label":"Fev","value":806},{"label":"Mar","value":962},{"label":"Abr","value":766},{"label":"Mai","value":956},{"label":"Jun","value":715},{"label":"Jul","value":1055},{"label":"Ago","value":1069},{"label":"Set","value":744},{"label":"Out","value":782},{"label":"Nov","value":798},{"label":"Dez","value":832}];
const MX = 1069;
