...
/* ═══ Franchise Training — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "9103", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2727", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2082127503", cells: ["FRA-5503", "Franchise Training Item 1", "16/4/2026", "€27 603"], status: "active" as const },
    { id: "2082131074", cells: ["FRA-9074", "Franchise Training Item 2", "3/11/2026", "€31 174"], status: "pending" as const },
    { id: "2082134645", cells: ["FRA-3645", "Franchise Training Item 3", "18/6/2026", "€34 745"], status: "completed" as const },
    { id: "2082138216", cells: ["FRA-7216", "Franchise Training Item 4", "5/1/2026", "€38 316"], status: "warning" as const },
    { id: "2082141787", cells: ["FRA-1787", "Franchise Training Item 5", "20/8/2026", "€41 887"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Training</p>
                    </div>
                </div>
