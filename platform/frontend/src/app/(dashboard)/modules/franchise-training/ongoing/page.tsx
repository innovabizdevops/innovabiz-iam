...
const ACCENT = "#1e40af";
const MODULE = "Franchise Training";
const PAGE = "Ongoing";
const KPIS = [{"l":"Total Franchise Training","v":"2.343","t":"-1.4%","d":"down"},{"l":"Ongoing Ativos","v":"926","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"67.0%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"69","t":"-5.6%","d":"down"}];
const COLS = ["ID","Ongoing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Franchise Training #001","Franchise Training #002","854","6.313","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Franchise Training #002","Franchise Training #003","5.589","6.359","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Franchise Training #003","Franchise Training #004","1.718","2.382","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Franchise Training #004","Franchise Training #005","7.224","2.736","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Franchise Training #005","Franchise Training #001","7.776","7.496","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":1014},{"label":"Mar","value":656},{"label":"Abr","value":937},{"label":"Mai","value":642},{"label":"Jun","value":964},{"label":"Jul","value":992},{"label":"Ago","value":946},{"label":"Set","value":985},{"label":"Out","value":790},{"label":"Nov","value":637},{"label":"Dez","value":813}];
const MX = 1014;
