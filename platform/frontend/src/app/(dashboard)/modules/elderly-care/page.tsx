...
/* ═══ Elderly Care Management — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "6586", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "52", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€455K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "176483886", cells: ["ELD-3886", "Elderly Care Management Item 1", "27/7/2026", "€33 986"], status: "active" as const },
    { id: "176487457", cells: ["ELD-7457", "Elderly Care Management Item 2", "14/2/2026", "€37 557"], status: "pending" as const },
    { id: "176491028", cells: ["ELD-2028", "Elderly Care Management Item 3", "1/9/2026", "€41 128"], status: "completed" as const },
    { id: "176494599", cells: ["ELD-5599", "Elderly Care Management Item 4", "16/4/2026", "€44 699"], status: "warning" as const },
    { id: "176498170", cells: ["ELD-9170", "Elderly Care Management Item 5", "3/11/2026", "€48 270"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Elderly Care Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Elderly Care Management</p>
                    </div>
                </div>
