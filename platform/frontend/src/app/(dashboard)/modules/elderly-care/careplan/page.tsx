...
const ACCENT = "#65a30d";
const MODULE = "Elderly Care Management";
const PAGE = "Care Plan";
const KPIS = [{"l":"Total Elderly Care","v":"607","t":"+12.2%","d":"up"},{"l":"Care Plan Ativos","v":"2.790","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"67","t":"-2.5%","d":"down"}];
const COLS = ["ID","Care Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elderly Care #001","Elderly Care #002","597","6.452","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Elderly Care #002","Elderly Care #003","7.283","881","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Elderly Care #003","Elderly Care #004","8.079","2.049","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Elderly Care #004","Elderly Care #005","6.326","8.728","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elderly Care #005","Elderly Care #001","8.181","1.225","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":799},{"label":"Mar","value":597},{"label":"Abr","value":696},{"label":"Mai","value":723},{"label":"Jun","value":523},{"label":"Jul","value":459},{"label":"Ago","value":506},{"label":"Set","value":604},{"label":"Out","value":476},{"label":"Nov","value":550},{"label":"Dez","value":725}];
const MX = 799;
