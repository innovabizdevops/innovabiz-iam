...
const PAGE = "Activity";
const KPIS = [{"l":"Total Elderly Care","v":"4.048","t":"+17.2%","d":"up"},{"l":"Activity Ativos","v":"554","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+13.0%","d":"up"}];
const COLS = ["ID","Activity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elderly Care #001","Elderly Care #002","1.945","7.160","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Elderly Care #002","Elderly Care #003","7.364","3.330","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Elderly Care #003","Elderly Care #004","2.726","7.212","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Elderly Care #004","Elderly Care #005","8.929","5.072","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elderly Care #005","Elderly Care #001","352","8.290","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":382},{"label":"Mar","value":543},{"label":"Abr","value":574},{"label":"Mai","value":288},{"label":"Jun","value":333},{"label":"Jul","value":291},{"label":"Ago","value":596},{"label":"Set","value":449},{"label":"Out","value":667},{"label":"Nov","value":486},{"label":"Dez","value":371}];
const MX = 667;
