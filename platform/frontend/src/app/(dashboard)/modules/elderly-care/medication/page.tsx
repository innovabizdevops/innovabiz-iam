...
const PAGE = "Medication";
const KPIS = [{"l":"Integrações Ativas","v":"6.186","t":"+4.4%","d":"up"},{"l":"Chamadas/Hora","v":"4599","t":"+12.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.9%","t":"+16.2%","d":"up"},{"l":"Latência Média (ms)","v":"142ms","t":"+14.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.647","1.111","85.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","825","8.940","84.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.582","4.776","91.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.503","2.394","95.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","873","1.795","79.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":563},{"label":"Mar","value":897},{"label":"Abr","value":629},{"label":"Mai","value":827},{"label":"Jun","value":577},{"label":"Jul","value":867},{"label":"Ago","value":563},{"label":"Set","value":563},{"label":"Out","value":936},{"label":"Nov","value":618},{"label":"Dez","value":579}];
const MX = 936;
