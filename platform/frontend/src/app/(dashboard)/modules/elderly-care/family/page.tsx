...
const PAGE = "Family";
const KPIS = [{"l":"Total Elderly Care","v":"3.933","t":"-4.4%","d":"down"},{"l":"Family Ativos","v":"3.289","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"82.8%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"90","t":"+12.3%","d":"up"}];
const COLS = ["ID","Family","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elderly Care #001","Elderly Care #002","5.581","1.099","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Elderly Care #002","Elderly Care #003","1.804","8.897","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Elderly Care #003","Elderly Care #004","6.327","2.873","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Elderly Care #004","Elderly Care #005","4.509","5.145","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elderly Care #005","Elderly Care #001","337","4.867","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":894},{"label":"Mar","value":940},{"label":"Abr","value":1054},{"label":"Mai","value":740},{"label":"Jun","value":844},{"label":"Jul","value":998},{"label":"Ago","value":949},{"label":"Set","value":1016},{"label":"Out","value":1020},{"label":"Nov","value":699},{"label":"Dez","value":767}];
const MX = 1054;
