...
const KPIS = [{"l":"Total Elderly Care","v":"6.926","t":"+2.4%","d":"up"},{"l":"Assessment Ativos","v":"5.238","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+12.4%","d":"up"}];
const COLS = ["ID","Assessment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Elderly Care #001","Elderly Care #002","7.672","5.425","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Elderly Care #002","Elderly Care #003","9.066","4.510","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Elderly Care #003","Elderly Care #004","8.828","877","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Elderly Care #004","Elderly Care #005","8.272","1.203","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elderly Care #005","Elderly Care #001","2.852","1.267","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":694},{"label":"Mar","value":551},{"label":"Abr","value":773},{"label":"Mai","value":662},{"label":"Jun","value":816},{"label":"Jul","value":774},{"label":"Ago","value":586},{"label":"Set","value":726},{"label":"Out","value":837},{"label":"Nov","value":859},{"label":"Dez","value":911}];
const MX = 911;
