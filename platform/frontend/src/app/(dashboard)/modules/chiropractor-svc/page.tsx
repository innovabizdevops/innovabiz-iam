...
/* ═══ Chiropractic Services — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "7808", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4560", trend: "-3%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€283K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1112886508", cells: ["CHI-1508", "Chiropractic Services Item 1", "21/5/2026", "€36 608"], status: "active" as const },
    { id: "1112890079", cells: ["CHI-5079", "Chiropractic Services Item 2", "8/12/2026", "€40 179"], status: "pending" as const },
    { id: "1112893650", cells: ["CHI-8650", "Chiropractic Services Item 3", "23/7/2026", "€43 750"], status: "completed" as const },
    { id: "1112897221", cells: ["CHI-3221", "Chiropractic Services Item 4", "10/2/2026", "€47 321"], status: "warning" as const },
    { id: "1112900792", cells: ["CHI-6792", "Chiropractic Services Item 5", "25/9/2026", "€892"], status: "active" as const },
];
...
export default function ChiropracticServicesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Chiropractic Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Chiropractic Services</p>
                    </div>
                </div>
