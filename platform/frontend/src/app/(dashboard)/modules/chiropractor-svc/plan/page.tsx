...
const PAGE = "Plan";
const KPIS = [{"l":"Total Chiropractor Svc","v":"3.365","t":"+2.6%","d":"up"},{"l":"Plan Ativos","v":"2.964","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"68","t":"-1.1%","d":"down"}];
const COLS = ["ID","Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chiropractor Svc #001","Chiropractor Svc #002","4.546","7.611","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Chiropractor Svc #002","Chiropractor Svc #003","8.120","4.085","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Chiropractor Svc #003","Chiropractor Svc #004","1.847","2.042","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Chiropractor Svc #004","Chiropractor Svc #005","222","2.630","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chiropractor Svc #005","Chiropractor Svc #001","1.819","281","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":375},{"label":"Mar","value":539},{"label":"Abr","value":333},{"label":"Mai","value":457},{"label":"Jun","value":383},{"label":"Jul","value":352},{"label":"Ago","value":538},{"label":"Set","value":320},{"label":"Out","value":649},{"label":"Nov","value":655},{"label":"Dez","value":549}];
const MX = 655;
