...
const KPIS = [
    { label: "Total Registos", value: "6115", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3419", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€52K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "408113715", cells: ["FUN-9715", "Fund Administration Item 1", "24/4/2026", "€13 815"], status: "active" as const },
    { id: "408117286", cells: ["FUN-4286", "Fund Administration Item 2", "11/11/2026", "€17 386"], status: "pending" as const },
    { id: "408120857", cells: ["FUN-7857", "Fund Administration Item 3", "26/6/2026", "€20 957"], status: "completed" as const },
    { id: "408124428", cells: ["FUN-2428", "Fund Administration Item 4", "13/1/2026", "€24 528"], status: "warning" as const },
    { id: "408127999", cells: ["FUN-5999", "Fund Administration Item 5", "28/8/2026", "€28 099"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fund Administration</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fund Administration</p>
                    </div>
                </div>
