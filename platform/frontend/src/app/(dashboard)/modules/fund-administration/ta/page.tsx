...
const ACCENT = "#1e3a5f";
const MODULE = "Fund Administration";
const PAGE = "Transfer Agent";
const KPIS = [{"l":"Total Fund Administration","v":"459","t":"+4.9%","d":"up"},{"l":"Transfer Agent Ativos","v":"7.162","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"93","t":"+10.3%","d":"up"}];
const COLS = ["ID","Transfer Agent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fund Administration #001","Fund Administration #002","4.764","3.162","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Fund Administration #002","Fund Administration #003","357","6.131","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Fund Administration #003","Fund Administration #004","670","4.569","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Fund Administration #004","Fund Administration #005","2.394","7.299","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fund Administration #005","Fund Administration #001","3.449","8.465","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":797},{"label":"Mar","value":509},{"label":"Abr","value":880},{"label":"Mai","value":814},{"label":"Jun","value":562},{"label":"Jul","value":516},{"label":"Ago","value":836},{"label":"Set","value":851},{"label":"Out","value":504},{"label":"Nov","value":897},{"label":"Dez","value":768}];
const MX = 897;
