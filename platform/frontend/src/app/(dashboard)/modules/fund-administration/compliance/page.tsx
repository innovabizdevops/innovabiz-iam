...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.563","t":"+0.6%","d":"up"},{"l":"NC Abertas","v":"3.064","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"75.1%","t":"+1.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.260","t":"-2.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","910","93.3%","8.635","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.735","98.3%","3.436","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.952","93.3%","463","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.237","77.1%","5.600","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.853","83.8%","1.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":376},{"label":"Mar","value":610},{"label":"Abr","value":268},{"label":"Mai","value":279},{"label":"Jun","value":576},{"label":"Jul","value":243},{"label":"Ago","value":579},{"label":"Set","value":432},{"label":"Out","value":388},{"label":"Nov","value":617},{"label":"Dez","value":301}];
const MX = 617;
