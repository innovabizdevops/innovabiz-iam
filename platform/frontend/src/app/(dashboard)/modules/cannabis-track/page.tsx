...
/* ═══ Seed-to-Sale Track — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5230", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1026", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€420K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "705815730", cells: ["CAN-9730", "Seed-to-Sale Track Item 1", "19/7/2026", "€15 830"], status: "active" as const },
    { id: "705819301", cells: ["CAN-4301", "Seed-to-Sale Track Item 2", "6/2/2026", "€19 401"], status: "pending" as const },
    { id: "705822872", cells: ["CAN-7872", "Seed-to-Sale Track Item 3", "21/9/2026", "€22 972"], status: "completed" as const },
    { id: "705826443", cells: ["CAN-2443", "Seed-to-Sale Track Item 4", "8/4/2026", "€26 543"], status: "warning" as const },
    { id: "705830014", cells: ["CAN-6014", "Seed-to-Sale Track Item 5", "23/11/2026", "€30 114"], status: "active" as const },
];
...
export default function SeedtosaleTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Seed-to-Sale Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Seed-to-Sale Track</p>
                    </div>
                </div>
