...
const PAGE = "COBIT Audit Program";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.834","t":"+12.6%","d":"up"},{"l":"NC Abertas","v":"7.824","t":"+6.7%","d":"up"},{"l":"Conformidade (%)","v":"81.3%","t":"+8.3%","d":"up"},{"l":"CAPAs Pendentes","v":"3.174","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.603","79.2%","5.008","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.075","81.0%","5.929","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.754","82.2%","7.320","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.041","71.6%","6.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.313","93.5%","5.561","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":883},{"label":"Mar","value":825},{"label":"Abr","value":948},{"label":"Mai","value":946},{"label":"Jun","value":771},{"label":"Jul","value":743},{"label":"Ago","value":691},{"label":"Set","value":977},{"label":"Out","value":805},{"label":"Nov","value":920},{"label":"Dez","value":913}];
const MX = 977;
...
export default function CobitAuditPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>COBIT</span></h1>
                </div>
