...
const PAGE = "Continuous Auditing AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.287","t":"+12.1%","d":"up"},{"l":"NC Abertas","v":"660","t":"+0.9%","d":"up"},{"l":"Conformidade (%)","v":"70.7%","t":"-5.6%","d":"down"},{"l":"CAPAs Pendentes","v":"7.822","t":"+0.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.178","81.6%","4.658","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.978","88.0%","7.568","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.411","84.9%","3.444","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.614","86.0%","1.975","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.855","79.4%","7.521","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":419},{"label":"Mar","value":436},{"label":"Abr","value":486},{"label":"Mai","value":351},{"label":"Jun","value":575},{"label":"Jul","value":393},{"label":"Ago","value":635},{"label":"Set","value":444},{"label":"Out","value":270},{"label":"Nov","value":296},{"label":"Dez","value":357}];
const MX = 635;
