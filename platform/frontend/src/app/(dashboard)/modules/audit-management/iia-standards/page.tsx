...
const PAGE = "IIA Standards";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.454","t":"+14.6%","d":"up"},{"l":"NC Abertas","v":"3.739","t":"-4.3%","d":"down"},{"l":"Conformidade (%)","v":"87.7%","t":"+0.0%","d":"up"},{"l":"CAPAs Pendentes","v":"1.847","t":"-2.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","419","83.9%","5.808","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.422","72.0%","5.974","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.527","82.6%","427","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.409","87.7%","6.594","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.214","84.4%","6.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":554},{"label":"Mar","value":329},{"label":"Abr","value":593},{"label":"Mai","value":617},{"label":"Jun","value":436},{"label":"Jul","value":581},{"label":"Ago","value":570},{"label":"Set","value":573},{"label":"Out","value":620},{"label":"Nov","value":301},{"label":"Dez","value":596}];
const MX = 620;
...
export default function IiaStandardsPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>IIA</span></h1>
                </div>
