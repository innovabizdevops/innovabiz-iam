...
const PAGE = "Audits";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.375","t":"-3.7%","d":"down"},{"l":"NC Abertas","v":"5.533","t":"+7.1%","d":"up"},{"l":"Conformidade (%)","v":"73.9%","t":"+0.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.135","t":"+4.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.522","98.2%","6.928","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.443","75.9%","473","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.652","97.9%","8.203","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.004","74.5%","2.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.858","73.0%","1.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":784},{"label":"Mar","value":775},{"label":"Abr","value":953},{"label":"Mai","value":924},{"label":"Jun","value":965},{"label":"Jul","value":772},{"label":"Ago","value":874},{"label":"Set","value":900},{"label":"Out","value":933},{"label":"Nov","value":893},{"label":"Dez","value":581}];
const MX = 965;
