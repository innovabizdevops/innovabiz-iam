...
const PAGE = "Audit Scheduling";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.507","t":"-5.1%","d":"down"},{"l":"NC Abertas","v":"3.306","t":"-0.1%","d":"down"},{"l":"Conformidade (%)","v":"72.6%","t":"-1.5%","d":"down"},{"l":"CAPAs Pendentes","v":"7.348","t":"+16.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.666","77.4%","7.105","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.577","92.5%","6.359","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","738","80.8%","7.808","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.391","85.9%","6.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.790","86.9%","8.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":629},{"label":"Mar","value":521},{"label":"Abr","value":501},{"label":"Mai","value":402},{"label":"Jun","value":418},{"label":"Jul","value":332},{"label":"Ago","value":561},{"label":"Set","value":391},{"label":"Out","value":563},{"label":"Nov","value":497},{"label":"Dez","value":720}];
const MX = 720;
