...
const PAGE = "Findings Tracker";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.585","t":"+2.4%","d":"up"},{"l":"NC Abertas","v":"4.551","t":"+6.9%","d":"up"},{"l":"Conformidade (%)","v":"89.1%","t":"+7.6%","d":"up"},{"l":"CAPAs Pendentes","v":"7.192","t":"+5.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.358","86.1%","6.649","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.413","77.3%","2.566","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.026","90.9%","8.404","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.095","89.7%","3.913","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.109","77.7%","7.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":882},{"label":"Mar","value":732},{"label":"Abr","value":860},{"label":"Mai","value":876},{"label":"Jun","value":822},{"label":"Jul","value":869},{"label":"Ago","value":794},{"label":"Set","value":603},{"label":"Out","value":620},{"label":"Nov","value":708},{"label":"Dez","value":928}];
const MX = 928;
