...
const KPIS = [{"l":"Total Attribution Model","v":"3.023","t":"+3.0%","d":"up"},{"l":"Budget Alloc Ativos","v":"€23652","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.5%","d":"down"}];
const COLS = ["ID","Budget Alloc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attribution Model #001","€ 8832.04","1.975","5.769","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Attribution Model #002","€ 32592.58","7.794","7.330","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Attribution Model #003","€ 33099.43","3.075","5.667","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Attribution Model #004","€ 11098.27","3.603","4.887","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attribution Model #005","€ 9710.70","1.182","2.190","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":758},{"label":"Mar","value":599},{"label":"Abr","value":577},{"label":"Mai","value":777},{"label":"Jun","value":549},{"label":"Jul","value":419},{"label":"Ago","value":604},{"label":"Set","value":571},{"label":"Out","value":413},{"label":"Nov","value":711},{"label":"Dez","value":644}];
const MX = 777;
