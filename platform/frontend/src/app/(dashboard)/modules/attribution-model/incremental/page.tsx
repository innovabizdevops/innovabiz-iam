...
const PAGE = "Incrementality";
const KPIS = [{"l":"Total Attribution Model","v":"4.595","t":"+13.1%","d":"up"},{"l":"Incrementality Ativos","v":"3.621","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+15.1%","d":"up"}];
const COLS = ["ID","Incrementality","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attribution Model #001","Attribution Model #002","4.429","4.892","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Attribution Model #002","Attribution Model #003","3.227","2.765","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Attribution Model #003","Attribution Model #004","4.951","2.448","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Attribution Model #004","Attribution Model #005","8.297","4.248","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attribution Model #005","Attribution Model #001","4.135","970","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":364},{"label":"Mar","value":592},{"label":"Abr","value":591},{"label":"Mai","value":458},{"label":"Jun","value":555},{"label":"Jul","value":638},{"label":"Ago","value":384},{"label":"Set","value":508},{"label":"Out","value":265},{"label":"Nov","value":397},{"label":"Dez","value":355}];
const MX = 638;
