...
const PAGE = "Multi-Touch";
const KPIS = [{"l":"Total Attribution Model","v":"6.776","t":"+17.9%","d":"up"},{"l":"Multi Touch Ativos","v":"6.961","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"94","t":"+0.4%","d":"up"}];
const COLS = ["ID","Multi Touch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attribution Model #001","Attribution Model #002","5.053","2.398","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Attribution Model #002","Attribution Model #003","1.933","3.506","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Attribution Model #003","Attribution Model #004","392","4.002","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Attribution Model #004","Attribution Model #005","5.388","2.046","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attribution Model #005","Attribution Model #001","3.253","7.186","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":752},{"label":"Mar","value":924},{"label":"Abr","value":788},{"label":"Mai","value":667},{"label":"Jun","value":808},{"label":"Jul","value":648},{"label":"Ago","value":805},{"label":"Set","value":745},{"label":"Out","value":836},{"label":"Nov","value":813},{"label":"Dez","value":813}];
const MX = 924;
