...
const ACCENT = "#0e7490";
const MODULE = "Attribution Modeling";
const PAGE = "Media Mix";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.372","t":"+8.8%","d":"up"},{"l":"Sessões/Dia","v":"1483","t":"+15.4%","d":"up"},{"l":"MFA Adoção (%)","v":"68.2%","t":"-1.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"2.767","t":"+11.7%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","2.804","8.892","7.600","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.070","5.862","8.235","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","9.051","8.427","615","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.009","833","2.166","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.620","4.990","1.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":662},{"label":"Mar","value":367},{"label":"Abr","value":504},{"label":"Mai","value":414},{"label":"Jun","value":727},{"label":"Jul","value":679},{"label":"Ago","value":694},{"label":"Set","value":482},{"label":"Out","value":558},{"label":"Nov","value":624},{"label":"Dez","value":405}];
const MX = 727;
