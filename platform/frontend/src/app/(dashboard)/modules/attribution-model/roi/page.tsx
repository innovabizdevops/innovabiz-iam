...
const PAGE = "ROI Report";
const KPIS = [{"l":"Total Attribution Model","v":"1.812","t":"+11.4%","d":"up"},{"l":"ROI Report Ativos","v":"4.818","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"92.7%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"60","t":"+14.1%","d":"up"}];
const COLS = ["ID","ROI Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Attribution Model #001","Attribution Model #002","3.108","2.359","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Attribution Model #002","Attribution Model #003","4.321","9.063","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Attribution Model #003","Attribution Model #004","7.938","8.190","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Attribution Model #004","Attribution Model #005","6.406","7.090","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Attribution Model #005","Attribution Model #001","6.623","8.748","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":770},{"label":"Mar","value":949},{"label":"Abr","value":937},{"label":"Mai","value":899},{"label":"Jun","value":941},{"label":"Jul","value":1081},{"label":"Ago","value":876},{"label":"Set","value":1056},{"label":"Out","value":985},{"label":"Nov","value":859},{"label":"Dez","value":749}];
const MX = 1081;
