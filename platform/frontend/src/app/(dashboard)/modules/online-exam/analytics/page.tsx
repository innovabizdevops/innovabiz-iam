...
const KPIS = [{"l":"Dashboards Ativos","v":"5.367","t":"+1.9%","d":"up"},{"l":"Queries/Dia","v":"3212","t":"+13.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.747","t":"+7.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.627","t":"+4.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","839","2026-01-25","567","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2402","2026-01-26","7.374","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","337","2026-03-05","4.791","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2272","2026-03-02","8.523","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2672","2026-02-07","1.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":513},{"label":"Mar","value":731},{"label":"Abr","value":722},{"label":"Mai","value":454},{"label":"Jun","value":521},{"label":"Jul","value":782},{"label":"Ago","value":633},{"label":"Set","value":772},{"label":"Out","value":720},{"label":"Nov","value":577},{"label":"Dez","value":427}];
const MX = 782;
