...
const PAGE = "Stream";
const KPIS = [{"l":"Integrações Ativas","v":"7.815","t":"+4.2%","d":"up"},{"l":"Chamadas/Hora","v":"4892","t":"+8.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.4%","t":"-5.1%","d":"down"},{"l":"Latência Média (ms)","v":"58ms","t":"+3.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.742","8.238","97.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.710","6.271","70.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.055","172","93.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.356","878","90.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.195","8.026","99.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":570},{"label":"Mar","value":559},{"label":"Abr","value":356},{"label":"Mai","value":499},{"label":"Jun","value":358},{"label":"Jul","value":511},{"label":"Ago","value":628},{"label":"Set","value":293},{"label":"Out","value":378},{"label":"Nov","value":533},{"label":"Dez","value":451}];
const MX = 628;
