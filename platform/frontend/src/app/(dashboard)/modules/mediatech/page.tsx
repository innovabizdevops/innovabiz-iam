...
/* ═══ MediaTech Platform — Dashboard ═══ */

const ACCENT = "#f43f5e";

const KPIS = [
    { label: "Total Registos", value: "2869", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "860", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1159609569", cells: ["MED-5569", "MediaTech Platform Item 1", "14/10/2026", "€9669"], status: "active" as const },
    { id: "1159613140", cells: ["MED-9140", "MediaTech Platform Item 2", "1/5/2026", "€13 240"], status: "pending" as const },
    { id: "1159616711", cells: ["MED-3711", "MediaTech Platform Item 3", "16/12/2026", "€16 811"], status: "completed" as const },
    { id: "1159620282", cells: ["MED-7282", "MediaTech Platform Item 4", "3/7/2026", "€20 382"], status: "warning" as const },
    { id: "1159623853", cells: ["MED-1853", "MediaTech Platform Item 5", "18/2/2026", "€23 953"], status: "active" as const },
];
...
export default function MediatechPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MediaTech Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MediaTech Platform</p>
                    </div>
                </div>
