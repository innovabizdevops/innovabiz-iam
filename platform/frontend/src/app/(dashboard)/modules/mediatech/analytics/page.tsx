...
const ACCENT = "#f43f5e";
const MODULE = "MediaTech Platform";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"3.819","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"4778","t":"+8.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.688","t":"-3.4%","d":"down"},{"l":"Utilizadores Analytics","v":"7.237","t":"+16.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3498","2026-02-15","5.586","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","341","2026-02-01","5.200","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","293","2026-01-18","857","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2437","2026-01-05","982","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4096","2026-01-15","8.726","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":369},{"label":"Mar","value":409},{"label":"Abr","value":445},{"label":"Mai","value":495},{"label":"Jun","value":633},{"label":"Jul","value":439},{"label":"Ago","value":376},{"label":"Set","value":420},{"label":"Out","value":404},{"label":"Nov","value":340},{"label":"Dez","value":476}];
const MX = 633;
