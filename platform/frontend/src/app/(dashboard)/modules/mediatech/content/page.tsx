...
const PAGE = "Content";
const KPIS = [{"l":"Integrações Ativas","v":"5.845","t":"+12.5%","d":"up"},{"l":"Chamadas/Hora","v":"650","t":"+16.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.3%","t":"-4.9%","d":"down"},{"l":"Latência Média (ms)","v":"156ms","t":"+13.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.437","4.952","76.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.731","4.889","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.512","2.962","78.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.108","2.935","73.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.461","1.444","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":599},{"label":"Mar","value":640},{"label":"Abr","value":676},{"label":"Mai","value":714},{"label":"Jun","value":351},{"label":"Jul","value":421},{"label":"Ago","value":512},{"label":"Set","value":504},{"label":"Out","value":367},{"label":"Nov","value":417},{"label":"Dez","value":361}];
const MX = 714;
