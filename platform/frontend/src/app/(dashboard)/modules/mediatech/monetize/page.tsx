...
const PAGE = "Monetize";
const KPIS = [{"l":"ARR (€M)","v":"€22.6M","t":"-1.7%","d":"down"},{"l":"MRR (€)","v":"€22915","t":"-0.3%","d":"down"},{"l":"Churn (%)","v":"79.1%","t":"+10.2%","d":"up"},{"l":"ARPU (€)","v":"€69253","t":"+3.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1927.14","5.986","€ 4810.31","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 33921.73","8.219","€ 42476.46","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 41478.65","8.654","€ 3728.60","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3786.32","3.037","€ 15029.37","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24578.01","1.032","€ 16702.14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":823},{"label":"Mar","value":832},{"label":"Abr","value":827},{"label":"Mai","value":534},{"label":"Jun","value":562},{"label":"Jul","value":465},{"label":"Ago","value":628},{"label":"Set","value":695},{"label":"Out","value":712},{"label":"Nov","value":543},{"label":"Dez","value":660}];
const MX = 832;
