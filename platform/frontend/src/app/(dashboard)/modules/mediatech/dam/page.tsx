...
const PAGE = "DAM";
const KPIS = [{"l":"Integrações Ativas","v":"7.808","t":"-5.9%","d":"down"},{"l":"Chamadas/Hora","v":"4183","t":"-2.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"69.4%","t":"+17.8%","d":"up"},{"l":"Latência Média (ms)","v":"50ms","t":"+14.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.023","3.283","88.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.369","8.299","76.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.768","7.339","87.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.285","8.386","70.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.864","3.137","84.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":784},{"label":"Mar","value":547},{"label":"Abr","value":585},{"label":"Mai","value":790},{"label":"Jun","value":609},{"label":"Jul","value":677},{"label":"Ago","value":739},{"label":"Set","value":694},{"label":"Out","value":760},{"label":"Nov","value":591},{"label":"Dez","value":655}];
const MX = 790;
