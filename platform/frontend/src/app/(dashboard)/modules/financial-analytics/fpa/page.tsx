...
const PAGE = "FP&amp;A";
const KPIS = [{"l":"Dashboards Ativos","v":"7.981","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"681","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.571","t":"+9.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.144","t":"-3.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4133","2026-03-05","8.563","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1867","2026-02-26","5.857","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2075","2026-03-10","6.370","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2063","2026-02-05","4.941","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4617","2026-01-17","5.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":744},{"label":"Fev","value":958},{"label":"Mar","value":676},{"label":"Abr","value":848},{"label":"Mai","value":937},{"label":"Jun","value":1056},{"label":"Jul","value":708},{"label":"Ago","value":981},{"label":"Set","value":1039},{"label":"Out","value":999},{"label":"Nov","value":891},{"label":"Dez","value":1055}];
const MX = 1056;
