...
/* ═══ Financial Analytics Deep — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "6329", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "532", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€285K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "159663529", cells: ["FIN-4529", "Financial Analytics Deep Item 1", "26/2/2026", "€13 629"], status: "active" as const },
    { id: "159667100", cells: ["FIN-8100", "Financial Analytics Deep Item 2", "13/9/2026", "€17 200"], status: "pending" as const },
    { id: "159670671", cells: ["FIN-2671", "Financial Analytics Deep Item 3", "28/4/2026", "€20 771"], status: "completed" as const },
    { id: "159674242", cells: ["FIN-6242", "Financial Analytics Deep Item 4", "15/11/2026", "€24 342"], status: "warning" as const },
    { id: "159677813", cells: ["FIN-9813", "Financial Analytics Deep Item 5", "2/6/2026", "€27 913"], status: "active" as const },
];
...
export default function FinancialAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Financial Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Financial Analytics Deep</p>
                    </div>
                </div>
