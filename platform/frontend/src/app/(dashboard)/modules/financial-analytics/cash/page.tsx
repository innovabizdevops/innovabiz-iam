...
const PAGE = "Cash";
const KPIS = [{"l":"Dashboards Ativos","v":"3.749","t":"-1.6%","d":"down"},{"l":"Queries/Dia","v":"562","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.884","t":"+16.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.443","t":"+11.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1323","2026-02-11","1.540","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","506","2026-02-16","1.028","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2871","2026-01-22","1.513","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1845","2026-03-11","6.729","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","801","2026-01-14","7.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":730},{"label":"Mar","value":771},{"label":"Abr","value":870},{"label":"Mai","value":733},{"label":"Jun","value":596},{"label":"Jul","value":635},{"label":"Ago","value":765},{"label":"Set","value":756},{"label":"Out","value":715},{"label":"Nov","value":922},{"label":"Dez","value":561}];
const MX = 922;
