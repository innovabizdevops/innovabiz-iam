...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€22.6M","t":"+15.9%","d":"up"},{"l":"MRR (€)","v":"€91822","t":"+11.5%","d":"up"},{"l":"Churn (%)","v":"73.6%","t":"-4.5%","d":"down"},{"l":"ARPU (€)","v":"€74599","t":"+16.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41205.43","2.447","€ 20207.29","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 36591.39","4.231","€ 7160.59","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13624.18","2.341","€ 20673.62","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11328.96","3.276","€ 47189.31","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 25856.32","6.045","€ 23781.03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":998},{"label":"Mar","value":688},{"label":"Abr","value":955},{"label":"Mai","value":763},{"label":"Jun","value":684},{"label":"Jul","value":808},{"label":"Ago","value":693},{"label":"Set","value":976},{"label":"Out","value":731},{"label":"Nov","value":937},{"label":"Dez","value":893}];
const MX = 998;
