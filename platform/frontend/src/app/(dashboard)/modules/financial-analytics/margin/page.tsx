...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€12.6M","t":"+7.7%","d":"up"},{"l":"MRR (€)","v":"€43900","t":"-4.1%","d":"down"},{"l":"Churn (%)","v":"77.7%","t":"+5.7%","d":"up"},{"l":"ARPU (€)","v":"€25976","t":"+5.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 24559.38","4.021","€ 18166.22","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18631.23","1.018","€ 34636.13","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 48105.24","859","€ 40270.34","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 25326.62","8.146","€ 12887.80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44860.71","4.959","€ 33676.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":245},{"label":"Fev","value":275},{"label":"Mar","value":456},{"label":"Abr","value":424},{"label":"Mai","value":308},{"label":"Jun","value":555},{"label":"Jul","value":433},{"label":"Ago","value":492},{"label":"Set","value":386},{"label":"Out","value":512},{"label":"Nov","value":231},{"label":"Dez","value":274}];
const MX = 555;
