...
const ACCENT = "#4338ca";
const MODULE = "Financial Analytics Deep";
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"4.364","t":"-0.6%","d":"down"},{"l":"Queries/Dia","v":"4925","t":"+14.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.801","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"8.740","t":"-3.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2419","2026-03-13","7.751","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4420","2026-02-21","7.004","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3401","2026-02-05","7.127","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4921","2026-01-22","5.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2997","2026-02-20","5.714","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":720},{"label":"Mar","value":706},{"label":"Abr","value":666},{"label":"Mai","value":357},{"label":"Jun","value":658},{"label":"Jul","value":453},{"label":"Ago","value":699},{"label":"Set","value":680},{"label":"Out","value":667},{"label":"Nov","value":464},{"label":"Dez","value":527}];
const MX = 720;
