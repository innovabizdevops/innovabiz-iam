...
const ACCENT = "#6366f1";
const MODULE = "Vehicle Inspection";
const PAGE = "Pre-Buy";
const KPIS = [{"l":"Total Vehicle Inspect","v":"3.243","t":"+14.3%","d":"up"},{"l":"Pre Buy Ativos","v":"1.340","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"63","t":"-0.7%","d":"down"}];
const COLS = ["ID","Pre Buy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Vehicle Inspect #001","Vehicle Inspect #002","8.286","9.049","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Vehicle Inspect #002","Vehicle Inspect #003","1.385","6.916","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Vehicle Inspect #003","Vehicle Inspect #004","8.677","120","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Vehicle Inspect #004","Vehicle Inspect #005","6.440","403","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Vehicle Inspect #005","Vehicle Inspect #001","3.179","3.101","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":882},{"label":"Mar","value":847},{"label":"Abr","value":627},{"label":"Mai","value":874},{"label":"Jun","value":847},{"label":"Jul","value":913},{"label":"Ago","value":966},{"label":"Set","value":642},{"label":"Out","value":784},{"label":"Nov","value":829},{"label":"Dez","value":921}];
const MX = 966;
