...
const KPIS = [{"l":"ARR (€M)","v":"€18.9M","t":"-0.1%","d":"down"},{"l":"MRR (€)","v":"€15282","t":"+16.3%","d":"up"},{"l":"Churn (%)","v":"90.0%","t":"+9.0%","d":"up"},{"l":"ARPU (€)","v":"€24691","t":"-3.0%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 2001.95","1.149","€ 32639.66","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 39886.55","239","€ 31637.77","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 7680.07","2.749","€ 43128.08","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 43689.06","1.337","€ 23459.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13618.11","3.537","€ 43839.86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":794},{"label":"Mar","value":705},{"label":"Abr","value":1013},{"label":"Mai","value":818},{"label":"Jun","value":852},{"label":"Jul","value":728},{"label":"Ago","value":922},{"label":"Set","value":983},{"label":"Out","value":698},{"label":"Nov","value":746},{"label":"Dez","value":1034}];
const MX = 1034;
