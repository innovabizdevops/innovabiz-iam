...
const KPIS = [{"l":"Formulários Ativos","v":"211","t":"+4.6%","d":"up"},{"l":"Submissões/Dia","v":"1384","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"3.571","t":"+7.7%","d":"up"},{"l":"Templates","v":"7.535","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.510","2026-01-28","5.737","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.283","2026-01-23","171","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.387","2026-01-11","3.223","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.417","2026-03-22","2.937","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.679","2026-01-23","6.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":915},{"label":"Mar","value":909},{"label":"Abr","value":624},{"label":"Mai","value":776},{"label":"Jun","value":527},{"label":"Jul","value":624},{"label":"Ago","value":797},{"label":"Set","value":905},{"label":"Out","value":613},{"label":"Nov","value":874},{"label":"Dez","value":901}];
const MX = 915;
