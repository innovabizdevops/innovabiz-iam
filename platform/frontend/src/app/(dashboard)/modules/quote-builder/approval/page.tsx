...
const KPIS = [{"l":"Aprovações Pendentes","v":"5.238","t":"+12.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.1%","t":"+3.1%","d":"up"},{"l":"Tempo Médio (h)","v":"53h","t":"-0.4%","d":"down"},{"l":"Rejeitadas (%)","v":"74.5%","t":"+7.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","8.440","€ 7933.17","3.236","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.966","€ 13039.35","1.617","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","489","€ 19753.36","3.170","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.307","€ 17429.96","1.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.422","€ 32801.80","1.008","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":225},{"label":"Mar","value":287},{"label":"Abr","value":390},{"label":"Mai","value":599},{"label":"Jun","value":242},{"label":"Jul","value":523},{"label":"Ago","value":427},{"label":"Set","value":605},{"label":"Out","value":565},{"label":"Nov","value":317},{"label":"Dez","value":356}];
const MX = 605;
