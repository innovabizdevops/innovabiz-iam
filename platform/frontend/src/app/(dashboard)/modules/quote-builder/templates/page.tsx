...
const ACCENT = "#7c3aed";
const MODULE = "Quote Builder";
const PAGE = "Template Studio";
const KPIS = [{"l":"Formulários Ativos","v":"5.057","t":"+2.2%","d":"up"},{"l":"Submissões/Dia","v":"3893","t":"+16.0%","d":"up"},{"l":"Documentos Gerados","v":"8.635","t":"+12.3%","d":"up"},{"l":"Templates","v":"4.491","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.781","2026-02-07","1.838","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.030","2026-02-04","8.792","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.002","2026-01-17","4.317","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.694","2026-02-21","1.430","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.277","2026-03-24","5.970","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":893},{"label":"Mar","value":1010},{"label":"Abr","value":919},{"label":"Mai","value":877},{"label":"Jun","value":696},{"label":"Jul","value":717},{"label":"Ago","value":707},{"label":"Set","value":657},{"label":"Out","value":991},{"label":"Nov","value":711},{"label":"Dez","value":785}];
const MX = 1010;
