...
const KPIS = [{"l":"Total Grid Modernize","v":"3.549","t":"-3.9%","d":"down"},{"l":"Resilience Ativos","v":"345","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+1.4%","d":"up"}];
const COLS = ["ID","Resilience","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Modernize #001","Grid Modernize #002","7.322","4.329","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Modernize #002","Grid Modernize #003","5.041","883","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Modernize #003","Grid Modernize #004","1.195","6.533","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Modernize #004","Grid Modernize #005","1.032","1.224","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Modernize #005","Grid Modernize #001","1.446","2.866","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":768},{"label":"Mar","value":516},{"label":"Abr","value":803},{"label":"Mai","value":783},{"label":"Jun","value":720},{"label":"Jul","value":694},{"label":"Ago","value":570},{"label":"Set","value":793},{"label":"Out","value":529},{"label":"Nov","value":621},{"label":"Dez","value":877}];
const MX = 877;
