...
const KPIS = [{"l":"Total Grid Modernize","v":"8.857","t":"+6.3%","d":"up"},{"l":"Smart Grid Ativos","v":"7.536","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"88.4%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"61","t":"+8.5%","d":"up"}];
const COLS = ["ID","Smart Grid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Modernize #001","Grid Modernize #002","4.567","8.595","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Modernize #002","Grid Modernize #003","4.899","1.000","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Modernize #003","Grid Modernize #004","8.621","3.507","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Modernize #004","Grid Modernize #005","2.121","6.276","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Modernize #005","Grid Modernize #001","3.908","3.001","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":787},{"label":"Mar","value":691},{"label":"Abr","value":726},{"label":"Mai","value":842},{"label":"Jun","value":617},{"label":"Jul","value":663},{"label":"Ago","value":730},{"label":"Set","value":476},{"label":"Out","value":559},{"label":"Nov","value":844},{"label":"Dez","value":602}];
const MX = 844;
