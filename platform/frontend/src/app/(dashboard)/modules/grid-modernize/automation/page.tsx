...
const KPIS = [{"l":"Total Grid Modernize","v":"3.065","t":"-3.0%","d":"down"},{"l":"Automation Ativos","v":"1.471","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"76","t":"-2.3%","d":"down"}];
const COLS = ["ID","Automation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Modernize #001","Grid Modernize #002","4.348","1.680","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Modernize #002","Grid Modernize #003","1.774","8.560","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Modernize #003","Grid Modernize #004","1.118","7.500","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Modernize #004","Grid Modernize #005","7.259","3.044","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Modernize #005","Grid Modernize #001","4.905","849","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":500},{"label":"Mar","value":543},{"label":"Abr","value":681},{"label":"Mai","value":578},{"label":"Jun","value":420},{"label":"Jul","value":624},{"label":"Ago","value":500},{"label":"Set","value":744},{"label":"Out","value":603},{"label":"Nov","value":640},{"label":"Dez","value":356}];
const MX = 744;
