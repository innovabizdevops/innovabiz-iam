...
export default function GridModernizePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Grid Modernize</h1><p className="text-sm text-muted-foreground">Grid Modernize • iBOS Enterprise</p></div>
