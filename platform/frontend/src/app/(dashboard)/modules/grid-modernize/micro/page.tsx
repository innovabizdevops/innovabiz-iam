...
const ACCENT = "#6366f1";
const MODULE = "Grid Modernization";
const PAGE = "Microgrid";
const KPIS = [{"l":"Total Grid Modernize","v":"3.221","t":"-4.1%","d":"down"},{"l":"Microgrid Ativos","v":"5.147","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"85.1%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"89","t":"-0.4%","d":"down"}];
const COLS = ["ID","Microgrid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Grid Modernize #001","Grid Modernize #002","5.238","573","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Grid Modernize #002","Grid Modernize #003","2.892","6.676","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Grid Modernize #003","Grid Modernize #004","5.397","3.638","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Grid Modernize #004","Grid Modernize #005","4.463","2.895","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Grid Modernize #005","Grid Modernize #001","7.992","5.523","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":308},{"label":"Fev","value":362},{"label":"Mar","value":352},{"label":"Abr","value":303},{"label":"Mai","value":519},{"label":"Jun","value":460},{"label":"Jul","value":660},{"label":"Ago","value":493},{"label":"Set","value":309},{"label":"Out","value":553},{"label":"Nov","value":635},{"label":"Dez","value":498}];
const MX = 660;
