...
/* ═══ Packaging Ops — Corrugated Prod ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1252", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "454", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "832", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "170759874", cells: ["PAC-3874", "Corrugated Prod Item 1", "27/7/2026", "€9974"], status: "active" as const },
    { id: "170763445", cells: ["PAC-7445", "Corrugated Prod Item 2", "14/2/2026", "€13 545"], status: "pending" as const },
    { id: "170767016", cells: ["PAC-2016", "Corrugated Prod Item 3", "1/9/2026", "€17 116"], status: "completed" as const },
    { id: "170770587", cells: ["PAC-5587", "Corrugated Prod Item 4", "16/4/2026", "€20 687"], status: "warning" as const },
    { id: "170774158", cells: ["PAC-9158", "Corrugated Prod Item 5", "3/11/2026", "€24 258"], status: "active" as const },
];
...
export default function PackagingOpsCorrugatedProdPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corrugated Prod</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Corrugated Prod</p>
                    </div>
                </div>
