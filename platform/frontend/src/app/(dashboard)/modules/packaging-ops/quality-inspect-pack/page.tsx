...
/* ═══ Packaging Ops — Quality Inspect Pack ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3904", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "303", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2682", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "269391307", cells: ["PAC-4307", "Quality Inspect Pack Item 1", "4/8/2026", "€41 407"], status: "active" as const },
    { id: "269394878", cells: ["PAC-7878", "Quality Inspect Pack Item 2", "19/3/2026", "€44 978"], status: "pending" as const },
    { id: "269398449", cells: ["PAC-2449", "Quality Inspect Pack Item 3", "6/10/2026", "€48 549"], status: "completed" as const },
    { id: "269402020", cells: ["PAC-6020", "Quality Inspect Pack Item 4", "21/5/2026", "€2120"], status: "warning" as const },
    { id: "269405591", cells: ["PAC-9591", "Quality Inspect Pack Item 5", "8/12/2026", "€5691"], status: "active" as const },
];
...
export default function PackagingOpsQualityInspectPackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Inspect Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Quality Inspect Pack</p>
                    </div>
                </div>
