...
/* ═══ Packaging Ops — Design Prepress ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1920", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "305", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "573", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "80%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "955621693", cells: ["PAC-2693", "Design Prepress Item 1", "6/2/2026", "€21 793"], status: "active" as const },
    { id: "955625264", cells: ["PAC-6264", "Design Prepress Item 2", "21/9/2026", "€25 364"], status: "pending" as const },
    { id: "955628835", cells: ["PAC-9835", "Design Prepress Item 3", "8/4/2026", "€28 935"], status: "completed" as const },
    { id: "955632406", cells: ["PAC-4406", "Design Prepress Item 4", "23/11/2026", "€32 506"], status: "warning" as const },
    { id: "955635977", cells: ["PAC-7977", "Design Prepress Item 5", "10/6/2026", "€36 077"], status: "active" as const },
];
...
export default function PackagingOpsDesignPrepressPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Design Prepress</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Design Prepress</p>
                    </div>
                </div>
