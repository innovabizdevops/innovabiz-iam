...
/* ═══ Packaging Ops — Waste Reduce Pack ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "142", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "380", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1600", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2131818312", cells: ["PAC-7312", "Waste Reduce Pack Item 1", "9/1/2026", "€18 412"], status: "active" as const },
    { id: "2131821883", cells: ["PAC-1883", "Waste Reduce Pack Item 2", "24/8/2026", "€21 983"], status: "pending" as const },
    { id: "2131825454", cells: ["PAC-5454", "Waste Reduce Pack Item 3", "11/3/2026", "€25 554"], status: "completed" as const },
    { id: "2131829025", cells: ["PAC-9025", "Waste Reduce Pack Item 4", "26/10/2026", "€29 125"], status: "warning" as const },
    { id: "2131832596", cells: ["PAC-3596", "Waste Reduce Pack Item 5", "13/5/2026", "€32 696"], status: "active" as const },
];
...
export default function PackagingOpsWasteReducePackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Waste Reduce Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Waste Reduce Pack</p>
                    </div>
                </div>
