...
/* ═══ Packaging Ops — Sustainability Pack ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3431", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "167", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3110", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "74%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "228412147", cells: ["PAC-2147", "Sustainability Pack Item 1", "20/8/2026", "€12 247"], status: "active" as const },
    { id: "228415718", cells: ["PAC-5718", "Sustainability Pack Item 2", "7/3/2026", "€15 818"], status: "pending" as const },
    { id: "228419289", cells: ["PAC-9289", "Sustainability Pack Item 3", "22/10/2026", "€19 389"], status: "completed" as const },
    { id: "228422860", cells: ["PAC-3860", "Sustainability Pack Item 4", "9/5/2026", "€22 960"], status: "warning" as const },
    { id: "228426431", cells: ["PAC-7431", "Sustainability Pack Item 5", "24/12/2026", "€26 531"], status: "active" as const },
];
...
export default function PackagingOpsSustainabilityPackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sustainability Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Sustainability Pack</p>
                    </div>
                </div>
