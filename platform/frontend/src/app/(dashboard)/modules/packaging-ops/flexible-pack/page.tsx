...
/* ═══ Packaging Ops — Flexible Pack ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "2271", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "413", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3687", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2085676457", cells: ["PAC-8457", "Flexible Pack Item 1", "26/6/2026", "€26 557"], status: "active" as const },
    { id: "2085680028", cells: ["PAC-3028", "Flexible Pack Item 2", "13/1/2026", "€30 128"], status: "pending" as const },
    { id: "2085683599", cells: ["PAC-6599", "Flexible Pack Item 3", "28/8/2026", "€33 699"], status: "completed" as const },
    { id: "2085687170", cells: ["PAC-1170", "Flexible Pack Item 4", "15/3/2026", "€37 270"], status: "warning" as const },
    { id: "2085690741", cells: ["PAC-4741", "Flexible Pack Item 5", "2/10/2026", "€40 841"], status: "active" as const },
];
...
export default function PackagingOpsFlexiblePackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Flexible Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Flexible Pack</p>
                    </div>
                </div>
