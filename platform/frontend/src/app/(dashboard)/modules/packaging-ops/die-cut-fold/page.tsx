...
/* ═══ Packaging Ops — Die Cut Fold ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "3290", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "48", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "369", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1183000732", cells: ["PAC-5732", "Die Cut Fold Item 1", "5/5/2026", "€832"], status: "active" as const },
    { id: "1183004303", cells: ["PAC-9303", "Die Cut Fold Item 2", "20/12/2026", "€4403"], status: "pending" as const },
    { id: "1183007874", cells: ["PAC-3874", "Die Cut Fold Item 3", "7/7/2026", "€7974"], status: "completed" as const },
    { id: "1183011445", cells: ["PAC-7445", "Die Cut Fold Item 4", "22/2/2026", "€11 545"], status: "warning" as const },
    { id: "1183015016", cells: ["PAC-2016", "Die Cut Fold Item 5", "9/9/2026", "€15 116"], status: "active" as const },
];
...
export default function PackagingOpsDieCutFoldPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Die Cut Fold</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Die Cut Fold</p>
                    </div>
                </div>
