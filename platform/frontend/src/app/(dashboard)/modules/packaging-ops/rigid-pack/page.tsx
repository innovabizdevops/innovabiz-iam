...
/* ═══ Packaging Ops — Rigid Pack ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "56", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "7", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1590", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "616463539", cells: ["PAC-9539", "Rigid Pack Item 1", "28/8/2026", "€13 639"], status: "active" as const },
    { id: "616467110", cells: ["PAC-4110", "Rigid Pack Item 2", "15/3/2026", "€17 210"], status: "pending" as const },
    { id: "616470681", cells: ["PAC-7681", "Rigid Pack Item 3", "2/10/2026", "€20 781"], status: "completed" as const },
    { id: "616474252", cells: ["PAC-2252", "Rigid Pack Item 4", "17/5/2026", "€24 352"], status: "warning" as const },
    { id: "616477823", cells: ["PAC-5823", "Rigid Pack Item 5", "4/12/2026", "€27 923"], status: "active" as const },
];
...
export default function PackagingOpsRigidPackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rigid Pack</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Rigid Pack</p>
                    </div>
                </div>
