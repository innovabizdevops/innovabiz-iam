...
/* ═══ Packaging Ops — Customer Artwork ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1328", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "395", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1649", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1612485495", cells: ["PAC-1495", "Customer Artwork Item 1", "20/4/2026", "€35 595"], status: "active" as const },
    { id: "1612489066", cells: ["PAC-5066", "Customer Artwork Item 2", "7/11/2026", "€39 166"], status: "pending" as const },
    { id: "1612492637", cells: ["PAC-8637", "Customer Artwork Item 3", "22/6/2026", "€42 737"], status: "completed" as const },
    { id: "1612496208", cells: ["PAC-3208", "Customer Artwork Item 4", "9/1/2026", "€46 308"], status: "warning" as const },
    { id: "1612499779", cells: ["PAC-6779", "Customer Artwork Item 5", "24/8/2026", "€49 879"], status: "active" as const },
];
...
export default function PackagingOpsCustomerArtworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Artwork</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Customer Artwork</p>
                    </div>
                </div>
