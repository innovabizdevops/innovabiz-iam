...
/* ═══ Packaging Ops — Label Sleeve ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total", value: "1291", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "157", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2870", trend: "-1%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1208322137", cells: ["PAC-1137", "Label Sleeve Item 1", "2/6/2026", "€22 237"], status: "active" as const },
    { id: "1208325708", cells: ["PAC-4708", "Label Sleeve Item 2", "17/1/2026", "€25 808"], status: "pending" as const },
    { id: "1208329279", cells: ["PAC-8279", "Label Sleeve Item 3", "4/8/2026", "€29 379"], status: "completed" as const },
    { id: "1208332850", cells: ["PAC-2850", "Label Sleeve Item 4", "19/3/2026", "€32 950"], status: "warning" as const },
    { id: "1208336421", cells: ["PAC-6421", "Label Sleeve Item 5", "6/10/2026", "€36 521"], status: "active" as const },
];
...
export default function PackagingOpsLabelSleevePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Label Sleeve</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Packaging Ops • Label Sleeve</p>
                    </div>
                </div>
