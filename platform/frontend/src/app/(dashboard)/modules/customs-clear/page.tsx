...
export default function CustomsClearPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Customs Clear</h1><p className="text-sm text-muted-foreground">Customs Clear • iBOS Enterprise</p></div>
