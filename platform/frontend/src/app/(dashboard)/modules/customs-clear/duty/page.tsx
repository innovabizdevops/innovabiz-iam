...
const ACCENT = "#6366f1";
const MODULE = "Customs Clearance";
const PAGE = "Duty";
const KPIS = [{"l":"Total Customs Clear","v":"€46103","t":"+7.4%","d":"up"},{"l":"Duty Ativos","v":"3.274","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"71.2%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.5%","d":"up"}];
const COLS = ["ID","Duty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Clear #001","Customs Clear #002","8.807","5.780","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Clear #002","Customs Clear #003","2.111","1.506","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Clear #003","Customs Clear #004","5.751","3.800","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Clear #004","Customs Clear #005","2.106","8.806","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Clear #005","Customs Clear #001","6.660","6.914","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":321},{"label":"Mar","value":557},{"label":"Abr","value":365},{"label":"Mai","value":286},{"label":"Jun","value":314},{"label":"Jul","value":294},{"label":"Ago","value":458},{"label":"Set","value":299},{"label":"Out","value":400},{"label":"Nov","value":613},{"label":"Dez","value":314}];
const MX = 613;
