...
const PAGE = "Broker";
const KPIS = [{"l":"Total Customs Clear","v":"€91969","t":"+8.1%","d":"up"},{"l":"Broker Ativos","v":"1.310","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+8.6%","d":"up"}];
const COLS = ["ID","Broker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Clear #001","Customs Clear #002","6.191","4.418","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Clear #002","Customs Clear #003","6.647","1.146","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Clear #003","Customs Clear #004","5.488","313","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Clear #004","Customs Clear #005","4.015","1.715","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Clear #005","Customs Clear #001","7.556","4.465","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":872},{"label":"Mar","value":598},{"label":"Abr","value":601},{"label":"Mai","value":734},{"label":"Jun","value":541},{"label":"Jul","value":575},{"label":"Ago","value":611},{"label":"Set","value":781},{"label":"Out","value":630},{"label":"Nov","value":627},{"label":"Dez","value":624}];
const MX = 872;
