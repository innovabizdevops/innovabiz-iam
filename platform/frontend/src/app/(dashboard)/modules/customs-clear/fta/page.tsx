...
const PAGE = "FTA";
const KPIS = [{"l":"Total Customs Clear","v":"€65095","t":"-1.5%","d":"down"},{"l":"FTA Ativos","v":"7.757","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"65","t":"-2.2%","d":"down"}];
const COLS = ["ID","FTA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Customs Clear #001","Customs Clear #002","5.819","7.754","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Customs Clear #002","Customs Clear #003","1.573","1.342","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Customs Clear #003","Customs Clear #004","998","3.601","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Customs Clear #004","Customs Clear #005","5.254","2.589","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Customs Clear #005","Customs Clear #001","5.259","8.832","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":686},{"label":"Mar","value":770},{"label":"Abr","value":639},{"label":"Mai","value":905},{"label":"Jun","value":549},{"label":"Jul","value":811},{"label":"Ago","value":911},{"label":"Set","value":874},{"label":"Out","value":574},{"label":"Nov","value":864},{"label":"Dez","value":723}];
const MX = 911;
