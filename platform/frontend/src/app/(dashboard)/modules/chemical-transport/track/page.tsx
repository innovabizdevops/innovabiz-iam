...
const ACCENT = "#6366f1";
const MODULE = "Chemical Transport";
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"2.416","t":"+12.1%","d":"up"},{"l":"Treinos/Semana","v":"3863","t":"-2.6%","d":"down"},{"l":"Competições","v":"822","t":"+16.8%","d":"up"},{"l":"Performance Score","v":"65","t":"+9.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.385","1.374","2.595","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.635","8.626","2.920","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.285","4.152","3.517","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.785","5.539","6.709","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.250","7.010","6.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":553},{"label":"Mar","value":498},{"label":"Abr","value":276},{"label":"Mai","value":495},{"label":"Jun","value":637},{"label":"Jul","value":561},{"label":"Ago","value":493},{"label":"Set","value":369},{"label":"Out","value":624},{"label":"Nov","value":378},{"label":"Dez","value":366}];
const MX = 637;
