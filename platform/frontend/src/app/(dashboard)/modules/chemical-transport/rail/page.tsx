...
const PAGE = "Rail Car";
const KPIS = [{"l":"Veículos Operação","v":"1.939","t":"+5.7%","d":"up"},{"l":"Viagens/Dia","v":"3805","t":"+2.4%","d":"up"},{"l":"Pontualidade (%)","v":"89.9%","t":"-5.9%","d":"down"},{"l":"Passageiros/Dia","v":"3447","t":"-4.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-23","2026-02-03","1.750","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-23","2026-01-13","3.772","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-23","2026-03-07","8.464","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-23","2026-02-27","6.578","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-01-01","2026-03-05","2.910","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":873},{"label":"Mar","value":735},{"label":"Abr","value":904},{"label":"Mai","value":817},{"label":"Jun","value":832},{"label":"Jul","value":607},{"label":"Ago","value":710},{"label":"Set","value":638},{"label":"Out","value":637},{"label":"Nov","value":906},{"label":"Dez","value":811}];
const MX = 906;
