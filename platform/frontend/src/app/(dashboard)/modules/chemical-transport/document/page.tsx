...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"1.325","t":"+14.6%","d":"up"},{"l":"Submissões/Dia","v":"1231","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"4.502","t":"+1.4%","d":"up"},{"l":"Templates","v":"2.900","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.207","2026-01-03","1.209","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","333","2026-03-12","2.779","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.384","2026-03-19","2.810","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.103","2026-02-02","2.669","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.101","2026-03-26","341","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":791},{"label":"Mar","value":661},{"label":"Abr","value":906},{"label":"Mai","value":587},{"label":"Jun","value":615},{"label":"Jul","value":729},{"label":"Ago","value":842},{"label":"Set","value":890},{"label":"Out","value":887},{"label":"Nov","value":584},{"label":"Dez","value":773}];
const MX = 906;
