...
export default function ChemicalTransportPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chemical Transport</h1><p className="text-sm text-muted-foreground">Chemical Transport • iBOS Enterprise</p></div>
