...
const PAGE = "Tanker";
const KPIS = [{"l":"Atletas Registados","v":"4.268","t":"+6.3%","d":"up"},{"l":"Treinos/Semana","v":"3353","t":"+15.8%","d":"up"},{"l":"Competições","v":"7.393","t":"-3.4%","d":"down"},{"l":"Performance Score","v":"71","t":"+16.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.529","8.051","2.585","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.694","5.061","7.037","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.201","2.371","6.863","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.264","470","8.101","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.420","5.429","3.333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":779},{"label":"Mar","value":726},{"label":"Abr","value":656},{"label":"Mai","value":833},{"label":"Jun","value":873},{"label":"Jul","value":896},{"label":"Ago","value":1035},{"label":"Set","value":724},{"label":"Out","value":753},{"label":"Nov","value":769},{"label":"Dez","value":697}];
const MX = 1035;
