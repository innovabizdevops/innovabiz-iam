...
const PAGE = "HazMat";
const KPIS = [{"l":"Atletas Registados","v":"5.640","t":"+0.4%","d":"up"},{"l":"Treinos/Semana","v":"5051","t":"+2.4%","d":"up"},{"l":"Competições","v":"521","t":"+6.1%","d":"up"},{"l":"Performance Score","v":"80","t":"+1.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.995","8.778","7.782","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","5.020","1.668","4.698","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.022","4.302","7.434","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.187","5.402","348","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.011","6.378","1.104","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":568},{"label":"Mar","value":686},{"label":"Abr","value":548},{"label":"Mai","value":615},{"label":"Jun","value":809},{"label":"Jul","value":797},{"label":"Ago","value":708},{"label":"Set","value":760},{"label":"Out","value":606},{"label":"Nov","value":902},{"label":"Dez","value":541}];
const MX = 902;
