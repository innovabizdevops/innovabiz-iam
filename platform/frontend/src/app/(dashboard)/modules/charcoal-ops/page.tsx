...
/* ═══ Charcoal Operations — Dashboard ═══ */

const ACCENT = "#0d3b1e";

const KPIS = [
    { label: "Total Registos", value: "5561", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4342", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€233K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1713051961", cells: ["CHA-1961", "Charcoal Operations Item 1", "6/2/2026", "€2061"], status: "active" as const },
    { id: "1713055532", cells: ["CHA-5532", "Charcoal Operations Item 2", "21/9/2026", "€5632"], status: "pending" as const },
    { id: "1713059103", cells: ["CHA-9103", "Charcoal Operations Item 3", "8/4/2026", "€9203"], status: "completed" as const },
    { id: "1713062674", cells: ["CHA-3674", "Charcoal Operations Item 4", "23/11/2026", "€12 774"], status: "warning" as const },
    { id: "1713066245", cells: ["CHA-7245", "Charcoal Operations Item 5", "10/6/2026", "€16 345"], status: "active" as const },
];
...
export default function CharcoalOperationsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Charcoal Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Charcoal Operations</p>
                    </div>
                </div>
