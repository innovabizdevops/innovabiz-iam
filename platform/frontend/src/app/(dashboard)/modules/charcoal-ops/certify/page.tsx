...
const ACCENT = "#0d3b1e";
const MODULE = "Charcoal Operations";
const PAGE = "Certify";
const KPIS = [{"l":"Total Charcoal Ops","v":"7.817","t":"+7.0%","d":"up"},{"l":"Certify Ativos","v":"1.236","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.4%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charcoal Ops #001","Charcoal Ops #002","433","7.704","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Charcoal Ops #002","Charcoal Ops #003","644","6.768","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Charcoal Ops #003","Charcoal Ops #004","5.571","1.951","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Charcoal Ops #004","Charcoal Ops #005","7.572","1.501","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charcoal Ops #005","Charcoal Ops #001","3.236","1.411","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":715},{"label":"Mar","value":643},{"label":"Abr","value":696},{"label":"Mai","value":715},{"label":"Jun","value":856},{"label":"Jul","value":554},{"label":"Ago","value":638},{"label":"Set","value":849},{"label":"Out","value":522},{"label":"Nov","value":829},{"label":"Dez","value":759}];
const MX = 856;
