...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.298","t":"-5.0%","d":"down"},{"l":"NC Abertas","v":"6.840","t":"+14.4%","d":"up"},{"l":"Conformidade (%)","v":"68.0%","t":"-3.9%","d":"down"},{"l":"CAPAs Pendentes","v":"2.157","t":"-0.5%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.799","83.7%","2.633","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.177","82.8%","5.910","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.872","97.5%","2.814","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.955","81.3%","2.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.945","72.2%","8.020","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":631},{"label":"Mar","value":786},{"label":"Abr","value":784},{"label":"Mai","value":769},{"label":"Jun","value":963},{"label":"Jul","value":767},{"label":"Ago","value":851},{"label":"Set","value":706},{"label":"Out","value":872},{"label":"Nov","value":737},{"label":"Dez","value":939}];
const MX = 963;
