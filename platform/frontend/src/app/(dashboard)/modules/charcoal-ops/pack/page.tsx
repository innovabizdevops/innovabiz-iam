...
const PAGE = "Pack";
const KPIS = [{"l":"Total Charcoal Ops","v":"2.558","t":"+10.2%","d":"up"},{"l":"Pack Ativos","v":"5.181","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"65.8%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"73","t":"-0.6%","d":"down"}];
const COLS = ["ID","Pack","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charcoal Ops #001","Charcoal Ops #002","366","250","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Charcoal Ops #002","Charcoal Ops #003","4.294","5.926","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Charcoal Ops #003","Charcoal Ops #004","6.147","4.817","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Charcoal Ops #004","Charcoal Ops #005","8.557","8.535","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charcoal Ops #005","Charcoal Ops #001","1.853","3.078","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":693},{"label":"Mar","value":716},{"label":"Abr","value":574},{"label":"Mai","value":719},{"label":"Jun","value":894},{"label":"Jul","value":696},{"label":"Ago","value":831},{"label":"Set","value":683},{"label":"Out","value":612},{"label":"Nov","value":804},{"label":"Dez","value":714}];
const MX = 906;
