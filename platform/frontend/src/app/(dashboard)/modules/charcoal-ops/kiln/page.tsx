...
const PAGE = "Kiln";
const KPIS = [{"l":"Total Charcoal Ops","v":"5.312","t":"-4.7%","d":"down"},{"l":"Kiln Ativos","v":"5.588","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"80.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.9%","d":"up"}];
const COLS = ["ID","Kiln","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Charcoal Ops #001","Charcoal Ops #002","1.940","4.411","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Charcoal Ops #002","Charcoal Ops #003","131","4.604","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Charcoal Ops #003","Charcoal Ops #004","3.883","6.424","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Charcoal Ops #004","Charcoal Ops #005","6.762","6.969","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Charcoal Ops #005","Charcoal Ops #001","5.815","8.320","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":814},{"label":"Mar","value":615},{"label":"Abr","value":598},{"label":"Mai","value":599},{"label":"Jun","value":668},{"label":"Jul","value":745},{"label":"Ago","value":619},{"label":"Set","value":645},{"label":"Out","value":927},{"label":"Nov","value":725},{"label":"Dez","value":909}];
const MX = 927;
