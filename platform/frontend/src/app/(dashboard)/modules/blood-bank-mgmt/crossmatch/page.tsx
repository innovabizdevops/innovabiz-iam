...
const ACCENT = "#6366f1";
const MODULE = "Blood Bank";
const PAGE = "Cross Match";
const KPIS = [{"l":"Atletas Registados","v":"7.417","t":"-2.1%","d":"down"},{"l":"Treinos/Semana","v":"3691","t":"-4.7%","d":"down"},{"l":"Competições","v":"7.930","t":"+3.4%","d":"up"},{"l":"Performance Score","v":"86","t":"+14.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.255","2.635","3.166","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","754","583","128","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","591","8.919","2.364","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.150","6.524","1.470","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.487","1.961","6.803","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":757},{"label":"Mar","value":776},{"label":"Abr","value":792},{"label":"Mai","value":754},{"label":"Jun","value":1077},{"label":"Jul","value":790},{"label":"Ago","value":1029},{"label":"Set","value":881},{"label":"Out","value":775},{"label":"Nov","value":866},{"label":"Dez","value":897}];
const MX = 1077;
