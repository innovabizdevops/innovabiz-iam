...
const PAGE = "Donation";
const KPIS = [{"l":"Total Blood Bank Mgmt","v":"5.519","t":"+7.1%","d":"up"},{"l":"Donation Ativos","v":"6.655","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"78","t":"-5.0%","d":"down"}];
const COLS = ["ID","Donation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blood Bank Mgmt #001","Blood Bank Mgmt #002","5.686","694","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Blood Bank Mgmt #002","Blood Bank Mgmt #003","8.798","674","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Blood Bank Mgmt #003","Blood Bank Mgmt #004","3.413","8.094","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Blood Bank Mgmt #004","Blood Bank Mgmt #005","545","5.711","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blood Bank Mgmt #005","Blood Bank Mgmt #001","4.263","1.497","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":700},{"label":"Mar","value":554},{"label":"Abr","value":771},{"label":"Mai","value":431},{"label":"Jun","value":495},{"label":"Jul","value":497},{"label":"Ago","value":682},{"label":"Set","value":621},{"label":"Out","value":788},{"label":"Nov","value":624},{"label":"Dez","value":747}];
const MX = 788;
