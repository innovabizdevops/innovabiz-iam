...
const PAGE = "Storage";
const KPIS = [{"l":"Total Blood Bank Mgmt","v":"4.259","t":"+3.9%","d":"up"},{"l":"Storage Ativos","v":"9.052","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+3.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+14.4%","d":"up"}];
const COLS = ["ID","Storage","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blood Bank Mgmt #001","Blood Bank Mgmt #002","5.771","7.337","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Blood Bank Mgmt #002","Blood Bank Mgmt #003","5.530","5.356","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Blood Bank Mgmt #003","Blood Bank Mgmt #004","4.786","6.180","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Blood Bank Mgmt #004","Blood Bank Mgmt #005","2.575","8.988","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blood Bank Mgmt #005","Blood Bank Mgmt #001","2.679","5.025","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":541},{"label":"Mar","value":689},{"label":"Abr","value":668},{"label":"Mai","value":519},{"label":"Jun","value":497},{"label":"Jul","value":464},{"label":"Ago","value":654},{"label":"Set","value":412},{"label":"Out","value":524},{"label":"Nov","value":573},{"label":"Dez","value":475}];
const MX = 689;
