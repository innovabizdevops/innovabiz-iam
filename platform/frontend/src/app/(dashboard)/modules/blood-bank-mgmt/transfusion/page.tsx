...
const PAGE = "Transfusion";
const KPIS = [{"l":"Total Blood Bank Mgmt","v":"3.342","t":"+4.9%","d":"up"},{"l":"Transfusion Ativos","v":"6.658","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"82","t":"+6.8%","d":"up"}];
const COLS = ["ID","Transfusion","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blood Bank Mgmt #001","Blood Bank Mgmt #002","3.165","751","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Blood Bank Mgmt #002","Blood Bank Mgmt #003","7.442","4.543","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Blood Bank Mgmt #003","Blood Bank Mgmt #004","4.895","5.159","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Blood Bank Mgmt #004","Blood Bank Mgmt #005","2.032","2.182","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blood Bank Mgmt #005","Blood Bank Mgmt #001","8.531","2.070","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":536},{"label":"Mar","value":576},{"label":"Abr","value":565},{"label":"Mai","value":542},{"label":"Jun","value":567},{"label":"Jul","value":708},{"label":"Ago","value":438},{"label":"Set","value":492},{"label":"Out","value":541},{"label":"Nov","value":548},{"label":"Dez","value":551}];
const MX = 708;
