...
const PAGE = "Testing";
const KPIS = [{"l":"Total Blood Bank Mgmt","v":"3.303","t":"+14.3%","d":"up"},{"l":"Testing Ativos","v":"3.727","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"94.4%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+8.7%","d":"up"}];
const COLS = ["ID","Testing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blood Bank Mgmt #001","Blood Bank Mgmt #002","6.329","308","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Blood Bank Mgmt #002","Blood Bank Mgmt #003","698","7.703","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Blood Bank Mgmt #003","Blood Bank Mgmt #004","1.459","5.262","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Blood Bank Mgmt #004","Blood Bank Mgmt #005","5.754","478","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blood Bank Mgmt #005","Blood Bank Mgmt #001","4.582","1.556","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":348},{"label":"Fev","value":645},{"label":"Mar","value":478},{"label":"Abr","value":301},{"label":"Mai","value":361},{"label":"Jun","value":505},{"label":"Jul","value":482},{"label":"Ago","value":587},{"label":"Set","value":581},{"label":"Out","value":437},{"label":"Nov","value":287},{"label":"Dez","value":298}];
const MX = 645;
