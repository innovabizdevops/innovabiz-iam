...
const KPIS = [{"l":"Eventos Planeados","v":"1.229","t":"+0.4%","d":"up"},{"l":"Participantes","v":"5.228","t":"+7.7%","d":"up"},{"l":"NPS Evento","v":"93","t":"+11.5%","d":"up"},{"l":"Receita (€)","v":"€77320","t":"-0.5%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-16","5.737","8.479","€ 5047.11","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-26","6.148","2.910","€ 32860.35","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-10","6.733","8.725","€ 38414.84","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-14","1.520","4.997","€ 43106.93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-23","4.761","4.030","€ 41133.64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":605},{"label":"Mar","value":724},{"label":"Abr","value":923},{"label":"Mai","value":745},{"label":"Jun","value":791},{"label":"Jul","value":696},{"label":"Ago","value":696},{"label":"Set","value":932},{"label":"Out","value":671},{"label":"Nov","value":823},{"label":"Dez","value":642}];
const MX = 932;
