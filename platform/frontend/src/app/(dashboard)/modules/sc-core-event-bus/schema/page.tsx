...
const PAGE = "Schema";
const KPIS = [{"l":"Eventos Planeados","v":"2.644","t":"-3.6%","d":"down"},{"l":"Participantes","v":"4.947","t":"+3.4%","d":"up"},{"l":"NPS Evento","v":"59","t":"+12.1%","d":"up"},{"l":"Receita (€)","v":"€72912","t":"+7.7%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-06","2.381","4.298","€ 11005.90","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-27","1.604","6.482","€ 43578.06","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-23","3.757","1.676","€ 41996.23","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-07","6.370","2.702","€ 22883.47","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-28","5.200","8.051","€ 27932.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":879},{"label":"Mar","value":885},{"label":"Abr","value":700},{"label":"Mai","value":861},{"label":"Jun","value":709},{"label":"Jul","value":920},{"label":"Ago","value":734},{"label":"Set","value":924},{"label":"Out","value":1034},{"label":"Nov","value":957},{"label":"Dez","value":676}];
const MX = 1034;
