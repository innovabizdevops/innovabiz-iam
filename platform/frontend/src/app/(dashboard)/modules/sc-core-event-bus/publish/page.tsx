...
const PAGE = "Publish";
const KPIS = [{"l":"Eventos Planeados","v":"357","t":"+11.3%","d":"up"},{"l":"Participantes","v":"7.320","t":"-4.7%","d":"down"},{"l":"NPS Evento","v":"86","t":"+3.7%","d":"up"},{"l":"Receita (€)","v":"€23699","t":"+5.8%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-04","5.751","6.758","€ 43104.43","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-16","4.222","5.609","€ 44239.76","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-19","7.663","8.079","€ 4555.36","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-05","6.395","2.022","€ 28509.07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-21","1.648","3.657","€ 37901.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":470},{"label":"Fev","value":702},{"label":"Mar","value":697},{"label":"Abr","value":439},{"label":"Mai","value":724},{"label":"Jun","value":549},{"label":"Jul","value":623},{"label":"Ago","value":334},{"label":"Set","value":667},{"label":"Out","value":697},{"label":"Nov","value":628},{"label":"Dez","value":478}];
const MX = 724;
