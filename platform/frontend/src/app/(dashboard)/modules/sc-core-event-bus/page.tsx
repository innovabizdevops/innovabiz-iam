...
/* ═══ SC: Core Event Bus — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "2229", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4485", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€123K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1275844829", cells: ["SC-5829", "SC: Core Event Bus Item 1", "22/6/2026", "€44 929"], status: "active" as const },
    { id: "1275848400", cells: ["SC-9400", "SC: Core Event Bus Item 2", "9/1/2026", "€48 500"], status: "pending" as const },
    { id: "1275851971", cells: ["SC-3971", "SC: Core Event Bus Item 3", "24/8/2026", "€2071"], status: "completed" as const },
    { id: "1275855542", cells: ["SC-7542", "SC: Core Event Bus Item 4", "11/3/2026", "€5642"], status: "warning" as const },
    { id: "1275859113", cells: ["SC-2113", "SC: Core Event Bus Item 5", "26/10/2026", "€9213"], status: "active" as const },
];
...
export default function ScCoreEventBusPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Event Bus</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Event Bus</p>
                    </div>
                </div>
