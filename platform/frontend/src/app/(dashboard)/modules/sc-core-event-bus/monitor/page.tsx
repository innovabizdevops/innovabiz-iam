...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Event Bus";
const PAGE = "Monitor";
const KPIS = [{"l":"Eventos Planeados","v":"4.322","t":"-3.1%","d":"down"},{"l":"Participantes","v":"4.641","t":"+11.6%","d":"up"},{"l":"NPS Evento","v":"75","t":"+10.9%","d":"up"},{"l":"Receita (€)","v":"€41777","t":"+9.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-26","3.837","7.053","€ 734.15","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-02","6.647","504","€ 39719.89","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-02","2.520","8.391","€ 26495.85","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-08","3.045","2.541","€ 192.85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-22","1.227","2.399","€ 23274.16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":1016},{"label":"Mar","value":913},{"label":"Abr","value":722},{"label":"Mai","value":1028},{"label":"Jun","value":946},{"label":"Jul","value":937},{"label":"Ago","value":680},{"label":"Set","value":844},{"label":"Out","value":902},{"label":"Nov","value":802},{"label":"Dez","value":827}];
const MX = 1028;
