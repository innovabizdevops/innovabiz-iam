...
const PAGE = "Mutual Plan";
const KPIS = [{"l":"Total Deal Room","v":"5.754","t":"+3.0%","d":"up"},{"l":"Mutual Plan Ativos","v":"3.303","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"85.2%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"82","t":"-2.3%","d":"down"}];
const COLS = ["ID","Mutual Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deal Room #001","Deal Room #002","9.017","3.151","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Deal Room #002","Deal Room #003","8.962","7.415","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Deal Room #003","Deal Room #004","8.529","2.001","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Deal Room #004","Deal Room #005","6.335","6.504","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deal Room #005","Deal Room #001","4.023","7.992","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":786},{"label":"Mar","value":671},{"label":"Abr","value":892},{"label":"Mai","value":950},{"label":"Jun","value":631},{"label":"Jul","value":929},{"label":"Ago","value":955},{"label":"Set","value":667},{"label":"Out","value":647},{"label":"Nov","value":739},{"label":"Dez","value":655}];
const MX = 955;
