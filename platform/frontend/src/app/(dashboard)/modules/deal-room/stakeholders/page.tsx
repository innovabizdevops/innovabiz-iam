...
const KPIS = [{"l":"Total Deal Room","v":"3.752","t":"-0.5%","d":"down"},{"l":"Stakeholder Map Ativos","v":"4.504","t":"+1.9%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"77","t":"+10.6%","d":"up"}];
const COLS = ["ID","Stakeholder Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deal Room #001","Deal Room #002","1.842","4.456","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Deal Room #002","Deal Room #003","1.456","5.319","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Deal Room #003","Deal Room #004","4.444","4.902","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Deal Room #004","Deal Room #005","5.405","7.539","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deal Room #005","Deal Room #001","5.122","6.643","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":946},{"label":"Mar","value":887},{"label":"Abr","value":1069},{"label":"Mai","value":1030},{"label":"Jun","value":709},{"label":"Jul","value":1065},{"label":"Ago","value":847},{"label":"Set","value":896},{"label":"Out","value":837},{"label":"Nov","value":1037},{"label":"Dez","value":910}];
const MX = 1069;
