...
const PAGE = "Activity Feed";
const KPIS = [{"l":"Total Deal Room","v":"6.222","t":"+13.2%","d":"up"},{"l":"Activity Feed Ativos","v":"2.629","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+7.6%","d":"up"}];
const COLS = ["ID","Activity Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Deal Room #001","Deal Room #002","8.026","1.747","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Deal Room #002","Deal Room #003","3.925","2.709","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Deal Room #003","Deal Room #004","1.179","8.161","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Deal Room #004","Deal Room #005","4.382","481","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Deal Room #005","Deal Room #001","2.519","4.905","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":805},{"label":"Mar","value":912},{"label":"Abr","value":963},{"label":"Mai","value":760},{"label":"Jun","value":800},{"label":"Jul","value":958},{"label":"Ago","value":1040},{"label":"Set","value":745},{"label":"Out","value":800},{"label":"Nov","value":841},{"label":"Dez","value":981}];
const MX = 1040;
