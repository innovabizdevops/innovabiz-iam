...
const KPIS = [{"l":"eNPS","v":"60","t":"+9.8%","d":"up"},{"l":"Engagement (%)","v":"73.2%","t":"+7.3%","d":"up"},{"l":"Turnover (%)","v":"89.3%","t":"+7.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"166","t":"-2.7%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.368","2026-03-05","68","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.452","2026-03-18","91","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.147","2026-03-13","87","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.134","2026-01-10","76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.295","2026-02-21","89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":530},{"label":"Mar","value":714},{"label":"Abr","value":638},{"label":"Mai","value":750},{"label":"Jun","value":448},{"label":"Jul","value":645},{"label":"Ago","value":605},{"label":"Set","value":525},{"label":"Out","value":565},{"label":"Nov","value":482},{"label":"Dez","value":522}];
const MX = 750;
