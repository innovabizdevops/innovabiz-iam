...
const ACCENT = "#4338ca";
const MODULE = "Deal Room";
const PAGE = "Document Share";
const KPIS = [{"l":"Formulários Ativos","v":"6.755","t":"+16.5%","d":"up"},{"l":"Submissões/Dia","v":"1554","t":"-2.2%","d":"down"},{"l":"Documentos Gerados","v":"4.894","t":"-5.3%","d":"down"},{"l":"Templates","v":"5.131","t":"-5.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.939","2026-03-08","4.959","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.094","2026-03-16","281","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.450","2026-01-13","3.649","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.846","2026-01-17","1.468","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.165","2026-01-16","526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":955},{"label":"Mar","value":716},{"label":"Abr","value":741},{"label":"Mai","value":758},{"label":"Jun","value":690},{"label":"Jul","value":764},{"label":"Ago","value":929},{"label":"Set","value":880},{"label":"Out","value":955},{"label":"Nov","value":1027},{"label":"Dez","value":677}];
const MX = 1027;
