...
const ACCENT = "#00bcf2";
const MODULE = "AI Copilot Studio";
const PAGE = "Entity";
const KPIS = [{"l":"Total Copilot Studio","v":"3.412","t":"+16.8%","d":"up"},{"l":"Entity Ativos","v":"8.455","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+14.1%","d":"up"},{"l":"Score Performance","v":"59","t":"+13.1%","d":"up"}];
const COLS = ["ID","Entity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copilot Studio #001","Copilot Studio #002","2.425","5.602","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Copilot Studio #002","Copilot Studio #003","7.123","1.858","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Copilot Studio #003","Copilot Studio #004","3.295","4.327","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Copilot Studio #004","Copilot Studio #005","4.955","2.713","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copilot Studio #005","Copilot Studio #001","4.335","4.322","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":464},{"label":"Mar","value":388},{"label":"Abr","value":468},{"label":"Mai","value":638},{"label":"Jun","value":532},{"label":"Jul","value":552},{"label":"Ago","value":374},{"label":"Set","value":334},{"label":"Out","value":585},{"label":"Nov","value":532},{"label":"Dez","value":312}];
const MX = 638;
