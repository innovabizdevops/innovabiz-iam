...
const PAGE = "Build";
const KPIS = [{"l":"Total Copilot Studio","v":"2.233","t":"+0.4%","d":"up"},{"l":"Build Ativos","v":"3.324","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"92.1%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+13.3%","d":"up"}];
const COLS = ["ID","Build","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Copilot Studio #001","Copilot Studio #002","5.673","8.210","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Copilot Studio #002","Copilot Studio #003","2.116","2.714","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Copilot Studio #003","Copilot Studio #004","1.812","2.298","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Copilot Studio #004","Copilot Studio #005","8.896","6.101","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Copilot Studio #005","Copilot Studio #001","8.311","6.397","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":756},{"label":"Fev","value":650},{"label":"Mar","value":463},{"label":"Abr","value":608},{"label":"Mai","value":464},{"label":"Jun","value":725},{"label":"Jul","value":773},{"label":"Ago","value":712},{"label":"Set","value":433},{"label":"Out","value":496},{"label":"Nov","value":516},{"label":"Dez","value":687}];
const MX = 773;
