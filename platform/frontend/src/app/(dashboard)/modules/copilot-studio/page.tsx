...
/* ═══ AI Copilot Studio — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "5438", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2030", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€108K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "484580638", cells: ["COP-3638", "AI Copilot Studio Item 1", "11/11/2026", "€30 738"], status: "active" as const },
    { id: "484584209", cells: ["COP-7209", "AI Copilot Studio Item 2", "26/6/2026", "€34 309"], status: "pending" as const },
    { id: "484587780", cells: ["COP-1780", "AI Copilot Studio Item 3", "13/1/2026", "€37 880"], status: "completed" as const },
    { id: "484591351", cells: ["COP-5351", "AI Copilot Studio Item 4", "28/8/2026", "€41 451"], status: "warning" as const },
    { id: "484594922", cells: ["COP-8922", "AI Copilot Studio Item 5", "15/3/2026", "€45 022"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Copilot Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Copilot Studio</p>
                    </div>
                </div>
