...
const KPIS = [{"l":"Dashboards Ativos","v":"4.824","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"3436","t":"+11.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.634","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.253","t":"+6.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1525","2026-02-13","4.281","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3846","2026-02-01","1.671","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3352","2026-03-02","8.130","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3433","2026-02-08","2.589","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2425","2026-01-04","3.208","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":423},{"label":"Mar","value":347},{"label":"Abr","value":529},{"label":"Mai","value":292},{"label":"Jun","value":615},{"label":"Jul","value":371},{"label":"Ago","value":453},{"label":"Set","value":581},{"label":"Out","value":234},{"label":"Nov","value":563},{"label":"Dez","value":416}];
const MX = 615;
