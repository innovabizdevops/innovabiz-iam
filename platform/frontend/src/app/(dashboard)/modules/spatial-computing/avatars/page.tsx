...
const PAGE = "Avatar System";
const KPIS = [{"l":"Quartos Ocupados","v":"8.399","t":"+13.5%","d":"up"},{"l":"RevPAR (€)","v":"€44095","t":"+17.9%","d":"up"},{"l":"Ocupação (%)","v":"72.0%","t":"+15.9%","d":"up"},{"l":"Guest Satisfaction","v":"3.743","t":"-5.9%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.343","2026-03-28","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.538","2026-02-19","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.105","2026-01-02","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.671","2026-01-10","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.011","2026-03-14","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":269},{"label":"Mar","value":397},{"label":"Abr","value":588},{"label":"Mai","value":230},{"label":"Jun","value":533},{"label":"Jul","value":266},{"label":"Ago","value":465},{"label":"Set","value":445},{"label":"Out","value":270},{"label":"Nov","value":511},{"label":"Dez","value":370}];
const MX = 588;
