...
const PAGE = "Haptic Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"2.534","t":"-2.2%","d":"down"},{"l":"Respostas/Semana","v":"4966","t":"-0.2%","d":"down"},{"l":"NPS Médio","v":"59","t":"+12.4%","d":"up"},{"l":"Taxa Resposta (%)","v":"66.9%","t":"+10.4%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","827","63","99.0%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","2.183","75","83.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","2.068","82","90.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.638","81","94.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","1.905","93","70.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":924},{"label":"Fev","value":544},{"label":"Mar","value":764},{"label":"Abr","value":895},{"label":"Mai","value":826},{"label":"Jun","value":548},{"label":"Jul","value":625},{"label":"Ago","value":763},{"label":"Set","value":874},{"label":"Out","value":893},{"label":"Nov","value":827},{"label":"Dez","value":610}];
const MX = 924;
