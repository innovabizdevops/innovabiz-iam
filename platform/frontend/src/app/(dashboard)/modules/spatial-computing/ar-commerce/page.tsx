...
const PAGE = "AR Commerce";
const KPIS = [{"l":"Pedidos/Dia","v":"1099","t":"+12.7%","d":"up"},{"l":"GMV (€)","v":"€95097","t":"-1.8%","d":"down"},{"l":"Conversão (%)","v":"82.5%","t":"+4.3%","d":"up"},{"l":"AOV (€)","v":"€70031","t":"+14.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 36962.47","8.813","6.778","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 14174.21","6.249","1.195","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 11173.69","2.744","7.207","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 26079.76","5.347","550","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 41855.94","8.090","1.746","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":578},{"label":"Mar","value":521},{"label":"Abr","value":509},{"label":"Mai","value":491},{"label":"Jun","value":541},{"label":"Jul","value":469},{"label":"Ago","value":576},{"label":"Set","value":352},{"label":"Out","value":563},{"label":"Nov","value":544},{"label":"Dez","value":429}];
const MX = 578;
...
export default function ArCommercePage() {
    return (
