...
const PAGE = "Virtual Showroom";
const KPIS = [{"l":"Quartos Ocupados","v":"4.819","t":"+5.1%","d":"up"},{"l":"RevPAR (€)","v":"€47343","t":"+13.1%","d":"up"},{"l":"Ocupação (%)","v":"68.3%","t":"+1.0%","d":"up"},{"l":"Guest Satisfaction","v":"3.397","t":"+10.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.496","2026-02-15","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.619","2026-03-13","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.920","2026-03-27","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.826","2026-03-23","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","780","2026-01-12","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":667},{"label":"Mar","value":741},{"label":"Abr","value":686},{"label":"Mai","value":682},{"label":"Jun","value":865},{"label":"Jul","value":793},{"label":"Ago","value":623},{"label":"Set","value":767},{"label":"Out","value":743},{"label":"Nov","value":722},{"label":"Dez","value":766}];
const MX = 865;
