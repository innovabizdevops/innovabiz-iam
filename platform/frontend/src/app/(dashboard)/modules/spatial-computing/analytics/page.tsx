...
const KPIS = [{"l":"Dashboards Ativos","v":"5.347","t":"+7.6%","d":"up"},{"l":"Queries/Dia","v":"3284","t":"+0.2%","d":"up"},{"l":"Dados Processados (GB)","v":"4.569","t":"+4.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.857","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1228","2026-01-22","8.564","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1594","2026-02-23","6.026","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3861","2026-03-10","3.402","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4659","2026-02-03","4.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2560","2026-03-22","6.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":635},{"label":"Mar","value":603},{"label":"Abr","value":749},{"label":"Mai","value":574},{"label":"Jun","value":559},{"label":"Jul","value":739},{"label":"Ago","value":397},{"label":"Set","value":767},{"label":"Out","value":745},{"label":"Nov","value":530},{"label":"Dez","value":502}];
const MX = 767;
