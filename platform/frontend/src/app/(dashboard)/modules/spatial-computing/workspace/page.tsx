...
const PAGE = "3D Workspace";
const KPIS = [{"l":"eNPS","v":"66","t":"+8.5%","d":"up"},{"l":"Engagement (%)","v":"79.1%","t":"+4.7%","d":"up"},{"l":"Turnover (%)","v":"72.2%","t":"-0.5%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"4.654","t":"+2.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.013","2026-02-05","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.380","2026-03-12","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.142","2026-01-08","86","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.887","2026-02-17","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","117","2026-03-25","68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":770},{"label":"Mar","value":895},{"label":"Abr","value":665},{"label":"Mai","value":632},{"label":"Jun","value":854},{"label":"Jul","value":572},{"label":"Ago","value":689},{"label":"Set","value":761},{"label":"Out","value":513},{"label":"Nov","value":575},{"label":"Dez","value":538}];
const MX = 895;
