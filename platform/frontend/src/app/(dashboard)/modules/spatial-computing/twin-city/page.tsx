...
const ACCENT = "#0891b2";
const MODULE = "Spatial Computing";
const PAGE = "Digital Twin City";
const KPIS = [{"l":"Twins Ativos","v":"2.318","t":"+6.7%","d":"up"},{"l":"Simulações/Dia","v":"1565","t":"+5.5%","d":"up"},{"l":"Precisão Modelo (%)","v":"90.9%","t":"+3.6%","d":"up"},{"l":"Latência Sync (ms)","v":"9ms","t":"-5.6%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","79.1%","2026-02-15","8.862","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","87.5%","2026-01-21","6.525","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","72.6%","2026-03-01","5.481","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.7%","2026-02-21","1.687","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","78.4%","2026-02-24","8.284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":706},{"label":"Mar","value":384},{"label":"Abr","value":617},{"label":"Mai","value":669},{"label":"Jun","value":617},{"label":"Jul","value":553},{"label":"Ago","value":683},{"label":"Set","value":383},{"label":"Out","value":513},{"label":"Nov","value":725},{"label":"Dez","value":750}];
const MX = 750;
...
export default function TwinCityPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0891b2'}}>DT</span></h1>
                </div>
