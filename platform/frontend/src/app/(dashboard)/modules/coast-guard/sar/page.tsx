...
const PAGE = "SAR";
const KPIS = [{"l":"Total Coast Guard","v":"1.816","t":"-2.3%","d":"down"},{"l":"SAR Ativos","v":"7.255","t":"+4.8%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.4%","d":"up"}];
const COLS = ["ID","SAR","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coast Guard #001","Coast Guard #002","2.011","5.779","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Coast Guard #002","Coast Guard #003","8.895","7.273","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Coast Guard #003","Coast Guard #004","6.579","3.401","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Coast Guard #004","Coast Guard #005","2.905","3.373","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coast Guard #005","Coast Guard #001","6.130","8.240","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":702},{"label":"Mar","value":686},{"label":"Abr","value":789},{"label":"Mai","value":708},{"label":"Jun","value":510},{"label":"Jul","value":576},{"label":"Ago","value":782},{"label":"Set","value":656},{"label":"Out","value":798},{"label":"Nov","value":632},{"label":"Dez","value":789}];
const MX = 798;
