...
export default function CoastGuardPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Coast Guard</h1><p className="text-sm text-muted-foreground">Coast Guard • iBOS Enterprise</p></div>
