...
const PAGE = "Patrol";
const KPIS = [{"l":"Total Coast Guard","v":"8.653","t":"+11.5%","d":"up"},{"l":"Patrol Ativos","v":"3.493","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"94","t":"+5.4%","d":"up"}];
const COLS = ["ID","Patrol","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coast Guard #001","Coast Guard #002","6.566","4.969","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Coast Guard #002","Coast Guard #003","1.055","1.535","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Coast Guard #003","Coast Guard #004","4.286","3.766","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Coast Guard #004","Coast Guard #005","5.459","6.679","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coast Guard #005","Coast Guard #001","2.383","787","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":746},{"label":"Mar","value":879},{"label":"Abr","value":909},{"label":"Mai","value":668},{"label":"Jun","value":820},{"label":"Jul","value":649},{"label":"Ago","value":624},{"label":"Set","value":917},{"label":"Out","value":759},{"label":"Nov","value":703},{"label":"Dez","value":726}];
const MX = 917;
