...
const PAGE = "Vessel";
const KPIS = [{"l":"Total Coast Guard","v":"7.887","t":"+10.7%","d":"up"},{"l":"Vessel Ativos","v":"5.698","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"80","t":"-4.1%","d":"down"}];
const COLS = ["ID","Vessel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coast Guard #001","Coast Guard #002","8.874","7.000","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Coast Guard #002","Coast Guard #003","6.803","4.369","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Coast Guard #003","Coast Guard #004","6.455","5.480","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Coast Guard #004","Coast Guard #005","7.095","1.520","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coast Guard #005","Coast Guard #001","7.172","2.880","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":622},{"label":"Mar","value":805},{"label":"Abr","value":720},{"label":"Mai","value":828},{"label":"Jun","value":737},{"label":"Jul","value":772},{"label":"Ago","value":506},{"label":"Set","value":595},{"label":"Out","value":898},{"label":"Nov","value":834},{"label":"Dez","value":659}];
const MX = 898;
