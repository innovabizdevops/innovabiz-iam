...
const ACCENT = "#6366f1";
const MODULE = "Coast Guard";
const PAGE = "Port Safety";
const KPIS = [{"l":"Total Coast Guard","v":"1.088","t":"+9.4%","d":"up"},{"l":"Port Safety Ativos","v":"557","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"80.7%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"83","t":"-3.7%","d":"down"}];
const COLS = ["ID","Port Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coast Guard #001","Coast Guard #002","605","4.589","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Coast Guard #002","Coast Guard #003","7.232","8.645","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Coast Guard #003","Coast Guard #004","1.614","615","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Coast Guard #004","Coast Guard #005","8.048","7.421","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coast Guard #005","Coast Guard #001","788","3.476","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":479},{"label":"Mar","value":397},{"label":"Abr","value":514},{"label":"Mai","value":366},{"label":"Jun","value":379},{"label":"Jul","value":560},{"label":"Ago","value":502},{"label":"Set","value":387},{"label":"Out","value":594},{"label":"Nov","value":474},{"label":"Dez","value":371}];
const MX = 594;
