...
const KPIS = [{"l":"Total Coast Guard","v":"6.417","t":"+5.2%","d":"up"},{"l":"Environment Ativos","v":"9.074","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"77.6%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"84","t":"+3.3%","d":"up"}];
const COLS = ["ID","Environment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coast Guard #001","Coast Guard #002","8.879","2.705","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Coast Guard #002","Coast Guard #003","7.768","984","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Coast Guard #003","Coast Guard #004","8.325","4.589","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Coast Guard #004","Coast Guard #005","832","8.046","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coast Guard #005","Coast Guard #001","1.548","1.306","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":333},{"label":"Mar","value":418},{"label":"Abr","value":619},{"label":"Mai","value":463},{"label":"Jun","value":444},{"label":"Jul","value":476},{"label":"Ago","value":612},{"label":"Set","value":377},{"label":"Out","value":570},{"label":"Nov","value":664},{"label":"Dez","value":386}];
const MX = 664;
