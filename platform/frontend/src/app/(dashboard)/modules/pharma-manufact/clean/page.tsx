...
const PAGE = "Clean Room";
const KPIS = [{"l":"Projetos Melhoria","v":"2.604","t":"-2.7%","d":"down"},{"l":"Savings (€)","v":"€57192","t":"-4.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"93.9%","t":"+9.7%","d":"up"},{"l":"Ciclos PDCA","v":"5.686","t":"+17.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.253","€ 11171.31","4.172","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.058","€ 37837.25","2.105","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","490","€ 11114.17","6.668","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.268","€ 7081.07","6.704","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.938","€ 24525.36","1.855","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":454},{"label":"Mar","value":446},{"label":"Abr","value":519},{"label":"Mai","value":560},{"label":"Jun","value":463},{"label":"Jul","value":463},{"label":"Ago","value":490},{"label":"Set","value":757},{"label":"Out","value":422},{"label":"Nov","value":414},{"label":"Dez","value":577}];
const MX = 757;
