...
const ACCENT = "#6366f1";
const MODULE = "Pharma Manufacturing";
const PAGE = "GMP";
const KPIS = [{"l":"Total Pharma Manufact","v":"8.303","t":"+6.5%","d":"up"},{"l":"GMP Ativos","v":"6.186","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+6.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+17.2%","d":"up"}];
const COLS = ["ID","GMP","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Manufact #001","Pharma Manufact #002","2.084","8.393","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Manufact #002","Pharma Manufact #003","8.690","8.177","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Manufact #003","Pharma Manufact #004","2.593","7.796","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Manufact #004","Pharma Manufact #005","6.968","6.737","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Manufact #005","Pharma Manufact #001","6.421","4.023","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":718},{"label":"Mar","value":784},{"label":"Abr","value":574},{"label":"Mai","value":666},{"label":"Jun","value":499},{"label":"Jul","value":636},{"label":"Ago","value":621},{"label":"Set","value":522},{"label":"Out","value":769},{"label":"Nov","value":654},{"label":"Dez","value":535}];
const MX = 784;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>GxP</span></h1>
                </div>
