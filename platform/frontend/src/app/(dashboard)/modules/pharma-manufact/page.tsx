...
export default function PharmaManufactPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pharma Manufact</h1><p className="text-sm text-muted-foreground">Pharma Manufact • iBOS Enterprise</p></div>
