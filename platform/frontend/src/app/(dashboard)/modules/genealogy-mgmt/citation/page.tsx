...
const PAGE = "Citation";
const KPIS = [{"l":"Total Genealogy Mgmt","v":"8.799","t":"+11.4%","d":"up"},{"l":"Citation Ativos","v":"8.469","t":"+16.1%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"69","t":"-2.6%","d":"down"}];
const COLS = ["ID","Citation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Mgmt #001","Genealogy Mgmt #002","6.932","1.057","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Mgmt #002","Genealogy Mgmt #003","7.680","5.623","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Mgmt #003","Genealogy Mgmt #004","7.070","1.014","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Mgmt #004","Genealogy Mgmt #005","2.329","822","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Mgmt #005","Genealogy Mgmt #001","3.333","4.195","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":370},{"label":"Mar","value":648},{"label":"Abr","value":557},{"label":"Mai","value":725},{"label":"Jun","value":427},{"label":"Jul","value":435},{"label":"Ago","value":570},{"label":"Set","value":425},{"label":"Out","value":604},{"label":"Nov","value":729},{"label":"Dez","value":744}];
const MX = 744;
