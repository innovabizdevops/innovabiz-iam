...
const PAGE = "Family Tree";
const KPIS = [{"l":"Total Genealogy Mgmt","v":"6.184","t":"+12.6%","d":"up"},{"l":"Family Tree Ativos","v":"4.855","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"65.4%","t":"+13.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+7.1%","d":"up"}];
const COLS = ["ID","Family Tree","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Mgmt #001","Genealogy Mgmt #002","2.136","3.686","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Mgmt #002","Genealogy Mgmt #003","2.594","4.505","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Mgmt #003","Genealogy Mgmt #004","858","1.815","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Mgmt #004","Genealogy Mgmt #005","7.476","6.038","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Mgmt #005","Genealogy Mgmt #001","8.355","8.338","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":602},{"label":"Mar","value":334},{"label":"Abr","value":489},{"label":"Mai","value":473},{"label":"Jun","value":365},{"label":"Jul","value":309},{"label":"Ago","value":294},{"label":"Set","value":473},{"label":"Out","value":387},{"label":"Nov","value":630},{"label":"Dez","value":386}];
const MX = 630;
