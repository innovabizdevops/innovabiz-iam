...
const PAGE = "DNA Link";
const KPIS = [{"l":"Total Genealogy Mgmt","v":"8.316","t":"+9.7%","d":"up"},{"l":"DNA Link Ativos","v":"3.891","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+1.9%","d":"up"}];
const COLS = ["ID","DNA Link","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genealogy Mgmt #001","Genealogy Mgmt #002","4.962","3.534","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Genealogy Mgmt #002","Genealogy Mgmt #003","4.303","5.417","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Genealogy Mgmt #003","Genealogy Mgmt #004","8.812","8.006","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Genealogy Mgmt #004","Genealogy Mgmt #005","8.239","676","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genealogy Mgmt #005","Genealogy Mgmt #001","6.900","3.851","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":708},{"label":"Mar","value":723},{"label":"Abr","value":961},{"label":"Mai","value":707},{"label":"Jun","value":622},{"label":"Jul","value":806},{"label":"Ago","value":809},{"label":"Set","value":969},{"label":"Out","value":761},{"label":"Nov","value":998},{"label":"Dez","value":801}];
const MX = 998;
