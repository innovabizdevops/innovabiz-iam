...
const ACCENT = "#b45309";
const MODULE = "Genealogy Management";
const PAGE = "Record Match";
const KPIS = [{"l":"Atletas Registados","v":"4.161","t":"+15.1%","d":"up"},{"l":"Treinos/Semana","v":"2454","t":"+17.5%","d":"up"},{"l":"Competições","v":"4.057","t":"+13.5%","d":"up"},{"l":"Performance Score","v":"89","t":"+12.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.909","6.742","161","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.298","348","2.066","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.319","8.615","1.597","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.093","4.881","2.753","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.075","5.920","6.345","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":713},{"label":"Mar","value":668},{"label":"Abr","value":804},{"label":"Mai","value":686},{"label":"Jun","value":929},{"label":"Jul","value":710},{"label":"Ago","value":979},{"label":"Set","value":637},{"label":"Out","value":669},{"label":"Nov","value":709},{"label":"Dez","value":632}];
const MX = 979;
