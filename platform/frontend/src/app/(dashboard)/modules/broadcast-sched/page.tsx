...
export default function BroadcastSchedPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Broadcast Sched</h1><p className="text-sm text-muted-foreground">Broadcast Sched • iBOS Enterprise</p></div>
