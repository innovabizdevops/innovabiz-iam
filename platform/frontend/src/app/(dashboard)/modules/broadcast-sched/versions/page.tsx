...
const PAGE = "Versioning";
const KPIS = [{"l":"Formulários Ativos","v":"4.253","t":"+3.9%","d":"up"},{"l":"Submissões/Dia","v":"2918","t":"+12.0%","d":"up"},{"l":"Documentos Gerados","v":"6.969","t":"+6.0%","d":"up"},{"l":"Templates","v":"1.525","t":"+11.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.335","2026-03-19","580","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.563","2026-03-23","5.616","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.833","2026-01-08","1.710","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.458","2026-02-06","962","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.008","2026-02-02","7.613","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":878},{"label":"Mar","value":780},{"label":"Abr","value":927},{"label":"Mai","value":969},{"label":"Jun","value":992},{"label":"Jul","value":907},{"label":"Ago","value":717},{"label":"Set","value":673},{"label":"Out","value":819},{"label":"Nov","value":905},{"label":"Dez","value":801}];
const MX = 992;
