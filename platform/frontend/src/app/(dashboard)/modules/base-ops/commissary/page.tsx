...
const ACCENT = "#6366f1";
const MODULE = "Base Operations";
const PAGE = "Commissary";
const KPIS = [{"l":"Total Base Ops","v":"6.724","t":"+10.6%","d":"up"},{"l":"Commissary Ativos","v":"1.501","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"55","t":"-2.8%","d":"down"}];
const COLS = ["ID","Commissary","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Base Ops #001","Base Ops #002","5.630","2.904","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Base Ops #002","Base Ops #003","6.950","8.948","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Base Ops #003","Base Ops #004","6.594","7.800","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Base Ops #004","Base Ops #005","1.133","2.040","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Base Ops #005","Base Ops #001","5.719","5.481","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":243},{"label":"Fev","value":532},{"label":"Mar","value":498},{"label":"Abr","value":242},{"label":"Mai","value":410},{"label":"Jun","value":342},{"label":"Jul","value":588},{"label":"Ago","value":623},{"label":"Set","value":557},{"label":"Out","value":322},{"label":"Nov","value":274},{"label":"Dez","value":590}];
const MX = 623;
