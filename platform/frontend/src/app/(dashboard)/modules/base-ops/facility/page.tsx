...
const PAGE = "Facility";
const KPIS = [{"l":"Total Base Ops","v":"4.913","t":"-0.1%","d":"down"},{"l":"Facility Ativos","v":"5.844","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.5%","d":"up"}];
const COLS = ["ID","Facility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Base Ops #001","Base Ops #002","6.868","5.807","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Base Ops #002","Base Ops #003","7.400","7.979","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Base Ops #003","Base Ops #004","4.543","2.518","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Base Ops #004","Base Ops #005","2.490","9.065","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Base Ops #005","Base Ops #001","7.580","7.455","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":872},{"label":"Mar","value":619},{"label":"Abr","value":821},{"label":"Mai","value":894},{"label":"Jun","value":565},{"label":"Jul","value":540},{"label":"Ago","value":879},{"label":"Set","value":619},{"label":"Out","value":706},{"label":"Nov","value":777},{"label":"Dez","value":708}];
const MX = 894;
