...
const PAGE = "Morale";
const KPIS = [{"l":"Total Base Ops","v":"4.654","t":"+7.5%","d":"up"},{"l":"Morale Ativos","v":"5.122","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"81","t":"-2.8%","d":"down"}];
const COLS = ["ID","Morale","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Base Ops #001","Base Ops #002","3.920","6.246","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Base Ops #002","Base Ops #003","8.134","2.560","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Base Ops #003","Base Ops #004","4.277","3.664","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Base Ops #004","Base Ops #005","427","7.133","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Base Ops #005","Base Ops #001","6.607","6.193","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":927},{"label":"Mar","value":943},{"label":"Abr","value":913},{"label":"Mai","value":907},{"label":"Jun","value":728},{"label":"Jul","value":828},{"label":"Ago","value":805},{"label":"Set","value":932},{"label":"Out","value":896},{"label":"Nov","value":892},{"label":"Dez","value":796}];
const MX = 943;
