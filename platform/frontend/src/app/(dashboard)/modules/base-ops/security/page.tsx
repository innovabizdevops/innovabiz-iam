...
const PAGE = "Security";
const KPIS = [{"l":"Total Base Ops","v":"4.845","t":"+13.2%","d":"up"},{"l":"Security Ativos","v":"901","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"78","t":"+10.5%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Base Ops #001","Base Ops #002","6.409","1.758","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Base Ops #002","Base Ops #003","4.158","6.746","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Base Ops #003","Base Ops #004","1.194","3.803","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Base Ops #004","Base Ops #005","6.787","5.458","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Base Ops #005","Base Ops #001","1.704","5.463","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":647},{"label":"Mar","value":657},{"label":"Abr","value":650},{"label":"Mai","value":617},{"label":"Jun","value":568},{"label":"Jul","value":827},{"label":"Ago","value":786},{"label":"Set","value":839},{"label":"Out","value":686},{"label":"Nov","value":888},{"label":"Dez","value":939}];
const MX = 939;
