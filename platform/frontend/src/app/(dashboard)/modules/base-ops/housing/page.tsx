...
const PAGE = "Housing";
const KPIS = [{"l":"Total Base Ops","v":"7.833","t":"+5.7%","d":"up"},{"l":"Housing Ativos","v":"2.050","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"95.0%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"67","t":"+6.5%","d":"up"}];
const COLS = ["ID","Housing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Base Ops #001","Base Ops #002","6.264","4.576","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Base Ops #002","Base Ops #003","1.936","4.197","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Base Ops #003","Base Ops #004","7.352","8.774","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Base Ops #004","Base Ops #005","903","985","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Base Ops #005","Base Ops #001","7.877","4.676","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":759},{"label":"Mar","value":659},{"label":"Abr","value":954},{"label":"Mai","value":828},{"label":"Jun","value":874},{"label":"Jul","value":887},{"label":"Ago","value":949},{"label":"Set","value":687},{"label":"Out","value":752},{"label":"Nov","value":858},{"label":"Dez","value":787}];
const MX = 954;
