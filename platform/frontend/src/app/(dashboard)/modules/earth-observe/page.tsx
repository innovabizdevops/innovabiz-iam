...
export default function EarthObservePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Earth Observe</h1><p className="text-sm text-muted-foreground">Earth Observe • iBOS Enterprise</p></div>
