...
const PAGE = "Climate Data";
const KPIS = [{"l":"Total Earth Observe","v":"5.661","t":"-2.3%","d":"down"},{"l":"Climate Data Ativos","v":"8.009","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"92","t":"+12.6%","d":"up"}];
const COLS = ["ID","Climate Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earth Observe #001","2026-03-05","451","5.898","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Earth Observe #002","2026-02-16","3.714","5.682","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Earth Observe #003","2026-03-18","7.511","7.340","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Earth Observe #004","2026-02-12","4.803","7.634","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earth Observe #005","2026-02-17","4.062","8.560","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":920},{"label":"Mar","value":807},{"label":"Abr","value":944},{"label":"Mai","value":978},{"label":"Jun","value":879},{"label":"Jul","value":924},{"label":"Ago","value":700},{"label":"Set","value":782},{"label":"Out","value":929},{"label":"Nov","value":619},{"label":"Dez","value":721}];
const MX = 978;
