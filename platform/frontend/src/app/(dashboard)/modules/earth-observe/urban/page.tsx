...
const ACCENT = "#b45309";
const MODULE = "Earth Observation";
const PAGE = "Urban Monitor";
const KPIS = [{"l":"Total Earth Observe","v":"7.977","t":"+6.5%","d":"up"},{"l":"Urban Monitor Ativos","v":"6.395","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.3%","d":"down"}];
const COLS = ["ID","Urban Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earth Observe #001","Earth Observe #002","6.793","2.996","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Earth Observe #002","Earth Observe #003","177","7.359","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Earth Observe #003","Earth Observe #004","5.517","1.861","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Earth Observe #004","Earth Observe #005","4.738","4.844","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earth Observe #005","Earth Observe #001","8.580","8.222","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":810},{"label":"Mar","value":764},{"label":"Abr","value":921},{"label":"Mai","value":962},{"label":"Jun","value":782},{"label":"Jul","value":875},{"label":"Ago","value":924},{"label":"Set","value":942},{"label":"Out","value":594},{"label":"Nov","value":812},{"label":"Dez","value":815}];
const MX = 962;
