...
const PAGE = "Disaster Resp";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.957","t":"+15.7%","d":"up"},{"l":"RTO Médio (h)","v":"189h","t":"+10.9%","d":"up"},{"l":"RPO Médio (h)","v":"59h","t":"+11.8%","d":"up"},{"l":"Testes DR (YTD)","v":"2.507","t":"+2.7%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","133h","155h","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","20h","94h","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","72h","28h","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","110h","122h","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","158h","32h","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":920},{"label":"Mar","value":764},{"label":"Abr","value":716},{"label":"Mai","value":902},{"label":"Jun","value":816},{"label":"Jul","value":1011},{"label":"Ago","value":780},{"label":"Set","value":702},{"label":"Out","value":923},{"label":"Nov","value":790},{"label":"Dez","value":658}];
const MX = 1011;
