...
const PAGE = "Ocean Watch";
const KPIS = [{"l":"Total Earth Observe","v":"4.290","t":"-4.2%","d":"down"},{"l":"Ocean Watch Ativos","v":"640","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"92.6%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"81","t":"+6.6%","d":"up"}];
const COLS = ["ID","Ocean Watch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earth Observe #001","Earth Observe #002","7.626","2.016","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Earth Observe #002","Earth Observe #003","729","3.350","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Earth Observe #003","Earth Observe #004","2.891","3.372","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Earth Observe #004","Earth Observe #005","1.852","5.419","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earth Observe #005","Earth Observe #001","4.016","919","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":829},{"label":"Mar","value":574},{"label":"Abr","value":713},{"label":"Mai","value":534},{"label":"Jun","value":905},{"label":"Jul","value":800},{"label":"Ago","value":575},{"label":"Set","value":783},{"label":"Out","value":561},{"label":"Nov","value":819},{"label":"Dez","value":680}];
const MX = 905;
