...
const PAGE = "Agriculture";
const KPIS = [{"l":"Total Earth Observe","v":"4.561","t":"+16.4%","d":"up"},{"l":"Agriculture Ativos","v":"7.801","t":"+7.5%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"+5.9%","d":"up"},{"l":"Score Performance","v":"61","t":"+0.3%","d":"up"}];
const COLS = ["ID","Agriculture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Earth Observe #001","Earth Observe #002","8.221","4.011","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Earth Observe #002","Earth Observe #003","6.058","7.189","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Earth Observe #003","Earth Observe #004","2.873","7.822","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Earth Observe #004","Earth Observe #005","7.793","4.387","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Earth Observe #005","Earth Observe #001","1.315","4.616","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":691},{"label":"Mar","value":445},{"label":"Abr","value":646},{"label":"Mai","value":743},{"label":"Jun","value":552},{"label":"Jul","value":710},{"label":"Ago","value":521},{"label":"Set","value":542},{"label":"Out","value":560},{"label":"Nov","value":739},{"label":"Dez","value":557}];
const MX = 798;
