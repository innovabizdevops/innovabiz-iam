...
const PAGE = "LOD";
const KPIS = [{"l":"Total Bim Mgmt","v":"6.567","t":"+12.6%","d":"up"},{"l":"LOD Ativos","v":"5.156","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"58","t":"-3.8%","d":"down"}];
const COLS = ["ID","LOD","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Mgmt #001","Bim Mgmt #002","7.325","1.623","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Mgmt #002","Bim Mgmt #003","6.661","7.451","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Mgmt #003","Bim Mgmt #004","2.600","870","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Mgmt #004","Bim Mgmt #005","2.858","3.182","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Mgmt #005","Bim Mgmt #001","3.214","6.178","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":819},{"label":"Mar","value":805},{"label":"Abr","value":882},{"label":"Mai","value":1088},{"label":"Jun","value":888},{"label":"Jul","value":977},{"label":"Ago","value":869},{"label":"Set","value":1012},{"label":"Out","value":961},{"label":"Nov","value":826},{"label":"Dez","value":1042}];
const MX = 1088;
