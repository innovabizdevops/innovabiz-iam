...
const KPIS = [{"l":"Total Bim Mgmt","v":"5.829","t":"+3.5%","d":"up"},{"l":"Coordinate Ativos","v":"5.915","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"90.2%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"59","t":"+12.3%","d":"up"}];
const COLS = ["ID","Coordinate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Mgmt #001","Bim Mgmt #002","5.212","2.404","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Mgmt #002","Bim Mgmt #003","6.607","5.575","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Mgmt #003","Bim Mgmt #004","6.630","3.998","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Mgmt #004","Bim Mgmt #005","7.391","2.380","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Mgmt #005","Bim Mgmt #001","360","4.336","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":598},{"label":"Mar","value":755},{"label":"Abr","value":483},{"label":"Mai","value":628},{"label":"Jun","value":736},{"label":"Jul","value":729},{"label":"Ago","value":705},{"label":"Set","value":661},{"label":"Out","value":548},{"label":"Nov","value":667},{"label":"Dez","value":391}];
const MX = 755;
