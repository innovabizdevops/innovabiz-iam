...
const ACCENT = "#6366f1";
const MODULE = "BIM Management";
const PAGE = "3D Model";
const KPIS = [{"l":"Total Bim Mgmt","v":"8.848","t":"+13.4%","d":"up"},{"l":"3D Model Ativos","v":"8.203","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+9.3%","d":"up"}];
const COLS = ["ID","3D Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Mgmt #001","Bim Mgmt #002","3.927","891","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Mgmt #002","Bim Mgmt #003","4.658","1.773","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Mgmt #003","Bim Mgmt #004","1.610","5.265","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Mgmt #004","Bim Mgmt #005","7.316","1.869","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Mgmt #005","Bim Mgmt #001","3.065","1.030","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":293},{"label":"Mar","value":520},{"label":"Abr","value":470},{"label":"Mai","value":309},{"label":"Jun","value":520},{"label":"Jul","value":406},{"label":"Ago","value":534},{"label":"Set","value":327},{"label":"Out","value":618},{"label":"Nov","value":559},{"label":"Dez","value":417}];
const MX = 618;
