...
const PAGE = "IFC";
const KPIS = [{"l":"Total Bim Mgmt","v":"4.402","t":"+16.0%","d":"up"},{"l":"IFC Ativos","v":"5.032","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"73.0%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"73","t":"+15.8%","d":"up"}];
const COLS = ["ID","IFC","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Mgmt #001","Bim Mgmt #002","2.302","430","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Mgmt #002","Bim Mgmt #003","1.225","1.548","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Mgmt #003","Bim Mgmt #004","496","8.806","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Mgmt #004","Bim Mgmt #005","1.241","8.416","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Mgmt #005","Bim Mgmt #001","528","4.783","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":422},{"label":"Mar","value":483},{"label":"Abr","value":575},{"label":"Mai","value":312},{"label":"Jun","value":418},{"label":"Jul","value":328},{"label":"Ago","value":520},{"label":"Set","value":480},{"label":"Out","value":549},{"label":"Nov","value":596},{"label":"Dez","value":401}];
const MX = 596;
