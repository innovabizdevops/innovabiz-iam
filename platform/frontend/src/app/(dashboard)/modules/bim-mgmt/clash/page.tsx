...
const PAGE = "Clash";
const KPIS = [{"l":"Total Bim Mgmt","v":"622","t":"+6.7%","d":"up"},{"l":"Clash Ativos","v":"897","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"90.1%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"92","t":"+12.0%","d":"up"}];
const COLS = ["ID","Clash","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Bim Mgmt #001","Bim Mgmt #002","4.682","3.114","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Bim Mgmt #002","Bim Mgmt #003","2.457","5.010","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Bim Mgmt #003","Bim Mgmt #004","558","5.531","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Bim Mgmt #004","Bim Mgmt #005","6.395","1.126","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Bim Mgmt #005","Bim Mgmt #001","3.859","6.998","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":712},{"label":"Mar","value":911},{"label":"Abr","value":817},{"label":"Mai","value":986},{"label":"Jun","value":777},{"label":"Jul","value":729},{"label":"Ago","value":701},{"label":"Set","value":913},{"label":"Out","value":723},{"label":"Nov","value":898},{"label":"Dez","value":814}];
const MX = 986;
