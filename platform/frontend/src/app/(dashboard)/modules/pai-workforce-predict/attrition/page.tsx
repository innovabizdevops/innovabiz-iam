...
const KPIS = [{"l":"eNPS","v":"71","t":"+2.0%","d":"up"},{"l":"Engagement (%)","v":"76.5%","t":"+3.0%","d":"up"},{"l":"Turnover (%)","v":"84.7%","t":"-1.7%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.673","t":"+4.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.016","2026-02-08","59","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.055","2026-02-07","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.514","2026-02-24","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.781","2026-03-26","69","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.122","2026-02-09","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":531},{"label":"Mar","value":709},{"label":"Abr","value":744},{"label":"Mai","value":486},{"label":"Jun","value":445},{"label":"Jul","value":518},{"label":"Ago","value":709},{"label":"Set","value":836},{"label":"Out","value":473},{"label":"Nov","value":822},{"label":"Dez","value":693}];
const MX = 836;
