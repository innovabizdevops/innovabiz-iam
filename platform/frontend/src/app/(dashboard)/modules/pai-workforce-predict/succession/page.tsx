...
const KPIS = [{"l":"eNPS","v":"80","t":"+8.8%","d":"up"},{"l":"Engagement (%)","v":"86.6%","t":"+15.4%","d":"up"},{"l":"Turnover (%)","v":"80.1%","t":"+12.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"271","t":"+2.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.431","2026-02-15","71","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.825","2026-03-07","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.629","2026-02-12","93","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","371","2026-02-20","76","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.082","2026-02-27","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":697},{"label":"Mar","value":647},{"label":"Abr","value":708},{"label":"Mai","value":873},{"label":"Jun","value":495},{"label":"Jul","value":737},{"label":"Ago","value":584},{"label":"Set","value":666},{"label":"Out","value":537},{"label":"Nov","value":867},{"label":"Dez","value":729}];
const MX = 873;
