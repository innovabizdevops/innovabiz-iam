...
const PAGE = "Plan";
const KPIS = [{"l":"eNPS","v":"78","t":"+5.9%","d":"up"},{"l":"Engagement (%)","v":"74.4%","t":"+3.3%","d":"up"},{"l":"Turnover (%)","v":"79.9%","t":"-0.9%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.921","t":"+13.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.317","2026-03-21","79","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.969","2026-01-13","85","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.584","2026-02-14","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","893","2026-03-21","74","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.325","2026-02-17","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":529},{"label":"Mar","value":518},{"label":"Abr","value":489},{"label":"Mai","value":403},{"label":"Jun","value":550},{"label":"Jul","value":385},{"label":"Ago","value":370},{"label":"Set","value":432},{"label":"Out","value":593},{"label":"Nov","value":681},{"label":"Dez","value":438}];
const MX = 681;
