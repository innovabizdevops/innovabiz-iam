...
/* ═══ P-AI Workforce Predict — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "8652", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3468", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€467K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "241489352", cells: ["PAI-2352", "P-AI Workforce Predict Item 1", "21/9/2026", "€39 452"], status: "active" as const },
    { id: "241492923", cells: ["PAI-5923", "P-AI Workforce Predict Item 2", "8/4/2026", "€43 023"], status: "pending" as const },
    { id: "241496494", cells: ["PAI-9494", "P-AI Workforce Predict Item 3", "23/11/2026", "€46 594"], status: "completed" as const },
    { id: "241500065", cells: ["PAI-4065", "P-AI Workforce Predict Item 4", "10/6/2026", "€165"], status: "warning" as const },
    { id: "241503636", cells: ["PAI-7636", "P-AI Workforce Predict Item 5", "25/1/2026", "€3736"], status: "active" as const },
];
...
export default function PaiWorkforcePredictPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Workforce Predict</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Workforce Predict</p>
                    </div>
                </div>
