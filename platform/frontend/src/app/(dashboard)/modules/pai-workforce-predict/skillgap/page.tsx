...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Workforce Predict";
const PAGE = "Skill Gap";
const KPIS = [{"l":"eNPS","v":"61","t":"+12.8%","d":"up"},{"l":"Engagement (%)","v":"94.5%","t":"+9.8%","d":"up"},{"l":"Turnover (%)","v":"89.2%","t":"+12.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.207","t":"-5.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.030","2026-03-21","77","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.763","2026-01-14","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.200","2026-01-16","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.213","2026-02-21","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.060","2026-02-22","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":431},{"label":"Mar","value":378},{"label":"Abr","value":452},{"label":"Mai","value":412},{"label":"Jun","value":510},{"label":"Jul","value":516},{"label":"Ago","value":537},{"label":"Set","value":614},{"label":"Out","value":328},{"label":"Nov","value":452},{"label":"Dez","value":603}];
const MX = 614;
