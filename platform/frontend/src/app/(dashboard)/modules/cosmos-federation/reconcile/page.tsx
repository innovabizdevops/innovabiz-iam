...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Federation Engine";
const PAGE = "Reconcile";
const KPIS = [{"l":"Total Cosmos Federation","v":"7.254","t":"-1.1%","d":"down"},{"l":"Reconcile Ativos","v":"3.443","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"63","t":"+6.1%","d":"up"}];
const COLS = ["ID","Reconcile","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Federation #001","Cosmos Federation #002","7.483","3.580","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Federation #002","Cosmos Federation #003","3.570","3.697","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Federation #003","Cosmos Federation #004","1.275","7.119","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Federation #004","Cosmos Federation #005","6.084","4.137","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Federation #005","Cosmos Federation #001","7.089","4.659","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":561},{"label":"Mar","value":436},{"label":"Abr","value":350},{"label":"Mai","value":346},{"label":"Jun","value":386},{"label":"Jul","value":366},{"label":"Ago","value":403},{"label":"Set","value":347},{"label":"Out","value":362},{"label":"Nov","value":221},{"label":"Dez","value":332}];
const MX = 561;
