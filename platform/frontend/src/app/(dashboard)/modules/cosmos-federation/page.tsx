...
/* ═══ COSMOS Federation Engine — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "7891", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1002", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€428K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1499214291", cells: ["COS-4291", "COSMOS Federation Engine Item 1", "16/4/2026", "€14 391"], status: "active" as const },
    { id: "1499217862", cells: ["COS-7862", "COSMOS Federation Engine Item 2", "3/11/2026", "€17 962"], status: "pending" as const },
    { id: "1499221433", cells: ["COS-2433", "COSMOS Federation Engine Item 3", "18/6/2026", "€21 533"], status: "completed" as const },
    { id: "1499225004", cells: ["COS-6004", "COSMOS Federation Engine Item 4", "5/1/2026", "€25 104"], status: "warning" as const },
    { id: "1499228575", cells: ["COS-9575", "COSMOS Federation Engine Item 5", "20/8/2026", "€28 675"], status: "active" as const },
];
...
export default function CosmosFederationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Federation Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Federation Engine</p>
                    </div>
                </div>
