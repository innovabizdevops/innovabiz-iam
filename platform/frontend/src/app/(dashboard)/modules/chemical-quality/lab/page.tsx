...
const ACCENT = "#6366f1";
const MODULE = "Chemical Quality";
const PAGE = "Lab";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.371","t":"+4.6%","d":"up"},{"l":"NC Abertas","v":"7.192","t":"+15.3%","d":"up"},{"l":"Conformidade (%)","v":"94.2%","t":"+7.0%","d":"up"},{"l":"CAPAs Pendentes","v":"8.431","t":"+2.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.633","92.6%","7.164","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.293","87.8%","5.227","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.174","99.9%","3.505","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.408","76.7%","5.607","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","781","78.5%","7.830","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":486},{"label":"Fev","value":509},{"label":"Mar","value":530},{"label":"Abr","value":716},{"label":"Mai","value":496},{"label":"Jun","value":678},{"label":"Jul","value":466},{"label":"Ago","value":597},{"label":"Set","value":473},{"label":"Out","value":393},{"label":"Nov","value":784},{"label":"Dez","value":666}];
const MX = 784;
