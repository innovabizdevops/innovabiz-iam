...
const PAGE = "Method";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.695","t":"+2.9%","d":"up"},{"l":"NC Abertas","v":"795","t":"+1.8%","d":"up"},{"l":"Conformidade (%)","v":"68.5%","t":"-1.4%","d":"down"},{"l":"CAPAs Pendentes","v":"8.836","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","659","80.9%","5.249","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.760","78.1%","5.547","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.351","99.5%","3.351","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.664","78.1%","3.638","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.982","83.2%","4.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":440},{"label":"Mar","value":350},{"label":"Abr","value":327},{"label":"Mai","value":559},{"label":"Jun","value":430},{"label":"Jul","value":583},{"label":"Ago","value":409},{"label":"Set","value":698},{"label":"Out","value":517},{"label":"Nov","value":516},{"label":"Dez","value":569}];
const MX = 698;
