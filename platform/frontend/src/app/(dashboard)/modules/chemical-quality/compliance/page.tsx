...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.991","t":"+8.5%","d":"up"},{"l":"NC Abertas","v":"3.188","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"87.2%","t":"+7.2%","d":"up"},{"l":"CAPAs Pendentes","v":"7.769","t":"+14.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.034","87.5%","4.316","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.156","80.1%","3.789","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.363","82.7%","7.115","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.479","73.2%","8.009","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.333","75.6%","3.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":998},{"label":"Mar","value":935},{"label":"Abr","value":993},{"label":"Mai","value":829},{"label":"Jun","value":726},{"label":"Jul","value":1062},{"label":"Ago","value":848},{"label":"Set","value":981},{"label":"Out","value":853},{"label":"Nov","value":802},{"label":"Dez","value":971}];
const MX = 1062;
