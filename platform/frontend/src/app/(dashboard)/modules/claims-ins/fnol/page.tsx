...
const PAGE = "FNOL Intake";
const KPIS = [{"l":"Total Claims Ins","v":"7.642","t":"-2.9%","d":"down"},{"l":"FNOL Intake Ativos","v":"2.184","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"85.4%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+5.6%","d":"up"}];
const COLS = ["ID","FNOL Intake","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","6.657","9.045","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","7.750","2.930","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","7.801","4.958","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","3.216","8.305","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","5.280","6.525","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":927},{"label":"Fev","value":796},{"label":"Mar","value":991},{"label":"Abr","value":760},{"label":"Mai","value":824},{"label":"Jun","value":699},{"label":"Jul","value":1017},{"label":"Ago","value":778},{"label":"Set","value":846},{"label":"Out","value":942},{"label":"Nov","value":977},{"label":"Dez","value":734}];
const MX = 1017;
