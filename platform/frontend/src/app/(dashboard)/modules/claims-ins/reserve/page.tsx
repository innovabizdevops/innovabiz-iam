...
const PAGE = "Reserve Mgmt";
const KPIS = [{"l":"Total Claims Ins","v":"7.607","t":"+10.8%","d":"up"},{"l":"Reserve Mgmt Ativos","v":"311","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"68","t":"+1.1%","d":"up"}];
const COLS = ["ID","Reserve Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","4.813","5.629","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","1.575","1.055","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","3.314","5.799","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","4.343","2.483","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","5.255","7.355","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":825},{"label":"Mar","value":608},{"label":"Abr","value":932},{"label":"Mai","value":840},{"label":"Jun","value":681},{"label":"Jul","value":946},{"label":"Ago","value":673},{"label":"Set","value":692},{"label":"Out","value":648},{"label":"Nov","value":942},{"label":"Dez","value":664}];
const MX = 946;
