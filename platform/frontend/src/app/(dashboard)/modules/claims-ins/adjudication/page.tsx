...
const PAGE = "Adjudication";
const KPIS = [{"l":"Total Claims Ins","v":"7.760","t":"-1.4%","d":"down"},{"l":"Adjudication Ativos","v":"1.920","t":"+5.9%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.1%","d":"up"}];
const COLS = ["ID","Adjudication","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","3.251","8.065","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","5.959","1.700","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","4.887","3.068","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","2.671","3.741","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","323","8.089","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":742},{"label":"Mar","value":837},{"label":"Abr","value":722},{"label":"Mai","value":746},{"label":"Jun","value":804},{"label":"Jul","value":872},{"label":"Ago","value":582},{"label":"Set","value":594},{"label":"Out","value":583},{"label":"Nov","value":746},{"label":"Dez","value":748}];
const MX = 872;
