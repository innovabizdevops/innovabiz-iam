...
const PAGE = "Payment";
const KPIS = [{"l":"Total Claims Ins","v":"8.919","t":"+17.8%","d":"up"},{"l":"Payment Ativos","v":"303","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"73.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"72","t":"-1.2%","d":"down"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","173","8.575","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","8.332","7.686","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","5.351","4.902","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","6.343","5.327","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","3.209","5.512","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":692},{"label":"Mar","value":885},{"label":"Abr","value":650},{"label":"Mai","value":730},{"label":"Jun","value":746},{"label":"Jul","value":843},{"label":"Ago","value":749},{"label":"Set","value":818},{"label":"Out","value":935},{"label":"Nov","value":747},{"label":"Dez","value":802}];
const MX = 935;
