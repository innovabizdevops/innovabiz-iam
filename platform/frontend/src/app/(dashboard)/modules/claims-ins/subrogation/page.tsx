...
const KPIS = [{"l":"Total Claims Ins","v":"8.927","t":"+9.1%","d":"up"},{"l":"Subrogation Ativos","v":"3.538","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"68","t":"-3.6%","d":"down"}];
const COLS = ["ID","Subrogation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","8.894","7.775","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","1.893","9.083","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","5.975","8.325","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","1.830","6.042","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","579","4.190","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":973},{"label":"Fev","value":992},{"label":"Mar","value":990},{"label":"Abr","value":841},{"label":"Mai","value":1058},{"label":"Jun","value":948},{"label":"Jul","value":686},{"label":"Ago","value":692},{"label":"Set","value":717},{"label":"Out","value":1006},{"label":"Nov","value":828},{"label":"Dez","value":1068}];
const MX = 1068;
