...
const ACCENT = "#dc2626";
const MODULE = "Claims Management";
const PAGE = "Photo Estimate AI";
const KPIS = [{"l":"Total Claims Ins","v":"1.887","t":"+11.9%","d":"up"},{"l":"Photo Estimate AI Ativos","v":"2.719","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"71","t":"+4.3%","d":"up"}];
const COLS = ["ID","Photo Estimate AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Claims Ins #001","Claims Ins #002","2.529","3.025","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Claims Ins #002","Claims Ins #003","1.371","1.504","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Claims Ins #003","Claims Ins #004","5.475","5.035","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Claims Ins #004","Claims Ins #005","7.117","3.270","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Claims Ins #005","Claims Ins #001","1.233","7.754","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":581},{"label":"Fev","value":604},{"label":"Mar","value":729},{"label":"Abr","value":566},{"label":"Mai","value":747},{"label":"Jun","value":446},{"label":"Jul","value":766},{"label":"Ago","value":672},{"label":"Set","value":464},{"label":"Out","value":504},{"label":"Nov","value":588},{"label":"Dez","value":393}];
const MX = 766;
