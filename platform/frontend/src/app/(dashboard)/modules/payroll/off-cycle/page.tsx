...
const PAGE = "Off-Cycle Run";
const KPIS = [{"l":"Total Payroll","v":"355","t":"+3.8%","d":"up"},{"l":"Off Cycle Run Ativos","v":"8.468","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"64","t":"-0.7%","d":"down"}];
const COLS = ["ID","Off Cycle Run","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","5.379","379","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","2.602","5.778","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","2.264","8.172","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","2.099","2.239","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","8.051","4.478","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":960},{"label":"Mar","value":742},{"label":"Abr","value":832},{"label":"Mai","value":851},{"label":"Jun","value":980},{"label":"Jul","value":809},{"label":"Ago","value":824},{"label":"Set","value":989},{"label":"Out","value":629},{"label":"Nov","value":697},{"label":"Dez","value":839}];
const MX = 989;
