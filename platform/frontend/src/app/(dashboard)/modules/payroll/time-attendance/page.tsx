...
const KPIS = [{"l":"Total Payroll","v":"8.520","t":"+17.2%","d":"up"},{"l":"Time & Attendance Ativos","v":"2.867","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"86","t":"-0.7%","d":"down"}];
const COLS = ["ID","Time & Attendance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","7.115","6.310","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","324","7.671","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","8.288","4.914","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","2.689","1.531","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","8.579","2.307","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":714},{"label":"Mar","value":619},{"label":"Abr","value":732},{"label":"Mai","value":626},{"label":"Jun","value":550},{"label":"Jul","value":768},{"label":"Ago","value":547},{"label":"Set","value":773},{"label":"Out","value":554},{"label":"Nov","value":672},{"label":"Dez","value":580}];
const MX = 773;
