...
const PAGE = "Tax Deductions";
const KPIS = [{"l":"Total Payroll","v":"7.838","t":"+0.1%","d":"up"},{"l":"Tax Deductions Ativos","v":"3.208","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"79.9%","t":"+17.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-4.2%","d":"down"}];
const COLS = ["ID","Tax Deductions","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","1.029","4.885","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","4.776","1.724","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","1.282","1.496","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","7.040","3.366","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","4.240","5.673","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":418},{"label":"Mar","value":354},{"label":"Abr","value":605},{"label":"Mai","value":554},{"label":"Jun","value":388},{"label":"Jul","value":463},{"label":"Ago","value":365},{"label":"Set","value":338},{"label":"Out","value":488},{"label":"Nov","value":565},{"label":"Dez","value":513}];
const MX = 605;
