...
const PAGE = "Payroll Run";
const KPIS = [{"l":"Total Payroll","v":"581","t":"+9.5%","d":"up"},{"l":"Payroll Run Ativos","v":"682","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"85","t":"+7.8%","d":"up"}];
const COLS = ["ID","Payroll Run","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","1.144","3.219","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","3.121","6.210","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","1.840","5.297","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","5.198","5.343","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","2.549","404","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":705},{"label":"Mar","value":640},{"label":"Abr","value":566},{"label":"Mai","value":773},{"label":"Jun","value":528},{"label":"Jul","value":674},{"label":"Ago","value":561},{"label":"Set","value":647},{"label":"Out","value":827},{"label":"Nov","value":763},{"label":"Dez","value":625}];
const MX = 827;
