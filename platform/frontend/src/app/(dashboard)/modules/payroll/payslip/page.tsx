...
const PAGE = "Pay Slip Generator";
const KPIS = [{"l":"Total Payroll","v":"2.771","t":"+17.8%","d":"up"},{"l":"Pay Slip Generator Ativos","v":"2.489","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+8.0%","d":"up"}];
const COLS = ["ID","Pay Slip Generator","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","6.541","304","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","6.546","8.547","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","8.994","3.545","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","6.052","4.059","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","8.748","3.769","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":726},{"label":"Mar","value":471},{"label":"Abr","value":588},{"label":"Mai","value":496},{"label":"Jun","value":706},{"label":"Jul","value":596},{"label":"Ago","value":663},{"label":"Set","value":795},{"label":"Out","value":793},{"label":"Nov","value":634},{"label":"Dez","value":484}];
const MX = 795;
