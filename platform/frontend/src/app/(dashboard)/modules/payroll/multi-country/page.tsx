...
const ACCENT = "#15803d";
const MODULE = "Payroll & Benefits";
const PAGE = "Multi-Country";
const KPIS = [{"l":"Total Payroll","v":"6.429","t":"+7.6%","d":"up"},{"l":"Multi Country Ativos","v":"5.880","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"61","t":"+13.4%","d":"up"}];
const COLS = ["ID","Multi Country","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","1.165","7.955","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","8.127","535","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","950","4.945","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","5.768","6.457","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","5.292","6.427","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":772},{"label":"Mar","value":724},{"label":"Abr","value":608},{"label":"Mai","value":803},{"label":"Jun","value":777},{"label":"Jul","value":509},{"label":"Ago","value":681},{"label":"Set","value":596},{"label":"Out","value":600},{"label":"Nov","value":760},{"label":"Dez","value":444}];
const MX = 803;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#15803d'}}>i18n</span></h1>
                </div>
