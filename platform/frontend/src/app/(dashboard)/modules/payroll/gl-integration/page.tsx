...
const PAGE = "GL Integration";
const KPIS = [{"l":"Integrações Ativas","v":"6.842","t":"+16.0%","d":"up"},{"l":"Chamadas/Hora","v":"2995","t":"+5.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.1%","t":"-4.6%","d":"down"},{"l":"Latência Média (ms)","v":"116ms","t":"+10.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.723","4.473","70.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.784","5.072","99.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.664","6.574","97.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","179","3.650","91.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.405","844","85.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":694},{"label":"Mar","value":828},{"label":"Abr","value":929},{"label":"Mai","value":910},{"label":"Jun","value":653},{"label":"Jul","value":926},{"label":"Ago","value":839},{"label":"Set","value":783},{"label":"Out","value":969},{"label":"Nov","value":829},{"label":"Dez","value":699}];
const MX = 969;
