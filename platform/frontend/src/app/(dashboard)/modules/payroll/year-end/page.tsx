...
const PAGE = "Year-End Reports";
const KPIS = [{"l":"Total Payroll","v":"7.477","t":"+17.3%","d":"up"},{"l":"Year End Reports Ativos","v":"1.323","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"61","t":"+2.3%","d":"up"}];
const COLS = ["ID","Year End Reports","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","4.396","5.714","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","130","5.700","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","6.343","7.523","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","3.223","9.037","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","3.034","4.383","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":814},{"label":"Mar","value":920},{"label":"Abr","value":669},{"label":"Mai","value":949},{"label":"Jun","value":717},{"label":"Jul","value":625},{"label":"Ago","value":723},{"label":"Set","value":695},{"label":"Out","value":784},{"label":"Nov","value":711},{"label":"Dez","value":811}];
const MX = 949;
