...
const PAGE = "Retro Pay Calc";
const KPIS = [{"l":"Total Payroll","v":"3.581","t":"+13.4%","d":"up"},{"l":"Retro Pay Calc Ativos","v":"4.664","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"81","t":"+6.5%","d":"up"}];
const COLS = ["ID","Retro Pay Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","1.009","3.428","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","2.291","4.164","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","7.807","1.017","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","1.717","3.126","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","5.712","2.985","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":581},{"label":"Mar","value":476},{"label":"Abr","value":551},{"label":"Mai","value":829},{"label":"Jun","value":471},{"label":"Jul","value":735},{"label":"Ago","value":724},{"label":"Set","value":602},{"label":"Out","value":777},{"label":"Nov","value":748},{"label":"Dez","value":807}];
const MX = 829;
