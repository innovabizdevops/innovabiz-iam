...
const KPIS = [{"l":"Total Payroll","v":"1.788","t":"+10.3%","d":"up"},{"l":"Benefits Admin Ativos","v":"4.659","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"55","t":"+8.0%","d":"up"}];
const COLS = ["ID","Benefits Admin","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payroll #001","Payroll #002","6.393","8.342","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Payroll #002","Payroll #003","3.716","8.259","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Payroll #003","Payroll #004","6.745","5.906","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payroll #004","Payroll #005","8.644","253","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payroll #005","Payroll #001","1.295","825","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":776},{"label":"Mar","value":624},{"label":"Abr","value":801},{"label":"Mai","value":627},{"label":"Jun","value":609},{"label":"Jul","value":713},{"label":"Ago","value":833},{"label":"Set","value":517},{"label":"Out","value":624},{"label":"Nov","value":831},{"label":"Dez","value":593}];
const MX = 833;
