...
export default function ConstructionDocPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Construction Doc</h1><p className="text-sm text-muted-foreground">Construction Doc • iBOS Enterprise</p></div>
