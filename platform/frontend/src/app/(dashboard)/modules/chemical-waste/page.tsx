...
export default function ChemicalWastePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Chemical Waste</h1><p className="text-sm text-muted-foreground">Chemical Waste • iBOS Enterprise</p></div>
