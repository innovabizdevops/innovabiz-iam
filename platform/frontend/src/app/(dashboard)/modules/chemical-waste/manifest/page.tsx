...
const ACCENT = "#6366f1";
const MODULE = "Chemical Waste";
const PAGE = "Manifest";
const KPIS = [{"l":"Total Chemical Waste","v":"4.630","t":"-3.3%","d":"down"},{"l":"Manifest Ativos","v":"8.249","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"82","t":"+7.6%","d":"up"}];
const COLS = ["ID","Manifest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Waste #001","Chemical Waste #002","1.812","5.963","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Waste #002","Chemical Waste #003","3.460","4.535","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Waste #003","Chemical Waste #004","4.794","8.157","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Waste #004","Chemical Waste #005","5.335","4.703","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Waste #005","Chemical Waste #001","1.718","1.207","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":559},{"label":"Mar","value":761},{"label":"Abr","value":429},{"label":"Mai","value":669},{"label":"Jun","value":437},{"label":"Jul","value":612},{"label":"Ago","value":559},{"label":"Set","value":690},{"label":"Out","value":732},{"label":"Nov","value":589},{"label":"Dez","value":758}];
const MX = 761;
