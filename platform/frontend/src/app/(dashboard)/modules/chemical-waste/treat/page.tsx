...
const PAGE = "Treat";
const KPIS = [{"l":"Total Chemical Waste","v":"781","t":"-2.7%","d":"down"},{"l":"Treat Ativos","v":"3.019","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"81.2%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+0.4%","d":"up"}];
const COLS = ["ID","Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Waste #001","Chemical Waste #002","7.947","1.370","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Waste #002","Chemical Waste #003","2.271","6.044","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Waste #003","Chemical Waste #004","6.337","4.889","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Waste #004","Chemical Waste #005","6.449","5.282","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Waste #005","Chemical Waste #001","4.936","3.908","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":756},{"label":"Mar","value":754},{"label":"Abr","value":447},{"label":"Mai","value":578},{"label":"Jun","value":717},{"label":"Jul","value":500},{"label":"Ago","value":536},{"label":"Set","value":443},{"label":"Out","value":746},{"label":"Nov","value":469},{"label":"Dez","value":575}];
const MX = 756;
