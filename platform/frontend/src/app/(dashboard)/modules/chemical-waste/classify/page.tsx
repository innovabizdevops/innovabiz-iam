...
const PAGE = "Classify";
const KPIS = [{"l":"Total Chemical Waste","v":"7.338","t":"-3.1%","d":"down"},{"l":"Classify Ativos","v":"7.189","t":"+0.0%","d":"up"},{"l":"Eficiência (%)","v":"90.5%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"63","t":"+4.7%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Chemical Waste #001","Chemical Waste #002","1.962","9.024","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Chemical Waste #002","Chemical Waste #003","5.065","237","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Chemical Waste #003","Chemical Waste #004","1.851","4.263","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Chemical Waste #004","Chemical Waste #005","5.316","792","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Chemical Waste #005","Chemical Waste #001","2.527","3.769","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":620},{"label":"Mar","value":378},{"label":"Abr","value":597},{"label":"Mai","value":728},{"label":"Jun","value":575},{"label":"Jul","value":723},{"label":"Ago","value":665},{"label":"Set","value":755},{"label":"Out","value":526},{"label":"Nov","value":372},{"label":"Dez","value":708}];
const MX = 755;
