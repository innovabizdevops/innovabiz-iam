...
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"1.568","t":"+15.2%","d":"up"},{"l":"Queries/Dia","v":"1776","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"557","t":"-5.9%","d":"down"},{"l":"Utilizadores Analytics","v":"1.662","t":"+4.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","706","2026-01-20","2.731","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","798","2026-01-14","5.137","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2297","2026-01-26","4.177","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","937","2026-02-07","6.783","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2715","2026-02-02","5.760","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":635},{"label":"Mar","value":647},{"label":"Abr","value":496},{"label":"Mai","value":609},{"label":"Jun","value":610},{"label":"Jul","value":621},{"label":"Ago","value":301},{"label":"Set","value":686},{"label":"Out","value":424},{"label":"Nov","value":329},{"label":"Dez","value":672}];
const MX = 686;
