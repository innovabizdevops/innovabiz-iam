...
const PAGE = "Plan";
const KPIS = [{"l":"Integrações Ativas","v":"1.154","t":"+6.6%","d":"up"},{"l":"Chamadas/Hora","v":"301","t":"+6.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.0%","t":"+1.3%","d":"up"},{"l":"Latência Média (ms)","v":"28ms","t":"+13.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.417","8.594","98.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.948","1.895","92.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.113","1.610","73.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.832","6.855","73.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.591","4.353","75.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":698},{"label":"Mar","value":445},{"label":"Abr","value":689},{"label":"Mai","value":498},{"label":"Jun","value":428},{"label":"Jul","value":582},{"label":"Ago","value":679},{"label":"Set","value":369},{"label":"Out","value":545},{"label":"Nov","value":632},{"label":"Dez","value":358}];
const MX = 698;
