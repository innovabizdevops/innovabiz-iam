...
const ACCENT = "#be185d";
const MODULE = "Social Media Marketing Deep";
const PAGE = "Listen";
const KPIS = [{"l":"Integrações Ativas","v":"8.748","t":"+14.8%","d":"up"},{"l":"Chamadas/Hora","v":"1390","t":"-4.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"74.8%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"65ms","t":"+2.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.212","4.288","87.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.870","4.118","96.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.456","3.734","96.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.354","861","90.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.746","1.598","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":943},{"label":"Mar","value":822},{"label":"Abr","value":678},{"label":"Mai","value":830},{"label":"Jun","value":842},{"label":"Jul","value":795},{"label":"Ago","value":689},{"label":"Set","value":949},{"label":"Out","value":938},{"label":"Nov","value":729},{"label":"Dez","value":624}];
const MX = 949;
