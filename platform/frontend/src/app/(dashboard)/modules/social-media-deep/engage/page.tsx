...
const PAGE = "Engage";
const KPIS = [{"l":"Integrações Ativas","v":"657","t":"+9.4%","d":"up"},{"l":"Chamadas/Hora","v":"930","t":"-1.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.2%","t":"+5.3%","d":"up"},{"l":"Latência Média (ms)","v":"68ms","t":"+12.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.200","314","77.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.983","1.095","98.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.445","2.596","88.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.488","3.928","80.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.977","5.883","80.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":653},{"label":"Mar","value":498},{"label":"Abr","value":565},{"label":"Mai","value":323},{"label":"Jun","value":436},{"label":"Jul","value":309},{"label":"Ago","value":443},{"label":"Set","value":363},{"label":"Out","value":347},{"label":"Nov","value":390},{"label":"Dez","value":524}];
const MX = 653;
