...
const PAGE = "Publish";
const KPIS = [{"l":"Integrações Ativas","v":"3.051","t":"+3.7%","d":"up"},{"l":"Chamadas/Hora","v":"1268","t":"+4.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.9%","t":"+12.1%","d":"up"},{"l":"Latência Média (ms)","v":"107ms","t":"+13.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.260","8.799","86.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.590","3.611","89.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","258","3.385","87.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.981","5.019","74.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.204","6.765","74.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":360},{"label":"Mar","value":609},{"label":"Abr","value":318},{"label":"Mai","value":507},{"label":"Jun","value":360},{"label":"Jul","value":458},{"label":"Ago","value":614},{"label":"Set","value":454},{"label":"Out","value":268},{"label":"Nov","value":330},{"label":"Dez","value":479}];
const MX = 614;
