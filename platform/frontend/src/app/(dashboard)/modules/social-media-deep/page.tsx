...
/* ═══ Social Media Marketing Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3472", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3806", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-5%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1374776772", cells: ["SOC-9772", "Social Media Marketing Deep Item 1", "13/1/2026", "€26 872"], status: "active" as const },
    { id: "1374780343", cells: ["SOC-4343", "Social Media Marketing Deep Item 2", "28/8/2026", "€30 443"], status: "pending" as const },
    { id: "1374783914", cells: ["SOC-7914", "Social Media Marketing Deep Item 3", "15/3/2026", "€34 014"], status: "completed" as const },
    { id: "1374787485", cells: ["SOC-2485", "Social Media Marketing Deep Item 4", "2/10/2026", "€37 585"], status: "warning" as const },
    { id: "1374791056", cells: ["SOC-6056", "Social Media Marketing Deep Item 5", "17/5/2026", "€41 156"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 72 }, { label: "Fev", value: 81 }, { label: "Mar", value: 90 }, { label: "Abr", value: 99 }, { label: "Mai", value: 28 }, { label: "Jun", value: 37 }];
...
export default function SocialMediaMarketingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Social Media Marketing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Social Media Marketing Deep</p>
                    </div>
                </div>
