...
const PAGE = "Access Map";
const KPIS = [{"l":"Total Education Equity","v":"8.637","t":"-5.6%","d":"down"},{"l":"Access Map Ativos","v":"1.141","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"94.4%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+4.2%","d":"up"}];
const COLS = ["ID","Access Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Equity #001","Education Equity #002","8.020","8.554","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Education Equity #002","Education Equity #003","3.263","1.367","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Equity #003","Education Equity #004","1.132","5.918","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Education Equity #004","Education Equity #005","3.521","620","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Equity #005","Education Equity #001","8.479","7.027","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":1021},{"label":"Mar","value":653},{"label":"Abr","value":707},{"label":"Mai","value":859},{"label":"Jun","value":715},{"label":"Jul","value":788},{"label":"Ago","value":700},{"label":"Set","value":784},{"label":"Out","value":1034},{"label":"Nov","value":661},{"label":"Dez","value":904}];
const MX = 1034;
