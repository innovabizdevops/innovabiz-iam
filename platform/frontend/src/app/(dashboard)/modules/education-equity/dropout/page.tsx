...
const ACCENT = "#1e40af";
const MODULE = "Education Equity";
const PAGE = "Dropout Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.111","t":"+7.0%","d":"up"},{"l":"Mitigações Ativas","v":"6.023","t":"+5.7%","d":"up"},{"l":"Score Risco Geral","v":"65","t":"+9.8%","d":"up"},{"l":"Incidentes YTD","v":"2.714","t":"-4.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.391","6.178","6.529","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.661","5.447","215","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.394","1.372","8.713","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.640","2.983","1.533","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.599","7.077","6.696","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":603},{"label":"Mar","value":417},{"label":"Abr","value":384},{"label":"Mai","value":490},{"label":"Jun","value":527},{"label":"Jul","value":521},{"label":"Ago","value":730},{"label":"Set","value":484},{"label":"Out","value":518},{"label":"Nov","value":724},{"label":"Dez","value":518}];
const MX = 730;
