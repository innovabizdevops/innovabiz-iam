...
export default function EducationEquityPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Education Equity</h1><p className="text-sm text-muted-foreground">Education Equity • iBOS Enterprise</p></div>
