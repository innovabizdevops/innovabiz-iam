...
const PAGE = "Teacher Train";
const KPIS = [{"l":"Total Education Equity","v":"4.680","t":"-3.4%","d":"down"},{"l":"Teacher Train Ativos","v":"8.678","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"68","t":"-4.3%","d":"down"}];
const COLS = ["ID","Teacher Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Equity #001","Education Equity #002","8.169","5.228","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Education Equity #002","Education Equity #003","515","7.231","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Equity #003","Education Equity #004","5.433","1.161","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Education Equity #004","Education Equity #005","6.924","5.438","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Equity #005","Education Equity #001","5.890","2.123","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":344},{"label":"Mar","value":654},{"label":"Abr","value":529},{"label":"Mai","value":422},{"label":"Jun","value":485},{"label":"Jul","value":609},{"label":"Ago","value":555},{"label":"Set","value":582},{"label":"Out","value":666},{"label":"Nov","value":314},{"label":"Dez","value":529}];
const MX = 666;
