...
const PAGE = "Inclusive Ed";
const KPIS = [{"l":"Total Education Equity","v":"4.996","t":"+6.5%","d":"up"},{"l":"Inclusive Ed Ativos","v":"8.086","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"70.9%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"93","t":"-3.8%","d":"down"}];
const COLS = ["ID","Inclusive Ed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Equity #001","Education Equity #002","7.096","4.691","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Education Equity #002","Education Equity #003","8.359","6.684","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Equity #003","Education Equity #004","5.037","1.272","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Education Equity #004","Education Equity #005","964","8.066","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Equity #005","Education Equity #001","8.352","8.671","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":562},{"label":"Mar","value":629},{"label":"Abr","value":553},{"label":"Mai","value":571},{"label":"Jun","value":576},{"label":"Jul","value":464},{"label":"Ago","value":362},{"label":"Set","value":353},{"label":"Out","value":521},{"label":"Nov","value":458},{"label":"Dez","value":483}];
const MX = 629;
