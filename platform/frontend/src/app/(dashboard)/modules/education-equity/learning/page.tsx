...
const PAGE = "Learning Level";
const KPIS = [{"l":"Total Education Equity","v":"2.992","t":"+13.5%","d":"up"},{"l":"Learning Level Ativos","v":"3.360","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"90.7%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+10.8%","d":"up"}];
const COLS = ["ID","Learning Level","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Education Equity #001","Education Equity #002","5.208","445","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Education Equity #002","Education Equity #003","2.586","3.908","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Education Equity #003","Education Equity #004","8.344","209","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Education Equity #004","Education Equity #005","2.348","371","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Education Equity #005","Education Equity #001","2.713","104","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":499},{"label":"Mar","value":596},{"label":"Abr","value":567},{"label":"Mai","value":514},{"label":"Jun","value":707},{"label":"Jul","value":729},{"label":"Ago","value":515},{"label":"Set","value":807},{"label":"Out","value":669},{"label":"Nov","value":735},{"label":"Dez","value":454}];
const MX = 807;
