...
/* ═══ Plywood Manufacturing — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "1290", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3687", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€369K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "379458290", cells: ["PLY-1290", "Plywood Manufacturing Item 1", "23/3/2026", "€8390"], status: "active" as const },
    { id: "379461861", cells: ["PLY-4861", "Plywood Manufacturing Item 2", "10/10/2026", "€11 961"], status: "pending" as const },
    { id: "379465432", cells: ["PLY-8432", "Plywood Manufacturing Item 3", "25/5/2026", "€15 532"], status: "completed" as const },
    { id: "379469003", cells: ["PLY-3003", "Plywood Manufacturing Item 4", "12/12/2026", "€19 103"], status: "warning" as const },
    { id: "379472574", cells: ["PLY-6574", "Plywood Manufacturing Item 5", "27/7/2026", "€22 674"], status: "active" as const },
];
...
export default function PlywoodManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Plywood Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Plywood Manufacturing</p>
                    </div>
                </div>
