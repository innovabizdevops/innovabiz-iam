...
const ACCENT = "#166534";
const MODULE = "Plywood Manufacturing";
const PAGE = "Gluing";
const KPIS = [{"l":"Total Plywood Mfg","v":"6.316","t":"+1.3%","d":"up"},{"l":"Gluing Ativos","v":"1.365","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"84.5%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+10.4%","d":"up"}];
const COLS = ["ID","Gluing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Plywood Mfg #001","Plywood Mfg #002","6.817","7.273","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Plywood Mfg #002","Plywood Mfg #003","4.737","8.361","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Plywood Mfg #003","Plywood Mfg #004","9.076","1.323","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Plywood Mfg #004","Plywood Mfg #005","4.673","3.420","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Plywood Mfg #005","Plywood Mfg #001","4.910","4.459","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":470},{"label":"Mar","value":504},{"label":"Abr","value":427},{"label":"Mai","value":322},{"label":"Jun","value":266},{"label":"Jul","value":338},{"label":"Ago","value":447},{"label":"Set","value":411},{"label":"Out","value":298},{"label":"Nov","value":417},{"label":"Dez","value":231}];
const MX = 504;
...
export default function GluingPage() {
    return (
