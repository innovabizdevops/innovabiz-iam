...
const KPIS = [{"l":"Riscos Identificados","v":"1.076","t":"+17.0%","d":"up"},{"l":"Mitigações Ativas","v":"3.746","t":"+2.2%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"+10.2%","d":"up"},{"l":"Incidentes YTD","v":"5.889","t":"-4.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.237","1.202","5.460","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.141","6.314","1.765","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.041","6.331","1.057","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.986","6.055","8.317","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.014","2.254","5.039","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":327},{"label":"Fev","value":288},{"label":"Mar","value":358},{"label":"Abr","value":426},{"label":"Mai","value":421},{"label":"Jun","value":481},{"label":"Jul","value":474},{"label":"Ago","value":374},{"label":"Set","value":431},{"label":"Out","value":482},{"label":"Nov","value":336},{"label":"Dez","value":619}];
const MX = 619;
