...
const ACCENT = "#059669";
const MODULE = "Permits & Licenses";
const PAGE = "Application Form";
const KPIS = [{"l":"Riscos Identificados","v":"723","t":"+8.5%","d":"up"},{"l":"Mitigações Ativas","v":"579","t":"-1.9%","d":"down"},{"l":"Score Risco Geral","v":"94","t":"+14.4%","d":"up"},{"l":"Incidentes YTD","v":"248","t":"-3.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.582","1.084","8.534","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.625","7.916","362","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.181","5.660","1.160","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.794","675","8.975","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.219","4.260","2.212","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":949},{"label":"Mar","value":926},{"label":"Abr","value":946},{"label":"Mai","value":889},{"label":"Jun","value":756},{"label":"Jul","value":933},{"label":"Ago","value":954},{"label":"Set","value":732},{"label":"Out","value":879},{"label":"Nov","value":990},{"label":"Dez","value":1001}];
const MX = 1001;
