...
const KPIS = [{"l":"Riscos Identificados","v":"5.404","t":"+16.9%","d":"up"},{"l":"Mitigações Ativas","v":"6.884","t":"+3.6%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+4.4%","d":"up"},{"l":"Incidentes YTD","v":"5.005","t":"+13.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.323","2.452","802","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.757","1.254","908","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","9.065","7.391","6.746","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.823","8.184","8.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.421","3.193","7.567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":884},{"label":"Fev","value":774},{"label":"Mar","value":798},{"label":"Abr","value":565},{"label":"Mai","value":738},{"label":"Jun","value":674},{"label":"Jul","value":725},{"label":"Ago","value":903},{"label":"Set","value":888},{"label":"Out","value":628},{"label":"Nov","value":915},{"label":"Dez","value":639}];
const MX = 915;
