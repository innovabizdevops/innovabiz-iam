...
const PAGE = "Issuance";
const KPIS = [{"l":"Riscos Identificados","v":"2.747","t":"+6.4%","d":"up"},{"l":"Mitigações Ativas","v":"2.039","t":"+17.4%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-5.6%","d":"down"},{"l":"Incidentes YTD","v":"1.212","t":"+8.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.428","2.536","7.530","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","9.093","4.744","4.081","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.629","2.734","707","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.991","3.763","6.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.100","2.320","6.146","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":509},{"label":"Mar","value":536},{"label":"Abr","value":317},{"label":"Mai","value":325},{"label":"Jun","value":637},{"label":"Jul","value":550},{"label":"Ago","value":410},{"label":"Set","value":579},{"label":"Out","value":358},{"label":"Nov","value":434},{"label":"Dez","value":402}];
const MX = 637;
