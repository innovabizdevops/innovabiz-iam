...
const PAGE = "Renewal";
const KPIS = [{"l":"Riscos Identificados","v":"3.587","t":"+5.2%","d":"up"},{"l":"Mitigações Ativas","v":"1.763","t":"+0.0%","d":"up"},{"l":"Score Risco Geral","v":"71","t":"+15.4%","d":"up"},{"l":"Incidentes YTD","v":"7.531","t":"+1.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.383","1.992","3.677","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.692","3.184","3.706","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.277","3.985","4.843","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.455","8.830","2.877","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.943","1.416","3.373","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":669},{"label":"Mar","value":686},{"label":"Abr","value":872},{"label":"Mai","value":956},{"label":"Jun","value":1008},{"label":"Jul","value":912},{"label":"Ago","value":884},{"label":"Set","value":924},{"label":"Out","value":797},{"label":"Nov","value":805},{"label":"Dez","value":654}];
const MX = 1008;
