...
const PAGE = "POS";
const KPIS = [{"l":"Pedidos/Dia","v":"1448","t":"+2.7%","d":"up"},{"l":"GMV (€)","v":"€9291","t":"-4.3%","d":"down"},{"l":"Conversão (%)","v":"76.1%","t":"-0.1%","d":"down"},{"l":"AOV (€)","v":"€25153","t":"-3.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 47543.11","343","3.507","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39868.77","2.947","3.226","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 31359.17","6.126","1.061","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 36159.25","4.472","2.950","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 16782.64","7.107","2.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1046},{"label":"Fev","value":1021},{"label":"Mar","value":936},{"label":"Abr","value":997},{"label":"Mai","value":1014},{"label":"Jun","value":718},{"label":"Jul","value":1052},{"label":"Ago","value":777},{"label":"Set","value":850},{"label":"Out","value":915},{"label":"Nov","value":683},{"label":"Dez","value":727}];
const MX = 1052;
