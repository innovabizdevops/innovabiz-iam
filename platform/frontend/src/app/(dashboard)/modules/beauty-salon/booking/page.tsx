...
const ACCENT = "#db2777";
const MODULE = "Beauty Salon";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"6.744","t":"-4.7%","d":"down"},{"l":"RevPAR (€)","v":"€38836","t":"+5.6%","d":"up"},{"l":"Ocupação (%)","v":"91.3%","t":"-0.7%","d":"down"},{"l":"Guest Satisfaction","v":"6.358","t":"+3.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","709","2026-01-01","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.310","2026-02-28","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.612","2026-02-10","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.642","2026-02-12","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.810","2026-03-05","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":657},{"label":"Mar","value":789},{"label":"Abr","value":722},{"label":"Mai","value":706},{"label":"Jun","value":627},{"label":"Jul","value":821},{"label":"Ago","value":812},{"label":"Set","value":721},{"label":"Out","value":683},{"label":"Nov","value":897},{"label":"Dez","value":733}];
const MX = 956;
