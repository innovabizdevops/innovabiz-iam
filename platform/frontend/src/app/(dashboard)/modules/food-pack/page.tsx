...
/* ═══ Food Packaging — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "8789", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2903", trend: "-9%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "1623925489", cells: ["FOO-2489", "Food Packaging Item 1", "26/2/2026", "€25 589"], status: "active" as const },
    { id: "1623929060", cells: ["FOO-6060", "Food Packaging Item 2", "13/9/2026", "€29 160"], status: "pending" as const },
    { id: "1623932631", cells: ["FOO-9631", "Food Packaging Item 3", "28/4/2026", "€32 731"], status: "completed" as const },
    { id: "1623936202", cells: ["FOO-4202", "Food Packaging Item 4", "15/11/2026", "€36 302"], status: "warning" as const },
    { id: "1623939773", cells: ["FOO-7773", "Food Packaging Item 5", "2/6/2026", "€39 873"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Packaging</p>
                    </div>
                </div>
