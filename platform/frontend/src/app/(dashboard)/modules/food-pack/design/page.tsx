...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"5.083","t":"+4.1%","d":"up"},{"l":"Submissões/Dia","v":"3672","t":"+16.3%","d":"up"},{"l":"Documentos Gerados","v":"1.476","t":"+12.3%","d":"up"},{"l":"Templates","v":"2.299","t":"-5.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.115","2026-03-17","983","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.843","2026-01-15","8.101","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.114","2026-02-09","7.092","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.679","2026-02-15","2.435","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.816","2026-02-08","2.898","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":585},{"label":"Mar","value":397},{"label":"Abr","value":327},{"label":"Mai","value":565},{"label":"Jun","value":247},{"label":"Jul","value":362},{"label":"Ago","value":545},{"label":"Set","value":546},{"label":"Out","value":247},{"label":"Nov","value":593},{"label":"Dez","value":562}];
const MX = 593;
