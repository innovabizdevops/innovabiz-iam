...
const PAGE = "PLM Lifecycle";
const KPIS = [{"l":"Produtos Ativos","v":"1.839","t":"-1.2%","d":"down"},{"l":"SKUs","v":"2.556","t":"-0.2%","d":"down"},{"l":"ECNs Pendentes","v":"1.386","t":"-4.9%","d":"down"},{"l":"Time-to-Market (dias)","v":"2.097","t":"-1.3%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","8.335","4.623","5.772","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.733","1.511","4.170","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","2.211","2.354","4.369","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","2.861","6.002","8.403","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","2.107","1.022","3.963","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":625},{"label":"Mar","value":642},{"label":"Abr","value":808},{"label":"Mai","value":985},{"label":"Jun","value":979},{"label":"Jul","value":618},{"label":"Ago","value":646},{"label":"Set","value":702},{"label":"Out","value":631},{"label":"Nov","value":914},{"label":"Dez","value":736}];
const MX = 985;
