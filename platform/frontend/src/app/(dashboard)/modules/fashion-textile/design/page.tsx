...
const PAGE = "Design Studio";
const KPIS = [{"l":"Formulários Ativos","v":"8.744","t":"+3.4%","d":"up"},{"l":"Submissões/Dia","v":"302","t":"+0.0%","d":"up"},{"l":"Documentos Gerados","v":"1.775","t":"-1.3%","d":"down"},{"l":"Templates","v":"3.840","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.361","2026-01-24","1.906","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.697","2026-02-25","4.318","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.211","2026-01-14","1.779","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.290","2026-02-20","2.217","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","461","2026-01-07","5.374","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":486},{"label":"Mar","value":463},{"label":"Abr","value":593},{"label":"Mai","value":693},{"label":"Jun","value":693},{"label":"Jul","value":681},{"label":"Ago","value":499},{"label":"Set","value":602},{"label":"Out","value":467},{"label":"Nov","value":647},{"label":"Dez","value":730}];
const MX = 730;
