...
const PAGE = "Digital Passport";
const KPIS = [{"l":"Atletas Registados","v":"5.980","t":"-2.6%","d":"down"},{"l":"Treinos/Semana","v":"3308","t":"-5.3%","d":"down"},{"l":"Competições","v":"4.999","t":"-3.9%","d":"down"},{"l":"Performance Score","v":"94","t":"+16.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.801","2.562","5.599","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","3.800","2.811","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.682","2.889","9.090","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.455","4.934","1.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.261","5.288","7.604","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":713},{"label":"Fev","value":914},{"label":"Mar","value":828},{"label":"Abr","value":881},{"label":"Mai","value":588},{"label":"Jun","value":643},{"label":"Jul","value":863},{"label":"Ago","value":705},{"label":"Set","value":594},{"label":"Out","value":860},{"label":"Nov","value":826},{"label":"Dez","value":792}];
const MX = 914;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>EU DPP</span></h1>
                </div>
