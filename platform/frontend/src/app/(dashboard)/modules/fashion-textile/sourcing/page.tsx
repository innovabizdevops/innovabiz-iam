...
const ACCENT = "#db2777";
const MODULE = "Fashion & Textile";
const PAGE = "Sustainable Sourcing";
const KPIS = [{"l":"Fornecedores Ativos","v":"1.467","t":"-3.8%","d":"down"},{"l":"Contratos (€M)","v":"€22.0M","t":"+4.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"67.3%","t":"+11.1%","d":"up"},{"l":"Score Médio","v":"73","t":"+2.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","93.5%","€ 2348.36","7.733","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","84.8%","€ 2060.81","6.613","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","84.7%","€ 13250.09","4.535","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","90.0%","€ 27015.29","8.949","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","87.3%","€ 44628.89","2.504","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":296},{"label":"Fev","value":335},{"label":"Mar","value":305},{"label":"Abr","value":398},{"label":"Mai","value":540},{"label":"Jun","value":608},{"label":"Jul","value":477},{"label":"Ago","value":484},{"label":"Set","value":506},{"label":"Out","value":495},{"label":"Nov","value":290},{"label":"Dez","value":319}];
const MX = 608;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#db2777'}}>ESG</span></h1>
                </div>
