...
/* ═══ Customer Insights (APQC 3.6) — Dashboard ═══ */

const ACCENT = "#60a5fa";

const KPIS = [
    { label: "Total Registos", value: "9229", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1107", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€42K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "332629329", cells: ["CUS-8329", "Customer Insights (APQC 3.6) Item 1", "26/10/2026", "€29 429"], status: "active" as const },
    { id: "332632900", cells: ["CUS-2900", "Customer Insights (APQC 3.6) Item 2", "13/5/2026", "€33 000"], status: "pending" as const },
    { id: "332636471", cells: ["CUS-6471", "Customer Insights (APQC 3.6) Item 3", "28/12/2026", "€36 571"], status: "completed" as const },
    { id: "332640042", cells: ["CUS-1042", "Customer Insights (APQC 3.6) Item 4", "15/7/2026", "€40 142"], status: "warning" as const },
    { id: "332643613", cells: ["CUS-4613", "Customer Insights (APQC 3.6) Item 5", "2/2/2026", "€43 713"], status: "active" as const },
];
...
export default function CustomerInsightsApqc36Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Customer Insights (APQC 3.6)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Customer Insights (APQC 3.6)</p>
                    </div>
                </div>
