...
const ACCENT = "#60a5fa";
const MODULE = "Customer Insights (APQC 3.6)";
const PAGE = "Sentiment";
const KPIS = [{"l":"Dashboards Ativos","v":"4.130","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"395","t":"+1.9%","d":"up"},{"l":"Dados Processados (GB)","v":"1.080","t":"+9.4%","d":"up"},{"l":"Utilizadores Analytics","v":"481","t":"-3.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3905","2026-01-12","7.009","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4449","2026-03-10","820","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1794","2026-01-21","726","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2668","2026-01-28","1.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","183","2026-03-20","5.904","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":288},{"label":"Mar","value":565},{"label":"Abr","value":546},{"label":"Mai","value":456},{"label":"Jun","value":618},{"label":"Jul","value":495},{"label":"Ago","value":439},{"label":"Set","value":484},{"label":"Out","value":430},{"label":"Nov","value":468},{"label":"Dez","value":561}];
const MX = 618;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#60a5fa'}}>AI</span></h1>
                </div>
