...
/* ═══ Biosimilar Development — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "1130", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4079", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€76K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1301979730", cells: ["BIO-4730", "Biosimilar Development Item 1", "3/11/2026", "€29 830"], status: "active" as const },
    { id: "1301983301", cells: ["BIO-8301", "Biosimilar Development Item 2", "18/6/2026", "€33 401"], status: "pending" as const },
    { id: "1301986872", cells: ["BIO-2872", "Biosimilar Development Item 3", "5/1/2026", "€36 972"], status: "completed" as const },
    { id: "1301990443", cells: ["BIO-6443", "Biosimilar Development Item 4", "20/8/2026", "€40 543"], status: "warning" as const },
    { id: "1301994014", cells: ["BIO-1014", "Biosimilar Development Item 5", "7/3/2026", "€44 114"], status: "active" as const },
];
...
export default function BiosimilarDevelopmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biosimilar Development</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Biosimilar Development</p>
                    </div>
                </div>
