...
const PAGE = "Compare";
const KPIS = [{"l":"Ideias Submetidas","v":"3.208","t":"-0.9%","d":"down"},{"l":"Patentes (YTD)","v":"3.822","t":"+3.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"403","t":"+9.3%","d":"up"},{"l":"Budget I&D (€M)","v":"€41.9M","t":"-1.1%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","797","85.2%","4.329","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","3.541","70.8%","4.694","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","4.983","90.7%","431","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.461","93.6%","3.021","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.423","86.2%","310","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":869},{"label":"Fev","value":571},{"label":"Mar","value":774},{"label":"Abr","value":800},{"label":"Mai","value":862},{"label":"Jun","value":825},{"label":"Jul","value":523},{"label":"Ago","value":893},{"label":"Set","value":551},{"label":"Out","value":591},{"label":"Nov","value":654},{"label":"Dez","value":585}];
const MX = 893;
