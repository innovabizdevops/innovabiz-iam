...
const ACCENT = "#5b21b6";
const MODULE = "Biosimilar Development";
const PAGE = "Characterize";
const KPIS = [{"l":"Ideias Submetidas","v":"175","t":"+17.7%","d":"up"},{"l":"Patentes (YTD)","v":"5.220","t":"+11.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.620","t":"-5.3%","d":"down"},{"l":"Budget I&D (€M)","v":"€10.6M","t":"-0.9%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.225","87.3%","3.006","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.451","85.4%","593","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.869","91.1%","4.935","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.182","81.6%","8.914","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","3.994","93.0%","6.642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":518},{"label":"Mar","value":525},{"label":"Abr","value":430},{"label":"Mai","value":679},{"label":"Jun","value":474},{"label":"Jul","value":384},{"label":"Ago","value":635},{"label":"Set","value":727},{"label":"Out","value":574},{"label":"Nov","value":450},{"label":"Dez","value":424}];
const MX = 727;
