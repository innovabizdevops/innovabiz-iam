...
const PAGE = "Clinical";
const KPIS = [{"l":"Ideias Submetidas","v":"8.762","t":"+16.7%","d":"up"},{"l":"Patentes (YTD)","v":"4.551","t":"+5.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.709","t":"+7.5%","d":"up"},{"l":"Budget I&D (€M)","v":"€19.1M","t":"+5.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.428","80.5%","3.017","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.351","81.6%","4.350","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","763","87.0%","6.402","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.814","87.6%","1.498","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.417","99.2%","7.438","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":670},{"label":"Mar","value":775},{"label":"Abr","value":933},{"label":"Mai","value":605},{"label":"Jun","value":644},{"label":"Jul","value":800},{"label":"Ago","value":877},{"label":"Set","value":938},{"label":"Out","value":655},{"label":"Nov","value":945},{"label":"Dez","value":959}];
const MX = 959;
