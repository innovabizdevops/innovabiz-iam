...
const PAGE = "Launch";
const KPIS = [{"l":"Ideias Submetidas","v":"1.950","t":"+5.5%","d":"up"},{"l":"Patentes (YTD)","v":"3.821","t":"+0.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.521","t":"+9.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€36.1M","t":"-5.2%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","3.301","89.0%","5.962","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.456","92.0%","5.466","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.187","98.1%","475","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.048","90.1%","7.488","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","767","77.8%","7.712","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":560},{"label":"Mar","value":662},{"label":"Abr","value":419},{"label":"Mai","value":804},{"label":"Jun","value":664},{"label":"Jul","value":503},{"label":"Ago","value":507},{"label":"Set","value":455},{"label":"Out","value":541},{"label":"Nov","value":484},{"label":"Dez","value":644}];
const MX = 804;
