...
const ACCENT = "#6366f1";
const MODULE = "Hospitality Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.769","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"4049","t":"+6.7%","d":"up"},{"l":"Dados Processados (GB)","v":"4.432","t":"+9.9%","d":"up"},{"l":"Utilizadores Analytics","v":"409","t":"-5.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","871","2026-02-16","1.855","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2325","2026-02-15","3.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2957","2026-02-10","1.000","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2384","2026-02-07","5.060","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3030","2026-01-16","2.911","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":502},{"label":"Fev","value":421},{"label":"Mar","value":626},{"label":"Abr","value":501},{"label":"Mai","value":582},{"label":"Jun","value":663},{"label":"Jul","value":640},{"label":"Ago","value":639},{"label":"Set","value":530},{"label":"Out","value":482},{"label":"Nov","value":620},{"label":"Dez","value":312}];
const MX = 663;
