...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"8.476","t":"+10.9%","d":"up"},{"l":"Queries/Dia","v":"3497","t":"+0.4%","d":"up"},{"l":"Dados Processados (GB)","v":"7.122","t":"+17.7%","d":"up"},{"l":"Utilizadores Analytics","v":"2.057","t":"+13.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3454","2026-02-20","8.802","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4253","2026-01-14","6.942","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2122","2026-01-13","7.349","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5021","2026-01-19","3.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2678","2026-02-17","8.932","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":605},{"label":"Mar","value":550},{"label":"Abr","value":472},{"label":"Mai","value":749},{"label":"Jun","value":575},{"label":"Jul","value":486},{"label":"Ago","value":458},{"label":"Set","value":750},{"label":"Out","value":450},{"label":"Nov","value":459},{"label":"Dez","value":603}];
const MX = 750;
