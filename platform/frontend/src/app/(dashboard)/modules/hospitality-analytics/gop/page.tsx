...
const PAGE = "GOP";
const KPIS = [{"l":"Dashboards Ativos","v":"4.556","t":"-1.7%","d":"down"},{"l":"Queries/Dia","v":"2808","t":"+16.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.166","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.063","t":"-5.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3726","2026-01-27","5.441","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3900","2026-03-10","6.486","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","784","2026-01-10","5.589","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4252","2026-01-18","9.038","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3891","2026-02-28","7.942","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":863},{"label":"Mar","value":827},{"label":"Abr","value":968},{"label":"Mai","value":910},{"label":"Jun","value":666},{"label":"Jul","value":834},{"label":"Ago","value":923},{"label":"Set","value":672},{"label":"Out","value":960},{"label":"Nov","value":780},{"label":"Dez","value":710}];
const MX = 968;
...
export default function GopPage() {
    return (
