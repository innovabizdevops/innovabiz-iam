...
const PAGE = "Guest";
const KPIS = [{"l":"Dashboards Ativos","v":"1.082","t":"+5.3%","d":"up"},{"l":"Queries/Dia","v":"3367","t":"+5.9%","d":"up"},{"l":"Dados Processados (GB)","v":"4.629","t":"+13.0%","d":"up"},{"l":"Utilizadores Analytics","v":"8.273","t":"+8.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1290","2026-03-05","2.115","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3063","2026-02-21","3.950","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3575","2026-02-24","5.520","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2346","2026-01-25","7.072","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2166","2026-01-01","4.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":457},{"label":"Mar","value":615},{"label":"Abr","value":416},{"label":"Mai","value":712},{"label":"Jun","value":799},{"label":"Jul","value":667},{"label":"Ago","value":789},{"label":"Set","value":656},{"label":"Out","value":544},{"label":"Nov","value":773},{"label":"Dez","value":645}];
const MX = 799;
