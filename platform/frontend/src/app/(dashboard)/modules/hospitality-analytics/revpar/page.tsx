...
const PAGE = "RevPAR";
const KPIS = [{"l":"Dashboards Ativos","v":"1.032","t":"+15.9%","d":"up"},{"l":"Queries/Dia","v":"3903","t":"+4.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.701","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"633","t":"+12.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2650","2026-01-24","4.843","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3844","2026-02-15","3.157","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1004","2026-02-16","2.664","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","217","2026-01-22","1.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1710","2026-01-23","1.241","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":749},{"label":"Mar","value":925},{"label":"Abr","value":938},{"label":"Mai","value":689},{"label":"Jun","value":628},{"label":"Jul","value":800},{"label":"Ago","value":657},{"label":"Set","value":798},{"label":"Out","value":639},{"label":"Nov","value":617},{"label":"Dez","value":745}];
const MX = 938;
