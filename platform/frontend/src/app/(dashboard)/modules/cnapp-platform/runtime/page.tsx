...
const ACCENT = "#7f1d1d";
const MODULE = "CNAPP Platform";
const PAGE = "Runtime";
const KPIS = [{"l":"Formulários Ativos","v":"7.554","t":"+7.2%","d":"up"},{"l":"Submissões/Dia","v":"4717","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"7.943","t":"+14.1%","d":"up"},{"l":"Templates","v":"319","t":"+6.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.898","2026-02-14","2.736","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.844","2026-02-14","7.618","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.332","2026-02-08","6.446","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","277","2026-02-28","4.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.915","2026-02-03","3.693","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":577},{"label":"Mar","value":725},{"label":"Abr","value":480},{"label":"Mai","value":734},{"label":"Jun","value":616},{"label":"Jul","value":422},{"label":"Ago","value":377},{"label":"Set","value":582},{"label":"Out","value":606},{"label":"Nov","value":596},{"label":"Dez","value":672}];
const MX = 734;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7f1d1d'}}>RTM</span></h1>
                </div>
