...
/* ═══ CNAPP Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "5355", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3786", trend: "+25%", trendDirection: "up" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "335555855", cells: ["CNA-9855", "CNAPP Platform Item 1", "20/12/2026", "€5955"], status: "active" as const },
    { id: "335559426", cells: ["CNA-4426", "CNAPP Platform Item 2", "7/7/2026", "€9526"], status: "pending" as const },
    { id: "335562997", cells: ["CNA-7997", "CNAPP Platform Item 3", "22/2/2026", "€13 097"], status: "completed" as const },
    { id: "335566568", cells: ["CNA-2568", "CNAPP Platform Item 4", "9/9/2026", "€16 668"], status: "warning" as const },
    { id: "335570139", cells: ["CNA-6139", "CNAPP Platform Item 5", "24/4/2026", "€20 239"], status: "active" as const },
];
...
export default function CnappPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CNAPP Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CNAPP Platform</p>
                    </div>
                </div>
