...
const PAGE = "Serverless";
const KPIS = [{"l":"Formulários Ativos","v":"2.817","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"3246","t":"-4.9%","d":"down"},{"l":"Documentos Gerados","v":"8.453","t":"+11.6%","d":"up"},{"l":"Templates","v":"6.572","t":"-1.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.403","2026-01-25","5.649","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.390","2026-03-23","8.750","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.699","2026-02-17","620","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.624","2026-01-15","300","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.429","2026-01-08","829","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":311},{"label":"Mar","value":536},{"label":"Abr","value":590},{"label":"Mai","value":365},{"label":"Jun","value":387},{"label":"Jul","value":376},{"label":"Ago","value":327},{"label":"Set","value":374},{"label":"Out","value":660},{"label":"Nov","value":322},{"label":"Dez","value":415}];
const MX = 660;
