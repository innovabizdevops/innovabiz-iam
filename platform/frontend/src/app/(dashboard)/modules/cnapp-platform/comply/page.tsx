...
const PAGE = "Comply";
const KPIS = [{"l":"Formulários Ativos","v":"4.594","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"1293","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"2.272","t":"-1.5%","d":"down"},{"l":"Templates","v":"5.577","t":"+12.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.521","2026-03-09","6.204","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.493","2026-01-06","6.130","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.099","2026-02-05","3.897","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.433","2026-02-17","8.885","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.484","2026-01-28","4.766","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":676},{"label":"Mar","value":587},{"label":"Abr","value":666},{"label":"Mai","value":476},{"label":"Jun","value":856},{"label":"Jul","value":734},{"label":"Ago","value":700},{"label":"Set","value":612},{"label":"Out","value":728},{"label":"Nov","value":527},{"label":"Dez","value":588}];
const MX = 856;
