...
const KPIS = [{"l":"Formulários Ativos","v":"5.470","t":"+16.8%","d":"up"},{"l":"Submissões/Dia","v":"3798","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"3.422","t":"+11.8%","d":"up"},{"l":"Templates","v":"6.246","t":"+7.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","522","2026-03-16","8.622","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.245","2026-03-02","3.717","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.274","2026-01-01","6.360","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.330","2026-01-14","1.821","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.238","2026-01-27","2.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":791},{"label":"Mar","value":837},{"label":"Abr","value":1014},{"label":"Mai","value":1057},{"label":"Jun","value":1067},{"label":"Jul","value":986},{"label":"Ago","value":739},{"label":"Set","value":997},{"label":"Out","value":812},{"label":"Nov","value":1074},{"label":"Dez","value":965}];
const MX = 1074;
