...
const PAGE = "IaC";
const KPIS = [{"l":"Formulários Ativos","v":"661","t":"+8.3%","d":"up"},{"l":"Submissões/Dia","v":"4130","t":"+11.7%","d":"up"},{"l":"Documentos Gerados","v":"8.894","t":"-5.3%","d":"down"},{"l":"Templates","v":"271","t":"+17.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.751","2026-02-22","4.202","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.789","2026-01-19","8.363","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.554","2026-02-18","1.535","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","377","2026-01-20","3.934","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.781","2026-02-14","7.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":780},{"label":"Fev","value":706},{"label":"Mar","value":735},{"label":"Abr","value":577},{"label":"Mai","value":624},{"label":"Jun","value":442},{"label":"Jul","value":397},{"label":"Ago","value":568},{"label":"Set","value":638},{"label":"Out","value":527},{"label":"Nov","value":780},{"label":"Dez","value":610}];
const MX = 780;
