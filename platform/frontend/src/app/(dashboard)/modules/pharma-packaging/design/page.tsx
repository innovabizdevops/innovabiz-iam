...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.753","t":"-1.1%","d":"down"},{"l":"Submissões/Dia","v":"3992","t":"-1.3%","d":"down"},{"l":"Documentos Gerados","v":"8.889","t":"+8.7%","d":"up"},{"l":"Templates","v":"3.589","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.527","2026-01-01","8.494","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.258","2026-03-28","4.131","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.314","2026-02-27","2.476","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.887","2026-01-19","4.508","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.126","2026-02-06","2.185","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":785},{"label":"Fev","value":741},{"label":"Mar","value":756},{"label":"Abr","value":519},{"label":"Mai","value":516},{"label":"Jun","value":559},{"label":"Jul","value":611},{"label":"Ago","value":570},{"label":"Set","value":673},{"label":"Out","value":687},{"label":"Nov","value":554},{"label":"Dez","value":643}];
const MX = 785;
