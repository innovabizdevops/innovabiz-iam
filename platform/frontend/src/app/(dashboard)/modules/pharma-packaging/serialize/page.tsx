...
const ACCENT = "#5b21b6";
const MODULE = "Pharma Packaging";
const PAGE = "Serialize";
const KPIS = [{"l":"Total Pharma Packaging","v":"6.688","t":"+0.4%","d":"up"},{"l":"Serialize Ativos","v":"4.435","t":"+1.1%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+3.3%","d":"up"}];
const COLS = ["ID","Serialize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Packaging #001","Pharma Packaging #002","1.810","5.144","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Packaging #002","Pharma Packaging #003","2.809","3.394","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Packaging #003","Pharma Packaging #004","7.532","4.374","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Packaging #004","Pharma Packaging #005","4.681","978","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Packaging #005","Pharma Packaging #001","775","4.401","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":588},{"label":"Mar","value":704},{"label":"Abr","value":550},{"label":"Mai","value":613},{"label":"Jun","value":617},{"label":"Jul","value":821},{"label":"Ago","value":617},{"label":"Set","value":799},{"label":"Out","value":757},{"label":"Nov","value":737},{"label":"Dez","value":803}];
const MX = 862;
