...
const PAGE = "Validate";
const KPIS = [{"l":"Total Pharma Packaging","v":"3.722","t":"-4.8%","d":"down"},{"l":"Validate Ativos","v":"7.303","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+16.1%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharma Packaging #001","Pharma Packaging #002","2.894","6.500","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Pharma Packaging #002","Pharma Packaging #003","7.494","7.270","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharma Packaging #003","Pharma Packaging #004","2.517","867","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Pharma Packaging #004","Pharma Packaging #005","1.808","5.212","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharma Packaging #005","Pharma Packaging #001","6.068","4.401","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":852},{"label":"Mar","value":782},{"label":"Abr","value":535},{"label":"Mai","value":667},{"label":"Jun","value":695},{"label":"Jul","value":547},{"label":"Ago","value":787},{"label":"Set","value":576},{"label":"Out","value":530},{"label":"Nov","value":804},{"label":"Dez","value":487}];
const MX = 852;
