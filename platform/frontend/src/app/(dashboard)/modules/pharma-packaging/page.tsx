...
/* ═══ Pharma Packaging — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "5646", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1099", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€71K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "577819046", cells: ["PHA-2046", "Pharma Packaging Item 1", "15/3/2026", "€19 146"], status: "active" as const },
    { id: "577822617", cells: ["PHA-5617", "Pharma Packaging Item 2", "2/10/2026", "€22 717"], status: "pending" as const },
    { id: "577826188", cells: ["PHA-9188", "Pharma Packaging Item 3", "17/5/2026", "€26 288"], status: "completed" as const },
    { id: "577829759", cells: ["PHA-3759", "Pharma Packaging Item 4", "4/12/2026", "€29 859"], status: "warning" as const },
    { id: "577833330", cells: ["PHA-7330", "Pharma Packaging Item 5", "19/7/2026", "€33 430"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pharma Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pharma Packaging</p>
                    </div>
                </div>
