...
const PAGE = "Demand";
const KPIS = [{"l":"Integrações Ativas","v":"5.913","t":"+10.5%","d":"up"},{"l":"Chamadas/Hora","v":"3644","t":"+8.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.6%","t":"+0.8%","d":"up"},{"l":"Latência Média (ms)","v":"167ms","t":"+17.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.386","8.863","93.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.198","2.362","99.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.659","4.839","85.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","289","2.453","70.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.070","7.917","90.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":500},{"label":"Mar","value":628},{"label":"Abr","value":312},{"label":"Mai","value":468},{"label":"Jun","value":489},{"label":"Jul","value":400},{"label":"Ago","value":460},{"label":"Set","value":284},{"label":"Out","value":343},{"label":"Nov","value":349},{"label":"Dez","value":422}];
const MX = 643;
