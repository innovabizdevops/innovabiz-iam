...
const KPIS = [{"l":"Integrações Ativas","v":"4.803","t":"+14.4%","d":"up"},{"l":"Chamadas/Hora","v":"1303","t":"+10.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"-2.5%","d":"down"},{"l":"Latência Média (ms)","v":"111ms","t":"-2.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.461","4.784","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.213","8.966","78.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.159","3.545","93.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.889","2.628","88.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.090","2.986","99.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":801},{"label":"Fev","value":813},{"label":"Mar","value":858},{"label":"Abr","value":685},{"label":"Mai","value":837},{"label":"Jun","value":923},{"label":"Jul","value":587},{"label":"Ago","value":897},{"label":"Set","value":691},{"label":"Out","value":727},{"label":"Nov","value":581},{"label":"Dez","value":792}];
const MX = 923;
