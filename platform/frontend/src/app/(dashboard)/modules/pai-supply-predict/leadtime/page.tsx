...
const ACCENT = "#0c4a6e";
const MODULE = "P-AI Supply Chain Predict";
const PAGE = "Lead Time";
const KPIS = [{"l":"Integrações Ativas","v":"3.332","t":"-1.1%","d":"down"},{"l":"Chamadas/Hora","v":"4001","t":"+17.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.4%","t":"+11.9%","d":"up"},{"l":"Latência Média (ms)","v":"7ms","t":"+14.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.831","4.783","94.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.378","7.074","91.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.809","7.674","97.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.364","5.532","79.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.433","4.054","93.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":851},{"label":"Mar","value":819},{"label":"Abr","value":965},{"label":"Mai","value":673},{"label":"Jun","value":660},{"label":"Jul","value":698},{"label":"Ago","value":797},{"label":"Set","value":687},{"label":"Out","value":654},{"label":"Nov","value":688},{"label":"Dez","value":939}];
const MX = 965;
