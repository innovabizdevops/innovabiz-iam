...
const PAGE = "Disrupt";
const KPIS = [{"l":"Integrações Ativas","v":"8.922","t":"-4.9%","d":"down"},{"l":"Chamadas/Hora","v":"3946","t":"+5.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"66.5%","t":"-0.8%","d":"down"},{"l":"Latência Média (ms)","v":"197ms","t":"+0.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.567","8.946","89.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.987","3.559","73.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.382","3.937","82.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.947","4.789","84.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.457","8.089","83.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":680},{"label":"Mar","value":742},{"label":"Abr","value":743},{"label":"Mai","value":831},{"label":"Jun","value":671},{"label":"Jul","value":861},{"label":"Ago","value":880},{"label":"Set","value":689},{"label":"Out","value":869},{"label":"Nov","value":579},{"label":"Dez","value":634}];
const MX = 880;
