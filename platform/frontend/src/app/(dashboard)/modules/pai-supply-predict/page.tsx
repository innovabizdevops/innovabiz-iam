...
/* ═══ P-AI Supply Chain Predict — Dashboard ═══ */

const ACCENT = "#0c4a6e";

const KPIS = [
    { label: "Total Registos", value: "6945", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1454", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "495254345", cells: ["PAI-3345", "P-AI Supply Chain Predict Item 1", "6/6/2026", "€4445"], status: "active" as const },
    { id: "495257916", cells: ["PAI-6916", "P-AI Supply Chain Predict Item 2", "21/1/2026", "€8016"], status: "pending" as const },
    { id: "495261487", cells: ["PAI-1487", "P-AI Supply Chain Predict Item 3", "8/8/2026", "€11 587"], status: "completed" as const },
    { id: "495265058", cells: ["PAI-5058", "P-AI Supply Chain Predict Item 4", "23/3/2026", "€15 158"], status: "warning" as const },
    { id: "495268629", cells: ["PAI-8629", "P-AI Supply Chain Predict Item 5", "10/10/2026", "€18 729"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 45 }, { label: "Fev", value: 54 }, { label: "Mar", value: 63 }, { label: "Abr", value: 72 }, { label: "Mai", value: 81 }, { label: "Jun", value: 90 }];
...
export default function PaiSupplyChainPredictPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P-AI Supply Chain Predict</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • P-AI Supply Chain Predict</p>
                    </div>
                </div>
