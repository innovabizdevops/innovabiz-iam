...
const PAGE = "Route";
const KPIS = [{"l":"Integrações Ativas","v":"4.577","t":"+4.9%","d":"up"},{"l":"Chamadas/Hora","v":"2171","t":"-0.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"82.6%","t":"+0.4%","d":"up"},{"l":"Latência Média (ms)","v":"122ms","t":"-4.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.370","7.314","75.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.414","2.808","81.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.891","3.830","91.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.395","3.073","91.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.699","2.710","95.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":750},{"label":"Mar","value":591},{"label":"Abr","value":649},{"label":"Mai","value":668},{"label":"Jun","value":738},{"label":"Jul","value":932},{"label":"Ago","value":584},{"label":"Set","value":871},{"label":"Out","value":878},{"label":"Nov","value":837},{"label":"Dez","value":709}];
const MX = 932;
