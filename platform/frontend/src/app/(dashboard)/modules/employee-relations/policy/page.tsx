...
const PAGE = "Policy";
const KPIS = [{"l":"eNPS","v":"78","t":"+14.0%","d":"up"},{"l":"Engagement (%)","v":"75.5%","t":"+13.1%","d":"up"},{"l":"Turnover (%)","v":"85.9%","t":"+17.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"774","t":"+13.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.745","2026-01-07","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.392","2026-01-04","84","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","185","2026-02-06","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.502","2026-03-02","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.215","2026-01-03","87","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":569},{"label":"Mar","value":688},{"label":"Abr","value":762},{"label":"Mai","value":626},{"label":"Jun","value":851},{"label":"Jul","value":569},{"label":"Ago","value":944},{"label":"Set","value":681},{"label":"Out","value":563},{"label":"Nov","value":743},{"label":"Dez","value":649}];
const MX = 944;
