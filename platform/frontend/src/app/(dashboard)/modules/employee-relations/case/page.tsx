...
const KPIS = [{"l":"eNPS","v":"72","t":"+11.7%","d":"up"},{"l":"Engagement (%)","v":"85.9%","t":"+10.9%","d":"up"},{"l":"Turnover (%)","v":"69.3%","t":"+12.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.509","t":"-1.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.634","2026-03-09","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.654","2026-03-27","82","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.387","2026-01-20","82","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","134","2026-01-07","83","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.841","2026-03-09","76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":777},{"label":"Mar","value":693},{"label":"Abr","value":573},{"label":"Mai","value":700},{"label":"Jun","value":635},{"label":"Jul","value":580},{"label":"Ago","value":762},{"label":"Set","value":853},{"label":"Out","value":757},{"label":"Nov","value":686},{"label":"Dez","value":689}];
const MX = 853;
