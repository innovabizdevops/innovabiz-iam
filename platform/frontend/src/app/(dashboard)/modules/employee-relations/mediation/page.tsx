...
const KPIS = [{"l":"eNPS","v":"93","t":"+4.1%","d":"up"},{"l":"Engagement (%)","v":"75.8%","t":"+1.4%","d":"up"},{"l":"Turnover (%)","v":"80.5%","t":"+17.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.666","t":"+12.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.103","2026-02-20","70","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.269","2026-02-08","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.493","2026-01-06","83","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","601","2026-03-17","93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.384","2026-02-13","83","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":636},{"label":"Mar","value":361},{"label":"Abr","value":361},{"label":"Mai","value":682},{"label":"Jun","value":371},{"label":"Jul","value":724},{"label":"Ago","value":390},{"label":"Set","value":473},{"label":"Out","value":480},{"label":"Nov","value":471},{"label":"Dez","value":473}];
const MX = 724;
