...
const KPIS = [{"l":"eNPS","v":"79","t":"+4.5%","d":"up"},{"l":"Engagement (%)","v":"85.5%","t":"-0.8%","d":"down"},{"l":"Turnover (%)","v":"66.3%","t":"+4.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"814","t":"+0.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","541","2026-02-10","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","9.057","2026-02-23","60","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.434","2026-03-26","56","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.648","2026-01-14","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.997","2026-03-17","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":463},{"label":"Mar","value":374},{"label":"Abr","value":618},{"label":"Mai","value":605},{"label":"Jun","value":373},{"label":"Jul","value":451},{"label":"Ago","value":554},{"label":"Set","value":458},{"label":"Out","value":429},{"label":"Nov","value":452},{"label":"Dez","value":705}];
const MX = 705;
