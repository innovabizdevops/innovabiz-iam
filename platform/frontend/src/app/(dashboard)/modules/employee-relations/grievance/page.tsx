...
const KPIS = [{"l":"eNPS","v":"91","t":"+8.0%","d":"up"},{"l":"Engagement (%)","v":"88.5%","t":"+16.3%","d":"up"},{"l":"Turnover (%)","v":"80.2%","t":"+12.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.907","t":"+11.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.909","2026-02-20","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.922","2026-01-20","57","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.956","2026-03-02","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.821","2026-01-09","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.718","2026-03-25","88","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":603},{"label":"Mar","value":602},{"label":"Abr","value":748},{"label":"Mai","value":543},{"label":"Jun","value":670},{"label":"Jul","value":589},{"label":"Ago","value":623},{"label":"Set","value":790},{"label":"Out","value":418},{"label":"Nov","value":763},{"label":"Dez","value":792}];
const MX = 792;
