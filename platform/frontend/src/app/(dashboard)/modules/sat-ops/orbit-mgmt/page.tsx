...
/* ═══ Satellite Ops — Orbit Mgmt ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "138", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "109", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3152", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1890344409", cells: ["SAT-3409", "Orbit Mgmt Item 1", "10/10/2026", "€44 509"], status: "active" as const },
    { id: "1890347980", cells: ["SAT-6980", "Orbit Mgmt Item 2", "25/5/2026", "€48 080"], status: "pending" as const },
    { id: "1890351551", cells: ["SAT-1551", "Orbit Mgmt Item 3", "12/12/2026", "€1651"], status: "completed" as const },
    { id: "1890355122", cells: ["SAT-5122", "Orbit Mgmt Item 4", "27/7/2026", "€5222"], status: "warning" as const },
    { id: "1890358693", cells: ["SAT-8693", "Orbit Mgmt Item 5", "14/2/2026", "€8793"], status: "active" as const },
];
...
export default function SatelliteOpsOrbitMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Orbit Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Orbit Mgmt</p>
                    </div>
                </div>
