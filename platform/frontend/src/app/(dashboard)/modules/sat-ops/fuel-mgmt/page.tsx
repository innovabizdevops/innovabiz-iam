...
/* ═══ Satellite Ops — Fuel Mgmt ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "4223", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "173", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "170", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1506926057", cells: ["SAT-3057", "Fuel Mgmt Item 1", "22/6/2026", "€26 157"], status: "active" as const },
    { id: "1506929628", cells: ["SAT-6628", "Fuel Mgmt Item 2", "9/1/2026", "€29 728"], status: "pending" as const },
    { id: "1506933199", cells: ["SAT-1199", "Fuel Mgmt Item 3", "24/8/2026", "€33 299"], status: "completed" as const },
    { id: "1506936770", cells: ["SAT-4770", "Fuel Mgmt Item 4", "11/3/2026", "€36 870"], status: "warning" as const },
    { id: "1506940341", cells: ["SAT-8341", "Fuel Mgmt Item 5", "26/10/2026", "€40 441"], status: "active" as const },
];
...
export default function SatelliteOpsFuelMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fuel Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Fuel Mgmt</p>
                    </div>
                </div>
