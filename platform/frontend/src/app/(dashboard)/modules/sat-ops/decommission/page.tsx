...
/* ═══ Satellite Ops — Decommission ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "891", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "118", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1975", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1019467122", cells: ["SAT-2122", "Decommission Item 1", "3/7/2026", "€17 222"], status: "active" as const },
    { id: "1019470693", cells: ["SAT-5693", "Decommission Item 2", "18/2/2026", "€20 793"], status: "pending" as const },
    { id: "1019474264", cells: ["SAT-9264", "Decommission Item 3", "5/9/2026", "€24 364"], status: "completed" as const },
    { id: "1019477835", cells: ["SAT-3835", "Decommission Item 4", "20/4/2026", "€27 935"], status: "warning" as const },
    { id: "1019481406", cells: ["SAT-7406", "Decommission Item 5", "7/11/2026", "€31 506"], status: "active" as const },
];
...
export default function SatelliteOpsDecommissionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Decommission</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Decommission</p>
                    </div>
                </div>
