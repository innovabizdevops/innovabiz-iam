...
/* ═══ Satellite Ops — Debris Track ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "4034", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "380", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3221", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1420196696", cells: ["SAT-6696", "Debris Track Item 1", "17/9/2026", "€46 796"], status: "active" as const },
    { id: "1420200267", cells: ["SAT-1267", "Debris Track Item 2", "4/4/2026", "€367"], status: "pending" as const },
    { id: "1420203838", cells: ["SAT-4838", "Debris Track Item 3", "19/11/2026", "€3938"], status: "completed" as const },
    { id: "1420207409", cells: ["SAT-8409", "Debris Track Item 4", "6/6/2026", "€7509"], status: "warning" as const },
    { id: "1420210980", cells: ["SAT-2980", "Debris Track Item 5", "21/1/2026", "€11 080"], status: "active" as const },
];
...
export default function SatelliteOpsDebrisTrackPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Debris Track</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Debris Track</p>
                    </div>
                </div>
