...
/* ═══ Satellite Ops — Payload Control ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "1388", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "173", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1023", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "262425353", cells: ["SAT-4353", "Payload Control Item 1", "2/6/2026", "€25 453"], status: "active" as const },
    { id: "262428924", cells: ["SAT-7924", "Payload Control Item 2", "17/1/2026", "€29 024"], status: "pending" as const },
    { id: "262432495", cells: ["SAT-2495", "Payload Control Item 3", "4/8/2026", "€32 595"], status: "completed" as const },
    { id: "262436066", cells: ["SAT-6066", "Payload Control Item 4", "19/3/2026", "€36 166"], status: "warning" as const },
    { id: "262439637", cells: ["SAT-9637", "Payload Control Item 5", "6/10/2026", "€39 737"], status: "active" as const },
];
...
export default function SatelliteOpsPayloadControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Payload Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Payload Control</p>
                    </div>
                </div>
