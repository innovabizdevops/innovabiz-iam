...
/* ═══ Satellite Ops — Spectrum Coord ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "2442", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "316", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1911", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "435033000", cells: ["SAT-1000", "Spectrum Coord Item 1", "25/1/2026", "€33 100"], status: "active" as const },
    { id: "435036571", cells: ["SAT-4571", "Spectrum Coord Item 2", "12/8/2026", "€36 671"], status: "pending" as const },
    { id: "435040142", cells: ["SAT-8142", "Spectrum Coord Item 3", "27/3/2026", "€40 242"], status: "completed" as const },
    { id: "435043713", cells: ["SAT-2713", "Spectrum Coord Item 4", "14/10/2026", "€43 813"], status: "warning" as const },
    { id: "435047284", cells: ["SAT-6284", "Spectrum Coord Item 5", "1/5/2026", "€47 384"], status: "active" as const },
];
...
export default function SatelliteOpsSpectrumCoordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Spectrum Coord</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Spectrum Coord</p>
                    </div>
                </div>
