...
/* ═══ Satellite Ops — Link Budget ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "654", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "411", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3874", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "213949527", cells: ["SAT-2527", "Link Budget Item 1", "16/4/2026", "€49 627"], status: "active" as const },
    { id: "213953098", cells: ["SAT-6098", "Link Budget Item 2", "3/11/2026", "€3198"], status: "pending" as const },
    { id: "213956669", cells: ["SAT-9669", "Link Budget Item 3", "18/6/2026", "€6769"], status: "completed" as const },
    { id: "213960240", cells: ["SAT-4240", "Link Budget Item 4", "5/1/2026", "€10 340"], status: "warning" as const },
    { id: "213963811", cells: ["SAT-7811", "Link Budget Item 5", "20/8/2026", "€13 911"], status: "active" as const },
];
...
export default function SatelliteOpsLinkBudgetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Link Budget</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Link Budget</p>
                    </div>
                </div>
