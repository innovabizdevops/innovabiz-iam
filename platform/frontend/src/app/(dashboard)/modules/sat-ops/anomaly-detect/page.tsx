...
/* ═══ Satellite Ops — Anomaly Detect ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "4645", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "130", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2784", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "743055262", cells: ["SAT-7262", "Anomaly Detect Item 1", "27/11/2026", "€5362"], status: "active" as const },
    { id: "743058833", cells: ["SAT-1833", "Anomaly Detect Item 2", "14/6/2026", "€8933"], status: "pending" as const },
    { id: "743062404", cells: ["SAT-5404", "Anomaly Detect Item 3", "1/1/2026", "€12 504"], status: "completed" as const },
    { id: "743065975", cells: ["SAT-8975", "Anomaly Detect Item 4", "16/8/2026", "€16 075"], status: "warning" as const },
    { id: "743069546", cells: ["SAT-3546", "Anomaly Detect Item 5", "3/3/2026", "€19 646"], status: "active" as const },
];
...
export default function SatelliteOpsAnomalyDetectPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Anomaly Detect</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Anomaly Detect</p>
                    </div>
                </div>
