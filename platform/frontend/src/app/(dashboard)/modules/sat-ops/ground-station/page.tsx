...
/* ═══ Satellite Ops — Ground Station ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "3274", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "481", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2405", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "66524509", cells: ["SAT-6509", "Ground Station Item 1", "10/2/2026", "€24 609"], status: "active" as const },
    { id: "66528080", cells: ["SAT-1080", "Ground Station Item 2", "25/9/2026", "€28 180"], status: "pending" as const },
    { id: "66531651", cells: ["SAT-4651", "Ground Station Item 3", "12/4/2026", "€31 751"], status: "completed" as const },
    { id: "66535222", cells: ["SAT-8222", "Ground Station Item 4", "27/11/2026", "€35 322"], status: "warning" as const },
    { id: "66538793", cells: ["SAT-2793", "Ground Station Item 5", "14/6/2026", "€38 893"], status: "active" as const },
];
...
export default function SatelliteOpsGroundStationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ground Station</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Ground Station</p>
                    </div>
                </div>
