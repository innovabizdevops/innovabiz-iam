...
/* ═══ Satellite Ops — Constellation ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total", value: "2001", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "291", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3206", trend: "-23%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1706183759", cells: ["SAT-9759", "Constellation Item 1", "8/12/2026", "€33 859"], status: "active" as const },
    { id: "1706187330", cells: ["SAT-4330", "Constellation Item 2", "23/7/2026", "€37 430"], status: "pending" as const },
    { id: "1706190901", cells: ["SAT-7901", "Constellation Item 3", "10/2/2026", "€41 001"], status: "completed" as const },
    { id: "1706194472", cells: ["SAT-2472", "Constellation Item 4", "25/9/2026", "€44 572"], status: "warning" as const },
    { id: "1706198043", cells: ["SAT-6043", "Constellation Item 5", "12/4/2026", "€48 143"], status: "active" as const },
];
...
export default function SatelliteOpsConstellationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Constellation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Satellite Ops • Constellation</p>
                    </div>
                </div>
