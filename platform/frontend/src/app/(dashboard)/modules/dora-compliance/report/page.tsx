...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.604","t":"+10.6%","d":"up"},{"l":"NC Abertas","v":"2.422","t":"+8.6%","d":"up"},{"l":"Conformidade (%)","v":"82.2%","t":"+11.1%","d":"up"},{"l":"CAPAs Pendentes","v":"4.815","t":"+10.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.634","87.6%","4.443","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","751","98.7%","8.978","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.904","99.3%","989","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.473","71.9%","2.669","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.701","99.0%","7.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":822},{"label":"Mar","value":806},{"label":"Abr","value":814},{"label":"Mai","value":762},{"label":"Jun","value":482},{"label":"Jul","value":814},{"label":"Ago","value":668},{"label":"Set","value":720},{"label":"Out","value":470},{"label":"Nov","value":745},{"label":"Dez","value":573}];
const MX = 822;
