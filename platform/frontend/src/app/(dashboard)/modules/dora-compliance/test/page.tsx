...
const PAGE = "Test";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.937","t":"+-0.0%","d":"up"},{"l":"NC Abertas","v":"5.939","t":"-5.2%","d":"down"},{"l":"Conformidade (%)","v":"82.9%","t":"+13.6%","d":"up"},{"l":"CAPAs Pendentes","v":"3.353","t":"+15.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.702","81.6%","4.496","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.529","93.7%","5.245","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.811","95.4%","1.899","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.863","74.5%","7.783","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.716","88.0%","5.666","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1019},{"label":"Fev","value":1033},{"label":"Mar","value":968},{"label":"Abr","value":718},{"label":"Mai","value":969},{"label":"Jun","value":944},{"label":"Jul","value":991},{"label":"Ago","value":922},{"label":"Set","value":934},{"label":"Out","value":704},{"label":"Nov","value":926},{"label":"Dez","value":894}];
const MX = 1033;
