...
const PAGE = "Third Party";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.096","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"7.709","t":"+3.4%","d":"up"},{"l":"Conformidade (%)","v":"93.5%","t":"+15.2%","d":"up"},{"l":"CAPAs Pendentes","v":"5.691","t":"+13.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.808","93.1%","9.093","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.196","98.0%","1.139","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.442","98.2%","1.019","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.883","93.9%","2.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.467","73.3%","7.104","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":953},{"label":"Mar","value":771},{"label":"Abr","value":1031},{"label":"Mai","value":912},{"label":"Jun","value":818},{"label":"Jul","value":819},{"label":"Ago","value":1073},{"label":"Set","value":813},{"label":"Out","value":903},{"label":"Nov","value":767},{"label":"Dez","value":1027}];
const MX = 1073;
