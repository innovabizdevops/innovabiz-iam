...
/* ═══ DORA Compliance (EU) — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "127", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4584", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€74K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "708404427", cells: ["DOR-6427", "DORA Compliance (EU) Item 1", "4/4/2026", "€4527"], status: "active" as const },
    { id: "708407998", cells: ["DOR-9998", "DORA Compliance (EU) Item 2", "19/11/2026", "€8098"], status: "pending" as const },
    { id: "708411569", cells: ["DOR-4569", "DORA Compliance (EU) Item 3", "6/6/2026", "€11 669"], status: "completed" as const },
    { id: "708415140", cells: ["DOR-8140", "DORA Compliance (EU) Item 4", "21/1/2026", "€15 240"], status: "warning" as const },
    { id: "708418711", cells: ["DOR-2711", "DORA Compliance (EU) Item 5", "8/8/2026", "€18 811"], status: "active" as const },
];
...
export default function DoraComplianceEuPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">DORA Compliance (EU)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • DORA Compliance (EU)</p>
                    </div>
                </div>
