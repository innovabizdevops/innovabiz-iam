...
const ACCENT = "#dc2626";
const MODULE = "DORA Compliance (EU)";
const PAGE = "ICT Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.690","t":"+14.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.059","t":"-4.7%","d":"down"},{"l":"Score Risco Geral","v":"56","t":"+5.3%","d":"up"},{"l":"Incidentes YTD","v":"1.081","t":"-1.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.974","1.265","3.537","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.960","1.896","6.394","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.257","7.871","4.467","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.524","2.922","5.335","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.902","8.195","4.865","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":602},{"label":"Mar","value":636},{"label":"Abr","value":580},{"label":"Mai","value":667},{"label":"Jun","value":567},{"label":"Jul","value":583},{"label":"Ago","value":607},{"label":"Set","value":680},{"label":"Out","value":797},{"label":"Nov","value":624},{"label":"Dez","value":735}];
const MX = 797;
