...
const ACCENT = "#155e75";
const MODULE = "Risk Mgmt Deep (ISO 31000)";
const PAGE = "Analyze";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.587","t":"-2.5%","d":"down"},{"l":"NC Abertas","v":"2.125","t":"+4.1%","d":"up"},{"l":"Conformidade (%)","v":"75.9%","t":"+3.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.104","t":"+3.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.670","84.6%","4.327","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.390","90.1%","1.885","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.613","88.1%","135","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.772","88.6%","5.198","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.995","77.9%","1.948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":572},{"label":"Mar","value":540},{"label":"Abr","value":765},{"label":"Mai","value":542},{"label":"Jun","value":507},{"label":"Jul","value":703},{"label":"Ago","value":536},{"label":"Set","value":425},{"label":"Out","value":492},{"label":"Nov","value":384},{"label":"Dez","value":540}];
const MX = 765;
