...
/* ═══ Risk Mgmt Deep (ISO 31000) — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "1393", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1896", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€193K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1827303693", cells: ["ISO-7693", "Risk Mgmt Deep (ISO 31000) Item 1", "6/10/2026", "€3793"], status: "active" as const },
    { id: "1827307264", cells: ["ISO-2264", "Risk Mgmt Deep (ISO 31000) Item 2", "21/5/2026", "€7364"], status: "pending" as const },
    { id: "1827310835", cells: ["ISO-5835", "Risk Mgmt Deep (ISO 31000) Item 3", "8/12/2026", "€10 935"], status: "completed" as const },
    { id: "1827314406", cells: ["ISO-9406", "Risk Mgmt Deep (ISO 31000) Item 4", "23/7/2026", "€14 506"], status: "warning" as const },
    { id: "1827317977", cells: ["ISO-3977", "Risk Mgmt Deep (ISO 31000) Item 5", "10/2/2026", "€18 077"], status: "active" as const },
];
...
export default function RiskMgmtDeepIso31000Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Risk Mgmt Deep (ISO 31000)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Risk Mgmt Deep (ISO 31000)</p>
                    </div>
                </div>
