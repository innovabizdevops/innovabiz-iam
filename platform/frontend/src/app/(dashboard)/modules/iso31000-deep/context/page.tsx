...
const PAGE = "Context";
const KPIS = [{"l":"Auditorias Realizadas","v":"301","t":"-0.2%","d":"down"},{"l":"NC Abertas","v":"7.635","t":"-0.1%","d":"down"},{"l":"Conformidade (%)","v":"95.0%","t":"+5.2%","d":"up"},{"l":"CAPAs Pendentes","v":"6.904","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.021","70.8%","4.435","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.436","87.2%","2.306","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.110","83.7%","1.612","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.070","95.1%","543","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.219","76.3%","8.199","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":793},{"label":"Mar","value":530},{"label":"Abr","value":549},{"label":"Mai","value":857},{"label":"Jun","value":765},{"label":"Jul","value":702},{"label":"Ago","value":509},{"label":"Set","value":679},{"label":"Out","value":733},{"label":"Nov","value":467},{"label":"Dez","value":632}];
const MX = 857;
