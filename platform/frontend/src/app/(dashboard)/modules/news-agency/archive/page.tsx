...
const PAGE = "Archive";
const KPIS = [{"l":"Total News Agency","v":"7.110","t":"+8.6%","d":"up"},{"l":"Archive Ativos","v":"8.485","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"69.2%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"68","t":"-5.7%","d":"down"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["News Agency #001","News Agency #002","7.872","207","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["News Agency #002","News Agency #003","6.791","2.833","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["News Agency #003","News Agency #004","6.020","9.002","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["News Agency #004","News Agency #005","4.717","1.400","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["News Agency #005","News Agency #001","6.290","1.953","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":992},{"label":"Mar","value":909},{"label":"Abr","value":822},{"label":"Mai","value":789},{"label":"Jun","value":775},{"label":"Jul","value":1059},{"label":"Ago","value":754},{"label":"Set","value":1067},{"label":"Out","value":839},{"label":"Nov","value":747},{"label":"Dez","value":733}];
const MX = 1067;
