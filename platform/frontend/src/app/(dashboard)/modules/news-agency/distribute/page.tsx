...
const ACCENT = "#6366f1";
const MODULE = "News Agency";
const PAGE = "Distribute";
const KPIS = [{"l":"Total News Agency","v":"3.950","t":"-3.8%","d":"down"},{"l":"Distribute Ativos","v":"2.728","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+16.3%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.3%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["News Agency #001","News Agency #002","498","2.742","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["News Agency #002","News Agency #003","4.569","6.614","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["News Agency #003","News Agency #004","7.338","8.998","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["News Agency #004","News Agency #005","8.523","8.494","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["News Agency #005","News Agency #001","4.396","5.845","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":637},{"label":"Mar","value":756},{"label":"Abr","value":851},{"label":"Mai","value":612},{"label":"Jun","value":654},{"label":"Jul","value":707},{"label":"Ago","value":687},{"label":"Set","value":776},{"label":"Out","value":840},{"label":"Nov","value":921},{"label":"Dez","value":719}];
const MX = 923;
