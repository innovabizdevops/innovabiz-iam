...
const PAGE = "Wire";
const KPIS = [{"l":"Total News Agency","v":"6.951","t":"-0.2%","d":"down"},{"l":"Wire Ativos","v":"7.156","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"86.1%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+11.3%","d":"up"}];
const COLS = ["ID","Wire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["News Agency #001","News Agency #002","1.891","7.734","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["News Agency #002","News Agency #003","7.592","2.323","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["News Agency #003","News Agency #004","4.693","2.973","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["News Agency #004","News Agency #005","6.571","7.137","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["News Agency #005","News Agency #001","6.476","7.028","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":657},{"label":"Mar","value":638},{"label":"Abr","value":688},{"label":"Mai","value":803},{"label":"Jun","value":697},{"label":"Jul","value":525},{"label":"Ago","value":766},{"label":"Set","value":845},{"label":"Out","value":722},{"label":"Nov","value":837},{"label":"Dez","value":590}];
const MX = 845;
