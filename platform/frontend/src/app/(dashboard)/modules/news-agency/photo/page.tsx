...
const PAGE = "Photo";
const KPIS = [{"l":"Total News Agency","v":"5.559","t":"+10.9%","d":"up"},{"l":"Photo Ativos","v":"2.036","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"66.8%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"77","t":"+2.6%","d":"up"}];
const COLS = ["ID","Photo","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["News Agency #001","News Agency #002","7.703","8.710","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["News Agency #002","News Agency #003","5.889","2.256","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["News Agency #003","News Agency #004","636","5.680","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["News Agency #004","News Agency #005","7.125","1.744","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["News Agency #005","News Agency #001","1.042","9.078","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":817},{"label":"Mar","value":687},{"label":"Abr","value":780},{"label":"Mai","value":733},{"label":"Jun","value":579},{"label":"Jul","value":486},{"label":"Ago","value":772},{"label":"Set","value":453},{"label":"Out","value":660},{"label":"Nov","value":634},{"label":"Dez","value":662}];
const MX = 817;
