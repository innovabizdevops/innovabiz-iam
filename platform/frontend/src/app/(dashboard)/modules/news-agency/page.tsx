...
export default function NewsAgencyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">News Agency</h1><p className="text-sm text-muted-foreground">News Agency • iBOS Enterprise</p></div>
