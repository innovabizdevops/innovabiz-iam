...
const PAGE = "Report";
const KPIS = [{"l":"Total Executive Protect","v":"6.524","t":"+14.1%","d":"up"},{"l":"Report Ativos","v":"4.425","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+3.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Executive Protect #001","Executive Protect #002","6.937","1.439","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Executive Protect #002","Executive Protect #003","258","5.450","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Executive Protect #003","Executive Protect #004","8.322","8.124","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Executive Protect #004","Executive Protect #005","1.965","5.373","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Protect #005","Executive Protect #001","5.657","2.714","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":382},{"label":"Mar","value":459},{"label":"Abr","value":490},{"label":"Mai","value":519},{"label":"Jun","value":519},{"label":"Jul","value":351},{"label":"Ago","value":428},{"label":"Set","value":541},{"label":"Out","value":472},{"label":"Nov","value":564},{"label":"Dez","value":579}];
const MX = 647;
