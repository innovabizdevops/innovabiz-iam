...
const PAGE = "Residence";
const KPIS = [{"l":"Total Executive Protect","v":"8.983","t":"+13.8%","d":"up"},{"l":"Residence Ativos","v":"4.786","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"73","t":"-4.1%","d":"down"}];
const COLS = ["ID","Residence","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Executive Protect #001","Executive Protect #002","8.110","8.069","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Executive Protect #002","Executive Protect #003","4.274","5.844","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Executive Protect #003","Executive Protect #004","5.322","6.915","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Executive Protect #004","Executive Protect #005","5.510","2.165","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Protect #005","Executive Protect #001","1.730","7.773","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":497},{"label":"Mar","value":691},{"label":"Abr","value":530},{"label":"Mai","value":481},{"label":"Jun","value":721},{"label":"Jul","value":375},{"label":"Ago","value":636},{"label":"Set","value":704},{"label":"Out","value":611},{"label":"Nov","value":618},{"label":"Dez","value":559}];
const MX = 721;
