...
const PAGE = "Travel";
const KPIS = [{"l":"Total Executive Protect","v":"4.884","t":"+9.3%","d":"up"},{"l":"Travel Ativos","v":"5.273","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"81","t":"+11.9%","d":"up"}];
const COLS = ["ID","Travel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Executive Protect #001","Executive Protect #002","2.408","2.475","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Executive Protect #002","Executive Protect #003","1.141","5.319","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Executive Protect #003","Executive Protect #004","141","210","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Executive Protect #004","Executive Protect #005","6.253","282","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Protect #005","Executive Protect #001","931","5.180","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":498},{"label":"Mar","value":504},{"label":"Abr","value":668},{"label":"Mai","value":371},{"label":"Jun","value":348},{"label":"Jul","value":348},{"label":"Ago","value":487},{"label":"Set","value":563},{"label":"Out","value":458},{"label":"Nov","value":654},{"label":"Dez","value":659}];
const MX = 671;
