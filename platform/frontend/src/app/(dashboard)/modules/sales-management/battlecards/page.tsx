...
const PAGE = "Competitive Battlecards";
const KPIS = [{"l":"Vendas YTD (€)","v":"€74055","t":"+17.4%","d":"up"},{"l":"Pipeline (€)","v":"€29497","t":"+16.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"72.1%","t":"+5.5%","d":"up"},{"l":"Win Rate (%)","v":"76.6%","t":"+8.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 6978.63","€ 48320.74","€ 48027.64","96.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 22975.70","€ 39328.76","€ 23965.57","72.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 18829.71","€ 7583.87","€ 43802.08","75.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 12033.36","€ 35724.69","€ 18477.30","89.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 30331.35","€ 28140.16","€ 49402.92","85.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":708},{"label":"Mar","value":691},{"label":"Abr","value":758},{"label":"Mai","value":708},{"label":"Jun","value":630},{"label":"Jul","value":554},{"label":"Ago","value":811},{"label":"Set","value":695},{"label":"Out","value":845},{"label":"Nov","value":596},{"label":"Dez","value":929}];
const MX = 929;
