...
const KPIS = [{"l":"Vendas YTD (€)","v":"€27334","t":"+2.8%","d":"up"},{"l":"Pipeline (€)","v":"€73667","t":"+18.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.6%","t":"-4.1%","d":"down"},{"l":"Win Rate (%)","v":"84.9%","t":"+12.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 42281.54","€ 29561.88","€ 45536.47","89.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 46711.32","€ 46763.96","€ 28064.75","79.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12823.01","€ 36070.30","€ 11275.77","77.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 6080.53","€ 10392.76","€ 16591.96","92.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 20227.55","€ 8111.01","€ 42213.00","97.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":571},{"label":"Fev","value":589},{"label":"Mar","value":854},{"label":"Abr","value":705},{"label":"Mai","value":604},{"label":"Jun","value":724},{"label":"Jul","value":816},{"label":"Ago","value":692},{"label":"Set","value":883},{"label":"Out","value":709},{"label":"Nov","value":508},{"label":"Dez","value":751}];
const MX = 883;
