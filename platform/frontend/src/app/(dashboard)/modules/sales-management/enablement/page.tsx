...
const PAGE = "Sales Enablement";
const KPIS = [{"l":"Vendas YTD (€)","v":"€91879","t":"+9.7%","d":"up"},{"l":"Pipeline (€)","v":"€35563","t":"-5.9%","d":"down"},{"l":"Atingimento Quota (%)","v":"95.0%","t":"+1.4%","d":"up"},{"l":"Win Rate (%)","v":"90.7%","t":"+3.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 40397.62","€ 34517.42","€ 3460.43","87.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 17427.24","€ 8762.11","€ 40347.59","97.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 3105.09","€ 32591.27","€ 39865.52","73.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 35737.39","€ 33200.82","€ 49714.73","73.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 47480.94","€ 2890.41","€ 29941.29","94.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":502},{"label":"Mar","value":417},{"label":"Abr","value":443},{"label":"Mai","value":439},{"label":"Jun","value":430},{"label":"Jul","value":460},{"label":"Ago","value":578},{"label":"Set","value":633},{"label":"Out","value":282},{"label":"Nov","value":453},{"label":"Dez","value":495}];
const MX = 666;
