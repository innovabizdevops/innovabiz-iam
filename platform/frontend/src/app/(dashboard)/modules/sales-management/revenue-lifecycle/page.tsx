...
const PAGE = "Revenue Lifecycle";
const KPIS = [{"l":"Vendas YTD (€)","v":"€58981","t":"+9.1%","d":"up"},{"l":"Pipeline (€)","v":"€33654","t":"+2.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.0%","t":"+15.8%","d":"up"},{"l":"Win Rate (%)","v":"89.2%","t":"+4.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 46077.75","€ 6692.73","€ 34501.07","82.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 24952.67","€ 232.90","€ 26708.45","89.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 5612.33","€ 33932.21","€ 44679.98","93.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 8425.20","€ 7256.87","€ 18197.90","85.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37474.75","€ 31004.88","€ 37781.62","87.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":760},{"label":"Fev","value":721},{"label":"Mar","value":387},{"label":"Abr","value":631},{"label":"Mai","value":477},{"label":"Jun","value":696},{"label":"Jul","value":664},{"label":"Ago","value":394},{"label":"Set","value":532},{"label":"Out","value":415},{"label":"Nov","value":435},{"label":"Dez","value":637}];
const MX = 760;
