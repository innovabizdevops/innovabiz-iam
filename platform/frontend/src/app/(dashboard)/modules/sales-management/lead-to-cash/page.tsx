...
const PAGE = "Lead-to-Cash";
const KPIS = [{"l":"Vendas YTD (€)","v":"€47209","t":"+11.5%","d":"up"},{"l":"Pipeline (€)","v":"€34695","t":"+3.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.1%","t":"+17.2%","d":"up"},{"l":"Win Rate (%)","v":"81.3%","t":"+17.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 46786.90","€ 22974.27","€ 14545.63","86.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 23766.61","€ 19069.44","€ 32496.95","96.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20992.22","€ 1969.66","€ 15368.68","72.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 40281.52","€ 30726.17","€ 6396.64","91.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 39964.65","€ 40522.55","€ 40206.21","73.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":402},{"label":"Mar","value":516},{"label":"Abr","value":321},{"label":"Mai","value":283},{"label":"Jun","value":287},{"label":"Jul","value":669},{"label":"Ago","value":599},{"label":"Set","value":669},{"label":"Out","value":322},{"label":"Nov","value":598},{"label":"Dez","value":458}];
const MX = 669;
