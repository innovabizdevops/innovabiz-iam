...
const PAGE = "Territories";
const KPIS = [{"l":"Vendas YTD (€)","v":"€51986","t":"+2.0%","d":"up"},{"l":"Pipeline (€)","v":"€7601","t":"+6.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"88.9%","t":"+0.6%","d":"up"},{"l":"Win Rate (%)","v":"92.3%","t":"+16.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 16740.43","€ 49307.40","€ 25998.45","75.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 19474.66","€ 11540.97","€ 45404.05","72.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 6979.96","€ 10343.90","€ 8161.93","77.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47134.10","€ 39483.38","€ 1114.30","97.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 14091.10","€ 32584.95","€ 42588.66","74.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":229},{"label":"Fev","value":531},{"label":"Mar","value":522},{"label":"Abr","value":364},{"label":"Mai","value":246},{"label":"Jun","value":500},{"label":"Jul","value":480},{"label":"Ago","value":542},{"label":"Set","value":480},{"label":"Out","value":399},{"label":"Nov","value":364},{"label":"Dez","value":385}];
const MX = 542;
