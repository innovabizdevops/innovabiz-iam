...
const PAGE = "Competitor Intel";
const KPIS = [{"l":"Vendas YTD (€)","v":"€99103","t":"-1.7%","d":"down"},{"l":"Pipeline (€)","v":"€10393","t":"+17.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"79.4%","t":"-3.3%","d":"down"},{"l":"Win Rate (%)","v":"82.1%","t":"-1.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1329.45","€ 35779.82","€ 671.64","86.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 11968.18","€ 7054.35","€ 39450.37","75.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29198.71","€ 31347.98","€ 33625.92","79.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 36353.54","€ 14842.36","€ 25656.04","74.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 6863.40","€ 41493.40","€ 1341.87","79.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":478},{"label":"Mar","value":666},{"label":"Abr","value":680},{"label":"Mai","value":617},{"label":"Jun","value":793},{"label":"Jul","value":594},{"label":"Ago","value":565},{"label":"Set","value":635},{"label":"Out","value":663},{"label":"Nov","value":730},{"label":"Dez","value":716}];
const MX = 793;
