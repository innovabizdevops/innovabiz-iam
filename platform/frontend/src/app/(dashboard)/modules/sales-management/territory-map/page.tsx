...
const PAGE = "Territory Map";
const KPIS = [{"l":"Vendas YTD (€)","v":"€9332","t":"+0.4%","d":"up"},{"l":"Pipeline (€)","v":"€74699","t":"+13.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.2%","t":"+7.3%","d":"up"},{"l":"Win Rate (%)","v":"86.2%","t":"+12.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 4110.26","€ 11452.65","€ 33445.40","90.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 11089.45","€ 2554.36","€ 11111.64","90.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 49302.77","€ 33119.55","€ 6066.08","93.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 44185.38","€ 28017.94","€ 35211.05","95.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41898.54","€ 7089.62","€ 11225.20","89.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":751},{"label":"Mar","value":771},{"label":"Abr","value":593},{"label":"Mai","value":504},{"label":"Jun","value":622},{"label":"Jul","value":783},{"label":"Ago","value":576},{"label":"Set","value":808},{"label":"Out","value":609},{"label":"Nov","value":679},{"label":"Dez","value":698}];
const MX = 808;
