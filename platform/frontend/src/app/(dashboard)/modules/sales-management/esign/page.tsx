...
const PAGE = "E-Signature Integration";
const KPIS = [{"l":"Vendas YTD (€)","v":"€88938","t":"-1.9%","d":"down"},{"l":"Pipeline (€)","v":"€18352","t":"+10.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.9%","t":"+16.0%","d":"up"},{"l":"Win Rate (%)","v":"80.8%","t":"+3.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 30726.93","€ 8785.18","€ 42311.17","74.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 5224.22","€ 23642.70","€ 10475.22","73.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 18428.96","€ 16342.18","€ 48993.67","86.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 28441.40","€ 19637.36","€ 49301.30","71.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 39644.17","€ 5354.21","€ 27766.46","83.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":534},{"label":"Mar","value":683},{"label":"Abr","value":526},{"label":"Mai","value":641},{"label":"Jun","value":759},{"label":"Jul","value":647},{"label":"Ago","value":643},{"label":"Set","value":639},{"label":"Out","value":587},{"label":"Nov","value":653},{"label":"Dez","value":698}];
const MX = 759;
