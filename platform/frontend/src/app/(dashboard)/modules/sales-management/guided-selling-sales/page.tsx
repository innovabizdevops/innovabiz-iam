...
const ACCENT = "#6366f1";
const MODULE = "Sales Management";
const PAGE = "Guided Selling AI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€59429","t":"+17.1%","d":"up"},{"l":"Pipeline (€)","v":"€60983","t":"+15.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.4%","t":"+6.5%","d":"up"},{"l":"Win Rate (%)","v":"77.6%","t":"-5.6%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39777.79","€ 14792.60","€ 5549.94","82.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 28743.66","€ 19062.43","€ 24322.87","75.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 14218.42","€ 14877.57","€ 46161.13","73.1%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3590.59","€ 20343.28","€ 44916.43","93.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 47859.77","€ 14930.17","€ 5064.47","83.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":908},{"label":"Mar","value":671},{"label":"Abr","value":664},{"label":"Mai","value":642},{"label":"Jun","value":579},{"label":"Jul","value":766},{"label":"Ago","value":588},{"label":"Set","value":640},{"label":"Out","value":921},{"label":"Nov","value":847},{"label":"Dez","value":723}];
const MX = 921;
...
export default function GuidedSellingSalesPage() {
    return (
