...
const PAGE = "Revenue Signals AI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€67342","t":"+15.4%","d":"up"},{"l":"Pipeline (€)","v":"€87391","t":"+6.5%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.3%","t":"+0.3%","d":"up"},{"l":"Win Rate (%)","v":"67.6%","t":"+11.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 36574.72","€ 17112.89","€ 16091.78","74.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 28697.07","€ 30246.05","€ 40730.78","71.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22286.55","€ 21635.61","€ 8705.43","90.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24626.77","€ 31364.70","€ 7176.63","73.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41760.64","€ 20498.90","€ 39762.61","95.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":669},{"label":"Mar","value":887},{"label":"Abr","value":576},{"label":"Mai","value":554},{"label":"Jun","value":723},{"label":"Jul","value":568},{"label":"Ago","value":824},{"label":"Set","value":748},{"label":"Out","value":875},{"label":"Nov","value":799},{"label":"Dez","value":743}];
const MX = 914;
...
export default function RevenueSignalsPage() {
    return (
