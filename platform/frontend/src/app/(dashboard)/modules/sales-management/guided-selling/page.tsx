...
const KPIS = [{"l":"Vendas YTD (€)","v":"€21173","t":"+10.0%","d":"up"},{"l":"Pipeline (€)","v":"€88407","t":"+10.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"83.3%","t":"+13.9%","d":"up"},{"l":"Win Rate (%)","v":"90.4%","t":"+18.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 17750.17","€ 39074.32","€ 6682.03","86.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 45110.75","€ 9156.40","€ 805.35","71.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 45324.61","€ 1248.83","€ 32424.58","99.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 20611.74","€ 27702.57","€ 24868.43","94.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 11596.75","€ 42657.01","€ 47443.53","82.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":401},{"label":"Mar","value":245},{"label":"Abr","value":237},{"label":"Mai","value":576},{"label":"Jun","value":474},{"label":"Jul","value":241},{"label":"Ago","value":245},{"label":"Set","value":477},{"label":"Out","value":626},{"label":"Nov","value":341},{"label":"Dez","value":419}];
const MX = 626;
