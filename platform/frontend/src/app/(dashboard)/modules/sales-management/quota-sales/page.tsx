...
const PAGE = "Quota Management";
const KPIS = [{"l":"Vendas YTD (€)","v":"€8360","t":"+0.7%","d":"up"},{"l":"Pipeline (€)","v":"€27152","t":"+7.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"80.3%","t":"+2.5%","d":"up"},{"l":"Win Rate (%)","v":"70.6%","t":"-4.4%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 11927.63","€ 16910.25","€ 18845.22","89.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 33044.84","€ 40684.22","€ 34068.52","99.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 20389.10","€ 9359.01","€ 37705.86","72.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 19351.06","€ 21643.01","€ 14142.07","97.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 22380.42","€ 43864.60","€ 7608.43","82.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":541},{"label":"Mar","value":734},{"label":"Abr","value":504},{"label":"Mai","value":702},{"label":"Jun","value":558},{"label":"Jul","value":691},{"label":"Ago","value":582},{"label":"Set","value":429},{"label":"Out","value":561},{"label":"Nov","value":594},{"label":"Dez","value":495}];
const MX = 734;
...
export default function QuotaSalesPage() {
    return (
