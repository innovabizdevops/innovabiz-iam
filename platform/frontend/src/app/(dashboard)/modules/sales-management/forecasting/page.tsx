...
const PAGE = "Forecasting";
const KPIS = [{"l":"Vendas YTD (€)","v":"€41532","t":"-3.0%","d":"down"},{"l":"Pipeline (€)","v":"€88992","t":"-1.2%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.6%","t":"+14.2%","d":"up"},{"l":"Win Rate (%)","v":"75.9%","t":"+16.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39082.63","€ 41189.72","€ 17735.99","71.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 25994.87","€ 7769.07","€ 28578.99","83.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11042.90","€ 19382.23","€ 45435.42","99.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 47499.98","€ 16830.11","€ 5201.76","84.2%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 30089.92","€ 46117.91","€ 44745.52","92.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":579},{"label":"Mar","value":807},{"label":"Abr","value":567},{"label":"Mai","value":797},{"label":"Jun","value":834},{"label":"Jul","value":752},{"label":"Ago","value":490},{"label":"Set","value":690},{"label":"Out","value":487},{"label":"Nov","value":538},{"label":"Dez","value":495}];
const MX = 834;
