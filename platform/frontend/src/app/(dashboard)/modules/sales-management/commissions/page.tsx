...
const KPIS = [{"l":"Vendas YTD (€)","v":"€41439","t":"-1.6%","d":"down"},{"l":"Pipeline (€)","v":"€20493","t":"-5.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"78.1%","t":"+16.5%","d":"up"},{"l":"Win Rate (%)","v":"93.2%","t":"+3.0%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 45612.03","€ 4628.41","€ 23880.62","71.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 583.05","€ 16531.64","€ 485.26","84.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 30194.27","€ 13472.14","€ 15110.25","98.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 26441.53","€ 16225.03","€ 30135.40","89.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 29344.53","€ 18420.16","€ 10974.74","78.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":799},{"label":"Mar","value":531},{"label":"Abr","value":724},{"label":"Mai","value":868},{"label":"Jun","value":722},{"label":"Jul","value":619},{"label":"Ago","value":731},{"label":"Set","value":726},{"label":"Out","value":653},{"label":"Nov","value":567},{"label":"Dez","value":800}];
const MX = 868;
