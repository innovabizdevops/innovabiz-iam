...
const PAGE = "Quote Builder Form";
const KPIS = [{"l":"Vendas YTD (€)","v":"€81034","t":"+14.0%","d":"up"},{"l":"Pipeline (€)","v":"€13430","t":"+6.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"73.9%","t":"-1.1%","d":"down"},{"l":"Win Rate (%)","v":"73.0%","t":"+10.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1568.35","€ 5086.55","€ 15936.00","84.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 5882.96","€ 35007.87","€ 18386.87","75.0%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 5092.80","€ 31173.72","€ 14906.63","73.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 24127.56","€ 46204.99","€ 2492.80","89.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 15779.02","€ 43237.38","€ 43140.83","73.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":418},{"label":"Fev","value":599},{"label":"Mar","value":239},{"label":"Abr","value":411},{"label":"Mai","value":262},{"label":"Jun","value":430},{"label":"Jul","value":390},{"label":"Ago","value":494},{"label":"Set","value":450},{"label":"Out","value":553},{"label":"Nov","value":463},{"label":"Dez","value":610}];
const MX = 610;
