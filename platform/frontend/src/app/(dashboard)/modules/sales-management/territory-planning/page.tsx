...
const PAGE = "Territory Planning AI";
const KPIS = [{"l":"Vendas YTD (€)","v":"€4688","t":"-5.8%","d":"down"},{"l":"Pipeline (€)","v":"€28618","t":"+14.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.9%","t":"+10.7%","d":"up"},{"l":"Win Rate (%)","v":"91.9%","t":"-0.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 49704.15","€ 10025.38","€ 10879.04","98.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 8205.31","€ 40602.18","€ 38169.29","95.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 43218.80","€ 5674.75","€ 26435.78","96.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 21772.51","€ 13425.18","€ 29496.16","82.6%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 42438.21","€ 22574.77","€ 41701.61","79.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":323},{"label":"Mar","value":338},{"label":"Abr","value":363},{"label":"Mai","value":379},{"label":"Jun","value":604},{"label":"Jul","value":389},{"label":"Ago","value":439},{"label":"Set","value":325},{"label":"Out","value":511},{"label":"Nov","value":567},{"label":"Dez","value":679}];
const MX = 679;
