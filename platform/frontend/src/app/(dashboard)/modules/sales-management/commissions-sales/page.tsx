...
const PAGE = "Commission Mgmt";
const KPIS = [{"l":"Vendas YTD (€)","v":"€64074","t":"+8.2%","d":"up"},{"l":"Pipeline (€)","v":"€98589","t":"+13.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"78.8%","t":"+7.8%","d":"up"},{"l":"Win Rate (%)","v":"68.1%","t":"-2.2%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 29046.05","€ 7127.44","€ 1077.85","84.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 17253.69","€ 22320.29","€ 19066.55","86.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 37062.40","€ 26826.93","€ 32985.98","95.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 23699.26","€ 17718.73","€ 48487.12","99.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 47656.87","€ 32312.37","€ 10591.83","97.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":464},{"label":"Fev","value":342},{"label":"Mar","value":311},{"label":"Abr","value":594},{"label":"Mai","value":557},{"label":"Jun","value":577},{"label":"Jul","value":393},{"label":"Ago","value":458},{"label":"Set","value":660},{"label":"Out","value":687},{"label":"Nov","value":392},{"label":"Dez","value":668}];
const MX = 687;
...
export default function CommissionsSalesPage() {
    return (
