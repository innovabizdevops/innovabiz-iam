...
const PAGE = "Win/Loss Dashboard";
const KPIS = [{"l":"Vendas YTD (€)","v":"€32637","t":"-4.8%","d":"down"},{"l":"Pipeline (€)","v":"€93214","t":"+9.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.3%","t":"-1.6%","d":"down"},{"l":"Win Rate (%)","v":"76.0%","t":"+5.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 49986.30","€ 35900.54","€ 6866.38","86.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 15295.30","€ 2818.74","€ 23466.73","75.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 43164.04","€ 38260.96","€ 12312.75","95.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 41034.87","€ 12259.52","€ 41515.09","88.5%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 40081.99","€ 36553.32","€ 21227.26","72.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":660},{"label":"Mar","value":819},{"label":"Abr","value":922},{"label":"Mai","value":670},{"label":"Jun","value":938},{"label":"Jul","value":949},{"label":"Ago","value":763},{"label":"Set","value":949},{"label":"Out","value":885},{"label":"Nov","value":694},{"label":"Dez","value":916}];
const MX = 949;
...
export default function WinLossChartPage() {
    return (
