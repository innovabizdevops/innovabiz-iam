...
const PAGE = "Partner Co-Selling";
const KPIS = [{"l":"Vendas YTD (€)","v":"€75954","t":"+2.3%","d":"up"},{"l":"Pipeline (€)","v":"€48254","t":"+16.6%","d":"up"},{"l":"Atingimento Quota (%)","v":"71.7%","t":"+6.6%","d":"up"},{"l":"Win Rate (%)","v":"80.6%","t":"+5.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 47169.92","€ 8355.28","€ 33079.37","84.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 43827.02","€ 28717.35","€ 31821.37","81.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 40114.38","€ 9210.34","€ 25093.03","85.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 25619.14","€ 41034.48","€ 38080.99","73.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 21509.41","€ 17524.73","€ 20684.87","81.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":818},{"label":"Fev","value":629},{"label":"Mar","value":817},{"label":"Abr","value":780},{"label":"Mai","value":535},{"label":"Jun","value":896},{"label":"Jul","value":591},{"label":"Ago","value":926},{"label":"Set","value":643},{"label":"Out","value":921},{"label":"Nov","value":541},{"label":"Dez","value":573}];
const MX = 926;
...
export default function CoSellingPage() {
    return (
