...
const PAGE = "Meeting Scheduler";
const KPIS = [{"l":"Vendas YTD (€)","v":"€88438","t":"+11.8%","d":"up"},{"l":"Pipeline (€)","v":"€11122","t":"+3.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"80.0%","t":"-5.0%","d":"down"},{"l":"Win Rate (%)","v":"91.1%","t":"+9.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1339.71","€ 29499.94","€ 28326.36","76.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 31412.17","€ 15404.08","€ 28832.15","81.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 41430.27","€ 5506.01","€ 4459.14","94.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 10300.98","€ 27751.99","€ 8193.09","85.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36431.05","€ 13442.20","€ 42634.74","88.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":869},{"label":"Mar","value":1027},{"label":"Abr","value":895},{"label":"Mai","value":908},{"label":"Jun","value":866},{"label":"Jul","value":835},{"label":"Ago","value":708},{"label":"Set","value":1050},{"label":"Out","value":1030},{"label":"Nov","value":968},{"label":"Dez","value":916}];
const MX = 1050;
