...
const PAGE = "Pipeline Kanban";
const KPIS = [{"l":"Vendas YTD (€)","v":"€93847","t":"+17.5%","d":"up"},{"l":"Pipeline (€)","v":"€50628","t":"-0.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"73.6%","t":"-4.8%","d":"down"},{"l":"Win Rate (%)","v":"87.0%","t":"+8.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 29243.62","€ 18360.27","€ 18460.87","72.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42314.46","€ 762.54","€ 42218.08","96.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29996.05","€ 29397.11","€ 40139.63","74.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 40357.82","€ 14188.07","€ 47863.79","80.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 20015.54","€ 46278.11","€ 45417.20","84.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":470},{"label":"Mar","value":513},{"label":"Abr","value":726},{"label":"Mai","value":777},{"label":"Jun","value":606},{"label":"Jul","value":412},{"label":"Ago","value":741},{"label":"Set","value":709},{"label":"Out","value":400},{"label":"Nov","value":704},{"label":"Dez","value":707}];
const MX = 777;
