...
const PAGE = "Sales Playbooks";
const KPIS = [{"l":"Vendas YTD (€)","v":"€49854","t":"+10.5%","d":"up"},{"l":"Pipeline (€)","v":"€68389","t":"+17.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"91.0%","t":"+7.1%","d":"up"},{"l":"Win Rate (%)","v":"91.9%","t":"-2.1%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 6923.84","€ 14459.49","€ 21252.83","92.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42999.01","€ 6386.61","€ 49277.49","73.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12675.61","€ 30537.99","€ 3057.14","71.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 8348.72","€ 16126.42","€ 1688.44","97.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 16458.59","€ 39325.09","€ 47588.20","89.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":709},{"label":"Mar","value":726},{"label":"Abr","value":913},{"label":"Mai","value":700},{"label":"Jun","value":700},{"label":"Jul","value":720},{"label":"Ago","value":949},{"label":"Set","value":746},{"label":"Out","value":815},{"label":"Nov","value":687},{"label":"Dez","value":915}];
const MX = 949;
...
export default function PlaybooksSalesPage() {
    return (
