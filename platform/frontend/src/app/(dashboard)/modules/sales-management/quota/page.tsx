...
const PAGE = "Quota";
const KPIS = [{"l":"Vendas YTD (€)","v":"€72575","t":"+5.5%","d":"up"},{"l":"Pipeline (€)","v":"€42369","t":"-5.4%","d":"down"},{"l":"Atingimento Quota (%)","v":"76.4%","t":"+6.0%","d":"up"},{"l":"Win Rate (%)","v":"89.6%","t":"+14.5%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 49713.30","€ 11918.75","€ 32565.17","85.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 37787.64","€ 34267.81","€ 283.46","76.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 29991.89","€ 14941.85","€ 730.17","93.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4925.80","€ 10684.53","€ 18422.58","82.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 37037.85","€ 41386.85","€ 38789.31","95.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":590},{"label":"Mar","value":569},{"label":"Abr","value":568},{"label":"Mai","value":383},{"label":"Jun","value":321},{"label":"Jul","value":612},{"label":"Ago","value":262},{"label":"Set","value":525},{"label":"Out","value":584},{"label":"Nov","value":473},{"label":"Dez","value":486}];
const MX = 612;
