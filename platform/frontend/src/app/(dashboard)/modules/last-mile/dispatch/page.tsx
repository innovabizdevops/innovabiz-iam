...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"6.243","t":"+11.9%","d":"up"},{"l":"Viagens/Dia","v":"2846","t":"-3.8%","d":"down"},{"l":"Pontualidade (%)","v":"65.7%","t":"+1.4%","d":"up"},{"l":"Passageiros/Dia","v":"1875","t":"-1.5%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-06","2026-01-18","3.721","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-09","2026-02-26","8.637","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-12","2026-02-18","1.905","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-23","2026-02-20","2.375","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-17","2026-03-06","4.387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":624},{"label":"Mar","value":831},{"label":"Abr","value":900},{"label":"Mai","value":772},{"label":"Jun","value":717},{"label":"Jul","value":921},{"label":"Ago","value":843},{"label":"Set","value":767},{"label":"Out","value":896},{"label":"Nov","value":699},{"label":"Dez","value":761}];
const MX = 921;
