...
const ACCENT = "#4b6a8f";
const MODULE = "Last Mile Delivery";
const PAGE = "Photo Proof";
const KPIS = [{"l":"Total Last Mile","v":"242","t":"+2.4%","d":"up"},{"l":"Photo Proof Ativos","v":"7.290","t":"+17.5%","d":"up"},{"l":"Eficiência (%)","v":"79.6%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"60","t":"+4.1%","d":"up"}];
const COLS = ["ID","Photo Proof","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Last Mile #001","Last Mile #002","2.033","4.087","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Last Mile #002","Last Mile #003","781","5.640","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Last Mile #003","Last Mile #004","4.975","6.306","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Last Mile #004","Last Mile #005","1.854","849","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Last Mile #005","Last Mile #001","7.581","1.897","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":947},{"label":"Mar","value":796},{"label":"Abr","value":682},{"label":"Mai","value":936},{"label":"Jun","value":808},{"label":"Jul","value":945},{"label":"Ago","value":618},{"label":"Set","value":791},{"label":"Out","value":786},{"label":"Nov","value":770},{"label":"Dez","value":736}];
const MX = 947;
