...
const PAGE = "Customer ETA";
const KPIS = [{"l":"Total Last Mile","v":"3.896","t":"+11.3%","d":"up"},{"l":"Customer ETA Ativos","v":"€87622","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"70.6%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"77","t":"+5.9%","d":"up"}];
const COLS = ["ID","Customer ETA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Last Mile #001","€ 37259.51","8.364","8.728","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Last Mile #002","€ 48355.70","3.063","6.572","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Last Mile #003","€ 3971.65","4.212","8.945","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Last Mile #004","€ 6422.69","8.889","2.732","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Last Mile #005","€ 10591.37","1.325","3.008","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":540},{"label":"Fev","value":493},{"label":"Mar","value":699},{"label":"Abr","value":708},{"label":"Mai","value":829},{"label":"Jun","value":673},{"label":"Jul","value":478},{"label":"Ago","value":850},{"label":"Set","value":729},{"label":"Out","value":592},{"label":"Nov","value":522},{"label":"Dez","value":852}];
const MX = 852;
