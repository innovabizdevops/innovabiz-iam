...
const PAGE = "Training";
const KPIS = [{"l":"Total Force Readiness","v":"7.069","t":"+15.3%","d":"up"},{"l":"Training Ativos","v":"7.264","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"61","t":"+12.8%","d":"up"}];
const COLS = ["ID","Training","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Force Readiness #001","Force Readiness #002","4.159","7.813","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Force Readiness #002","Force Readiness #003","5.889","6.352","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Force Readiness #003","Force Readiness #004","8.795","1.165","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Force Readiness #004","Force Readiness #005","3.208","8.370","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Force Readiness #005","Force Readiness #001","6.690","6.749","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":291},{"label":"Mar","value":508},{"label":"Abr","value":557},{"label":"Mai","value":492},{"label":"Jun","value":321},{"label":"Jul","value":438},{"label":"Ago","value":586},{"label":"Set","value":534},{"label":"Out","value":470},{"label":"Nov","value":622},{"label":"Dez","value":411}];
const MX = 622;
