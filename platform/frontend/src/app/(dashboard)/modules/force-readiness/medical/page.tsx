...
const PAGE = "Medical";
const KPIS = [{"l":"Integrações Ativas","v":"4.561","t":"+9.6%","d":"up"},{"l":"Chamadas/Hora","v":"4223","t":"+4.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.6%","t":"-1.2%","d":"down"},{"l":"Latência Média (ms)","v":"123ms","t":"+17.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.509","1.918","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.682","6.145","90.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.343","8.242","84.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.245","8.903","81.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.298","5.047","84.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":697},{"label":"Mar","value":802},{"label":"Abr","value":478},{"label":"Mai","value":789},{"label":"Jun","value":587},{"label":"Jul","value":616},{"label":"Ago","value":738},{"label":"Set","value":825},{"label":"Out","value":514},{"label":"Nov","value":758},{"label":"Dez","value":830}];
const MX = 830;
