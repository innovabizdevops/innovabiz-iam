...
const ACCENT = "#6366f1";
const MODULE = "Force Readiness";
const PAGE = "Personnel";
const KPIS = [{"l":"Total Force Readiness","v":"7.636","t":"+6.6%","d":"up"},{"l":"Personnel Ativos","v":"1.108","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"93.0%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"68","t":"+9.5%","d":"up"}];
const COLS = ["ID","Personnel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Force Readiness #001","Force Readiness #002","3.984","8.664","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Force Readiness #002","Force Readiness #003","686","6.486","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Force Readiness #003","Force Readiness #004","5.130","105","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Force Readiness #004","Force Readiness #005","4.187","7.098","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Force Readiness #005","Force Readiness #001","215","3.438","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":595},{"label":"Mar","value":469},{"label":"Abr","value":482},{"label":"Mai","value":518},{"label":"Jun","value":371},{"label":"Jul","value":361},{"label":"Ago","value":547},{"label":"Set","value":362},{"label":"Out","value":252},{"label":"Nov","value":276},{"label":"Dez","value":401}];
const MX = 595;
