...
export default function ForceReadinessPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Force Readiness</h1><p className="text-sm text-muted-foreground">Force Readiness • iBOS Enterprise</p></div>
