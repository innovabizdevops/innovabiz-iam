...
const ACCENT = "#6366f1";
const MODULE = "Factoring & Forfaiting";
const PAGE = "Risco";
const KPIS = [{"l":"Riscos Identificados","v":"8.363","t":"+16.2%","d":"up"},{"l":"Mitigações Ativas","v":"4.263","t":"+12.4%","d":"up"},{"l":"Score Risco Geral","v":"60","t":"-0.2%","d":"down"},{"l":"Incidentes YTD","v":"2.455","t":"-2.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","405","7.243","1.667","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.920","4.381","7.745","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","557","5.578","5.317","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.099","4.773","1.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","430","5.554","8.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":1029},{"label":"Mar","value":891},{"label":"Abr","value":696},{"label":"Mai","value":961},{"label":"Jun","value":869},{"label":"Jul","value":949},{"label":"Ago","value":650},{"label":"Set","value":655},{"label":"Out","value":809},{"label":"Nov","value":812},{"label":"Dez","value":1032}];
const MX = 1032;
