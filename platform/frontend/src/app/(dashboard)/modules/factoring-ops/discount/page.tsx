...
const PAGE = "Desconto Faturas";
const KPIS = [{"l":"ARR (€M)","v":"€37.3M","t":"-0.9%","d":"down"},{"l":"MRR (€)","v":"€11296","t":"+10.6%","d":"up"},{"l":"Churn (%)","v":"65.1%","t":"+2.1%","d":"up"},{"l":"ARPU (€)","v":"€63990","t":"+4.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 44660.61","754","€ 17619.65","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42671.14","8.568","€ 34904.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25058.16","107","€ 29141.49","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 19102.90","1.717","€ 35515.63","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 19226.61","7.663","€ 47136.89","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":653},{"label":"Mar","value":487},{"label":"Abr","value":354},{"label":"Mai","value":438},{"label":"Jun","value":345},{"label":"Jul","value":455},{"label":"Ago","value":613},{"label":"Set","value":472},{"label":"Out","value":637},{"label":"Nov","value":316},{"label":"Dez","value":511}];
const MX = 669;
