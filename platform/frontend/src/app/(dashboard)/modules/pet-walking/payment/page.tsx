...
const PAGE = "Payment";
const KPIS = [{"l":"Total Pet Walking","v":"1.216","t":"+4.4%","d":"up"},{"l":"Payment Ativos","v":"8.754","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"82.2%","t":"+7.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.8%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Walking #001","Pet Walking #002","7.753","5.423","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Walking #002","Pet Walking #003","6.702","2.507","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Walking #003","Pet Walking #004","8.222","969","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Walking #004","Pet Walking #005","886","8.755","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Walking #005","Pet Walking #001","1.647","6.702","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":722},{"label":"Mar","value":811},{"label":"Abr","value":522},{"label":"Mai","value":615},{"label":"Jun","value":773},{"label":"Jul","value":521},{"label":"Ago","value":730},{"label":"Set","value":604},{"label":"Out","value":586},{"label":"Nov","value":603},{"label":"Dez","value":825}];
const MX = 825;
