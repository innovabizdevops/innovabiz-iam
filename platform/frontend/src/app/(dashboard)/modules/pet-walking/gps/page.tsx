...
const PAGE = "GPS";
const KPIS = [{"l":"Total Pet Walking","v":"7.128","t":"+16.5%","d":"up"},{"l":"GPS Ativos","v":"3.215","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"69.9%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"58","t":"+12.1%","d":"up"}];
const COLS = ["ID","GPS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Walking #001","Pet Walking #002","8.485","4.136","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Walking #002","Pet Walking #003","1.041","5.133","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Walking #003","Pet Walking #004","1.637","6.528","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Walking #004","Pet Walking #005","7.809","4.943","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Walking #005","Pet Walking #001","4.936","3.466","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":535},{"label":"Mar","value":615},{"label":"Abr","value":889},{"label":"Mai","value":542},{"label":"Jun","value":499},{"label":"Jul","value":890},{"label":"Ago","value":528},{"label":"Set","value":768},{"label":"Out","value":519},{"label":"Nov","value":591},{"label":"Dez","value":738}];
const MX = 890;
