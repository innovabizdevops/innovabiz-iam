...
const ACCENT = "#fb923c";
const MODULE = "Pet Walking";
const PAGE = "Track";
const KPIS = [{"l":"Total Pet Walking","v":"1.585","t":"-2.9%","d":"down"},{"l":"Track Ativos","v":"4.966","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"65.6%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"62","t":"-3.6%","d":"down"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Walking #001","Pet Walking #002","231","1.619","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Walking #002","Pet Walking #003","3.445","5.709","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Walking #003","Pet Walking #004","6.552","8.000","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Walking #004","Pet Walking #005","2.349","3.696","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Walking #005","Pet Walking #001","4.893","8.762","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":595},{"label":"Mar","value":452},{"label":"Abr","value":484},{"label":"Mai","value":573},{"label":"Jun","value":500},{"label":"Jul","value":587},{"label":"Ago","value":512},{"label":"Set","value":769},{"label":"Out","value":377},{"label":"Nov","value":768},{"label":"Dez","value":403}];
const MX = 769;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#fb923c'}}>IoT</span></h1>
                </div>
