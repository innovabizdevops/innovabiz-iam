...
const PAGE = "Walker";
const KPIS = [{"l":"Total Pet Walking","v":"3.353","t":"-4.7%","d":"down"},{"l":"Walker Ativos","v":"6.255","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"76","t":"-5.2%","d":"down"}];
const COLS = ["ID","Walker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Walking #001","Pet Walking #002","2.910","130","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Walking #002","Pet Walking #003","6.152","4.354","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Walking #003","Pet Walking #004","6.860","7.605","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Walking #004","Pet Walking #005","6.765","3.507","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Walking #005","Pet Walking #001","7.982","4.338","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":708},{"label":"Mar","value":698},{"label":"Abr","value":833},{"label":"Mai","value":636},{"label":"Jun","value":819},{"label":"Jul","value":855},{"label":"Ago","value":642},{"label":"Set","value":772},{"label":"Out","value":680},{"label":"Nov","value":655},{"label":"Dez","value":679}];
const MX = 875;
