...
/* ═══ Pet Walking — Dashboard ═══ */

const ACCENT = "#fb923c";

const KPIS = [
    { label: "Total Registos", value: "2474", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4607", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€402K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "538572274", cells: ["PET-4274", "Pet Walking Item 1", "3/11/2026", "€22 374"], status: "active" as const },
    { id: "538575845", cells: ["PET-7845", "Pet Walking Item 2", "18/6/2026", "€25 945"], status: "pending" as const },
    { id: "538579416", cells: ["PET-2416", "Pet Walking Item 3", "5/1/2026", "€29 516"], status: "completed" as const },
    { id: "538582987", cells: ["PET-5987", "Pet Walking Item 4", "20/8/2026", "€33 087"], status: "warning" as const },
    { id: "538586558", cells: ["PET-9558", "Pet Walking Item 5", "7/3/2026", "€36 658"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Walking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Walking</p>
                    </div>
                </div>
