...
const PAGE = "Rx Verify";
const KPIS = [{"l":"Total Pharmacy Mgmt","v":"2.223","t":"+5.7%","d":"up"},{"l":"Rx Verify Ativos","v":"5.975","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"80.9%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"90","t":"+2.4%","d":"up"}];
const COLS = ["ID","Rx Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacy Mgmt #001","Pharmacy Mgmt #002","7.915","3.157","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacy Mgmt #002","Pharmacy Mgmt #003","250","4.174","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacy Mgmt #003","Pharmacy Mgmt #004","4.954","599","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacy Mgmt #004","Pharmacy Mgmt #005","8.266","8.267","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacy Mgmt #005","Pharmacy Mgmt #001","1.960","6.902","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":352},{"label":"Mar","value":716},{"label":"Abr","value":413},{"label":"Mai","value":688},{"label":"Jun","value":573},{"label":"Jul","value":374},{"label":"Ago","value":519},{"label":"Set","value":403},{"label":"Out","value":358},{"label":"Nov","value":660},{"label":"Dez","value":621}];
const MX = 716;
