...
const ACCENT = "#ea580c";
const MODULE = "Pharmacy Management";
const PAGE = "Drug Interaction";
const KPIS = [{"l":"Total Pharmacy Mgmt","v":"4.104","t":"+12.3%","d":"up"},{"l":"Drug Interaction Ativos","v":"8.394","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+12.5%","d":"up"}];
const COLS = ["ID","Drug Interaction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacy Mgmt #001","Pharmacy Mgmt #002","7.357","8.626","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacy Mgmt #002","Pharmacy Mgmt #003","1.977","6.542","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacy Mgmt #003","Pharmacy Mgmt #004","1.763","8.254","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacy Mgmt #004","Pharmacy Mgmt #005","3.168","5.540","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacy Mgmt #005","Pharmacy Mgmt #001","8.493","6.844","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":660},{"label":"Mar","value":543},{"label":"Abr","value":608},{"label":"Mai","value":431},{"label":"Jun","value":519},{"label":"Jul","value":437},{"label":"Ago","value":347},{"label":"Set","value":644},{"label":"Out","value":325},{"label":"Nov","value":384},{"label":"Dez","value":477}];
const MX = 660;
