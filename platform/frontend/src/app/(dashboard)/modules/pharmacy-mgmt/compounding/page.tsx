...
const PAGE = "Compounding";
const KPIS = [{"l":"Total Pharmacy Mgmt","v":"7.332","t":"+11.4%","d":"up"},{"l":"Compounding Ativos","v":"5.560","t":"-0.8%","d":"down"},{"l":"Eficiência (%)","v":"88.6%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"83","t":"+17.8%","d":"up"}];
const COLS = ["ID","Compounding","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacy Mgmt #001","Pharmacy Mgmt #002","282","7.434","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacy Mgmt #002","Pharmacy Mgmt #003","7.452","4.867","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacy Mgmt #003","Pharmacy Mgmt #004","4.556","754","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacy Mgmt #004","Pharmacy Mgmt #005","1.497","982","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacy Mgmt #005","Pharmacy Mgmt #001","2.238","2.520","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":500},{"label":"Mar","value":672},{"label":"Abr","value":707},{"label":"Mai","value":648},{"label":"Jun","value":531},{"label":"Jul","value":447},{"label":"Ago","value":439},{"label":"Set","value":602},{"label":"Out","value":389},{"label":"Nov","value":493},{"label":"Dez","value":603}];
const MX = 707;
