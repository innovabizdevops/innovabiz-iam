...
const KPIS = [{"l":"Total Pharmacy Mgmt","v":"5.170","t":"+13.1%","d":"up"},{"l":"Inventory Ativos","v":"2.039","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"65","t":"-2.4%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacy Mgmt #001","Pharmacy Mgmt #002","4.151","8.183","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacy Mgmt #002","Pharmacy Mgmt #003","6.906","7.906","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacy Mgmt #003","Pharmacy Mgmt #004","1.948","8.739","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacy Mgmt #004","Pharmacy Mgmt #005","6.245","1.507","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacy Mgmt #005","Pharmacy Mgmt #001","976","5.567","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":990},{"label":"Fev","value":662},{"label":"Mar","value":728},{"label":"Abr","value":892},{"label":"Mai","value":774},{"label":"Jun","value":883},{"label":"Jul","value":851},{"label":"Ago","value":641},{"label":"Set","value":763},{"label":"Out","value":914},{"label":"Nov","value":755},{"label":"Dez","value":926}];
const MX = 990;
