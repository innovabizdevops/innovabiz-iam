...
const KPIS = [{"l":"Total Pharmacy Mgmt","v":"1.495","t":"+12.6%","d":"up"},{"l":"Dispensing Ativos","v":"6.678","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"57","t":"-5.8%","d":"down"}];
const COLS = ["ID","Dispensing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pharmacy Mgmt #001","Pharmacy Mgmt #002","883","1.605","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Pharmacy Mgmt #002","Pharmacy Mgmt #003","219","4.434","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Pharmacy Mgmt #003","Pharmacy Mgmt #004","1.530","6.099","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pharmacy Mgmt #004","Pharmacy Mgmt #005","4.259","2.731","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pharmacy Mgmt #005","Pharmacy Mgmt #001","5.209","5.129","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":725},{"label":"Mar","value":940},{"label":"Abr","value":785},{"label":"Mai","value":630},{"label":"Jun","value":845},{"label":"Jul","value":686},{"label":"Ago","value":582},{"label":"Set","value":758},{"label":"Out","value":605},{"label":"Nov","value":755},{"label":"Dez","value":886}];
const MX = 940;
