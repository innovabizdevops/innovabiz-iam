...
const PAGE = "Split Payments";
const KPIS = [{"l":"Total Payment Services","v":"2.869","t":"-3.2%","d":"down"},{"l":"Split Payments Ativos","v":"2.476","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"93.7%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"70","t":"-1.9%","d":"down"}];
const COLS = ["ID","Split Payments","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","7.593","1.799","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","7.475","215","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","7.613","6.861","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","1.251","6.808","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","753","7.568","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":522},{"label":"Mar","value":563},{"label":"Abr","value":324},{"label":"Mai","value":320},{"label":"Jun","value":509},{"label":"Jul","value":317},{"label":"Ago","value":438},{"label":"Set","value":392},{"label":"Out","value":459},{"label":"Nov","value":304},{"label":"Dez","value":647}];
const MX = 647;
