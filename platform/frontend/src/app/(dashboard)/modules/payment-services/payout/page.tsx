...
const PAGE = "Payouts";
const KPIS = [{"l":"Total Payment Services","v":"424","t":"+4.9%","d":"up"},{"l":"Payouts Ativos","v":"2.684","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"93","t":"+8.2%","d":"up"}];
const COLS = ["ID","Payouts","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","6.612","7.425","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","7.170","8.512","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","7.106","109","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","5.039","6.503","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","8.616","1.103","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":825},{"label":"Mar","value":995},{"label":"Abr","value":803},{"label":"Mai","value":938},{"label":"Jun","value":697},{"label":"Jul","value":706},{"label":"Ago","value":747},{"label":"Set","value":932},{"label":"Out","value":1009},{"label":"Nov","value":1017},{"label":"Dez","value":875}];
const MX = 1017;
