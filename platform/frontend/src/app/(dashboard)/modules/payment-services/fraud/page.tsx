...
const PAGE = "Security &amp; Risk";
const KPIS = [{"l":"Riscos Identificados","v":"8.598","t":"+7.1%","d":"up"},{"l":"Mitigações Ativas","v":"4.051","t":"-6.0%","d":"down"},{"l":"Score Risco Geral","v":"57","t":"+8.8%","d":"up"},{"l":"Incidentes YTD","v":"199","t":"-5.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.883","7.507","8.062","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.246","5.801","8.753","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.877","8.548","7.354","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.245","4.224","8.332","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.701","4.362","9.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":346},{"label":"Fev","value":504},{"label":"Mar","value":307},{"label":"Abr","value":317},{"label":"Mai","value":481},{"label":"Jun","value":409},{"label":"Jul","value":502},{"label":"Ago","value":258},{"label":"Set","value":257},{"label":"Out","value":525},{"label":"Nov","value":579},{"label":"Dez","value":493}];
const MX = 579;
