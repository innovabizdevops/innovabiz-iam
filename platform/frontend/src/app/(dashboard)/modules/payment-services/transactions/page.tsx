...
const PAGE = "Processing &amp; Settlement";
const KPIS = [{"l":"Total Payment Services","v":"4.061","t":"-5.0%","d":"down"},{"l":"Processing & Settlement Ativos","v":"7.820","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.8%","d":"up"}];
const COLS = ["ID","Processing & Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","8.793","6.316","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","8.323","8.821","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","5.182","453","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","2.685","8.497","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","7.858","4.951","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":1055},{"label":"Mar","value":918},{"label":"Abr","value":1051},{"label":"Mai","value":1058},{"label":"Jun","value":765},{"label":"Jul","value":732},{"label":"Ago","value":695},{"label":"Set","value":887},{"label":"Out","value":710},{"label":"Nov","value":868},{"label":"Dez","value":898}];
const MX = 1058;
