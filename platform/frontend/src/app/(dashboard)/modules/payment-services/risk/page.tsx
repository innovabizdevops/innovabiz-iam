...
const PAGE = "Risk Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"7.618","t":"+5.9%","d":"up"},{"l":"Mitigações Ativas","v":"3.217","t":"-3.4%","d":"down"},{"l":"Score Risco Geral","v":"81","t":"+4.1%","d":"up"},{"l":"Incidentes YTD","v":"8.111","t":"+1.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.843","1.568","3.661","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.206","7.669","4.590","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.093","1.020","5.941","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.784","6.049","4.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.136","7.030","6.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":904},{"label":"Mar","value":894},{"label":"Abr","value":1055},{"label":"Mai","value":1049},{"label":"Jun","value":1020},{"label":"Jul","value":1059},{"label":"Ago","value":831},{"label":"Set","value":857},{"label":"Out","value":864},{"label":"Nov","value":957},{"label":"Dez","value":709}];
const MX = 1059;
