...
const PAGE = "Terminals";
const KPIS = [{"l":"Riscos Identificados","v":"2.247","t":"+1.6%","d":"up"},{"l":"Mitigações Ativas","v":"1.446","t":"+2.4%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+16.5%","d":"up"},{"l":"Incidentes YTD","v":"2.186","t":"+8.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.078","8.798","3.201","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.289","3.976","753","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.485","5.200","276","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.297","3.428","296","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.115","3.358","5.781","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":439},{"label":"Mar","value":331},{"label":"Abr","value":516},{"label":"Mai","value":513},{"label":"Jun","value":457},{"label":"Jul","value":503},{"label":"Ago","value":575},{"label":"Set","value":724},{"label":"Out","value":686},{"label":"Nov","value":373},{"label":"Dez","value":358}];
const MX = 725;
