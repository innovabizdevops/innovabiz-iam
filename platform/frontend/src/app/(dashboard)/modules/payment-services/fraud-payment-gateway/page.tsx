...
const KPIS = [{"l":"Integrações Ativas","v":"300","t":"+3.9%","d":"up"},{"l":"Chamadas/Hora","v":"4951","t":"+17.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"68.4%","t":"-2.8%","d":"down"},{"l":"Latência Média (ms)","v":"60ms","t":"+9.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.119","4.638","95.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.619","8.244","89.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.720","1.237","95.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.234","3.989","79.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.404","8.021","77.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":404},{"label":"Mar","value":342},{"label":"Abr","value":625},{"label":"Mai","value":398},{"label":"Jun","value":402},{"label":"Jul","value":729},{"label":"Ago","value":395},{"label":"Set","value":333},{"label":"Out","value":574},{"label":"Nov","value":487},{"label":"Dez","value":483}];
const MX = 729;
...
export default function FraudPaymentGatewayPage() {
    return (
