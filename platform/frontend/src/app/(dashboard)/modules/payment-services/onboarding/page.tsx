...
const KPIS = [{"l":"eNPS","v":"84","t":"-2.3%","d":"down"},{"l":"Engagement (%)","v":"67.5%","t":"+12.3%","d":"up"},{"l":"Turnover (%)","v":"93.8%","t":"+14.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.242","t":"+16.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.156","2026-02-12","56","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.621","2026-03-06","56","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","235","2026-03-26","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","959","2026-01-11","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.892","2026-03-26","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":673},{"label":"Mar","value":879},{"label":"Abr","value":805},{"label":"Mai","value":659},{"label":"Jun","value":781},{"label":"Jul","value":602},{"label":"Ago","value":905},{"label":"Set","value":686},{"label":"Out","value":757},{"label":"Nov","value":563},{"label":"Dez","value":643}];
const MX = 905;
