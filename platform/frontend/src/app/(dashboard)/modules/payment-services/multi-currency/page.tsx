...
const ACCENT = "#6366f1";
const MODULE = "Payment Services";
const PAGE = "Multi-Currency";
const KPIS = [{"l":"Total Payment Services","v":"6.767","t":"-5.0%","d":"down"},{"l":"Multi Currency Ativos","v":"627","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"84.6%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+13.8%","d":"up"}];
const COLS = ["ID","Multi Currency","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","2.270","6.623","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","9.069","2.296","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","4.010","1.788","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","7.582","7.733","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","4.805","1.085","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":847},{"label":"Mar","value":687},{"label":"Abr","value":585},{"label":"Mai","value":546},{"label":"Jun","value":796},{"label":"Jul","value":788},{"label":"Ago","value":512},{"label":"Set","value":678},{"label":"Out","value":799},{"label":"Nov","value":575},{"label":"Dez","value":701}];
const MX = 847;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Multi</span></h1>
                </div>
