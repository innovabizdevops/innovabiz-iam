...
const KPIS = [{"l":"Total Payment Services","v":"8.145","t":"-4.3%","d":"down"},{"l":"Settlement Ativos","v":"5.432","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.2%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","5.518","3.089","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","693","937","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","4.820","3.500","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","4.562","3.436","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","2.429","6.230","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":499},{"label":"Mar","value":752},{"label":"Abr","value":593},{"label":"Mai","value":619},{"label":"Jun","value":471},{"label":"Jul","value":497},{"label":"Ago","value":707},{"label":"Set","value":751},{"label":"Out","value":411},{"label":"Nov","value":553},{"label":"Dez","value":772}];
const MX = 772;
