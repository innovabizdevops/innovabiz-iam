...
const PAGE = "Reconciliation";
const KPIS = [{"l":"Total Payment Services","v":"4.380","t":"+0.5%","d":"up"},{"l":"Reconciliation Ativos","v":"2.060","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"76.1%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"79","t":"+10.8%","d":"up"}];
const COLS = ["ID","Reconciliation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","217","5.318","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","3.798","9.088","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","7.753","7.265","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","3.618","2.902","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","3.466","1.791","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":818},{"label":"Mar","value":901},{"label":"Abr","value":769},{"label":"Mai","value":934},{"label":"Jun","value":860},{"label":"Jul","value":710},{"label":"Ago","value":746},{"label":"Set","value":903},{"label":"Out","value":765},{"label":"Nov","value":771},{"label":"Dez","value":677}];
const MX = 934;
