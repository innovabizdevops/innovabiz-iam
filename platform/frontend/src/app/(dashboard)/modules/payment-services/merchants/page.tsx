...
const PAGE = "Gateway Operations";
const KPIS = [{"l":"Integrações Ativas","v":"5.352","t":"+17.1%","d":"up"},{"l":"Chamadas/Hora","v":"1078","t":"+1.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.0%","t":"+0.3%","d":"up"},{"l":"Latência Média (ms)","v":"85ms","t":"+0.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.700","6.831","95.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.092","5.602","83.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","421","8.481","89.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.049","9.052","96.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.992","3.456","78.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":870},{"label":"Mar","value":604},{"label":"Abr","value":847},{"label":"Mai","value":650},{"label":"Jun","value":690},{"label":"Jul","value":741},{"label":"Ago","value":713},{"label":"Set","value":894},{"label":"Out","value":547},{"label":"Nov","value":652},{"label":"Dez","value":550}];
const MX = 894;
