...
const PAGE = "Tokenization";
const KPIS = [{"l":"Total Payment Services","v":"1.094","t":"+16.0%","d":"up"},{"l":"Tokenization Ativos","v":"5.741","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"83.1%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+0.4%","d":"up"}];
const COLS = ["ID","Tokenization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","2.078","6.694","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","2.961","3.923","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","4.744","8.337","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","8.468","6.063","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","5.130","8.775","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":409},{"label":"Mar","value":522},{"label":"Abr","value":431},{"label":"Mai","value":639},{"label":"Jun","value":457},{"label":"Jul","value":668},{"label":"Ago","value":610},{"label":"Set","value":442},{"label":"Out","value":551},{"label":"Nov","value":358},{"label":"Dez","value":729}];
const MX = 729;
