...
const KPIS = [{"l":"Integrações Ativas","v":"6.345","t":"-5.0%","d":"down"},{"l":"Chamadas/Hora","v":"4357","t":"+11.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.6%","t":"+5.9%","d":"up"},{"l":"Latência Média (ms)","v":"179ms","t":"+2.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.634","7.700","99.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.353","7.537","98.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.953","1.938","98.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.121","8.867","78.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.226","4.376","75.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":479},{"label":"Mar","value":762},{"label":"Abr","value":501},{"label":"Mai","value":691},{"label":"Jun","value":541},{"label":"Jul","value":529},{"label":"Ago","value":745},{"label":"Set","value":623},{"label":"Out","value":730},{"label":"Nov","value":680},{"label":"Dez","value":438}];
const MX = 762;
...
export default function MerchantsPaymentGatewayPage() {
    return (
