...
const KPIS = [{"l":"Integrações Ativas","v":"830","t":"+11.0%","d":"up"},{"l":"Chamadas/Hora","v":"2569","t":"+12.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.4%","t":"+9.0%","d":"up"},{"l":"Latência Média (ms)","v":"89ms","t":"+13.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.592","1.037","87.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","844","1.149","91.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.521","8.849","75.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.172","4.074","77.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.865","4.796","93.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":854},{"label":"Mar","value":642},{"label":"Abr","value":764},{"label":"Mai","value":483},{"label":"Jun","value":761},{"label":"Jul","value":762},{"label":"Ago","value":557},{"label":"Set","value":793},{"label":"Out","value":841},{"label":"Nov","value":802},{"label":"Dez","value":683}];
const MX = 854;
