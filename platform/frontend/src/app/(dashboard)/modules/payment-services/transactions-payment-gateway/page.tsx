...
const PAGE = "Transactions Hub";
const KPIS = [{"l":"Integrações Ativas","v":"7.614","t":"+13.8%","d":"up"},{"l":"Chamadas/Hora","v":"2412","t":"-3.0%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.6%","t":"+9.3%","d":"up"},{"l":"Latência Média (ms)","v":"100ms","t":"-3.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.764","3.240","72.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","864","216","71.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.655","6.373","86.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.587","4.644","88.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.063","6.291","73.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":486},{"label":"Mar","value":536},{"label":"Abr","value":406},{"label":"Mai","value":549},{"label":"Jun","value":645},{"label":"Jul","value":661},{"label":"Ago","value":544},{"label":"Set","value":399},{"label":"Out","value":551},{"label":"Nov","value":701},{"label":"Dez","value":748}];
const MX = 748;
...
export default function TransactionsPaymentGatewayPage() {
    return (
