...
const KPIS = [{"l":"Dashboards Ativos","v":"8.521","t":"-4.8%","d":"down"},{"l":"Queries/Dia","v":"3405","t":"+11.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.269","t":"-1.5%","d":"down"},{"l":"Utilizadores Analytics","v":"1.002","t":"+10.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","713","2026-02-19","8.724","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4337","2026-01-28","9.003","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3518","2026-01-05","2.692","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2579","2026-03-20","1.224","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3348","2026-01-06","396","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":378},{"label":"Fev","value":376},{"label":"Mar","value":429},{"label":"Abr","value":373},{"label":"Mai","value":611},{"label":"Jun","value":490},{"label":"Jul","value":731},{"label":"Ago","value":631},{"label":"Set","value":524},{"label":"Out","value":435},{"label":"Nov","value":643},{"label":"Dez","value":474}];
const MX = 731;
