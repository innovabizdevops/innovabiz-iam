...
const PAGE = "Cross-Border";
const KPIS = [{"l":"Total Payment Services","v":"8.903","t":"+3.1%","d":"up"},{"l":"Cross Border Ativos","v":"759","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+7.0%","d":"up"}];
const COLS = ["ID","Cross Border","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Services #001","Payment Services #002","5.924","7.578","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Services #002","Payment Services #003","804","7.518","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Services #003","Payment Services #004","7.711","8.090","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Services #004","Payment Services #005","8.032","8.616","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Services #005","Payment Services #001","4.231","755","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":426},{"label":"Mar","value":413},{"label":"Abr","value":510},{"label":"Mai","value":250},{"label":"Jun","value":347},{"label":"Jul","value":486},{"label":"Ago","value":587},{"label":"Set","value":490},{"label":"Out","value":344},{"label":"Nov","value":568},{"label":"Dez","value":344}];
const MX = 587;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ISIC</span></h1>
                </div>
