...
const ACCENT = "#4f46e5";
const MODULE = "Circular Economy";
const PAGE = "Impact Track";
const KPIS = [{"l":"Projetos Sociais","v":"9.091","t":"+16.6%","d":"up"},{"l":"Beneficiários","v":"3.841","t":"+2.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€87794","t":"-5.1%","d":"down"},{"l":"Score Impacto","v":"92","t":"+2.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.041","€ 40033.68","2.786","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.649","€ 5492.83","5.306","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.602","€ 1295.56","819","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.277","€ 28818.28","7.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","781","€ 7829.88","6.348","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":1006},{"label":"Mar","value":974},{"label":"Abr","value":747},{"label":"Mai","value":1009},{"label":"Jun","value":705},{"label":"Jul","value":946},{"label":"Ago","value":934},{"label":"Set","value":745},{"label":"Out","value":702},{"label":"Nov","value":1005},{"label":"Dez","value":904}];
const MX = 1009;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4f46e5'}}>ESG</span></h1>
                </div>
