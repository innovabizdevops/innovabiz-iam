...
const PAGE = "Remanufacture";
const KPIS = [{"l":"Total Circular Economy","v":"702","t":"+11.1%","d":"up"},{"l":"Remanufacture Ativos","v":"7.196","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"92","t":"+6.2%","d":"up"}];
const COLS = ["ID","Remanufacture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Circular Economy #001","Circular Economy #002","1.547","5.373","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Circular Economy #002","Circular Economy #003","3.287","8.824","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Circular Economy #003","Circular Economy #004","5.614","4.119","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Circular Economy #004","Circular Economy #005","5.351","1.143","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Circular Economy #005","Circular Economy #001","1.427","2.354","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":284},{"label":"Fev","value":277},{"label":"Mar","value":254},{"label":"Abr","value":487},{"label":"Mai","value":382},{"label":"Jun","value":454},{"label":"Jul","value":312},{"label":"Ago","value":357},{"label":"Set","value":531},{"label":"Out","value":598},{"label":"Nov","value":459},{"label":"Dez","value":304}];
const MX = 598;
...
export default function RemfgPage() {
    return (
