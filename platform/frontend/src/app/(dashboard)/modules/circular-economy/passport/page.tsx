...
const PAGE = "Product Passport";
const KPIS = [{"l":"Atletas Registados","v":"553","t":"-1.4%","d":"down"},{"l":"Treinos/Semana","v":"3591","t":"+3.1%","d":"up"},{"l":"Competições","v":"1.105","t":"+17.3%","d":"up"},{"l":"Performance Score","v":"64","t":"+15.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.059","7.113","7.730","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.091","7.296","1.039","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.858","3.026","4.552","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.136","5.676","6.057","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.098","7.487","6.925","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":352},{"label":"Fev","value":653},{"label":"Mar","value":550},{"label":"Abr","value":371},{"label":"Mai","value":386},{"label":"Jun","value":453},{"label":"Jul","value":435},{"label":"Ago","value":709},{"label":"Set","value":449},{"label":"Out","value":666},{"label":"Nov","value":595},{"label":"Dez","value":449}];
const MX = 709;
