...
const ACCENT = "#be185d";
const MODULE = "Marketing Operations Deep";
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"5.633","t":"+12.6%","d":"up"},{"l":"Valor Total (€M)","v":"€41.0M","t":"+6.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€66054","t":"+-0.0%","d":"up"},{"l":"Ativos em Garantia","v":"6.304","t":"-4.7%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 41506.04","3.223","€ 43044.24","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 7118.56","848","€ 15967.22","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 5279.75","9.043","€ 624.69","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 16589.90","1.742","€ 5065.90","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 12459.23","4.012","€ 11381.76","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":639},{"label":"Fev","value":452},{"label":"Mar","value":511},{"label":"Abr","value":522},{"label":"Mai","value":573},{"label":"Jun","value":640},{"label":"Jul","value":488},{"label":"Ago","value":506},{"label":"Set","value":747},{"label":"Out","value":736},{"label":"Nov","value":801},{"label":"Dez","value":698}];
const MX = 801;
