...
const PAGE = "Budget";
const KPIS = [{"l":"Total Marketing Ops","v":"4.432","t":"+9.9%","d":"up"},{"l":"Budget Ativos","v":"€59476","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"73.5%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"94","t":"+9.7%","d":"up"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Ops #001","€ 7445.95","7.504","2.678","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Ops #002","€ 4374.27","7.624","2.237","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Ops #003","€ 37405.25","3.776","3.231","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Ops #004","€ 48757.74","7.178","571","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Ops #005","€ 27969.10","8.701","6.113","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":759},{"label":"Mar","value":844},{"label":"Abr","value":489},{"label":"Mai","value":692},{"label":"Jun","value":592},{"label":"Jul","value":466},{"label":"Ago","value":670},{"label":"Set","value":749},{"label":"Out","value":658},{"label":"Nov","value":641},{"label":"Dez","value":751}];
const MX = 844;
