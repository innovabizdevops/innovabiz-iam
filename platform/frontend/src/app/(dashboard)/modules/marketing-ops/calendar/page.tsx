...
const PAGE = "Calendar";
const KPIS = [{"l":"Total Marketing Ops","v":"6.905","t":"-4.1%","d":"down"},{"l":"Calendar Ativos","v":"1.121","t":"+17.8%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+14.5%","d":"up"},{"l":"Score Performance","v":"56","t":"-5.5%","d":"down"}];
const COLS = ["ID","Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marketing Ops #001","Marketing Ops #002","5.728","7.221","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Marketing Ops #002","Marketing Ops #003","4.410","3.857","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Marketing Ops #003","Marketing Ops #004","5.784","4.625","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Marketing Ops #004","Marketing Ops #005","6.476","7.285","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marketing Ops #005","Marketing Ops #001","7.738","949","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":326},{"label":"Mar","value":329},{"label":"Abr","value":280},{"label":"Mai","value":472},{"label":"Jun","value":484},{"label":"Jul","value":478},{"label":"Ago","value":591},{"label":"Set","value":395},{"label":"Out","value":513},{"label":"Nov","value":298},{"label":"Dez","value":362}];
const MX = 591;
