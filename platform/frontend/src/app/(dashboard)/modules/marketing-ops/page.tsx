...
/* ═══ Marketing Operations Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "2254", trend: "-5%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1205", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€381K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-12%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "442047054", cells: ["MAR-4054", "Marketing Operations Deep Item 1", "23/7/2026", "€47 154"], status: "active" as const },
    { id: "442050625", cells: ["MAR-7625", "Marketing Operations Deep Item 2", "10/2/2026", "€725"], status: "pending" as const },
    { id: "442054196", cells: ["MAR-2196", "Marketing Operations Deep Item 3", "25/9/2026", "€4296"], status: "completed" as const },
    { id: "442057767", cells: ["MAR-5767", "Marketing Operations Deep Item 4", "12/4/2026", "€7867"], status: "warning" as const },
    { id: "442061338", cells: ["MAR-9338", "Marketing Operations Deep Item 5", "27/11/2026", "€11 438"], status: "active" as const },
];
...
export default function MarketingOperationsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Marketing Operations Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Marketing Operations Deep</p>
                    </div>
                </div>
