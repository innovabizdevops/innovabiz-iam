...
const PAGE = "FAQ Engine";
const KPIS = [{"l":"Projetos Melhoria","v":"4.594","t":"-0.2%","d":"down"},{"l":"Savings (€)","v":"€86857","t":"+16.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.7%","t":"+9.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.711","t":"+15.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.940","€ 11921.98","1.108","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.486","€ 11248.29","5.710","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.378","€ 12099.84","4.248","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.815","€ 31204.33","8.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.728","€ 29739.11","8.314","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":283},{"label":"Mar","value":385},{"label":"Abr","value":407},{"label":"Mai","value":260},{"label":"Jun","value":615},{"label":"Jul","value":442},{"label":"Ago","value":587},{"label":"Set","value":244},{"label":"Out","value":359},{"label":"Nov","value":360},{"label":"Dez","value":475}];
const MX = 615;
