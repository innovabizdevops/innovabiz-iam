...
const KPIS = [{"l":"Projetos Melhoria","v":"4.823","t":"-2.4%","d":"down"},{"l":"Savings (€)","v":"€50163","t":"+6.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.9%","t":"+13.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.436","t":"+6.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","9.075","€ 7600.29","491","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","877","€ 24622.53","1.338","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.644","€ 13657.21","7.841","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.317","€ 18608.74","619","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.203","€ 15787.71","8.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":617},{"label":"Mar","value":830},{"label":"Abr","value":800},{"label":"Mai","value":733},{"label":"Jun","value":720},{"label":"Jul","value":677},{"label":"Ago","value":754},{"label":"Set","value":900},{"label":"Out","value":770},{"label":"Nov","value":645},{"label":"Dez","value":906}];
const MX = 906;
