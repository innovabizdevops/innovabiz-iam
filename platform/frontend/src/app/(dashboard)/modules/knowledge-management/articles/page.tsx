...
const PAGE = "Articles";
const KPIS = [{"l":"Projetos Melhoria","v":"3.686","t":"+10.0%","d":"up"},{"l":"Savings (€)","v":"€51718","t":"+15.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.8%","t":"+8.3%","d":"up"},{"l":"Ciclos PDCA","v":"3.877","t":"+8.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.195","€ 38659.61","2.924","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.052","€ 20286.15","4.195","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.740","€ 4539.38","5.771","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.411","€ 33897.38","5.070","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.292","€ 5593.44","3.143","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":883},{"label":"Fev","value":904},{"label":"Mar","value":611},{"label":"Abr","value":962},{"label":"Mai","value":725},{"label":"Jun","value":957},{"label":"Jul","value":944},{"label":"Ago","value":647},{"label":"Set","value":693},{"label":"Out","value":794},{"label":"Nov","value":930},{"label":"Dez","value":740}];
const MX = 962;
