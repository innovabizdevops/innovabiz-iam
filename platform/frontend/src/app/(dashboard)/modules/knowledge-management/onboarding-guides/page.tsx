...
const PAGE = "Onboarding Guides";
const KPIS = [{"l":"eNPS","v":"69","t":"-4.7%","d":"down"},{"l":"Engagement (%)","v":"80.1%","t":"+16.6%","d":"up"},{"l":"Turnover (%)","v":"77.0%","t":"+16.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.378","t":"-4.2%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.148","2026-01-14","75","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.372","2026-03-16","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.395","2026-03-24","81","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","3.864","2026-02-02","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.958","2026-02-10","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":787},{"label":"Mar","value":962},{"label":"Abr","value":1049},{"label":"Mai","value":899},{"label":"Jun","value":757},{"label":"Jul","value":804},{"label":"Ago","value":1023},{"label":"Set","value":720},{"label":"Out","value":986},{"label":"Nov","value":704},{"label":"Dez","value":844}];
const MX = 1049;
