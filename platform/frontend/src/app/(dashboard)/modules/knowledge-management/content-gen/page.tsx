...
const PAGE = "Content Generation";
const KPIS = [{"l":"Projetos Melhoria","v":"8.967","t":"+1.7%","d":"up"},{"l":"Savings (€)","v":"€44931","t":"-1.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"92.0%","t":"+3.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.208","t":"+8.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.695","€ 35755.96","6.764","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.489","€ 32464.81","6.851","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.571","€ 17285.46","8.896","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.917","€ 7307.76","6.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.625","€ 11325.74","7.170","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":1009},{"label":"Mar","value":941},{"label":"Abr","value":902},{"label":"Mai","value":1048},{"label":"Jun","value":744},{"label":"Jul","value":1010},{"label":"Ago","value":929},{"label":"Set","value":720},{"label":"Out","value":848},{"label":"Nov","value":926},{"label":"Dez","value":765}];
const MX = 1048;
