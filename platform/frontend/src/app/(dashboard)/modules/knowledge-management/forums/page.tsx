...
const PAGE = "Community Forums";
const KPIS = [{"l":"Projetos Melhoria","v":"3.764","t":"+14.5%","d":"up"},{"l":"Savings (€)","v":"€6923","t":"+11.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"93.6%","t":"+16.1%","d":"up"},{"l":"Ciclos PDCA","v":"3.485","t":"-1.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.850","€ 29713.16","8.735","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","184","€ 35234.83","7.288","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.901","€ 42892.10","449","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.721","€ 20730.91","3.139","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.559","€ 29101.21","3.181","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":536},{"label":"Fev","value":639},{"label":"Mar","value":453},{"label":"Abr","value":566},{"label":"Mai","value":611},{"label":"Jun","value":541},{"label":"Jul","value":621},{"label":"Ago","value":435},{"label":"Set","value":420},{"label":"Out","value":574},{"label":"Nov","value":641},{"label":"Dez","value":283}];
const MX = 641;
