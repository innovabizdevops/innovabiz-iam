...
const KPIS = [{"l":"Projetos Melhoria","v":"194","t":"-1.0%","d":"down"},{"l":"Savings (€)","v":"€14846","t":"-2.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"89.9%","t":"-1.6%","d":"down"},{"l":"Ciclos PDCA","v":"7.803","t":"+16.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.889","€ 18916.62","737","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.990","€ 38043.85","1.137","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.514","€ 17968.10","6.562","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.659","€ 6984.87","1.847","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.023","€ 6016.05","3.827","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":291},{"label":"Mar","value":610},{"label":"Abr","value":453},{"label":"Mai","value":264},{"label":"Jun","value":361},{"label":"Jul","value":322},{"label":"Ago","value":540},{"label":"Set","value":523},{"label":"Out","value":456},{"label":"Nov","value":232},{"label":"Dez","value":581}];
const MX = 610;
