...
const PAGE = "Taxonomy";
const KPIS = [{"l":"Projetos Melhoria","v":"6.410","t":"+6.3%","d":"up"},{"l":"Savings (€)","v":"€12119","t":"+14.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.6%","t":"+17.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.698","t":"+1.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.987","€ 1701.07","7.392","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.787","€ 7607.30","8.147","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","734","€ 45665.26","1.591","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.354","€ 2778.65","8.429","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.829","€ 31448.15","5.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1048},{"label":"Fev","value":1004},{"label":"Mar","value":709},{"label":"Abr","value":859},{"label":"Mai","value":945},{"label":"Jun","value":781},{"label":"Jul","value":859},{"label":"Ago","value":921},{"label":"Set","value":880},{"label":"Out","value":950},{"label":"Nov","value":858},{"label":"Dez","value":862}];
const MX = 1048;
