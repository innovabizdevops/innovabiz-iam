...
const PAGE = "Expert Finder AI";
const KPIS = [{"l":"Projetos Melhoria","v":"1.613","t":"-0.8%","d":"down"},{"l":"Savings (€)","v":"€74303","t":"+4.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.9%","t":"+7.6%","d":"up"},{"l":"Ciclos PDCA","v":"1.989","t":"-1.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.809","€ 35527.67","6.854","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.963","€ 21557.86","2.549","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.797","€ 47466.27","404","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.983","€ 8681.12","5.012","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.923","€ 37778.41","1.120","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":375},{"label":"Mar","value":434},{"label":"Abr","value":645},{"label":"Mai","value":477},{"label":"Jun","value":378},{"label":"Jul","value":751},{"label":"Ago","value":586},{"label":"Set","value":483},{"label":"Out","value":449},{"label":"Nov","value":460},{"label":"Dez","value":470}];
const MX = 751;
