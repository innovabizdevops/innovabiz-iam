...
/* ═══ Deposits & Savings (BIAN) — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "469", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1428", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€162K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "498990069", cells: ["BIA-4069", "Deposits & Savings (BIAN) Item 1", "26/10/2026", "€40 169"], status: "active" as const },
    { id: "498993640", cells: ["BIA-7640", "Deposits & Savings (BIAN) Item 2", "13/5/2026", "€43 740"], status: "pending" as const },
    { id: "498997211", cells: ["BIA-2211", "Deposits & Savings (BIAN) Item 3", "28/12/2026", "€47 311"], status: "completed" as const },
    { id: "499000782", cells: ["BIA-5782", "Deposits & Savings (BIAN) Item 4", "15/7/2026", "€882"], status: "warning" as const },
    { id: "499004353", cells: ["BIA-9353", "Deposits & Savings (BIAN) Item 5", "2/2/2026", "€4453"], status: "active" as const },
];
...
export default function DepositsSavingsBianPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Deposits & Savings (BIAN)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Deposits & Savings (BIAN)</p>
                    </div>
                </div>
