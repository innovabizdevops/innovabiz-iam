...
const ACCENT = "#0e7490";
const MODULE = "Deposits & Savings (BIAN)";
const PAGE = "Transact";
const KPIS = [{"l":"Pedidos/Dia","v":"1348","t":"-3.3%","d":"down"},{"l":"GMV (€)","v":"€65643","t":"+12.1%","d":"up"},{"l":"Conversão (%)","v":"75.4%","t":"+10.4%","d":"up"},{"l":"AOV (€)","v":"€46930","t":"+11.2%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 13187.39","8.403","6.760","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 3339.78","7.386","1.525","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 42435.56","9.031","530","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 8364.31","4.708","4.609","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 10831.70","1.643","7.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":583},{"label":"Mar","value":555},{"label":"Abr","value":586},{"label":"Mai","value":927},{"label":"Jun","value":616},{"label":"Jul","value":747},{"label":"Ago","value":853},{"label":"Set","value":703},{"label":"Out","value":647},{"label":"Nov","value":578},{"label":"Dez","value":555}];
const MX = 927;
