...
const KPIS = [{"l":"Dashboards Ativos","v":"1.039","t":"+4.9%","d":"up"},{"l":"Queries/Dia","v":"448","t":"+3.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.224","t":"-0.5%","d":"down"},{"l":"Utilizadores Analytics","v":"2.515","t":"+8.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4301","2026-03-16","4.333","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1084","2026-03-14","2.218","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2748","2026-01-11","3.907","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2183","2026-02-18","2.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3512","2026-03-04","4.542","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":557},{"label":"Mar","value":310},{"label":"Abr","value":265},{"label":"Mai","value":607},{"label":"Jun","value":240},{"label":"Jul","value":309},{"label":"Ago","value":460},{"label":"Set","value":368},{"label":"Out","value":370},{"label":"Nov","value":437},{"label":"Dez","value":605}];
const MX = 607;
