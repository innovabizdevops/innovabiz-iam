...
export default function PalletTrackPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pallet Track</h1><p className="text-sm text-muted-foreground">Pallet Track • iBOS Enterprise</p></div>
