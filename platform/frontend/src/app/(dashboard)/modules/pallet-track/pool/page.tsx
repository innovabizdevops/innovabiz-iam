...
const PAGE = "Pool Mgmt";
const KPIS = [{"l":"Total Pallet Track","v":"8.185","t":"+12.1%","d":"up"},{"l":"Pool Mgmt Ativos","v":"767","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"71.7%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+16.8%","d":"up"}];
const COLS = ["ID","Pool Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Track #001","Pallet Track #002","3.723","3.635","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Track #002","Pallet Track #003","7.050","4.597","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Track #003","Pallet Track #004","739","5.554","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Track #004","Pallet Track #005","3.712","2.062","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Track #005","Pallet Track #001","5.962","6.268","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":594},{"label":"Mar","value":703},{"label":"Abr","value":556},{"label":"Mai","value":643},{"label":"Jun","value":583},{"label":"Jul","value":493},{"label":"Ago","value":784},{"label":"Set","value":696},{"label":"Out","value":538},{"label":"Nov","value":691},{"label":"Dez","value":565}];
const MX = 784;
