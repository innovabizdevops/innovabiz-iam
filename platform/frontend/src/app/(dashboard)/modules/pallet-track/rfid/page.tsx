...
const ACCENT = "#6366f1";
const MODULE = "Pallet Tracking";
const PAGE = "RFID";
const KPIS = [{"l":"Total Pallet Track","v":"6.339","t":"+16.2%","d":"up"},{"l":"RFID Ativos","v":"3.105","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"85","t":"+10.4%","d":"up"}];
const COLS = ["ID","RFID","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Track #001","Pallet Track #002","7.626","3.526","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Track #002","Pallet Track #003","856","4.834","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Track #003","Pallet Track #004","336","6.556","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Track #004","Pallet Track #005","2.409","7.399","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Track #005","Pallet Track #001","946","8.328","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":503},{"label":"Mar","value":569},{"label":"Abr","value":492},{"label":"Mai","value":553},{"label":"Jun","value":798},{"label":"Jul","value":441},{"label":"Ago","value":510},{"label":"Set","value":788},{"label":"Out","value":742},{"label":"Nov","value":573},{"label":"Dez","value":566}];
const MX = 798;
