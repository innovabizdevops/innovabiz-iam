...
/* ═══ Multimodal GenAI Engine — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "3528", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2122", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€407K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1907941328", cells: ["GEN-5328", "Multimodal GenAI Engine Item 1", "21/9/2026", "€41 428"], status: "active" as const },
    { id: "1907944899", cells: ["GEN-8899", "Multimodal GenAI Engine Item 2", "8/4/2026", "€44 999"], status: "pending" as const },
    { id: "1907948470", cells: ["GEN-3470", "Multimodal GenAI Engine Item 3", "23/11/2026", "€48 570"], status: "completed" as const },
    { id: "1907952041", cells: ["GEN-7041", "Multimodal GenAI Engine Item 4", "10/6/2026", "€2141"], status: "warning" as const },
    { id: "1907955612", cells: ["GEN-1612", "Multimodal GenAI Engine Item 5", "25/1/2026", "€5712"], status: "active" as const },
];
...
export default function MultimodalGenaiEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multimodal GenAI Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multimodal GenAI Engine</p>
                    </div>
                </div>
