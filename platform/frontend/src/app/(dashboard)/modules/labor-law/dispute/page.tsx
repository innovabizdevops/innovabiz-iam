...
const ACCENT = "#4338ca";
const MODULE = "Labor & Employment Law";
const PAGE = "Dispute Track";
const KPIS = [{"l":"Total Labor Law","v":"3.600","t":"-4.6%","d":"down"},{"l":"Dispute Track Ativos","v":"3.323","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.6%","d":"up"}];
const COLS = ["ID","Dispute Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Labor Law #001","Labor Law #002","1.635","495","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Labor Law #002","Labor Law #003","2.548","3.886","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Labor Law #003","Labor Law #004","1.448","5.460","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Labor Law #004","Labor Law #005","7.094","6.145","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Labor Law #005","Labor Law #001","728","4.011","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":611},{"label":"Mar","value":783},{"label":"Abr","value":903},{"label":"Mai","value":816},{"label":"Jun","value":969},{"label":"Jul","value":746},{"label":"Ago","value":636},{"label":"Set","value":922},{"label":"Out","value":788},{"label":"Nov","value":597},{"label":"Dez","value":851}];
const MX = 969;
