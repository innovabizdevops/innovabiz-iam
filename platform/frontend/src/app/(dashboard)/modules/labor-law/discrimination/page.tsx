...
const PAGE = "Discrimination";
const KPIS = [{"l":"Total Labor Law","v":"8.818","t":"+4.3%","d":"up"},{"l":"Discrimination Ativos","v":"3.346","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"90","t":"-3.6%","d":"down"}];
const COLS = ["ID","Discrimination","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Labor Law #001","Labor Law #002","2.200","6.483","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Labor Law #002","Labor Law #003","8.280","4.804","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Labor Law #003","Labor Law #004","3.793","136","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Labor Law #004","Labor Law #005","1.414","7.928","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Labor Law #005","Labor Law #001","8.741","8.676","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1044},{"label":"Fev","value":1063},{"label":"Mar","value":901},{"label":"Abr","value":832},{"label":"Mai","value":1089},{"label":"Jun","value":1095},{"label":"Jul","value":739},{"label":"Ago","value":876},{"label":"Set","value":1001},{"label":"Out","value":847},{"label":"Nov","value":891},{"label":"Dez","value":915}];
const MX = 1095;
