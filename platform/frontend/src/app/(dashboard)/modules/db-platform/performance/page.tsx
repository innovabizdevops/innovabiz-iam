...
const KPIS = [{"l":"Formulários Ativos","v":"1.187","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"1797","t":"+16.2%","d":"up"},{"l":"Documentos Gerados","v":"2.153","t":"-1.5%","d":"down"},{"l":"Templates","v":"6.465","t":"+11.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.497","2026-02-12","5.521","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.859","2026-03-10","4.416","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.345","2026-01-28","1.686","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.370","2026-03-09","3.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.327","2026-03-21","1.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":753},{"label":"Mar","value":875},{"label":"Abr","value":949},{"label":"Mai","value":949},{"label":"Jun","value":981},{"label":"Jul","value":694},{"label":"Ago","value":676},{"label":"Set","value":998},{"label":"Out","value":716},{"label":"Nov","value":688},{"label":"Dez","value":813}];
const MX = 998;
