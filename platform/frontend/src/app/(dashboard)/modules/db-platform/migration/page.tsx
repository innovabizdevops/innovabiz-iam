...
const KPIS = [{"l":"Formulários Ativos","v":"294","t":"-5.0%","d":"down"},{"l":"Submissões/Dia","v":"4159","t":"+2.5%","d":"up"},{"l":"Documentos Gerados","v":"8.239","t":"-4.3%","d":"down"},{"l":"Templates","v":"4.157","t":"-2.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.450","2026-02-09","6.237","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.137","2026-01-12","4.300","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.366","2026-03-25","2.909","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.823","2026-02-27","722","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","206","2026-03-24","5.254","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":747},{"label":"Mar","value":433},{"label":"Abr","value":764},{"label":"Mai","value":667},{"label":"Jun","value":414},{"label":"Jul","value":462},{"label":"Ago","value":612},{"label":"Set","value":772},{"label":"Out","value":514},{"label":"Nov","value":695},{"label":"Dez","value":703}];
const MX = 772;
