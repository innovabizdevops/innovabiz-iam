...
const KPIS = [{"l":"Formulários Ativos","v":"5.313","t":"-1.7%","d":"down"},{"l":"Submissões/Dia","v":"229","t":"+4.8%","d":"up"},{"l":"Documentos Gerados","v":"8.990","t":"-5.8%","d":"down"},{"l":"Templates","v":"244","t":"+16.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.002","2026-03-01","8.920","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.234","2026-02-14","2.117","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.262","2026-01-04","1.238","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.077","2026-01-28","445","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.458","2026-02-16","4.810","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":711},{"label":"Mar","value":705},{"label":"Abr","value":574},{"label":"Mai","value":587},{"label":"Jun","value":792},{"label":"Jul","value":899},{"label":"Ago","value":951},{"label":"Set","value":749},{"label":"Out","value":724},{"label":"Nov","value":819},{"label":"Dez","value":850}];
const MX = 951;
