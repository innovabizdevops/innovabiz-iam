...
const PAGE = "Backup/Recovery";
const KPIS = [{"l":"Formulários Ativos","v":"8.638","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"4782","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"4.234","t":"+7.0%","d":"up"},{"l":"Templates","v":"4.380","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.160","2026-02-08","8.062","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.850","2026-01-14","1.337","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","229","2026-01-04","8.073","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","430","2026-02-16","8.124","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.708","2026-02-20","4.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":571},{"label":"Mar","value":451},{"label":"Abr","value":527},{"label":"Mai","value":501},{"label":"Jun","value":649},{"label":"Jul","value":533},{"label":"Ago","value":790},{"label":"Set","value":640},{"label":"Out","value":802},{"label":"Nov","value":746},{"label":"Dez","value":813}];
const MX = 813;
