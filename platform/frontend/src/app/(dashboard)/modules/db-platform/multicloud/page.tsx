...
const ACCENT = "#ec4899";
const MODULE = "Database Platform";
const PAGE = "Multi-Cloud";
const KPIS = [{"l":"Formulários Ativos","v":"8.895","t":"+12.3%","d":"up"},{"l":"Submissões/Dia","v":"4936","t":"+10.8%","d":"up"},{"l":"Documentos Gerados","v":"1.786","t":"+2.7%","d":"up"},{"l":"Templates","v":"2.291","t":"+7.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.655","2026-02-20","6.040","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.473","2026-02-10","2.904","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.747","2026-02-14","4.583","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.195","2026-02-16","1.505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.503","2026-02-01","2.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":417},{"label":"Mar","value":586},{"label":"Abr","value":533},{"label":"Mai","value":531},{"label":"Jun","value":352},{"label":"Jul","value":363},{"label":"Ago","value":501},{"label":"Set","value":406},{"label":"Out","value":682},{"label":"Nov","value":440},{"label":"Dez","value":583}];
const MX = 682;
