...
const PAGE = "Entitlement Check";
const KPIS = [{"l":"ARR (€M)","v":"€15.9M","t":"-4.6%","d":"down"},{"l":"MRR (€)","v":"€23219","t":"+0.2%","d":"up"},{"l":"Churn (%)","v":"89.1%","t":"-3.8%","d":"down"},{"l":"ARPU (€)","v":"€79566","t":"+11.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 18173.09","8.337","€ 47121.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27691.36","599","€ 13794.65","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 12388.19","2.592","€ 41554.26","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 1570.45","8.067","€ 14412.93","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 1086.95","4.722","€ 29081.00","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":831},{"label":"Mar","value":878},{"label":"Abr","value":674},{"label":"Mai","value":726},{"label":"Jun","value":831},{"label":"Jul","value":943},{"label":"Ago","value":966},{"label":"Set","value":901},{"label":"Out","value":746},{"label":"Nov","value":1004},{"label":"Dez","value":907}];
const MX = 1004;
