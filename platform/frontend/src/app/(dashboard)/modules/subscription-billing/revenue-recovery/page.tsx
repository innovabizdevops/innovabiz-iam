...
const PAGE = "Revenue Recovery AI";
const KPIS = [{"l":"ARR (€M)","v":"€9.9M","t":"-1.8%","d":"down"},{"l":"MRR (€)","v":"€78274","t":"-2.0%","d":"down"},{"l":"Churn (%)","v":"78.2%","t":"-0.4%","d":"down"},{"l":"ARPU (€)","v":"€28990","t":"+13.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 45228.75","755","€ 43631.03","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 24486.09","7.446","€ 10664.47","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 24867.45","813","€ 37148.38","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 45532.35","563","€ 33868.48","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 48500.43","8.303","€ 20757.95","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":544},{"label":"Mar","value":674},{"label":"Abr","value":609},{"label":"Mai","value":541},{"label":"Jun","value":673},{"label":"Jul","value":574},{"label":"Ago","value":761},{"label":"Set","value":503},{"label":"Out","value":510},{"label":"Nov","value":769},{"label":"Dez","value":647}];
const MX = 769;
