...
const ACCENT = "#6366f1";
const MODULE = "Subscription Billing";
const PAGE = "Revenue Recognition";
const KPIS = [{"l":"ARR (€M)","v":"€41.8M","t":"+1.0%","d":"up"},{"l":"MRR (€)","v":"€74521","t":"-2.8%","d":"down"},{"l":"Churn (%)","v":"92.0%","t":"-4.5%","d":"down"},{"l":"ARPU (€)","v":"€43964","t":"+13.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 41559.00","1.227","€ 47820.06","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13558.16","6.818","€ 21876.31","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30040.15","868","€ 44152.68","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 11952.29","7.431","€ 35601.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 32665.97","8.718","€ 25877.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":759},{"label":"Fev","value":866},{"label":"Mar","value":713},{"label":"Abr","value":989},{"label":"Mai","value":1010},{"label":"Jun","value":760},{"label":"Jul","value":643},{"label":"Ago","value":898},{"label":"Set","value":730},{"label":"Out","value":812},{"label":"Nov","value":942},{"label":"Dez","value":638}];
const MX = 1010;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>ASC 606</span></h1>
                </div>
