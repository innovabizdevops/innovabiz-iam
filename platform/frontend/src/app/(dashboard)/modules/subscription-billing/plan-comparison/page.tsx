...
const PAGE = "Plan Comparison";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.575","t":"+17.3%","d":"up"},{"l":"NC Abertas","v":"4.775","t":"+3.8%","d":"up"},{"l":"Conformidade (%)","v":"69.1%","t":"-3.4%","d":"down"},{"l":"CAPAs Pendentes","v":"7.833","t":"+2.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.349","99.5%","1.654","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.054","99.6%","8.627","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.281","97.0%","8.482","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.794","85.7%","6.087","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.874","77.9%","8.082","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":282},{"label":"Mar","value":386},{"label":"Abr","value":655},{"label":"Mai","value":631},{"label":"Jun","value":408},{"label":"Jul","value":655},{"label":"Ago","value":476},{"label":"Set","value":444},{"label":"Out","value":518},{"label":"Nov","value":459},{"label":"Dez","value":312}];
const MX = 655;
