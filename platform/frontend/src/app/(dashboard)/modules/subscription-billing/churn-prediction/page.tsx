...
const PAGE = "Churn Prediction";
const KPIS = [{"l":"ARR (€M)","v":"€31.2M","t":"+3.6%","d":"up"},{"l":"MRR (€)","v":"€16252","t":"+9.2%","d":"up"},{"l":"Churn (%)","v":"90.3%","t":"+9.6%","d":"up"},{"l":"ARPU (€)","v":"€17145","t":"-5.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 26751.51","7.648","€ 11682.38","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37850.42","6.882","€ 21503.86","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38066.36","8.356","€ 1467.42","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 32714.57","2.290","€ 42287.03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 33263.42","2.301","€ 35176.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":592},{"label":"Fev","value":910},{"label":"Mar","value":888},{"label":"Abr","value":885},{"label":"Mai","value":641},{"label":"Jun","value":715},{"label":"Jul","value":918},{"label":"Ago","value":933},{"label":"Set","value":644},{"label":"Out","value":744},{"label":"Nov","value":728},{"label":"Dez","value":587}];
const MX = 933;
