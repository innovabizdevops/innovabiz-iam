...
const PAGE = "Trial Management";
const KPIS = [{"l":"ARR (€M)","v":"€18.0M","t":"+4.8%","d":"up"},{"l":"MRR (€)","v":"€46444","t":"+2.0%","d":"up"},{"l":"Churn (%)","v":"92.3%","t":"+12.7%","d":"up"},{"l":"ARPU (€)","v":"€85527","t":"+5.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 835.59","4.895","€ 31294.84","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 13463.55","3.847","€ 22898.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 13120.09","2.133","€ 48501.17","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3709.03","6.909","€ 33646.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 22610.03","2.907","€ 27914.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":684},{"label":"Mar","value":818},{"label":"Abr","value":697},{"label":"Mai","value":754},{"label":"Jun","value":912},{"label":"Jul","value":923},{"label":"Ago","value":710},{"label":"Set","value":755},{"label":"Out","value":619},{"label":"Nov","value":900},{"label":"Dez","value":755}];
const MX = 923;
