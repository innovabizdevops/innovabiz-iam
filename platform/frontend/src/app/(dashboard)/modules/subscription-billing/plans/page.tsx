...
const PAGE = "Plans";
const KPIS = [{"l":"ARR (€M)","v":"€50.5M","t":"+17.5%","d":"up"},{"l":"MRR (€)","v":"€32488","t":"+10.2%","d":"up"},{"l":"Churn (%)","v":"93.2%","t":"+1.1%","d":"up"},{"l":"ARPU (€)","v":"€22904","t":"+10.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 23907.80","4.468","€ 43359.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 18115.35","3.728","€ 31508.58","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 37206.79","126","€ 24278.14","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 6277.23","2.468","€ 42376.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35899.50","7.512","€ 13901.34","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":562},{"label":"Mar","value":410},{"label":"Abr","value":407},{"label":"Mai","value":368},{"label":"Jun","value":503},{"label":"Jul","value":436},{"label":"Ago","value":466},{"label":"Set","value":469},{"label":"Out","value":628},{"label":"Nov","value":589},{"label":"Dez","value":509}];
const MX = 628;
