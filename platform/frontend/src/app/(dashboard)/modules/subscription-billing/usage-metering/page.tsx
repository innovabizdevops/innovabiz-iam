...
const KPIS = [{"l":"ARR (€M)","v":"€1.7M","t":"+7.9%","d":"up"},{"l":"MRR (€)","v":"€57163","t":"+4.7%","d":"up"},{"l":"Churn (%)","v":"89.7%","t":"+2.6%","d":"up"},{"l":"ARPU (€)","v":"€46813","t":"+14.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 784.03","4.720","€ 17767.89","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 680.57","4.941","€ 45237.09","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 40866.55","3.385","€ 3212.77","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15119.47","5.748","€ 20984.00","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 31116.17","7.564","€ 17077.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":581},{"label":"Mar","value":605},{"label":"Abr","value":473},{"label":"Mai","value":711},{"label":"Jun","value":852},{"label":"Jul","value":718},{"label":"Ago","value":600},{"label":"Set","value":527},{"label":"Out","value":794},{"label":"Nov","value":771},{"label":"Dez","value":657}];
const MX = 852;
