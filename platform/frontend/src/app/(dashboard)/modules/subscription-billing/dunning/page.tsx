...
const PAGE = "Dunning AI";
const KPIS = [{"l":"ARR (€M)","v":"€44.8M","t":"+15.5%","d":"up"},{"l":"MRR (€)","v":"€99081","t":"-3.2%","d":"down"},{"l":"Churn (%)","v":"76.6%","t":"+3.6%","d":"up"},{"l":"ARPU (€)","v":"€57706","t":"-0.5%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31348.29","7.012","€ 36185.83","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 8180.46","3.424","€ 20558.63","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45745.25","4.324","€ 37458.18","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 19882.23","4.926","€ 12428.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 26572.29","6.539","€ 25238.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":279},{"label":"Mar","value":513},{"label":"Abr","value":601},{"label":"Mai","value":402},{"label":"Jun","value":364},{"label":"Jul","value":263},{"label":"Ago","value":248},{"label":"Set","value":466},{"label":"Out","value":558},{"label":"Nov","value":554},{"label":"Dez","value":507}];
const MX = 601;
