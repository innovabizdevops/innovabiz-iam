...
const KPIS = [{"l":"ARR (€M)","v":"€30.4M","t":"+14.7%","d":"up"},{"l":"MRR (€)","v":"€63568","t":"+2.7%","d":"up"},{"l":"Churn (%)","v":"73.1%","t":"-5.9%","d":"down"},{"l":"ARPU (€)","v":"€11361","t":"+14.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 39839.70","8.503","€ 20133.47","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 47785.78","4.151","€ 44385.26","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 1745.19","4.937","€ 6401.36","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 33311.66","3.478","€ 16142.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24651.17","2.154","€ 13098.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":587},{"label":"Mar","value":631},{"label":"Abr","value":407},{"label":"Mai","value":269},{"label":"Jun","value":625},{"label":"Jul","value":462},{"label":"Ago","value":357},{"label":"Set","value":561},{"label":"Out","value":492},{"label":"Nov","value":399},{"label":"Dez","value":240}];
const MX = 631;
