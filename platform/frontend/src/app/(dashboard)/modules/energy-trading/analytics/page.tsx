...
const KPIS = [{"l":"Dashboards Ativos","v":"1.095","t":"+3.8%","d":"up"},{"l":"Queries/Dia","v":"710","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"7.564","t":"+12.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.957","t":"+5.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1274","2026-01-16","323","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4969","2026-02-10","7.344","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2501","2026-02-02","1.712","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1568","2026-02-28","4.107","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2132","2026-01-10","1.773","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":294},{"label":"Mar","value":345},{"label":"Abr","value":345},{"label":"Mai","value":584},{"label":"Jun","value":228},{"label":"Jul","value":329},{"label":"Ago","value":297},{"label":"Set","value":551},{"label":"Out","value":397},{"label":"Nov","value":426},{"label":"Dez","value":605}];
const MX = 605;
