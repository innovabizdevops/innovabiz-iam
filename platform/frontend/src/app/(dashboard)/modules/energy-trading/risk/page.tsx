...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.789","t":"+2.1%","d":"up"},{"l":"Mitigações Ativas","v":"1.737","t":"-4.4%","d":"down"},{"l":"Score Risco Geral","v":"87","t":"+2.5%","d":"up"},{"l":"Incidentes YTD","v":"5.765","t":"+14.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.927","3.794","7.097","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.583","4.557","5.848","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.345","5.039","3.717","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.416","4.247","3.208","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.129","3.714","4.293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":470},{"label":"Mar","value":756},{"label":"Abr","value":688},{"label":"Mai","value":731},{"label":"Jun","value":709},{"label":"Jul","value":771},{"label":"Ago","value":747},{"label":"Set","value":587},{"label":"Out","value":758},{"label":"Nov","value":575},{"label":"Dez","value":805}];
const MX = 805;
