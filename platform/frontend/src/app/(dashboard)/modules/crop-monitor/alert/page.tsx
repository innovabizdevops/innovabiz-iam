...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"4.311","t":"+12.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"88.7%","t":"+7.3%","d":"up"},{"l":"Taxa Abertura (%)","v":"67.8%","t":"-2.8%","d":"down"},{"l":"Escalações","v":"2.424","t":"+5.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.987","76.6%","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.810","98.2%","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.885","71.3%","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","8.382","94.7%","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.022","77.8%","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":675},{"label":"Mar","value":714},{"label":"Abr","value":671},{"label":"Mai","value":797},{"label":"Jun","value":661},{"label":"Jul","value":450},{"label":"Ago","value":604},{"label":"Set","value":587},{"label":"Out","value":727},{"label":"Nov","value":469},{"label":"Dez","value":781}];
const MX = 797;
