...
const PAGE = "Growth";
const KPIS = [{"l":"Total Crop Monitor","v":"6.502","t":"+4.7%","d":"up"},{"l":"Growth Ativos","v":"6.154","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"-5.6%","d":"down"},{"l":"Score Performance","v":"92","t":"-2.6%","d":"down"}];
const COLS = ["ID","Growth","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Monitor #001","Crop Monitor #002","7.099","6.045","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Monitor #002","Crop Monitor #003","6.529","4.913","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Monitor #003","Crop Monitor #004","4.337","7.589","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Monitor #004","Crop Monitor #005","2.489","1.194","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Monitor #005","Crop Monitor #001","4.067","8.726","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":792},{"label":"Mar","value":712},{"label":"Abr","value":812},{"label":"Mai","value":611},{"label":"Jun","value":944},{"label":"Jul","value":906},{"label":"Ago","value":803},{"label":"Set","value":968},{"label":"Out","value":624},{"label":"Nov","value":714},{"label":"Dez","value":687}];
const MX = 968;
