...
const ACCENT = "#6366f1";
const MODULE = "Crop Monitoring";
const PAGE = "Disease";
const KPIS = [{"l":"Total Crop Monitor","v":"5.365","t":"+0.5%","d":"up"},{"l":"Disease Ativos","v":"1.570","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+8.7%","d":"up"}];
const COLS = ["ID","Disease","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Monitor #001","Crop Monitor #002","1.124","5.958","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Monitor #002","Crop Monitor #003","8.785","3.574","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Monitor #003","Crop Monitor #004","6.777","7.865","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Monitor #004","Crop Monitor #005","3.846","7.524","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Monitor #005","Crop Monitor #001","3.871","7.415","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":900},{"label":"Fev","value":762},{"label":"Mar","value":729},{"label":"Abr","value":647},{"label":"Mai","value":961},{"label":"Jun","value":916},{"label":"Jul","value":786},{"label":"Ago","value":802},{"label":"Set","value":781},{"label":"Out","value":733},{"label":"Nov","value":945},{"label":"Dez","value":947}];
const MX = 961;
