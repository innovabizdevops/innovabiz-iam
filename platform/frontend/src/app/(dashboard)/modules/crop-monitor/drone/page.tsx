...
const PAGE = "Drone";
const KPIS = [{"l":"Total Crop Monitor","v":"8.110","t":"-2.0%","d":"down"},{"l":"Drone Ativos","v":"5.468","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.5%","d":"up"}];
const COLS = ["ID","Drone","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Monitor #001","Crop Monitor #002","3.432","259","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Monitor #002","Crop Monitor #003","3.125","5.937","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Monitor #003","Crop Monitor #004","5.223","6.333","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Monitor #004","Crop Monitor #005","7.398","2.670","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Monitor #005","Crop Monitor #001","3.559","8.099","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":905},{"label":"Mar","value":715},{"label":"Abr","value":959},{"label":"Mai","value":923},{"label":"Jun","value":954},{"label":"Jul","value":876},{"label":"Ago","value":742},{"label":"Set","value":902},{"label":"Out","value":729},{"label":"Nov","value":832},{"label":"Dez","value":747}];
const MX = 959;
