...
const ACCENT = "#7f1d1d";
const MODULE = "Threat Hunting Platform";
const PAGE = "Hunt";
const KPIS = [{"l":"Total Threat Hunting","v":"5.576","t":"+10.1%","d":"up"},{"l":"Hunt Ativos","v":"4.012","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"87","t":"+2.0%","d":"up"}];
const COLS = ["ID","Hunt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Threat Hunting #001","Threat Hunting #002","1.471","7.100","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Threat Hunting #002","Threat Hunting #003","7.813","1.509","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Threat Hunting #003","Threat Hunting #004","3.524","7.374","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Threat Hunting #004","Threat Hunting #005","8.242","629","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Threat Hunting #005","Threat Hunting #001","626","7.825","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":700},{"label":"Mar","value":657},{"label":"Abr","value":498},{"label":"Mai","value":345},{"label":"Jun","value":600},{"label":"Jul","value":487},{"label":"Ago","value":341},{"label":"Set","value":328},{"label":"Out","value":667},{"label":"Nov","value":712},{"label":"Dez","value":439}];
const MX = 712;
