...
const KPIS = [{"l":"Total Threat Hunting","v":"2.471","t":"-5.0%","d":"down"},{"l":"Investigate Ativos","v":"8.015","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.0%","d":"down"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Threat Hunting #001","Threat Hunting #002","3.692","6.681","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Threat Hunting #002","Threat Hunting #003","5.632","2.781","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Threat Hunting #003","Threat Hunting #004","3.218","8.655","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Threat Hunting #004","Threat Hunting #005","8.239","929","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Threat Hunting #005","Threat Hunting #001","3.512","3.861","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":566},{"label":"Mar","value":773},{"label":"Abr","value":716},{"label":"Mai","value":898},{"label":"Jun","value":756},{"label":"Jul","value":620},{"label":"Ago","value":904},{"label":"Set","value":553},{"label":"Out","value":845},{"label":"Nov","value":549},{"label":"Dez","value":895}];
const MX = 904;
