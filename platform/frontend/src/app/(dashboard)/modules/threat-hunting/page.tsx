...
/* ═══ Threat Hunting Platform — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "573", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4995", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€198K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1118017373", cells: ["THR-2373", "Threat Hunting Platform Item 1", "26/6/2026", "€17 473"], status: "active" as const },
    { id: "1118020944", cells: ["THR-5944", "Threat Hunting Platform Item 2", "13/1/2026", "€21 044"], status: "pending" as const },
    { id: "1118024515", cells: ["THR-9515", "Threat Hunting Platform Item 3", "28/8/2026", "€24 615"], status: "completed" as const },
    { id: "1118028086", cells: ["THR-4086", "Threat Hunting Platform Item 4", "15/3/2026", "€28 186"], status: "warning" as const },
    { id: "1118031657", cells: ["THR-7657", "Threat Hunting Platform Item 5", "2/10/2026", "€31 757"], status: "active" as const },
];
...
export default function ThreatHuntingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Threat Hunting Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Threat Hunting Platform</p>
                    </div>
                </div>
