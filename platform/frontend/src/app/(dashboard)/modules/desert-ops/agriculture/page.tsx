...
const ACCENT = "#6366f1";
const MODULE = "Desert Operations";
const PAGE = "Desert Agri";
const KPIS = [{"l":"Total Desert Ops","v":"711","t":"+10.2%","d":"up"},{"l":"Desert Agri Ativos","v":"5.651","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"86.0%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"74","t":"-1.7%","d":"down"}];
const COLS = ["ID","Desert Agri","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Desert Ops #001","Desert Ops #002","4.709","7.049","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Desert Ops #002","Desert Ops #003","5.776","6.088","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Desert Ops #003","Desert Ops #004","7.032","6.312","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Desert Ops #004","Desert Ops #005","1.181","7.194","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Desert Ops #005","Desert Ops #001","6.375","4.479","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":669},{"label":"Mar","value":836},{"label":"Abr","value":565},{"label":"Mai","value":538},{"label":"Jun","value":884},{"label":"Jul","value":850},{"label":"Ago","value":722},{"label":"Set","value":517},{"label":"Out","value":726},{"label":"Nov","value":782},{"label":"Dez","value":756}];
const MX = 884;
