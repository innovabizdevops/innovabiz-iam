...
/* ═══ NEURA Neural Network Studio — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "7395", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3595", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€282K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "239676395", cells: ["NEU-7395", "NEURA Neural Network Studio Item 1", "8/12/2026", "€26 495"], status: "active" as const },
    { id: "239679966", cells: ["NEU-1966", "NEURA Neural Network Studio Item 2", "23/7/2026", "€30 066"], status: "pending" as const },
    { id: "239683537", cells: ["NEU-5537", "NEURA Neural Network Studio Item 3", "10/2/2026", "€33 637"], status: "completed" as const },
    { id: "239687108", cells: ["NEU-9108", "NEURA Neural Network Studio Item 4", "25/9/2026", "€37 208"], status: "warning" as const },
    { id: "239690679", cells: ["NEU-3679", "NEURA Neural Network Studio Item 5", "12/4/2026", "€40 779"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 95 }, { label: "Fev", value: 24 }, { label: "Mar", value: 33 }, { label: "Abr", value: 42 }, { label: "Mai", value: 51 }, { label: "Jun", value: 60 }];
...
export default function NeuraNeuralNetworkStudioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">NEURA Neural Network Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • NEURA Neural Network Studio</p>
                    </div>
                </div>
