...
/* ═══ Quote-to-Cash (CPQ) — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "2467", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "248", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€116K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1398248667", cells: ["QUO-9667", "Quote-to-Cash (CPQ) Item 1", "12/4/2026", "€48 767"], status: "active" as const },
    { id: "1398252238", cells: ["QUO-4238", "Quote-to-Cash (CPQ) Item 2", "27/11/2026", "€2338"], status: "pending" as const },
    { id: "1398255809", cells: ["QUO-7809", "Quote-to-Cash (CPQ) Item 3", "14/6/2026", "€5909"], status: "completed" as const },
    { id: "1398259380", cells: ["QUO-2380", "Quote-to-Cash (CPQ) Item 4", "1/1/2026", "€9480"], status: "warning" as const },
    { id: "1398262951", cells: ["QUO-5951", "Quote-to-Cash (CPQ) Item 5", "16/8/2026", "€13 051"], status: "active" as const },
];
...
export default function QuotetocashCpqPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quote-to-Cash (CPQ)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Quote-to-Cash (CPQ)</p>
                    </div>
                </div>
