...
const KPIS = [{"l":"Configurações","v":"2.580","t":"-5.6%","d":"down"},{"l":"Últimas Alterações","v":"3.560","t":"-5.5%","d":"down"},{"l":"Ambientes","v":"5.819","t":"+5.8%","d":"up"},{"l":"Versão Config","v":"7.096","t":"+4.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 45207.15","4.703","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 11189.68","3.821","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 36962.36","1.884","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 44520.62","1.062","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 36766.19","5.883","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":593},{"label":"Mar","value":480},{"label":"Abr","value":422},{"label":"Mai","value":441},{"label":"Jun","value":378},{"label":"Jul","value":306},{"label":"Ago","value":342},{"label":"Set","value":367},{"label":"Out","value":695},{"label":"Nov","value":482},{"label":"Dez","value":674}];
const MX = 695;
