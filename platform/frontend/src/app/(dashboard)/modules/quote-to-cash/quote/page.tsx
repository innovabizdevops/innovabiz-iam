...
const PAGE = "Quote";
const KPIS = [{"l":"Total Quote To Cash","v":"6.503","t":"-2.6%","d":"down"},{"l":"Quote Ativos","v":"2.111","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"79.6%","t":"+10.1%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.6%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Quote To Cash #001","Quote To Cash #002","5.379","5.864","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Quote To Cash #002","Quote To Cash #003","5.487","7.941","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Quote To Cash #003","Quote To Cash #004","6.861","4.450","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Quote To Cash #004","Quote To Cash #005","8.963","3.032","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Quote To Cash #005","Quote To Cash #001","6.433","6.638","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":405},{"label":"Mar","value":219},{"label":"Abr","value":304},{"label":"Mai","value":469},{"label":"Jun","value":360},{"label":"Jul","value":340},{"label":"Ago","value":533},{"label":"Set","value":342},{"label":"Out","value":585},{"label":"Nov","value":334},{"label":"Dez","value":332}];
const MX = 585;
