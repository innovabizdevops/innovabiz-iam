...
const ACCENT = "#00a1e0";
const MODULE = "Quote-to-Cash (CPQ)";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"6.263","t":"+2.1%","d":"up"},{"l":"Valor Total (€M)","v":"€39.8M","t":"+16.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"7.562","t":"+1.5%","d":"up"},{"l":"Obrigações Pendentes","v":"8.703","t":"+14.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 28394.97","2026-01-02","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 38670.34","2026-03-07","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 36292.73","2026-01-03","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 40756.55","2026-02-21","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 9346.14","2026-02-24","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":458},{"label":"Mar","value":515},{"label":"Abr","value":419},{"label":"Mai","value":549},{"label":"Jun","value":392},{"label":"Jul","value":311},{"label":"Ago","value":624},{"label":"Set","value":555},{"label":"Out","value":623},{"label":"Nov","value":663},{"label":"Dez","value":670}];
const MX = 670;
