...
/* ═══ Farm Accounting Platform — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "5983", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2790", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "997549683", cells: ["FAR-8683", "Farm Accounting Platform Item 1", "12/4/2026", "€49 783"], status: "active" as const },
    { id: "997553254", cells: ["FAR-3254", "Farm Accounting Platform Item 2", "27/11/2026", "€3354"], status: "pending" as const },
    { id: "997556825", cells: ["FAR-6825", "Farm Accounting Platform Item 3", "14/6/2026", "€6925"], status: "completed" as const },
    { id: "997560396", cells: ["FAR-1396", "Farm Accounting Platform Item 4", "1/1/2026", "€10 496"], status: "warning" as const },
    { id: "997563967", cells: ["FAR-4967", "Farm Accounting Platform Item 5", "16/8/2026", "€14 067"], status: "active" as const },
];
...
export default function FarmAccountingPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Farm Accounting Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Farm Accounting Platform</p>
                    </div>
                </div>
