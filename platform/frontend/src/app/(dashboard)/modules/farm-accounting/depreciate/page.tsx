...
const ACCENT = "#166534";
const MODULE = "Farm Accounting Platform";
const PAGE = "Depreciate";
const KPIS = [{"l":"Ativos Registados","v":"3.731","t":"-2.0%","d":"down"},{"l":"Valor Total (€M)","v":"€35.3M","t":"+7.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€9218","t":"+7.1%","d":"up"},{"l":"Ativos em Garantia","v":"8.120","t":"-1.2%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 35504.17","8.969","€ 10351.85","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 6443.55","3.770","€ 11558.02","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 11571.72","2.641","€ 10560.59","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 4686.98","4.407","€ 27285.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 7119.69","2.941","€ 34011.72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":548},{"label":"Mar","value":532},{"label":"Abr","value":498},{"label":"Mai","value":708},{"label":"Jun","value":570},{"label":"Jul","value":357},{"label":"Ago","value":361},{"label":"Set","value":544},{"label":"Out","value":401},{"label":"Nov","value":360},{"label":"Dez","value":386}];
const MX = 708;
...
export default function DepreciatePage() {
    return (
