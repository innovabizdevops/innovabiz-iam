...
const PAGE = "Sample";
const KPIS = [{"l":"Produtos Ativos","v":"4.988","t":"+12.5%","d":"up"},{"l":"SKUs","v":"1.790","t":"-4.2%","d":"down"},{"l":"ECNs Pendentes","v":"5.618","t":"-3.8%","d":"down"},{"l":"Time-to-Market (dias)","v":"4.665","t":"-2.5%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.505","7.124","8.349","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","6.924","4.277","6.047","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","1.202","6.064","7.747","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","663","218","2.443","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","8.186","3.131","3.469","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":659},{"label":"Fev","value":661},{"label":"Mar","value":551},{"label":"Abr","value":744},{"label":"Mai","value":499},{"label":"Jun","value":513},{"label":"Jul","value":776},{"label":"Ago","value":496},{"label":"Set","value":519},{"label":"Out","value":775},{"label":"Nov","value":539},{"label":"Dez","value":526}];
const MX = 776;
