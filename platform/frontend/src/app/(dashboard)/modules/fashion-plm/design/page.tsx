...
const ACCENT = "#be185d";
const MODULE = "Fashion PLM Platform";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.906","t":"+14.5%","d":"up"},{"l":"Submissões/Dia","v":"1498","t":"+13.5%","d":"up"},{"l":"Documentos Gerados","v":"5.833","t":"+10.0%","d":"up"},{"l":"Templates","v":"301","t":"-5.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.437","2026-03-20","4.237","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.238","2026-03-23","3.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.093","2026-03-08","6.272","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.620","2026-02-27","3.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.626","2026-01-03","3.610","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":562},{"label":"Mar","value":632},{"label":"Abr","value":430},{"label":"Mai","value":419},{"label":"Jun","value":412},{"label":"Jul","value":625},{"label":"Ago","value":608},{"label":"Set","value":341},{"label":"Out","value":282},{"label":"Nov","value":335},{"label":"Dez","value":672}];
const MX = 672;
