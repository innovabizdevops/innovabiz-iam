...
const PAGE = "Cost";
const KPIS = [{"l":"Produtos Ativos","v":"1.075","t":"+8.2%","d":"up"},{"l":"SKUs","v":"2.885","t":"-5.9%","d":"down"},{"l":"ECNs Pendentes","v":"4.625","t":"+11.0%","d":"up"},{"l":"Time-to-Market (dias)","v":"7.462","t":"+3.5%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","6.120","8.441","926","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","496","8.405","1.478","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","4.955","5.405","767","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","563","6.006","5.461","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","8.432","6.951","8.832","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":855},{"label":"Mar","value":796},{"label":"Abr","value":888},{"label":"Mai","value":638},{"label":"Jun","value":881},{"label":"Jul","value":722},{"label":"Ago","value":704},{"label":"Set","value":914},{"label":"Out","value":807},{"label":"Nov","value":572},{"label":"Dez","value":587}];
const MX = 914;
