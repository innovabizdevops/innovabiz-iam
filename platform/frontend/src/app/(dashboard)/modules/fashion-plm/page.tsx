...
/* ═══ Fashion PLM Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "4219", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1599", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€11K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1674302019", cells: ["FAS-6019", "Fashion PLM Platform Item 1", "20/4/2026", "€2119"], status: "active" as const },
    { id: "1674305590", cells: ["FAS-9590", "Fashion PLM Platform Item 2", "7/11/2026", "€5690"], status: "pending" as const },
    { id: "1674309161", cells: ["FAS-4161", "Fashion PLM Platform Item 3", "22/6/2026", "€9261"], status: "completed" as const },
    { id: "1674312732", cells: ["FAS-7732", "Fashion PLM Platform Item 4", "9/1/2026", "€12 832"], status: "warning" as const },
    { id: "1674316303", cells: ["FAS-2303", "Fashion PLM Platform Item 5", "24/8/2026", "€16 403"], status: "active" as const },
];
...
export default function FashionPlmPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion PLM Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion PLM Platform</p>
                    </div>
                </div>
