...
const PAGE = "Develop";
const KPIS = [{"l":"Produtos Ativos","v":"7.476","t":"+11.6%","d":"up"},{"l":"SKUs","v":"5.401","t":"+11.9%","d":"up"},{"l":"ECNs Pendentes","v":"1.749","t":"+3.2%","d":"up"},{"l":"Time-to-Market (dias)","v":"539","t":"+0.5%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","304","1.727","2.294","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","2.699","1.111","8.199","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","7.877","6.884","7.319","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","2.511","1.975","1.837","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","6.022","3.804","8.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":805},{"label":"Mar","value":770},{"label":"Abr","value":770},{"label":"Mai","value":956},{"label":"Jun","value":599},{"label":"Jul","value":829},{"label":"Ago","value":659},{"label":"Set","value":946},{"label":"Out","value":695},{"label":"Nov","value":812},{"label":"Dez","value":837}];
const MX = 956;
