...
const PAGE = "Launch";
const KPIS = [{"l":"Produtos Ativos","v":"8.512","t":"+16.0%","d":"up"},{"l":"SKUs","v":"4.440","t":"-5.4%","d":"down"},{"l":"ECNs Pendentes","v":"4.782","t":"-4.8%","d":"down"},{"l":"Time-to-Market (dias)","v":"206","t":"-5.3%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","8.830","6.350","5.172","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","8.810","8.211","3.110","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","5.072","733","5.972","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","7.330","5.229","1.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","6.352","4.073","1.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":761},{"label":"Mar","value":643},{"label":"Abr","value":861},{"label":"Mai","value":625},{"label":"Jun","value":503},{"label":"Jul","value":847},{"label":"Ago","value":654},{"label":"Set","value":546},{"label":"Out","value":504},{"label":"Nov","value":871},{"label":"Dez","value":865}];
const MX = 871;
