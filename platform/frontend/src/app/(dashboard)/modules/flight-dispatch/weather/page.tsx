...
const KPIS = [{"l":"Veículos Operação","v":"7.941","t":"-1.4%","d":"down"},{"l":"Viagens/Dia","v":"1939","t":"+16.8%","d":"up"},{"l":"Pontualidade (%)","v":"88.6%","t":"-4.6%","d":"down"},{"l":"Passageiros/Dia","v":"2423","t":"+4.7%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-20","2026-03-13","6.062","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-02-16","2026-02-28","2.299","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-27","2026-01-12","4.336","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-01","2026-01-06","412","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-02","2026-03-23","2.226","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":625},{"label":"Mar","value":574},{"label":"Abr","value":505},{"label":"Mai","value":715},{"label":"Jun","value":491},{"label":"Jul","value":670},{"label":"Ago","value":518},{"label":"Set","value":401},{"label":"Out","value":554},{"label":"Nov","value":446},{"label":"Dez","value":762}];
const MX = 762;
