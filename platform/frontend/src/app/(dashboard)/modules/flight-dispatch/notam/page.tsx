...
const ACCENT = "#0e7490";
const MODULE = "Flight Dispatch";
const PAGE = "NOTAM Check";
const KPIS = [{"l":"Veículos Operação","v":"5.299","t":"+5.7%","d":"up"},{"l":"Viagens/Dia","v":"329","t":"-4.5%","d":"down"},{"l":"Pontualidade (%)","v":"89.3%","t":"+4.5%","d":"up"},{"l":"Passageiros/Dia","v":"1878","t":"+14.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-07","2026-02-06","1.393","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-23","2026-02-22","664","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-19","2026-03-11","5.775","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-25","2026-03-03","8.090","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-10","2026-01-16","2.754","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":996},{"label":"Mar","value":699},{"label":"Abr","value":694},{"label":"Mai","value":678},{"label":"Jun","value":736},{"label":"Jul","value":663},{"label":"Ago","value":909},{"label":"Set","value":979},{"label":"Out","value":820},{"label":"Nov","value":948},{"label":"Dez","value":751}];
const MX = 996;
