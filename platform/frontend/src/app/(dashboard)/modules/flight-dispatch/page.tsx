...
export default function FlightDispatchPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Flight Dispatch</h1><p className="text-sm text-muted-foreground">Flight Dispatch • iBOS Enterprise</p></div>
