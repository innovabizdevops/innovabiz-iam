...
const KPIS = [{"l":"Veículos Operação","v":"7.288","t":"+2.4%","d":"up"},{"l":"Viagens/Dia","v":"2143","t":"+15.2%","d":"up"},{"l":"Pontualidade (%)","v":"85.5%","t":"+9.2%","d":"up"},{"l":"Passageiros/Dia","v":"2888","t":"+1.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-07","2026-03-05","6.658","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-07","2026-01-09","6.567","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-20","2026-01-23","5.239","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-13","2026-01-05","156","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-02","2026-02-12","1.591","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":637},{"label":"Mar","value":770},{"label":"Abr","value":573},{"label":"Mai","value":576},{"label":"Jun","value":517},{"label":"Jul","value":611},{"label":"Ago","value":605},{"label":"Set","value":482},{"label":"Out","value":800},{"label":"Nov","value":465},{"label":"Dez","value":830}];
const MX = 830;
