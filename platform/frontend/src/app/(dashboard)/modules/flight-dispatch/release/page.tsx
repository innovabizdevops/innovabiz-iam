...
const PAGE = "Release Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.431","t":"+8.6%","d":"up"},{"l":"Sessões/Dia","v":"795","t":"+11.6%","d":"up"},{"l":"MFA Adoção (%)","v":"67.0%","t":"+9.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.216","t":"+17.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.931","7.019","8.281","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.121","8.564","2.367","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.369","6.478","1.607","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.559","8.773","2.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.325","6.196","7.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":641},{"label":"Mar","value":832},{"label":"Abr","value":672},{"label":"Mai","value":915},{"label":"Jun","value":606},{"label":"Jul","value":927},{"label":"Ago","value":757},{"label":"Set","value":863},{"label":"Out","value":805},{"label":"Nov","value":849},{"label":"Dez","value":740}];
const MX = 927;
