...
const KPIS = [{"l":"Veículos Operação","v":"4.463","t":"+5.3%","d":"up"},{"l":"Viagens/Dia","v":"208","t":"+4.4%","d":"up"},{"l":"Pontualidade (%)","v":"69.4%","t":"+5.3%","d":"up"},{"l":"Passageiros/Dia","v":"347","t":"-2.8%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-23","2026-01-22","3.671","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-14","2026-03-28","7.239","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-03-13","2026-01-04","8.868","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-02-08","2026-03-21","2.423","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-02-25","2026-03-16","893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":738},{"label":"Mar","value":662},{"label":"Abr","value":615},{"label":"Mai","value":548},{"label":"Jun","value":584},{"label":"Jul","value":699},{"label":"Ago","value":700},{"label":"Set","value":824},{"label":"Out","value":601},{"label":"Nov","value":789},{"label":"Dez","value":711}];
const MX = 824;
