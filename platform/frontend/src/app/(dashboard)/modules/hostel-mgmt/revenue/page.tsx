...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€24.0M","t":"+9.2%","d":"up"},{"l":"MRR (€)","v":"€34520","t":"+14.5%","d":"up"},{"l":"Churn (%)","v":"90.8%","t":"+16.3%","d":"up"},{"l":"ARPU (€)","v":"€81379","t":"+12.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 21926.59","3.304","€ 43264.36","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11640.21","1.775","€ 933.36","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 28484.59","6.507","€ 21515.46","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 35259.01","534","€ 32924.71","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 5708.80","6.411","€ 31371.94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":983},{"label":"Mar","value":720},{"label":"Abr","value":901},{"label":"Mai","value":978},{"label":"Jun","value":921},{"label":"Jul","value":698},{"label":"Ago","value":794},{"label":"Set","value":806},{"label":"Out","value":820},{"label":"Nov","value":652},{"label":"Dez","value":757}];
const MX = 983;
