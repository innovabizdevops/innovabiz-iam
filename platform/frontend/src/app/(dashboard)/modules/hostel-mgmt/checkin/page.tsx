...
const PAGE = "Check-In";
const KPIS = [{"l":"Total Hostel Mgmt","v":"1.178","t":"+1.8%","d":"up"},{"l":"Check In Ativos","v":"2.233","t":"+9.8%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.6%","d":"up"}];
const COLS = ["ID","Check In","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hostel Mgmt #001","2026-02-23","8.249","5.437","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Hostel Mgmt #002","2026-02-04","1.673","2.998","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Hostel Mgmt #003","2026-03-28","907","5.198","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Hostel Mgmt #004","2026-01-16","1.002","334","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hostel Mgmt #005","2026-03-10","6.982","5.932","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":923},{"label":"Mar","value":845},{"label":"Abr","value":764},{"label":"Mai","value":1012},{"label":"Jun","value":1023},{"label":"Jul","value":738},{"label":"Ago","value":981},{"label":"Set","value":627},{"label":"Out","value":790},{"label":"Nov","value":761},{"label":"Dez","value":885}];
const MX = 1023;
