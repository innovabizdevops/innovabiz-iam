...
const ACCENT = "#6366f1";
const MODULE = "Hostel Management";
const PAGE = "Activity";
const KPIS = [{"l":"Total Hostel Mgmt","v":"1.362","t":"-5.2%","d":"down"},{"l":"Activity Ativos","v":"327","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"86.4%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.2%","d":"down"}];
const COLS = ["ID","Activity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hostel Mgmt #001","Hostel Mgmt #002","2.344","1.905","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Hostel Mgmt #002","Hostel Mgmt #003","6.176","2.410","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Hostel Mgmt #003","Hostel Mgmt #004","4.827","8.011","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Hostel Mgmt #004","Hostel Mgmt #005","1.949","7.129","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hostel Mgmt #005","Hostel Mgmt #001","2.022","2.438","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":470},{"label":"Mar","value":436},{"label":"Abr","value":237},{"label":"Mai","value":622},{"label":"Jun","value":487},{"label":"Jul","value":337},{"label":"Ago","value":482},{"label":"Set","value":451},{"label":"Out","value":232},{"label":"Nov","value":561},{"label":"Dez","value":455}];
const MX = 622;
