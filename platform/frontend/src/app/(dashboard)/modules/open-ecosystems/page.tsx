...
export default function OpenEcosystemsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Open Ecosystems</h1><p className="text-sm text-muted-foreground">Open Ecosystems • iBOS Enterprise</p></div>
