...
const PAGE = "Collect";
const KPIS = [{"l":"Formulários Ativos","v":"5.110","t":"+11.3%","d":"up"},{"l":"Submissões/Dia","v":"1399","t":"+9.7%","d":"up"},{"l":"Documentos Gerados","v":"8.305","t":"+2.3%","d":"up"},{"l":"Templates","v":"3.092","t":"+12.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.643","2026-02-13","2.116","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.636","2026-03-25","5.641","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.438","2026-02-18","8.134","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.195","2026-03-27","398","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.052","2026-02-20","3.803","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":835},{"label":"Mar","value":751},{"label":"Abr","value":634},{"label":"Mai","value":882},{"label":"Jun","value":620},{"label":"Jul","value":595},{"label":"Ago","value":733},{"label":"Set","value":842},{"label":"Out","value":789},{"label":"Nov","value":710},{"label":"Dez","value":629}];
const MX = 882;
