...
const PAGE = "Act";
const KPIS = [{"l":"Formulários Ativos","v":"2.895","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"2225","t":"+0.6%","d":"up"},{"l":"Documentos Gerados","v":"6.476","t":"+6.9%","d":"up"},{"l":"Templates","v":"1.132","t":"-0.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.365","2026-01-20","8.818","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.033","2026-03-23","8.085","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.203","2026-01-20","764","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.350","2026-03-05","1.800","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.168","2026-02-20","5.552","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":580},{"label":"Mar","value":634},{"label":"Abr","value":577},{"label":"Mai","value":543},{"label":"Jun","value":760},{"label":"Jul","value":797},{"label":"Ago","value":628},{"label":"Set","value":598},{"label":"Out","value":880},{"label":"Nov","value":706},{"label":"Dez","value":606}];
const MX = 880;
