...
const ACCENT = "#059669";
const MODULE = "Feedback Platform Deep";
const PAGE = "Classify";
const KPIS = [{"l":"Formulários Ativos","v":"2.840","t":"+4.0%","d":"up"},{"l":"Submissões/Dia","v":"3976","t":"+6.9%","d":"up"},{"l":"Documentos Gerados","v":"3.340","t":"+0.7%","d":"up"},{"l":"Templates","v":"5.970","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.008","2026-02-20","2.911","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.506","2026-02-16","468","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.060","2026-03-23","1.875","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.905","2026-02-28","1.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.505","2026-02-24","785","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":855},{"label":"Mar","value":567},{"label":"Abr","value":793},{"label":"Mai","value":778},{"label":"Jun","value":552},{"label":"Jul","value":509},{"label":"Ago","value":545},{"label":"Set","value":858},{"label":"Out","value":631},{"label":"Nov","value":486},{"label":"Dez","value":742}];
const MX = 858;
