...
/* ═══ Feedback Platform Deep — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "2442", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2539", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€57K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "69638942", cells: ["FEE-6942", "Feedback Platform Deep Item 1", "3/3/2026", "€39 042"], status: "active" as const },
    { id: "69642513", cells: ["FEE-1513", "Feedback Platform Deep Item 2", "18/10/2026", "€42 613"], status: "pending" as const },
    { id: "69646084", cells: ["FEE-5084", "Feedback Platform Deep Item 3", "5/5/2026", "€46 184"], status: "completed" as const },
    { id: "69649655", cells: ["FEE-8655", "Feedback Platform Deep Item 4", "20/12/2026", "€49 755"], status: "warning" as const },
    { id: "69653226", cells: ["FEE-3226", "Feedback Platform Deep Item 5", "7/7/2026", "€3326"], status: "active" as const },
];
...
export default function FeedbackPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Feedback Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Feedback Platform Deep</p>
                    </div>
                </div>
