...
const PAGE = "Prioritize";
const KPIS = [{"l":"Formulários Ativos","v":"2.689","t":"-2.5%","d":"down"},{"l":"Submissões/Dia","v":"4464","t":"+16.1%","d":"up"},{"l":"Documentos Gerados","v":"4.228","t":"+14.3%","d":"up"},{"l":"Templates","v":"5.650","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.543","2026-01-26","721","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.317","2026-01-01","6.690","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.623","2026-03-13","1.976","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.606","2026-02-24","7.176","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","963","2026-03-13","8.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":449},{"label":"Mar","value":565},{"label":"Abr","value":491},{"label":"Mai","value":572},{"label":"Jun","value":736},{"label":"Jul","value":618},{"label":"Ago","value":433},{"label":"Set","value":675},{"label":"Out","value":391},{"label":"Nov","value":370},{"label":"Dez","value":375}];
const MX = 736;
