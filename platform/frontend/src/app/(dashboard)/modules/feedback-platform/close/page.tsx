...
const PAGE = "Close";
const KPIS = [{"l":"Formulários Ativos","v":"6.880","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"3840","t":"+13.2%","d":"up"},{"l":"Documentos Gerados","v":"6.284","t":"-4.4%","d":"down"},{"l":"Templates","v":"7.837","t":"+8.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.731","2026-03-10","5.372","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.108","2026-02-19","8.216","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","231","2026-03-17","7.273","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.739","2026-02-15","334","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.477","2026-02-13","6.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":1091},{"label":"Mar","value":1026},{"label":"Abr","value":952},{"label":"Mai","value":781},{"label":"Jun","value":904},{"label":"Jul","value":786},{"label":"Ago","value":801},{"label":"Set","value":762},{"label":"Out","value":974},{"label":"Nov","value":1031},{"label":"Dez","value":832}];
const MX = 1091;
