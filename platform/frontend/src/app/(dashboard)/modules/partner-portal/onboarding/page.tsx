...
const ACCENT = "#78350f";
const MODULE = "Partner Portal";
const PAGE = "Onboarding";
const KPIS = [{"l":"eNPS","v":"69","t":"+5.5%","d":"up"},{"l":"Engagement (%)","v":"75.7%","t":"+9.6%","d":"up"},{"l":"Turnover (%)","v":"71.7%","t":"+2.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.061","t":"+1.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.174","2026-01-27","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.414","2026-02-25","69","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","274","2026-03-05","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.110","2026-02-19","56","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.431","2026-01-15","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":840},{"label":"Mar","value":870},{"label":"Abr","value":752},{"label":"Mai","value":788},{"label":"Jun","value":641},{"label":"Jul","value":920},{"label":"Ago","value":851},{"label":"Set","value":865},{"label":"Out","value":783},{"label":"Nov","value":770},{"label":"Dez","value":909}];
const MX = 920;
