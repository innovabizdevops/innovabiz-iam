...
const PAGE = "Policy";
const KPIS = [{"l":"Dashboards Ativos","v":"187","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"3161","t":"+7.8%","d":"up"},{"l":"Dados Processados (GB)","v":"7.331","t":"+17.7%","d":"up"},{"l":"Utilizadores Analytics","v":"432","t":"+16.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2242","2026-02-27","4.398","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","284","2026-02-05","440","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2410","2026-02-18","8.783","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","509","2026-03-10","505","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2378","2026-03-06","6.914","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":517},{"label":"Mar","value":533},{"label":"Abr","value":510},{"label":"Mai","value":588},{"label":"Jun","value":698},{"label":"Jul","value":590},{"label":"Ago","value":504},{"label":"Set","value":688},{"label":"Out","value":872},{"label":"Nov","value":849},{"label":"Dez","value":630}];
const MX = 872;
