...
/* ═══ Data Retention Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "1878", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4345", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€106K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "250600478", cells: ["DAT-5478", "Data Retention Platform Item 1", "3/3/2026", "€578"], status: "active" as const },
    { id: "250604049", cells: ["DAT-9049", "Data Retention Platform Item 2", "18/10/2026", "€4149"], status: "pending" as const },
    { id: "250607620", cells: ["DAT-3620", "Data Retention Platform Item 3", "5/5/2026", "€7720"], status: "completed" as const },
    { id: "250611191", cells: ["DAT-7191", "Data Retention Platform Item 4", "20/12/2026", "€11 291"], status: "warning" as const },
    { id: "250614762", cells: ["DAT-1762", "Data Retention Platform Item 5", "7/7/2026", "€14 862"], status: "active" as const },
];
...
export default function DataRetentionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Data Retention Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Data Retention Platform</p>
                    </div>
                </div>
