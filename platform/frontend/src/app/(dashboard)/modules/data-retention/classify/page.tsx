...
const PAGE = "Classify";
const KPIS = [{"l":"Dashboards Ativos","v":"3.117","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"655","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"574","t":"+17.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.569","t":"+4.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1794","2026-02-15","616","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2041","2026-01-25","4.268","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1119","2026-01-02","182","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3648","2026-01-22","1.677","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2635","2026-02-10","8.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":802},{"label":"Mar","value":930},{"label":"Abr","value":670},{"label":"Mai","value":592},{"label":"Jun","value":727},{"label":"Jul","value":866},{"label":"Ago","value":906},{"label":"Set","value":767},{"label":"Out","value":866},{"label":"Nov","value":703},{"label":"Dez","value":693}];
const MX = 930;
