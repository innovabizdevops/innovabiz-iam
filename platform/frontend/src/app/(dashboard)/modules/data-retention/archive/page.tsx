...
const PAGE = "Archive";
const KPIS = [{"l":"Dashboards Ativos","v":"2.997","t":"+8.4%","d":"up"},{"l":"Queries/Dia","v":"3927","t":"-5.0%","d":"down"},{"l":"Dados Processados (GB)","v":"8.377","t":"+1.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.970","t":"+14.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2133","2026-01-24","8.005","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2926","2026-02-13","5.840","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2405","2026-01-06","3.813","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","596","2026-02-26","942","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1027","2026-01-04","8.012","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":913},{"label":"Mar","value":1045},{"label":"Abr","value":1050},{"label":"Mai","value":987},{"label":"Jun","value":709},{"label":"Jul","value":960},{"label":"Ago","value":795},{"label":"Set","value":890},{"label":"Out","value":835},{"label":"Nov","value":757},{"label":"Dez","value":751}];
const MX = 1050;
