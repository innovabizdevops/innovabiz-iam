...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.098","t":"-2.9%","d":"down"},{"l":"NC Abertas","v":"5.376","t":"+14.3%","d":"up"},{"l":"Conformidade (%)","v":"89.7%","t":"-4.8%","d":"down"},{"l":"CAPAs Pendentes","v":"4.924","t":"+0.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.154","88.7%","8.455","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.833","77.3%","748","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","486","82.0%","576","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.751","74.6%","7.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.626","70.6%","3.549","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":636},{"label":"Mar","value":497},{"label":"Abr","value":537},{"label":"Mai","value":618},{"label":"Jun","value":404},{"label":"Jul","value":396},{"label":"Ago","value":436},{"label":"Set","value":500},{"label":"Out","value":363},{"label":"Nov","value":372},{"label":"Dez","value":322}];
const MX = 636;
