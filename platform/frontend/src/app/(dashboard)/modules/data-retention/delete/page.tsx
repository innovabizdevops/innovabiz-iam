...
const ACCENT = "#1e3a5f";
const MODULE = "Data Retention Platform";
const PAGE = "Delete";
const KPIS = [{"l":"Dashboards Ativos","v":"506","t":"+2.5%","d":"up"},{"l":"Queries/Dia","v":"1257","t":"+3.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.640","t":"+7.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.022","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1700","2026-03-10","186","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","368","2026-02-19","8.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3609","2026-03-26","7.051","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4090","2026-02-22","6.979","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1485","2026-03-05","3.119","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":584},{"label":"Mar","value":536},{"label":"Abr","value":691},{"label":"Mai","value":834},{"label":"Jun","value":699},{"label":"Jul","value":609},{"label":"Ago","value":530},{"label":"Set","value":602},{"label":"Out","value":827},{"label":"Nov","value":636},{"label":"Dez","value":846}];
const MX = 846;
