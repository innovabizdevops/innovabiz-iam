...
const PAGE = "Patient Select";
const KPIS = [{"l":"Total Companion Diag","v":"5.145","t":"+5.9%","d":"up"},{"l":"Patient Select Ativos","v":"7.381","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"92.9%","t":"-5.7%","d":"down"},{"l":"Score Performance","v":"56","t":"+4.7%","d":"up"}];
const COLS = ["ID","Patient Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Companion Diag #001","Companion Diag #002","5.853","5.835","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Companion Diag #002","Companion Diag #003","4.108","4.705","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Companion Diag #003","Companion Diag #004","2.712","1.631","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Companion Diag #004","Companion Diag #005","7.641","4.155","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Companion Diag #005","Companion Diag #001","1.509","869","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":674},{"label":"Mar","value":866},{"label":"Abr","value":785},{"label":"Mai","value":785},{"label":"Jun","value":784},{"label":"Jul","value":595},{"label":"Ago","value":793},{"label":"Set","value":742},{"label":"Out","value":895},{"label":"Nov","value":679},{"label":"Dez","value":630}];
const MX = 915;
