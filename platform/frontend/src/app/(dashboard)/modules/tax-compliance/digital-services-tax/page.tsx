...
const PAGE = "Digital Services Tax";
const KPIS = [{"l":"Obrigações Fiscais","v":"342","d":"+1.2%","u":true},{"l":"Declarações Enviadas","v":"298","d":"+5.4%","u":true},{"l":"Pendentes","v":"44","d":"-12.3%","u":false},{"l":"Conformidade (%)","v":"97.1%","d":"+0.8%","u":true}];
const COLS = ["Tipo Imposto","Período","Valor (€)","Prazo","Entidade","Estado"];
const ROWS = [
  { id: "001", c: ["Digital Services Tax-001", "Digital Services Tax Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Digital Services Tax-002", "Digital Services Tax Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Digital Services Tax-003", "Digital Services Tax Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Digital Services Tax-004", "Digital Services Tax Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Digital Services Tax-005", "Digital Services Tax Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Digital Services Tax", ts: "Há 2min", a: "Sistema" },
...
export default function DigitalServicesTaxPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Tax Compliance — iBOS Enterprise</p>
        </div>
