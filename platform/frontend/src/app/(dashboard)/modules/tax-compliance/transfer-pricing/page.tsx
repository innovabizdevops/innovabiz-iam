...
const ROWS = [
  { id: "001", c: ["Transfer Pricing-001", "Transfer Pricing Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Transfer Pricing-002", "Transfer Pricing Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Transfer Pricing-003", "Transfer Pricing Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Transfer Pricing-004", "Transfer Pricing Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Transfer Pricing-005", "Transfer Pricing Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Transfer Pricing", ts: "Há 2min", a: "Sistema" },
