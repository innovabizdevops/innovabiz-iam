...
const ROWS = [
  { id: "001", c: ["Carbon Tax-001", "Carbon Tax Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Carbon Tax-002", "Carbon Tax Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Carbon Tax-003", "Carbon Tax Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Carbon Tax-004", "Carbon Tax Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Carbon Tax-005", "Carbon Tax Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Carbon Tax", ts: "Há 2min", a: "Sistema" },
