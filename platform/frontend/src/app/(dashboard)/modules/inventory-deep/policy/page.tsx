...
const ACCENT = "#1e3a5f";
const MODULE = "Inventory Optimization Deep";
const PAGE = "Policy";
const KPIS = [{"l":"Total Inventory Deep","v":"8.176","t":"+10.3%","d":"up"},{"l":"Policy Ativos","v":"5.134","t":"-3.9%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+5.1%","d":"up"}];
const COLS = ["ID","Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Deep #001","Inventory Deep #002","8.716","1.353","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Deep #002","Inventory Deep #003","2.868","423","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Deep #003","Inventory Deep #004","3.817","8.016","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Deep #004","Inventory Deep #005","1.683","7.056","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Deep #005","Inventory Deep #001","8.838","4.784","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":563},{"label":"Mar","value":687},{"label":"Abr","value":680},{"label":"Mai","value":734},{"label":"Jun","value":485},{"label":"Jul","value":599},{"label":"Ago","value":707},{"label":"Set","value":729},{"label":"Out","value":799},{"label":"Nov","value":735},{"label":"Dez","value":440}];
const MX = 799;
