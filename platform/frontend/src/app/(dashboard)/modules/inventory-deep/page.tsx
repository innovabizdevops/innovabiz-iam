...
/* ═══ Inventory Optimization Deep — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4264", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2495", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€34K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-22%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "745988964", cells: ["INV-6964", "Inventory Optimization Deep Item 1", "1/1/2026", "€39 064"], status: "active" as const },
    { id: "745992535", cells: ["INV-1535", "Inventory Optimization Deep Item 2", "16/8/2026", "€42 635"], status: "pending" as const },
    { id: "745996106", cells: ["INV-5106", "Inventory Optimization Deep Item 3", "3/3/2026", "€46 206"], status: "completed" as const },
    { id: "745999677", cells: ["INV-8677", "Inventory Optimization Deep Item 4", "18/10/2026", "€49 777"], status: "warning" as const },
    { id: "746003248", cells: ["INV-3248", "Inventory Optimization Deep Item 5", "5/5/2026", "€3348"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 24 }, { label: "Fev", value: 33 }, { label: "Mar", value: 42 }, { label: "Abr", value: 51 }, { label: "Mai", value: 60 }, { label: "Jun", value: 69 }];
...
export default function InventoryOptimizationDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Inventory Optimization Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Inventory Optimization Deep</p>
                    </div>
                </div>
