...
const KPIS = [{"l":"Total Inventory Deep","v":"4.648","t":"+18.0%","d":"up"},{"l":"Multi Echelon Ativos","v":"7.192","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"73","t":"+7.6%","d":"up"}];
const COLS = ["ID","Multi Echelon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inventory Deep #001","Inventory Deep #002","3.941","4.181","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Inventory Deep #002","Inventory Deep #003","2.605","8.478","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Inventory Deep #003","Inventory Deep #004","1.754","4.996","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Inventory Deep #004","Inventory Deep #005","522","2.975","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inventory Deep #005","Inventory Deep #001","5.733","1.765","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":511},{"label":"Fev","value":628},{"label":"Mar","value":597},{"label":"Abr","value":418},{"label":"Mai","value":409},{"label":"Jun","value":662},{"label":"Jul","value":686},{"label":"Ago","value":530},{"label":"Set","value":590},{"label":"Out","value":657},{"label":"Nov","value":507},{"label":"Dez","value":683}];
const MX = 686;
