...
const PAGE = "ITAR Comply";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.400","t":"-2.9%","d":"down"},{"l":"Contratos (€M)","v":"€25.3M","t":"+15.1%","d":"up"},{"l":"On-Time Delivery (%)","v":"93.3%","t":"+6.0%","d":"up"},{"l":"Score Médio","v":"58","t":"-4.1%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","76.4%","€ 28730.83","7.775","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","81.8%","€ 9449.32","2.698","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","94.6%","€ 41882.12","101","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","93.1%","€ 35880.27","5.360","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","99.1%","€ 7608.21","6.255","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":266},{"label":"Mar","value":451},{"label":"Abr","value":643},{"label":"Mai","value":392},{"label":"Jun","value":309},{"label":"Jul","value":560},{"label":"Ago","value":601},{"label":"Set","value":399},{"label":"Out","value":347},{"label":"Nov","value":560},{"label":"Dez","value":615}];
const MX = 643;
