...
const PAGE = "DCMA Inspect";
const KPIS = [{"l":"Fornecedores Ativos","v":"3.385","t":"-4.4%","d":"down"},{"l":"Contratos (€M)","v":"€47.1M","t":"+12.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"83.1%","t":"+13.5%","d":"up"},{"l":"Score Médio","v":"59","t":"+10.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","74.0%","€ 15419.62","8.178","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","95.3%","€ 38319.88","7.262","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.3%","€ 29897.39","4.420","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.9%","€ 7305.50","7.606","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","76.9%","€ 13043.10","2.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":579},{"label":"Mar","value":616},{"label":"Abr","value":766},{"label":"Mai","value":807},{"label":"Jun","value":826},{"label":"Jul","value":605},{"label":"Ago","value":578},{"label":"Set","value":765},{"label":"Out","value":803},{"label":"Nov","value":622},{"label":"Dez","value":717}];
const MX = 826;
