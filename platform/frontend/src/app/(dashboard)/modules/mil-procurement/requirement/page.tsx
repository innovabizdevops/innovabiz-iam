...
const PAGE = "Requirement";
const KPIS = [{"l":"Fornecedores Ativos","v":"251","t":"+10.9%","d":"up"},{"l":"Contratos (€M)","v":"€22.9M","t":"+3.5%","d":"up"},{"l":"On-Time Delivery (%)","v":"82.8%","t":"-2.7%","d":"down"},{"l":"Score Médio","v":"88","t":"+4.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","90.3%","€ 7114.27","8.648","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","94.2%","€ 15382.99","5.646","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","77.5%","€ 31774.20","9.081","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","76.7%","€ 41551.76","3.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","86.6%","€ 41130.22","5.530","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":706},{"label":"Mar","value":993},{"label":"Abr","value":873},{"label":"Mai","value":960},{"label":"Jun","value":682},{"label":"Jul","value":922},{"label":"Ago","value":628},{"label":"Set","value":742},{"label":"Out","value":747},{"label":"Nov","value":984},{"label":"Dez","value":831}];
const MX = 993;
