...
const ACCENT = "#7c3aed";
const MODULE = "Military Procurement";
const PAGE = "Contract Award";
const KPIS = [{"l":"Contratos Ativos","v":"8.507","t":"+16.5%","d":"up"},{"l":"Valor Total (€M)","v":"€50.6M","t":"-3.4%","d":"down"},{"l":"Renovações Próx. 30d","v":"7.679","t":"+12.3%","d":"up"},{"l":"Obrigações Pendentes","v":"2.576","t":"+16.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 46431.10","2026-02-18","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 22563.14","2026-01-27","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 14396.82","2026-03-07","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 47227.95","2026-01-09","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 26065.77","2026-01-26","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":691},{"label":"Mar","value":563},{"label":"Abr","value":803},{"label":"Mai","value":599},{"label":"Jun","value":859},{"label":"Jul","value":635},{"label":"Ago","value":804},{"label":"Set","value":762},{"label":"Out","value":490},{"label":"Nov","value":707},{"label":"Dez","value":848}];
const MX = 859;
