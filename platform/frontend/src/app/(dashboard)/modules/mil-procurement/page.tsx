...
export default function MilProcurementPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mil Procurement</h1><p className="text-sm text-muted-foreground">Mil Procurement • iBOS Enterprise</p></div>
