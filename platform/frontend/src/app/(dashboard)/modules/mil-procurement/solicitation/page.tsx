...
const PAGE = "Solicitation";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.907","t":"+16.6%","d":"up"},{"l":"Contratos (€M)","v":"€39.7M","t":"+16.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.6%","t":"+6.5%","d":"up"},{"l":"Score Médio","v":"88","t":"+18.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","79.1%","€ 18769.03","5.828","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","94.5%","€ 15356.75","4.461","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","74.3%","€ 10249.95","8.442","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.3%","€ 39005.17","5.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","83.6%","€ 40157.53","5.116","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":446},{"label":"Fev","value":750},{"label":"Mar","value":662},{"label":"Abr","value":643},{"label":"Mai","value":408},{"label":"Jun","value":662},{"label":"Jul","value":565},{"label":"Ago","value":567},{"label":"Set","value":692},{"label":"Out","value":550},{"label":"Nov","value":515},{"label":"Dez","value":472}];
const MX = 750;
