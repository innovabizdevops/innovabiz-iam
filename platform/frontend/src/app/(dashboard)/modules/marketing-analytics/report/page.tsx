...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"7.191","t":"+16.6%","d":"up"},{"l":"Queries/Dia","v":"641","t":"+8.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.691","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"1.494","t":"+18.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1068","2026-02-21","2.863","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1981","2026-01-11","7.956","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1716","2026-02-15","4.260","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1264","2026-03-20","7.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","539","2026-03-09","1.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":678},{"label":"Mar","value":818},{"label":"Abr","value":669},{"label":"Mai","value":611},{"label":"Jun","value":887},{"label":"Jul","value":557},{"label":"Ago","value":599},{"label":"Set","value":837},{"label":"Out","value":566},{"label":"Nov","value":798},{"label":"Dez","value":537}];
const MX = 887;
