...
const ACCENT = "#6366f1";
const MODULE = "Marketing Analytics";
const PAGE = "Forecast";
const KPIS = [{"l":"Dashboards Ativos","v":"8.787","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"4031","t":"-3.3%","d":"down"},{"l":"Dados Processados (GB)","v":"199","t":"+16.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.259","t":"-3.6%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2636","2026-01-12","3.438","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2510","2026-03-06","387","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1669","2026-01-27","6.995","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4720","2026-01-26","7.507","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2696","2026-02-24","606","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":588},{"label":"Mar","value":418},{"label":"Abr","value":449},{"label":"Mai","value":653},{"label":"Jun","value":354},{"label":"Jul","value":636},{"label":"Ago","value":597},{"label":"Set","value":565},{"label":"Out","value":612},{"label":"Nov","value":392},{"label":"Dez","value":497}];
const MX = 653;
