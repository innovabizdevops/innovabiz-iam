...
const KPIS = [{"l":"Dashboards Ativos","v":"3.558","t":"+6.4%","d":"up"},{"l":"Queries/Dia","v":"3675","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.945","t":"+2.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.723","t":"+11.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5061","2026-02-01","5.441","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3276","2026-01-15","5.426","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3112","2026-02-04","1.256","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","431","2026-02-14","6.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","922","2026-03-26","7.584","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":778},{"label":"Mar","value":726},{"label":"Abr","value":879},{"label":"Mai","value":845},{"label":"Jun","value":508},{"label":"Jul","value":855},{"label":"Ago","value":852},{"label":"Set","value":798},{"label":"Out","value":503},{"label":"Nov","value":634},{"label":"Dez","value":509}];
const MX = 879;
