...
const PAGE = "ROI";
const KPIS = [{"l":"Dashboards Ativos","v":"2.460","t":"-3.2%","d":"down"},{"l":"Queries/Dia","v":"777","t":"-0.5%","d":"down"},{"l":"Dados Processados (GB)","v":"7.667","t":"+9.7%","d":"up"},{"l":"Utilizadores Analytics","v":"8.440","t":"+1.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1454","2026-02-08","6.998","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2193","2026-02-16","8.900","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","877","2026-03-07","2.407","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","254","2026-02-07","3.590","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2505","2026-03-14","649","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":760},{"label":"Mar","value":467},{"label":"Abr","value":558},{"label":"Mai","value":636},{"label":"Jun","value":620},{"label":"Jul","value":721},{"label":"Ago","value":412},{"label":"Set","value":766},{"label":"Out","value":475},{"label":"Nov","value":611},{"label":"Dez","value":766}];
const MX = 766;
