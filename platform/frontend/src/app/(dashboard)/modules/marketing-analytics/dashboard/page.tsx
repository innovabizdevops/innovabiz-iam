...
const KPIS = [{"l":"Dashboards Ativos","v":"1.382","t":"+12.6%","d":"up"},{"l":"Queries/Dia","v":"2393","t":"+8.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.895","t":"-2.9%","d":"down"},{"l":"Utilizadores Analytics","v":"2.571","t":"+9.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4838","2026-01-08","2.484","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3070","2026-01-07","5.476","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4477","2026-03-22","344","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1172","2026-02-17","9.013","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2538","2026-01-07","4.125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":392},{"label":"Mar","value":628},{"label":"Abr","value":334},{"label":"Mai","value":434},{"label":"Jun","value":348},{"label":"Jul","value":506},{"label":"Ago","value":592},{"label":"Set","value":490},{"label":"Out","value":572},{"label":"Nov","value":594},{"label":"Dez","value":545}];
const MX = 628;
