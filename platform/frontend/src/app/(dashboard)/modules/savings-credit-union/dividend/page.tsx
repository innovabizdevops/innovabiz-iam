...
const PAGE = "Dividendo";
const KPIS = [{"l":"Integrações Ativas","v":"8.043","t":"+4.4%","d":"up"},{"l":"Chamadas/Hora","v":"1353","t":"+11.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"78.0%","t":"+11.2%","d":"up"},{"l":"Latência Média (ms)","v":"187ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.579","3.221","88.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.071","7.758","94.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.621","3.881","79.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.840","899","79.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.883","8.062","90.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":600},{"label":"Mar","value":594},{"label":"Abr","value":659},{"label":"Mai","value":638},{"label":"Jun","value":724},{"label":"Jul","value":640},{"label":"Ago","value":625},{"label":"Set","value":509},{"label":"Out","value":394},{"label":"Nov","value":442},{"label":"Dez","value":547}];
const MX = 724;
