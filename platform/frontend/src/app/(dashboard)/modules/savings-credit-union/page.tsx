...
export default function SavingsCreditUnionPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Savings Credit Union</h1><p className="text-sm text-muted-foreground">Savings Credit Union • iBOS Enterprise</p></div>
