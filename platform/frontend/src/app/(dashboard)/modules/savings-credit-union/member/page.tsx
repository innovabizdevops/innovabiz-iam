...
const PAGE = "Membro";
const KPIS = [{"l":"Integrações Ativas","v":"6.975","t":"+1.4%","d":"up"},{"l":"Chamadas/Hora","v":"409","t":"+0.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.8%","t":"+4.1%","d":"up"},{"l":"Latência Média (ms)","v":"38ms","t":"+3.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.134","512","88.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.766","2.964","73.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.472","1.258","99.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.391","5.145","89.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.377","2.825","86.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":734},{"label":"Mar","value":749},{"label":"Abr","value":458},{"label":"Mai","value":564},{"label":"Jun","value":531},{"label":"Jul","value":625},{"label":"Ago","value":644},{"label":"Set","value":767},{"label":"Out","value":409},{"label":"Nov","value":779},{"label":"Dez","value":570}];
const MX = 779;
