...
const PAGE = "Depósito";
const KPIS = [{"l":"Pedidos/Dia","v":"2140","t":"-1.9%","d":"down"},{"l":"GMV (€)","v":"€74997","t":"+2.5%","d":"up"},{"l":"Conversão (%)","v":"80.7%","t":"+7.9%","d":"up"},{"l":"AOV (€)","v":"€71045","t":"-2.2%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 23196.91","7.671","8.987","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 8151.22","6.394","3.655","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41496.22","7.208","6.806","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 16769.57","2.111","3.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 4693.46","6.062","2.217","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":625},{"label":"Mar","value":733},{"label":"Abr","value":858},{"label":"Mai","value":859},{"label":"Jun","value":547},{"label":"Jul","value":878},{"label":"Ago","value":660},{"label":"Set","value":690},{"label":"Out","value":882},{"label":"Nov","value":550},{"label":"Dez","value":625}];
const MX = 882;
