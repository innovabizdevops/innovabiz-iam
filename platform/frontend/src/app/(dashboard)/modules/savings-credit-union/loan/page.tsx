...
const ACCENT = "#6366f1";
const MODULE = "Cooperativa Crédito";
const PAGE = "Empréstimo";
const KPIS = [{"l":"Integrações Ativas","v":"304","t":"-1.0%","d":"down"},{"l":"Chamadas/Hora","v":"4155","t":"+14.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"86.2%","t":"-1.0%","d":"down"},{"l":"Latência Média (ms)","v":"167ms","t":"+0.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.784","1.897","75.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","601","9.026","81.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.798","7.860","94.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.801","5.582","97.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.651","6.440","72.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":760},{"label":"Mar","value":660},{"label":"Abr","value":625},{"label":"Mai","value":729},{"label":"Jun","value":449},{"label":"Jul","value":778},{"label":"Ago","value":602},{"label":"Set","value":512},{"label":"Out","value":468},{"label":"Nov","value":704},{"label":"Dez","value":569}];
const MX = 778;
