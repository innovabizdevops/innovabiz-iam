...
const ACCENT = "#7c3aed";
const MODULE = "Data Privacy & Consent";
const PAGE = "NIST Privacy Framework";
const KPIS = [{"l":"Dashboards Ativos","v":"260","t":"-5.2%","d":"down"},{"l":"Queries/Dia","v":"2361","t":"+11.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.288","t":"+2.7%","d":"up"},{"l":"Utilizadores Analytics","v":"4.352","t":"+9.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2257","2026-02-18","943","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4299","2026-02-28","7.070","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1911","2026-01-21","2.835","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3635","2026-03-10","3.523","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2982","2026-02-01","423","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":867},{"label":"Mar","value":701},{"label":"Abr","value":975},{"label":"Mai","value":734},{"label":"Jun","value":743},{"label":"Jul","value":1053},{"label":"Ago","value":955},{"label":"Set","value":829},{"label":"Out","value":988},{"label":"Nov","value":750},{"label":"Dez","value":737}];
const MX = 1053;
...
export default function NistPrivacyPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>NIST</span></h1>
                </div>
