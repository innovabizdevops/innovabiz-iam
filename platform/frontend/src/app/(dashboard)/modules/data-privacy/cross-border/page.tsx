...
const PAGE = "Cross-Border Transfers";
const KPIS = [{"l":"Dashboards Ativos","v":"4.283","t":"-3.3%","d":"down"},{"l":"Queries/Dia","v":"2462","t":"+16.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.643","t":"+13.9%","d":"up"},{"l":"Utilizadores Analytics","v":"4.995","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4157","2026-03-09","5.353","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2478","2026-01-27","8.267","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2299","2026-03-11","2.069","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3120","2026-03-13","1.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3683","2026-03-13","7.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":839},{"label":"Mar","value":489},{"label":"Abr","value":703},{"label":"Mai","value":694},{"label":"Jun","value":673},{"label":"Jul","value":534},{"label":"Ago","value":839},{"label":"Set","value":657},{"label":"Out","value":838},{"label":"Nov","value":681},{"label":"Dez","value":632}];
const MX = 839;
