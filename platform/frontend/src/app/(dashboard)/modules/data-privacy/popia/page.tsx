...
const PAGE = "POPIA (South Africa)";
const KPIS = [{"l":"Dashboards Ativos","v":"2.602","t":"-5.5%","d":"down"},{"l":"Queries/Dia","v":"3990","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"416","t":"+16.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.461","t":"+12.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2029","2026-01-19","5.926","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3894","2026-02-22","3.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1004","2026-01-21","6.382","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","382","2026-01-20","1.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4057","2026-03-15","5.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":325},{"label":"Fev","value":438},{"label":"Mar","value":403},{"label":"Abr","value":491},{"label":"Mai","value":351},{"label":"Jun","value":349},{"label":"Jul","value":473},{"label":"Ago","value":245},{"label":"Set","value":347},{"label":"Out","value":352},{"label":"Nov","value":368},{"label":"Dez","value":367}];
const MX = 491;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>POPIA</span></h1>
                </div>
