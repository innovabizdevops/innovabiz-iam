...
const PAGE = "Data Mapping";
const KPIS = [{"l":"Dashboards Ativos","v":"4.553","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"3208","t":"+3.7%","d":"up"},{"l":"Dados Processados (GB)","v":"5.479","t":"-0.6%","d":"down"},{"l":"Utilizadores Analytics","v":"1.087","t":"-2.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4949","2026-02-18","1.909","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1559","2026-03-10","3.153","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","920","2026-01-18","2.340","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1864","2026-01-26","8.049","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3045","2026-02-28","5.753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":829},{"label":"Mar","value":834},{"label":"Abr","value":759},{"label":"Mai","value":931},{"label":"Jun","value":757},{"label":"Jul","value":765},{"label":"Ago","value":898},{"label":"Set","value":739},{"label":"Out","value":945},{"label":"Nov","value":666},{"label":"Dez","value":838}];
const MX = 945;
