...
const PAGE = "Breach Management";
const KPIS = [{"l":"Dashboards Ativos","v":"6.183","t":"+4.3%","d":"up"},{"l":"Queries/Dia","v":"3022","t":"-0.1%","d":"down"},{"l":"Dados Processados (GB)","v":"1.296","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"5.596","t":"+4.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2085","2026-03-11","4.599","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3704","2026-02-01","1.711","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2437","2026-03-21","1.476","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","729","2026-02-21","2.599","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3995","2026-03-02","1.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":684},{"label":"Mar","value":594},{"label":"Abr","value":707},{"label":"Mai","value":759},{"label":"Jun","value":508},{"label":"Jul","value":434},{"label":"Ago","value":397},{"label":"Set","value":542},{"label":"Out","value":399},{"label":"Nov","value":586},{"label":"Dez","value":494}];
const MX = 759;
...
export default function BreachMgmtPage() {
    return (
