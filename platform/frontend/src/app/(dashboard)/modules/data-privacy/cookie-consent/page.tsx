...
const PAGE = "Cookie Consent";
const KPIS = [{"l":"Dashboards Ativos","v":"4.135","t":"-1.1%","d":"down"},{"l":"Queries/Dia","v":"936","t":"+8.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.133","t":"+3.9%","d":"up"},{"l":"Utilizadores Analytics","v":"2.986","t":"+12.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3160","2026-03-05","1.726","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3054","2026-02-14","7.505","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2924","2026-01-01","4.354","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2219","2026-03-19","1.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4014","2026-03-11","2.445","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":897},{"label":"Mar","value":966},{"label":"Abr","value":628},{"label":"Mai","value":734},{"label":"Jun","value":955},{"label":"Jul","value":766},{"label":"Ago","value":603},{"label":"Set","value":714},{"label":"Out","value":816},{"label":"Nov","value":608},{"label":"Dez","value":924}];
const MX = 966;
