...
const PAGE = "LGPD (Brasil)";
const KPIS = [{"l":"Dashboards Ativos","v":"6.552","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"313","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"161","t":"+5.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.445","t":"-0.1%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1771","2026-03-09","7.393","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4045","2026-03-18","6.699","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3933","2026-02-26","7.368","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4292","2026-03-06","7.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1184","2026-01-02","6.452","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":805},{"label":"Mar","value":625},{"label":"Abr","value":850},{"label":"Mai","value":646},{"label":"Jun","value":879},{"label":"Jul","value":748},{"label":"Ago","value":713},{"label":"Set","value":604},{"label":"Out","value":531},{"label":"Nov","value":716},{"label":"Dez","value":607}];
const MX = 879;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>LGPD</span></h1>
                </div>
