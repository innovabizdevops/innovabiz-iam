...
const PAGE = "Consent Management";
const KPIS = [{"l":"Dashboards Ativos","v":"5.953","t":"+8.7%","d":"up"},{"l":"Queries/Dia","v":"3553","t":"-1.2%","d":"down"},{"l":"Dados Processados (GB)","v":"4.602","t":"+1.9%","d":"up"},{"l":"Utilizadores Analytics","v":"3.255","t":"+7.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3034","2026-03-13","4.781","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1032","2026-02-09","3.517","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4631","2026-03-15","8.733","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3348","2026-03-21","2.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4207","2026-01-09","7.137","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":739},{"label":"Mar","value":949},{"label":"Abr","value":627},{"label":"Mai","value":841},{"label":"Jun","value":718},{"label":"Jul","value":638},{"label":"Ago","value":882},{"label":"Set","value":948},{"label":"Out","value":724},{"label":"Nov","value":889},{"label":"Dez","value":862}];
const MX = 949;
