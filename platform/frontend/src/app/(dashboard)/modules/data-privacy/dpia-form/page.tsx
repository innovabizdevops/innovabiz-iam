...
const PAGE = "DPIA Form";
const KPIS = [{"l":"Formulários Ativos","v":"649","t":"-5.1%","d":"down"},{"l":"Submissões/Dia","v":"167","t":"+9.1%","d":"up"},{"l":"Documentos Gerados","v":"6.684","t":"-5.5%","d":"down"},{"l":"Templates","v":"7.875","t":"+11.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.242","2026-03-12","2.386","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.456","2026-01-02","2.612","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.490","2026-01-25","7.803","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.137","2026-01-25","852","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.833","2026-02-26","3.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":574},{"label":"Mar","value":427},{"label":"Abr","value":255},{"label":"Mai","value":513},{"label":"Jun","value":441},{"label":"Jul","value":617},{"label":"Ago","value":522},{"label":"Set","value":624},{"label":"Out","value":253},{"label":"Nov","value":279},{"label":"Dez","value":540}];
const MX = 624;
...
export default function DpiaFormPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>GDPR</span></h1>
                </div>
