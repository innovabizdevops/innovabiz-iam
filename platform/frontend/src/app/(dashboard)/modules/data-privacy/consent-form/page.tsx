...
const PAGE = "Consent Management Form";
const KPIS = [{"l":"Formulários Ativos","v":"2.152","t":"+9.9%","d":"up"},{"l":"Submissões/Dia","v":"3595","t":"-2.9%","d":"down"},{"l":"Documentos Gerados","v":"1.459","t":"+7.4%","d":"up"},{"l":"Templates","v":"8.271","t":"+12.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.401","2026-02-18","4.700","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.580","2026-03-13","4.457","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.438","2026-02-15","6.864","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","801","2026-03-05","3.326","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.405","2026-01-15","6.557","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":864},{"label":"Mar","value":869},{"label":"Abr","value":953},{"label":"Mai","value":674},{"label":"Jun","value":697},{"label":"Jul","value":862},{"label":"Ago","value":719},{"label":"Set","value":876},{"label":"Out","value":928},{"label":"Nov","value":705},{"label":"Dez","value":919}];
const MX = 953;
