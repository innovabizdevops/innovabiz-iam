...
const PAGE = "Privacy AI";
const KPIS = [{"l":"Dashboards Ativos","v":"3.112","t":"-2.7%","d":"down"},{"l":"Queries/Dia","v":"437","t":"+0.7%","d":"up"},{"l":"Dados Processados (GB)","v":"6.850","t":"+15.2%","d":"up"},{"l":"Utilizadores Analytics","v":"9.048","t":"+4.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4768","2026-02-24","3.279","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2939","2026-01-14","1.925","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","933","2026-02-01","934","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2744","2026-02-18","4.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","817","2026-03-05","1.598","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":658},{"label":"Mar","value":848},{"label":"Abr","value":575},{"label":"Mai","value":667},{"label":"Jun","value":533},{"label":"Jul","value":867},{"label":"Ago","value":671},{"label":"Set","value":775},{"label":"Out","value":646},{"label":"Nov","value":822},{"label":"Dez","value":817}];
const MX = 867;
