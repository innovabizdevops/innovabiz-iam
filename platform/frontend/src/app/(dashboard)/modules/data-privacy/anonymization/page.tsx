...
const PAGE = "Anonymization Engine";
const KPIS = [{"l":"Dashboards Ativos","v":"5.792","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"4356","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"3.274","t":"+1.1%","d":"up"},{"l":"Utilizadores Analytics","v":"2.406","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3221","2026-02-17","5.744","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3161","2026-01-28","2.789","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4679","2026-01-12","8.269","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4003","2026-01-12","7.683","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","752","2026-03-07","5.160","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":811},{"label":"Mar","value":726},{"label":"Abr","value":549},{"label":"Mai","value":634},{"label":"Jun","value":702},{"label":"Jul","value":614},{"label":"Ago","value":814},{"label":"Set","value":809},{"label":"Out","value":550},{"label":"Nov","value":486},{"label":"Dez","value":719}];
const MX = 814;
