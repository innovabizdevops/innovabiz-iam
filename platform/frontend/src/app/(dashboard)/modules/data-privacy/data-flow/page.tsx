...
const PAGE = "Data Flow Diagram";
const KPIS = [{"l":"Dashboards Ativos","v":"7.284","t":"+10.5%","d":"up"},{"l":"Queries/Dia","v":"1110","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"5.694","t":"+6.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.396","t":"+9.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2569","2026-02-25","2.097","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3397","2026-02-23","7.940","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2326","2026-03-03","1.101","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5032","2026-02-04","540","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","125","2026-03-10","5.957","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":800},{"label":"Mar","value":666},{"label":"Abr","value":671},{"label":"Mai","value":672},{"label":"Jun","value":597},{"label":"Jul","value":535},{"label":"Ago","value":630},{"label":"Set","value":646},{"label":"Out","value":571},{"label":"Nov","value":631},{"label":"Dez","value":660}];
const MX = 800;
