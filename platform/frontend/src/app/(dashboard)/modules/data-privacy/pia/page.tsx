...
const PAGE = "Privacy Impact";
const KPIS = [{"l":"Dashboards Ativos","v":"2.391","t":"+8.6%","d":"up"},{"l":"Queries/Dia","v":"344","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"868","t":"+11.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.623","t":"-2.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","424","2026-01-12","8.764","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","773","2026-01-18","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1843","2026-03-04","1.916","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3985","2026-03-15","8.491","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4882","2026-01-13","4.106","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":733},{"label":"Mar","value":490},{"label":"Abr","value":736},{"label":"Mai","value":445},{"label":"Jun","value":726},{"label":"Jul","value":515},{"label":"Ago","value":706},{"label":"Set","value":717},{"label":"Out","value":566},{"label":"Nov","value":628},{"label":"Dez","value":500}];
const MX = 736;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>DPIA</span></h1>
                </div>
