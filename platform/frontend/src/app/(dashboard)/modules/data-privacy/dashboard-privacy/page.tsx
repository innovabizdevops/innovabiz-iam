...
const PAGE = "Privacy Dashboard";
const KPIS = [{"l":"Dashboards Ativos","v":"1.308","t":"+4.6%","d":"up"},{"l":"Queries/Dia","v":"4241","t":"+12.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.103","t":"+12.3%","d":"up"},{"l":"Utilizadores Analytics","v":"7.094","t":"+3.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4804","2026-03-22","1.844","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2877","2026-03-11","7.149","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3369","2026-03-22","9.085","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4895","2026-03-19","4.909","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","456","2026-01-25","1.562","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":579},{"label":"Mar","value":880},{"label":"Abr","value":581},{"label":"Mai","value":738},{"label":"Jun","value":861},{"label":"Jul","value":637},{"label":"Ago","value":902},{"label":"Set","value":891},{"label":"Out","value":860},{"label":"Nov","value":681},{"label":"Dez","value":840}];
const MX = 902;
