...
const PAGE = "DSAR Automation";
const KPIS = [{"l":"Dashboards Ativos","v":"6.139","t":"+10.8%","d":"up"},{"l":"Queries/Dia","v":"1376","t":"-1.0%","d":"down"},{"l":"Dados Processados (GB)","v":"692","t":"+1.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.147","t":"+3.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","232","2026-03-21","8.845","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2968","2026-01-25","8.147","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1873","2026-02-01","8.187","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1570","2026-02-26","7.513","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","317","2026-01-08","3.859","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":819},{"label":"Mar","value":644},{"label":"Abr","value":690},{"label":"Mai","value":715},{"label":"Jun","value":616},{"label":"Jul","value":680},{"label":"Ago","value":607},{"label":"Set","value":602},{"label":"Out","value":844},{"label":"Nov","value":620},{"label":"Dez","value":628}];
const MX = 844;
