...
const PAGE = "CCPA/CPRA (USA)";
const KPIS = [{"l":"Dashboards Ativos","v":"4.643","t":"+3.0%","d":"up"},{"l":"Queries/Dia","v":"1571","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"9.093","t":"-2.3%","d":"down"},{"l":"Utilizadores Analytics","v":"6.814","t":"+6.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4752","2026-02-16","6.246","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","485","2026-02-28","1.966","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2693","2026-03-09","698","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2079","2026-02-10","4.324","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","898","2026-03-07","3.641","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":477},{"label":"Mar","value":524},{"label":"Abr","value":518},{"label":"Mai","value":713},{"label":"Jun","value":665},{"label":"Jul","value":627},{"label":"Ago","value":779},{"label":"Set","value":646},{"label":"Out","value":722},{"label":"Nov","value":825},{"label":"Dez","value":644}];
const MX = 825;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>CCPA</span></h1>
                </div>
