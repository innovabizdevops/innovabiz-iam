...
/* ═══ SC: Testing Kit — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "9955", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4100", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€41K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1895137155", cells: ["SC-8155", "SC: Testing Kit Item 1", "24/4/2026", "€37 255"], status: "active" as const },
    { id: "1895140726", cells: ["SC-2726", "SC: Testing Kit Item 2", "11/11/2026", "€40 826"], status: "pending" as const },
    { id: "1895144297", cells: ["SC-6297", "SC: Testing Kit Item 3", "26/6/2026", "€44 397"], status: "completed" as const },
    { id: "1895147868", cells: ["SC-9868", "SC: Testing Kit Item 4", "13/1/2026", "€47 968"], status: "warning" as const },
    { id: "1895151439", cells: ["SC-4439", "SC: Testing Kit Item 5", "28/8/2026", "€1539"], status: "active" as const },
];
...
export default function ScTestingKitPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Testing Kit</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Testing Kit</p>
                    </div>
                </div>
