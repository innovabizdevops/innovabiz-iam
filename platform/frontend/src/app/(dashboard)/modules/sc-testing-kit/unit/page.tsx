...
const ACCENT = "#0284c7";
const MODULE = "SC: Testing Kit";
const PAGE = "Unit";
const KPIS = [{"l":"Total Sc Testing Kit","v":"469","t":"+10.3%","d":"up"},{"l":"Unit Ativos","v":"6.965","t":"-2.0%","d":"down"},{"l":"Eficiência (%)","v":"65.6%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"68","t":"+16.0%","d":"up"}];
const COLS = ["ID","Unit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Testing Kit #001","Sc Testing Kit #002","8.933","8.970","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Testing Kit #002","Sc Testing Kit #003","9.030","6.239","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Testing Kit #003","Sc Testing Kit #004","5.046","3.930","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Testing Kit #004","Sc Testing Kit #005","4.613","6.667","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Testing Kit #005","Sc Testing Kit #001","7.944","1.550","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":630},{"label":"Mar","value":341},{"label":"Abr","value":457},{"label":"Mai","value":348},{"label":"Jun","value":299},{"label":"Jul","value":631},{"label":"Ago","value":662},{"label":"Set","value":637},{"label":"Out","value":601},{"label":"Nov","value":343},{"label":"Dez","value":415}];
const MX = 662;
