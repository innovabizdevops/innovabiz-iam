...
const KPIS = [{"l":"Integrações Ativas","v":"5.089","t":"+7.5%","d":"up"},{"l":"Chamadas/Hora","v":"4703","t":"+15.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.4%","t":"+17.3%","d":"up"},{"l":"Latência Média (ms)","v":"141ms","t":"+13.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.887","3.667","91.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.067","3.322","81.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.903","7.012","90.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","302","4.616","80.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.801","5.795","76.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":820},{"label":"Mar","value":507},{"label":"Abr","value":889},{"label":"Mai","value":717},{"label":"Jun","value":588},{"label":"Jul","value":630},{"label":"Ago","value":715},{"label":"Set","value":624},{"label":"Out","value":572},{"label":"Nov","value":807},{"label":"Dez","value":567}];
const MX = 889;
