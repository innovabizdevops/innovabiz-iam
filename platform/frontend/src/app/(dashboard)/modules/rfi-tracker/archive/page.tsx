...
const PAGE = "Archive";
const KPIS = [{"l":"Total Rfi Tracker","v":"122","t":"+4.6%","d":"up"},{"l":"Archive Ativos","v":"3.135","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+15.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+15.6%","d":"up"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Rfi Tracker #001","Rfi Tracker #002","2.864","8.784","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Rfi Tracker #002","Rfi Tracker #003","8.094","2.737","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Rfi Tracker #003","Rfi Tracker #004","1.052","2.630","2026-02-13","Concluído"],"status":"done"},{"id":"r3","cells":["Rfi Tracker #004","Rfi Tracker #005","2.344","1.762","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Rfi Tracker #005","Rfi Tracker #001","8.182","7.648","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":786},{"label":"Mar","value":473},{"label":"Abr","value":781},{"label":"Mai","value":826},{"label":"Jun","value":823},{"label":"Jul","value":494},{"label":"Ago","value":544},{"label":"Set","value":628},{"label":"Out","value":693},{"label":"Nov","value":702},{"label":"Dez","value":448}];
const MX = 826;
