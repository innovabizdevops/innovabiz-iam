...
const ACCENT = "#0e7490";
const MODULE = "RFI Tracker";
const PAGE = "Cost Impact";
const KPIS = [{"l":"Projetos Sociais","v":"6.862","t":"-3.8%","d":"down"},{"l":"Beneficiários","v":"464","t":"+0.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€90134","t":"+10.1%","d":"up"},{"l":"Score Impacto","v":"79","t":"+-0.0%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","4.813","€ 33422.73","2.060","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","8.884","€ 27878.81","2.683","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","721","€ 29497.11","7.284","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","5.587","€ 47634.58","4.906","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","3.334","€ 37254.69","3.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":656},{"label":"Mar","value":556},{"label":"Abr","value":553},{"label":"Mai","value":543},{"label":"Jun","value":748},{"label":"Jul","value":500},{"label":"Ago","value":477},{"label":"Set","value":805},{"label":"Out","value":693},{"label":"Nov","value":723},{"label":"Dez","value":579}];
const MX = 805;
