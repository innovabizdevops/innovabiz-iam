...
const ACCENT = "#db2777";
const MODULE = "Event Décor";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.343","t":"+17.6%","d":"up"},{"l":"Submissões/Dia","v":"2718","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"4.186","t":"-3.1%","d":"down"},{"l":"Templates","v":"2.362","t":"+7.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.558","2026-03-08","3.153","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.367","2026-01-12","2.059","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.106","2026-02-13","8.089","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.987","2026-01-16","7.649","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.962","2026-01-26","4.698","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":872},{"label":"Fev","value":798},{"label":"Mar","value":990},{"label":"Abr","value":842},{"label":"Mai","value":739},{"label":"Jun","value":725},{"label":"Jul","value":710},{"label":"Ago","value":983},{"label":"Set","value":741},{"label":"Out","value":721},{"label":"Nov","value":716},{"label":"Dez","value":957}];
const MX = 990;
