...
const PAGE = "Strike";
const KPIS = [{"l":"Eventos Planeados","v":"1.654","t":"+6.2%","d":"up"},{"l":"Participantes","v":"2.178","t":"+15.4%","d":"up"},{"l":"NPS Evento","v":"81","t":"+18.0%","d":"up"},{"l":"Receita (€)","v":"€26969","t":"+12.9%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-18","7.657","2.873","€ 23787.69","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-12","528","5.551","€ 23532.88","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-25","3.974","9.032","€ 4638.41","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-28","5.727","1.181","€ 12803.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-19","2.419","5.590","€ 34834.18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":847},{"label":"Mar","value":1093},{"label":"Abr","value":769},{"label":"Mai","value":1073},{"label":"Jun","value":866},{"label":"Jul","value":933},{"label":"Ago","value":773},{"label":"Set","value":1033},{"label":"Out","value":728},{"label":"Nov","value":1010},{"label":"Dez","value":861}];
const MX = 1093;
