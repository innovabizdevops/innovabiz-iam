...
const PAGE = "Setup";
const KPIS = [{"l":"Eventos Planeados","v":"8.677","t":"+0.8%","d":"up"},{"l":"Participantes","v":"5.610","t":"+1.3%","d":"up"},{"l":"NPS Evento","v":"73","t":"+4.6%","d":"up"},{"l":"Receita (€)","v":"€70143","t":"+10.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-14","5.274","7.220","€ 723.51","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-05","4.540","4.198","€ 24260.69","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-03","8.806","1.303","€ 3830.00","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-19","2.431","5.203","€ 38242.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-11","4.425","3.312","€ 30783.65","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":360},{"label":"Fev","value":603},{"label":"Mar","value":544},{"label":"Abr","value":416},{"label":"Mai","value":286},{"label":"Jun","value":312},{"label":"Jul","value":316},{"label":"Ago","value":395},{"label":"Set","value":330},{"label":"Out","value":545},{"label":"Nov","value":393},{"label":"Dez","value":353}];
const MX = 603;
