...
const PAGE = "Prop";
const KPIS = [{"l":"Eventos Planeados","v":"3.490","t":"+0.7%","d":"up"},{"l":"Participantes","v":"3.943","t":"+16.6%","d":"up"},{"l":"NPS Evento","v":"63","t":"+15.0%","d":"up"},{"l":"Receita (€)","v":"€31671","t":"-4.2%","d":"down"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-11","8.248","6.939","€ 35937.67","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-10","8.498","4.575","€ 37631.34","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-19","3.409","3.654","€ 42925.33","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-03","1.213","2.971","€ 12192.78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-28","4.336","2.326","€ 38130.99","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":359},{"label":"Mar","value":552},{"label":"Abr","value":496},{"label":"Mai","value":256},{"label":"Jun","value":445},{"label":"Jul","value":372},{"label":"Ago","value":485},{"label":"Set","value":362},{"label":"Out","value":642},{"label":"Nov","value":493},{"label":"Dez","value":622}];
const MX = 642;
