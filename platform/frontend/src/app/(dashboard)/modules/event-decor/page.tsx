...
/* ═══ Event Décor — Dashboard ═══ */

const ACCENT = "#db2777";

const KPIS = [
    { label: "Total Registos", value: "7731", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2666", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€394K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "870593831", cells: ["EVE-6831", "Event Décor Item 1", "24/12/2026", "€43 931"], status: "active" as const },
    { id: "870597402", cells: ["EVE-1402", "Event Décor Item 2", "11/7/2026", "€47 502"], status: "pending" as const },
    { id: "870600973", cells: ["EVE-4973", "Event Décor Item 3", "26/2/2026", "€1073"], status: "completed" as const },
    { id: "870604544", cells: ["EVE-8544", "Event Décor Item 4", "13/9/2026", "€4644"], status: "warning" as const },
    { id: "870608115", cells: ["EVE-3115", "Event Décor Item 5", "28/4/2026", "€8215"], status: "active" as const },
];
...
export default function EventDcorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Décor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Décor</p>
                    </div>
                </div>
