...
const PAGE = "Billing";
const KPIS = [{"l":"Eventos Planeados","v":"7.365","t":"+14.3%","d":"up"},{"l":"Participantes","v":"3.635","t":"-0.2%","d":"down"},{"l":"NPS Evento","v":"77","t":"+14.8%","d":"up"},{"l":"Receita (€)","v":"€71832","t":"+5.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-23","2.743","1.480","€ 24310.14","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-21","8.115","6.319","€ 46811.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-28","3.273","2.612","€ 1660.97","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-01-22","5.341","5.152","€ 12081.19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-05","2.652","6.167","€ 47492.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":916},{"label":"Mar","value":823},{"label":"Abr","value":922},{"label":"Mai","value":655},{"label":"Jun","value":744},{"label":"Jul","value":560},{"label":"Ago","value":609},{"label":"Set","value":674},{"label":"Out","value":787},{"label":"Nov","value":804},{"label":"Dez","value":815}];
const MX = 922;
