...
/* ═══ Pathology Information System — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "6897", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3502", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€12K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1501836797", cells: ["PAT-7797", "Pathology Information System Item 1", "14/6/2026", "€36 897"], status: "active" as const },
    { id: "1501840368", cells: ["PAT-2368", "Pathology Information System Item 2", "1/1/2026", "€40 468"], status: "pending" as const },
    { id: "1501843939", cells: ["PAT-5939", "Pathology Information System Item 3", "16/8/2026", "€44 039"], status: "completed" as const },
    { id: "1501847510", cells: ["PAT-9510", "Pathology Information System Item 4", "3/3/2026", "€47 610"], status: "warning" as const },
    { id: "1501851081", cells: ["PAT-4081", "Pathology Information System Item 5", "18/10/2026", "€1181"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 97 }, { label: "Fev", value: 26 }, { label: "Mar", value: 35 }, { label: "Abr", value: 44 }, { label: "Mai", value: 53 }, { label: "Jun", value: 62 }];
...
export default function PathologyInformationSystemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pathology Information System</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pathology Information System</p>
                    </div>
                </div>
