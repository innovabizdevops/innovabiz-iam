...
const PAGE = "Test";
const KPIS = [{"l":"Total Pcb Assembly","v":"1.656","t":"-4.8%","d":"down"},{"l":"Test Ativos","v":"5.514","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"88","t":"+15.6%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pcb Assembly #001","Pcb Assembly #002","8.730","4.257","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pcb Assembly #002","Pcb Assembly #003","4.660","8.015","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pcb Assembly #003","Pcb Assembly #004","1.329","849","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Pcb Assembly #004","Pcb Assembly #005","1.297","7.838","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pcb Assembly #005","Pcb Assembly #001","5.225","793","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":716},{"label":"Mar","value":655},{"label":"Abr","value":910},{"label":"Mai","value":769},{"label":"Jun","value":968},{"label":"Jul","value":993},{"label":"Ago","value":848},{"label":"Set","value":884},{"label":"Out","value":651},{"label":"Nov","value":964},{"label":"Dez","value":986}];
const MX = 993;
