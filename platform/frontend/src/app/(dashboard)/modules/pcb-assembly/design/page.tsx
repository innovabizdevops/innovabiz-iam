...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"6.166","t":"+8.1%","d":"up"},{"l":"Submissões/Dia","v":"2582","t":"+11.6%","d":"up"},{"l":"Documentos Gerados","v":"3.264","t":"+15.1%","d":"up"},{"l":"Templates","v":"3.483","t":"-4.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.742","2026-02-16","4.438","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.580","2026-01-02","567","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.599","2026-02-11","8.296","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.242","2026-01-18","5.385","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.545","2026-01-03","6.575","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":449},{"label":"Mar","value":496},{"label":"Abr","value":466},{"label":"Mai","value":452},{"label":"Jun","value":541},{"label":"Jul","value":784},{"label":"Ago","value":731},{"label":"Set","value":427},{"label":"Out","value":452},{"label":"Nov","value":508},{"label":"Dez","value":453}];
const MX = 784;
