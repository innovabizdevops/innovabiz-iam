...
/* ═══ PCB Assembly — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "9099", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4471", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€178K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1321490699", cells: ["PCB-3699", "PCB Assembly Item 1", "12/12/2026", "€40 799"], status: "active" as const },
    { id: "1321494270", cells: ["PCB-7270", "PCB Assembly Item 2", "27/7/2026", "€44 370"], status: "pending" as const },
    { id: "1321497841", cells: ["PCB-1841", "PCB Assembly Item 3", "14/2/2026", "€47 941"], status: "completed" as const },
    { id: "1321501412", cells: ["PCB-5412", "PCB Assembly Item 4", "1/9/2026", "€1512"], status: "warning" as const },
    { id: "1321504983", cells: ["PCB-8983", "PCB Assembly Item 5", "16/4/2026", "€5083"], status: "active" as const },
];
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • PCB Assembly</p>
                    </div>
                </div>
