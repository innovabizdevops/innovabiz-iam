...
const ACCENT = "#059669";
const MODULE = "PCB Assembly";
const PAGE = "Through Hole";
const KPIS = [{"l":"Total Pcb Assembly","v":"2.913","t":"+7.3%","d":"up"},{"l":"Through Hole Ativos","v":"1.041","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"84.1%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"73","t":"+10.5%","d":"up"}];
const COLS = ["ID","Through Hole","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pcb Assembly #001","Pcb Assembly #002","4.735","4.647","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Pcb Assembly #002","Pcb Assembly #003","6.846","6.584","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Pcb Assembly #003","Pcb Assembly #004","771","7.830","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Pcb Assembly #004","Pcb Assembly #005","3.829","658","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pcb Assembly #005","Pcb Assembly #001","3.263","7.831","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":402},{"label":"Fev","value":541},{"label":"Mar","value":753},{"label":"Abr","value":645},{"label":"Mai","value":492},{"label":"Jun","value":696},{"label":"Jul","value":537},{"label":"Ago","value":453},{"label":"Set","value":402},{"label":"Out","value":549},{"label":"Nov","value":681},{"label":"Dez","value":751}];
const MX = 753;
