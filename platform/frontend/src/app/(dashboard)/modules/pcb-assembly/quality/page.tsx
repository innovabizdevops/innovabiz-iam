...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.098","t":"+0.7%","d":"up"},{"l":"NC Abertas","v":"3.165","t":"+17.1%","d":"up"},{"l":"Conformidade (%)","v":"72.1%","t":"+2.5%","d":"up"},{"l":"CAPAs Pendentes","v":"5.452","t":"+7.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.910","91.0%","7.205","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.529","73.6%","7.183","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.485","85.2%","5.922","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.161","80.6%","6.096","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.412","91.5%","8.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":631},{"label":"Mar","value":277},{"label":"Abr","value":430},{"label":"Mai","value":341},{"label":"Jun","value":616},{"label":"Jul","value":415},{"label":"Ago","value":382},{"label":"Set","value":419},{"label":"Out","value":281},{"label":"Nov","value":509},{"label":"Dez","value":302}];
const MX = 631;
