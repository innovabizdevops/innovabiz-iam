...
const PAGE = "Energy";
const KPIS = [{"l":"Dashboards Ativos","v":"6.023","t":"+1.3%","d":"up"},{"l":"Queries/Dia","v":"986","t":"+0.5%","d":"up"},{"l":"Dados Processados (GB)","v":"6.807","t":"-4.7%","d":"down"},{"l":"Utilizadores Analytics","v":"6.211","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","156","2026-01-24","8.307","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3797","2026-02-20","4.314","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4102","2026-01-07","4.062","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2659","2026-02-17","6.651","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1400","2026-01-15","7.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":566},{"label":"Mar","value":799},{"label":"Abr","value":619},{"label":"Mai","value":682},{"label":"Jun","value":472},{"label":"Jul","value":761},{"label":"Ago","value":623},{"label":"Set","value":501},{"label":"Out","value":836},{"label":"Nov","value":789},{"label":"Dez","value":463}];
const MX = 836;
