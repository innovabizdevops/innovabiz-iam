...
const ACCENT = "#6366f1";
const MODULE = "Chemical Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.971","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"4795","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.422","t":"-1.8%","d":"down"},{"l":"Utilizadores Analytics","v":"7.781","t":"-4.5%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3247","2026-01-26","5.939","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4960","2026-01-21","1.484","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4190","2026-03-11","3.143","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1681","2026-02-18","7.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3569","2026-02-01","2.743","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1090},{"label":"Fev","value":726},{"label":"Mar","value":825},{"label":"Abr","value":1038},{"label":"Mai","value":734},{"label":"Jun","value":763},{"label":"Jul","value":702},{"label":"Ago","value":1049},{"label":"Set","value":1022},{"label":"Out","value":803},{"label":"Nov","value":1039},{"label":"Dez","value":813}];
const MX = 1090;
