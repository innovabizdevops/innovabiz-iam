...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.203","t":"+13.3%","d":"up"},{"l":"NC Abertas","v":"5.154","t":"+8.1%","d":"up"},{"l":"Conformidade (%)","v":"69.9%","t":"+6.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.012","t":"+7.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.784","70.8%","1.546","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.499","92.5%","5.409","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.939","77.1%","1.700","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.743","74.6%","2.840","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.389","91.4%","6.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1057},{"label":"Fev","value":801},{"label":"Mar","value":949},{"label":"Abr","value":898},{"label":"Mai","value":996},{"label":"Jun","value":706},{"label":"Jul","value":793},{"label":"Ago","value":723},{"label":"Set","value":905},{"label":"Out","value":1061},{"label":"Nov","value":692},{"label":"Dez","value":1034}];
const MX = 1061;
