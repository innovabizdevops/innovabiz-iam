...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"8.365","t":"+9.0%","d":"up"},{"l":"Queries/Dia","v":"1583","t":"-2.9%","d":"down"},{"l":"Dados Processados (GB)","v":"1.609","t":"+8.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.222","t":"+4.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3842","2026-02-28","3.435","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1682","2026-01-18","3.159","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3876","2026-02-25","3.238","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","283","2026-02-26","378","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1116","2026-02-22","7.603","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":660},{"label":"Mar","value":736},{"label":"Abr","value":1034},{"label":"Mai","value":936},{"label":"Jun","value":643},{"label":"Jul","value":1029},{"label":"Ago","value":681},{"label":"Set","value":1029},{"label":"Out","value":702},{"label":"Nov","value":692},{"label":"Dez","value":745}];
const MX = 1034;
