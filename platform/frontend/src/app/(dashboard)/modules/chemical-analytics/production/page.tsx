...
const KPIS = [{"l":"Dashboards Ativos","v":"4.975","t":"-0.2%","d":"down"},{"l":"Queries/Dia","v":"3270","t":"+17.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.929","t":"+4.1%","d":"up"},{"l":"Utilizadores Analytics","v":"5.422","t":"+11.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2812","2026-03-04","444","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","791","2026-01-26","344","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","349","2026-02-01","4.528","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2931","2026-03-16","8.005","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4324","2026-02-23","2.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":789},{"label":"Mar","value":864},{"label":"Abr","value":845},{"label":"Mai","value":783},{"label":"Jun","value":479},{"label":"Jul","value":740},{"label":"Ago","value":727},{"label":"Set","value":837},{"label":"Out","value":853},{"label":"Nov","value":492},{"label":"Dez","value":670}];
const MX = 864;
