...
const ACCENT = "#15803d";
const MODULE = "Cannabis IP Mgmt";
const PAGE = "Patent";
const KPIS = [{"l":"Ideias Submetidas","v":"1.712","t":"+-0.0%","d":"up"},{"l":"Patentes (YTD)","v":"1.508","t":"-3.4%","d":"down"},{"l":"Projetos Innovation Lab","v":"7.276","t":"-5.5%","d":"down"},{"l":"Budget I&D (€M)","v":"€39.7M","t":"+1.1%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.944","90.8%","7.592","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","5.805","87.4%","7.462","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.292","98.7%","6.376","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","6.256","72.3%","337","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.231","79.0%","9.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":895},{"label":"Mar","value":736},{"label":"Abr","value":675},{"label":"Mai","value":735},{"label":"Jun","value":829},{"label":"Jul","value":787},{"label":"Ago","value":851},{"label":"Set","value":630},{"label":"Out","value":868},{"label":"Nov","value":771},{"label":"Dez","value":690}];
const MX = 895;
