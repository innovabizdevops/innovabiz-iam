...
/* ═══ Cannabis IP Mgmt — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "1050", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2837", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "403416050", cells: ["CAN-1050", "Cannabis IP Mgmt Item 1", "3/3/2026", "€16 150"], status: "active" as const },
    { id: "403419621", cells: ["CAN-4621", "Cannabis IP Mgmt Item 2", "18/10/2026", "€19 721"], status: "pending" as const },
    { id: "403423192", cells: ["CAN-8192", "Cannabis IP Mgmt Item 3", "5/5/2026", "€23 292"], status: "completed" as const },
    { id: "403426763", cells: ["CAN-2763", "Cannabis IP Mgmt Item 4", "20/12/2026", "€26 863"], status: "warning" as const },
    { id: "403430334", cells: ["CAN-6334", "Cannabis IP Mgmt Item 5", "7/7/2026", "€30 434"], status: "active" as const },
];
...
export default function CannabisIpMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis IP Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis IP Mgmt</p>
                    </div>
                </div>
