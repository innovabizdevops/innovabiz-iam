...
const ACCENT = "#00a1e0";
const MODULE = "Manufacturing Cloud";
const PAGE = "Account Forecast";
const KPIS = [{"l":"Total Industry Mfg Cloud","v":"5.543","t":"+3.0%","d":"up"},{"l":"Account Forecast Ativos","v":"1.269","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+2.6%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.9%","d":"up"}];
const COLS = ["ID","Account Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Mfg Cloud #001","Industry Mfg Cloud #002","1.510","8.518","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Mfg Cloud #002","Industry Mfg Cloud #003","5.264","6.158","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Mfg Cloud #003","Industry Mfg Cloud #004","6.259","8.412","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Mfg Cloud #004","Industry Mfg Cloud #005","5.426","8.950","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Mfg Cloud #005","Industry Mfg Cloud #001","7.079","6.812","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":326},{"label":"Mar","value":401},{"label":"Abr","value":482},{"label":"Mai","value":509},{"label":"Jun","value":553},{"label":"Jul","value":534},{"label":"Ago","value":258},{"label":"Set","value":557},{"label":"Out","value":314},{"label":"Nov","value":450},{"label":"Dez","value":326}];
const MX = 643;
