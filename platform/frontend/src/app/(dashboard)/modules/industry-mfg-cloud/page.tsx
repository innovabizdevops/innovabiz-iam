...
/* ═══ Manufacturing Cloud — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "8082", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "520", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€100K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "978365582", cells: ["IND-3582", "Manufacturing Cloud Item 1", "27/3/2026", "€15 682"], status: "active" as const },
    { id: "978369153", cells: ["IND-7153", "Manufacturing Cloud Item 2", "14/10/2026", "€19 253"], status: "pending" as const },
    { id: "978372724", cells: ["IND-1724", "Manufacturing Cloud Item 3", "1/5/2026", "€22 824"], status: "completed" as const },
    { id: "978376295", cells: ["IND-5295", "Manufacturing Cloud Item 4", "16/12/2026", "€26 395"], status: "warning" as const },
    { id: "978379866", cells: ["IND-8866", "Manufacturing Cloud Item 5", "3/7/2026", "€29 966"], status: "active" as const },
];
...
export default function ManufacturingCloudPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Manufacturing Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Manufacturing Cloud</p>
                    </div>
                </div>
