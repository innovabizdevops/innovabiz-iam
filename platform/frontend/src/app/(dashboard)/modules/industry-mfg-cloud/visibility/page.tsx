...
const KPIS = [{"l":"Total Industry Mfg Cloud","v":"3.015","t":"-5.5%","d":"down"},{"l":"Visibility Ativos","v":"5.960","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"81.9%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+5.2%","d":"up"}];
const COLS = ["ID","Visibility","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Mfg Cloud #001","Industry Mfg Cloud #002","570","8.732","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Mfg Cloud #002","Industry Mfg Cloud #003","1.990","6.480","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Mfg Cloud #003","Industry Mfg Cloud #004","570","5.720","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Mfg Cloud #004","Industry Mfg Cloud #005","2.902","2.325","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Mfg Cloud #005","Industry Mfg Cloud #001","4.602","7.823","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":518},{"label":"Mar","value":446},{"label":"Abr","value":684},{"label":"Mai","value":578},{"label":"Jun","value":656},{"label":"Jul","value":651},{"label":"Ago","value":482},{"label":"Set","value":593},{"label":"Out","value":716},{"label":"Nov","value":631},{"label":"Dez","value":674}];
const MX = 716;
