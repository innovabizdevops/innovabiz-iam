...
const PAGE = "Warranty";
const KPIS = [{"l":"ARR (€M)","v":"€11.2M","t":"+7.0%","d":"up"},{"l":"MRR (€)","v":"€7628","t":"+5.7%","d":"up"},{"l":"Churn (%)","v":"92.2%","t":"+0.9%","d":"up"},{"l":"ARPU (€)","v":"€51586","t":"+4.2%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17613.95","5.968","€ 33738.10","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4107.86","8.463","€ 25280.28","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 26039.92","1.160","€ 34778.94","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 5987.94","7.190","€ 15317.67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15570.80","1.706","€ 37183.68","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":547},{"label":"Mar","value":475},{"label":"Abr","value":639},{"label":"Mai","value":439},{"label":"Jun","value":494},{"label":"Jul","value":294},{"label":"Ago","value":581},{"label":"Set","value":489},{"label":"Out","value":513},{"label":"Nov","value":551},{"label":"Dez","value":394}];
const MX = 639;
