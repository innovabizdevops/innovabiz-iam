...
const PAGE = "Sales Agreement";
const KPIS = [{"l":"Vendas YTD (€)","v":"€22873","t":"+8.4%","d":"up"},{"l":"Pipeline (€)","v":"€72754","t":"-4.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"67.4%","t":"+16.3%","d":"up"},{"l":"Win Rate (%)","v":"72.2%","t":"+17.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 45710.35","€ 8105.07","€ 15365.90","80.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 20532.49","€ 4736.37","€ 26260.95","91.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 941.67","€ 31532.58","€ 21644.77","71.4%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 34673.09","€ 43181.61","€ 15916.33","92.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 14085.13","€ 406.30","€ 44399.28","98.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":965},{"label":"Fev","value":811},{"label":"Mar","value":827},{"label":"Abr","value":722},{"label":"Mai","value":696},{"label":"Jun","value":836},{"label":"Jul","value":776},{"label":"Ago","value":739},{"label":"Set","value":738},{"label":"Out","value":815},{"label":"Nov","value":720},{"label":"Dez","value":1000}];
const MX = 1000;
