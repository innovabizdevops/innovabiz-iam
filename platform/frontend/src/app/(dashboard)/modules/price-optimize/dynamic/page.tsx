...
const ACCENT = "#6366f1";
const MODULE = "Price Optimization";
const PAGE = "Dynamic";
const KPIS = [{"l":"Total Price Optimize","v":"404","t":"-4.1%","d":"down"},{"l":"Dynamic Ativos","v":"5.157","t":"+12.9%","d":"up"},{"l":"Eficiência (%)","v":"68.1%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"92","t":"+5.7%","d":"up"}];
const COLS = ["ID","Dynamic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Price Optimize #001","Price Optimize #002","7.604","7.336","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Price Optimize #002","Price Optimize #003","8.683","8.350","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Price Optimize #003","Price Optimize #004","2.687","6.870","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Price Optimize #004","Price Optimize #005","3.088","5.792","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Price Optimize #005","Price Optimize #001","3.937","5.204","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":793},{"label":"Fev","value":748},{"label":"Mar","value":680},{"label":"Abr","value":789},{"label":"Mai","value":689},{"label":"Jun","value":673},{"label":"Jul","value":626},{"label":"Ago","value":924},{"label":"Set","value":761},{"label":"Out","value":685},{"label":"Nov","value":927},{"label":"Dez","value":811}];
const MX = 927;
