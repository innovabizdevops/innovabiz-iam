...
const PAGE = "Elasticity";
const KPIS = [{"l":"Total Price Optimize","v":"8.989","t":"+1.5%","d":"up"},{"l":"Elasticity Ativos","v":"2.429","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"83.9%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"66","t":"+3.4%","d":"up"}];
const COLS = ["ID","Elasticity","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Price Optimize #001","Price Optimize #002","6.278","7.770","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Price Optimize #002","Price Optimize #003","1.807","2.197","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Price Optimize #003","Price Optimize #004","5.301","6.547","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Price Optimize #004","Price Optimize #005","5.422","1.685","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Price Optimize #005","Price Optimize #001","3.348","3.984","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":708},{"label":"Mar","value":630},{"label":"Abr","value":763},{"label":"Mai","value":812},{"label":"Jun","value":867},{"label":"Jul","value":727},{"label":"Ago","value":490},{"label":"Set","value":736},{"label":"Out","value":535},{"label":"Nov","value":604},{"label":"Dez","value":808}];
const MX = 867;
