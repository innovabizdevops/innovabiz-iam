...
const ACCENT = "#6366f1";
const MODULE = "Packaging Print";
const PAGE = "Prepress";
const KPIS = [{"l":"Total Packaging Print","v":"2.583","t":"-4.3%","d":"down"},{"l":"Prepress Ativos","v":"4.849","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"65.7%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+17.5%","d":"up"}];
const COLS = ["ID","Prepress","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Packaging Print #001","Packaging Print #002","8.481","2.265","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Packaging Print #002","Packaging Print #003","438","1.236","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Packaging Print #003","Packaging Print #004","736","3.615","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Packaging Print #004","Packaging Print #005","1.715","4.541","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Packaging Print #005","Packaging Print #001","2.401","4.237","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":534},{"label":"Mar","value":828},{"label":"Abr","value":873},{"label":"Mai","value":879},{"label":"Jun","value":780},{"label":"Jul","value":607},{"label":"Ago","value":856},{"label":"Set","value":586},{"label":"Out","value":608},{"label":"Nov","value":747},{"label":"Dez","value":523}];
const MX = 879;
