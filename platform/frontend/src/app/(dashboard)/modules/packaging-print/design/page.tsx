...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.471","t":"+12.1%","d":"up"},{"l":"Submissões/Dia","v":"2367","t":"+1.4%","d":"up"},{"l":"Documentos Gerados","v":"1.058","t":"+1.1%","d":"up"},{"l":"Templates","v":"4.471","t":"+10.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.087","2026-01-01","8.042","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.982","2026-01-22","8.688","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.093","2026-03-09","1.005","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","723","2026-01-10","6.713","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.726","2026-01-01","6.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":361},{"label":"Fev","value":499},{"label":"Mar","value":432},{"label":"Abr","value":614},{"label":"Mai","value":458},{"label":"Jun","value":629},{"label":"Jul","value":651},{"label":"Ago","value":560},{"label":"Set","value":336},{"label":"Out","value":511},{"label":"Nov","value":711},{"label":"Dez","value":577}];
const MX = 711;
