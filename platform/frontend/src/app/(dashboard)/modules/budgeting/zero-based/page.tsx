...
const PAGE = "Zero-Based Budget";
const KPIS = [{"l":"Total Budgeting","v":"€7912","t":"+0.9%","d":"up"},{"l":"Zero Based Budget Ativos","v":"€25364","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"68.5%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"86","t":"-2.4%","d":"down"}];
const COLS = ["ID","Zero Based Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","€ 7939.69","4.347","218","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","€ 9686.09","7.306","8.273","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","€ 46954.08","1.816","3.735","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","€ 20727.77","5.038","457","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","€ 27358.05","3.108","5.635","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":847},{"label":"Mar","value":717},{"label":"Abr","value":506},{"label":"Mai","value":861},{"label":"Jun","value":606},{"label":"Jul","value":822},{"label":"Ago","value":821},{"label":"Set","value":593},{"label":"Out","value":648},{"label":"Nov","value":536},{"label":"Dez","value":689}];
const MX = 861;
...
export default function ZeroBasedPage() {
    return (
