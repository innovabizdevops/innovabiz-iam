...
const PAGE = "Rolling Forecast";
const KPIS = [{"l":"Total Budgeting","v":"€77280","t":"+8.4%","d":"up"},{"l":"Rolling Forecast Ativos","v":"4.430","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"94.5%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.0%","d":"down"}];
const COLS = ["ID","Rolling Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","2.401","8.533","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","774","6.473","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","2.699","5.344","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","8.316","2.506","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","5.107","917","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":803},{"label":"Mar","value":728},{"label":"Abr","value":606},{"label":"Mai","value":706},{"label":"Jun","value":799},{"label":"Jul","value":468},{"label":"Ago","value":793},{"label":"Set","value":668},{"label":"Out","value":641},{"label":"Nov","value":725},{"label":"Dez","value":414}];
const MX = 803;
