...
const ACCENT = "#059669";
const MODULE = "Budget & Planning";
const PAGE = "Driver-Based Plan";
const KPIS = [{"l":"Total Budgeting","v":"€95047","t":"+10.5%","d":"up"},{"l":"Driver Based Plan Ativos","v":"2.334","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"88","t":"+12.8%","d":"up"}];
const COLS = ["ID","Driver Based Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","4.210","5.514","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","2.237","9.021","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","4.523","6.965","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","7.580","583","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","3.525","4.183","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":556},{"label":"Mar","value":679},{"label":"Abr","value":369},{"label":"Mai","value":425},{"label":"Jun","value":528},{"label":"Jul","value":622},{"label":"Ago","value":355},{"label":"Set","value":329},{"label":"Out","value":466},{"label":"Nov","value":318},{"label":"Dez","value":711}];
const MX = 711;
...
export default function DriverBasedPage() {
    return (
