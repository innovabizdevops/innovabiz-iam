...
const PAGE = "CapEx Tracking";
const KPIS = [{"l":"Total Budgeting","v":"€51888","t":"+1.2%","d":"up"},{"l":"CapEx Tracking Ativos","v":"6.220","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+12.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+14.6%","d":"up"}];
const COLS = ["ID","CapEx Tracking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","7.677","4.417","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","3.341","765","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","1.416","2.306","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","5.570","5.234","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","8.972","4.174","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":468},{"label":"Mar","value":368},{"label":"Abr","value":221},{"label":"Mai","value":368},{"label":"Jun","value":305},{"label":"Jul","value":274},{"label":"Ago","value":505},{"label":"Set","value":606},{"label":"Out","value":394},{"label":"Nov","value":254},{"label":"Dez","value":520}];
const MX = 606;
