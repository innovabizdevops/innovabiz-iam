...
const PAGE = "Forecast vs Actual";
const KPIS = [{"l":"Total Budgeting","v":"€53265","t":"+4.9%","d":"up"},{"l":"Forecast Vs Actual Ativos","v":"6.103","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"68.2%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"71","t":"+5.4%","d":"up"}];
const COLS = ["ID","Forecast Vs Actual","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","6.799","8.008","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","7.024","7.161","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","1.866","2.677","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","7.772","1.501","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","3.993","1.611","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":609},{"label":"Mar","value":292},{"label":"Abr","value":564},{"label":"Mai","value":456},{"label":"Jun","value":605},{"label":"Jul","value":433},{"label":"Ago","value":518},{"label":"Set","value":525},{"label":"Out","value":649},{"label":"Nov","value":345},{"label":"Dez","value":599}];
const MX = 649;
...
export default function FvaPage() {
    return (
