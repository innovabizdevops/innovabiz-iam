...
const PAGE = "Departmental";
const KPIS = [{"l":"Total Budgeting","v":"€64083","t":"+3.6%","d":"up"},{"l":"Departmental Ativos","v":"8.367","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"70.5%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"65","t":"+0.6%","d":"up"}];
const COLS = ["ID","Departmental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","8.459","4.454","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","3.870","4.966","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","8.467","6.113","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","5.115","8.306","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","2.147","333","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":565},{"label":"Mar","value":834},{"label":"Abr","value":741},{"label":"Mai","value":682},{"label":"Jun","value":595},{"label":"Jul","value":539},{"label":"Ago","value":901},{"label":"Set","value":900},{"label":"Out","value":689},{"label":"Nov","value":645},{"label":"Dez","value":725}];
const MX = 901;
