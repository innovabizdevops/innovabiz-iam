...
const PAGE = "Budget Templates";
const KPIS = [{"l":"Formulários Ativos","v":"1.417","t":"+7.6%","d":"up"},{"l":"Submissões/Dia","v":"2507","t":"+17.9%","d":"up"},{"l":"Documentos Gerados","v":"5.545","t":"+4.3%","d":"up"},{"l":"Templates","v":"8.725","t":"+15.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.855","2026-02-03","6.028","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.672","2026-03-02","3.699","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.253","2026-02-07","8.096","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.248","2026-02-17","706","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","404","2026-03-21","3.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":715},{"label":"Mar","value":812},{"label":"Abr","value":936},{"label":"Mai","value":876},{"label":"Jun","value":923},{"label":"Jul","value":709},{"label":"Ago","value":691},{"label":"Set","value":781},{"label":"Out","value":810},{"label":"Nov","value":716},{"label":"Dez","value":731}];
const MX = 936;
