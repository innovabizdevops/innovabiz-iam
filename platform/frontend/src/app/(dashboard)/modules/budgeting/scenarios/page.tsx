...
const KPIS = [{"l":"Total Budgeting","v":"€97922","t":"+11.7%","d":"up"},{"l":"Scenario Planning Ativos","v":"8.449","t":"+0.2%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"64","t":"+16.0%","d":"up"}];
const COLS = ["ID","Scenario Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Budgeting #001","Budgeting #002","6.232","3.106","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Budgeting #002","Budgeting #003","5.435","1.376","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Budgeting #003","Budgeting #004","5.210","3.612","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Budgeting #004","Budgeting #005","1.279","3.230","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Budgeting #005","Budgeting #001","9.079","4.800","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":565},{"label":"Mar","value":566},{"label":"Abr","value":574},{"label":"Mai","value":420},{"label":"Jun","value":319},{"label":"Jul","value":684},{"label":"Ago","value":540},{"label":"Set","value":682},{"label":"Out","value":373},{"label":"Nov","value":686},{"label":"Dez","value":456}];
const MX = 686;
