...
export default function CirculationSysPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Circulation Sys</h1><p className="text-sm text-muted-foreground">Circulation Sys • iBOS Enterprise</p></div>
