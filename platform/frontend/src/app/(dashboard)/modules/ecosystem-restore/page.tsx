...
export default function EcosystemRestorePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ecosystem Restore</h1><p className="text-sm text-muted-foreground">Ecosystem Restore • iBOS Enterprise</p></div>
