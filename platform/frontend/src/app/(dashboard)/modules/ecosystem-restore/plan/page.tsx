...
const ACCENT = "#6366f1";
const MODULE = "Ecosystem Restoration";
const PAGE = "Plan";
const KPIS = [{"l":"Pedidos/Dia","v":"3016","t":"-2.7%","d":"down"},{"l":"GMV (€)","v":"€96465","t":"+1.9%","d":"up"},{"l":"Conversão (%)","v":"70.2%","t":"+12.2%","d":"up"},{"l":"AOV (€)","v":"€44617","t":"+13.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48362.89","6.027","5.206","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 12371.40","3.103","1.167","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 26779.93","7.588","1.917","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 9544.17","4.481","1.345","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 20184.73","7.361","3.950","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":737},{"label":"Mar","value":869},{"label":"Abr","value":793},{"label":"Mai","value":791},{"label":"Jun","value":716},{"label":"Jul","value":564},{"label":"Ago","value":614},{"label":"Set","value":828},{"label":"Out","value":875},{"label":"Nov","value":857},{"label":"Dez","value":681}];
const MX = 875;
