...
/* ═══ EDGE3 Device Fleet — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "6994", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2840", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€298K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1416855294", cells: ["EDG-4294", "EDGE3 Device Fleet Item 1", "23/7/2026", "€5394"], status: "active" as const },
    { id: "1416858865", cells: ["EDG-7865", "EDGE3 Device Fleet Item 2", "10/2/2026", "€8965"], status: "pending" as const },
    { id: "1416862436", cells: ["EDG-2436", "EDGE3 Device Fleet Item 3", "25/9/2026", "€12 536"], status: "completed" as const },
    { id: "1416866007", cells: ["EDG-6007", "EDGE3 Device Fleet Item 4", "12/4/2026", "€16 107"], status: "warning" as const },
    { id: "1416869578", cells: ["EDG-9578", "EDGE3 Device Fleet Item 5", "27/11/2026", "€19 678"], status: "active" as const },
];
...
export default function Edge3DeviceFleetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Device Fleet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Device Fleet</p>
                    </div>
                </div>
