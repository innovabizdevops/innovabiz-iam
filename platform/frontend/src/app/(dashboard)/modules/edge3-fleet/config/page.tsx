...
const PAGE = "Config";
const KPIS = [{"l":"Configurações","v":"3.369","t":"+5.3%","d":"up"},{"l":"Últimas Alterações","v":"8.869","t":"+2.2%","d":"up"},{"l":"Ambientes","v":"8.525","t":"+3.7%","d":"up"},{"l":"Versão Config","v":"1.228","t":"+17.1%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 8136.80","3.531","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 17406.05","5.126","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 26011.04","309","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 26228.66","392","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 25654.68","4.873","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":715},{"label":"Mar","value":495},{"label":"Abr","value":524},{"label":"Mai","value":669},{"label":"Jun","value":652},{"label":"Jul","value":719},{"label":"Ago","value":436},{"label":"Set","value":513},{"label":"Out","value":706},{"label":"Nov","value":613},{"label":"Dez","value":616}];
const MX = 719;
