...
const ACCENT = "#0f766e";
const MODULE = "EDGE3 Device Fleet";
const PAGE = "Health";
const KPIS = [{"l":"Total Edge3 Fleet","v":"1.378","t":"+2.7%","d":"up"},{"l":"Health Ativos","v":"8.348","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"91.7%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+14.3%","d":"up"}];
const COLS = ["ID","Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Edge3 Fleet #001","Edge3 Fleet #002","8.147","2.699","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Edge3 Fleet #002","Edge3 Fleet #003","1.105","741","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Edge3 Fleet #003","Edge3 Fleet #004","7.288","3.926","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Edge3 Fleet #004","Edge3 Fleet #005","9.030","1.200","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Edge3 Fleet #005","Edge3 Fleet #001","8.888","5.228","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":686},{"label":"Mar","value":1016},{"label":"Abr","value":853},{"label":"Mai","value":779},{"label":"Jun","value":1006},{"label":"Jul","value":1050},{"label":"Ago","value":996},{"label":"Set","value":853},{"label":"Out","value":751},{"label":"Nov","value":1064},{"label":"Dez","value":694}];
const MX = 1064;
