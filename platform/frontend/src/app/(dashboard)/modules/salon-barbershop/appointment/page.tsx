...
const ACCENT = "#6366f1";
const MODULE = "Salon & Barbershop";
const PAGE = "Appointment";
const KPIS = [{"l":"Total Salon Barbershop","v":"935","t":"+8.0%","d":"up"},{"l":"Appointment Ativos","v":"668","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"-4.2%","d":"down"},{"l":"Score Performance","v":"69","t":"-0.5%","d":"down"}];
const COLS = ["ID","Appointment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Salon Barbershop #001","Salon Barbershop #002","8.699","977","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Salon Barbershop #002","Salon Barbershop #003","7.902","5.481","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Salon Barbershop #003","Salon Barbershop #004","1.822","5.714","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Salon Barbershop #004","Salon Barbershop #005","4.017","2.729","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Salon Barbershop #005","Salon Barbershop #001","2.119","3.430","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":868},{"label":"Mar","value":677},{"label":"Abr","value":918},{"label":"Mai","value":649},{"label":"Jun","value":891},{"label":"Jul","value":736},{"label":"Ago","value":707},{"label":"Set","value":847},{"label":"Out","value":572},{"label":"Nov","value":646},{"label":"Dez","value":639}];
const MX = 918;
