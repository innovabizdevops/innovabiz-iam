...
const PAGE = "POS";
const KPIS = [{"l":"Pedidos/Dia","v":"4012","t":"-4.5%","d":"down"},{"l":"GMV (€)","v":"€61756","t":"+14.0%","d":"up"},{"l":"Conversão (%)","v":"78.1%","t":"+15.0%","d":"up"},{"l":"AOV (€)","v":"€64075","t":"+1.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 14572.60","8.589","828","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 36204.94","1.435","177","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 40025.43","1.968","8.678","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 26589.73","3.184","8.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 25743.54","402","1.404","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":882},{"label":"Mar","value":1043},{"label":"Abr","value":840},{"label":"Mai","value":684},{"label":"Jun","value":835},{"label":"Jul","value":778},{"label":"Ago","value":1069},{"label":"Set","value":1063},{"label":"Out","value":1001},{"label":"Nov","value":1005},{"label":"Dez","value":905}];
const MX = 1069;
