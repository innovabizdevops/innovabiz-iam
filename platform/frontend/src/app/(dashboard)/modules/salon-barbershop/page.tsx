...
export default function SalonBarbershopPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Salon Barbershop</h1><p className="text-sm text-muted-foreground">Salon Barbershop • iBOS Enterprise</p></div>
