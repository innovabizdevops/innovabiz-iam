...
const PAGE = "Water Mgmt";
const KPIS = [{"l":"Projetos Melhoria","v":"8.110","t":"+8.7%","d":"up"},{"l":"Savings (€)","v":"€7242","t":"+5.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.8%","t":"-0.1%","d":"down"},{"l":"Ciclos PDCA","v":"8.247","t":"+9.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.308","€ 1739.91","8.798","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.383","€ 49761.93","1.796","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","692","€ 25344.47","7.215","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.460","€ 42696.55","185","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.368","€ 41468.74","7.884","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":501},{"label":"Mar","value":609},{"label":"Abr","value":783},{"label":"Mai","value":515},{"label":"Jun","value":738},{"label":"Jul","value":751},{"label":"Ago","value":767},{"label":"Set","value":477},{"label":"Out","value":609},{"label":"Nov","value":513},{"label":"Dez","value":750}];
const MX = 783;
