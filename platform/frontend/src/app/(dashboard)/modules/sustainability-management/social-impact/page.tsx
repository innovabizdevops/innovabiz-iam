...
const PAGE = "Social Impact";
const KPIS = [{"l":"Projetos Melhoria","v":"1.660","t":"+15.5%","d":"up"},{"l":"Savings (€)","v":"€60745","t":"+12.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.7%","t":"-1.2%","d":"down"},{"l":"Ciclos PDCA","v":"243","t":"+7.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.408","€ 22970.90","8.094","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.968","€ 2836.92","8.695","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.774","€ 15226.88","8.376","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.586","€ 14219.35","1.116","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.436","€ 18959.52","3.955","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":521},{"label":"Mar","value":614},{"label":"Abr","value":577},{"label":"Mai","value":520},{"label":"Jun","value":719},{"label":"Jul","value":715},{"label":"Ago","value":815},{"label":"Set","value":457},{"label":"Out","value":807},{"label":"Nov","value":586},{"label":"Dez","value":807}];
const MX = 815;
