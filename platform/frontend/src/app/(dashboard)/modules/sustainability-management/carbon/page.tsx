...
const KPIS = [{"l":"Projetos Melhoria","v":"4.685","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€93188","t":"+5.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.3%","t":"+13.2%","d":"up"},{"l":"Ciclos PDCA","v":"1.527","t":"-1.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.739","€ 13227.46","5.412","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.809","€ 19649.72","4.474","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.128","€ 3595.28","782","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.779","€ 13740.78","3.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.890","€ 43949.58","1.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":899},{"label":"Mar","value":798},{"label":"Abr","value":914},{"label":"Mai","value":666},{"label":"Jun","value":1033},{"label":"Jul","value":998},{"label":"Ago","value":876},{"label":"Set","value":684},{"label":"Out","value":709},{"label":"Nov","value":766},{"label":"Dez","value":724}];
const MX = 1033;
