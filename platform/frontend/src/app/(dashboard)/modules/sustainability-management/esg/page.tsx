...
const PAGE = "Reporting &amp; Goals";
const KPIS = [{"l":"Projetos Melhoria","v":"2.724","t":"+14.0%","d":"up"},{"l":"Savings (€)","v":"€95321","t":"+17.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.0%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"9.029","t":"+3.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.014","€ 36155.40","941","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.081","€ 21926.40","815","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.130","€ 31122.14","7.511","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.327","€ 13440.86","5.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.965","€ 17688.18","3.137","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":865},{"label":"Mar","value":1014},{"label":"Abr","value":1013},{"label":"Mai","value":1040},{"label":"Jun","value":992},{"label":"Jul","value":916},{"label":"Ago","value":902},{"label":"Set","value":811},{"label":"Out","value":998},{"label":"Nov","value":895},{"label":"Dez","value":662}];
const MX = 1040;
