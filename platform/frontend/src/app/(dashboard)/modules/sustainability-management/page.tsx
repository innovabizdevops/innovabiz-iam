...
export default function SustainabilityManagementPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sustainability Management</h1><p className="text-sm text-muted-foreground">Sustainability Management • iBOS Enterprise</p></div>
