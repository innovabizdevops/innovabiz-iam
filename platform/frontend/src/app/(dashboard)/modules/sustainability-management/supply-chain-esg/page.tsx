...
const ACCENT = "#6366f1";
const MODULE = "Sustainability Management";
const PAGE = "Supply Chain ESG";
const KPIS = [{"l":"Projetos Melhoria","v":"1.551","t":"+10.6%","d":"up"},{"l":"Savings (€)","v":"€17436","t":"-5.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"68.0%","t":"+9.0%","d":"up"},{"l":"Ciclos PDCA","v":"528","t":"+16.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.760","€ 20247.95","3.304","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.961","€ 7857.79","2.450","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.899","€ 32211.58","1.247","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","9.047","€ 21196.05","6.866","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.252","€ 6728.51","6.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":670},{"label":"Mar","value":299},{"label":"Abr","value":392},{"label":"Mai","value":557},{"label":"Jun","value":504},{"label":"Jul","value":605},{"label":"Ago","value":656},{"label":"Set","value":557},{"label":"Out","value":304},{"label":"Nov","value":445},{"label":"Dez","value":394}];
const MX = 670;
...
export default function SupplyChainEsgPage() {
    return (
