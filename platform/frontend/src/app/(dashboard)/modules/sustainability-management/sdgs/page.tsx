...
const PAGE = "SDGs Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"1.290","t":"+10.5%","d":"up"},{"l":"Savings (€)","v":"€52130","t":"+9.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.5%","t":"+11.9%","d":"up"},{"l":"Ciclos PDCA","v":"1.944","t":"+9.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.179","€ 2544.61","5.609","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.858","€ 27935.87","4.967","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.661","€ 12664.94","1.862","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","125","€ 14467.11","1.194","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.493","€ 23448.68","7.329","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":757},{"label":"Fev","value":840},{"label":"Mar","value":768},{"label":"Abr","value":631},{"label":"Mai","value":663},{"label":"Jun","value":554},{"label":"Jul","value":610},{"label":"Ago","value":818},{"label":"Set","value":863},{"label":"Out","value":768},{"label":"Nov","value":786},{"label":"Dez","value":687}];
const MX = 863;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>UN</span></h1>
                </div>
