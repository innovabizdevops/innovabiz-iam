...
const PAGE = "Carbon Tracking";
const KPIS = [{"l":"Projetos Melhoria","v":"2.362","t":"+7.4%","d":"up"},{"l":"Savings (€)","v":"€46920","t":"+16.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"85.0%","t":"-4.1%","d":"down"},{"l":"Ciclos PDCA","v":"7.285","t":"+5.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.805","€ 10003.49","3.056","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.400","€ 41658.21","7.443","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","291","€ 28543.89","8.178","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.881","€ 44904.92","3.226","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.892","€ 38142.23","5.376","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":459},{"label":"Mar","value":472},{"label":"Abr","value":489},{"label":"Mai","value":460},{"label":"Jun","value":733},{"label":"Jul","value":466},{"label":"Ago","value":414},{"label":"Set","value":643},{"label":"Out","value":457},{"label":"Nov","value":524},{"label":"Dez","value":594}];
const MX = 733;
