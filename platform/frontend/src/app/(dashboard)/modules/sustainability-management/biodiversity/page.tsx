...
const KPIS = [{"l":"Projetos Melhoria","v":"1.237","t":"-4.9%","d":"down"},{"l":"Savings (€)","v":"€73171","t":"-1.9%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"75.7%","t":"+7.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.463","t":"+4.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.553","€ 22547.41","4.371","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.098","€ 34569.53","983","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","757","€ 3761.24","3.871","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.296","€ 10480.42","2.336","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.088","€ 36592.78","1.235","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":425},{"label":"Fev","value":493},{"label":"Mar","value":735},{"label":"Abr","value":440},{"label":"Mai","value":524},{"label":"Jun","value":731},{"label":"Jul","value":459},{"label":"Ago","value":424},{"label":"Set","value":637},{"label":"Out","value":458},{"label":"Nov","value":482},{"label":"Dez","value":749}];
const MX = 749;
