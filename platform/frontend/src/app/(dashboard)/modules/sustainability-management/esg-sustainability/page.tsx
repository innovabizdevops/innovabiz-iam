...
const KPIS = [{"l":"Projetos Melhoria","v":"6.361","t":"+7.4%","d":"up"},{"l":"Savings (€)","v":"€88295","t":"-0.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"82.5%","t":"+0.3%","d":"up"},{"l":"Ciclos PDCA","v":"7.398","t":"+1.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.788","€ 32907.75","4.113","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.188","€ 26060.17","8.358","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.994","€ 43622.70","8.410","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.163","€ 48712.40","2.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.593","€ 36440.96","7.889","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":881},{"label":"Mar","value":805},{"label":"Abr","value":867},{"label":"Mai","value":638},{"label":"Jun","value":728},{"label":"Jul","value":926},{"label":"Ago","value":966},{"label":"Set","value":948},{"label":"Out","value":744},{"label":"Nov","value":683},{"label":"Dez","value":1008}];
const MX = 1008;
