...
/* ═══ Quality Management Deep (ISO 9001) — Dashboard ═══ */

const ACCENT = "#064e3b";

const KPIS = [
    { label: "Total Registos", value: "9905", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1925", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€294K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1213858705", cells: ["QUA-2705", "Quality Management Deep (ISO 9001) Item 1", "18/2/2026", "€8805"], status: "active" as const },
    { id: "1213862276", cells: ["QUA-6276", "Quality Management Deep (ISO 9001) Item 2", "5/9/2026", "€12 376"], status: "pending" as const },
    { id: "1213865847", cells: ["QUA-9847", "Quality Management Deep (ISO 9001) Item 3", "20/4/2026", "€15 947"], status: "completed" as const },
    { id: "1213869418", cells: ["QUA-4418", "Quality Management Deep (ISO 9001) Item 4", "7/11/2026", "€19 518"], status: "warning" as const },
    { id: "1213872989", cells: ["QUA-7989", "Quality Management Deep (ISO 9001) Item 5", "22/6/2026", "€23 089"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 85 }, { label: "Fev", value: 94 }, { label: "Mar", value: 23 }, { label: "Abr", value: 32 }, { label: "Mai", value: 41 }, { label: "Jun", value: 50 }];
...
export default function QualityManagementDeepIso9001Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Management Deep (ISO 9001)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Quality Management Deep (ISO 9001)</p>
                    </div>
                </div>
