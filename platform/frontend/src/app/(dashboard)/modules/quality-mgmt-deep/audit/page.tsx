...
const ACCENT = "#064e3b";
const MODULE = "Quality Management Deep (ISO 9001)";
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.988","t":"-1.6%","d":"down"},{"l":"NC Abertas","v":"6.774","t":"+9.7%","d":"up"},{"l":"Conformidade (%)","v":"67.6%","t":"-4.5%","d":"down"},{"l":"CAPAs Pendentes","v":"8.269","t":"+1.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.691","76.2%","4.138","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.404","92.0%","5.219","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.855","94.7%","5.144","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.230","99.1%","6.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.051","82.2%","2.583","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":855},{"label":"Mar","value":671},{"label":"Abr","value":758},{"label":"Mai","value":887},{"label":"Jun","value":902},{"label":"Jul","value":673},{"label":"Ago","value":928},{"label":"Set","value":740},{"label":"Out","value":938},{"label":"Nov","value":700},{"label":"Dez","value":928}];
const MX = 938;
