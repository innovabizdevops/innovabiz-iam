...
const PAGE = "Control";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.652","t":"-2.7%","d":"down"},{"l":"NC Abertas","v":"3.667","t":"+12.5%","d":"up"},{"l":"Conformidade (%)","v":"77.6%","t":"+7.0%","d":"up"},{"l":"CAPAs Pendentes","v":"3.634","t":"-4.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.859","84.2%","4.738","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","836","98.9%","1.873","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.469","70.4%","2.906","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","995","73.0%","6.795","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.021","95.6%","1.347","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":725},{"label":"Mar","value":710},{"label":"Abr","value":753},{"label":"Mai","value":740},{"label":"Jun","value":640},{"label":"Jul","value":660},{"label":"Ago","value":762},{"label":"Set","value":608},{"label":"Out","value":900},{"label":"Nov","value":776},{"label":"Dez","value":842}];
const MX = 900;
