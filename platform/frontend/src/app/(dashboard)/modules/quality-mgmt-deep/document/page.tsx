...
const PAGE = "Document";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.286","t":"-5.8%","d":"down"},{"l":"NC Abertas","v":"8.218","t":"+18.0%","d":"up"},{"l":"Conformidade (%)","v":"91.7%","t":"+3.0%","d":"up"},{"l":"CAPAs Pendentes","v":"761","t":"+6.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.974","98.9%","6.199","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.131","70.7%","1.755","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.451","96.0%","430","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.212","90.2%","6.086","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.068","96.0%","2.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":373},{"label":"Mar","value":520},{"label":"Abr","value":638},{"label":"Mai","value":675},{"label":"Jun","value":322},{"label":"Jul","value":561},{"label":"Ago","value":583},{"label":"Set","value":318},{"label":"Out","value":615},{"label":"Nov","value":389},{"label":"Dez","value":576}];
const MX = 675;
