...
const PAGE = "CAPA";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.103","t":"+15.7%","d":"up"},{"l":"NC Abertas","v":"5.862","t":"-1.2%","d":"down"},{"l":"Conformidade (%)","v":"74.1%","t":"+4.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.731","t":"+12.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.073","79.7%","5.245","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.497","95.3%","7.056","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.602","87.7%","767","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.433","94.4%","584","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.156","96.6%","6.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":729},{"label":"Mar","value":707},{"label":"Abr","value":746},{"label":"Mai","value":640},{"label":"Jun","value":794},{"label":"Jul","value":541},{"label":"Ago","value":799},{"label":"Set","value":761},{"label":"Out","value":916},{"label":"Nov","value":564},{"label":"Dez","value":693}];
const MX = 916;
