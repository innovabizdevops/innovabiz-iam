...
const PAGE = "Plan";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.044","t":"+17.3%","d":"up"},{"l":"NC Abertas","v":"2.978","t":"+2.8%","d":"up"},{"l":"Conformidade (%)","v":"93.9%","t":"+9.5%","d":"up"},{"l":"CAPAs Pendentes","v":"8.664","t":"-3.9%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.853","91.1%","904","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.461","79.1%","5.516","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.032","94.3%","5.789","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.597","88.9%","653","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.839","89.2%","1.120","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":551},{"label":"Mar","value":441},{"label":"Abr","value":707},{"label":"Mai","value":674},{"label":"Jun","value":634},{"label":"Jul","value":436},{"label":"Ago","value":497},{"label":"Set","value":429},{"label":"Out","value":394},{"label":"Nov","value":730},{"label":"Dez","value":404}];
const MX = 730;
