...
const ACCENT = "#475569";
const MODULE = "Space Tourism Ops";
const PAGE = "Flight Ops";
const KPIS = [{"l":"Quartos Ocupados","v":"2.306","t":"+6.9%","d":"up"},{"l":"RevPAR (€)","v":"€30946","t":"+9.9%","d":"up"},{"l":"Ocupação (%)","v":"94.8%","t":"-2.6%","d":"down"},{"l":"Guest Satisfaction","v":"2.456","t":"+14.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.374","2026-03-11","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","218","2026-01-09","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.528","2026-03-16","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.245","2026-02-02","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.537","2026-03-04","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":351},{"label":"Mar","value":382},{"label":"Abr","value":632},{"label":"Mai","value":310},{"label":"Jun","value":346},{"label":"Jul","value":401},{"label":"Ago","value":433},{"label":"Set","value":556},{"label":"Out","value":427},{"label":"Nov","value":603},{"label":"Dez","value":647}];
const MX = 647;
