...
const PAGE = "Medical Clear";
const KPIS = [{"l":"Integrações Ativas","v":"3.806","t":"+14.5%","d":"up"},{"l":"Chamadas/Hora","v":"4430","t":"+3.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.6%","t":"+12.8%","d":"up"},{"l":"Latência Média (ms)","v":"179ms","t":"+16.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.601","4.382","90.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.996","1.678","78.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.190","6.927","97.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.061","8.837","89.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.544","4.219","95.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":877},{"label":"Mar","value":582},{"label":"Abr","value":580},{"label":"Mai","value":858},{"label":"Jun","value":876},{"label":"Jul","value":820},{"label":"Ago","value":918},{"label":"Set","value":787},{"label":"Out","value":861},{"label":"Nov","value":910},{"label":"Dez","value":718}];
const MX = 918;
