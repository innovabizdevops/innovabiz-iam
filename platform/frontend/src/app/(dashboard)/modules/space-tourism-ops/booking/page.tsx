...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"5.482","t":"+6.1%","d":"up"},{"l":"RevPAR (€)","v":"€91266","t":"+15.1%","d":"up"},{"l":"Ocupação (%)","v":"68.3%","t":"+7.3%","d":"up"},{"l":"Guest Satisfaction","v":"1.934","t":"+12.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.914","2026-02-21","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.834","2026-01-09","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.345","2026-03-19","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.393","2026-02-20","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.805","2026-01-13","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":705},{"label":"Mar","value":615},{"label":"Abr","value":737},{"label":"Mai","value":696},{"label":"Jun","value":722},{"label":"Jul","value":579},{"label":"Ago","value":568},{"label":"Set","value":687},{"label":"Out","value":550},{"label":"Nov","value":780},{"label":"Dez","value":838}];
const MX = 838;
