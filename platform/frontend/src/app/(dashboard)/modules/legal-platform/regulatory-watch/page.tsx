...
/* ═══ Legal Platform — Regulatory Watch ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4505", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1323", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1356310861", cells: ["LEG-2861", "Regulatory Watch Item 1", "18/2/2026", "€10 961"], status: "active" as const },
    { id: "1356314432", cells: ["LEG-6432", "Regulatory Watch Item 2", "5/9/2026", "€14 532"], status: "pending" as const },
    { id: "1356318003", cells: ["LEG-1003", "Regulatory Watch Item 3", "20/4/2026", "€18 103"], status: "completed" as const },
    { id: "1356321574", cells: ["LEG-4574", "Regulatory Watch Item 4", "7/11/2026", "€21 674"], status: "warning" as const },
    { id: "1356325145", cells: ["LEG-8145", "Regulatory Watch Item 5", "22/6/2026", "€25 245"], status: "active" as const },
];
...
export default function LegalPlatformRegulatoryWatchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Watch</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Regulatory Watch</p>
                    </div>
                </div>
