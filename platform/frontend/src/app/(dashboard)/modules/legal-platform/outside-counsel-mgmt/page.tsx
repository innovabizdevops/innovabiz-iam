...
/* ═══ Legal Platform — Outside Counsel Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4910", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "87", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "982", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "84%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "482748467", cells: ["LEG-7467", "Outside Counsel Mgmt Item 1", "20/12/2026", "€48 567"], status: "active" as const },
    { id: "482752038", cells: ["LEG-2038", "Outside Counsel Mgmt Item 2", "7/7/2026", "€2138"], status: "pending" as const },
    { id: "482755609", cells: ["LEG-5609", "Outside Counsel Mgmt Item 3", "22/2/2026", "€5709"], status: "completed" as const },
    { id: "482759180", cells: ["LEG-9180", "Outside Counsel Mgmt Item 4", "9/9/2026", "€9280"], status: "warning" as const },
    { id: "482762751", cells: ["LEG-3751", "Outside Counsel Mgmt Item 5", "24/4/2026", "€12 851"], status: "active" as const },
];
...
export default function LegalPlatformOutsideCounselMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Outside Counsel Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Outside Counsel Mgmt</p>
                    </div>
                </div>
