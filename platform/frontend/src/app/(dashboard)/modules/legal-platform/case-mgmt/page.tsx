...
/* ═══ Legal Platform — Case Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "278", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "367", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3626", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1524609643", cells: ["LEG-1643", "Case Mgmt Item 1", "12/8/2026", "€9743"], status: "active" as const },
    { id: "1524613214", cells: ["LEG-5214", "Case Mgmt Item 2", "27/3/2026", "€13 314"], status: "pending" as const },
    { id: "1524616785", cells: ["LEG-8785", "Case Mgmt Item 3", "14/10/2026", "€16 885"], status: "completed" as const },
    { id: "1524620356", cells: ["LEG-3356", "Case Mgmt Item 4", "1/5/2026", "€20 456"], status: "warning" as const },
    { id: "1524623927", cells: ["LEG-6927", "Case Mgmt Item 5", "16/12/2026", "€24 027"], status: "active" as const },
];
...
export default function LegalPlatformCaseMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Case Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Case Mgmt</p>
                    </div>
                </div>
