...
/* ═══ Legal Platform — Matter Intake ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "623", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "159", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2439", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "327072987", cells: ["LEG-4987", "Matter Intake Item 1", "4/4/2026", "€23 087"], status: "active" as const },
    { id: "327076558", cells: ["LEG-8558", "Matter Intake Item 2", "19/11/2026", "€26 658"], status: "pending" as const },
    { id: "327080129", cells: ["LEG-3129", "Matter Intake Item 3", "6/6/2026", "€30 229"], status: "completed" as const },
    { id: "327083700", cells: ["LEG-6700", "Matter Intake Item 4", "21/1/2026", "€33 800"], status: "warning" as const },
    { id: "327087271", cells: ["LEG-1271", "Matter Intake Item 5", "8/8/2026", "€37 371"], status: "active" as const },
];
...
export default function LegalPlatformMatterIntakePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Matter Intake</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Matter Intake</p>
                    </div>
                </div>
