...
/* ═══ Legal Platform — Entity Mgmt ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4922", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "28", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3775", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1984724200", cells: ["LEG-9200", "Entity Mgmt Item 1", "5/5/2026", "€24 300"], status: "active" as const },
    { id: "1984727771", cells: ["LEG-3771", "Entity Mgmt Item 2", "20/12/2026", "€27 871"], status: "pending" as const },
    { id: "1984731342", cells: ["LEG-7342", "Entity Mgmt Item 3", "7/7/2026", "€31 442"], status: "completed" as const },
    { id: "1984734913", cells: ["LEG-1913", "Entity Mgmt Item 4", "22/2/2026", "€35 013"], status: "warning" as const },
    { id: "1984738484", cells: ["LEG-5484", "Entity Mgmt Item 5", "9/9/2026", "€38 584"], status: "active" as const },
];
...
export default function LegalPlatformEntityMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Entity Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Entity Mgmt</p>
                    </div>
                </div>
