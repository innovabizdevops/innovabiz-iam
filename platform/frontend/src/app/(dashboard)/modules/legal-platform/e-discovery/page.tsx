...
/* ═══ Legal Platform — E Discovery ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "3239", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "373", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "204", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "126271569", cells: ["LEG-2569", "E Discovery Item 1", "26/10/2026", "€21 669"], status: "active" as const },
    { id: "126275140", cells: ["LEG-6140", "E Discovery Item 2", "13/5/2026", "€25 240"], status: "pending" as const },
    { id: "126278711", cells: ["LEG-9711", "E Discovery Item 3", "28/12/2026", "€28 811"], status: "completed" as const },
    { id: "126282282", cells: ["LEG-4282", "E Discovery Item 4", "15/7/2026", "€32 382"], status: "warning" as const },
    { id: "126285853", cells: ["LEG-7853", "E Discovery Item 5", "2/2/2026", "€35 953"], status: "active" as const },
];
...
export default function LegalPlatformEDiscoveryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">E Discovery</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • E Discovery</p>
                    </div>
                </div>
