...
/* ═══ Legal Platform — Legal Research ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1794", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "252", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3025", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1439401192", cells: ["LEG-5192", "Legal Research Item 1", "13/5/2026", "€1292"], status: "active" as const },
    { id: "1439404763", cells: ["LEG-8763", "Legal Research Item 2", "28/12/2026", "€4863"], status: "pending" as const },
    { id: "1439408334", cells: ["LEG-3334", "Legal Research Item 3", "15/7/2026", "€8434"], status: "completed" as const },
    { id: "1439411905", cells: ["LEG-6905", "Legal Research Item 4", "2/2/2026", "€12 005"], status: "warning" as const },
    { id: "1439415476", cells: ["LEG-1476", "Legal Research Item 5", "17/9/2026", "€15 576"], status: "active" as const },
];
...
export default function LegalPlatformLegalResearchPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legal Research</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Legal Research</p>
                    </div>
                </div>
