...
/* ═══ Legal Platform — Ip Portfolio ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4783", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "297", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1022", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1770939541", cells: ["LEG-1541", "Ip Portfolio Item 1", "22/2/2026", "€39 641"], status: "active" as const },
    { id: "1770943112", cells: ["LEG-5112", "Ip Portfolio Item 2", "9/9/2026", "€43 212"], status: "pending" as const },
    { id: "1770946683", cells: ["LEG-8683", "Ip Portfolio Item 3", "24/4/2026", "€46 783"], status: "completed" as const },
    { id: "1770950254", cells: ["LEG-3254", "Ip Portfolio Item 4", "11/11/2026", "€354"], status: "warning" as const },
    { id: "1770953825", cells: ["LEG-6825", "Ip Portfolio Item 5", "26/6/2026", "€3925"], status: "active" as const },
];
...
export default function LegalPlatformIpPortfolioPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Ip Portfolio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Ip Portfolio</p>
                    </div>
                </div>
