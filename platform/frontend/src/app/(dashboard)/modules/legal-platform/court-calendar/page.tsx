...
/* ═══ Legal Platform — Court Calendar ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "1918", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "155", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3597", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1315349511", cells: ["LEG-9511", "Court Calendar Item 1", "8/4/2026", "€49 611"], status: "active" as const },
    { id: "1315353082", cells: ["LEG-4082", "Court Calendar Item 2", "23/11/2026", "€3182"], status: "pending" as const },
    { id: "1315356653", cells: ["LEG-7653", "Court Calendar Item 3", "10/6/2026", "€6753"], status: "completed" as const },
    { id: "1315360224", cells: ["LEG-2224", "Court Calendar Item 4", "25/1/2026", "€10 324"], status: "warning" as const },
    { id: "1315363795", cells: ["LEG-5795", "Court Calendar Item 5", "12/8/2026", "€13 895"], status: "active" as const },
];
...
export default function LegalPlatformCourtCalendarPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Court Calendar</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Court Calendar</p>
                    </div>
                </div>
