...
/* ═══ Legal Platform — Legal Billing ═══ */

const ACCENT = "#7c3aed";

const KPIS = [
    { label: "Total", value: "4838", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "98", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1178", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1887584654", cells: ["LEG-6654", "Legal Billing Item 1", "19/3/2026", "€34 754"], status: "active" as const },
    { id: "1887588225", cells: ["LEG-1225", "Legal Billing Item 2", "6/10/2026", "€38 325"], status: "pending" as const },
    { id: "1887591796", cells: ["LEG-4796", "Legal Billing Item 3", "21/5/2026", "€41 896"], status: "completed" as const },
    { id: "1887595367", cells: ["LEG-8367", "Legal Billing Item 4", "8/12/2026", "€45 467"], status: "warning" as const },
    { id: "1887598938", cells: ["LEG-2938", "Legal Billing Item 5", "23/7/2026", "€49 038"], status: "active" as const },
];
...
export default function LegalPlatformLegalBillingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Legal Billing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Legal Platform • Legal Billing</p>
                    </div>
                </div>
