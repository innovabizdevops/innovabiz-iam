...
const ACCENT = "#6366f1";
const MODULE = "Retail Analytics";
const PAGE = "Basket";
const KPIS = [{"l":"Pedidos/Dia","v":"2182","t":"+7.6%","d":"up"},{"l":"GMV (€)","v":"€38709","t":"-5.0%","d":"down"},{"l":"Conversão (%)","v":"73.0%","t":"+11.7%","d":"up"},{"l":"AOV (€)","v":"€43788","t":"+9.9%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 21454.59","3.101","2.473","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 3782.12","8.550","2.059","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 1810.87","4.779","8.613","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40505.70","2.787","6.395","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 42015.75","6.968","4.989","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":849},{"label":"Mar","value":887},{"label":"Abr","value":731},{"label":"Mai","value":976},{"label":"Jun","value":989},{"label":"Jul","value":705},{"label":"Ago","value":942},{"label":"Set","value":1069},{"label":"Out","value":854},{"label":"Nov","value":956},{"label":"Dez","value":775}];
const MX = 1069;
