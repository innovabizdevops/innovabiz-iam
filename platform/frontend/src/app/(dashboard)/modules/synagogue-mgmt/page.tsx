...
/* ═══ Synagogue Management — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "3291", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2376", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€57K", trend: "-5%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "22080191", cells: ["SYN-4191", "Synagogue Management Item 1", "8/12/2026", "€30 291"], status: "active" as const },
    { id: "22083762", cells: ["SYN-7762", "Synagogue Management Item 2", "23/7/2026", "€33 862"], status: "pending" as const },
    { id: "22087333", cells: ["SYN-2333", "Synagogue Management Item 3", "10/2/2026", "€37 433"], status: "completed" as const },
    { id: "22090904", cells: ["SYN-5904", "Synagogue Management Item 4", "25/9/2026", "€41 004"], status: "warning" as const },
    { id: "22094475", cells: ["SYN-9475", "Synagogue Management Item 5", "12/4/2026", "€44 575"], status: "active" as const },
];
...
export default function SynagogueManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Synagogue Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Synagogue Management</p>
                    </div>
                </div>
