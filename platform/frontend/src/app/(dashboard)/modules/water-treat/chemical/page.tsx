...
const PAGE = "Chemical";
const KPIS = [{"l":"Total Water Treat","v":"3.738","t":"+15.8%","d":"up"},{"l":"Chemical Ativos","v":"8.475","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+17.5%","d":"up"}];
const COLS = ["ID","Chemical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Treat #001","Water Treat #002","402","7.505","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Water Treat #002","Water Treat #003","4.268","7.178","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Treat #003","Water Treat #004","7.108","702","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Water Treat #004","Water Treat #005","2.643","2.723","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Treat #005","Water Treat #001","7.881","4.483","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":916},{"label":"Fev","value":863},{"label":"Mar","value":814},{"label":"Abr","value":918},{"label":"Mai","value":792},{"label":"Jun","value":810},{"label":"Jul","value":808},{"label":"Ago","value":577},{"label":"Set","value":583},{"label":"Out","value":566},{"label":"Nov","value":736},{"label":"Dez","value":842}];
const MX = 918;
