...
const KPIS = [{"l":"Total Water Treat","v":"7.168","t":"+17.7%","d":"up"},{"l":"Filtration Ativos","v":"873","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.6%","d":"up"}];
const COLS = ["ID","Filtration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Treat #001","Water Treat #002","5.885","4.070","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Water Treat #002","Water Treat #003","7.412","2.827","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Treat #003","Water Treat #004","4.461","107","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Water Treat #004","Water Treat #005","6.889","8.320","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Treat #005","Water Treat #001","4.989","6.130","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":549},{"label":"Mar","value":447},{"label":"Abr","value":558},{"label":"Mai","value":637},{"label":"Jun","value":547},{"label":"Jul","value":435},{"label":"Ago","value":534},{"label":"Set","value":446},{"label":"Out","value":280},{"label":"Nov","value":369},{"label":"Dez","value":646}];
const MX = 646;
