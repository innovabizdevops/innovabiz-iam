...
const PAGE = "SCADA";
const KPIS = [{"l":"Dispositivos Online","v":"4.865","t":"+13.8%","d":"up"},{"l":"Dados/Min (MB)","v":"374","t":"+5.1%","d":"up"},{"l":"Alertas Ativos","v":"5.236","t":"+4.4%","d":"up"},{"l":"Uptime (%)","v":"88.2%","t":"+2.0%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","542","6.110","5.199","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","373","6.516","7.932","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.928","5.158","4.268","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.777","6.717","1.354","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.468","5.192","8.612","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":627},{"label":"Fev","value":570},{"label":"Mar","value":630},{"label":"Abr","value":628},{"label":"Mai","value":571},{"label":"Jun","value":756},{"label":"Jul","value":566},{"label":"Ago","value":712},{"label":"Set","value":804},{"label":"Out","value":612},{"label":"Nov","value":486},{"label":"Dez","value":500}];
const MX = 804;
