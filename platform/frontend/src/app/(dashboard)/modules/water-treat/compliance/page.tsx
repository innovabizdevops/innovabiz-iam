...
const KPIS = [{"l":"Auditorias Realizadas","v":"4.865","t":"-3.5%","d":"down"},{"l":"NC Abertas","v":"719","t":"+12.8%","d":"up"},{"l":"Conformidade (%)","v":"88.5%","t":"-1.8%","d":"down"},{"l":"CAPAs Pendentes","v":"8.889","t":"+3.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.858","86.9%","1.036","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.283","99.0%","1.566","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.283","92.1%","4.741","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.494","84.9%","7.141","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","809","88.5%","7.290","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":681},{"label":"Mar","value":842},{"label":"Abr","value":733},{"label":"Mai","value":833},{"label":"Jun","value":555},{"label":"Jul","value":624},{"label":"Ago","value":601},{"label":"Set","value":597},{"label":"Out","value":768},{"label":"Nov","value":519},{"label":"Dez","value":583}];
const MX = 842;
