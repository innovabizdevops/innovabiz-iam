...
const KPIS = [{"l":"Total Utilization Mgmt","v":"211","t":"+4.2%","d":"up"},{"l":"Benchmark Ativos","v":"6.748","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"67.4%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+4.0%","d":"up"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilization Mgmt #001","Utilization Mgmt #002","8.362","1.002","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Utilization Mgmt #002","Utilization Mgmt #003","6.271","6.955","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilization Mgmt #003","Utilization Mgmt #004","3.938","8.610","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Utilization Mgmt #004","Utilization Mgmt #005","8.335","6.529","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilization Mgmt #005","Utilization Mgmt #001","5.289","5.911","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":882},{"label":"Mar","value":966},{"label":"Abr","value":591},{"label":"Mai","value":795},{"label":"Jun","value":706},{"label":"Jul","value":923},{"label":"Ago","value":683},{"label":"Set","value":740},{"label":"Out","value":642},{"label":"Nov","value":912},{"label":"Dez","value":657}];
const MX = 966;
