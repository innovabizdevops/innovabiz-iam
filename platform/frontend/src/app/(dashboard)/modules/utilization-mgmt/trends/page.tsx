...
const PAGE = "Trend Chart";
const KPIS = [{"l":"Total Utilization Mgmt","v":"8.044","t":"+11.2%","d":"up"},{"l":"Trend Chart Ativos","v":"3.528","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"65.1%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+4.3%","d":"up"}];
const COLS = ["ID","Trend Chart","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilization Mgmt #001","Utilization Mgmt #002","5.512","4.687","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Utilization Mgmt #002","Utilization Mgmt #003","972","2.091","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilization Mgmt #003","Utilization Mgmt #004","3.603","1.613","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Utilization Mgmt #004","Utilization Mgmt #005","7.377","805","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilization Mgmt #005","Utilization Mgmt #001","3.589","3.752","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":650},{"label":"Mar","value":540},{"label":"Abr","value":730},{"label":"Mai","value":726},{"label":"Jun","value":851},{"label":"Jul","value":753},{"label":"Ago","value":920},{"label":"Set","value":804},{"label":"Out","value":788},{"label":"Nov","value":540},{"label":"Dez","value":713}];
const MX = 920;
