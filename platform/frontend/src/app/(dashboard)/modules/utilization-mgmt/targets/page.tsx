...
const ACCENT = "#7c3aed";
const MODULE = "Utilization Mgmt";
const PAGE = "Target Set";
const KPIS = [{"l":"Total Utilization Mgmt","v":"4.358","t":"+8.7%","d":"up"},{"l":"Target Set Ativos","v":"6.557","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.2%","d":"up"}];
const COLS = ["ID","Target Set","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Utilization Mgmt #001","Utilization Mgmt #002","1.656","5.677","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Utilization Mgmt #002","Utilization Mgmt #003","8.710","4.440","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Utilization Mgmt #003","Utilization Mgmt #004","639","3.596","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Utilization Mgmt #004","Utilization Mgmt #005","7.642","5.435","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Utilization Mgmt #005","Utilization Mgmt #001","2.496","7.465","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":333},{"label":"Mar","value":480},{"label":"Abr","value":327},{"label":"Mai","value":327},{"label":"Jun","value":442},{"label":"Jul","value":398},{"label":"Ago","value":538},{"label":"Set","value":601},{"label":"Out","value":331},{"label":"Nov","value":639},{"label":"Dez","value":552}];
const MX = 639;
