...
/* ═══ Enterprise Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "6257", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4044", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€429K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "919448857", cells: ["EA-9857", "Enterprise Architecture (TOGAF) Item 1", "6/2/2026", "€48 957"], status: "active" as const },
    { id: "919452428", cells: ["EA-4428", "Enterprise Architecture (TOGAF) Item 2", "21/9/2026", "€2528"], status: "pending" as const },
    { id: "919455999", cells: ["EA-7999", "Enterprise Architecture (TOGAF) Item 3", "8/4/2026", "€6099"], status: "completed" as const },
    { id: "919459570", cells: ["EA-2570", "Enterprise Architecture (TOGAF) Item 4", "23/11/2026", "€9670"], status: "warning" as const },
    { id: "919463141", cells: ["EA-6141", "Enterprise Architecture (TOGAF) Item 5", "10/6/2026", "€13 241"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 77 }, { label: "Fev", value: 86 }, { label: "Mar", value: 95 }, { label: "Abr", value: 24 }, { label: "Mai", value: 33 }, { label: "Jun", value: 42 }];
...
export default function EnterpriseArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Enterprise Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Enterprise Architecture (TOGAF)</p>
                    </div>
                </div>
