...
const PAGE = "ADM";
const KPIS = [{"l":"Total Ea Togaf","v":"5.532","t":"+4.0%","d":"up"},{"l":"ADM Ativos","v":"8.633","t":"-2.1%","d":"down"},{"l":"Eficiência (%)","v":"89.3%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"80","t":"-1.6%","d":"down"}];
const COLS = ["ID","ADM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ea Togaf #001","Ea Togaf #002","4.687","1.186","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ea Togaf #002","Ea Togaf #003","7.568","5.558","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Ea Togaf #003","Ea Togaf #004","7.759","7.441","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Ea Togaf #004","Ea Togaf #005","1.259","8.352","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ea Togaf #005","Ea Togaf #001","2.440","7.731","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":612},{"label":"Mar","value":533},{"label":"Abr","value":756},{"label":"Mai","value":504},{"label":"Jun","value":518},{"label":"Jul","value":399},{"label":"Ago","value":409},{"label":"Set","value":435},{"label":"Out","value":745},{"label":"Nov","value":667},{"label":"Dez","value":754}];
const MX = 756;
