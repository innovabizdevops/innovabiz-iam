...
const ACCENT = "#0891b2";
const MODULE = "Enterprise Architecture (TOGAF)";
const PAGE = "Governance";
const KPIS = [{"l":"Riscos Identificados","v":"4.171","t":"+8.6%","d":"up"},{"l":"Mitigações Ativas","v":"1.156","t":"+13.0%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+16.6%","d":"up"},{"l":"Incidentes YTD","v":"7.176","t":"+2.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.895","2.993","5.979","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.867","1.762","153","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.072","4.773","7.029","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.549","5.363","6.441","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.012","2.232","8.748","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":340},{"label":"Fev","value":599},{"label":"Mar","value":302},{"label":"Abr","value":343},{"label":"Mai","value":513},{"label":"Jun","value":523},{"label":"Jul","value":600},{"label":"Ago","value":324},{"label":"Set","value":320},{"label":"Out","value":607},{"label":"Nov","value":552},{"label":"Dez","value":267}];
const MX = 607;
