...
const KPIS = [{"l":"Dashboards Ativos","v":"6.535","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"3006","t":"-2.2%","d":"down"},{"l":"Dados Processados (GB)","v":"8.642","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"618","t":"-4.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4698","2026-02-16","8.964","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1281","2026-02-23","6.880","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3753","2026-01-03","7.614","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3118","2026-03-13","1.742","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","622","2026-03-07","3.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":435},{"label":"Mar","value":647},{"label":"Abr","value":499},{"label":"Mai","value":700},{"label":"Jun","value":556},{"label":"Jul","value":711},{"label":"Ago","value":422},{"label":"Set","value":657},{"label":"Out","value":696},{"label":"Nov","value":460},{"label":"Dez","value":484}];
const MX = 711;
