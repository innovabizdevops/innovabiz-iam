...
const ACCENT = "#6366f1";
const MODULE = "Membership Mgmt";
const PAGE = "Dues";
const KPIS = [{"l":"Total Membership Ngo","v":"4.308","t":"+4.5%","d":"up"},{"l":"Dues Ativos","v":"3.994","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"73","t":"-0.9%","d":"down"}];
const COLS = ["ID","Dues","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Membership Ngo #001","Membership Ngo #002","8.343","6.896","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Membership Ngo #002","Membership Ngo #003","2.258","464","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Membership Ngo #003","Membership Ngo #004","2.928","8.363","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Membership Ngo #004","Membership Ngo #005","6.243","2.179","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Membership Ngo #005","Membership Ngo #001","6.455","1.955","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":603},{"label":"Mar","value":588},{"label":"Abr","value":620},{"label":"Mai","value":513},{"label":"Jun","value":706},{"label":"Jul","value":495},{"label":"Ago","value":729},{"label":"Set","value":595},{"label":"Out","value":642},{"label":"Nov","value":637},{"label":"Dez","value":455}];
const MX = 729;
