...
export default function MembershipNgoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Membership Ngo</h1><p className="text-sm text-muted-foreground">Membership Ngo • iBOS Enterprise</p></div>
