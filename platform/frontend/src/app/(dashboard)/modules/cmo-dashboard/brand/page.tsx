...
const PAGE = "Brand";
const KPIS = [{"l":"Teams Ativos","v":"2.242","t":"+6.6%","d":"up"},{"l":"Reuniões/Semana","v":"959","t":"+0.1%","d":"up"},{"l":"Mensagens/Dia","v":"1292","t":"+11.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"4.211","t":"+15.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.592","3929","4.295","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.695","520","4.862","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","815","761","1.607","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.422","4642","8.109","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","5.649","2787","705","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1066},{"label":"Fev","value":774},{"label":"Mar","value":1047},{"label":"Abr","value":883},{"label":"Mai","value":1072},{"label":"Jun","value":932},{"label":"Jul","value":1060},{"label":"Ago","value":676},{"label":"Set","value":962},{"label":"Out","value":729},{"label":"Nov","value":881},{"label":"Dez","value":789}];
const MX = 1072;
