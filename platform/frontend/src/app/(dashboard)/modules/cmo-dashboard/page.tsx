...
/* ═══ CMO Dashboard — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "1627", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2811", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€275K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1282378227", cells: ["CMO-5227", "CMO Dashboard Item 1", "12/4/2026", "€28 327"], status: "active" as const },
    { id: "1282381798", cells: ["CMO-8798", "CMO Dashboard Item 2", "27/11/2026", "€31 898"], status: "pending" as const },
    { id: "1282385369", cells: ["CMO-3369", "CMO Dashboard Item 3", "14/6/2026", "€35 469"], status: "completed" as const },
    { id: "1282388940", cells: ["CMO-6940", "CMO Dashboard Item 4", "1/1/2026", "€39 040"], status: "warning" as const },
    { id: "1282392511", cells: ["CMO-1511", "CMO Dashboard Item 5", "16/8/2026", "€42 611"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CMO Dashboard</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CMO Dashboard</p>
                    </div>
                </div>
