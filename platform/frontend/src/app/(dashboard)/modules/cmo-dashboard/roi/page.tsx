...
const ACCENT = "#1e293b";
const MODULE = "CMO Dashboard";
const PAGE = "ROI";
const KPIS = [{"l":"Teams Ativos","v":"7.732","t":"-1.8%","d":"down"},{"l":"Reuniões/Semana","v":"3652","t":"+16.2%","d":"up"},{"l":"Mensagens/Dia","v":"3076","t":"-1.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"8.446","t":"+1.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","693","749","1.408","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.090","4987","6.423","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.380","2837","9.030","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","1.587","893","5.669","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.731","4662","8.350","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":567},{"label":"Mar","value":270},{"label":"Abr","value":481},{"label":"Mai","value":396},{"label":"Jun","value":438},{"label":"Jul","value":372},{"label":"Ago","value":590},{"label":"Set","value":509},{"label":"Out","value":480},{"label":"Nov","value":441},{"label":"Dez","value":634}];
const MX = 634;
