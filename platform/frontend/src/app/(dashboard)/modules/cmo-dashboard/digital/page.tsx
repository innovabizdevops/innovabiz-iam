...
const PAGE = "Digital";
const KPIS = [{"l":"Teams Ativos","v":"331","t":"+3.5%","d":"up"},{"l":"Reuniões/Semana","v":"1155","t":"-2.4%","d":"down"},{"l":"Mensagens/Dia","v":"3931","t":"-1.1%","d":"down"},{"l":"Ficheiros Partilhados","v":"8.605","t":"+7.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","7.254","1643","7.364","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","7.581","1274","2.574","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","328","523","5.257","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.690","2689","4.872","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","2.723","2641","3.384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":634},{"label":"Mar","value":597},{"label":"Abr","value":751},{"label":"Mai","value":717},{"label":"Jun","value":675},{"label":"Jul","value":607},{"label":"Ago","value":787},{"label":"Set","value":676},{"label":"Out","value":679},{"label":"Nov","value":792},{"label":"Dez","value":814}];
const MX = 814;
