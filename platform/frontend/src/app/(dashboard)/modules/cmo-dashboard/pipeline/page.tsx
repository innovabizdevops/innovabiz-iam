...
const PAGE = "Pipeline";
const KPIS = [{"l":"Teams Ativos","v":"4.539","t":"+12.2%","d":"up"},{"l":"Reuniões/Semana","v":"4039","t":"-5.0%","d":"down"},{"l":"Mensagens/Dia","v":"2955","t":"+17.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.232","t":"+7.9%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.373","3183","5.543","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","3.318","4942","2.312","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.196","4704","5.041","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","6.209","2831","4.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","625","4610","5.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":814},{"label":"Mar","value":836},{"label":"Abr","value":717},{"label":"Mai","value":479},{"label":"Jun","value":642},{"label":"Jul","value":769},{"label":"Ago","value":647},{"label":"Set","value":817},{"label":"Out","value":540},{"label":"Nov","value":764},{"label":"Dez","value":591}];
const MX = 836;
