...
const PAGE = "Test";
const KPIS = [{"l":"Integrações Ativas","v":"5.515","t":"+0.6%","d":"up"},{"l":"Chamadas/Hora","v":"411","t":"+16.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.6%","t":"+15.2%","d":"up"},{"l":"Latência Média (ms)","v":"13ms","t":"+7.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.105","4.221","89.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.193","6.478","81.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","3.108","7.595","80.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.199","4.666","80.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.262","2.026","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":1023},{"label":"Mar","value":1045},{"label":"Abr","value":974},{"label":"Mai","value":864},{"label":"Jun","value":833},{"label":"Jul","value":744},{"label":"Ago","value":952},{"label":"Set","value":967},{"label":"Out","value":1056},{"label":"Nov","value":984},{"label":"Dez","value":1005}];
const MX = 1056;
