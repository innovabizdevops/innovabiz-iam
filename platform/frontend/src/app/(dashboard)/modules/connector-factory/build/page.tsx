...
const PAGE = "Build";
const KPIS = [{"l":"Integrações Ativas","v":"645","t":"+11.9%","d":"up"},{"l":"Chamadas/Hora","v":"3791","t":"-2.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"91.1%","t":"-2.0%","d":"down"},{"l":"Latência Média (ms)","v":"107ms","t":"+5.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.851","5.788","72.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.678","5.441","73.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.718","9.044","93.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.840","7.988","86.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.737","144","96.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":503},{"label":"Mar","value":622},{"label":"Abr","value":613},{"label":"Mai","value":774},{"label":"Jun","value":642},{"label":"Jul","value":559},{"label":"Ago","value":780},{"label":"Set","value":562},{"label":"Out","value":765},{"label":"Nov","value":624},{"label":"Dez","value":572}];
const MX = 855;
