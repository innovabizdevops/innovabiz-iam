...
const PAGE = "Publish";
const KPIS = [{"l":"Integrações Ativas","v":"1.543","t":"+11.8%","d":"up"},{"l":"Chamadas/Hora","v":"4558","t":"+4.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"82.4%","t":"+13.1%","d":"up"},{"l":"Latência Média (ms)","v":"100ms","t":"+11.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.363","3.433","84.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.254","1.542","89.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","153","8.394","75.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.163","7.165","80.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.046","6.276","78.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":436},{"label":"Mar","value":680},{"label":"Abr","value":620},{"label":"Mai","value":601},{"label":"Jun","value":599},{"label":"Jul","value":674},{"label":"Ago","value":801},{"label":"Set","value":584},{"label":"Out","value":418},{"label":"Nov","value":586},{"label":"Dez","value":806}];
const MX = 806;
