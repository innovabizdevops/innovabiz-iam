...
const PAGE = "Config";
const KPIS = [{"l":"Integrações Ativas","v":"2.201","t":"+11.0%","d":"up"},{"l":"Chamadas/Hora","v":"151","t":"+0.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.7%","t":"+15.9%","d":"up"},{"l":"Latência Média (ms)","v":"21ms","t":"+9.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.188","7.428","88.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.098","481","98.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.308","6.845","91.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.388","8.371","96.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","730","4.851","92.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":275},{"label":"Mar","value":599},{"label":"Abr","value":317},{"label":"Mai","value":347},{"label":"Jun","value":351},{"label":"Jul","value":317},{"label":"Ago","value":315},{"label":"Set","value":535},{"label":"Out","value":385},{"label":"Nov","value":415},{"label":"Dez","value":455}];
const MX = 599;
