...
const ACCENT = "#0d9488";
const MODULE = "Connector Factory";
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"7.605","t":"+13.6%","d":"up"},{"l":"Submissões/Dia","v":"4940","t":"-1.1%","d":"down"},{"l":"Documentos Gerados","v":"8.231","t":"-1.3%","d":"down"},{"l":"Templates","v":"5.895","t":"+15.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.406","2026-03-12","3.171","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.404","2026-02-24","6.797","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","101","2026-03-26","8.282","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.255","2026-02-16","8.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.159","2026-01-17","8.987","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":775},{"label":"Mar","value":994},{"label":"Abr","value":1001},{"label":"Mai","value":639},{"label":"Jun","value":706},{"label":"Jul","value":967},{"label":"Ago","value":1006},{"label":"Set","value":853},{"label":"Out","value":890},{"label":"Nov","value":983},{"label":"Dez","value":910}];
const MX = 1006;
