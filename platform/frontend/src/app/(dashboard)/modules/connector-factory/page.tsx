...
/* ═══ Connector Factory — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "4363", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "194", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€266K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1233128463", cells: ["CON-3463", "Connector Factory Item 1", "8/4/2026", "€28 563"], status: "active" as const },
    { id: "1233132034", cells: ["CON-7034", "Connector Factory Item 2", "23/11/2026", "€32 134"], status: "pending" as const },
    { id: "1233135605", cells: ["CON-1605", "Connector Factory Item 3", "10/6/2026", "€35 705"], status: "completed" as const },
    { id: "1233139176", cells: ["CON-5176", "Connector Factory Item 4", "25/1/2026", "€39 276"], status: "warning" as const },
    { id: "1233142747", cells: ["CON-8747", "Connector Factory Item 5", "12/8/2026", "€42 847"], status: "active" as const },
];
...
export default function ConnectorFactoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Connector Factory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Connector Factory</p>
                    </div>
                </div>
