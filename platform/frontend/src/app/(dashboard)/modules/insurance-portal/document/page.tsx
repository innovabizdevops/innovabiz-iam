...
const ACCENT = "#92400e";
const MODULE = "Insurance Customer Portal";
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"8.115","t":"+6.0%","d":"up"},{"l":"Submissões/Dia","v":"2120","t":"+5.2%","d":"up"},{"l":"Documentos Gerados","v":"1.581","t":"+8.8%","d":"up"},{"l":"Templates","v":"328","t":"+7.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.695","2026-01-27","3.145","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.445","2026-03-21","1.340","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.851","2026-02-17","1.757","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.697","2026-02-28","3.099","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.670","2026-01-19","5.351","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":425},{"label":"Mar","value":513},{"label":"Abr","value":590},{"label":"Mai","value":639},{"label":"Jun","value":440},{"label":"Jul","value":422},{"label":"Ago","value":466},{"label":"Set","value":346},{"label":"Out","value":433},{"label":"Nov","value":561},{"label":"Dez","value":526}];
const MX = 639;
