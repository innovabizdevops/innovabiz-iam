...
/* ═══ Insurance Customer Portal — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "4378", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4468", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€329K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1482984678", cells: ["INS-1678", "Insurance Customer Portal Item 1", "15/7/2026", "€34 778"], status: "active" as const },
    { id: "1482988249", cells: ["INS-5249", "Insurance Customer Portal Item 2", "2/2/2026", "€38 349"], status: "pending" as const },
    { id: "1482991820", cells: ["INS-8820", "Insurance Customer Portal Item 3", "17/9/2026", "€41 920"], status: "completed" as const },
    { id: "1482995391", cells: ["INS-3391", "Insurance Customer Portal Item 4", "4/4/2026", "€45 491"], status: "warning" as const },
    { id: "1482998962", cells: ["INS-6962", "Insurance Customer Portal Item 5", "19/11/2026", "€49 062"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Insurance Customer Portal</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Insurance Customer Portal</p>
                    </div>
                </div>
