...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"7.395","t":"+9.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"71.2%","t":"+14.0%","d":"up"},{"l":"MTTR (h)","v":"54h","t":"-4.2%","d":"down"},{"l":"Satisfação (%)","v":"84.7%","t":"+4.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","866","7.659","2.732","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.068","874","5.081","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.316","8.127","5.808","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.343","5.641","5.002","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.888","1.087","1.349","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":794},{"label":"Fev","value":893},{"label":"Mar","value":872},{"label":"Abr","value":999},{"label":"Mai","value":868},{"label":"Jun","value":836},{"label":"Jul","value":1043},{"label":"Ago","value":966},{"label":"Set","value":991},{"label":"Out","value":1022},{"label":"Nov","value":830},{"label":"Dez","value":680}];
const MX = 1043;
