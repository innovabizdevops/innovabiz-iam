...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.101","t":"+7.8%","d":"up"},{"l":"NC Abertas","v":"1.300","t":"-5.4%","d":"down"},{"l":"Conformidade (%)","v":"71.3%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.137","t":"+9.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.024","71.0%","424","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.348","96.7%","3.939","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.586","89.3%","7.513","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.710","95.4%","5.758","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.630","84.4%","5.081","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":683},{"label":"Mar","value":571},{"label":"Abr","value":369},{"label":"Mai","value":509},{"label":"Jun","value":474},{"label":"Jul","value":414},{"label":"Ago","value":533},{"label":"Set","value":675},{"label":"Out","value":447},{"label":"Nov","value":424},{"label":"Dez","value":561}];
const MX = 683;
