...
const PAGE = "VSM";
const KPIS = [{"l":"Projetos Melhoria","v":"1.981","t":"+17.6%","d":"up"},{"l":"Savings (€)","v":"€99244","t":"+3.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.8%","t":"+3.6%","d":"up"},{"l":"Ciclos PDCA","v":"4.612","t":"+0.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","451","€ 29768.15","5.818","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.419","€ 35066.48","8.743","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.961","€ 15293.12","1.009","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.159","€ 30318.06","4.775","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.109","€ 15020.74","6.414","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":785},{"label":"Mar","value":731},{"label":"Abr","value":998},{"label":"Mai","value":755},{"label":"Jun","value":1022},{"label":"Jul","value":684},{"label":"Ago","value":868},{"label":"Set","value":856},{"label":"Out","value":987},{"label":"Nov","value":680},{"label":"Dez","value":671}];
const MX = 1022;
