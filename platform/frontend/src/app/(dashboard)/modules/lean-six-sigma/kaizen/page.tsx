...
const PAGE = "Kaizen";
const KPIS = [{"l":"Projetos Melhoria","v":"2.101","t":"+17.4%","d":"up"},{"l":"Savings (€)","v":"€50673","t":"+1.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.0%","t":"+4.2%","d":"up"},{"l":"Ciclos PDCA","v":"2.935","t":"-0.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.633","€ 46383.43","6.305","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.524","€ 41308.29","2.847","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.218","€ 20939.85","772","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.582","€ 3516.59","7.445","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.945","€ 9340.33","3.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":241},{"label":"Fev","value":376},{"label":"Mar","value":348},{"label":"Abr","value":360},{"label":"Mai","value":574},{"label":"Jun","value":506},{"label":"Jul","value":405},{"label":"Ago","value":516},{"label":"Set","value":497},{"label":"Out","value":397},{"label":"Nov","value":394},{"label":"Dez","value":423}];
const MX = 574;
