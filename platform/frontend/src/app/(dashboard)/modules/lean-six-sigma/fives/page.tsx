...
const PAGE = "5S";
const KPIS = [{"l":"Projetos Melhoria","v":"5.605","t":"+8.5%","d":"up"},{"l":"Savings (€)","v":"€64136","t":"+7.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.7%","t":"-0.8%","d":"down"},{"l":"Ciclos PDCA","v":"9.016","t":"+12.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.724","€ 47271.54","1.356","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.285","€ 7620.71","5.849","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.594","€ 26834.21","5.778","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.051","€ 24057.49","5.364","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.705","€ 26573.28","1.750","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":651},{"label":"Mar","value":573},{"label":"Abr","value":496},{"label":"Mai","value":720},{"label":"Jun","value":675},{"label":"Jul","value":796},{"label":"Ago","value":612},{"label":"Set","value":684},{"label":"Out","value":605},{"label":"Nov","value":550},{"label":"Dez","value":654}];
const MX = 796;
