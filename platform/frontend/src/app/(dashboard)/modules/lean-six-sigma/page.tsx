...
const KPIS = [
    { label: "Total Registos", value: "4334", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1673", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€345K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "47811334", cells: ["LEA-4334", "Lean Six Sigma Item 1", "19/11/2026", "€11 434"], status: "active" as const },
    { id: "47814905", cells: ["LEA-7905", "Lean Six Sigma Item 2", "6/6/2026", "€15 005"], status: "pending" as const },
    { id: "47818476", cells: ["LEA-2476", "Lean Six Sigma Item 3", "21/1/2026", "€18 576"], status: "completed" as const },
    { id: "47822047", cells: ["LEA-6047", "Lean Six Sigma Item 4", "8/8/2026", "€22 147"], status: "warning" as const },
    { id: "47825618", cells: ["LEA-9618", "Lean Six Sigma Item 5", "23/3/2026", "€25 718"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Lean Six Sigma</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Lean Six Sigma</p>
                    </div>
                </div>
