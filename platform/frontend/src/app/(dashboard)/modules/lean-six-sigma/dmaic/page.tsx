...
const PAGE = "DMAIC";
const KPIS = [{"l":"Projetos Melhoria","v":"573","t":"+2.5%","d":"up"},{"l":"Savings (€)","v":"€52828","t":"-4.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"66.6%","t":"+16.7%","d":"up"},{"l":"Ciclos PDCA","v":"6.023","t":"-3.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.445","€ 18534.11","2.575","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.365","€ 804.64","5.587","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.099","€ 38432.30","6.203","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.049","€ 17431.85","6.278","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.509","€ 38548.07","2.411","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":387},{"label":"Fev","value":556},{"label":"Mar","value":469},{"label":"Abr","value":696},{"label":"Mai","value":655},{"label":"Jun","value":713},{"label":"Jul","value":657},{"label":"Ago","value":680},{"label":"Set","value":503},{"label":"Out","value":414},{"label":"Nov","value":684},{"label":"Dez","value":551}];
const MX = 713;
