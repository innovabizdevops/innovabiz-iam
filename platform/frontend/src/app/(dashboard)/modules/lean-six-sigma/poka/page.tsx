...
const ACCENT = "#064e3b";
const MODULE = "Lean Six Sigma";
const PAGE = "Poka-Yoke";
const KPIS = [{"l":"Projetos Melhoria","v":"741","t":"+5.6%","d":"up"},{"l":"Savings (€)","v":"€68619","t":"+3.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.5%","t":"-2.5%","d":"down"},{"l":"Ciclos PDCA","v":"1.709","t":"+15.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","470","€ 47613.93","8.009","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.220","€ 42605.44","1.332","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.988","€ 48897.16","4.684","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.847","€ 45271.45","5.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","215","€ 40054.03","6.162","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":516},{"label":"Mar","value":656},{"label":"Abr","value":562},{"label":"Mai","value":627},{"label":"Jun","value":788},{"label":"Jul","value":659},{"label":"Ago","value":599},{"label":"Set","value":859},{"label":"Out","value":525},{"label":"Nov","value":488},{"label":"Dez","value":783}];
const MX = 859;
