...
const KPIS = [{"l":"Total Oil Trading","v":"2.294","t":"-4.4%","d":"down"},{"l":"Settlement Ativos","v":"2.005","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"65.2%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.1%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Trading #001","Oil Trading #002","5.964","2.595","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Trading #002","Oil Trading #003","8.075","1.705","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Trading #003","Oil Trading #004","9.097","6.058","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Trading #004","Oil Trading #005","6.542","3.179","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Trading #005","Oil Trading #001","4.033","6.278","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":481},{"label":"Mar","value":842},{"label":"Abr","value":571},{"label":"Mai","value":506},{"label":"Jun","value":657},{"label":"Jul","value":752},{"label":"Ago","value":559},{"label":"Set","value":616},{"label":"Out","value":513},{"label":"Nov","value":780},{"label":"Dez","value":572}];
const MX = 842;
