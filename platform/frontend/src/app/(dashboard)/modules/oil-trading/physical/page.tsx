...
const PAGE = "Physical";
const KPIS = [{"l":"Total Oil Trading","v":"504","t":"+3.3%","d":"up"},{"l":"Physical Ativos","v":"438","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"76.4%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"72","t":"-2.2%","d":"down"}];
const COLS = ["ID","Physical","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Trading #001","Oil Trading #002","1.931","4.472","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Trading #002","Oil Trading #003","1.251","3.886","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Trading #003","Oil Trading #004","8.823","4.302","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Trading #004","Oil Trading #005","2.437","5.747","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Trading #005","Oil Trading #001","5.619","2.024","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":718},{"label":"Mar","value":1040},{"label":"Abr","value":816},{"label":"Mai","value":1024},{"label":"Jun","value":1048},{"label":"Jul","value":1016},{"label":"Ago","value":1057},{"label":"Set","value":856},{"label":"Out","value":827},{"label":"Nov","value":736},{"label":"Dez","value":956}];
const MX = 1057;
