...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.872","t":"-5.6%","d":"down"},{"l":"Mitigações Ativas","v":"8.183","t":"-5.3%","d":"down"},{"l":"Score Risco Geral","v":"94","t":"-3.3%","d":"down"},{"l":"Incidentes YTD","v":"5.119","t":"+13.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.818","3.749","4.221","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.685","4.049","2.230","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","4.170","7.928","4.689","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.326","2.289","6.114","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.713","6.849","3.656","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":635},{"label":"Mar","value":581},{"label":"Abr","value":724},{"label":"Mai","value":799},{"label":"Jun","value":682},{"label":"Jul","value":967},{"label":"Ago","value":858},{"label":"Set","value":606},{"label":"Out","value":662},{"label":"Nov","value":837},{"label":"Dez","value":761}];
const MX = 967;
