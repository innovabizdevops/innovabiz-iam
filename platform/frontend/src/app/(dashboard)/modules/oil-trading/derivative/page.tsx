...
const ACCENT = "#6366f1";
const MODULE = "Oil & Gas Trading";
const PAGE = "Derivative";
const KPIS = [{"l":"Total Oil Trading","v":"869","t":"+13.3%","d":"up"},{"l":"Derivative Ativos","v":"3.356","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"91","t":"+12.0%","d":"up"}];
const COLS = ["ID","Derivative","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Trading #001","Oil Trading #002","7.262","1.353","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Trading #002","Oil Trading #003","1.443","8.069","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Trading #003","Oil Trading #004","5.554","7.969","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Trading #004","Oil Trading #005","1.172","3.393","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Trading #005","Oil Trading #001","5.016","1.710","2026-03-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1022},{"label":"Fev","value":918},{"label":"Mar","value":922},{"label":"Abr","value":731},{"label":"Mai","value":721},{"label":"Jun","value":1068},{"label":"Jul","value":964},{"label":"Ago","value":859},{"label":"Set","value":1005},{"label":"Out","value":970},{"label":"Nov","value":997},{"label":"Dez","value":1036}];
const MX = 1068;
