...
const PAGE = "Route";
const KPIS = [{"l":"Total Issue To Resolve","v":"2.051","t":"+3.7%","d":"up"},{"l":"Route Ativos","v":"7.845","t":"+12.4%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"70","t":"+3.4%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Issue To Resolve #001","Issue To Resolve #002","5.396","7.973","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Issue To Resolve #002","Issue To Resolve #003","7.758","5.598","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Issue To Resolve #003","Issue To Resolve #004","3.426","4.427","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Issue To Resolve #004","Issue To Resolve #005","5.453","3.885","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Issue To Resolve #005","Issue To Resolve #001","4.968","9.099","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":894},{"label":"Mar","value":922},{"label":"Abr","value":770},{"label":"Mai","value":799},{"label":"Jun","value":720},{"label":"Jul","value":793},{"label":"Ago","value":606},{"label":"Set","value":863},{"label":"Out","value":820},{"label":"Nov","value":865},{"label":"Dez","value":900}];
const MX = 922;
