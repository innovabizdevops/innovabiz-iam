...
const PAGE = "Improve";
const KPIS = [{"l":"Projetos Melhoria","v":"8.423","t":"+5.0%","d":"up"},{"l":"Savings (€)","v":"€46483","t":"+17.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"70.2%","t":"-2.4%","d":"down"},{"l":"Ciclos PDCA","v":"3.749","t":"+11.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.991","€ 44829.02","2.760","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.731","€ 49141.84","2.628","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.822","€ 36324.81","7.698","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.834","€ 48534.42","4.905","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.340","€ 48395.48","3.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":415},{"label":"Mar","value":506},{"label":"Abr","value":441},{"label":"Mai","value":546},{"label":"Jun","value":610},{"label":"Jul","value":514},{"label":"Ago","value":595},{"label":"Set","value":399},{"label":"Out","value":363},{"label":"Nov","value":381},{"label":"Dez","value":563}];
const MX = 610;
