...
const PAGE = "Report";
const KPIS = [{"l":"Total Issue To Resolve","v":"8.926","t":"-4.0%","d":"down"},{"l":"Report Ativos","v":"5.133","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"91.5%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+3.9%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Issue To Resolve #001","Issue To Resolve #002","6.508","4.707","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Issue To Resolve #002","Issue To Resolve #003","3.495","5.768","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Issue To Resolve #003","Issue To Resolve #004","7.139","3.253","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Issue To Resolve #004","Issue To Resolve #005","6.827","3.376","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Issue To Resolve #005","Issue To Resolve #001","6.190","8.093","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":537},{"label":"Mar","value":609},{"label":"Abr","value":651},{"label":"Mai","value":646},{"label":"Jun","value":726},{"label":"Jul","value":708},{"label":"Ago","value":688},{"label":"Set","value":551},{"label":"Out","value":628},{"label":"Nov","value":526},{"label":"Dez","value":881}];
const MX = 881;
