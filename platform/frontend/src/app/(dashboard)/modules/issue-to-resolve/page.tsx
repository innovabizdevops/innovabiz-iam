...
/* ═══ Issue-to-Resolution E2E — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "3207", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4161", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€371K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2065044107", cells: ["ISS-4107", "Issue-to-Resolution E2E Item 1", "8/12/2026", "€44 207"], status: "active" as const },
    { id: "2065047678", cells: ["ISS-7678", "Issue-to-Resolution E2E Item 2", "23/7/2026", "€47 778"], status: "pending" as const },
    { id: "2065051249", cells: ["ISS-2249", "Issue-to-Resolution E2E Item 3", "10/2/2026", "€1349"], status: "completed" as const },
    { id: "2065054820", cells: ["ISS-5820", "Issue-to-Resolution E2E Item 4", "25/9/2026", "€4920"], status: "warning" as const },
    { id: "2065058391", cells: ["ISS-9391", "Issue-to-Resolution E2E Item 5", "12/4/2026", "€8491"], status: "active" as const },
];
...
export default function IssuetoresolutionE2ePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Issue-to-Resolution E2E</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Issue-to-Resolution E2E</p>
                    </div>
                </div>
