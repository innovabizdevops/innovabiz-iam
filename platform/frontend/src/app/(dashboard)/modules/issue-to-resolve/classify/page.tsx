...
const ACCENT = "#06b6d4";
const MODULE = "Issue-to-Resolution E2E";
const PAGE = "Classify";
const KPIS = [{"l":"Total Issue To Resolve","v":"6.684","t":"-5.8%","d":"down"},{"l":"Classify Ativos","v":"8.734","t":"+8.9%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+-0.0%","d":"up"},{"l":"Score Performance","v":"61","t":"+9.3%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Issue To Resolve #001","Issue To Resolve #002","6.633","1.747","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Issue To Resolve #002","Issue To Resolve #003","8.214","6.881","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Issue To Resolve #003","Issue To Resolve #004","8.185","1.488","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Issue To Resolve #004","Issue To Resolve #005","7.033","3.110","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Issue To Resolve #005","Issue To Resolve #001","2.152","5.364","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":314},{"label":"Mar","value":368},{"label":"Abr","value":292},{"label":"Mai","value":576},{"label":"Jun","value":219},{"label":"Jul","value":449},{"label":"Ago","value":388},{"label":"Set","value":300},{"label":"Out","value":271},{"label":"Nov","value":393},{"label":"Dez","value":575}];
const MX = 576;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#06b6d4'}}>AI</span></h1>
                </div>
