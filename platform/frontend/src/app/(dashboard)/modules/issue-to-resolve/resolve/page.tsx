...
const PAGE = "Resolve";
const KPIS = [{"l":"Total Issue To Resolve","v":"5.618","t":"+18.0%","d":"up"},{"l":"Resolve Ativos","v":"665","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"77.8%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+6.3%","d":"up"}];
const COLS = ["ID","Resolve","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Issue To Resolve #001","Issue To Resolve #002","6.863","1.448","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Issue To Resolve #002","Issue To Resolve #003","8.227","3.618","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Issue To Resolve #003","Issue To Resolve #004","7.569","1.674","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Issue To Resolve #004","Issue To Resolve #005","2.895","6.028","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Issue To Resolve #005","Issue To Resolve #001","9.050","5.256","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":978},{"label":"Fev","value":630},{"label":"Mar","value":926},{"label":"Abr","value":911},{"label":"Mai","value":798},{"label":"Jun","value":676},{"label":"Jul","value":901},{"label":"Ago","value":780},{"label":"Set","value":936},{"label":"Out","value":661},{"label":"Nov","value":865},{"label":"Dez","value":1018}];
const MX = 1018;
