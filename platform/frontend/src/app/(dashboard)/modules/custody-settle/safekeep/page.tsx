...
const PAGE = "Asset Safekeep";
const KPIS = [{"l":"Ativos Registados","v":"8.019","t":"+12.4%","d":"up"},{"l":"Valor Total (€M)","v":"€33.4M","t":"-4.6%","d":"down"},{"l":"Depreciação Anual (€)","v":"€90848","t":"+6.7%","d":"up"},{"l":"Ativos em Garantia","v":"3.207","t":"+0.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 22143.77","1.461","€ 22837.43","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 40203.93","172","€ 17625.15","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22954.13","8.551","€ 28447.99","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 23514.48","1.134","€ 43668.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 21524.62","1.199","€ 40170.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":479},{"label":"Mar","value":502},{"label":"Abr","value":773},{"label":"Mai","value":721},{"label":"Jun","value":676},{"label":"Jul","value":789},{"label":"Ago","value":493},{"label":"Set","value":742},{"label":"Out","value":765},{"label":"Nov","value":596},{"label":"Dez","value":504}];
const MX = 789;
