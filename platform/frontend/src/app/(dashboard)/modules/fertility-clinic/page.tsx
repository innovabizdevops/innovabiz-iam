...
/* ═══ Fertility Clinic — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "8726", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "807", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€20K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "95%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1408709326", cells: ["FER-3326", "Fertility Clinic Item 1", "11/11/2026", "€9426"], status: "active" as const },
    { id: "1408712897", cells: ["FER-6897", "Fertility Clinic Item 2", "26/6/2026", "€12 997"], status: "pending" as const },
    { id: "1408716468", cells: ["FER-1468", "Fertility Clinic Item 3", "13/1/2026", "€16 568"], status: "completed" as const },
    { id: "1408720039", cells: ["FER-5039", "Fertility Clinic Item 4", "28/8/2026", "€20 139"], status: "warning" as const },
    { id: "1408723610", cells: ["FER-8610", "Fertility Clinic Item 5", "15/3/2026", "€23 710"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fertility Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fertility Clinic</p>
                    </div>
                </div>
