...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"2.310","t":"+15.6%","d":"up"},{"l":"Chamadas/Hora","v":"2661","t":"-5.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"73.8%","t":"+15.2%","d":"up"},{"l":"Latência Média (ms)","v":"87ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.295","5.930","77.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.410","4.778","85.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.149","6.351","78.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.642","3.425","84.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.181","8.482","84.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":703},{"label":"Fev","value":397},{"label":"Mar","value":555},{"label":"Abr","value":548},{"label":"Mai","value":408},{"label":"Jun","value":465},{"label":"Jul","value":716},{"label":"Ago","value":716},{"label":"Set","value":388},{"label":"Out","value":619},{"label":"Nov","value":440},{"label":"Dez","value":545}];
const MX = 716;
