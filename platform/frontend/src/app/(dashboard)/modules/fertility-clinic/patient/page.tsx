...
const ACCENT = "#be185d";
const MODULE = "Fertility Clinic";
const PAGE = "Patient";
const KPIS = [{"l":"Total Fertility Clinic","v":"3.555","t":"+10.6%","d":"up"},{"l":"Patient Ativos","v":"1.217","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"72.3%","t":"-1.6%","d":"down"},{"l":"Score Performance","v":"56","t":"+1.6%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fertility Clinic #001","Fertility Clinic #002","8.755","3.457","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Fertility Clinic #002","Fertility Clinic #003","8.352","7.527","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Fertility Clinic #003","Fertility Clinic #004","1.189","7.062","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Fertility Clinic #004","Fertility Clinic #005","2.450","2.841","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fertility Clinic #005","Fertility Clinic #001","560","1.454","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":959},{"label":"Fev","value":876},{"label":"Mar","value":940},{"label":"Abr","value":746},{"label":"Mai","value":978},{"label":"Jun","value":800},{"label":"Jul","value":828},{"label":"Ago","value":726},{"label":"Set","value":698},{"label":"Out","value":897},{"label":"Nov","value":756},{"label":"Dez","value":815}];
const MX = 978;
