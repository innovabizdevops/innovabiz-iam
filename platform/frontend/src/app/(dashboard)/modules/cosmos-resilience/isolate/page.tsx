...
const PAGE = "Isolate";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.965","t":"+1.1%","d":"up"},{"l":"NC Abertas","v":"7.882","t":"-4.7%","d":"down"},{"l":"Conformidade (%)","v":"70.6%","t":"+15.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.863","t":"-0.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.275","90.0%","6.545","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","949","92.6%","2.611","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.802","87.7%","7.017","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.188","76.2%","7.661","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.512","83.9%","3.103","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":638},{"label":"Mar","value":600},{"label":"Abr","value":491},{"label":"Mai","value":676},{"label":"Jun","value":481},{"label":"Jul","value":458},{"label":"Ago","value":383},{"label":"Set","value":582},{"label":"Out","value":384},{"label":"Nov","value":469},{"label":"Dez","value":429}];
const MX = 704;
