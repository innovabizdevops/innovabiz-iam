...
const ACCENT = "#1e1b4b";
const MODULE = "COSMOS Resilience Engine";
const PAGE = "Detect";
const KPIS = [{"l":"Total Cosmos Resilience","v":"272","t":"+2.6%","d":"up"},{"l":"Detect Ativos","v":"8.685","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"77","t":"+14.0%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Resilience #001","Cosmos Resilience #002","1.894","7.639","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Resilience #002","Cosmos Resilience #003","3.866","8.382","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Resilience #003","Cosmos Resilience #004","796","4.808","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Resilience #004","Cosmos Resilience #005","2.278","765","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Resilience #005","Cosmos Resilience #001","8.168","6.985","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":865},{"label":"Fev","value":628},{"label":"Mar","value":924},{"label":"Abr","value":1018},{"label":"Mai","value":1012},{"label":"Jun","value":1001},{"label":"Jul","value":832},{"label":"Ago","value":822},{"label":"Set","value":858},{"label":"Out","value":912},{"label":"Nov","value":858},{"label":"Dez","value":842}];
const MX = 1018;
