...
const PAGE = "Report";
const KPIS = [{"l":"Total Cosmos Resilience","v":"8.282","t":"+0.6%","d":"up"},{"l":"Report Ativos","v":"5.139","t":"+10.3%","d":"up"},{"l":"Eficiência (%)","v":"76.9%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+12.2%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cosmos Resilience #001","Cosmos Resilience #002","1.310","4.283","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cosmos Resilience #002","Cosmos Resilience #003","4.147","2.514","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cosmos Resilience #003","Cosmos Resilience #004","8.509","6.596","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cosmos Resilience #004","Cosmos Resilience #005","2.575","3.904","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cosmos Resilience #005","Cosmos Resilience #001","2.523","5.466","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":843},{"label":"Mar","value":559},{"label":"Abr","value":536},{"label":"Mai","value":721},{"label":"Jun","value":803},{"label":"Jul","value":912},{"label":"Ago","value":550},{"label":"Set","value":821},{"label":"Out","value":788},{"label":"Nov","value":619},{"label":"Dez","value":546}];
const MX = 912;
