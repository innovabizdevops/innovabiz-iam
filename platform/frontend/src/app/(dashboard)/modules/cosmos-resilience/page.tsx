...
/* ═══ COSMOS Resilience Engine — Dashboard ═══ */

const ACCENT = "#1e1b4b";

const KPIS = [
    { label: "Total Registos", value: "4401", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "162", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€307K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1559234501", cells: ["COS-3501", "COSMOS Resilience Engine Item 1", "14/6/2026", "€34 601"], status: "active" as const },
    { id: "1559238072", cells: ["COS-7072", "COSMOS Resilience Engine Item 2", "1/1/2026", "€38 172"], status: "pending" as const },
    { id: "1559241643", cells: ["COS-1643", "COSMOS Resilience Engine Item 3", "16/8/2026", "€41 743"], status: "completed" as const },
    { id: "1559245214", cells: ["COS-5214", "COSMOS Resilience Engine Item 4", "3/3/2026", "€45 314"], status: "warning" as const },
    { id: "1559248785", cells: ["COS-8785", "COSMOS Resilience Engine Item 5", "18/10/2026", "€48 885"], status: "active" as const },
];
...
export default function CosmosResilienceEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">COSMOS Resilience Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • COSMOS Resilience Engine</p>
                    </div>
                </div>
