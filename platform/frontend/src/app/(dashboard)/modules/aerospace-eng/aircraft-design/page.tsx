...
/* ═══ Aerospace Eng — Aircraft Design ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "885", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "163", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "532", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "437482095", cells: ["AER-2095", "Aircraft Design Item 1", "16/4/2026", "€32 195"], status: "active" as const },
    { id: "437485666", cells: ["AER-5666", "Aircraft Design Item 2", "3/11/2026", "€35 766"], status: "pending" as const },
    { id: "437489237", cells: ["AER-9237", "Aircraft Design Item 3", "18/6/2026", "€39 337"], status: "completed" as const },
    { id: "437492808", cells: ["AER-3808", "Aircraft Design Item 4", "5/1/2026", "€42 908"], status: "warning" as const },
    { id: "437496379", cells: ["AER-7379", "Aircraft Design Item 5", "20/8/2026", "€46 479"], status: "active" as const },
];
...
export default function AerospaceEngAircraftDesignPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aircraft Design</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Aircraft Design</p>
                    </div>
                </div>
