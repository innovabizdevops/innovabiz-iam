...
/* ═══ Aerospace Eng — Systems Integrate ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "453", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "390", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2359", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "83%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1371633346", cells: ["AER-7346", "Systems Integrate Item 1", "7/11/2026", "€33 446"], status: "active" as const },
    { id: "1371636917", cells: ["AER-1917", "Systems Integrate Item 2", "22/6/2026", "€37 017"], status: "pending" as const },
    { id: "1371640488", cells: ["AER-5488", "Systems Integrate Item 3", "9/1/2026", "€40 588"], status: "completed" as const },
    { id: "1371644059", cells: ["AER-9059", "Systems Integrate Item 4", "24/8/2026", "€44 159"], status: "warning" as const },
    { id: "1371647630", cells: ["AER-3630", "Systems Integrate Item 5", "11/3/2026", "€47 730"], status: "active" as const },
];
...
export default function AerospaceEngSystemsIntegratePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Systems Integrate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Systems Integrate</p>
                    </div>
                </div>
