...
/* ═══ Aerospace Eng — Certification Air ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "4124", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "257", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "288", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1844732397", cells: ["AER-3397", "Certification Air Item 1", "26/10/2026", "€32 497"], status: "active" as const },
    { id: "1844735968", cells: ["AER-6968", "Certification Air Item 2", "13/5/2026", "€36 068"], status: "pending" as const },
    { id: "1844739539", cells: ["AER-1539", "Certification Air Item 3", "28/12/2026", "€39 639"], status: "completed" as const },
    { id: "1844743110", cells: ["AER-5110", "Certification Air Item 4", "15/7/2026", "€43 210"], status: "warning" as const },
    { id: "1844746681", cells: ["AER-8681", "Certification Air Item 5", "2/2/2026", "€46 781"], status: "active" as const },
];
...
export default function AerospaceEngCertificationAirPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Certification Air</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Certification Air</p>
                    </div>
                </div>
