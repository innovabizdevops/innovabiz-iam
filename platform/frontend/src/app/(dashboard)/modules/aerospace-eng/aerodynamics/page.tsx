...
/* ═══ Aerospace Eng — Aerodynamics ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "4991", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "136", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2028", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1156737620", cells: ["AER-4620", "Aerodynamics Item 1", "25/9/2026", "€37 720"], status: "active" as const },
    { id: "1156741191", cells: ["AER-8191", "Aerodynamics Item 2", "12/4/2026", "€41 291"], status: "pending" as const },
    { id: "1156744762", cells: ["AER-2762", "Aerodynamics Item 3", "27/11/2026", "€44 862"], status: "completed" as const },
    { id: "1156748333", cells: ["AER-6333", "Aerodynamics Item 4", "14/6/2026", "€48 433"], status: "warning" as const },
    { id: "1156751904", cells: ["AER-9904", "Aerodynamics Item 5", "1/1/2026", "€2004"], status: "active" as const },
];
...
export default function AerospaceEngAerodynamicsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Aerodynamics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Aerodynamics</p>
                    </div>
                </div>
