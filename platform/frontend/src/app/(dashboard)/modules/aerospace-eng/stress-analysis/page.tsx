...
/* ═══ Aerospace Eng — Stress Analysis ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "606", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "35", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2243", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "78%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "792104111", cells: ["AER-6111", "Stress Analysis Item 1", "16/12/2026", "€4211"], status: "active" as const },
    { id: "792107682", cells: ["AER-9682", "Stress Analysis Item 2", "3/7/2026", "€7782"], status: "pending" as const },
    { id: "792111253", cells: ["AER-4253", "Stress Analysis Item 3", "18/2/2026", "€11 353"], status: "completed" as const },
    { id: "792114824", cells: ["AER-7824", "Stress Analysis Item 4", "5/9/2026", "€14 924"], status: "warning" as const },
    { id: "792118395", cells: ["AER-2395", "Stress Analysis Item 5", "20/4/2026", "€18 495"], status: "active" as const },
];
...
export default function AerospaceEngStressAnalysisPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Stress Analysis</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Stress Analysis</p>
                    </div>
                </div>
