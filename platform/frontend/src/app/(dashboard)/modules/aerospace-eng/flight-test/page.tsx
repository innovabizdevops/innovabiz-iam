...
/* ═══ Aerospace Eng — Flight Test ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "1580", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "393", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2391", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "997840309", cells: ["AER-2309", "Flight Test Item 1", "26/2/2026", "€40 409"], status: "active" as const },
    { id: "997843880", cells: ["AER-5880", "Flight Test Item 2", "13/9/2026", "€43 980"], status: "pending" as const },
    { id: "997847451", cells: ["AER-9451", "Flight Test Item 3", "28/4/2026", "€47 551"], status: "completed" as const },
    { id: "997851022", cells: ["AER-4022", "Flight Test Item 4", "15/11/2026", "€1122"], status: "warning" as const },
    { id: "997854593", cells: ["AER-7593", "Flight Test Item 5", "2/6/2026", "€4693"], status: "active" as const },
];
...
export default function AerospaceEngFlightTestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Flight Test</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Flight Test</p>
                    </div>
                </div>
