...
/* ═══ Aerospace Eng — Composite Struct ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "793", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "345", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2509", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "398958949", cells: ["AER-7949", "Composite Struct Item 1", "26/2/2026", "€9049"], status: "active" as const },
    { id: "398962520", cells: ["AER-2520", "Composite Struct Item 2", "13/9/2026", "€12 620"], status: "pending" as const },
    { id: "398966091", cells: ["AER-6091", "Composite Struct Item 3", "28/4/2026", "€16 191"], status: "completed" as const },
    { id: "398969662", cells: ["AER-9662", "Composite Struct Item 4", "15/11/2026", "€19 762"], status: "warning" as const },
    { id: "398973233", cells: ["AER-4233", "Composite Struct Item 5", "2/6/2026", "€23 333"], status: "active" as const },
];
...
export default function AerospaceEngCompositeStructPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Composite Struct</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Composite Struct</p>
                    </div>
                </div>
