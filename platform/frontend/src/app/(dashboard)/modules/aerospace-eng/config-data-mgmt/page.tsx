...
/* ═══ Aerospace Eng — Config Data Mgmt ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2744", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "180", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "793", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "652693040", cells: ["AER-5040", "Config Data Mgmt Item 1", "21/9/2026", "€43 140"], status: "active" as const },
    { id: "652696611", cells: ["AER-8611", "Config Data Mgmt Item 2", "8/4/2026", "€46 711"], status: "pending" as const },
    { id: "652700182", cells: ["AER-3182", "Config Data Mgmt Item 3", "23/11/2026", "€282"], status: "completed" as const },
    { id: "652703753", cells: ["AER-6753", "Config Data Mgmt Item 4", "10/6/2026", "€3853"], status: "warning" as const },
    { id: "652707324", cells: ["AER-1324", "Config Data Mgmt Item 5", "25/1/2026", "€7424"], status: "active" as const },
];
...
export default function AerospaceEngConfigDataMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Config Data Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Config Data Mgmt</p>
                    </div>
                </div>
