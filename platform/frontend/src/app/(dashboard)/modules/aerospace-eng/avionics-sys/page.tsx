...
/* ═══ Aerospace Eng — Avionics Sys ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "3963", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "442", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2631", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1239052598", cells: ["AER-5598", "Avionics Sys Item 1", "15/3/2026", "€2698"], status: "active" as const },
    { id: "1239056169", cells: ["AER-9169", "Avionics Sys Item 2", "2/10/2026", "€6269"], status: "pending" as const },
    { id: "1239059740", cells: ["AER-3740", "Avionics Sys Item 3", "17/5/2026", "€9840"], status: "completed" as const },
    { id: "1239063311", cells: ["AER-7311", "Avionics Sys Item 4", "4/12/2026", "€13 411"], status: "warning" as const },
    { id: "1239066882", cells: ["AER-1882", "Avionics Sys Item 5", "19/7/2026", "€16 982"], status: "active" as const },
];
...
export default function AerospaceEngAvionicsSysPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Avionics Sys</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Avionics Sys</p>
                    </div>
                </div>
