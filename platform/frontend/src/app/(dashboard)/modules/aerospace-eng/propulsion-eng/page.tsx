...
/* ═══ Aerospace Eng — Propulsion Eng ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total", value: "2921", trend: "-7%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "200", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "416", trend: "+20%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "73%", trend: "-14%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1745121156", cells: ["AER-4156", "Propulsion Eng Item 1", "17/1/2026", "€21 256"], status: "active" as const },
    { id: "1745124727", cells: ["AER-7727", "Propulsion Eng Item 2", "4/8/2026", "€24 827"], status: "pending" as const },
    { id: "1745128298", cells: ["AER-2298", "Propulsion Eng Item 3", "19/3/2026", "€28 398"], status: "completed" as const },
    { id: "1745131869", cells: ["AER-5869", "Propulsion Eng Item 4", "6/10/2026", "€31 969"], status: "warning" as const },
    { id: "1745135440", cells: ["AER-9440", "Propulsion Eng Item 5", "21/5/2026", "€35 540"], status: "active" as const },
];
...
export default function AerospaceEngPropulsionEngPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Propulsion Eng</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Aerospace Eng • Propulsion Eng</p>
                    </div>
                </div>
