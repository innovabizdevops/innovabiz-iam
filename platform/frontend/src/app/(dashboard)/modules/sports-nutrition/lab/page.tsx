...
const PAGE = "Lab Test";
const KPIS = [{"l":"Atletas Registados","v":"5.828","t":"+15.6%","d":"up"},{"l":"Treinos/Semana","v":"3174","t":"+15.0%","d":"up"},{"l":"Competições","v":"2.101","t":"+12.0%","d":"up"},{"l":"Performance Score","v":"79","t":"+3.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.820","5.786","2.251","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.354","5.339","5.062","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.267","4.203","5.089","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.938","7.752","4.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.773","5.299","7.133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":421},{"label":"Mar","value":567},{"label":"Abr","value":494},{"label":"Mai","value":466},{"label":"Jun","value":670},{"label":"Jul","value":524},{"label":"Ago","value":519},{"label":"Set","value":658},{"label":"Out","value":419},{"label":"Nov","value":330},{"label":"Dez","value":450}];
const MX = 670;
