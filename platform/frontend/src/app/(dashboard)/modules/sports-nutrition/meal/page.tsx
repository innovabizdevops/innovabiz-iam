...
const KPIS = [{"l":"Atletas Registados","v":"3.676","t":"-5.7%","d":"down"},{"l":"Treinos/Semana","v":"2774","t":"+5.1%","d":"up"},{"l":"Competições","v":"7.787","t":"+12.3%","d":"up"},{"l":"Performance Score","v":"74","t":"+17.5%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.392","4.008","4.877","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.159","7.370","8.756","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.138","512","5.207","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.955","7.668","8.282","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.500","2.247","8.148","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":502},{"label":"Mar","value":589},{"label":"Abr","value":800},{"label":"Mai","value":514},{"label":"Jun","value":555},{"label":"Jul","value":574},{"label":"Ago","value":475},{"label":"Set","value":692},{"label":"Out","value":818},{"label":"Nov","value":481},{"label":"Dez","value":580}];
const MX = 818;
