...
const KPIS = [{"l":"Atletas Registados","v":"7.326","t":"-1.1%","d":"down"},{"l":"Treinos/Semana","v":"4907","t":"+2.7%","d":"up"},{"l":"Competições","v":"1.067","t":"-5.5%","d":"down"},{"l":"Performance Score","v":"75","t":"+11.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.506","5.539","8.196","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.513","883","665","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","5.106","7.572","2.511","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.220","6.438","1.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.592","2.860","825","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":661},{"label":"Mar","value":899},{"label":"Abr","value":680},{"label":"Mai","value":841},{"label":"Jun","value":716},{"label":"Jul","value":672},{"label":"Ago","value":694},{"label":"Set","value":694},{"label":"Out","value":867},{"label":"Nov","value":772},{"label":"Dez","value":706}];
const MX = 899;
