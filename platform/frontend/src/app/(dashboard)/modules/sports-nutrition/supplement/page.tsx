...
const ACCENT = "#6366f1";
const MODULE = "Sports Nutrition";
const PAGE = "Supplement";
const KPIS = [{"l":"Atletas Registados","v":"3.596","t":"+16.9%","d":"up"},{"l":"Treinos/Semana","v":"3345","t":"+14.4%","d":"up"},{"l":"Competições","v":"6.214","t":"-4.9%","d":"down"},{"l":"Performance Score","v":"68","t":"+6.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.297","6.735","5.181","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.020","8.995","6.585","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.634","1.818","2.032","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.854","1.388","6.689","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.385","809","3.799","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":328},{"label":"Mar","value":430},{"label":"Abr","value":412},{"label":"Mai","value":304},{"label":"Jun","value":662},{"label":"Jul","value":429},{"label":"Ago","value":488},{"label":"Set","value":636},{"label":"Out","value":463},{"label":"Nov","value":485},{"label":"Dez","value":446}];
const MX = 668;
