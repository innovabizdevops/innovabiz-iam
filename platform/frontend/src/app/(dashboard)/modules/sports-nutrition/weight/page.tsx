...
const PAGE = "Weight";
const KPIS = [{"l":"Atletas Registados","v":"854","t":"+15.5%","d":"up"},{"l":"Treinos/Semana","v":"3730","t":"+11.5%","d":"up"},{"l":"Competições","v":"8.590","t":"+14.3%","d":"up"},{"l":"Performance Score","v":"60","t":"-0.3%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.264","2.188","7.972","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.497","1.654","5.187","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.807","1.942","525","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.266","6.128","2.261","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","1.539","5.103","1.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":627},{"label":"Mar","value":266},{"label":"Abr","value":555},{"label":"Mai","value":590},{"label":"Jun","value":610},{"label":"Jul","value":600},{"label":"Ago","value":388},{"label":"Set","value":361},{"label":"Out","value":517},{"label":"Nov","value":390},{"label":"Dez","value":602}];
const MX = 627;
