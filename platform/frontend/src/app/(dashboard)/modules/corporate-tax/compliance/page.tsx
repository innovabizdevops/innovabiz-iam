...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.569","t":"-2.4%","d":"down"},{"l":"NC Abertas","v":"684","t":"-5.5%","d":"down"},{"l":"Conformidade (%)","v":"83.6%","t":"+16.6%","d":"up"},{"l":"CAPAs Pendentes","v":"2.268","t":"-5.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.030","80.8%","1.596","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.849","83.7%","1.322","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.044","94.9%","6.807","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.486","70.9%","1.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.241","96.8%","2.763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":908},{"label":"Fev","value":748},{"label":"Mar","value":627},{"label":"Abr","value":735},{"label":"Mai","value":550},{"label":"Jun","value":878},{"label":"Jul","value":598},{"label":"Ago","value":871},{"label":"Set","value":881},{"label":"Out","value":648},{"label":"Nov","value":878},{"label":"Dez","value":658}];
const MX = 908;
