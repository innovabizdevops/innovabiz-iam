...
const KPIS = [{"l":"Total Corporate Tax","v":"8.282","t":"+12.1%","d":"up"},{"l":"Provision Ativos","v":"7.264","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"91","t":"-1.5%","d":"down"}];
const COLS = ["ID","Provision","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Tax #001","Corporate Tax #002","3.028","1.591","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Tax #002","Corporate Tax #003","4.555","1.201","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Tax #003","Corporate Tax #004","7.501","2.408","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Tax #004","Corporate Tax #005","4.307","8.588","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Tax #005","Corporate Tax #001","7.662","8.519","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":686},{"label":"Mar","value":667},{"label":"Abr","value":524},{"label":"Mai","value":678},{"label":"Jun","value":629},{"label":"Jul","value":736},{"label":"Ago","value":396},{"label":"Set","value":425},{"label":"Out","value":618},{"label":"Nov","value":515},{"label":"Dez","value":549}];
const MX = 766;
