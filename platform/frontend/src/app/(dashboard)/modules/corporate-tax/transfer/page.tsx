...
const PAGE = "Transfer";
const KPIS = [{"l":"Total Corporate Tax","v":"1.756","t":"+13.4%","d":"up"},{"l":"Transfer Ativos","v":"1.064","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"94","t":"+2.1%","d":"up"}];
const COLS = ["ID","Transfer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Corporate Tax #001","Corporate Tax #002","1.386","5.202","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Corporate Tax #002","Corporate Tax #003","1.562","4.881","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Corporate Tax #003","Corporate Tax #004","3.900","7.124","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Corporate Tax #004","Corporate Tax #005","2.808","123","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Corporate Tax #005","Corporate Tax #001","224","7.125","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1000},{"label":"Fev","value":732},{"label":"Mar","value":906},{"label":"Abr","value":920},{"label":"Mai","value":822},{"label":"Jun","value":862},{"label":"Jul","value":960},{"label":"Ago","value":936},{"label":"Set","value":1020},{"label":"Out","value":981},{"label":"Nov","value":896},{"label":"Dez","value":820}];
const MX = 1020;
