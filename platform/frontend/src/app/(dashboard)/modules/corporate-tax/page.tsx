...
/* ═══ Corporate Tax Deep — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "282", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "237", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€409K", trend: "-21%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+15%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1900562582", cells: ["COR-6582", "Corporate Tax Deep Item 1", "3/3/2026", "€12 682"], status: "active" as const },
    { id: "1900566153", cells: ["COR-1153", "Corporate Tax Deep Item 2", "18/10/2026", "€16 253"], status: "pending" as const },
    { id: "1900569724", cells: ["COR-4724", "Corporate Tax Deep Item 3", "5/5/2026", "€19 824"], status: "completed" as const },
    { id: "1900573295", cells: ["COR-8295", "Corporate Tax Deep Item 4", "20/12/2026", "€23 395"], status: "warning" as const },
    { id: "1900576866", cells: ["COR-2866", "Corporate Tax Deep Item 5", "7/7/2026", "€26 966"], status: "active" as const },
];
...
export default function CorporateTaxDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corporate Tax Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Corporate Tax Deep</p>
                    </div>
                </div>
