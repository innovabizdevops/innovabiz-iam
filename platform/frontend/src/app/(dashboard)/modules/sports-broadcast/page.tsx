...
export default function SportsBroadcastPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sports Broadcast</h1><p className="text-sm text-muted-foreground">Sports Broadcast • iBOS Enterprise</p></div>
