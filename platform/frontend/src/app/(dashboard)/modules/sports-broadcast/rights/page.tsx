...
const PAGE = "Rights";
const KPIS = [{"l":"Atletas Registados","v":"2.181","t":"+2.3%","d":"up"},{"l":"Treinos/Semana","v":"994","t":"-2.5%","d":"down"},{"l":"Competições","v":"5.718","t":"-0.6%","d":"down"},{"l":"Performance Score","v":"57","t":"+7.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.310","5.970","1.309","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.848","4.533","1.027","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.147","7.607","7.816","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.267","4.244","6.214","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.633","7.745","156","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":901},{"label":"Mar","value":655},{"label":"Abr","value":697},{"label":"Mai","value":698},{"label":"Jun","value":579},{"label":"Jul","value":678},{"label":"Ago","value":621},{"label":"Set","value":752},{"label":"Out","value":645},{"label":"Nov","value":557},{"label":"Dez","value":735}];
const MX = 901;
