...
const KPIS = [{"l":"Atletas Registados","v":"8.978","t":"+15.1%","d":"up"},{"l":"Treinos/Semana","v":"3458","t":"+12.8%","d":"up"},{"l":"Competições","v":"1.618","t":"+0.1%","d":"up"},{"l":"Performance Score","v":"90","t":"+5.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.791","5.271","2.195","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.624","9.092","6.347","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.192","8.824","8.031","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.583","3.942","3.627","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.984","5.140","2.159","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":601},{"label":"Mar","value":557},{"label":"Abr","value":501},{"label":"Mai","value":416},{"label":"Jun","value":504},{"label":"Jul","value":415},{"label":"Ago","value":665},{"label":"Set","value":739},{"label":"Out","value":759},{"label":"Nov","value":731},{"label":"Dez","value":387}];
const MX = 759;
