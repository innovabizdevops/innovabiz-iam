...
const ACCENT = "#6366f1";
const MODULE = "Sports Broadcast";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.595","t":"-5.0%","d":"down"},{"l":"Queries/Dia","v":"4395","t":"+4.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.787","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"4.114","t":"+9.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4621","2026-01-26","4.285","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4856","2026-01-22","8.608","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","335","2026-02-15","486","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2533","2026-02-26","8.015","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","935","2026-03-25","1.345","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":855},{"label":"Mar","value":701},{"label":"Abr","value":805},{"label":"Mai","value":961},{"label":"Jun","value":731},{"label":"Jul","value":693},{"label":"Ago","value":766},{"label":"Set","value":870},{"label":"Out","value":784},{"label":"Nov","value":777},{"label":"Dez","value":886}];
const MX = 961;
