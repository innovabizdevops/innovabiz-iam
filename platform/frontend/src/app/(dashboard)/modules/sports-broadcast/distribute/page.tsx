...
const KPIS = [{"l":"Atletas Registados","v":"3.204","t":"-5.0%","d":"down"},{"l":"Treinos/Semana","v":"3458","t":"+10.4%","d":"up"},{"l":"Competições","v":"2.777","t":"-0.1%","d":"down"},{"l":"Performance Score","v":"91","t":"+17.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.697","5.046","7.900","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.144","9.059","1.416","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.277","2.365","4.766","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.882","6.346","4.637","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.981","4.712","4.378","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":745},{"label":"Mar","value":823},{"label":"Abr","value":805},{"label":"Mai","value":797},{"label":"Jun","value":821},{"label":"Jul","value":807},{"label":"Ago","value":877},{"label":"Set","value":637},{"label":"Out","value":833},{"label":"Nov","value":581},{"label":"Dez","value":760}];
const MX = 877;
