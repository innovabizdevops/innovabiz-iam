...
const PAGE = "OTT";
const KPIS = [{"l":"Atletas Registados","v":"7.035","t":"-0.9%","d":"down"},{"l":"Treinos/Semana","v":"2369","t":"+6.9%","d":"up"},{"l":"Competições","v":"4.516","t":"-1.5%","d":"down"},{"l":"Performance Score","v":"64","t":"+1.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","248","942","4.324","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","2.805","6.945","2.076","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.198","6.900","1.540","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","5.899","8.854","4.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.822","1.992","5.690","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":473},{"label":"Mar","value":369},{"label":"Abr","value":374},{"label":"Mai","value":650},{"label":"Jun","value":411},{"label":"Jul","value":379},{"label":"Ago","value":490},{"label":"Set","value":367},{"label":"Out","value":583},{"label":"Nov","value":585},{"label":"Dez","value":723}];
const MX = 723;
