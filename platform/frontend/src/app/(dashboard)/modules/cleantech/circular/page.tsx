...
const KPIS = [{"l":"Projetos Melhoria","v":"3.133","t":"+4.4%","d":"up"},{"l":"Savings (€)","v":"€67220","t":"-5.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.8%","t":"-5.7%","d":"down"},{"l":"Ciclos PDCA","v":"3.173","t":"+4.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.847","€ 1652.18","3.728","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.528","€ 49256.71","666","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.645","€ 21192.43","2.566","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.330","€ 37045.19","3.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.343","€ 48033.64","2.141","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":600},{"label":"Fev","value":475},{"label":"Mar","value":620},{"label":"Abr","value":435},{"label":"Mai","value":498},{"label":"Jun","value":624},{"label":"Jul","value":664},{"label":"Ago","value":497},{"label":"Set","value":735},{"label":"Out","value":713},{"label":"Nov","value":662},{"label":"Dez","value":766}];
const MX = 766;
