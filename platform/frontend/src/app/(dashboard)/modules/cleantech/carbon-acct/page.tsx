...
const ACCENT = "#059669";
const MODULE = "CleanTech & Circular";
const PAGE = "Carbon Accounting";
const KPIS = [{"l":"Projetos Melhoria","v":"319","t":"+5.0%","d":"up"},{"l":"Savings (€)","v":"€59849","t":"+3.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.9%","t":"+5.6%","d":"up"},{"l":"Ciclos PDCA","v":"5.707","t":"+12.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.465","€ 43876.30","3.766","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.087","€ 33059.02","1.536","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.814","€ 5381.29","6.093","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.759","€ 21935.67","6.311","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.355","€ 4515.95","1.697","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":641},{"label":"Mar","value":518},{"label":"Abr","value":700},{"label":"Mai","value":517},{"label":"Jun","value":770},{"label":"Jul","value":545},{"label":"Ago","value":615},{"label":"Set","value":639},{"label":"Out","value":452},{"label":"Nov","value":740},{"label":"Dez","value":401}];
const MX = 770;
...
export default function CarbonAcctPage() {
    return (
