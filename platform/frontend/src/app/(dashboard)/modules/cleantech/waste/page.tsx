...
const PAGE = "Waste Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.020","t":"+3.8%","d":"up"},{"l":"Savings (€)","v":"€16293","t":"+3.6%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.4%","t":"-0.1%","d":"down"},{"l":"Ciclos PDCA","v":"4.411","t":"+8.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.845","€ 40343.97","7.202","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.650","€ 22577.92","205","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.023","€ 33858.20","2.847","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.793","€ 4795.55","6.016","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.182","€ 30106.64","4.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":699},{"label":"Fev","value":436},{"label":"Mar","value":593},{"label":"Abr","value":618},{"label":"Mai","value":606},{"label":"Jun","value":353},{"label":"Jul","value":563},{"label":"Ago","value":697},{"label":"Set","value":615},{"label":"Out","value":637},{"label":"Nov","value":470},{"label":"Dez","value":508}];
const MX = 699;
