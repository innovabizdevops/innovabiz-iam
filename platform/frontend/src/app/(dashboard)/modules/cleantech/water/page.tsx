...
const PAGE = "Water Treatment";
const KPIS = [{"l":"Projetos Melhoria","v":"4.434","t":"+11.5%","d":"up"},{"l":"Savings (€)","v":"€25580","t":"+2.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.0%","t":"-1.0%","d":"down"},{"l":"Ciclos PDCA","v":"7.785","t":"-5.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.988","€ 33696.94","1.752","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.081","€ 27675.04","6.047","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.993","€ 2246.83","2.632","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.998","€ 34509.73","6.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.804","€ 45985.64","4.133","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":596},{"label":"Mar","value":539},{"label":"Abr","value":769},{"label":"Mai","value":453},{"label":"Jun","value":646},{"label":"Jul","value":823},{"label":"Ago","value":437},{"label":"Set","value":675},{"label":"Out","value":439},{"label":"Nov","value":636},{"label":"Dez","value":606}];
const MX = 823;
