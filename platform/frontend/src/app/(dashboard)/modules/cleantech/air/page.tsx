...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.922","t":"-0.4%","d":"down"},{"l":"NC Abertas","v":"4.387","t":"-2.5%","d":"down"},{"l":"Conformidade (%)","v":"93.5%","t":"+12.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.966","t":"-1.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.272","87.6%","2.528","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.469","76.2%","2.427","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.627","93.0%","4.447","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.135","72.1%","2.225","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.318","85.5%","6.178","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":493},{"label":"Mar","value":600},{"label":"Abr","value":715},{"label":"Mai","value":619},{"label":"Jun","value":440},{"label":"Jul","value":560},{"label":"Ago","value":452},{"label":"Set","value":537},{"label":"Out","value":623},{"label":"Nov","value":514},{"label":"Dez","value":617}];
const MX = 715;
