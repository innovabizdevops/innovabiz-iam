...
const PAGE = "Scope 3 Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"536","t":"-1.1%","d":"down"},{"l":"Savings (€)","v":"€49996","t":"+14.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.8%","t":"+0.1%","d":"up"},{"l":"Ciclos PDCA","v":"8.363","t":"-0.4%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.557","€ 10335.13","7.668","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.942","€ 19618.66","4.578","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.065","€ 49243.03","2.686","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.739","€ 30951.88","5.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.562","€ 2078.24","1.899","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":383},{"label":"Mar","value":707},{"label":"Abr","value":588},{"label":"Mai","value":378},{"label":"Jun","value":588},{"label":"Jul","value":567},{"label":"Ago","value":510},{"label":"Set","value":593},{"label":"Out","value":388},{"label":"Nov","value":540},{"label":"Dez","value":718}];
const MX = 718;
