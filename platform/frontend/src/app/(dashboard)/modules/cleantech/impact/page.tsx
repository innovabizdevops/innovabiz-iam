...
const PAGE = "Impact Metrics";
const KPIS = [{"l":"Projetos Melhoria","v":"8.874","t":"+1.5%","d":"up"},{"l":"Savings (€)","v":"€95480","t":"+9.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.4%","t":"+12.0%","d":"up"},{"l":"Ciclos PDCA","v":"3.719","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.524","€ 37205.13","2.777","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","262","€ 22203.33","7.723","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.941","€ 30383.74","7.291","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.215","€ 39469.63","8.922","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.047","€ 300.16","5.920","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":849},{"label":"Mar","value":837},{"label":"Abr","value":640},{"label":"Mai","value":631},{"label":"Jun","value":936},{"label":"Jul","value":1017},{"label":"Ago","value":708},{"label":"Set","value":695},{"label":"Out","value":687},{"label":"Nov","value":711},{"label":"Dez","value":821}];
const MX = 1017;
