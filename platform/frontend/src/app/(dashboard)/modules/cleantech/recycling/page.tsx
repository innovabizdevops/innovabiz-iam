...
const PAGE = "Recycling Tracker";
const KPIS = [{"l":"Projetos Melhoria","v":"4.285","t":"+8.3%","d":"up"},{"l":"Savings (€)","v":"€71799","t":"+14.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.8%","t":"+0.6%","d":"up"},{"l":"Ciclos PDCA","v":"7.424","t":"+15.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.782","€ 42719.87","3.154","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.994","€ 4238.06","8.466","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.892","€ 26541.70","4.519","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.504","€ 44039.73","4.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.621","€ 41077.23","9.074","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":529},{"label":"Fev","value":807},{"label":"Mar","value":454},{"label":"Abr","value":744},{"label":"Mai","value":603},{"label":"Jun","value":554},{"label":"Jul","value":774},{"label":"Ago","value":534},{"label":"Set","value":763},{"label":"Out","value":524},{"label":"Nov","value":544},{"label":"Dez","value":716}];
const MX = 807;
