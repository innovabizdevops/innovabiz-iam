...
/* ═══ Religious School (K-12) — Dashboard ═══ */

const ACCENT = "#4c1d95";

const KPIS = [
    { label: "Total Registos", value: "2165", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2213", trend: "-10%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€236K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2122453165", cells: ["REL-2165", "Religious School (K-12) Item 1", "22/2/2026", "€3265"], status: "active" as const },
    { id: "2122456736", cells: ["REL-5736", "Religious School (K-12) Item 2", "9/9/2026", "€6836"], status: "pending" as const },
    { id: "2122460307", cells: ["REL-9307", "Religious School (K-12) Item 3", "24/4/2026", "€10 407"], status: "completed" as const },
    { id: "2122463878", cells: ["REL-3878", "Religious School (K-12) Item 4", "11/11/2026", "€13 978"], status: "warning" as const },
    { id: "2122467449", cells: ["REL-7449", "Religious School (K-12) Item 5", "26/6/2026", "€17 549"], status: "active" as const },
];
...
export default function ReligiousSchoolK12Page() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Religious School (K-12)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Religious School (K-12)</p>
                    </div>
                </div>
