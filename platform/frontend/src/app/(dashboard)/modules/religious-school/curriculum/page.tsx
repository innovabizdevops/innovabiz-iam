...
const KPIS = [{"l":"Total Religious School","v":"5.573","t":"+8.0%","d":"up"},{"l":"Curriculum Ativos","v":"8.737","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"84","t":"+7.7%","d":"up"}];
const COLS = ["ID","Curriculum","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious School #001","Religious School #002","3.000","7.964","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Religious School #002","Religious School #003","2.858","5.965","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious School #003","Religious School #004","3.229","1.788","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Religious School #004","Religious School #005","6.274","3.675","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious School #005","Religious School #001","6.470","7.800","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":671},{"label":"Mar","value":381},{"label":"Abr","value":542},{"label":"Mai","value":449},{"label":"Jun","value":504},{"label":"Jul","value":748},{"label":"Ago","value":432},{"label":"Set","value":582},{"label":"Out","value":625},{"label":"Nov","value":514},{"label":"Dez","value":634}];
const MX = 748;
