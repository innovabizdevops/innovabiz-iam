...
const PAGE = "Chapel";
const KPIS = [{"l":"Total Religious School","v":"2.205","t":"-1.0%","d":"down"},{"l":"Chapel Ativos","v":"8.705","t":"+2.7%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+4.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+10.7%","d":"up"}];
const COLS = ["ID","Chapel","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious School #001","Religious School #002","450","3.060","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Religious School #002","Religious School #003","2.997","6.946","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious School #003","Religious School #004","7.983","4.255","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Religious School #004","Religious School #005","280","4.372","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious School #005","Religious School #001","1.517","5.612","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":827},{"label":"Fev","value":765},{"label":"Mar","value":615},{"label":"Abr","value":545},{"label":"Mai","value":861},{"label":"Jun","value":737},{"label":"Jul","value":752},{"label":"Ago","value":520},{"label":"Set","value":666},{"label":"Out","value":671},{"label":"Nov","value":811},{"label":"Dez","value":648}];
const MX = 861;
