...
const PAGE = "Student";
const KPIS = [{"l":"Total Religious School","v":"8.859","t":"-5.9%","d":"down"},{"l":"Student Ativos","v":"6.074","t":"-2.7%","d":"down"},{"l":"Eficiência (%)","v":"93.9%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"89","t":"-1.7%","d":"down"}];
const COLS = ["ID","Student","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious School #001","Religious School #002","5.125","6.459","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Religious School #002","Religious School #003","8.004","4.904","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious School #003","Religious School #004","6.626","8.456","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Religious School #004","Religious School #005","3.966","2.860","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious School #005","Religious School #001","417","3.971","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":722},{"label":"Mar","value":664},{"label":"Abr","value":597},{"label":"Mai","value":689},{"label":"Jun","value":493},{"label":"Jul","value":610},{"label":"Ago","value":456},{"label":"Set","value":641},{"label":"Out","value":718},{"label":"Nov","value":779},{"label":"Dez","value":675}];
const MX = 779;
