...
const PAGE = "Enroll";
const KPIS = [{"l":"Total Religious School","v":"5.834","t":"+4.7%","d":"up"},{"l":"Enroll Ativos","v":"7.906","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"74.4%","t":"+2.3%","d":"up"},{"l":"Score Performance","v":"57","t":"+8.5%","d":"up"}];
const COLS = ["ID","Enroll","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious School #001","Religious School #002","3.976","4.148","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Religious School #002","Religious School #003","7.623","1.937","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious School #003","Religious School #004","5.828","8.600","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Religious School #004","Religious School #005","1.825","1.292","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious School #005","Religious School #001","2.517","2.306","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":619},{"label":"Mar","value":541},{"label":"Abr","value":664},{"label":"Mai","value":425},{"label":"Jun","value":485},{"label":"Jul","value":750},{"label":"Ago","value":450},{"label":"Set","value":701},{"label":"Out","value":532},{"label":"Nov","value":798},{"label":"Dez","value":649}];
const MX = 798;
