...
const ACCENT = "#4c1d95";
const MODULE = "Religious School (K-12)";
const PAGE = "Faculty";
const KPIS = [{"l":"Total Religious School","v":"6.391","t":"+13.6%","d":"up"},{"l":"Faculty Ativos","v":"1.584","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"84.3%","t":"+16.0%","d":"up"},{"l":"Score Performance","v":"91","t":"+1.8%","d":"up"}];
const COLS = ["ID","Faculty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious School #001","Religious School #002","4.826","353","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Religious School #002","Religious School #003","2.117","663","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious School #003","Religious School #004","8.204","9.092","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Religious School #004","Religious School #005","8.425","2.443","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious School #005","Religious School #001","7.333","4.680","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":601},{"label":"Mar","value":752},{"label":"Abr","value":614},{"label":"Mai","value":914},{"label":"Jun","value":833},{"label":"Jul","value":901},{"label":"Ago","value":761},{"label":"Set","value":932},{"label":"Out","value":731},{"label":"Nov","value":746},{"label":"Dez","value":662}];
const MX = 932;
