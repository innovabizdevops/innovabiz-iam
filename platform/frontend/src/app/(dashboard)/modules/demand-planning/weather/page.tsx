...
const PAGE = "Weather Impact";
const KPIS = [{"l":"Projetos Sociais","v":"2.192","t":"+2.8%","d":"up"},{"l":"Beneficiários","v":"397","t":"-2.6%","d":"down"},{"l":"Investimento CSR (€)","v":"€21553","t":"+14.8%","d":"up"},{"l":"Score Impacto","v":"85","t":"+6.5%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","741","€ 7790.01","4.788","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.283","€ 21455.62","1.020","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.654","€ 34531.44","3.361","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.952","€ 31369.60","4.801","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.374","€ 11802.97","3.376","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":917},{"label":"Mar","value":854},{"label":"Abr","value":798},{"label":"Mai","value":859},{"label":"Jun","value":839},{"label":"Jul","value":816},{"label":"Ago","value":701},{"label":"Set","value":720},{"label":"Out","value":682},{"label":"Nov","value":650},{"label":"Dez","value":567}];
const MX = 944;
