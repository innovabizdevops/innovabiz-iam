...
const ACCENT = "#6989af";
const MODULE = "Demand Planning";
const PAGE = "Forecast Engine";
const KPIS = [{"l":"Total Demand Planning","v":"2.145","t":"+7.8%","d":"up"},{"l":"Forecast Engine Ativos","v":"5.658","t":"+13.5%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+13.6%","d":"up"}];
const COLS = ["ID","Forecast Engine","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning #001","Demand Planning #002","1.573","4.078","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning #002","Demand Planning #003","8.978","8.364","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning #003","Demand Planning #004","4.662","2.564","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning #004","Demand Planning #005","8.707","7.491","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning #005","Demand Planning #001","950","5.370","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":491},{"label":"Mar","value":358},{"label":"Abr","value":407},{"label":"Mai","value":588},{"label":"Jun","value":596},{"label":"Jul","value":673},{"label":"Ago","value":496},{"label":"Set","value":676},{"label":"Out","value":615},{"label":"Nov","value":676},{"label":"Dez","value":455}];
const MX = 683;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6989af'}}>AI</span></h1>
                </div>
