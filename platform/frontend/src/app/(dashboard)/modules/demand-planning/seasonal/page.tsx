...
const PAGE = "Seasonal Model";
const KPIS = [{"l":"Total Demand Planning","v":"5.528","t":"-2.0%","d":"down"},{"l":"Seasonal Model Ativos","v":"5.062","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"82.7%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"59","t":"+16.7%","d":"up"}];
const COLS = ["ID","Seasonal Model","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning #001","Demand Planning #002","7.888","6.244","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning #002","Demand Planning #003","2.011","8.954","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning #003","Demand Planning #004","8.072","2.228","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning #004","Demand Planning #005","8.537","4.075","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning #005","Demand Planning #001","5.883","3.133","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1060},{"label":"Fev","value":699},{"label":"Mar","value":865},{"label":"Abr","value":966},{"label":"Mai","value":960},{"label":"Jun","value":821},{"label":"Jul","value":901},{"label":"Ago","value":982},{"label":"Set","value":931},{"label":"Out","value":845},{"label":"Nov","value":906},{"label":"Dez","value":944}];
const MX = 1060;
