...
const PAGE = "Promotion Impact";
const KPIS = [{"l":"Projetos Sociais","v":"995","t":"+12.0%","d":"up"},{"l":"Beneficiários","v":"6.366","t":"+7.8%","d":"up"},{"l":"Investimento CSR (€)","v":"€21999","t":"+17.1%","d":"up"},{"l":"Score Impacto","v":"90","t":"+13.4%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","9.097","€ 13562.06","7.346","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.638","€ 41953.94","7.833","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","5.771","€ 17684.65","5.029","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","4.846","€ 6381.91","422","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.289","€ 34749.42","7.870","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":693},{"label":"Mar","value":474},{"label":"Abr","value":566},{"label":"Mai","value":380},{"label":"Jun","value":461},{"label":"Jul","value":533},{"label":"Ago","value":490},{"label":"Set","value":323},{"label":"Out","value":572},{"label":"Nov","value":437},{"label":"Dez","value":500}];
const MX = 693;
