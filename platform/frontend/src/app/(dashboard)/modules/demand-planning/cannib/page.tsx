...
const PAGE = "Cannibalization";
const KPIS = [{"l":"Total Demand Planning","v":"7.462","t":"+12.2%","d":"up"},{"l":"Cannibalization Ativos","v":"6.702","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"84.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+16.7%","d":"up"}];
const COLS = ["ID","Cannibalization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning #001","Demand Planning #002","925","1.242","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning #002","Demand Planning #003","4.952","5.359","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning #003","Demand Planning #004","1.962","6.533","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning #004","Demand Planning #005","6.206","5.386","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning #005","Demand Planning #001","2.314","6.099","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":435},{"label":"Mar","value":583},{"label":"Abr","value":568},{"label":"Mai","value":610},{"label":"Jun","value":521},{"label":"Jul","value":553},{"label":"Ago","value":586},{"label":"Set","value":575},{"label":"Out","value":474},{"label":"Nov","value":691},{"label":"Dez","value":558}];
const MX = 691;
...
export default function CannibPage() {
    return (
