...
const PAGE = "Consensus Plan";
const KPIS = [{"l":"Total Demand Planning","v":"6.611","t":"+8.9%","d":"up"},{"l":"Consensus Plan Ativos","v":"487","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"95","t":"-4.8%","d":"down"}];
const COLS = ["ID","Consensus Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Demand Planning #001","Demand Planning #002","3.401","8.246","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Demand Planning #002","Demand Planning #003","682","1.934","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Demand Planning #003","Demand Planning #004","4.158","5.569","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Demand Planning #004","Demand Planning #005","7.003","8.718","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Demand Planning #005","Demand Planning #001","6.441","7.881","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":803},{"label":"Mar","value":671},{"label":"Abr","value":827},{"label":"Mai","value":720},{"label":"Jun","value":635},{"label":"Jul","value":485},{"label":"Ago","value":741},{"label":"Set","value":499},{"label":"Out","value":699},{"label":"Nov","value":526},{"label":"Dez","value":659}];
const MX = 827;
