...
/* ═══ CMO/CDMO Management — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "7386", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1038", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€324K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2050307186", cells: ["CMO-9186", "CMO/CDMO Management Item 1", "19/3/2026", "€7286"], status: "active" as const },
    { id: "2050310757", cells: ["CMO-3757", "CMO/CDMO Management Item 2", "6/10/2026", "€10 857"], status: "pending" as const },
    { id: "2050314328", cells: ["CMO-7328", "CMO/CDMO Management Item 3", "21/5/2026", "€14 428"], status: "completed" as const },
    { id: "2050317899", cells: ["CMO-1899", "CMO/CDMO Management Item 4", "8/12/2026", "€17 999"], status: "warning" as const },
    { id: "2050321470", cells: ["CMO-5470", "CMO/CDMO Management Item 5", "23/7/2026", "€21 570"], status: "active" as const },
];
...
export default function CmocdmoManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CMO/CDMO Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CMO/CDMO Management</p>
                    </div>
                </div>
