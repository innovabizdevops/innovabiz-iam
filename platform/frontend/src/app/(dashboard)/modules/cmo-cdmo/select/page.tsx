...
const PAGE = "Select";
const KPIS = [{"l":"Total Cmo Cdmo","v":"7.279","t":"+14.3%","d":"up"},{"l":"Select Ativos","v":"7.246","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"69.7%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"85","t":"-1.3%","d":"down"}];
const COLS = ["ID","Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cmo Cdmo #001","Cmo Cdmo #002","2.155","485","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cmo Cdmo #002","Cmo Cdmo #003","4.920","3.480","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cmo Cdmo #003","Cmo Cdmo #004","6.848","8.314","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Cmo Cdmo #004","Cmo Cdmo #005","1.805","5.478","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cmo Cdmo #005","Cmo Cdmo #001","1.810","891","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":777},{"label":"Mar","value":650},{"label":"Abr","value":827},{"label":"Mai","value":859},{"label":"Jun","value":952},{"label":"Jul","value":804},{"label":"Ago","value":891},{"label":"Set","value":1010},{"label":"Out","value":832},{"label":"Nov","value":926},{"label":"Dez","value":743}];
const MX = 1010;
