...
const ACCENT = "#9333ea";
const MODULE = "CMO/CDMO Management";
const PAGE = "Contract";
const KPIS = [{"l":"Contratos Ativos","v":"9.069","t":"-0.7%","d":"down"},{"l":"Valor Total (€M)","v":"€10.3M","t":"+13.4%","d":"up"},{"l":"Renovações Próx. 30d","v":"6.318","t":"+14.3%","d":"up"},{"l":"Obrigações Pendentes","v":"5.903","t":"-2.5%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 19075.17","2026-01-19","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 49108.22","2026-02-13","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 48406.50","2026-02-22","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 26799.07","2026-01-09","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 33768.57","2026-03-13","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":705},{"label":"Mar","value":874},{"label":"Abr","value":668},{"label":"Mai","value":951},{"label":"Jun","value":969},{"label":"Jul","value":1002},{"label":"Ago","value":774},{"label":"Set","value":973},{"label":"Out","value":959},{"label":"Nov","value":901},{"label":"Dez","value":938}];
const MX = 1002;
