...
const PAGE = "Monitor";
const KPIS = [{"l":"Tickets Abertos","v":"4.122","t":"+6.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.0%","t":"+7.3%","d":"up"},{"l":"MTTR (h)","v":"183h","t":"+11.3%","d":"up"},{"l":"Satisfação (%)","v":"87.5%","t":"+4.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.907","6.674","6.447","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.549","506","4.934","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.316","5.668","1.273","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","9.062","948","7.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.936","1.505","4.945","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":638},{"label":"Mar","value":506},{"label":"Abr","value":523},{"label":"Mai","value":792},{"label":"Jun","value":863},{"label":"Jul","value":800},{"label":"Ago","value":670},{"label":"Set","value":519},{"label":"Out","value":786},{"label":"Nov","value":707},{"label":"Dez","value":613}];
const MX = 863;
