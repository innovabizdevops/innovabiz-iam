...
const ACCENT = "#475569";
const MODULE = "Access Management (ITIL)";
const PAGE = "Provision";
const KPIS = [{"l":"Tickets Abertos","v":"2.619","t":"-5.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"65.6%","t":"-5.8%","d":"down"},{"l":"MTTR (h)","v":"208h","t":"-4.5%","d":"down"},{"l":"Satisfação (%)","v":"93.6%","t":"+10.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.259","440","2.573","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.516","4.843","1.828","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.855","443","3.062","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.510","6.601","5.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.765","7.613","313","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":457},{"label":"Mar","value":671},{"label":"Abr","value":698},{"label":"Mai","value":771},{"label":"Jun","value":567},{"label":"Jul","value":590},{"label":"Ago","value":499},{"label":"Set","value":687},{"label":"Out","value":700},{"label":"Nov","value":671},{"label":"Dez","value":678}];
const MX = 771;
