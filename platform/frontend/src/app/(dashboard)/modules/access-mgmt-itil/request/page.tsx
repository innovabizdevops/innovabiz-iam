...
const PAGE = "Request";
const KPIS = [{"l":"Tickets Abertos","v":"6.789","t":"+7.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.6%","t":"+15.1%","d":"up"},{"l":"MTTR (h)","v":"34h","t":"-5.4%","d":"down"},{"l":"Satisfação (%)","v":"71.5%","t":"+9.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.523","5.052","7.544","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.351","3.042","6.479","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.245","4.398","4.104","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.755","289","9.047","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.232","5.891","7.461","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":724},{"label":"Mar","value":664},{"label":"Abr","value":390},{"label":"Mai","value":594},{"label":"Jun","value":630},{"label":"Jul","value":619},{"label":"Ago","value":724},{"label":"Set","value":522},{"label":"Out","value":688},{"label":"Nov","value":585},{"label":"Dez","value":601}];
const MX = 724;
