...
/* ═══ Access Management (ITIL) — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "996", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2954", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€103K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "910028696", cells: ["ACC-3696", "Access Management (ITIL) Item 1", "25/9/2026", "€28 796"], status: "active" as const },
    { id: "910032267", cells: ["ACC-7267", "Access Management (ITIL) Item 2", "12/4/2026", "€32 367"], status: "pending" as const },
    { id: "910035838", cells: ["ACC-1838", "Access Management (ITIL) Item 3", "27/11/2026", "€35 938"], status: "completed" as const },
    { id: "910039409", cells: ["ACC-5409", "Access Management (ITIL) Item 4", "14/6/2026", "€39 509"], status: "warning" as const },
    { id: "910042980", cells: ["ACC-8980", "Access Management (ITIL) Item 5", "1/1/2026", "€43 080"], status: "active" as const },
];
...
export default function AccessManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Access Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Access Management (ITIL)</p>
                    </div>
                </div>
