...
const PAGE = "Revoke";
const KPIS = [{"l":"Tickets Abertos","v":"4.038","t":"+13.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.5%","t":"+0.4%","d":"up"},{"l":"MTTR (h)","v":"177h","t":"+1.5%","d":"up"},{"l":"Satisfação (%)","v":"82.4%","t":"+8.3%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.687","5.020","8.956","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","360","2.322","8.330","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.729","8.222","509","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.017","1.335","3.258","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.538","537","1.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":479},{"label":"Mar","value":511},{"label":"Abr","value":632},{"label":"Mai","value":417},{"label":"Jun","value":725},{"label":"Jul","value":488},{"label":"Ago","value":490},{"label":"Set","value":623},{"label":"Out","value":672},{"label":"Nov","value":634},{"label":"Dez","value":361}];
const MX = 725;
