...
const PAGE = "Verify";
const KPIS = [{"l":"Tickets Abertos","v":"2.464","t":"+14.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.2%","t":"+4.6%","d":"up"},{"l":"MTTR (h)","v":"106h","t":"+12.4%","d":"up"},{"l":"Satisfação (%)","v":"67.2%","t":"+12.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.733","7.732","1.081","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.301","1.987","3.038","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.242","8.011","1.626","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.210","927","2.148","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","298","2.556","3.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":716},{"label":"Mar","value":866},{"label":"Abr","value":944},{"label":"Mai","value":849},{"label":"Jun","value":805},{"label":"Jul","value":871},{"label":"Ago","value":795},{"label":"Set","value":805},{"label":"Out","value":911},{"label":"Nov","value":762},{"label":"Dez","value":850}];
const MX = 944;
