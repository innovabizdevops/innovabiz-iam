...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.423","t":"+7.5%","d":"up"},{"l":"Contratos (€M)","v":"€42.7M","t":"+5.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"91.9%","t":"+9.5%","d":"up"},{"l":"Score Médio","v":"93","t":"+17.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","99.7%","€ 49981.41","8.318","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","92.0%","€ 6192.98","8.038","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","82.7%","€ 43822.55","5.272","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.9%","€ 36965.13","324","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","97.1%","€ 11668.80","550","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":377},{"label":"Fev","value":467},{"label":"Mar","value":515},{"label":"Abr","value":460},{"label":"Mai","value":299},{"label":"Jun","value":291},{"label":"Jul","value":439},{"label":"Ago","value":605},{"label":"Set","value":303},{"label":"Out","value":404},{"label":"Nov","value":617},{"label":"Dez","value":569}];
const MX = 617;
