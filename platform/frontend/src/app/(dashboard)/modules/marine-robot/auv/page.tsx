...
const PAGE = "AUV Mission";
const KPIS = [{"l":"Total Marine Robot","v":"2.364","t":"+3.4%","d":"up"},{"l":"AUV Mission Ativos","v":"8.496","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"81.0%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"84","t":"+14.7%","d":"up"}];
const COLS = ["ID","AUV Mission","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marine Robot #001","Marine Robot #002","3.236","3.057","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Marine Robot #002","Marine Robot #003","2.162","1.466","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Marine Robot #003","Marine Robot #004","3.175","550","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Marine Robot #004","Marine Robot #005","1.645","2.536","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marine Robot #005","Marine Robot #001","6.623","5.928","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":531},{"label":"Fev","value":307},{"label":"Mar","value":623},{"label":"Abr","value":289},{"label":"Mai","value":284},{"label":"Jun","value":327},{"label":"Jul","value":462},{"label":"Ago","value":355},{"label":"Set","value":421},{"label":"Out","value":573},{"label":"Nov","value":462},{"label":"Dez","value":460}];
const MX = 623;
