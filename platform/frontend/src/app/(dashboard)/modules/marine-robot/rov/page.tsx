...
const PAGE = "ROV Ops";
const KPIS = [{"l":"Total Marine Robot","v":"855","t":"+11.4%","d":"up"},{"l":"ROV Ops Ativos","v":"8.784","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"80.4%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.1%","d":"up"}];
const COLS = ["ID","ROV Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Marine Robot #001","Marine Robot #002","8.509","2.833","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Marine Robot #002","Marine Robot #003","6.248","3.292","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Marine Robot #003","Marine Robot #004","9.069","6.103","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Marine Robot #004","Marine Robot #005","6.452","2.022","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Marine Robot #005","Marine Robot #001","4.187","801","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":973},{"label":"Mar","value":714},{"label":"Abr","value":674},{"label":"Mai","value":966},{"label":"Jun","value":948},{"label":"Jul","value":975},{"label":"Ago","value":671},{"label":"Set","value":799},{"label":"Out","value":836},{"label":"Nov","value":866},{"label":"Dez","value":753}];
const MX = 975;
