...
const ACCENT = "#1e293b";
const MODULE = "Tattoo Studio";
const PAGE = "Aftercare";
const KPIS = [{"l":"Total Tattoo Studio","v":"8.195","t":"+9.9%","d":"up"},{"l":"Aftercare Ativos","v":"4.348","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"85.6%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"65","t":"+15.2%","d":"up"}];
const COLS = ["ID","Aftercare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tattoo Studio #001","Tattoo Studio #002","6.330","447","2026-02-18","Ativo"],"status":"active"},{"id":"r1","cells":["Tattoo Studio #002","Tattoo Studio #003","3.041","7.853","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Tattoo Studio #003","Tattoo Studio #004","5.221","7.330","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Tattoo Studio #004","Tattoo Studio #005","5.371","2.714","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tattoo Studio #005","Tattoo Studio #001","4.956","7.132","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":533},{"label":"Mar","value":361},{"label":"Abr","value":396},{"label":"Mai","value":676},{"label":"Jun","value":386},{"label":"Jul","value":725},{"label":"Ago","value":700},{"label":"Set","value":425},{"label":"Out","value":662},{"label":"Nov","value":434},{"label":"Dez","value":652}];
const MX = 725;
