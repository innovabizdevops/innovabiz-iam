...
const PAGE = "Artist";
const KPIS = [{"l":"Total Tattoo Studio","v":"6.471","t":"-1.6%","d":"down"},{"l":"Artist Ativos","v":"7.046","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"62","t":"+15.5%","d":"up"}];
const COLS = ["ID","Artist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tattoo Studio #001","Tattoo Studio #002","7.956","4.290","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Tattoo Studio #002","Tattoo Studio #003","4.490","6.740","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Tattoo Studio #003","Tattoo Studio #004","2.505","8.342","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Tattoo Studio #004","Tattoo Studio #005","1.552","166","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tattoo Studio #005","Tattoo Studio #001","9.092","6.974","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":603},{"label":"Mar","value":389},{"label":"Abr","value":650},{"label":"Mai","value":581},{"label":"Jun","value":450},{"label":"Jul","value":394},{"label":"Ago","value":628},{"label":"Set","value":471},{"label":"Out","value":527},{"label":"Nov","value":634},{"label":"Dez","value":342}];
const MX = 650;
