...
const KPIS = [
    ...
    { label: "Ativos", value: "1934", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€144K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "90%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "707903677", cells: ["TAT-9677", "Tattoo Studio Item 1", "6/2/2026", "€3777"], status: "active" as const },
    { id: "707907248", cells: ["TAT-4248", "Tattoo Studio Item 2", "21/9/2026", "€7348"], status: "pending" as const },
    { id: "707910819", cells: ["TAT-7819", "Tattoo Studio Item 3", "8/4/2026", "€10 919"], status: "completed" as const },
    { id: "707914390", cells: ["TAT-2390", "Tattoo Studio Item 4", "23/11/2026", "€14 490"], status: "warning" as const },
    { id: "707917961", cells: ["TAT-5961", "Tattoo Studio Item 5", "10/6/2026", "€18 061"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Tattoo Studio</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Tattoo Studio</p>
                    </div>
                </div>
