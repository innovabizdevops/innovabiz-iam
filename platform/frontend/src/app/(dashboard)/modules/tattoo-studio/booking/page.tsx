...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"2.799","t":"+5.9%","d":"up"},{"l":"RevPAR (€)","v":"€22042","t":"-3.3%","d":"down"},{"l":"Ocupação (%)","v":"88.9%","t":"-0.8%","d":"down"},{"l":"Guest Satisfaction","v":"3.533","t":"+17.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.536","2026-02-10","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.781","2026-01-11","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.998","2026-01-09","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.393","2026-01-13","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.178","2026-01-08","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":374},{"label":"Mar","value":326},{"label":"Abr","value":265},{"label":"Mai","value":332},{"label":"Jun","value":477},{"label":"Jul","value":296},{"label":"Ago","value":490},{"label":"Set","value":304},{"label":"Out","value":327},{"label":"Nov","value":274},{"label":"Dez","value":284}];
const MX = 535;
