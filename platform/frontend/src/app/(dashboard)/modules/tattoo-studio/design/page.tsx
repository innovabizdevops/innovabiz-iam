...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.420","t":"+12.8%","d":"up"},{"l":"Submissões/Dia","v":"2417","t":"+8.8%","d":"up"},{"l":"Documentos Gerados","v":"3.449","t":"+9.5%","d":"up"},{"l":"Templates","v":"2.507","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","981","2026-01-20","6.636","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.091","2026-03-03","998","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.496","2026-03-21","403","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.178","2026-01-10","8.955","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.822","2026-01-12","799","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":293},{"label":"Mar","value":574},{"label":"Abr","value":442},{"label":"Mai","value":588},{"label":"Jun","value":406},{"label":"Jul","value":405},{"label":"Ago","value":619},{"label":"Set","value":280},{"label":"Out","value":340},{"label":"Nov","value":279},{"label":"Dez","value":628}];
const MX = 628;
