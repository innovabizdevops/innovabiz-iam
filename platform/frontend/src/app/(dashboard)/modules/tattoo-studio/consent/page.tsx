...
const PAGE = "Consent";
const KPIS = [{"l":"Total Tattoo Studio","v":"142","t":"-4.6%","d":"down"},{"l":"Consent Ativos","v":"6.060","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"62","t":"+2.1%","d":"up"}];
const COLS = ["ID","Consent","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tattoo Studio #001","Tattoo Studio #002","8.234","1.581","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Tattoo Studio #002","Tattoo Studio #003","5.139","1.487","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Tattoo Studio #003","Tattoo Studio #004","377","7.623","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Tattoo Studio #004","Tattoo Studio #005","7.674","958","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tattoo Studio #005","Tattoo Studio #001","7.416","6.397","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":893},{"label":"Fev","value":917},{"label":"Mar","value":865},{"label":"Abr","value":695},{"label":"Mai","value":753},{"label":"Jun","value":891},{"label":"Jul","value":972},{"label":"Ago","value":924},{"label":"Set","value":759},{"label":"Out","value":642},{"label":"Nov","value":940},{"label":"Dez","value":714}];
const MX = 972;
