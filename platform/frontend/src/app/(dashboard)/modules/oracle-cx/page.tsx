...
/* ═══ CX Cloud (Oracle) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "9027", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1851", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1652764427", cells: ["ORA-5427", "CX Cloud (Oracle) Item 1", "28/12/2026", "€14 527"], status: "active" as const },
    { id: "1652767998", cells: ["ORA-8998", "CX Cloud (Oracle) Item 2", "15/7/2026", "€18 098"], status: "pending" as const },
    { id: "1652771569", cells: ["ORA-3569", "CX Cloud (Oracle) Item 3", "2/2/2026", "€21 669"], status: "completed" as const },
    { id: "1652775140", cells: ["ORA-7140", "CX Cloud (Oracle) Item 4", "17/9/2026", "€25 240"], status: "warning" as const },
    { id: "1652778711", cells: ["ORA-1711", "CX Cloud (Oracle) Item 5", "4/4/2026", "€28 811"], status: "active" as const },
];
...
export default function CxCloudOraclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CX Cloud (Oracle)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CX Cloud (Oracle)</p>
                    </div>
                </div>
