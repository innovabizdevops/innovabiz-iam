...
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€54802","t":"-2.0%","d":"down"},{"l":"Pipeline (€)","v":"€56823","t":"-3.9%","d":"down"},{"l":"Atingimento Quota (%)","v":"65.5%","t":"+11.5%","d":"up"},{"l":"Win Rate (%)","v":"68.6%","t":"+13.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 7468.65","€ 22547.37","€ 33723.07","71.9%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 36001.32","€ 32353.80","€ 38863.32","84.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 18517.39","€ 18974.27","€ 44117.29","84.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 41479.54","€ 5400.99","€ 40200.44","98.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 40227.52","€ 2541.62","€ 1828.97","94.7%"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":812},{"label":"Mar","value":841},{"label":"Abr","value":734},{"label":"Mai","value":595},{"label":"Jun","value":519},{"label":"Jul","value":852},{"label":"Ago","value":698},{"label":"Set","value":620},{"label":"Out","value":847},{"label":"Nov","value":854},{"label":"Dez","value":757}];
const MX = 854;
