...
const PAGE = "Manifest";
const KPIS = [{"l":"Total Waste Hazardous","v":"625","t":"+4.5%","d":"up"},{"l":"Manifest Ativos","v":"8.458","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"+3.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+0.2%","d":"up"}];
const COLS = ["ID","Manifest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Hazardous #001","Waste Hazardous #002","4.982","6.044","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Hazardous #002","Waste Hazardous #003","1.128","435","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Hazardous #003","Waste Hazardous #004","2.947","5.720","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Hazardous #004","Waste Hazardous #005","3.350","1.252","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Hazardous #005","Waste Hazardous #001","2.405","5.588","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":625},{"label":"Mar","value":593},{"label":"Abr","value":700},{"label":"Mai","value":645},{"label":"Jun","value":653},{"label":"Jul","value":610},{"label":"Ago","value":976},{"label":"Set","value":819},{"label":"Out","value":779},{"label":"Nov","value":962},{"label":"Dez","value":848}];
const MX = 976;
