...
export default function WasteHazardousPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Waste Hazardous</h1><p className="text-sm text-muted-foreground">Waste Hazardous • iBOS Enterprise</p></div>
