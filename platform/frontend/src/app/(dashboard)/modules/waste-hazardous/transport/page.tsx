...
const KPIS = [{"l":"Atletas Registados","v":"7.864","t":"+17.5%","d":"up"},{"l":"Treinos/Semana","v":"1276","t":"+7.1%","d":"up"},{"l":"Competições","v":"7.430","t":"+2.8%","d":"up"},{"l":"Performance Score","v":"90","t":"-4.7%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.305","791","7.432","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.477","8.103","5.392","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","900","4.290","3.377","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.086","7.448","6.367","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.003","4.188","2.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":749},{"label":"Mar","value":788},{"label":"Abr","value":501},{"label":"Mai","value":868},{"label":"Jun","value":830},{"label":"Jul","value":763},{"label":"Ago","value":830},{"label":"Set","value":568},{"label":"Out","value":651},{"label":"Nov","value":734},{"label":"Dez","value":851}];
const MX = 868;
