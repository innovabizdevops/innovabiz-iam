...
const PAGE = "Treat";
const KPIS = [{"l":"Total Waste Hazardous","v":"7.272","t":"+2.7%","d":"up"},{"l":"Treat Ativos","v":"9.052","t":"-2.3%","d":"down"},{"l":"Eficiência (%)","v":"92.9%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"64","t":"+6.5%","d":"up"}];
const COLS = ["ID","Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Hazardous #001","Waste Hazardous #002","1.746","6.369","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Hazardous #002","Waste Hazardous #003","8.808","5.433","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Hazardous #003","Waste Hazardous #004","2.551","7.856","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Hazardous #004","Waste Hazardous #005","1.556","947","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Hazardous #005","Waste Hazardous #001","3.475","1.222","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":441},{"label":"Mar","value":658},{"label":"Abr","value":749},{"label":"Mai","value":613},{"label":"Jun","value":607},{"label":"Jul","value":711},{"label":"Ago","value":775},{"label":"Set","value":719},{"label":"Out","value":498},{"label":"Nov","value":550},{"label":"Dez","value":510}];
const MX = 775;
