...
const PAGE = "Classify";
const KPIS = [{"l":"Total Waste Hazardous","v":"1.371","t":"+14.4%","d":"up"},{"l":"Classify Ativos","v":"7.290","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"77.7%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"64","t":"-3.0%","d":"down"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Hazardous #001","Waste Hazardous #002","4.029","1.279","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Hazardous #002","Waste Hazardous #003","5.929","7.958","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Hazardous #003","Waste Hazardous #004","8.942","3.111","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Hazardous #004","Waste Hazardous #005","5.076","7.384","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Hazardous #005","Waste Hazardous #001","2.034","2.948","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":649},{"label":"Mar","value":653},{"label":"Abr","value":512},{"label":"Mai","value":463},{"label":"Jun","value":354},{"label":"Jul","value":418},{"label":"Ago","value":676},{"label":"Set","value":420},{"label":"Out","value":642},{"label":"Nov","value":681},{"label":"Dez","value":642}];
const MX = 681;
