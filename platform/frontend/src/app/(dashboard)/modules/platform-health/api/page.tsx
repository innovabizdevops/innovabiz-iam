...
const PAGE = "API";
const KPIS = [{"l":"Formulários Ativos","v":"2.507","t":"-4.2%","d":"down"},{"l":"Submissões/Dia","v":"2765","t":"+1.5%","d":"up"},{"l":"Documentos Gerados","v":"5.029","t":"-4.7%","d":"down"},{"l":"Templates","v":"112","t":"+0.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.463","2026-03-11","7.277","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.274","2026-02-24","3.293","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.595","2026-02-21","1.351","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","859","2026-01-22","7.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.748","2026-01-08","8.773","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":750},{"label":"Mar","value":919},{"label":"Abr","value":634},{"label":"Mai","value":752},{"label":"Jun","value":799},{"label":"Jul","value":964},{"label":"Ago","value":974},{"label":"Set","value":674},{"label":"Out","value":878},{"label":"Nov","value":682},{"label":"Dez","value":756}];
const MX = 997;
