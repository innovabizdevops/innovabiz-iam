...
const ACCENT = "#22c55e";
const MODULE = "Platform Health Monitor";
const PAGE = "Cost";
const KPIS = [{"l":"Formulários Ativos","v":"170","t":"-4.3%","d":"down"},{"l":"Submissões/Dia","v":"2874","t":"+5.5%","d":"up"},{"l":"Documentos Gerados","v":"3.659","t":"+17.0%","d":"up"},{"l":"Templates","v":"7.401","t":"-3.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.412","2026-03-04","2.109","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.887","2026-02-21","3.243","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.025","2026-03-12","4.930","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.610","2026-01-01","6.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.958","2026-02-23","4.268","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":385},{"label":"Mar","value":651},{"label":"Abr","value":615},{"label":"Mai","value":690},{"label":"Jun","value":665},{"label":"Jul","value":438},{"label":"Ago","value":670},{"label":"Set","value":406},{"label":"Out","value":529},{"label":"Nov","value":385},{"label":"Dez","value":450}];
const MX = 766;
