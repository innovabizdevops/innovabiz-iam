...
const PAGE = "User";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.498","t":"+8.0%","d":"up"},{"l":"Sessões/Dia","v":"3188","t":"+1.3%","d":"up"},{"l":"MFA Adoção (%)","v":"72.1%","t":"+9.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.971","t":"-0.2%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.022","8.887","6.181","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.328","493","525","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.621","5.650","880","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.725","6.741","4.417","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.292","4.180","3.985","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":956},{"label":"Mar","value":714},{"label":"Abr","value":667},{"label":"Mai","value":655},{"label":"Jun","value":878},{"label":"Jul","value":600},{"label":"Ago","value":607},{"label":"Set","value":774},{"label":"Out","value":865},{"label":"Nov","value":870},{"label":"Dez","value":671}];
const MX = 956;
