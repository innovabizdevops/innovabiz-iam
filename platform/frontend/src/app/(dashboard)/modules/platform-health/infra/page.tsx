...
const PAGE = "Infra";
const KPIS = [{"l":"Formulários Ativos","v":"7.437","t":"+15.0%","d":"up"},{"l":"Submissões/Dia","v":"4769","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"812","t":"-3.5%","d":"down"},{"l":"Templates","v":"2.591","t":"+1.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.053","2026-01-25","3.487","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.406","2026-02-28","7.519","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.758","2026-01-26","3.778","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.507","2026-02-15","7.660","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.086","2026-02-11","1.027","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":802},{"label":"Mar","value":917},{"label":"Abr","value":764},{"label":"Mai","value":1050},{"label":"Jun","value":747},{"label":"Jul","value":995},{"label":"Ago","value":833},{"label":"Set","value":743},{"label":"Out","value":834},{"label":"Nov","value":761},{"label":"Dez","value":760}];
const MX = 1050;
