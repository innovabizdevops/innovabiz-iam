...
/* ═══ Platform Health Monitor — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "455", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1520", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1886069155", cells: ["PLA-3155", "Platform Health Monitor Item 1", "20/8/2026", "€19 255"], status: "active" as const },
    { id: "1886072726", cells: ["PLA-6726", "Platform Health Monitor Item 2", "7/3/2026", "€22 826"], status: "pending" as const },
    { id: "1886076297", cells: ["PLA-1297", "Platform Health Monitor Item 3", "22/10/2026", "€26 397"], status: "completed" as const },
    { id: "1886079868", cells: ["PLA-4868", "Platform Health Monitor Item 4", "9/5/2026", "€29 968"], status: "warning" as const },
    { id: "1886083439", cells: ["PLA-8439", "Platform Health Monitor Item 5", "24/12/2026", "€33 539"], status: "active" as const },
];
...
export default function PlatformHealthMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Health Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Health Monitor</p>
                    </div>
                </div>
