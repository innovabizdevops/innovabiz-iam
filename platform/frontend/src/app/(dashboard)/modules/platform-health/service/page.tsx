...
const PAGE = "Service";
const KPIS = [{"l":"Formulários Ativos","v":"2.492","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"3240","t":"+4.5%","d":"up"},{"l":"Documentos Gerados","v":"6.691","t":"+4.7%","d":"up"},{"l":"Templates","v":"718","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.167","2026-03-27","7.908","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.792","2026-01-19","5.746","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.566","2026-03-13","894","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.066","2026-01-14","427","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.666","2026-01-14","724","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":487},{"label":"Fev","value":570},{"label":"Mar","value":794},{"label":"Abr","value":488},{"label":"Mai","value":698},{"label":"Jun","value":630},{"label":"Jul","value":714},{"label":"Ago","value":619},{"label":"Set","value":450},{"label":"Out","value":453},{"label":"Nov","value":469},{"label":"Dez","value":696}];
const MX = 794;
