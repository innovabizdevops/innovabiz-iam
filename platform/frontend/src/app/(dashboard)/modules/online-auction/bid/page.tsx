...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.714","t":"+14.6%","d":"up"},{"l":"Contratos (€M)","v":"€30.3M","t":"+10.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.6%","t":"+16.0%","d":"up"},{"l":"Score Médio","v":"58","t":"+11.0%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","87.3%","€ 23289.77","6.099","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.3%","€ 12094.48","360","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","87.3%","€ 33750.51","2.213","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.5%","€ 47260.55","8.540","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.5%","€ 8954.54","2.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":632},{"label":"Mar","value":698},{"label":"Abr","value":629},{"label":"Mai","value":436},{"label":"Jun","value":532},{"label":"Jul","value":641},{"label":"Ago","value":697},{"label":"Set","value":577},{"label":"Out","value":344},{"label":"Nov","value":677},{"label":"Dez","value":601}];
const MX = 715;
