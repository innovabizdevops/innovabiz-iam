...
/* ═══ Online Auction Platform — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3720", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4702", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€434K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1490795120", cells: ["ONL-9120", "Online Auction Platform Item 1", "25/9/2026", "€45 220"], status: "active" as const },
    { id: "1490798691", cells: ["ONL-3691", "Online Auction Platform Item 2", "12/4/2026", "€48 791"], status: "pending" as const },
    { id: "1490802262", cells: ["ONL-7262", "Online Auction Platform Item 3", "27/11/2026", "€2362"], status: "completed" as const },
    { id: "1490805833", cells: ["ONL-1833", "Online Auction Platform Item 4", "14/6/2026", "€5933"], status: "warning" as const },
    { id: "1490809404", cells: ["ONL-5404", "Online Auction Platform Item 5", "1/1/2026", "€9504"], status: "active" as const },
];
...
export default function OnlineAuctionPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Online Auction Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Online Auction Platform</p>
                    </div>
                </div>
