...
const PAGE = "Buy Now";
const KPIS = [{"l":"Total Online Auction","v":"3.631","t":"+17.0%","d":"up"},{"l":"Buy Now Ativos","v":"1.464","t":"+13.9%","d":"up"},{"l":"Eficiência (%)","v":"69.1%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"75","t":"-4.3%","d":"down"}];
const COLS = ["ID","Buy Now","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Online Auction #001","Online Auction #002","586","8.211","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Online Auction #002","Online Auction #003","3.506","2.586","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Online Auction #003","Online Auction #004","134","4.448","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Online Auction #004","Online Auction #005","2.758","6.719","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Online Auction #005","Online Auction #001","7.959","6.243","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":287},{"label":"Mar","value":390},{"label":"Abr","value":554},{"label":"Mai","value":508},{"label":"Jun","value":401},{"label":"Jul","value":259},{"label":"Ago","value":268},{"label":"Set","value":257},{"label":"Out","value":313},{"label":"Nov","value":458},{"label":"Dez","value":252}];
const MX = 588;
