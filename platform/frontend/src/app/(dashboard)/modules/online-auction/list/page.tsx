...
const PAGE = "List";
const KPIS = [{"l":"Total Online Auction","v":"2.003","t":"+2.8%","d":"up"},{"l":"List Ativos","v":"5.036","t":"+7.7%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+7.6%","d":"up"}];
const COLS = ["ID","List","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Online Auction #001","Online Auction #002","8.020","8.126","2026-01-12","Ativo"],"status":"active"},{"id":"r1","cells":["Online Auction #002","Online Auction #003","4.599","8.205","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Online Auction #003","Online Auction #004","2.385","6.026","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Online Auction #004","Online Auction #005","8.296","5.942","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Online Auction #005","Online Auction #001","1.214","3.815","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":732},{"label":"Mar","value":558},{"label":"Abr","value":677},{"label":"Mai","value":456},{"label":"Jun","value":684},{"label":"Jul","value":822},{"label":"Ago","value":732},{"label":"Set","value":504},{"label":"Out","value":638},{"label":"Nov","value":566},{"label":"Dez","value":561}];
const MX = 822;
