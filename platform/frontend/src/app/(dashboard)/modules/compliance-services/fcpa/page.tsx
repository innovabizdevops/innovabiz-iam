...
const ACCENT = "#6366f1";
const MODULE = "Compliance Services";
const PAGE = "FCPA &amp; UK Bribery Act";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.408","t":"+6.8%","d":"up"},{"l":"NC Abertas","v":"670","t":"+13.2%","d":"up"},{"l":"Conformidade (%)","v":"87.0%","t":"+3.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.714","t":"+13.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.632","83.0%","1.357","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.303","74.2%","4.742","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.045","91.7%","3.353","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.702","86.1%","2.762","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.881","75.4%","8.352","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":990},{"label":"Mar","value":961},{"label":"Abr","value":1031},{"label":"Mai","value":923},{"label":"Jun","value":817},{"label":"Jul","value":794},{"label":"Ago","value":1000},{"label":"Set","value":997},{"label":"Out","value":917},{"label":"Nov","value":823},{"label":"Dez","value":823}];
const MX = 1031;
...
export default function FcpaPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Law</span></h1>
                </div>
