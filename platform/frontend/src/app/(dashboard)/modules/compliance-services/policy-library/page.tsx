...
const PAGE = "Policy Library";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.504","t":"+0.1%","d":"up"},{"l":"NC Abertas","v":"5.455","t":"+15.2%","d":"up"},{"l":"Conformidade (%)","v":"72.5%","t":"+14.1%","d":"up"},{"l":"CAPAs Pendentes","v":"6.139","t":"+16.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.177","97.0%","3.506","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.288","91.4%","6.919","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.623","72.3%","8.168","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.460","83.0%","6.092","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.885","95.1%","8.958","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":503},{"label":"Mar","value":362},{"label":"Abr","value":279},{"label":"Mai","value":597},{"label":"Jun","value":286},{"label":"Jul","value":436},{"label":"Ago","value":276},{"label":"Set","value":615},{"label":"Out","value":478},{"label":"Nov","value":234},{"label":"Dez","value":379}];
const MX = 615;
