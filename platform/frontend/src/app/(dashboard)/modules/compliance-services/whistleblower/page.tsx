...
const PAGE = "Whistleblower Portal";
const KPIS = [{"l":"Auditorias Realizadas","v":"8.579","t":"-2.2%","d":"down"},{"l":"NC Abertas","v":"5.440","t":"+1.1%","d":"up"},{"l":"Conformidade (%)","v":"72.9%","t":"+16.4%","d":"up"},{"l":"CAPAs Pendentes","v":"4.422","t":"+1.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.345","88.0%","7.110","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.671","89.2%","6.680","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.417","85.9%","6.179","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.084","81.1%","7.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","630","87.0%","2.833","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":564},{"label":"Mar","value":401},{"label":"Abr","value":469},{"label":"Mai","value":666},{"label":"Jun","value":353},{"label":"Jul","value":348},{"label":"Ago","value":539},{"label":"Set","value":561},{"label":"Out","value":379},{"label":"Nov","value":657},{"label":"Dez","value":547}];
const MX = 666;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>EU</span></h1>
                </div>
