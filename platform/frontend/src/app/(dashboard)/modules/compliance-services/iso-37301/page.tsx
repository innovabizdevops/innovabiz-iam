...
const PAGE = "ISO 37301 Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"414","t":"+17.4%","d":"up"},{"l":"NC Abertas","v":"3.438","t":"+16.3%","d":"up"},{"l":"Conformidade (%)","v":"82.9%","t":"+14.8%","d":"up"},{"l":"CAPAs Pendentes","v":"7.656","t":"+15.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.605","91.8%","2.594","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.910","92.8%","1.668","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","899","95.9%","9.003","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.448","75.2%","4.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.948","87.4%","5.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":426},{"label":"Mar","value":399},{"label":"Abr","value":409},{"label":"Mai","value":440},{"label":"Jun","value":621},{"label":"Jul","value":460},{"label":"Ago","value":660},{"label":"Set","value":674},{"label":"Out","value":722},{"label":"Nov","value":535},{"label":"Dez","value":565}];
const MX = 729;
