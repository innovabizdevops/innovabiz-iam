...
const KPIS = [{"l":"Riscos Identificados","v":"5.705","t":"+14.8%","d":"up"},{"l":"Mitigações Ativas","v":"1.392","t":"+5.5%","d":"up"},{"l":"Score Risco Geral","v":"72","t":"+12.9%","d":"up"},{"l":"Incidentes YTD","v":"2.496","t":"+4.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.796","1.902","3.210","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","257","3.888","7.486","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.298","6.249","1.362","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.954","7.948","1.588","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.122","1.977","3.951","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":591},{"label":"Mar","value":323},{"label":"Abr","value":453},{"label":"Mai","value":465},{"label":"Jun","value":650},{"label":"Jul","value":460},{"label":"Ago","value":390},{"label":"Set","value":499},{"label":"Out","value":403},{"label":"Nov","value":511},{"label":"Dez","value":502}];
const MX = 650;
