...
const PAGE = "ISO 37001 Anti-Bribery";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.598","t":"+10.3%","d":"up"},{"l":"NC Abertas","v":"8.469","t":"+5.6%","d":"up"},{"l":"Conformidade (%)","v":"71.5%","t":"+12.4%","d":"up"},{"l":"CAPAs Pendentes","v":"722","t":"+8.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.787","76.1%","8.302","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.362","71.6%","8.243","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.688","78.3%","4.148","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.234","84.7%","312","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","616","77.5%","1.783","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":940},{"label":"Mar","value":619},{"label":"Abr","value":801},{"label":"Mai","value":709},{"label":"Jun","value":866},{"label":"Jul","value":963},{"label":"Ago","value":926},{"label":"Set","value":722},{"label":"Out","value":584},{"label":"Nov","value":925},{"label":"Dez","value":970}];
const MX = 970;
