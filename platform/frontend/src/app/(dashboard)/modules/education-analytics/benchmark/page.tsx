...
const KPIS = [{"l":"Dashboards Ativos","v":"1.190","t":"-0.7%","d":"down"},{"l":"Queries/Dia","v":"4491","t":"+14.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.737","t":"-0.4%","d":"down"},{"l":"Utilizadores Analytics","v":"2.089","t":"+11.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3754","2026-03-25","7.211","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1493","2026-02-27","1.926","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3920","2026-03-04","8.974","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5023","2026-01-07","6.205","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3338","2026-03-09","6.418","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":399},{"label":"Mar","value":576},{"label":"Abr","value":457},{"label":"Mai","value":600},{"label":"Jun","value":237},{"label":"Jul","value":244},{"label":"Ago","value":470},{"label":"Set","value":584},{"label":"Out","value":593},{"label":"Nov","value":319},{"label":"Dez","value":611}];
const MX = 611;
