...
const KPIS = [{"l":"Dashboards Ativos","v":"2.128","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"2057","t":"-2.0%","d":"down"},{"l":"Dados Processados (GB)","v":"6.195","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"962","t":"+2.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","906","2026-03-01","1.154","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3499","2026-03-19","2.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4004","2026-02-11","5.768","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2731","2026-03-15","7.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","228","2026-03-28","5.067","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":657},{"label":"Mar","value":549},{"label":"Abr","value":650},{"label":"Mai","value":837},{"label":"Jun","value":734},{"label":"Jul","value":700},{"label":"Ago","value":715},{"label":"Set","value":592},{"label":"Out","value":692},{"label":"Nov","value":746},{"label":"Dez","value":711}];
const MX = 844;
