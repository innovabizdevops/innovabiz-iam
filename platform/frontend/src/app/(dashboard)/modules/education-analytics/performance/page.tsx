...
const ACCENT = "#0ea5e9";
const MODULE = "Education Analytics";
const PAGE = "Performance";
const KPIS = [{"l":"Formulários Ativos","v":"3.312","t":"+2.3%","d":"up"},{"l":"Submissões/Dia","v":"526","t":"+8.6%","d":"up"},{"l":"Documentos Gerados","v":"4.417","t":"+9.2%","d":"up"},{"l":"Templates","v":"6.531","t":"+14.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.118","2026-01-14","6.605","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.008","2026-02-04","6.123","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.103","2026-01-06","2.232","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.671","2026-02-16","1.077","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","522","2026-01-01","2.907","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":578},{"label":"Fev","value":437},{"label":"Mar","value":698},{"label":"Abr","value":356},{"label":"Mai","value":681},{"label":"Jun","value":738},{"label":"Jul","value":458},{"label":"Ago","value":367},{"label":"Set","value":713},{"label":"Out","value":365},{"label":"Nov","value":694},{"label":"Dez","value":595}];
const MX = 738;
