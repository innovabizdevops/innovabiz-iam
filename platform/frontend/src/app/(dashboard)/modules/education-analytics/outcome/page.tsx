...
const PAGE = "Outcome";
const KPIS = [{"l":"Dashboards Ativos","v":"5.100","t":"-2.8%","d":"down"},{"l":"Queries/Dia","v":"4001","t":"-0.2%","d":"down"},{"l":"Dados Processados (GB)","v":"8.417","t":"+5.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.979","t":"+7.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2719","2026-03-09","741","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2670","2026-02-06","4.731","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3433","2026-01-14","8.577","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4487","2026-01-24","7.798","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1600","2026-03-11","8.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":751},{"label":"Mar","value":899},{"label":"Abr","value":679},{"label":"Mai","value":850},{"label":"Jun","value":710},{"label":"Jul","value":910},{"label":"Ago","value":894},{"label":"Set","value":777},{"label":"Out","value":637},{"label":"Nov","value":850},{"label":"Dez","value":917}];
const MX = 917;
