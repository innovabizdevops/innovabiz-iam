...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"4.510","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"1053","t":"+12.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.989","t":"+15.3%","d":"up"},{"l":"Utilizadores Analytics","v":"3.831","t":"+3.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2880","2026-01-23","8.177","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4863","2026-01-13","8.267","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","570","2026-03-08","5.665","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1593","2026-01-01","8.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2028","2026-02-21","125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":872},{"label":"Mar","value":725},{"label":"Abr","value":725},{"label":"Mai","value":800},{"label":"Jun","value":749},{"label":"Jul","value":677},{"label":"Ago","value":500},{"label":"Set","value":670},{"label":"Out","value":810},{"label":"Nov","value":609},{"label":"Dez","value":873}];
const MX = 873;
