...
const PAGE = "Award Notice";
const KPIS = [{"l":"Fornecedores Ativos","v":"8.123","t":"+10.6%","d":"up"},{"l":"Contratos (€M)","v":"€43.9M","t":"+1.7%","d":"up"},{"l":"On-Time Delivery (%)","v":"77.6%","t":"+12.8%","d":"up"},{"l":"Score Médio","v":"79","t":"-4.2%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","91.3%","€ 34100.93","5.873","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","90.3%","€ 4442.95","8.156","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","73.5%","€ 42589.91","530","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","88.4%","€ 17660.64","2.874","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","73.8%","€ 29461.37","5.796","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":615},{"label":"Mar","value":599},{"label":"Abr","value":746},{"label":"Mai","value":547},{"label":"Jun","value":532},{"label":"Jul","value":799},{"label":"Ago","value":788},{"label":"Set","value":496},{"label":"Out","value":691},{"label":"Nov","value":494},{"label":"Dez","value":452}];
const MX = 799;
