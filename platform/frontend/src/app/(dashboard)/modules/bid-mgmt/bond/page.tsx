...
const KPIS = [{"l":"Fornecedores Ativos","v":"4.924","t":"-3.8%","d":"down"},{"l":"Contratos (€M)","v":"€13.7M","t":"+13.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"86.7%","t":"+17.3%","d":"up"},{"l":"Score Médio","v":"72","t":"+12.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","71.9%","€ 1706.11","9.054","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","91.6%","€ 14276.54","6.984","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.7%","€ 11350.50","3.769","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","78.4%","€ 47843.72","825","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","97.6%","€ 8856.41","7.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":474},{"label":"Mar","value":545},{"label":"Abr","value":525},{"label":"Mai","value":434},{"label":"Jun","value":434},{"label":"Jul","value":681},{"label":"Ago","value":680},{"label":"Set","value":528},{"label":"Out","value":542},{"label":"Nov","value":584},{"label":"Dez","value":427}];
const MX = 681;
