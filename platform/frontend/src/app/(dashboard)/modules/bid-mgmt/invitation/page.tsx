...
const ACCENT = "#5a7a9f";
const MODULE = "Bidding & Tender";
const PAGE = "Bid Invitation";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.630","t":"+9.4%","d":"up"},{"l":"Contratos (€M)","v":"€43.7M","t":"+8.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.1%","t":"+12.3%","d":"up"},{"l":"Score Médio","v":"62","t":"-2.0%","d":"down"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","82.4%","€ 30277.41","5.492","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.7%","€ 31803.24","5.826","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","88.2%","€ 35254.98","5.668","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","94.5%","€ 44383.60","4.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","70.8%","€ 42741.99","5.573","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":432},{"label":"Mar","value":543},{"label":"Abr","value":580},{"label":"Mai","value":658},{"label":"Jun","value":483},{"label":"Jul","value":585},{"label":"Ago","value":351},{"label":"Set","value":549},{"label":"Out","value":635},{"label":"Nov","value":522},{"label":"Dez","value":541}];
const MX = 658;
