...
const PAGE = "Case Routing";
const KPIS = [{"l":"eNPS","v":"83","t":"-2.9%","d":"down"},{"l":"Engagement (%)","v":"94.3%","t":"+9.6%","d":"up"},{"l":"Turnover (%)","v":"70.6%","t":"+11.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.720","t":"+12.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.028","2026-03-01","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.874","2026-02-07","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.028","2026-02-03","93","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.290","2026-01-21","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.776","2026-03-09","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":379},{"label":"Mar","value":456},{"label":"Abr","value":441},{"label":"Mai","value":361},{"label":"Jun","value":296},{"label":"Jul","value":455},{"label":"Ago","value":407},{"label":"Set","value":539},{"label":"Out","value":454},{"label":"Nov","value":648},{"label":"Dez","value":498}];
const MX = 648;
