...
const PAGE = "Internal Mobility";
const KPIS = [{"l":"eNPS","v":"75","t":"+13.0%","d":"up"},{"l":"Engagement (%)","v":"72.5%","t":"+9.5%","d":"up"},{"l":"Turnover (%)","v":"80.4%","t":"+4.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.283","t":"+1.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.266","2026-02-18","81","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.915","2026-02-01","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.149","2026-02-24","71","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.866","2026-02-24","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.304","2026-03-09","71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":393},{"label":"Mar","value":331},{"label":"Abr","value":487},{"label":"Mai","value":408},{"label":"Jun","value":302},{"label":"Jul","value":637},{"label":"Ago","value":411},{"label":"Set","value":405},{"label":"Out","value":625},{"label":"Nov","value":433},{"label":"Dez","value":465}];
const MX = 637;
