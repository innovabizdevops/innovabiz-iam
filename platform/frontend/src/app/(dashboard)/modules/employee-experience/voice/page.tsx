...
const PAGE = "Employee Voice";
const KPIS = [{"l":"eNPS","v":"59","t":"+14.2%","d":"up"},{"l":"Engagement (%)","v":"78.9%","t":"+3.3%","d":"up"},{"l":"Turnover (%)","v":"79.0%","t":"+7.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.356","t":"+12.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.408","2026-03-08","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.216","2026-02-15","95","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.748","2026-03-03","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.567","2026-01-13","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.089","2026-01-01","93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":596},{"label":"Mar","value":365},{"label":"Abr","value":634},{"label":"Mai","value":580},{"label":"Jun","value":455},{"label":"Jul","value":440},{"label":"Ago","value":712},{"label":"Set","value":567},{"label":"Out","value":696},{"label":"Nov","value":583},{"label":"Dez","value":559}];
const MX = 712;
