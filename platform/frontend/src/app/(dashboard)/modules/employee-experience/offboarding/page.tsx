...
const KPIS = [{"l":"eNPS","v":"89","t":"+6.4%","d":"up"},{"l":"Engagement (%)","v":"69.3%","t":"+11.0%","d":"up"},{"l":"Turnover (%)","v":"86.6%","t":"-3.8%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.757","t":"+7.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","351","2026-02-11","66","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.511","2026-02-11","55","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.071","2026-01-02","85","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.200","2026-02-03","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.009","2026-02-12","92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":726},{"label":"Fev","value":657},{"label":"Mar","value":450},{"label":"Abr","value":563},{"label":"Mai","value":772},{"label":"Jun","value":662},{"label":"Jul","value":760},{"label":"Ago","value":669},{"label":"Set","value":594},{"label":"Out","value":637},{"label":"Nov","value":840},{"label":"Dez","value":598}];
const MX = 840;
