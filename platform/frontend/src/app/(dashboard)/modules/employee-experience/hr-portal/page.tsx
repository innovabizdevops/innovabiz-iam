...
const PAGE = "HR Portal";
const KPIS = [{"l":"eNPS","v":"95","t":"-2.3%","d":"down"},{"l":"Engagement (%)","v":"65.5%","t":"+14.4%","d":"up"},{"l":"Turnover (%)","v":"78.5%","t":"-3.0%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.828","t":"+3.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.323","2026-03-19","95","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.933","2026-03-22","87","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.658","2026-01-16","85","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.979","2026-02-03","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.870","2026-02-09","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":430},{"label":"Fev","value":478},{"label":"Mar","value":697},{"label":"Abr","value":510},{"label":"Mai","value":731},{"label":"Jun","value":657},{"label":"Jul","value":402},{"label":"Ago","value":514},{"label":"Set","value":704},{"label":"Out","value":499},{"label":"Nov","value":595},{"label":"Dez","value":643}];
const MX = 731;
