...
const PAGE = "Employee Pulse";
const KPIS = [{"l":"eNPS","v":"94","t":"-4.0%","d":"down"},{"l":"Engagement (%)","v":"85.0%","t":"-5.9%","d":"down"},{"l":"Turnover (%)","v":"66.1%","t":"+6.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.845","t":"+9.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.574","2026-01-02","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.535","2026-03-04","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.221","2026-01-15","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.049","2026-02-12","59","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","1.087","2026-01-26","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":276},{"label":"Fev","value":449},{"label":"Mar","value":227},{"label":"Abr","value":594},{"label":"Mai","value":221},{"label":"Jun","value":289},{"label":"Jul","value":613},{"label":"Ago","value":397},{"label":"Set","value":598},{"label":"Out","value":303},{"label":"Nov","value":252},{"label":"Dez","value":559}];
const MX = 613;
...
export default function PulseSurveysEmployeeExperiencePage() {
    return (
