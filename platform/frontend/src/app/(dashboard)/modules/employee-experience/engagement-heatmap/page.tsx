...
const PAGE = "Engagement Heatmap";
const KPIS = [{"l":"eNPS","v":"89","t":"+5.2%","d":"up"},{"l":"Engagement (%)","v":"93.4%","t":"+10.5%","d":"up"},{"l":"Turnover (%)","v":"69.0%","t":"+4.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.332","t":"+17.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.499","2026-01-19","67","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","168","2026-02-14","88","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.480","2026-01-06","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.685","2026-03-25","60","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.582","2026-02-16","81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":498},{"label":"Mar","value":431},{"label":"Abr","value":461},{"label":"Mai","value":456},{"label":"Jun","value":609},{"label":"Jul","value":464},{"label":"Ago","value":583},{"label":"Set","value":428},{"label":"Out","value":463},{"label":"Nov","value":608},{"label":"Dez","value":719}];
const MX = 719;
