...
const PAGE = "Feedback Form";
const KPIS = [{"l":"eNPS","v":"77","t":"-5.4%","d":"down"},{"l":"Engagement (%)","v":"87.6%","t":"+15.2%","d":"up"},{"l":"Turnover (%)","v":"78.3%","t":"-5.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"1.019","t":"-2.0%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","330","2026-03-03","90","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","948","2026-01-09","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.802","2026-01-11","95","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.114","2026-01-14","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.349","2026-03-12","64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":524},{"label":"Mar","value":513},{"label":"Abr","value":318},{"label":"Mai","value":516},{"label":"Jun","value":498},{"label":"Jul","value":566},{"label":"Ago","value":512},{"label":"Set","value":675},{"label":"Out","value":311},{"label":"Nov","value":461},{"label":"Dez","value":666}];
const MX = 675;
