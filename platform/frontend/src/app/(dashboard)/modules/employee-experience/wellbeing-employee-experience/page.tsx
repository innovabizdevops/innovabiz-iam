...
const PAGE = "Wellbeing Hub";
const KPIS = [{"l":"eNPS","v":"64","t":"+3.8%","d":"up"},{"l":"Engagement (%)","v":"68.5%","t":"+8.4%","d":"up"},{"l":"Turnover (%)","v":"74.3%","t":"+15.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.224","t":"+8.1%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.498","2026-02-24","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.419","2026-03-11","55","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.971","2026-03-15","58","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.964","2026-03-20","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.840","2026-02-21","82","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":680},{"label":"Mar","value":640},{"label":"Abr","value":565},{"label":"Mai","value":565},{"label":"Jun","value":417},{"label":"Jul","value":598},{"label":"Ago","value":575},{"label":"Set","value":657},{"label":"Out","value":668},{"label":"Nov","value":476},{"label":"Dez","value":748}];
const MX = 748;
...
export default function WellbeingEmployeeExperiencePage() {
    return (
