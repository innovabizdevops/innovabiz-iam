...
const PAGE = "NPS Survey Form";
const KPIS = [{"l":"eNPS","v":"88","t":"+0.9%","d":"up"},{"l":"Engagement (%)","v":"68.2%","t":"+1.9%","d":"up"},{"l":"Turnover (%)","v":"90.5%","t":"+6.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.591","t":"+10.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","8.011","2026-03-03","91","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","624","2026-03-06","90","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.630","2026-01-28","62","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.951","2026-02-17","85","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.018","2026-02-10","58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":437},{"label":"Mar","value":350},{"label":"Abr","value":537},{"label":"Mai","value":564},{"label":"Jun","value":374},{"label":"Jul","value":335},{"label":"Ago","value":374},{"label":"Set","value":571},{"label":"Out","value":616},{"label":"Nov","value":531},{"label":"Dez","value":586}];
const MX = 616;
