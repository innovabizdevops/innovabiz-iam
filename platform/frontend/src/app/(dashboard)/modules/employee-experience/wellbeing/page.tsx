...
const PAGE = "Wellbeing &amp; Culture";
const KPIS = [{"l":"eNPS","v":"79","t":"-1.7%","d":"down"},{"l":"Engagement (%)","v":"71.0%","t":"+5.5%","d":"up"},{"l":"Turnover (%)","v":"77.1%","t":"+15.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.167","t":"-3.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.692","2026-01-08","74","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","6.247","2026-03-15","73","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","2.734","2026-01-08","74","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.008","2026-01-16","91","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.918","2026-03-13","55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":481},{"label":"Mar","value":748},{"label":"Abr","value":396},{"label":"Mai","value":380},{"label":"Jun","value":738},{"label":"Jul","value":508},{"label":"Ago","value":408},{"label":"Set","value":595},{"label":"Out","value":463},{"label":"Nov","value":472},{"label":"Dez","value":629}];
const MX = 748;
