...
const KPIS = [{"l":"eNPS","v":"95","t":"+0.2%","d":"up"},{"l":"Engagement (%)","v":"79.5%","t":"-4.5%","d":"down"},{"l":"Turnover (%)","v":"82.9%","t":"+15.7%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.344","t":"-2.3%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","1.567","2026-01-20","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","7.105","2026-03-13","67","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","883","2026-01-04","72","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.953","2026-02-06","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.625","2026-01-19","62","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":655},{"label":"Mar","value":634},{"label":"Abr","value":569},{"label":"Mai","value":783},{"label":"Jun","value":937},{"label":"Jul","value":543},{"label":"Ago","value":742},{"label":"Set","value":656},{"label":"Out","value":605},{"label":"Nov","value":769},{"label":"Dez","value":763}];
const MX = 937;
