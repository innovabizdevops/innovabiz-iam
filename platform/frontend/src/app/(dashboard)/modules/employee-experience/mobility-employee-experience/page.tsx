...
const KPIS = [{"l":"eNPS","v":"70","t":"-4.3%","d":"down"},{"l":"Engagement (%)","v":"85.4%","t":"-3.1%","d":"down"},{"l":"Turnover (%)","v":"69.7%","t":"+4.6%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.578","t":"+17.5%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.396","2026-03-04","61","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","1.470","2026-03-16","63","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","3.669","2026-01-16","67","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.308","2026-03-28","72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.732","2026-02-27","55","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":515},{"label":"Mar","value":361},{"label":"Abr","value":548},{"label":"Mai","value":359},{"label":"Jun","value":282},{"label":"Jul","value":286},{"label":"Ago","value":264},{"label":"Set","value":302},{"label":"Out","value":307},{"label":"Nov","value":430},{"label":"Dez","value":482}];
const MX = 548;
...
export default function MobilityEmployeeExperiencePage() {
    return (
