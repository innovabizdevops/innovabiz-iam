...
const KPIS = [{"l":"eNPS","v":"91","t":"+3.4%","d":"up"},{"l":"Engagement (%)","v":"70.9%","t":"+11.8%","d":"up"},{"l":"Turnover (%)","v":"89.8%","t":"+10.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.648","t":"+0.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.679","2026-01-26","86","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.775","2026-02-10","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.371","2026-03-13","80","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","252","2026-02-20","62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.459","2026-03-12","57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":582},{"label":"Mar","value":559},{"label":"Abr","value":742},{"label":"Mai","value":783},{"label":"Jun","value":724},{"label":"Jul","value":824},{"label":"Ago","value":891},{"label":"Set","value":545},{"label":"Out","value":699},{"label":"Nov","value":713},{"label":"Dez","value":636}];
const MX = 894;
