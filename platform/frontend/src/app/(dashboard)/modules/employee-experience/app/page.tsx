...
const PAGE = "Employee App";
const KPIS = [{"l":"eNPS","v":"91","t":"-0.7%","d":"down"},{"l":"Engagement (%)","v":"73.4%","t":"+13.2%","d":"up"},{"l":"Turnover (%)","v":"82.9%","t":"+16.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.908","t":"+2.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","849","2026-02-24","64","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.321","2026-02-25","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.044","2026-02-12","94","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","826","2026-03-25","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.924","2026-02-18","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":750},{"label":"Mar","value":849},{"label":"Abr","value":797},{"label":"Mai","value":814},{"label":"Jun","value":852},{"label":"Jul","value":696},{"label":"Ago","value":960},{"label":"Set","value":695},{"label":"Out","value":811},{"label":"Nov","value":812},{"label":"Dez","value":912}];
const MX = 960;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>Mobile</span></h1>
                </div>
