...
const PAGE = "Career Development";
const KPIS = [{"l":"eNPS","v":"62","t":"+6.8%","d":"up"},{"l":"Engagement (%)","v":"69.4%","t":"+6.9%","d":"up"},{"l":"Turnover (%)","v":"69.0%","t":"+17.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.913","t":"+11.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.970","2026-01-18","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","3.537","2026-02-20","93","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.918","2026-03-13","69","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.819","2026-01-21","78","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.240","2026-02-14","70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":905},{"label":"Fev","value":584},{"label":"Mar","value":569},{"label":"Abr","value":794},{"label":"Mai","value":568},{"label":"Jun","value":896},{"label":"Jul","value":637},{"label":"Ago","value":613},{"label":"Set","value":551},{"label":"Out","value":884},{"label":"Nov","value":773},{"label":"Dez","value":604}];
const MX = 905;
