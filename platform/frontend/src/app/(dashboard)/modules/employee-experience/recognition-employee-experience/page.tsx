...
const PAGE = "Kudos &amp; Recognition";
const KPIS = [{"l":"eNPS","v":"63","t":"+17.8%","d":"up"},{"l":"Engagement (%)","v":"84.7%","t":"+3.7%","d":"up"},{"l":"Turnover (%)","v":"68.3%","t":"+15.9%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"7.913","t":"+4.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.096","2026-02-17","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.407","2026-03-04","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","8.616","2026-03-12","77","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.048","2026-01-14","82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","3.231","2026-01-09","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":689},{"label":"Mar","value":515},{"label":"Abr","value":611},{"label":"Mai","value":531},{"label":"Jun","value":579},{"label":"Jul","value":763},{"label":"Ago","value":515},{"label":"Set","value":689},{"label":"Out","value":485},{"label":"Nov","value":616},{"label":"Dez","value":794}];
const MX = 794;
...
export default function RecognitionEmployeeExperiencePage() {
    return (
