...
const ACCENT = "#ec4899";
const MODULE = "Employee Experience";
const PAGE = "Wellbeing Programs";
const KPIS = [{"l":"eNPS","v":"88","t":"+7.2%","d":"up"},{"l":"Engagement (%)","v":"84.3%","t":"+7.8%","d":"up"},{"l":"Turnover (%)","v":"76.0%","t":"+12.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"1.026","t":"+8.8%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","144","2026-02-02","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.258","2026-01-19","77","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.131","2026-03-25","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","567","2026-03-03","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.314","2026-03-20","94","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":455},{"label":"Mar","value":575},{"label":"Abr","value":677},{"label":"Mai","value":636},{"label":"Jun","value":465},{"label":"Jul","value":400},{"label":"Ago","value":434},{"label":"Set","value":640},{"label":"Out","value":593},{"label":"Nov","value":403},{"label":"Dez","value":534}];
const MX = 677;
...
export default function WellbeingEmployeeExperienceEmployeeExperiencePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>New</span></h1>
                </div>
