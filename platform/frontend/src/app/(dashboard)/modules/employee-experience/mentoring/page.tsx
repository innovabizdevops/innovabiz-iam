...
const PAGE = "Mentoring Platform";
const KPIS = [{"l":"eNPS","v":"64","t":"-0.6%","d":"down"},{"l":"Engagement (%)","v":"76.4%","t":"+1.4%","d":"up"},{"l":"Turnover (%)","v":"73.6%","t":"-2.4%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"4.958","t":"-2.4%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.334","2026-01-26","87","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.416","2026-03-10","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","666","2026-01-10","57","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","6.627","2026-03-24","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.639","2026-03-02","73","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":322},{"label":"Mar","value":259},{"label":"Abr","value":536},{"label":"Mai","value":378},{"label":"Jun","value":283},{"label":"Jul","value":615},{"label":"Ago","value":261},{"label":"Set","value":412},{"label":"Out","value":555},{"label":"Nov","value":404},{"label":"Dez","value":520}];
const MX = 615;
