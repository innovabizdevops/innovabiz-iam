...
const PAGE = "Pulse Surveys";
const KPIS = [{"l":"eNPS","v":"55","t":"+13.2%","d":"up"},{"l":"Engagement (%)","v":"70.2%","t":"+16.0%","d":"up"},{"l":"Turnover (%)","v":"82.4%","t":"+11.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"2.716","t":"-1.8%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.128","2026-02-06","88","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.986","2026-02-03","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","757","2026-03-17","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.395","2026-02-13","67","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.127","2026-03-20","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":379},{"label":"Fev","value":419},{"label":"Mar","value":643},{"label":"Abr","value":437},{"label":"Mai","value":451},{"label":"Jun","value":298},{"label":"Jul","value":449},{"label":"Ago","value":628},{"label":"Set","value":635},{"label":"Out","value":434},{"label":"Nov","value":293},{"label":"Dez","value":281}];
const MX = 643;
