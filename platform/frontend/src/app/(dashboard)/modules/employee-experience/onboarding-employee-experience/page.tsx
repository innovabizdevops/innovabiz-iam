...
const KPIS = [{"l":"eNPS","v":"87","t":"+6.7%","d":"up"},{"l":"Engagement (%)","v":"67.3%","t":"+1.9%","d":"up"},{"l":"Turnover (%)","v":"67.7%","t":"+0.3%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.108","t":"+9.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.278","2026-01-01","83","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.763","2026-02-12","79","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.469","2026-01-02","68","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.776","2026-01-06","74","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","331","2026-03-20","66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":313},{"label":"Mar","value":569},{"label":"Abr","value":525},{"label":"Mai","value":531},{"label":"Jun","value":427},{"label":"Jul","value":585},{"label":"Ago","value":485},{"label":"Set","value":478},{"label":"Out","value":298},{"label":"Nov","value":542},{"label":"Dez","value":501}];
const MX = 585;
...
export default function OnboardingEmployeeExperiencePage() {
    return (
