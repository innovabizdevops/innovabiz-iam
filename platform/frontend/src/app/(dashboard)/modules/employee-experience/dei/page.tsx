...
const PAGE = "DEI Programs";
const KPIS = [{"l":"eNPS","v":"70","t":"+8.0%","d":"up"},{"l":"Engagement (%)","v":"68.0%","t":"+0.1%","d":"up"},{"l":"Turnover (%)","v":"76.1%","t":"-1.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"3.100","t":"+2.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.075","2026-03-27","81","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","728","2026-01-08","78","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.274","2026-01-18","60","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","5.734","2026-01-25","80","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.314","2026-02-24","63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":651},{"label":"Mar","value":790},{"label":"Abr","value":821},{"label":"Mai","value":764},{"label":"Jun","value":836},{"label":"Jul","value":587},{"label":"Ago","value":737},{"label":"Set","value":568},{"label":"Out","value":924},{"label":"Nov","value":889},{"label":"Dez","value":680}];
const MX = 924;
