...
const PAGE = "Recognition &amp; Rewards";
const KPIS = [{"l":"eNPS","v":"91","t":"-1.3%","d":"down"},{"l":"Engagement (%)","v":"70.2%","t":"-1.2%","d":"down"},{"l":"Turnover (%)","v":"81.7%","t":"+9.4%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"770","t":"-3.9%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.330","2026-02-01","93","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","579","2026-03-16","91","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","1.453","2026-01-04","89","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.240","2026-02-23","86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","7.798","2026-03-08","59","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":607},{"label":"Mar","value":825},{"label":"Abr","value":902},{"label":"Mai","value":737},{"label":"Jun","value":717},{"label":"Jul","value":949},{"label":"Ago","value":730},{"label":"Set","value":850},{"label":"Out","value":613},{"label":"Nov","value":682},{"label":"Dez","value":768}];
const MX = 949;
