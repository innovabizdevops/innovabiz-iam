...
const KPIS = [{"l":"Teams Ativos","v":"7.855","t":"+12.0%","d":"up"},{"l":"Reuniões/Semana","v":"638","t":"+16.5%","d":"up"},{"l":"Mensagens/Dia","v":"4630","t":"-0.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"171","t":"+16.8%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","5.309","1663","5.669","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","539","3531","4.628","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.918","3518","4.535","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","568","1552","6.923","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.215","4889","2.626","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":666},{"label":"Mar","value":823},{"label":"Abr","value":818},{"label":"Mai","value":655},{"label":"Jun","value":963},{"label":"Jul","value":691},{"label":"Ago","value":732},{"label":"Set","value":791},{"label":"Out","value":969},{"label":"Nov","value":875},{"label":"Dez","value":815}];
const MX = 969;
