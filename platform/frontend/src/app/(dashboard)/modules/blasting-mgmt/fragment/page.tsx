...
const PAGE = "Fragment Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"5.857","t":"+5.9%","d":"up"},{"l":"Queries/Dia","v":"4466","t":"+12.6%","d":"up"},{"l":"Dados Processados (GB)","v":"7.219","t":"+17.6%","d":"up"},{"l":"Utilizadores Analytics","v":"1.982","t":"+7.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3309","2026-01-01","895","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2484","2026-02-01","5.670","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3017","2026-02-28","4.888","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3021","2026-03-18","2.241","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","560","2026-03-11","555","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":389},{"label":"Mar","value":531},{"label":"Abr","value":397},{"label":"Mai","value":370},{"label":"Jun","value":536},{"label":"Jul","value":397},{"label":"Ago","value":456},{"label":"Set","value":373},{"label":"Out","value":710},{"label":"Nov","value":615},{"label":"Dez","value":375}];
const MX = 710;
