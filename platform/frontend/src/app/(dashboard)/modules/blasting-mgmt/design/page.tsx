...
const KPIS = [{"l":"Formulários Ativos","v":"2.360","t":"+9.3%","d":"up"},{"l":"Submissões/Dia","v":"3694","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"5.046","t":"+7.5%","d":"up"},{"l":"Templates","v":"1.801","t":"-3.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.747","2026-02-24","7.652","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.880","2026-02-16","8.297","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.655","2026-02-15","8.153","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.268","2026-01-07","166","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.621","2026-02-14","5.109","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":629},{"label":"Mar","value":382},{"label":"Abr","value":245},{"label":"Mai","value":430},{"label":"Jun","value":507},{"label":"Jul","value":613},{"label":"Ago","value":497},{"label":"Set","value":402},{"label":"Out","value":447},{"label":"Nov","value":432},{"label":"Dez","value":527}];
const MX = 629;
