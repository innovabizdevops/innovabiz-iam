...
const ACCENT = "#ec4899";
const MODULE = "Blasting Management";
const PAGE = "Vibration Mon";
const KPIS = [{"l":"Total Blasting Mgmt","v":"2.557","t":"+13.9%","d":"up"},{"l":"Vibration Mon Ativos","v":"1.209","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+2.8%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.2%","d":"down"}];
const COLS = ["ID","Vibration Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Blasting Mgmt #001","Blasting Mgmt #002","5.977","5.773","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Blasting Mgmt #002","Blasting Mgmt #003","5.066","4.754","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Blasting Mgmt #003","Blasting Mgmt #004","5.598","5.204","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Blasting Mgmt #004","Blasting Mgmt #005","2.627","3.519","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Blasting Mgmt #005","Blasting Mgmt #001","228","5.600","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":679},{"label":"Mar","value":458},{"label":"Abr","value":781},{"label":"Mai","value":637},{"label":"Jun","value":751},{"label":"Jul","value":699},{"label":"Ago","value":641},{"label":"Set","value":620},{"label":"Out","value":488},{"label":"Nov","value":664},{"label":"Dez","value":478}];
const MX = 804;
