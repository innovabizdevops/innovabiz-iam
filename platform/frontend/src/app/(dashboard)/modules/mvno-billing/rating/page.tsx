...
const PAGE = "Rating";
const KPIS = [{"l":"Surveys Ativos","v":"505","t":"+8.2%","d":"up"},{"l":"Respostas/Semana","v":"2420","t":"+3.5%","d":"up"},{"l":"NPS Médio","v":"64","t":"+12.7%","d":"up"},{"l":"Taxa Resposta (%)","v":"73.4%","t":"-0.4%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","5.780","70","78.8%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","6.455","84","91.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.654","87","70.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","6.178","61","79.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","3.430","61","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":521},{"label":"Mar","value":854},{"label":"Abr","value":576},{"label":"Mai","value":478},{"label":"Jun","value":592},{"label":"Jul","value":717},{"label":"Ago","value":689},{"label":"Set","value":854},{"label":"Out","value":728},{"label":"Nov","value":703},{"label":"Dez","value":528}];
const MX = 854;
