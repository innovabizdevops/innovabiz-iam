...
const ACCENT = "#6366f1";
const MODULE = "MVNO Billing Engine";
const PAGE = "Prepaid";
const KPIS = [{"l":"Total Mvno Billing","v":"6.388","t":"+9.4%","d":"up"},{"l":"Prepaid Ativos","v":"2.469","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"73","t":"-4.8%","d":"down"}];
const COLS = ["ID","Prepaid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Billing #001","Mvno Billing #002","1.029","8.215","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Billing #002","Mvno Billing #003","8.778","1.659","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Billing #003","Mvno Billing #004","1.559","7.292","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Billing #004","Mvno Billing #005","1.153","4.505","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Billing #005","Mvno Billing #001","5.718","6.464","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":772},{"label":"Mar","value":837},{"label":"Abr","value":689},{"label":"Mai","value":791},{"label":"Jun","value":763},{"label":"Jul","value":799},{"label":"Ago","value":580},{"label":"Set","value":550},{"label":"Out","value":740},{"label":"Nov","value":747},{"label":"Dez","value":595}];
const MX = 837;
