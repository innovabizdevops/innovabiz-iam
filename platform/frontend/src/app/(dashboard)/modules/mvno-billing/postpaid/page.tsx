...
const PAGE = "Postpaid";
const KPIS = [{"l":"Pedidos/Dia","v":"4288","t":"+7.0%","d":"up"},{"l":"GMV (€)","v":"€24315","t":"+15.3%","d":"up"},{"l":"Conversão (%)","v":"76.3%","t":"-5.7%","d":"down"},{"l":"AOV (€)","v":"€58729","t":"+0.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 32261.92","1.275","8.482","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 46939.86","5.011","8.857","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 37540.04","1.659","4.967","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 3245.98","2.501","4.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 7308.08","1.916","2.822","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":953},{"label":"Mar","value":762},{"label":"Abr","value":771},{"label":"Mai","value":692},{"label":"Jun","value":829},{"label":"Jul","value":735},{"label":"Ago","value":862},{"label":"Set","value":818},{"label":"Out","value":692},{"label":"Nov","value":632},{"label":"Dez","value":754}];
const MX = 953;
