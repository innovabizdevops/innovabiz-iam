...
export default function MvnoBillingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mvno Billing</h1><p className="text-sm text-muted-foreground">Mvno Billing • iBOS Enterprise</p></div>
