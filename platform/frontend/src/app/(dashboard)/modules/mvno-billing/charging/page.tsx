...
const PAGE = "Charging";
const KPIS = [{"l":"Total Mvno Billing","v":"627","t":"+0.5%","d":"up"},{"l":"Charging Ativos","v":"9.034","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"81.4%","t":"+9.6%","d":"up"},{"l":"Score Performance","v":"62","t":"+10.7%","d":"up"}];
const COLS = ["ID","Charging","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Billing #001","Mvno Billing #002","1.897","270","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Billing #002","Mvno Billing #003","6.953","5.958","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Billing #003","Mvno Billing #004","2.383","8.782","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Billing #004","Mvno Billing #005","8.980","5.645","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Billing #005","Mvno Billing #001","6.515","8.180","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":573},{"label":"Mar","value":459},{"label":"Abr","value":775},{"label":"Mai","value":581},{"label":"Jun","value":713},{"label":"Jul","value":630},{"label":"Ago","value":810},{"label":"Set","value":678},{"label":"Out","value":802},{"label":"Nov","value":497},{"label":"Dez","value":700}];
const MX = 810;
