...
/* ═══ SC: UI Icon Registry — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "8267", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4956", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€367K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "272208667", cells: ["SC-4667", "SC: UI Icon Registry Item 1", "4/8/2026", "€8767"], status: "active" as const },
    { id: "272212238", cells: ["SC-8238", "SC: UI Icon Registry Item 2", "19/3/2026", "€12 338"], status: "pending" as const },
    { id: "272215809", cells: ["SC-2809", "SC: UI Icon Registry Item 3", "6/10/2026", "€15 909"], status: "completed" as const },
    { id: "272219380", cells: ["SC-6380", "SC: UI Icon Registry Item 4", "21/5/2026", "€19 480"], status: "warning" as const },
    { id: "272222951", cells: ["SC-9951", "SC: UI Icon Registry Item 5", "8/12/2026", "€23 051"], status: "active" as const },
];
...
export default function ScUiIconRegistryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: UI Icon Registry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: UI Icon Registry</p>
                    </div>
                </div>
