...
const PAGE = "Custom";
const KPIS = [{"l":"Total Sc Ui Icons","v":"2.691","t":"-1.0%","d":"down"},{"l":"Custom Ativos","v":"€91611","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"83.5%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"65","t":"-2.5%","d":"down"}];
const COLS = ["ID","Custom","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sc Ui Icons #001","€ 19637.03","5.011","2.749","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Sc Ui Icons #002","€ 49567.50","7.541","5.102","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Sc Ui Icons #003","€ 22243.24","5.872","8.562","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Sc Ui Icons #004","€ 1974.43","5.242","5.252","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sc Ui Icons #005","€ 7879.84","8.060","5.195","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":543},{"label":"Mar","value":383},{"label":"Abr","value":607},{"label":"Mai","value":393},{"label":"Jun","value":438},{"label":"Jul","value":405},{"label":"Ago","value":461},{"label":"Set","value":677},{"label":"Out","value":604},{"label":"Nov","value":641},{"label":"Dez","value":551}];
const MX = 677;
