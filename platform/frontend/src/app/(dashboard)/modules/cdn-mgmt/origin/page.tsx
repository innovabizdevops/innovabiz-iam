...
const PAGE = "Origin Shield";
const KPIS = [{"l":"Total Cdn Mgmt","v":"1.010","t":"+12.3%","d":"up"},{"l":"Origin Shield Ativos","v":"8.970","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"79.2%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"56","t":"+13.9%","d":"up"}];
const COLS = ["ID","Origin Shield","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdn Mgmt #001","Cdn Mgmt #002","5.121","8.266","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Cdn Mgmt #002","Cdn Mgmt #003","2.611","2.845","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdn Mgmt #003","Cdn Mgmt #004","369","4.415","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cdn Mgmt #004","Cdn Mgmt #005","1.666","2.106","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdn Mgmt #005","Cdn Mgmt #001","3.506","6.483","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":804},{"label":"Mar","value":754},{"label":"Abr","value":938},{"label":"Mai","value":938},{"label":"Jun","value":949},{"label":"Jul","value":854},{"label":"Ago","value":657},{"label":"Set","value":738},{"label":"Out","value":602},{"label":"Nov","value":577},{"label":"Dez","value":767}];
const MX = 949;
