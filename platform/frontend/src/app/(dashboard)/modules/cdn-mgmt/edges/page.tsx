...
const PAGE = "Edge Nodes";
const KPIS = [{"l":"Total Cdn Mgmt","v":"1.792","t":"+0.1%","d":"up"},{"l":"Edge Nodes Ativos","v":"2.908","t":"+5.0%","d":"up"},{"l":"Eficiência (%)","v":"81.6%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+13.0%","d":"up"}];
const COLS = ["ID","Edge Nodes","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdn Mgmt #001","Cdn Mgmt #002","5.450","9.065","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Cdn Mgmt #002","Cdn Mgmt #003","4.305","354","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdn Mgmt #003","Cdn Mgmt #004","3.102","8.210","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cdn Mgmt #004","Cdn Mgmt #005","6.918","4.826","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdn Mgmt #005","Cdn Mgmt #001","8.668","9.042","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":941},{"label":"Fev","value":680},{"label":"Mar","value":715},{"label":"Abr","value":774},{"label":"Mai","value":721},{"label":"Jun","value":691},{"label":"Jul","value":713},{"label":"Ago","value":856},{"label":"Set","value":676},{"label":"Out","value":825},{"label":"Nov","value":829},{"label":"Dez","value":662}];
const MX = 941;
