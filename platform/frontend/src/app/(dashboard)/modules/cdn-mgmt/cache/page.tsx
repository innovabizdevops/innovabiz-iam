...
const PAGE = "Cache Rules";
const KPIS = [{"l":"Total Cdn Mgmt","v":"4.765","t":"+0.3%","d":"up"},{"l":"Cache Rules Ativos","v":"7.973","t":"-3.2%","d":"down"},{"l":"Eficiência (%)","v":"94.3%","t":"-4.5%","d":"down"},{"l":"Score Performance","v":"67","t":"+14.8%","d":"up"}];
const COLS = ["ID","Cache Rules","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdn Mgmt #001","Cdn Mgmt #002","4.595","5.391","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cdn Mgmt #002","Cdn Mgmt #003","2.197","6.527","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdn Mgmt #003","Cdn Mgmt #004","6.152","8.436","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Cdn Mgmt #004","Cdn Mgmt #005","8.134","8.025","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdn Mgmt #005","Cdn Mgmt #001","6.373","3.135","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":748},{"label":"Mar","value":645},{"label":"Abr","value":595},{"label":"Mai","value":617},{"label":"Jun","value":532},{"label":"Jul","value":742},{"label":"Ago","value":539},{"label":"Set","value":716},{"label":"Out","value":483},{"label":"Nov","value":553},{"label":"Dez","value":402}];
const MX = 748;
