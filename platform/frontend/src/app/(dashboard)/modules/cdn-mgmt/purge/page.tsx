...
const ACCENT = "#78350f";
const MODULE = "CDN Management";
const PAGE = "Real-Time Purge";
const KPIS = [{"l":"Total Cdn Mgmt","v":"5.906","t":"-5.9%","d":"down"},{"l":"Real Time Purge Ativos","v":"3.748","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"84.7%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"59","t":"-2.0%","d":"down"}];
const COLS = ["ID","Real Time Purge","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdn Mgmt #001","Cdn Mgmt #002","4.970","1.672","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Cdn Mgmt #002","Cdn Mgmt #003","2.755","3.397","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdn Mgmt #003","Cdn Mgmt #004","7.323","8.464","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Cdn Mgmt #004","Cdn Mgmt #005","4.915","5.777","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdn Mgmt #005","Cdn Mgmt #001","185","7.555","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":558},{"label":"Mar","value":792},{"label":"Abr","value":570},{"label":"Mai","value":752},{"label":"Jun","value":757},{"label":"Jul","value":486},{"label":"Ago","value":712},{"label":"Set","value":698},{"label":"Out","value":654},{"label":"Nov","value":605},{"label":"Dez","value":723}];
const MX = 792;
