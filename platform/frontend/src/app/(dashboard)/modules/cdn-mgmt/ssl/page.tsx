...
const PAGE = "SSL/TLS";
const KPIS = [{"l":"Total Cdn Mgmt","v":"3.544","t":"+5.9%","d":"up"},{"l":"SSL/TLS Ativos","v":"8.480","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.8%","d":"up"}];
const COLS = ["ID","SSL/TLS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cdn Mgmt #001","Cdn Mgmt #002","2.429","7.993","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Cdn Mgmt #002","Cdn Mgmt #003","5.420","8.118","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cdn Mgmt #003","Cdn Mgmt #004","532","6.660","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cdn Mgmt #004","Cdn Mgmt #005","3.330","2.950","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cdn Mgmt #005","Cdn Mgmt #001","9.051","718","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":728},{"label":"Mar","value":914},{"label":"Abr","value":869},{"label":"Mai","value":693},{"label":"Jun","value":558},{"label":"Jul","value":582},{"label":"Ago","value":716},{"label":"Set","value":855},{"label":"Out","value":895},{"label":"Nov","value":681},{"label":"Dez","value":844}];
const MX = 914;
