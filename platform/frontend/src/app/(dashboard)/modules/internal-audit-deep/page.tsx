...
/* ═══ Internal Audit Deep — Dashboard ═══ */

const ACCENT = "#7f1d1d";

const KPIS = [
    { label: "Total Registos", value: "3803", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3434", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€264K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+11%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1472717803", cells: ["INT-3803", "Internal Audit Deep Item 1", "12/8/2026", "€17 903"], status: "active" as const },
    { id: "1472721374", cells: ["INT-7374", "Internal Audit Deep Item 2", "27/3/2026", "€21 474"], status: "pending" as const },
    { id: "1472724945", cells: ["INT-1945", "Internal Audit Deep Item 3", "14/10/2026", "€25 045"], status: "completed" as const },
    { id: "1472728516", cells: ["INT-5516", "Internal Audit Deep Item 4", "1/5/2026", "€28 616"], status: "warning" as const },
    { id: "1472732087", cells: ["INT-9087", "Internal Audit Deep Item 5", "16/12/2026", "€32 187"], status: "active" as const },
];
...
export default function InternalAuditDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Internal Audit Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Internal Audit Deep</p>
                    </div>
                </div>
