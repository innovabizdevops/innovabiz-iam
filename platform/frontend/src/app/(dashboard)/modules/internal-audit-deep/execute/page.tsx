...
const PAGE = "Execute";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.457","t":"+16.1%","d":"up"},{"l":"NC Abertas","v":"4.193","t":"+-0.0%","d":"up"},{"l":"Conformidade (%)","v":"65.5%","t":"+8.6%","d":"up"},{"l":"CAPAs Pendentes","v":"3.170","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.234","93.9%","6.399","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.792","78.9%","2.544","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.273","80.5%","3.528","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.910","84.2%","3.786","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.743","92.0%","8.155","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":770},{"label":"Mar","value":788},{"label":"Abr","value":993},{"label":"Mai","value":990},{"label":"Jun","value":997},{"label":"Jul","value":894},{"label":"Ago","value":885},{"label":"Set","value":770},{"label":"Out","value":743},{"label":"Nov","value":797},{"label":"Dez","value":852}];
const MX = 997;
