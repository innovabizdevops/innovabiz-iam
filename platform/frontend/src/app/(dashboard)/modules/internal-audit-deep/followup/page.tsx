...
const ACCENT = "#7f1d1d";
const MODULE = "Internal Audit Deep";
const PAGE = "Follow-Up";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.517","t":"+8.5%","d":"up"},{"l":"NC Abertas","v":"3.605","t":"+7.6%","d":"up"},{"l":"Conformidade (%)","v":"94.7%","t":"+7.2%","d":"up"},{"l":"CAPAs Pendentes","v":"1.850","t":"+7.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.204","83.1%","6.017","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.308","76.0%","5.914","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.992","74.6%","1.575","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.983","83.4%","169","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.020","91.0%","4.776","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":451},{"label":"Mar","value":468},{"label":"Abr","value":549},{"label":"Mai","value":502},{"label":"Jun","value":705},{"label":"Jul","value":587},{"label":"Ago","value":810},{"label":"Set","value":436},{"label":"Out","value":598},{"label":"Nov","value":732},{"label":"Dez","value":584}];
const MX = 810;
