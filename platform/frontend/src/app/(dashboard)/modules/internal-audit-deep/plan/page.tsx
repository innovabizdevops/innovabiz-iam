...
const PAGE = "Plan";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.885","t":"+12.0%","d":"up"},{"l":"NC Abertas","v":"3.364","t":"+13.9%","d":"up"},{"l":"Conformidade (%)","v":"90.8%","t":"+12.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.110","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.148","78.0%","1.313","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.845","93.1%","1.270","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.597","94.5%","5.378","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.229","84.5%","530","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.498","85.8%","2.007","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":384},{"label":"Mar","value":410},{"label":"Abr","value":393},{"label":"Mai","value":376},{"label":"Jun","value":583},{"label":"Jul","value":657},{"label":"Ago","value":638},{"label":"Set","value":602},{"label":"Out","value":468},{"label":"Nov","value":372},{"label":"Dez","value":674}];
const MX = 674;
