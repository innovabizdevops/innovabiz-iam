...
const KPIS = [{"l":"Auditorias Realizadas","v":"847","t":"+6.2%","d":"up"},{"l":"NC Abertas","v":"8.794","t":"+13.2%","d":"up"},{"l":"Conformidade (%)","v":"71.0%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"7.111","t":"-0.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.263","70.1%","1.431","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.169","98.4%","5.238","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.183","94.1%","3.022","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.531","85.6%","732","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","898","73.0%","4.800","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":365},{"label":"Fev","value":432},{"label":"Mar","value":712},{"label":"Abr","value":457},{"label":"Mai","value":519},{"label":"Jun","value":377},{"label":"Jul","value":689},{"label":"Ago","value":632},{"label":"Set","value":509},{"label":"Out","value":340},{"label":"Nov","value":560},{"label":"Dez","value":409}];
const MX = 712;
