...
const PAGE = "Finding";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.401","t":"+4.1%","d":"up"},{"l":"NC Abertas","v":"2.237","t":"-1.8%","d":"down"},{"l":"Conformidade (%)","v":"92.7%","t":"+3.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.832","t":"-4.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.240","95.5%","1.330","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.969","91.1%","1.910","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.867","97.1%","8.768","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.521","99.7%","4.082","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","939","99.1%","4.368","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":566},{"label":"Mar","value":597},{"label":"Abr","value":642},{"label":"Mai","value":636},{"label":"Jun","value":551},{"label":"Jul","value":486},{"label":"Ago","value":614},{"label":"Set","value":579},{"label":"Out","value":364},{"label":"Nov","value":538},{"label":"Dez","value":489}];
const MX = 642;
