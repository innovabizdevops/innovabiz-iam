...
const ROWS = [
  { id: "001", c: ["Data Marketplace-001", "Data Marketplace Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Data Marketplace-002", "Data Marketplace Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Data Marketplace-003", "Data Marketplace Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Data Marketplace-004", "Data Marketplace Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Data Marketplace-005", "Data Marketplace Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Data Marketplace", ts: "Há 2min", a: "Sistema" },
