...
const KPIS = [{"l":"BCP Plans Ativos","v":"8.054","t":"+10.1%","d":"up"},{"l":"RTO Médio (h)","v":"122h","t":"-4.0%","d":"down"},{"l":"RPO Médio (h)","v":"148h","t":"+7.0%","d":"up"},{"l":"Testes DR (YTD)","v":"7.084","t":"+7.4%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","178h","166h","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","24h","66h","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","99h","189h","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","126h","20h","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","171h","188h","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":497},{"label":"Mar","value":812},{"label":"Abr","value":599},{"label":"Mai","value":576},{"label":"Jun","value":740},{"label":"Jul","value":605},{"label":"Ago","value":450},{"label":"Set","value":702},{"label":"Out","value":787},{"label":"Nov","value":509},{"label":"Dez","value":808}];
const MX = 812;
