...
const PAGE = "Noise Reduction";
const KPIS = [{"l":"Total Aiops","v":"1.096","t":"-2.1%","d":"down"},{"l":"Noise Reduction Ativos","v":"8.535","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"64","t":"+7.2%","d":"up"}];
const COLS = ["ID","Noise Reduction","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aiops #001","Aiops #002","5.475","3.185","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Aiops #002","Aiops #003","3.727","3.133","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Aiops #003","Aiops #004","5.554","7.250","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Aiops #004","Aiops #005","530","6.762","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aiops #005","Aiops #001","8.465","8.762","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":766},{"label":"Mar","value":985},{"label":"Abr","value":864},{"label":"Mai","value":948},{"label":"Jun","value":900},{"label":"Jul","value":893},{"label":"Ago","value":701},{"label":"Set","value":788},{"label":"Out","value":836},{"label":"Nov","value":898},{"label":"Dez","value":934}];
const MX = 985;
