...
const ACCENT = "#6366f1";
const MODULE = "AIOps & Autonomous Ops";
const PAGE = "Root Cause Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"6.434","t":"+13.0%","d":"up"},{"l":"Queries/Dia","v":"3595","t":"+2.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.812","t":"-0.8%","d":"down"},{"l":"Utilizadores Analytics","v":"8.993","t":"+2.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4198","2026-03-17","8.998","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3458","2026-01-11","1.738","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1933","2026-01-18","2.240","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2523","2026-01-16","1.629","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3402","2026-02-01","5.916","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":250},{"label":"Mar","value":593},{"label":"Abr","value":361},{"label":"Mai","value":457},{"label":"Jun","value":288},{"label":"Jul","value":419},{"label":"Ago","value":352},{"label":"Set","value":344},{"label":"Out","value":255},{"label":"Nov","value":320},{"label":"Dez","value":511}];
const MX = 593;
