...
const PAGE = "Topology Discovery";
const KPIS = [{"l":"Total Aiops","v":"3.762","t":"+6.9%","d":"up"},{"l":"Topology Discovery Ativos","v":"1.472","t":"+16.0%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"69","t":"+12.5%","d":"up"}];
const COLS = ["ID","Topology Discovery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aiops #001","Aiops #002","4.062","6.729","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Aiops #002","Aiops #003","4.723","1.045","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Aiops #003","Aiops #004","3.583","4.410","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Aiops #004","Aiops #005","3.541","1.139","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aiops #005","Aiops #001","9.046","853","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":503},{"label":"Mar","value":442},{"label":"Abr","value":383},{"label":"Mai","value":242},{"label":"Jun","value":459},{"label":"Jul","value":490},{"label":"Ago","value":370},{"label":"Set","value":596},{"label":"Out","value":212},{"label":"Nov","value":523},{"label":"Dez","value":360}];
const MX = 596;
