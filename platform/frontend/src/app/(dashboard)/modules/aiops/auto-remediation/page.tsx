...
const KPIS = [{"l":"Integrações Ativas","v":"3.335","t":"+12.7%","d":"up"},{"l":"Chamadas/Hora","v":"4190","t":"+8.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.0%","t":"+12.6%","d":"up"},{"l":"Latência Média (ms)","v":"57ms","t":"-3.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.368","988","97.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.257","5.581","83.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.215","2.602","71.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.766","1.008","75.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.294","7.354","97.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":326},{"label":"Mar","value":554},{"label":"Abr","value":340},{"label":"Mai","value":410},{"label":"Jun","value":316},{"label":"Jul","value":251},{"label":"Ago","value":381},{"label":"Set","value":412},{"label":"Out","value":600},{"label":"Nov","value":620},{"label":"Dez","value":423}];
const MX = 620;
