...
const PAGE = "Capacity Planning AI";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.812","t":"+2.1%","d":"up"},{"l":"NC Abertas","v":"5.869","t":"+3.3%","d":"up"},{"l":"Conformidade (%)","v":"74.2%","t":"+4.6%","d":"up"},{"l":"CAPAs Pendentes","v":"6.183","t":"+13.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.120","81.9%","3.046","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.820","77.9%","5.267","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.137","95.9%","4.275","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.847","71.0%","6.664","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.732","90.7%","5.149","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":774},{"label":"Fev","value":732},{"label":"Mar","value":832},{"label":"Abr","value":844},{"label":"Mai","value":729},{"label":"Jun","value":869},{"label":"Jul","value":786},{"label":"Ago","value":975},{"label":"Set","value":1049},{"label":"Out","value":704},{"label":"Nov","value":725},{"label":"Dez","value":1049}];
const MX = 1049;
