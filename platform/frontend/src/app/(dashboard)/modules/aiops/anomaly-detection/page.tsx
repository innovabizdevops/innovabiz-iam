...
const PAGE = "Anomaly Detection AI";
const KPIS = [{"l":"Total Aiops","v":"5.847","t":"+6.1%","d":"up"},{"l":"Anomaly Detection AI Ativos","v":"3.711","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"74.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"71","t":"+8.9%","d":"up"}];
const COLS = ["ID","Anomaly Detection AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aiops #001","Aiops #002","8.280","844","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Aiops #002","Aiops #003","7.032","3.792","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Aiops #003","Aiops #004","3.810","4.245","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Aiops #004","Aiops #005","5.223","4.868","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aiops #005","Aiops #001","7.868","343","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":909},{"label":"Mar","value":956},{"label":"Abr","value":622},{"label":"Mai","value":704},{"label":"Jun","value":877},{"label":"Jul","value":832},{"label":"Ago","value":736},{"label":"Set","value":785},{"label":"Out","value":829},{"label":"Nov","value":815},{"label":"Dez","value":872}];
const MX = 956;
