...
const PAGE = "Log Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.197","t":"+7.9%","d":"up"},{"l":"Queries/Dia","v":"1424","t":"+12.9%","d":"up"},{"l":"Dados Processados (GB)","v":"2.327","t":"-5.6%","d":"down"},{"l":"Utilizadores Analytics","v":"3.892","t":"+7.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2156","2026-01-27","5.446","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2557","2026-03-16","561","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2497","2026-01-14","4.182","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2506","2026-02-11","5.511","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","366","2026-01-28","2.323","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":638},{"label":"Mar","value":743},{"label":"Abr","value":892},{"label":"Mai","value":752},{"label":"Jun","value":725},{"label":"Jul","value":838},{"label":"Ago","value":721},{"label":"Set","value":696},{"label":"Out","value":902},{"label":"Nov","value":746},{"label":"Dez","value":923}];
const MX = 923;
