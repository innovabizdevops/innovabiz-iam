...
/* ═══ GenAI Reasoning Engine — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6840", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1377", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€405K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1745545040", cells: ["GEN-5040", "GenAI Reasoning Engine Item 1", "9/9/2026", "€45 140"], status: "active" as const },
    { id: "1745548611", cells: ["GEN-8611", "GenAI Reasoning Engine Item 2", "24/4/2026", "€48 711"], status: "pending" as const },
    { id: "1745552182", cells: ["GEN-3182", "GenAI Reasoning Engine Item 3", "11/11/2026", "€2282"], status: "completed" as const },
    { id: "1745555753", cells: ["GEN-6753", "GenAI Reasoning Engine Item 4", "26/6/2026", "€5853"], status: "warning" as const },
    { id: "1745559324", cells: ["GEN-1324", "GenAI Reasoning Engine Item 5", "13/1/2026", "€9424"], status: "active" as const },
];
...
export default function GenaiReasoningEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Reasoning Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Reasoning Engine</p>
                    </div>
                </div>
