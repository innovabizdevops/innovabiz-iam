...
const PAGE = "Bill";
const KPIS = [{"l":"Total Catering Banquet","v":"2.447","t":"+8.1%","d":"up"},{"l":"Bill Ativos","v":"6.995","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"65","t":"+10.5%","d":"up"}];
const COLS = ["ID","Bill","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Catering Banquet #001","Catering Banquet #002","6.504","6.291","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Catering Banquet #002","Catering Banquet #003","8.112","5.672","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Catering Banquet #003","Catering Banquet #004","9.052","6.910","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Catering Banquet #004","Catering Banquet #005","8.801","5.697","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Catering Banquet #005","Catering Banquet #001","6.955","6.338","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":369},{"label":"Mar","value":617},{"label":"Abr","value":442},{"label":"Mai","value":332},{"label":"Jun","value":384},{"label":"Jul","value":595},{"label":"Ago","value":340},{"label":"Set","value":286},{"label":"Out","value":364},{"label":"Nov","value":258},{"label":"Dez","value":415}];
const MX = 617;
