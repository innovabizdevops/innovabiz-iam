...
/* ═══ Catering & Banquet — Dashboard ═══ */

const ACCENT = "#c2410c";

const KPIS = [
    { label: "Total Registos", value: "5759", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4120", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€147K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2141019259", cells: ["CAT-1259", "Catering & Banquet Item 1", "16/8/2026", "€19 359"], status: "active" as const },
    { id: "2141022830", cells: ["CAT-4830", "Catering & Banquet Item 2", "3/3/2026", "€22 930"], status: "pending" as const },
    { id: "2141026401", cells: ["CAT-8401", "Catering & Banquet Item 3", "18/10/2026", "€26 501"], status: "completed" as const },
    { id: "2141029972", cells: ["CAT-2972", "Catering & Banquet Item 4", "5/5/2026", "€30 072"], status: "warning" as const },
    { id: "2141033543", cells: ["CAT-6543", "Catering & Banquet Item 5", "20/12/2026", "€33 643"], status: "active" as const },
];
...
export default function CateringBanquetPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Catering & Banquet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Catering & Banquet</p>
                    </div>
                </div>
