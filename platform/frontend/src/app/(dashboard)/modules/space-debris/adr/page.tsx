...
const PAGE = "ADR Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"876","t":"+5.1%","d":"up"},{"l":"RevPAR (€)","v":"€88890","t":"-0.4%","d":"down"},{"l":"Ocupação (%)","v":"89.8%","t":"+8.5%","d":"up"},{"l":"Guest Satisfaction","v":"7.491","t":"-4.5%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.157","2026-01-12","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.620","2026-01-12","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.556","2026-02-21","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","402","2026-02-01","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.104","2026-03-15","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":661},{"label":"Mar","value":451},{"label":"Abr","value":482},{"label":"Mai","value":679},{"label":"Jun","value":492},{"label":"Jul","value":684},{"label":"Ago","value":372},{"label":"Set","value":546},{"label":"Out","value":476},{"label":"Nov","value":348},{"label":"Dez","value":531}];
const MX = 684;
