...
const ACCENT = "#0284c7";
const MODULE = "Space Debris Track";
const PAGE = "Collision Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.141","t":"+11.7%","d":"up"},{"l":"Mitigações Ativas","v":"5.458","t":"+14.0%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+7.4%","d":"up"},{"l":"Incidentes YTD","v":"1.582","t":"+11.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.191","7.685","8.660","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.525","2.359","5.682","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.318","8.067","6.796","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.566","2.703","2.313","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.365","4.273","7.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":793},{"label":"Mar","value":531},{"label":"Abr","value":558},{"label":"Mai","value":598},{"label":"Jun","value":663},{"label":"Jul","value":626},{"label":"Ago","value":777},{"label":"Set","value":636},{"label":"Out","value":633},{"label":"Nov","value":505},{"label":"Dez","value":742}];
const MX = 839;
