...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.918","t":"+9.9%","d":"up"},{"l":"Queries/Dia","v":"5006","t":"+16.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.668","t":"+17.0%","d":"up"},{"l":"Utilizadores Analytics","v":"466","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3094","2026-01-14","3.230","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4576","2026-02-27","5.974","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4203","2026-02-17","845","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1633","2026-02-11","4.676","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4726","2026-02-01","6.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":971},{"label":"Fev","value":733},{"label":"Mar","value":940},{"label":"Abr","value":880},{"label":"Mai","value":714},{"label":"Jun","value":954},{"label":"Jul","value":851},{"label":"Ago","value":785},{"label":"Set","value":818},{"label":"Out","value":970},{"label":"Nov","value":863},{"label":"Dez","value":871}];
const MX = 971;
