...
const KPIS = [{"l":"Quartos Ocupados","v":"571","t":"+10.3%","d":"up"},{"l":"RevPAR (€)","v":"€63693","t":"+13.5%","d":"up"},{"l":"Ocupação (%)","v":"91.8%","t":"+14.8%","d":"up"},{"l":"Guest Satisfaction","v":"1.372","t":"+16.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.130","2026-03-21","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.059","2026-03-28","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.346","2026-02-21","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.187","2026-02-19","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.332","2026-03-05","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":351},{"label":"Fev","value":578},{"label":"Mar","value":532},{"label":"Abr","value":206},{"label":"Mai","value":553},{"label":"Jun","value":255},{"label":"Jul","value":465},{"label":"Ago","value":207},{"label":"Set","value":273},{"label":"Out","value":557},{"label":"Nov","value":251},{"label":"Dez","value":489}];
const MX = 578;
