...
const PAGE = "Category Tree";
const KPIS = [{"l":"Artigos Publicados","v":"5.310","t":"+1.3%","d":"up"},{"l":"Views/Semana","v":"2602","t":"+6.6%","d":"up"},{"l":"Feedback Útil (%)","v":"68.8%","t":"+6.5%","d":"up"},{"l":"Artigos Desatualizados","v":"4.837","t":"+3.5%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","5.722","92.7%","4.969","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.516","99.0%","5.696","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.034","71.7%","8.162","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.152","78.2%","4.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","8.523","72.0%","3.533","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":628},{"label":"Mar","value":265},{"label":"Abr","value":574},{"label":"Mai","value":302},{"label":"Jun","value":623},{"label":"Jul","value":412},{"label":"Ago","value":455},{"label":"Set","value":468},{"label":"Out","value":391},{"label":"Nov","value":342},{"label":"Dez","value":489}];
const MX = 628;
