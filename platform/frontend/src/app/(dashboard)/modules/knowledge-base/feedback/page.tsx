...
const PAGE = "Feedback";
const KPIS = [{"l":"Artigos Publicados","v":"3.752","t":"-1.6%","d":"down"},{"l":"Views/Semana","v":"606","t":"+5.1%","d":"up"},{"l":"Feedback Útil (%)","v":"80.4%","t":"+7.8%","d":"up"},{"l":"Artigos Desatualizados","v":"682","t":"-5.4%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","3.048","80.7%","3.344","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.968","95.0%","5.711","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","3.293","87.3%","9.053","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","1.109","87.5%","718","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","6.575","72.2%","2.860","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":456},{"label":"Fev","value":420},{"label":"Mar","value":545},{"label":"Abr","value":380},{"label":"Mai","value":624},{"label":"Jun","value":298},{"label":"Jul","value":653},{"label":"Ago","value":576},{"label":"Set","value":566},{"label":"Out","value":448},{"label":"Nov","value":465},{"label":"Dez","value":579}];
const MX = 653;
