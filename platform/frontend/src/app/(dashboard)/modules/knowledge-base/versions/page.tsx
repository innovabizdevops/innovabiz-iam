...
const KPIS = [{"l":"Formulários Ativos","v":"3.677","t":"+17.1%","d":"up"},{"l":"Submissões/Dia","v":"654","t":"+3.0%","d":"up"},{"l":"Documentos Gerados","v":"8.876","t":"-0.5%","d":"down"},{"l":"Templates","v":"1.312","t":"+15.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.215","2026-01-01","8.142","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.411","2026-03-07","3.446","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.269","2026-01-13","4.361","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.559","2026-02-03","2.896","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","727","2026-02-05","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":646},{"label":"Mar","value":743},{"label":"Abr","value":539},{"label":"Mai","value":725},{"label":"Jun","value":773},{"label":"Jul","value":728},{"label":"Ago","value":455},{"label":"Set","value":613},{"label":"Out","value":636},{"label":"Nov","value":624},{"label":"Dez","value":670}];
const MX = 773;
