...
const KPIS = [{"l":"Tickets Abertos","v":"8.977","t":"+14.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.2%","t":"-3.5%","d":"down"},{"l":"MTTR (h)","v":"19h","t":"+16.6%","d":"up"},{"l":"Satisfação (%)","v":"82.0%","t":"+13.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.144","2.629","684","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","233","5.733","2.697","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.957","7.445","6.114","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","932","4.042","8.707","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.460","4.056","488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":542},{"label":"Mar","value":824},{"label":"Abr","value":710},{"label":"Mai","value":825},{"label":"Jun","value":721},{"label":"Jul","value":560},{"label":"Ago","value":692},{"label":"Set","value":545},{"label":"Out","value":807},{"label":"Nov","value":581},{"label":"Dez","value":873}];
const MX = 873;
