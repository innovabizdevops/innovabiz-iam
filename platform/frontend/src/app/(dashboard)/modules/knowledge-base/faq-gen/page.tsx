...
const PAGE = "FAQ Auto-Gen";
const KPIS = [{"l":"Artigos Publicados","v":"3.904","t":"+7.4%","d":"up"},{"l":"Views/Semana","v":"3046","t":"-3.2%","d":"down"},{"l":"Feedback Útil (%)","v":"81.9%","t":"+15.3%","d":"up"},{"l":"Artigos Desatualizados","v":"6.555","t":"+14.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.174","89.0%","6.690","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","3.999","78.1%","337","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","2.289","93.9%","7.482","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","6.193","90.2%","1.063","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","1.357","93.3%","6.702","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":856},{"label":"Mar","value":738},{"label":"Abr","value":530},{"label":"Mai","value":641},{"label":"Jun","value":536},{"label":"Jul","value":684},{"label":"Ago","value":717},{"label":"Set","value":740},{"label":"Out","value":785},{"label":"Nov","value":825},{"label":"Dez","value":834}];
const MX = 878;
