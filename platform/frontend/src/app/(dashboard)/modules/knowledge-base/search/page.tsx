...
const KPIS = [{"l":"Artigos Publicados","v":"1.817","t":"+9.9%","d":"up"},{"l":"Views/Semana","v":"1603","t":"+6.6%","d":"up"},{"l":"Feedback Útil (%)","v":"72.6%","t":"-2.9%","d":"down"},{"l":"Artigos Desatualizados","v":"1.063","t":"+8.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.251","95.8%","7.931","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.843","98.4%","7.394","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","3.048","92.0%","1.306","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","4.996","79.8%","1.650","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","4.317","75.9%","5.045","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":807},{"label":"Mar","value":613},{"label":"Abr","value":636},{"label":"Mai","value":635},{"label":"Jun","value":828},{"label":"Jul","value":943},{"label":"Ago","value":939},{"label":"Set","value":982},{"label":"Out","value":953},{"label":"Nov","value":634},{"label":"Dez","value":931}];
const MX = 982;
