...
const PAGE = "Article Editor";
const KPIS = [{"l":"Integrações Ativas","v":"5.103","t":"+17.9%","d":"up"},{"l":"Chamadas/Hora","v":"2606","t":"-1.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"81.9%","t":"+11.5%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"+2.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.766","1.272","71.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.089","7.327","72.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.911","326","75.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.608","4.846","87.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.737","529","85.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":838},{"label":"Mar","value":883},{"label":"Abr","value":861},{"label":"Mai","value":860},{"label":"Jun","value":609},{"label":"Jul","value":899},{"label":"Ago","value":629},{"label":"Set","value":754},{"label":"Out","value":941},{"label":"Nov","value":961},{"label":"Dez","value":837}];
const MX = 961;
