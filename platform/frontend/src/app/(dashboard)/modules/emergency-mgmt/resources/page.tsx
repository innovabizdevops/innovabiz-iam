...
const PAGE = "Resource Deploy";
const KPIS = [{"l":"Total Emergency Mgmt","v":"3.830","t":"-4.6%","d":"down"},{"l":"Resource Deploy Ativos","v":"4.520","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"71.0%","t":"+9.7%","d":"up"},{"l":"Score Performance","v":"76","t":"-5.8%","d":"down"}];
const COLS = ["ID","Resource Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency Mgmt #001","Emergency Mgmt #002","5.413","1.871","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency Mgmt #002","Emergency Mgmt #003","5.387","2.092","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency Mgmt #003","Emergency Mgmt #004","8.738","6.428","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency Mgmt #004","Emergency Mgmt #005","3.656","5.462","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency Mgmt #005","Emergency Mgmt #001","3.157","2.011","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":517},{"label":"Mar","value":675},{"label":"Abr","value":717},{"label":"Mai","value":673},{"label":"Jun","value":865},{"label":"Jul","value":771},{"label":"Ago","value":668},{"label":"Set","value":509},{"label":"Out","value":732},{"label":"Nov","value":877},{"label":"Dez","value":826}];
const MX = 895;
