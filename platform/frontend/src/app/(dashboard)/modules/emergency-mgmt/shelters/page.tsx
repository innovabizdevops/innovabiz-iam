...
const PAGE = "Shelter Mgmt";
const KPIS = [{"l":"Total Emergency Mgmt","v":"7.495","t":"+5.7%","d":"up"},{"l":"Shelter Mgmt Ativos","v":"4.715","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"77.0%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"66","t":"+13.9%","d":"up"}];
const COLS = ["ID","Shelter Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency Mgmt #001","Emergency Mgmt #002","689","5.878","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency Mgmt #002","Emergency Mgmt #003","2.917","2.445","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency Mgmt #003","Emergency Mgmt #004","6.251","195","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency Mgmt #004","Emergency Mgmt #005","743","5.388","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency Mgmt #005","Emergency Mgmt #001","4.614","1.439","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":1025},{"label":"Mar","value":919},{"label":"Abr","value":858},{"label":"Mai","value":958},{"label":"Jun","value":717},{"label":"Jul","value":958},{"label":"Ago","value":891},{"label":"Set","value":861},{"label":"Out","value":809},{"label":"Nov","value":1056},{"label":"Dez","value":924}];
const MX = 1056;
