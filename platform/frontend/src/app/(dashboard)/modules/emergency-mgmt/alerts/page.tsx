...
const PAGE = "Alert Broadcast";
const KPIS = [{"l":"Notificações Enviadas","v":"5.535","t":"+5.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"86.9%","t":"+11.5%","d":"up"},{"l":"Taxa Abertura (%)","v":"75.3%","t":"+11.8%","d":"up"},{"l":"Escalações","v":"5.589","t":"+14.9%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","5.100","81.3%","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.780","96.5%","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.565","86.4%","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.172","72.8%","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.503","91.6%","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1021},{"label":"Fev","value":966},{"label":"Mar","value":926},{"label":"Abr","value":819},{"label":"Mai","value":853},{"label":"Jun","value":814},{"label":"Jul","value":831},{"label":"Ago","value":1031},{"label":"Set","value":812},{"label":"Out","value":852},{"label":"Nov","value":896},{"label":"Dez","value":767}];
const MX = 1031;
