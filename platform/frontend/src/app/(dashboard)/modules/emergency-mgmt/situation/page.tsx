...
const ACCENT = "#334155";
const MODULE = "Emergency Management";
const PAGE = "Situation Room";
const KPIS = [{"l":"Total Emergency Mgmt","v":"7.530","t":"+16.7%","d":"up"},{"l":"Situation Room Ativos","v":"6.901","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"68.5%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"64","t":"+7.6%","d":"up"}];
const COLS = ["ID","Situation Room","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency Mgmt #001","Emergency Mgmt #002","1.650","6.097","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency Mgmt #002","Emergency Mgmt #003","6.751","8.503","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency Mgmt #003","Emergency Mgmt #004","1.151","3.190","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency Mgmt #004","Emergency Mgmt #005","8.901","8.671","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency Mgmt #005","Emergency Mgmt #001","1.771","4.752","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":961},{"label":"Mar","value":639},{"label":"Abr","value":823},{"label":"Mai","value":948},{"label":"Jun","value":975},{"label":"Jul","value":680},{"label":"Ago","value":667},{"label":"Set","value":934},{"label":"Out","value":975},{"label":"Nov","value":885},{"label":"Dez","value":953}];
const MX = 975;
