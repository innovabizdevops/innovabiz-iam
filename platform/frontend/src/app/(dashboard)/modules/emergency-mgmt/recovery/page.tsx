...
const PAGE = "Recovery Plan";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.681","t":"+3.6%","d":"up"},{"l":"RTO Médio (h)","v":"41h","t":"+6.6%","d":"up"},{"l":"RPO Médio (h)","v":"126h","t":"+13.9%","d":"up"},{"l":"Testes DR (YTD)","v":"1.917","t":"+3.0%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","195h","101h","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","105h","96h","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","154h","125h","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","209h","103h","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","121h","174h","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":895},{"label":"Fev","value":671},{"label":"Mar","value":767},{"label":"Abr","value":760},{"label":"Mai","value":714},{"label":"Jun","value":907},{"label":"Jul","value":571},{"label":"Ago","value":805},{"label":"Set","value":544},{"label":"Out","value":577},{"label":"Nov","value":618},{"label":"Dez","value":564}];
const MX = 907;
