...
const ACCENT = "#dc2626";
const MODULE = "AOG Support";
const PAGE = "Part Source";
const KPIS = [{"l":"Tickets Abertos","v":"8.327","t":"+10.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.0%","t":"-3.6%","d":"down"},{"l":"MTTR (h)","v":"79h","t":"+4.3%","d":"up"},{"l":"Satisfação (%)","v":"79.0%","t":"+5.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.288","8.674","4.437","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","682","8.376","7.260","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.691","5.348","4.732","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.904","992","3.886","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.821","7.943","2.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":728},{"label":"Mar","value":691},{"label":"Abr","value":567},{"label":"Mai","value":489},{"label":"Jun","value":539},{"label":"Jul","value":711},{"label":"Ago","value":656},{"label":"Set","value":663},{"label":"Out","value":559},{"label":"Nov","value":750},{"label":"Dez","value":600}];
const MX = 750;
