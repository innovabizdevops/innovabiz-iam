...
const KPIS = [{"l":"Tickets Abertos","v":"7.934","t":"-5.3%","d":"down"},{"l":"SLA Cumprido (%)","v":"66.1%","t":"+12.4%","d":"up"},{"l":"MTTR (h)","v":"15h","t":"-0.1%","d":"down"},{"l":"Satisfação (%)","v":"76.0%","t":"+13.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.047","2.645","6.695","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.122","6.641","3.557","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.523","2.662","6.703","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.801","5.092","1.306","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.349","4.171","1.669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":888},{"label":"Fev","value":814},{"label":"Mar","value":839},{"label":"Abr","value":815},{"label":"Mai","value":948},{"label":"Jun","value":1011},{"label":"Jul","value":1008},{"label":"Ago","value":733},{"label":"Set","value":850},{"label":"Out","value":906},{"label":"Nov","value":975},{"label":"Dez","value":655}];
const MX = 1011;
