...
export default function AogSupportPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aog Support</h1><p className="text-sm text-muted-foreground">Aog Support • iBOS Enterprise</p></div>
