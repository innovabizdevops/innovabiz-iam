...
const PAGE = "Expedite";
const KPIS = [{"l":"Tickets Abertos","v":"1.336","t":"+0.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"90.0%","t":"-5.1%","d":"down"},{"l":"MTTR (h)","v":"78h","t":"+7.7%","d":"up"},{"l":"Satisfação (%)","v":"72.0%","t":"+1.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.895","3.241","5.655","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.235","3.363","2.432","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.374","8.606","1.733","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.477","2.346","7.343","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.340","7.305","5.494","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":1025},{"label":"Mar","value":1061},{"label":"Abr","value":820},{"label":"Mai","value":980},{"label":"Jun","value":952},{"label":"Jul","value":919},{"label":"Ago","value":985},{"label":"Set","value":1041},{"label":"Out","value":900},{"label":"Nov","value":772},{"label":"Dez","value":996}];
const MX = 1061;
