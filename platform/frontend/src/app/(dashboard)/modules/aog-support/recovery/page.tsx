...
const PAGE = "Recovery";
const KPIS = [{"l":"Tickets Abertos","v":"6.422","t":"+1.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.8%","t":"+4.5%","d":"up"},{"l":"MTTR (h)","v":"199h","t":"+2.0%","d":"up"},{"l":"Satisfação (%)","v":"74.9%","t":"+1.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.736","6.444","3.037","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.998","3.443","7.738","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.229","2.586","779","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.884","4.467","8.532","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.857","2.942","253","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":699},{"label":"Mar","value":727},{"label":"Abr","value":883},{"label":"Mai","value":869},{"label":"Jun","value":689},{"label":"Jul","value":847},{"label":"Ago","value":786},{"label":"Set","value":800},{"label":"Out","value":815},{"label":"Nov","value":697},{"label":"Dez","value":716}];
const MX = 883;
