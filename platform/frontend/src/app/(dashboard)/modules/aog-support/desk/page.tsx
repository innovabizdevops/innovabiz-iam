...
const PAGE = "AOG Desk";
const KPIS = [{"l":"Tickets Abertos","v":"1.317","t":"+16.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"83.4%","t":"+11.2%","d":"up"},{"l":"MTTR (h)","v":"153h","t":"+12.2%","d":"up"},{"l":"Satisfação (%)","v":"80.6%","t":"-4.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.965","2.324","8.133","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","9.045","3.155","917","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.785","9.047","1.802","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.735","6.119","8.204","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","9.056","2.794","5.998","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":742},{"label":"Mar","value":581},{"label":"Abr","value":890},{"label":"Mai","value":915},{"label":"Jun","value":754},{"label":"Jul","value":800},{"label":"Ago","value":711},{"label":"Set","value":595},{"label":"Out","value":917},{"label":"Nov","value":790},{"label":"Dez","value":829}];
const MX = 917;
