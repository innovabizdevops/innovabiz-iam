...
const PAGE = "System Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.994","t":"-1.0%","d":"down"},{"l":"Submissões/Dia","v":"831","t":"+5.9%","d":"up"},{"l":"Documentos Gerados","v":"6.310","t":"-3.1%","d":"down"},{"l":"Templates","v":"4.884","t":"+6.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.966","2026-03-19","8.312","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.858","2026-02-07","2.918","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.470","2026-01-16","634","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.737","2026-03-20","8.940","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.450","2026-02-27","2.482","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":729},{"label":"Mar","value":532},{"label":"Abr","value":617},{"label":"Mai","value":815},{"label":"Jun","value":641},{"label":"Jul","value":742},{"label":"Ago","value":820},{"label":"Set","value":480},{"label":"Out","value":740},{"label":"Nov","value":610},{"label":"Dez","value":817}];
const MX = 820;
