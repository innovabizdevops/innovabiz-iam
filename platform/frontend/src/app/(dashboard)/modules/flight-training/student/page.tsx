...
const PAGE = "Student";
const KPIS = [{"l":"Total Flight Training","v":"5.322","t":"+2.2%","d":"up"},{"l":"Student Ativos","v":"3.184","t":"-3.7%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+12.9%","d":"up"}];
const COLS = ["ID","Student","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Training #001","Flight Training #002","8.840","8.343","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Training #002","Flight Training #003","9.069","6.997","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Training #003","Flight Training #004","582","3.792","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Training #004","Flight Training #005","1.868","8.795","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Training #005","Flight Training #001","3.643","3.144","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":857},{"label":"Mar","value":666},{"label":"Abr","value":828},{"label":"Mai","value":543},{"label":"Jun","value":761},{"label":"Jul","value":492},{"label":"Ago","value":673},{"label":"Set","value":530},{"label":"Out","value":582},{"label":"Nov","value":833},{"label":"Dez","value":553}];
const MX = 857;
