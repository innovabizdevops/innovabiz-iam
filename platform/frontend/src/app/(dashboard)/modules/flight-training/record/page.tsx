...
const ACCENT = "#6366f1";
const MODULE = "Flight Training";
const PAGE = "Record";
const KPIS = [{"l":"Total Flight Training","v":"8.247","t":"+16.9%","d":"up"},{"l":"Record Ativos","v":"8.852","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"55","t":"+6.6%","d":"up"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Training #001","Flight Training #002","7.625","1.783","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Training #002","Flight Training #003","2.144","8.040","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Training #003","Flight Training #004","2.932","4.744","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Training #004","Flight Training #005","1.216","8.946","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Training #005","Flight Training #001","3.115","8.623","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":314},{"label":"Mar","value":568},{"label":"Abr","value":429},{"label":"Mai","value":545},{"label":"Jun","value":305},{"label":"Jul","value":321},{"label":"Ago","value":609},{"label":"Set","value":233},{"label":"Out","value":588},{"label":"Nov","value":287},{"label":"Dez","value":619}];
const MX = 619;
