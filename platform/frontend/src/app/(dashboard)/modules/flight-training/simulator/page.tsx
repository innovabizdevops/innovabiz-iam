...
const KPIS = [{"l":"Twins Ativos","v":"6.665","t":"-1.6%","d":"down"},{"l":"Simulações/Dia","v":"1486","t":"+13.0%","d":"up"},{"l":"Precisão Modelo (%)","v":"86.1%","t":"+3.3%","d":"up"},{"l":"Latência Sync (ms)","v":"180ms","t":"+13.1%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","77.0%","2026-01-05","4.939","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","95.0%","2026-01-15","5.350","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","70.2%","2026-02-09","6.200","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","72.1%","2026-02-21","533","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","90.8%","2026-01-07","3.488","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":701},{"label":"Mar","value":657},{"label":"Abr","value":310},{"label":"Mai","value":475},{"label":"Jun","value":572},{"label":"Jul","value":461},{"label":"Ago","value":408},{"label":"Set","value":629},{"label":"Out","value":605},{"label":"Nov","value":611},{"label":"Dez","value":643}];
const MX = 701;
