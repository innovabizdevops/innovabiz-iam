...
const KPIS = [{"l":"Total Flight Training","v":"2.191","t":"+8.2%","d":"up"},{"l":"Instructor Ativos","v":"6.919","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"79","t":"+1.8%","d":"up"}];
const COLS = ["ID","Instructor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flight Training #001","Flight Training #002","1.100","7.341","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Flight Training #002","Flight Training #003","6.596","7.828","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Flight Training #003","Flight Training #004","2.324","797","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Flight Training #004","Flight Training #005","9.030","3.787","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flight Training #005","Flight Training #001","8.782","724","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":742},{"label":"Mar","value":624},{"label":"Abr","value":900},{"label":"Mai","value":643},{"label":"Jun","value":909},{"label":"Jul","value":574},{"label":"Ago","value":897},{"label":"Set","value":634},{"label":"Out","value":878},{"label":"Nov","value":750},{"label":"Dez","value":863}];
const MX = 909;
