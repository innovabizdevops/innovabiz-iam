...
const PAGE = "Lease";
const KPIS = [{"l":"Total Residential Lease","v":"2.118","t":"+1.9%","d":"up"},{"l":"Lease Ativos","v":"415","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"59","t":"+8.6%","d":"up"}];
const COLS = ["ID","Lease","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Residential Lease #001","Residential Lease #002","8.626","7.610","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Residential Lease #002","Residential Lease #003","3.292","8.160","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Residential Lease #003","Residential Lease #004","1.968","4.527","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Residential Lease #004","Residential Lease #005","4.083","1.287","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Residential Lease #005","Residential Lease #001","5.207","1.099","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":523},{"label":"Mar","value":596},{"label":"Abr","value":412},{"label":"Mai","value":518},{"label":"Jun","value":565},{"label":"Jul","value":436},{"label":"Ago","value":455},{"label":"Set","value":489},{"label":"Out","value":278},{"label":"Nov","value":510},{"label":"Dez","value":649}];
const MX = 649;
