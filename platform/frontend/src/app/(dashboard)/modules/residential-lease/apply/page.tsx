...
const KPIS = [{"l":"Total Residential Lease","v":"5.831","t":"+2.3%","d":"up"},{"l":"Application Ativos","v":"4.321","t":"+6.9%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+14.8%","d":"up"},{"l":"Score Performance","v":"77","t":"+6.2%","d":"up"}];
const COLS = ["ID","Application","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Residential Lease #001","Residential Lease #002","3.657","6.417","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Residential Lease #002","Residential Lease #003","7.581","519","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Residential Lease #003","Residential Lease #004","5.738","2.210","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Residential Lease #004","Residential Lease #005","7.712","2.779","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Residential Lease #005","Residential Lease #001","8.153","7.795","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":679},{"label":"Mar","value":693},{"label":"Abr","value":706},{"label":"Mai","value":755},{"label":"Jun","value":654},{"label":"Jul","value":536},{"label":"Ago","value":498},{"label":"Set","value":679},{"label":"Out","value":680},{"label":"Nov","value":546},{"label":"Dez","value":525}];
const MX = 861;
