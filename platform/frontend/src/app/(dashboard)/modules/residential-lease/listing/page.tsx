...
const ACCENT = "#6366f1";
const MODULE = "Residential Leasing";
const PAGE = "Listing";
const KPIS = [{"l":"Total Residential Lease","v":"3.047","t":"+15.0%","d":"up"},{"l":"Listing Ativos","v":"5.980","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"88.3%","t":"-3.5%","d":"down"},{"l":"Score Performance","v":"63","t":"+17.2%","d":"up"}];
const COLS = ["ID","Listing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Residential Lease #001","Residential Lease #002","4.673","7.366","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Residential Lease #002","Residential Lease #003","8.221","8.175","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Residential Lease #003","Residential Lease #004","2.672","6.621","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Residential Lease #004","Residential Lease #005","5.177","133","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Residential Lease #005","Residential Lease #001","7.645","1.782","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":601},{"label":"Mar","value":650},{"label":"Abr","value":635},{"label":"Mai","value":584},{"label":"Jun","value":829},{"label":"Jul","value":782},{"label":"Ago","value":704},{"label":"Set","value":499},{"label":"Out","value":607},{"label":"Nov","value":594},{"label":"Dez","value":522}];
const MX = 829;
