...
const KPIS = [{"l":"Total Arch Business","v":"7.652","t":"-5.3%","d":"down"},{"l":"Organization Ativos","v":"5.797","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.4%","d":"up"}];
const COLS = ["ID","Organization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Business #001","Arch Business #002","8.228","3.538","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Business #002","Arch Business #003","1.976","5.721","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Business #003","Arch Business #004","8.714","2.089","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Business #004","Arch Business #005","3.407","5.862","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Business #005","Arch Business #001","7.456","7.160","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":552},{"label":"Mar","value":347},{"label":"Abr","value":497},{"label":"Mai","value":619},{"label":"Jun","value":692},{"label":"Jul","value":374},{"label":"Ago","value":570},{"label":"Set","value":565},{"label":"Out","value":529},{"label":"Nov","value":350},{"label":"Dez","value":402}];
const MX = 692;
