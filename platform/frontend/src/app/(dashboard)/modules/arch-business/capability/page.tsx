...
const PAGE = "Capability";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.413","t":"-4.9%","d":"down"},{"l":"NC Abertas","v":"7.771","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"85.3%","t":"+16.7%","d":"up"},{"l":"CAPAs Pendentes","v":"5.700","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.342","94.8%","6.290","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.019","98.1%","5.086","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.724","72.0%","5.139","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.456","70.2%","4.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.010","91.9%","2.056","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":495},{"label":"Mar","value":699},{"label":"Abr","value":832},{"label":"Mai","value":520},{"label":"Jun","value":835},{"label":"Jul","value":564},{"label":"Ago","value":807},{"label":"Set","value":714},{"label":"Out","value":818},{"label":"Nov","value":763},{"label":"Dez","value":818}];
const MX = 835;
