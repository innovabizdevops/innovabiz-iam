...
const ACCENT = "#0e7490";
const MODULE = "Business Architecture (TOGAF)";
const PAGE = "Value Stream";
const KPIS = [{"l":"Total Arch Business","v":"1.705","t":"+7.5%","d":"up"},{"l":"Value Stream Ativos","v":"7.347","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"84.4%","t":"+1.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+15.0%","d":"up"}];
const COLS = ["ID","Value Stream","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Business #001","Arch Business #002","5.097","5.338","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Business #002","Arch Business #003","8.183","2.129","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Business #003","Arch Business #004","8.706","6.687","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Business #004","Arch Business #005","4.430","1.225","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Business #005","Arch Business #001","4.327","5.585","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":537},{"label":"Mar","value":435},{"label":"Abr","value":626},{"label":"Mai","value":762},{"label":"Jun","value":548},{"label":"Jul","value":662},{"label":"Ago","value":517},{"label":"Set","value":795},{"label":"Out","value":777},{"label":"Nov","value":484},{"label":"Dez","value":450}];
const MX = 795;
