...
/* ═══ Business Architecture (TOGAF) — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "7270", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2785", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€287K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-3%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "429875070", cells: ["ARC-9070", "Business Architecture (TOGAF) Item 1", "3/7/2026", "€25 170"], status: "active" as const },
    { id: "429878641", cells: ["ARC-3641", "Business Architecture (TOGAF) Item 2", "18/2/2026", "€28 741"], status: "pending" as const },
    { id: "429882212", cells: ["ARC-7212", "Business Architecture (TOGAF) Item 3", "5/9/2026", "€32 312"], status: "completed" as const },
    { id: "429885783", cells: ["ARC-1783", "Business Architecture (TOGAF) Item 4", "20/4/2026", "€35 883"], status: "warning" as const },
    { id: "429889354", cells: ["ARC-5354", "Business Architecture (TOGAF) Item 5", "7/11/2026", "€39 454"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 50 }, { label: "Fev", value: 59 }, { label: "Mar", value: 68 }, { label: "Abr", value: 77 }, { label: "Mai", value: 86 }, { label: "Jun", value: 95 }];
...
export default function BusinessArchitectureTogafPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Business Architecture (TOGAF)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Business Architecture (TOGAF)</p>
                    </div>
                </div>
