...
const PAGE = "Gap";
const KPIS = [{"l":"Total Arch Business","v":"6.679","t":"+14.0%","d":"up"},{"l":"Gap Ativos","v":"4.390","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"67.2%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"62","t":"+11.7%","d":"up"}];
const COLS = ["ID","Gap","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Business #001","Arch Business #002","6.194","3.846","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Business #002","Arch Business #003","991","2.014","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Business #003","Arch Business #004","2.201","7.715","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Business #004","Arch Business #005","7.535","6.305","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Business #005","Arch Business #001","6.740","2.657","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":589},{"label":"Mar","value":729},{"label":"Abr","value":750},{"label":"Mai","value":815},{"label":"Jun","value":660},{"label":"Jul","value":895},{"label":"Ago","value":843},{"label":"Set","value":708},{"label":"Out","value":890},{"label":"Nov","value":846},{"label":"Dez","value":862}];
const MX = 895;
