...
const PAGE = "Function";
const KPIS = [{"l":"Total Arch Business","v":"5.492","t":"+8.1%","d":"up"},{"l":"Function Ativos","v":"738","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"84.9%","t":"+14.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+16.5%","d":"up"}];
const COLS = ["ID","Function","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Arch Business #001","Arch Business #002","5.656","5.528","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Arch Business #002","Arch Business #003","5.538","7.021","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Arch Business #003","Arch Business #004","4.037","2.087","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Arch Business #004","Arch Business #005","7.658","8.866","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Arch Business #005","Arch Business #001","4.995","4.901","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":705},{"label":"Fev","value":392},{"label":"Mar","value":649},{"label":"Abr","value":447},{"label":"Mai","value":761},{"label":"Jun","value":398},{"label":"Jul","value":664},{"label":"Ago","value":453},{"label":"Set","value":449},{"label":"Out","value":685},{"label":"Nov","value":450},{"label":"Dez","value":580}];
const MX = 761;
