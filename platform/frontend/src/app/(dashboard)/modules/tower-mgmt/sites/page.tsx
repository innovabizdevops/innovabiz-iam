...
const PAGE = "Site Database";
const KPIS = [{"l":"Total Tower Mgmt","v":"7.992","t":"+14.2%","d":"up"},{"l":"Site Database Ativos","v":"5.582","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+15.2%","d":"up"},{"l":"Score Performance","v":"57","t":"-5.6%","d":"down"}];
const COLS = ["ID","Site Database","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","2026-02-24","3.906","4.583","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","2026-03-18","6.673","1.188","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","2026-02-05","7.328","192","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","2026-02-28","5.631","520","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","2026-01-09","8.178","6.257","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":516},{"label":"Mar","value":731},{"label":"Abr","value":775},{"label":"Mai","value":650},{"label":"Jun","value":446},{"label":"Jul","value":700},{"label":"Ago","value":760},{"label":"Set","value":677},{"label":"Out","value":439},{"label":"Nov","value":774},{"label":"Dez","value":678}];
const MX = 775;
