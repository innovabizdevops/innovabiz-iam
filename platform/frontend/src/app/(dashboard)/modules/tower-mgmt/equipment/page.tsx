...
const KPIS = [{"l":"Total Tower Mgmt","v":"6.820","t":"+3.7%","d":"up"},{"l":"Equipment Ativos","v":"1.753","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"75","t":"-0.1%","d":"down"}];
const COLS = ["ID","Equipment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","7.903","4.489","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","244","4.830","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","3.729","5.081","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","8.608","7.167","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","2.402","2.008","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":270},{"label":"Mar","value":614},{"label":"Abr","value":312},{"label":"Mai","value":453},{"label":"Jun","value":275},{"label":"Jul","value":497},{"label":"Ago","value":624},{"label":"Set","value":617},{"label":"Out","value":521},{"label":"Nov","value":584},{"label":"Dez","value":640}];
const MX = 640;
