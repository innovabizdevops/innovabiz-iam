...
const PAGE = "Lease Mgmt";
const KPIS = [{"l":"Total Tower Mgmt","v":"1.023","t":"-2.3%","d":"down"},{"l":"Lease Mgmt Ativos","v":"7.930","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"76.3%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"57","t":"+0.1%","d":"up"}];
const COLS = ["ID","Lease Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","556","8.169","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","3.186","1.862","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","4.916","5.185","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","4.802","8.900","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","8.971","8.040","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":735},{"label":"Fev","value":866},{"label":"Mar","value":682},{"label":"Abr","value":802},{"label":"Mai","value":898},{"label":"Jun","value":717},{"label":"Jul","value":935},{"label":"Ago","value":963},{"label":"Set","value":791},{"label":"Out","value":832},{"label":"Nov","value":671},{"label":"Dez","value":671}];
const MX = 963;
