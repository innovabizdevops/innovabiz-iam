...
const PAGE = "DAS System";
const KPIS = [{"l":"Total Tower Mgmt","v":"4.331","t":"+1.3%","d":"up"},{"l":"DAS System Ativos","v":"8.512","t":"+14.4%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.8%","d":"up"}];
const COLS = ["ID","DAS System","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","2.560","2.968","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","5.482","4.754","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","7.660","7.417","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","1.027","5.876","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","3.046","992","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":883},{"label":"Mar","value":858},{"label":"Abr","value":790},{"label":"Mai","value":989},{"label":"Jun","value":615},{"label":"Jul","value":652},{"label":"Ago","value":715},{"label":"Set","value":642},{"label":"Out","value":974},{"label":"Nov","value":954},{"label":"Dez","value":861}];
const MX = 989;
