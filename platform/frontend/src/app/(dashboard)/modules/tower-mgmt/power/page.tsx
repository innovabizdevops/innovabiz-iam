...
const PAGE = "Power Mgmt";
const KPIS = [{"l":"Total Tower Mgmt","v":"4.508","t":"+10.3%","d":"up"},{"l":"Power Mgmt Ativos","v":"6.983","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"72.7%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"93","t":"+2.0%","d":"up"}];
const COLS = ["ID","Power Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","7.383","8.620","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","6.761","6.078","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","6.777","620","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","7.825","855","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","9.067","5.755","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":856},{"label":"Mar","value":775},{"label":"Abr","value":750},{"label":"Mai","value":787},{"label":"Jun","value":858},{"label":"Jul","value":1006},{"label":"Ago","value":714},{"label":"Set","value":977},{"label":"Out","value":729},{"label":"Nov","value":788},{"label":"Dez","value":826}];
const MX = 1006;
