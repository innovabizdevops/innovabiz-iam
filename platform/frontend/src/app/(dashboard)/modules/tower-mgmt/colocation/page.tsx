...
const PAGE = "Co-Location";
const KPIS = [{"l":"Total Tower Mgmt","v":"3.827","t":"+14.8%","d":"up"},{"l":"Co Location Ativos","v":"671","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"76","t":"+6.6%","d":"up"}];
const COLS = ["ID","Co Location","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","5.765","7.064","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","1.014","2.018","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","1.561","7.263","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","8.191","536","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","1.843","7.277","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":848},{"label":"Mar","value":801},{"label":"Abr","value":914},{"label":"Mai","value":995},{"label":"Jun","value":733},{"label":"Jul","value":921},{"label":"Ago","value":848},{"label":"Set","value":887},{"label":"Out","value":640},{"label":"Nov","value":642},{"label":"Dez","value":973}];
const MX = 995;
