...
const ACCENT = "#8b5cf6";
const MODULE = "Tower Management";
const PAGE = "Small Cell";
const KPIS = [{"l":"Total Tower Mgmt","v":"7.115","t":"+13.6%","d":"up"},{"l":"Small Cell Ativos","v":"751","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+16.4%","d":"up"},{"l":"Score Performance","v":"59","t":"+14.6%","d":"up"}];
const COLS = ["ID","Small Cell","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tower Mgmt #001","Tower Mgmt #002","4.137","8.628","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Tower Mgmt #002","Tower Mgmt #003","8.505","3.112","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Tower Mgmt #003","Tower Mgmt #004","3.614","927","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Tower Mgmt #004","Tower Mgmt #005","987","4.792","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tower Mgmt #005","Tower Mgmt #001","3.351","6.700","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":544},{"label":"Fev","value":822},{"label":"Mar","value":531},{"label":"Abr","value":669},{"label":"Mai","value":495},{"label":"Jun","value":695},{"label":"Jul","value":510},{"label":"Ago","value":651},{"label":"Set","value":759},{"label":"Out","value":862},{"label":"Nov","value":818},{"label":"Dez","value":506}];
const MX = 862;
...
export default function SmallCellPage() {
    return (
