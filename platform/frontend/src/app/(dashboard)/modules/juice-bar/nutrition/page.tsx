...
const KPIS = [{"l":"Total Juice Bar","v":"8.984","t":"+0.1%","d":"up"},{"l":"Nutrition Ativos","v":"3.075","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"72.2%","t":"+9.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+13.2%","d":"up"}];
const COLS = ["ID","Nutrition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Juice Bar #001","Juice Bar #002","4.080","2.145","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Juice Bar #002","Juice Bar #003","7.217","2.334","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Juice Bar #003","Juice Bar #004","7.997","4.457","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Juice Bar #004","Juice Bar #005","7.577","8.282","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Juice Bar #005","Juice Bar #001","5.814","7.103","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":798},{"label":"Mar","value":981},{"label":"Abr","value":949},{"label":"Mai","value":794},{"label":"Jun","value":832},{"label":"Jul","value":650},{"label":"Ago","value":886},{"label":"Set","value":738},{"label":"Out","value":882},{"label":"Nov","value":695},{"label":"Dez","value":969}];
const MX = 981;
