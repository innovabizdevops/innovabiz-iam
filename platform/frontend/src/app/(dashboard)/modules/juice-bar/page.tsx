...
/* ═══ Juice Bar Chain — Dashboard ═══ */

const ACCENT = "#16a34a";

const KPIS = [
    { label: "Total Registos", value: "4005", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1213", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€431K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "672184205", cells: ["JUI-2205", "Juice Bar Chain Item 1", "22/6/2026", "€34 305"], status: "active" as const },
    { id: "672187776", cells: ["JUI-5776", "Juice Bar Chain Item 2", "9/1/2026", "€37 876"], status: "pending" as const },
    { id: "672191347", cells: ["JUI-9347", "Juice Bar Chain Item 3", "24/8/2026", "€41 447"], status: "completed" as const },
    { id: "672194918", cells: ["JUI-3918", "Juice Bar Chain Item 4", "11/3/2026", "€45 018"], status: "warning" as const },
    { id: "672198489", cells: ["JUI-7489", "Juice Bar Chain Item 5", "26/10/2026", "€48 589"], status: "active" as const },
];
...
export default function JuiceBarChainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Juice Bar Chain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Juice Bar Chain</p>
                    </div>
                </div>
