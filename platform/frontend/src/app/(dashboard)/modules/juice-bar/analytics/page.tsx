...
const ACCENT = "#16a34a";
const MODULE = "Juice Bar Chain";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"7.058","t":"+2.4%","d":"up"},{"l":"Queries/Dia","v":"5079","t":"+11.6%","d":"up"},{"l":"Dados Processados (GB)","v":"8.991","t":"+17.3%","d":"up"},{"l":"Utilizadores Analytics","v":"6.890","t":"+18.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1465","2026-01-06","4.646","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","947","2026-03-02","533","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3268","2026-02-16","1.591","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1364","2026-02-08","1.749","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1476","2026-01-23","6.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":962},{"label":"Fev","value":816},{"label":"Mar","value":811},{"label":"Abr","value":928},{"label":"Mai","value":684},{"label":"Jun","value":642},{"label":"Jul","value":872},{"label":"Ago","value":838},{"label":"Set","value":945},{"label":"Out","value":774},{"label":"Nov","value":768},{"label":"Dez","value":787}];
const MX = 962;
