...
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"6.833","t":"+5.6%","d":"up"},{"l":"RevPAR (€)","v":"€6808","t":"+14.6%","d":"up"},{"l":"Ocupação (%)","v":"90.2%","t":"+7.7%","d":"up"},{"l":"Guest Satisfaction","v":"8.002","t":"+9.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.803","2026-03-23","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.947","2026-02-07","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.174","2026-02-16","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.803","2026-01-02","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.772","2026-03-09","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":724},{"label":"Fev","value":708},{"label":"Mar","value":552},{"label":"Abr","value":613},{"label":"Mai","value":483},{"label":"Jun","value":532},{"label":"Jul","value":509},{"label":"Ago","value":561},{"label":"Set","value":535},{"label":"Out","value":561},{"label":"Nov","value":744},{"label":"Dez","value":701}];
const MX = 744;
