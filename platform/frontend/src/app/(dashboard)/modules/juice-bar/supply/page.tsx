...
const PAGE = "Supply";
const KPIS = [{"l":"Total Juice Bar","v":"2.578","t":"-1.8%","d":"down"},{"l":"Supply Ativos","v":"1.039","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"87.9%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+6.4%","d":"up"}];
const COLS = ["ID","Supply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Juice Bar #001","Juice Bar #002","3.315","4.400","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Juice Bar #002","Juice Bar #003","3.582","7.518","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Juice Bar #003","Juice Bar #004","5.518","3.519","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Juice Bar #004","Juice Bar #005","4.913","166","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Juice Bar #005","Juice Bar #001","1.645","5.618","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":729},{"label":"Mar","value":962},{"label":"Abr","value":710},{"label":"Mai","value":706},{"label":"Jun","value":998},{"label":"Jul","value":778},{"label":"Ago","value":895},{"label":"Set","value":930},{"label":"Out","value":808},{"label":"Nov","value":741},{"label":"Dez","value":695}];
const MX = 998;
