...
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"4.581","t":"+15.5%","d":"up"},{"l":"Submissões/Dia","v":"4558","t":"+1.4%","d":"up"},{"l":"Documentos Gerados","v":"4.491","t":"+17.4%","d":"up"},{"l":"Templates","v":"2.739","t":"+6.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.531","2026-01-16","2.301","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.748","2026-01-02","4.191","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.823","2026-02-23","2.915","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.999","2026-01-05","7.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.094","2026-01-08","7.865","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":751},{"label":"Mar","value":479},{"label":"Abr","value":732},{"label":"Mai","value":512},{"label":"Jun","value":606},{"label":"Jul","value":734},{"label":"Ago","value":435},{"label":"Set","value":529},{"label":"Out","value":566},{"label":"Nov","value":477},{"label":"Dez","value":370}];
const MX = 751;
