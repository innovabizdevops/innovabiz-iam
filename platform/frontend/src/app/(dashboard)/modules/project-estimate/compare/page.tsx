...
const ACCENT = "#6366f1";
const MODULE = "Project Estimating";
const PAGE = "Compare";
const KPIS = [{"l":"Total Project Estimate","v":"7.848","t":"-0.5%","d":"down"},{"l":"Compare Ativos","v":"6.596","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"82","t":"+11.4%","d":"up"}];
const COLS = ["ID","Compare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Project Estimate #001","Project Estimate #002","2.192","1.370","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Project Estimate #002","Project Estimate #003","3.684","4.197","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Project Estimate #003","Project Estimate #004","8.767","5.742","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Project Estimate #004","Project Estimate #005","3.363","416","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Project Estimate #005","Project Estimate #001","154","2.349","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":924},{"label":"Mar","value":693},{"label":"Abr","value":768},{"label":"Mai","value":620},{"label":"Jun","value":736},{"label":"Jul","value":816},{"label":"Ago","value":764},{"label":"Set","value":572},{"label":"Out","value":661},{"label":"Nov","value":883},{"label":"Dez","value":597}];
const MX = 924;
