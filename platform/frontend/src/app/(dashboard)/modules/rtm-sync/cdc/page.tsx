...
const PAGE = "CDC";
const KPIS = [{"l":"Integrações Ativas","v":"8.402","t":"+5.8%","d":"up"},{"l":"Chamadas/Hora","v":"214","t":"+4.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"81.7%","t":"-3.1%","d":"down"},{"l":"Latência Média (ms)","v":"94ms","t":"+13.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.571","5.262","76.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.664","8.195","90.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","938","5.708","95.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.242","5.025","95.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.926","1.032","73.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":855},{"label":"Fev","value":748},{"label":"Mar","value":715},{"label":"Abr","value":896},{"label":"Mai","value":666},{"label":"Jun","value":927},{"label":"Jul","value":828},{"label":"Ago","value":928},{"label":"Set","value":907},{"label":"Out","value":665},{"label":"Nov","value":802},{"label":"Dez","value":753}];
const MX = 928;
