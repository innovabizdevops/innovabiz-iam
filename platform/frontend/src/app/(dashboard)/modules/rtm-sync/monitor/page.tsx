...
const ACCENT = "#dc2626";
const MODULE = "RTM Data Synchronization";
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"8.400","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"4430","t":"+13.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.8%","t":"+3.1%","d":"up"},{"l":"Latência Média (ms)","v":"9ms","t":"+16.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.136","8.704","74.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.994","8.386","79.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.425","3.524","97.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.104","8.825","77.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.811","2.217","76.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":747},{"label":"Mar","value":839},{"label":"Abr","value":690},{"label":"Mai","value":827},{"label":"Jun","value":614},{"label":"Jul","value":863},{"label":"Ago","value":583},{"label":"Set","value":593},{"label":"Out","value":894},{"label":"Nov","value":767},{"label":"Dez","value":680}];
const MX = 894;
