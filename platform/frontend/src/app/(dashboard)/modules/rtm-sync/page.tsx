...
/* ═══ RTM Data Synchronization — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8908", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2567", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€140K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "93%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "735588708", cells: ["RTM-1708", "RTM Data Synchronization Item 1", "9/1/2026", "€38 808"], status: "active" as const },
    { id: "735592279", cells: ["RTM-5279", "RTM Data Synchronization Item 2", "24/8/2026", "€42 379"], status: "pending" as const },
    { id: "735595850", cells: ["RTM-8850", "RTM Data Synchronization Item 3", "11/3/2026", "€45 950"], status: "completed" as const },
    { id: "735599421", cells: ["RTM-3421", "RTM Data Synchronization Item 4", "26/10/2026", "€49 521"], status: "warning" as const },
    { id: "735602992", cells: ["RTM-6992", "RTM Data Synchronization Item 5", "13/5/2026", "€3092"], status: "active" as const },
];
...
export default function RtmDataSynchronizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Data Synchronization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Data Synchronization</p>
                    </div>
                </div>
