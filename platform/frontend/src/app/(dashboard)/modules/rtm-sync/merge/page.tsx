...
const PAGE = "Merge";
const KPIS = [{"l":"Integrações Ativas","v":"3.615","t":"+16.6%","d":"up"},{"l":"Chamadas/Hora","v":"2229","t":"+0.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.4%","t":"-4.9%","d":"down"},{"l":"Latência Média (ms)","v":"156ms","t":"-3.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.915","811","93.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.230","428","93.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.618","5.795","91.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.573","6.573","97.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.609","358","97.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":476},{"label":"Mar","value":579},{"label":"Abr","value":533},{"label":"Mai","value":430},{"label":"Jun","value":497},{"label":"Jul","value":709},{"label":"Ago","value":433},{"label":"Set","value":471},{"label":"Out","value":725},{"label":"Nov","value":533},{"label":"Dez","value":485}];
const MX = 725;
