...
const PAGE = "Verify";
const KPIS = [{"l":"Integrações Ativas","v":"1.041","t":"+8.3%","d":"up"},{"l":"Chamadas/Hora","v":"1752","t":"+17.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.7%","t":"+11.7%","d":"up"},{"l":"Latência Média (ms)","v":"71ms","t":"+10.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.962","8.129","80.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.585","1.887","78.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.385","2.610","79.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.832","4.507","83.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.632","5.552","81.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":216},{"label":"Fev","value":349},{"label":"Mar","value":485},{"label":"Abr","value":264},{"label":"Mai","value":497},{"label":"Jun","value":535},{"label":"Jul","value":243},{"label":"Ago","value":486},{"label":"Set","value":265},{"label":"Out","value":405},{"label":"Nov","value":300},{"label":"Dez","value":470}];
const MX = 535;
