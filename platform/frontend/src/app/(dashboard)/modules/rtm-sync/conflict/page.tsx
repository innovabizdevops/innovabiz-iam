...
const PAGE = "Conflict";
const KPIS = [{"l":"Integrações Ativas","v":"2.973","t":"+11.6%","d":"up"},{"l":"Chamadas/Hora","v":"1931","t":"-3.9%","d":"down"},{"l":"Taxa Sucesso (%)","v":"65.1%","t":"+6.9%","d":"up"},{"l":"Latência Média (ms)","v":"146ms","t":"+5.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.313","3.665","78.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.942","8.568","74.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.856","8.321","74.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.194","6.644","75.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","567","6.718","87.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":749},{"label":"Mar","value":466},{"label":"Abr","value":639},{"label":"Mai","value":479},{"label":"Jun","value":517},{"label":"Jul","value":648},{"label":"Ago","value":603},{"label":"Set","value":550},{"label":"Out","value":763},{"label":"Nov","value":459},{"label":"Dez","value":423}];
const MX = 763;
