...
/* ═══ Transportation Mgmt (TMS) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "1225", trend: "-1%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "444", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€447K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "-8%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "884219625", cells: ["TRA-6625", "Transportation Mgmt (TMS) Item 1", "10/10/2026", "€19 725"], status: "active" as const },
    { id: "884223196", cells: ["TRA-1196", "Transportation Mgmt (TMS) Item 2", "25/5/2026", "€23 296"], status: "pending" as const },
    { id: "884226767", cells: ["TRA-4767", "Transportation Mgmt (TMS) Item 3", "12/12/2026", "€26 867"], status: "completed" as const },
    { id: "884230338", cells: ["TRA-8338", "Transportation Mgmt (TMS) Item 4", "27/7/2026", "€30 438"], status: "warning" as const },
    { id: "884233909", cells: ["TRA-2909", "Transportation Mgmt (TMS) Item 5", "14/2/2026", "€34 009"], status: "active" as const },
];
...
export default function TransportationMgmtTmsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Transportation Mgmt (TMS)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Transportation Mgmt (TMS)</p>
                    </div>
                </div>
