...
const PAGE = "Execute";
const KPIS = [{"l":"Atletas Registados","v":"6.171","t":"+16.9%","d":"up"},{"l":"Treinos/Semana","v":"2076","t":"+3.5%","d":"up"},{"l":"Competições","v":"138","t":"+14.0%","d":"up"},{"l":"Performance Score","v":"59","t":"-5.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.703","1.297","1.480","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.039","7.080","5.424","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.415","2.445","8.674","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","6.488","4.427","1.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.674","3.781","3.907","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":416},{"label":"Mar","value":576},{"label":"Abr","value":367},{"label":"Mai","value":237},{"label":"Jun","value":323},{"label":"Jul","value":475},{"label":"Ago","value":413},{"label":"Set","value":294},{"label":"Out","value":587},{"label":"Nov","value":248},{"label":"Dez","value":535}];
const MX = 587;
