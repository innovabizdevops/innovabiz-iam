...
const PAGE = "Settle";
const KPIS = [{"l":"Atletas Registados","v":"3.375","t":"-0.2%","d":"down"},{"l":"Treinos/Semana","v":"3800","t":"-4.9%","d":"down"},{"l":"Competições","v":"2.181","t":"+1.7%","d":"up"},{"l":"Performance Score","v":"75","t":"+8.4%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.080","4.581","8.876","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.518","5.328","8.338","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","7.037","2.964","2.910","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.650","6.872","6.457","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.993","3.086","2.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":675},{"label":"Mar","value":303},{"label":"Abr","value":560},{"label":"Mai","value":329},{"label":"Jun","value":343},{"label":"Jul","value":444},{"label":"Ago","value":555},{"label":"Set","value":590},{"label":"Out","value":354},{"label":"Nov","value":539},{"label":"Dez","value":378}];
const MX = 675;
