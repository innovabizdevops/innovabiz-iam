...
const PAGE = "Optimize";
const KPIS = [{"l":"Atletas Registados","v":"5.069","t":"+5.6%","d":"up"},{"l":"Treinos/Semana","v":"3201","t":"-3.3%","d":"down"},{"l":"Competições","v":"7.947","t":"+10.9%","d":"up"},{"l":"Performance Score","v":"76","t":"+8.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.801","607","7.497","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.321","5.388","5.389","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","1.831","6.036","6.723","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.748","4.850","1.941","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.305","4.125","189","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":337},{"label":"Mar","value":381},{"label":"Abr","value":577},{"label":"Mai","value":383},{"label":"Jun","value":575},{"label":"Jul","value":538},{"label":"Ago","value":643},{"label":"Set","value":375},{"label":"Out","value":362},{"label":"Nov","value":503},{"label":"Dez","value":301}];
const MX = 643;
