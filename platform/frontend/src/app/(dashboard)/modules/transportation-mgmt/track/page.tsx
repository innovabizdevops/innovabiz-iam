...
const ACCENT = "#0891b2";
const MODULE = "Transportation Mgmt (TMS)";
const PAGE = "Track";
const KPIS = [{"l":"Atletas Registados","v":"3.858","t":"+10.2%","d":"up"},{"l":"Treinos/Semana","v":"3164","t":"+12.1%","d":"up"},{"l":"Competições","v":"2.386","t":"-0.9%","d":"down"},{"l":"Performance Score","v":"66","t":"+12.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","5.442","8.644","4.498","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.051","2.260","8.185","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.993","6.402","8.370","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","928","2.459","8.790","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","537","762","8.771","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":566},{"label":"Mar","value":620},{"label":"Abr","value":608},{"label":"Mai","value":673},{"label":"Jun","value":866},{"label":"Jul","value":686},{"label":"Ago","value":578},{"label":"Set","value":822},{"label":"Out","value":561},{"label":"Nov","value":646},{"label":"Dez","value":606}];
const MX = 866;
