...
const PAGE = "Plan";
const KPIS = [{"l":"Atletas Registados","v":"1.431","t":"+13.3%","d":"up"},{"l":"Treinos/Semana","v":"1361","t":"+3.4%","d":"up"},{"l":"Competições","v":"2.750","t":"-3.2%","d":"down"},{"l":"Performance Score","v":"63","t":"-4.3%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","525","2.310","5.327","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.050","7.517","2.477","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.630","4.049","3.599","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","231","1.331","7.073","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.488","5.801","6.935","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":678},{"label":"Mar","value":663},{"label":"Abr","value":509},{"label":"Mai","value":646},{"label":"Jun","value":736},{"label":"Jul","value":870},{"label":"Ago","value":760},{"label":"Set","value":537},{"label":"Out","value":642},{"label":"Nov","value":577},{"label":"Dez","value":687}];
const MX = 870;
