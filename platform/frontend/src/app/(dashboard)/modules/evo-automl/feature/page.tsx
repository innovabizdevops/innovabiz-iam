...
const ACCENT = "#059669";
const MODULE = "EVO AutoML Pipeline";
const PAGE = "Feature";
const KPIS = [{"l":"Total Evo Automl","v":"5.834","t":"+0.9%","d":"up"},{"l":"Feature Ativos","v":"816","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"73.6%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+0.7%","d":"up"}];
const COLS = ["ID","Feature","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Evo Automl #001","Evo Automl #002","6.118","1.272","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Evo Automl #002","Evo Automl #003","8.287","4.588","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Evo Automl #003","Evo Automl #004","3.953","5.235","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Evo Automl #004","Evo Automl #005","832","7.986","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Evo Automl #005","Evo Automl #001","1.486","9.061","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":518},{"label":"Fev","value":395},{"label":"Mar","value":601},{"label":"Abr","value":443},{"label":"Mai","value":485},{"label":"Jun","value":507},{"label":"Jul","value":602},{"label":"Ago","value":576},{"label":"Set","value":601},{"label":"Out","value":431},{"label":"Nov","value":558},{"label":"Dez","value":492}];
const MX = 602;
