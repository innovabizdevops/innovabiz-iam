...
/* ═══ EVO AutoML Pipeline — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "6320", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1718", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€57K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "643842820", cells: ["EVO-1820", "EVO AutoML Pipeline Item 1", "13/5/2026", "€42 920"], status: "active" as const },
    { id: "643846391", cells: ["EVO-5391", "EVO AutoML Pipeline Item 2", "28/12/2026", "€46 491"], status: "pending" as const },
    { id: "643849962", cells: ["EVO-8962", "EVO AutoML Pipeline Item 3", "15/7/2026", "€50 062"], status: "completed" as const },
    { id: "643853533", cells: ["EVO-3533", "EVO AutoML Pipeline Item 4", "2/2/2026", "€3633"], status: "warning" as const },
    { id: "643857104", cells: ["EVO-7104", "EVO AutoML Pipeline Item 5", "17/9/2026", "€7204"], status: "active" as const },
];
...
export default function EvoAutomlPipelinePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EVO AutoML Pipeline</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EVO AutoML Pipeline</p>
                    </div>
                </div>
