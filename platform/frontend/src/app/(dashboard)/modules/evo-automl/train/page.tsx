...
const PAGE = "Train";
const KPIS = [{"l":"Total Evo Automl","v":"6.493","t":"-0.5%","d":"down"},{"l":"Train Ativos","v":"2.721","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"75.9%","t":"+18.0%","d":"up"},{"l":"Score Performance","v":"69","t":"+10.2%","d":"up"}];
const COLS = ["ID","Train","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Evo Automl #001","Evo Automl #002","1.924","230","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Evo Automl #002","Evo Automl #003","2.281","8.204","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Evo Automl #003","Evo Automl #004","2.368","1.203","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Evo Automl #004","Evo Automl #005","5.040","4.351","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Evo Automl #005","Evo Automl #001","7.316","1.201","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":826},{"label":"Fev","value":866},{"label":"Mar","value":968},{"label":"Abr","value":722},{"label":"Mai","value":656},{"label":"Jun","value":645},{"label":"Jul","value":649},{"label":"Ago","value":917},{"label":"Set","value":774},{"label":"Out","value":987},{"label":"Nov","value":637},{"label":"Dez","value":849}];
const MX = 987;
