...
const ACCENT = "#155e75";
const MODULE = "Leather Care";
const PAGE = "Repair";
const KPIS = [{"l":"Total Leather Care","v":"8.898","t":"+3.5%","d":"up"},{"l":"Repair Ativos","v":"1.917","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"84.2%","t":"+15.5%","d":"up"},{"l":"Score Performance","v":"57","t":"+13.0%","d":"up"}];
const COLS = ["ID","Repair","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Care #001","Leather Care #002","5.785","2.662","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Care #002","Leather Care #003","4.966","1.653","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Care #003","Leather Care #004","7.194","5.220","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Care #004","Leather Care #005","426","5.655","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Care #005","Leather Care #001","5.993","6.479","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":705},{"label":"Mar","value":399},{"label":"Abr","value":340},{"label":"Mai","value":558},{"label":"Jun","value":556},{"label":"Jul","value":570},{"label":"Ago","value":632},{"label":"Set","value":500},{"label":"Out","value":657},{"label":"Nov","value":447},{"label":"Dez","value":585}];
const MX = 705;
