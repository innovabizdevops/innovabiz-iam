...
const PAGE = "Clean";
const KPIS = [{"l":"Projetos Melhoria","v":"7.254","t":"+9.5%","d":"up"},{"l":"Savings (€)","v":"€83226","t":"-4.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"83.4%","t":"+2.6%","d":"up"},{"l":"Ciclos PDCA","v":"1.781","t":"+6.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.018","€ 22313.97","3.893","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.437","€ 31800.56","7.169","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.547","€ 15477.70","5.400","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.307","€ 48507.39","4.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.885","€ 39503.37","8.996","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":545},{"label":"Mar","value":427},{"label":"Abr","value":366},{"label":"Mai","value":373},{"label":"Jun","value":623},{"label":"Jul","value":591},{"label":"Ago","value":643},{"label":"Set","value":404},{"label":"Out","value":522},{"label":"Nov","value":568},{"label":"Dez","value":430}];
const MX = 643;
