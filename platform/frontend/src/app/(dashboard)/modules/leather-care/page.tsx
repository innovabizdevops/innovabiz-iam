...
const KPIS = [
    { label: "Total Registos", value: "6848", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2321", trend: "-18%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€289K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1463840548", cells: ["LEA-9548", "Leather Care Item 1", "17/5/2026", "€40 648"], status: "active" as const },
    { id: "1463844119", cells: ["LEA-4119", "Leather Care Item 2", "4/12/2026", "€44 219"], status: "pending" as const },
    { id: "1463847690", cells: ["LEA-7690", "Leather Care Item 3", "19/7/2026", "€47 790"], status: "completed" as const },
    { id: "1463851261", cells: ["LEA-2261", "Leather Care Item 4", "6/2/2026", "€1361"], status: "warning" as const },
    { id: "1463854832", cells: ["LEA-5832", "Leather Care Item 5", "21/9/2026", "€4932"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Leather Care</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Leather Care</p>
                    </div>
                </div>
