...
const PAGE = "Protect";
const KPIS = [{"l":"Total Leather Care","v":"3.463","t":"+1.4%","d":"up"},{"l":"Protect Ativos","v":"621","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"82","t":"+6.9%","d":"up"}];
const COLS = ["ID","Protect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Leather Care #001","Leather Care #002","7.443","3.586","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Leather Care #002","Leather Care #003","750","7.366","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Leather Care #003","Leather Care #004","4.347","2.501","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Leather Care #004","Leather Care #005","5.308","8.307","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Leather Care #005","Leather Care #001","5.360","8.184","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":633},{"label":"Mar","value":459},{"label":"Abr","value":655},{"label":"Mai","value":573},{"label":"Jun","value":451},{"label":"Jul","value":586},{"label":"Ago","value":582},{"label":"Set","value":687},{"label":"Out","value":627},{"label":"Nov","value":640},{"label":"Dez","value":651}];
const MX = 687;
