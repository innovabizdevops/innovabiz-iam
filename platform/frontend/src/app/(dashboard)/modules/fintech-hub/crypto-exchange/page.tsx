...
/* ═══ FinTech Hub — Crypto Exchange ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "4042", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "50", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3390", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1000706846", cells: ["FIN-6846", "Crypto Exchange Item 1", "7/3/2026", "€6946"], status: "active" as const },
    { id: "1000710417", cells: ["FIN-1417", "Crypto Exchange Item 2", "22/10/2026", "€10 517"], status: "pending" as const },
    { id: "1000713988", cells: ["FIN-4988", "Crypto Exchange Item 3", "9/5/2026", "€14 088"], status: "completed" as const },
    { id: "1000717559", cells: ["FIN-8559", "Crypto Exchange Item 4", "24/12/2026", "€17 659"], status: "warning" as const },
    { id: "1000721130", cells: ["FIN-3130", "Crypto Exchange Item 5", "11/7/2026", "€21 230"], status: "active" as const },
];
...
export default function FintechHubCryptoExchangePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crypto Exchange</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Crypto Exchange</p>
                    </div>
                </div>
