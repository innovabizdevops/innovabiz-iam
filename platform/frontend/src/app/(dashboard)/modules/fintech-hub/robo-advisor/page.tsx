...
/* ═══ FinTech Hub — Robo Advisor ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "1683", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "34", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "74", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1457257966", cells: ["FIN-5966", "Robo Advisor Item 1", "11/11/2026", "€8066"], status: "active" as const },
    { id: "1457261537", cells: ["FIN-9537", "Robo Advisor Item 2", "26/6/2026", "€11 637"], status: "pending" as const },
    { id: "1457265108", cells: ["FIN-4108", "Robo Advisor Item 3", "13/1/2026", "€15 208"], status: "completed" as const },
    { id: "1457268679", cells: ["FIN-7679", "Robo Advisor Item 4", "28/8/2026", "€18 779"], status: "warning" as const },
    { id: "1457272250", cells: ["FIN-2250", "Robo Advisor Item 5", "15/3/2026", "€22 350"], status: "active" as const },
];
...
export default function FintechHubRoboAdvisorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Robo Advisor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Robo Advisor</p>
                    </div>
                </div>
