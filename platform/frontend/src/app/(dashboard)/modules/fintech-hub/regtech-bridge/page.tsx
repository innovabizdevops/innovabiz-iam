...
/* ═══ FinTech Hub — Regtech Bridge ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "340", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "433", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "599", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "300499069", cells: ["FIN-8069", "Regtech Bridge Item 1", "18/2/2026", "€49 169"], status: "active" as const },
    { id: "300502640", cells: ["FIN-2640", "Regtech Bridge Item 2", "5/9/2026", "€2740"], status: "pending" as const },
    { id: "300506211", cells: ["FIN-6211", "Regtech Bridge Item 3", "20/4/2026", "€6311"], status: "completed" as const },
    { id: "300509782", cells: ["FIN-9782", "Regtech Bridge Item 4", "7/11/2026", "€9882"], status: "warning" as const },
    { id: "300513353", cells: ["FIN-4353", "Regtech Bridge Item 5", "22/6/2026", "€13 453"], status: "active" as const },
];
...
export default function FintechHubRegtechBridgePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regtech Bridge</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Regtech Bridge</p>
                    </div>
                </div>
