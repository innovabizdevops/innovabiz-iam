...
/* ═══ FinTech Hub — Crowdfunding ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "2048", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "88", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2205", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "94720724", cells: ["FIN-5724", "Crowdfunding Item 1", "1/9/2026", "€20 824"], status: "active" as const },
    { id: "94724295", cells: ["FIN-9295", "Crowdfunding Item 2", "16/4/2026", "€24 395"], status: "pending" as const },
    { id: "94727866", cells: ["FIN-3866", "Crowdfunding Item 3", "3/11/2026", "€27 966"], status: "completed" as const },
    { id: "94731437", cells: ["FIN-7437", "Crowdfunding Item 4", "18/6/2026", "€31 537"], status: "warning" as const },
    { id: "94735008", cells: ["FIN-2008", "Crowdfunding Item 5", "5/1/2026", "€35 108"], status: "active" as const },
];
...
export default function FintechHubCrowdfundingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crowdfunding</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Crowdfunding</p>
                    </div>
                </div>
