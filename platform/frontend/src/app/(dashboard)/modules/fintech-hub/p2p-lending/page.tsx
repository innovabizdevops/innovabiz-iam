...
/* ═══ FinTech Hub — P2p Lending ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "385", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "375", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2089", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1834114147", cells: ["FIN-5147", "P2p Lending Item 1", "20/8/2026", "€14 247"], status: "active" as const },
    { id: "1834117718", cells: ["FIN-8718", "P2p Lending Item 2", "7/3/2026", "€17 818"], status: "pending" as const },
    { id: "1834121289", cells: ["FIN-3289", "P2p Lending Item 3", "22/10/2026", "€21 389"], status: "completed" as const },
    { id: "1834124860", cells: ["FIN-6860", "P2p Lending Item 4", "9/5/2026", "€24 960"], status: "warning" as const },
    { id: "1834128431", cells: ["FIN-1431", "P2p Lending Item 5", "24/12/2026", "€28 531"], status: "active" as const },
];
...
export default function FintechHubP2pLendingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">P2p Lending</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • P2p Lending</p>
                    </div>
                </div>
