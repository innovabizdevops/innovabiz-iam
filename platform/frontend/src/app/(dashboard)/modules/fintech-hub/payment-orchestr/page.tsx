...
/* ═══ FinTech Hub — Payment Orchestr ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "4757", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "438", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2370", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "71%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "176516434", cells: ["FIN-9434", "Payment Orchestr Item 1", "11/11/2026", "€16 534"], status: "active" as const },
    { id: "176520005", cells: ["FIN-4005", "Payment Orchestr Item 2", "26/6/2026", "€20 105"], status: "pending" as const },
    { id: "176523576", cells: ["FIN-7576", "Payment Orchestr Item 3", "13/1/2026", "€23 676"], status: "completed" as const },
    { id: "176527147", cells: ["FIN-2147", "Payment Orchestr Item 4", "28/8/2026", "€27 247"], status: "warning" as const },
    { id: "176530718", cells: ["FIN-5718", "Payment Orchestr Item 5", "15/3/2026", "€30 818"], status: "active" as const },
];
...
export default function FintechHubPaymentOrchestrPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Payment Orchestr</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Payment Orchestr</p>
                    </div>
                </div>
