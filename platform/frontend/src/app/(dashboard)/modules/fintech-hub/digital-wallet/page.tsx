...
/* ═══ FinTech Hub — Digital Wallet ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "1782", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "175", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "903", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "765506747", cells: ["FIN-3747", "Digital Wallet Item 1", "20/12/2026", "€6847"], status: "active" as const },
    { id: "765510318", cells: ["FIN-7318", "Digital Wallet Item 2", "7/7/2026", "€10 418"], status: "pending" as const },
    { id: "765513889", cells: ["FIN-1889", "Digital Wallet Item 3", "22/2/2026", "€13 989"], status: "completed" as const },
    { id: "765517460", cells: ["FIN-5460", "Digital Wallet Item 4", "9/9/2026", "€17 560"], status: "warning" as const },
    { id: "765521031", cells: ["FIN-9031", "Digital Wallet Item 5", "24/4/2026", "€21 131"], status: "active" as const },
];
...
export default function FintechHubDigitalWalletPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Digital Wallet</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Digital Wallet</p>
                    </div>
                </div>
