...
/* ═══ FinTech Hub — Embedded Finance ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "2391", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "492", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2520", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "362145976", cells: ["FIN-4976", "Embedded Finance Item 1", "25/5/2026", "€46 076"], status: "active" as const },
    { id: "362149547", cells: ["FIN-8547", "Embedded Finance Item 2", "12/12/2026", "€49 647"], status: "pending" as const },
    { id: "362153118", cells: ["FIN-3118", "Embedded Finance Item 3", "27/7/2026", "€3218"], status: "completed" as const },
    { id: "362156689", cells: ["FIN-6689", "Embedded Finance Item 4", "14/2/2026", "€6789"], status: "warning" as const },
    { id: "362160260", cells: ["FIN-1260", "Embedded Finance Item 5", "1/9/2026", "€10 360"], status: "active" as const },
];
...
export default function FintechHubEmbeddedFinancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Embedded Finance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Embedded Finance</p>
                    </div>
                </div>
