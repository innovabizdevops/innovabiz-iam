...
/* ═══ FinTech Hub — Open Banking ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "2978", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "296", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "605", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1285250388", cells: ["FIN-6388", "Open Banking Item 1", "17/1/2026", "€488"], status: "active" as const },
    { id: "1285253959", cells: ["FIN-9959", "Open Banking Item 2", "4/8/2026", "€4059"], status: "pending" as const },
    { id: "1285257530", cells: ["FIN-4530", "Open Banking Item 3", "19/3/2026", "€7630"], status: "completed" as const },
    { id: "1285261101", cells: ["FIN-8101", "Open Banking Item 4", "6/10/2026", "€11 201"], status: "warning" as const },
    { id: "1285264672", cells: ["FIN-2672", "Open Banking Item 5", "21/5/2026", "€14 772"], status: "active" as const },
];
...
export default function FintechHubOpenBankingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Open Banking</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Open Banking</p>
                    </div>
                </div>
