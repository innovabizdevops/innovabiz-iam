...
/* ═══ FinTech Hub — Bnpl Engine ═══ */

const ACCENT = "#10b981";

const KPIS = [
    { label: "Total", value: "2281", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "154", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "424", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "940559510", cells: ["FIN-6510", "Bnpl Engine Item 1", "3/3/2026", "€9610"], status: "active" as const },
    { id: "940563081", cells: ["FIN-1081", "Bnpl Engine Item 2", "18/10/2026", "€13 181"], status: "pending" as const },
    { id: "940566652", cells: ["FIN-4652", "Bnpl Engine Item 3", "5/5/2026", "€16 752"], status: "completed" as const },
    { id: "940570223", cells: ["FIN-8223", "Bnpl Engine Item 4", "20/12/2026", "€20 323"], status: "warning" as const },
    { id: "940573794", cells: ["FIN-2794", "Bnpl Engine Item 5", "7/7/2026", "€23 894"], status: "active" as const },
];
...
export default function FintechHubBnplEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Bnpl Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">FinTech Hub • Bnpl Engine</p>
                    </div>
                </div>
