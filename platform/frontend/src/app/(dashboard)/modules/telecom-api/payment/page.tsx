...
const PAGE = "Payment";
const KPIS = [{"l":"Total Telecom Api","v":"8.459","t":"+0.2%","d":"up"},{"l":"Payment Ativos","v":"4.856","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"89","t":"+10.2%","d":"up"}];
const COLS = ["ID","Payment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Api #001","Telecom Api #002","2.269","5.156","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Api #002","Telecom Api #003","496","454","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Api #003","Telecom Api #004","2.299","3.375","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Api #004","Telecom Api #005","5.111","4.964","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Api #005","Telecom Api #001","9.045","2.670","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":431},{"label":"Mar","value":529},{"label":"Abr","value":647},{"label":"Mai","value":603},{"label":"Jun","value":490},{"label":"Jul","value":605},{"label":"Ago","value":796},{"label":"Set","value":787},{"label":"Out","value":700},{"label":"Nov","value":746},{"label":"Dez","value":476}];
const MX = 796;
