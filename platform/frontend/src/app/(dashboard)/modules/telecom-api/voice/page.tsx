...
const ACCENT = "#6366f1";
const MODULE = "Telecom API Platform";
const PAGE = "Voice API";
const KPIS = [{"l":"Total Telecom Api","v":"1.316","t":"-3.1%","d":"down"},{"l":"Voice API Ativos","v":"2.724","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"71.9%","t":"-5.9%","d":"down"},{"l":"Score Performance","v":"64","t":"-3.0%","d":"down"}];
const COLS = ["ID","Voice API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Api #001","Telecom Api #002","3.978","615","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Api #002","Telecom Api #003","8.324","4.126","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Api #003","Telecom Api #004","402","2.394","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Api #004","Telecom Api #005","3.490","5.907","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Api #005","Telecom Api #001","8.198","6.841","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":329},{"label":"Mar","value":451},{"label":"Abr","value":375},{"label":"Mai","value":324},{"label":"Jun","value":280},{"label":"Jul","value":627},{"label":"Ago","value":613},{"label":"Set","value":542},{"label":"Out","value":391},{"label":"Nov","value":270},{"label":"Dez","value":278}];
const MX = 627;
