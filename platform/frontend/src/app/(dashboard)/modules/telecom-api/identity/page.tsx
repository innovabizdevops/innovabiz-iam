...
const PAGE = "Identity";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.390","t":"+6.6%","d":"up"},{"l":"Sessões/Dia","v":"1823","t":"+9.2%","d":"up"},{"l":"MFA Adoção (%)","v":"65.3%","t":"+5.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.860","t":"+8.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","714","6.785","1.479","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","5.239","4.666","2.445","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.093","6.786","6.634","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.999","3.372","6.610","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","4.514","7.165","5.427","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":463},{"label":"Mar","value":783},{"label":"Abr","value":711},{"label":"Mai","value":735},{"label":"Jun","value":848},{"label":"Jul","value":753},{"label":"Ago","value":674},{"label":"Set","value":520},{"label":"Out","value":518},{"label":"Nov","value":510},{"label":"Dez","value":796}];
const MX = 848;
