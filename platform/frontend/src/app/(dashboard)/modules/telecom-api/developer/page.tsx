...
const KPIS = [{"l":"Total Telecom Api","v":"4.398","t":"+5.0%","d":"up"},{"l":"Developer Ativos","v":"679","t":"-5.4%","d":"down"},{"l":"Eficiência (%)","v":"90.6%","t":"+1.7%","d":"up"},{"l":"Score Performance","v":"83","t":"+5.9%","d":"up"}];
const COLS = ["ID","Developer","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Api #001","Telecom Api #002","3.078","5.864","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Api #002","Telecom Api #003","7.867","8.614","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Api #003","Telecom Api #004","400","248","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Api #004","Telecom Api #005","7.948","2.873","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Api #005","Telecom Api #001","4.189","5.543","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":606},{"label":"Mar","value":679},{"label":"Abr","value":523},{"label":"Mai","value":860},{"label":"Jun","value":638},{"label":"Jul","value":564},{"label":"Ago","value":536},{"label":"Set","value":567},{"label":"Out","value":766},{"label":"Nov","value":876},{"label":"Dez","value":528}];
const MX = 876;
