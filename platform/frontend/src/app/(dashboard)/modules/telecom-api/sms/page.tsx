...
const PAGE = "SMS API";
const KPIS = [{"l":"Total Telecom Api","v":"8.355","t":"+15.1%","d":"up"},{"l":"SMS API Ativos","v":"2.775","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"86","t":"-0.1%","d":"down"}];
const COLS = ["ID","SMS API","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Telecom Api #001","Telecom Api #002","503","7.518","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Telecom Api #002","Telecom Api #003","7.232","1.568","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Telecom Api #003","Telecom Api #004","8.128","3.174","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Telecom Api #004","Telecom Api #005","5.664","3.650","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Telecom Api #005","Telecom Api #001","1.606","512","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":622},{"label":"Mar","value":461},{"label":"Abr","value":411},{"label":"Mai","value":478},{"label":"Jun","value":557},{"label":"Jul","value":332},{"label":"Ago","value":414},{"label":"Set","value":439},{"label":"Out","value":383},{"label":"Nov","value":543},{"label":"Dez","value":582}];
const MX = 622;
