...
const PAGE = "Dispute";
const KPIS = [{"l":"Total Card Mgmt","v":"8.343","t":"+10.9%","d":"up"},{"l":"Dispute Ativos","v":"2.327","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"79.1%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.9%","d":"up"}];
const COLS = ["ID","Dispute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Card Mgmt #001","Card Mgmt #002","3.056","3.751","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Card Mgmt #002","Card Mgmt #003","8.683","2.541","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Card Mgmt #003","Card Mgmt #004","3.470","5.161","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Card Mgmt #004","Card Mgmt #005","7.083","6.844","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Card Mgmt #005","Card Mgmt #001","4.266","1.266","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":739},{"label":"Mar","value":1020},{"label":"Abr","value":990},{"label":"Mai","value":714},{"label":"Jun","value":649},{"label":"Jul","value":954},{"label":"Ago","value":747},{"label":"Set","value":663},{"label":"Out","value":926},{"label":"Nov","value":737},{"label":"Dez","value":901}];
const MX = 1020;
