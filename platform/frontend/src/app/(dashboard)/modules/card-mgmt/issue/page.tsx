...
const PAGE = "Card Issue";
const KPIS = [{"l":"Total Card Mgmt","v":"8.425","t":"+0.0%","d":"up"},{"l":"Card Issue Ativos","v":"2.398","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"-3.4%","d":"down"},{"l":"Score Performance","v":"87","t":"+16.2%","d":"up"}];
const COLS = ["ID","Card Issue","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Card Mgmt #001","Card Mgmt #002","4.227","7.523","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Card Mgmt #002","Card Mgmt #003","1.328","8.888","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Card Mgmt #003","Card Mgmt #004","5.011","441","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Card Mgmt #004","Card Mgmt #005","1.672","5.069","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Card Mgmt #005","Card Mgmt #001","7.742","4.549","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":532},{"label":"Mar","value":622},{"label":"Abr","value":637},{"label":"Mai","value":665},{"label":"Jun","value":731},{"label":"Jul","value":702},{"label":"Ago","value":561},{"label":"Set","value":810},{"label":"Out","value":532},{"label":"Nov","value":740},{"label":"Dez","value":910}];
const MX = 910;
