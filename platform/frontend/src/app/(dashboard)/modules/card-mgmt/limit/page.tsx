...
const PAGE = "Limit Mgmt";
const KPIS = [{"l":"Total Card Mgmt","v":"5.550","t":"+11.3%","d":"up"},{"l":"Limit Mgmt Ativos","v":"4.172","t":"+14.7%","d":"up"},{"l":"Eficiência (%)","v":"71.1%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.2%","d":"up"}];
const COLS = ["ID","Limit Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Card Mgmt #001","Card Mgmt #002","1.655","8.818","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Card Mgmt #002","Card Mgmt #003","6.564","3.731","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Card Mgmt #003","Card Mgmt #004","3.279","3.368","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Card Mgmt #004","Card Mgmt #005","3.201","5.941","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Card Mgmt #005","Card Mgmt #001","6.050","2.317","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":735},{"label":"Mar","value":612},{"label":"Abr","value":737},{"label":"Mai","value":467},{"label":"Jun","value":653},{"label":"Jul","value":510},{"label":"Ago","value":578},{"label":"Set","value":513},{"label":"Out","value":815},{"label":"Nov","value":591},{"label":"Dez","value":566}];
const MX = 815;
