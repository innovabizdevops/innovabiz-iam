...
const PAGE = "Rewards";
const KPIS = [{"l":"Total Card Mgmt","v":"5.459","t":"+2.8%","d":"up"},{"l":"Rewards Ativos","v":"7.892","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"68.3%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"70","t":"+16.6%","d":"up"}];
const COLS = ["ID","Rewards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Card Mgmt #001","Card Mgmt #002","7.128","6.945","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Card Mgmt #002","Card Mgmt #003","8.625","8.194","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Card Mgmt #003","Card Mgmt #004","1.678","8.810","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Card Mgmt #004","Card Mgmt #005","444","4.025","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Card Mgmt #005","Card Mgmt #001","8.158","4.978","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":708},{"label":"Mar","value":767},{"label":"Abr","value":604},{"label":"Mai","value":627},{"label":"Jun","value":548},{"label":"Jul","value":779},{"label":"Ago","value":726},{"label":"Set","value":595},{"label":"Out","value":463},{"label":"Nov","value":512},{"label":"Dez","value":655}];
const MX = 779;
