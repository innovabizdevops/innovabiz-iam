...
const ACCENT = "#7c3aed";
const MODULE = "Card Management";
const PAGE = "Auth Engine";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.729","t":"+15.5%","d":"up"},{"l":"Sessões/Dia","v":"321","t":"+7.3%","d":"up"},{"l":"MFA Adoção (%)","v":"74.9%","t":"+7.8%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.392","t":"+8.5%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.514","3.921","5.214","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","6.804","4.568","4.873","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","2.757","3.925","982","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.236","566","6.634","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.549","2.336","6.547","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":738},{"label":"Mar","value":756},{"label":"Abr","value":928},{"label":"Mai","value":707},{"label":"Jun","value":823},{"label":"Jul","value":850},{"label":"Ago","value":755},{"label":"Set","value":776},{"label":"Out","value":586},{"label":"Nov","value":916},{"label":"Dez","value":940}];
const MX = 940;
