...
export default function BeautyBrandPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Beauty Brand</h1><p className="text-sm text-muted-foreground">Beauty Brand • iBOS Enterprise</p></div>
