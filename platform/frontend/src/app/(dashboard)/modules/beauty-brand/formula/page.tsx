...
const ACCENT = "#6366f1";
const MODULE = "Beauty Brand";
const PAGE = "Formula";
const KPIS = [{"l":"Formulários Ativos","v":"4.886","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"3012","t":"+3.1%","d":"up"},{"l":"Documentos Gerados","v":"5.753","t":"+14.6%","d":"up"},{"l":"Templates","v":"4.623","t":"+3.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.942","2026-02-21","3.093","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.458","2026-03-25","7.584","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.784","2026-01-15","5.087","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.806","2026-02-02","8.845","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.125","2026-01-17","7.377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":294},{"label":"Fev","value":386},{"label":"Mar","value":457},{"label":"Abr","value":488},{"label":"Mai","value":288},{"label":"Jun","value":461},{"label":"Jul","value":498},{"label":"Ago","value":475},{"label":"Set","value":501},{"label":"Out","value":494},{"label":"Nov","value":369},{"label":"Dez","value":322}];
const MX = 501;
