...
const PAGE = "Case";
const KPIS = [{"l":"Total Service Cloud","v":"8.733","t":"+7.2%","d":"up"},{"l":"Case Ativos","v":"2.925","t":"+13.2%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"90","t":"-1.8%","d":"down"}];
const COLS = ["ID","Case","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Cloud #001","Service Cloud #002","4.501","5.814","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Service Cloud #002","Service Cloud #003","1.785","3.974","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Cloud #003","Service Cloud #004","8.939","3.370","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Service Cloud #004","Service Cloud #005","2.448","1.893","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Cloud #005","Service Cloud #001","2.794","8.853","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":609},{"label":"Mar","value":462},{"label":"Abr","value":587},{"label":"Mai","value":332},{"label":"Jun","value":616},{"label":"Jul","value":291},{"label":"Ago","value":335},{"label":"Set","value":273},{"label":"Out","value":241},{"label":"Nov","value":278},{"label":"Dez","value":430}];
const MX = 616;
