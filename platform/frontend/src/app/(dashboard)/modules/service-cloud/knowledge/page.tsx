...
const KPIS = [{"l":"Artigos Publicados","v":"2.253","t":"-5.5%","d":"down"},{"l":"Views/Semana","v":"2371","t":"-3.1%","d":"down"},{"l":"Feedback Útil (%)","v":"89.0%","t":"+3.2%","d":"up"},{"l":"Artigos Desatualizados","v":"4.673","t":"-0.8%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","3.748","80.6%","5.588","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","4.296","79.2%","1.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.503","92.7%","6.379","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.867","84.7%","8.266","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.537","95.4%","8.420","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":781},{"label":"Mar","value":736},{"label":"Abr","value":910},{"label":"Mai","value":743},{"label":"Jun","value":794},{"label":"Jul","value":593},{"label":"Ago","value":838},{"label":"Set","value":863},{"label":"Out","value":864},{"label":"Nov","value":857},{"label":"Dez","value":771}];
const MX = 910;
