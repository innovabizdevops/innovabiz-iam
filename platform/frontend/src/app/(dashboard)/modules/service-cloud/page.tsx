...
/* ═══ Service Cloud Deep — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "4772", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1609", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€347K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "329446972", cells: ["SER-2972", "Service Cloud Deep Item 1", "9/5/2026", "€47 072"], status: "active" as const },
    { id: "329450543", cells: ["SER-6543", "Service Cloud Deep Item 2", "24/12/2026", "€643"], status: "pending" as const },
    { id: "329454114", cells: ["SER-1114", "Service Cloud Deep Item 3", "11/7/2026", "€4214"], status: "completed" as const },
    { id: "329457685", cells: ["SER-4685", "Service Cloud Deep Item 4", "26/2/2026", "€7785"], status: "warning" as const },
    { id: "329461256", cells: ["SER-8256", "Service Cloud Deep Item 5", "13/9/2026", "€11 356"], status: "active" as const },
];
...
export default function ServiceCloudDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Service Cloud Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Service Cloud Deep</p>
                    </div>
                </div>
