...
const ACCENT = "#00a1e0";
const MODULE = "Service Cloud Deep";
const PAGE = "Chatbot";
const KPIS = [{"l":"Teams Ativos","v":"5.165","t":"+11.5%","d":"up"},{"l":"Reuniões/Semana","v":"569","t":"+5.3%","d":"up"},{"l":"Mensagens/Dia","v":"158","t":"+7.5%","d":"up"},{"l":"Ficheiros Partilhados","v":"7.607","t":"+4.6%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","779","3934","1.271","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","8.701","1999","6.796","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","1.178","2751","4.531","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.577","219","5.051","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.390","3431","6.267","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":749},{"label":"Mar","value":971},{"label":"Abr","value":1058},{"label":"Mai","value":706},{"label":"Jun","value":878},{"label":"Jul","value":704},{"label":"Ago","value":772},{"label":"Set","value":787},{"label":"Out","value":935},{"label":"Nov","value":880},{"label":"Dez","value":784}];
const MX = 1058;
