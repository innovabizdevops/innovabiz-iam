...
const PAGE = "Omni";
const KPIS = [{"l":"Total Service Cloud","v":"7.709","t":"+0.8%","d":"up"},{"l":"Omni Ativos","v":"5.136","t":"+4.3%","d":"up"},{"l":"Eficiência (%)","v":"73.3%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"65","t":"+6.0%","d":"up"}];
const COLS = ["ID","Omni","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Service Cloud #001","Service Cloud #002","6.718","8.308","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Service Cloud #002","Service Cloud #003","3.699","8.083","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Service Cloud #003","Service Cloud #004","4.812","8.409","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Service Cloud #004","Service Cloud #005","2.990","5.817","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Service Cloud #005","Service Cloud #001","2.631","2.456","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":552},{"label":"Mar","value":619},{"label":"Abr","value":706},{"label":"Mai","value":578},{"label":"Jun","value":822},{"label":"Jul","value":591},{"label":"Ago","value":792},{"label":"Set","value":624},{"label":"Out","value":816},{"label":"Nov","value":579},{"label":"Dez","value":698}];
const MX = 838;
