...
const PAGE = "Inbound";
const KPIS = [{"l":"Total Warehouse Mgmt","v":"8.858","t":"+9.2%","d":"up"},{"l":"Inbound Ativos","v":"7.521","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+17.7%","d":"up"}];
const COLS = ["ID","Inbound","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt #001","Warehouse Mgmt #002","8.410","3.554","2026-03-08","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt #002","Warehouse Mgmt #003","2.013","1.409","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt #003","Warehouse Mgmt #004","5.559","9.029","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt #004","Warehouse Mgmt #005","4.524","7.423","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt #005","Warehouse Mgmt #001","3.704","3.512","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":837},{"label":"Mar","value":783},{"label":"Abr","value":901},{"label":"Mai","value":976},{"label":"Jun","value":728},{"label":"Jul","value":967},{"label":"Ago","value":912},{"label":"Set","value":837},{"label":"Out","value":820},{"label":"Nov","value":912},{"label":"Dez","value":710}];
const MX = 976;
