...
const KPIS = [{"l":"Total Warehouse Mgmt","v":"102","t":"-0.3%","d":"down"},{"l":"Cycle Count Ativos","v":"3.229","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"88.0%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"92","t":"+7.1%","d":"up"}];
const COLS = ["ID","Cycle Count","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt #001","Warehouse Mgmt #002","8.072","7.868","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt #002","Warehouse Mgmt #003","3.877","4.291","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt #003","Warehouse Mgmt #004","2.132","600","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt #004","Warehouse Mgmt #005","6.697","6.352","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt #005","Warehouse Mgmt #001","6.365","7.907","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":510},{"label":"Mar","value":659},{"label":"Abr","value":877},{"label":"Mai","value":525},{"label":"Jun","value":663},{"label":"Jul","value":648},{"label":"Ago","value":788},{"label":"Set","value":773},{"label":"Out","value":574},{"label":"Nov","value":502},{"label":"Dez","value":595}];
const MX = 877;
