...
const PAGE = "Robot Picking";
const KPIS = [{"l":"Total Warehouse Mgmt","v":"1.456","t":"-5.6%","d":"down"},{"l":"Robot Picking Ativos","v":"8.011","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+7.7%","d":"up"},{"l":"Score Performance","v":"72","t":"-5.4%","d":"down"}];
const COLS = ["ID","Robot Picking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt #001","Warehouse Mgmt #002","4.757","1.650","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt #002","Warehouse Mgmt #003","8.628","4.460","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt #003","Warehouse Mgmt #004","1.503","1.281","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt #004","Warehouse Mgmt #005","937","4.601","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt #005","Warehouse Mgmt #001","1.450","4.197","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":662},{"label":"Mar","value":1014},{"label":"Abr","value":898},{"label":"Mai","value":969},{"label":"Jun","value":957},{"label":"Jul","value":749},{"label":"Ago","value":779},{"label":"Set","value":1014},{"label":"Out","value":859},{"label":"Nov","value":711},{"label":"Dez","value":891}];
const MX = 1014;
