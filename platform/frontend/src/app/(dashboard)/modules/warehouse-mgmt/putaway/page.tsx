...
const PAGE = "Put-Away";
const KPIS = [{"l":"Total Warehouse Mgmt","v":"5.598","t":"+12.2%","d":"up"},{"l":"Put Away Ativos","v":"3.143","t":"+4.2%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"58","t":"+5.1%","d":"up"}];
const COLS = ["ID","Put Away","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt #001","Warehouse Mgmt #002","2.047","8.514","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt #002","Warehouse Mgmt #003","8.512","4.928","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt #003","Warehouse Mgmt #004","1.771","3.585","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt #004","Warehouse Mgmt #005","7.980","6.331","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt #005","Warehouse Mgmt #001","1.323","5.144","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":457},{"label":"Mar","value":751},{"label":"Abr","value":773},{"label":"Mai","value":713},{"label":"Jun","value":692},{"label":"Jul","value":585},{"label":"Ago","value":755},{"label":"Set","value":794},{"label":"Out","value":597},{"label":"Nov","value":553},{"label":"Dez","value":562}];
const MX = 794;
