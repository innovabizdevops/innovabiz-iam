...
const ACCENT = "#78350f";
const MODULE = "Warehouse Management";
const PAGE = "Slot Optimization";
const KPIS = [{"l":"Total Warehouse Mgmt","v":"3.999","t":"+16.0%","d":"up"},{"l":"Slot Optimization Ativos","v":"9.075","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"77","t":"+11.2%","d":"up"}];
const COLS = ["ID","Slot Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Warehouse Mgmt #001","Warehouse Mgmt #002","9.032","8.550","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Warehouse Mgmt #002","Warehouse Mgmt #003","2.608","8.837","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Warehouse Mgmt #003","Warehouse Mgmt #004","5.051","3.323","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Warehouse Mgmt #004","Warehouse Mgmt #005","7.360","6.448","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Warehouse Mgmt #005","Warehouse Mgmt #001","4.372","1.256","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":658},{"label":"Mar","value":746},{"label":"Abr","value":640},{"label":"Mai","value":721},{"label":"Jun","value":628},{"label":"Jul","value":707},{"label":"Ago","value":729},{"label":"Set","value":618},{"label":"Out","value":938},{"label":"Nov","value":667},{"label":"Dez","value":903}];
const MX = 938;
