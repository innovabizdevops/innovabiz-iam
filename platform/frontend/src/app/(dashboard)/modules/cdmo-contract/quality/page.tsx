...
const PAGE = "Quality Agree";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.160","t":"+13.3%","d":"up"},{"l":"NC Abertas","v":"5.477","t":"+17.6%","d":"up"},{"l":"Conformidade (%)","v":"80.4%","t":"-0.2%","d":"down"},{"l":"CAPAs Pendentes","v":"8.570","t":"+11.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.104","98.6%","7.741","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.397","83.7%","5.428","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.465","98.7%","3.668","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.657","84.8%","7.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.374","71.7%","6.651","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":821},{"label":"Mar","value":739},{"label":"Abr","value":582},{"label":"Mai","value":651},{"label":"Jun","value":767},{"label":"Jul","value":538},{"label":"Ago","value":741},{"label":"Set","value":529},{"label":"Out","value":583},{"label":"Nov","value":671},{"label":"Dez","value":541}];
const MX = 877;
