...
export default function CdmoContractPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Cdmo Contract</h1><p className="text-sm text-muted-foreground">Cdmo Contract • iBOS Enterprise</p></div>
