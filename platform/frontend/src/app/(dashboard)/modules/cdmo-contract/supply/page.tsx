...
const PAGE = "Supply Plan";
const KPIS = [{"l":"Contratos Ativos","v":"5.233","t":"+14.3%","d":"up"},{"l":"Valor Total (€M)","v":"€16.0M","t":"+5.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.963","t":"+17.4%","d":"up"},{"l":"Obrigações Pendentes","v":"7.121","t":"+16.3%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 24941.94","2026-03-21","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 40792.45","2026-03-02","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 29647.30","2026-03-17","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 40522.18","2026-03-24","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 25150.54","2026-03-06","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1047},{"label":"Fev","value":1044},{"label":"Mar","value":1056},{"label":"Abr","value":865},{"label":"Mai","value":972},{"label":"Jun","value":694},{"label":"Jul","value":1058},{"label":"Ago","value":1061},{"label":"Set","value":742},{"label":"Out","value":865},{"label":"Nov","value":813},{"label":"Dez","value":747}];
const MX = 1061;
