...
const PAGE = "Batch Record";
const KPIS = [{"l":"Contratos Ativos","v":"2.186","t":"+5.1%","d":"up"},{"l":"Valor Total (€M)","v":"€9.5M","t":"-3.5%","d":"down"},{"l":"Renovações Próx. 30d","v":"5.538","t":"+10.0%","d":"up"},{"l":"Obrigações Pendentes","v":"1.814","t":"-4.5%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 32619.06","2026-01-27","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 26004.07","2026-02-14","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 20214.35","2026-03-02","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 47367.43","2026-01-01","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 11859.42","2026-03-09","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":499},{"label":"Mar","value":295},{"label":"Abr","value":653},{"label":"Mai","value":573},{"label":"Jun","value":626},{"label":"Jul","value":510},{"label":"Ago","value":424},{"label":"Set","value":637},{"label":"Out","value":510},{"label":"Nov","value":268},{"label":"Dez","value":466}];
const MX = 653;
