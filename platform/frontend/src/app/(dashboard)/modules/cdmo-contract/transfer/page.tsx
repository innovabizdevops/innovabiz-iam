...
const ACCENT = "#ec4899";
const MODULE = "CDMO Contract Mgmt";
const PAGE = "Tech Transfer";
const KPIS = [{"l":"Contratos Ativos","v":"8.327","t":"+14.5%","d":"up"},{"l":"Valor Total (€M)","v":"€2.9M","t":"+10.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.313","t":"+10.8%","d":"up"},{"l":"Obrigações Pendentes","v":"5.776","t":"-5.4%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 33919.77","2026-01-15","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 39810.16","2026-03-04","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 20848.89","2026-01-13","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 7541.69","2026-02-17","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 10717.22","2026-01-19","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":645},{"label":"Mar","value":1018},{"label":"Abr","value":1009},{"label":"Mai","value":1016},{"label":"Jun","value":710},{"label":"Jul","value":762},{"label":"Ago","value":991},{"label":"Set","value":957},{"label":"Out","value":1012},{"label":"Nov","value":848},{"label":"Dez","value":902}];
const MX = 1018;
