...
const PAGE = "Scale-Up";
const KPIS = [{"l":"Contratos Ativos","v":"4.365","t":"+12.1%","d":"up"},{"l":"Valor Total (€M)","v":"€9.2M","t":"+6.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"2.720","t":"+5.6%","d":"up"},{"l":"Obrigações Pendentes","v":"2.330","t":"-4.3%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 32176.70","2026-03-23","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 42367.68","2026-02-20","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 25017.52","2026-01-14","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 9573.21","2026-02-04","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 8206.14","2026-02-21","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":953},{"label":"Mar","value":983},{"label":"Abr","value":727},{"label":"Mai","value":651},{"label":"Jun","value":726},{"label":"Jul","value":888},{"label":"Ago","value":821},{"label":"Set","value":927},{"label":"Out","value":739},{"label":"Nov","value":866},{"label":"Dez","value":674}];
const MX = 983;
