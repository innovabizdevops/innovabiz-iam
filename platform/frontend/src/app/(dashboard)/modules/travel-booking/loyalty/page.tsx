...
const PAGE = "Loyalty Link";
const KPIS = [{"l":"Quartos Ocupados","v":"790","t":"-1.5%","d":"down"},{"l":"RevPAR (€)","v":"€23353","t":"+14.7%","d":"up"},{"l":"Ocupação (%)","v":"85.8%","t":"-3.6%","d":"down"},{"l":"Guest Satisfaction","v":"982","t":"+11.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.728","2026-03-09","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","9.076","2026-02-15","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.034","2026-02-01","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.830","2026-03-01","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.831","2026-02-05","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":278},{"label":"Fev","value":527},{"label":"Mar","value":460},{"label":"Abr","value":545},{"label":"Mai","value":500},{"label":"Jun","value":444},{"label":"Jul","value":515},{"label":"Ago","value":450},{"label":"Set","value":396},{"label":"Out","value":561},{"label":"Nov","value":459},{"label":"Dez","value":614}];
const MX = 614;
