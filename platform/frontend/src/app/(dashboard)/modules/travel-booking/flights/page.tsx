...
const PAGE = "Flight Search";
const KPIS = [{"l":"Quartos Ocupados","v":"6.878","t":"+3.9%","d":"up"},{"l":"RevPAR (€)","v":"€46136","t":"+16.9%","d":"up"},{"l":"Ocupação (%)","v":"79.1%","t":"-0.5%","d":"down"},{"l":"Guest Satisfaction","v":"7.052","t":"+15.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.803","2026-02-28","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.603","2026-02-21","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.800","2026-02-18","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.291","2026-02-28","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.537","2026-02-10","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":946},{"label":"Mar","value":735},{"label":"Abr","value":947},{"label":"Mai","value":698},{"label":"Jun","value":751},{"label":"Jul","value":660},{"label":"Ago","value":907},{"label":"Set","value":983},{"label":"Out","value":943},{"label":"Nov","value":932},{"label":"Dez","value":673}];
const MX = 983;
