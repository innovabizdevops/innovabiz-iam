...
const PAGE = "Package Build";
const KPIS = [{"l":"Quartos Ocupados","v":"4.426","t":"+2.1%","d":"up"},{"l":"RevPAR (€)","v":"€17631","t":"+6.2%","d":"up"},{"l":"Ocupação (%)","v":"84.6%","t":"+10.4%","d":"up"},{"l":"Guest Satisfaction","v":"4.374","t":"+5.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","512","2026-01-25","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.874","2026-03-27","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.963","2026-02-20","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.752","2026-01-07","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.520","2026-02-12","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":817},{"label":"Mar","value":979},{"label":"Abr","value":662},{"label":"Mai","value":813},{"label":"Jun","value":800},{"label":"Jul","value":890},{"label":"Ago","value":792},{"label":"Set","value":794},{"label":"Out","value":756},{"label":"Nov","value":967},{"label":"Dez","value":666}];
const MX = 979;
