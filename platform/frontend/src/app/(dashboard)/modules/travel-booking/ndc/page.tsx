...
const ACCENT = "#1e40af";
const MODULE = "Travel Booking";
const PAGE = "NDC Connect";
const KPIS = [{"l":"Quartos Ocupados","v":"5.133","t":"+9.8%","d":"up"},{"l":"RevPAR (€)","v":"€89491","t":"+17.0%","d":"up"},{"l":"Ocupação (%)","v":"82.5%","t":"+15.0%","d":"up"},{"l":"Guest Satisfaction","v":"147","t":"+5.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.211","2026-02-05","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.464","2026-03-26","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","9.062","2026-01-06","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.851","2026-01-08","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.841","2026-02-14","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":512},{"label":"Mar","value":377},{"label":"Abr","value":553},{"label":"Mai","value":743},{"label":"Jun","value":583},{"label":"Jul","value":383},{"label":"Ago","value":747},{"label":"Set","value":674},{"label":"Out","value":667},{"label":"Nov","value":546},{"label":"Dez","value":398}];
const MX = 747;
