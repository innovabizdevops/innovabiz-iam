...
/* ═══ Flexible Packaging — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3426", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2819", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€211K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "658313726", cells: ["FLE-9726", "Flexible Packaging Item 1", "15/3/2026", "€13 826"], status: "active" as const },
    { id: "658317297", cells: ["FLE-4297", "Flexible Packaging Item 2", "2/10/2026", "€17 397"], status: "pending" as const },
    { id: "658320868", cells: ["FLE-7868", "Flexible Packaging Item 3", "17/5/2026", "€20 968"], status: "completed" as const },
    { id: "658324439", cells: ["FLE-2439", "Flexible Packaging Item 4", "4/12/2026", "€24 539"], status: "warning" as const },
    { id: "658328010", cells: ["FLE-6010", "Flexible Packaging Item 5", "19/7/2026", "€28 110"], status: "active" as const },
];
...
export default function FlexiblePackagingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Flexible Packaging</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Flexible Packaging</p>
                    </div>
                </div>
