...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.214","t":"+2.1%","d":"up"},{"l":"NC Abertas","v":"6.718","t":"+1.9%","d":"up"},{"l":"Conformidade (%)","v":"88.1%","t":"+10.5%","d":"up"},{"l":"CAPAs Pendentes","v":"520","t":"+3.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.080","95.9%","1.213","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.272","73.3%","3.080","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.317","98.4%","7.820","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.584","72.8%","2.527","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","945","91.7%","3.968","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":878},{"label":"Mar","value":590},{"label":"Abr","value":622},{"label":"Mai","value":573},{"label":"Jun","value":608},{"label":"Jul","value":797},{"label":"Ago","value":809},{"label":"Set","value":621},{"label":"Out","value":836},{"label":"Nov","value":661},{"label":"Dez","value":967}];
const MX = 967;
