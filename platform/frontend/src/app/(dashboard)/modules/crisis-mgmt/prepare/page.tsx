...
const PAGE = "Prepare";
const KPIS = [{"l":"Total Crisis Mgmt","v":"6.739","t":"+9.8%","d":"up"},{"l":"Prepare Ativos","v":"4.619","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"78.0%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"64","t":"-1.9%","d":"down"}];
const COLS = ["ID","Prepare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crisis Mgmt #001","Crisis Mgmt #002","6.231","4.782","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Crisis Mgmt #002","Crisis Mgmt #003","5.989","2.630","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Crisis Mgmt #003","Crisis Mgmt #004","8.698","7.547","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Crisis Mgmt #004","Crisis Mgmt #005","1.380","7.862","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crisis Mgmt #005","Crisis Mgmt #001","5.955","7.071","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":481},{"label":"Mar","value":360},{"label":"Abr","value":610},{"label":"Mai","value":394},{"label":"Jun","value":501},{"label":"Jul","value":440},{"label":"Ago","value":585},{"label":"Set","value":542},{"label":"Out","value":394},{"label":"Nov","value":489},{"label":"Dez","value":655}];
const MX = 655;
