...
const PAGE = "Respond";
const KPIS = [{"l":"Total Crisis Mgmt","v":"7.995","t":"+0.6%","d":"up"},{"l":"Respond Ativos","v":"8.396","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"78.1%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"94","t":"+12.8%","d":"up"}];
const COLS = ["ID","Respond","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crisis Mgmt #001","Crisis Mgmt #002","4.595","8.019","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Crisis Mgmt #002","Crisis Mgmt #003","1.125","8.285","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Crisis Mgmt #003","Crisis Mgmt #004","7.316","1.324","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Crisis Mgmt #004","Crisis Mgmt #005","4.556","5.549","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crisis Mgmt #005","Crisis Mgmt #001","6.251","7.039","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":458},{"label":"Fev","value":724},{"label":"Mar","value":679},{"label":"Abr","value":531},{"label":"Mai","value":493},{"label":"Jun","value":536},{"label":"Jul","value":785},{"label":"Ago","value":766},{"label":"Set","value":584},{"label":"Out","value":523},{"label":"Nov","value":565},{"label":"Dez","value":642}];
const MX = 785;
