...
const KPIS = [
    { label: "Total Registos", value: "8282", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3208", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "306690382", cells: ["CRI-7382", "Crisis Management Item 1", "27/11/2026", "€40 482"], status: "active" as const },
    { id: "306693953", cells: ["CRI-1953", "Crisis Management Item 2", "14/6/2026", "€44 053"], status: "pending" as const },
    { id: "306697524", cells: ["CRI-5524", "Crisis Management Item 3", "1/1/2026", "€47 624"], status: "completed" as const },
    { id: "306701095", cells: ["CRI-9095", "Crisis Management Item 4", "16/8/2026", "€1195"], status: "warning" as const },
    { id: "306704666", cells: ["CRI-3666", "Crisis Management Item 5", "3/3/2026", "€4766"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crisis Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crisis Management</p>
                    </div>
                </div>
