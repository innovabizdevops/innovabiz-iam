...
const ACCENT = "#059669";
const MODULE = "Crisis Management";
const PAGE = "Communicate";
const KPIS = [{"l":"Total Crisis Mgmt","v":"3.190","t":"+7.6%","d":"up"},{"l":"Communicate Ativos","v":"6.068","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"86.7%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"65","t":"+4.2%","d":"up"}];
const COLS = ["ID","Communicate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crisis Mgmt #001","Crisis Mgmt #002","1.907","2.416","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Crisis Mgmt #002","Crisis Mgmt #003","1.794","4.956","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Crisis Mgmt #003","Crisis Mgmt #004","1.016","7.553","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Crisis Mgmt #004","Crisis Mgmt #005","4.438","5.825","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crisis Mgmt #005","Crisis Mgmt #001","5.711","5.555","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":564},{"label":"Mar","value":681},{"label":"Abr","value":799},{"label":"Mai","value":857},{"label":"Jun","value":824},{"label":"Jul","value":543},{"label":"Ago","value":881},{"label":"Set","value":790},{"label":"Out","value":507},{"label":"Nov","value":681},{"label":"Dez","value":528}];
const MX = 881;
