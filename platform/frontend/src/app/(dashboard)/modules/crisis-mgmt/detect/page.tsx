...
const PAGE = "Detect";
const KPIS = [{"l":"Total Crisis Mgmt","v":"6.552","t":"+3.9%","d":"up"},{"l":"Detect Ativos","v":"5.967","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"73.6%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"64","t":"+0.6%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crisis Mgmt #001","Crisis Mgmt #002","6.038","4.614","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Crisis Mgmt #002","Crisis Mgmt #003","3.119","834","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Crisis Mgmt #003","Crisis Mgmt #004","1.336","8.303","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Crisis Mgmt #004","Crisis Mgmt #005","1.892","862","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crisis Mgmt #005","Crisis Mgmt #001","3.155","1.740","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":765},{"label":"Mar","value":503},{"label":"Abr","value":688},{"label":"Mai","value":685},{"label":"Jun","value":582},{"label":"Jul","value":753},{"label":"Ago","value":824},{"label":"Set","value":659},{"label":"Out","value":600},{"label":"Nov","value":596},{"label":"Dez","value":729}];
const MX = 824;
