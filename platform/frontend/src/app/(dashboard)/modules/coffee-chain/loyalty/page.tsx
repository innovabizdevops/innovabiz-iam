...
const PAGE = "Loyalty";
const KPIS = [{"l":"Total Coffee Chain","v":"858","t":"-1.1%","d":"down"},{"l":"Loyalty Ativos","v":"3.079","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"78","t":"+5.9%","d":"up"}];
const COLS = ["ID","Loyalty","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Coffee Chain #001","Coffee Chain #002","8.290","2.353","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Coffee Chain #002","Coffee Chain #003","943","7.769","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Coffee Chain #003","Coffee Chain #004","556","5.031","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Coffee Chain #004","Coffee Chain #005","7.729","5.197","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Coffee Chain #005","Coffee Chain #001","5.857","4.188","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":379},{"label":"Mar","value":397},{"label":"Abr","value":348},{"label":"Mai","value":445},{"label":"Jun","value":629},{"label":"Jul","value":436},{"label":"Ago","value":412},{"label":"Set","value":411},{"label":"Out","value":429},{"label":"Nov","value":609},{"label":"Dez","value":539}];
const MX = 629;
