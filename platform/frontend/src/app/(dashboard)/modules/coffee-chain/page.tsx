...
/* ═══ Coffee Chain Mgmt — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "3197", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3438", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€460K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "314585497", cells: ["COF-9497", "Coffee Chain Mgmt Item 1", "10/2/2026", "€35 597"], status: "active" as const },
    { id: "314589068", cells: ["COF-4068", "Coffee Chain Mgmt Item 2", "25/9/2026", "€39 168"], status: "pending" as const },
    { id: "314592639", cells: ["COF-7639", "Coffee Chain Mgmt Item 3", "12/4/2026", "€42 739"], status: "completed" as const },
    { id: "314596210", cells: ["COF-2210", "Coffee Chain Mgmt Item 4", "27/11/2026", "€46 310"], status: "warning" as const },
    { id: "314599781", cells: ["COF-5781", "Coffee Chain Mgmt Item 5", "14/6/2026", "€49 881"], status: "active" as const },
];
...
export default function CoffeeChainMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Coffee Chain Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Coffee Chain Mgmt</p>
                    </div>
                </div>
