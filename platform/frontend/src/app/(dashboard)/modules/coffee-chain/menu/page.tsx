...
const ACCENT = "#92400e";
const MODULE = "Coffee Chain Mgmt";
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"7.934","t":"+15.0%","d":"up"},{"l":"RevPAR (€)","v":"€47750","t":"-5.9%","d":"down"},{"l":"Ocupação (%)","v":"69.8%","t":"+6.1%","d":"up"},{"l":"Guest Satisfaction","v":"6.332","t":"-2.2%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.601","2026-01-09","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.548","2026-01-12","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","3.895","2026-01-04","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.044","2026-03-05","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.936","2026-03-16","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":854},{"label":"Mar","value":944},{"label":"Abr","value":806},{"label":"Mai","value":823},{"label":"Jun","value":673},{"label":"Jul","value":975},{"label":"Ago","value":786},{"label":"Set","value":905},{"label":"Out","value":785},{"label":"Nov","value":669},{"label":"Dez","value":884}];
const MX = 975;
