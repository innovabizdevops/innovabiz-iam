...
export default function DcPowerPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Dc Power</h1><p className="text-sm text-muted-foreground">Dc Power • iBOS Enterprise</p></div>
