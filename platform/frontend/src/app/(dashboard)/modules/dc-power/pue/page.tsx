...
const ACCENT = "#dc2626";
const MODULE = "DC Power Management";
const PAGE = "PUE Track";
const KPIS = [{"l":"Total Dc Power","v":"8.900","t":"+11.8%","d":"up"},{"l":"PUE Track Ativos","v":"2.244","t":"+1.3%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"87","t":"+13.1%","d":"up"}];
const COLS = ["ID","PUE Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Power #001","Dc Power #002","8.038","3.743","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Power #002","Dc Power #003","5.441","9.009","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Power #003","Dc Power #004","2.280","2.698","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Power #004","Dc Power #005","7.516","8.507","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Power #005","Dc Power #001","5.809","2.219","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":688},{"label":"Mar","value":523},{"label":"Abr","value":534},{"label":"Mai","value":764},{"label":"Jun","value":543},{"label":"Jul","value":598},{"label":"Ago","value":762},{"label":"Set","value":820},{"label":"Out","value":638},{"label":"Nov","value":850},{"label":"Dez","value":819}];
const MX = 850;
