...
const ACCENT = "#b45309";
const MODULE = "Tanker Operations";
const PAGE = "MARPOL";
const KPIS = [{"l":"Total Tanker Ops","v":"6.438","t":"+0.5%","d":"up"},{"l":"MARPOL Ativos","v":"1.563","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+7.4%","d":"up"},{"l":"Score Performance","v":"67","t":"-5.8%","d":"down"}];
const COLS = ["ID","MARPOL","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tanker Ops #001","Tanker Ops #002","648","5.102","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Tanker Ops #002","Tanker Ops #003","7.718","8.329","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Tanker Ops #003","Tanker Ops #004","8.903","6.453","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Tanker Ops #004","Tanker Ops #005","3.343","8.338","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tanker Ops #005","Tanker Ops #001","2.958","2.216","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":751},{"label":"Mar","value":849},{"label":"Abr","value":495},{"label":"Mai","value":751},{"label":"Jun","value":737},{"label":"Jul","value":584},{"label":"Ago","value":572},{"label":"Set","value":724},{"label":"Out","value":672},{"label":"Nov","value":611},{"label":"Dez","value":681}];
const MX = 849;
