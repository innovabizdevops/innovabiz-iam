...
const PAGE = "Loading Plan";
const KPIS = [{"l":"Total Tanker Ops","v":"7.624","t":"+10.3%","d":"up"},{"l":"Loading Plan Ativos","v":"4.743","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"75.5%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"75","t":"+6.6%","d":"up"}];
const COLS = ["ID","Loading Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tanker Ops #001","Tanker Ops #002","4.665","5.836","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Tanker Ops #002","Tanker Ops #003","8.673","5.757","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Tanker Ops #003","Tanker Ops #004","7.004","623","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Tanker Ops #004","Tanker Ops #005","395","8.337","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tanker Ops #005","Tanker Ops #001","590","8.887","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":361},{"label":"Mar","value":381},{"label":"Abr","value":412},{"label":"Mai","value":493},{"label":"Jun","value":476},{"label":"Jul","value":642},{"label":"Ago","value":388},{"label":"Set","value":456},{"label":"Out","value":439},{"label":"Nov","value":536},{"label":"Dez","value":441}];
const MX = 642;
