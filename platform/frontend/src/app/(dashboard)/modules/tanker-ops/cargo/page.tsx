...
const PAGE = "Cargo Calc";
const KPIS = [{"l":"Total Tanker Ops","v":"8.036","t":"+6.4%","d":"up"},{"l":"Cargo Calc Ativos","v":"6.475","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"56","t":"+16.3%","d":"up"}];
const COLS = ["ID","Cargo Calc","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tanker Ops #001","Tanker Ops #002","6.805","705","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["Tanker Ops #002","Tanker Ops #003","3.896","4.167","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Tanker Ops #003","Tanker Ops #004","2.612","8.950","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Tanker Ops #004","Tanker Ops #005","6.513","5.428","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tanker Ops #005","Tanker Ops #001","2.283","4.861","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":680},{"label":"Mar","value":653},{"label":"Abr","value":512},{"label":"Mai","value":603},{"label":"Jun","value":711},{"label":"Jul","value":728},{"label":"Ago","value":450},{"label":"Set","value":473},{"label":"Out","value":683},{"label":"Nov","value":724},{"label":"Dez","value":426}];
const MX = 728;
