...
const PAGE = "COW/IGS";
const KPIS = [{"l":"Total Tanker Ops","v":"2.144","t":"+1.2%","d":"up"},{"l":"COW/IGS Ativos","v":"4.432","t":"+6.5%","d":"up"},{"l":"Eficiência (%)","v":"73.9%","t":"+0.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+14.0%","d":"up"}];
const COLS = ["ID","COW/IGS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tanker Ops #001","Tanker Ops #002","4.472","173","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Tanker Ops #002","Tanker Ops #003","6.468","4.699","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Tanker Ops #003","Tanker Ops #004","306","6.028","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Tanker Ops #004","Tanker Ops #005","288","2.690","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tanker Ops #005","Tanker Ops #001","7.927","1.824","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":576},{"label":"Mar","value":766},{"label":"Abr","value":720},{"label":"Mai","value":772},{"label":"Jun","value":443},{"label":"Jul","value":765},{"label":"Ago","value":799},{"label":"Set","value":547},{"label":"Out","value":554},{"label":"Nov","value":623},{"label":"Dez","value":786}];
const MX = 807;
