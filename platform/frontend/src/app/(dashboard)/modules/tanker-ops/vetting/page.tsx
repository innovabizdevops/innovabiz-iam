...
const PAGE = "Vetting";
const KPIS = [{"l":"Total Tanker Ops","v":"7.274","t":"+11.3%","d":"up"},{"l":"Vetting Ativos","v":"8.883","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"75.4%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"77","t":"-5.7%","d":"down"}];
const COLS = ["ID","Vetting","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tanker Ops #001","Tanker Ops #002","2.410","2.744","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Tanker Ops #002","Tanker Ops #003","2.585","7.994","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Tanker Ops #003","Tanker Ops #004","6.910","3.015","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Tanker Ops #004","Tanker Ops #005","429","2.818","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tanker Ops #005","Tanker Ops #001","8.511","3.267","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":758},{"label":"Mar","value":402},{"label":"Abr","value":779},{"label":"Mai","value":577},{"label":"Jun","value":700},{"label":"Jul","value":729},{"label":"Ago","value":572},{"label":"Set","value":604},{"label":"Out","value":776},{"label":"Nov","value":416},{"label":"Dez","value":628}];
const MX = 779;
