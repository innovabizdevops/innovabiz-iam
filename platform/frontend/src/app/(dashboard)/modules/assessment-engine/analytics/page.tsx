...
const KPIS = [{"l":"Dashboards Ativos","v":"8.469","t":"+17.1%","d":"up"},{"l":"Queries/Dia","v":"3902","t":"-0.5%","d":"down"},{"l":"Dados Processados (GB)","v":"4.080","t":"+3.4%","d":"up"},{"l":"Utilizadores Analytics","v":"6.299","t":"+15.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2900","2026-02-06","9.083","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1883","2026-02-21","8.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","550","2026-02-10","9.083","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","855","2026-03-17","3.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3817","2026-02-19","6.139","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":713},{"label":"Mar","value":721},{"label":"Abr","value":965},{"label":"Mai","value":915},{"label":"Jun","value":590},{"label":"Jul","value":708},{"label":"Ago","value":943},{"label":"Set","value":651},{"label":"Out","value":614},{"label":"Nov","value":591},{"label":"Dez","value":570}];
const MX = 965;
