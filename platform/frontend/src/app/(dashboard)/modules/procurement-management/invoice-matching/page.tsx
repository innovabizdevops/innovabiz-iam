...
const PAGE = "Invoice Matching";
const KPIS = [{"l":"Projetos Melhoria","v":"3.224","t":"+17.3%","d":"up"},{"l":"Savings (€)","v":"€76840","t":"+7.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"75.1%","t":"-1.3%","d":"down"},{"l":"Ciclos PDCA","v":"4.474","t":"+13.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.714","€ 30824.94","2.833","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.162","€ 23128.59","2.871","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.229","€ 37978.99","3.669","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.413","€ 9298.90","8.774","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.352","€ 30329.83","4.342","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":501},{"label":"Fev","value":548},{"label":"Mar","value":729},{"label":"Abr","value":708},{"label":"Mai","value":789},{"label":"Jun","value":569},{"label":"Jul","value":588},{"label":"Ago","value":655},{"label":"Set","value":474},{"label":"Out","value":605},{"label":"Nov","value":551},{"label":"Dez","value":440}];
const MX = 789;
