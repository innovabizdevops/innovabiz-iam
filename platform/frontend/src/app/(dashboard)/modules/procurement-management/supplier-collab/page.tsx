...
const ACCENT = "#6366f1";
const MODULE = "Procurement Management";
const PAGE = "Supplier Collaboration";
const KPIS = [{"l":"Projetos Melhoria","v":"1.330","t":"+2.6%","d":"up"},{"l":"Savings (€)","v":"€14044","t":"-0.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"74.4%","t":"+2.3%","d":"up"},{"l":"Ciclos PDCA","v":"6.163","t":"-3.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.958","€ 23274.74","6.002","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.319","€ 42054.13","238","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.442","€ 9083.80","4.160","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.883","€ 32879.78","1.045","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.978","€ 27857.10","1.984","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":306},{"label":"Fev","value":649},{"label":"Mar","value":526},{"label":"Abr","value":352},{"label":"Mai","value":498},{"label":"Jun","value":393},{"label":"Jul","value":515},{"label":"Ago","value":314},{"label":"Set","value":489},{"label":"Out","value":618},{"label":"Nov","value":611},{"label":"Dez","value":685}];
const MX = 685;
...
export default function SupplierCollabPage() {
    return (
