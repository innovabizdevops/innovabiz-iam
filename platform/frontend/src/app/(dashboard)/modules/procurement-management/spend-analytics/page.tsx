...
const KPIS = [{"l":"Dashboards Ativos","v":"4.301","t":"+2.2%","d":"up"},{"l":"Queries/Dia","v":"112","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.540","t":"-5.3%","d":"down"},{"l":"Utilizadores Analytics","v":"9.059","t":"+0.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1395","2026-01-19","7.242","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1950","2026-03-15","283","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","676","2026-02-15","4.880","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1832","2026-02-25","7.608","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1370","2026-02-11","3.229","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":930},{"label":"Mar","value":713},{"label":"Abr","value":860},{"label":"Mai","value":861},{"label":"Jun","value":827},{"label":"Jul","value":949},{"label":"Ago","value":803},{"label":"Set","value":829},{"label":"Out","value":771},{"label":"Nov","value":864},{"label":"Dez","value":716}];
const MX = 949;
