...
const PAGE = "Purchase Order Form";
const KPIS = [{"l":"Formulários Ativos","v":"7.244","t":"+1.9%","d":"up"},{"l":"Submissões/Dia","v":"2711","t":"-3.8%","d":"down"},{"l":"Documentos Gerados","v":"6.573","t":"+16.6%","d":"up"},{"l":"Templates","v":"1.001","t":"+11.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.046","2026-01-12","513","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.526","2026-01-07","4.141","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.367","2026-03-24","480","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.309","2026-01-23","5.904","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.151","2026-01-25","8.709","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":682},{"label":"Mar","value":705},{"label":"Abr","value":338},{"label":"Mai","value":354},{"label":"Jun","value":709},{"label":"Jul","value":594},{"label":"Ago","value":517},{"label":"Set","value":541},{"label":"Out","value":573},{"label":"Nov","value":465},{"label":"Dez","value":343}];
const MX = 709;
