...
const PAGE = "Sourcing &amp; Suppliers";
const KPIS = [{"l":"Projetos Melhoria","v":"4.462","t":"+12.9%","d":"up"},{"l":"Savings (€)","v":"€85195","t":"+5.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"81.4%","t":"+11.2%","d":"up"},{"l":"Ciclos PDCA","v":"3.720","t":"+5.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.543","€ 258.41","2.144","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.523","€ 21549.11","1.599","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.628","€ 32376.77","8.304","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.254","€ 40219.52","3.572","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","650","€ 2828.79","8.381","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":293},{"label":"Mar","value":535},{"label":"Abr","value":373},{"label":"Mai","value":643},{"label":"Jun","value":383},{"label":"Jul","value":446},{"label":"Ago","value":582},{"label":"Set","value":503},{"label":"Out","value":380},{"label":"Nov","value":557},{"label":"Dez","value":331}];
const MX = 643;
