...
const PAGE = "Sourcing";
const KPIS = [{"l":"Projetos Melhoria","v":"4.527","t":"-5.5%","d":"down"},{"l":"Savings (€)","v":"€27074","t":"+8.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.7%","t":"+14.1%","d":"up"},{"l":"Ciclos PDCA","v":"296","t":"+11.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.408","€ 13173.68","485","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.010","€ 50051.86","4.455","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.927","€ 36759.65","5.124","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.007","€ 22006.10","6.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.840","€ 6780.55","1.463","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":350},{"label":"Mar","value":539},{"label":"Abr","value":459},{"label":"Mai","value":466},{"label":"Jun","value":441},{"label":"Jul","value":653},{"label":"Ago","value":386},{"label":"Set","value":663},{"label":"Out","value":367},{"label":"Nov","value":406},{"label":"Dez","value":381}];
const MX = 663;
