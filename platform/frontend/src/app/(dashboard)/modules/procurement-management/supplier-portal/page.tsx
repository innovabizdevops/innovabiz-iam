...
const PAGE = "Supplier Portal";
const KPIS = [{"l":"Projetos Melhoria","v":"342","t":"+0.5%","d":"up"},{"l":"Savings (€)","v":"€9915","t":"-1.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.5%","t":"-5.9%","d":"down"},{"l":"Ciclos PDCA","v":"4.387","t":"+5.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.456","€ 38925.96","190","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.189","€ 18779.27","3.782","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.923","€ 38968.11","5.878","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.611","€ 8697.71","455","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.047","€ 28994.16","4.567","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":761},{"label":"Fev","value":788},{"label":"Mar","value":860},{"label":"Abr","value":935},{"label":"Mai","value":953},{"label":"Jun","value":716},{"label":"Jul","value":734},{"label":"Ago","value":787},{"label":"Set","value":926},{"label":"Out","value":947},{"label":"Nov","value":1042},{"label":"Dez","value":771}];
const MX = 1042;
