...
const KPIS = [{"l":"Projetos Melhoria","v":"7.251","t":"-3.3%","d":"down"},{"l":"Savings (€)","v":"€19085","t":"-1.8%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"86.2%","t":"+15.4%","d":"up"},{"l":"Ciclos PDCA","v":"988","t":"+12.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.981","€ 21279.09","8.610","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.664","€ 46768.40","3.344","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.551","€ 4438.78","6.496","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.583","€ 30067.95","4.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.478","€ 48155.04","7.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":455},{"label":"Mar","value":698},{"label":"Abr","value":442},{"label":"Mai","value":484},{"label":"Jun","value":583},{"label":"Jul","value":392},{"label":"Ago","value":510},{"label":"Set","value":490},{"label":"Out","value":530},{"label":"Nov","value":533},{"label":"Dez","value":415}];
const MX = 698;
