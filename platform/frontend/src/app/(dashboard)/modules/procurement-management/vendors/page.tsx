...
const PAGE = "Vendors";
const KPIS = [{"l":"Projetos Melhoria","v":"3.621","t":"+0.6%","d":"up"},{"l":"Savings (€)","v":"€18322","t":"+2.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"90.6%","t":"-2.4%","d":"down"},{"l":"Ciclos PDCA","v":"5.419","t":"+5.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.802","€ 14837.19","8.887","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.889","€ 7626.69","5.036","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.676","€ 14544.81","4.989","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","9.002","€ 44371.42","6.444","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.932","€ 35259.04","2.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":597},{"label":"Mar","value":405},{"label":"Abr","value":598},{"label":"Mai","value":393},{"label":"Jun","value":458},{"label":"Jul","value":383},{"label":"Ago","value":390},{"label":"Set","value":526},{"label":"Out","value":680},{"label":"Nov","value":464},{"label":"Dez","value":632}];
const MX = 680;
