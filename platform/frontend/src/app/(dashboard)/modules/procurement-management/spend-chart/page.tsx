...
const PAGE = "Spend Analysis Chart";
const KPIS = [{"l":"Dashboards Ativos","v":"617","t":"+7.2%","d":"up"},{"l":"Queries/Dia","v":"2674","t":"+2.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.391","t":"-0.2%","d":"down"},{"l":"Utilizadores Analytics","v":"5.166","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4916","2026-01-17","457","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4166","2026-03-28","3.119","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","986","2026-01-12","2.406","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","492","2026-01-25","1.883","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","653","2026-01-01","5.681","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":1014},{"label":"Mar","value":866},{"label":"Abr","value":664},{"label":"Mai","value":1013},{"label":"Jun","value":830},{"label":"Jul","value":997},{"label":"Ago","value":1017},{"label":"Set","value":898},{"label":"Out","value":784},{"label":"Nov","value":950},{"label":"Dez","value":929}];
const MX = 1017;
...
export default function SpendChartPage() {
    return (
