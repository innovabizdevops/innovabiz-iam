...
const PAGE = "Purchasing &amp; Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"5.958","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"3605","t":"-1.5%","d":"down"},{"l":"Dados Processados (GB)","v":"207","t":"+8.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.679","t":"+6.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1171","2026-02-26","2.584","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1895","2026-03-01","5.272","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2971","2026-02-21","7.426","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","708","2026-01-04","3.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2983","2026-02-07","6.025","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":525},{"label":"Mar","value":573},{"label":"Abr","value":430},{"label":"Mai","value":459},{"label":"Jun","value":702},{"label":"Jul","value":517},{"label":"Ago","value":647},{"label":"Set","value":640},{"label":"Out","value":504},{"label":"Nov","value":614},{"label":"Dez","value":795}];
const MX = 795;
