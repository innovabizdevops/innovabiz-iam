...
const PAGE = "Goods Receipt";
const KPIS = [{"l":"Projetos Melhoria","v":"8.109","t":"+15.3%","d":"up"},{"l":"Savings (€)","v":"€94096","t":"-0.2%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"69.3%","t":"+3.7%","d":"up"},{"l":"Ciclos PDCA","v":"9.052","t":"+9.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.107","€ 557.16","7.272","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","723","€ 26741.66","7.997","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","938","€ 22884.43","8.251","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.872","€ 23825.51","1.256","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.291","€ 20670.14","4.355","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":961},{"label":"Fev","value":651},{"label":"Mar","value":602},{"label":"Abr","value":695},{"label":"Mai","value":723},{"label":"Jun","value":871},{"label":"Jul","value":648},{"label":"Ago","value":812},{"label":"Set","value":933},{"label":"Out","value":684},{"label":"Nov","value":761},{"label":"Dez","value":643}];
const MX = 961;
