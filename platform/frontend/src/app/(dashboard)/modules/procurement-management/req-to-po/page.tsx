...
const PAGE = "Requisition-to-PO";
const KPIS = [{"l":"Projetos Melhoria","v":"6.960","t":"+16.8%","d":"up"},{"l":"Savings (€)","v":"€92402","t":"+15.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.1%","t":"-0.3%","d":"down"},{"l":"Ciclos PDCA","v":"1.882","t":"+-0.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.106","€ 48323.93","6.609","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.379","€ 7438.32","7.325","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.964","€ 21933.30","6.439","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.830","€ 25539.80","2.755","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.424","€ 25031.36","4.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":225},{"label":"Fev","value":486},{"label":"Mar","value":510},{"label":"Abr","value":242},{"label":"Mai","value":604},{"label":"Jun","value":509},{"label":"Jul","value":533},{"label":"Ago","value":326},{"label":"Set","value":449},{"label":"Out","value":295},{"label":"Nov","value":290},{"label":"Dez","value":443}];
const MX = 604;
...
export default function ReqToPoPage() {
    return (
