...
const PAGE = "Supplier Eval Form";
const KPIS = [{"l":"Formulários Ativos","v":"5.463","t":"+12.4%","d":"up"},{"l":"Submissões/Dia","v":"448","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"2.290","t":"+12.3%","d":"up"},{"l":"Templates","v":"4.459","t":"-0.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.251","2026-03-02","7.433","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.985","2026-01-01","8.743","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.547","2026-01-03","686","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.463","2026-02-19","8.925","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.304","2026-01-08","6.542","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":611},{"label":"Mar","value":497},{"label":"Abr","value":639},{"label":"Mai","value":555},{"label":"Jun","value":786},{"label":"Jul","value":603},{"label":"Ago","value":813},{"label":"Set","value":523},{"label":"Out","value":544},{"label":"Nov","value":479},{"label":"Dez","value":861}];
const MX = 861;
