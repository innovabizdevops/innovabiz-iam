...
const KPIS = [{"l":"Projetos Melhoria","v":"5.174","t":"+8.0%","d":"up"},{"l":"Savings (€)","v":"€98804","t":"+14.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.0%","t":"-1.3%","d":"down"},{"l":"Ciclos PDCA","v":"2.570","t":"-0.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.237","€ 44897.01","200","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.186","€ 27062.65","2.959","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.500","€ 45777.90","4.921","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.720","€ 37908.84","8.185","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.160","€ 21352.31","2.820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":804},{"label":"Mar","value":789},{"label":"Abr","value":688},{"label":"Mai","value":640},{"label":"Jun","value":686},{"label":"Jul","value":484},{"label":"Ago","value":770},{"label":"Set","value":615},{"label":"Out","value":704},{"label":"Nov","value":658},{"label":"Dez","value":537}];
const MX = 804;
