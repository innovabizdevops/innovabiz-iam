...
const PAGE = "GPA (WTO)";
const KPIS = [{"l":"Projetos Melhoria","v":"4.525","t":"+16.6%","d":"up"},{"l":"Savings (€)","v":"€83188","t":"-5.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"70.2%","t":"+8.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.365","t":"+0.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.350","€ 15113.17","5.501","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","576","€ 23782.50","4.653","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.065","€ 23862.65","7.255","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.064","€ 34249.33","8.079","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.630","€ 25060.39","502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":958},{"label":"Mar","value":644},{"label":"Abr","value":720},{"label":"Mai","value":850},{"label":"Jun","value":958},{"label":"Jul","value":986},{"label":"Ago","value":810},{"label":"Set","value":674},{"label":"Out","value":816},{"label":"Nov","value":979},{"label":"Dez","value":787}];
const MX = 986;
...
export default function GpaWtoPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>WTO</span></h1>
                </div>
