...
const PAGE = "Invoice Matching 3-Way";
const KPIS = [{"l":"Projetos Melhoria","v":"8.800","t":"-1.1%","d":"down"},{"l":"Savings (€)","v":"€42130","t":"+2.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"92.5%","t":"+10.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.056","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.271","€ 49264.05","8.970","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","311","€ 232.61","6.899","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.188","€ 20384.04","356","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.998","€ 31889.15","6.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.727","€ 19308.29","6.184","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":376},{"label":"Mar","value":465},{"label":"Abr","value":669},{"label":"Mai","value":686},{"label":"Jun","value":633},{"label":"Jul","value":358},{"label":"Ago","value":690},{"label":"Set","value":617},{"label":"Out","value":484},{"label":"Nov","value":630},{"label":"Dez","value":356}];
const MX = 690;
...
export default function InvoiceMatchingProcurementPage() {
    return (
