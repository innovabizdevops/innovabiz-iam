...
const PAGE = "ISO 20400 Sustainable";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.392","t":"+11.5%","d":"up"},{"l":"NC Abertas","v":"2.618","t":"+11.9%","d":"up"},{"l":"Conformidade (%)","v":"79.2%","t":"-1.9%","d":"down"},{"l":"CAPAs Pendentes","v":"5.525","t":"+17.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.552","85.2%","2.111","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.208","97.8%","602","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.606","97.1%","5.113","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.018","88.0%","5.729","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.026","99.6%","1.573","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":763},{"label":"Mar","value":455},{"label":"Abr","value":581},{"label":"Mai","value":784},{"label":"Jun","value":669},{"label":"Jul","value":662},{"label":"Ago","value":565},{"label":"Set","value":788},{"label":"Out","value":491},{"label":"Nov","value":719},{"label":"Dez","value":589}];
const MX = 788;
...
export default function Iso20400Page() {
    return (
