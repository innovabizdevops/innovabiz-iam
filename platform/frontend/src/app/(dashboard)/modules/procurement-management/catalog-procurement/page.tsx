...
const PAGE = "Catalog Management";
const KPIS = [{"l":"Dashboards Ativos","v":"8.621","t":"-1.1%","d":"down"},{"l":"Queries/Dia","v":"1213","t":"+8.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.884","t":"+3.3%","d":"up"},{"l":"Utilizadores Analytics","v":"602","t":"+14.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1691","2026-02-11","2.875","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","942","2026-02-24","7.978","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2389","2026-02-26","6.371","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4587","2026-02-20","4.259","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1802","2026-03-07","3.924","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":670},{"label":"Mar","value":374},{"label":"Abr","value":476},{"label":"Mai","value":689},{"label":"Jun","value":398},{"label":"Jul","value":483},{"label":"Ago","value":693},{"label":"Set","value":471},{"label":"Out","value":406},{"label":"Nov","value":744},{"label":"Dez","value":618}];
const MX = 744;
...
export default function CatalogProcurementPage() {
    return (
