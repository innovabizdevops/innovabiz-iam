...
const PAGE = "Catalog Mgmt";
const KPIS = [{"l":"Dashboards Ativos","v":"8.245","t":"+6.1%","d":"up"},{"l":"Queries/Dia","v":"1513","t":"+6.9%","d":"up"},{"l":"Dados Processados (GB)","v":"3.411","t":"+7.0%","d":"up"},{"l":"Utilizadores Analytics","v":"7.297","t":"+0.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3374","2026-01-14","7.174","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4572","2026-01-17","5.118","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1013","2026-01-12","5.046","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1631","2026-03-28","3.703","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","532","2026-02-11","4.552","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":663},{"label":"Mar","value":709},{"label":"Abr","value":454},{"label":"Mai","value":538},{"label":"Jun","value":752},{"label":"Jul","value":734},{"label":"Ago","value":743},{"label":"Set","value":625},{"label":"Out","value":546},{"label":"Nov","value":728},{"label":"Dez","value":713}];
const MX = 752;
