...
const KPIS = [{"l":"Projetos Melhoria","v":"6.439","t":"+10.0%","d":"up"},{"l":"Savings (€)","v":"€18760","t":"+12.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.6%","t":"+1.1%","d":"up"},{"l":"Ciclos PDCA","v":"647","t":"+5.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.612","€ 10777.53","4.699","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.980","€ 44749.42","4.689","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.973","€ 15352.56","601","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.642","€ 17389.29","7.723","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","9.032","€ 25097.24","8.739","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":439},{"label":"Mar","value":666},{"label":"Abr","value":646},{"label":"Mai","value":770},{"label":"Jun","value":499},{"label":"Jul","value":702},{"label":"Ago","value":589},{"label":"Set","value":381},{"label":"Out","value":751},{"label":"Nov","value":758},{"label":"Dez","value":535}];
const MX = 770;
...
export default function SuppliersProcurementPage() {
    return (
