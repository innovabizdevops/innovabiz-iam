...
const PAGE = "Sourcing AI";
const KPIS = [{"l":"Projetos Melhoria","v":"2.920","t":"-4.5%","d":"down"},{"l":"Savings (€)","v":"€22163","t":"-5.5%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"91.3%","t":"-4.0%","d":"down"},{"l":"Ciclos PDCA","v":"982","t":"+3.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.449","€ 1196.25","8.391","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.842","€ 497.59","8.975","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.542","€ 9446.80","3.615","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.203","€ 24149.76","691","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.713","€ 7203.08","3.492","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":555},{"label":"Mar","value":692},{"label":"Abr","value":380},{"label":"Mai","value":470},{"label":"Jun","value":664},{"label":"Jul","value":763},{"label":"Ago","value":469},{"label":"Set","value":374},{"label":"Out","value":501},{"label":"Nov","value":747},{"label":"Dez","value":645}];
const MX = 763;
