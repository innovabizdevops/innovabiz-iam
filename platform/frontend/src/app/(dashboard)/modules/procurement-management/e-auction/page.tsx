...
const PAGE = "e-Auction";
const KPIS = [{"l":"Projetos Melhoria","v":"4.782","t":"+5.0%","d":"up"},{"l":"Savings (€)","v":"€51523","t":"+12.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.5%","t":"+16.3%","d":"up"},{"l":"Ciclos PDCA","v":"4.843","t":"+17.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.177","€ 28397.83","5.786","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.637","€ 23962.33","3.885","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.322","€ 3281.26","5.772","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.661","€ 49641.78","7.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.442","€ 11768.05","4.967","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":708},{"label":"Mar","value":858},{"label":"Abr","value":684},{"label":"Mai","value":754},{"label":"Jun","value":748},{"label":"Jul","value":1003},{"label":"Ago","value":919},{"label":"Set","value":945},{"label":"Out","value":964},{"label":"Nov","value":897},{"label":"Dez","value":612}];
const MX = 1003;
