...
const PAGE = "Vendor Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.433","t":"+3.5%","d":"up"},{"l":"Mitigações Ativas","v":"932","t":"+15.6%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+1.1%","d":"up"},{"l":"Incidentes YTD","v":"6.227","t":"+9.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.654","1.827","7.476","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.199","8.486","2.278","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.181","4.275","3.077","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.183","5.529","5.477","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.284","1.684","4.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":828},{"label":"Mar","value":989},{"label":"Abr","value":990},{"label":"Mai","value":672},{"label":"Jun","value":696},{"label":"Jul","value":658},{"label":"Ago","value":919},{"label":"Set","value":630},{"label":"Out","value":1018},{"label":"Nov","value":738},{"label":"Dez","value":827}];
const MX = 1018;
