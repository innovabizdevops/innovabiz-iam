...
const PAGE = "Contract Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.579","t":"-4.2%","d":"down"},{"l":"NC Abertas","v":"579","t":"+14.1%","d":"up"},{"l":"Conformidade (%)","v":"84.5%","t":"-2.1%","d":"down"},{"l":"CAPAs Pendentes","v":"2.409","t":"+9.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.500","74.9%","7.190","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.974","90.8%","6.823","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.221","99.6%","9.068","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.882","80.6%","7.825","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.549","75.6%","1.614","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":764},{"label":"Fev","value":642},{"label":"Mar","value":848},{"label":"Abr","value":795},{"label":"Mai","value":693},{"label":"Jun","value":982},{"label":"Jul","value":1002},{"label":"Ago","value":726},{"label":"Set","value":631},{"label":"Out","value":976},{"label":"Nov","value":692},{"label":"Dez","value":658}];
const MX = 1002;
