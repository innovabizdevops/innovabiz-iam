...
const PAGE = "Vendor Scorecard";
const KPIS = [{"l":"Projetos Melhoria","v":"2.771","t":"-3.3%","d":"down"},{"l":"Savings (€)","v":"€90488","t":"+5.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"80.2%","t":"+13.4%","d":"up"},{"l":"Ciclos PDCA","v":"302","t":"+15.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.621","€ 11382.27","5.455","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.202","€ 17527.57","1.072","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.985","€ 15632.01","5.141","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.102","€ 36264.55","3.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.972","€ 39445.67","6.690","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":674},{"label":"Mar","value":416},{"label":"Abr","value":421},{"label":"Mai","value":738},{"label":"Jun","value":428},{"label":"Jul","value":727},{"label":"Ago","value":623},{"label":"Set","value":533},{"label":"Out","value":457},{"label":"Nov","value":418},{"label":"Dez","value":387}];
const MX = 738;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Chart</span></h1>
                </div>
