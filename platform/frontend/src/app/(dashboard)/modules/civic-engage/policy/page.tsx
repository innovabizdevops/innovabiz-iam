...
const PAGE = "Policy Feedback";
const KPIS = [{"l":"Surveys Ativos","v":"6.192","t":"+11.9%","d":"up"},{"l":"Respostas/Semana","v":"3620","t":"-2.3%","d":"down"},{"l":"NPS Médio","v":"60","t":"+13.9%","d":"up"},{"l":"Taxa Resposta (%)","v":"75.2%","t":"+10.7%","d":"up"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","4.753","69","98.6%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","4.361","93","74.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","4.632","95","94.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.990","75","84.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.423","74","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":579},{"label":"Mar","value":466},{"label":"Abr","value":615},{"label":"Mai","value":722},{"label":"Jun","value":583},{"label":"Jul","value":635},{"label":"Ago","value":516},{"label":"Set","value":489},{"label":"Out","value":547},{"label":"Nov","value":835},{"label":"Dez","value":521}];
const MX = 835;
