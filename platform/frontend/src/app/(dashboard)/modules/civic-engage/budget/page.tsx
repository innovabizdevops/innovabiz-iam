...
const PAGE = "Budget Particip";
const KPIS = [{"l":"Total Civic Engage","v":"6.819","t":"+12.0%","d":"up"},{"l":"Budget Particip Ativos","v":"€62121","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"67.9%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+4.4%","d":"up"}];
const COLS = ["ID","Budget Particip","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Civic Engage #001","€ 18975.51","8.348","3.215","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Civic Engage #002","€ 34084.85","3.528","7.803","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Civic Engage #003","€ 6837.23","8.966","4.031","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Civic Engage #004","€ 28901.81","401","6.225","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Civic Engage #005","€ 12328.88","8.448","3.969","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":630},{"label":"Mar","value":582},{"label":"Abr","value":405},{"label":"Mai","value":421},{"label":"Jun","value":616},{"label":"Jul","value":589},{"label":"Ago","value":420},{"label":"Set","value":427},{"label":"Out","value":727},{"label":"Nov","value":736},{"label":"Dez","value":699}];
const MX = 736;
