...
const KPIS = [{"l":"Total Notary Mgmt","v":"1.621","t":"+10.3%","d":"up"},{"l":"Appointment Ativos","v":"4.629","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"69.4%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"77","t":"-5.4%","d":"down"}];
const COLS = ["ID","Appointment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Mgmt #001","Notary Mgmt #002","8.297","877","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Mgmt #002","Notary Mgmt #003","8.798","7.564","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Mgmt #003","Notary Mgmt #004","1.697","3.576","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Mgmt #004","Notary Mgmt #005","5.846","7.101","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Mgmt #005","Notary Mgmt #001","7.671","8.250","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":298},{"label":"Fev","value":397},{"label":"Mar","value":515},{"label":"Abr","value":524},{"label":"Mai","value":477},{"label":"Jun","value":324},{"label":"Jul","value":578},{"label":"Ago","value":534},{"label":"Set","value":428},{"label":"Out","value":403},{"label":"Nov","value":505},{"label":"Dez","value":611}];
const MX = 611;
