...
const PAGE = "Archive";
const KPIS = [{"l":"Total Notary Mgmt","v":"265","t":"+7.4%","d":"up"},{"l":"Archive Ativos","v":"6.940","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.8%","d":"down"}];
const COLS = ["ID","Archive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Mgmt #001","Notary Mgmt #002","628","2.196","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Mgmt #002","Notary Mgmt #003","865","8.094","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Mgmt #003","Notary Mgmt #004","556","3.206","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Mgmt #004","Notary Mgmt #005","7.485","1.202","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Mgmt #005","Notary Mgmt #001","7.937","7.430","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":935},{"label":"Mar","value":969},{"label":"Abr","value":771},{"label":"Mai","value":985},{"label":"Jun","value":834},{"label":"Jul","value":971},{"label":"Ago","value":653},{"label":"Set","value":874},{"label":"Out","value":1009},{"label":"Nov","value":983},{"label":"Dez","value":662}];
const MX = 1009;
