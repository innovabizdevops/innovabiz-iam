...
const ACCENT = "#6366f1";
const MODULE = "Notary Management";
const PAGE = "Signature";
const KPIS = [{"l":"Formulários Ativos","v":"2.485","t":"+0.8%","d":"up"},{"l":"Submissões/Dia","v":"4282","t":"+13.0%","d":"up"},{"l":"Documentos Gerados","v":"8.648","t":"+17.7%","d":"up"},{"l":"Templates","v":"1.973","t":"-4.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.625","2026-01-05","4.587","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.007","2026-02-06","5.681","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.982","2026-02-27","8.868","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.180","2026-01-25","4.100","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","277","2026-02-12","7.395","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":502},{"label":"Mar","value":612},{"label":"Abr","value":476},{"label":"Mai","value":373},{"label":"Jun","value":649},{"label":"Jul","value":678},{"label":"Ago","value":700},{"label":"Set","value":677},{"label":"Out","value":574},{"label":"Nov","value":734},{"label":"Dez","value":602}];
const MX = 734;
