...
const PAGE = "Billing";
const KPIS = [{"l":"Total Notary Mgmt","v":"4.231","t":"+14.1%","d":"up"},{"l":"Billing Ativos","v":"6.199","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"82.1%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.5%","d":"down"}];
const COLS = ["ID","Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Mgmt #001","Notary Mgmt #002","6.984","8.038","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Mgmt #002","Notary Mgmt #003","4.579","3.385","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Mgmt #003","Notary Mgmt #004","7.411","3.912","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Mgmt #004","Notary Mgmt #005","1.431","3.398","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Mgmt #005","Notary Mgmt #001","8.582","7.138","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":388},{"label":"Mar","value":425},{"label":"Abr","value":586},{"label":"Mai","value":499},{"label":"Jun","value":615},{"label":"Jul","value":552},{"label":"Ago","value":276},{"label":"Set","value":497},{"label":"Out","value":518},{"label":"Nov","value":359},{"label":"Dez","value":389}];
const MX = 629;
