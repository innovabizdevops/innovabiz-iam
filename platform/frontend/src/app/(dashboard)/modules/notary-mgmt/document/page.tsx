...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"6.142","t":"-0.9%","d":"down"},{"l":"Submissões/Dia","v":"4862","t":"+12.6%","d":"up"},{"l":"Documentos Gerados","v":"3.685","t":"+7.3%","d":"up"},{"l":"Templates","v":"4.449","t":"+8.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","493","2026-03-15","1.231","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.819","2026-03-13","3.787","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.879","2026-02-11","2.070","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.018","2026-02-23","707","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.761","2026-01-09","6.309","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":1034},{"label":"Mar","value":801},{"label":"Abr","value":745},{"label":"Mai","value":882},{"label":"Jun","value":726},{"label":"Jul","value":844},{"label":"Ago","value":702},{"label":"Set","value":740},{"label":"Out","value":700},{"label":"Nov","value":740},{"label":"Dez","value":713}];
const MX = 1034;
