...
const PAGE = "Create";
const KPIS = [{"l":"Total Mam Lifecycle","v":"7.555","t":"+16.8%","d":"up"},{"l":"Create Ativos","v":"2.566","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"86.0%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"68","t":"-1.3%","d":"down"}];
const COLS = ["ID","Create","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Lifecycle #001","Mam Lifecycle #002","6.006","6.885","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Lifecycle #002","Mam Lifecycle #003","1.050","5.546","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Lifecycle #003","Mam Lifecycle #004","8.481","1.766","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Lifecycle #004","Mam Lifecycle #005","3.269","1.878","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Lifecycle #005","Mam Lifecycle #001","5.702","7.115","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":765},{"label":"Fev","value":722},{"label":"Mar","value":513},{"label":"Abr","value":766},{"label":"Mai","value":515},{"label":"Jun","value":706},{"label":"Jul","value":551},{"label":"Ago","value":397},{"label":"Set","value":694},{"label":"Out","value":711},{"label":"Nov","value":641},{"label":"Dez","value":474}];
const MX = 766;
