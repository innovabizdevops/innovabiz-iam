...
const ACCENT = "#0369a1";
const MODULE = "MAM Agent Lifecycle";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Mam Lifecycle","v":"3.097","t":"-2.1%","d":"down"},{"l":"Monitor Ativos","v":"7.496","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"92.8%","t":"-5.2%","d":"down"},{"l":"Score Performance","v":"63","t":"-3.9%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mam Lifecycle #001","Mam Lifecycle #002","6.150","3.500","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Mam Lifecycle #002","Mam Lifecycle #003","6.345","7.402","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Mam Lifecycle #003","Mam Lifecycle #004","524","2.013","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mam Lifecycle #004","Mam Lifecycle #005","6.455","5.340","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mam Lifecycle #005","Mam Lifecycle #001","479","7.552","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":892},{"label":"Mar","value":660},{"label":"Abr","value":748},{"label":"Mai","value":748},{"label":"Jun","value":677},{"label":"Jul","value":822},{"label":"Ago","value":676},{"label":"Set","value":624},{"label":"Out","value":832},{"label":"Nov","value":819},{"label":"Dez","value":849}];
const MX = 892;
