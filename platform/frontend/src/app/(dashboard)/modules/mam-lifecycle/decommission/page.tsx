...
const KPIS = [{"l":"Vendas YTD (€)","v":"€9873","t":"+15.8%","d":"up"},{"l":"Pipeline (€)","v":"€62361","t":"+2.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"68.1%","t":"-1.4%","d":"down"},{"l":"Win Rate (%)","v":"89.7%","t":"+2.6%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 13879.36","€ 34477.64","€ 49711.00","92.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 1557.12","€ 27317.60","€ 2197.01","98.3%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 45910.88","€ 21678.87","€ 33343.57","76.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 10170.41","€ 5012.49","€ 29644.23","87.3%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 41552.75","€ 4244.41","€ 40360.03","84.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":533},{"label":"Mar","value":354},{"label":"Abr","value":406},{"label":"Mai","value":390},{"label":"Jun","value":538},{"label":"Jul","value":336},{"label":"Ago","value":331},{"label":"Set","value":518},{"label":"Out","value":550},{"label":"Nov","value":283},{"label":"Dez","value":495}];
const MX = 561;
