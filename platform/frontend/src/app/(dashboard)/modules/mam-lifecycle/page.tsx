...
/* ═══ MAM Agent Lifecycle — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "7229", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "959", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€207K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "263931229", cells: ["MAM-7229", "MAM Agent Lifecycle Item 1", "10/2/2026", "€31 329"], status: "active" as const },
    { id: "263934800", cells: ["MAM-1800", "MAM Agent Lifecycle Item 2", "25/9/2026", "€34 900"], status: "pending" as const },
    { id: "263938371", cells: ["MAM-5371", "MAM Agent Lifecycle Item 3", "12/4/2026", "€38 471"], status: "completed" as const },
    { id: "263941942", cells: ["MAM-8942", "MAM Agent Lifecycle Item 4", "27/11/2026", "€42 042"], status: "warning" as const },
    { id: "263945513", cells: ["MAM-3513", "MAM Agent Lifecycle Item 5", "14/6/2026", "€45 613"], status: "active" as const },
];
...
export default function MamAgentLifecyclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MAM Agent Lifecycle</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MAM Agent Lifecycle</p>
                    </div>
                </div>
