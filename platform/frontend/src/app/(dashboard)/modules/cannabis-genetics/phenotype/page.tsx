...
const ACCENT = "#14532d";
const MODULE = "Cannabis Genetics";
const PAGE = "Phenotype";
const KPIS = [{"l":"Total Cannabis Genetics","v":"5.607","t":"-4.0%","d":"down"},{"l":"Phenotype Ativos","v":"8.469","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"63","t":"-4.4%","d":"down"}];
const COLS = ["ID","Phenotype","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Genetics #001","Cannabis Genetics #002","2.193","8.642","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Genetics #002","Cannabis Genetics #003","5.073","2.078","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Genetics #003","Cannabis Genetics #004","5.155","2.762","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Genetics #004","Cannabis Genetics #005","1.207","810","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Genetics #005","Cannabis Genetics #001","2.464","2.663","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":695},{"label":"Mar","value":765},{"label":"Abr","value":837},{"label":"Mai","value":817},{"label":"Jun","value":807},{"label":"Jul","value":700},{"label":"Ago","value":884},{"label":"Set","value":777},{"label":"Out","value":723},{"label":"Nov","value":900},{"label":"Dez","value":744}];
const MX = 900;
