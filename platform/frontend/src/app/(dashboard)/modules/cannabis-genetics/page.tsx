...
/* ═══ Cannabis Genetics — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "7013", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2501", trend: "-8%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€165K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1795500613", cells: ["CAN-1613", "Cannabis Genetics Item 1", "26/2/2026", "€713"], status: "active" as const },
    { id: "1795504184", cells: ["CAN-5184", "Cannabis Genetics Item 2", "13/9/2026", "€4284"], status: "pending" as const },
    { id: "1795507755", cells: ["CAN-8755", "Cannabis Genetics Item 3", "28/4/2026", "€7855"], status: "completed" as const },
    { id: "1795511326", cells: ["CAN-3326", "Cannabis Genetics Item 4", "15/11/2026", "€11 426"], status: "warning" as const },
    { id: "1795514897", cells: ["CAN-6897", "Cannabis Genetics Item 5", "2/6/2026", "€14 997"], status: "active" as const },
];
...
export default function CannabisGeneticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Genetics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Genetics</p>
                    </div>
                </div>
