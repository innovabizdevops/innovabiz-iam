...
const PAGE = "Strain";
const KPIS = [{"l":"Total Cannabis Genetics","v":"485","t":"+14.1%","d":"up"},{"l":"Strain Ativos","v":"1.181","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"85.3%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"68","t":"+14.0%","d":"up"}];
const COLS = ["ID","Strain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Genetics #001","Cannabis Genetics #002","3.442","4.141","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Genetics #002","Cannabis Genetics #003","6.224","5.927","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Genetics #003","Cannabis Genetics #004","3.001","4.287","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Genetics #004","Cannabis Genetics #005","933","2.475","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Genetics #005","Cannabis Genetics #001","3.952","1.844","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":953},{"label":"Mar","value":916},{"label":"Abr","value":896},{"label":"Mai","value":761},{"label":"Jun","value":948},{"label":"Jul","value":979},{"label":"Ago","value":957},{"label":"Set","value":837},{"label":"Out","value":926},{"label":"Nov","value":836},{"label":"Dez","value":1011}];
const MX = 1011;
