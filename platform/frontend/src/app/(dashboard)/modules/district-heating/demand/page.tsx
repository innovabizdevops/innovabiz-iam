...
const ACCENT = "#dc2626";
const MODULE = "District Heating";
const PAGE = "Demand Forecast";
const KPIS = [{"l":"Total District Heating","v":"6.083","t":"+14.2%","d":"up"},{"l":"Demand Forecast Ativos","v":"1.763","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+10.6%","d":"up"}];
const COLS = ["ID","Demand Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Heating #001","District Heating #002","6.523","1.387","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["District Heating #002","District Heating #003","3.191","5.964","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["District Heating #003","District Heating #004","5.312","7.437","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["District Heating #004","District Heating #005","5.018","1.549","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Heating #005","District Heating #001","2.095","2.211","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":718},{"label":"Mar","value":765},{"label":"Abr","value":614},{"label":"Mai","value":799},{"label":"Jun","value":645},{"label":"Jul","value":788},{"label":"Ago","value":817},{"label":"Set","value":605},{"label":"Out","value":704},{"label":"Nov","value":734},{"label":"Dez","value":608}];
const MX = 817;
