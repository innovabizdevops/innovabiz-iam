...
const PAGE = "Substation Mon";
const KPIS = [{"l":"Total District Heating","v":"8.716","t":"+1.7%","d":"up"},{"l":"Substation Mon Ativos","v":"3.594","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"76.0%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"82","t":"+6.2%","d":"up"}];
const COLS = ["ID","Substation Mon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Heating #001","District Heating #002","4.479","7.826","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["District Heating #002","District Heating #003","7.954","7.096","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["District Heating #003","District Heating #004","7.331","8.395","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["District Heating #004","District Heating #005","9.038","7.257","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Heating #005","District Heating #001","8.224","3.485","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":674},{"label":"Mar","value":706},{"label":"Abr","value":745},{"label":"Mai","value":842},{"label":"Jun","value":811},{"label":"Jul","value":884},{"label":"Ago","value":807},{"label":"Set","value":895},{"label":"Out","value":568},{"label":"Nov","value":627},{"label":"Dez","value":705}];
const MX = 895;
