...
const PAGE = "Heat Network";
const KPIS = [{"l":"Total District Heating","v":"6.639","t":"+2.7%","d":"up"},{"l":"Heat Network Ativos","v":"3.729","t":"+6.0%","d":"up"},{"l":"Eficiência (%)","v":"76.4%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"91","t":"+6.5%","d":"up"}];
const COLS = ["ID","Heat Network","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Heating #001","District Heating #002","7.626","7.678","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["District Heating #002","District Heating #003","858","8.975","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["District Heating #003","District Heating #004","5.181","508","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["District Heating #004","District Heating #005","531","3.692","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Heating #005","District Heating #001","2.998","5.827","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":784},{"label":"Mar","value":417},{"label":"Abr","value":604},{"label":"Mai","value":695},{"label":"Jun","value":614},{"label":"Jul","value":603},{"label":"Ago","value":705},{"label":"Set","value":456},{"label":"Out","value":428},{"label":"Nov","value":633},{"label":"Dez","value":514}];
const MX = 784;
