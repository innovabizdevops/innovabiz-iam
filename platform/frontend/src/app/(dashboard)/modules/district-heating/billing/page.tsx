...
const PAGE = "Customer Billing";
const KPIS = [{"l":"Total District Heating","v":"7.128","t":"-4.9%","d":"down"},{"l":"Customer Billing Ativos","v":"€89710","t":"+3.1%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"66","t":"+12.4%","d":"up"}];
const COLS = ["ID","Customer Billing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Heating #001","€ 9750.95","4.708","3.308","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["District Heating #002","€ 34720.44","8.932","1.994","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["District Heating #003","€ 22857.62","8.978","3.756","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["District Heating #004","€ 49942.47","5.316","8.263","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Heating #005","€ 39996.61","5.363","4.306","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":417},{"label":"Fev","value":584},{"label":"Mar","value":452},{"label":"Abr","value":402},{"label":"Mai","value":508},{"label":"Jun","value":504},{"label":"Jul","value":701},{"label":"Ago","value":403},{"label":"Set","value":638},{"label":"Out","value":575},{"label":"Nov","value":548},{"label":"Dez","value":685}];
const MX = 701;
