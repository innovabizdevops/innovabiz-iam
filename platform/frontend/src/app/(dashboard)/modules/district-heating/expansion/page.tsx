...
const PAGE = "Expansion Plan";
const KPIS = [{"l":"Total District Heating","v":"6.185","t":"-5.3%","d":"down"},{"l":"Expansion Plan Ativos","v":"6.334","t":"+8.2%","d":"up"},{"l":"Eficiência (%)","v":"86.8%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"63","t":"-3.8%","d":"down"}];
const COLS = ["ID","Expansion Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["District Heating #001","District Heating #002","7.112","6.256","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["District Heating #002","District Heating #003","6.338","4.367","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["District Heating #003","District Heating #004","2.018","974","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["District Heating #004","District Heating #005","8.797","8.894","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["District Heating #005","District Heating #001","4.287","8.873","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":550},{"label":"Mar","value":417},{"label":"Abr","value":602},{"label":"Mai","value":547},{"label":"Jun","value":640},{"label":"Jul","value":457},{"label":"Ago","value":540},{"label":"Set","value":424},{"label":"Out","value":525},{"label":"Nov","value":690},{"label":"Dez","value":523}];
const MX = 690;
