...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"561","t":"-1.7%","d":"down"},{"l":"Chamadas/Hora","v":"1327","t":"+1.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.5%","t":"-1.7%","d":"down"},{"l":"Latência Média (ms)","v":"80ms","t":"+5.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.519","8.155","95.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.858","5.583","96.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.667","285","76.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.517","8.206","80.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.083","4.710","97.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":722},{"label":"Fev","value":701},{"label":"Mar","value":598},{"label":"Abr","value":543},{"label":"Mai","value":623},{"label":"Jun","value":486},{"label":"Jul","value":754},{"label":"Ago","value":782},{"label":"Set","value":518},{"label":"Out","value":567},{"label":"Nov","value":761},{"label":"Dez","value":832}];
const MX = 832;
