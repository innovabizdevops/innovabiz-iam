...
const ACCENT = "#65a30d";
const MODULE = "Photography Services";
const PAGE = "Gallery";
const KPIS = [{"l":"Total Photography Svc","v":"6.707","t":"+14.3%","d":"up"},{"l":"Gallery Ativos","v":"1.521","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"76","t":"+4.9%","d":"up"}];
const COLS = ["ID","Gallery","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photography Svc #001","Photography Svc #002","4.232","6.903","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Photography Svc #002","Photography Svc #003","4.460","8.664","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Photography Svc #003","Photography Svc #004","8.190","4.253","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Photography Svc #004","Photography Svc #005","2.673","3.676","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photography Svc #005","Photography Svc #001","8.621","5.792","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":1029},{"label":"Mar","value":1078},{"label":"Abr","value":1039},{"label":"Mai","value":975},{"label":"Jun","value":731},{"label":"Jul","value":1063},{"label":"Ago","value":811},{"label":"Set","value":1051},{"label":"Out","value":1054},{"label":"Nov","value":918},{"label":"Dez","value":850}];
const MX = 1078;
