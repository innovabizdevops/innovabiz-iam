...
const PAGE = "Shoot";
const KPIS = [{"l":"Total Photography Svc","v":"4.574","t":"-2.2%","d":"down"},{"l":"Shoot Ativos","v":"2.607","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.9%","d":"up"}];
const COLS = ["ID","Shoot","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photography Svc #001","Photography Svc #002","6.862","746","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Photography Svc #002","Photography Svc #003","8.257","725","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Photography Svc #003","Photography Svc #004","4.445","6.332","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Photography Svc #004","Photography Svc #005","3.336","1.057","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photography Svc #005","Photography Svc #001","7.674","777","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":777},{"label":"Mar","value":955},{"label":"Abr","value":692},{"label":"Mai","value":740},{"label":"Jun","value":814},{"label":"Jul","value":796},{"label":"Ago","value":925},{"label":"Set","value":985},{"label":"Out","value":719},{"label":"Nov","value":928},{"label":"Dez","value":710}];
const MX = 985;
