...
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"9.042","t":"+2.8%","d":"up"},{"l":"RevPAR (€)","v":"€40002","t":"+8.7%","d":"up"},{"l":"Ocupação (%)","v":"70.6%","t":"-3.2%","d":"down"},{"l":"Guest Satisfaction","v":"2.498","t":"+15.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.231","2026-01-14","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.626","2026-01-13","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.022","2026-02-25","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.936","2026-03-08","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.160","2026-01-19","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":468},{"label":"Mar","value":313},{"label":"Abr","value":605},{"label":"Mai","value":280},{"label":"Jun","value":518},{"label":"Jul","value":440},{"label":"Ago","value":420},{"label":"Set","value":362},{"label":"Out","value":360},{"label":"Nov","value":389},{"label":"Dez","value":597}];
const MX = 605;
