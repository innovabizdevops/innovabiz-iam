...
const PAGE = "Deliver";
const KPIS = [{"l":"Total Photography Svc","v":"2.276","t":"+3.0%","d":"up"},{"l":"Deliver Ativos","v":"2.276","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"83","t":"+14.5%","d":"up"}];
const COLS = ["ID","Deliver","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Photography Svc #001","Photography Svc #002","208","1.545","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Photography Svc #002","Photography Svc #003","8.109","6.404","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Photography Svc #003","Photography Svc #004","473","6.324","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Photography Svc #004","Photography Svc #005","3.045","1.825","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Photography Svc #005","Photography Svc #001","4.828","1.944","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":411},{"label":"Fev","value":390},{"label":"Mar","value":474},{"label":"Abr","value":288},{"label":"Mai","value":578},{"label":"Jun","value":434},{"label":"Jul","value":276},{"label":"Ago","value":509},{"label":"Set","value":434},{"label":"Out","value":310},{"label":"Nov","value":342},{"label":"Dez","value":446}];
const MX = 578;
