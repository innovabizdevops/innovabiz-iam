...
/* ═══ Photography Services — Dashboard ═══ */

const ACCENT = "#65a30d";

const KPIS = [
    { label: "Total Registos", value: "3017", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1785", trend: "-12%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€193K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1731344617", cells: ["PHO-6617", "Photography Services Item 1", "10/2/2026", "€44 717"], status: "active" as const },
    { id: "1731348188", cells: ["PHO-1188", "Photography Services Item 2", "25/9/2026", "€48 288"], status: "pending" as const },
    { id: "1731351759", cells: ["PHO-4759", "Photography Services Item 3", "12/4/2026", "€1859"], status: "completed" as const },
    { id: "1731355330", cells: ["PHO-8330", "Photography Services Item 4", "27/11/2026", "€5430"], status: "warning" as const },
    { id: "1731358901", cells: ["PHO-2901", "Photography Services Item 5", "14/6/2026", "€9001"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Photography Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Photography Services</p>
                    </div>
                </div>
