...
/* ═══ Underwriting (ACORD) — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "5151", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "823", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€378K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "163404551", cells: ["ACO-1551", "Underwriting (ACORD) Item 1", "24/12/2026", "€4651"], status: "active" as const },
    { id: "163408122", cells: ["ACO-5122", "Underwriting (ACORD) Item 2", "11/7/2026", "€8222"], status: "pending" as const },
    { id: "163411693", cells: ["ACO-8693", "Underwriting (ACORD) Item 3", "26/2/2026", "€11 793"], status: "completed" as const },
    { id: "163415264", cells: ["ACO-3264", "Underwriting (ACORD) Item 4", "13/9/2026", "€15 364"], status: "warning" as const },
    { id: "163418835", cells: ["ACO-6835", "Underwriting (ACORD) Item 5", "28/4/2026", "€18 935"], status: "active" as const },
];
...
export default function UnderwritingAcordPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Underwriting (ACORD)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Underwriting (ACORD)</p>
                    </div>
                </div>
