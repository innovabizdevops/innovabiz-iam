...
const ACCENT = "#155e75";
const MODULE = "Underwriting (ACORD)";
const PAGE = "Risk Assess";
const KPIS = [{"l":"Riscos Identificados","v":"2.382","t":"-2.0%","d":"down"},{"l":"Mitigações Ativas","v":"7.659","t":"-4.0%","d":"down"},{"l":"Score Risco Geral","v":"82","t":"+8.7%","d":"up"},{"l":"Incidentes YTD","v":"8.432","t":"+5.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.396","3.825","3.174","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.428","5.823","4.355","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.568","1.553","3.164","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.961","4.203","1.836","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.773","4.732","572","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":817},{"label":"Mar","value":618},{"label":"Abr","value":706},{"label":"Mai","value":636},{"label":"Jun","value":848},{"label":"Jul","value":879},{"label":"Ago","value":863},{"label":"Set","value":926},{"label":"Out","value":906},{"label":"Nov","value":765},{"label":"Dez","value":671}];
const MX = 926;
