...
/* ═══ Carpet Cleaning — Dashboard ═══ */

const ACCENT = "#155e75";

const KPIS = [
    { label: "Total Registos", value: "6114", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2776", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "552970514", cells: ["CAR-2514", "Carpet Cleaning Item 1", "27/3/2026", "€20 614"], status: "active" as const },
    { id: "552974085", cells: ["CAR-6085", "Carpet Cleaning Item 2", "14/10/2026", "€24 185"], status: "pending" as const },
    { id: "552977656", cells: ["CAR-9656", "Carpet Cleaning Item 3", "1/5/2026", "€27 756"], status: "completed" as const },
    { id: "552981227", cells: ["CAR-4227", "Carpet Cleaning Item 4", "16/12/2026", "€31 327"], status: "warning" as const },
    { id: "552984798", cells: ["CAR-7798", "Carpet Cleaning Item 5", "3/7/2026", "€34 898"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carpet Cleaning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Carpet Cleaning</p>
                    </div>
                </div>
