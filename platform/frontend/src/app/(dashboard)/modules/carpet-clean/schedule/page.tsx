...
const PAGE = "Schedule";
const KPIS = [{"l":"Projetos Melhoria","v":"7.157","t":"+1.7%","d":"up"},{"l":"Savings (€)","v":"€25806","t":"+0.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.3%","t":"+0.7%","d":"up"},{"l":"Ciclos PDCA","v":"8.744","t":"+14.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.096","€ 18393.30","2.514","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.811","€ 48145.86","3.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.578","€ 21821.42","6.986","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","848","€ 44238.15","2.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.984","€ 34050.70","1.338","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":584},{"label":"Fev","value":770},{"label":"Mar","value":658},{"label":"Abr","value":574},{"label":"Mai","value":768},{"label":"Jun","value":636},{"label":"Jul","value":559},{"label":"Ago","value":855},{"label":"Set","value":502},{"label":"Out","value":628},{"label":"Nov","value":578},{"label":"Dez","value":751}];
const MX = 855;
