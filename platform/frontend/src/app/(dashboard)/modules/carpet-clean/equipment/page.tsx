...
const KPIS = [{"l":"Projetos Melhoria","v":"4.742","t":"+7.0%","d":"up"},{"l":"Savings (€)","v":"€49402","t":"+15.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"78.2%","t":"+15.5%","d":"up"},{"l":"Ciclos PDCA","v":"2.880","t":"+14.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","789","€ 13337.18","4.263","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.526","€ 39355.07","6.920","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.341","€ 40145.92","7.587","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.034","€ 8471.10","8.340","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.130","€ 28308.14","5.294","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":654},{"label":"Mar","value":519},{"label":"Abr","value":630},{"label":"Mai","value":758},{"label":"Jun","value":560},{"label":"Jul","value":638},{"label":"Ago","value":433},{"label":"Set","value":434},{"label":"Out","value":707},{"label":"Nov","value":393},{"label":"Dez","value":609}];
const MX = 758;
