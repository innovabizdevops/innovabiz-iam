...
const PAGE = "Service";
const KPIS = [{"l":"Projetos Melhoria","v":"752","t":"+8.1%","d":"up"},{"l":"Savings (€)","v":"€85668","t":"+13.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"74.4%","t":"+14.9%","d":"up"},{"l":"Ciclos PDCA","v":"1.885","t":"+1.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.901","€ 47366.27","563","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.801","€ 3573.82","8.561","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","9.087","€ 43303.54","1.785","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.955","€ 16521.36","465","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.317","€ 38756.63","5.394","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":842},{"label":"Mar","value":558},{"label":"Abr","value":782},{"label":"Mai","value":794},{"label":"Jun","value":647},{"label":"Jul","value":522},{"label":"Ago","value":597},{"label":"Set","value":526},{"label":"Out","value":789},{"label":"Nov","value":806},{"label":"Dez","value":697}];
const MX = 842;
