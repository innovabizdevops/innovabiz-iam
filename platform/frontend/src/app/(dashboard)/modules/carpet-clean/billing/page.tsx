...
const ACCENT = "#155e75";
const MODULE = "Carpet Cleaning";
const PAGE = "Billing";
const KPIS = [{"l":"Projetos Melhoria","v":"7.528","t":"+12.9%","d":"up"},{"l":"Savings (€)","v":"€25648","t":"-1.4%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"83.8%","t":"+6.0%","d":"up"},{"l":"Ciclos PDCA","v":"7.755","t":"+13.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.365","€ 1838.77","3.362","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.016","€ 36177.83","3.650","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.348","€ 48092.72","8.735","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.109","€ 20243.91","3.034","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.948","€ 1497.68","2.055","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":615},{"label":"Mar","value":547},{"label":"Abr","value":434},{"label":"Mai","value":722},{"label":"Jun","value":430},{"label":"Jul","value":677},{"label":"Ago","value":602},{"label":"Set","value":646},{"label":"Out","value":483},{"label":"Nov","value":612},{"label":"Dez","value":356}];
const MX = 722;
