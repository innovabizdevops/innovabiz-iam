...
const PAGE = "Chemical";
const KPIS = [{"l":"Projetos Melhoria","v":"6.383","t":"-0.2%","d":"down"},{"l":"Savings (€)","v":"€32031","t":"+6.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"83.3%","t":"+7.4%","d":"up"},{"l":"Ciclos PDCA","v":"6.326","t":"+13.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.109","€ 44606.77","5.725","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.577","€ 3307.47","3.686","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.831","€ 41682.47","4.383","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.330","€ 22736.00","8.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.909","€ 271.21","7.009","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":598},{"label":"Mar","value":677},{"label":"Abr","value":868},{"label":"Mai","value":828},{"label":"Jun","value":773},{"label":"Jul","value":878},{"label":"Ago","value":594},{"label":"Set","value":591},{"label":"Out","value":888},{"label":"Nov","value":723},{"label":"Dez","value":594}];
const MX = 888;
