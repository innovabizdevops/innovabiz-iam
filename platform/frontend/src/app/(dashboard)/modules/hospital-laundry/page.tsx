...
/* ═══ Hospital Laundry — Dashboard ═══ */

const ACCENT = "#083344";

const KPIS = [
    { label: "Total Registos", value: "857", trend: "+8%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3893", trend: "-2%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€454K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1953359857", cells: ["HOS-9857", "Hospital Laundry Item 1", "2/2/2026", "€9957"], status: "active" as const },
    { id: "1953363428", cells: ["HOS-4428", "Hospital Laundry Item 2", "17/9/2026", "€13 528"], status: "pending" as const },
    { id: "1953366999", cells: ["HOS-7999", "Hospital Laundry Item 3", "4/4/2026", "€17 099"], status: "completed" as const },
    { id: "1953370570", cells: ["HOS-2570", "Hospital Laundry Item 4", "19/11/2026", "€20 670"], status: "warning" as const },
    { id: "1953374141", cells: ["HOS-6141", "Hospital Laundry Item 5", "6/6/2026", "€24 241"], status: "active" as const },
];
...
export default function HospitalLaundryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Hospital Laundry</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Hospital Laundry</p>
                    </div>
                </div>
