...
const ACCENT = "#083344";
const MODULE = "Hospital Laundry";
const PAGE = "Track";
const KPIS = [{"l":"Total Hospital Laundry","v":"3.009","t":"+15.4%","d":"up"},{"l":"Track Ativos","v":"5.953","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.6%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospital Laundry #001","Hospital Laundry #002","8.331","1.809","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Hospital Laundry #002","Hospital Laundry #003","1.602","8.922","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospital Laundry #003","Hospital Laundry #004","4.084","3.784","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Hospital Laundry #004","Hospital Laundry #005","7.785","4.515","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospital Laundry #005","Hospital Laundry #001","5.824","1.084","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":931},{"label":"Fev","value":883},{"label":"Mar","value":804},{"label":"Abr","value":903},{"label":"Mai","value":815},{"label":"Jun","value":849},{"label":"Jul","value":695},{"label":"Ago","value":754},{"label":"Set","value":1041},{"label":"Out","value":903},{"label":"Nov","value":826},{"label":"Dez","value":1059}];
const MX = 1059;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#083344'}}>IoT</span></h1>
                </div>
