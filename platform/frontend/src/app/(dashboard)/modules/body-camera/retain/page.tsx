...
const PAGE = "Retain";
const KPIS = [{"l":"Total Body Camera","v":"1.891","t":"-2.8%","d":"down"},{"l":"Retain Ativos","v":"7.670","t":"+4.9%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"55","t":"+3.0%","d":"up"}];
const COLS = ["ID","Retain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Camera #001","2026-01-28","4.550","257","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Body Camera #002","2026-01-26","6.233","5.070","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Camera #003","2026-01-25","5.127","2.144","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Body Camera #004","2026-01-25","6.242","2.539","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Camera #005","2026-03-20","8.558","2.213","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":513},{"label":"Mar","value":442},{"label":"Abr","value":502},{"label":"Mai","value":595},{"label":"Jun","value":633},{"label":"Jul","value":466},{"label":"Ago","value":495},{"label":"Set","value":453},{"label":"Out","value":454},{"label":"Nov","value":715},{"label":"Dez","value":765}];
const MX = 765;
