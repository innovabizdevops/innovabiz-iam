...
const PAGE = "Assign";
const KPIS = [{"l":"Total Body Camera","v":"2.759","t":"+5.9%","d":"up"},{"l":"Assign Ativos","v":"1.546","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"+6.8%","d":"up"},{"l":"Score Performance","v":"75","t":"-1.7%","d":"down"}];
const COLS = ["ID","Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Camera #001","Body Camera #002","6.078","5.532","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Body Camera #002","Body Camera #003","5.955","3.764","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Camera #003","Body Camera #004","6.533","2.522","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Body Camera #004","Body Camera #005","7.022","1.085","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Camera #005","Body Camera #001","6.377","1.556","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":608},{"label":"Mar","value":791},{"label":"Abr","value":621},{"label":"Mai","value":620},{"label":"Jun","value":733},{"label":"Jul","value":634},{"label":"Ago","value":468},{"label":"Set","value":595},{"label":"Out","value":578},{"label":"Nov","value":554},{"label":"Dez","value":483}];
const MX = 791;
