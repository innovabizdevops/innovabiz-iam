...
const ACCENT = "#6366f1";
const MODULE = "Body Camera Mgmt";
const PAGE = "Redact";
const KPIS = [{"l":"Total Body Camera","v":"219","t":"+2.7%","d":"up"},{"l":"Redact Ativos","v":"7.693","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+5.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+11.3%","d":"up"}];
const COLS = ["ID","Redact","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Camera #001","Body Camera #002","2.071","959","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Body Camera #002","Body Camera #003","686","8.643","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Camera #003","Body Camera #004","1.293","425","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Body Camera #004","Body Camera #005","1.917","7.189","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Camera #005","Body Camera #001","8.981","7.371","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":495},{"label":"Mar","value":709},{"label":"Abr","value":712},{"label":"Mai","value":633},{"label":"Jun","value":792},{"label":"Jul","value":819},{"label":"Ago","value":498},{"label":"Set","value":829},{"label":"Out","value":472},{"label":"Nov","value":856},{"label":"Dez","value":662}];
const MX = 856;
