...
const PAGE = "Upload";
const KPIS = [{"l":"Total Body Camera","v":"3.811","t":"+14.2%","d":"up"},{"l":"Upload Ativos","v":"835","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"81.2%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"75","t":"+3.9%","d":"up"}];
const COLS = ["ID","Upload","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Camera #001","Body Camera #002","183","7.421","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Body Camera #002","Body Camera #003","4.782","3.310","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Camera #003","Body Camera #004","4.328","6.662","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Body Camera #004","Body Camera #005","3.130","5.483","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Camera #005","Body Camera #001","6.050","5.139","2026-01-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":481},{"label":"Mar","value":570},{"label":"Abr","value":265},{"label":"Mai","value":279},{"label":"Jun","value":255},{"label":"Jul","value":283},{"label":"Ago","value":416},{"label":"Set","value":331},{"label":"Out","value":385},{"label":"Nov","value":325},{"label":"Dez","value":304}];
const MX = 570;
