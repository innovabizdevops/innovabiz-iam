...
const PAGE = "Share";
const KPIS = [{"l":"Total Body Camera","v":"1.331","t":"+7.8%","d":"up"},{"l":"Share Ativos","v":"3.473","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"92.0%","t":"-0.7%","d":"down"},{"l":"Score Performance","v":"82","t":"-4.0%","d":"down"}];
const COLS = ["ID","Share","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Body Camera #001","Body Camera #002","8.273","3.679","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Body Camera #002","Body Camera #003","3.918","8.810","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Body Camera #003","Body Camera #004","5.777","5.565","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Body Camera #004","Body Camera #005","7.223","3.670","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Body Camera #005","Body Camera #001","3.650","3.012","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":597},{"label":"Mar","value":690},{"label":"Abr","value":588},{"label":"Mai","value":621},{"label":"Jun","value":774},{"label":"Jul","value":928},{"label":"Ago","value":674},{"label":"Set","value":758},{"label":"Out","value":826},{"label":"Nov","value":599},{"label":"Dez","value":842}];
const MX = 955;
