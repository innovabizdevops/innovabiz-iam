...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Fleet Mgmt Deep","v":"7.105","t":"+17.2%","d":"up"},{"l":"Maintain Ativos","v":"5.662","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"94.3%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"92","t":"+10.6%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt Deep #001","Fleet Mgmt Deep #002","5.238","9.065","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt Deep #002","Fleet Mgmt Deep #003","6.492","5.366","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt Deep #003","Fleet Mgmt Deep #004","8.744","2.724","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt Deep #004","Fleet Mgmt Deep #005","2.264","1.328","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt Deep #005","Fleet Mgmt Deep #001","7.779","2.915","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":512},{"label":"Mar","value":503},{"label":"Abr","value":598},{"label":"Mai","value":724},{"label":"Jun","value":468},{"label":"Jul","value":763},{"label":"Ago","value":747},{"label":"Set","value":773},{"label":"Out","value":623},{"label":"Nov","value":674},{"label":"Dez","value":552}];
const MX = 773;
