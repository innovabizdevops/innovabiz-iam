...
const PAGE = "Acquire";
const KPIS = [{"l":"Total Fleet Mgmt Deep","v":"8.687","t":"+2.6%","d":"up"},{"l":"Acquire Ativos","v":"8.381","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"65","t":"+13.9%","d":"up"}];
const COLS = ["ID","Acquire","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt Deep #001","Fleet Mgmt Deep #002","4.827","2.091","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt Deep #002","Fleet Mgmt Deep #003","5.491","8.485","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt Deep #003","Fleet Mgmt Deep #004","8.259","6.422","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt Deep #004","Fleet Mgmt Deep #005","8.777","1.393","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt Deep #005","Fleet Mgmt Deep #001","4.963","6.682","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":376},{"label":"Fev","value":567},{"label":"Mar","value":488},{"label":"Abr","value":762},{"label":"Mai","value":714},{"label":"Jun","value":427},{"label":"Jul","value":523},{"label":"Ago","value":734},{"label":"Set","value":436},{"label":"Out","value":702},{"label":"Nov","value":510},{"label":"Dez","value":435}];
const MX = 762;
