...
/* ═══ Fleet Management Deep — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "1704", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "648", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€131K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1855390304", cells: ["FLE-5304", "Fleet Management Deep Item 1", "13/9/2026", "€40 404"], status: "active" as const },
    { id: "1855393875", cells: ["FLE-8875", "Fleet Management Deep Item 2", "28/4/2026", "€43 975"], status: "pending" as const },
    { id: "1855397446", cells: ["FLE-3446", "Fleet Management Deep Item 3", "15/11/2026", "€47 546"], status: "completed" as const },
    { id: "1855401017", cells: ["FLE-7017", "Fleet Management Deep Item 4", "2/6/2026", "€1117"], status: "warning" as const },
    { id: "1855404588", cells: ["FLE-1588", "Fleet Management Deep Item 5", "17/1/2026", "€4688"], status: "active" as const },
];
...
export default function FleetManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fleet Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fleet Management Deep</p>
                    </div>
                </div>
