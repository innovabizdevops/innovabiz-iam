...
const ACCENT = "#92400e";
const MODULE = "Fleet Management Deep";
const PAGE = "Track";
const KPIS = [{"l":"Total Fleet Mgmt Deep","v":"4.688","t":"+6.5%","d":"up"},{"l":"Track Ativos","v":"5.361","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+9.6%","d":"up"}];
const COLS = ["ID","Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Fleet Mgmt Deep #001","Fleet Mgmt Deep #002","5.652","386","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Fleet Mgmt Deep #002","Fleet Mgmt Deep #003","5.205","7.082","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Fleet Mgmt Deep #003","Fleet Mgmt Deep #004","8.917","8.398","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Fleet Mgmt Deep #004","Fleet Mgmt Deep #005","6.898","7.480","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Fleet Mgmt Deep #005","Fleet Mgmt Deep #001","919","8.779","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":347},{"label":"Fev","value":541},{"label":"Mar","value":363},{"label":"Abr","value":405},{"label":"Mai","value":605},{"label":"Jun","value":285},{"label":"Jul","value":605},{"label":"Ago","value":497},{"label":"Set","value":447},{"label":"Out","value":379},{"label":"Nov","value":445},{"label":"Dez","value":582}];
const MX = 605;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#92400e'}}>IoT</span></h1>
                </div>
