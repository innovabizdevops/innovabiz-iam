...
export default function ContentManagementContentManagementPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Content Management Content Management</h1><p className="text-sm text-muted-foreground">Content Management Content Management • iBOS Enterprise</p></div>
