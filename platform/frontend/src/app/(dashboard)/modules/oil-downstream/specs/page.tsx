...
const PAGE = "Product Spec";
const KPIS = [{"l":"Total Oil Downstream","v":"432","t":"+6.0%","d":"up"},{"l":"Product Spec Ativos","v":"2.188","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+2.5%","d":"up"},{"l":"Score Performance","v":"79","t":"+11.0%","d":"up"}];
const COLS = ["ID","Product Spec","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Downstream #001","Oil Downstream #002","6.194","5.730","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Downstream #002","Oil Downstream #003","630","7.805","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Downstream #003","Oil Downstream #004","7.525","1.132","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Downstream #004","Oil Downstream #005","6.025","8.383","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Downstream #005","Oil Downstream #001","3.198","6.794","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":417},{"label":"Mar","value":317},{"label":"Abr","value":653},{"label":"Mai","value":314},{"label":"Jun","value":473},{"label":"Jul","value":493},{"label":"Ago","value":646},{"label":"Set","value":409},{"label":"Out","value":578},{"label":"Nov","value":338},{"label":"Dez","value":346}];
const MX = 653;
