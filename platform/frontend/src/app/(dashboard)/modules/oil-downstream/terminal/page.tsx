...
const PAGE = "Terminal Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"2.512","t":"-0.5%","d":"down"},{"l":"Mitigações Ativas","v":"1.418","t":"-0.1%","d":"down"},{"l":"Score Risco Geral","v":"85","t":"+8.0%","d":"up"},{"l":"Incidentes YTD","v":"2.583","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.529","1.819","3.470","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.638","3.410","1.532","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.249","144","2.137","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.291","320","6.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.016","6.213","6.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":317},{"label":"Mar","value":388},{"label":"Abr","value":567},{"label":"Mai","value":486},{"label":"Jun","value":549},{"label":"Jul","value":601},{"label":"Ago","value":624},{"label":"Set","value":562},{"label":"Out","value":626},{"label":"Nov","value":458},{"label":"Dez","value":313}];
const MX = 626;
