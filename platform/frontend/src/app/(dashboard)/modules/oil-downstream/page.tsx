...
export default function OilDownstreamPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Oil Downstream</h1><p className="text-sm text-muted-foreground">Oil Downstream • iBOS Enterprise</p></div>
