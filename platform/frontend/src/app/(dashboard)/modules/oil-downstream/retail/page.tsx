...
const PAGE = "Fuel Retail";
const KPIS = [{"l":"Pedidos/Dia","v":"2411","t":"+4.4%","d":"up"},{"l":"GMV (€)","v":"€62304","t":"+5.0%","d":"up"},{"l":"Conversão (%)","v":"94.9%","t":"+11.2%","d":"up"},{"l":"AOV (€)","v":"€88772","t":"-5.6%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 48176.03","1.296","2.695","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 4441.81","2.782","352","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 49144.46","1.494","6.193","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 37841.98","3.742","1.683","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 34213.08","9.010","3.429","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":575},{"label":"Mar","value":458},{"label":"Abr","value":380},{"label":"Mai","value":477},{"label":"Jun","value":534},{"label":"Jul","value":682},{"label":"Ago","value":709},{"label":"Set","value":541},{"label":"Out","value":681},{"label":"Nov","value":648},{"label":"Dez","value":661}];
const MX = 709;
