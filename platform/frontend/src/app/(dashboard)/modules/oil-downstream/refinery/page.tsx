...
const PAGE = "Refinery Ops";
const KPIS = [{"l":"Total Oil Downstream","v":"1.245","t":"+13.4%","d":"up"},{"l":"Refinery Ops Ativos","v":"773","t":"+2.4%","d":"up"},{"l":"Eficiência (%)","v":"78.1%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"90","t":"+15.6%","d":"up"}];
const COLS = ["ID","Refinery Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Downstream #001","Oil Downstream #002","1.186","8.537","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Downstream #002","Oil Downstream #003","5.888","8.247","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Downstream #003","Oil Downstream #004","1.167","1.570","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Downstream #004","Oil Downstream #005","2.217","1.097","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Downstream #005","Oil Downstream #001","1.289","2.347","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":775},{"label":"Mar","value":948},{"label":"Abr","value":869},{"label":"Mai","value":1004},{"label":"Jun","value":800},{"label":"Jul","value":902},{"label":"Ago","value":868},{"label":"Set","value":1002},{"label":"Out","value":845},{"label":"Nov","value":823},{"label":"Dez","value":950}];
const MX = 1004;
