...
const ACCENT = "#b45309";
const MODULE = "Oil Downstream";
const PAGE = "Blend Optimize";
const KPIS = [{"l":"Total Oil Downstream","v":"1.967","t":"-3.7%","d":"down"},{"l":"Blend Optimize Ativos","v":"7.106","t":"+12.0%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"69","t":"+6.0%","d":"up"}];
const COLS = ["ID","Blend Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Downstream #001","Oil Downstream #002","7.654","6.555","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Downstream #002","Oil Downstream #003","2.968","7.095","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Downstream #003","Oil Downstream #004","6.513","1.976","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Downstream #004","Oil Downstream #005","8.756","4.637","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Downstream #005","Oil Downstream #001","7.475","8.170","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":840},{"label":"Fev","value":913},{"label":"Mar","value":932},{"label":"Abr","value":987},{"label":"Mai","value":834},{"label":"Jun","value":1008},{"label":"Jul","value":869},{"label":"Ago","value":942},{"label":"Set","value":979},{"label":"Out","value":985},{"label":"Nov","value":942},{"label":"Dez","value":897}];
const MX = 1008;
