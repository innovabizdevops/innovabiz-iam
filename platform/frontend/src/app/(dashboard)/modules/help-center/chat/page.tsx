...
const PAGE = "Chat";
const KPIS = [{"l":"Artigos Publicados","v":"4.080","t":"+5.1%","d":"up"},{"l":"Views/Semana","v":"618","t":"+4.0%","d":"up"},{"l":"Feedback Útil (%)","v":"94.0%","t":"+11.0%","d":"up"},{"l":"Artigos Desatualizados","v":"3.522","t":"-5.9%","d":"down"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","508","73.8%","8.522","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","8.936","87.8%","545","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.103","89.7%","6.122","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.901","97.9%","1.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.507","80.5%","763","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":764},{"label":"Mar","value":767},{"label":"Abr","value":798},{"label":"Mai","value":773},{"label":"Jun","value":738},{"label":"Jul","value":718},{"label":"Ago","value":771},{"label":"Set","value":596},{"label":"Out","value":922},{"label":"Nov","value":975},{"label":"Dez","value":992}];
const MX = 992;
