...
const KPIS = [{"l":"Dashboards Ativos","v":"8.973","t":"+8.1%","d":"up"},{"l":"Queries/Dia","v":"5012","t":"+3.8%","d":"up"},{"l":"Dados Processados (GB)","v":"6.163","t":"+13.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.371","t":"+10.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3044","2026-01-14","3.009","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1231","2026-02-06","6.480","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4025","2026-02-21","5.760","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","372","2026-03-02","3.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1187","2026-02-06","8.150","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":458},{"label":"Mar","value":439},{"label":"Abr","value":275},{"label":"Mai","value":436},{"label":"Jun","value":263},{"label":"Jul","value":549},{"label":"Ago","value":276},{"label":"Set","value":484},{"label":"Out","value":309},{"label":"Nov","value":390},{"label":"Dez","value":459}];
const MX = 549;
