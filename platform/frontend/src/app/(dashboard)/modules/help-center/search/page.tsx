...
const ACCENT = "#059669";
const MODULE = "Help Center Platform";
const PAGE = "Search";
const KPIS = [{"l":"Artigos Publicados","v":"8.830","t":"-5.9%","d":"down"},{"l":"Views/Semana","v":"1270","t":"-5.0%","d":"down"},{"l":"Feedback Útil (%)","v":"81.2%","t":"-3.0%","d":"down"},{"l":"Artigos Desatualizados","v":"8.311","t":"+9.4%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.381","98.5%","7.971","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","4.041","72.8%","3.759","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.750","93.4%","7.181","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","3.904","97.1%","3.195","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.127","75.2%","5.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":639},{"label":"Mar","value":777},{"label":"Abr","value":857},{"label":"Mai","value":578},{"label":"Jun","value":946},{"label":"Jul","value":705},{"label":"Ago","value":798},{"label":"Set","value":845},{"label":"Out","value":779},{"label":"Nov","value":576},{"label":"Dez","value":813}];
const MX = 946;
