...
const PAGE = "Article";
const KPIS = [{"l":"Artigos Publicados","v":"1.406","t":"+0.1%","d":"up"},{"l":"Views/Semana","v":"3603","t":"+6.2%","d":"up"},{"l":"Feedback Útil (%)","v":"71.7%","t":"+6.3%","d":"up"},{"l":"Artigos Desatualizados","v":"2.682","t":"+2.0%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","6.813","70.5%","362","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","1.472","80.4%","9.013","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","1.984","71.1%","5.357","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.590","78.1%","8.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","3.906","81.8%","1.790","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":617},{"label":"Mar","value":723},{"label":"Abr","value":798},{"label":"Mai","value":566},{"label":"Jun","value":773},{"label":"Jul","value":539},{"label":"Ago","value":745},{"label":"Set","value":664},{"label":"Out","value":529},{"label":"Nov","value":912},{"label":"Dez","value":850}];
const MX = 912;
