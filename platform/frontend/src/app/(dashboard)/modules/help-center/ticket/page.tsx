...
const PAGE = "Ticket";
const KPIS = [{"l":"Tickets Abertos","v":"1.970","t":"-3.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"78.5%","t":"+8.8%","d":"up"},{"l":"MTTR (h)","v":"143h","t":"+17.7%","d":"up"},{"l":"Satisfação (%)","v":"83.5%","t":"+15.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.320","9.071","5.388","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.894","8.667","8.058","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.232","6.564","3.813","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.485","7.365","8.897","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.114","7.710","2.636","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":557},{"label":"Fev","value":590},{"label":"Mar","value":467},{"label":"Abr","value":616},{"label":"Mai","value":316},{"label":"Jun","value":380},{"label":"Jul","value":377},{"label":"Ago","value":663},{"label":"Set","value":595},{"label":"Out","value":568},{"label":"Nov","value":616},{"label":"Dez","value":408}];
const MX = 663;
