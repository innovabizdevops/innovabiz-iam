...
/* ═══ Help Center Platform — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "2264", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4166", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€340K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1022979064", cells: ["HEL-4064", "Help Center Platform Item 1", "17/5/2026", "€29 164"], status: "active" as const },
    { id: "1022982635", cells: ["HEL-7635", "Help Center Platform Item 2", "4/12/2026", "€32 735"], status: "pending" as const },
    { id: "1022986206", cells: ["HEL-2206", "Help Center Platform Item 3", "19/7/2026", "€36 306"], status: "completed" as const },
    { id: "1022989777", cells: ["HEL-5777", "Help Center Platform Item 4", "6/2/2026", "€39 877"], status: "warning" as const },
    { id: "1022993348", cells: ["HEL-9348", "Help Center Platform Item 5", "21/9/2026", "€43 448"], status: "active" as const },
];
...
export default function HelpCenterPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Help Center Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Help Center Platform</p>
                    </div>
                </div>
