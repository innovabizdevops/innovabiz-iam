...
const PAGE = "Fixed Assets";
const KPIS = [{"l":"Ativos Registados","v":"1.019","t":"+2.8%","d":"up"},{"l":"Valor Total (€M)","v":"€11.2M","t":"+10.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€85979","t":"-1.1%","d":"down"},{"l":"Ativos em Garantia","v":"4.925","t":"+11.3%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 29280.38","6.127","€ 19936.02","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 3485.57","7.319","€ 11925.02","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 26913.86","5.962","€ 18005.02","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 26466.23","1.665","€ 37580.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 1352.84","8.968","€ 19122.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":254},{"label":"Fev","value":410},{"label":"Mar","value":279},{"label":"Abr","value":444},{"label":"Mai","value":603},{"label":"Jun","value":492},{"label":"Jul","value":556},{"label":"Ago","value":291},{"label":"Set","value":544},{"label":"Out","value":461},{"label":"Nov","value":523},{"label":"Dez","value":597}];
const MX = 603;
