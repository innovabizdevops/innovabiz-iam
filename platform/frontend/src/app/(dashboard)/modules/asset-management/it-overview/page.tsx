...
const PAGE = "IT Assets";
const KPIS = [{"l":"Ativos Registados","v":"785","t":"+8.0%","d":"up"},{"l":"Valor Total (€M)","v":"€16.8M","t":"+7.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€7569","t":"+12.9%","d":"up"},{"l":"Ativos em Garantia","v":"4.454","t":"-4.8%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 5462.44","4.064","€ 9142.79","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 42511.75","2.614","€ 45123.90","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 48491.82","4.408","€ 41487.14","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 30548.56","379","€ 37162.65","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 36444.76","3.084","€ 15268.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":501},{"label":"Mar","value":524},{"label":"Abr","value":787},{"label":"Mai","value":608},{"label":"Jun","value":479},{"label":"Jul","value":474},{"label":"Ago","value":771},{"label":"Set","value":539},{"label":"Out","value":704},{"label":"Nov","value":509},{"label":"Dez","value":619}];
const MX = 787;
