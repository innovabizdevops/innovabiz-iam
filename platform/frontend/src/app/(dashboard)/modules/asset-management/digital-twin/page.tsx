...
const PAGE = "Digital Twin Assets";
const KPIS = [{"l":"Twins Ativos","v":"228","t":"+14.9%","d":"up"},{"l":"Simulações/Dia","v":"4313","t":"+0.1%","d":"up"},{"l":"Precisão Modelo (%)","v":"67.3%","t":"-3.2%","d":"down"},{"l":"Latência Sync (ms)","v":"76ms","t":"+12.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","76.7%","2026-02-20","774","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","70.9%","2026-03-18","3.866","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","97.7%","2026-01-07","4.881","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","81.3%","2026-01-26","4.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","94.6%","2026-01-28","1.770","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":735},{"label":"Mar","value":779},{"label":"Abr","value":609},{"label":"Mai","value":611},{"label":"Jun","value":533},{"label":"Jul","value":491},{"label":"Ago","value":522},{"label":"Set","value":643},{"label":"Out","value":657},{"label":"Nov","value":542},{"label":"Dez","value":691}];
const MX = 779;
