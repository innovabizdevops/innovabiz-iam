...
const PAGE = "Work Order Mgmt";
const KPIS = [{"l":"Ativos Registados","v":"8.479","t":"+0.0%","d":"up"},{"l":"Valor Total (€M)","v":"€27.7M","t":"+9.0%","d":"up"},{"l":"Depreciação Anual (€)","v":"€65901","t":"+14.8%","d":"up"},{"l":"Ativos em Garantia","v":"2.253","t":"-3.3%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 1068.64","3.654","€ 30686.22","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 39455.89","6.438","€ 18192.07","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 27004.33","3.135","€ 13335.85","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 1273.26","8.551","€ 39252.50","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 24291.85","1.851","€ 13288.92","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":771},{"label":"Mar","value":835},{"label":"Abr","value":787},{"label":"Mai","value":821},{"label":"Jun","value":767},{"label":"Jul","value":877},{"label":"Ago","value":615},{"label":"Set","value":722},{"label":"Out","value":755},{"label":"Nov","value":969},{"label":"Dez","value":830}];
const MX = 969;
