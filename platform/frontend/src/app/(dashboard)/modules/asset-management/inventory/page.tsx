...
const KPIS = [{"l":"Ativos Registados","v":"8.484","t":"-5.3%","d":"down"},{"l":"Valor Total (€M)","v":"€17.6M","t":"+6.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€1289","t":"+13.3%","d":"up"},{"l":"Ativos em Garantia","v":"3.004","t":"+0.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 37784.66","2.820","€ 10352.69","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 37459.32","1.565","€ 8490.09","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22034.60","8.588","€ 13906.51","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 46821.63","6.046","€ 15943.74","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 18068.31","1.480","€ 35087.60","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":282},{"label":"Fev","value":440},{"label":"Mar","value":487},{"label":"Abr","value":434},{"label":"Mai","value":627},{"label":"Jun","value":465},{"label":"Jul","value":467},{"label":"Ago","value":616},{"label":"Set","value":287},{"label":"Out","value":524},{"label":"Nov","value":573},{"label":"Dez","value":595}];
const MX = 627;
