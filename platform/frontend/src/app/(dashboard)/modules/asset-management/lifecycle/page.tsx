...
const KPIS = [{"l":"Ativos Registados","v":"4.404","t":"+16.7%","d":"up"},{"l":"Valor Total (€M)","v":"€28.3M","t":"-2.0%","d":"down"},{"l":"Depreciação Anual (€)","v":"€42881","t":"+13.8%","d":"up"},{"l":"Ativos em Garantia","v":"7.300","t":"+14.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 25041.54","718","€ 494.48","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 27847.96","4.084","€ 19963.84","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22843.45","661","€ 40713.16","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 33631.55","5.122","€ 26544.26","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 42975.56","8.202","€ 10246.06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":562},{"label":"Mar","value":276},{"label":"Abr","value":653},{"label":"Mai","value":517},{"label":"Jun","value":658},{"label":"Jul","value":641},{"label":"Ago","value":599},{"label":"Set","value":581},{"label":"Out","value":647},{"label":"Nov","value":606},{"label":"Dez","value":538}];
const MX = 658;
