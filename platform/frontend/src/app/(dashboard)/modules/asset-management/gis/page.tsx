...
const PAGE = "GIS / Spatial";
const KPIS = [{"l":"Ativos Registados","v":"8.178","t":"+12.9%","d":"up"},{"l":"Valor Total (€M)","v":"€18.1M","t":"+11.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€68510","t":"+13.2%","d":"up"},{"l":"Ativos em Garantia","v":"4.812","t":"-3.2%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 18308.32","376","€ 118.26","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 46255.47","1.389","€ 18042.70","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 43727.58","6.000","€ 36148.42","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 9569.05","546","€ 36292.94","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 47458.79","6.821","€ 36126.81","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":871},{"label":"Mar","value":578},{"label":"Abr","value":818},{"label":"Mai","value":752},{"label":"Jun","value":683},{"label":"Jul","value":814},{"label":"Ago","value":819},{"label":"Set","value":739},{"label":"Out","value":714},{"label":"Nov","value":568},{"label":"Dez","value":585}];
const MX = 871;
