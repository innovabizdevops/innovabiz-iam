...
const PAGE = "Depreciation";
const KPIS = [{"l":"Ativos Registados","v":"3.839","t":"+13.0%","d":"up"},{"l":"Valor Total (€M)","v":"€48.5M","t":"+10.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€63576","t":"+3.3%","d":"up"},{"l":"Ativos em Garantia","v":"1.023","t":"-4.9%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 26209.14","9.023","€ 31527.19","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 12554.52","7.275","€ 34133.08","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 21001.94","5.192","€ 19113.34","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 34093.54","3.208","€ 23131.49","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 49759.51","2.624","€ 28235.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":776},{"label":"Fev","value":744},{"label":"Mar","value":555},{"label":"Abr","value":772},{"label":"Mai","value":468},{"label":"Jun","value":586},{"label":"Jul","value":711},{"label":"Ago","value":851},{"label":"Set","value":477},{"label":"Out","value":683},{"label":"Nov","value":735},{"label":"Dez","value":485}];
const MX = 851;
