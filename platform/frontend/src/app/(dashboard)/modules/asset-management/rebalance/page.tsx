...
const PAGE = "Rebalance";
const KPIS = [{"l":"Ativos Registados","v":"7.876","t":"-1.7%","d":"down"},{"l":"Valor Total (€M)","v":"€21.6M","t":"+10.3%","d":"up"},{"l":"Depreciação Anual (€)","v":"€30627","t":"-3.4%","d":"down"},{"l":"Ativos em Garantia","v":"4.272","t":"+17.2%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 41160.15","4.810","€ 43525.16","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 6726.99","6.168","€ 1704.89","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 6157.39","7.447","€ 26236.29","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 4346.47","178","€ 7286.16","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 41349.87","8.913","€ 31478.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":692},{"label":"Mar","value":784},{"label":"Abr","value":724},{"label":"Mai","value":1027},{"label":"Jun","value":714},{"label":"Jul","value":910},{"label":"Ago","value":742},{"label":"Set","value":749},{"label":"Out","value":763},{"label":"Nov","value":930},{"label":"Dez","value":845}];
const MX = 1055;
