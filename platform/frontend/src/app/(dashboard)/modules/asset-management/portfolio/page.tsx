...
const KPIS = [{"l":"Ativos Registados","v":"5.441","t":"+15.4%","d":"up"},{"l":"Valor Total (€M)","v":"€4.6M","t":"+1.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€48028","t":"+6.2%","d":"up"},{"l":"Ativos em Garantia","v":"8.108","t":"-4.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 22105.13","3.662","€ 22216.88","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 31872.58","7.544","€ 39237.56","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 45565.52","6.071","€ 7145.59","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 3316.82","427","€ 26560.59","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 20969.32","7.004","€ 10175.70","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":566},{"label":"Fev","value":635},{"label":"Mar","value":401},{"label":"Abr","value":335},{"label":"Mai","value":361},{"label":"Jun","value":386},{"label":"Jul","value":505},{"label":"Ago","value":324},{"label":"Set","value":412},{"label":"Out","value":389},{"label":"Nov","value":276},{"label":"Dez","value":370}];
const MX = 635;
