...
const PAGE = "CMDB";
const KPIS = [{"l":"Ativos Registados","v":"4.095","t":"-3.7%","d":"down"},{"l":"Valor Total (€M)","v":"€24.9M","t":"-5.7%","d":"down"},{"l":"Depreciação Anual (€)","v":"€28142","t":"+15.2%","d":"up"},{"l":"Ativos em Garantia","v":"7.964","t":"+2.0%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 38230.55","5.258","€ 23656.48","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 16067.70","5.022","€ 40379.70","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 14785.57","3.873","€ 36497.50","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 29540.62","8.145","€ 40303.83","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 6049.50","6.983","€ 10766.74","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":369},{"label":"Mar","value":602},{"label":"Abr","value":446},{"label":"Mai","value":579},{"label":"Jun","value":586},{"label":"Jul","value":460},{"label":"Ago","value":553},{"label":"Set","value":335},{"label":"Out","value":399},{"label":"Nov","value":476},{"label":"Dez","value":674}];
const MX = 677;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>ITIL</span></h1>
                </div>
