...
const PAGE = "Work Planning";
const KPIS = [{"l":"Ativos Registados","v":"6.276","t":"-1.2%","d":"down"},{"l":"Valor Total (€M)","v":"€17.6M","t":"+12.5%","d":"up"},{"l":"Depreciação Anual (€)","v":"€27280","t":"+1.8%","d":"up"},{"l":"Ativos em Garantia","v":"1.019","t":"-4.8%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 8800.03","2.183","€ 47665.23","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 29195.91","5.704","€ 42781.53","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 3939.85","6.006","€ 24532.98","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 32387.50","8.726","€ 13454.56","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 8912.25","5.773","€ 15662.72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":736},{"label":"Fev","value":518},{"label":"Mar","value":825},{"label":"Abr","value":721},{"label":"Mai","value":809},{"label":"Jun","value":787},{"label":"Jul","value":799},{"label":"Ago","value":639},{"label":"Set","value":661},{"label":"Out","value":715},{"label":"Nov","value":721},{"label":"Dez","value":861}];
const MX = 861;
