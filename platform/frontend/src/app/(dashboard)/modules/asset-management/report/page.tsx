...
const PAGE = "Report";
const KPIS = [{"l":"Ativos Registados","v":"3.537","t":"+15.8%","d":"up"},{"l":"Valor Total (€M)","v":"€31.8M","t":"+5.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€15815","t":"+0.2%","d":"up"},{"l":"Ativos em Garantia","v":"111","t":"-4.0%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 27066.34","4.213","€ 42536.20","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 45497.58","1.668","€ 11651.74","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 2893.97","6.152","€ 18913.47","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 49935.03","5.443","€ 18169.52","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 11893.09","1.801","€ 29350.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":968},{"label":"Mar","value":871},{"label":"Abr","value":611},{"label":"Mai","value":874},{"label":"Jun","value":771},{"label":"Jul","value":886},{"label":"Ago","value":661},{"label":"Set","value":785},{"label":"Out","value":850},{"label":"Nov","value":806},{"label":"Dez","value":680}];
const MX = 968;
