...
const PAGE = "CMMS";
const KPIS = [{"l":"Ativos Registados","v":"6.913","t":"+4.5%","d":"up"},{"l":"Valor Total (€M)","v":"€10.2M","t":"+13.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€90855","t":"+4.7%","d":"up"},{"l":"Ativos em Garantia","v":"7.662","t":"-1.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 40324.52","6.014","€ 38304.93","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 48811.18","1.541","€ 34972.65","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 41639.47","8.968","€ 40590.35","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 30561.46","6.834","€ 31441.58","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 49401.71","4.396","€ 25649.98","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":773},{"label":"Mar","value":587},{"label":"Abr","value":567},{"label":"Mai","value":522},{"label":"Jun","value":718},{"label":"Jul","value":588},{"label":"Ago","value":593},{"label":"Set","value":513},{"label":"Out","value":817},{"label":"Nov","value":590},{"label":"Dez","value":786}];
const MX = 833;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>New</span></h1>
                </div>
