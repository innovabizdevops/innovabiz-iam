...
const KPIS = [{"l":"Formulários Ativos","v":"1.878","t":"+8.4%","d":"up"},{"l":"Submissões/Dia","v":"4654","t":"-0.6%","d":"down"},{"l":"Documentos Gerados","v":"1.034","t":"+6.9%","d":"up"},{"l":"Templates","v":"6.188","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.086","2026-03-14","8.656","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.114","2026-01-24","1.946","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","764","2026-02-17","6.337","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.349","2026-02-26","4.102","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.275","2026-01-14","927","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":929},{"label":"Fev","value":944},{"label":"Mar","value":861},{"label":"Abr","value":794},{"label":"Mai","value":664},{"label":"Jun","value":771},{"label":"Jul","value":816},{"label":"Ago","value":855},{"label":"Set","value":910},{"label":"Out","value":745},{"label":"Nov","value":970},{"label":"Dez","value":961}];
const MX = 970;
