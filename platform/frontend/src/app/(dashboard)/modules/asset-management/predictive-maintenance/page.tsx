...
const PAGE = "Predictive Maintenance AI";
const KPIS = [{"l":"Integrações Ativas","v":"855","t":"-3.0%","d":"down"},{"l":"Chamadas/Hora","v":"2407","t":"-4.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.2%","t":"+14.5%","d":"up"},{"l":"Latência Média (ms)","v":"201ms","t":"-5.4%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.152","7.025","81.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","957","1.104","96.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.075","4.938","90.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.500","2.477","95.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","622","475","79.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":469},{"label":"Fev","value":517},{"label":"Mar","value":387},{"label":"Abr","value":334},{"label":"Mai","value":355},{"label":"Jun","value":566},{"label":"Jul","value":395},{"label":"Ago","value":389},{"label":"Set","value":509},{"label":"Out","value":623},{"label":"Nov","value":521},{"label":"Dez","value":250}];
const MX = 623;
