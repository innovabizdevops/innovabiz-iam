...
const PAGE = "Order";
const KPIS = [{"l":"Ativos Registados","v":"2.038","t":"+12.7%","d":"up"},{"l":"Valor Total (€M)","v":"€26.2M","t":"+15.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€55529","t":"+8.6%","d":"up"},{"l":"Ativos em Garantia","v":"3.881","t":"+2.2%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 43145.25","7.270","€ 36556.47","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 32994.96","1.189","€ 4483.99","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 22381.67","5.609","€ 21921.96","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 28959.40","4.065","€ 43394.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 34028.98","7.896","€ 29616.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":751},{"label":"Mar","value":728},{"label":"Abr","value":704},{"label":"Mai","value":562},{"label":"Jun","value":846},{"label":"Jul","value":831},{"label":"Ago","value":742},{"label":"Set","value":667},{"label":"Out","value":770},{"label":"Nov","value":869},{"label":"Dez","value":809}];
const MX = 869;
