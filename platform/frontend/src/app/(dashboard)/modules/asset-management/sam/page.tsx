...
const ACCENT = "#1e3a5f";
const MODULE = "Asset Management Platform";
const PAGE = "SAM License Mgmt";
const KPIS = [{"l":"Ativos Registados","v":"6.359","t":"+2.3%","d":"up"},{"l":"Valor Total (€M)","v":"€48.1M","t":"+10.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€66371","t":"+0.1%","d":"up"},{"l":"Ativos em Garantia","v":"1.247","t":"-2.0%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 37338.34","1.150","€ 44903.66","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 26328.33","5.145","€ 25809.46","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 11971.30","4.946","€ 13750.69","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 556.18","1.609","€ 12701.87","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 9619.79","6.429","€ 13819.39","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":706},{"label":"Fev","value":485},{"label":"Mar","value":443},{"label":"Abr","value":682},{"label":"Mai","value":687},{"label":"Jun","value":393},{"label":"Jul","value":505},{"label":"Ago","value":641},{"label":"Set","value":693},{"label":"Out","value":478},{"label":"Nov","value":664},{"label":"Dez","value":736}];
const MX = 736;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e3a5f'}}>ITAM</span></h1>
                </div>
