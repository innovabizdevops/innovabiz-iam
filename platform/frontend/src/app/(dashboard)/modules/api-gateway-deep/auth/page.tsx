...
const PAGE = "Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"4.748","t":"+16.5%","d":"up"},{"l":"Sessões/Dia","v":"618","t":"+10.7%","d":"up"},{"l":"MFA Adoção (%)","v":"73.1%","t":"-3.8%","d":"down"},{"l":"Tentativas Bloqueadas","v":"3.071","t":"-2.1%","d":"down"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.032","2.431","6.994","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","2.931","8.249","4.667","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.432","410","5.603","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.395","5.291","149","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.777","4.327","5.826","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":827},{"label":"Mar","value":816},{"label":"Abr","value":818},{"label":"Mai","value":969},{"label":"Jun","value":849},{"label":"Jul","value":1000},{"label":"Ago","value":867},{"label":"Set","value":963},{"label":"Out","value":986},{"label":"Nov","value":942},{"label":"Dez","value":1003}];
const MX = 1003;
