...
const ACCENT = "#0d9488";
const MODULE = "API Gateway Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Integrações Ativas","v":"7.227","t":"-0.9%","d":"down"},{"l":"Chamadas/Hora","v":"317","t":"+11.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.9%","t":"+10.4%","d":"up"},{"l":"Latência Média (ms)","v":"185ms","t":"+12.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.612","1.815","72.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.485","6.869","81.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.283","6.477","98.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.590","9.063","75.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.709","6.072","98.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":823},{"label":"Mar","value":857},{"label":"Abr","value":660},{"label":"Mai","value":805},{"label":"Jun","value":783},{"label":"Jul","value":935},{"label":"Ago","value":892},{"label":"Set","value":650},{"label":"Out","value":743},{"label":"Nov","value":821},{"label":"Dez","value":702}];
const MX = 935;
