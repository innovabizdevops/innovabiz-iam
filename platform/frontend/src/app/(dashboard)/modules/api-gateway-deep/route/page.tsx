...
const PAGE = "Route";
const KPIS = [{"l":"Integrações Ativas","v":"1.351","t":"+13.5%","d":"up"},{"l":"Chamadas/Hora","v":"1674","t":"+9.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.9%","t":"+11.1%","d":"up"},{"l":"Latência Média (ms)","v":"186ms","t":"+15.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.077","196","82.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.378","479","93.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.450","8.540","78.3%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","153","6.451","98.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.553","1.757","77.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":995},{"label":"Fev","value":757},{"label":"Mar","value":648},{"label":"Abr","value":839},{"label":"Mai","value":889},{"label":"Jun","value":933},{"label":"Jul","value":969},{"label":"Ago","value":978},{"label":"Set","value":685},{"label":"Out","value":984},{"label":"Nov","value":640},{"label":"Dez","value":860}];
const MX = 995;
