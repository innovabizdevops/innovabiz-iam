...
const PAGE = "Rate";
const KPIS = [{"l":"Integrações Ativas","v":"8.941","t":"+10.4%","d":"up"},{"l":"Chamadas/Hora","v":"700","t":"+17.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"67.3%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"118ms","t":"+1.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.086","6.208","75.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.341","5.164","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.331","1.536","74.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.749","7.922","96.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.637","3.984","84.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":711},{"label":"Mar","value":724},{"label":"Abr","value":875},{"label":"Mai","value":933},{"label":"Jun","value":889},{"label":"Jul","value":953},{"label":"Ago","value":1067},{"label":"Set","value":748},{"label":"Out","value":911},{"label":"Nov","value":990},{"label":"Dez","value":889}];
const MX = 1067;
