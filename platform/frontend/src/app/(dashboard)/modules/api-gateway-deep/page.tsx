...
/* ═══ API Gateway Deep — Dashboard ═══ */

const ACCENT = "#0d9488";

const KPIS = [
    { label: "Total Registos", value: "4893", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4403", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€54K", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "197786993", cells: ["API-3993", "API Gateway Deep Item 1", "6/6/2026", "€37 093"], status: "active" as const },
    { id: "197790564", cells: ["API-7564", "API Gateway Deep Item 2", "21/1/2026", "€40 664"], status: "pending" as const },
    { id: "197794135", cells: ["API-2135", "API Gateway Deep Item 3", "8/8/2026", "€44 235"], status: "completed" as const },
    { id: "197797706", cells: ["API-5706", "API Gateway Deep Item 4", "23/3/2026", "€47 806"], status: "warning" as const },
    { id: "197801277", cells: ["API-9277", "API Gateway Deep Item 5", "10/10/2026", "€1377"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">API Gateway Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • API Gateway Deep</p>
                    </div>
                </div>
