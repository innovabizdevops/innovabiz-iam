...
const KPIS = [{"l":"Formulários Ativos","v":"1.788","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"2098","t":"-1.4%","d":"down"},{"l":"Documentos Gerados","v":"140","t":"-4.3%","d":"down"},{"l":"Templates","v":"8.572","t":"+13.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.451","2026-03-04","7.008","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","637","2026-02-24","3.753","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.269","2026-01-26","5.600","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.370","2026-01-13","4.236","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.382","2026-02-25","2.317","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":414},{"label":"Mar","value":460},{"label":"Abr","value":281},{"label":"Mai","value":276},{"label":"Jun","value":611},{"label":"Jul","value":585},{"label":"Ago","value":405},{"label":"Set","value":522},{"label":"Out","value":287},{"label":"Nov","value":505},{"label":"Dez","value":376}];
const MX = 611;
