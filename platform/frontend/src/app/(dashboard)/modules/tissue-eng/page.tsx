...
export default function TissueEngPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Tissue Eng</h1><p className="text-sm text-muted-foreground">Tissue Eng • iBOS Enterprise</p></div>
