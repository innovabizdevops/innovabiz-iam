...
const PAGE = "Cell Culture";
const KPIS = [{"l":"Total Tissue Eng","v":"8.151","t":"+14.6%","d":"up"},{"l":"Cell Culture Ativos","v":"4.367","t":"-6.0%","d":"down"},{"l":"Eficiência (%)","v":"83.4%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"76","t":"+3.3%","d":"up"}];
const COLS = ["ID","Cell Culture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Eng #001","Tissue Eng #002","5.849","458","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Eng #002","Tissue Eng #003","345","8.489","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Eng #003","Tissue Eng #004","6.414","7.335","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Eng #004","Tissue Eng #005","6.503","2.597","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Eng #005","Tissue Eng #001","8.176","6.160","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":331},{"label":"Fev","value":540},{"label":"Mar","value":447},{"label":"Abr","value":313},{"label":"Mai","value":609},{"label":"Jun","value":384},{"label":"Jul","value":314},{"label":"Ago","value":559},{"label":"Set","value":410},{"label":"Out","value":281},{"label":"Nov","value":328},{"label":"Dez","value":418}];
const MX = 609;
