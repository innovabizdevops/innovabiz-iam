...
const PAGE = "Implant";
const KPIS = [{"l":"Total Tissue Eng","v":"8.440","t":"+10.1%","d":"up"},{"l":"Implant Ativos","v":"3.758","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"64","t":"-4.9%","d":"down"}];
const COLS = ["ID","Implant","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Eng #001","Tissue Eng #002","1.173","6.119","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Eng #002","Tissue Eng #003","2.330","3.928","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Eng #003","Tissue Eng #004","8.412","8.408","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Eng #004","Tissue Eng #005","3.221","4.239","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Eng #005","Tissue Eng #001","1.505","3.105","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":763},{"label":"Mar","value":669},{"label":"Abr","value":749},{"label":"Mai","value":431},{"label":"Jun","value":613},{"label":"Jul","value":518},{"label":"Ago","value":676},{"label":"Set","value":590},{"label":"Out","value":548},{"label":"Nov","value":475},{"label":"Dez","value":539}];
const MX = 763;
