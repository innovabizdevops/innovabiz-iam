...
const ACCENT = "#6366f1";
const MODULE = "Tissue Engineering";
const PAGE = "Bioprint";
const KPIS = [{"l":"Total Tissue Eng","v":"507","t":"-1.8%","d":"down"},{"l":"Bioprint Ativos","v":"5.555","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"86.3%","t":"+12.0%","d":"up"},{"l":"Score Performance","v":"75","t":"+7.7%","d":"up"}];
const COLS = ["ID","Bioprint","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Tissue Eng #001","Tissue Eng #002","1.074","3.253","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Tissue Eng #002","Tissue Eng #003","2.892","1.653","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Tissue Eng #003","Tissue Eng #004","851","1.102","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Tissue Eng #004","Tissue Eng #005","1.898","1.349","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Tissue Eng #005","Tissue Eng #001","2.550","1.893","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":953},{"label":"Mar","value":734},{"label":"Abr","value":685},{"label":"Mai","value":641},{"label":"Jun","value":807},{"label":"Jul","value":907},{"label":"Ago","value":945},{"label":"Set","value":660},{"label":"Out","value":869},{"label":"Nov","value":850},{"label":"Dez","value":801}];
const MX = 953;
