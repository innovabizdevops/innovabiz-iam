...
const PAGE = "Workforce";
const KPIS = [{"l":"eNPS","v":"79","t":"+10.7%","d":"up"},{"l":"Engagement (%)","v":"86.3%","t":"+1.7%","d":"up"},{"l":"Turnover (%)","v":"80.5%","t":"+6.2%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.211","t":"+8.0%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.251","2026-01-28","82","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.404","2026-02-03","62","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","5.807","2026-03-06","56","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.131","2026-03-16","70","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.181","2026-01-18","75","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":453},{"label":"Mar","value":731},{"label":"Abr","value":553},{"label":"Mai","value":598},{"label":"Jun","value":560},{"label":"Jul","value":672},{"label":"Ago","value":429},{"label":"Set","value":633},{"label":"Out","value":657},{"label":"Nov","value":644},{"label":"Dez","value":724}];
const MX = 731;
