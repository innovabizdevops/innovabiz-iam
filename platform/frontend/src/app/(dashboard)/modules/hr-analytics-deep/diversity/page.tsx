...
const KPIS = [{"l":"eNPS","v":"64","t":"+8.9%","d":"up"},{"l":"Engagement (%)","v":"66.7%","t":"+16.0%","d":"up"},{"l":"Turnover (%)","v":"83.1%","t":"+1.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"4.793","t":"-0.6%","d":"down"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.106","2026-03-01","63","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","5.079","2026-03-01","68","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.131","2026-03-07","78","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","8.826","2026-02-20","66","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","6.554","2026-01-12","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":334},{"label":"Mar","value":425},{"label":"Abr","value":580},{"label":"Mai","value":547},{"label":"Jun","value":477},{"label":"Jul","value":561},{"label":"Ago","value":545},{"label":"Set","value":490},{"label":"Out","value":283},{"label":"Nov","value":256},{"label":"Dez","value":496}];
const MX = 580;
