...
/* ═══ HR Analytics Deep (People) — Dashboard ═══ */

const ACCENT = "#4338ca";

const KPIS = [
    { label: "Total Registos", value: "8065", trend: "-16%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2549", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€311K", trend: "+4%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "-23%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1224598365", cells: ["HR-5365", "HR Analytics Deep (People) Item 1", "26/10/2026", "€48 465"], status: "active" as const },
    { id: "1224601936", cells: ["HR-8936", "HR Analytics Deep (People) Item 2", "13/5/2026", "€2036"], status: "pending" as const },
    { id: "1224605507", cells: ["HR-3507", "HR Analytics Deep (People) Item 3", "28/12/2026", "€5607"], status: "completed" as const },
    { id: "1224609078", cells: ["HR-7078", "HR Analytics Deep (People) Item 4", "15/7/2026", "€9178"], status: "warning" as const },
    { id: "1224612649", cells: ["HR-1649", "HR Analytics Deep (People) Item 5", "2/2/2026", "€12 749"], status: "active" as const },
];
...
export default function HrAnalyticsDeepPeoplePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HR Analytics Deep (People)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HR Analytics Deep (People)</p>
                    </div>
                </div>
