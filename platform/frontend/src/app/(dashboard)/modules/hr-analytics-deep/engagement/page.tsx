...
const KPIS = [{"l":"eNPS","v":"68","t":"+1.6%","d":"up"},{"l":"Engagement (%)","v":"92.2%","t":"+12.8%","d":"up"},{"l":"Turnover (%)","v":"92.1%","t":"+5.0%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"5.862","t":"+2.3%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","6.253","2026-01-21","84","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.677","2026-03-14","80","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.251","2026-03-09","88","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.868","2026-01-04","77","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.140","2026-02-07","80","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":923},{"label":"Mar","value":782},{"label":"Abr","value":703},{"label":"Mai","value":997},{"label":"Jun","value":821},{"label":"Jul","value":922},{"label":"Ago","value":1045},{"label":"Set","value":886},{"label":"Out","value":825},{"label":"Nov","value":852},{"label":"Dez","value":771}];
const MX = 1045;
