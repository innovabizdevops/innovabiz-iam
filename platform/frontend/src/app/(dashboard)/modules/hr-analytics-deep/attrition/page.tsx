...
const ACCENT = "#4338ca";
const MODULE = "HR Analytics Deep (People)";
const PAGE = "Attrition";
const KPIS = [{"l":"eNPS","v":"71","t":"+4.5%","d":"up"},{"l":"Engagement (%)","v":"81.3%","t":"+1.2%","d":"up"},{"l":"Turnover (%)","v":"88.4%","t":"+7.5%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"6.443","t":"+2.6%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","2.354","2026-03-20","73","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","2.390","2026-02-25","66","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","7.412","2026-01-10","56","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.852","2026-01-22","64","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","8.422","2026-02-12","84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":585},{"label":"Mar","value":624},{"label":"Abr","value":482},{"label":"Mai","value":280},{"label":"Jun","value":556},{"label":"Jul","value":575},{"label":"Ago","value":360},{"label":"Set","value":389},{"label":"Out","value":285},{"label":"Nov","value":386},{"label":"Dez","value":624}];
const MX = 624;
