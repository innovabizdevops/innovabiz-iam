...
const PAGE = "Cost";
const KPIS = [{"l":"eNPS","v":"72","t":"+11.1%","d":"up"},{"l":"Engagement (%)","v":"81.4%","t":"-4.7%","d":"down"},{"l":"Turnover (%)","v":"76.3%","t":"-1.6%","d":"down"},{"l":"Time-to-Productivity (dias)","v":"5.205","t":"+12.2%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","3.447","2026-03-25","80","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","8.020","2026-02-22","61","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","353","2026-02-28","91","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","4.627","2026-01-13","58","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.817","2026-02-20","67","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":643},{"label":"Mar","value":830},{"label":"Abr","value":579},{"label":"Mai","value":820},{"label":"Jun","value":502},{"label":"Jul","value":676},{"label":"Ago","value":826},{"label":"Set","value":461},{"label":"Out","value":678},{"label":"Nov","value":583},{"label":"Dez","value":676}];
const MX = 830;
