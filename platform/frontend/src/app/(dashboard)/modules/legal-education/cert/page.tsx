...
const ACCENT = "#6366f1";
const MODULE = "Legal Education";
const PAGE = "Certification";
const KPIS = [{"l":"Total Legal Education","v":"4.474","t":"-2.5%","d":"down"},{"l":"Certification Ativos","v":"5.232","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"76.1%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"56","t":"-2.3%","d":"down"}];
const COLS = ["ID","Certification","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Legal Education #001","Legal Education #002","4.857","8.118","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Legal Education #002","Legal Education #003","617","8.602","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Legal Education #003","Legal Education #004","8.293","1.743","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Legal Education #004","Legal Education #005","5.524","6.244","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Legal Education #005","Legal Education #001","5.456","1.231","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":843},{"label":"Mar","value":969},{"label":"Abr","value":827},{"label":"Mai","value":868},{"label":"Jun","value":921},{"label":"Jul","value":730},{"label":"Ago","value":924},{"label":"Set","value":897},{"label":"Out","value":782},{"label":"Nov","value":693},{"label":"Dez","value":985}];
const MX = 985;
