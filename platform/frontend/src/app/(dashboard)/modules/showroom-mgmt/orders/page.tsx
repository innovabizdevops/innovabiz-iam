...
const KPIS = [{"l":"Total Showroom Mgmt","v":"6.956","t":"+4.6%","d":"up"},{"l":"Order Entry Ativos","v":"8.436","t":"+17.0%","d":"up"},{"l":"Eficiência (%)","v":"83.7%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"89","t":"+4.2%","d":"up"}];
const COLS = ["ID","Order Entry","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Showroom Mgmt #001","Showroom Mgmt #002","9.008","5.218","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Showroom Mgmt #002","Showroom Mgmt #003","5.906","3.456","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Showroom Mgmt #003","Showroom Mgmt #004","4.780","226","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Showroom Mgmt #004","Showroom Mgmt #005","8.069","2.885","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Showroom Mgmt #005","Showroom Mgmt #001","5.657","5.559","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":648},{"label":"Mar","value":624},{"label":"Abr","value":639},{"label":"Mai","value":683},{"label":"Jun","value":385},{"label":"Jul","value":606},{"label":"Ago","value":704},{"label":"Set","value":629},{"label":"Out","value":446},{"label":"Nov","value":409},{"label":"Dez","value":606}];
const MX = 704;
