...
const PAGE = "Line Sheet";
const KPIS = [{"l":"Total Showroom Mgmt","v":"205","t":"+7.8%","d":"up"},{"l":"Line Sheet Ativos","v":"325","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"69.6%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"75","t":"+12.1%","d":"up"}];
const COLS = ["ID","Line Sheet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Showroom Mgmt #001","Showroom Mgmt #002","4.099","6.292","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Showroom Mgmt #002","Showroom Mgmt #003","6.010","5.018","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Showroom Mgmt #003","Showroom Mgmt #004","1.205","8.844","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Showroom Mgmt #004","Showroom Mgmt #005","1.262","5.244","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Showroom Mgmt #005","Showroom Mgmt #001","1.948","8.986","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":396},{"label":"Fev","value":711},{"label":"Mar","value":680},{"label":"Abr","value":457},{"label":"Mai","value":567},{"label":"Jun","value":434},{"label":"Jul","value":439},{"label":"Ago","value":779},{"label":"Set","value":678},{"label":"Out","value":496},{"label":"Nov","value":440},{"label":"Dez","value":568}];
const MX = 779;
