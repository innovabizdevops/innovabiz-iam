...
const PAGE = "Look Book";
const KPIS = [{"l":"Total Showroom Mgmt","v":"383","t":"+6.3%","d":"up"},{"l":"Look Book Ativos","v":"2.319","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+9.4%","d":"up"},{"l":"Score Performance","v":"73","t":"+10.8%","d":"up"}];
const COLS = ["ID","Look Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Showroom Mgmt #001","Showroom Mgmt #002","1.213","4.992","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Showroom Mgmt #002","Showroom Mgmt #003","6.743","1.509","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Showroom Mgmt #003","Showroom Mgmt #004","8.499","2.489","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Showroom Mgmt #004","Showroom Mgmt #005","1.623","7.020","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Showroom Mgmt #005","Showroom Mgmt #001","1.771","3.853","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":534},{"label":"Mar","value":600},{"label":"Abr","value":658},{"label":"Mai","value":711},{"label":"Jun","value":630},{"label":"Jul","value":729},{"label":"Ago","value":646},{"label":"Set","value":480},{"label":"Out","value":581},{"label":"Nov","value":482},{"label":"Dez","value":518}];
const MX = 729;
