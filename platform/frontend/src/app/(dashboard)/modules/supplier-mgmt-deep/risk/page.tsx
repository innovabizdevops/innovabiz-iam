...
const ACCENT = "#78350f";
const MODULE = "Supplier Management Deep";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"3.203","t":"+11.0%","d":"up"},{"l":"Mitigações Ativas","v":"8.017","t":"+0.0%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"-1.7%","d":"down"},{"l":"Incidentes YTD","v":"7.871","t":"+14.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.265","2.790","3.873","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.404","7.834","8.038","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.201","2.563","5.641","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.664","5.132","8.715","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.898","5.930","5.974","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":693},{"label":"Fev","value":773},{"label":"Mar","value":677},{"label":"Abr","value":769},{"label":"Mai","value":741},{"label":"Jun","value":659},{"label":"Jul","value":473},{"label":"Ago","value":458},{"label":"Set","value":598},{"label":"Out","value":734},{"label":"Nov","value":588},{"label":"Dez","value":457}];
const MX = 773;
