...
const PAGE = "Qualify";
const KPIS = [{"l":"Fornecedores Ativos","v":"7.323","t":"-1.5%","d":"down"},{"l":"Contratos (€M)","v":"€30.9M","t":"+13.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.8%","t":"-1.0%","d":"down"},{"l":"Score Médio","v":"71","t":"+1.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","76.0%","€ 36289.11","4.065","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","80.0%","€ 32699.37","4.639","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","74.3%","€ 25527.01","5.476","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","94.3%","€ 13238.40","7.296","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","74.3%","€ 21312.49","6.498","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":552},{"label":"Mar","value":541},{"label":"Abr","value":844},{"label":"Mai","value":892},{"label":"Jun","value":850},{"label":"Jul","value":885},{"label":"Ago","value":530},{"label":"Set","value":633},{"label":"Out","value":566},{"label":"Nov","value":638},{"label":"Dez","value":901}];
const MX = 901;
