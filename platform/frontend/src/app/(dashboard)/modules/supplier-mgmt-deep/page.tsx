...
/* ═══ Supplier Management Deep — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "9062", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1729", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€313K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "686435362", cells: ["SUP-6362", "Supplier Management Deep Item 1", "19/11/2026", "€35 462"], status: "active" as const },
    { id: "686438933", cells: ["SUP-9933", "Supplier Management Deep Item 2", "6/6/2026", "€39 033"], status: "pending" as const },
    { id: "686442504", cells: ["SUP-4504", "Supplier Management Deep Item 3", "21/1/2026", "€42 604"], status: "completed" as const },
    { id: "686446075", cells: ["SUP-8075", "Supplier Management Deep Item 4", "8/8/2026", "€46 175"], status: "warning" as const },
    { id: "686449646", cells: ["SUP-2646", "Supplier Management Deep Item 5", "23/3/2026", "€49 746"], status: "active" as const },
];
...
export default function SupplierManagementDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Supplier Management Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Supplier Management Deep</p>
                    </div>
                </div>
