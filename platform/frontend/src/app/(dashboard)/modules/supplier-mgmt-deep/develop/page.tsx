...
const PAGE = "Develop";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.806","t":"+1.2%","d":"up"},{"l":"Contratos (€M)","v":"€26.0M","t":"+16.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"94.7%","t":"+11.1%","d":"up"},{"l":"Score Médio","v":"71","t":"+12.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","80.1%","€ 32577.98","7.078","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","100.0%","€ 28390.99","6.659","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","79.4%","€ 36443.43","5.532","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","80.3%","€ 40402.34","1.697","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","92.0%","€ 42843.85","7.919","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":420},{"label":"Fev","value":455},{"label":"Mar","value":502},{"label":"Abr","value":410},{"label":"Mai","value":276},{"label":"Jun","value":623},{"label":"Jul","value":271},{"label":"Ago","value":620},{"label":"Set","value":399},{"label":"Out","value":301},{"label":"Nov","value":323},{"label":"Dez","value":576}];
const MX = 623;
