...
const PAGE = "Perform";
const KPIS = [{"l":"Formulários Ativos","v":"7.191","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"2465","t":"+8.4%","d":"up"},{"l":"Documentos Gerados","v":"3.905","t":"-2.5%","d":"down"},{"l":"Templates","v":"7.812","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.152","2026-02-28","5.991","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","569","2026-03-02","3.166","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.067","2026-03-22","107","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.829","2026-03-01","1.382","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.268","2026-01-25","7.000","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":772},{"label":"Mar","value":1000},{"label":"Abr","value":920},{"label":"Mai","value":1049},{"label":"Jun","value":761},{"label":"Jul","value":775},{"label":"Ago","value":750},{"label":"Set","value":732},{"label":"Out","value":1041},{"label":"Nov","value":876},{"label":"Dez","value":1054}];
const MX = 1054;
