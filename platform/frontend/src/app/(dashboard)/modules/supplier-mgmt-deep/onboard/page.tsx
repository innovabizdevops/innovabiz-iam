...
const PAGE = "Onboard";
const KPIS = [{"l":"eNPS","v":"84","t":"+11.5%","d":"up"},{"l":"Engagement (%)","v":"76.9%","t":"-2.2%","d":"down"},{"l":"Turnover (%)","v":"89.9%","t":"+13.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.414","t":"+16.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","4.703","2026-01-01","60","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.788","2026-01-26","58","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","6.953","2026-01-05","70","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","7.661","2026-01-02","68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","4.981","2026-01-17","79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":582},{"label":"Fev","value":818},{"label":"Mar","value":816},{"label":"Abr","value":475},{"label":"Mai","value":831},{"label":"Jun","value":802},{"label":"Jul","value":834},{"label":"Ago","value":770},{"label":"Set","value":486},{"label":"Out","value":517},{"label":"Nov","value":552},{"label":"Dez","value":669}];
const MX = 834;
