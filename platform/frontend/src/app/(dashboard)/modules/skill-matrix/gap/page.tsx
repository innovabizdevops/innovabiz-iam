...
const ACCENT = "#dc2626";
const MODULE = "Skill Matrix";
const PAGE = "Gap Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"4.037","t":"+11.0%","d":"up"},{"l":"Queries/Dia","v":"4844","t":"-0.4%","d":"down"},{"l":"Dados Processados (GB)","v":"2.133","t":"+7.3%","d":"up"},{"l":"Utilizadores Analytics","v":"510","t":"-5.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3200","2026-03-20","4.811","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3398","2026-01-15","4.305","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2608","2026-03-15","7.891","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5045","2026-03-15","3.605","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1892","2026-02-14","1.872","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":853},{"label":"Fev","value":895},{"label":"Mar","value":961},{"label":"Abr","value":1070},{"label":"Mai","value":946},{"label":"Jun","value":874},{"label":"Jul","value":841},{"label":"Ago","value":799},{"label":"Set","value":711},{"label":"Out","value":1035},{"label":"Nov","value":1048},{"label":"Dez","value":866}];
const MX = 1070;
