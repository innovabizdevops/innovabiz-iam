...
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"4.518","t":"+4.7%","d":"up"},{"l":"Queries/Dia","v":"4224","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"2.627","t":"+12.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.956","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","454","2026-02-23","8.558","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","740","2026-01-23","2.982","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2612","2026-03-12","8.219","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4470","2026-03-03","3.440","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3854","2026-02-27","6.485","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":641},{"label":"Fev","value":778},{"label":"Mar","value":679},{"label":"Abr","value":896},{"label":"Mai","value":641},{"label":"Jun","value":798},{"label":"Jul","value":819},{"label":"Ago","value":642},{"label":"Set","value":828},{"label":"Out","value":650},{"label":"Nov","value":803},{"label":"Dez","value":575}];
const MX = 896;
