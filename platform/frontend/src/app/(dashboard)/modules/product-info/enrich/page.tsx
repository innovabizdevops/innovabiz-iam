...
const ACCENT = "#6366f1";
const MODULE = "Product Info Mgmt";
const PAGE = "Enrich";
const KPIS = [{"l":"Produtos Ativos","v":"635","t":"+5.6%","d":"up"},{"l":"SKUs","v":"8.670","t":"-2.6%","d":"down"},{"l":"ECNs Pendentes","v":"3.020","t":"+0.7%","d":"up"},{"l":"Time-to-Market (dias)","v":"834","t":"-3.3%","d":"down"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","412","6.611","744","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","3.227","7.258","5.303","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","5.454","3.394","2.171","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","1.898","5.382","912","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","2.637","853","8.977","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":628},{"label":"Mar","value":753},{"label":"Abr","value":846},{"label":"Mai","value":650},{"label":"Jun","value":568},{"label":"Jul","value":635},{"label":"Ago","value":539},{"label":"Set","value":797},{"label":"Out","value":521},{"label":"Nov","value":650},{"label":"Dez","value":785}];
const MX = 846;
