...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.126","t":"-3.0%","d":"down"},{"l":"NC Abertas","v":"1.503","t":"+5.8%","d":"up"},{"l":"Conformidade (%)","v":"71.6%","t":"+17.3%","d":"up"},{"l":"CAPAs Pendentes","v":"7.506","t":"-4.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.753","78.6%","5.850","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.806","80.0%","5.844","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.225","84.3%","3.441","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.168","79.0%","3.054","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.192","78.8%","6.648","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":461},{"label":"Fev","value":429},{"label":"Mar","value":334},{"label":"Abr","value":416},{"label":"Mai","value":367},{"label":"Jun","value":387},{"label":"Jul","value":571},{"label":"Ago","value":327},{"label":"Set","value":345},{"label":"Out","value":356},{"label":"Nov","value":627},{"label":"Dez","value":324}];
const MX = 627;
