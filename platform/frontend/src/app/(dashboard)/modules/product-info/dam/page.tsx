...
const PAGE = "DAM";
const KPIS = [{"l":"Produtos Ativos","v":"1.124","t":"+8.2%","d":"up"},{"l":"SKUs","v":"1.726","t":"+13.6%","d":"up"},{"l":"ECNs Pendentes","v":"9.048","t":"-5.0%","d":"down"},{"l":"Time-to-Market (dias)","v":"6.802","t":"+0.8%","d":"up"}];
const COLS = ["Produto","SKU","Versão","Categoria","Lifecycle Stage","Estado"];
const ROWS = [{"id":"r0","cells":["PRD-IBOS-Enterprise","PRD-IBOS-Pro","1.246","8.786","416","Ativo"],"status":"active"},{"id":"r1","cells":["PRD-IBOS-Pro","PRD-IBOS-Starter","1.273","4.896","9.059","Pendente"],"status":"pending"},{"id":"r2","cells":["PRD-IBOS-Starter","PRD-Module-AI","6.306","7.348","8.587","Concluído"],"status":"done"},{"id":"r3","cells":["PRD-Module-AI","PRD-Module-IoT","781","6.739","4.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["PRD-Module-IoT","PRD-IBOS-Enterprise","1.810","6.483","1.101","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":645},{"label":"Mar","value":573},{"label":"Abr","value":609},{"label":"Mai","value":863},{"label":"Jun","value":509},{"label":"Jul","value":789},{"label":"Ago","value":890},{"label":"Set","value":878},{"label":"Out","value":525},{"label":"Nov","value":675},{"label":"Dez","value":889}];
const MX = 890;
