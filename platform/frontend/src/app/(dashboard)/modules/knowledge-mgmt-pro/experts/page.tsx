...
const ACCENT = "#1e40af";
const MODULE = "Knowledge Mgmt Pro";
const PAGE = "Expert Finder";
const KPIS = [{"l":"Artigos Publicados","v":"954","t":"+7.2%","d":"up"},{"l":"Views/Semana","v":"4414","t":"-4.4%","d":"down"},{"l":"Feedback Útil (%)","v":"78.2%","t":"+12.9%","d":"up"},{"l":"Artigos Desatualizados","v":"1.825","t":"+8.3%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","8.419","78.5%","8.696","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","4.795","86.2%","8.222","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.765","87.2%","7.685","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.846","88.1%","8.931","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.537","77.0%","4.460","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":604},{"label":"Mar","value":810},{"label":"Abr","value":805},{"label":"Mai","value":494},{"label":"Jun","value":794},{"label":"Jul","value":448},{"label":"Ago","value":764},{"label":"Set","value":534},{"label":"Out","value":774},{"label":"Nov","value":654},{"label":"Dez","value":513}];
const MX = 825;
