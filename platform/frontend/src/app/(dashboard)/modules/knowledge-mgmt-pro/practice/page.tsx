...
const PAGE = "Practice Area";
const KPIS = [{"l":"Artigos Publicados","v":"5.469","t":"+5.5%","d":"up"},{"l":"Views/Semana","v":"645","t":"-3.8%","d":"down"},{"l":"Feedback Útil (%)","v":"94.6%","t":"+3.6%","d":"up"},{"l":"Artigos Desatualizados","v":"1.330","t":"+16.3%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","4.581","75.0%","6.190","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","6.342","94.6%","7.825","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.775","95.8%","4.738","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.335","80.0%","2.925","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","5.956","73.0%","1.087","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":538},{"label":"Mar","value":693},{"label":"Abr","value":720},{"label":"Mai","value":684},{"label":"Jun","value":791},{"label":"Jul","value":767},{"label":"Ago","value":786},{"label":"Set","value":546},{"label":"Out","value":596},{"label":"Nov","value":868},{"label":"Dez","value":710}];
const MX = 868;
