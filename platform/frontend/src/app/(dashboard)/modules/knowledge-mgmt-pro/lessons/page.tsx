...
const PAGE = "Lesson Learned";
const KPIS = [{"l":"Utilizadores Ativos","v":"5.213","t":"+0.7%","d":"up"},{"l":"Sessões/Dia","v":"2048","t":"+2.7%","d":"up"},{"l":"MFA Adoção (%)","v":"67.3%","t":"-4.7%","d":"down"},{"l":"Tentativas Bloqueadas","v":"9.010","t":"+17.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","3.602","3.076","3.386","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.007","6.412","3.390","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","8.474","2.270","536","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","3.688","7.250","225","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.941","4.873","5.854","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":684},{"label":"Mar","value":387},{"label":"Abr","value":432},{"label":"Mai","value":609},{"label":"Jun","value":730},{"label":"Jul","value":575},{"label":"Ago","value":414},{"label":"Set","value":652},{"label":"Out","value":611},{"label":"Nov","value":417},{"label":"Dez","value":540}];
const MX = 730;
