...
const PAGE = "Best Practice";
const KPIS = [{"l":"Artigos Publicados","v":"998","t":"+1.9%","d":"up"},{"l":"Views/Semana","v":"1869","t":"+7.0%","d":"up"},{"l":"Feedback Útil (%)","v":"72.9%","t":"+15.9%","d":"up"},{"l":"Artigos Desatualizados","v":"235","t":"+14.8%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","7.759","73.9%","5.589","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","7.249","98.9%","8.680","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","7.208","95.3%","2.938","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","8.349","73.6%","2.164","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.639","98.7%","6.769","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":255},{"label":"Mar","value":448},{"label":"Abr","value":450},{"label":"Mai","value":396},{"label":"Jun","value":576},{"label":"Jul","value":322},{"label":"Ago","value":446},{"label":"Set","value":520},{"label":"Out","value":342},{"label":"Nov","value":361},{"label":"Dez","value":607}];
const MX = 607;
