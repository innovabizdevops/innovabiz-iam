...
export default function KnowledgeMgmtProPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Knowledge Mgmt Pro</h1><p className="text-sm text-muted-foreground">Knowledge Mgmt Pro • iBOS Enterprise</p></div>
