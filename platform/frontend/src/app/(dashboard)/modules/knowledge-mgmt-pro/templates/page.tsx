...
const PAGE = "Template Hub";
const KPIS = [{"l":"Formulários Ativos","v":"1.315","t":"+14.3%","d":"up"},{"l":"Submissões/Dia","v":"3187","t":"+14.6%","d":"up"},{"l":"Documentos Gerados","v":"7.486","t":"+17.7%","d":"up"},{"l":"Templates","v":"7.193","t":"-3.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.164","2026-03-21","8.692","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.561","2026-02-28","173","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.593","2026-01-09","7.851","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.857","2026-01-08","8.121","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.093","2026-03-03","3.006","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":490},{"label":"Mar","value":512},{"label":"Abr","value":817},{"label":"Mai","value":746},{"label":"Jun","value":837},{"label":"Jul","value":811},{"label":"Ago","value":861},{"label":"Set","value":488},{"label":"Out","value":525},{"label":"Nov","value":692},{"label":"Dez","value":603}];
const MX = 861;
