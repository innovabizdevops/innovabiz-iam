...
export default function EnergyMgmtIsoPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Energy Mgmt Iso</h1><p className="text-sm text-muted-foreground">Energy Mgmt Iso • iBOS Enterprise</p></div>
