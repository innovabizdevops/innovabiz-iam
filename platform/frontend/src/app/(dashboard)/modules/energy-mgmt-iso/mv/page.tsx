...
const PAGE = "M&amp;V Protocol";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.039","t":"+0.3%","d":"up"},{"l":"NC Abertas","v":"639","t":"+3.2%","d":"up"},{"l":"Conformidade (%)","v":"92.9%","t":"+14.4%","d":"up"},{"l":"CAPAs Pendentes","v":"1.175","t":"+1.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.638","84.4%","7.700","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.010","76.3%","8.234","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.488","88.4%","3.751","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.870","86.1%","2.262","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.223","80.3%","1.157","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":710},{"label":"Mar","value":925},{"label":"Abr","value":618},{"label":"Mai","value":758},{"label":"Jun","value":655},{"label":"Jul","value":671},{"label":"Ago","value":720},{"label":"Set","value":824},{"label":"Out","value":738},{"label":"Nov","value":615},{"label":"Dez","value":704}];
const MX = 925;
