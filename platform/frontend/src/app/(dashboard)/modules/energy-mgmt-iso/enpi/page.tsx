...
const ACCENT = "#b45309";
const MODULE = "Energy Mgmt ISO";
const PAGE = "EnPI Track";
const KPIS = [{"l":"Auditorias Realizadas","v":"4.968","t":"-4.4%","d":"down"},{"l":"NC Abertas","v":"8.816","t":"-4.5%","d":"down"},{"l":"Conformidade (%)","v":"92.8%","t":"+1.3%","d":"up"},{"l":"CAPAs Pendentes","v":"1.481","t":"-3.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.715","94.2%","8.912","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.543","89.9%","4.485","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.294","79.5%","8.936","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.791","80.8%","2.115","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.655","93.4%","6.617","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":328},{"label":"Fev","value":515},{"label":"Mar","value":707},{"label":"Abr","value":385},{"label":"Mai","value":611},{"label":"Jun","value":513},{"label":"Jul","value":360},{"label":"Ago","value":677},{"label":"Set","value":630},{"label":"Out","value":702},{"label":"Nov","value":369},{"label":"Dez","value":490}];
const MX = 707;
...
export default function EnpiPage() {
    return (
