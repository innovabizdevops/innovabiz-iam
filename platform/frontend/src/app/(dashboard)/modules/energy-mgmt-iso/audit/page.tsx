...
const PAGE = "Energy Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.201","t":"-2.2%","d":"down"},{"l":"NC Abertas","v":"2.709","t":"-3.9%","d":"down"},{"l":"Conformidade (%)","v":"69.4%","t":"+12.6%","d":"up"},{"l":"CAPAs Pendentes","v":"4.136","t":"+7.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.447","94.6%","2.450","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.127","91.5%","2.499","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.423","88.5%","3.487","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.055","98.8%","8.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.125","95.2%","6.544","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":444},{"label":"Fev","value":401},{"label":"Mar","value":516},{"label":"Abr","value":487},{"label":"Mai","value":475},{"label":"Jun","value":413},{"label":"Jul","value":572},{"label":"Ago","value":442},{"label":"Set","value":554},{"label":"Out","value":743},{"label":"Nov","value":749},{"label":"Dez","value":645}];
const MX = 749;
