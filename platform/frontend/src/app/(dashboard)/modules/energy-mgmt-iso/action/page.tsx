...
const KPIS = [{"l":"Auditorias Realizadas","v":"7.248","t":"+11.1%","d":"up"},{"l":"NC Abertas","v":"5.217","t":"+5.9%","d":"up"},{"l":"Conformidade (%)","v":"83.7%","t":"-2.9%","d":"down"},{"l":"CAPAs Pendentes","v":"7.758","t":"+16.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.872","95.9%","1.589","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.619","95.0%","340","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.545","70.5%","5.302","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.841","89.7%","7.706","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.927","94.8%","5.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":752},{"label":"Mar","value":819},{"label":"Abr","value":709},{"label":"Mai","value":684},{"label":"Jun","value":586},{"label":"Jul","value":581},{"label":"Ago","value":571},{"label":"Set","value":908},{"label":"Out","value":792},{"label":"Nov","value":834},{"label":"Dez","value":675}];
const MX = 908;
