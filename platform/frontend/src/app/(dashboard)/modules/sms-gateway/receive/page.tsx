...
const PAGE = "Receive";
const KPIS = [{"l":"Integrações Ativas","v":"8.662","t":"+16.2%","d":"up"},{"l":"Chamadas/Hora","v":"3287","t":"-5.8%","d":"down"},{"l":"Taxa Sucesso (%)","v":"78.1%","t":"+13.9%","d":"up"},{"l":"Latência Média (ms)","v":"118ms","t":"+0.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.449","5.723","83.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.368","3.901","77.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.317","1.499","92.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.468","5.088","92.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.808","312","83.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":708},{"label":"Mar","value":915},{"label":"Abr","value":866},{"label":"Mai","value":941},{"label":"Jun","value":771},{"label":"Jul","value":611},{"label":"Ago","value":817},{"label":"Set","value":773},{"label":"Out","value":822},{"label":"Nov","value":564},{"label":"Dez","value":933}];
const MX = 941;
