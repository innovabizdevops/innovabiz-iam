...
const KPIS = [{"l":"Dashboards Ativos","v":"8.456","t":"+3.5%","d":"up"},{"l":"Queries/Dia","v":"3615","t":"+4.5%","d":"up"},{"l":"Dados Processados (GB)","v":"1.252","t":"+9.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.505","t":"+11.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2044","2026-03-24","2.112","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","5011","2026-02-23","460","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3976","2026-02-24","383","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","304","2026-01-23","3.871","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1845","2026-02-18","2.999","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":899},{"label":"Mar","value":694},{"label":"Abr","value":972},{"label":"Mai","value":869},{"label":"Jun","value":860},{"label":"Jul","value":808},{"label":"Ago","value":868},{"label":"Set","value":943},{"label":"Out","value":852},{"label":"Nov","value":752},{"label":"Dez","value":795}];
const MX = 972;
