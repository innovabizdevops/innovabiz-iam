...
const PAGE = "Schedule";
const KPIS = [{"l":"Integrações Ativas","v":"6.206","t":"+16.6%","d":"up"},{"l":"Chamadas/Hora","v":"3297","t":"+14.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"71.1%","t":"+10.7%","d":"up"},{"l":"Latência Média (ms)","v":"66ms","t":"+11.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.250","2.600","72.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.154","9.054","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.334","5.484","72.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.285","268","78.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.344","543","96.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":682},{"label":"Fev","value":647},{"label":"Mar","value":422},{"label":"Abr","value":625},{"label":"Mai","value":543},{"label":"Jun","value":596},{"label":"Jul","value":588},{"label":"Ago","value":568},{"label":"Set","value":781},{"label":"Out","value":421},{"label":"Nov","value":714},{"label":"Dez","value":509}];
const MX = 781;
