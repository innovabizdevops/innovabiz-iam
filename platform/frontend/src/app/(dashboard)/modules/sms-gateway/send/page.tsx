...
const PAGE = "Send";
const KPIS = [{"l":"Integrações Ativas","v":"3.977","t":"+3.1%","d":"up"},{"l":"Chamadas/Hora","v":"4032","t":"+9.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.7%","t":"+2.5%","d":"up"},{"l":"Latência Média (ms)","v":"173ms","t":"+5.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.898","7.271","76.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.754","1.922","92.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.424","8.522","76.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.628","4.643","94.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.737","3.444","78.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":561},{"label":"Mar","value":542},{"label":"Abr","value":477},{"label":"Mai","value":502},{"label":"Jun","value":564},{"label":"Jul","value":311},{"label":"Ago","value":238},{"label":"Set","value":420},{"label":"Out","value":457},{"label":"Nov","value":586},{"label":"Dez","value":369}];
const MX = 586;
