...
/* ═══ SMS/Voice Gateway — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "5103", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3546", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€446K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1301112503", cells: ["SMS-1503", "SMS/Voice Gateway Item 1", "20/12/2026", "€12 603"], status: "active" as const },
    { id: "1301116074", cells: ["SMS-5074", "SMS/Voice Gateway Item 2", "7/7/2026", "€16 174"], status: "pending" as const },
    { id: "1301119645", cells: ["SMS-8645", "SMS/Voice Gateway Item 3", "22/2/2026", "€19 745"], status: "completed" as const },
    { id: "1301123216", cells: ["SMS-3216", "SMS/Voice Gateway Item 4", "9/9/2026", "€23 316"], status: "warning" as const },
    { id: "1301126787", cells: ["SMS-6787", "SMS/Voice Gateway Item 5", "24/4/2026", "€26 887"], status: "active" as const },
];
...
export default function SmsvoiceGatewayPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SMS/Voice Gateway</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SMS/Voice Gateway</p>
                    </div>
                </div>
