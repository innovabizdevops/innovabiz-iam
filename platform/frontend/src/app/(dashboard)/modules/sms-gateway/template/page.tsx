...
const ACCENT = "#06b6d4";
const MODULE = "SMS/Voice Gateway";
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"7.326","t":"+2.8%","d":"up"},{"l":"Submissões/Dia","v":"3345","t":"+4.1%","d":"up"},{"l":"Documentos Gerados","v":"3.511","t":"+6.0%","d":"up"},{"l":"Templates","v":"6.936","t":"-1.9%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.424","2026-02-01","2.174","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.539","2026-02-15","4.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.098","2026-02-13","8.942","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.242","2026-03-10","3.954","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.613","2026-01-26","6.454","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":843},{"label":"Fev","value":699},{"label":"Mar","value":942},{"label":"Abr","value":767},{"label":"Mai","value":764},{"label":"Jun","value":838},{"label":"Jul","value":1003},{"label":"Ago","value":616},{"label":"Set","value":933},{"label":"Out","value":692},{"label":"Nov","value":954},{"label":"Dez","value":923}];
const MX = 1003;
