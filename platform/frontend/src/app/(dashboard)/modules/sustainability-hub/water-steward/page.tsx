...
const ROWS = [
  { id: "001", c: ["Water Steward-001", "Water Steward Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Water Steward-002", "Water Steward Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Water Steward-003", "Water Steward Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Water Steward-004", "Water Steward Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Water Steward-005", "Water Steward Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Water Steward", ts: "Há 2min", a: "Sistema" },
...
export default function WaterStewardPage() {
  return (
