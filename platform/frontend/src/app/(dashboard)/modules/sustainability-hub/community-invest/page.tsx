...
const ROWS = [
  { id: "001", c: ["Community Invest-001", "Community Invest Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Community Invest-002", "Community Invest Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Community Invest-003", "Community Invest Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Community Invest-004", "Community Invest Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Community Invest-005", "Community Invest Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Community Invest", ts: "Há 2min", a: "Sistema" },
...
export default function CommunityInvestPage() {
  return (
