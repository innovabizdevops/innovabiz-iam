...
const ROWS = [
  { id: "001", c: ["Net Zero Plan-001", "Net Zero Plan Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Net Zero Plan-002", "Net Zero Plan Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Net Zero Plan-003", "Net Zero Plan Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Net Zero Plan-004", "Net Zero Plan Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Net Zero Plan-005", "Net Zero Plan Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Net Zero Plan", ts: "Há 2min", a: "Sistema" },
...
export default function NetZeroPlanPage() {
  return (
