...
const ROWS = [
  { id: "001", c: ["Dei Metrics-001", "Dei Metrics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Dei Metrics-002", "Dei Metrics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Dei Metrics-003", "Dei Metrics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Dei Metrics-004", "Dei Metrics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Dei Metrics-005", "Dei Metrics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Dei Metrics", ts: "Há 2min", a: "Sistema" },
...
export default function DeiMetricsPage() {
  return (
