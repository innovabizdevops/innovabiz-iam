...
const PAGE = "Sustainability Report";
const KPIS = [{"l":"Emissões CO₂ (tCO₂e)","v":"12,450","d":"-8.2%","u":false},{"l":"Energia Renovável (%)","v":"67.3%","d":"+12.1%","u":true},{"l":"Circularidade (%)","v":"42.8%","d":"+5.4%","u":true},{"l":"Score ESG","v":"A","d":"+1","u":true}];
const COLS = ["Indicador","Scope","Valor","Meta","Progresso","Estado"];
const ROWS = [
  { id: "001", c: ["Sustainability Report-001", "Sustainability Report Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Sustainability Report-002", "Sustainability Report Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Sustainability Report-003", "Sustainability Report Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Sustainability Report-004", "Sustainability Report Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Sustainability Report-005", "Sustainability Report Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Sustainability Report", ts: "Há 2min", a: "Sistema" },
    ...
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Sustainability Hub — iBOS Enterprise</p>
        </div>
