...
const ROWS = [
  { id: "001", c: ["Social Impact Sus-001", "Social Impact Sus Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Social Impact Sus-002", "Social Impact Sus Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Social Impact Sus-003", "Social Impact Sus Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Social Impact Sus-004", "Social Impact Sus Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Social Impact Sus-005", "Social Impact Sus Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Social Impact Sus", ts: "Há 2min", a: "Sistema" },
...
export default function SocialImpactSusPage() {
  return (
