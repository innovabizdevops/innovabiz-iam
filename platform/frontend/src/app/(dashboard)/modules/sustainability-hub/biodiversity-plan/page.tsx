...
const ROWS = [
  { id: "001", c: ["Biodiversity Plan-001", "Biodiversity Plan Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Biodiversity Plan-002", "Biodiversity Plan Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Biodiversity Plan-003", "Biodiversity Plan Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Biodiversity Plan-004", "Biodiversity Plan Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Biodiversity Plan-005", "Biodiversity Plan Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Biodiversity Plan", ts: "Há 2min", a: "Sistema" },
...
export default function BiodiversityPlanPage() {
  return (
