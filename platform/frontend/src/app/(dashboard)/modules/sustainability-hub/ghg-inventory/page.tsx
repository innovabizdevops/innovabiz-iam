...
const ROWS = [
  { id: "001", c: ["Ghg Inventory-001", "Ghg Inventory Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Ghg Inventory-002", "Ghg Inventory Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Ghg Inventory-003", "Ghg Inventory Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Ghg Inventory-004", "Ghg Inventory Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Ghg Inventory-005", "Ghg Inventory Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Ghg Inventory", ts: "Há 2min", a: "Sistema" },
