...
const ROWS = [
  { id: "001", c: ["Renewable Procure-001", "Renewable Procure Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Renewable Procure-002", "Renewable Procure Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Renewable Procure-003", "Renewable Procure Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Renewable Procure-004", "Renewable Procure Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Renewable Procure-005", "Renewable Procure Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Renewable Procure", ts: "Há 2min", a: "Sistema" },
...
export default function RenewableProcurePage() {
  return (
