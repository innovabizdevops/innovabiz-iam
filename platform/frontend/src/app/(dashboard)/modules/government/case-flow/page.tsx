...
const PAGE = "Case Flow Diagram";
const KPIS = [{"l":"Diagramas Criados","v":"2.880","t":"+10.2%","d":"up"},{"l":"Templates","v":"2.207","t":"+6.7%","d":"up"},{"l":"Colaboradores","v":"8.267","t":"+16.1%","d":"up"},{"l":"Comentários/Semana","v":"4416","t":"-3.4%","d":"down"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","8.083","2026-02-12","8.652","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","1.455","2026-03-14","8.254","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","7.077","2026-03-12","4.401","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","6.806","2026-01-19","2.234","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","3.667","2026-02-15","3.942","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":906},{"label":"Mar","value":811},{"label":"Abr","value":845},{"label":"Mai","value":861},{"label":"Jun","value":758},{"label":"Jul","value":871},{"label":"Ago","value":1067},{"label":"Set","value":1042},{"label":"Out","value":876},{"label":"Nov","value":960},{"label":"Dez","value":881}];
const MX = 1067;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>BPMN</span></h1>
                </div>
