...
const PAGE = "Budget Sankey";
const KPIS = [{"l":"Total Government","v":"6.092","t":"+12.0%","d":"up"},{"l":"Budget Sankey Ativos","v":"€49827","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"92.1%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"76","t":"+17.3%","d":"up"}];
const COLS = ["ID","Budget Sankey","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government #001","€ 26107.25","8.122","1.420","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Government #002","€ 32679.94","4.868","8.956","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Government #003","€ 24608.12","7.978","5.460","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Government #004","€ 27584.53","6.680","4.668","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government #005","€ 12579.56","6.936","6.256","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":919},{"label":"Fev","value":921},{"label":"Mar","value":1013},{"label":"Abr","value":1008},{"label":"Mai","value":867},{"label":"Jun","value":888},{"label":"Jul","value":858},{"label":"Ago","value":795},{"label":"Set","value":671},{"label":"Out","value":885},{"label":"Nov","value":800},{"label":"Dez","value":648}];
const MX = 1013;
...
export default function BudgetSankeyPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#1e40af'}}>Chart</span></h1>
                </div>
