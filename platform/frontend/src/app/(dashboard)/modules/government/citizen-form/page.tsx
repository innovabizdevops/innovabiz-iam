...
const PAGE = "Citizen Request Form";
const KPIS = [{"l":"Formulários Ativos","v":"4.128","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"2273","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"4.205","t":"+13.9%","d":"up"},{"l":"Templates","v":"2.885","t":"+0.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.081","2026-01-22","8.617","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.998","2026-01-21","8.750","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","9.072","2026-01-14","5.025","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.465","2026-03-03","1.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.038","2026-01-25","1.865","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":398},{"label":"Mar","value":407},{"label":"Abr","value":394},{"label":"Mai","value":610},{"label":"Jun","value":533},{"label":"Jul","value":714},{"label":"Ago","value":683},{"label":"Set","value":455},{"label":"Out","value":415},{"label":"Nov","value":724},{"label":"Dez","value":579}];
const MX = 724;
