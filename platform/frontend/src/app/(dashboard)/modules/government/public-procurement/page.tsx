...
const KPIS = [{"l":"Fornecedores Ativos","v":"7.081","t":"+12.1%","d":"up"},{"l":"Contratos (€M)","v":"€32.8M","t":"+7.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"71.3%","t":"+4.8%","d":"up"},{"l":"Score Médio","v":"83","t":"+8.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","83.7%","€ 43923.05","4.343","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","94.9%","€ 27266.21","232","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.5%","€ 46056.47","4.351","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","87.5%","€ 29247.25","5.761","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","88.2%","€ 30539.54","1.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":718},{"label":"Fev","value":705},{"label":"Mar","value":685},{"label":"Abr","value":744},{"label":"Mai","value":507},{"label":"Jun","value":393},{"label":"Jul","value":602},{"label":"Ago","value":484},{"label":"Set","value":492},{"label":"Out","value":510},{"label":"Nov","value":389},{"label":"Dez","value":673}];
const MX = 744;
