...
const PAGE = "Permit Management";
const KPIS = [{"l":"Riscos Identificados","v":"4.383","t":"+11.3%","d":"up"},{"l":"Mitigações Ativas","v":"4.376","t":"+12.1%","d":"up"},{"l":"Score Risco Geral","v":"83","t":"-5.9%","d":"down"},{"l":"Incidentes YTD","v":"3.447","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.651","3.527","7.562","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","714","1.533","6.929","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.905","5.378","6.523","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.773","1.298","3.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","443","4.410","7.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":934},{"label":"Fev","value":895},{"label":"Mar","value":974},{"label":"Abr","value":829},{"label":"Mai","value":896},{"label":"Jun","value":709},{"label":"Jul","value":905},{"label":"Ago","value":979},{"label":"Set","value":798},{"label":"Out","value":973},{"label":"Nov","value":1048},{"label":"Dez","value":1002}];
const MX = 1048;
