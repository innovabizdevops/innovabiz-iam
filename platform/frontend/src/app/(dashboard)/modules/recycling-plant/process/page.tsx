...
const PAGE = "Process";
const KPIS = [{"l":"Total Recycling Plant","v":"2.306","t":"-0.3%","d":"down"},{"l":"Process Ativos","v":"7.214","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"85.8%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"56","t":"+2.2%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recycling Plant #001","Recycling Plant #002","8.181","4.263","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Recycling Plant #002","Recycling Plant #003","6.284","5.155","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Recycling Plant #003","Recycling Plant #004","6.813","7.208","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Recycling Plant #004","Recycling Plant #005","8.300","8.350","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recycling Plant #005","Recycling Plant #001","679","6.428","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":549},{"label":"Mar","value":386},{"label":"Abr","value":692},{"label":"Mai","value":374},{"label":"Jun","value":616},{"label":"Jul","value":478},{"label":"Ago","value":518},{"label":"Set","value":404},{"label":"Out","value":386},{"label":"Nov","value":716},{"label":"Dez","value":459}];
const MX = 716;
