...
const ACCENT = "#6366f1";
const MODULE = "Recycling Plant";
const PAGE = "Sort";
const KPIS = [{"l":"Total Recycling Plant","v":"4.797","t":"+6.2%","d":"up"},{"l":"Sort Ativos","v":"1.235","t":"+6.6%","d":"up"},{"l":"Eficiência (%)","v":"85.1%","t":"+3.8%","d":"up"},{"l":"Score Performance","v":"91","t":"+4.2%","d":"up"}];
const COLS = ["ID","Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Recycling Plant #001","Recycling Plant #002","4.232","5.391","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Recycling Plant #002","Recycling Plant #003","1.054","3.675","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Recycling Plant #003","Recycling Plant #004","4.721","8.930","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Recycling Plant #004","Recycling Plant #005","1.652","7.056","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Recycling Plant #005","Recycling Plant #001","6.074","7.682","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":630},{"label":"Mar","value":405},{"label":"Abr","value":440},{"label":"Mai","value":347},{"label":"Jun","value":390},{"label":"Jul","value":367},{"label":"Ago","value":549},{"label":"Set","value":427},{"label":"Out","value":330},{"label":"Nov","value":612},{"label":"Dez","value":420}];
const MX = 630;
