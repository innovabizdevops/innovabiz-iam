...
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"2.772","t":"+15.9%","d":"up"},{"l":"Taxa Entrega (%)","v":"83.1%","t":"-3.2%","d":"down"},{"l":"Taxa Abertura (%)","v":"72.0%","t":"+15.8%","d":"up"},{"l":"Escalações","v":"2.322","t":"+8.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.743","94.3%","2026-02-04","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","385","87.4%","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.218","92.6%","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.767","83.2%","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.657","77.7%","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":672},{"label":"Fev","value":668},{"label":"Mar","value":630},{"label":"Abr","value":876},{"label":"Mai","value":943},{"label":"Jun","value":708},{"label":"Jul","value":960},{"label":"Ago","value":869},{"label":"Set","value":932},{"label":"Out","value":610},{"label":"Nov","value":920},{"label":"Dez","value":671}];
const MX = 960;
