...
const ACCENT = "#be185d";
const MODULE = "Brand Monitoring Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Brand Monitoring","v":"2.930","t":"-2.6%","d":"down"},{"l":"Monitor Ativos","v":"9.010","t":"-4.2%","d":"down"},{"l":"Eficiência (%)","v":"88.0%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"65","t":"-3.9%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brand Monitoring #001","Brand Monitoring #002","2.731","6.940","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Brand Monitoring #002","Brand Monitoring #003","8.412","4.405","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Brand Monitoring #003","Brand Monitoring #004","7.496","4.210","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Brand Monitoring #004","Brand Monitoring #005","3.959","4.637","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brand Monitoring #005","Brand Monitoring #001","5.103","6.624","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":523},{"label":"Mar","value":619},{"label":"Abr","value":704},{"label":"Mai","value":481},{"label":"Jun","value":791},{"label":"Jul","value":665},{"label":"Ago","value":713},{"label":"Set","value":564},{"label":"Out","value":485},{"label":"Nov","value":628},{"label":"Dez","value":763}];
const MX = 791;
