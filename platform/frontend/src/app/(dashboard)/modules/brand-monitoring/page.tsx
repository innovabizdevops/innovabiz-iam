...
/* ═══ Brand Monitoring Deep — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "3513", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "721", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€240K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "31129013", cells: ["BRA-8013", "Brand Monitoring Deep Item 1", "14/6/2026", "€29 113"], status: "active" as const },
    { id: "31132584", cells: ["BRA-2584", "Brand Monitoring Deep Item 2", "1/1/2026", "€32 684"], status: "pending" as const },
    { id: "31136155", cells: ["BRA-6155", "Brand Monitoring Deep Item 3", "16/8/2026", "€36 255"], status: "completed" as const },
    { id: "31139726", cells: ["BRA-9726", "Brand Monitoring Deep Item 4", "3/3/2026", "€39 826"], status: "warning" as const },
    { id: "31143297", cells: ["BRA-4297", "Brand Monitoring Deep Item 5", "18/10/2026", "€43 397"], status: "active" as const },
];
...
export default function BrandMonitoringDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brand Monitoring Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Brand Monitoring Deep</p>
                    </div>
                </div>
