...
const KPIS = [{"l":"Dashboards Ativos","v":"5.330","t":"+10.3%","d":"up"},{"l":"Queries/Dia","v":"2266","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.134","t":"-6.0%","d":"down"},{"l":"Utilizadores Analytics","v":"7.859","t":"-1.3%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3786","2026-03-14","4.828","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1476","2026-02-02","4.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1925","2026-03-22","988","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","294","2026-01-06","6.437","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3073","2026-01-19","2.067","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":915},{"label":"Fev","value":1005},{"label":"Mar","value":1083},{"label":"Abr","value":1004},{"label":"Mai","value":1075},{"label":"Jun","value":798},{"label":"Jul","value":1020},{"label":"Ago","value":715},{"label":"Set","value":789},{"label":"Out","value":1062},{"label":"Nov","value":835},{"label":"Dez","value":909}];
const MX = 1083;
