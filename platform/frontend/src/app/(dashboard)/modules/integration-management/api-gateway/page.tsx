...
const KPIS = [{"l":"Integrações Ativas","v":"1.006","t":"+8.8%","d":"up"},{"l":"Chamadas/Hora","v":"4490","t":"+12.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.9%","t":"+14.0%","d":"up"},{"l":"Latência Média (ms)","v":"97ms","t":"-3.9%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.268","4.605","89.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","981","4.306","82.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.035","164","80.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.578","4.605","80.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","455","1.865","91.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":582},{"label":"Mar","value":421},{"label":"Abr","value":388},{"label":"Mai","value":295},{"label":"Jun","value":470},{"label":"Jul","value":455},{"label":"Ago","value":598},{"label":"Set","value":422},{"label":"Out","value":401},{"label":"Nov","value":459},{"label":"Dez","value":248}];
const MX = 598;
