...
const PAGE = "Hub";
const KPIS = [{"l":"Integrações Ativas","v":"3.654","t":"+3.5%","d":"up"},{"l":"Chamadas/Hora","v":"3203","t":"+16.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.7%","t":"-2.1%","d":"down"},{"l":"Latência Média (ms)","v":"203ms","t":"+8.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","4.267","4.801","85.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.258","3.552","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.676","5.920","80.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","467","685","73.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.874","6.947","90.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":708},{"label":"Mar","value":647},{"label":"Abr","value":786},{"label":"Mai","value":692},{"label":"Jun","value":831},{"label":"Jul","value":618},{"label":"Ago","value":612},{"label":"Set","value":580},{"label":"Out","value":859},{"label":"Nov","value":841},{"label":"Dez","value":831}];
const MX = 859;
