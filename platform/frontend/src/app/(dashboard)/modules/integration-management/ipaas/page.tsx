...
const ACCENT = "#6366f1";
const MODULE = "Integration Management";
const PAGE = "iPaaS";
const KPIS = [{"l":"Integrações Ativas","v":"8.259","t":"+15.2%","d":"up"},{"l":"Chamadas/Hora","v":"1784","t":"+15.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.7%","t":"+17.6%","d":"up"},{"l":"Latência Média (ms)","v":"96ms","t":"+13.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.741","5.616","88.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.069","3.010","85.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.093","2.006","88.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.786","5.037","90.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.348","4.141","94.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":556},{"label":"Mar","value":600},{"label":"Abr","value":570},{"label":"Mai","value":648},{"label":"Jun","value":693},{"label":"Jul","value":703},{"label":"Ago","value":569},{"label":"Set","value":525},{"label":"Out","value":467},{"label":"Nov","value":754},{"label":"Dez","value":767}];
const MX = 767;
