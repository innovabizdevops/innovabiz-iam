...
const KPIS = [{"l":"Integrações Ativas","v":"4.184","t":"-2.5%","d":"down"},{"l":"Chamadas/Hora","v":"1264","t":"+10.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"87.6%","t":"+2.5%","d":"up"},{"l":"Latência Média (ms)","v":"102ms","t":"+6.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.056","1.090","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.041","2.472","94.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.874","2.576","75.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.425","4.782","75.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.967","2.664","80.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":862},{"label":"Mar","value":861},{"label":"Abr","value":983},{"label":"Mai","value":905},{"label":"Jun","value":708},{"label":"Jul","value":791},{"label":"Ago","value":911},{"label":"Set","value":981},{"label":"Out","value":914},{"label":"Nov","value":939},{"label":"Dez","value":786}];
const MX = 983;
