...
const PAGE = "Event Bus";
const KPIS = [{"l":"Integrações Ativas","v":"3.524","t":"+9.7%","d":"up"},{"l":"Chamadas/Hora","v":"2981","t":"+9.3%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.8%","t":"+4.9%","d":"up"},{"l":"Latência Média (ms)","v":"103ms","t":"+3.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.293","2.522","97.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.477","3.388","94.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.398","2.131","92.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.846","1.599","82.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.102","4.653","73.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":615},{"label":"Mar","value":895},{"label":"Abr","value":659},{"label":"Mai","value":727},{"label":"Jun","value":835},{"label":"Jul","value":579},{"label":"Ago","value":757},{"label":"Set","value":644},{"label":"Out","value":628},{"label":"Nov","value":924},{"label":"Dez","value":606}];
const MX = 924;
