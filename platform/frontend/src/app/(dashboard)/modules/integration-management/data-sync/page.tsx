...
const KPIS = [{"l":"Dashboards Ativos","v":"2.869","t":"+15.0%","d":"up"},{"l":"Queries/Dia","v":"2626","t":"+8.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.871","t":"+15.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.188","t":"+8.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1548","2026-02-05","6.887","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2230","2026-01-16","3.905","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3207","2026-01-11","1.846","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4411","2026-01-15","7.560","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3934","2026-02-05","7.552","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":843},{"label":"Mar","value":923},{"label":"Abr","value":561},{"label":"Mai","value":669},{"label":"Jun","value":819},{"label":"Jul","value":840},{"label":"Ago","value":879},{"label":"Set","value":793},{"label":"Out","value":825},{"label":"Nov","value":789},{"label":"Dez","value":563}];
const MX = 923;
