...
const KPIS = [{"l":"Vendas YTD (€)","v":"€91340","t":"+12.4%","d":"up"},{"l":"Pipeline (€)","v":"€95562","t":"+12.9%","d":"up"},{"l":"Atingimento Quota (%)","v":"69.2%","t":"+0.5%","d":"up"},{"l":"Win Rate (%)","v":"84.7%","t":"-3.1%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 32968.05","€ 35171.67","€ 46711.48","74.7%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 34350.73","€ 36666.21","€ 43978.18","72.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11681.65","€ 24093.88","€ 49916.57","71.7%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 3683.62","€ 42596.99","€ 33883.81","83.4%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 6968.30","€ 20423.57","€ 26907.24","94.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":559},{"label":"Mar","value":843},{"label":"Abr","value":820},{"label":"Mai","value":589},{"label":"Jun","value":783},{"label":"Jul","value":865},{"label":"Ago","value":890},{"label":"Set","value":737},{"label":"Out","value":645},{"label":"Nov","value":595},{"label":"Dez","value":705}];
const MX = 890;
