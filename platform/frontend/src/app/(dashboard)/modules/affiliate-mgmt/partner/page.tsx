...
const PAGE = "Partner";
const KPIS = [{"l":"Total Affiliate Mgmt","v":"6.327","t":"+9.7%","d":"up"},{"l":"Partner Ativos","v":"6.481","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"89.6%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"67","t":"+10.6%","d":"up"}];
const COLS = ["ID","Partner","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Affiliate Mgmt #001","Affiliate Mgmt #002","6.110","2.727","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Affiliate Mgmt #002","Affiliate Mgmt #003","2.516","3.896","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Affiliate Mgmt #003","Affiliate Mgmt #004","8.672","1.631","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Affiliate Mgmt #004","Affiliate Mgmt #005","2.240","8.346","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Affiliate Mgmt #005","Affiliate Mgmt #001","6.092","6.421","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":394},{"label":"Mar","value":504},{"label":"Abr","value":343},{"label":"Mai","value":629},{"label":"Jun","value":460},{"label":"Jul","value":356},{"label":"Ago","value":484},{"label":"Set","value":624},{"label":"Out","value":602},{"label":"Nov","value":661},{"label":"Dez","value":667}];
const MX = 688;
