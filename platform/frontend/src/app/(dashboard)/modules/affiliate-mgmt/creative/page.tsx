...
const ACCENT = "#6366f1";
const MODULE = "Affiliate Management";
const PAGE = "Creative";
const KPIS = [{"l":"Total Affiliate Mgmt","v":"9.089","t":"-5.1%","d":"down"},{"l":"Creative Ativos","v":"2.020","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+14.4%","d":"up"}];
const COLS = ["ID","Creative","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Affiliate Mgmt #001","Affiliate Mgmt #002","4.648","6.819","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Affiliate Mgmt #002","Affiliate Mgmt #003","4.119","5.563","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Affiliate Mgmt #003","Affiliate Mgmt #004","5.733","3.941","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Affiliate Mgmt #004","Affiliate Mgmt #005","917","5.052","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Affiliate Mgmt #005","Affiliate Mgmt #001","5.137","2.100","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":892},{"label":"Fev","value":944},{"label":"Mar","value":799},{"label":"Abr","value":771},{"label":"Mai","value":841},{"label":"Jun","value":609},{"label":"Jul","value":728},{"label":"Ago","value":807},{"label":"Set","value":922},{"label":"Out","value":905},{"label":"Nov","value":720},{"label":"Dez","value":706}];
const MX = 944;
