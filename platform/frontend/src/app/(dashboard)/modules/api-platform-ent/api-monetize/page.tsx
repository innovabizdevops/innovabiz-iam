...
const ROWS = [
  { id: "001", c: ["Api Monetize-001", "Api Monetize Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Api Monetize-002", "Api Monetize Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Api Monetize-003", "Api Monetize Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Api Monetize-004", "Api Monetize Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Api Monetize-005", "Api Monetize Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Api Monetize", ts: "Há 2min", a: "Sistema" },
...
export default function ApiMonetizePage() {
  return (
