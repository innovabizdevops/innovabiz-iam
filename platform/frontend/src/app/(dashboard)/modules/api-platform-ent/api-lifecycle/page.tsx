...
const ROWS = [
  { id: "001", c: ["Api Lifecycle-001", "Api Lifecycle Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Api Lifecycle-002", "Api Lifecycle Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Api Lifecycle-003", "Api Lifecycle Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Api Lifecycle-004", "Api Lifecycle Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Api Lifecycle-005", "Api Lifecycle Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Api Lifecycle", ts: "Há 2min", a: "Sistema" },
