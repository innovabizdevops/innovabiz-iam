...
const PAGE = "Benefits";
const KPIS = [{"l":"Total Veteran Affairs","v":"7.227","t":"+15.4%","d":"up"},{"l":"Benefits Ativos","v":"4.212","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"81.6%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"95","t":"+4.0%","d":"up"}];
const COLS = ["ID","Benefits","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Affairs #001","Veteran Affairs #002","5.644","1.454","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Affairs #002","Veteran Affairs #003","6.106","8.159","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Affairs #003","Veteran Affairs #004","2.016","7.956","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Affairs #004","Veteran Affairs #005","2.937","4.613","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Affairs #005","Veteran Affairs #001","5.203","2.830","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":822},{"label":"Mar","value":884},{"label":"Abr","value":633},{"label":"Mai","value":766},{"label":"Jun","value":753},{"label":"Jul","value":525},{"label":"Ago","value":549},{"label":"Set","value":684},{"label":"Out","value":665},{"label":"Nov","value":710},{"label":"Dez","value":743}];
const MX = 884;
