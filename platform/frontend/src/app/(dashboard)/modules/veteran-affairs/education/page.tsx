...
const KPIS = [{"l":"Total Veteran Affairs","v":"2.493","t":"+9.7%","d":"up"},{"l":"Education Ativos","v":"2.697","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"66.6%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"90","t":"+1.2%","d":"up"}];
const COLS = ["ID","Education","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Affairs #001","Veteran Affairs #002","3.839","5.019","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Affairs #002","Veteran Affairs #003","543","8.679","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Affairs #003","Veteran Affairs #004","1.645","3.280","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Affairs #004","Veteran Affairs #005","6.168","4.632","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Affairs #005","Veteran Affairs #001","176","8.064","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":381},{"label":"Fev","value":356},{"label":"Mar","value":422},{"label":"Abr","value":293},{"label":"Mai","value":338},{"label":"Jun","value":361},{"label":"Jul","value":465},{"label":"Ago","value":600},{"label":"Set","value":290},{"label":"Out","value":559},{"label":"Nov","value":615},{"label":"Dez","value":607}];
const MX = 615;
