...
const KPIS = [{"l":"Total Veteran Affairs","v":"774","t":"+17.2%","d":"up"},{"l":"Disability Ativos","v":"7.613","t":"+12.2%","d":"up"},{"l":"Eficiência (%)","v":"65.4%","t":"+16.8%","d":"up"},{"l":"Score Performance","v":"86","t":"+7.4%","d":"up"}];
const COLS = ["ID","Disability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Affairs #001","Veteran Affairs #002","1.230","4.370","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Affairs #002","Veteran Affairs #003","3.622","3.757","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Affairs #003","Veteran Affairs #004","2.230","6.093","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Affairs #004","Veteran Affairs #005","7.708","8.670","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Affairs #005","Veteran Affairs #001","6.163","5.304","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":266},{"label":"Mar","value":427},{"label":"Abr","value":384},{"label":"Mai","value":499},{"label":"Jun","value":262},{"label":"Jul","value":283},{"label":"Ago","value":246},{"label":"Set","value":579},{"label":"Out","value":252},{"label":"Nov","value":381},{"label":"Dez","value":434}];
const MX = 607;
