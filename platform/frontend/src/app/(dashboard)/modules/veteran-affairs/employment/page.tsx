...
const ACCENT = "#6366f1";
const MODULE = "Veteran Affairs";
const PAGE = "Employment";
const KPIS = [{"l":"Total Veteran Affairs","v":"2.348","t":"-3.2%","d":"down"},{"l":"Employment Ativos","v":"2.846","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"57","t":"+7.8%","d":"up"}];
const COLS = ["ID","Employment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Affairs #001","Veteran Affairs #002","8.129","1.304","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Affairs #002","Veteran Affairs #003","2.064","1.610","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Affairs #003","Veteran Affairs #004","5.710","5.707","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Affairs #004","Veteran Affairs #005","4.194","7.870","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Affairs #005","Veteran Affairs #001","6.062","7.321","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":684},{"label":"Mar","value":404},{"label":"Abr","value":668},{"label":"Mai","value":642},{"label":"Jun","value":435},{"label":"Jul","value":377},{"label":"Ago","value":641},{"label":"Set","value":447},{"label":"Out","value":412},{"label":"Nov","value":512},{"label":"Dez","value":603}];
const MX = 684;
