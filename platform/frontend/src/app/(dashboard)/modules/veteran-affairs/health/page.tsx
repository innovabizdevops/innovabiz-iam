...
const PAGE = "Healthcare";
const KPIS = [{"l":"Total Veteran Affairs","v":"997","t":"+15.6%","d":"up"},{"l":"Healthcare Ativos","v":"1.229","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"90.1%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"82","t":"-2.3%","d":"down"}];
const COLS = ["ID","Healthcare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Veteran Affairs #001","Veteran Affairs #002","2.006","8.134","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Veteran Affairs #002","Veteran Affairs #003","5.012","2.164","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Veteran Affairs #003","Veteran Affairs #004","4.070","5.428","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Veteran Affairs #004","Veteran Affairs #005","1.169","1.644","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Veteran Affairs #005","Veteran Affairs #001","414","4.270","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":903},{"label":"Fev","value":1040},{"label":"Mar","value":994},{"label":"Abr","value":905},{"label":"Mai","value":779},{"label":"Jun","value":1043},{"label":"Jul","value":958},{"label":"Ago","value":891},{"label":"Set","value":722},{"label":"Out","value":884},{"label":"Nov","value":966},{"label":"Dez","value":740}];
const MX = 1043;
