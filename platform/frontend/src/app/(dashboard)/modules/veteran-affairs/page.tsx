...
export default function VeteranAffairsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Veteran Affairs</h1><p className="text-sm text-muted-foreground">Veteran Affairs • iBOS Enterprise</p></div>
