...
export default function DistilleryOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Distillery Ops</h1><p className="text-sm text-muted-foreground">Distillery Ops • iBOS Enterprise</p></div>
