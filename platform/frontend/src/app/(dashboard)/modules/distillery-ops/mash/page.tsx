...
const ACCENT = "#6366f1";
const MODULE = "Distillery Operations";
const PAGE = "Mash";
const KPIS = [{"l":"Total Distillery Ops","v":"6.367","t":"-2.1%","d":"down"},{"l":"Mash Ativos","v":"7.030","t":"-5.7%","d":"down"},{"l":"Eficiência (%)","v":"85.6%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.2%","d":"up"}];
const COLS = ["ID","Mash","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Distillery Ops #001","Distillery Ops #002","2.156","3.986","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Distillery Ops #002","Distillery Ops #003","1.840","8.625","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Distillery Ops #003","Distillery Ops #004","2.117","508","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Distillery Ops #004","Distillery Ops #005","4.726","3.741","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Distillery Ops #005","Distillery Ops #001","4.695","6.763","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":953},{"label":"Mar","value":867},{"label":"Abr","value":732},{"label":"Mai","value":709},{"label":"Jun","value":882},{"label":"Jul","value":714},{"label":"Ago","value":809},{"label":"Set","value":942},{"label":"Out","value":964},{"label":"Nov","value":694},{"label":"Dez","value":936}];
const MX = 964;
