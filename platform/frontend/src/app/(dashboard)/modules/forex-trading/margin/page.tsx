...
const PAGE = "Margin";
const KPIS = [{"l":"ARR (€M)","v":"€16.6M","t":"-3.5%","d":"down"},{"l":"MRR (€)","v":"€74958","t":"+9.6%","d":"up"},{"l":"Churn (%)","v":"65.7%","t":"+1.1%","d":"up"},{"l":"ARPU (€)","v":"€67405","t":"+8.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 32928.35","4.308","€ 35742.15","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 38531.27","221","€ 28000.84","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 30293.28","2.356","€ 38406.36","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 38041.49","8.875","€ 13114.07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 49057.82","1.948","€ 32259.53","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":532},{"label":"Mar","value":678},{"label":"Abr","value":545},{"label":"Mai","value":716},{"label":"Jun","value":775},{"label":"Jul","value":458},{"label":"Ago","value":665},{"label":"Set","value":754},{"label":"Out","value":637},{"label":"Nov","value":775},{"label":"Dez","value":446}];
const MX = 775;
