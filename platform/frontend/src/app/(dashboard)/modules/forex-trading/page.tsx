...
const KPIS = [
    { label: "Total Registos", value: "5055", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3639", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€289K", trend: "-19%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1390964855", cells: ["FOR-6855", "Forex Trading Item 1", "8/12/2026", "€14 955"], status: "active" as const },
    { id: "1390968426", cells: ["FOR-1426", "Forex Trading Item 2", "23/7/2026", "€18 526"], status: "pending" as const },
    { id: "1390971997", cells: ["FOR-4997", "Forex Trading Item 3", "10/2/2026", "€22 097"], status: "completed" as const },
    { id: "1390975568", cells: ["FOR-8568", "Forex Trading Item 4", "25/9/2026", "€25 668"], status: "warning" as const },
    { id: "1390979139", cells: ["FOR-3139", "Forex Trading Item 5", "12/4/2026", "€29 239"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Forex Trading</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Forex Trading</p>
                    </div>
                </div>
