...
const PAGE = "Platform";
const KPIS = [{"l":"Formulários Ativos","v":"7.516","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"4459","t":"-1.1%","d":"down"},{"l":"Documentos Gerados","v":"4.058","t":"+1.4%","d":"up"},{"l":"Templates","v":"2.876","t":"-4.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.945","2026-03-03","4.509","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.874","2026-01-17","2.116","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.660","2026-03-25","1.241","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.926","2026-03-02","1.472","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.686","2026-01-13","5.354","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":834},{"label":"Fev","value":749},{"label":"Mar","value":753},{"label":"Abr","value":916},{"label":"Mai","value":659},{"label":"Jun","value":633},{"label":"Jul","value":693},{"label":"Ago","value":797},{"label":"Set","value":563},{"label":"Out","value":849},{"label":"Nov","value":660},{"label":"Dez","value":696}];
const MX = 916;
