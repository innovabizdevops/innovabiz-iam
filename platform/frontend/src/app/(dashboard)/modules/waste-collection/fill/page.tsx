...
const PAGE = "Fill Level";
const KPIS = [{"l":"Total Waste Collection","v":"1.814","t":"+7.2%","d":"up"},{"l":"Fill Level Ativos","v":"258","t":"-3.8%","d":"down"},{"l":"Eficiência (%)","v":"71.3%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"90","t":"+8.4%","d":"up"}];
const COLS = ["ID","Fill Level","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Collection #001","Waste Collection #002","7.755","7.603","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Collection #002","Waste Collection #003","2.294","1.036","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Collection #003","Waste Collection #004","4.393","2.561","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Collection #004","Waste Collection #005","8.340","7.151","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Collection #005","Waste Collection #001","3.732","7.273","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":921},{"label":"Mar","value":975},{"label":"Abr","value":881},{"label":"Mai","value":917},{"label":"Jun","value":880},{"label":"Jul","value":847},{"label":"Ago","value":815},{"label":"Set","value":774},{"label":"Out","value":700},{"label":"Nov","value":825},{"label":"Dez","value":629}];
const MX = 975;
