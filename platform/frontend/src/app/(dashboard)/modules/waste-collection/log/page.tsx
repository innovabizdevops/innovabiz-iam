...
const PAGE = "Collection Log";
const KPIS = [{"l":"Total Waste Collection","v":"2.301","t":"+5.7%","d":"up"},{"l":"Collection Log Ativos","v":"7.985","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+9.9%","d":"up"}];
const COLS = ["ID","Collection Log","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Collection #001","Waste Collection #002","1.799","3.097","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Collection #002","Waste Collection #003","2.563","6.618","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Collection #003","Waste Collection #004","887","2.969","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Collection #004","Waste Collection #005","7.219","5.968","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Collection #005","Waste Collection #001","2.575","7.362","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":1034},{"label":"Mar","value":1079},{"label":"Abr","value":1004},{"label":"Mai","value":1012},{"label":"Jun","value":928},{"label":"Jul","value":757},{"label":"Ago","value":851},{"label":"Set","value":693},{"label":"Out","value":965},{"label":"Nov","value":795},{"label":"Dez","value":954}];
const MX = 1079;
