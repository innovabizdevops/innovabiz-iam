...
const KPIS = [{"l":"Total Waste Collection","v":"6.791","t":"-3.3%","d":"down"},{"l":"Recycling Ativos","v":"4.136","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"76.8%","t":"+6.4%","d":"up"},{"l":"Score Performance","v":"81","t":"-0.3%","d":"down"}];
const COLS = ["ID","Recycling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Collection #001","Waste Collection #002","2.755","7.511","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Collection #002","Waste Collection #003","4.199","7.554","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Collection #003","Waste Collection #004","1.961","4.472","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Collection #004","Waste Collection #005","5.340","6.827","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Collection #005","Waste Collection #001","3.137","2.328","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":514},{"label":"Fev","value":477},{"label":"Mar","value":314},{"label":"Abr","value":623},{"label":"Mai","value":654},{"label":"Jun","value":366},{"label":"Jul","value":652},{"label":"Ago","value":614},{"label":"Set","value":612},{"label":"Out","value":586},{"label":"Nov","value":602},{"label":"Dez","value":504}];
const MX = 654;
