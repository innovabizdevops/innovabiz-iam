...
const ACCENT = "#7c3aed";
const MODULE = "Smart Waste Collection";
const PAGE = "Route Optimize";
const KPIS = [{"l":"Total Waste Collection","v":"5.896","t":"+8.0%","d":"up"},{"l":"Route Optimize Ativos","v":"7.769","t":"+10.2%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"-4.0%","d":"down"},{"l":"Score Performance","v":"56","t":"+8.4%","d":"up"}];
const COLS = ["ID","Route Optimize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Waste Collection #001","Waste Collection #002","2.523","9.051","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Waste Collection #002","Waste Collection #003","7.683","8.440","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Waste Collection #003","Waste Collection #004","6.908","4.311","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Waste Collection #004","Waste Collection #005","3.495","2.890","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Waste Collection #005","Waste Collection #001","5.566","7.959","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":532},{"label":"Fev","value":567},{"label":"Mar","value":341},{"label":"Abr","value":666},{"label":"Mai","value":356},{"label":"Jun","value":352},{"label":"Jul","value":592},{"label":"Ago","value":637},{"label":"Set","value":487},{"label":"Out","value":430},{"label":"Nov","value":637},{"label":"Dez","value":614}];
const MX = 666;
