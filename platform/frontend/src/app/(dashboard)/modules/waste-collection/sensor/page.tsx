...
const PAGE = "Bin Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"2.604","t":"+16.8%","d":"up"},{"l":"Dados/Min (MB)","v":"793","t":"+3.7%","d":"up"},{"l":"Alertas Ativos","v":"2.200","t":"+16.0%","d":"up"},{"l":"Uptime (%)","v":"94.1%","t":"+17.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.314","1.554","8.953","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","6.237","2.075","8.496","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.048","7.133","5.763","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","2.214","8.379","8.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.520","7.350","753","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":475},{"label":"Mar","value":658},{"label":"Abr","value":657},{"label":"Mai","value":574},{"label":"Jun","value":548},{"label":"Jul","value":599},{"label":"Ago","value":336},{"label":"Set","value":292},{"label":"Out","value":597},{"label":"Nov","value":551},{"label":"Dez","value":352}];
const MX = 658;
