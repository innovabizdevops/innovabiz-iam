...
/* ═══ Franchise Real Estate — Dashboard ═══ */

const ACCENT = "#bfdbfe";

const KPIS = [
    { label: "Total Registos", value: "8402", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3873", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€19K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2050813102", cells: ["FRA-2102", "Franchise Real Estate Item 1", "3/11/2026", "€13 202"], status: "active" as const },
    { id: "2050816673", cells: ["FRA-5673", "Franchise Real Estate Item 2", "18/6/2026", "€16 773"], status: "pending" as const },
    { id: "2050820244", cells: ["FRA-9244", "Franchise Real Estate Item 3", "5/1/2026", "€20 344"], status: "completed" as const },
    { id: "2050823815", cells: ["FRA-3815", "Franchise Real Estate Item 4", "20/8/2026", "€23 915"], status: "warning" as const },
    { id: "2050827386", cells: ["FRA-7386", "Franchise Real Estate Item 5", "7/3/2026", "€27 486"], status: "active" as const },
];
...
export default function FranchiseRealEstatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Real Estate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Real Estate</p>
                    </div>
                </div>
