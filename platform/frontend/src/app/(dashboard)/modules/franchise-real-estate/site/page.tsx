...
const ACCENT = "#bfdbfe";
const MODULE = "Franchise Real Estate";
const PAGE = "Site Select";
const KPIS = [{"l":"Total Franchise Real Estate","v":"6.866","t":"+9.6%","d":"up"},{"l":"Site Select Ativos","v":"3.182","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"89.9%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"70","t":"+0.7%","d":"up"}];
const COLS = ["ID","Site Select","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Franchise Real Estate #001","Franchise Real Estate #002","7.964","4.879","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Franchise Real Estate #002","Franchise Real Estate #003","668","5.902","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Franchise Real Estate #003","Franchise Real Estate #004","796","2.723","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Franchise Real Estate #004","Franchise Real Estate #005","6.585","3.879","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Franchise Real Estate #005","Franchise Real Estate #001","8.117","3.600","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":412},{"label":"Fev","value":638},{"label":"Mar","value":605},{"label":"Abr","value":352},{"label":"Mai","value":660},{"label":"Jun","value":654},{"label":"Jul","value":626},{"label":"Ago","value":396},{"label":"Set","value":358},{"label":"Out","value":558},{"label":"Nov","value":535},{"label":"Dez","value":472}];
const MX = 660;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#bfdbfe'}}>AI</span></h1>
                </div>
