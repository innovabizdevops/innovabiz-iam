...
const ACCENT = "#164e63";
const MODULE = "Sewerage Operations";
const PAGE = "Pump";
const KPIS = [{"l":"Total Sewerage Ops","v":"1.322","t":"-3.5%","d":"down"},{"l":"Pump Ativos","v":"6.354","t":"+-0.0%","d":"up"},{"l":"Eficiência (%)","v":"69.5%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"88","t":"+4.4%","d":"up"}];
const COLS = ["ID","Pump","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sewerage Ops #001","Sewerage Ops #002","688","3.596","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Sewerage Ops #002","Sewerage Ops #003","1.350","2.647","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Sewerage Ops #003","Sewerage Ops #004","7.778","5.964","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Sewerage Ops #004","Sewerage Ops #005","7.927","3.909","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sewerage Ops #005","Sewerage Ops #001","8.390","7.132","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":334},{"label":"Mar","value":533},{"label":"Abr","value":460},{"label":"Mai","value":623},{"label":"Jun","value":501},{"label":"Jul","value":322},{"label":"Ago","value":324},{"label":"Set","value":428},{"label":"Out","value":496},{"label":"Nov","value":365},{"label":"Dez","value":527}];
const MX = 623;
