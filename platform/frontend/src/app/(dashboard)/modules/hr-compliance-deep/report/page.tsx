...
const PAGE = "Report";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.995","t":"-2.3%","d":"down"},{"l":"NC Abertas","v":"7.063","t":"+4.3%","d":"up"},{"l":"Conformidade (%)","v":"67.1%","t":"+16.8%","d":"up"},{"l":"CAPAs Pendentes","v":"6.007","t":"+5.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.116","86.1%","8.769","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.239","99.0%","6.112","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.134","93.4%","5.349","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.845","73.0%","4.556","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.343","92.1%","2.563","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":874},{"label":"Mar","value":601},{"label":"Abr","value":990},{"label":"Mai","value":883},{"label":"Jun","value":957},{"label":"Jul","value":621},{"label":"Ago","value":648},{"label":"Set","value":833},{"label":"Out","value":637},{"label":"Nov","value":696},{"label":"Dez","value":624}];
const MX = 990;
