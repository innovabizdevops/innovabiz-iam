...
/* ═══ HR Compliance Deep — Dashboard ═══ */

const ACCENT = "#0e7490";

const KPIS = [
    { label: "Total Registos", value: "6874", trend: "-25%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "446", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "-7%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "528013374", cells: ["HR-2374", "HR Compliance Deep Item 1", "15/7/2026", "€13 474"], status: "active" as const },
    { id: "528016945", cells: ["HR-5945", "HR Compliance Deep Item 2", "2/2/2026", "€17 045"], status: "pending" as const },
    { id: "528020516", cells: ["HR-9516", "HR Compliance Deep Item 3", "17/9/2026", "€20 616"], status: "completed" as const },
    { id: "528024087", cells: ["HR-4087", "HR Compliance Deep Item 4", "4/4/2026", "€24 187"], status: "warning" as const },
    { id: "528027658", cells: ["HR-7658", "HR Compliance Deep Item 5", "19/11/2026", "€27 758"], status: "active" as const },
];
...
export default function HrComplianceDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HR Compliance Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HR Compliance Deep</p>
                    </div>
                </div>
