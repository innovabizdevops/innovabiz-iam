...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.129","t":"+13.4%","d":"up"},{"l":"NC Abertas","v":"2.462","t":"+4.3%","d":"up"},{"l":"Conformidade (%)","v":"83.0%","t":"-0.7%","d":"down"},{"l":"CAPAs Pendentes","v":"5.076","t":"+7.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.052","97.6%","5.276","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.358","83.7%","6.298","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","4.502","71.6%","8.994","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","4.696","71.6%","6.039","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.147","88.8%","3.959","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":439},{"label":"Mar","value":548},{"label":"Abr","value":505},{"label":"Mai","value":667},{"label":"Jun","value":683},{"label":"Jul","value":669},{"label":"Ago","value":608},{"label":"Set","value":509},{"label":"Out","value":334},{"label":"Nov","value":484},{"label":"Dez","value":348}];
const MX = 683;
