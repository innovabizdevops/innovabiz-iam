...
const PAGE = "Labor Law";
const KPIS = [{"l":"Auditorias Realizadas","v":"957","t":"+16.9%","d":"up"},{"l":"NC Abertas","v":"3.331","t":"+5.7%","d":"up"},{"l":"Conformidade (%)","v":"78.5%","t":"+17.0%","d":"up"},{"l":"CAPAs Pendentes","v":"7.268","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.675","99.3%","6.904","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","2.998","88.7%","501","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.602","71.2%","3.068","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.165","77.6%","8.829","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.558","88.1%","2.338","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":326},{"label":"Fev","value":248},{"label":"Mar","value":280},{"label":"Abr","value":543},{"label":"Mai","value":402},{"label":"Jun","value":428},{"label":"Jul","value":469},{"label":"Ago","value":501},{"label":"Set","value":260},{"label":"Out","value":376},{"label":"Nov","value":516},{"label":"Dez","value":432}];
const MX = 543;
