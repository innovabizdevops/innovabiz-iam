...
const PAGE = "Train";
const KPIS = [{"l":"Auditorias Realizadas","v":"743","t":"+0.9%","d":"up"},{"l":"NC Abertas","v":"6.879","t":"+3.2%","d":"up"},{"l":"Conformidade (%)","v":"82.9%","t":"+1.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.665","t":"+10.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.152","95.0%","7.166","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.827","70.5%","145","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.428","75.2%","4.160","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.146","70.6%","8.595","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.702","83.5%","8.057","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":739},{"label":"Mar","value":528},{"label":"Abr","value":709},{"label":"Mai","value":761},{"label":"Jun","value":392},{"label":"Jul","value":485},{"label":"Ago","value":693},{"label":"Set","value":527},{"label":"Out","value":679},{"label":"Nov","value":747},{"label":"Dez","value":627}];
const MX = 761;
