...
const ACCENT = "#0e7490";
const MODULE = "HR Compliance Deep";
const PAGE = "Certify";
const KPIS = [{"l":"Auditorias Realizadas","v":"373","t":"+13.9%","d":"up"},{"l":"NC Abertas","v":"2.654","t":"-4.1%","d":"down"},{"l":"Conformidade (%)","v":"75.1%","t":"+13.5%","d":"up"},{"l":"CAPAs Pendentes","v":"6.487","t":"+17.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.570","81.9%","1.315","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.279","71.0%","6.836","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.115","83.1%","4.844","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.280","92.8%","1.135","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.960","82.1%","6.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":647},{"label":"Fev","value":725},{"label":"Mar","value":605},{"label":"Abr","value":651},{"label":"Mai","value":651},{"label":"Jun","value":809},{"label":"Jul","value":660},{"label":"Ago","value":823},{"label":"Set","value":659},{"label":"Out","value":665},{"label":"Nov","value":693},{"label":"Dez","value":664}];
const MX = 823;
