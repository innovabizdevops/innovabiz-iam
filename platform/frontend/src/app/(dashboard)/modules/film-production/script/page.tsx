...
const ACCENT = "#ea580c";
const MODULE = "Film Production";
const PAGE = "Script Track";
const KPIS = [{"l":"Total Film Production","v":"6.409","t":"+16.5%","d":"up"},{"l":"Script Track Ativos","v":"5.665","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+16.7%","d":"up"},{"l":"Score Performance","v":"76","t":"-1.6%","d":"down"}];
const COLS = ["ID","Script Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Film Production #001","Film Production #002","1.600","7.680","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Film Production #002","Film Production #003","4.468","2.498","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Film Production #003","Film Production #004","6.924","5.512","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Film Production #004","Film Production #005","1.854","7.814","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Film Production #005","Film Production #001","4.573","2.417","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":541},{"label":"Mar","value":776},{"label":"Abr","value":520},{"label":"Mai","value":680},{"label":"Jun","value":772},{"label":"Jul","value":568},{"label":"Ago","value":733},{"label":"Set","value":796},{"label":"Out","value":578},{"label":"Nov","value":498},{"label":"Dez","value":526}];
const MX = 796;
