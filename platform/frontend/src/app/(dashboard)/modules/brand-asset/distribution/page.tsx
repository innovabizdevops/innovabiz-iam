...
const KPIS = [{"l":"Ativos Registados","v":"867","t":"+9.2%","d":"up"},{"l":"Valor Total (€M)","v":"€3.2M","t":"+2.1%","d":"up"},{"l":"Depreciação Anual (€)","v":"€42776","t":"+3.4%","d":"up"},{"l":"Ativos em Garantia","v":"2.377","t":"-3.3%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 16813.19","4.773","€ 27436.93","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 27159.20","2.574","€ 11298.52","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 28924.78","723","€ 21431.10","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 42149.25","4.447","€ 3823.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 38858.26","2.618","€ 22924.57","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":565},{"label":"Fev","value":600},{"label":"Mar","value":629},{"label":"Abr","value":636},{"label":"Mai","value":611},{"label":"Jun","value":460},{"label":"Jul","value":529},{"label":"Ago","value":679},{"label":"Set","value":757},{"label":"Out","value":523},{"label":"Nov","value":652},{"label":"Dez","value":520}];
const MX = 757;
