...
const PAGE = "Brand Guide";
const KPIS = [{"l":"Ativos Registados","v":"2.940","t":"+1.2%","d":"up"},{"l":"Valor Total (€M)","v":"€42.6M","t":"-3.3%","d":"down"},{"l":"Depreciação Anual (€)","v":"€16858","t":"-4.8%","d":"down"},{"l":"Ativos em Garantia","v":"1.311","t":"+9.4%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 6206.60","2.336","€ 41828.14","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 7615.78","251","€ 31213.04","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 45299.37","1.693","€ 26531.59","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 27112.58","2.010","€ 22799.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 7603.80","6.588","€ 34234.71","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":295},{"label":"Fev","value":607},{"label":"Mar","value":441},{"label":"Abr","value":360},{"label":"Mai","value":425},{"label":"Jun","value":613},{"label":"Jul","value":541},{"label":"Ago","value":367},{"label":"Set","value":594},{"label":"Out","value":640},{"label":"Nov","value":454},{"label":"Dez","value":310}];
const MX = 640;
