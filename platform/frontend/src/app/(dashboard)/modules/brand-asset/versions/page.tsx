...
const KPIS = [{"l":"Formulários Ativos","v":"3.109","t":"+4.9%","d":"up"},{"l":"Submissões/Dia","v":"489","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"4.600","t":"+5.0%","d":"up"},{"l":"Templates","v":"5.836","t":"-5.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.072","2026-02-20","3.423","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.657","2026-03-02","1.641","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.351","2026-02-05","6.883","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.076","2026-01-21","7.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.603","2026-03-12","8.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":650},{"label":"Mar","value":480},{"label":"Abr","value":845},{"label":"Mai","value":561},{"label":"Jun","value":455},{"label":"Jul","value":515},{"label":"Ago","value":486},{"label":"Set","value":758},{"label":"Out","value":549},{"label":"Nov","value":757},{"label":"Dez","value":682}];
const MX = 845;
