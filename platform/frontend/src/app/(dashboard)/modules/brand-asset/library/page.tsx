...
const KPIS = [{"l":"Ativos Registados","v":"2.667","t":"+3.4%","d":"up"},{"l":"Valor Total (€M)","v":"€17.0M","t":"+5.2%","d":"up"},{"l":"Depreciação Anual (€)","v":"€74830","t":"+5.9%","d":"up"},{"l":"Ativos em Garantia","v":"5.260","t":"+17.8%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 5041.37","7.986","€ 1728.15","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 1467.40","6.537","€ 30479.14","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 8488.45","1.287","€ 19251.92","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 47288.62","1.551","€ 48611.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 10316.92","2.850","€ 42534.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":545},{"label":"Mar","value":637},{"label":"Abr","value":747},{"label":"Mai","value":858},{"label":"Jun","value":756},{"label":"Jul","value":564},{"label":"Ago","value":696},{"label":"Set","value":592},{"label":"Out","value":845},{"label":"Nov","value":615},{"label":"Dez","value":864}];
const MX = 864;
