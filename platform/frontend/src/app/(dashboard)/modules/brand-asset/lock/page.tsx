...
const ACCENT = "#ec4899";
const MODULE = "Brand Asset Manager";
const PAGE = "Template Lock";
const KPIS = [{"l":"Formulários Ativos","v":"2.502","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"1407","t":"-0.4%","d":"down"},{"l":"Documentos Gerados","v":"7.339","t":"+11.8%","d":"up"},{"l":"Templates","v":"274","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.674","2026-03-02","4.953","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.278","2026-01-22","7.873","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.926","2026-03-12","4.816","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.092","2026-01-02","5.277","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","118","2026-03-10","330","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":508},{"label":"Mar","value":716},{"label":"Abr","value":710},{"label":"Mai","value":401},{"label":"Jun","value":498},{"label":"Jul","value":401},{"label":"Ago","value":464},{"label":"Set","value":506},{"label":"Out","value":690},{"label":"Nov","value":545},{"label":"Dez","value":734}];
const MX = 734;
