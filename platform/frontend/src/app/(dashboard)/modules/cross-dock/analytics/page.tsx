...
const KPIS = [{"l":"Dashboards Ativos","v":"3.671","t":"+17.5%","d":"up"},{"l":"Queries/Dia","v":"1759","t":"-1.7%","d":"down"},{"l":"Dados Processados (GB)","v":"4.085","t":"+5.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.772","t":"+3.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2633","2026-03-26","6.018","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1938","2026-03-14","4.150","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2396","2026-02-25","1.950","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","331","2026-02-22","3.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4123","2026-02-15","4.255","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":822},{"label":"Mar","value":490},{"label":"Abr","value":473},{"label":"Mai","value":638},{"label":"Jun","value":579},{"label":"Jul","value":761},{"label":"Ago","value":614},{"label":"Set","value":711},{"label":"Out","value":477},{"label":"Nov","value":644},{"label":"Dez","value":520}];
const MX = 822;
