...
const PAGE = "Receive";
const KPIS = [{"l":"Total Cross Dock","v":"7.476","t":"+15.9%","d":"up"},{"l":"Receive Ativos","v":"2.445","t":"+11.4%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"77","t":"+7.4%","d":"up"}];
const COLS = ["ID","Receive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Dock #001","Cross Dock #002","737","7.083","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Dock #002","Cross Dock #003","8.435","8.658","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Dock #003","Cross Dock #004","1.369","1.343","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Dock #004","Cross Dock #005","908","4.884","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Dock #005","Cross Dock #001","3.673","5.403","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":521},{"label":"Fev","value":604},{"label":"Mar","value":370},{"label":"Abr","value":444},{"label":"Mai","value":696},{"label":"Jun","value":546},{"label":"Jul","value":426},{"label":"Ago","value":562},{"label":"Set","value":646},{"label":"Out","value":542},{"label":"Nov","value":685},{"label":"Dez","value":410}];
const MX = 696;
