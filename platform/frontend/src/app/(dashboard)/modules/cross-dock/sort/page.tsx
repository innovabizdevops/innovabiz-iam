...
const PAGE = "Sort";
const KPIS = [{"l":"Total Cross Dock","v":"4.648","t":"+10.8%","d":"up"},{"l":"Sort Ativos","v":"621","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"76","t":"+11.5%","d":"up"}];
const COLS = ["ID","Sort","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Dock #001","Cross Dock #002","8.266","7.723","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Dock #002","Cross Dock #003","1.578","8.513","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Dock #003","Cross Dock #004","4.600","880","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Dock #004","Cross Dock #005","8.733","5.890","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Dock #005","Cross Dock #001","3.209","8.004","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":806},{"label":"Fev","value":659},{"label":"Mar","value":787},{"label":"Abr","value":830},{"label":"Mai","value":872},{"label":"Jun","value":980},{"label":"Jul","value":885},{"label":"Ago","value":837},{"label":"Set","value":955},{"label":"Out","value":631},{"label":"Nov","value":907},{"label":"Dez","value":972}];
const MX = 980;
