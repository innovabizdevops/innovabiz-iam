...
const PAGE = "Ship";
const KPIS = [{"l":"Total Cross Dock","v":"6.662","t":"+13.0%","d":"up"},{"l":"Ship Ativos","v":"330","t":"+13.0%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"+17.3%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.6%","d":"down"}];
const COLS = ["ID","Ship","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Dock #001","Cross Dock #002","8.251","1.586","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Dock #002","Cross Dock #003","2.223","6.992","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Dock #003","Cross Dock #004","210","1.544","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Dock #004","Cross Dock #005","1.401","2.905","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Dock #005","Cross Dock #001","5.472","4.195","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":823},{"label":"Mar","value":864},{"label":"Abr","value":893},{"label":"Mai","value":881},{"label":"Jun","value":778},{"label":"Jul","value":726},{"label":"Ago","value":670},{"label":"Set","value":939},{"label":"Out","value":735},{"label":"Nov","value":902},{"label":"Dez","value":768}];
const MX = 939;
