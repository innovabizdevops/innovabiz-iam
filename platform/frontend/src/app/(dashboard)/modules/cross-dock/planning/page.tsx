...
const PAGE = "Planning";
const KPIS = [{"l":"Total Cross Dock","v":"6.035","t":"+6.6%","d":"up"},{"l":"Planning Ativos","v":"2.143","t":"-5.5%","d":"down"},{"l":"Eficiência (%)","v":"78.8%","t":"-4.6%","d":"down"},{"l":"Score Performance","v":"62","t":"+15.5%","d":"up"}];
const COLS = ["ID","Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cross Dock #001","Cross Dock #002","7.063","3.147","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Cross Dock #002","Cross Dock #003","5.749","5.534","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Cross Dock #003","Cross Dock #004","7.148","4.379","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Cross Dock #004","Cross Dock #005","389","7.303","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cross Dock #005","Cross Dock #001","1.605","2.536","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":488},{"label":"Fev","value":572},{"label":"Mar","value":384},{"label":"Abr","value":529},{"label":"Mai","value":469},{"label":"Jun","value":509},{"label":"Jul","value":387},{"label":"Ago","value":411},{"label":"Set","value":512},{"label":"Out","value":594},{"label":"Nov","value":628},{"label":"Dez","value":396}];
const MX = 628;
