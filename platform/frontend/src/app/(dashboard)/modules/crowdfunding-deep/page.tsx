...
/* ═══ Crowdfunding Platform Deep — Dashboard ═══ */

const ACCENT = "#9333ea";

const KPIS = [
    { label: "Total Registos", value: "2024", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "602", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€422K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "686279824", cells: ["CRO-3824", "Crowdfunding Platform Deep Item 1", "21/5/2026", "€29 924"], status: "active" as const },
    { id: "686283395", cells: ["CRO-7395", "Crowdfunding Platform Deep Item 2", "8/12/2026", "€33 495"], status: "pending" as const },
    { id: "686286966", cells: ["CRO-1966", "Crowdfunding Platform Deep Item 3", "23/7/2026", "€37 066"], status: "completed" as const },
    { id: "686290537", cells: ["CRO-5537", "Crowdfunding Platform Deep Item 4", "10/2/2026", "€40 637"], status: "warning" as const },
    { id: "686294108", cells: ["CRO-9108", "Crowdfunding Platform Deep Item 5", "25/9/2026", "€44 208"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 84 }, { label: "Fev", value: 93 }, { label: "Mar", value: 22 }, { label: "Abr", value: 31 }, { label: "Mai", value: 40 }, { label: "Jun", value: 49 }];
...
export default function CrowdfundingPlatformDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crowdfunding Platform Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crowdfunding Platform Deep</p>
                    </div>
                </div>
