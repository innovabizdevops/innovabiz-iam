...
const PAGE = "Drone Scout";
const KPIS = [{"l":"Total Agri Precision","v":"6.094","t":"+13.9%","d":"up"},{"l":"Drone Scout Ativos","v":"3.273","t":"+1.4%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"61","t":"+6.1%","d":"up"}];
const COLS = ["ID","Drone Scout","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Precision #001","Agri Precision #002","5.406","8.378","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Precision #002","Agri Precision #003","4.191","888","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Precision #003","Agri Precision #004","5.206","5.018","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Precision #004","Agri Precision #005","4.095","8.199","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Precision #005","Agri Precision #001","4.338","5.778","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":634},{"label":"Mar","value":694},{"label":"Abr","value":698},{"label":"Mai","value":721},{"label":"Jun","value":758},{"label":"Jul","value":564},{"label":"Ago","value":821},{"label":"Set","value":543},{"label":"Out","value":764},{"label":"Nov","value":583},{"label":"Dez","value":838}];
const MX = 838;
