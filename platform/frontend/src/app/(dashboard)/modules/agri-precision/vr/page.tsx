...
const PAGE = "Variable Rate";
const KPIS = [{"l":"Total Agri Precision","v":"6.671","t":"+11.0%","d":"up"},{"l":"Variable Rate Ativos","v":"741","t":"+0.1%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"+8.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+0.6%","d":"up"}];
const COLS = ["ID","Variable Rate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Precision #001","Agri Precision #002","1.263","5.429","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Precision #002","Agri Precision #003","8.874","2.513","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Precision #003","Agri Precision #004","5.785","7.331","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Precision #004","Agri Precision #005","5.139","5.635","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Precision #005","Agri Precision #001","9.053","704","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":438},{"label":"Mar","value":426},{"label":"Abr","value":481},{"label":"Mai","value":434},{"label":"Jun","value":496},{"label":"Jul","value":583},{"label":"Ago","value":414},{"label":"Set","value":431},{"label":"Out","value":401},{"label":"Nov","value":543},{"label":"Dez","value":613}];
const MX = 618;
