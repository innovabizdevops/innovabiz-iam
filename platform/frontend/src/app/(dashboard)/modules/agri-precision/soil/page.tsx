...
const PAGE = "Soil Sensor";
const KPIS = [{"l":"Dispositivos Online","v":"6.801","t":"-5.2%","d":"down"},{"l":"Dados/Min (MB)","v":"698","t":"+7.4%","d":"up"},{"l":"Alertas Ativos","v":"764","t":"-0.6%","d":"down"},{"l":"Uptime (%)","v":"66.3%","t":"-1.7%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.338","9.069","6.648","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.459","3.777","3.779","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.918","5.464","1.560","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.329","6.501","1.127","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.506","6.814","5.284","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":629},{"label":"Mar","value":590},{"label":"Abr","value":602},{"label":"Mai","value":742},{"label":"Jun","value":611},{"label":"Jul","value":676},{"label":"Ago","value":465},{"label":"Set","value":591},{"label":"Out","value":438},{"label":"Nov","value":630},{"label":"Dez","value":603}];
const MX = 742;
