...
const ACCENT = "#22c55e";
const MODULE = "Precision Agriculture";
const PAGE = "Yield Map";
const KPIS = [{"l":"Total Agri Precision","v":"4.056","t":"+15.9%","d":"up"},{"l":"Yield Map Ativos","v":"1.869","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"78.6%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+5.0%","d":"up"}];
const COLS = ["ID","Yield Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agri Precision #001","Agri Precision #002","8.825","2.014","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Agri Precision #002","Agri Precision #003","2.688","8.592","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Agri Precision #003","Agri Precision #004","9.007","6.925","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Agri Precision #004","Agri Precision #005","2.443","3.549","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agri Precision #005","Agri Precision #001","1.340","7.598","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":902},{"label":"Fev","value":806},{"label":"Mar","value":631},{"label":"Abr","value":798},{"label":"Mai","value":771},{"label":"Jun","value":799},{"label":"Jul","value":731},{"label":"Ago","value":538},{"label":"Set","value":551},{"label":"Out","value":671},{"label":"Nov","value":872},{"label":"Dez","value":660}];
const MX = 902;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#22c55e'}}>AI</span></h1>
                </div>
