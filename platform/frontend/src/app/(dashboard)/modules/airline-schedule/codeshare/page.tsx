...
const PAGE = "Codeshare";
const KPIS = [{"l":"Total Airline Schedule","v":"2.051","t":"+9.4%","d":"up"},{"l":"Codeshare Ativos","v":"1.488","t":"+12.3%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"63","t":"+11.1%","d":"up"}];
const COLS = ["ID","Codeshare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Schedule #001","Airline Schedule #002","5.649","2.304","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Schedule #002","Airline Schedule #003","8.832","8.848","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Schedule #003","Airline Schedule #004","4.445","3.171","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Schedule #004","Airline Schedule #005","434","4.083","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Schedule #005","Airline Schedule #001","7.269","1.317","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":294},{"label":"Mar","value":493},{"label":"Abr","value":324},{"label":"Mai","value":516},{"label":"Jun","value":277},{"label":"Jul","value":465},{"label":"Ago","value":567},{"label":"Set","value":303},{"label":"Out","value":239},{"label":"Nov","value":242},{"label":"Dez","value":410}];
const MX = 567;
