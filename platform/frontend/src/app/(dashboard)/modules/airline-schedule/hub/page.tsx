...
const PAGE = "Hub Connect";
const KPIS = [{"l":"Total Airline Schedule","v":"1.090","t":"+17.9%","d":"up"},{"l":"Hub Connect Ativos","v":"5.047","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"89.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"73","t":"+14.3%","d":"up"}];
const COLS = ["ID","Hub Connect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Schedule #001","Airline Schedule #002","8.735","6.637","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Schedule #002","Airline Schedule #003","4.639","4.274","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Schedule #003","Airline Schedule #004","7.357","8.910","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Schedule #004","Airline Schedule #005","4.574","1.986","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Schedule #005","Airline Schedule #001","1.425","8.602","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":408},{"label":"Fev","value":633},{"label":"Mar","value":492},{"label":"Abr","value":605},{"label":"Mai","value":377},{"label":"Jun","value":538},{"label":"Jul","value":398},{"label":"Ago","value":401},{"label":"Set","value":432},{"label":"Out","value":516},{"label":"Nov","value":368},{"label":"Dez","value":330}];
const MX = 633;
