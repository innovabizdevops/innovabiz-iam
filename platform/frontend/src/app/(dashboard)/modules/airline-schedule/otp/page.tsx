...
const PAGE = "OTP Monitor";
const KPIS = [{"l":"Total Airline Schedule","v":"1.720","t":"-2.9%","d":"down"},{"l":"OTP Monitor Ativos","v":"8.261","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"90.4%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"56","t":"+5.6%","d":"up"}];
const COLS = ["ID","OTP Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Schedule #001","Airline Schedule #002","6.318","1.807","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Schedule #002","Airline Schedule #003","6.553","6.563","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Schedule #003","Airline Schedule #004","2.548","3.644","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Schedule #004","Airline Schedule #005","3.696","167","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Schedule #005","Airline Schedule #001","8.625","5.918","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":500},{"label":"Mar","value":545},{"label":"Abr","value":500},{"label":"Mai","value":700},{"label":"Jun","value":877},{"label":"Jul","value":535},{"label":"Ago","value":791},{"label":"Set","value":624},{"label":"Out","value":516},{"label":"Nov","value":502},{"label":"Dez","value":837}];
const MX = 877;
