...
const ACCENT = "#4338ca";
const MODULE = "Airline Scheduling";
const PAGE = "Network Plan";
const KPIS = [{"l":"Total Airline Schedule","v":"5.697","t":"+16.6%","d":"up"},{"l":"Network Plan Ativos","v":"3.993","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"66.3%","t":"+10.4%","d":"up"},{"l":"Score Performance","v":"74","t":"-1.7%","d":"down"}];
const COLS = ["ID","Network Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Schedule #001","Airline Schedule #002","9.023","2.963","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Schedule #002","Airline Schedule #003","6.164","3.791","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Schedule #003","Airline Schedule #004","7.806","3.141","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Schedule #004","Airline Schedule #005","3.631","7.170","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Schedule #005","Airline Schedule #001","4.440","3.988","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":534},{"label":"Mar","value":540},{"label":"Abr","value":625},{"label":"Mai","value":577},{"label":"Jun","value":390},{"label":"Jul","value":656},{"label":"Ago","value":487},{"label":"Set","value":303},{"label":"Out","value":408},{"label":"Nov","value":410},{"label":"Dez","value":416}];
const MX = 656;
