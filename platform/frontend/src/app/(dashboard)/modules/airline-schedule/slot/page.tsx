...
const PAGE = "Slot Request";
const KPIS = [{"l":"Total Airline Schedule","v":"593","t":"+9.0%","d":"up"},{"l":"Slot Request Ativos","v":"8.534","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"85.5%","t":"+1.3%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.5%","d":"down"}];
const COLS = ["ID","Slot Request","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airline Schedule #001","Airline Schedule #002","5.218","1.875","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Airline Schedule #002","Airline Schedule #003","8.441","4.185","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Airline Schedule #003","Airline Schedule #004","5.610","3.500","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Airline Schedule #004","Airline Schedule #005","1.288","8.398","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airline Schedule #005","Airline Schedule #001","3.086","2.604","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":884},{"label":"Mar","value":910},{"label":"Abr","value":891},{"label":"Mai","value":874},{"label":"Jun","value":810},{"label":"Jul","value":943},{"label":"Ago","value":834},{"label":"Set","value":709},{"label":"Out","value":700},{"label":"Nov","value":837},{"label":"Dez","value":631}];
const MX = 982;
