...
const PAGE = "Benchmark Data";
const KPIS = [{"l":"Total Comp Planning","v":"1.946","t":"-5.1%","d":"down"},{"l":"Benchmark Data Ativos","v":"4.269","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"73","t":"+0.6%","d":"up"}];
const COLS = ["ID","Benchmark Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Planning #001","2026-02-25","1.590","5.036","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Planning #002","2026-02-12","257","5.990","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Planning #003","2026-01-22","134","1.314","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Planning #004","2026-03-01","3.669","2.995","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Planning #005","2026-01-26","2.855","4.708","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":871},{"label":"Mar","value":885},{"label":"Abr","value":691},{"label":"Mai","value":823},{"label":"Jun","value":651},{"label":"Jul","value":611},{"label":"Ago","value":790},{"label":"Set","value":715},{"label":"Out","value":651},{"label":"Nov","value":789},{"label":"Dez","value":962}];
const MX = 962;
