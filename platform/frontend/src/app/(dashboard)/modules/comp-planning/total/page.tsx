...
const ACCENT = "#0e7490";
const MODULE = "Compensation Planning";
const PAGE = "Total Rewards";
const KPIS = [{"l":"Total Comp Planning","v":"1.849","t":"+17.1%","d":"up"},{"l":"Total Rewards Ativos","v":"8.658","t":"+13.4%","d":"up"},{"l":"Eficiência (%)","v":"88.8%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+7.1%","d":"up"}];
const COLS = ["ID","Total Rewards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Planning #001","Comp Planning #002","6.970","5.630","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Planning #002","Comp Planning #003","3.970","7.900","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Planning #003","Comp Planning #004","9.005","843","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Planning #004","Comp Planning #005","680","6.145","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Planning #005","Comp Planning #001","8.699","1.862","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":807},{"label":"Fev","value":895},{"label":"Mar","value":916},{"label":"Abr","value":873},{"label":"Mai","value":1045},{"label":"Jun","value":890},{"label":"Jul","value":1072},{"label":"Ago","value":1026},{"label":"Set","value":935},{"label":"Out","value":870},{"label":"Nov","value":768},{"label":"Dez","value":725}];
const MX = 1072;
