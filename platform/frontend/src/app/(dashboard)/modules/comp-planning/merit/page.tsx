...
const PAGE = "Merit Cycle";
const KPIS = [{"l":"Total Comp Planning","v":"1.208","t":"+15.9%","d":"up"},{"l":"Merit Cycle Ativos","v":"8.400","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"80.6%","t":"+2.9%","d":"up"},{"l":"Score Performance","v":"90","t":"+1.8%","d":"up"}];
const COLS = ["ID","Merit Cycle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Planning #001","Comp Planning #002","6.817","2.955","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Planning #002","Comp Planning #003","1.610","608","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Planning #003","Comp Planning #004","4.156","1.239","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Planning #004","Comp Planning #005","3.148","7.710","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Planning #005","Comp Planning #001","2.657","2.358","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":668},{"label":"Mar","value":519},{"label":"Abr","value":502},{"label":"Mai","value":576},{"label":"Jun","value":606},{"label":"Jul","value":577},{"label":"Ago","value":750},{"label":"Set","value":431},{"label":"Out","value":578},{"label":"Nov","value":542},{"label":"Dez","value":418}];
const MX = 750;
