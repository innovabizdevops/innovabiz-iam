...
const PAGE = "Salary Bands";
const KPIS = [{"l":"Total Comp Planning","v":"3.340","t":"+15.2%","d":"up"},{"l":"Salary Bands Ativos","v":"8.505","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"83.4%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.8%","d":"down"}];
const COLS = ["ID","Salary Bands","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Planning #001","Comp Planning #002","6.072","3.227","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Planning #002","Comp Planning #003","4.435","1.103","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Planning #003","Comp Planning #004","1.368","940","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Planning #004","Comp Planning #005","2.076","3.533","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Planning #005","Comp Planning #001","565","6.803","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":561},{"label":"Mar","value":430},{"label":"Abr","value":497},{"label":"Mai","value":318},{"label":"Jun","value":368},{"label":"Jul","value":482},{"label":"Ago","value":444},{"label":"Set","value":279},{"label":"Out","value":460},{"label":"Nov","value":281},{"label":"Dez","value":396}];
const MX = 561;
