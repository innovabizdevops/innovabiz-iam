...
const PAGE = "Equity Grants";
const KPIS = [{"l":"Total Comp Planning","v":"2.639","t":"+5.9%","d":"up"},{"l":"Equity Grants Ativos","v":"5.672","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+17.8%","d":"up"},{"l":"Score Performance","v":"65","t":"+2.3%","d":"up"}];
const COLS = ["ID","Equity Grants","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Comp Planning #001","Comp Planning #002","3.698","6.558","2026-01-13","Ativo"],"status":"active"},{"id":"r1","cells":["Comp Planning #002","Comp Planning #003","262","4.989","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Comp Planning #003","Comp Planning #004","5.403","3.196","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Comp Planning #004","Comp Planning #005","5.435","750","2026-02-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Comp Planning #005","Comp Planning #001","2.670","2.005","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":409},{"label":"Fev","value":584},{"label":"Mar","value":604},{"label":"Abr","value":540},{"label":"Mai","value":626},{"label":"Jun","value":695},{"label":"Jul","value":732},{"label":"Ago","value":432},{"label":"Set","value":623},{"label":"Out","value":784},{"label":"Nov","value":410},{"label":"Dez","value":776}];
const MX = 784;
