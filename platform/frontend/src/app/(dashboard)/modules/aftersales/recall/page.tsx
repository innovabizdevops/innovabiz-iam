...
const PAGE = "Recall";
const KPIS = [{"l":"Vendas YTD (€)","v":"€58994","t":"+16.7%","d":"up"},{"l":"Pipeline (€)","v":"€44411","t":"+8.8%","d":"up"},{"l":"Atingimento Quota (%)","v":"85.7%","t":"+4.6%","d":"up"},{"l":"Win Rate (%)","v":"79.6%","t":"+6.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 4380.04","€ 16700.82","€ 20670.18","97.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 40324.41","€ 35034.81","€ 25019.20","78.5%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11323.81","€ 11407.80","€ 12714.75","96.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 18548.72","€ 36806.35","€ 9196.71","83.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 25252.31","€ 32142.75","€ 37124.63","84.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":256},{"label":"Fev","value":311},{"label":"Mar","value":264},{"label":"Abr","value":509},{"label":"Mai","value":649},{"label":"Jun","value":628},{"label":"Jul","value":630},{"label":"Ago","value":634},{"label":"Set","value":270},{"label":"Out","value":387},{"label":"Nov","value":329},{"label":"Dez","value":441}];
const MX = 649;
