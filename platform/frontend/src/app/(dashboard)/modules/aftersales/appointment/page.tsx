...
const ACCENT = "#6366f1";
const MODULE = "Aftersales Service";
const PAGE = "Appointment";
const KPIS = [{"l":"Vendas YTD (€)","v":"€96693","t":"+0.6%","d":"up"},{"l":"Pipeline (€)","v":"€42963","t":"+4.0%","d":"up"},{"l":"Atingimento Quota (%)","v":"92.4%","t":"+0.3%","d":"up"},{"l":"Win Rate (%)","v":"83.5%","t":"+5.2%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 39608.74","€ 47914.39","€ 22935.14","75.6%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29476.78","€ 37587.05","€ 16620.58","97.8%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 22166.94","€ 12702.60","€ 49863.15","89.9%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 39798.52","€ 32628.02","€ 13360.44","79.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 12606.58","€ 31657.64","€ 27232.05","85.3%"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":1043},{"label":"Mar","value":846},{"label":"Abr","value":892},{"label":"Mai","value":947},{"label":"Jun","value":953},{"label":"Jul","value":885},{"label":"Ago","value":785},{"label":"Set","value":693},{"label":"Out","value":852},{"label":"Nov","value":714},{"label":"Dez","value":744}];
const MX = 1043;
