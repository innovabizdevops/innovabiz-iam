...
const PAGE = "Parts";
const KPIS = [{"l":"Vendas YTD (€)","v":"€32903","t":"+7.8%","d":"up"},{"l":"Pipeline (€)","v":"€9328","t":"+8.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"86.8%","t":"+6.0%","d":"up"},{"l":"Win Rate (%)","v":"67.2%","t":"-2.8%","d":"down"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 20067.10","€ 2636.46","€ 28733.07","92.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 7335.47","€ 28044.30","€ 40513.80","77.6%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 41363.09","€ 48616.54","€ 21228.01","90.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 386.35","€ 35439.55","€ 43985.64","93.7%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 7689.89","€ 31728.70","€ 17919.83","94.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":281},{"label":"Fev","value":595},{"label":"Mar","value":340},{"label":"Abr","value":483},{"label":"Mai","value":451},{"label":"Jun","value":301},{"label":"Jul","value":281},{"label":"Ago","value":596},{"label":"Set","value":657},{"label":"Out","value":293},{"label":"Nov","value":639},{"label":"Dez","value":521}];
const MX = 657;
