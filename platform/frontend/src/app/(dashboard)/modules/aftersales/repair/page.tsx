...
const PAGE = "Repair";
const KPIS = [{"l":"Vendas YTD (€)","v":"€15764","t":"+13.4%","d":"up"},{"l":"Pipeline (€)","v":"€51185","t":"-3.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"67.9%","t":"-4.0%","d":"down"},{"l":"Win Rate (%)","v":"82.1%","t":"+2.8%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1155.36","€ 9487.22","€ 35416.51","80.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 27606.35","€ 42837.82","€ 8229.91","99.9%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 1984.83","€ 33525.91","€ 17323.48","80.2%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 26297.11","€ 957.76","€ 44289.06","87.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 31628.76","€ 47317.45","€ 10543.22","71.9%"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":581},{"label":"Mar","value":450},{"label":"Abr","value":802},{"label":"Mai","value":530},{"label":"Jun","value":553},{"label":"Jul","value":647},{"label":"Ago","value":792},{"label":"Set","value":432},{"label":"Out","value":528},{"label":"Nov","value":585},{"label":"Dez","value":593}];
const MX = 802;
