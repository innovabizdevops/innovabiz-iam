...
const PAGE = "Warranty";
const KPIS = [{"l":"Vendas YTD (€)","v":"€14965","t":"+7.2%","d":"up"},{"l":"Pipeline (€)","v":"€2366","t":"+8.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.2%","t":"+0.7%","d":"up"},{"l":"Win Rate (%)","v":"77.8%","t":"+10.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 21967.42","€ 23170.24","€ 28631.29","81.3%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 37540.76","€ 29249.36","€ 39919.81","94.2%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 26287.41","€ 10131.91","€ 30847.84","78.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 40469.15","€ 18358.27","€ 18405.38","80.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 34226.39","€ 38300.89","€ 3915.38","85.4%"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":803},{"label":"Mar","value":814},{"label":"Abr","value":550},{"label":"Mai","value":734},{"label":"Jun","value":789},{"label":"Jul","value":724},{"label":"Ago","value":615},{"label":"Set","value":768},{"label":"Out","value":639},{"label":"Nov","value":658},{"label":"Dez","value":548}];
const MX = 814;
