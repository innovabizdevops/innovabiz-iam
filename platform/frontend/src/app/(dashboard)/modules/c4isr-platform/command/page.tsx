...
const PAGE = "Command";
const KPIS = [{"l":"Formulários Ativos","v":"6.757","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"3636","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"153","t":"+6.6%","d":"up"},{"l":"Templates","v":"1.923","t":"-2.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.239","2026-02-12","1.646","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.821","2026-03-04","232","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.218","2026-02-10","3.712","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.505","2026-01-17","366","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.069","2026-03-26","6.677","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":933},{"label":"Fev","value":805},{"label":"Mar","value":707},{"label":"Abr","value":1000},{"label":"Mai","value":667},{"label":"Jun","value":655},{"label":"Jul","value":629},{"label":"Ago","value":816},{"label":"Set","value":696},{"label":"Out","value":906},{"label":"Nov","value":987},{"label":"Dez","value":724}];
const MX = 1000;
