...
const ACCENT = "#64748b";
const MODULE = "C4ISR Platform";
const PAGE = "Intel";
const KPIS = [{"l":"Formulários Ativos","v":"6.066","t":"+1.8%","d":"up"},{"l":"Submissões/Dia","v":"1017","t":"+2.0%","d":"up"},{"l":"Documentos Gerados","v":"8.252","t":"+17.6%","d":"up"},{"l":"Templates","v":"4.288","t":"+13.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.812","2026-02-24","7.892","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.903","2026-02-26","2.530","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.469","2026-01-27","4.952","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.580","2026-01-02","2.163","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.193","2026-02-28","8.297","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":686},{"label":"Mar","value":620},{"label":"Abr","value":818},{"label":"Mai","value":793},{"label":"Jun","value":624},{"label":"Jul","value":674},{"label":"Ago","value":569},{"label":"Set","value":625},{"label":"Out","value":694},{"label":"Nov","value":709},{"label":"Dez","value":685}];
const MX = 818;
