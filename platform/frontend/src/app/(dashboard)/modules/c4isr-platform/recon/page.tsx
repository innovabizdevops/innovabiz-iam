...
const PAGE = "Recon";
const KPIS = [{"l":"Formulários Ativos","v":"1.527","t":"-3.7%","d":"down"},{"l":"Submissões/Dia","v":"3426","t":"+17.2%","d":"up"},{"l":"Documentos Gerados","v":"2.420","t":"+9.6%","d":"up"},{"l":"Templates","v":"701","t":"+9.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.519","2026-01-17","392","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.700","2026-02-21","1.635","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","372","2026-02-15","2.862","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.690","2026-01-14","2.717","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","259","2026-03-05","2.668","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":310},{"label":"Fev","value":370},{"label":"Mar","value":421},{"label":"Abr","value":469},{"label":"Mai","value":399},{"label":"Jun","value":341},{"label":"Jul","value":351},{"label":"Ago","value":424},{"label":"Set","value":241},{"label":"Out","value":326},{"label":"Nov","value":490},{"label":"Dez","value":273}];
const MX = 490;
