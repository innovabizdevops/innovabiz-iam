...
const PAGE = "Control";
const KPIS = [{"l":"Formulários Ativos","v":"5.324","t":"+6.3%","d":"up"},{"l":"Submissões/Dia","v":"2224","t":"-5.7%","d":"down"},{"l":"Documentos Gerados","v":"4.691","t":"-5.4%","d":"down"},{"l":"Templates","v":"248","t":"+2.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.025","2026-02-03","3.336","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.685","2026-01-15","540","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.399","2026-01-03","1.313","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.925","2026-01-26","889","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.657","2026-03-01","6.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":560},{"label":"Mar","value":486},{"label":"Abr","value":314},{"label":"Mai","value":317},{"label":"Jun","value":562},{"label":"Jul","value":353},{"label":"Ago","value":519},{"label":"Set","value":304},{"label":"Out","value":557},{"label":"Nov","value":555},{"label":"Dez","value":626}];
const MX = 626;
