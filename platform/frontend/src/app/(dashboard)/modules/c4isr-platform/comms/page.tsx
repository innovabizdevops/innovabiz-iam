...
const PAGE = "Comms";
const KPIS = [{"l":"Formulários Ativos","v":"8.711","t":"+2.4%","d":"up"},{"l":"Submissões/Dia","v":"290","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"991","t":"+11.2%","d":"up"},{"l":"Templates","v":"604","t":"+1.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.803","2026-03-06","6.566","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","602","2026-01-15","1.310","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.870","2026-03-20","3.728","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.589","2026-01-11","8.284","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","965","2026-03-17","6.601","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":764},{"label":"Mar","value":890},{"label":"Abr","value":848},{"label":"Mai","value":775},{"label":"Jun","value":930},{"label":"Jul","value":1020},{"label":"Ago","value":1051},{"label":"Set","value":951},{"label":"Out","value":794},{"label":"Nov","value":781},{"label":"Dez","value":774}];
const MX = 1051;
