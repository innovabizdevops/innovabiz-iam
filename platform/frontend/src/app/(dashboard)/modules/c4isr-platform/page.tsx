...
/* ═══ C4ISR Platform — Dashboard ═══ */

const ACCENT = "#64748b";

const KPIS = [
    { label: "Total Registos", value: "3840", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4028", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€231K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1174371440", cells: ["C4I-7440", "C4ISR Platform Item 1", "5/9/2026", "€21 540"], status: "active" as const },
    { id: "1174375011", cells: ["C4I-2011", "C4ISR Platform Item 2", "20/4/2026", "€25 111"], status: "pending" as const },
    { id: "1174378582", cells: ["C4I-5582", "C4ISR Platform Item 3", "7/11/2026", "€28 682"], status: "completed" as const },
    { id: "1174382153", cells: ["C4I-9153", "C4ISR Platform Item 4", "22/6/2026", "€32 253"], status: "warning" as const },
    { id: "1174385724", cells: ["C4I-3724", "C4ISR Platform Item 5", "9/1/2026", "€35 824"], status: "active" as const },
];
...
export default function C4isrPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">C4ISR Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • C4ISR Platform</p>
                    </div>
                </div>
