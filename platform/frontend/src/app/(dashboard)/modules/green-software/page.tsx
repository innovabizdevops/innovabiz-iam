...
/* ═══ Green Software Engineering — Dashboard ═══ */

const ACCENT = "#22c55e";

const KPIS = [
    { label: "Total Registos", value: "1496", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3172", trend: "-16%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€386K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1174131496", cells: ["GRE-1496", "Green Software Engineering Item 1", "21/5/2026", "€31 596"], status: "active" as const },
    { id: "1174135067", cells: ["GRE-5067", "Green Software Engineering Item 2", "8/12/2026", "€35 167"], status: "pending" as const },
    { id: "1174138638", cells: ["GRE-8638", "Green Software Engineering Item 3", "23/7/2026", "€38 738"], status: "completed" as const },
    { id: "1174142209", cells: ["GRE-3209", "Green Software Engineering Item 4", "10/2/2026", "€42 309"], status: "warning" as const },
    { id: "1174145780", cells: ["GRE-6780", "Green Software Engineering Item 5", "25/9/2026", "€45 880"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 76 }, { label: "Fev", value: 85 }, { label: "Mar", value: 94 }, { label: "Abr", value: 23 }, { label: "Mai", value: 32 }, { label: "Jun", value: 41 }];
...
export default function GreenSoftwareEngineeringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Green Software Engineering</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Green Software Engineering</p>
                    </div>
                </div>
