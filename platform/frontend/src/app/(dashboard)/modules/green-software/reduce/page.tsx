...
const PAGE = "Reduce";
const KPIS = [{"l":"Total Green Software","v":"3.461","t":"-1.1%","d":"down"},{"l":"Reduce Ativos","v":"1.841","t":"+5.6%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+5.3%","d":"up"},{"l":"Score Performance","v":"61","t":"-3.3%","d":"down"}];
const COLS = ["ID","Reduce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Software #001","Green Software #002","2.989","1.233","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Green Software #002","Green Software #003","1.655","6.477","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Software #003","Green Software #004","6.858","5.979","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Green Software #004","Green Software #005","7.236","9.000","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Software #005","Green Software #001","5.380","3.884","2026-01-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":712},{"label":"Fev","value":504},{"label":"Mar","value":652},{"label":"Abr","value":764},{"label":"Mai","value":385},{"label":"Jun","value":470},{"label":"Jul","value":624},{"label":"Ago","value":678},{"label":"Set","value":565},{"label":"Out","value":524},{"label":"Nov","value":458},{"label":"Dez","value":498}];
const MX = 764;
