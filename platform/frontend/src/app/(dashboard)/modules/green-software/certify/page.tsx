...
const ACCENT = "#22c55e";
const MODULE = "Green Software Engineering";
const PAGE = "Certify";
const KPIS = [{"l":"Total Green Software","v":"9.013","t":"-3.6%","d":"down"},{"l":"Certify Ativos","v":"7.288","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.2%","d":"up"}];
const COLS = ["ID","Certify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Green Software #001","Green Software #002","388","4.613","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Green Software #002","Green Software #003","7.722","2.173","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Green Software #003","Green Software #004","3.500","6.431","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Green Software #004","Green Software #005","4.980","6.597","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Green Software #005","Green Software #001","4.365","2.634","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":663},{"label":"Mar","value":953},{"label":"Abr","value":967},{"label":"Mai","value":641},{"label":"Jun","value":696},{"label":"Jul","value":700},{"label":"Ago","value":1022},{"label":"Set","value":691},{"label":"Out","value":1024},{"label":"Nov","value":753},{"label":"Dez","value":725}];
const MX = 1024;
