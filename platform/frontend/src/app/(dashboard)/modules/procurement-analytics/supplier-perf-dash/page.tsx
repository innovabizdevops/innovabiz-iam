...
const ROWS = [
  { id: "001", c: ["Supplier Perf Dash-001", "Supplier Perf Dash Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Supplier Perf Dash-002", "Supplier Perf Dash Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Supplier Perf Dash-003", "Supplier Perf Dash Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Supplier Perf Dash-004", "Supplier Perf Dash Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Supplier Perf Dash-005", "Supplier Perf Dash Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Supplier Perf Dash", ts: "Há 2min", a: "Sistema" },
...
export default function SupplierPerfDashPage() {
  return (
