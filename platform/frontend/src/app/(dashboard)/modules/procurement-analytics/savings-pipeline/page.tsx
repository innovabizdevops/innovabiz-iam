...
const ROWS = [
  { id: "001", c: ["Savings Pipeline-001", "Savings Pipeline Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Savings Pipeline-002", "Savings Pipeline Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Savings Pipeline-003", "Savings Pipeline Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Savings Pipeline-004", "Savings Pipeline Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Savings Pipeline-005", "Savings Pipeline Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Savings Pipeline", ts: "Há 2min", a: "Sistema" },
