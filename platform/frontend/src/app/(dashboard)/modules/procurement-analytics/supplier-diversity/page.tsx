...
const ROWS = [
  { id: "001", c: ["Supplier Diversity-001", "Supplier Diversity Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Supplier Diversity-002", "Supplier Diversity Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Supplier Diversity-003", "Supplier Diversity Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Supplier Diversity-004", "Supplier Diversity Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Supplier Diversity-005", "Supplier Diversity Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Supplier Diversity", ts: "Há 2min", a: "Sistema" },
