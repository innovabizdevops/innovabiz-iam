...
const PAGE = "Procurement Analytics";
const KPIS = [
  { l: "Total Procurement Analytics", v: "2,847", d: "+12.3%", u: true },
  { l: "Procurement Analytics Ativos", v: "1,923", d: "+5.1%", u: true },
  { l: "Pendentes", v: "124", d: "-8.4%", u: false },
  { l: "Score (%)", v: "94.2%", d: "+2.1%", u: true },
];
const COLS = ["ID", "Nome", "Categoria", "Responsável", "Data", "Estado"];
const ROWS = [
  { id: "001", c: ["Procurement Analytics-001", "Procurement Analytics Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Procurement Analytics-002", "Procurement Analytics Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Procurement Analytics-003", "Procurement Analytics Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Procurement Analytics-004", "Procurement Analytics Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Procurement Analytics-005", "Procurement Analytics Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Procurement Analytics", ts: "Há 2min", a: "Sistema" },
