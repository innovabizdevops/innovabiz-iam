...
const ROWS = [
  { id: "001", c: ["Category Insight-001", "Category Insight Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Category Insight-002", "Category Insight Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Category Insight-003", "Category Insight Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Category Insight-004", "Category Insight Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Category Insight-005", "Category Insight Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Category Insight", ts: "Há 2min", a: "Sistema" },
...
export default function CategoryInsightPage() {
  return (
