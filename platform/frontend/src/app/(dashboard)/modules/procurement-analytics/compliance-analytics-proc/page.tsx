...
const PAGE = "Compliance Analytics Proc";
const KPIS = [{"l":"Spend Total (€M)","v":"247.3","d":"+3.2%","u":true},{"l":"Savings (€M)","v":"18.4","d":"+12.1%","u":true},{"l":"Fornecedores","v":"4,847","d":"+2.1%","u":true},{"l":"Compliance (%)","v":"94.3%","d":"+1.5%","u":true}];
const COLS = ["Categoria","Spend (€M)","Savings (€)","Fornecedores","Compliance","Estado"];
const ROWS = [
  { id: "001", c: ["Compliance Analytics Proc-001", "Compliance Analytics Proc Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Compliance Analytics Proc-002", "Compliance Analytics Proc Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Compliance Analytics Proc-003", "Compliance Analytics Proc Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Compliance Analytics Proc-004", "Compliance Analytics Proc Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Compliance Analytics Proc-005", "Compliance Analytics Proc Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Compliance Analytics Proc", ts: "Há 2min", a: "Sistema" },
...
export default function ComplianceAnalyticsProcPage() {
  return (
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Procurement Analytics — iBOS Enterprise</p>
        </div>
