...
const ROWS = [
  { id: "001", c: ["Demand Aggregate-001", "Demand Aggregate Alpha", "Tipo A", "Ana Costa", "2026-02-20", "Ativo"] },
  { id: "002", c: ["Demand Aggregate-002", "Demand Aggregate Beta", "Tipo B", "João Silva", "2026-02-19", "Em Revisão"] },
  { id: "003", c: ["Demand Aggregate-003", "Demand Aggregate Gamma", "Tipo A", "Maria Santos", "2026-02-18", "Concluído"] },
  { id: "004", c: ["Demand Aggregate-004", "Demand Aggregate Delta", "Tipo C", "Pedro Oliveira", "2026-02-17", "Pendente"] },
  { id: "005", c: ["Demand Aggregate-005", "Demand Aggregate Epsilon", "Tipo B", "Carla Mendes", "2026-02-16", "Ativo"] },
];
const CHART = [65, 78, 52, 90, 85, 72, 91, 68, 83, 76, 89, 94];
const ACTIVITY = [
  { t: "Novo registo criado em Demand Aggregate", ts: "Há 2min", a: "Sistema" },
...
export default function DemandAggregatePage() {
  return (
