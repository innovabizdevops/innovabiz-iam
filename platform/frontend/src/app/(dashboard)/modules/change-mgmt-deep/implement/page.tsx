...
const KPIS = [{"l":"Tickets Abertos","v":"7.020","t":"+6.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"81.2%","t":"+4.8%","d":"up"},{"l":"MTTR (h)","v":"58h","t":"+12.9%","d":"up"},{"l":"Satisfação (%)","v":"92.2%","t":"+11.7%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.728","691","7.746","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.209","6.286","8.593","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.593","2.993","6.793","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","222","2.512","3.147","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.519","665","8.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":865},{"label":"Mar","value":1039},{"label":"Abr","value":947},{"label":"Mai","value":994},{"label":"Jun","value":755},{"label":"Jul","value":774},{"label":"Ago","value":1018},{"label":"Set","value":777},{"label":"Out","value":802},{"label":"Nov","value":657},{"label":"Dez","value":789}];
const MX = 1039;
