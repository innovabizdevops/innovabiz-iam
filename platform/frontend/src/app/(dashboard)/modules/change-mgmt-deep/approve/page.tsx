...
const PAGE = "Approve";
const KPIS = [{"l":"Tickets Abertos","v":"838","t":"-5.9%","d":"down"},{"l":"SLA Cumprido (%)","v":"73.0%","t":"-0.8%","d":"down"},{"l":"MTTR (h)","v":"206h","t":"+1.7%","d":"up"},{"l":"Satisfação (%)","v":"89.2%","t":"+4.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.470","2.955","5.392","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.691","902","3.900","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.925","2.777","3.786","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.467","5.578","6.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.990","1.356","8.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":913},{"label":"Mar","value":777},{"label":"Abr","value":872},{"label":"Mai","value":554},{"label":"Jun","value":577},{"label":"Jul","value":552},{"label":"Ago","value":685},{"label":"Set","value":676},{"label":"Out","value":700},{"label":"Nov","value":796},{"label":"Dez","value":710}];
const MX = 913;
