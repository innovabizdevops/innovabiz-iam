...
const PAGE = "Request";
const KPIS = [{"l":"Tickets Abertos","v":"3.215","t":"+3.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.9%","t":"+3.2%","d":"up"},{"l":"MTTR (h)","v":"144h","t":"-5.5%","d":"down"},{"l":"Satisfação (%)","v":"73.4%","t":"-4.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.625","1.691","857","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.580","2.745","996","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.788","1.802","7.735","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.399","4.371","752","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.814","3.704","728","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":794},{"label":"Mar","value":1003},{"label":"Abr","value":869},{"label":"Mai","value":922},{"label":"Jun","value":900},{"label":"Jul","value":789},{"label":"Ago","value":855},{"label":"Set","value":910},{"label":"Out","value":714},{"label":"Nov","value":1006},{"label":"Dez","value":973}];
const MX = 1006;
