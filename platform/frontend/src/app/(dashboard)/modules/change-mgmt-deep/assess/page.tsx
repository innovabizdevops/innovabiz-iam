...
const ACCENT = "#1e40af";
const MODULE = "Change Management Deep (ITSM)";
const PAGE = "Assess";
const KPIS = [{"l":"Tickets Abertos","v":"8.526","t":"-2.0%","d":"down"},{"l":"SLA Cumprido (%)","v":"88.6%","t":"+1.2%","d":"up"},{"l":"MTTR (h)","v":"19h","t":"+8.0%","d":"up"},{"l":"Satisfação (%)","v":"93.7%","t":"-0.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.507","1.400","2.787","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.575","963","236","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.913","3.796","6.612","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.871","880","184","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","4.164","4.037","8.259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":649},{"label":"Fev","value":589},{"label":"Mar","value":639},{"label":"Abr","value":791},{"label":"Mai","value":672},{"label":"Jun","value":720},{"label":"Jul","value":713},{"label":"Ago","value":647},{"label":"Set","value":746},{"label":"Out","value":517},{"label":"Nov","value":605},{"label":"Dez","value":782}];
const MX = 791;
