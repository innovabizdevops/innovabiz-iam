...
const PAGE = "Review";
const KPIS = [{"l":"Tickets Abertos","v":"7.201","t":"-0.6%","d":"down"},{"l":"SLA Cumprido (%)","v":"83.2%","t":"-5.4%","d":"down"},{"l":"MTTR (h)","v":"141h","t":"+10.6%","d":"up"},{"l":"Satisfação (%)","v":"93.6%","t":"+7.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.452","8.800","3.033","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","715","3.427","8.849","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.884","6.394","6.705","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","1.854","904","6.496","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","1.314","8.189","6.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":655},{"label":"Mar","value":407},{"label":"Abr","value":508},{"label":"Mai","value":687},{"label":"Jun","value":466},{"label":"Jul","value":593},{"label":"Ago","value":424},{"label":"Set","value":577},{"label":"Out","value":607},{"label":"Nov","value":564},{"label":"Dez","value":723}];
const MX = 723;
