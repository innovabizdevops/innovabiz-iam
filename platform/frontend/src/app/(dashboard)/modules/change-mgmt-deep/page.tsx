...
/* ═══ Change Management Deep (ITSM) — Dashboard ═══ */

const ACCENT = "#1e40af";

const KPIS = [
    { label: "Total Registos", value: "7254", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1550", trend: "+24%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€181K", trend: "-18%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1170543554", cells: ["CHA-4554", "Change Management Deep (ITSM) Item 1", "27/3/2026", "€43 654"], status: "active" as const },
    { id: "1170547125", cells: ["CHA-8125", "Change Management Deep (ITSM) Item 2", "14/10/2026", "€47 225"], status: "pending" as const },
    { id: "1170550696", cells: ["CHA-2696", "Change Management Deep (ITSM) Item 3", "1/5/2026", "€796"], status: "completed" as const },
    { id: "1170554267", cells: ["CHA-6267", "Change Management Deep (ITSM) Item 4", "16/12/2026", "€4367"], status: "warning" as const },
    { id: "1170557838", cells: ["CHA-9838", "Change Management Deep (ITSM) Item 5", "3/7/2026", "€7938"], status: "active" as const },
];
...
export default function ChangeManagementDeepItsmPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Change Management Deep (ITSM)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Change Management Deep (ITSM)</p>
                    </div>
                </div>
