...
const PAGE = "Executive Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"1.145","t":"+1.4%","d":"up"},{"l":"Reuniões/Semana","v":"174","t":"-3.8%","d":"down"},{"l":"Mensagens/Dia","v":"2556","t":"+1.1%","d":"up"},{"l":"Ficheiros Partilhados","v":"307","t":"+16.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.555","3263","903","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.132","1387","4.834","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","8.101","1197","2.425","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.305","1142","3.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","1.615","3012","6.929","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":807},{"label":"Mar","value":738},{"label":"Abr","value":819},{"label":"Mai","value":821},{"label":"Jun","value":658},{"label":"Jul","value":846},{"label":"Ago","value":532},{"label":"Set","value":742},{"label":"Out","value":746},{"label":"Nov","value":736},{"label":"Dez","value":890}];
const MX = 890;
