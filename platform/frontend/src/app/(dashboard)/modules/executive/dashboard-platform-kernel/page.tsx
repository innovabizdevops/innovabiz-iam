...
const PAGE = "Executive Dash";
const KPIS = [{"l":"Formulários Ativos","v":"6.056","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"3525","t":"+2.4%","d":"up"},{"l":"Documentos Gerados","v":"6.131","t":"+3.2%","d":"up"},{"l":"Templates","v":"8.373","t":"-0.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.435","2026-01-17","4.689","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.293","2026-01-19","3.116","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.417","2026-01-20","1.596","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","888","2026-01-06","8.944","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.010","2026-03-06","5.672","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":495},{"label":"Fev","value":591},{"label":"Mar","value":553},{"label":"Abr","value":650},{"label":"Mai","value":479},{"label":"Jun","value":494},{"label":"Jul","value":561},{"label":"Ago","value":531},{"label":"Set","value":811},{"label":"Out","value":688},{"label":"Nov","value":656},{"label":"Dez","value":533}];
const MX = 811;
...
export default function DashboardPlatformKernelPage() {
    return (
