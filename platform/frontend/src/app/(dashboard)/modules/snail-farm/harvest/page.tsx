...
const PAGE = "Harvest";
const KPIS = [{"l":"Total Snail Farm","v":"303","t":"-3.6%","d":"down"},{"l":"Harvest Ativos","v":"1.643","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"80.6%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"65","t":"+5.4%","d":"up"}];
const COLS = ["ID","Harvest","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snail Farm #001","Snail Farm #002","6.249","8.648","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Snail Farm #002","Snail Farm #003","2.306","4.158","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Snail Farm #003","Snail Farm #004","8.592","863","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Snail Farm #004","Snail Farm #005","3.132","4.335","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snail Farm #005","Snail Farm #001","4.976","8.556","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":924},{"label":"Mar","value":922},{"label":"Abr","value":576},{"label":"Mai","value":791},{"label":"Jun","value":928},{"label":"Jul","value":621},{"label":"Ago","value":582},{"label":"Set","value":829},{"label":"Out","value":590},{"label":"Nov","value":948},{"label":"Dez","value":855}];
const MX = 948;
