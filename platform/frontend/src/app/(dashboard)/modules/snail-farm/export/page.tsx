...
const PAGE = "Export";
const KPIS = [{"l":"Total Snail Farm","v":"4.852","t":"+5.6%","d":"up"},{"l":"Export Ativos","v":"5.160","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"66.1%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"64","t":"-4.6%","d":"down"}];
const COLS = ["ID","Export","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snail Farm #001","Snail Farm #002","973","4.846","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Snail Farm #002","Snail Farm #003","4.054","7.466","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Snail Farm #003","Snail Farm #004","226","6.427","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Snail Farm #004","Snail Farm #005","2.270","835","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snail Farm #005","Snail Farm #001","7.759","1.266","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":844},{"label":"Fev","value":679},{"label":"Mar","value":979},{"label":"Abr","value":881},{"label":"Mai","value":884},{"label":"Jun","value":722},{"label":"Jul","value":690},{"label":"Ago","value":693},{"label":"Set","value":859},{"label":"Out","value":697},{"label":"Nov","value":663},{"label":"Dez","value":762}];
const MX = 979;
