...
const PAGE = "Feed";
const KPIS = [{"l":"Total Snail Farm","v":"6.511","t":"+2.0%","d":"up"},{"l":"Feed Ativos","v":"3.824","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"60","t":"+11.5%","d":"up"}];
const COLS = ["ID","Feed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snail Farm #001","Snail Farm #002","6.706","1.451","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Snail Farm #002","Snail Farm #003","857","2.657","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Snail Farm #003","Snail Farm #004","2.045","2.965","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Snail Farm #004","Snail Farm #005","3.158","9.084","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snail Farm #005","Snail Farm #001","2.142","216","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":664},{"label":"Mar","value":967},{"label":"Abr","value":844},{"label":"Mai","value":600},{"label":"Jun","value":618},{"label":"Jul","value":940},{"label":"Ago","value":642},{"label":"Set","value":792},{"label":"Out","value":739},{"label":"Nov","value":708},{"label":"Dez","value":615}];
const MX = 967;
