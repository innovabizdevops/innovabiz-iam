...
const ACCENT = "#b45309";
const MODULE = "Snail Farming (Heliciculture)";
const PAGE = "Process";
const KPIS = [{"l":"Total Snail Farm","v":"5.214","t":"+5.9%","d":"up"},{"l":"Process Ativos","v":"2.083","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"79.7%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"73","t":"-1.8%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snail Farm #001","Snail Farm #002","6.303","4.710","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Snail Farm #002","Snail Farm #003","5.973","1.266","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Snail Farm #003","Snail Farm #004","7.170","6.141","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Snail Farm #004","Snail Farm #005","2.108","1.387","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snail Farm #005","Snail Farm #001","447","4.655","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1036},{"label":"Fev","value":766},{"label":"Mar","value":733},{"label":"Abr","value":837},{"label":"Mai","value":667},{"label":"Jun","value":745},{"label":"Jul","value":703},{"label":"Ago","value":856},{"label":"Set","value":728},{"label":"Out","value":698},{"label":"Nov","value":883},{"label":"Dez","value":788}];
const MX = 1036;
