...
/* ═══ Snail Farming (Heliciculture) — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "7281", trend: "+7%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "783", trend: "+1%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€432K", trend: "-20%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1297926881", cells: ["SNA-1881", "Snail Farming (Heliciculture) Item 1", "14/6/2026", "€26 981"], status: "active" as const },
    { id: "1297930452", cells: ["SNA-5452", "Snail Farming (Heliciculture) Item 2", "1/1/2026", "€30 552"], status: "pending" as const },
    { id: "1297934023", cells: ["SNA-9023", "Snail Farming (Heliciculture) Item 3", "16/8/2026", "€34 123"], status: "completed" as const },
    { id: "1297937594", cells: ["SNA-3594", "Snail Farming (Heliciculture) Item 4", "3/3/2026", "€37 694"], status: "warning" as const },
    { id: "1297941165", cells: ["SNA-7165", "Snail Farming (Heliciculture) Item 5", "18/10/2026", "€41 265"], status: "active" as const },
];
...
export default function SnailFarmingHeliciculturePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Snail Farming (Heliciculture)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Snail Farming (Heliciculture)</p>
                    </div>
                </div>
