...
const PAGE = "Breed";
const KPIS = [{"l":"Total Snail Farm","v":"9.020","t":"-2.6%","d":"down"},{"l":"Breed Ativos","v":"5.431","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"75.1%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"70","t":"+13.4%","d":"up"}];
const COLS = ["ID","Breed","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Snail Farm #001","Snail Farm #002","7.138","3.430","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Snail Farm #002","Snail Farm #003","4.651","8.272","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Snail Farm #003","Snail Farm #004","1.841","3.833","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Snail Farm #004","Snail Farm #005","3.822","975","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Snail Farm #005","Snail Farm #001","6.433","939","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":533},{"label":"Mar","value":840},{"label":"Abr","value":713},{"label":"Mai","value":461},{"label":"Jun","value":478},{"label":"Jul","value":822},{"label":"Ago","value":597},{"label":"Set","value":705},{"label":"Out","value":688},{"label":"Nov","value":651},{"label":"Dez","value":838}];
const MX = 840;
