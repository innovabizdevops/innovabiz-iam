...
/* ═══ MD: Multi-Tenant Engine Deep — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "1650", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3888", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€65K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1134274250", cells: ["MD-5250", "MD: Multi-Tenant Engine Deep Item 1", "19/3/2026", "€24 350"], status: "active" as const },
    { id: "1134277821", cells: ["MD-8821", "MD: Multi-Tenant Engine Deep Item 2", "6/10/2026", "€27 921"], status: "pending" as const },
    { id: "1134281392", cells: ["MD-3392", "MD: Multi-Tenant Engine Deep Item 3", "21/5/2026", "€31 492"], status: "completed" as const },
    { id: "1134284963", cells: ["MD-6963", "MD: Multi-Tenant Engine Deep Item 4", "8/12/2026", "€35 063"], status: "warning" as const },
    { id: "1134288534", cells: ["MD-1534", "MD: Multi-Tenant Engine Deep Item 5", "23/7/2026", "€38 634"], status: "active" as const },
];
...
export default function MdMultitenantEngineDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Tenant Engine Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Tenant Engine Deep</p>
                    </div>
                </div>
