...
const PAGE = "Scale";
const KPIS = [{"l":"Configurações","v":"5.051","t":"-3.3%","d":"down"},{"l":"Últimas Alterações","v":"615","t":"+11.0%","d":"up"},{"l":"Ambientes","v":"2.624","t":"+2.7%","d":"up"},{"l":"Versão Config","v":"8.860","t":"-4.0%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 10845.88","6.109","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 49940.57","4.368","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 2651.64","2.806","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 12416.62","6.499","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 16898.73","1.522","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":611},{"label":"Mar","value":532},{"label":"Abr","value":391},{"label":"Mai","value":402},{"label":"Jun","value":483},{"label":"Jul","value":458},{"label":"Ago","value":504},{"label":"Set","value":589},{"label":"Out","value":312},{"label":"Nov","value":323},{"label":"Dez","value":448}];
const MX = 611;
