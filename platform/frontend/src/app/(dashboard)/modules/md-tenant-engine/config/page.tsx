...
const PAGE = "Config";
const KPIS = [{"l":"Configurações","v":"5.350","t":"-5.4%","d":"down"},{"l":"Últimas Alterações","v":"8.065","t":"-5.5%","d":"down"},{"l":"Ambientes","v":"2.991","t":"+9.0%","d":"up"},{"l":"Versão Config","v":"7.389","t":"+14.1%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 48848.58","3.909","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 37889.50","9.029","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 10274.99","3.381","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 12249.95","6.533","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 35922.69","4.888","2026-03-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":524},{"label":"Fev","value":330},{"label":"Mar","value":455},{"label":"Abr","value":424},{"label":"Mai","value":546},{"label":"Jun","value":363},{"label":"Jul","value":236},{"label":"Ago","value":584},{"label":"Set","value":283},{"label":"Out","value":331},{"label":"Nov","value":319},{"label":"Dez","value":464}];
const MX = 584;
