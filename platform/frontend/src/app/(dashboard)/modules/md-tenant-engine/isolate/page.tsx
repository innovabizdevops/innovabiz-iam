...
const PAGE = "Isolate";
const KPIS = [{"l":"Auditorias Realizadas","v":"244","t":"+2.2%","d":"up"},{"l":"NC Abertas","v":"527","t":"+4.9%","d":"up"},{"l":"Conformidade (%)","v":"67.0%","t":"-0.4%","d":"down"},{"l":"CAPAs Pendentes","v":"2.860","t":"+1.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.596","79.9%","7.020","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.161","95.4%","6.013","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.238","77.1%","9.049","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.361","75.3%","9.066","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.216","75.4%","5.623","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":738},{"label":"Fev","value":701},{"label":"Mar","value":748},{"label":"Abr","value":879},{"label":"Mai","value":742},{"label":"Jun","value":975},{"label":"Jul","value":1026},{"label":"Ago","value":931},{"label":"Set","value":710},{"label":"Out","value":942},{"label":"Nov","value":776},{"label":"Dez","value":971}];
const MX = 1026;
