...
const KPIS = [{"l":"Configurações","v":"7.806","t":"+10.6%","d":"up"},{"l":"Últimas Alterações","v":"7.323","t":"+4.4%","d":"up"},{"l":"Ambientes","v":"601","t":"+15.0%","d":"up"},{"l":"Versão Config","v":"7.812","t":"+11.6%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 20117.50","5.694","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 34182.53","8.473","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 25015.31","113","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 29355.88","5.375","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 41233.59","7.790","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1024},{"label":"Fev","value":964},{"label":"Mar","value":689},{"label":"Abr","value":737},{"label":"Mai","value":980},{"label":"Jun","value":918},{"label":"Jul","value":787},{"label":"Ago","value":933},{"label":"Set","value":993},{"label":"Out","value":741},{"label":"Nov","value":823},{"label":"Dez","value":818}];
const MX = 1024;
