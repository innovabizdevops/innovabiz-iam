...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Tenant Engine Deep";
const PAGE = "Monitor";
const KPIS = [{"l":"Configurações","v":"8.657","t":"+7.8%","d":"up"},{"l":"Últimas Alterações","v":"3.588","t":"+1.9%","d":"up"},{"l":"Ambientes","v":"5.741","t":"+15.3%","d":"up"},{"l":"Versão Config","v":"8.349","t":"+12.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 41819.20","3.524","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 2064.27","2.819","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 47065.38","5.495","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 25241.95","8.462","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 26059.17","3.835","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":596},{"label":"Mar","value":393},{"label":"Abr","value":215},{"label":"Mai","value":464},{"label":"Jun","value":557},{"label":"Jul","value":315},{"label":"Ago","value":481},{"label":"Set","value":523},{"label":"Out","value":338},{"label":"Nov","value":421},{"label":"Dez","value":232}];
const MX = 596;
