...
const PAGE = "Schedule Board";
const KPIS = [{"l":"Teams Ativos","v":"3.340","t":"+15.4%","d":"up"},{"l":"Reuniões/Semana","v":"4613","t":"+7.5%","d":"up"},{"l":"Mensagens/Dia","v":"1216","t":"+6.4%","d":"up"},{"l":"Ficheiros Partilhados","v":"2.335","t":"+6.3%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.373","4229","2.395","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","4.927","636","4.103","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","852","3040","3.776","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","2.097","3165","5.556","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","913","5074","4.062","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":390},{"label":"Fev","value":650},{"label":"Mar","value":551},{"label":"Abr","value":487},{"label":"Mai","value":643},{"label":"Jun","value":673},{"label":"Jul","value":551},{"label":"Ago","value":403},{"label":"Set","value":424},{"label":"Out","value":533},{"label":"Nov","value":345},{"label":"Dez","value":547}];
const MX = 673;
