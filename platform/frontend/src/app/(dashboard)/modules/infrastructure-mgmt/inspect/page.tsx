...
const ACCENT = "#0369a1";
const MODULE = "Infrastructure Mgmt Platform";
const PAGE = "Inspect";
const KPIS = [{"l":"Total Infrastructure Mgmt","v":"6.384","t":"+13.4%","d":"up"},{"l":"Inspect Ativos","v":"452","t":"+14.0%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"59","t":"-4.5%","d":"down"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Infrastructure Mgmt #001","Infrastructure Mgmt #002","5.016","7.612","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Infrastructure Mgmt #002","Infrastructure Mgmt #003","7.626","1.994","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Infrastructure Mgmt #003","Infrastructure Mgmt #004","7.544","3.527","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Infrastructure Mgmt #004","Infrastructure Mgmt #005","4.635","2.090","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Infrastructure Mgmt #005","Infrastructure Mgmt #001","8.338","2.395","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":261},{"label":"Mar","value":366},{"label":"Abr","value":490},{"label":"Mai","value":274},{"label":"Jun","value":590},{"label":"Jul","value":398},{"label":"Ago","value":353},{"label":"Set","value":304},{"label":"Out","value":463},{"label":"Nov","value":570},{"label":"Dez","value":490}];
const MX = 590;
