...
const PAGE = "Asset";
const KPIS = [{"l":"Ativos Registados","v":"362","t":"+13.9%","d":"up"},{"l":"Valor Total (€M)","v":"€45.7M","t":"-4.3%","d":"down"},{"l":"Depreciação Anual (€)","v":"€87467","t":"+1.7%","d":"up"},{"l":"Ativos em Garantia","v":"8.415","t":"-4.6%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 37701.62","1.784","€ 3913.81","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 14285.12","1.421","€ 40068.97","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 36407.09","6.134","€ 14115.92","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 48046.60","7.897","€ 6419.76","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 49841.39","5.103","€ 29043.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":567},{"label":"Mar","value":747},{"label":"Abr","value":619},{"label":"Mai","value":734},{"label":"Jun","value":752},{"label":"Jul","value":645},{"label":"Ago","value":763},{"label":"Set","value":411},{"label":"Out","value":497},{"label":"Nov","value":578},{"label":"Dez","value":576}];
const MX = 763;
