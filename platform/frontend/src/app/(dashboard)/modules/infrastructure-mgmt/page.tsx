...
/* ═══ Infrastructure Mgmt Platform — Dashboard ═══ */

const ACCENT = "#0369a1";

const KPIS = [
    { label: "Total Registos", value: "3718", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "749", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "83%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "52632018", cells: ["INF-1018", "Infrastructure Mgmt Platform Item 1", "27/7/2026", "€32 118"], status: "active" as const },
    { id: "52635589", cells: ["INF-4589", "Infrastructure Mgmt Platform Item 2", "14/2/2026", "€35 689"], status: "pending" as const },
    { id: "52639160", cells: ["INF-8160", "Infrastructure Mgmt Platform Item 3", "1/9/2026", "€39 260"], status: "completed" as const },
    { id: "52642731", cells: ["INF-2731", "Infrastructure Mgmt Platform Item 4", "16/4/2026", "€42 831"], status: "warning" as const },
    { id: "52646302", cells: ["INF-6302", "Infrastructure Mgmt Platform Item 5", "3/11/2026", "€46 402"], status: "active" as const },
];

const CHART = [{ label: "Jan", value: 38 }, { label: "Fev", value: 47 }, { label: "Mar", value: 56 }, { label: "Abr", value: 65 }, { label: "Mai", value: 74 }, { label: "Jun", value: 83 }];
...
export default function InfrastructureMgmtPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Infrastructure Mgmt Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Infrastructure Mgmt Platform</p>
                    </div>
                </div>
