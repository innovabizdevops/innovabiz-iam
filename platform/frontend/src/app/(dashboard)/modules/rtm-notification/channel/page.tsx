...
const PAGE = "Channel";
const KPIS = [{"l":"Notificações Enviadas","v":"1.428","t":"+10.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"76.9%","t":"+3.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"85.7%","t":"+9.9%","d":"up"},{"l":"Escalações","v":"8.643","t":"+5.0%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.377","78.5%","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.053","72.3%","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","3.390","73.4%","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.887","91.2%","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.512","85.6%","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":947},{"label":"Fev","value":799},{"label":"Mar","value":989},{"label":"Abr","value":890},{"label":"Mai","value":689},{"label":"Jun","value":785},{"label":"Jul","value":680},{"label":"Ago","value":701},{"label":"Set","value":884},{"label":"Out","value":1013},{"label":"Nov","value":804},{"label":"Dez","value":659}];
const MX = 1013;
