...
const PAGE = "Deliver";
const KPIS = [{"l":"Notificações Enviadas","v":"3.823","t":"+7.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"78.2%","t":"+10.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"83.3%","t":"+0.3%","d":"up"},{"l":"Escalações","v":"3.802","t":"+12.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","512","99.2%","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","2.230","85.7%","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.641","89.0%","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.829","72.3%","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","644","91.0%","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":821},{"label":"Mar","value":907},{"label":"Abr","value":922},{"label":"Mai","value":595},{"label":"Jun","value":668},{"label":"Jul","value":889},{"label":"Ago","value":674},{"label":"Set","value":704},{"label":"Out","value":925},{"label":"Nov","value":912},{"label":"Dez","value":766}];
const MX = 925;
