...
/* ═══ RTM Push Notification — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "380", trend: "+6%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1566", trend: "-25%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€450K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+13%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "103663180", cells: ["RTM-2180", "RTM Push Notification Item 1", "13/5/2026", "€13 280"], status: "active" as const },
    { id: "103666751", cells: ["RTM-5751", "RTM Push Notification Item 2", "28/12/2026", "€16 851"], status: "pending" as const },
    { id: "103670322", cells: ["RTM-9322", "RTM Push Notification Item 3", "15/7/2026", "€20 422"], status: "completed" as const },
    { id: "103673893", cells: ["RTM-3893", "RTM Push Notification Item 4", "2/2/2026", "€23 993"], status: "warning" as const },
    { id: "103677464", cells: ["RTM-7464", "RTM Push Notification Item 5", "17/9/2026", "€27 564"], status: "active" as const },
];
...
export default function RtmPushNotificationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Push Notification</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Push Notification</p>
                    </div>
                </div>
