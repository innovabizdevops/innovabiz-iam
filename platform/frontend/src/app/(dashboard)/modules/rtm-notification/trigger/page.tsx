...
const PAGE = "Trigger";
const KPIS = [{"l":"Notificações Enviadas","v":"1.143","t":"+9.5%","d":"up"},{"l":"Taxa Entrega (%)","v":"87.2%","t":"+16.6%","d":"up"},{"l":"Taxa Abertura (%)","v":"79.5%","t":"-2.9%","d":"down"},{"l":"Escalações","v":"8.004","t":"+5.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","2.038","76.0%","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.689","91.7%","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.353","95.4%","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","2.842","99.0%","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","4.722","93.0%","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":745},{"label":"Mar","value":716},{"label":"Abr","value":519},{"label":"Mai","value":899},{"label":"Jun","value":797},{"label":"Jul","value":712},{"label":"Ago","value":868},{"label":"Set","value":869},{"label":"Out","value":753},{"label":"Nov","value":631},{"label":"Dez","value":633}];
const MX = 899;
