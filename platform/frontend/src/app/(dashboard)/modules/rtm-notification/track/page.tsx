...
const ACCENT = "#dc2626";
const MODULE = "RTM Push Notification";
const PAGE = "Track";
const KPIS = [{"l":"Notificações Enviadas","v":"3.439","t":"+14.6%","d":"up"},{"l":"Taxa Entrega (%)","v":"90.7%","t":"+6.4%","d":"up"},{"l":"Taxa Abertura (%)","v":"65.3%","t":"+14.8%","d":"up"},{"l":"Escalações","v":"4.234","t":"-4.4%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","4.671","77.8%","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.058","76.6%","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.400","77.9%","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","766","77.6%","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","1.004","92.3%","2026-01-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":771},{"label":"Mar","value":688},{"label":"Abr","value":846},{"label":"Mai","value":884},{"label":"Jun","value":753},{"label":"Jul","value":670},{"label":"Ago","value":1021},{"label":"Set","value":751},{"label":"Out","value":997},{"label":"Nov","value":999},{"label":"Dez","value":993}];
const MX = 1021;
