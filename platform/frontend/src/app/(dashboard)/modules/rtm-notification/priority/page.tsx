...
const PAGE = "Priority";
const KPIS = [{"l":"Notificações Enviadas","v":"903","t":"+14.3%","d":"up"},{"l":"Taxa Entrega (%)","v":"67.5%","t":"+2.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"73.6%","t":"+8.0%","d":"up"},{"l":"Escalações","v":"5.364","t":"-5.8%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.456","74.9%","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","6.804","78.3%","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","7.280","84.5%","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.502","86.1%","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.999","98.4%","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":370},{"label":"Fev","value":599},{"label":"Mar","value":401},{"label":"Abr","value":404},{"label":"Mai","value":495},{"label":"Jun","value":399},{"label":"Jul","value":555},{"label":"Ago","value":468},{"label":"Set","value":575},{"label":"Out","value":442},{"label":"Nov","value":630},{"label":"Dez","value":449}];
const MX = 630;
