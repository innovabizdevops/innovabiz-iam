...
const PAGE = "SLA Track";
const KPIS = [{"l":"Tickets Abertos","v":"3.453","t":"+0.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.7%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"193h","t":"+13.5%","d":"up"},{"l":"Satisfação (%)","v":"87.0%","t":"+15.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.629","5.849","8.059","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.875","8.919","5.813","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.650","8.239","5.045","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.450","4.502","7.977","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.807","1.918","8.168","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":951},{"label":"Mar","value":878},{"label":"Abr","value":761},{"label":"Mai","value":731},{"label":"Jun","value":734},{"label":"Jul","value":949},{"label":"Ago","value":734},{"label":"Set","value":799},{"label":"Out","value":1068},{"label":"Nov","value":916},{"label":"Dez","value":916}];
const MX = 1068;
