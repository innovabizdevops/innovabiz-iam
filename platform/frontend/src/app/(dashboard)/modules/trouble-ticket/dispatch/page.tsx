...
const PAGE = "Dispatch";
const KPIS = [{"l":"Tickets Abertos","v":"373","t":"+14.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.9%","t":"+2.1%","d":"up"},{"l":"MTTR (h)","v":"136h","t":"+17.7%","d":"up"},{"l":"Satisfação (%)","v":"80.3%","t":"+6.8%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.517","4.139","702","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.113","8.854","6.792","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","3.342","8.914","3.224","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.814","1.537","4.741","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.555","3.302","4.923","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":524},{"label":"Mar","value":425},{"label":"Abr","value":607},{"label":"Mai","value":385},{"label":"Jun","value":235},{"label":"Jul","value":420},{"label":"Ago","value":608},{"label":"Set","value":426},{"label":"Out","value":473},{"label":"Nov","value":292},{"label":"Dez","value":554}];
const MX = 608;
