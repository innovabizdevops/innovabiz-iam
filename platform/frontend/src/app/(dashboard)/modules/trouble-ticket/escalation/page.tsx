...
const KPIS = [{"l":"Tickets Abertos","v":"8.202","t":"+0.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"77.0%","t":"+7.2%","d":"up"},{"l":"MTTR (h)","v":"124h","t":"+14.9%","d":"up"},{"l":"Satisfação (%)","v":"70.8%","t":"-1.6%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.253","578","4.983","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","388","6.672","1.500","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.281","3.191","5.656","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.949","7.213","5.482","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.453","7.885","5.824","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":365},{"label":"Mar","value":597},{"label":"Abr","value":474},{"label":"Mai","value":554},{"label":"Jun","value":316},{"label":"Jul","value":685},{"label":"Ago","value":513},{"label":"Set","value":497},{"label":"Out","value":701},{"label":"Nov","value":469},{"label":"Dez","value":416}];
const MX = 701;
