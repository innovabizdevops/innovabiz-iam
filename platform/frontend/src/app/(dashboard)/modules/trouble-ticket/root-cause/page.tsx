...
const KPIS = [{"l":"Tickets Abertos","v":"1.944","t":"+4.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.5%","t":"+7.4%","d":"up"},{"l":"MTTR (h)","v":"40h","t":"+13.0%","d":"up"},{"l":"Satisfação (%)","v":"75.8%","t":"+15.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","609","2.934","3.783","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.965","3.197","6.044","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","634","4.401","3.414","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","368","4.168","6.128","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.617","4.827","3.393","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":317},{"label":"Mar","value":650},{"label":"Abr","value":310},{"label":"Mai","value":348},{"label":"Jun","value":601},{"label":"Jul","value":441},{"label":"Ago","value":367},{"label":"Set","value":317},{"label":"Out","value":669},{"label":"Nov","value":605},{"label":"Dez","value":535}];
const MX = 669;
