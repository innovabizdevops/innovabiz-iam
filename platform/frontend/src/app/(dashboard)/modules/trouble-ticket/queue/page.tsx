...
const ACCENT = "#dc2626";
const MODULE = "Trouble Ticket";
const PAGE = "Ticket Queue";
const KPIS = [{"l":"Tickets Abertos","v":"6.602","t":"-3.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"67.8%","t":"+12.0%","d":"up"},{"l":"MTTR (h)","v":"125h","t":"-3.7%","d":"down"},{"l":"Satisfação (%)","v":"83.5%","t":"+2.0%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","8.804","5.771","2.245","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.519","3.397","3.787","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","878","8.282","5.694","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","3.258","5.886","1.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.226","3.553","4.002","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":321},{"label":"Fev","value":318},{"label":"Mar","value":476},{"label":"Abr","value":500},{"label":"Mai","value":357},{"label":"Jun","value":518},{"label":"Jul","value":316},{"label":"Ago","value":392},{"label":"Set","value":316},{"label":"Out","value":587},{"label":"Nov","value":308},{"label":"Dez","value":390}];
const MX = 587;
