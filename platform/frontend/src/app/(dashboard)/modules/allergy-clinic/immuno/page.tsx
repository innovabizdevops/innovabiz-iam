...
const ACCENT = "#f59e0b";
const MODULE = "Allergy Clinic";
const PAGE = "Immunotherapy";
const KPIS = [{"l":"Total Allergy Clinic","v":"3.236","t":"+10.2%","d":"up"},{"l":"Immunotherapy Ativos","v":"1.304","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"68.9%","t":"+6.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+14.4%","d":"up"}];
const COLS = ["ID","Immunotherapy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Allergy Clinic #001","Allergy Clinic #002","3.699","4.174","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Allergy Clinic #002","Allergy Clinic #003","7.674","5.489","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Allergy Clinic #003","Allergy Clinic #004","4.594","2.254","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Allergy Clinic #004","Allergy Clinic #005","1.253","157","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Allergy Clinic #005","Allergy Clinic #001","3.382","3.054","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":545},{"label":"Mar","value":619},{"label":"Abr","value":695},{"label":"Mai","value":693},{"label":"Jun","value":654},{"label":"Jul","value":706},{"label":"Ago","value":773},{"label":"Set","value":562},{"label":"Out","value":683},{"label":"Nov","value":684},{"label":"Dez","value":614}];
const MX = 773;
...
export default function ImmunoPage() {
    return (
