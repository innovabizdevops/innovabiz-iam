...
/* ═══ Allergy Clinic — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "8720", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2268", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€320K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1456991620", cells: ["ALL-9620", "Allergy Clinic Item 1", "1/5/2026", "€41 720"], status: "active" as const },
    { id: "1456995191", cells: ["ALL-4191", "Allergy Clinic Item 2", "16/12/2026", "€45 291"], status: "pending" as const },
    { id: "1456998762", cells: ["ALL-7762", "Allergy Clinic Item 3", "3/7/2026", "€48 862"], status: "completed" as const },
    { id: "1457002333", cells: ["ALL-2333", "Allergy Clinic Item 4", "18/2/2026", "€2433"], status: "warning" as const },
    { id: "1457005904", cells: ["ALL-5904", "Allergy Clinic Item 5", "5/9/2026", "€6004"], status: "active" as const },
];
...
export default function AllergyClinicPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Allergy Clinic</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Allergy Clinic</p>
                    </div>
                </div>
