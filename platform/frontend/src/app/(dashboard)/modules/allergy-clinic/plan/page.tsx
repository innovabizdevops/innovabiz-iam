...
const KPIS = [{"l":"Total Allergy Clinic","v":"1.127","t":"-4.2%","d":"down"},{"l":"Action Plan Ativos","v":"2.993","t":"+15.8%","d":"up"},{"l":"Eficiência (%)","v":"68.0%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"76","t":"+4.3%","d":"up"}];
const COLS = ["ID","Action Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Allergy Clinic #001","Allergy Clinic #002","433","7.665","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Allergy Clinic #002","Allergy Clinic #003","4.866","2.225","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Allergy Clinic #003","Allergy Clinic #004","352","3.006","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Allergy Clinic #004","Allergy Clinic #005","3.827","1.049","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Allergy Clinic #005","Allergy Clinic #001","9.055","8.174","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":687},{"label":"Mar","value":651},{"label":"Abr","value":377},{"label":"Mai","value":414},{"label":"Jun","value":443},{"label":"Jul","value":423},{"label":"Ago","value":432},{"label":"Set","value":521},{"label":"Out","value":458},{"label":"Nov","value":303},{"label":"Dez","value":637}];
const MX = 687;
