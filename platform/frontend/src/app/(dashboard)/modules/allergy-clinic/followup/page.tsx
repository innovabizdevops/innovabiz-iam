...
const KPIS = [{"l":"Total Allergy Clinic","v":"2.803","t":"-3.6%","d":"down"},{"l":"Follow Up Ativos","v":"7.008","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"86","t":"-2.9%","d":"down"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Allergy Clinic #001","Allergy Clinic #002","2.935","8.320","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Allergy Clinic #002","Allergy Clinic #003","6.181","542","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Allergy Clinic #003","Allergy Clinic #004","4.298","8.802","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Allergy Clinic #004","Allergy Clinic #005","6.138","5.853","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Allergy Clinic #005","Allergy Clinic #001","6.887","3.295","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":827},{"label":"Mar","value":889},{"label":"Abr","value":988},{"label":"Mai","value":648},{"label":"Jun","value":717},{"label":"Jul","value":926},{"label":"Ago","value":911},{"label":"Set","value":910},{"label":"Out","value":836},{"label":"Nov","value":729},{"label":"Dez","value":779}];
const MX = 988;
