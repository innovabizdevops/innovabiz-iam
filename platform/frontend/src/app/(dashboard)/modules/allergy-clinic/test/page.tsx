...
const PAGE = "Test";
const KPIS = [{"l":"Total Allergy Clinic","v":"735","t":"+10.9%","d":"up"},{"l":"Test Ativos","v":"2.405","t":"-0.2%","d":"down"},{"l":"Eficiência (%)","v":"86.1%","t":"-1.3%","d":"down"},{"l":"Score Performance","v":"76","t":"+5.8%","d":"up"}];
const COLS = ["ID","Test","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Allergy Clinic #001","Allergy Clinic #002","1.241","3.800","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Allergy Clinic #002","Allergy Clinic #003","2.104","1.865","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Allergy Clinic #003","Allergy Clinic #004","5.212","6.292","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Allergy Clinic #004","Allergy Clinic #005","2.393","7.487","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Allergy Clinic #005","Allergy Clinic #001","3.065","6.978","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":429},{"label":"Mar","value":646},{"label":"Abr","value":556},{"label":"Mai","value":443},{"label":"Jun","value":685},{"label":"Jul","value":554},{"label":"Ago","value":498},{"label":"Set","value":727},{"label":"Out","value":774},{"label":"Nov","value":580},{"label":"Dez","value":440}];
const MX = 774;
