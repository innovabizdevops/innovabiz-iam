...
const PAGE = "Patient";
const KPIS = [{"l":"Total Allergy Clinic","v":"121","t":"+10.4%","d":"up"},{"l":"Patient Ativos","v":"2.411","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+1.6%","d":"up"},{"l":"Score Performance","v":"77","t":"-1.0%","d":"down"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Allergy Clinic #001","Allergy Clinic #002","5.072","4.741","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Allergy Clinic #002","Allergy Clinic #003","281","5.971","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Allergy Clinic #003","Allergy Clinic #004","8.322","3.547","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Allergy Clinic #004","Allergy Clinic #005","4.961","5.779","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Allergy Clinic #005","Allergy Clinic #001","3.071","6.087","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":446},{"label":"Mar","value":591},{"label":"Abr","value":439},{"label":"Mai","value":477},{"label":"Jun","value":753},{"label":"Jul","value":636},{"label":"Ago","value":760},{"label":"Set","value":444},{"label":"Out","value":603},{"label":"Nov","value":505},{"label":"Dez","value":436}];
const MX = 782;
