...
/* ═══ Compliance Hub — Whistleblower ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1081", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "109", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2887", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2099532409", cells: ["COM-4409", "Whistleblower Item 1", "10/2/2026", "€32 509"], status: "active" as const },
    { id: "2099535980", cells: ["COM-7980", "Whistleblower Item 2", "25/9/2026", "€36 080"], status: "pending" as const },
    { id: "2099539551", cells: ["COM-2551", "Whistleblower Item 3", "12/4/2026", "€39 651"], status: "completed" as const },
    { id: "2099543122", cells: ["COM-6122", "Whistleblower Item 4", "27/11/2026", "€43 222"], status: "warning" as const },
    { id: "2099546693", cells: ["COM-9693", "Whistleblower Item 5", "14/6/2026", "€46 793"], status: "active" as const },
];
...
export default function ComplianceHubWhistleblowerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Whistleblower</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Whistleblower</p>
                    </div>
                </div>
