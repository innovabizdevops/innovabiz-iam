...
/* ═══ Compliance Hub — Compliance Dash ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "401", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "369", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1287", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "486703853", cells: ["COM-2853", "Compliance Dash Item 1", "14/6/2026", "€3953"], status: "active" as const },
    { id: "486707424", cells: ["COM-6424", "Compliance Dash Item 2", "1/1/2026", "€7524"], status: "pending" as const },
    { id: "486710995", cells: ["COM-9995", "Compliance Dash Item 3", "16/8/2026", "€11 095"], status: "completed" as const },
    { id: "486714566", cells: ["COM-4566", "Compliance Dash Item 4", "3/3/2026", "€14 666"], status: "warning" as const },
    { id: "486718137", cells: ["COM-8137", "Compliance Dash Item 5", "18/10/2026", "€18 237"], status: "active" as const },
];
...
export default function ComplianceHubComplianceDashPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Dash</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Compliance Dash</p>
                    </div>
                </div>
