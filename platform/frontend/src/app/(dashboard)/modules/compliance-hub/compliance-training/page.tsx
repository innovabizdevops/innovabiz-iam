...
/* ═══ Compliance Hub — Compliance Training ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "474", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "111", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1964", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "471566667", cells: ["COM-3667", "Compliance Training Item 1", "20/4/2026", "€16 767"], status: "active" as const },
    { id: "471570238", cells: ["COM-7238", "Compliance Training Item 2", "7/11/2026", "€20 338"], status: "pending" as const },
    { id: "471573809", cells: ["COM-1809", "Compliance Training Item 3", "22/6/2026", "€23 909"], status: "completed" as const },
    { id: "471577380", cells: ["COM-5380", "Compliance Training Item 4", "9/1/2026", "€27 480"], status: "warning" as const },
    { id: "471580951", cells: ["COM-8951", "Compliance Training Item 5", "24/8/2026", "€31 051"], status: "active" as const },
];
...
export default function ComplianceHubComplianceTrainingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Training</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Compliance Training</p>
                    </div>
                </div>
