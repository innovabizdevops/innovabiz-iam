...
/* ═══ Compliance Hub — Compliance Assess ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1570", trend: "-10%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "309", trend: "+4%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3379", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "498295809", cells: ["COM-2809", "Compliance Assess Item 1", "26/10/2026", "€45 909"], status: "active" as const },
    { id: "498299380", cells: ["COM-6380", "Compliance Assess Item 2", "13/5/2026", "€49 480"], status: "pending" as const },
    { id: "498302951", cells: ["COM-9951", "Compliance Assess Item 3", "28/12/2026", "€3051"], status: "completed" as const },
    { id: "498306522", cells: ["COM-4522", "Compliance Assess Item 4", "15/7/2026", "€6622"], status: "warning" as const },
    { id: "498310093", cells: ["COM-8093", "Compliance Assess Item 5", "2/2/2026", "€10 193"], status: "active" as const },
];
...
export default function ComplianceHubComplianceAssessPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Compliance Assess</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Compliance Assess</p>
                    </div>
                </div>
