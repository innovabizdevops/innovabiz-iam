...
/* ═══ Compliance Hub — Gift Entertain ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1300", trend: "-2%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "480", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2401", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1143220476", cells: ["COM-5476", "Gift Entertain Item 1", "21/1/2026", "€20 576"], status: "active" as const },
    { id: "1143224047", cells: ["COM-9047", "Gift Entertain Item 2", "8/8/2026", "€24 147"], status: "pending" as const },
    { id: "1143227618", cells: ["COM-3618", "Gift Entertain Item 3", "23/3/2026", "€27 718"], status: "completed" as const },
    { id: "1143231189", cells: ["COM-7189", "Gift Entertain Item 4", "10/10/2026", "€31 289"], status: "warning" as const },
    { id: "1143234760", cells: ["COM-1760", "Gift Entertain Item 5", "25/5/2026", "€34 860"], status: "active" as const },
];
...
export default function ComplianceHubGiftEntertainPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gift Entertain</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Gift Entertain</p>
                    </div>
                </div>
