...
/* ═══ Compliance Hub — Sanctions Screen ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "2061", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "442", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3876", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1510206374", cells: ["COM-7374", "Sanctions Screen Item 1", "27/3/2026", "€6474"], status: "active" as const },
    { id: "1510209945", cells: ["COM-1945", "Sanctions Screen Item 2", "14/10/2026", "€10 045"], status: "pending" as const },
    { id: "1510213516", cells: ["COM-5516", "Sanctions Screen Item 3", "1/5/2026", "€13 616"], status: "completed" as const },
    { id: "1510217087", cells: ["COM-9087", "Sanctions Screen Item 4", "16/12/2026", "€17 187"], status: "warning" as const },
    { id: "1510220658", cells: ["COM-3658", "Sanctions Screen Item 5", "3/7/2026", "€20 758"], status: "active" as const },
];
...
export default function ComplianceHubSanctionsScreenPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sanctions Screen</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Sanctions Screen</p>
                    </div>
                </div>
