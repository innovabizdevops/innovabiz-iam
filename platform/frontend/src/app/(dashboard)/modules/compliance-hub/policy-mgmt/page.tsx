...
/* ═══ Compliance Hub — Policy Mgmt ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "748", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "431", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "2101", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1678513051", cells: ["COM-5051", "Policy Mgmt Item 1", "20/8/2026", "€13 151"], status: "active" as const },
    { id: "1678516622", cells: ["COM-8622", "Policy Mgmt Item 2", "7/3/2026", "€16 722"], status: "pending" as const },
    { id: "1678520193", cells: ["COM-3193", "Policy Mgmt Item 3", "22/10/2026", "€20 293"], status: "completed" as const },
    { id: "1678523764", cells: ["COM-6764", "Policy Mgmt Item 4", "9/5/2026", "€23 864"], status: "warning" as const },
    { id: "1678527335", cells: ["COM-1335", "Policy Mgmt Item 5", "24/12/2026", "€27 435"], status: "active" as const },
];
...
export default function ComplianceHubPolicyMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Policy Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Policy Mgmt</p>
                    </div>
                </div>
