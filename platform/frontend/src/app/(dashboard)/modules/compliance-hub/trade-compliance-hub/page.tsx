...
/* ═══ Compliance Hub — Trade Compliance Hub ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "1256", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "442", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "694", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "75%", trend: "+16%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "832635158", cells: ["COM-1158", "Trade Compliance Hub Item 1", "27/3/2026", "€35 258"], status: "active" as const },
    { id: "832638729", cells: ["COM-4729", "Trade Compliance Hub Item 2", "14/10/2026", "€38 829"], status: "pending" as const },
    { id: "832642300", cells: ["COM-8300", "Trade Compliance Hub Item 3", "1/5/2026", "€42 400"], status: "completed" as const },
    { id: "832645871", cells: ["COM-2871", "Trade Compliance Hub Item 4", "16/12/2026", "€45 971"], status: "warning" as const },
    { id: "832649442", cells: ["COM-6442", "Trade Compliance Hub Item 5", "3/7/2026", "€49 542"], status: "active" as const },
];
...
export default function ComplianceHubTradeComplianceHubPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Trade Compliance Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Trade Compliance Hub</p>
                    </div>
                </div>
