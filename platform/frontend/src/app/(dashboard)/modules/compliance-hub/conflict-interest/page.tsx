...
/* ═══ Compliance Hub — Conflict Interest ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "3410", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "310", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "692", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "93%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1763855186", cells: ["COM-9186", "Conflict Interest Item 1", "3/3/2026", "€5286"], status: "active" as const },
    { id: "1763858757", cells: ["COM-3757", "Conflict Interest Item 2", "18/10/2026", "€8857"], status: "pending" as const },
    { id: "1763862328", cells: ["COM-7328", "Conflict Interest Item 3", "5/5/2026", "€12 428"], status: "completed" as const },
    { id: "1763865899", cells: ["COM-1899", "Conflict Interest Item 4", "20/12/2026", "€15 999"], status: "warning" as const },
    { id: "1763869470", cells: ["COM-5470", "Conflict Interest Item 5", "7/7/2026", "€19 570"], status: "active" as const },
];
...
export default function ComplianceHubConflictInterestPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Conflict Interest</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Conflict Interest</p>
                    </div>
                </div>
