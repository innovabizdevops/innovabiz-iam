...
/* ═══ Compliance Hub — Regulatory Change ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total", value: "4984", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "150", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3239", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1361800402", cells: ["COM-2402", "Regulatory Change Item 1", "19/11/2026", "€502"], status: "active" as const },
    { id: "1361803973", cells: ["COM-5973", "Regulatory Change Item 2", "6/6/2026", "€4073"], status: "pending" as const },
    { id: "1361807544", cells: ["COM-9544", "Regulatory Change Item 3", "21/1/2026", "€7644"], status: "completed" as const },
    { id: "1361811115", cells: ["COM-4115", "Regulatory Change Item 4", "8/8/2026", "€11 215"], status: "warning" as const },
    { id: "1361814686", cells: ["COM-7686", "Regulatory Change Item 5", "23/3/2026", "€14 786"], status: "active" as const },
];
...
export default function ComplianceHubRegulatoryChangePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Regulatory Change</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Compliance Hub • Regulatory Change</p>
                    </div>
                </div>
