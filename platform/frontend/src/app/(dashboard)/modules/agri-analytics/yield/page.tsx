...
const ACCENT = "#6366f1";
const MODULE = "Agriculture Analytics";
const PAGE = "Yield AI";
const KPIS = [{"l":"Dashboards Ativos","v":"370","t":"-0.9%","d":"down"},{"l":"Queries/Dia","v":"4190","t":"+8.7%","d":"up"},{"l":"Dados Processados (GB)","v":"3.463","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.396","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4674","2026-01-03","6.472","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1141","2026-03-02","3.907","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3119","2026-02-05","5.943","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3969","2026-03-09","6.576","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4674","2026-01-23","6.639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":375},{"label":"Fev","value":327},{"label":"Mar","value":534},{"label":"Abr","value":597},{"label":"Mai","value":213},{"label":"Jun","value":544},{"label":"Jul","value":584},{"label":"Ago","value":216},{"label":"Set","value":587},{"label":"Out","value":300},{"label":"Nov","value":418},{"label":"Dez","value":229}];
const MX = 597;
