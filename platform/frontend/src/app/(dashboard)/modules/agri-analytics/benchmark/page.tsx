...
const KPIS = [{"l":"Dashboards Ativos","v":"5.123","t":"+0.2%","d":"up"},{"l":"Queries/Dia","v":"343","t":"+8.1%","d":"up"},{"l":"Dados Processados (GB)","v":"1.770","t":"-2.5%","d":"down"},{"l":"Utilizadores Analytics","v":"3.858","t":"+6.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1957","2026-02-28","5.156","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3295","2026-01-25","4.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4245","2026-02-19","7.708","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","926","2026-02-12","6.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4763","2026-03-12","1.703","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":850},{"label":"Mar","value":617},{"label":"Abr","value":871},{"label":"Mai","value":796},{"label":"Jun","value":524},{"label":"Jul","value":614},{"label":"Ago","value":742},{"label":"Set","value":637},{"label":"Out","value":858},{"label":"Nov","value":690},{"label":"Dez","value":520}];
const MX = 871;
