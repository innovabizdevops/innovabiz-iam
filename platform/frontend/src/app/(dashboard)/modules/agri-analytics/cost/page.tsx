...
const PAGE = "Cost";
const KPIS = [{"l":"Dashboards Ativos","v":"1.869","t":"-4.1%","d":"down"},{"l":"Queries/Dia","v":"892","t":"+14.0%","d":"up"},{"l":"Dados Processados (GB)","v":"8.582","t":"+12.2%","d":"up"},{"l":"Utilizadores Analytics","v":"719","t":"+2.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1522","2026-03-12","6.345","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2323","2026-01-16","4.158","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","435","2026-03-07","1.959","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2134","2026-01-28","4.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4654","2026-03-01","2.647","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":778},{"label":"Mar","value":708},{"label":"Abr","value":565},{"label":"Mai","value":828},{"label":"Jun","value":564},{"label":"Jul","value":814},{"label":"Ago","value":675},{"label":"Set","value":480},{"label":"Out","value":508},{"label":"Nov","value":812},{"label":"Dez","value":857}];
const MX = 857;
