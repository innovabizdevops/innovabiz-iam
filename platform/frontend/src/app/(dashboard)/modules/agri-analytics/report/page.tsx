...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"2.417","t":"-5.7%","d":"down"},{"l":"Queries/Dia","v":"988","t":"+10.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.461","t":"-2.7%","d":"down"},{"l":"Utilizadores Analytics","v":"8.557","t":"-3.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2670","2026-02-20","2.784","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2179","2026-03-04","1.123","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1988","2026-02-27","5.782","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4669","2026-02-08","2.126","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3655","2026-03-08","5.430","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":358},{"label":"Fev","value":535},{"label":"Mar","value":426},{"label":"Abr","value":290},{"label":"Mai","value":351},{"label":"Jun","value":497},{"label":"Jul","value":296},{"label":"Ago","value":386},{"label":"Set","value":330},{"label":"Out","value":484},{"label":"Nov","value":402},{"label":"Dez","value":309}];
const MX = 535;
