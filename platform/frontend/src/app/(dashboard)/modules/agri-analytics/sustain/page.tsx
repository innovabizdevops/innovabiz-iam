...
const KPIS = [{"l":"Dashboards Ativos","v":"1.661","t":"+0.7%","d":"up"},{"l":"Queries/Dia","v":"1252","t":"+5.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.000","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.204","t":"+17.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3320","2026-01-13","1.727","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4070","2026-02-17","3.812","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4058","2026-02-14","3.538","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1878","2026-03-08","6.653","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3819","2026-03-12","8.442","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":570},{"label":"Mar","value":592},{"label":"Abr","value":333},{"label":"Mai","value":421},{"label":"Jun","value":291},{"label":"Jul","value":522},{"label":"Ago","value":303},{"label":"Set","value":408},{"label":"Out","value":495},{"label":"Nov","value":499},{"label":"Dez","value":384}];
const MX = 592;
