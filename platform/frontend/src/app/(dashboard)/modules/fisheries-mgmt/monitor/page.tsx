...
const ACCENT = "#059669";
const MODULE = "Fisheries Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Embarcações Ativas","v":"3.329","t":"+11.8%","d":"up"},{"l":"Capturas (ton)","v":"4570","t":"+14.7%","d":"up"},{"l":"Quota Utilizada (%)","v":"67.9%","t":"-1.2%","d":"down"},{"l":"Certificações","v":"6.467","t":"+11.0%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4599","6.790","82.5%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","715","5.314","91.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","521","4.230","94.6%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","4475","3.924","78.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1563","1.473","96.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":661},{"label":"Mar","value":685},{"label":"Abr","value":885},{"label":"Mai","value":749},{"label":"Jun","value":660},{"label":"Jul","value":854},{"label":"Ago","value":887},{"label":"Set","value":837},{"label":"Out","value":745},{"label":"Nov","value":782},{"label":"Dez","value":582}];
const MX = 887;
