...
const KPIS = [
    { label: "Total Registos", value: "725", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2577", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€62K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "94%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "114692125", cells: ["FIS-6125", "Fisheries Management Item 1", "10/2/2026", "€42 225"], status: "active" as const },
    { id: "114695696", cells: ["FIS-9696", "Fisheries Management Item 2", "25/9/2026", "€45 796"], status: "pending" as const },
    { id: "114699267", cells: ["FIS-4267", "Fisheries Management Item 3", "12/4/2026", "€49 367"], status: "completed" as const },
    { id: "114702838", cells: ["FIS-7838", "Fisheries Management Item 4", "27/11/2026", "€2938"], status: "warning" as const },
    { id: "114706409", cells: ["FIS-2409", "Fisheries Management Item 5", "14/6/2026", "€6509"], status: "active" as const },
];
...
export default function FisheriesManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fisheries Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fisheries Management</p>
                    </div>
                </div>
