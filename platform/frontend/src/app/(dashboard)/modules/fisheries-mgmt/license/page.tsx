...
const PAGE = "License";
const KPIS = [{"l":"Embarcações Ativas","v":"8.689","t":"+18.0%","d":"up"},{"l":"Capturas (ton)","v":"4707","t":"+13.8%","d":"up"},{"l":"Quota Utilizada (%)","v":"86.0%","t":"+8.9%","d":"up"},{"l":"Certificações","v":"2.602","t":"+15.2%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","5053","742","98.1%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","822","2.724","95.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3859","3.931","97.1%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","1391","2.063","70.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","620","4.497","91.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":640},{"label":"Mar","value":733},{"label":"Abr","value":646},{"label":"Mai","value":692},{"label":"Jun","value":535},{"label":"Jul","value":839},{"label":"Ago","value":481},{"label":"Set","value":782},{"label":"Out","value":675},{"label":"Nov","value":673},{"label":"Dez","value":619}];
const MX = 839;
