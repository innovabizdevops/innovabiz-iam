...
const PAGE = "Quota";
const KPIS = [{"l":"Vendas YTD (€)","v":"€29945","t":"+16.7%","d":"up"},{"l":"Pipeline (€)","v":"€92630","t":"-5.2%","d":"down"},{"l":"Atingimento Quota (%)","v":"85.6%","t":"+6.4%","d":"up"},{"l":"Win Rate (%)","v":"90.2%","t":"+14.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 35981.42","€ 10288.51","€ 9500.46","74.4%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 25846.74","€ 3076.39","€ 14885.11","79.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 35287.87","€ 22528.24","€ 42514.61","97.8%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 45042.08","€ 18570.42","€ 49166.50","95.1%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 20582.17","€ 6823.31","€ 30891.88","85.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":513},{"label":"Fev","value":718},{"label":"Mar","value":429},{"label":"Abr","value":753},{"label":"Mai","value":467},{"label":"Jun","value":522},{"label":"Jul","value":786},{"label":"Ago","value":687},{"label":"Set","value":821},{"label":"Out","value":798},{"label":"Nov","value":431},{"label":"Dez","value":632}];
const MX = 821;
