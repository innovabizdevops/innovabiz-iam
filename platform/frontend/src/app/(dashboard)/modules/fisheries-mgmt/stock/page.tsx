...
const PAGE = "Stock";
const KPIS = [{"l":"Embarcações Ativas","v":"5.138","t":"+7.4%","d":"up"},{"l":"Capturas (ton)","v":"1064","t":"+13.9%","d":"up"},{"l":"Quota Utilizada (%)","v":"84.1%","t":"+15.2%","d":"up"},{"l":"Certificações","v":"7.512","t":"+8.5%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","2015","2.134","93.2%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3475","5.749","92.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2749","7.108","95.0%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2457","2.541","74.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","4490","2.707","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":389},{"label":"Fev","value":349},{"label":"Mar","value":617},{"label":"Abr","value":524},{"label":"Mai","value":395},{"label":"Jun","value":500},{"label":"Jul","value":528},{"label":"Ago","value":548},{"label":"Set","value":355},{"label":"Out","value":422},{"label":"Nov","value":470},{"label":"Dez","value":524}];
const MX = 617;
