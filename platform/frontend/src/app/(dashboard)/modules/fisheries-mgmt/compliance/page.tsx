...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.256","t":"+12.9%","d":"up"},{"l":"NC Abertas","v":"7.625","t":"+1.0%","d":"up"},{"l":"Conformidade (%)","v":"92.1%","t":"+9.6%","d":"up"},{"l":"CAPAs Pendentes","v":"664","t":"+6.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","428","98.8%","495","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","9.081","76.3%","6.240","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.422","80.8%","6.576","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.844","97.4%","2.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.868","98.0%","1.034","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":453},{"label":"Fev","value":654},{"label":"Mar","value":576},{"label":"Abr","value":631},{"label":"Mai","value":508},{"label":"Jun","value":716},{"label":"Jul","value":466},{"label":"Ago","value":655},{"label":"Set","value":704},{"label":"Out","value":643},{"label":"Nov","value":729},{"label":"Dez","value":570}];
const MX = 729;
