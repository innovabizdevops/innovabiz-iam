...
const PAGE = "Upstream";
const KPIS = [{"l":"Riscos Identificados","v":"7.652","t":"-5.5%","d":"down"},{"l":"Mitigações Ativas","v":"5.335","t":"-4.9%","d":"down"},{"l":"Score Risco Geral","v":"60","t":"+7.5%","d":"up"},{"l":"Incidentes YTD","v":"3.531","t":"+10.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.341","5.219","688","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.834","3.681","7.879","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.950","5.734","5.467","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.058","5.320","4.702","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.173","8.112","2.925","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":203},{"label":"Fev","value":355},{"label":"Mar","value":345},{"label":"Abr","value":404},{"label":"Mai","value":290},{"label":"Jun","value":265},{"label":"Jul","value":504},{"label":"Ago","value":489},{"label":"Set","value":257},{"label":"Out","value":552},{"label":"Nov","value":412},{"label":"Dez","value":259}];
const MX = 552;
