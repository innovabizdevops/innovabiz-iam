...
const PAGE = "Downstream";
const KPIS = [{"l":"Riscos Identificados","v":"4.866","t":"+1.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.705","t":"+12.5%","d":"up"},{"l":"Score Risco Geral","v":"55","t":"+1.8%","d":"up"},{"l":"Incidentes YTD","v":"1.374","t":"+3.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.391","875","1.217","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.278","3.767","7.776","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.247","8.177","6.420","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.543","6.213","922","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.197","4.460","6.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":634},{"label":"Mar","value":863},{"label":"Abr","value":760},{"label":"Mai","value":644},{"label":"Jun","value":987},{"label":"Jul","value":859},{"label":"Ago","value":991},{"label":"Set","value":664},{"label":"Out","value":957},{"label":"Nov","value":781},{"label":"Dez","value":819}];
const MX = 991;
