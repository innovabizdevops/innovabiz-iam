...
const ACCENT = "#6366f1";
const MODULE = "Fermentation Tech";
const PAGE = "Control";
const KPIS = [{"l":"Riscos Identificados","v":"6.203","t":"+13.1%","d":"up"},{"l":"Mitigações Ativas","v":"7.414","t":"+17.6%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+16.2%","d":"up"},{"l":"Incidentes YTD","v":"4.414","t":"-3.1%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.588","2.249","4.979","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.960","6.312","3.264","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","9.056","352","2.243","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.949","6.937","5.676","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.560","622","4.605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":694},{"label":"Mar","value":817},{"label":"Abr","value":904},{"label":"Mai","value":708},{"label":"Jun","value":817},{"label":"Jul","value":969},{"label":"Ago","value":1021},{"label":"Set","value":823},{"label":"Out","value":714},{"label":"Nov","value":995},{"label":"Dez","value":1023}];
const MX = 1023;
