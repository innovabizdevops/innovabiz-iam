...
const PAGE = "Scale";
const KPIS = [{"l":"Riscos Identificados","v":"804","t":"-5.3%","d":"down"},{"l":"Mitigações Ativas","v":"5.012","t":"+14.1%","d":"up"},{"l":"Score Risco Geral","v":"75","t":"-4.0%","d":"down"},{"l":"Incidentes YTD","v":"1.165","t":"+3.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.903","5.913","4.983","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.565","9.069","5.248","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.967","6.958","5.397","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.697","795","372","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.059","4.104","4.675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":562},{"label":"Mar","value":741},{"label":"Abr","value":551},{"label":"Mai","value":697},{"label":"Jun","value":581},{"label":"Jul","value":802},{"label":"Ago","value":442},{"label":"Set","value":723},{"label":"Out","value":738},{"label":"Nov","value":657},{"label":"Dez","value":484}];
const MX = 802;
