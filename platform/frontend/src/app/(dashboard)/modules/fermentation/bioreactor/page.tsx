...
const PAGE = "Bioreactor";
const KPIS = [{"l":"Riscos Identificados","v":"995","t":"+14.5%","d":"up"},{"l":"Mitigações Ativas","v":"4.592","t":"+14.6%","d":"up"},{"l":"Score Risco Geral","v":"94","t":"+1.8%","d":"up"},{"l":"Incidentes YTD","v":"7.361","t":"+7.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.110","3.132","1.273","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.235","210","6.006","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.962","5.413","8.113","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.780","7.062","2.777","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.442","1.677","1.948","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":298},{"label":"Mar","value":658},{"label":"Abr","value":507},{"label":"Mai","value":507},{"label":"Jun","value":519},{"label":"Jul","value":375},{"label":"Ago","value":616},{"label":"Set","value":480},{"label":"Out","value":333},{"label":"Nov","value":445},{"label":"Dez","value":631}];
const MX = 658;
