...
const ACCENT = "#60a5fa";
const MODULE = "ATM Management";
const PAGE = "Cash Forecast";
const KPIS = [{"l":"Total Atm Mgmt","v":"2.161","t":"-0.3%","d":"down"},{"l":"Cash Forecast Ativos","v":"5.971","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"75.6%","t":"+14.3%","d":"up"},{"l":"Score Performance","v":"59","t":"+8.5%","d":"up"}];
const COLS = ["ID","Cash Forecast","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atm Mgmt #001","Atm Mgmt #002","6.779","1.212","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Atm Mgmt #002","Atm Mgmt #003","8.606","2.249","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Atm Mgmt #003","Atm Mgmt #004","7.619","950","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Atm Mgmt #004","Atm Mgmt #005","5.797","6.586","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atm Mgmt #005","Atm Mgmt #001","9.055","1.346","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":819},{"label":"Mar","value":1010},{"label":"Abr","value":810},{"label":"Mai","value":805},{"label":"Jun","value":1029},{"label":"Jul","value":714},{"label":"Ago","value":929},{"label":"Set","value":1071},{"label":"Out","value":1021},{"label":"Nov","value":915},{"label":"Dez","value":897}];
const MX = 1071;
