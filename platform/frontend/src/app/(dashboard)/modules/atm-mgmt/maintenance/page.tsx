...
const KPIS = [{"l":"Total Atm Mgmt","v":"5.345","t":"-5.3%","d":"down"},{"l":"Maintenance Ativos","v":"2.117","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+14.2%","d":"up"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atm Mgmt #001","Atm Mgmt #002","7.283","1.629","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Atm Mgmt #002","Atm Mgmt #003","6.197","479","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Atm Mgmt #003","Atm Mgmt #004","4.780","8.845","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["Atm Mgmt #004","Atm Mgmt #005","7.702","1.504","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atm Mgmt #005","Atm Mgmt #001","6.187","6.548","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":719},{"label":"Fev","value":808},{"label":"Mar","value":724},{"label":"Abr","value":819},{"label":"Mai","value":878},{"label":"Jun","value":560},{"label":"Jul","value":847},{"label":"Ago","value":774},{"label":"Set","value":904},{"label":"Out","value":888},{"label":"Nov","value":810},{"label":"Dez","value":786}];
const MX = 904;
