...
const PAGE = "Security";
const KPIS = [{"l":"Total Atm Mgmt","v":"8.690","t":"+15.4%","d":"up"},{"l":"Security Ativos","v":"647","t":"-2.6%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"+2.1%","d":"up"},{"l":"Score Performance","v":"63","t":"+15.2%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atm Mgmt #001","Atm Mgmt #002","6.495","6.826","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Atm Mgmt #002","Atm Mgmt #003","5.914","732","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Atm Mgmt #003","Atm Mgmt #004","2.501","3.946","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Atm Mgmt #004","Atm Mgmt #005","8.856","5.325","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atm Mgmt #005","Atm Mgmt #001","1.334","2.564","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":675},{"label":"Mar","value":581},{"label":"Abr","value":534},{"label":"Mai","value":558},{"label":"Jun","value":739},{"label":"Jul","value":477},{"label":"Ago","value":715},{"label":"Set","value":674},{"label":"Out","value":469},{"label":"Nov","value":766},{"label":"Dez","value":587}];
const MX = 766;
