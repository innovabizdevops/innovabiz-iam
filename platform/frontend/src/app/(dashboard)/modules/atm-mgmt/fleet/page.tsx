...
const PAGE = "Fleet";
const KPIS = [{"l":"Total Atm Mgmt","v":"4.601","t":"+1.1%","d":"up"},{"l":"Fleet Ativos","v":"6.614","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+15.1%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atm Mgmt #001","Atm Mgmt #002","7.249","7.115","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Atm Mgmt #002","Atm Mgmt #003","5.706","7.744","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Atm Mgmt #003","Atm Mgmt #004","2.959","7.202","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Atm Mgmt #004","Atm Mgmt #005","5.311","7.543","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atm Mgmt #005","Atm Mgmt #001","3.108","280","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":836},{"label":"Fev","value":725},{"label":"Mar","value":793},{"label":"Abr","value":902},{"label":"Mai","value":871},{"label":"Jun","value":931},{"label":"Jul","value":830},{"label":"Ago","value":917},{"label":"Set","value":703},{"label":"Out","value":825},{"label":"Nov","value":889},{"label":"Dez","value":880}];
const MX = 931;
