...
const KPIS = [{"l":"Dashboards Ativos","v":"4.260","t":"+11.5%","d":"up"},{"l":"Queries/Dia","v":"418","t":"+4.4%","d":"up"},{"l":"Dados Processados (GB)","v":"6.148","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"4.402","t":"+15.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1749","2026-02-26","420","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","163","2026-01-04","1.497","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4899","2026-02-17","3.848","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3691","2026-03-25","8.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3117","2026-02-09","3.644","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":351},{"label":"Mar","value":505},{"label":"Abr","value":300},{"label":"Mai","value":360},{"label":"Jun","value":461},{"label":"Jul","value":398},{"label":"Ago","value":273},{"label":"Set","value":442},{"label":"Out","value":231},{"label":"Nov","value":242},{"label":"Dez","value":328}];
const MX = 505;
