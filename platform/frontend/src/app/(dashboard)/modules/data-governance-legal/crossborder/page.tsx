...
const KPIS = [{"l":"Riscos Identificados","v":"8.803","t":"+12.6%","d":"up"},{"l":"Mitigações Ativas","v":"527","t":"-5.3%","d":"down"},{"l":"Score Risco Geral","v":"82","t":"-3.0%","d":"down"},{"l":"Incidentes YTD","v":"6.027","t":"-5.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.956","3.330","6.884","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.171","1.188","7.286","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","920","2.755","1.642","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.035","8.941","8.827","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","123","6.224","5.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":693},{"label":"Mar","value":769},{"label":"Abr","value":432},{"label":"Mai","value":570},{"label":"Jun","value":755},{"label":"Jul","value":593},{"label":"Ago","value":560},{"label":"Set","value":806},{"label":"Out","value":703},{"label":"Nov","value":559},{"label":"Dez","value":656}];
const MX = 806;
