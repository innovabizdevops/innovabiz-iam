...
const PAGE = "Retention Sched";
const KPIS = [{"l":"Riscos Identificados","v":"3.129","t":"+4.7%","d":"up"},{"l":"Mitigações Ativas","v":"8.096","t":"+2.5%","d":"up"},{"l":"Score Risco Geral","v":"95","t":"+4.4%","d":"up"},{"l":"Incidentes YTD","v":"5.845","t":"+13.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.652","9.024","8.319","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.676","8.268","7.773","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.246","1.711","3.791","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.737","6.252","1.992","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.354","1.218","1.049","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":696},{"label":"Mar","value":445},{"label":"Abr","value":462},{"label":"Mai","value":350},{"label":"Jun","value":487},{"label":"Jul","value":625},{"label":"Ago","value":608},{"label":"Set","value":502},{"label":"Out","value":401},{"label":"Nov","value":716},{"label":"Dez","value":552}];
const MX = 716;
