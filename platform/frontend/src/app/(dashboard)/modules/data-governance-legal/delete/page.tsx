...
const ACCENT = "#b45309";
const MODULE = "Data Governance Legal";
const PAGE = "Right Delete";
const KPIS = [{"l":"Riscos Identificados","v":"2.695","t":"+0.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.573","t":"+17.3%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+15.4%","d":"up"},{"l":"Incidentes YTD","v":"1.690","t":"+15.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.413","4.461","7.857","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.206","4.133","1.140","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.845","7.299","6.720","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.959","4.082","6.856","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.399","5.723","2.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":321},{"label":"Mar","value":627},{"label":"Abr","value":538},{"label":"Mai","value":592},{"label":"Jun","value":649},{"label":"Jul","value":396},{"label":"Ago","value":361},{"label":"Set","value":681},{"label":"Out","value":513},{"label":"Nov","value":308},{"label":"Dez","value":525}];
const MX = 681;
