...
const PAGE = "Data Map";
const KPIS = [{"l":"Riscos Identificados","v":"446","t":"+14.2%","d":"up"},{"l":"Mitigações Ativas","v":"7.202","t":"+2.1%","d":"up"},{"l":"Score Risco Geral","v":"85","t":"+2.9%","d":"up"},{"l":"Incidentes YTD","v":"6.501","t":"+2.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","273","6.241","4.371","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.224","1.658","1.667","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.462","6.046","8.971","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.766","3.435","2.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.197","7.362","688","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":593},{"label":"Fev","value":477},{"label":"Mar","value":646},{"label":"Abr","value":513},{"label":"Mai","value":344},{"label":"Jun","value":534},{"label":"Jul","value":459},{"label":"Ago","value":277},{"label":"Set","value":383},{"label":"Out","value":466},{"label":"Nov","value":487},{"label":"Dez","value":590}];
const MX = 646;
