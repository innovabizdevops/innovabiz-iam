...
const KPIS = [{"l":"Riscos Identificados","v":"3.212","t":"+16.2%","d":"up"},{"l":"Mitigações Ativas","v":"4.685","t":"-1.4%","d":"down"},{"l":"Score Risco Geral","v":"93","t":"+2.6%","d":"up"},{"l":"Incidentes YTD","v":"7.400","t":"+12.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.149","8.791","601","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","177","7.095","3.736","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.178","158","4.194","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","1.532","901","2.046","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.303","8.668","4.264","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":618},{"label":"Mar","value":958},{"label":"Abr","value":636},{"label":"Mai","value":602},{"label":"Jun","value":763},{"label":"Jul","value":637},{"label":"Ago","value":808},{"label":"Set","value":930},{"label":"Out","value":620},{"label":"Nov","value":921},{"label":"Dez","value":618}];
const MX = 958;
