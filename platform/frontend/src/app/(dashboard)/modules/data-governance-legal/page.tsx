...
export default function DataGovernanceLegalPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Data Governance Legal</h1><p className="text-sm text-muted-foreground">Data Governance Legal • iBOS Enterprise</p></div>
