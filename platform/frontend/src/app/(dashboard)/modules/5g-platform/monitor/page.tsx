...
const ACCENT = "#6d28d9";
const MODULE = "5G Network Platform";
const PAGE = "Monitor";
const KPIS = [{"l":"Formulários Ativos","v":"990","t":"+5.5%","d":"up"},{"l":"Submissões/Dia","v":"1850","t":"+8.9%","d":"up"},{"l":"Documentos Gerados","v":"5.246","t":"+9.4%","d":"up"},{"l":"Templates","v":"6.129","t":"+2.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.956","2026-03-08","2.231","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.318","2026-03-25","876","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.676","2026-01-16","4.767","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.145","2026-02-23","8.140","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.539","2026-02-07","8.977","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":966},{"label":"Mar","value":916},{"label":"Abr","value":782},{"label":"Mai","value":1012},{"label":"Jun","value":715},{"label":"Jul","value":840},{"label":"Ago","value":927},{"label":"Set","value":989},{"label":"Out","value":662},{"label":"Nov","value":628},{"label":"Dez","value":662}];
const MX = 1012;
