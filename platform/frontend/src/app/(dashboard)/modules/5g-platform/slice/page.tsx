...
const PAGE = "Slice";
const KPIS = [{"l":"Formulários Ativos","v":"4.499","t":"+1.4%","d":"up"},{"l":"Submissões/Dia","v":"2186","t":"-0.5%","d":"down"},{"l":"Documentos Gerados","v":"1.687","t":"+1.9%","d":"up"},{"l":"Templates","v":"7.850","t":"+11.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.620","2026-01-06","7.309","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.152","2026-01-27","6.727","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.202","2026-03-22","915","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.587","2026-01-04","7.215","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.270","2026-02-21","6.051","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":811},{"label":"Fev","value":624},{"label":"Mar","value":894},{"label":"Abr","value":608},{"label":"Mai","value":630},{"label":"Jun","value":670},{"label":"Jul","value":791},{"label":"Ago","value":630},{"label":"Set","value":989},{"label":"Out","value":737},{"label":"Nov","value":892},{"label":"Dez","value":798}];
const MX = 989;
