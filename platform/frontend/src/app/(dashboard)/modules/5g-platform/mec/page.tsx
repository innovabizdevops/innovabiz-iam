...
const PAGE = "MEC";
const KPIS = [{"l":"Formulários Ativos","v":"6.586","t":"+16.7%","d":"up"},{"l":"Submissões/Dia","v":"598","t":"-3.6%","d":"down"},{"l":"Documentos Gerados","v":"6.025","t":"+11.8%","d":"up"},{"l":"Templates","v":"5.318","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.164","2026-02-10","2.000","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.144","2026-01-09","2.623","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.282","2026-02-28","8.606","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.684","2026-03-22","500","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.772","2026-03-07","1.173","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":737},{"label":"Fev","value":482},{"label":"Mar","value":654},{"label":"Abr","value":479},{"label":"Mai","value":734},{"label":"Jun","value":818},{"label":"Jul","value":651},{"label":"Ago","value":740},{"label":"Set","value":769},{"label":"Out","value":583},{"label":"Nov","value":547},{"label":"Dez","value":640}];
const MX = 818;
