...
const PAGE = "Edge";
const KPIS = [{"l":"Formulários Ativos","v":"4.297","t":"+7.9%","d":"up"},{"l":"Submissões/Dia","v":"1738","t":"+11.7%","d":"up"},{"l":"Documentos Gerados","v":"4.897","t":"+14.5%","d":"up"},{"l":"Templates","v":"6.206","t":"+0.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.353","2026-03-28","8.857","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.074","2026-02-26","1.412","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.269","2026-02-12","6.002","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.195","2026-01-04","5.776","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.848","2026-03-26","1.837","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":723},{"label":"Mar","value":962},{"label":"Abr","value":673},{"label":"Mai","value":1020},{"label":"Jun","value":801},{"label":"Jul","value":942},{"label":"Ago","value":1008},{"label":"Set","value":952},{"label":"Out","value":993},{"label":"Nov","value":691},{"label":"Dez","value":871}];
const MX = 1020;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6d28d9'}}>EDGE3</span></h1>
                </div>
