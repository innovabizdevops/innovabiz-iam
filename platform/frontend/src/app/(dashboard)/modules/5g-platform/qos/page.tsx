...
const PAGE = "QoS";
const KPIS = [{"l":"Formulários Ativos","v":"1.672","t":"+15.2%","d":"up"},{"l":"Submissões/Dia","v":"1921","t":"-5.4%","d":"down"},{"l":"Documentos Gerados","v":"1.309","t":"-0.9%","d":"down"},{"l":"Templates","v":"2.766","t":"-1.4%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.876","2026-03-19","4.274","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","253","2026-02-21","7.066","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.368","2026-03-05","4.574","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.144","2026-03-04","2.876","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.103","2026-01-24","2.019","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":889},{"label":"Mar","value":950},{"label":"Abr","value":816},{"label":"Mai","value":760},{"label":"Jun","value":955},{"label":"Jul","value":1019},{"label":"Ago","value":852},{"label":"Set","value":716},{"label":"Out","value":751},{"label":"Nov","value":753},{"label":"Dez","value":823}];
const MX = 1019;
