...
/* ═══ 5G Network Platform — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "8971", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4525", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-4%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1854348171", cells: ["5G-7171", "5G Network Platform Item 1", "12/4/2026", "€48 271"], status: "active" as const },
    { id: "1854351742", cells: ["5G-1742", "5G Network Platform Item 2", "27/11/2026", "€1842"], status: "pending" as const },
    { id: "1854355313", cells: ["5G-5313", "5G Network Platform Item 3", "14/6/2026", "€5413"], status: "completed" as const },
    { id: "1854358884", cells: ["5G-8884", "5G Network Platform Item 4", "1/1/2026", "€8984"], status: "warning" as const },
    { id: "1854362455", cells: ["5G-3455", "5G Network Platform Item 5", "16/8/2026", "€12 555"], status: "active" as const },
];
...
export default function P5gNetworkPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">5G Network Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • 5G Network Platform</p>
                    </div>
                </div>
