...
export default function TaxControversyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Tax Controversy</h1><p className="text-sm text-muted-foreground">Tax Controversy • iBOS Enterprise</p></div>
