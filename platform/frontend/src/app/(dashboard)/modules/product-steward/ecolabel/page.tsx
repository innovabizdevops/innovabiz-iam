...
const PAGE = "Eco-Label";
const KPIS = [{"l":"Total Product Steward","v":"8.481","t":"+17.5%","d":"up"},{"l":"Eco Label Ativos","v":"4.678","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"71.4%","t":"-4.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+2.8%","d":"up"}];
const COLS = ["ID","Eco Label","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Steward #001","Product Steward #002","302","5.936","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Product Steward #002","Product Steward #003","2.129","3.268","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Steward #003","Product Steward #004","7.102","6.333","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Product Steward #004","Product Steward #005","679","5.887","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Steward #005","Product Steward #001","9.014","4.580","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":658},{"label":"Fev","value":898},{"label":"Mar","value":633},{"label":"Abr","value":935},{"label":"Mai","value":904},{"label":"Jun","value":778},{"label":"Jul","value":908},{"label":"Ago","value":940},{"label":"Set","value":966},{"label":"Out","value":715},{"label":"Nov","value":995},{"label":"Dez","value":750}];
const MX = 995;
