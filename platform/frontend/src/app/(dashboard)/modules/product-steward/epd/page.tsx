...
const ACCENT = "#4338ca";
const MODULE = "Product Stewardship";
const PAGE = "EPD Publish";
const KPIS = [{"l":"Total Product Steward","v":"2.872","t":"+12.5%","d":"up"},{"l":"EPD Publish Ativos","v":"2.265","t":"-3.6%","d":"down"},{"l":"Eficiência (%)","v":"74.2%","t":"+5.8%","d":"up"},{"l":"Score Performance","v":"94","t":"-4.4%","d":"down"}];
const COLS = ["ID","EPD Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Steward #001","Product Steward #002","3.749","2.212","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Product Steward #002","Product Steward #003","7.861","8.974","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Steward #003","Product Steward #004","5.708","7.943","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Product Steward #004","Product Steward #005","1.301","9.090","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Steward #005","Product Steward #001","7.713","7.614","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":849},{"label":"Mar","value":928},{"label":"Abr","value":748},{"label":"Mai","value":672},{"label":"Jun","value":934},{"label":"Jul","value":698},{"label":"Ago","value":713},{"label":"Set","value":796},{"label":"Out","value":1043},{"label":"Nov","value":832},{"label":"Dez","value":951}];
const MX = 1043;
