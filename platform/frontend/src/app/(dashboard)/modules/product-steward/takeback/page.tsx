...
const KPIS = [{"l":"Total Product Steward","v":"8.301","t":"+5.8%","d":"up"},{"l":"Take Back Ativos","v":"5.225","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"75","t":"-1.0%","d":"down"}];
const COLS = ["ID","Take Back","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Steward #001","Product Steward #002","3.298","499","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Product Steward #002","Product Steward #003","401","7.497","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Steward #003","Product Steward #004","1.120","7.483","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Product Steward #004","Product Steward #005","3.620","7.458","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Steward #005","Product Steward #001","3.127","1.042","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":875},{"label":"Mar","value":557},{"label":"Abr","value":767},{"label":"Mai","value":741},{"label":"Jun","value":742},{"label":"Jul","value":786},{"label":"Ago","value":620},{"label":"Set","value":788},{"label":"Out","value":773},{"label":"Nov","value":878},{"label":"Dez","value":805}];
const MX = 878;
