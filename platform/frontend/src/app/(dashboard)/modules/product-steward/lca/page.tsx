...
const PAGE = "Lifecycle Assess";
const KPIS = [{"l":"Total Product Steward","v":"5.310","t":"+1.1%","d":"up"},{"l":"Lifecycle Assess Ativos","v":"1.410","t":"+16.5%","d":"up"},{"l":"Eficiência (%)","v":"92.8%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"88","t":"+3.9%","d":"up"}];
const COLS = ["ID","Lifecycle Assess","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Product Steward #001","Product Steward #002","2.059","7.212","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["Product Steward #002","Product Steward #003","5.328","4.037","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Product Steward #003","Product Steward #004","3.754","4.995","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Product Steward #004","Product Steward #005","5.362","2.673","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Product Steward #005","Product Steward #001","7.933","3.520","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":457},{"label":"Mar","value":386},{"label":"Abr","value":317},{"label":"Mai","value":354},{"label":"Jun","value":398},{"label":"Jul","value":660},{"label":"Ago","value":349},{"label":"Set","value":511},{"label":"Out","value":589},{"label":"Nov","value":549},{"label":"Dez","value":536}];
const MX = 660;
