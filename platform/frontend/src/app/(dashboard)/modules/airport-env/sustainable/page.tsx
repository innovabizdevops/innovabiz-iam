...
const PAGE = "Sustainable";
const KPIS = [{"l":"Total Airport Env","v":"4.759","t":"+10.4%","d":"up"},{"l":"Sustainable Ativos","v":"7.995","t":"-4.4%","d":"down"},{"l":"Eficiência (%)","v":"65.9%","t":"+15.0%","d":"up"},{"l":"Score Performance","v":"73","t":"-2.3%","d":"down"}];
const COLS = ["ID","Sustainable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Env #001","Airport Env #002","1.900","4.536","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Env #002","Airport Env #003","2.288","7.348","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Env #003","Airport Env #004","8.629","4.333","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Env #004","Airport Env #005","2.306","2.178","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Env #005","Airport Env #001","719","7.190","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":588},{"label":"Fev","value":486},{"label":"Mar","value":522},{"label":"Abr","value":461},{"label":"Mai","value":739},{"label":"Jun","value":587},{"label":"Jul","value":696},{"label":"Ago","value":651},{"label":"Set","value":793},{"label":"Out","value":667},{"label":"Nov","value":813},{"label":"Dez","value":814}];
const MX = 814;
