...
const KPIS = [{"l":"Total Airport Env","v":"3.915","t":"-4.3%","d":"down"},{"l":"Water Mgmt Ativos","v":"6.734","t":"+17.9%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+8.8%","d":"up"}];
const COLS = ["ID","Water Mgmt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Env #001","Airport Env #002","4.553","6.163","2026-02-16","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Env #002","Airport Env #003","8.718","5.926","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Env #003","Airport Env #004","5.246","7.698","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Env #004","Airport Env #005","973","1.429","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Env #005","Airport Env #001","1.350","2.546","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":969},{"label":"Mar","value":968},{"label":"Abr","value":966},{"label":"Mai","value":810},{"label":"Jun","value":998},{"label":"Jul","value":646},{"label":"Ago","value":809},{"label":"Set","value":930},{"label":"Out","value":713},{"label":"Nov","value":874},{"label":"Dez","value":783}];
const MX = 998;
