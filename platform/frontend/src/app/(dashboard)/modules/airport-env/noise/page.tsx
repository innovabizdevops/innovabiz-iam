...
const PAGE = "Noise Monitor";
const KPIS = [{"l":"Total Airport Env","v":"8.372","t":"+11.5%","d":"up"},{"l":"Noise Monitor Ativos","v":"3.756","t":"+0.5%","d":"up"},{"l":"Eficiência (%)","v":"79.8%","t":"-2.7%","d":"down"},{"l":"Score Performance","v":"85","t":"+15.8%","d":"up"}];
const COLS = ["ID","Noise Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Env #001","Airport Env #002","8.538","4.594","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Env #002","Airport Env #003","6.237","1.402","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Env #003","Airport Env #004","2.847","3.497","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Env #004","Airport Env #005","8.410","1.673","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Env #005","Airport Env #001","8.368","4.915","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":318},{"label":"Fev","value":489},{"label":"Mar","value":582},{"label":"Abr","value":538},{"label":"Mai","value":475},{"label":"Jun","value":496},{"label":"Jul","value":450},{"label":"Ago","value":418},{"label":"Set","value":505},{"label":"Out","value":408},{"label":"Nov","value":624},{"label":"Dez","value":496}];
const MX = 624;
