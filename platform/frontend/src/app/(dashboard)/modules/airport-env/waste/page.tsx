...
const PAGE = "Waste Stream";
const KPIS = [{"l":"Total Airport Env","v":"3.339","t":"+1.1%","d":"up"},{"l":"Waste Stream Ativos","v":"7.050","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"71","t":"+12.1%","d":"up"}];
const COLS = ["ID","Waste Stream","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Env #001","Airport Env #002","7.561","6.154","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Env #002","Airport Env #003","2.764","3.974","2026-03-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Env #003","Airport Env #004","1.561","4.413","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Env #004","Airport Env #005","3.697","9.049","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Env #005","Airport Env #001","5.962","5.570","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1005},{"label":"Fev","value":982},{"label":"Mar","value":996},{"label":"Abr","value":715},{"label":"Mai","value":938},{"label":"Jun","value":997},{"label":"Jul","value":641},{"label":"Ago","value":826},{"label":"Set","value":732},{"label":"Out","value":695},{"label":"Nov","value":938},{"label":"Dez","value":834}];
const MX = 1005;
