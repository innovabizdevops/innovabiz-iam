...
const ACCENT = "#059669";
const MODULE = "Airport Environment";
const PAGE = "Emission Track";
const KPIS = [{"l":"Total Airport Env","v":"7.274","t":"+6.0%","d":"up"},{"l":"Emission Track Ativos","v":"2.843","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"66","t":"+5.4%","d":"up"}];
const COLS = ["ID","Emission Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Airport Env #001","Airport Env #002","9.039","8.590","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Airport Env #002","Airport Env #003","1.360","263","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Airport Env #003","Airport Env #004","8.053","2.723","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Airport Env #004","Airport Env #005","8.737","5.779","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Airport Env #005","Airport Env #001","8.875","4.003","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":889},{"label":"Fev","value":506},{"label":"Mar","value":622},{"label":"Abr","value":816},{"label":"Mai","value":893},{"label":"Jun","value":587},{"label":"Jul","value":719},{"label":"Ago","value":639},{"label":"Set","value":833},{"label":"Out","value":746},{"label":"Nov","value":672},{"label":"Dez","value":548}];
const MX = 893;
