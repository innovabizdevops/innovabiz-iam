...
export default function FoodInnovationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Food Innovation</h1><p className="text-sm text-muted-foreground">Food Innovation • iBOS Enterprise</p></div>
