...
const PAGE = "Ideation";
const KPIS = [{"l":"Ideias Submetidas","v":"4.316","t":"+5.0%","d":"up"},{"l":"Patentes (YTD)","v":"8.211","t":"-2.8%","d":"down"},{"l":"Projetos Innovation Lab","v":"4.535","t":"+7.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€20.0M","t":"-2.1%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.811","91.8%","8.419","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.632","73.8%","5.963","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.463","88.9%","4.793","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.727","78.4%","3.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","721","75.6%","5.023","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":368},{"label":"Mar","value":494},{"label":"Abr","value":497},{"label":"Mai","value":640},{"label":"Jun","value":696},{"label":"Jul","value":685},{"label":"Ago","value":533},{"label":"Set","value":740},{"label":"Out","value":583},{"label":"Nov","value":545},{"label":"Dez","value":400}];
const MX = 740;
