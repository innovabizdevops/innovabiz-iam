...
const PAGE = "Test";
const KPIS = [{"l":"Ideias Submetidas","v":"5.638","t":"+6.2%","d":"up"},{"l":"Patentes (YTD)","v":"1.830","t":"+17.9%","d":"up"},{"l":"Projetos Innovation Lab","v":"4.879","t":"+12.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€11.8M","t":"-0.2%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.594","82.7%","6.404","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.636","85.5%","363","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.497","96.6%","6.811","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","2.065","91.8%","6.534","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.635","84.2%","1.434","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":247},{"label":"Fev","value":233},{"label":"Mar","value":320},{"label":"Abr","value":370},{"label":"Mai","value":260},{"label":"Jun","value":209},{"label":"Jul","value":385},{"label":"Ago","value":594},{"label":"Set","value":377},{"label":"Out","value":507},{"label":"Nov","value":431},{"label":"Dez","value":295}];
const MX = 594;
