...
const KPIS = [{"l":"Ideias Submetidas","v":"2.894","t":"+8.4%","d":"up"},{"l":"Patentes (YTD)","v":"531","t":"+6.5%","d":"up"},{"l":"Projetos Innovation Lab","v":"8.943","t":"+7.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€16.2M","t":"+0.4%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.348","83.0%","3.226","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","2.771","97.5%","1.995","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","6.432","83.0%","3.232","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","5.327","73.2%","4.241","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","2.161","71.7%","3.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":812},{"label":"Mar","value":589},{"label":"Abr","value":624},{"label":"Mai","value":732},{"label":"Jun","value":754},{"label":"Jul","value":607},{"label":"Ago","value":730},{"label":"Set","value":889},{"label":"Out","value":640},{"label":"Nov","value":677},{"label":"Dez","value":620}];
const MX = 889;
