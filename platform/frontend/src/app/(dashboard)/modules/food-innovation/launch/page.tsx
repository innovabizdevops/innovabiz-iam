...
const PAGE = "Launch";
const KPIS = [{"l":"Ideias Submetidas","v":"3.385","t":"+14.6%","d":"up"},{"l":"Patentes (YTD)","v":"6.591","t":"+3.4%","d":"up"},{"l":"Projetos Innovation Lab","v":"2.355","t":"+15.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€11.2M","t":"+12.3%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","5.166","75.6%","7.584","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","1.948","98.5%","2.718","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","3.351","92.0%","7.760","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.594","93.8%","2.656","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.566","91.0%","6.669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":965},{"label":"Mar","value":1009},{"label":"Abr","value":917},{"label":"Mai","value":972},{"label":"Jun","value":724},{"label":"Jul","value":946},{"label":"Ago","value":895},{"label":"Set","value":800},{"label":"Out","value":855},{"label":"Nov","value":670},{"label":"Dez","value":750}];
const MX = 1009;
