...
const ACCENT = "#6366f1";
const MODULE = "Food Innovation";
const PAGE = "Consumer";
const KPIS = [{"l":"Ideias Submetidas","v":"8.015","t":"+11.7%","d":"up"},{"l":"Patentes (YTD)","v":"1.623","t":"+5.1%","d":"up"},{"l":"Projetos Innovation Lab","v":"5.004","t":"+13.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€45.3M","t":"+17.5%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","9.083","91.1%","7.941","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","6.099","80.2%","1.981","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","2.413","81.2%","2.033","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.808","93.2%","8.480","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","8.499","92.6%","7.334","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":714},{"label":"Mar","value":823},{"label":"Abr","value":580},{"label":"Mai","value":464},{"label":"Jun","value":837},{"label":"Jul","value":551},{"label":"Ago","value":816},{"label":"Set","value":507},{"label":"Out","value":640},{"label":"Nov","value":571},{"label":"Dez","value":487}];
const MX = 837;
