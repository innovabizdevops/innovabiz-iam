...
const KPIS = [{"l":"Total Art Auction","v":"5.344","t":"+6.8%","d":"up"},{"l":"Provenance Ativos","v":"7.727","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"60","t":"+12.3%","d":"up"}];
const COLS = ["ID","Provenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Auction #001","Art Auction #002","2.449","3.420","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Art Auction #002","Art Auction #003","6.512","1.410","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Auction #003","Art Auction #004","7.907","8.582","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Art Auction #004","Art Auction #005","7.994","3.740","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Auction #005","Art Auction #001","898","2.491","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":573},{"label":"Fev","value":730},{"label":"Mar","value":768},{"label":"Abr","value":820},{"label":"Mai","value":890},{"label":"Jun","value":921},{"label":"Jul","value":733},{"label":"Ago","value":873},{"label":"Set","value":760},{"label":"Out","value":745},{"label":"Nov","value":612},{"label":"Dez","value":806}];
const MX = 921;
