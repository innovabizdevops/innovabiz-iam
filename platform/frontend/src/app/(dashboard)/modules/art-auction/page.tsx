...
/* ═══ Art Auction — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "3292", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2411", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€339K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "-25%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1188062592", cells: ["ART-9592", "Art Auction Item 1", "25/1/2026", "€12 692"], status: "active" as const },
    { id: "1188066163", cells: ["ART-4163", "Art Auction Item 2", "12/8/2026", "€16 263"], status: "pending" as const },
    { id: "1188069734", cells: ["ART-7734", "Art Auction Item 3", "27/3/2026", "€19 834"], status: "completed" as const },
    { id: "1188073305", cells: ["ART-2305", "Art Auction Item 4", "14/10/2026", "€23 405"], status: "warning" as const },
    { id: "1188076876", cells: ["ART-5876", "Art Auction Item 5", "1/5/2026", "€26 976"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Art Auction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Art Auction</p>
                    </div>
                </div>
