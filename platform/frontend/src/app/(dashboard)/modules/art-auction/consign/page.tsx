...
const PAGE = "Consign";
const KPIS = [{"l":"Total Art Auction","v":"505","t":"-3.7%","d":"down"},{"l":"Consign Ativos","v":"7.652","t":"+5.8%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+2.9%","d":"up"}];
const COLS = ["ID","Consign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Auction #001","Art Auction #002","1.864","2.945","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Art Auction #002","Art Auction #003","4.611","6.918","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Auction #003","Art Auction #004","5.043","4.159","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Art Auction #004","Art Auction #005","8.084","8.738","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Auction #005","Art Auction #001","3.058","2.080","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":635},{"label":"Fev","value":510},{"label":"Mar","value":409},{"label":"Abr","value":620},{"label":"Mai","value":455},{"label":"Jun","value":519},{"label":"Jul","value":783},{"label":"Ago","value":430},{"label":"Set","value":616},{"label":"Out","value":790},{"label":"Nov","value":515},{"label":"Dez","value":729}];
const MX = 790;
