...
const ACCENT = "#78350f";
const MODULE = "Art Auction";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"3.180","t":"+15.6%","d":"up"},{"l":"Queries/Dia","v":"1315","t":"+2.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.511","t":"+11.2%","d":"up"},{"l":"Utilizadores Analytics","v":"2.696","t":"+15.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4125","2026-01-20","6.022","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","860","2026-01-13","2.519","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1985","2026-01-14","6.651","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4569","2026-03-15","8.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2546","2026-02-07","3.565","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":597},{"label":"Fev","value":360},{"label":"Mar","value":321},{"label":"Abr","value":279},{"label":"Mai","value":461},{"label":"Jun","value":274},{"label":"Jul","value":592},{"label":"Ago","value":514},{"label":"Set","value":372},{"label":"Out","value":637},{"label":"Nov","value":342},{"label":"Dez","value":555}];
const MX = 637;
