...
const PAGE = "Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"6.538","t":"+3.6%","d":"up"},{"l":"Contratos (€M)","v":"€44.5M","t":"+4.9%","d":"up"},{"l":"On-Time Delivery (%)","v":"78.5%","t":"+4.5%","d":"up"},{"l":"Score Médio","v":"62","t":"+12.3%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","81.7%","€ 277.99","3.533","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.0%","€ 8918.97","6.405","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","99.7%","€ 41012.11","8.089","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","87.7%","€ 141.58","5.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","81.3%","€ 2741.34","8.038","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":586},{"label":"Mar","value":567},{"label":"Abr","value":776},{"label":"Mai","value":772},{"label":"Jun","value":744},{"label":"Jul","value":776},{"label":"Ago","value":617},{"label":"Set","value":664},{"label":"Out","value":580},{"label":"Nov","value":714},{"label":"Dez","value":678}];
const MX = 776;
