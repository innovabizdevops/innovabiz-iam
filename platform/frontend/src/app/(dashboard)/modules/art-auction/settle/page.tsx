...
const PAGE = "Settle";
const KPIS = [{"l":"Total Art Auction","v":"4.711","t":"+7.0%","d":"up"},{"l":"Settle Ativos","v":"2.370","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"71.2%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"92","t":"+10.5%","d":"up"}];
const COLS = ["ID","Settle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Art Auction #001","Art Auction #002","5.955","720","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Art Auction #002","Art Auction #003","7.123","8.075","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Art Auction #003","Art Auction #004","7.889","3.078","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Art Auction #004","Art Auction #005","7.006","4.296","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Art Auction #005","Art Auction #001","6.623","977","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":464},{"label":"Mar","value":743},{"label":"Abr","value":833},{"label":"Mai","value":529},{"label":"Jun","value":770},{"label":"Jul","value":811},{"label":"Ago","value":644},{"label":"Set","value":452},{"label":"Out","value":663},{"label":"Nov","value":720},{"label":"Dez","value":628}];
const MX = 833;
