...
const ACCENT = "#dc2626";
const MODULE = "Nuclear Safety";
const PAGE = "Dose Monitor";
const KPIS = [{"l":"Total Nuclear Safety","v":"5.565","t":"-2.5%","d":"down"},{"l":"Dose Monitor Ativos","v":"5.849","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"67","t":"-0.6%","d":"down"}];
const COLS = ["ID","Dose Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Safety #001","Nuclear Safety #002","7.647","4.629","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Safety #002","Nuclear Safety #003","5.653","5.075","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Safety #003","Nuclear Safety #004","1.591","7.744","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Safety #004","Nuclear Safety #005","3.841","1.773","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Safety #005","Nuclear Safety #001","6.035","7.666","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":707},{"label":"Fev","value":746},{"label":"Mar","value":705},{"label":"Abr","value":1022},{"label":"Mai","value":632},{"label":"Jun","value":880},{"label":"Jul","value":999},{"label":"Ago","value":740},{"label":"Set","value":761},{"label":"Out","value":940},{"label":"Nov","value":766},{"label":"Dez","value":870}];
const MX = 1022;
