...
export default function NuclearSafetyPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Nuclear Safety</h1><p className="text-sm text-muted-foreground">Nuclear Safety • iBOS Enterprise</p></div>
