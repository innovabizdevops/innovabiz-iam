...
const KPIS = [{"l":"Auditorias Realizadas","v":"5.562","t":"+8.5%","d":"up"},{"l":"NC Abertas","v":"4.834","t":"-4.7%","d":"down"},{"l":"Conformidade (%)","v":"92.9%","t":"+6.7%","d":"up"},{"l":"CAPAs Pendentes","v":"1.033","t":"+14.4%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.467","89.5%","1.126","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.539","96.9%","4.394","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.305","87.8%","1.814","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","942","90.1%","2.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.471","84.3%","1.735","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":781},{"label":"Mar","value":1000},{"label":"Abr","value":891},{"label":"Mai","value":831},{"label":"Jun","value":940},{"label":"Jul","value":1014},{"label":"Ago","value":1031},{"label":"Set","value":752},{"label":"Out","value":944},{"label":"Nov","value":1033},{"label":"Dez","value":670}];
const MX = 1033;
