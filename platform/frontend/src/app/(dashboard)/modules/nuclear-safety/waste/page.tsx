...
const PAGE = "Waste Classify";
const KPIS = [{"l":"Total Nuclear Safety","v":"5.801","t":"+0.6%","d":"up"},{"l":"Waste Classify Ativos","v":"1.078","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"83.0%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"94","t":"+3.4%","d":"up"}];
const COLS = ["ID","Waste Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Safety #001","Nuclear Safety #002","466","3.998","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Safety #002","Nuclear Safety #003","8.066","1.009","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Safety #003","Nuclear Safety #004","5.482","722","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Safety #004","Nuclear Safety #005","3.097","2.788","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Safety #005","Nuclear Safety #001","6.534","3.048","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":466},{"label":"Mar","value":708},{"label":"Abr","value":530},{"label":"Mai","value":793},{"label":"Jun","value":505},{"label":"Jul","value":571},{"label":"Ago","value":667},{"label":"Set","value":693},{"label":"Out","value":574},{"label":"Nov","value":757},{"label":"Dez","value":666}];
const MX = 793;
