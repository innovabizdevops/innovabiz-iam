...
const PAGE = "Emergency Plan";
const KPIS = [{"l":"Total Nuclear Safety","v":"5.787","t":"+12.5%","d":"up"},{"l":"Emergency Plan Ativos","v":"8.738","t":"+1.5%","d":"up"},{"l":"Eficiência (%)","v":"79.0%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+14.9%","d":"up"}];
const COLS = ["ID","Emergency Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Safety #001","Nuclear Safety #002","5.909","4.135","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Safety #002","Nuclear Safety #003","744","624","2026-01-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Safety #003","Nuclear Safety #004","5.732","2.846","2026-03-19","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Safety #004","Nuclear Safety #005","4.682","372","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Safety #005","Nuclear Safety #001","7.110","5.384","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":677},{"label":"Fev","value":449},{"label":"Mar","value":750},{"label":"Abr","value":709},{"label":"Mai","value":672},{"label":"Jun","value":652},{"label":"Jul","value":561},{"label":"Ago","value":644},{"label":"Set","value":431},{"label":"Out","value":779},{"label":"Nov","value":659},{"label":"Dez","value":565}];
const MX = 779;
