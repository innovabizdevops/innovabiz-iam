...
const PAGE = "NRC Comply";
const KPIS = [{"l":"Total Nuclear Safety","v":"6.792","t":"+0.2%","d":"up"},{"l":"NRC Comply Ativos","v":"5.075","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"72.9%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"69","t":"+1.8%","d":"up"}];
const COLS = ["ID","NRC Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Nuclear Safety #001","Nuclear Safety #002","1.249","6.162","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Nuclear Safety #002","Nuclear Safety #003","780","4.478","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Nuclear Safety #003","Nuclear Safety #004","3.566","718","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Nuclear Safety #004","Nuclear Safety #005","7.196","4.036","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Nuclear Safety #005","Nuclear Safety #001","5.144","6.277","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":619},{"label":"Mar","value":632},{"label":"Abr","value":649},{"label":"Mai","value":427},{"label":"Jun","value":438},{"label":"Jul","value":360},{"label":"Ago","value":343},{"label":"Set","value":438},{"label":"Out","value":572},{"label":"Nov","value":577},{"label":"Dez","value":460}];
const MX = 649;
