...
const ACCENT = "#6366f1";
const MODULE = "Gaming Studio";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"901","t":"+1.0%","d":"up"},{"l":"Submissões/Dia","v":"4822","t":"-0.3%","d":"down"},{"l":"Documentos Gerados","v":"8.384","t":"+10.8%","d":"up"},{"l":"Templates","v":"2.306","t":"+17.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.478","2026-03-25","6.772","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.656","2026-03-02","5.573","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.061","2026-01-22","6.645","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","202","2026-01-18","1.593","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.431","2026-03-27","2.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":911},{"label":"Fev","value":679},{"label":"Mar","value":680},{"label":"Abr","value":681},{"label":"Mai","value":517},{"label":"Jun","value":663},{"label":"Jul","value":778},{"label":"Ago","value":903},{"label":"Set","value":655},{"label":"Out","value":570},{"label":"Nov","value":880},{"label":"Dez","value":702}];
const MX = 911;
