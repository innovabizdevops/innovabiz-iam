...
const PAGE = "QA";
const KPIS = [{"l":"Total Gaming Studio","v":"4.119","t":"+3.0%","d":"up"},{"l":"QA Ativos","v":"653","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"+12.7%","d":"up"},{"l":"Score Performance","v":"66","t":"+1.1%","d":"up"}];
const COLS = ["ID","QA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gaming Studio #001","Gaming Studio #002","6.343","1.928","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Gaming Studio #002","Gaming Studio #003","167","8.803","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Gaming Studio #003","Gaming Studio #004","315","4.737","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Gaming Studio #004","Gaming Studio #005","5.283","1.559","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gaming Studio #005","Gaming Studio #001","7.160","7.295","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":841},{"label":"Mar","value":616},{"label":"Abr","value":856},{"label":"Mai","value":723},{"label":"Jun","value":575},{"label":"Jul","value":769},{"label":"Ago","value":637},{"label":"Set","value":868},{"label":"Out","value":677},{"label":"Nov","value":707},{"label":"Dez","value":814}];
const MX = 868;
