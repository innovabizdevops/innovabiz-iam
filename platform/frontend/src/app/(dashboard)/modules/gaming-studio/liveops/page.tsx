...
const PAGE = "Live Ops";
const KPIS = [{"l":"Total Gaming Studio","v":"6.032","t":"+16.8%","d":"up"},{"l":"Live Ops Ativos","v":"4.777","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"79.1%","t":"+3.5%","d":"up"},{"l":"Score Performance","v":"63","t":"+17.2%","d":"up"}];
const COLS = ["ID","Live Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gaming Studio #001","Gaming Studio #002","5.360","7.450","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Gaming Studio #002","Gaming Studio #003","3.881","215","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Gaming Studio #003","Gaming Studio #004","5.982","3.118","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Gaming Studio #004","Gaming Studio #005","5.595","6.882","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gaming Studio #005","Gaming Studio #001","7.019","6.028","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":834},{"label":"Mar","value":596},{"label":"Abr","value":663},{"label":"Mai","value":699},{"label":"Jun","value":581},{"label":"Jul","value":692},{"label":"Ago","value":509},{"label":"Set","value":688},{"label":"Out","value":522},{"label":"Nov","value":726},{"label":"Dez","value":790}];
const MX = 834;
