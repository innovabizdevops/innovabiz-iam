...
const PAGE = "Launch";
const KPIS = [{"l":"Total Gaming Studio","v":"5.633","t":"+4.2%","d":"up"},{"l":"Launch Ativos","v":"6.856","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"69","t":"-0.1%","d":"down"}];
const COLS = ["ID","Launch","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Gaming Studio #001","Gaming Studio #002","2.034","2.604","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Gaming Studio #002","Gaming Studio #003","4.613","2.168","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Gaming Studio #003","Gaming Studio #004","8.662","1.294","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Gaming Studio #004","Gaming Studio #005","6.400","1.311","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Gaming Studio #005","Gaming Studio #001","7.840","6.786","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":900},{"label":"Mar","value":781},{"label":"Abr","value":749},{"label":"Mai","value":785},{"label":"Jun","value":866},{"label":"Jul","value":802},{"label":"Ago","value":929},{"label":"Set","value":933},{"label":"Out","value":787},{"label":"Nov","value":762},{"label":"Dez","value":706}];
const MX = 933;
