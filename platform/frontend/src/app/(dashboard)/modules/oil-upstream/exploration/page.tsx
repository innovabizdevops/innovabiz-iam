...
const ACCENT = "#78350f";
const MODULE = "Oil Upstream";
const PAGE = "Exploration";
const KPIS = [{"l":"Total Oil Upstream","v":"5.059","t":"-1.0%","d":"down"},{"l":"Exploration Ativos","v":"6.961","t":"+0.6%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"84","t":"+4.7%","d":"up"}];
const COLS = ["ID","Exploration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Upstream #001","Oil Upstream #002","2.679","3.573","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Upstream #002","Oil Upstream #003","4.198","1.755","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Upstream #003","Oil Upstream #004","7.327","7.929","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Upstream #004","Oil Upstream #005","5.754","9.066","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Upstream #005","Oil Upstream #001","8.556","2.787","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":577},{"label":"Mar","value":646},{"label":"Abr","value":561},{"label":"Mai","value":669},{"label":"Jun","value":478},{"label":"Jul","value":378},{"label":"Ago","value":678},{"label":"Set","value":442},{"label":"Out","value":530},{"label":"Nov","value":470},{"label":"Dez","value":544}];
const MX = 678;
