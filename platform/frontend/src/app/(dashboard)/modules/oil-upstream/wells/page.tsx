...
const PAGE = "Well Planning";
const KPIS = [{"l":"Total Oil Upstream","v":"785","t":"+8.4%","d":"up"},{"l":"Well Planning Ativos","v":"6.820","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"-5.0%","d":"down"},{"l":"Score Performance","v":"89","t":"-4.1%","d":"down"}];
const COLS = ["ID","Well Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Upstream #001","Oil Upstream #002","3.993","3.302","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Upstream #002","Oil Upstream #003","8.721","7.225","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Upstream #003","Oil Upstream #004","7.013","2.273","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Upstream #004","Oil Upstream #005","7.004","4.792","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Upstream #005","Oil Upstream #001","1.975","2.328","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":620},{"label":"Mar","value":691},{"label":"Abr","value":831},{"label":"Mai","value":537},{"label":"Jun","value":916},{"label":"Jul","value":921},{"label":"Ago","value":896},{"label":"Set","value":609},{"label":"Out","value":672},{"label":"Nov","value":891},{"label":"Dez","value":580}];
const MX = 921;
