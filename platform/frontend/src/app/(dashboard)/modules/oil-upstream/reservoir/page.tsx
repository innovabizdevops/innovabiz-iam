...
const PAGE = "Reservoir Sim";
const KPIS = [{"l":"Total Oil Upstream","v":"5.249","t":"+6.2%","d":"up"},{"l":"Reservoir Sim Ativos","v":"9.040","t":"+6.3%","d":"up"},{"l":"Eficiência (%)","v":"88.5%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"58","t":"+4.9%","d":"up"}];
const COLS = ["ID","Reservoir Sim","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Upstream #001","Oil Upstream #002","2.650","7.880","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Upstream #002","Oil Upstream #003","1.617","4.326","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Upstream #003","Oil Upstream #004","2.024","1.127","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Upstream #004","Oil Upstream #005","4.179","5.490","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Upstream #005","Oil Upstream #001","1.251","4.383","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":708},{"label":"Mar","value":712},{"label":"Abr","value":443},{"label":"Mai","value":756},{"label":"Jun","value":444},{"label":"Jul","value":511},{"label":"Ago","value":504},{"label":"Set","value":499},{"label":"Out","value":640},{"label":"Nov","value":704},{"label":"Dez","value":687}];
const MX = 756;
