...
const KPIS = [{"l":"Total Oil Upstream","v":"8.451","t":"-4.2%","d":"down"},{"l":"Production Ativos","v":"4.393","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"84.3%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"90","t":"-1.4%","d":"down"}];
const COLS = ["ID","Production","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oil Upstream #001","Oil Upstream #002","8.884","4.434","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Oil Upstream #002","Oil Upstream #003","8.113","5.835","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Oil Upstream #003","Oil Upstream #004","939","2.817","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Oil Upstream #004","Oil Upstream #005","1.576","5.337","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oil Upstream #005","Oil Upstream #001","1.524","5.585","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1026},{"label":"Fev","value":980},{"label":"Mar","value":910},{"label":"Abr","value":926},{"label":"Mai","value":910},{"label":"Jun","value":1051},{"label":"Jul","value":1078},{"label":"Ago","value":890},{"label":"Set","value":948},{"label":"Out","value":906},{"label":"Nov","value":982},{"label":"Dez","value":1038}];
const MX = 1078;
