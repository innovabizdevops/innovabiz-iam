...
/* ═══ OMNI Channel Orchestrator — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "9945", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "716", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€297K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "157033745", cells: ["OMN-2745", "OMNI Channel Orchestrator Item 1", "2/6/2026", "€33 845"], status: "active" as const },
    { id: "157037316", cells: ["OMN-6316", "OMNI Channel Orchestrator Item 2", "17/1/2026", "€37 416"], status: "pending" as const },
    { id: "157040887", cells: ["OMN-9887", "OMNI Channel Orchestrator Item 3", "4/8/2026", "€40 987"], status: "completed" as const },
    { id: "157044458", cells: ["OMN-4458", "OMNI Channel Orchestrator Item 4", "19/3/2026", "€44 558"], status: "warning" as const },
    { id: "157048029", cells: ["OMN-8029", "OMNI Channel Orchestrator Item 5", "6/10/2026", "€48 129"], status: "active" as const },
];
...
export default function OmniChannelOrchestratorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Channel Orchestrator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Channel Orchestrator</p>
                    </div>
                </div>
