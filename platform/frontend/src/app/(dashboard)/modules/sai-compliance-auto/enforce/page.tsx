...
const PAGE = "Enforce";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.677","t":"+8.0%","d":"up"},{"l":"NC Abertas","v":"4.470","t":"-1.7%","d":"down"},{"l":"Conformidade (%)","v":"77.3%","t":"-4.4%","d":"down"},{"l":"CAPAs Pendentes","v":"3.473","t":"-5.2%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.225","83.5%","1.565","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.104","74.4%","6.440","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.490","75.1%","3.330","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","636","78.6%","6.506","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.574","77.0%","5.384","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":780},{"label":"Mar","value":818},{"label":"Abr","value":620},{"label":"Mai","value":748},{"label":"Jun","value":626},{"label":"Jul","value":717},{"label":"Ago","value":925},{"label":"Set","value":777},{"label":"Out","value":980},{"label":"Nov","value":950},{"label":"Dez","value":821}];
const MX = 980;
