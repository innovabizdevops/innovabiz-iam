...
/* ═══ S-AI Compliance Automation — Dashboard ═══ */

const ACCENT = "#991b1b";

const KPIS = [
    { label: "Total Registos", value: "5182", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4342", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€201K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "151712682", cells: ["SAI-9682", "S-AI Compliance Automation Item 1", "3/7/2026", "€12 782"], status: "active" as const },
    { id: "151716253", cells: ["SAI-4253", "S-AI Compliance Automation Item 2", "18/2/2026", "€16 353"], status: "pending" as const },
    { id: "151719824", cells: ["SAI-7824", "S-AI Compliance Automation Item 3", "5/9/2026", "€19 924"], status: "completed" as const },
    { id: "151723395", cells: ["SAI-2395", "S-AI Compliance Automation Item 4", "20/4/2026", "€23 495"], status: "warning" as const },
    { id: "151726966", cells: ["SAI-5966", "S-AI Compliance Automation Item 5", "7/11/2026", "€27 066"], status: "active" as const },
];
...
export default function SaiComplianceAutomationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">S-AI Compliance Automation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • S-AI Compliance Automation</p>
                    </div>
                </div>
