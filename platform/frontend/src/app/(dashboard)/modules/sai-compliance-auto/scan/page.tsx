...
const ACCENT = "#991b1b";
const MODULE = "S-AI Compliance Automation";
const PAGE = "Scan";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.390","t":"-4.5%","d":"down"},{"l":"NC Abertas","v":"7.509","t":"+13.4%","d":"up"},{"l":"Conformidade (%)","v":"74.0%","t":"+14.5%","d":"up"},{"l":"CAPAs Pendentes","v":"3.125","t":"+2.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.789","75.7%","7.915","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.766","76.8%","2.928","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.090","78.2%","234","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.338","74.7%","4.678","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.328","86.7%","1.452","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":401},{"label":"Mar","value":523},{"label":"Abr","value":365},{"label":"Mai","value":288},{"label":"Jun","value":256},{"label":"Jul","value":351},{"label":"Ago","value":408},{"label":"Set","value":513},{"label":"Out","value":472},{"label":"Nov","value":493},{"label":"Dez","value":359}];
const MX = 523;
