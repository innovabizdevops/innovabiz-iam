...
const PAGE = "Evidence";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.994","t":"+2.9%","d":"up"},{"l":"NC Abertas","v":"8.097","t":"-2.7%","d":"down"},{"l":"Conformidade (%)","v":"84.5%","t":"-1.1%","d":"down"},{"l":"CAPAs Pendentes","v":"8.167","t":"+9.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.300","92.0%","2.757","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.277","70.4%","445","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.065","71.1%","7.782","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.180","82.3%","8.001","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.513","77.9%","3.091","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":403},{"label":"Fev","value":589},{"label":"Mar","value":551},{"label":"Abr","value":660},{"label":"Mai","value":355},{"label":"Jun","value":628},{"label":"Jul","value":549},{"label":"Ago","value":387},{"label":"Set","value":390},{"label":"Out","value":583},{"label":"Nov","value":406},{"label":"Dez","value":370}];
const MX = 660;
