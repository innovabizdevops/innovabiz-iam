...
/* ═══ Fashion Influencer Platform — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "423", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1468", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€156K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "802801223", cells: ["FAS-2223", "Fashion Influencer Platform Item 1", "8/12/2026", "€1323"], status: "active" as const },
    { id: "802804794", cells: ["FAS-5794", "Fashion Influencer Platform Item 2", "23/7/2026", "€4894"], status: "pending" as const },
    { id: "802808365", cells: ["FAS-9365", "Fashion Influencer Platform Item 3", "10/2/2026", "€8465"], status: "completed" as const },
    { id: "802811936", cells: ["FAS-3936", "Fashion Influencer Platform Item 4", "25/9/2026", "€12 036"], status: "warning" as const },
    { id: "802815507", cells: ["FAS-7507", "Fashion Influencer Platform Item 5", "12/4/2026", "€15 607"], status: "active" as const },
];
...
export default function FashionInfluencerPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Influencer Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Influencer Platform</p>
                    </div>
                </div>
