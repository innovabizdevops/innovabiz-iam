...
const PAGE = "Report";
const KPIS = [{"l":"Total Hazmat Response","v":"5.010","t":"+8.8%","d":"up"},{"l":"Report Ativos","v":"5.972","t":"+10.1%","d":"up"},{"l":"Eficiência (%)","v":"75.8%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"87","t":"+9.6%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazmat Response #001","Hazmat Response #002","8.019","6.175","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Hazmat Response #002","Hazmat Response #003","5.604","3.763","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazmat Response #003","Hazmat Response #004","8.021","4.238","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Hazmat Response #004","Hazmat Response #005","2.640","6.526","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazmat Response #005","Hazmat Response #001","5.648","3.139","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":847},{"label":"Fev","value":729},{"label":"Mar","value":685},{"label":"Abr","value":612},{"label":"Mai","value":706},{"label":"Jun","value":736},{"label":"Jul","value":798},{"label":"Ago","value":537},{"label":"Set","value":778},{"label":"Out","value":573},{"label":"Nov","value":647},{"label":"Dez","value":896}];
const MX = 896;
