...
const PAGE = "Identify";
const KPIS = [{"l":"Total Hazmat Response","v":"7.399","t":"+11.3%","d":"up"},{"l":"Identify Ativos","v":"3.550","t":"+12.7%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"87","t":"+12.9%","d":"up"}];
const COLS = ["ID","Identify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazmat Response #001","Hazmat Response #002","7.631","938","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Hazmat Response #002","Hazmat Response #003","7.389","7.358","2026-01-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazmat Response #003","Hazmat Response #004","795","5.141","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Hazmat Response #004","Hazmat Response #005","2.254","1.546","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazmat Response #005","Hazmat Response #001","2.972","5.181","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":251},{"label":"Fev","value":496},{"label":"Mar","value":313},{"label":"Abr","value":429},{"label":"Mai","value":409},{"label":"Jun","value":451},{"label":"Jul","value":343},{"label":"Ago","value":403},{"label":"Set","value":497},{"label":"Out","value":582},{"label":"Nov","value":533},{"label":"Dez","value":521}];
const MX = 582;
