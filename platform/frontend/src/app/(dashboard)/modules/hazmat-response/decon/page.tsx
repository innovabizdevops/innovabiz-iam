...
const PAGE = "Decon";
const KPIS = [{"l":"Total Hazmat Response","v":"6.475","t":"+9.8%","d":"up"},{"l":"Decon Ativos","v":"6.835","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"93.1%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.3%","d":"down"}];
const COLS = ["ID","Decon","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazmat Response #001","Hazmat Response #002","218","1.028","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Hazmat Response #002","Hazmat Response #003","5.459","439","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazmat Response #003","Hazmat Response #004","4.503","8.280","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Hazmat Response #004","Hazmat Response #005","1.082","6.638","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazmat Response #005","Hazmat Response #001","991","6.672","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1049},{"label":"Fev","value":829},{"label":"Mar","value":800},{"label":"Abr","value":766},{"label":"Mai","value":954},{"label":"Jun","value":956},{"label":"Jul","value":925},{"label":"Ago","value":1009},{"label":"Set","value":879},{"label":"Out","value":943},{"label":"Nov","value":725},{"label":"Dez","value":978}];
const MX = 1049;
