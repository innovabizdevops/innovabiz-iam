...
const ACCENT = "#6366f1";
const MODULE = "HazMat Response";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Hazmat Response","v":"4.803","t":"+0.7%","d":"up"},{"l":"Monitor Ativos","v":"5.427","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-2.9%","d":"down"},{"l":"Score Performance","v":"91","t":"+12.4%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazmat Response #001","Hazmat Response #002","7.253","2.922","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Hazmat Response #002","Hazmat Response #003","889","7.574","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazmat Response #003","Hazmat Response #004","2.482","1.053","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Hazmat Response #004","Hazmat Response #005","1.199","6.171","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazmat Response #005","Hazmat Response #001","2.739","6.919","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":569},{"label":"Mar","value":680},{"label":"Abr","value":526},{"label":"Mai","value":609},{"label":"Jun","value":639},{"label":"Jul","value":650},{"label":"Ago","value":774},{"label":"Set","value":606},{"label":"Out","value":452},{"label":"Nov","value":534},{"label":"Dez","value":561}];
const MX = 777;
