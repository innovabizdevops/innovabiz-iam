...
const PAGE = "Contain";
const KPIS = [{"l":"Total Hazmat Response","v":"7.321","t":"+6.2%","d":"up"},{"l":"Contain Ativos","v":"3.362","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"93.3%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"55","t":"-3.1%","d":"down"}];
const COLS = ["ID","Contain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hazmat Response #001","Hazmat Response #002","2.854","6.463","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Hazmat Response #002","Hazmat Response #003","8.770","8.593","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Hazmat Response #003","Hazmat Response #004","4.736","6.419","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Hazmat Response #004","Hazmat Response #005","7.177","5.580","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hazmat Response #005","Hazmat Response #001","4.714","2.521","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":841},{"label":"Mar","value":460},{"label":"Abr","value":638},{"label":"Mai","value":695},{"label":"Jun","value":539},{"label":"Jul","value":491},{"label":"Ago","value":608},{"label":"Set","value":782},{"label":"Out","value":633},{"label":"Nov","value":761},{"label":"Dez","value":747}];
const MX = 841;
