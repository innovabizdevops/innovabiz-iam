...
const KPIS = [{"l":"Utilizadores Ativos","v":"5.045","t":"-5.0%","d":"down"},{"l":"Sessões/Dia","v":"2778","t":"+12.4%","d":"up"},{"l":"MFA Adoção (%)","v":"88.7%","t":"+13.2%","d":"up"},{"l":"Tentativas Bloqueadas","v":"4.367","t":"+9.9%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","1.703","1.078","6.984","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","3.181","8.433","4.086","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","1.555","408","1.467","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","1.447","5.478","7.779","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","8.535","7.442","1.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":786},{"label":"Fev","value":791},{"label":"Mar","value":549},{"label":"Abr","value":562},{"label":"Mai","value":816},{"label":"Jun","value":710},{"label":"Jul","value":848},{"label":"Ago","value":668},{"label":"Set","value":675},{"label":"Out","value":706},{"label":"Nov","value":683},{"label":"Dez","value":605}];
const MX = 848;
