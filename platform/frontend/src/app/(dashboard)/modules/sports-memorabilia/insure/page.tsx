...
const PAGE = "Insure";
const KPIS = [{"l":"Atletas Registados","v":"3.724","t":"+6.2%","d":"up"},{"l":"Treinos/Semana","v":"3970","t":"+14.1%","d":"up"},{"l":"Competições","v":"3.775","t":"+9.6%","d":"up"},{"l":"Performance Score","v":"84","t":"+14.7%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.115","2.882","2.100","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.344","8.060","3.726","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","3.127","4.157","8.140","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.136","4.177","7.021","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","9.057","8.146","1.232","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":813},{"label":"Fev","value":1045},{"label":"Mar","value":849},{"label":"Abr","value":659},{"label":"Mai","value":981},{"label":"Jun","value":985},{"label":"Jul","value":890},{"label":"Ago","value":739},{"label":"Set","value":946},{"label":"Out","value":1039},{"label":"Nov","value":807},{"label":"Dez","value":1040}];
const MX = 1045;
