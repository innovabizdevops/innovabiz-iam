...
const ACCENT = "#92400e";
const MODULE = "Sports Memorabilia";
const PAGE = "Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"6.729","t":"+15.8%","d":"up"},{"l":"Queries/Dia","v":"732","t":"+1.1%","d":"up"},{"l":"Dados Processados (GB)","v":"6.477","t":"-5.4%","d":"down"},{"l":"Utilizadores Analytics","v":"4.545","t":"-3.2%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","402","2026-03-14","516","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4924","2026-02-24","7.346","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2861","2026-01-26","2.904","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1450","2026-01-16","3.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3584","2026-03-09","3.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":901},{"label":"Fev","value":841},{"label":"Mar","value":886},{"label":"Abr","value":902},{"label":"Mai","value":635},{"label":"Jun","value":756},{"label":"Jul","value":815},{"label":"Ago","value":918},{"label":"Set","value":973},{"label":"Out","value":815},{"label":"Nov","value":850},{"label":"Dez","value":616}];
const MX = 973;
