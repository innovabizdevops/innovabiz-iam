...
/* ═══ Sports Memorabilia — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "9341", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1949", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€117K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "82%", trend: "+24%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1827776941", cells: ["SPO-3941", "Sports Memorabilia Item 1", "26/2/2026", "€27 041"], status: "active" as const },
    { id: "1827780512", cells: ["SPO-7512", "Sports Memorabilia Item 2", "13/9/2026", "€30 612"], status: "pending" as const },
    { id: "1827784083", cells: ["SPO-2083", "Sports Memorabilia Item 3", "28/4/2026", "€34 183"], status: "completed" as const },
    { id: "1827787654", cells: ["SPO-5654", "Sports Memorabilia Item 4", "15/11/2026", "€37 754"], status: "warning" as const },
    { id: "1827791225", cells: ["SPO-9225", "Sports Memorabilia Item 5", "2/6/2026", "€41 325"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sports Memorabilia</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Sports Memorabilia</p>
                    </div>
                </div>
