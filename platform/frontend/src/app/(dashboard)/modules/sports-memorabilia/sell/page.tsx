...
const PAGE = "Sell";
const KPIS = [{"l":"Atletas Registados","v":"1.551","t":"+2.3%","d":"up"},{"l":"Treinos/Semana","v":"1135","t":"-5.2%","d":"down"},{"l":"Competições","v":"464","t":"+1.7%","d":"up"},{"l":"Performance Score","v":"62","t":"+10.2%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.435","4.576","5.073","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.865","1.145","506","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","583","4.654","8.108","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","423","1.304","8.806","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.499","1.815","6.481","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":531},{"label":"Mar","value":548},{"label":"Abr","value":377},{"label":"Mai","value":649},{"label":"Jun","value":685},{"label":"Jul","value":632},{"label":"Ago","value":456},{"label":"Set","value":542},{"label":"Out","value":481},{"label":"Nov","value":456},{"label":"Dez","value":494}];
const MX = 685;
