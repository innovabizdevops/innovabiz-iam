...
const PAGE = "Grade";
const KPIS = [{"l":"Atletas Registados","v":"8.736","t":"-4.1%","d":"down"},{"l":"Treinos/Semana","v":"3150","t":"+12.0%","d":"up"},{"l":"Competições","v":"8.783","t":"+10.8%","d":"up"},{"l":"Performance Score","v":"70","t":"-5.2%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","4.385","6.568","3.348","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","445","3.560","7.711","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.847","5.131","6.025","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.841","7.355","5.730","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.531","8.943","6.353","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":520},{"label":"Fev","value":544},{"label":"Mar","value":781},{"label":"Abr","value":746},{"label":"Mai","value":687},{"label":"Jun","value":859},{"label":"Jul","value":700},{"label":"Ago","value":581},{"label":"Set","value":502},{"label":"Out","value":564},{"label":"Nov","value":478},{"label":"Dez","value":473}];
const MX = 859;
