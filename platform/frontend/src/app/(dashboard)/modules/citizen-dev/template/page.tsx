...
const ACCENT = "#00bcf2";
const MODULE = "Citizen Developer Platform";
const PAGE = "Template";
const KPIS = [{"l":"Formulários Ativos","v":"6.916","t":"+4.2%","d":"up"},{"l":"Submissões/Dia","v":"4322","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"8.319","t":"+8.7%","d":"up"},{"l":"Templates","v":"7.779","t":"-2.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.507","2026-02-13","1.637","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.847","2026-02-11","2.196","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.332","2026-03-08","5.508","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","303","2026-03-06","595","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.664","2026-01-22","4.089","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":855},{"label":"Mar","value":797},{"label":"Abr","value":712},{"label":"Mai","value":782},{"label":"Jun","value":1030},{"label":"Jul","value":805},{"label":"Ago","value":722},{"label":"Set","value":837},{"label":"Out","value":782},{"label":"Nov","value":960},{"label":"Dez","value":864}];
const MX = 1030;
