...
const PAGE = "Low Code";
const KPIS = [{"l":"Total Citizen Dev","v":"7.575","t":"-1.5%","d":"down"},{"l":"Low Code Ativos","v":"3.125","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"78.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"68","t":"+1.5%","d":"up"}];
const COLS = ["ID","Low Code","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Citizen Dev #001","Citizen Dev #002","3.226","8.962","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Citizen Dev #002","Citizen Dev #003","6.825","161","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Citizen Dev #003","Citizen Dev #004","4.321","8.438","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Citizen Dev #004","Citizen Dev #005","3.144","7.025","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Citizen Dev #005","Citizen Dev #001","3.363","8.852","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":795},{"label":"Mar","value":524},{"label":"Abr","value":451},{"label":"Mai","value":698},{"label":"Jun","value":509},{"label":"Jul","value":483},{"label":"Ago","value":634},{"label":"Set","value":656},{"label":"Out","value":498},{"label":"Nov","value":449},{"label":"Dez","value":736}];
const MX = 795;
