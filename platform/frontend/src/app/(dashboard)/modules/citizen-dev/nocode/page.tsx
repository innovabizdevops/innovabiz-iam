...
const PAGE = "No Code";
const KPIS = [{"l":"Total Citizen Dev","v":"7.753","t":"+2.8%","d":"up"},{"l":"No Code Ativos","v":"4.255","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"57","t":"-0.3%","d":"down"}];
const COLS = ["ID","No Code","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Citizen Dev #001","Citizen Dev #002","1.535","6.530","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Citizen Dev #002","Citizen Dev #003","7.041","3.043","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Citizen Dev #003","Citizen Dev #004","1.937","7.349","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Citizen Dev #004","Citizen Dev #005","4.571","1.669","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Citizen Dev #005","Citizen Dev #001","3.041","7.535","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":820},{"label":"Mar","value":896},{"label":"Abr","value":601},{"label":"Mai","value":901},{"label":"Jun","value":606},{"label":"Jul","value":602},{"label":"Ago","value":980},{"label":"Set","value":807},{"label":"Out","value":929},{"label":"Nov","value":750},{"label":"Dez","value":839}];
const MX = 980;
