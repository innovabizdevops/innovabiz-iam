...
const PAGE = "Govern";
const KPIS = [{"l":"Total Citizen Dev","v":"1.610","t":"+15.4%","d":"up"},{"l":"Govern Ativos","v":"6.987","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"56","t":"-5.6%","d":"down"}];
const COLS = ["ID","Govern","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Citizen Dev #001","Citizen Dev #002","3.425","2.095","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["Citizen Dev #002","Citizen Dev #003","922","9.026","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Citizen Dev #003","Citizen Dev #004","7.344","8.853","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Citizen Dev #004","Citizen Dev #005","5.325","4.804","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Citizen Dev #005","Citizen Dev #001","5.494","1.115","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":902},{"label":"Mar","value":937},{"label":"Abr","value":792},{"label":"Mai","value":864},{"label":"Jun","value":955},{"label":"Jul","value":976},{"label":"Ago","value":729},{"label":"Set","value":765},{"label":"Out","value":659},{"label":"Nov","value":715},{"label":"Dez","value":947}];
const MX = 976;
