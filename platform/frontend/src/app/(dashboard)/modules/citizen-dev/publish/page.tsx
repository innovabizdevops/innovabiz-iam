...
const PAGE = "Publish";
const KPIS = [{"l":"Total Citizen Dev","v":"5.454","t":"+5.3%","d":"up"},{"l":"Publish Ativos","v":"4.536","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"70.4%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"83","t":"+9.0%","d":"up"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Citizen Dev #001","Citizen Dev #002","4.258","2.003","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Citizen Dev #002","Citizen Dev #003","3.196","3.037","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Citizen Dev #003","Citizen Dev #004","4.270","7.922","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Citizen Dev #004","Citizen Dev #005","1.633","356","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Citizen Dev #005","Citizen Dev #001","2.560","2.295","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":644},{"label":"Fev","value":676},{"label":"Mar","value":711},{"label":"Abr","value":911},{"label":"Mai","value":959},{"label":"Jun","value":822},{"label":"Jul","value":946},{"label":"Ago","value":858},{"label":"Set","value":800},{"label":"Out","value":679},{"label":"Nov","value":701},{"label":"Dez","value":722}];
const MX = 959;
