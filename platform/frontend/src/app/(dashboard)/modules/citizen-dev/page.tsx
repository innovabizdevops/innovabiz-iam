...
/* ═══ Citizen Developer Platform — Dashboard ═══ */

const ACCENT = "#00bcf2";

const KPIS = [
    { label: "Total Registos", value: "4303", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2540", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€402K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1894478103", cells: ["CIT-6103", "Citizen Developer Platform Item 1", "8/4/2026", "€28 203"], status: "active" as const },
    { id: "1894481674", cells: ["CIT-9674", "Citizen Developer Platform Item 2", "23/11/2026", "€31 774"], status: "pending" as const },
    { id: "1894485245", cells: ["CIT-4245", "Citizen Developer Platform Item 3", "10/6/2026", "€35 345"], status: "completed" as const },
    { id: "1894488816", cells: ["CIT-7816", "Citizen Developer Platform Item 4", "25/1/2026", "€38 916"], status: "warning" as const },
    { id: "1894492387", cells: ["CIT-2387", "Citizen Developer Platform Item 5", "12/8/2026", "€42 487"], status: "active" as const },
];
...
export default function CitizenDeveloperPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Citizen Developer Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Citizen Developer Platform</p>
                    </div>
                </div>
