...
/* ═══ Custody & Settlement — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "2908", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "60", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€256K", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1130315508", cells: ["CUS-6508", "Custody & Settlement Item 1", "1/1/2026", "€15 608"], status: "active" as const },
    { id: "1130319079", cells: ["CUS-1079", "Custody & Settlement Item 2", "16/8/2026", "€19 179"], status: "pending" as const },
    { id: "1130322650", cells: ["CUS-4650", "Custody & Settlement Item 3", "3/3/2026", "€22 750"], status: "completed" as const },
    { id: "1130326221", cells: ["CUS-8221", "Custody & Settlement Item 4", "18/10/2026", "€26 321"], status: "warning" as const },
    { id: "1130329792", cells: ["CUS-2792", "Custody & Settlement Item 5", "5/5/2026", "€29 892"], status: "active" as const },
];
...
export default function CustodySettlementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Custody & Settlement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Custody & Settlement</p>
                    </div>
                </div>
