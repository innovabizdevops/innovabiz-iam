...
const PAGE = "Settle";
const KPIS = [{"l":"Total Custody Settlement","v":"€75355","t":"+11.7%","d":"up"},{"l":"Settle Ativos","v":"7.403","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+15.4%","d":"up"},{"l":"Score Performance","v":"88","t":"+13.1%","d":"up"}];
const COLS = ["ID","Settle","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Custody Settlement #001","Custody Settlement #002","3.004","3.618","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Custody Settlement #002","Custody Settlement #003","7.786","4.680","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Custody Settlement #003","Custody Settlement #004","5.758","3.427","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Custody Settlement #004","Custody Settlement #005","3.597","5.989","2026-01-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custody Settlement #005","Custody Settlement #001","3.644","968","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1019},{"label":"Fev","value":848},{"label":"Mar","value":731},{"label":"Abr","value":709},{"label":"Mai","value":822},{"label":"Jun","value":902},{"label":"Jul","value":983},{"label":"Ago","value":878},{"label":"Set","value":815},{"label":"Out","value":1031},{"label":"Nov","value":998},{"label":"Dez","value":757}];
const MX = 1031;
