...
const PAGE = "Safekeep";
const KPIS = [{"l":"Total Custody Settlement","v":"€98255","t":"+11.0%","d":"up"},{"l":"Safekeep Ativos","v":"1.219","t":"+4.7%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+0.7%","d":"up"},{"l":"Score Performance","v":"80","t":"+16.4%","d":"up"}];
const COLS = ["ID","Safekeep","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Custody Settlement #001","Custody Settlement #002","8.933","9.063","2026-03-21","Ativo"],"status":"active"},{"id":"r1","cells":["Custody Settlement #002","Custody Settlement #003","5.942","3.446","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Custody Settlement #003","Custody Settlement #004","1.088","6.075","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Custody Settlement #004","Custody Settlement #005","5.568","8.652","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custody Settlement #005","Custody Settlement #001","3.946","7.642","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":934},{"label":"Mar","value":719},{"label":"Abr","value":722},{"label":"Mai","value":920},{"label":"Jun","value":880},{"label":"Jul","value":867},{"label":"Ago","value":915},{"label":"Set","value":824},{"label":"Out","value":869},{"label":"Nov","value":862},{"label":"Dez","value":662}];
const MX = 934;
...
export default function SafekeepPage() {
    return (
