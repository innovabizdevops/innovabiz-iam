...
const ACCENT = "#1e3a5f";
const MODULE = "Custody & Settlement";
const PAGE = "Corporate Action";
const KPIS = [{"l":"Total Custody Settlement","v":"€61089","t":"+3.2%","d":"up"},{"l":"Corporate Action Ativos","v":"5.140","t":"+2.3%","d":"up"},{"l":"Eficiência (%)","v":"85.0%","t":"+7.1%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.5%","d":"down"}];
const COLS = ["ID","Corporate Action","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Custody Settlement #001","Custody Settlement #002","289","8.091","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Custody Settlement #002","Custody Settlement #003","6.299","2.086","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Custody Settlement #003","Custody Settlement #004","5.552","5.217","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Custody Settlement #004","Custody Settlement #005","984","1.435","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custody Settlement #005","Custody Settlement #001","1.152","4.133","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":451},{"label":"Mar","value":634},{"label":"Abr","value":520},{"label":"Mai","value":622},{"label":"Jun","value":471},{"label":"Jul","value":425},{"label":"Ago","value":565},{"label":"Set","value":405},{"label":"Out","value":551},{"label":"Nov","value":421},{"label":"Dez","value":396}];
const MX = 634;
...
export default function CorpactionPage() {
    return (
