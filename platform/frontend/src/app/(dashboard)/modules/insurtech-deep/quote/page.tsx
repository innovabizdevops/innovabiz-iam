...
const PAGE = "Quote";
const KPIS = [{"l":"Total Insurtech Deep","v":"9.071","t":"+3.4%","d":"up"},{"l":"Quote Ativos","v":"6.122","t":"+16.3%","d":"up"},{"l":"Eficiência (%)","v":"92.2%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.4%","d":"up"}];
const COLS = ["ID","Quote","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech Deep #001","Insurtech Deep #002","3.032","917","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech Deep #002","Insurtech Deep #003","7.823","458","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech Deep #003","Insurtech Deep #004","4.230","2.575","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech Deep #004","Insurtech Deep #005","4.476","8.272","2026-03-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech Deep #005","Insurtech Deep #001","1.124","7.402","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":862},{"label":"Mar","value":846},{"label":"Abr","value":611},{"label":"Mai","value":794},{"label":"Jun","value":714},{"label":"Jul","value":815},{"label":"Ago","value":846},{"label":"Set","value":742},{"label":"Out","value":748},{"label":"Nov","value":563},{"label":"Dez","value":623}];
const MX = 862;
