...
const ACCENT = "#0ea5e9";
const MODULE = "InsurTech Deep";
const PAGE = "Telematics";
const KPIS = [{"l":"Total Insurtech Deep","v":"2.774","t":"+2.1%","d":"up"},{"l":"Telematics Ativos","v":"6.553","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"78.4%","t":"-0.1%","d":"down"},{"l":"Score Performance","v":"70","t":"+15.1%","d":"up"}];
const COLS = ["ID","Telematics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech Deep #001","Insurtech Deep #002","4.933","4.929","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech Deep #002","Insurtech Deep #003","3.789","1.688","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech Deep #003","Insurtech Deep #004","4.808","7.373","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech Deep #004","Insurtech Deep #005","318","1.904","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech Deep #005","Insurtech Deep #001","3.109","1.569","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":653},{"label":"Mar","value":633},{"label":"Abr","value":601},{"label":"Mai","value":471},{"label":"Jun","value":488},{"label":"Jul","value":614},{"label":"Ago","value":587},{"label":"Set","value":473},{"label":"Out","value":463},{"label":"Nov","value":576},{"label":"Dez","value":706}];
const MX = 706;
