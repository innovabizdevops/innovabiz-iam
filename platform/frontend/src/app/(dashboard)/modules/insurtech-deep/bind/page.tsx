...
const PAGE = "Bind";
const KPIS = [{"l":"Total Insurtech Deep","v":"1.976","t":"+1.1%","d":"up"},{"l":"Bind Ativos","v":"4.979","t":"+18.0%","d":"up"},{"l":"Eficiência (%)","v":"67.6%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.0%","d":"down"}];
const COLS = ["ID","Bind","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Insurtech Deep #001","Insurtech Deep #002","630","4.703","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Insurtech Deep #002","Insurtech Deep #003","2.577","1.185","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Insurtech Deep #003","Insurtech Deep #004","4.141","3.085","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Insurtech Deep #004","Insurtech Deep #005","2.650","7.848","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Insurtech Deep #005","Insurtech Deep #001","5.254","2.917","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":838},{"label":"Mar","value":1093},{"label":"Abr","value":1035},{"label":"Mai","value":876},{"label":"Jun","value":853},{"label":"Jul","value":981},{"label":"Ago","value":855},{"label":"Set","value":936},{"label":"Out","value":932},{"label":"Nov","value":1049},{"label":"Dez","value":788}];
const MX = 1093;
