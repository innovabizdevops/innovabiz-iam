...
/* ═══ InsurTech Deep — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "7969", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3141", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€389K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1633299969", cells: ["INS-7969", "InsurTech Deep Item 1", "22/10/2026", "€50 069"], status: "active" as const },
    { id: "1633303540", cells: ["INS-2540", "InsurTech Deep Item 2", "9/5/2026", "€3640"], status: "pending" as const },
    { id: "1633307111", cells: ["INS-6111", "InsurTech Deep Item 3", "24/12/2026", "€7211"], status: "completed" as const },
    { id: "1633310682", cells: ["INS-9682", "InsurTech Deep Item 4", "11/7/2026", "€10 782"], status: "warning" as const },
    { id: "1633314253", cells: ["INS-4253", "InsurTech Deep Item 5", "26/2/2026", "€14 353"], status: "active" as const },
];
...
export default function InsurtechDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">InsurTech Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • InsurTech Deep</p>
                    </div>
                </div>
