...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.155","t":"+14.6%","d":"up"},{"l":"NC Abertas","v":"4.657","t":"+0.1%","d":"up"},{"l":"Conformidade (%)","v":"67.0%","t":"+15.4%","d":"up"},{"l":"CAPAs Pendentes","v":"946","t":"+10.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.167","82.0%","7.418","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","8.964","75.4%","648","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.819","99.2%","1.252","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.194","93.2%","2.379","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.559","76.6%","4.195","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":825},{"label":"Mar","value":648},{"label":"Abr","value":596},{"label":"Mai","value":809},{"label":"Jun","value":872},{"label":"Jul","value":593},{"label":"Ago","value":549},{"label":"Set","value":754},{"label":"Out","value":607},{"label":"Nov","value":744},{"label":"Dez","value":771}];
const MX = 872;
