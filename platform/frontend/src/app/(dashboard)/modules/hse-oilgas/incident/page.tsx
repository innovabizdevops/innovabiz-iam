...
const ACCENT = "#6366f1";
const MODULE = "HSE Oil & Gas";
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"6.258","t":"+13.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"69.3%","t":"+16.8%","d":"up"},{"l":"MTTR (h)","v":"145h","t":"-0.6%","d":"down"},{"l":"Satisfação (%)","v":"85.5%","t":"-3.3%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.198","3.186","1.285","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","8.434","3.237","4.195","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.980","8.287","1.364","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.103","8.774","4.199","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.542","2.630","8.021","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":437},{"label":"Fev","value":529},{"label":"Mar","value":556},{"label":"Abr","value":745},{"label":"Mai","value":446},{"label":"Jun","value":597},{"label":"Jul","value":443},{"label":"Ago","value":440},{"label":"Set","value":679},{"label":"Out","value":512},{"label":"Nov","value":668},{"label":"Dez","value":491}];
const MX = 745;
