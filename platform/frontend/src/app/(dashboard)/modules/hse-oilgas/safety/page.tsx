...
const KPIS = [{"l":"Incidentes (YTD)","v":"901","t":"-1.8%","d":"down"},{"l":"LTIR","v":"6.397","t":"-4.9%","d":"down"},{"l":"Formações HSE","v":"1.434","t":"+0.7%","d":"up"},{"l":"Inspeções Realizadas","v":"2.800","t":"+13.0%","d":"up"}];
const COLS = ["Incidente","Local","Tipo","Gravidade","Investigador","Estado"];
const ROWS = [{"id":"r0","cells":["EHS-INC-4521","EHS-NM-3214","1.237","2.577","2.109","Ativo"],"status":"active"},{"id":"r1","cells":["EHS-NM-3214","EHS-INSP-7891","6.087","5.788","5.877","Pendente"],"status":"pending"},{"id":"r2","cells":["EHS-INSP-7891","EHS-FORM-1098","8.896","9.067","934","Concluído"],"status":"done"},{"id":"r3","cells":["EHS-FORM-1098","EHS-AUD-5623","745","789","3.584","Em Análise"],"status":"risk"},{"id":"r4","cells":["EHS-AUD-5623","EHS-INC-4521","3.660","2.597","5.591","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":482},{"label":"Fev","value":622},{"label":"Mar","value":770},{"label":"Abr","value":591},{"label":"Mai","value":653},{"label":"Jun","value":456},{"label":"Jul","value":657},{"label":"Ago","value":709},{"label":"Set","value":646},{"label":"Out","value":568},{"label":"Nov","value":613},{"label":"Dez","value":728}];
const MX = 770;
