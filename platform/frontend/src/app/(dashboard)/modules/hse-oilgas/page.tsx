...
export default function HseOilgasPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Hse Oilgas</h1><p className="text-sm text-muted-foreground">Hse Oilgas • iBOS Enterprise</p></div>
