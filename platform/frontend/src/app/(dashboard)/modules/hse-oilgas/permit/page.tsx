...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"2.646","t":"+0.4%","d":"up"},{"l":"Mitigações Ativas","v":"2.911","t":"+6.5%","d":"up"},{"l":"Score Risco Geral","v":"58","t":"+4.1%","d":"up"},{"l":"Incidentes YTD","v":"1.924","t":"+9.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.363","2.587","7.714","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.643","3.283","8.421","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.617","8.437","1.144","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","2.383","5.209","5.938","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.253","3.497","7.600","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":689},{"label":"Fev","value":609},{"label":"Mar","value":431},{"label":"Abr","value":484},{"label":"Mai","value":456},{"label":"Jun","value":380},{"label":"Jul","value":384},{"label":"Ago","value":649},{"label":"Set","value":645},{"label":"Out","value":717},{"label":"Nov","value":400},{"label":"Dez","value":427}];
const MX = 717;
