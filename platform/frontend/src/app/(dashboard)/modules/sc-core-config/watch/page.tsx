...
const ACCENT = "#0284c7";
const MODULE = "SC: Core Config Provider";
const PAGE = "Watch";
const KPIS = [{"l":"Configurações","v":"3.867","t":"+15.3%","d":"up"},{"l":"Últimas Alterações","v":"2.424","t":"+4.4%","d":"up"},{"l":"Ambientes","v":"2.236","t":"+14.2%","d":"up"},{"l":"Versão Config","v":"4.628","t":"+12.9%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 13554.62","810","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 10661.14","4.030","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 31060.04","4.015","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 3359.79","5.148","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 32832.19","2.234","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":802},{"label":"Mar","value":559},{"label":"Abr","value":778},{"label":"Mai","value":758},{"label":"Jun","value":867},{"label":"Jul","value":547},{"label":"Ago","value":879},{"label":"Set","value":510},{"label":"Out","value":513},{"label":"Nov","value":744},{"label":"Dez","value":887}];
const MX = 887;
