...
const PAGE = "Source";
const KPIS = [{"l":"Configurações","v":"7.144","t":"-1.9%","d":"down"},{"l":"Últimas Alterações","v":"4.623","t":"+3.1%","d":"up"},{"l":"Ambientes","v":"300","t":"+9.6%","d":"up"},{"l":"Versão Config","v":"7.489","t":"+3.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 8564.31","1.724","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 574.87","4.835","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 13327.16","4.684","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 23402.46","1.088","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 28142.99","5.064","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":815},{"label":"Mar","value":622},{"label":"Abr","value":708},{"label":"Mai","value":921},{"label":"Jun","value":745},{"label":"Jul","value":959},{"label":"Ago","value":809},{"label":"Set","value":927},{"label":"Out","value":951},{"label":"Nov","value":939},{"label":"Dez","value":777}];
const MX = 959;
