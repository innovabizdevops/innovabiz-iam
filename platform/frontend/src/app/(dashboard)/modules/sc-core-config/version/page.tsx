...
const PAGE = "Version";
const KPIS = [{"l":"Formulários Ativos","v":"7.476","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"3666","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"5.468","t":"+0.9%","d":"up"},{"l":"Templates","v":"1.653","t":"+0.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.293","2026-02-22","6.475","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.976","2026-01-15","6.622","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.595","2026-02-03","1.919","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.892","2026-03-01","4.358","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.792","2026-03-26","8.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":720},{"label":"Fev","value":649},{"label":"Mar","value":634},{"label":"Abr","value":661},{"label":"Mai","value":747},{"label":"Jun","value":693},{"label":"Jul","value":553},{"label":"Ago","value":782},{"label":"Set","value":908},{"label":"Out","value":626},{"label":"Nov","value":665},{"label":"Dez","value":865}];
const MX = 908;
