...
const PAGE = "Override";
const KPIS = [{"l":"Configurações","v":"3.528","t":"+13.7%","d":"up"},{"l":"Últimas Alterações","v":"8.462","t":"+13.2%","d":"up"},{"l":"Ambientes","v":"2.823","t":"+16.3%","d":"up"},{"l":"Versão Config","v":"1.019","t":"+11.0%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 33415.62","5.978","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 23337.48","288","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 45565.89","8.825","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 7927.93","7.748","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 1106.98","2.398","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":565},{"label":"Mar","value":704},{"label":"Abr","value":746},{"label":"Mai","value":650},{"label":"Jun","value":614},{"label":"Jul","value":802},{"label":"Ago","value":863},{"label":"Set","value":666},{"label":"Out","value":631},{"label":"Nov","value":606},{"label":"Dez","value":856}];
const MX = 863;
