...
const PAGE = "Validate";
const KPIS = [{"l":"Configurações","v":"6.121","t":"+1.1%","d":"up"},{"l":"Últimas Alterações","v":"4.288","t":"+4.1%","d":"up"},{"l":"Ambientes","v":"3.457","t":"+16.3%","d":"up"},{"l":"Versão Config","v":"5.426","t":"+11.5%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 32931.76","8.262","2026-03-02","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 19214.21","2.401","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 32976.40","964","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 37369.10","7.723","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 25392.30","5.609","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":425},{"label":"Mar","value":654},{"label":"Abr","value":482},{"label":"Mai","value":572},{"label":"Jun","value":521},{"label":"Jul","value":503},{"label":"Ago","value":544},{"label":"Set","value":672},{"label":"Out","value":581},{"label":"Nov","value":599},{"label":"Dez","value":541}];
const MX = 675;
