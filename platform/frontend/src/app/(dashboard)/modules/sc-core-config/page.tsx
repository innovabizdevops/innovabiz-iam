...
/* ═══ SC: Core Config Provider — Dashboard ═══ */

const ACCENT = "#0284c7";

const KPIS = [
    { label: "Total Registos", value: "5230", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "392", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€134K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1412190630", cells: ["SC-1630", "SC: Core Config Provider Item 1", "19/7/2026", "€40 730"], status: "active" as const },
    { id: "1412194201", cells: ["SC-5201", "SC: Core Config Provider Item 2", "6/2/2026", "€44 301"], status: "pending" as const },
    { id: "1412197772", cells: ["SC-8772", "SC: Core Config Provider Item 3", "21/9/2026", "€47 872"], status: "completed" as const },
    { id: "1412201343", cells: ["SC-3343", "SC: Core Config Provider Item 4", "8/4/2026", "€1443"], status: "warning" as const },
    { id: "1412204914", cells: ["SC-6914", "SC: Core Config Provider Item 5", "23/11/2026", "€5014"], status: "active" as const },
];
...
export default function ScCoreConfigProviderPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">SC: Core Config Provider</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • SC: Core Config Provider</p>
                    </div>
                </div>
