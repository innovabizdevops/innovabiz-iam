...
const PAGE = "Training";
const KPIS = [{"l":"Quartos Ocupados","v":"2.597","t":"-3.0%","d":"down"},{"l":"RevPAR (€)","v":"€12806","t":"+5.4%","d":"up"},{"l":"Ocupação (%)","v":"82.3%","t":"+9.6%","d":"up"},{"l":"Guest Satisfaction","v":"633","t":"-1.4%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.745","2026-03-14","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.922","2026-01-20","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.373","2026-03-25","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.158","2026-01-12","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.882","2026-02-26","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":617},{"label":"Mar","value":928},{"label":"Abr","value":770},{"label":"Mai","value":716},{"label":"Jun","value":810},{"label":"Jul","value":722},{"label":"Ago","value":997},{"label":"Set","value":827},{"label":"Out","value":878},{"label":"Nov","value":756},{"label":"Dez","value":759}];
const MX = 997;
