...
const ACCENT = "#6366f1";
const MODULE = "Space Tourism";
const PAGE = "Booking";
const KPIS = [{"l":"Quartos Ocupados","v":"6.303","t":"+14.3%","d":"up"},{"l":"RevPAR (€)","v":"€66921","t":"+9.5%","d":"up"},{"l":"Ocupação (%)","v":"77.6%","t":"+14.3%","d":"up"},{"l":"Guest Satisfaction","v":"8.981","t":"-1.8%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","3.863","2026-03-18","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.445","2026-02-04","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.606","2026-03-23","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.687","2026-03-04","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.011","2026-01-03","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":743},{"label":"Fev","value":824},{"label":"Mar","value":687},{"label":"Abr","value":691},{"label":"Mai","value":968},{"label":"Jun","value":689},{"label":"Jul","value":888},{"label":"Ago","value":749},{"label":"Set","value":870},{"label":"Out","value":678},{"label":"Nov","value":844},{"label":"Dez","value":779}];
const MX = 968;
