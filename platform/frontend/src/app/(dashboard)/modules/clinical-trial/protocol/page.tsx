...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"2.033","t":"+6.1%","d":"up"},{"l":"Chamadas/Hora","v":"2302","t":"+4.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.6%","t":"+4.8%","d":"up"},{"l":"Latência Média (ms)","v":"147ms","t":"+15.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.614","8.576","75.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.517","4.081","71.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.971","4.865","87.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.549","4.379","90.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.031","8.874","88.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":554},{"label":"Mar","value":787},{"label":"Abr","value":639},{"label":"Mai","value":420},{"label":"Jun","value":794},{"label":"Jul","value":640},{"label":"Ago","value":555},{"label":"Set","value":481},{"label":"Out","value":782},{"label":"Nov","value":452},{"label":"Dez","value":743}];
const MX = 794;
