...
const PAGE = "Safety";
const KPIS = [{"l":"Total Clinical Trial","v":"858","t":"+6.3%","d":"up"},{"l":"Safety Ativos","v":"361","t":"+0.7%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"58","t":"+2.7%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trial #001","Clinical Trial #002","4.996","5.365","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trial #002","Clinical Trial #003","5.906","8.655","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trial #003","Clinical Trial #004","6.999","7.982","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trial #004","Clinical Trial #005","738","1.631","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trial #005","Clinical Trial #001","7.327","335","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":638},{"label":"Fev","value":831},{"label":"Mar","value":587},{"label":"Abr","value":736},{"label":"Mai","value":943},{"label":"Jun","value":809},{"label":"Jul","value":928},{"label":"Ago","value":570},{"label":"Set","value":914},{"label":"Out","value":729},{"label":"Nov","value":864},{"label":"Dez","value":590}];
const MX = 943;
