...
const PAGE = "Foster";
const KPIS = [{"l":"Total Animal Shelter","v":"8.118","t":"+17.4%","d":"up"},{"l":"Foster Ativos","v":"2.402","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"-0.6%","d":"down"},{"l":"Score Performance","v":"79","t":"+12.4%","d":"up"}];
const COLS = ["ID","Foster","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Shelter #001","Animal Shelter #002","4.229","5.744","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Shelter #002","Animal Shelter #003","1.435","1.997","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Shelter #003","Animal Shelter #004","8.971","1.421","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Shelter #004","Animal Shelter #005","9.019","2.435","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Shelter #005","Animal Shelter #001","7.697","7.966","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":758},{"label":"Fev","value":844},{"label":"Mar","value":803},{"label":"Abr","value":625},{"label":"Mai","value":706},{"label":"Jun","value":702},{"label":"Jul","value":563},{"label":"Ago","value":761},{"label":"Set","value":583},{"label":"Out","value":610},{"label":"Nov","value":605},{"label":"Dez","value":633}];
const MX = 844;
