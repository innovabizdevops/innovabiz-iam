...
const KPIS = [
    ...
    { label: "Ativos", value: "2912", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€12K", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "782161403", cells: ["ANI-8403", "Animal Shelter Item 1", "24/12/2026", "€11 503"], status: "active" as const },
    { id: "782164974", cells: ["ANI-2974", "Animal Shelter Item 2", "11/7/2026", "€15 074"], status: "pending" as const },
    { id: "782168545", cells: ["ANI-6545", "Animal Shelter Item 3", "26/2/2026", "€18 645"], status: "completed" as const },
    { id: "782172116", cells: ["ANI-1116", "Animal Shelter Item 4", "13/9/2026", "€22 216"], status: "warning" as const },
    { id: "782175687", cells: ["ANI-4687", "Animal Shelter Item 5", "28/4/2026", "€25 787"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Animal Shelter</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Animal Shelter</p>
                    </div>
                </div>
