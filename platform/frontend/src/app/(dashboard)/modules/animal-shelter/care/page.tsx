...
const PAGE = "Care";
const KPIS = [{"l":"Total Animal Shelter","v":"2.642","t":"+0.1%","d":"up"},{"l":"Care Ativos","v":"2.460","t":"+0.3%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"+6.1%","d":"up"},{"l":"Score Performance","v":"85","t":"-1.3%","d":"down"}];
const COLS = ["ID","Care","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Shelter #001","Animal Shelter #002","5.158","3.081","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Shelter #002","Animal Shelter #003","3.974","6.792","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Shelter #003","Animal Shelter #004","5.186","1.264","2026-01-18","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Shelter #004","Animal Shelter #005","3.526","769","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Shelter #005","Animal Shelter #001","5.640","4.099","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":970},{"label":"Fev","value":795},{"label":"Mar","value":846},{"label":"Abr","value":793},{"label":"Mai","value":792},{"label":"Jun","value":815},{"label":"Jul","value":827},{"label":"Ago","value":980},{"label":"Set","value":834},{"label":"Out","value":605},{"label":"Nov","value":730},{"label":"Dez","value":713}];
const MX = 980;
