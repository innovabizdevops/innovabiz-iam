...
const ACCENT = "#fdba74";
const MODULE = "Animal Shelter";
const PAGE = "Fundraise";
const KPIS = [{"l":"Total Animal Shelter","v":"8.240","t":"+4.3%","d":"up"},{"l":"Fundraise Ativos","v":"8.443","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"68.8%","t":"+8.1%","d":"up"},{"l":"Score Performance","v":"94","t":"-2.5%","d":"down"}];
const COLS = ["ID","Fundraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Shelter #001","Animal Shelter #002","2.827","7.248","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Shelter #002","Animal Shelter #003","1.101","3.888","2026-03-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Shelter #003","Animal Shelter #004","1.730","8.290","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Shelter #004","Animal Shelter #005","596","5.191","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Shelter #005","Animal Shelter #001","6.619","6.372","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":606},{"label":"Mar","value":477},{"label":"Abr","value":372},{"label":"Mai","value":553},{"label":"Jun","value":662},{"label":"Jul","value":378},{"label":"Ago","value":689},{"label":"Set","value":528},{"label":"Out","value":678},{"label":"Nov","value":408},{"label":"Dez","value":393}];
const MX = 700;
