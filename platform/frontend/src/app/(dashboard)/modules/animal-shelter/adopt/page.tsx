...
const PAGE = "Adopt";
const KPIS = [{"l":"Total Animal Shelter","v":"1.595","t":"-4.5%","d":"down"},{"l":"Adopt Ativos","v":"2.217","t":"+15.9%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"-4.1%","d":"down"},{"l":"Score Performance","v":"91","t":"+17.9%","d":"up"}];
const COLS = ["ID","Adopt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Animal Shelter #001","Animal Shelter #002","8.955","6.796","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Animal Shelter #002","Animal Shelter #003","1.346","5.173","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Animal Shelter #003","Animal Shelter #004","8.760","8.350","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Animal Shelter #004","Animal Shelter #005","645","5.364","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Animal Shelter #005","Animal Shelter #001","5.666","2.508","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":950},{"label":"Mar","value":798},{"label":"Abr","value":986},{"label":"Mai","value":917},{"label":"Jun","value":912},{"label":"Jul","value":814},{"label":"Ago","value":1052},{"label":"Set","value":824},{"label":"Out","value":884},{"label":"Nov","value":929},{"label":"Dez","value":788}];
const MX = 1052;
