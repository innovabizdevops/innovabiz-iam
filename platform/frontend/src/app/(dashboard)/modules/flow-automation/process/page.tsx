...
const ACCENT = "#00a1e0";
const MODULE = "Flow Automation Engine";
const PAGE = "Process";
const KPIS = [{"l":"Total Flow Automation","v":"5.971","t":"-0.2%","d":"down"},{"l":"Process Ativos","v":"3.906","t":"+2.6%","d":"up"},{"l":"Eficiência (%)","v":"77.1%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"71","t":"-4.4%","d":"down"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Flow Automation #001","Flow Automation #002","2.323","7.981","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["Flow Automation #002","Flow Automation #003","6.604","1.809","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Flow Automation #003","Flow Automation #004","1.355","6.232","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["Flow Automation #004","Flow Automation #005","2.094","8.538","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Flow Automation #005","Flow Automation #001","6.685","398","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":543},{"label":"Fev","value":511},{"label":"Mar","value":398},{"label":"Abr","value":719},{"label":"Mai","value":530},{"label":"Jun","value":707},{"label":"Jul","value":706},{"label":"Ago","value":460},{"label":"Set","value":373},{"label":"Out","value":730},{"label":"Nov","value":403},{"label":"Dez","value":697}];
const MX = 730;
