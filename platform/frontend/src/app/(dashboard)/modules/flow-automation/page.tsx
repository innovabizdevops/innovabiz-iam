...
/* ═══ Flow Automation Engine — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "7113", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2265", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€339K", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1930764413", cells: ["FLO-4413", "Flow Automation Engine Item 1", "26/6/2026", "€14 513"], status: "active" as const },
    { id: "1930767984", cells: ["FLO-7984", "Flow Automation Engine Item 2", "13/1/2026", "€18 084"], status: "pending" as const },
    { id: "1930771555", cells: ["FLO-2555", "Flow Automation Engine Item 3", "28/8/2026", "€21 655"], status: "completed" as const },
    { id: "1930775126", cells: ["FLO-6126", "Flow Automation Engine Item 4", "15/3/2026", "€25 226"], status: "warning" as const },
    { id: "1930778697", cells: ["FLO-9697", "Flow Automation Engine Item 5", "2/10/2026", "€28 797"], status: "active" as const },
];
...
export default function FlowAutomationEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Flow Automation Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Flow Automation Engine</p>
                    </div>
                </div>
