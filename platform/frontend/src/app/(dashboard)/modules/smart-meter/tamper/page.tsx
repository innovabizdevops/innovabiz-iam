...
const PAGE = "Tamper Detect";
const KPIS = [{"l":"Total Smart Meter","v":"284","t":"+3.7%","d":"up"},{"l":"Tamper Detect Ativos","v":"326","t":"+12.8%","d":"up"},{"l":"Eficiência (%)","v":"77.4%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"94","t":"+11.4%","d":"up"}];
const COLS = ["ID","Tamper Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Smart Meter #001","Smart Meter #002","3.925","1.279","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Smart Meter #002","Smart Meter #003","7.320","7.184","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Meter #003","Smart Meter #004","3.818","4.833","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Smart Meter #004","Smart Meter #005","4.717","5.829","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Smart Meter #005","Smart Meter #001","8.023","5.553","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":394},{"label":"Mar","value":222},{"label":"Abr","value":416},{"label":"Mai","value":218},{"label":"Jun","value":580},{"label":"Jul","value":460},{"label":"Ago","value":561},{"label":"Set","value":389},{"label":"Out","value":276},{"label":"Nov","value":310},{"label":"Dez","value":475}];
const MX = 580;
