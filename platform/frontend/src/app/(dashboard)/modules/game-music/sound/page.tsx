...
const ACCENT = "#7c3aed";
const MODULE = "Game Music & Audio";
const PAGE = "Sound Design";
const KPIS = [{"l":"Formulários Ativos","v":"1.237","t":"-4.7%","d":"down"},{"l":"Submissões/Dia","v":"1749","t":"-0.9%","d":"down"},{"l":"Documentos Gerados","v":"6.747","t":"+7.9%","d":"up"},{"l":"Templates","v":"4.456","t":"+15.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.950","2026-03-20","8.967","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.556","2026-03-17","6.957","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.428","2026-01-07","6.037","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.034","2026-01-22","4.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","341","2026-02-01","5.743","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":982},{"label":"Fev","value":861},{"label":"Mar","value":714},{"label":"Abr","value":916},{"label":"Mai","value":736},{"label":"Jun","value":1008},{"label":"Jul","value":912},{"label":"Ago","value":718},{"label":"Set","value":874},{"label":"Out","value":842},{"label":"Nov","value":771},{"label":"Dez","value":941}];
const MX = 1008;
