...
const ACCENT = "#6366f1";
const MODULE = "Cargo Shipping";
const PAGE = "Bill of Lading";
const KPIS = [{"l":"Total Cargo Ship","v":"4.590","t":"+15.0%","d":"up"},{"l":"Bill Of Lading Ativos","v":"5.171","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"85","t":"-5.3%","d":"down"}];
const COLS = ["ID","Bill Of Lading","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Ship #001","Cargo Ship #002","5.508","8.531","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Ship #002","Cargo Ship #003","2.675","3.232","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Ship #003","Cargo Ship #004","3.739","3.893","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Ship #004","Cargo Ship #005","1.189","2.192","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Ship #005","Cargo Ship #001","5.926","3.169","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":694},{"label":"Fev","value":395},{"label":"Mar","value":685},{"label":"Abr","value":704},{"label":"Mai","value":614},{"label":"Jun","value":705},{"label":"Jul","value":489},{"label":"Ago","value":527},{"label":"Set","value":445},{"label":"Out","value":637},{"label":"Nov","value":614},{"label":"Dez","value":559}];
const MX = 705;
