...
const KPIS = [{"l":"Total Cargo Ship","v":"914","t":"+4.1%","d":"up"},{"l":"Container Ativos","v":"8.193","t":"+9.1%","d":"up"},{"l":"Eficiência (%)","v":"72.3%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+14.7%","d":"up"}];
const COLS = ["ID","Container","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Ship #001","Cargo Ship #002","2.813","4.537","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Ship #002","Cargo Ship #003","5.555","6.083","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Ship #003","Cargo Ship #004","481","8.350","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Ship #004","Cargo Ship #005","1.376","3.570","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Ship #005","Cargo Ship #001","4.589","3.521","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":696},{"label":"Mar","value":513},{"label":"Abr","value":684},{"label":"Mai","value":637},{"label":"Jun","value":871},{"label":"Jul","value":738},{"label":"Ago","value":696},{"label":"Set","value":699},{"label":"Out","value":768},{"label":"Nov","value":849},{"label":"Dez","value":662}];
const MX = 871;
