...
const PAGE = "Customs";
const KPIS = [{"l":"Total Cargo Ship","v":"4.535","t":"+13.1%","d":"up"},{"l":"Customs Ativos","v":"€19925","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"73.4%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+8.1%","d":"up"}];
const COLS = ["ID","Customs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cargo Ship #001","€ 3449.12","5.286","1.166","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Cargo Ship #002","€ 45808.72","1.871","4.112","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cargo Ship #003","€ 43044.32","2.731","2.144","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Cargo Ship #004","€ 29226.38","4.683","4.662","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cargo Ship #005","€ 4370.36","6.359","1.666","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":617},{"label":"Mar","value":874},{"label":"Abr","value":635},{"label":"Mai","value":614},{"label":"Jun","value":630},{"label":"Jul","value":552},{"label":"Ago","value":779},{"label":"Set","value":603},{"label":"Out","value":645},{"label":"Nov","value":642},{"label":"Dez","value":874}];
const MX = 874;
