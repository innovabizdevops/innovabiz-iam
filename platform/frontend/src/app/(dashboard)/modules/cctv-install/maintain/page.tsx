...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Cctv Install","v":"6.878","t":"+14.7%","d":"up"},{"l":"Maintain Ativos","v":"6.034","t":"+2.0%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"-3.7%","d":"down"},{"l":"Score Performance","v":"80","t":"-5.0%","d":"down"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cctv Install #001","Cctv Install #002","8.596","436","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Cctv Install #002","Cctv Install #003","6.473","5.756","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Cctv Install #003","Cctv Install #004","5.411","281","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Cctv Install #004","Cctv Install #005","6.473","8.039","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cctv Install #005","Cctv Install #001","2.845","8.960","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":760},{"label":"Mar","value":892},{"label":"Abr","value":927},{"label":"Mai","value":820},{"label":"Jun","value":945},{"label":"Jul","value":734},{"label":"Ago","value":956},{"label":"Set","value":750},{"label":"Out","value":871},{"label":"Nov","value":818},{"label":"Dez","value":829}];
const MX = 956;
