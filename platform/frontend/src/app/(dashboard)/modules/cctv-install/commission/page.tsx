...
const KPIS = [{"l":"Vendas YTD (€)","v":"€24602","t":"+3.1%","d":"up"},{"l":"Pipeline (€)","v":"€44965","t":"+14.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"89.6%","t":"-4.9%","d":"down"},{"l":"Win Rate (%)","v":"81.0%","t":"+12.4%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 6938.26","€ 8784.34","€ 33934.18","88.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 25084.37","€ 48489.67","€ 22300.61","96.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 11218.89","€ 338.02","€ 17702.72","86.3%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 32611.38","€ 7118.51","€ 46139.93","83.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 42420.10","€ 32073.20","€ 4188.35","87.2%"],"status":"active"}];
const CHART = [{"label":"Jan","value":443},{"label":"Fev","value":537},{"label":"Mar","value":458},{"label":"Abr","value":745},{"label":"Mai","value":570},{"label":"Jun","value":379},{"label":"Jul","value":640},{"label":"Ago","value":395},{"label":"Set","value":696},{"label":"Out","value":396},{"label":"Nov","value":509},{"label":"Dez","value":543}];
const MX = 745;
