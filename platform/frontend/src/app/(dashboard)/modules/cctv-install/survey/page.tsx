...
const PAGE = "Survey";
const KPIS = [{"l":"Surveys Ativos","v":"8.097","t":"+17.8%","d":"up"},{"l":"Respostas/Semana","v":"2173","t":"-5.6%","d":"down"},{"l":"NPS Médio","v":"71","t":"+15.8%","d":"up"},{"l":"Taxa Resposta (%)","v":"74.0%","t":"-4.2%","d":"down"}];
const COLS = ["Survey","Tipo","Respostas","NPS","Taxa (%)","Estado"];
const ROWS = [{"id":"r0","cells":["Satisfação Cliente Q1","eNPS Colaboradores","3.843","80","97.3%","Ativo"],"status":"active"},{"id":"r1","cells":["eNPS Colaboradores","Produto Feedback","7.534","59","70.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Produto Feedback","Evento Post-Survey","6.360","87","91.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Evento Post-Survey","Onboarding Survey","3.793","63","79.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Onboarding Survey","Satisfação Cliente Q1","4.626","61","77.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":782},{"label":"Mar","value":571},{"label":"Abr","value":704},{"label":"Mai","value":509},{"label":"Jun","value":586},{"label":"Jul","value":821},{"label":"Ago","value":607},{"label":"Set","value":806},{"label":"Out","value":562},{"label":"Nov","value":759},{"label":"Dez","value":735}];
const MX = 821;
