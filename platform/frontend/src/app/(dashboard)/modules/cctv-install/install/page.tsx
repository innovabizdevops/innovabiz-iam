...
const PAGE = "Install";
const KPIS = [{"l":"Total Cctv Install","v":"1.703","t":"+6.1%","d":"up"},{"l":"Install Ativos","v":"4.027","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"93","t":"+9.1%","d":"up"}];
const COLS = ["ID","Install","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cctv Install #001","Cctv Install #002","7.307","6.052","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Cctv Install #002","Cctv Install #003","7.740","1.245","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cctv Install #003","Cctv Install #004","5.142","6.879","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cctv Install #004","Cctv Install #005","7.014","1.070","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cctv Install #005","Cctv Install #001","4.590","3.185","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":549},{"label":"Mar","value":456},{"label":"Abr","value":658},{"label":"Mai","value":402},{"label":"Jun","value":344},{"label":"Jul","value":423},{"label":"Ago","value":602},{"label":"Set","value":532},{"label":"Out","value":646},{"label":"Nov","value":536},{"label":"Dez","value":588}];
const MX = 658;
