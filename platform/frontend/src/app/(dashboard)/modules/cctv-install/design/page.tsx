...
const ACCENT = "#475569";
const MODULE = "CCTV Installation";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.697","t":"+2.6%","d":"up"},{"l":"Submissões/Dia","v":"4082","t":"+15.1%","d":"up"},{"l":"Documentos Gerados","v":"5.569","t":"+4.7%","d":"up"},{"l":"Templates","v":"482","t":"+3.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.083","2026-02-03","5.891","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.710","2026-03-04","4.049","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.576","2026-01-04","4.501","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.214","2026-01-02","4.612","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.078","2026-02-24","6.581","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":268},{"label":"Fev","value":470},{"label":"Mar","value":288},{"label":"Abr","value":379},{"label":"Mai","value":604},{"label":"Jun","value":432},{"label":"Jul","value":348},{"label":"Ago","value":460},{"label":"Set","value":523},{"label":"Out","value":489},{"label":"Nov","value":374},{"label":"Dez","value":228}];
const MX = 604;
