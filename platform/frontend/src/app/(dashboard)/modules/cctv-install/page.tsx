...
/* ═══ CCTV Installation — Dashboard ═══ */

const ACCENT = "#475569";

const KPIS = [
    { label: "Total Registos", value: "6541", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2012", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€122K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "74%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2050811241", cells: ["CCT-9241", "CCTV Installation Item 1", "18/10/2026", "€11 341"], status: "active" as const },
    { id: "2050814812", cells: ["CCT-3812", "CCTV Installation Item 2", "5/5/2026", "€14 912"], status: "pending" as const },
    { id: "2050818383", cells: ["CCT-7383", "CCTV Installation Item 3", "20/12/2026", "€18 483"], status: "completed" as const },
    { id: "2050821954", cells: ["CCT-1954", "CCTV Installation Item 4", "7/7/2026", "€22 054"], status: "warning" as const },
    { id: "2050825525", cells: ["CCT-5525", "CCTV Installation Item 5", "22/2/2026", "€25 625"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">CCTV Installation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • CCTV Installation</p>
                    </div>
                </div>
