...
const KPIS = [{"l":"Total Endpoint Security","v":"4.226","t":"+9.7%","d":"up"},{"l":"Investigate Ativos","v":"2.338","t":"+4.1%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"80","t":"+7.4%","d":"up"}];
const COLS = ["ID","Investigate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endpoint Security #001","Endpoint Security #002","6.485","344","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Endpoint Security #002","Endpoint Security #003","2.717","804","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Endpoint Security #003","Endpoint Security #004","342","5.406","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Endpoint Security #004","Endpoint Security #005","789","864","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endpoint Security #005","Endpoint Security #001","6.230","3.527","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":519},{"label":"Mar","value":367},{"label":"Abr","value":295},{"label":"Mai","value":604},{"label":"Jun","value":585},{"label":"Jul","value":318},{"label":"Ago","value":294},{"label":"Set","value":572},{"label":"Out","value":285},{"label":"Nov","value":608},{"label":"Dez","value":587}];
const MX = 608;
