...
const PAGE = "Hunt";
const KPIS = [{"l":"Total Endpoint Security","v":"6.654","t":"-0.3%","d":"down"},{"l":"Hunt Ativos","v":"4.187","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"71.6%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"83","t":"-4.1%","d":"down"}];
const COLS = ["ID","Hunt","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endpoint Security #001","Endpoint Security #002","2.832","5.304","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Endpoint Security #002","Endpoint Security #003","7.231","8.374","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Endpoint Security #003","Endpoint Security #004","2.842","6.566","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Endpoint Security #004","Endpoint Security #005","696","734","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endpoint Security #005","Endpoint Security #001","2.746","3.579","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":425},{"label":"Mar","value":705},{"label":"Abr","value":651},{"label":"Mai","value":483},{"label":"Jun","value":548},{"label":"Jul","value":513},{"label":"Ago","value":422},{"label":"Set","value":544},{"label":"Out","value":568},{"label":"Nov","value":711},{"label":"Dez","value":565}];
const MX = 711;
