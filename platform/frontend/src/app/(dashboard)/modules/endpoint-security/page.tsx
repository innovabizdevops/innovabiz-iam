...
const KPIS = [
    { label: "Total Registos", value: "5023", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1127", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€131K", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "109251423", cells: ["END-1423", "Endpoint Security (EDR) Item 1", "16/4/2026", "€1523"], status: "active" as const },
    { id: "109254994", cells: ["END-4994", "Endpoint Security (EDR) Item 2", "3/11/2026", "€5094"], status: "pending" as const },
    { id: "109258565", cells: ["END-8565", "Endpoint Security (EDR) Item 3", "18/6/2026", "€8665"], status: "completed" as const },
    { id: "109262136", cells: ["END-3136", "Endpoint Security (EDR) Item 4", "5/1/2026", "€12 236"], status: "warning" as const },
    { id: "109265707", cells: ["END-6707", "Endpoint Security (EDR) Item 5", "20/8/2026", "€15 807"], status: "active" as const },
];
...
export default function EndpointSecurityEdrPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Endpoint Security (EDR)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Endpoint Security (EDR)</p>
                    </div>
                </div>
