...
const ACCENT = "#dc2626";
const MODULE = "Endpoint Security (EDR)";
const PAGE = "Detect";
const KPIS = [{"l":"Total Endpoint Security","v":"4.462","t":"-2.3%","d":"down"},{"l":"Detect Ativos","v":"8.826","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"76.2%","t":"+0.6%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.5%","d":"up"}];
const COLS = ["ID","Detect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Endpoint Security #001","Endpoint Security #002","5.229","7.741","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Endpoint Security #002","Endpoint Security #003","5.991","4.091","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Endpoint Security #003","Endpoint Security #004","5.552","9.032","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Endpoint Security #004","Endpoint Security #005","8.477","5.104","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Endpoint Security #005","Endpoint Security #001","4.229","1.779","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":831},{"label":"Mar","value":876},{"label":"Abr","value":737},{"label":"Mai","value":757},{"label":"Jun","value":987},{"label":"Jul","value":843},{"label":"Ago","value":777},{"label":"Set","value":883},{"label":"Out","value":801},{"label":"Nov","value":996},{"label":"Dez","value":697}];
const MX = 996;
