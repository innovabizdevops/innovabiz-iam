...
const ACCENT = "#4338ca";
const MODULE = "Graph Analytics";
const PAGE = "Anomaly";
const KPIS = [{"l":"Dashboards Ativos","v":"6.128","t":"-2.5%","d":"down"},{"l":"Queries/Dia","v":"4806","t":"-2.3%","d":"down"},{"l":"Dados Processados (GB)","v":"5.679","t":"+13.4%","d":"up"},{"l":"Utilizadores Analytics","v":"2.625","t":"+7.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1273","2026-03-22","7.601","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2136","2026-01-22","7.881","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2919","2026-03-22","5.854","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2987","2026-03-12","5.881","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","337","2026-02-02","1.795","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":606},{"label":"Mar","value":659},{"label":"Abr","value":548},{"label":"Mai","value":671},{"label":"Jun","value":499},{"label":"Jul","value":556},{"label":"Ago","value":430},{"label":"Set","value":558},{"label":"Out","value":495},{"label":"Nov","value":669},{"label":"Dez","value":430}];
const MX = 671;
