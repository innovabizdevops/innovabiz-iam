...
const PAGE = "Path";
const KPIS = [{"l":"Dashboards Ativos","v":"6.487","t":"+11.3%","d":"up"},{"l":"Queries/Dia","v":"4036","t":"+6.0%","d":"up"},{"l":"Dados Processados (GB)","v":"4.915","t":"+11.8%","d":"up"},{"l":"Utilizadores Analytics","v":"6.391","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2085","2026-03-12","6.407","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","364","2026-03-24","7.319","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2207","2026-02-26","5.701","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4640","2026-03-13","1.780","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3150","2026-03-09","7.371","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":677},{"label":"Mar","value":781},{"label":"Abr","value":618},{"label":"Mai","value":638},{"label":"Jun","value":686},{"label":"Jul","value":812},{"label":"Ago","value":652},{"label":"Set","value":608},{"label":"Out","value":773},{"label":"Nov","value":774},{"label":"Dez","value":643}];
const MX = 829;
