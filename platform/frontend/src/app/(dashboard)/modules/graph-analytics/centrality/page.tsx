...
const PAGE = "Centrality";
const KPIS = [{"l":"Dashboards Ativos","v":"5.469","t":"+13.4%","d":"up"},{"l":"Queries/Dia","v":"4930","t":"-4.1%","d":"down"},{"l":"Dados Processados (GB)","v":"8.026","t":"+13.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.566","t":"+10.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4608","2026-02-07","6.152","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4169","2026-01-03","1.677","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3996","2026-02-20","1.995","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1879","2026-01-28","7.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5070","2026-03-27","4.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":498},{"label":"Fev","value":578},{"label":"Mar","value":812},{"label":"Abr","value":826},{"label":"Mai","value":823},{"label":"Jun","value":700},{"label":"Jul","value":471},{"label":"Ago","value":544},{"label":"Set","value":610},{"label":"Out","value":735},{"label":"Nov","value":861},{"label":"Dez","value":471}];
const MX = 861;
...
export default function CentralityPage() {
    return (
