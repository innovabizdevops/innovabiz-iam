...
const KPIS = [
    { label: "Total Registos", value: "3586", trend: "-12%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1722", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€324K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "87%", trend: "-19%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "26208786", cells: ["GRA-1786", "Graph Analytics Item 1", "3/7/2026", "€8886"], status: "active" as const },
    { id: "26212357", cells: ["GRA-5357", "Graph Analytics Item 2", "18/2/2026", "€12 457"], status: "pending" as const },
    { id: "26215928", cells: ["GRA-8928", "Graph Analytics Item 3", "5/9/2026", "€16 028"], status: "completed" as const },
    { id: "26219499", cells: ["GRA-3499", "Graph Analytics Item 4", "20/4/2026", "€19 599"], status: "warning" as const },
    { id: "26223070", cells: ["GRA-7070", "Graph Analytics Item 5", "7/11/2026", "€23 170"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Graph Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Graph Analytics</p>
                    </div>
                </div>
