...
const PAGE = "Network";
const KPIS = [{"l":"Dashboards Ativos","v":"8.270","t":"+15.0%","d":"up"},{"l":"Queries/Dia","v":"2689","t":"+4.4%","d":"up"},{"l":"Dados Processados (GB)","v":"1.534","t":"+0.7%","d":"up"},{"l":"Utilizadores Analytics","v":"9.031","t":"-3.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1853","2026-03-27","2.503","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","886","2026-02-10","5.000","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1581","2026-03-22","7.601","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2108","2026-03-21","1.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1405","2026-01-13","8.959","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":344},{"label":"Mar","value":340},{"label":"Abr","value":626},{"label":"Mai","value":588},{"label":"Jun","value":629},{"label":"Jul","value":402},{"label":"Ago","value":530},{"label":"Set","value":419},{"label":"Out","value":394},{"label":"Nov","value":356},{"label":"Dez","value":554}];
const MX = 629;
