...
const KPIS = [{"l":"Dashboards Ativos","v":"1.414","t":"+17.7%","d":"up"},{"l":"Queries/Dia","v":"640","t":"+8.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.138","t":"+10.8%","d":"up"},{"l":"Utilizadores Analytics","v":"7.663","t":"-2.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1475","2026-01-15","8.894","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3339","2026-01-13","8.200","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1685","2026-01-18","3.365","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","543","2026-01-06","2.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","5077","2026-02-11","7.231","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":733},{"label":"Fev","value":726},{"label":"Mar","value":725},{"label":"Abr","value":649},{"label":"Mai","value":685},{"label":"Jun","value":980},{"label":"Jul","value":651},{"label":"Ago","value":671},{"label":"Set","value":586},{"label":"Out","value":603},{"label":"Nov","value":725},{"label":"Dez","value":705}];
const MX = 980;
