...
const PAGE = "Contact Trace";
const KPIS = [{"l":"Total Public Health","v":"1.145","t":"+6.8%","d":"up"},{"l":"Contact Trace Ativos","v":"8.337","t":"+8.6%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"-1.0%","d":"down"},{"l":"Score Performance","v":"77","t":"-4.1%","d":"down"}];
const COLS = ["ID","Contact Trace","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health #001","Public Health #002","8.470","7.443","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health #002","Public Health #003","9.073","6.863","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health #003","Public Health #004","4.526","4.702","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health #004","Public Health #005","4.793","6.691","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health #005","Public Health #001","5.274","1.859","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":329},{"label":"Mar","value":436},{"label":"Abr","value":358},{"label":"Mai","value":392},{"label":"Jun","value":475},{"label":"Jul","value":447},{"label":"Ago","value":641},{"label":"Set","value":442},{"label":"Out","value":566},{"label":"Nov","value":517},{"label":"Dez","value":351}];
const MX = 641;
