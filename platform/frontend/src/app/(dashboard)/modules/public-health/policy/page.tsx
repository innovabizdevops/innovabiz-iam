...
const PAGE = "Health Policy";
const KPIS = [{"l":"Total Public Health","v":"2.484","t":"+12.4%","d":"up"},{"l":"Health Policy Ativos","v":"638","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"78.5%","t":"+17.1%","d":"up"},{"l":"Score Performance","v":"81","t":"-3.2%","d":"down"}];
const COLS = ["ID","Health Policy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Public Health #001","Public Health #002","5.963","6.802","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Public Health #002","Public Health #003","5.299","3.661","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Public Health #003","Public Health #004","3.227","3.914","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Public Health #004","Public Health #005","6.032","1.773","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Public Health #005","Public Health #001","5.041","4.946","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":982},{"label":"Mar","value":683},{"label":"Abr","value":901},{"label":"Mai","value":854},{"label":"Jun","value":888},{"label":"Jul","value":1025},{"label":"Ago","value":965},{"label":"Set","value":859},{"label":"Out","value":827},{"label":"Nov","value":652},{"label":"Dez","value":668}];
const MX = 1025;
