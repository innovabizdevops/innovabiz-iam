...
/* ═══ OMNI Composable Experience — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "6287", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "77", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€262K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "72%", trend: "+20%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "61900987", cells: ["OMN-8987", "OMNI Composable Experience Item 1", "16/8/2026", "€1087"], status: "active" as const },
    { id: "61904558", cells: ["OMN-3558", "OMNI Composable Experience Item 2", "3/3/2026", "€4658"], status: "pending" as const },
    { id: "61908129", cells: ["OMN-7129", "OMNI Composable Experience Item 3", "18/10/2026", "€8229"], status: "completed" as const },
    { id: "61911700", cells: ["OMN-1700", "OMNI Composable Experience Item 4", "5/5/2026", "€11 800"], status: "warning" as const },
    { id: "61915271", cells: ["OMN-5271", "OMNI Composable Experience Item 5", "20/12/2026", "€15 371"], status: "active" as const },
];
...
export default function OmniComposableExperiencePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Composable Experience</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Composable Experience</p>
                    </div>
                </div>
