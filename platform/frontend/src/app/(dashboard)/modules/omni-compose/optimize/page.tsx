...
const ACCENT = "#2563eb";
const MODULE = "OMNI Composable Experience";
const PAGE = "Optimize";
const KPIS = [{"l":"Pedidos/Dia","v":"2452","t":"+1.3%","d":"up"},{"l":"GMV (€)","v":"€16154","t":"+13.6%","d":"up"},{"l":"Conversão (%)","v":"83.9%","t":"-2.2%","d":"down"},{"l":"AOV (€)","v":"€35704","t":"+5.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 49880.71","4.973","1.995","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 22994.80","2.732","8.550","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 29355.59","5.750","1.902","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 46550.57","8.808","5.744","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 9379.09","164","8.503","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":898},{"label":"Mar","value":672},{"label":"Abr","value":682},{"label":"Mai","value":969},{"label":"Jun","value":781},{"label":"Jul","value":713},{"label":"Ago","value":632},{"label":"Set","value":845},{"label":"Out","value":747},{"label":"Nov","value":899},{"label":"Dez","value":830}];
const MX = 969;
