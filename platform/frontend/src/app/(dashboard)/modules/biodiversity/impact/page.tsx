...
const PAGE = "Impact";
const KPIS = [{"l":"Projetos Sociais","v":"6.195","t":"-5.1%","d":"down"},{"l":"Beneficiários","v":"3.640","t":"+6.9%","d":"up"},{"l":"Investimento CSR (€)","v":"€72941","t":"+5.8%","d":"up"},{"l":"Score Impacto","v":"89","t":"+11.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","5.585","€ 4838.27","3.659","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","6.792","€ 34348.38","2.749","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.865","€ 44859.69","3.037","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.590","€ 9860.28","6.426","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","868","€ 45830.29","6.761","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":576},{"label":"Fev","value":443},{"label":"Mar","value":365},{"label":"Abr","value":642},{"label":"Mai","value":615},{"label":"Jun","value":369},{"label":"Jul","value":580},{"label":"Ago","value":667},{"label":"Set","value":465},{"label":"Out","value":381},{"label":"Nov","value":391},{"label":"Dez","value":633}];
const MX = 667;
