...
/* ═══ Biodiversity Management — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "8592", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4770", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€227K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1863792392", cells: ["BIO-1392", "Biodiversity Management Item 1", "1/9/2026", "€42 492"], status: "active" as const },
    { id: "1863795963", cells: ["BIO-4963", "Biodiversity Management Item 2", "16/4/2026", "€46 063"], status: "pending" as const },
    { id: "1863799534", cells: ["BIO-8534", "Biodiversity Management Item 3", "3/11/2026", "€49 634"], status: "completed" as const },
    { id: "1863803105", cells: ["BIO-3105", "Biodiversity Management Item 4", "18/6/2026", "€3205"], status: "warning" as const },
    { id: "1863806676", cells: ["BIO-6676", "Biodiversity Management Item 5", "5/1/2026", "€6776"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biodiversity Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Biodiversity Management</p>
                    </div>
                </div>
