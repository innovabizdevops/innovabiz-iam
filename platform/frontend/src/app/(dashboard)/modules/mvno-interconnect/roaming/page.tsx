...
const PAGE = "Roaming";
const KPIS = [{"l":"Total Mvno Interconnect","v":"7.674","t":"+13.7%","d":"up"},{"l":"Roaming Ativos","v":"9.055","t":"+4.6%","d":"up"},{"l":"Eficiência (%)","v":"78.7%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"95","t":"+9.1%","d":"up"}];
const COLS = ["ID","Roaming","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Interconnect #001","Mvno Interconnect #002","1.683","8.802","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Interconnect #002","Mvno Interconnect #003","7.028","4.576","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Interconnect #003","Mvno Interconnect #004","3.616","6.610","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Interconnect #004","Mvno Interconnect #005","3.795","5.695","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Interconnect #005","Mvno Interconnect #001","2.113","5.497","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":628},{"label":"Mar","value":630},{"label":"Abr","value":691},{"label":"Mai","value":627},{"label":"Jun","value":508},{"label":"Jul","value":606},{"label":"Ago","value":676},{"label":"Set","value":507},{"label":"Out","value":427},{"label":"Nov","value":405},{"label":"Dez","value":704}];
const MX = 704;
