...
const KPIS = [{"l":"Total Mvno Interconnect","v":"1.983","t":"+12.1%","d":"up"},{"l":"Settlement Ativos","v":"3.933","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"69.8%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"93","t":"+3.0%","d":"up"}];
const COLS = ["ID","Settlement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Interconnect #001","Mvno Interconnect #002","2.076","808","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Interconnect #002","Mvno Interconnect #003","6.328","5.058","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Interconnect #003","Mvno Interconnect #004","7.534","6.948","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Interconnect #004","Mvno Interconnect #005","1.059","450","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Interconnect #005","Mvno Interconnect #001","2.862","8.220","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":312},{"label":"Mar","value":263},{"label":"Abr","value":244},{"label":"Mai","value":330},{"label":"Jun","value":337},{"label":"Jul","value":308},{"label":"Ago","value":317},{"label":"Set","value":234},{"label":"Out","value":487},{"label":"Nov","value":532},{"label":"Dez","value":527}];
const MX = 532;
