...
const ACCENT = "#6366f1";
const MODULE = "MVNO Interconnect";
const PAGE = "CDR Process";
const KPIS = [{"l":"Total Mvno Interconnect","v":"204","t":"+15.5%","d":"up"},{"l":"CDR Process Ativos","v":"7.293","t":"-2.8%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"72","t":"+17.6%","d":"up"}];
const COLS = ["ID","CDR Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Interconnect #001","Mvno Interconnect #002","7.309","1.282","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Interconnect #002","Mvno Interconnect #003","5.183","1.476","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Interconnect #003","Mvno Interconnect #004","5.939","7.649","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Interconnect #004","Mvno Interconnect #005","8.021","6.287","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Interconnect #005","Mvno Interconnect #001","4.766","5.797","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":772},{"label":"Mar","value":489},{"label":"Abr","value":538},{"label":"Mai","value":664},{"label":"Jun","value":540},{"label":"Jul","value":710},{"label":"Ago","value":559},{"label":"Set","value":759},{"label":"Out","value":804},{"label":"Nov","value":456},{"label":"Dez","value":568}];
const MX = 804;
