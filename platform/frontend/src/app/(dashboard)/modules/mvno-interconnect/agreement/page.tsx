...
const PAGE = "Agreement";
const KPIS = [{"l":"Total Mvno Interconnect","v":"406","t":"-4.5%","d":"down"},{"l":"Agreement Ativos","v":"4.936","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"77.1%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"76","t":"+10.3%","d":"up"}];
const COLS = ["ID","Agreement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Interconnect #001","Mvno Interconnect #002","6.448","2.746","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Interconnect #002","Mvno Interconnect #003","1.008","6.284","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Interconnect #003","Mvno Interconnect #004","1.700","3.796","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Interconnect #004","Mvno Interconnect #005","134","374","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Interconnect #005","Mvno Interconnect #001","7.113","3.316","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":643},{"label":"Mar","value":452},{"label":"Abr","value":290},{"label":"Mai","value":533},{"label":"Jun","value":317},{"label":"Jul","value":331},{"label":"Ago","value":302},{"label":"Set","value":619},{"label":"Out","value":522},{"label":"Nov","value":499},{"label":"Dez","value":404}];
const MX = 643;
