...
export default function MvnoInterconnectPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Mvno Interconnect</h1><p className="text-sm text-muted-foreground">Mvno Interconnect • iBOS Enterprise</p></div>
