...
const PAGE = "Dispute";
const KPIS = [{"l":"Total Mvno Interconnect","v":"4.029","t":"+14.8%","d":"up"},{"l":"Dispute Ativos","v":"7.847","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"79.9%","t":"+0.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+7.4%","d":"up"}];
const COLS = ["ID","Dispute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mvno Interconnect #001","Mvno Interconnect #002","8.471","8.162","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Mvno Interconnect #002","Mvno Interconnect #003","7.220","834","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Mvno Interconnect #003","Mvno Interconnect #004","1.440","5.793","2026-01-04","Concluído"],"status":"done"},{"id":"r3","cells":["Mvno Interconnect #004","Mvno Interconnect #005","3.192","8.443","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mvno Interconnect #005","Mvno Interconnect #001","4.673","4.328","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":733},{"label":"Mar","value":773},{"label":"Abr","value":850},{"label":"Mai","value":789},{"label":"Jun","value":735},{"label":"Jul","value":1057},{"label":"Ago","value":992},{"label":"Set","value":1088},{"label":"Out","value":822},{"label":"Nov","value":1077},{"label":"Dez","value":1073}];
const MX = 1088;
