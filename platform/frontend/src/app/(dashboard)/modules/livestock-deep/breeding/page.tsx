...
const ACCENT = "#fb923c";
const MODULE = "Livestock Deep";
const PAGE = "Breeding";
const KPIS = [{"l":"Integrações Ativas","v":"5.170","t":"-4.3%","d":"down"},{"l":"Chamadas/Hora","v":"3357","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"86.6%","t":"+2.6%","d":"up"},{"l":"Latência Média (ms)","v":"130ms","t":"-4.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.557","271","74.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.765","6.291","87.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.783","2.565","86.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.335","2.109","72.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.392","6.275","92.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":709},{"label":"Mar","value":852},{"label":"Abr","value":795},{"label":"Mai","value":606},{"label":"Jun","value":819},{"label":"Jul","value":883},{"label":"Ago","value":665},{"label":"Set","value":672},{"label":"Out","value":768},{"label":"Nov","value":796},{"label":"Dez","value":626}];
const MX = 883;
