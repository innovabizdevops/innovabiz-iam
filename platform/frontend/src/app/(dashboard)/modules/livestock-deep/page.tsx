...
/* ═══ Livestock Deep — Dashboard ═══ */

const ACCENT = "#fb923c";

const KPIS = [
    { label: "Total Registos", value: "2278", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "179", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€180K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "599694678", cells: ["LIV-7678", "Livestock Deep Item 1", "3/7/2026", "€44 778"], status: "active" as const },
    { id: "599698249", cells: ["LIV-2249", "Livestock Deep Item 2", "18/2/2026", "€48 349"], status: "pending" as const },
    { id: "599701820", cells: ["LIV-5820", "Livestock Deep Item 3", "5/9/2026", "€1920"], status: "completed" as const },
    { id: "599705391", cells: ["LIV-9391", "Livestock Deep Item 4", "20/4/2026", "€5491"], status: "warning" as const },
    { id: "599708962", cells: ["LIV-3962", "Livestock Deep Item 5", "7/11/2026", "€9062"], status: "active" as const },
];
...
export default function LivestockDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Livestock Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Livestock Deep</p>
                    </div>
                </div>
