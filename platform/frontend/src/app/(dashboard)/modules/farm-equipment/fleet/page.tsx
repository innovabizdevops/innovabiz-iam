...
const ACCENT = "#6366f1";
const MODULE = "Farm Equipment";
const PAGE = "Fleet";
const KPIS = [{"l":"Total Farm Equipment","v":"8.728","t":"+6.2%","d":"up"},{"l":"Fleet Ativos","v":"8.928","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+8.6%","d":"up"},{"l":"Score Performance","v":"66","t":"+17.4%","d":"up"}];
const COLS = ["ID","Fleet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Equipment #001","Farm Equipment #002","3.221","238","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Equipment #002","Farm Equipment #003","4.895","3.913","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Equipment #003","Farm Equipment #004","3.600","6.895","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Equipment #004","Farm Equipment #005","1.954","3.310","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Equipment #005","Farm Equipment #001","4.718","7.463","2026-02-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":829},{"label":"Mar","value":983},{"label":"Abr","value":996},{"label":"Mai","value":674},{"label":"Jun","value":990},{"label":"Jul","value":905},{"label":"Ago","value":675},{"label":"Set","value":913},{"label":"Out","value":646},{"label":"Nov","value":908},{"label":"Dez","value":878}];
const MX = 996;
