...
const PAGE = "Rental";
const KPIS = [{"l":"Total Farm Equipment","v":"4.357","t":"-3.0%","d":"down"},{"l":"Rental Ativos","v":"774","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+5.5%","d":"up"},{"l":"Score Performance","v":"87","t":"-4.2%","d":"down"}];
const COLS = ["ID","Rental","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Farm Equipment #001","Farm Equipment #002","2.095","3.531","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Farm Equipment #002","Farm Equipment #003","5.265","6.101","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Farm Equipment #003","Farm Equipment #004","2.433","1.034","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Farm Equipment #004","Farm Equipment #005","7.353","2.047","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Farm Equipment #005","Farm Equipment #001","5.106","147","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":518},{"label":"Mar","value":574},{"label":"Abr","value":362},{"label":"Mai","value":396},{"label":"Jun","value":543},{"label":"Jul","value":549},{"label":"Ago","value":351},{"label":"Set","value":275},{"label":"Out","value":574},{"label":"Nov","value":322},{"label":"Dez","value":399}];
const MX = 574;
