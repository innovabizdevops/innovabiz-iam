...
const PAGE = "Human Eval";
const KPIS = [{"l":"Total Ai Evaluation","v":"6.145","t":"+1.3%","d":"up"},{"l":"Human Eval Ativos","v":"1.039","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"89.1%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"71","t":"-1.9%","d":"down"}];
const COLS = ["ID","Human Eval","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Evaluation #001","Ai Evaluation #002","1.718","7.818","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Evaluation #002","Ai Evaluation #003","5.115","7.202","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Evaluation #003","Ai Evaluation #004","4.538","8.472","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Evaluation #004","Ai Evaluation #005","2.348","6.708","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Evaluation #005","Ai Evaluation #001","4.274","3.869","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":1041},{"label":"Mar","value":796},{"label":"Abr","value":911},{"label":"Mai","value":685},{"label":"Jun","value":1064},{"label":"Jul","value":921},{"label":"Ago","value":1059},{"label":"Set","value":895},{"label":"Out","value":940},{"label":"Nov","value":668},{"label":"Dez","value":972}];
const MX = 1064;
