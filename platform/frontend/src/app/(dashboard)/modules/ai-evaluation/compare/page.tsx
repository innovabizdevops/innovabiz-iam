...
const PAGE = "Compare";
const KPIS = [{"l":"Total Ai Evaluation","v":"7.371","t":"+11.1%","d":"up"},{"l":"Compare Ativos","v":"4.136","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"89.2%","t":"+13.1%","d":"up"},{"l":"Score Performance","v":"60","t":"+11.3%","d":"up"}];
const COLS = ["ID","Compare","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Evaluation #001","Ai Evaluation #002","622","774","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Evaluation #002","Ai Evaluation #003","1.736","6.088","2026-01-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Evaluation #003","Ai Evaluation #004","7.006","8.406","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Evaluation #004","Ai Evaluation #005","8.717","2.109","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Evaluation #005","Ai Evaluation #001","1.631","4.454","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":405},{"label":"Fev","value":487},{"label":"Mar","value":647},{"label":"Abr","value":416},{"label":"Mai","value":651},{"label":"Jun","value":632},{"label":"Jul","value":653},{"label":"Ago","value":597},{"label":"Set","value":345},{"label":"Out","value":292},{"label":"Nov","value":326},{"label":"Dez","value":358}];
const MX = 653;
