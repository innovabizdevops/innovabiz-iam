...
const ACCENT = "#7c3aed";
const MODULE = "AI Evaluation Framework";
const PAGE = "Auto Eval";
const KPIS = [{"l":"Total Ai Evaluation","v":"2.443","t":"+11.3%","d":"up"},{"l":"Auto Eval Ativos","v":"232","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"75.2%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"61","t":"-2.4%","d":"down"}];
const COLS = ["ID","Auto Eval","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Evaluation #001","Ai Evaluation #002","9.081","8.815","2026-01-01","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Evaluation #002","Ai Evaluation #003","3.293","1.316","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Evaluation #003","Ai Evaluation #004","8.597","8.461","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Evaluation #004","Ai Evaluation #005","5.863","6.443","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Evaluation #005","Ai Evaluation #001","7.688","1.817","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":779},{"label":"Mar","value":706},{"label":"Abr","value":493},{"label":"Mai","value":619},{"label":"Jun","value":693},{"label":"Jul","value":483},{"label":"Ago","value":566},{"label":"Set","value":598},{"label":"Out","value":619},{"label":"Nov","value":659},{"label":"Dez","value":728}];
const MX = 779;
