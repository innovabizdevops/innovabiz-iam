...
const KPIS = [
    { label: "Total Registos", value: "6412", trend: "-13%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2346", trend: "+7%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€352K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "48833112", cells: ["AI-9112", "AI Evaluation Framework Item 1", "21/1/2026", "€33 212"], status: "active" as const },
    { id: "48836683", cells: ["AI-3683", "AI Evaluation Framework Item 2", "8/8/2026", "€36 783"], status: "pending" as const },
    { id: "48840254", cells: ["AI-7254", "AI Evaluation Framework Item 3", "23/3/2026", "€40 354"], status: "completed" as const },
    { id: "48843825", cells: ["AI-1825", "AI Evaluation Framework Item 4", "10/10/2026", "€43 925"], status: "warning" as const },
    { id: "48847396", cells: ["AI-5396", "AI Evaluation Framework Item 5", "25/5/2026", "€47 496"], status: "active" as const },
];
...
export default function AiEvaluationFrameworkPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Evaluation Framework</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Evaluation Framework</p>
                    </div>
                </div>
