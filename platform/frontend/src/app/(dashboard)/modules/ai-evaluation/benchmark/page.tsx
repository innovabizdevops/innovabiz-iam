...
const KPIS = [{"l":"Total Ai Evaluation","v":"2.888","t":"+15.9%","d":"up"},{"l":"Benchmark Ativos","v":"5.952","t":"+0.4%","d":"up"},{"l":"Eficiência (%)","v":"73.6%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.0%","d":"up"}];
const COLS = ["ID","Benchmark","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ai Evaluation #001","Ai Evaluation #002","3.268","2.961","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ai Evaluation #002","Ai Evaluation #003","2.551","5.940","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Ai Evaluation #003","Ai Evaluation #004","6.507","6.071","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Ai Evaluation #004","Ai Evaluation #005","2.857","7.836","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ai Evaluation #005","Ai Evaluation #001","4.166","8.015","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":594},{"label":"Fev","value":854},{"label":"Mar","value":851},{"label":"Abr","value":747},{"label":"Mai","value":632},{"label":"Jun","value":798},{"label":"Jul","value":836},{"label":"Ago","value":558},{"label":"Set","value":795},{"label":"Out","value":863},{"label":"Nov","value":896},{"label":"Dez","value":556}];
const MX = 896;
