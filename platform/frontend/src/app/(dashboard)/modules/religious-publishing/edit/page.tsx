...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"1.355","t":"+11.0%","d":"up"},{"l":"Chamadas/Hora","v":"3892","t":"+2.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.4%","t":"+11.3%","d":"up"},{"l":"Latência Média (ms)","v":"164ms","t":"+16.9%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.143","4.393","96.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.993","2.520","79.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","780","2.859","86.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","599","2.213","71.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.612","1.998","73.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":615},{"label":"Fev","value":773},{"label":"Mar","value":778},{"label":"Abr","value":586},{"label":"Mai","value":865},{"label":"Jun","value":862},{"label":"Jul","value":820},{"label":"Ago","value":875},{"label":"Set","value":914},{"label":"Out","value":677},{"label":"Nov","value":809},{"label":"Dez","value":686}];
const MX = 914;
