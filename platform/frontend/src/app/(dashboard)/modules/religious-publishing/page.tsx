...
/* ═══ Religious Publishing — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "3960", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2059", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "77%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "233802260", cells: ["REL-1260", "Religious Publishing Item 1", "21/9/2026", "€2360"], status: "active" as const },
    { id: "233805831", cells: ["REL-4831", "Religious Publishing Item 2", "8/4/2026", "€5931"], status: "pending" as const },
    { id: "233809402", cells: ["REL-8402", "Religious Publishing Item 3", "23/11/2026", "€9502"], status: "completed" as const },
    { id: "233812973", cells: ["REL-2973", "Religious Publishing Item 4", "10/6/2026", "€13 073"], status: "warning" as const },
    { id: "233816544", cells: ["REL-6544", "Religious Publishing Item 5", "25/1/2026", "€16 644"], status: "active" as const },
];
...
export default function ReligiousPublishingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Religious Publishing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Religious Publishing</p>
                    </div>
                </div>
