...
const ACCENT = "#5b21b6";
const MODULE = "Religious Publishing";
const PAGE = "Distribute";
const KPIS = [{"l":"Total Religious Publishing","v":"6.031","t":"-4.5%","d":"down"},{"l":"Distribute Ativos","v":"5.749","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"89.4%","t":"-1.2%","d":"down"},{"l":"Score Performance","v":"95","t":"+15.2%","d":"up"}];
const COLS = ["ID","Distribute","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Publishing #001","Religious Publishing #002","6.568","2.774","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Publishing #002","Religious Publishing #003","3.029","378","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Publishing #003","Religious Publishing #004","7.627","7.338","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Publishing #004","Religious Publishing #005","7.660","2.135","2026-02-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Publishing #005","Religious Publishing #001","1.514","2.930","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":828},{"label":"Fev","value":755},{"label":"Mar","value":703},{"label":"Abr","value":662},{"label":"Mai","value":699},{"label":"Jun","value":805},{"label":"Jul","value":942},{"label":"Ago","value":682},{"label":"Set","value":889},{"label":"Out","value":960},{"label":"Nov","value":1053},{"label":"Dez","value":1021}];
const MX = 1053;
