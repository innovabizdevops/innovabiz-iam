...
const PAGE = "Print";
const KPIS = [{"l":"Total Religious Publishing","v":"3.232","t":"+15.4%","d":"up"},{"l":"Print Ativos","v":"5.887","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"70.3%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"82","t":"-4.9%","d":"down"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Religious Publishing #001","Religious Publishing #002","8.642","6.177","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Religious Publishing #002","Religious Publishing #003","1.199","8.153","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Religious Publishing #003","Religious Publishing #004","7.704","4.890","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Religious Publishing #004","Religious Publishing #005","6.484","2.858","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Religious Publishing #005","Religious Publishing #001","3.216","5.448","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":843},{"label":"Mar","value":576},{"label":"Abr","value":611},{"label":"Mai","value":786},{"label":"Jun","value":595},{"label":"Jul","value":536},{"label":"Ago","value":591},{"label":"Set","value":579},{"label":"Out","value":622},{"label":"Nov","value":829},{"label":"Dez","value":704}];
const MX = 843;
