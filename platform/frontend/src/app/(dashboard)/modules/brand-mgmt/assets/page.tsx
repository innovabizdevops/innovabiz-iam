...
const ACCENT = "#0284c7";
const MODULE = "Brand Management";
const PAGE = "Asset Library";
const KPIS = [{"l":"Ativos Registados","v":"1.748","t":"+10.7%","d":"up"},{"l":"Valor Total (€M)","v":"€43.8M","t":"+1.8%","d":"up"},{"l":"Depreciação Anual (€)","v":"€62759","t":"+13.8%","d":"up"},{"l":"Ativos em Garantia","v":"7.113","t":"+4.6%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 29225.94","4.948","€ 32163.08","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 18573.59","738","€ 7160.10","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 7377.80","7.947","€ 7052.19","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 11493.08","8.775","€ 48689.17","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 5763.59","3.917","€ 13535.13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":422},{"label":"Mar","value":299},{"label":"Abr","value":594},{"label":"Mai","value":289},{"label":"Jun","value":465},{"label":"Jul","value":583},{"label":"Ago","value":592},{"label":"Set","value":331},{"label":"Out","value":389},{"label":"Nov","value":617},{"label":"Dez","value":444}];
const MX = 617;
