...
const KPIS = [{"l":"Artigos Publicados","v":"4.312","t":"+16.2%","d":"up"},{"l":"Views/Semana","v":"3573","t":"+10.7%","d":"up"},{"l":"Feedback Útil (%)","v":"81.1%","t":"-3.1%","d":"down"},{"l":"Artigos Desatualizados","v":"5.693","t":"+10.7%","d":"up"}];
const COLS = ["Artigo","Categoria","Views","Útil (%)","Autor","Estado"];
const ROWS = [{"id":"r0","cells":["Como Criar Utilizador","FAQ Integrações","3.034","91.7%","4.166","Ativo"],"status":"active"},{"id":"r1","cells":["FAQ Integrações","Guia API REST","5.665","74.2%","2.920","Pendente"],"status":"pending"},{"id":"r2","cells":["Guia API REST","Tutorial Dashboard","4.292","84.5%","5.469","Concluído"],"status":"done"},{"id":"r3","cells":["Tutorial Dashboard","Troubleshoot Login","2.132","70.1%","8.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["Troubleshoot Login","Como Criar Utilizador","2.455","72.2%","1.934","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":777},{"label":"Mar","value":456},{"label":"Abr","value":442},{"label":"Mai","value":824},{"label":"Jun","value":465},{"label":"Jul","value":776},{"label":"Ago","value":456},{"label":"Set","value":726},{"label":"Out","value":791},{"label":"Nov","value":489},{"label":"Dez","value":556}];
const MX = 824;
