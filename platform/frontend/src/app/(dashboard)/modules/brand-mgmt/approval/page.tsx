...
const PAGE = "Approval Flow";
const KPIS = [{"l":"Aprovações Pendentes","v":"4.852","t":"+15.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"91.4%","t":"-4.2%","d":"down"},{"l":"Tempo Médio (h)","v":"63h","t":"+4.7%","d":"up"},{"l":"Rejeitadas (%)","v":"77.9%","t":"+7.1%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.819","€ 18814.77","5.002","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.430","€ 26908.88","7.215","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","5.237","€ 46451.82","6.858","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.967","€ 33623.86","1.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","7.204","€ 14184.96","6.026","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":729},{"label":"Mar","value":753},{"label":"Abr","value":902},{"label":"Mai","value":831},{"label":"Jun","value":658},{"label":"Jul","value":855},{"label":"Ago","value":574},{"label":"Set","value":566},{"label":"Out","value":517},{"label":"Nov","value":542},{"label":"Dez","value":701}];
const MX = 902;
