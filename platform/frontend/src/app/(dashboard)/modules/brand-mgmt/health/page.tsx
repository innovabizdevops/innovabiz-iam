...
const PAGE = "Brand Health";
const KPIS = [{"l":"Total Brand Mgmt","v":"6.050","t":"+11.5%","d":"up"},{"l":"Brand Health Ativos","v":"1.161","t":"-0.7%","d":"down"},{"l":"Eficiência (%)","v":"84.8%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"88","t":"+11.4%","d":"up"}];
const COLS = ["ID","Brand Health","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brand Mgmt #001","Brand Mgmt #002","3.530","6.353","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Brand Mgmt #002","Brand Mgmt #003","5.110","7.445","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Brand Mgmt #003","Brand Mgmt #004","7.472","3.083","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Brand Mgmt #004","Brand Mgmt #005","4.026","1.204","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brand Mgmt #005","Brand Mgmt #001","7.377","4.741","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":388},{"label":"Fev","value":600},{"label":"Mar","value":577},{"label":"Abr","value":652},{"label":"Mai","value":446},{"label":"Jun","value":631},{"label":"Jul","value":749},{"label":"Ago","value":545},{"label":"Set","value":686},{"label":"Out","value":457},{"label":"Nov","value":586},{"label":"Dez","value":509}];
const MX = 749;
