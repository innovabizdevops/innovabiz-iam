...
const PAGE = "Membrane";
const KPIS = [{"l":"Total Water Treatment","v":"8.692","t":"+2.8%","d":"up"},{"l":"Membrane Ativos","v":"8.166","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"70","t":"+11.7%","d":"up"}];
const COLS = ["ID","Membrane","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Treatment #001","Water Treatment #002","2.088","2.494","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Water Treatment #002","Water Treatment #003","3.534","5.083","2026-01-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Treatment #003","Water Treatment #004","8.393","7.346","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Water Treatment #004","Water Treatment #005","1.836","3.599","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Treatment #005","Water Treatment #001","625","6.716","2026-03-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":288},{"label":"Fev","value":421},{"label":"Mar","value":342},{"label":"Abr","value":588},{"label":"Mai","value":530},{"label":"Jun","value":307},{"label":"Jul","value":579},{"label":"Ago","value":557},{"label":"Set","value":396},{"label":"Out","value":499},{"label":"Nov","value":416},{"label":"Dez","value":392}];
const MX = 588;
