...
const KPIS = [{"l":"Twins Ativos","v":"2.906","t":"+7.3%","d":"up"},{"l":"Simulações/Dia","v":"4209","t":"+7.3%","d":"up"},{"l":"Precisão Modelo (%)","v":"72.1%","t":"+0.0%","d":"up"},{"l":"Latência Sync (ms)","v":"16ms","t":"+9.4%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","75.8%","2026-02-16","7.584","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","77.3%","2026-01-15","7.310","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","89.3%","2026-01-14","842","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","95.4%","2026-01-11","1.835","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","87.9%","2026-02-14","1.693","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":751},{"label":"Fev","value":828},{"label":"Mar","value":977},{"label":"Abr","value":666},{"label":"Mai","value":981},{"label":"Jun","value":959},{"label":"Jul","value":745},{"label":"Ago","value":660},{"label":"Set","value":695},{"label":"Out","value":809},{"label":"Nov","value":706},{"label":"Dez","value":711}];
const MX = 981;
