...
const PAGE = "SCADA Integration";
const KPIS = [{"l":"Dispositivos Online","v":"3.080","t":"+4.1%","d":"up"},{"l":"Dados/Min (MB)","v":"9.032","t":"+1.3%","d":"up"},{"l":"Alertas Ativos","v":"5.521","t":"+11.8%","d":"up"},{"l":"Uptime (%)","v":"83.5%","t":"+4.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.892","8.278","2.035","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","2.590","900","8.028","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.197","3.233","8.161","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","7.936","5.460","2.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.061","1.326","8.016","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":715},{"label":"Fev","value":921},{"label":"Mar","value":974},{"label":"Abr","value":816},{"label":"Mai","value":738},{"label":"Jun","value":1059},{"label":"Jul","value":1061},{"label":"Ago","value":923},{"label":"Set","value":849},{"label":"Out","value":989},{"label":"Nov","value":767},{"label":"Dez","value":1058}];
const MX = 1061;
