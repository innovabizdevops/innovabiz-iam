...
const PAGE = "Chemical Dose";
const KPIS = [{"l":"Total Water Treatment","v":"2.613","t":"-1.0%","d":"down"},{"l":"Chemical Dose Ativos","v":"747","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"68","t":"+9.6%","d":"up"}];
const COLS = ["ID","Chemical Dose","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Water Treatment #001","Water Treatment #002","506","4.662","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Water Treatment #002","Water Treatment #003","3.796","2.689","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Water Treatment #003","Water Treatment #004","8.987","1.785","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["Water Treatment #004","Water Treatment #005","7.880","4.636","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Water Treatment #005","Water Treatment #001","1.784","1.324","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":834},{"label":"Mar","value":875},{"label":"Abr","value":782},{"label":"Mai","value":897},{"label":"Jun","value":826},{"label":"Jul","value":762},{"label":"Ago","value":753},{"label":"Set","value":584},{"label":"Out","value":726},{"label":"Nov","value":856},{"label":"Dez","value":807}];
const MX = 897;
