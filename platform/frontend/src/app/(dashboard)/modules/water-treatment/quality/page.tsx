...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.586","t":"+6.4%","d":"up"},{"l":"NC Abertas","v":"7.446","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"71.0%","t":"+9.9%","d":"up"},{"l":"CAPAs Pendentes","v":"5.023","t":"+2.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.576","95.1%","6.336","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.765","70.6%","8.455","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","120","99.9%","9.016","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.271","81.7%","1.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.799","73.9%","3.336","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":667},{"label":"Mar","value":431},{"label":"Abr","value":492},{"label":"Mai","value":531},{"label":"Jun","value":402},{"label":"Jul","value":598},{"label":"Ago","value":790},{"label":"Set","value":406},{"label":"Out","value":460},{"label":"Nov","value":785},{"label":"Dez","value":669}];
const MX = 790;
