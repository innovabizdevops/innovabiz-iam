...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€8.7M","t":"+16.6%","d":"up"},{"l":"MRR (€)","v":"€64308","t":"+9.9%","d":"up"},{"l":"Churn (%)","v":"69.1%","t":"-0.2%","d":"down"},{"l":"ARPU (€)","v":"€22376","t":"+6.1%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 44201.41","1.278","€ 43498.92","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 37133.64","5.253","€ 23086.15","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 25673.82","2.080","€ 15553.63","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7972.08","1.293","€ 38861.48","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 38825.78","9.084","€ 7528.24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":792},{"label":"Fev","value":810},{"label":"Mar","value":711},{"label":"Abr","value":691},{"label":"Mai","value":493},{"label":"Jun","value":587},{"label":"Jul","value":520},{"label":"Ago","value":487},{"label":"Set","value":577},{"label":"Out","value":628},{"label":"Nov","value":612},{"label":"Dez","value":688}];
const MX = 810;
