...
const KPIS = [{"l":"Atletas Registados","v":"8.243","t":"+5.4%","d":"up"},{"l":"Treinos/Semana","v":"3626","t":"+8.7%","d":"up"},{"l":"Competições","v":"2.068","t":"+1.9%","d":"up"},{"l":"Performance Score","v":"82","t":"-1.6%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.251","855","2.012","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.135","8.261","3.697","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.716","6.702","4.922","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","517","3.296","6.544","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.849","7.689","1.310","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":994},{"label":"Mar","value":1029},{"label":"Abr","value":840},{"label":"Mai","value":763},{"label":"Jun","value":883},{"label":"Jul","value":854},{"label":"Ago","value":794},{"label":"Set","value":809},{"label":"Out","value":684},{"label":"Nov","value":817},{"label":"Dez","value":1005}];
const MX = 1029;
