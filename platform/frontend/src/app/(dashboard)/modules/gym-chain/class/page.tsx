...
const PAGE = "Class";
const KPIS = [{"l":"Atletas Registados","v":"3.630","t":"+6.4%","d":"up"},{"l":"Treinos/Semana","v":"3328","t":"+7.8%","d":"up"},{"l":"Competições","v":"3.120","t":"-1.5%","d":"down"},{"l":"Performance Score","v":"57","t":"+3.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.874","467","7.066","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.219","7.033","1.232","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.024","8.758","4.184","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.229","8.993","3.097","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","6.700","4.615","5.704","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1080},{"label":"Fev","value":1016},{"label":"Mar","value":943},{"label":"Abr","value":810},{"label":"Mai","value":764},{"label":"Jun","value":796},{"label":"Jul","value":838},{"label":"Ago","value":835},{"label":"Set","value":866},{"label":"Out","value":918},{"label":"Nov","value":1037},{"label":"Dez","value":1085}];
const MX = 1085;
