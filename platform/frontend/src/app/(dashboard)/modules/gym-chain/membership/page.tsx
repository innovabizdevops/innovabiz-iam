...
const KPIS = [{"l":"Atletas Registados","v":"8.000","t":"-3.1%","d":"down"},{"l":"Treinos/Semana","v":"4068","t":"+3.5%","d":"up"},{"l":"Competições","v":"7.932","t":"-3.1%","d":"down"},{"l":"Performance Score","v":"73","t":"+14.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","1.297","4.454","6.095","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","4.920","1.381","5.124","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.945","8.643","4.470","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","894","3.258","762","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.742","4.744","3.327","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":354},{"label":"Fev","value":395},{"label":"Mar","value":356},{"label":"Abr","value":283},{"label":"Mai","value":581},{"label":"Jun","value":255},{"label":"Jul","value":451},{"label":"Ago","value":494},{"label":"Set","value":493},{"label":"Out","value":322},{"label":"Nov","value":380},{"label":"Dez","value":577}];
const MX = 581;
