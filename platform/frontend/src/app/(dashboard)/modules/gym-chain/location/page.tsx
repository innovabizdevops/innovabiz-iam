...
const ACCENT = "#14532d";
const MODULE = "Gym Chain Mgmt";
const PAGE = "Location";
const KPIS = [{"l":"Atletas Registados","v":"8.111","t":"-1.0%","d":"down"},{"l":"Treinos/Semana","v":"1587","t":"+1.0%","d":"up"},{"l":"Competições","v":"862","t":"+7.2%","d":"up"},{"l":"Performance Score","v":"73","t":"+2.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.881","6.173","8.893","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.113","902","6.498","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.994","6.661","3.931","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.427","8.582","5.289","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.550","5.713","7.878","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":930},{"label":"Fev","value":949},{"label":"Mar","value":894},{"label":"Abr","value":1026},{"label":"Mai","value":915},{"label":"Jun","value":981},{"label":"Jul","value":791},{"label":"Ago","value":861},{"label":"Set","value":750},{"label":"Out","value":687},{"label":"Nov","value":894},{"label":"Dez","value":753}];
const MX = 1026;
