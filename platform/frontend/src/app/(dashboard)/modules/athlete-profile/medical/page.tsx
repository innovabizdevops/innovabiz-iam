...
const PAGE = "Medical Record";
const KPIS = [{"l":"Perfis Unificados","v":"6.792","t":"+4.8%","d":"up"},{"l":"Segmentos Ativos","v":"4.468","t":"+16.9%","d":"up"},{"l":"NPS Score","v":"61","t":"+9.0%","d":"up"},{"l":"Churn Previsto (%)","v":"85.0%","t":"-1.0%","d":"down"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","482","€ 26680.05","99.3%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","4.536","€ 168.63","88.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","8.835","€ 10078.09","89.9%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","5.314","€ 41260.70","98.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","2.319","€ 7555.72","78.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":879},{"label":"Fev","value":598},{"label":"Mar","value":826},{"label":"Abr","value":787},{"label":"Mai","value":739},{"label":"Jun","value":559},{"label":"Jul","value":828},{"label":"Ago","value":826},{"label":"Set","value":725},{"label":"Out","value":638},{"label":"Nov","value":816},{"label":"Dez","value":681}];
const MX = 879;
