...
const KPIS = [{"l":"Formulários Ativos","v":"2.915","t":"+3.5%","d":"up"},{"l":"Submissões/Dia","v":"1931","t":"+6.5%","d":"up"},{"l":"Documentos Gerados","v":"901","t":"+16.8%","d":"up"},{"l":"Templates","v":"6.580","t":"+10.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.565","2026-01-07","7.764","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.110","2026-03-14","5.362","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.939","2026-03-09","7.193","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.505","2026-02-17","4.463","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.212","2026-03-04","5.526","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":642},{"label":"Fev","value":486},{"label":"Mar","value":662},{"label":"Abr","value":614},{"label":"Mai","value":561},{"label":"Jun","value":564},{"label":"Jul","value":637},{"label":"Ago","value":406},{"label":"Set","value":419},{"label":"Out","value":609},{"label":"Nov","value":693},{"label":"Dez","value":343}];
const MX = 693;
