...
const ACCENT = "#7c3aed";
const MODULE = "Athlete Profile";
const PAGE = "Wearable Data";
const KPIS = [{"l":"Perfis Unificados","v":"6.072","t":"+12.2%","d":"up"},{"l":"Segmentos Ativos","v":"3.863","t":"+14.2%","d":"up"},{"l":"NPS Score","v":"71","t":"+14.8%","d":"up"},{"l":"Churn Previsto (%)","v":"79.7%","t":"+12.2%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","5.786","€ 39348.71","75.4%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","5.500","€ 13731.67","95.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","6.634","€ 37279.31","92.5%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","4.786","€ 4696.53","80.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","4.389","€ 42763.19","90.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":653},{"label":"Mar","value":475},{"label":"Abr","value":368},{"label":"Mai","value":479},{"label":"Jun","value":631},{"label":"Jul","value":352},{"label":"Ago","value":398},{"label":"Set","value":346},{"label":"Out","value":350},{"label":"Nov","value":711},{"label":"Dez","value":344}];
const MX = 711;
