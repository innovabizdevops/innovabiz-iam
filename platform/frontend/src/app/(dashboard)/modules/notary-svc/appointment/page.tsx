...
const KPIS = [{"l":"Total Notary Svc","v":"4.074","t":"-1.3%","d":"down"},{"l":"Appointment Ativos","v":"8.972","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"91.7%","t":"+11.8%","d":"up"},{"l":"Score Performance","v":"84","t":"-0.3%","d":"down"}];
const COLS = ["ID","Appointment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Svc #001","Notary Svc #002","5.619","2.386","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Svc #002","Notary Svc #003","467","156","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Svc #003","Notary Svc #004","3.050","2.018","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Svc #004","Notary Svc #005","6.518","4.054","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Svc #005","Notary Svc #001","828","4.780","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":337},{"label":"Mar","value":530},{"label":"Abr","value":292},{"label":"Mai","value":340},{"label":"Jun","value":355},{"label":"Jul","value":497},{"label":"Ago","value":539},{"label":"Set","value":633},{"label":"Out","value":510},{"label":"Nov","value":313},{"label":"Dez","value":609}];
const MX = 633;
