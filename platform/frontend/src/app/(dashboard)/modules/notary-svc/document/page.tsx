...
const ACCENT = "#6366f1";
const MODULE = "Notary Services";
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"2.639","t":"+3.0%","d":"up"},{"l":"Submissões/Dia","v":"1252","t":"+3.8%","d":"up"},{"l":"Documentos Gerados","v":"7.876","t":"+12.7%","d":"up"},{"l":"Templates","v":"7.583","t":"+13.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.257","2026-01-07","4.083","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.453","2026-03-09","4.275","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.770","2026-03-28","6.365","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.722","2026-01-08","1.554","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.210","2026-03-16","325","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":669},{"label":"Fev","value":497},{"label":"Mar","value":732},{"label":"Abr","value":569},{"label":"Mai","value":549},{"label":"Jun","value":748},{"label":"Jul","value":523},{"label":"Ago","value":643},{"label":"Set","value":464},{"label":"Out","value":468},{"label":"Nov","value":649},{"label":"Dez","value":557}];
const MX = 748;
