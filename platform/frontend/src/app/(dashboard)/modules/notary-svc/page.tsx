...
export default function NotarySvcPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Notary Svc</h1><p className="text-sm text-muted-foreground">Notary Svc • iBOS Enterprise</p></div>
