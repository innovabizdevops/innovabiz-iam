...
const PAGE = "Verify";
const KPIS = [{"l":"Total Notary Svc","v":"8.922","t":"+13.9%","d":"up"},{"l":"Verify Ativos","v":"3.190","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"74.0%","t":"+17.2%","d":"up"},{"l":"Score Performance","v":"89","t":"-0.8%","d":"down"}];
const COLS = ["ID","Verify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Notary Svc #001","Notary Svc #002","7.427","1.660","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Notary Svc #002","Notary Svc #003","7.285","6.360","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Notary Svc #003","Notary Svc #004","853","3.635","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Notary Svc #004","Notary Svc #005","2.889","3.649","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Notary Svc #005","Notary Svc #001","7.201","5.746","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":283},{"label":"Fev","value":549},{"label":"Mar","value":584},{"label":"Abr","value":416},{"label":"Mai","value":481},{"label":"Jun","value":425},{"label":"Jul","value":572},{"label":"Ago","value":394},{"label":"Set","value":241},{"label":"Out","value":488},{"label":"Nov","value":436},{"label":"Dez","value":459}];
const MX = 584;
