...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"1.869","t":"+4.0%","d":"up"},{"l":"Viagens/Dia","v":"296","t":"-1.2%","d":"down"},{"l":"Pontualidade (%)","v":"74.1%","t":"-0.9%","d":"down"},{"l":"Passageiros/Dia","v":"665","t":"-2.3%","d":"down"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-02-11","2026-01-27","6.929","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-26","2026-02-03","5.502","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-01-02","2026-03-10","8.075","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-26","2026-03-28","2.621","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-03","2026-03-18","8.061","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":933},{"label":"Mar","value":821},{"label":"Abr","value":852},{"label":"Mai","value":878},{"label":"Jun","value":923},{"label":"Jul","value":784},{"label":"Ago","value":880},{"label":"Set","value":706},{"label":"Out","value":932},{"label":"Nov","value":588},{"label":"Dez","value":874}];
const MX = 933;
