...
const ACCENT = "#6366f1";
const MODULE = "Police CAD";
const PAGE = "Priority";
const KPIS = [{"l":"Total Police Cad","v":"4.581","t":"+11.3%","d":"up"},{"l":"Priority Ativos","v":"1.658","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"75.4%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"80","t":"+15.4%","d":"up"}];
const COLS = ["ID","Priority","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Police Cad #001","Police Cad #002","2.118","5.229","2026-01-16","Ativo"],"status":"active"},{"id":"r1","cells":["Police Cad #002","Police Cad #003","8.495","2.319","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Police Cad #003","Police Cad #004","4.464","4.385","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Police Cad #004","Police Cad #005","636","4.875","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Police Cad #005","Police Cad #001","5.071","4.404","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":904},{"label":"Fev","value":691},{"label":"Mar","value":675},{"label":"Abr","value":861},{"label":"Mai","value":930},{"label":"Jun","value":655},{"label":"Jul","value":861},{"label":"Ago","value":729},{"label":"Set","value":854},{"label":"Out","value":777},{"label":"Nov","value":801},{"label":"Dez","value":637}];
const MX = 930;
