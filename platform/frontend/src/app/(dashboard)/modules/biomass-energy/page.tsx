...
/* ═══ Biomass Energy — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "9928", trend: "-4%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "486", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€465K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "-11%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "881634528", cells: ["BIO-4528", "Biomass Energy Item 1", "13/1/2026", "€34 628"], status: "active" as const },
    { id: "881638099", cells: ["BIO-8099", "Biomass Energy Item 2", "28/8/2026", "€38 199"], status: "pending" as const },
    { id: "881641670", cells: ["BIO-2670", "Biomass Energy Item 3", "15/3/2026", "€41 770"], status: "completed" as const },
    { id: "881645241", cells: ["BIO-6241", "Biomass Energy Item 4", "2/10/2026", "€45 341"], status: "warning" as const },
    { id: "881648812", cells: ["BIO-9812", "Biomass Energy Item 5", "17/5/2026", "€48 912"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Biomass Energy</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Biomass Energy</p>
                    </div>
                </div>
