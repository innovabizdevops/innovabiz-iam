...
const PAGE = "Process";
const KPIS = [{"l":"Total Biomass Energy","v":"125","t":"+1.4%","d":"up"},{"l":"Process Ativos","v":"7.258","t":"-5.0%","d":"down"},{"l":"Eficiência (%)","v":"83.6%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"56","t":"+7.3%","d":"up"}];
const COLS = ["ID","Process","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Energy #001","Biomass Energy #002","7.880","7.765","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Energy #002","Biomass Energy #003","3.227","2.759","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Energy #003","Biomass Energy #004","4.200","2.948","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Energy #004","Biomass Energy #005","2.090","5.130","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Energy #005","Biomass Energy #001","7.854","3.247","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":412},{"label":"Mar","value":629},{"label":"Abr","value":615},{"label":"Mai","value":629},{"label":"Jun","value":579},{"label":"Jul","value":429},{"label":"Ago","value":390},{"label":"Set","value":529},{"label":"Out","value":387},{"label":"Nov","value":431},{"label":"Dez","value":404}];
const MX = 629;
