...
const PAGE = "Generate";
const KPIS = [{"l":"Total Biomass Energy","v":"6.954","t":"+12.3%","d":"up"},{"l":"Generate Ativos","v":"4.319","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"78.8%","t":"+15.9%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.1%","d":"up"}];
const COLS = ["ID","Generate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Energy #001","Biomass Energy #002","3.072","5.202","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Energy #002","Biomass Energy #003","2.648","1.651","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Energy #003","Biomass Energy #004","3.036","2.006","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Energy #004","Biomass Energy #005","8.706","4.867","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Energy #005","Biomass Energy #001","5.407","6.042","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":551},{"label":"Mar","value":550},{"label":"Abr","value":888},{"label":"Mai","value":719},{"label":"Jun","value":644},{"label":"Jul","value":827},{"label":"Ago","value":650},{"label":"Set","value":827},{"label":"Out","value":615},{"label":"Nov","value":626},{"label":"Dez","value":828}];
const MX = 888;
