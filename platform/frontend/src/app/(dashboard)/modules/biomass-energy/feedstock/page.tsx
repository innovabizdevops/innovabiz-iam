...
const ACCENT = "#14532d";
const MODULE = "Biomass Energy";
const PAGE = "Feedstock";
const KPIS = [{"l":"Total Biomass Energy","v":"1.884","t":"-5.7%","d":"down"},{"l":"Feedstock Ativos","v":"5.595","t":"+14.5%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+7.6%","d":"up"},{"l":"Score Performance","v":"75","t":"-5.9%","d":"down"}];
const COLS = ["ID","Feedstock","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Energy #001","Biomass Energy #002","936","639","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Energy #002","Biomass Energy #003","1.390","4.128","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Energy #003","Biomass Energy #004","8.102","5.938","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Energy #004","Biomass Energy #005","6.023","7.965","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Energy #005","Biomass Energy #001","7.547","8.904","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":878},{"label":"Mar","value":840},{"label":"Abr","value":792},{"label":"Mai","value":1019},{"label":"Jun","value":690},{"label":"Jul","value":1042},{"label":"Ago","value":1059},{"label":"Set","value":779},{"label":"Out","value":1023},{"label":"Nov","value":951},{"label":"Dez","value":809}];
const MX = 1059;
