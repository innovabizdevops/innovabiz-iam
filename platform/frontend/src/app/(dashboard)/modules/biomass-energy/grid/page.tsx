...
const PAGE = "Grid";
const KPIS = [{"l":"Total Biomass Energy","v":"2.815","t":"+0.5%","d":"up"},{"l":"Grid Ativos","v":"1.938","t":"+14.6%","d":"up"},{"l":"Eficiência (%)","v":"72.6%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"78","t":"-0.9%","d":"down"}];
const COLS = ["ID","Grid","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biomass Energy #001","Biomass Energy #002","8.646","3.532","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Biomass Energy #002","Biomass Energy #003","6.431","9.059","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Biomass Energy #003","Biomass Energy #004","8.543","657","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Biomass Energy #004","Biomass Energy #005","8.044","5.994","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biomass Energy #005","Biomass Energy #001","9.013","8.857","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":727},{"label":"Fev","value":454},{"label":"Mar","value":695},{"label":"Abr","value":676},{"label":"Mai","value":536},{"label":"Jun","value":362},{"label":"Jul","value":363},{"label":"Ago","value":369},{"label":"Set","value":678},{"label":"Out","value":723},{"label":"Nov","value":683},{"label":"Dez","value":615}];
const MX = 727;
