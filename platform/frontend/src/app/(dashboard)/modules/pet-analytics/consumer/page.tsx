...
const PAGE = "Consumer";
const KPIS = [{"l":"Dashboards Ativos","v":"3.917","t":"+0.2%","d":"up"},{"l":"Queries/Dia","v":"4749","t":"+16.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.478","t":"-4.4%","d":"down"},{"l":"Utilizadores Analytics","v":"2.300","t":"-4.0%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4192","2026-02-04","158","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4173","2026-03-11","7.318","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1722","2026-02-15","7.729","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1042","2026-01-28","7.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2539","2026-03-07","1.092","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":858},{"label":"Fev","value":765},{"label":"Mar","value":841},{"label":"Abr","value":926},{"label":"Mai","value":674},{"label":"Jun","value":1009},{"label":"Jul","value":771},{"label":"Ago","value":779},{"label":"Set","value":807},{"label":"Out","value":687},{"label":"Nov","value":859},{"label":"Dez","value":896}];
const MX = 1009;
