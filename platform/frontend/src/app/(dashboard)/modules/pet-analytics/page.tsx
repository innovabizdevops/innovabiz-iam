...
/* ═══ Pet Industry Analytics — Dashboard ═══ */

const ACCENT = "#fdba74";

const KPIS = [
    { label: "Total Registos", value: "7917", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2368", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€471K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1096551617", cells: ["PET-1617", "Pet Industry Analytics Item 1", "22/6/2026", "€1717"], status: "active" as const },
    { id: "1096555188", cells: ["PET-5188", "Pet Industry Analytics Item 2", "9/1/2026", "€5288"], status: "pending" as const },
    { id: "1096558759", cells: ["PET-8759", "Pet Industry Analytics Item 3", "24/8/2026", "€8859"], status: "completed" as const },
    { id: "1096562330", cells: ["PET-3330", "Pet Industry Analytics Item 4", "11/3/2026", "€12 430"], status: "warning" as const },
    { id: "1096565901", cells: ["PET-6901", "Pet Industry Analytics Item 5", "26/10/2026", "€16 001"], status: "active" as const },
];
...
export default function PetIndustryAnalyticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pet Industry Analytics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pet Industry Analytics</p>
                    </div>
                </div>
