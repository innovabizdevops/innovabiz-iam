...
const PAGE = "Market";
const KPIS = [{"l":"Dashboards Ativos","v":"3.969","t":"+11.8%","d":"up"},{"l":"Queries/Dia","v":"3916","t":"+16.5%","d":"up"},{"l":"Dados Processados (GB)","v":"3.053","t":"-3.1%","d":"down"},{"l":"Utilizadores Analytics","v":"1.676","t":"+1.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3496","2026-02-23","8.951","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3697","2026-03-11","1.066","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2312","2026-01-26","7.535","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","753","2026-01-28","5.043","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","563","2026-01-15","167","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":616},{"label":"Mar","value":491},{"label":"Abr","value":750},{"label":"Mai","value":726},{"label":"Jun","value":541},{"label":"Jul","value":814},{"label":"Ago","value":755},{"label":"Set","value":704},{"label":"Out","value":572},{"label":"Nov","value":479},{"label":"Dez","value":739}];
const MX = 814;
