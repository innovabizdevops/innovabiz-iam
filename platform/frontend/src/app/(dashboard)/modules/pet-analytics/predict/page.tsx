...
const ACCENT = "#fdba74";
const MODULE = "Pet Industry Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"767","t":"-0.3%","d":"down"},{"l":"Queries/Dia","v":"1352","t":"+1.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.652","t":"+2.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.702","t":"+8.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1572","2026-01-16","3.401","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2067","2026-02-21","3.088","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","803","2026-02-17","6.109","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1964","2026-03-01","5.301","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1526","2026-03-09","1.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":323},{"label":"Mar","value":473},{"label":"Abr","value":619},{"label":"Mai","value":389},{"label":"Jun","value":356},{"label":"Jul","value":415},{"label":"Ago","value":624},{"label":"Set","value":649},{"label":"Out","value":517},{"label":"Nov","value":482},{"label":"Dez","value":318}];
const MX = 649;
