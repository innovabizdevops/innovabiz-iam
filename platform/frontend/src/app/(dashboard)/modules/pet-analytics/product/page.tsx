...
const PAGE = "Product";
const KPIS = [{"l":"Dashboards Ativos","v":"7.062","t":"+2.4%","d":"up"},{"l":"Queries/Dia","v":"241","t":"+4.6%","d":"up"},{"l":"Dados Processados (GB)","v":"3.975","t":"+2.8%","d":"up"},{"l":"Utilizadores Analytics","v":"532","t":"+8.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2177","2026-03-02","4.663","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1085","2026-01-08","3.405","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2782","2026-03-05","2.732","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1322","2026-02-24","2.641","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3670","2026-01-19","5.433","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":545},{"label":"Mar","value":595},{"label":"Abr","value":361},{"label":"Mai","value":346},{"label":"Jun","value":258},{"label":"Jul","value":284},{"label":"Ago","value":276},{"label":"Set","value":448},{"label":"Out","value":367},{"label":"Nov","value":473},{"label":"Dez","value":597}];
const MX = 597;
