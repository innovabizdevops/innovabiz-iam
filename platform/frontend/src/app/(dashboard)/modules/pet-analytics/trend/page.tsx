...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"3.149","t":"+1.6%","d":"up"},{"l":"Queries/Dia","v":"4314","t":"+13.2%","d":"up"},{"l":"Dados Processados (GB)","v":"989","t":"+15.4%","d":"up"},{"l":"Utilizadores Analytics","v":"4.347","t":"-4.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2614","2026-01-15","2.749","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1205","2026-02-16","8.826","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","594","2026-01-08","6.945","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2486","2026-02-23","8.809","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","203","2026-03-20","6.851","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":940},{"label":"Fev","value":924},{"label":"Mar","value":829},{"label":"Abr","value":777},{"label":"Mai","value":894},{"label":"Jun","value":720},{"label":"Jul","value":776},{"label":"Ago","value":645},{"label":"Set","value":957},{"label":"Out","value":687},{"label":"Nov","value":617},{"label":"Dez","value":910}];
const MX = 957;
