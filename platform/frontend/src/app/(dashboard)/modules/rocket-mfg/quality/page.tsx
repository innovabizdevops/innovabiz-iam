...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.487","t":"+15.1%","d":"up"},{"l":"NC Abertas","v":"8.907","t":"+0.4%","d":"up"},{"l":"Conformidade (%)","v":"93.6%","t":"-0.2%","d":"down"},{"l":"CAPAs Pendentes","v":"6.967","t":"+4.0%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.264","92.7%","7.991","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.511","80.6%","5.102","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.200","80.2%","2.437","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.849","78.7%","4.999","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","194","78.3%","5.103","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":415},{"label":"Mar","value":630},{"label":"Abr","value":669},{"label":"Mai","value":648},{"label":"Jun","value":319},{"label":"Jul","value":478},{"label":"Ago","value":358},{"label":"Set","value":410},{"label":"Out","value":416},{"label":"Nov","value":610},{"label":"Dez","value":342}];
const MX = 676;
