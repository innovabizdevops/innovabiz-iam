...
const KPIS = [{"l":"Integrações Ativas","v":"978","t":"+13.2%","d":"up"},{"l":"Chamadas/Hora","v":"202","t":"+17.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.4%","t":"+4.7%","d":"up"},{"l":"Latência Média (ms)","v":"89ms","t":"+2.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.999","6.906","71.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.726","4.107","96.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.451","7.904","97.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.277","8.977","90.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.476","8.616","90.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":418},{"label":"Mar","value":718},{"label":"Abr","value":453},{"label":"Mai","value":596},{"label":"Jun","value":630},{"label":"Jul","value":779},{"label":"Ago","value":522},{"label":"Set","value":486},{"label":"Out","value":713},{"label":"Nov","value":491},{"label":"Dez","value":587}];
const MX = 779;
