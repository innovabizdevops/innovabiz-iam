...
const ACCENT = "#1e3a5f";
const MODULE = "Rocket Manufacturing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.250","t":"-1.4%","d":"down"},{"l":"Submissões/Dia","v":"2154","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"4.094","t":"+7.7%","d":"up"},{"l":"Templates","v":"4.153","t":"-3.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.865","2026-01-18","7.423","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.815","2026-03-08","5.851","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.232","2026-02-02","8.714","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.780","2026-02-13","5.168","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.734","2026-03-03","3.093","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":875},{"label":"Fev","value":819},{"label":"Mar","value":788},{"label":"Abr","value":704},{"label":"Mai","value":731},{"label":"Jun","value":1054},{"label":"Jul","value":1027},{"label":"Ago","value":761},{"label":"Set","value":1044},{"label":"Out","value":923},{"label":"Nov","value":1045},{"label":"Dez","value":709}];
const MX = 1054;
