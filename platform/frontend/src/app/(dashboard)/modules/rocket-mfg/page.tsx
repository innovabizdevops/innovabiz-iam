...
/* ═══ Rocket Manufacturing — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "8804", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3599", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€167K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "85%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "684504604", cells: ["ROC-1604", "Rocket Manufacturing Item 1", "1/5/2026", "€4704"], status: "active" as const },
    { id: "684508175", cells: ["ROC-5175", "Rocket Manufacturing Item 2", "16/12/2026", "€8275"], status: "pending" as const },
    { id: "684511746", cells: ["ROC-8746", "Rocket Manufacturing Item 3", "3/7/2026", "€11 846"], status: "completed" as const },
    { id: "684515317", cells: ["ROC-3317", "Rocket Manufacturing Item 4", "18/2/2026", "€15 417"], status: "warning" as const },
    { id: "684518888", cells: ["ROC-6888", "Rocket Manufacturing Item 5", "5/9/2026", "€18 988"], status: "active" as const },
];
...
export default function RocketManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Rocket Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Rocket Manufacturing</p>
                    </div>
                </div>
