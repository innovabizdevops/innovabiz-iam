...
const ACCENT = "#ec4899";
const MODULE = "InsurTech Embedded";
const PAGE = "Usage-Based";
const KPIS = [{"l":"Dashboards Ativos","v":"4.811","t":"-2.2%","d":"down"},{"l":"Queries/Dia","v":"1447","t":"+16.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.560","t":"+5.2%","d":"up"},{"l":"Utilizadores Analytics","v":"8.822","t":"+1.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1401","2026-01-03","1.809","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3531","2026-01-19","159","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1967","2026-01-10","8.942","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","973","2026-03-12","7.042","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4274","2026-03-20","7.694","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":881},{"label":"Mar","value":636},{"label":"Abr","value":904},{"label":"Mai","value":623},{"label":"Jun","value":858},{"label":"Jul","value":714},{"label":"Ago","value":568},{"label":"Set","value":770},{"label":"Out","value":924},{"label":"Nov","value":679},{"label":"Dez","value":856}];
const MX = 924;
