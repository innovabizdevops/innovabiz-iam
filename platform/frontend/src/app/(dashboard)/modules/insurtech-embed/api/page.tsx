...
const PAGE = "API Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"841","t":"+2.0%","d":"up"},{"l":"Queries/Dia","v":"4381","t":"+3.9%","d":"up"},{"l":"Dados Processados (GB)","v":"6.734","t":"-4.5%","d":"down"},{"l":"Utilizadores Analytics","v":"4.378","t":"+15.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1887","2026-03-05","406","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3884","2026-01-01","3.388","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1451","2026-01-19","5.076","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3134","2026-03-28","5.049","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2658","2026-01-22","8.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":857},{"label":"Fev","value":977},{"label":"Mar","value":863},{"label":"Abr","value":867},{"label":"Mai","value":922},{"label":"Jun","value":760},{"label":"Jul","value":1011},{"label":"Ago","value":692},{"label":"Set","value":780},{"label":"Out","value":717},{"label":"Nov","value":908},{"label":"Dez","value":913}];
const MX = 1011;
