...
const PAGE = "Micro Insurance";
const KPIS = [{"l":"Dashboards Ativos","v":"7.871","t":"+8.2%","d":"up"},{"l":"Queries/Dia","v":"3129","t":"+8.2%","d":"up"},{"l":"Dados Processados (GB)","v":"5.620","t":"+17.6%","d":"up"},{"l":"Utilizadores Analytics","v":"2.595","t":"-2.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1467","2026-03-10","548","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4425","2026-03-27","2.407","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","250","2026-01-02","2.217","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1069","2026-02-22","7.031","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2327","2026-02-21","4.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":352},{"label":"Fev","value":409},{"label":"Mar","value":478},{"label":"Abr","value":526},{"label":"Mai","value":550},{"label":"Jun","value":513},{"label":"Jul","value":270},{"label":"Ago","value":565},{"label":"Set","value":385},{"label":"Out","value":485},{"label":"Nov","value":450},{"label":"Dez","value":583}];
const MX = 583;
