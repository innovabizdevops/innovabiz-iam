...
const PAGE = "Widget Builder";
const KPIS = [{"l":"Dashboards Ativos","v":"6.646","t":"+17.7%","d":"up"},{"l":"Queries/Dia","v":"3538","t":"+15.0%","d":"up"},{"l":"Dados Processados (GB)","v":"292","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"7.648","t":"+15.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2122","2026-02-27","8.122","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3304","2026-03-02","7.574","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4639","2026-03-10","8.145","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3882","2026-02-03","1.077","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","862","2026-02-10","6.906","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":956},{"label":"Fev","value":818},{"label":"Mar","value":813},{"label":"Abr","value":748},{"label":"Mai","value":1009},{"label":"Jun","value":1024},{"label":"Jul","value":813},{"label":"Ago","value":811},{"label":"Set","value":648},{"label":"Out","value":682},{"label":"Nov","value":728},{"label":"Dez","value":986}];
const MX = 1024;
