...
export default function InsurtechEmbedPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Insurtech Embed</h1><p className="text-sm text-muted-foreground">Insurtech Embed • iBOS Enterprise</p></div>
