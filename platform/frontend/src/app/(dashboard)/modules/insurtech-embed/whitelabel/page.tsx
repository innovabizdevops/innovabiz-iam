...
const PAGE = "White Label";
const KPIS = [{"l":"Dashboards Ativos","v":"5.792","t":"+9.0%","d":"up"},{"l":"Queries/Dia","v":"932","t":"+18.0%","d":"up"},{"l":"Dados Processados (GB)","v":"2.077","t":"+1.3%","d":"up"},{"l":"Utilizadores Analytics","v":"1.107","t":"+16.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2457","2026-02-16","3.949","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1376","2026-03-07","5.983","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1633","2026-01-20","6.392","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2676","2026-02-19","5.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2033","2026-03-11","2.545","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":394},{"label":"Mar","value":258},{"label":"Abr","value":304},{"label":"Mai","value":457},{"label":"Jun","value":557},{"label":"Jul","value":323},{"label":"Ago","value":387},{"label":"Set","value":271},{"label":"Out","value":360},{"label":"Nov","value":261},{"label":"Dez","value":345}];
const MX = 557;
