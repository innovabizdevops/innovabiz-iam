...
const ACCENT = "#38bdf8";
const MODULE = "Number Management";
const PAGE = "Port Request";
const KPIS = [{"l":"Total Number Mgmt","v":"2.667","t":"+7.7%","d":"up"},{"l":"Port Request Ativos","v":"6.587","t":"-2.5%","d":"down"},{"l":"Eficiência (%)","v":"68.6%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"72","t":"+13.3%","d":"up"}];
const COLS = ["ID","Port Request","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Mgmt #001","Number Mgmt #002","8.140","8.696","2026-03-14","Ativo"],"status":"active"},{"id":"r1","cells":["Number Mgmt #002","Number Mgmt #003","3.110","493","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Mgmt #003","Number Mgmt #004","5.260","8.923","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Number Mgmt #004","Number Mgmt #005","8.021","3.713","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Mgmt #005","Number Mgmt #001","5.563","1.553","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":446},{"label":"Mar","value":662},{"label":"Abr","value":733},{"label":"Mai","value":583},{"label":"Jun","value":459},{"label":"Jul","value":421},{"label":"Ago","value":688},{"label":"Set","value":621},{"label":"Out","value":617},{"label":"Nov","value":485},{"label":"Dez","value":757}];
const MX = 757;
