...
const PAGE = "DID Assign";
const KPIS = [{"l":"Total Number Mgmt","v":"4.384","t":"-1.4%","d":"down"},{"l":"DID Assign Ativos","v":"2.235","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"94.9%","t":"+4.0%","d":"up"},{"l":"Score Performance","v":"77","t":"+13.1%","d":"up"}];
const COLS = ["ID","DID Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Mgmt #001","Number Mgmt #002","3.391","3.183","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Number Mgmt #002","Number Mgmt #003","3.005","3.024","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Mgmt #003","Number Mgmt #004","7.382","4.057","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Number Mgmt #004","Number Mgmt #005","5.269","2.838","2026-03-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Mgmt #005","Number Mgmt #001","1.276","3.839","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":808},{"label":"Mar","value":722},{"label":"Abr","value":799},{"label":"Mai","value":912},{"label":"Jun","value":935},{"label":"Jul","value":622},{"label":"Ago","value":948},{"label":"Set","value":635},{"label":"Out","value":675},{"label":"Nov","value":653},{"label":"Dez","value":736}];
const MX = 948;
