...
const PAGE = "Number Pool";
const KPIS = [{"l":"Total Number Mgmt","v":"2.006","t":"+2.3%","d":"up"},{"l":"Number Pool Ativos","v":"3.928","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"78.2%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.5%","d":"up"}];
const COLS = ["ID","Number Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Mgmt #001","Number Mgmt #002","728","4.169","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Number Mgmt #002","Number Mgmt #003","3.964","9.004","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Mgmt #003","Number Mgmt #004","1.084","7.166","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Number Mgmt #004","Number Mgmt #005","5.079","8.709","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Mgmt #005","Number Mgmt #001","897","8.103","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":697},{"label":"Mar","value":701},{"label":"Abr","value":718},{"label":"Mai","value":387},{"label":"Jun","value":693},{"label":"Jul","value":735},{"label":"Ago","value":617},{"label":"Set","value":584},{"label":"Out","value":570},{"label":"Nov","value":642},{"label":"Dez","value":444}];
const MX = 784;
