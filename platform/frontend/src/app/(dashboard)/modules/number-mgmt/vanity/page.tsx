...
const PAGE = "Vanity Number";
const KPIS = [{"l":"Total Number Mgmt","v":"9.029","t":"+7.2%","d":"up"},{"l":"Vanity Number Ativos","v":"480","t":"+7.6%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+17.4%","d":"up"},{"l":"Score Performance","v":"70","t":"-5.0%","d":"down"}];
const COLS = ["ID","Vanity Number","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Number Mgmt #001","Number Mgmt #002","1.693","1.917","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Number Mgmt #002","Number Mgmt #003","8.520","2.539","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Number Mgmt #003","Number Mgmt #004","326","9.058","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Number Mgmt #004","Number Mgmt #005","1.029","3.054","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Number Mgmt #005","Number Mgmt #001","7.219","2.662","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":933},{"label":"Mar","value":580},{"label":"Abr","value":747},{"label":"Mai","value":632},{"label":"Jun","value":757},{"label":"Jul","value":712},{"label":"Ago","value":782},{"label":"Set","value":635},{"label":"Out","value":860},{"label":"Nov","value":655},{"label":"Dez","value":771}];
const MX = 933;
