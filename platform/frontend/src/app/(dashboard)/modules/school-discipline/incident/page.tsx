...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"2.530","t":"+11.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"73.9%","t":"+3.1%","d":"up"},{"l":"MTTR (h)","v":"189h","t":"+9.1%","d":"up"},{"l":"Satisfação (%)","v":"67.7%","t":"-2.2%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.816","3.683","8.335","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.861","7.333","1.904","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.489","7.194","7.968","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.866","810","4.476","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.843","135","3.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":815},{"label":"Mar","value":706},{"label":"Abr","value":604},{"label":"Mai","value":501},{"label":"Jun","value":638},{"label":"Jul","value":513},{"label":"Ago","value":497},{"label":"Set","value":499},{"label":"Out","value":657},{"label":"Nov","value":674},{"label":"Dez","value":567}];
const MX = 815;
