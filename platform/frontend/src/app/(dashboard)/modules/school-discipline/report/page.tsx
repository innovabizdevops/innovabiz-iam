...
const PAGE = "Report";
const KPIS = [{"l":"Total School Discipline","v":"709","t":"-1.6%","d":"down"},{"l":"Report Ativos","v":"7.978","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"71.3%","t":"+16.9%","d":"up"},{"l":"Score Performance","v":"64","t":"+4.7%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["School Discipline #001","School Discipline #002","2.299","4.627","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["School Discipline #002","School Discipline #003","1.458","2.377","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["School Discipline #003","School Discipline #004","6.776","5.808","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["School Discipline #004","School Discipline #005","627","4.184","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["School Discipline #005","School Discipline #001","5.753","6.678","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":826},{"label":"Mar","value":740},{"label":"Abr","value":729},{"label":"Mai","value":704},{"label":"Jun","value":625},{"label":"Jul","value":768},{"label":"Ago","value":889},{"label":"Set","value":733},{"label":"Out","value":785},{"label":"Nov","value":827},{"label":"Dez","value":841}];
const MX = 889;
