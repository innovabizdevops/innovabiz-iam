...
const KPIS = [
    { label: "Total Registos", value: "6952", trend: "-3%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4855", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€318K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "73%", trend: "-10%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1492085352", cells: ["AGE-3352", "AI Legal Agent Item 1", "17/1/2026", "€35 452"], status: "active" as const },
    { id: "1492088923", cells: ["AGE-6923", "AI Legal Agent Item 2", "4/8/2026", "€39 023"], status: "pending" as const },
    { id: "1492092494", cells: ["AGE-1494", "AI Legal Agent Item 3", "19/3/2026", "€42 594"], status: "completed" as const },
    { id: "1492096065", cells: ["AGE-5065", "AI Legal Agent Item 4", "6/10/2026", "€46 165"], status: "warning" as const },
    { id: "1492099636", cells: ["AGE-8636", "AI Legal Agent Item 5", "21/5/2026", "€49 736"], status: "active" as const },
];
...
export default function AiLegalAgentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">AI Legal Agent</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • AI Legal Agent</p>
                    </div>
                </div>
