...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"2.831","t":"+14.0%","d":"up"},{"l":"Mitigações Ativas","v":"1.985","t":"-1.1%","d":"down"},{"l":"Score Risco Geral","v":"56","t":"+9.4%","d":"up"},{"l":"Incidentes YTD","v":"529","t":"+9.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.341","3.665","5.840","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.357","1.385","2.642","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.662","5.956","5.797","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.425","536","3.660","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.380","5.956","8.781","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":696},{"label":"Fev","value":829},{"label":"Mar","value":613},{"label":"Abr","value":751},{"label":"Mai","value":849},{"label":"Jun","value":732},{"label":"Jul","value":666},{"label":"Ago","value":601},{"label":"Set","value":842},{"label":"Out","value":648},{"label":"Nov","value":681},{"label":"Dez","value":729}];
const MX = 849;
