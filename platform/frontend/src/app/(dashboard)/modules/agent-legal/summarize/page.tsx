...
const KPIS = [{"l":"Total Agent Legal","v":"3.373","t":"+11.9%","d":"up"},{"l":"Summarize Ativos","v":"5.616","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"91.9%","t":"+0.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+4.4%","d":"up"}];
const COLS = ["ID","Summarize","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Legal #001","Agent Legal #002","1.234","2.413","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Legal #002","Agent Legal #003","698","8.141","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Legal #003","Agent Legal #004","1.213","1.229","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Legal #004","Agent Legal #005","3.918","6.380","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Legal #005","Agent Legal #001","1.624","8.859","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":571},{"label":"Mar","value":868},{"label":"Abr","value":886},{"label":"Mai","value":899},{"label":"Jun","value":804},{"label":"Jul","value":675},{"label":"Ago","value":707},{"label":"Set","value":545},{"label":"Out","value":536},{"label":"Nov","value":570},{"label":"Dez","value":768}];
const MX = 899;
