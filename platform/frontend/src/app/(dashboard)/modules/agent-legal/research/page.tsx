...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"3.526","t":"-4.3%","d":"down"},{"l":"Patentes (YTD)","v":"5.724","t":"+9.3%","d":"up"},{"l":"Projetos Innovation Lab","v":"6.531","t":"+7.6%","d":"up"},{"l":"Budget I&D (€M)","v":"€12.8M","t":"+5.6%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","6.286","89.8%","6.322","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","7.585","75.1%","3.308","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","7.155","94.2%","6.178","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","857","96.5%","7.255","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.129","75.8%","7.971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":822},{"label":"Mar","value":696},{"label":"Abr","value":663},{"label":"Mai","value":657},{"label":"Jun","value":642},{"label":"Jul","value":866},{"label":"Ago","value":653},{"label":"Set","value":671},{"label":"Out","value":802},{"label":"Nov","value":518},{"label":"Dez","value":661}];
const MX = 866;
