...
const ACCENT = "#7c3aed";
const MODULE = "AI Legal Agent";
const PAGE = "Draft";
const KPIS = [{"l":"Total Agent Legal","v":"2.266","t":"+0.2%","d":"up"},{"l":"Draft Ativos","v":"3.159","t":"+2.8%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+15.7%","d":"up"},{"l":"Score Performance","v":"78","t":"+6.1%","d":"up"}];
const COLS = ["ID","Draft","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Agent Legal #001","Agent Legal #002","1.669","2.953","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Agent Legal #002","Agent Legal #003","1.404","7.920","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Agent Legal #003","Agent Legal #004","1.531","773","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Agent Legal #004","Agent Legal #005","6.685","6.623","2026-01-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Agent Legal #005","Agent Legal #001","1.663","4.909","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":672},{"label":"Mar","value":795},{"label":"Abr","value":880},{"label":"Mai","value":848},{"label":"Jun","value":753},{"label":"Jul","value":754},{"label":"Ago","value":709},{"label":"Set","value":795},{"label":"Out","value":902},{"label":"Nov","value":727},{"label":"Dez","value":718}];
const MX = 907;
