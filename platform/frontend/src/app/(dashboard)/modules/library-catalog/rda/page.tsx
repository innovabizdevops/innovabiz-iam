...
const PAGE = "RDA Standard";
const KPIS = [{"l":"Dashboards Ativos","v":"7.306","t":"+3.9%","d":"up"},{"l":"Queries/Dia","v":"1255","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"2.377","t":"-1.6%","d":"down"},{"l":"Utilizadores Analytics","v":"8.236","t":"+0.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2859","2026-02-25","4.505","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2222","2026-03-10","8.186","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1198","2026-01-25","6.153","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1568","2026-01-18","8.010","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1002","2026-02-09","9.052","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":490},{"label":"Fev","value":443},{"label":"Mar","value":499},{"label":"Abr","value":575},{"label":"Mai","value":434},{"label":"Jun","value":801},{"label":"Jul","value":465},{"label":"Ago","value":581},{"label":"Set","value":584},{"label":"Out","value":572},{"label":"Nov","value":736},{"label":"Dez","value":664}];
const MX = 801;
