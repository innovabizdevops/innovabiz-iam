...
const KPIS = [{"l":"Utilizadores Ativos","v":"1.237","t":"+13.5%","d":"up"},{"l":"Sessões/Dia","v":"1554","t":"+2.1%","d":"up"},{"l":"MFA Adoção (%)","v":"69.0%","t":"-2.1%","d":"down"},{"l":"Tentativas Bloqueadas","v":"4.124","t":"+8.2%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.723","4.165","3.598","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.710","7.156","2.520","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","3.151","4.002","2.364","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.004","4.853","7.118","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","7.841","105","8.639","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":955},{"label":"Fev","value":851},{"label":"Mar","value":715},{"label":"Abr","value":758},{"label":"Mai","value":655},{"label":"Jun","value":962},{"label":"Jul","value":986},{"label":"Ago","value":851},{"label":"Set","value":915},{"label":"Out","value":948},{"label":"Nov","value":629},{"label":"Dez","value":984}];
const MX = 986;
