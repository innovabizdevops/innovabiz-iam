...
const PAGE = "Serials";
const KPIS = [{"l":"Dashboards Ativos","v":"2.121","t":"+12.5%","d":"up"},{"l":"Queries/Dia","v":"4297","t":"+11.1%","d":"up"},{"l":"Dados Processados (GB)","v":"7.102","t":"+0.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.807","t":"+0.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","822","2026-01-18","4.909","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1815","2026-01-06","2.771","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","300","2026-02-21","4.298","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4624","2026-02-11","4.032","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4676","2026-03-03","2.358","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":615},{"label":"Mar","value":339},{"label":"Abr","value":567},{"label":"Mai","value":612},{"label":"Jun","value":583},{"label":"Jul","value":482},{"label":"Ago","value":630},{"label":"Set","value":390},{"label":"Out","value":508},{"label":"Nov","value":472},{"label":"Dez","value":384}];
const MX = 663;
