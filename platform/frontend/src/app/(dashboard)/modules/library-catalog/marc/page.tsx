...
const ACCENT = "#475569";
const MODULE = "Library Catalog";
const PAGE = "MARC Records";
const KPIS = [{"l":"Dashboards Ativos","v":"3.470","t":"+7.4%","d":"up"},{"l":"Queries/Dia","v":"3842","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"5.279","t":"-1.3%","d":"down"},{"l":"Utilizadores Analytics","v":"3.985","t":"-3.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1856","2026-01-16","1.940","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3505","2026-02-27","8.126","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","587","2026-02-09","7.857","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","556","2026-01-10","4.240","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3300","2026-03-25","8.760","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":909},{"label":"Fev","value":864},{"label":"Mar","value":827},{"label":"Abr","value":947},{"label":"Mai","value":880},{"label":"Jun","value":845},{"label":"Jul","value":735},{"label":"Ago","value":655},{"label":"Set","value":985},{"label":"Out","value":780},{"label":"Nov","value":647},{"label":"Dez","value":908}];
const MX = 985;
