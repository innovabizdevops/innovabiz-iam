...
const KPIS = [{"l":"Dashboards Ativos","v":"5.243","t":"+1.1%","d":"up"},{"l":"Queries/Dia","v":"3093","t":"+5.2%","d":"up"},{"l":"Dados Processados (GB)","v":"1.324","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"5.761","t":"+15.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5067","2026-02-09","2.351","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2631","2026-02-04","5.335","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4756","2026-03-04","5.755","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4532","2026-02-24","1.935","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","482","2026-01-21","4.675","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":485},{"label":"Fev","value":322},{"label":"Mar","value":474},{"label":"Abr","value":602},{"label":"Mai","value":323},{"label":"Jun","value":426},{"label":"Jul","value":462},{"label":"Ago","value":396},{"label":"Set","value":396},{"label":"Out","value":466},{"label":"Nov","value":370},{"label":"Dez","value":563}];
const MX = 602;
