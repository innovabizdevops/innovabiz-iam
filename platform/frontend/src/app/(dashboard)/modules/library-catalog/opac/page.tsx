...
const PAGE = "OPAC Search";
const KPIS = [{"l":"Dashboards Ativos","v":"845","t":"+8.1%","d":"up"},{"l":"Queries/Dia","v":"3377","t":"+16.9%","d":"up"},{"l":"Dados Processados (GB)","v":"8.132","t":"+8.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.731","t":"+0.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1212","2026-01-28","3.534","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4979","2026-02-17","4.781","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2930","2026-03-12","8.637","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2081","2026-03-04","560","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","418","2026-03-05","3.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":1054},{"label":"Mar","value":692},{"label":"Abr","value":867},{"label":"Mai","value":959},{"label":"Jun","value":710},{"label":"Jul","value":675},{"label":"Ago","value":682},{"label":"Set","value":772},{"label":"Out","value":686},{"label":"Nov","value":1053},{"label":"Dez","value":1036}];
const MX = 1054;
