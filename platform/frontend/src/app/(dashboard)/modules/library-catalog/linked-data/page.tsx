...
const KPIS = [{"l":"Dashboards Ativos","v":"7.123","t":"+16.1%","d":"up"},{"l":"Queries/Dia","v":"3347","t":"+17.0%","d":"up"},{"l":"Dados Processados (GB)","v":"6.130","t":"+0.8%","d":"up"},{"l":"Utilizadores Analytics","v":"872","t":"+0.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","554","2026-02-14","6.464","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","679","2026-02-18","581","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4561","2026-02-08","8.084","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4665","2026-01-23","6.207","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","875","2026-01-08","3.708","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":1018},{"label":"Mar","value":1057},{"label":"Abr","value":896},{"label":"Mai","value":1076},{"label":"Jun","value":905},{"label":"Jul","value":761},{"label":"Ago","value":1016},{"label":"Set","value":989},{"label":"Out","value":936},{"label":"Nov","value":1073},{"label":"Dez","value":731}];
const MX = 1076;
