...
const PAGE = "Event-Driven Architecture";
const KPIS = [{"l":"Eventos Planeados","v":"2.168","t":"+12.4%","d":"up"},{"l":"Participantes","v":"4.797","t":"+3.9%","d":"up"},{"l":"NPS Evento","v":"92","t":"+7.8%","d":"up"},{"l":"Receita (€)","v":"€43134","t":"+12.6%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-16","3.642","1.410","€ 30055.20","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-14","2.190","2.129","€ 48946.95","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-16","7.714","4.804","€ 32791.54","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-16","5.442","8.352","€ 12353.86","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-13","7.877","1.212","€ 40775.77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":991},{"label":"Fev","value":900},{"label":"Mar","value":834},{"label":"Abr","value":857},{"label":"Mai","value":926},{"label":"Jun","value":712},{"label":"Jul","value":1026},{"label":"Ago","value":647},{"label":"Set","value":812},{"label":"Out","value":825},{"label":"Nov","value":939},{"label":"Dez","value":1020}];
const MX = 1026;
