...
const PAGE = "API Governance";
const KPIS = [{"l":"Riscos Identificados","v":"3.265","t":"+9.3%","d":"up"},{"l":"Mitigações Ativas","v":"3.150","t":"-5.7%","d":"down"},{"l":"Score Risco Geral","v":"72","t":"+11.9%","d":"up"},{"l":"Incidentes YTD","v":"4.585","t":"+12.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.356","3.006","6.854","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.978","3.459","8.517","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.448","2.620","6.150","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.022","2.726","2.673","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.618","3.304","3.279","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":626},{"label":"Fev","value":446},{"label":"Mar","value":533},{"label":"Abr","value":565},{"label":"Mai","value":633},{"label":"Jun","value":584},{"label":"Jul","value":680},{"label":"Ago","value":342},{"label":"Set","value":634},{"label":"Out","value":462},{"label":"Nov","value":545},{"label":"Dez","value":531}];
const MX = 680;
