...
const KPIS = [{"l":"Total Ipaas","v":"4.066","t":"+17.4%","d":"up"},{"l":"Recipe Builder Ativos","v":"8.615","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"66.5%","t":"-4.7%","d":"down"},{"l":"Score Performance","v":"72","t":"+13.8%","d":"up"}];
const COLS = ["ID","Recipe Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ipaas #001","Ipaas #002","1.656","207","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Ipaas #002","Ipaas #003","4.632","1.085","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Ipaas #003","Ipaas #004","6.907","7.497","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Ipaas #004","Ipaas #005","5.949","4.535","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ipaas #005","Ipaas #001","3.072","5.407","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":629},{"label":"Fev","value":692},{"label":"Mar","value":889},{"label":"Abr","value":877},{"label":"Mai","value":714},{"label":"Jun","value":579},{"label":"Jul","value":708},{"label":"Ago","value":825},{"label":"Set","value":774},{"label":"Out","value":775},{"label":"Nov","value":616},{"label":"Dez","value":821}];
const MX = 889;
