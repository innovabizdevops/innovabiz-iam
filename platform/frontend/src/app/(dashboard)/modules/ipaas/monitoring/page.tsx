...
const KPIS = [{"l":"Total Ipaas","v":"8.352","t":"+3.5%","d":"up"},{"l":"Monitoring Ativos","v":"3.901","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"93.7%","t":"+7.2%","d":"up"},{"l":"Score Performance","v":"67","t":"+13.5%","d":"up"}];
const COLS = ["ID","Monitoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ipaas #001","Ipaas #002","3.190","1.801","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Ipaas #002","Ipaas #003","5.012","3.621","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Ipaas #003","Ipaas #004","3.481","249","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Ipaas #004","Ipaas #005","2.964","2.848","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ipaas #005","Ipaas #001","2.267","8.023","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":257},{"label":"Fev","value":606},{"label":"Mar","value":393},{"label":"Abr","value":224},{"label":"Mai","value":259},{"label":"Jun","value":337},{"label":"Jul","value":608},{"label":"Ago","value":541},{"label":"Set","value":601},{"label":"Out","value":336},{"label":"Nov","value":592},{"label":"Dez","value":511}];
const MX = 608;
