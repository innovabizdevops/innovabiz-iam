...
const KPIS = [{"l":"Total Ipaas","v":"2.668","t":"+12.2%","d":"up"},{"l":"Error Handling Ativos","v":"7.071","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"74.7%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"73","t":"-5.2%","d":"down"}];
const COLS = ["ID","Error Handling","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ipaas #001","Ipaas #002","7.136","3.438","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Ipaas #002","Ipaas #003","3.791","7.103","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Ipaas #003","Ipaas #004","2.061","239","2026-01-10","Concluído"],"status":"done"},{"id":"r3","cells":["Ipaas #004","Ipaas #005","5.573","4.389","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ipaas #005","Ipaas #001","7.958","8.064","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":771},{"label":"Mar","value":623},{"label":"Abr","value":774},{"label":"Mai","value":593},{"label":"Jun","value":793},{"label":"Jul","value":810},{"label":"Ago","value":823},{"label":"Set","value":837},{"label":"Out","value":562},{"label":"Nov","value":588},{"label":"Dez","value":699}];
const MX = 954;
