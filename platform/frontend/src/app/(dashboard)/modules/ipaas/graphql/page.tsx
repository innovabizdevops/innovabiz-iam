...
const KPIS = [{"l":"Integrações Ativas","v":"1.514","t":"+10.3%","d":"up"},{"l":"Chamadas/Hora","v":"2092","t":"-3.6%","d":"down"},{"l":"Taxa Sucesso (%)","v":"67.0%","t":"-0.6%","d":"down"},{"l":"Latência Média (ms)","v":"189ms","t":"+13.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.079","4.811","82.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.644","611","98.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.493","5.170","98.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.262","2.265","94.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.148","2.130","72.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":319},{"label":"Fev","value":341},{"label":"Mar","value":656},{"label":"Abr","value":282},{"label":"Mai","value":309},{"label":"Jun","value":457},{"label":"Jul","value":336},{"label":"Ago","value":344},{"label":"Set","value":588},{"label":"Out","value":333},{"label":"Nov","value":370},{"label":"Dez","value":303}];
const MX = 656;
