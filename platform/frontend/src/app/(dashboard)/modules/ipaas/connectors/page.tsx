...
const PAGE = "Pre-Built Connectors";
const KPIS = [{"l":"Integrações Ativas","v":"4.266","t":"+6.4%","d":"up"},{"l":"Chamadas/Hora","v":"4796","t":"+6.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.7%","t":"+13.8%","d":"up"},{"l":"Latência Média (ms)","v":"109ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.104","1.711","80.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","1.822","4.174","92.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.426","2.645","78.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.399","1.208","87.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.523","7.910","89.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":394},{"label":"Fev","value":397},{"label":"Mar","value":418},{"label":"Abr","value":692},{"label":"Mai","value":763},{"label":"Jun","value":591},{"label":"Jul","value":738},{"label":"Ago","value":421},{"label":"Set","value":537},{"label":"Out","value":440},{"label":"Nov","value":592},{"label":"Dez","value":779}];
const MX = 779;
