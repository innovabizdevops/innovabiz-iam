...
const ACCENT = "#6d28d9";
const MODULE = "iPaaS Engine";
const PAGE = "Data Transform";
const KPIS = [{"l":"Formulários Ativos","v":"6.675","t":"+8.1%","d":"up"},{"l":"Submissões/Dia","v":"4357","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"2.332","t":"+2.5%","d":"up"},{"l":"Templates","v":"4.997","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","9.084","2026-01-01","7.430","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.516","2026-03-17","5.003","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.479","2026-01-14","1.336","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.395","2026-03-27","2.947","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.014","2026-02-09","7.359","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":962},{"label":"Mar","value":748},{"label":"Abr","value":598},{"label":"Mai","value":761},{"label":"Jun","value":918},{"label":"Jul","value":819},{"label":"Ago","value":756},{"label":"Set","value":765},{"label":"Out","value":778},{"label":"Nov","value":680},{"label":"Dez","value":870}];
const MX = 962;
