...
const ACCENT = "#d97706";
const MODULE = "Podiatry Services";
const PAGE = "Orthotic";
const KPIS = [{"l":"Total Podiatry Svc","v":"2.993","t":"+10.1%","d":"up"},{"l":"Orthotic Ativos","v":"360","t":"+5.7%","d":"up"},{"l":"Eficiência (%)","v":"94.2%","t":"-4.4%","d":"down"},{"l":"Score Performance","v":"81","t":"+6.8%","d":"up"}];
const COLS = ["ID","Orthotic","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podiatry Svc #001","Podiatry Svc #002","8.751","7.452","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Podiatry Svc #002","Podiatry Svc #003","4.581","4.138","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Podiatry Svc #003","Podiatry Svc #004","1.054","8.216","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Podiatry Svc #004","Podiatry Svc #005","227","4.967","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podiatry Svc #005","Podiatry Svc #001","748","7.370","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":497},{"label":"Fev","value":649},{"label":"Mar","value":692},{"label":"Abr","value":659},{"label":"Mai","value":728},{"label":"Jun","value":367},{"label":"Jul","value":558},{"label":"Ago","value":399},{"label":"Set","value":701},{"label":"Out","value":647},{"label":"Nov","value":347},{"label":"Dez","value":425}];
const MX = 728;
...
export default function OrthoticPage() {
    return (
