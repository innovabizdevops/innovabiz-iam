...
const KPIS = [{"l":"Total Podiatry Svc","v":"7.193","t":"+8.7%","d":"up"},{"l":"Follow Up Ativos","v":"7.688","t":"+3.9%","d":"up"},{"l":"Eficiência (%)","v":"82.5%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"77","t":"+4.3%","d":"up"}];
const COLS = ["ID","Follow Up","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podiatry Svc #001","Podiatry Svc #002","4.724","795","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Podiatry Svc #002","Podiatry Svc #003","2.756","5.451","2026-01-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Podiatry Svc #003","Podiatry Svc #004","762","1.036","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Podiatry Svc #004","Podiatry Svc #005","8.735","3.167","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podiatry Svc #005","Podiatry Svc #001","5.066","1.633","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":527},{"label":"Mar","value":465},{"label":"Abr","value":579},{"label":"Mai","value":826},{"label":"Jun","value":685},{"label":"Jul","value":460},{"label":"Ago","value":790},{"label":"Set","value":821},{"label":"Out","value":683},{"label":"Nov","value":467},{"label":"Dez","value":547}];
const MX = 826;
