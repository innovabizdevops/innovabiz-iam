...
/* ═══ Podiatry Services — Dashboard ═══ */

const ACCENT = "#d97706";

const KPIS = [
    { label: "Total Registos", value: "3116", trend: "+17%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1387", trend: "-11%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€332K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1038671416", cells: ["POD-9416", "Podiatry Services Item 1", "21/5/2026", "€21 516"], status: "active" as const },
    { id: "1038674987", cells: ["POD-3987", "Podiatry Services Item 2", "8/12/2026", "€25 087"], status: "pending" as const },
    { id: "1038678558", cells: ["POD-7558", "Podiatry Services Item 3", "23/7/2026", "€28 658"], status: "completed" as const },
    { id: "1038682129", cells: ["POD-2129", "Podiatry Services Item 4", "10/2/2026", "€32 229"], status: "warning" as const },
    { id: "1038685700", cells: ["POD-5700", "Podiatry Services Item 5", "25/9/2026", "€35 800"], status: "active" as const },
];
...
export default function PodiatryServicesPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Podiatry Services</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Podiatry Services</p>
                    </div>
                </div>
