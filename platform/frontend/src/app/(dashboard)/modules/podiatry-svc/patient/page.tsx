...
const PAGE = "Patient";
const KPIS = [{"l":"Total Podiatry Svc","v":"4.754","t":"-0.4%","d":"down"},{"l":"Patient Ativos","v":"6.956","t":"+17.2%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+8.9%","d":"up"},{"l":"Score Performance","v":"67","t":"+6.5%","d":"up"}];
const COLS = ["ID","Patient","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podiatry Svc #001","Podiatry Svc #002","887","3.097","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Podiatry Svc #002","Podiatry Svc #003","2.464","1.912","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Podiatry Svc #003","Podiatry Svc #004","6.473","7.212","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Podiatry Svc #004","Podiatry Svc #005","6.750","6.115","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podiatry Svc #005","Podiatry Svc #001","1.243","4.792","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":662},{"label":"Fev","value":376},{"label":"Mar","value":557},{"label":"Abr","value":604},{"label":"Mai","value":592},{"label":"Jun","value":565},{"label":"Jul","value":592},{"label":"Ago","value":366},{"label":"Set","value":500},{"label":"Out","value":711},{"label":"Nov","value":347},{"label":"Dez","value":633}];
const MX = 711;
