...
const PAGE = "Exam";
const KPIS = [{"l":"Total Podiatry Svc","v":"3.990","t":"+4.5%","d":"up"},{"l":"Exam Ativos","v":"3.118","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"87.7%","t":"+1.8%","d":"up"},{"l":"Score Performance","v":"82","t":"+3.2%","d":"up"}];
const COLS = ["ID","Exam","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podiatry Svc #001","Podiatry Svc #002","1.393","2.727","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Podiatry Svc #002","Podiatry Svc #003","2.014","4.766","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Podiatry Svc #003","Podiatry Svc #004","8.548","2.214","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Podiatry Svc #004","Podiatry Svc #005","7.282","5.771","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podiatry Svc #005","Podiatry Svc #001","1.188","5.390","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":265},{"label":"Fev","value":430},{"label":"Mar","value":258},{"label":"Abr","value":542},{"label":"Mai","value":264},{"label":"Jun","value":414},{"label":"Jul","value":545},{"label":"Ago","value":357},{"label":"Set","value":470},{"label":"Out","value":627},{"label":"Nov","value":641},{"label":"Dez","value":274}];
const MX = 641;
