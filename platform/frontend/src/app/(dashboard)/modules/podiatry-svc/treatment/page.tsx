...
const KPIS = [{"l":"Total Podiatry Svc","v":"1.291","t":"+13.6%","d":"up"},{"l":"Treatment Ativos","v":"590","t":"+2.1%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+3.4%","d":"up"},{"l":"Score Performance","v":"70","t":"+9.9%","d":"up"}];
const COLS = ["ID","Treatment","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Podiatry Svc #001","Podiatry Svc #002","5.261","3.304","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["Podiatry Svc #002","Podiatry Svc #003","1.587","5.482","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Podiatry Svc #003","Podiatry Svc #004","8.570","5.894","2026-03-28","Concluído"],"status":"done"},{"id":"r3","cells":["Podiatry Svc #004","Podiatry Svc #005","5.185","7.236","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Podiatry Svc #005","Podiatry Svc #001","8.673","6.100","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":936},{"label":"Mar","value":635},{"label":"Abr","value":895},{"label":"Mai","value":711},{"label":"Jun","value":759},{"label":"Jul","value":868},{"label":"Ago","value":665},{"label":"Set","value":895},{"label":"Out","value":897},{"label":"Nov","value":615},{"label":"Dez","value":666}];
const MX = 936;
