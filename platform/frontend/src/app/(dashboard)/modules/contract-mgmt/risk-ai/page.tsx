...
const PAGE = "Risk Scoring AI";
const KPIS = [{"l":"Riscos Identificados","v":"2.774","t":"+16.0%","d":"up"},{"l":"Mitigações Ativas","v":"3.408","t":"+5.2%","d":"up"},{"l":"Score Risco Geral","v":"90","t":"+0.7%","d":"up"},{"l":"Incidentes YTD","v":"7.785","t":"+14.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.190","1.412","1.081","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.632","4.404","4.665","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.105","2.429","8.995","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.156","6.161","2.202","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.650","8.482","7.393","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":667},{"label":"Mar","value":574},{"label":"Abr","value":752},{"label":"Mai","value":721},{"label":"Jun","value":736},{"label":"Jul","value":627},{"label":"Ago","value":508},{"label":"Set","value":512},{"label":"Out","value":615},{"label":"Nov","value":792},{"label":"Dez","value":671}];
const MX = 792;
