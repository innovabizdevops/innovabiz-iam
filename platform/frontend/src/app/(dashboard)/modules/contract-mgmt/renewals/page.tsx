...
const PAGE = "Renewal Alerts";
const KPIS = [{"l":"Notificações Enviadas","v":"4.476","t":"+14.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"79.4%","t":"+7.1%","d":"up"},{"l":"Taxa Abertura (%)","v":"67.8%","t":"+16.1%","d":"up"},{"l":"Escalações","v":"2.823","t":"+9.8%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.794","92.5%","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.001","70.5%","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.135","97.5%","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","3.082","81.5%","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.560","77.9%","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":287},{"label":"Fev","value":499},{"label":"Mar","value":308},{"label":"Abr","value":422},{"label":"Mai","value":290},{"label":"Jun","value":438},{"label":"Jul","value":508},{"label":"Ago","value":386},{"label":"Set","value":523},{"label":"Out","value":387},{"label":"Nov","value":292},{"label":"Dez","value":300}];
const MX = 523;
