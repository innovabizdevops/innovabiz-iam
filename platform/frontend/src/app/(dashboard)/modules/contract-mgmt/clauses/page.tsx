...
const PAGE = "Clause Library";
const KPIS = [{"l":"Contratos Ativos","v":"5.888","t":"+12.2%","d":"up"},{"l":"Valor Total (€M)","v":"€29.9M","t":"-4.9%","d":"down"},{"l":"Renovações Próx. 30d","v":"123","t":"-4.0%","d":"down"},{"l":"Obrigações Pendentes","v":"9.099","t":"-0.9%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 26796.49","2026-01-16","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 31016.21","2026-01-02","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 11865.61","2026-01-06","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 38369.42","2026-01-11","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 42482.29","2026-03-10","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":575},{"label":"Fev","value":453},{"label":"Mar","value":579},{"label":"Abr","value":697},{"label":"Mai","value":596},{"label":"Jun","value":428},{"label":"Jul","value":653},{"label":"Ago","value":499},{"label":"Set","value":646},{"label":"Out","value":667},{"label":"Nov","value":614},{"label":"Dez","value":473}];
const MX = 697;
