...
const PAGE = "Contract Creator";
const KPIS = [{"l":"Contratos Ativos","v":"5.982","t":"-2.6%","d":"down"},{"l":"Valor Total (€M)","v":"€11.5M","t":"-6.0%","d":"down"},{"l":"Renovações Próx. 30d","v":"3.076","t":"+13.3%","d":"up"},{"l":"Obrigações Pendentes","v":"7.740","t":"+16.1%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 36291.16","2026-01-13","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 2442.96","2026-01-26","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 3429.67","2026-02-16","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 39388.65","2026-01-22","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 34647.95","2026-02-24","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":754},{"label":"Fev","value":730},{"label":"Mar","value":530},{"label":"Abr","value":401},{"label":"Mai","value":713},{"label":"Jun","value":496},{"label":"Jul","value":575},{"label":"Ago","value":716},{"label":"Set","value":680},{"label":"Out","value":536},{"label":"Nov","value":521},{"label":"Dez","value":683}];
const MX = 754;
