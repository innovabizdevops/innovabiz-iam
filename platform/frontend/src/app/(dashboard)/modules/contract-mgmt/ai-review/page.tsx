...
const ACCENT = "#4338ca";
const MODULE = "Contract Management";
const PAGE = "AI Clause Review";
const KPIS = [{"l":"Contratos Ativos","v":"2.920","t":"-0.9%","d":"down"},{"l":"Valor Total (€M)","v":"€37.0M","t":"+10.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.986","t":"+16.2%","d":"up"},{"l":"Obrigações Pendentes","v":"490","t":"+3.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 21237.49","2026-01-10","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 45110.49","2026-03-02","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 18170.49","2026-01-07","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 14204.32","2026-01-27","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 20937.83","2026-01-05","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":258},{"label":"Fev","value":578},{"label":"Mar","value":331},{"label":"Abr","value":407},{"label":"Mai","value":461},{"label":"Jun","value":262},{"label":"Jul","value":426},{"label":"Ago","value":276},{"label":"Set","value":504},{"label":"Out","value":338},{"label":"Nov","value":314},{"label":"Dez","value":492}];
const MX = 578;
