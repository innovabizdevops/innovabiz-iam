...
const KPIS = [{"l":"Formulários Ativos","v":"3.156","t":"-3.9%","d":"down"},{"l":"Submissões/Dia","v":"1785","t":"-4.1%","d":"down"},{"l":"Documentos Gerados","v":"363","t":"+14.9%","d":"up"},{"l":"Templates","v":"4.305","t":"+15.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.637","2026-02-07","242","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.972","2026-03-26","3.481","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.777","2026-02-27","7.227","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.458","2026-02-05","6.546","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.977","2026-02-26","205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":406},{"label":"Fev","value":242},{"label":"Mar","value":375},{"label":"Abr","value":531},{"label":"Mai","value":490},{"label":"Jun","value":487},{"label":"Jul","value":241},{"label":"Ago","value":293},{"label":"Set","value":611},{"label":"Out","value":534},{"label":"Nov","value":531},{"label":"Dez","value":619}];
const MX = 619;
