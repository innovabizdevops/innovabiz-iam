...
const PAGE = "Template Generator";
const KPIS = [{"l":"Formulários Ativos","v":"7.700","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"2400","t":"+12.2%","d":"up"},{"l":"Documentos Gerados","v":"610","t":"-3.6%","d":"down"},{"l":"Templates","v":"7.892","t":"-2.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.408","2026-02-11","8.174","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.724","2026-02-04","4.135","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.000","2026-03-17","5.049","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.137","2026-03-11","6.814","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","407","2026-03-18","4.003","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":533},{"label":"Mar","value":492},{"label":"Abr","value":476},{"label":"Mai","value":718},{"label":"Jun","value":403},{"label":"Jul","value":619},{"label":"Ago","value":421},{"label":"Set","value":662},{"label":"Out","value":582},{"label":"Nov","value":388},{"label":"Dez","value":513}];
const MX = 718;
