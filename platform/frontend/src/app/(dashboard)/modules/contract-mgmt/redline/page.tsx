...
const PAGE = "Redline &amp; Negotiation";
const KPIS = [{"l":"Contratos Ativos","v":"7.638","t":"+17.3%","d":"up"},{"l":"Valor Total (€M)","v":"€36.6M","t":"+2.9%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.770","t":"+9.3%","d":"up"},{"l":"Obrigações Pendentes","v":"7.058","t":"+4.2%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 19444.11","2026-01-08","2026-01-26","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 28647.85","2026-01-19","2026-01-25","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 44509.67","2026-02-16","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 22099.65","2026-03-23","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 29213.77","2026-02-01","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":688},{"label":"Mar","value":428},{"label":"Abr","value":718},{"label":"Mai","value":725},{"label":"Jun","value":419},{"label":"Jul","value":422},{"label":"Ago","value":412},{"label":"Set","value":489},{"label":"Out","value":736},{"label":"Nov","value":709},{"label":"Dez","value":665}];
const MX = 736;
