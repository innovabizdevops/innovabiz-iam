...
const PAGE = "Photo Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"7.619","t":"+14.0%","d":"up"},{"l":"RevPAR (€)","v":"€38321","t":"+5.6%","d":"up"},{"l":"Ocupação (%)","v":"83.2%","t":"+16.2%","d":"up"},{"l":"Guest Satisfaction","v":"6.971","t":"+3.0%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.185","2026-02-09","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.483","2026-01-13","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.628","2026-01-01","2026-01-28","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.800","2026-01-10","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.775","2026-01-26","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":879},{"label":"Mar","value":883},{"label":"Abr","value":884},{"label":"Mai","value":943},{"label":"Jun","value":636},{"label":"Jul","value":786},{"label":"Ago","value":912},{"label":"Set","value":609},{"label":"Out","value":666},{"label":"Nov","value":768},{"label":"Dez","value":721}];
const MX = 943;
