...
const PAGE = "Star/Dog Matrix";
const KPIS = [{"l":"Quartos Ocupados","v":"7.029","t":"-2.9%","d":"down"},{"l":"RevPAR (€)","v":"€42519","t":"+10.2%","d":"up"},{"l":"Ocupação (%)","v":"82.3%","t":"+3.5%","d":"up"},{"l":"Guest Satisfaction","v":"3.201","t":"+2.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.081","2026-02-11","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.294","2026-02-13","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.511","2026-01-12","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.393","2026-02-15","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.093","2026-03-22","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":721},{"label":"Mar","value":570},{"label":"Abr","value":621},{"label":"Mai","value":436},{"label":"Jun","value":546},{"label":"Jul","value":531},{"label":"Ago","value":615},{"label":"Set","value":750},{"label":"Out","value":809},{"label":"Nov","value":609},{"label":"Dez","value":595}];
const MX = 809;
