...
const ACCENT = "#059669";
const MODULE = "Menu Engineering";
const PAGE = "Price Optimize";
const KPIS = [{"l":"ARR (€M)","v":"€15.7M","t":"+15.9%","d":"up"},{"l":"MRR (€)","v":"€41930","t":"+3.5%","d":"up"},{"l":"Churn (%)","v":"88.3%","t":"+14.4%","d":"up"},{"l":"ARPU (€)","v":"€6638","t":"+9.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 43423.91","4.391","€ 9956.36","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42895.69","8.351","€ 42991.60","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45972.28","1.583","€ 403.21","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 41621.18","8.588","€ 41504.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 35574.53","7.322","€ 33559.04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":686},{"label":"Mar","value":854},{"label":"Abr","value":675},{"label":"Mai","value":772},{"label":"Jun","value":791},{"label":"Jul","value":867},{"label":"Ago","value":767},{"label":"Set","value":974},{"label":"Out","value":894},{"label":"Nov","value":869},{"label":"Dez","value":910}];
const MX = 974;
