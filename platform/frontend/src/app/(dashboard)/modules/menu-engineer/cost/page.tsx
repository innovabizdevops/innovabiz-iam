...
const PAGE = "Cost Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"4.319","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"4598","t":"+7.0%","d":"up"},{"l":"Dados Processados (GB)","v":"5.401","t":"+6.1%","d":"up"},{"l":"Utilizadores Analytics","v":"8.105","t":"+2.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1594","2026-03-15","6.295","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4542","2026-03-22","2.825","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","660","2026-01-19","4.218","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4110","2026-01-13","4.425","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1125","2026-01-10","7.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":564},{"label":"Mar","value":654},{"label":"Abr","value":703},{"label":"Mai","value":710},{"label":"Jun","value":843},{"label":"Jul","value":778},{"label":"Ago","value":798},{"label":"Set","value":760},{"label":"Out","value":650},{"label":"Nov","value":598},{"label":"Dez","value":694}];
const MX = 843;
