...
const PAGE = "Seasonal Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"2.086","t":"+9.0%","d":"up"},{"l":"RevPAR (€)","v":"€4313","t":"-1.2%","d":"down"},{"l":"Ocupação (%)","v":"86.5%","t":"+13.9%","d":"up"},{"l":"Guest Satisfaction","v":"8.141","t":"+1.4%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.184","2026-03-26","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.975","2026-01-07","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","1.079","2026-03-03","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","4.838","2026-02-20","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.584","2026-01-19","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":829},{"label":"Fev","value":963},{"label":"Mar","value":877},{"label":"Abr","value":660},{"label":"Mai","value":879},{"label":"Jun","value":765},{"label":"Jul","value":980},{"label":"Ago","value":606},{"label":"Set","value":756},{"label":"Out","value":942},{"label":"Nov","value":766},{"label":"Dez","value":843}];
const MX = 980;
