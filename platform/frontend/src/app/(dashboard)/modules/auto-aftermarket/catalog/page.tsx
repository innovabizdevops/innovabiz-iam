...
const PAGE = "Catalog";
const KPIS = [{"l":"Riscos Identificados","v":"174","t":"+6.2%","d":"up"},{"l":"Mitigações Ativas","v":"3.192","t":"-1.7%","d":"down"},{"l":"Score Risco Geral","v":"89","t":"+2.3%","d":"up"},{"l":"Incidentes YTD","v":"1.513","t":"+10.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","764","3.953","4.024","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","818","8.897","3.977","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.798","1.631","7.809","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.304","6.396","8.071","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.274","8.957","2.650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":421},{"label":"Fev","value":596},{"label":"Mar","value":709},{"label":"Abr","value":532},{"label":"Mai","value":602},{"label":"Jun","value":620},{"label":"Jul","value":488},{"label":"Ago","value":630},{"label":"Set","value":398},{"label":"Out","value":371},{"label":"Nov","value":533},{"label":"Dez","value":573}];
const MX = 709;
