...
const PAGE = "Order";
const KPIS = [{"l":"Riscos Identificados","v":"1.634","t":"+14.8%","d":"up"},{"l":"Mitigações Ativas","v":"4.513","t":"+7.2%","d":"up"},{"l":"Score Risco Geral","v":"73","t":"+16.2%","d":"up"},{"l":"Incidentes YTD","v":"9.053","t":"+11.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.373","1.027","4.416","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.887","1.651","8.186","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.861","2.628","3.079","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.006","4.618","4.372","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","151","915","293","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":672},{"label":"Mar","value":667},{"label":"Abr","value":562},{"label":"Mai","value":486},{"label":"Jun","value":734},{"label":"Jul","value":597},{"label":"Ago","value":478},{"label":"Set","value":735},{"label":"Out","value":400},{"label":"Nov","value":723},{"label":"Dez","value":547}];
const MX = 735;
