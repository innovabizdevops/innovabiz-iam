...
/* ═══ Automotive Aftermarket — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "6059", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3490", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€296K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "513875359", cells: ["AUT-3359", "Automotive Aftermarket Item 1", "12/8/2026", "€25 459"], status: "active" as const },
    { id: "513878930", cells: ["AUT-6930", "Automotive Aftermarket Item 2", "27/3/2026", "€29 030"], status: "pending" as const },
    { id: "513882501", cells: ["AUT-1501", "Automotive Aftermarket Item 3", "14/10/2026", "€32 601"], status: "completed" as const },
    { id: "513886072", cells: ["AUT-5072", "Automotive Aftermarket Item 4", "1/5/2026", "€36 172"], status: "warning" as const },
    { id: "513889643", cells: ["AUT-8643", "Automotive Aftermarket Item 5", "16/12/2026", "€39 743"], status: "active" as const },
];
...
export default function AutomotiveAftermarketPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Automotive Aftermarket</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Automotive Aftermarket</p>
                    </div>
                </div>
