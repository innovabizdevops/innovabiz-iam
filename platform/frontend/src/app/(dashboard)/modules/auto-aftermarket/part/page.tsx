...
const PAGE = "Part";
const KPIS = [{"l":"Riscos Identificados","v":"5.708","t":"+12.2%","d":"up"},{"l":"Mitigações Ativas","v":"2.152","t":"+14.7%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+3.6%","d":"up"},{"l":"Incidentes YTD","v":"4.700","t":"-0.9%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.460","5.950","522","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","734","2.071","7.337","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.127","8.583","106","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.210","2.519","494","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.703","1.770","377","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":791},{"label":"Fev","value":513},{"label":"Mar","value":598},{"label":"Abr","value":666},{"label":"Mai","value":726},{"label":"Jun","value":595},{"label":"Jul","value":621},{"label":"Ago","value":826},{"label":"Set","value":456},{"label":"Out","value":759},{"label":"Nov","value":624},{"label":"Dez","value":608}];
const MX = 826;
