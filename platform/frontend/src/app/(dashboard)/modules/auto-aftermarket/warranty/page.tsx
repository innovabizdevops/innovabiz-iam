...
const ACCENT = "#1e3a5f";
const MODULE = "Automotive Aftermarket";
const PAGE = "Warranty";
const KPIS = [{"l":"Riscos Identificados","v":"6.975","t":"+11.1%","d":"up"},{"l":"Mitigações Ativas","v":"6.419","t":"-5.5%","d":"down"},{"l":"Score Risco Geral","v":"77","t":"+12.0%","d":"up"},{"l":"Incidentes YTD","v":"1.633","t":"-3.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.389","4.781","1.229","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.662","8.449","4.911","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.569","4.355","4.701","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.516","6.084","5.908","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.592","2.174","616","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":628},{"label":"Mar","value":396},{"label":"Abr","value":545},{"label":"Mai","value":508},{"label":"Jun","value":417},{"label":"Jul","value":421},{"label":"Ago","value":682},{"label":"Set","value":726},{"label":"Out","value":478},{"label":"Nov","value":759},{"label":"Dez","value":739}];
const MX = 759;
