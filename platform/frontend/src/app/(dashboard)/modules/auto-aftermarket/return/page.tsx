...
const PAGE = "Return";
const KPIS = [{"l":"Riscos Identificados","v":"5.257","t":"-4.3%","d":"down"},{"l":"Mitigações Ativas","v":"7.655","t":"+10.7%","d":"up"},{"l":"Score Risco Geral","v":"82","t":"+0.3%","d":"up"},{"l":"Incidentes YTD","v":"7.256","t":"+0.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.255","8.872","4.863","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","895","5.965","4.823","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.209","1.389","5.272","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.606","8.467","4.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.898","5.149","2.132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":330},{"label":"Fev","value":501},{"label":"Mar","value":276},{"label":"Abr","value":440},{"label":"Mai","value":409},{"label":"Jun","value":336},{"label":"Jul","value":363},{"label":"Ago","value":303},{"label":"Set","value":528},{"label":"Out","value":421},{"label":"Nov","value":486},{"label":"Dez","value":540}];
const MX = 540;
