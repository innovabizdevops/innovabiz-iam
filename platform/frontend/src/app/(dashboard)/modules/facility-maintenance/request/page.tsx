...
const PAGE = "Request";
const KPIS = [{"l":"Total Facility Maintenance","v":"2.071","t":"+4.3%","d":"up"},{"l":"Request Ativos","v":"1.919","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"65.5%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"77","t":"+11.1%","d":"up"}];
const COLS = ["ID","Request","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Maintenance #001","Facility Maintenance #002","5.775","5.363","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Maintenance #002","Facility Maintenance #003","7.937","1.324","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Maintenance #003","Facility Maintenance #004","8.325","2.044","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Maintenance #004","Facility Maintenance #005","2.745","1.883","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Maintenance #005","Facility Maintenance #001","2.610","560","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":537},{"label":"Fev","value":592},{"label":"Mar","value":675},{"label":"Abr","value":503},{"label":"Mai","value":665},{"label":"Jun","value":734},{"label":"Jul","value":558},{"label":"Ago","value":715},{"label":"Set","value":522},{"label":"Out","value":763},{"label":"Nov","value":779},{"label":"Dez","value":670}];
const MX = 779;
