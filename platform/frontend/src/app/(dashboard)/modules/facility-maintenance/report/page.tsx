...
const PAGE = "Report";
const KPIS = [{"l":"Total Facility Maintenance","v":"1.780","t":"+10.8%","d":"up"},{"l":"Report Ativos","v":"7.567","t":"-1.6%","d":"down"},{"l":"Eficiência (%)","v":"94.7%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"87","t":"-2.8%","d":"down"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Maintenance #001","Facility Maintenance #002","5.273","5.666","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Maintenance #002","Facility Maintenance #003","173","6.524","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Maintenance #003","Facility Maintenance #004","4.438","423","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Maintenance #004","Facility Maintenance #005","984","5.485","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Maintenance #005","Facility Maintenance #001","7.872","5.697","2026-03-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":548},{"label":"Fev","value":717},{"label":"Mar","value":466},{"label":"Abr","value":736},{"label":"Mai","value":483},{"label":"Jun","value":687},{"label":"Jul","value":599},{"label":"Ago","value":655},{"label":"Set","value":490},{"label":"Out","value":700},{"label":"Nov","value":469},{"label":"Dez","value":472}];
const MX = 736;
