...
const PAGE = "PM";
const KPIS = [{"l":"Total Facility Maintenance","v":"271","t":"+7.5%","d":"up"},{"l":"PM Ativos","v":"1.698","t":"+16.9%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"71","t":"-5.1%","d":"down"}];
const COLS = ["ID","PM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Maintenance #001","Facility Maintenance #002","3.556","1.399","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Maintenance #002","Facility Maintenance #003","3.131","7.759","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Maintenance #003","Facility Maintenance #004","2.701","5.310","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Maintenance #004","Facility Maintenance #005","1.675","8.354","2026-01-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Maintenance #005","Facility Maintenance #001","2.770","1.828","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":291},{"label":"Fev","value":583},{"label":"Mar","value":386},{"label":"Abr","value":336},{"label":"Mai","value":582},{"label":"Jun","value":589},{"label":"Jul","value":603},{"label":"Ago","value":312},{"label":"Set","value":278},{"label":"Out","value":326},{"label":"Nov","value":602},{"label":"Dez","value":378}];
const MX = 603;
