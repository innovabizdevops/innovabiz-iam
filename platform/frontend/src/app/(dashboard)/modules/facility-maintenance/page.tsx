...
/* ═══ Facility Maintenance (CMMS) — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "5768", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "340", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€403K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+1%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2075609968", cells: ["FAC-3968", "Facility Maintenance (CMMS) Item 1", "13/5/2026", "€10 068"], status: "active" as const },
    { id: "2075613539", cells: ["FAC-7539", "Facility Maintenance (CMMS) Item 2", "28/12/2026", "€13 639"], status: "pending" as const },
    { id: "2075617110", cells: ["FAC-2110", "Facility Maintenance (CMMS) Item 3", "15/7/2026", "€17 210"], status: "completed" as const },
    { id: "2075620681", cells: ["FAC-5681", "Facility Maintenance (CMMS) Item 4", "2/2/2026", "€20 781"], status: "warning" as const },
    { id: "2075624252", cells: ["FAC-9252", "Facility Maintenance (CMMS) Item 5", "17/9/2026", "€24 352"], status: "active" as const },
];
...
export default function FacilityMaintenanceCmmsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Facility Maintenance (CMMS)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Facility Maintenance (CMMS)</p>
                    </div>
                </div>
