...
const PAGE = "Spare";
const KPIS = [{"l":"Quartos Ocupados","v":"4.406","t":"+17.0%","d":"up"},{"l":"RevPAR (€)","v":"€54159","t":"-5.6%","d":"down"},{"l":"Ocupação (%)","v":"75.0%","t":"-3.8%","d":"down"},{"l":"Guest Satisfaction","v":"3.753","t":"+16.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.567","2026-02-28","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","830","2026-01-02","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","5.423","2026-02-04","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.051","2026-02-23","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.192","2026-03-15","2026-01-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":578},{"label":"Mar","value":662},{"label":"Abr","value":815},{"label":"Mai","value":865},{"label":"Jun","value":629},{"label":"Jul","value":792},{"label":"Ago","value":766},{"label":"Set","value":850},{"label":"Out","value":634},{"label":"Nov","value":764},{"label":"Dez","value":673}];
const MX = 865;
