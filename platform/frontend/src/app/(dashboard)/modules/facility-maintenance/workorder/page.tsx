...
const ACCENT = "#92400e";
const MODULE = "Facility Maintenance (CMMS)";
const PAGE = "Work Order";
const KPIS = [{"l":"Total Facility Maintenance","v":"592","t":"+7.2%","d":"up"},{"l":"Work Order Ativos","v":"7.515","t":"+11.9%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"90","t":"+6.0%","d":"up"}];
const COLS = ["ID","Work Order","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Facility Maintenance #001","Facility Maintenance #002","8.031","2.690","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Facility Maintenance #002","Facility Maintenance #003","9.099","5.863","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Facility Maintenance #003","Facility Maintenance #004","1.308","4.384","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Facility Maintenance #004","Facility Maintenance #005","5.897","3.470","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Facility Maintenance #005","Facility Maintenance #001","525","1.318","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":250},{"label":"Mar","value":396},{"label":"Abr","value":293},{"label":"Mai","value":433},{"label":"Jun","value":407},{"label":"Jul","value":350},{"label":"Ago","value":428},{"label":"Set","value":466},{"label":"Out","value":251},{"label":"Nov","value":601},{"label":"Dez","value":422}];
const MX = 606;
