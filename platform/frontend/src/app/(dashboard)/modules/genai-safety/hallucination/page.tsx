...
const PAGE = "Hallucination";
const KPIS = [{"l":"Total Genai Safety","v":"291","t":"+1.7%","d":"up"},{"l":"Hallucination Ativos","v":"1.589","t":"+3.4%","d":"up"},{"l":"Eficiência (%)","v":"90.0%","t":"+15.6%","d":"up"},{"l":"Score Performance","v":"69","t":"+11.1%","d":"up"}];
const COLS = ["ID","Hallucination","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Safety #001","Genai Safety #002","4.468","5.212","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Safety #002","Genai Safety #003","7.404","2.126","2026-01-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Safety #003","Genai Safety #004","6.812","8.299","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Safety #004","Genai Safety #005","3.576","4.495","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Safety #005","Genai Safety #001","4.094","124","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":738},{"label":"Mar","value":798},{"label":"Abr","value":549},{"label":"Mai","value":606},{"label":"Jun","value":495},{"label":"Jul","value":795},{"label":"Ago","value":536},{"label":"Set","value":715},{"label":"Out","value":540},{"label":"Nov","value":774},{"label":"Dez","value":504}];
const MX = 798;
