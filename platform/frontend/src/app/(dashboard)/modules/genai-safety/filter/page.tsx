...
const PAGE = "Content Filter";
const KPIS = [{"l":"Total Genai Safety","v":"262","t":"+7.8%","d":"up"},{"l":"Content Filter Ativos","v":"7.583","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"75.0%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"69","t":"-1.6%","d":"down"}];
const COLS = ["ID","Content Filter","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Safety #001","Genai Safety #002","324","2.296","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Safety #002","Genai Safety #003","1.517","3.407","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Safety #003","Genai Safety #004","5.400","3.245","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Safety #004","Genai Safety #005","6.983","5.949","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Safety #005","Genai Safety #001","3.772","5.541","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":646},{"label":"Fev","value":751},{"label":"Mar","value":865},{"label":"Abr","value":839},{"label":"Mai","value":674},{"label":"Jun","value":857},{"label":"Jul","value":908},{"label":"Ago","value":1001},{"label":"Set","value":910},{"label":"Out","value":652},{"label":"Nov","value":676},{"label":"Dez","value":783}];
const MX = 1001;
