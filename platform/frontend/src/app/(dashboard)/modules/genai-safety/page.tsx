...
/* ═══ GenAI Safety & Alignment — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "7034", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3999", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€228K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+17%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "634844434", cells: ["GEN-3434", "GenAI Safety & Alignment Item 1", "15/11/2026", "€44 534"], status: "active" as const },
    { id: "634848005", cells: ["GEN-7005", "GenAI Safety & Alignment Item 2", "2/6/2026", "€48 105"], status: "pending" as const },
    { id: "634851576", cells: ["GEN-1576", "GenAI Safety & Alignment Item 3", "17/1/2026", "€1676"], status: "completed" as const },
    { id: "634855147", cells: ["GEN-5147", "GenAI Safety & Alignment Item 4", "4/8/2026", "€5247"], status: "warning" as const },
    { id: "634858718", cells: ["GEN-8718", "GenAI Safety & Alignment Item 5", "19/3/2026", "€8818"], status: "active" as const },
];
...
export default function GenaiSafetyAlignmentPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Safety & Alignment</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Safety & Alignment</p>
                    </div>
                </div>
