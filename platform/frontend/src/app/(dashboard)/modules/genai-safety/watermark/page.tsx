...
const KPIS = [{"l":"Riscos Identificados","v":"8.987","t":"+14.8%","d":"up"},{"l":"Mitigações Ativas","v":"5.621","t":"-2.9%","d":"down"},{"l":"Score Risco Geral","v":"58","t":"+10.8%","d":"up"},{"l":"Incidentes YTD","v":"8.540","t":"+14.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.842","1.292","6.077","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","966","2.038","3.235","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.620","6.009","194","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.960","300","5.422","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.756","2.773","7.813","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":856},{"label":"Fev","value":743},{"label":"Mar","value":775},{"label":"Abr","value":934},{"label":"Mai","value":976},{"label":"Jun","value":768},{"label":"Jul","value":859},{"label":"Ago","value":887},{"label":"Set","value":789},{"label":"Out","value":1016},{"label":"Nov","value":748},{"label":"Dez","value":714}];
const MX = 1016;
