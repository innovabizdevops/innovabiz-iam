...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Safety & Alignment";
const PAGE = "Bias Detect";
const KPIS = [{"l":"BCP Plans Ativos","v":"5.816","t":"+0.6%","d":"up"},{"l":"RTO Médio (h)","v":"64h","t":"+2.3%","d":"up"},{"l":"RPO Médio (h)","v":"37h","t":"+12.8%","d":"up"},{"l":"Testes DR (YTD)","v":"2.891","t":"+5.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","136h","191h","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","53h","112h","2026-02-14","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","46h","28h","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","28h","117h","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","119h","123h","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":735},{"label":"Mar","value":916},{"label":"Abr","value":814},{"label":"Mai","value":802},{"label":"Jun","value":848},{"label":"Jul","value":724},{"label":"Ago","value":1040},{"label":"Set","value":974},{"label":"Out","value":884},{"label":"Nov","value":1039},{"label":"Dez","value":801}];
const MX = 1040;
