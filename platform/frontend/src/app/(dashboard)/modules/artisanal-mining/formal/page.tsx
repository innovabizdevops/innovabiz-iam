...
const PAGE = "Formalize";
const KPIS = [{"l":"Formulários Ativos","v":"8.159","t":"+7.8%","d":"up"},{"l":"Submissões/Dia","v":"1050","t":"+12.5%","d":"up"},{"l":"Documentos Gerados","v":"429","t":"-5.9%","d":"down"},{"l":"Templates","v":"3.474","t":"-1.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.471","2026-01-12","1.098","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.206","2026-01-01","7.876","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.846","2026-02-20","197","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.506","2026-02-05","7.615","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.795","2026-01-10","4.029","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":747},{"label":"Mar","value":847},{"label":"Abr","value":637},{"label":"Mai","value":807},{"label":"Jun","value":802},{"label":"Jul","value":750},{"label":"Ago","value":661},{"label":"Set","value":795},{"label":"Out","value":883},{"label":"Nov","value":829},{"label":"Dez","value":759}];
const MX = 920;
