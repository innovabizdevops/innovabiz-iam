...
const KPIS = [{"l":"Projetos Sociais","v":"8.267","t":"+3.5%","d":"up"},{"l":"Beneficiários","v":"6.286","t":"+2.4%","d":"up"},{"l":"Investimento CSR (€)","v":"€32884","t":"+17.1%","d":"up"},{"l":"Score Impacto","v":"86","t":"+11.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","8.488","€ 34197.73","8.866","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.583","€ 24581.90","7.316","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","7.076","€ 39941.20","4.209","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","2.408","€ 12994.26","865","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","5.208","€ 14955.64","839","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":722},{"label":"Mar","value":644},{"label":"Abr","value":375},{"label":"Mai","value":535},{"label":"Jun","value":684},{"label":"Jul","value":720},{"label":"Ago","value":687},{"label":"Set","value":692},{"label":"Out","value":361},{"label":"Nov","value":722},{"label":"Dez","value":549}];
const MX = 722;
