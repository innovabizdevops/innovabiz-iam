...
const ACCENT = "#6366f1";
const MODULE = "Artisanal Mining";
const PAGE = "Mercury Free";
const KPIS = [{"l":"Total Artisanal Mining","v":"4.585","t":"+8.8%","d":"up"},{"l":"Mercury Free Ativos","v":"3.261","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"67.0%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"73","t":"+9.0%","d":"up"}];
const COLS = ["ID","Mercury Free","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Artisanal Mining #001","Artisanal Mining #002","4.311","4.819","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Artisanal Mining #002","Artisanal Mining #003","8.478","1.295","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Artisanal Mining #003","Artisanal Mining #004","4.175","3.406","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Artisanal Mining #004","Artisanal Mining #005","4.493","4.639","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Artisanal Mining #005","Artisanal Mining #001","1.581","8.525","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":605},{"label":"Mar","value":722},{"label":"Abr","value":463},{"label":"Mai","value":465},{"label":"Jun","value":748},{"label":"Jul","value":590},{"label":"Ago","value":720},{"label":"Set","value":438},{"label":"Out","value":504},{"label":"Nov","value":695},{"label":"Dez","value":531}];
const MX = 748;
