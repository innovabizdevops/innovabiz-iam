...
const KPIS = [{"l":"ARR (€M)","v":"€7.0M","t":"-5.7%","d":"down"},{"l":"MRR (€)","v":"€38779","t":"-3.1%","d":"down"},{"l":"Churn (%)","v":"80.3%","t":"+3.4%","d":"up"},{"l":"ARPU (€)","v":"€29288","t":"+7.4%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 10427.07","4.994","€ 44062.81","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11381.38","7.691","€ 39604.20","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 6878.84","4.039","€ 14525.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 4710.21","6.071","€ 3431.72","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 15530.99","4.107","€ 9614.25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":999},{"label":"Fev","value":666},{"label":"Mar","value":850},{"label":"Abr","value":817},{"label":"Mai","value":812},{"label":"Jun","value":961},{"label":"Jul","value":690},{"label":"Ago","value":721},{"label":"Set","value":654},{"label":"Out","value":828},{"label":"Nov","value":807},{"label":"Dez","value":784}];
const MX = 999;
