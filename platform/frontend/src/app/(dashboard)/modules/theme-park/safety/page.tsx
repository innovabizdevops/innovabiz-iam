...
const PAGE = "Safety Check";
const KPIS = [{"l":"Configurações","v":"6.263","t":"+13.0%","d":"up"},{"l":"Últimas Alterações","v":"6.113","t":"+0.3%","d":"up"},{"l":"Ambientes","v":"5.504","t":"-4.9%","d":"down"},{"l":"Versão Config","v":"2.256","t":"+14.2%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 31472.79","5.948","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 39115.29","7.169","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 19007.38","7.611","2026-01-03","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 7541.56","4.417","2026-02-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 35348.94","1.615","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":851},{"label":"Fev","value":657},{"label":"Mar","value":963},{"label":"Abr","value":715},{"label":"Mai","value":896},{"label":"Jun","value":958},{"label":"Jul","value":675},{"label":"Ago","value":930},{"label":"Set","value":717},{"label":"Out","value":951},{"label":"Nov","value":878},{"label":"Dez","value":780}];
const MX = 963;
