...
const ACCENT = "#c2410c";
const MODULE = "Theme Park Ops";
const PAGE = "Ride Monitor";
const KPIS = [{"l":"Configurações","v":"2.814","t":"+2.4%","d":"up"},{"l":"Últimas Alterações","v":"6.198","t":"-1.2%","d":"down"},{"l":"Ambientes","v":"7.267","t":"+1.0%","d":"up"},{"l":"Versão Config","v":"3.144","t":"+11.7%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 40366.97","7.170","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 23696.64","2.564","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 33825.85","5.237","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 27420.57","5.305","2026-03-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 36048.37","1.916","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":601},{"label":"Mar","value":499},{"label":"Abr","value":587},{"label":"Mai","value":354},{"label":"Jun","value":307},{"label":"Jul","value":561},{"label":"Ago","value":353},{"label":"Set","value":316},{"label":"Out","value":414},{"label":"Nov","value":704},{"label":"Dez","value":622}];
const MX = 704;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#c2410c'}}>IoT</span></h1>
                </div>
