...
const PAGE = "Queue Time";
const KPIS = [{"l":"Configurações","v":"3.029","t":"-1.9%","d":"down"},{"l":"Últimas Alterações","v":"1.997","t":"+2.9%","d":"up"},{"l":"Ambientes","v":"2.972","t":"+13.7%","d":"up"},{"l":"Versão Config","v":"3.251","t":"-2.4%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 33054.70","6.900","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 35887.78","8.007","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 33771.19","4.943","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 4590.52","4.700","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 20884.58","1.130","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":475},{"label":"Fev","value":489},{"label":"Mar","value":385},{"label":"Abr","value":605},{"label":"Mai","value":519},{"label":"Jun","value":480},{"label":"Jul","value":577},{"label":"Ago","value":273},{"label":"Set","value":490},{"label":"Out","value":627},{"label":"Nov","value":277},{"label":"Dez","value":431}];
const MX = 627;
