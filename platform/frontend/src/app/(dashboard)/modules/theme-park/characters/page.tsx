...
const PAGE = "Character Sched";
const KPIS = [{"l":"Configurações","v":"6.824","t":"-1.8%","d":"down"},{"l":"Últimas Alterações","v":"1.070","t":"-1.5%","d":"down"},{"l":"Ambientes","v":"5.336","t":"+5.5%","d":"up"},{"l":"Versão Config","v":"8.436","t":"-5.5%","d":"down"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 10444.68","1.591","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 27231.33","2.725","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 3453.28","3.494","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 33987.69","4.266","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 47832.85","1.076","2026-01-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":401},{"label":"Mar","value":358},{"label":"Abr","value":404},{"label":"Mai","value":609},{"label":"Jun","value":709},{"label":"Jul","value":330},{"label":"Ago","value":423},{"label":"Set","value":530},{"label":"Out","value":374},{"label":"Nov","value":634},{"label":"Dez","value":583}];
const MX = 709;
