...
const ACCENT = "#0f172a";
const MODULE = "RegTech Platform";
const PAGE = "KYC/AML";
const KPIS = [{"l":"Formulários Ativos","v":"7.259","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"977","t":"+4.8%","d":"up"},{"l":"Documentos Gerados","v":"1.515","t":"+9.0%","d":"up"},{"l":"Templates","v":"6.672","t":"+8.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.862","2026-01-08","8.461","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.499","2026-03-28","5.632","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.800","2026-01-24","8.033","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.962","2026-02-15","2.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.853","2026-01-02","4.166","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":530},{"label":"Mar","value":393},{"label":"Abr","value":331},{"label":"Mai","value":274},{"label":"Jun","value":526},{"label":"Jul","value":327},{"label":"Ago","value":509},{"label":"Set","value":506},{"label":"Out","value":508},{"label":"Nov","value":609},{"label":"Dez","value":397}];
const MX = 609;
