...
/* ═══ RegTech Platform — Dashboard ═══ */

const ACCENT = "#0f172a";

const KPIS = [
    { label: "Total Registos", value: "8743", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2230", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€152K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "76%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "867644643", cells: ["REG-9643", "RegTech Platform Item 1", "20/4/2026", "€44 743"], status: "active" as const },
    { id: "867648214", cells: ["REG-4214", "RegTech Platform Item 2", "7/11/2026", "€48 314"], status: "pending" as const },
    { id: "867651785", cells: ["REG-7785", "RegTech Platform Item 3", "22/6/2026", "€1885"], status: "completed" as const },
    { id: "867655356", cells: ["REG-2356", "RegTech Platform Item 4", "9/1/2026", "€5456"], status: "warning" as const },
    { id: "867658927", cells: ["REG-5927", "RegTech Platform Item 5", "24/8/2026", "€9027"], status: "active" as const },
];
...
export default function RegtechPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RegTech Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RegTech Platform</p>
                    </div>
                </div>
