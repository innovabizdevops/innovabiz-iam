...
const PAGE = "Sanction Screen";
const KPIS = [{"l":"Formulários Ativos","v":"8.613","t":"-3.2%","d":"down"},{"l":"Submissões/Dia","v":"5030","t":"+11.3%","d":"up"},{"l":"Documentos Gerados","v":"2.986","t":"+15.0%","d":"up"},{"l":"Templates","v":"8.806","t":"-2.7%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.025","2026-01-19","8.723","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.860","2026-02-12","3.361","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.896","2026-01-18","3.672","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.107","2026-02-07","4.323","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.102","2026-03-07","2.895","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":539},{"label":"Mar","value":615},{"label":"Abr","value":641},{"label":"Mai","value":782},{"label":"Jun","value":520},{"label":"Jul","value":463},{"label":"Ago","value":623},{"label":"Set","value":635},{"label":"Out","value":735},{"label":"Nov","value":583},{"label":"Dez","value":769}];
const MX = 782;
