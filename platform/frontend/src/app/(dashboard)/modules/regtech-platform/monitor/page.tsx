...
const KPIS = [{"l":"Formulários Ativos","v":"3.779","t":"+10.1%","d":"up"},{"l":"Submissões/Dia","v":"3224","t":"+0.7%","d":"up"},{"l":"Documentos Gerados","v":"5.945","t":"+3.4%","d":"up"},{"l":"Templates","v":"4.817","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","737","2026-02-19","4.352","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.056","2026-02-12","5.498","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.164","2026-02-14","155","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.537","2026-03-27","6.545","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","633","2026-01-23","1.597","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":937},{"label":"Fev","value":872},{"label":"Mar","value":668},{"label":"Abr","value":698},{"label":"Mai","value":824},{"label":"Jun","value":1005},{"label":"Jul","value":751},{"label":"Ago","value":732},{"label":"Set","value":1012},{"label":"Out","value":755},{"label":"Nov","value":877},{"label":"Dez","value":856}];
const MX = 1012;
