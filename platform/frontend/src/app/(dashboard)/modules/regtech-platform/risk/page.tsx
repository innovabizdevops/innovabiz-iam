...
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"6.433","t":"-2.8%","d":"down"},{"l":"Mitigações Ativas","v":"1.584","t":"+13.0%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"+13.5%","d":"up"},{"l":"Incidentes YTD","v":"4.361","t":"+16.2%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.913","8.915","5.747","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.224","8.802","3.977","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","307","1.577","2.013","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.659","1.368","4.793","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.986","3.880","6.194","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":928},{"label":"Mar","value":682},{"label":"Abr","value":1033},{"label":"Mai","value":878},{"label":"Jun","value":740},{"label":"Jul","value":976},{"label":"Ago","value":1015},{"label":"Set","value":889},{"label":"Out","value":1031},{"label":"Nov","value":811},{"label":"Dez","value":684}];
const MX = 1033;
