...
const PAGE = "Report";
const KPIS = [{"l":"Formulários Ativos","v":"6.357","t":"-4.6%","d":"down"},{"l":"Submissões/Dia","v":"2611","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"5.049","t":"-3.8%","d":"down"},{"l":"Templates","v":"1.266","t":"-5.5%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.415","2026-02-26","3.672","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.028","2026-01-25","4.555","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.059","2026-02-03","843","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","525","2026-02-23","2.823","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.152","2026-02-27","4.849","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":407},{"label":"Fev","value":329},{"label":"Mar","value":411},{"label":"Abr","value":375},{"label":"Mai","value":484},{"label":"Jun","value":553},{"label":"Jul","value":309},{"label":"Ago","value":292},{"label":"Set","value":314},{"label":"Out","value":455},{"label":"Nov","value":388},{"label":"Dez","value":544}];
const MX = 553;
