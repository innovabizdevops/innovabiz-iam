...
const KPIS = [{"l":"Formulários Ativos","v":"8.711","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"1500","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"3.000","t":"+14.7%","d":"up"},{"l":"Templates","v":"2.210","t":"+3.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.940","2026-01-11","4.557","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.856","2026-02-17","4.607","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.678","2026-01-22","4.466","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.735","2026-03-28","1.018","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.343","2026-03-18","8.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":740},{"label":"Fev","value":927},{"label":"Mar","value":906},{"label":"Abr","value":1037},{"label":"Mai","value":665},{"label":"Jun","value":998},{"label":"Jul","value":989},{"label":"Ago","value":1037},{"label":"Set","value":932},{"label":"Out","value":763},{"label":"Nov","value":690},{"label":"Dez","value":676}];
const MX = 1037;
