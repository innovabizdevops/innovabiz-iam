...
const PAGE = "Training Job";
const KPIS = [{"l":"Formulários Ativos","v":"958","t":"+17.5%","d":"up"},{"l":"Submissões/Dia","v":"2951","t":"+7.5%","d":"up"},{"l":"Documentos Gerados","v":"2.119","t":"+12.9%","d":"up"},{"l":"Templates","v":"1.186","t":"+17.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","633","2026-01-28","4.814","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.546","2026-03-22","317","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.264","2026-03-01","3.038","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.043","2026-03-01","1.312","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.809","2026-03-28","6.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":399},{"label":"Fev","value":373},{"label":"Mar","value":507},{"label":"Abr","value":644},{"label":"Mai","value":313},{"label":"Jun","value":411},{"label":"Jul","value":597},{"label":"Ago","value":299},{"label":"Set","value":579},{"label":"Out","value":388},{"label":"Nov","value":400},{"label":"Dez","value":586}];
const MX = 644;
