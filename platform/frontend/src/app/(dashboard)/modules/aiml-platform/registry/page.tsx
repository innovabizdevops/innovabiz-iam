...
const ACCENT = "#b45309";
const MODULE = "AI/ML Platform";
const PAGE = "Model Registry";
const KPIS = [{"l":"Formulários Ativos","v":"7.035","t":"+15.8%","d":"up"},{"l":"Submissões/Dia","v":"3001","t":"+14.7%","d":"up"},{"l":"Documentos Gerados","v":"732","t":"-3.8%","d":"down"},{"l":"Templates","v":"7.410","t":"+17.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.351","2026-03-14","5.187","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.579","2026-03-04","1.814","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.540","2026-03-02","8.023","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.635","2026-01-24","5.391","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.255","2026-03-05","897","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":628},{"label":"Fev","value":684},{"label":"Mar","value":978},{"label":"Abr","value":608},{"label":"Mai","value":752},{"label":"Jun","value":704},{"label":"Jul","value":777},{"label":"Ago","value":872},{"label":"Set","value":737},{"label":"Out","value":911},{"label":"Nov","value":975},{"label":"Dez","value":985}];
const MX = 985;
