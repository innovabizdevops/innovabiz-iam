...
const PAGE = "Notebook";
const KPIS = [{"l":"Formulários Ativos","v":"8.250","t":"-1.1%","d":"down"},{"l":"Submissões/Dia","v":"2565","t":"+2.6%","d":"up"},{"l":"Documentos Gerados","v":"7.786","t":"+4.4%","d":"up"},{"l":"Templates","v":"7.799","t":"+0.6%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.596","2026-02-16","6.488","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.768","2026-02-05","4.237","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.047","2026-02-22","1.049","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.049","2026-03-16","4.256","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.035","2026-02-27","6.801","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":778},{"label":"Fev","value":841},{"label":"Mar","value":535},{"label":"Abr","value":667},{"label":"Mai","value":526},{"label":"Jun","value":717},{"label":"Jul","value":522},{"label":"Ago","value":840},{"label":"Set","value":679},{"label":"Out","value":692},{"label":"Nov","value":699},{"label":"Dez","value":876}];
const MX = 876;
