...
const KPIS = [{"l":"Projetos Sociais","v":"1.855","t":"+5.5%","d":"up"},{"l":"Beneficiários","v":"5.873","t":"+3.2%","d":"up"},{"l":"Investimento CSR (€)","v":"€93594","t":"+6.3%","d":"up"},{"l":"Score Impacto","v":"55","t":"+16.1%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.242","€ 16502.41","5.645","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","2.542","€ 19759.83","872","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.594","€ 38364.13","5.605","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","3.611","€ 28699.00","6.918","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","8.241","€ 40248.37","1.410","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":996},{"label":"Mar","value":701},{"label":"Abr","value":702},{"label":"Mai","value":721},{"label":"Jun","value":789},{"label":"Jul","value":803},{"label":"Ago","value":840},{"label":"Set","value":675},{"label":"Out","value":744},{"label":"Nov","value":713},{"label":"Dez","value":674}];
const MX = 996;
