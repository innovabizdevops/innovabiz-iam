...
const ACCENT = "#6366f1";
const MODULE = "Mine Closure";
const PAGE = "Decommission";
const KPIS = [{"l":"Vendas YTD (€)","v":"€62302","t":"+13.8%","d":"up"},{"l":"Pipeline (€)","v":"€23740","t":"+4.4%","d":"up"},{"l":"Atingimento Quota (%)","v":"75.0%","t":"-1.5%","d":"down"},{"l":"Win Rate (%)","v":"87.8%","t":"+7.3%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 1068.61","€ 1112.37","€ 28959.52","95.5%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 37657.26","€ 44120.72","€ 46421.88","83.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 45229.78","€ 9136.44","€ 37421.42","80.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 7154.84","€ 8417.64","€ 27759.37","80.9%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 36097.05","€ 27640.90","€ 47221.86","88.0%"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":756},{"label":"Mar","value":614},{"label":"Abr","value":640},{"label":"Mai","value":772},{"label":"Jun","value":611},{"label":"Jul","value":593},{"label":"Ago","value":917},{"label":"Set","value":634},{"label":"Out","value":794},{"label":"Nov","value":574},{"label":"Dez","value":708}];
const MX = 917;
