...
const PAGE = "Water Treat";
const KPIS = [{"l":"Total Mine Closure","v":"5.387","t":"-3.4%","d":"down"},{"l":"Water Treat Ativos","v":"5.587","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"76.7%","t":"-1.7%","d":"down"},{"l":"Score Performance","v":"57","t":"-0.8%","d":"down"}];
const COLS = ["ID","Water Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mine Closure #001","Mine Closure #002","5.438","2.903","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Mine Closure #002","Mine Closure #003","7.522","8.908","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Mine Closure #003","Mine Closure #004","4.223","3.723","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["Mine Closure #004","Mine Closure #005","949","1.940","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mine Closure #005","Mine Closure #001","2.761","2.890","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":517},{"label":"Fev","value":583},{"label":"Mar","value":608},{"label":"Abr","value":538},{"label":"Mai","value":527},{"label":"Jun","value":634},{"label":"Jul","value":646},{"label":"Ago","value":485},{"label":"Set","value":517},{"label":"Out","value":663},{"label":"Nov","value":688},{"label":"Dez","value":719}];
const MX = 719;
