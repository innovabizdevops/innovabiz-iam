...
const KPIS = [{"l":"Riscos Identificados","v":"6.941","t":"+2.4%","d":"up"},{"l":"Mitigações Ativas","v":"6.267","t":"+10.4%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+17.7%","d":"up"},{"l":"Incidentes YTD","v":"8.890","t":"-0.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.288","1.143","5.575","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.914","3.416","3.981","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","803","3.346","758","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.453","1.364","8.058","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.824","3.219","8.025","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":506},{"label":"Fev","value":637},{"label":"Mar","value":849},{"label":"Abr","value":745},{"label":"Mai","value":530},{"label":"Jun","value":779},{"label":"Jul","value":866},{"label":"Ago","value":768},{"label":"Set","value":690},{"label":"Out","value":500},{"label":"Nov","value":634},{"label":"Dez","value":831}];
const MX = 866;
