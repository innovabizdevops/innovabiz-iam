...
const PAGE = "Vendor Assessment";
const KPIS = [{"l":"Riscos Identificados","v":"1.551","t":"+13.3%","d":"up"},{"l":"Mitigações Ativas","v":"6.186","t":"+3.0%","d":"up"},{"l":"Score Risco Geral","v":"77","t":"+3.6%","d":"up"},{"l":"Incidentes YTD","v":"4.008","t":"+6.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.876","6.689","8.151","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.287","8.868","7.049","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.292","3.814","5.548","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.196","6.158","1.745","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.440","5.976","6.274","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":432},{"label":"Fev","value":560},{"label":"Mar","value":507},{"label":"Abr","value":562},{"label":"Mai","value":456},{"label":"Jun","value":526},{"label":"Jul","value":450},{"label":"Ago","value":716},{"label":"Set","value":568},{"label":"Out","value":454},{"label":"Nov","value":742},{"label":"Dez","value":497}];
const MX = 742;
