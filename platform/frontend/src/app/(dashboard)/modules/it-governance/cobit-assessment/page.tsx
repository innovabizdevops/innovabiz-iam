...
const PAGE = "COBIT Assessment Form";
const KPIS = [{"l":"Riscos Identificados","v":"2.761","t":"+15.4%","d":"up"},{"l":"Mitigações Ativas","v":"3.843","t":"-3.2%","d":"down"},{"l":"Score Risco Geral","v":"60","t":"-4.3%","d":"down"},{"l":"Incidentes YTD","v":"904","t":"+17.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.585","7.723","417","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.783","932","2.132","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.619","5.901","551","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.964","6.943","7.884","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.092","1.129","4.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":234},{"label":"Fev","value":295},{"label":"Mar","value":265},{"label":"Abr","value":273},{"label":"Mai","value":544},{"label":"Jun","value":573},{"label":"Jul","value":565},{"label":"Ago","value":306},{"label":"Set","value":437},{"label":"Out","value":435},{"label":"Nov","value":451},{"label":"Dez","value":599}];
const MX = 599;
