...
const PAGE = "IT Value Realization";
const KPIS = [{"l":"Riscos Identificados","v":"7.430","t":"+2.3%","d":"up"},{"l":"Mitigações Ativas","v":"2.955","t":"-0.3%","d":"down"},{"l":"Score Risco Geral","v":"59","t":"+6.0%","d":"up"},{"l":"Incidentes YTD","v":"7.841","t":"+14.5%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.104","8.308","4.766","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.250","3.750","7.630","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.599","8.415","569","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.659","156","4.542","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.957","7.326","4.740","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":365},{"label":"Mar","value":635},{"label":"Abr","value":493},{"label":"Mai","value":731},{"label":"Jun","value":715},{"label":"Jul","value":432},{"label":"Ago","value":517},{"label":"Set","value":472},{"label":"Out","value":675},{"label":"Nov","value":511},{"label":"Dez","value":491}];
const MX = 731;
