...
const ACCENT = "#4338ca";
const MODULE = "IT Governance (COBIT)";
const PAGE = "Architecture Compliance";
const KPIS = [{"l":"Riscos Identificados","v":"3.441","t":"+11.8%","d":"up"},{"l":"Mitigações Ativas","v":"7.908","t":"-2.0%","d":"down"},{"l":"Score Risco Geral","v":"87","t":"+5.7%","d":"up"},{"l":"Incidentes YTD","v":"5.590","t":"+5.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","5.082","8.529","5.933","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.907","8.301","8.687","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.196","6.346","2.832","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.724","4.531","757","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.584","8.616","6.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":821},{"label":"Fev","value":574},{"label":"Mar","value":675},{"label":"Abr","value":487},{"label":"Mai","value":711},{"label":"Jun","value":468},{"label":"Jul","value":486},{"label":"Ago","value":563},{"label":"Set","value":515},{"label":"Out","value":488},{"label":"Nov","value":480},{"label":"Dez","value":610}];
const MX = 821;
...
export default function ArchCompliancePage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>TOGAF</span></h1>
                </div>
