...
const PAGE = "EA Capability Map";
const KPIS = [{"l":"Riscos Identificados","v":"3.692","t":"+0.4%","d":"up"},{"l":"Mitigações Ativas","v":"3.446","t":"+14.1%","d":"up"},{"l":"Score Risco Geral","v":"74","t":"+0.5%","d":"up"},{"l":"Incidentes YTD","v":"6.282","t":"-1.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.412","4.330","3.424","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.869","276","7.318","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.647","5.176","8.114","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.307","1.723","3.889","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.155","4.424","6.576","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":772},{"label":"Mar","value":477},{"label":"Abr","value":502},{"label":"Mai","value":548},{"label":"Jun","value":675},{"label":"Jul","value":602},{"label":"Ago","value":653},{"label":"Set","value":604},{"label":"Out","value":573},{"label":"Nov","value":594},{"label":"Dez","value":482}];
const MX = 772;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>Diagram</span></h1>
                </div>
