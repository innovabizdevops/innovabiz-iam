...
const PAGE = "IT Portfolio Mgmt";
const KPIS = [{"l":"Riscos Identificados","v":"2.056","t":"+4.6%","d":"up"},{"l":"Mitigações Ativas","v":"1.448","t":"+3.1%","d":"up"},{"l":"Score Risco Geral","v":"78","t":"+16.1%","d":"up"},{"l":"Incidentes YTD","v":"4.502","t":"-0.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.483","4.159","3.410","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.970","1.648","1.851","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.798","4.704","4.310","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.178","2.439","2.670","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.552","1.896","7.879","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":609},{"label":"Fev","value":656},{"label":"Mar","value":566},{"label":"Abr","value":539},{"label":"Mai","value":368},{"label":"Jun","value":493},{"label":"Jul","value":421},{"label":"Ago","value":445},{"label":"Set","value":352},{"label":"Out","value":609},{"label":"Nov","value":692},{"label":"Dez","value":581}];
const MX = 692;
...
export default function ItPortfolioPage() {
    return (
