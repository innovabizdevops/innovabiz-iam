...
const PAGE = "MEA (Monitor Evaluate Assess)";
const KPIS = [{"l":"Riscos Identificados","v":"184","t":"+11.8%","d":"up"},{"l":"Mitigações Ativas","v":"7.531","t":"+9.9%","d":"up"},{"l":"Score Risco Geral","v":"69","t":"-3.4%","d":"down"},{"l":"Incidentes YTD","v":"6.369","t":"+13.0%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.607","4.505","6.893","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","5.140","3.071","4.934","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.354","8.061","7.855","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.219","1.602","8.929","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.531","1.997","3.558","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":913},{"label":"Fev","value":968},{"label":"Mar","value":752},{"label":"Abr","value":862},{"label":"Mai","value":913},{"label":"Jun","value":783},{"label":"Jul","value":654},{"label":"Ago","value":855},{"label":"Set","value":1002},{"label":"Out","value":905},{"label":"Nov","value":984},{"label":"Dez","value":832}];
const MX = 1002;
