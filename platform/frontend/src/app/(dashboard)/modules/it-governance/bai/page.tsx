...
const PAGE = "BAI (Build Acquire Implement)";
const KPIS = [{"l":"Riscos Identificados","v":"837","t":"+4.9%","d":"up"},{"l":"Mitigações Ativas","v":"141","t":"+11.4%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+15.7%","d":"up"},{"l":"Incidentes YTD","v":"5.710","t":"-5.8%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.347","4.435","8.505","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.610","2.323","6.072","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.517","4.446","1.033","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.845","5.120","7.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.608","6.614","4.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":749},{"label":"Fev","value":720},{"label":"Mar","value":707},{"label":"Abr","value":843},{"label":"Mai","value":1012},{"label":"Jun","value":822},{"label":"Jul","value":934},{"label":"Ago","value":634},{"label":"Set","value":1020},{"label":"Out","value":817},{"label":"Nov","value":982},{"label":"Dez","value":891}];
const MX = 1020;
