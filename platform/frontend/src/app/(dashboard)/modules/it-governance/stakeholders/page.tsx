...
const PAGE = "Stakeholder Needs";
const KPIS = [{"l":"Riscos Identificados","v":"8.581","t":"-2.7%","d":"down"},{"l":"Mitigações Ativas","v":"6.937","t":"+11.0%","d":"up"},{"l":"Score Risco Geral","v":"66","t":"-3.2%","d":"down"},{"l":"Incidentes YTD","v":"3.531","t":"+7.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.677","516","143","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.803","8.947","2.745","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.201","8.543","6.724","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.810","1.539","6.423","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","126","3.713","6.805","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":996},{"label":"Fev","value":735},{"label":"Mar","value":777},{"label":"Abr","value":855},{"label":"Mai","value":1074},{"label":"Jun","value":865},{"label":"Jul","value":748},{"label":"Ago","value":794},{"label":"Set","value":1075},{"label":"Out","value":714},{"label":"Nov","value":863},{"label":"Dez","value":985}];
const MX = 1075;
