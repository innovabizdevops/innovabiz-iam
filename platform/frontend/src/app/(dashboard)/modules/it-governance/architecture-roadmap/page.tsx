...
const PAGE = "Architecture Roadmap";
const KPIS = [{"l":"Riscos Identificados","v":"6.321","t":"+4.3%","d":"up"},{"l":"Mitigações Ativas","v":"8.004","t":"+12.7%","d":"up"},{"l":"Score Risco Geral","v":"57","t":"+12.1%","d":"up"},{"l":"Incidentes YTD","v":"5.614","t":"+15.9%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.917","1.079","8.068","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.093","3.314","6.961","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","3.709","2.304","3.736","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.720","503","8.655","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.623","5.537","6.285","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":886},{"label":"Mar","value":899},{"label":"Abr","value":700},{"label":"Mai","value":675},{"label":"Jun","value":564},{"label":"Jul","value":768},{"label":"Ago","value":775},{"label":"Set","value":909},{"label":"Out","value":722},{"label":"Nov","value":894},{"label":"Dez","value":649}];
const MX = 909;
