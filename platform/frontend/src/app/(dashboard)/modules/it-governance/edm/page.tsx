...
const PAGE = "EDM (Evaluate Direct Monitor)";
const KPIS = [{"l":"Riscos Identificados","v":"3.197","t":"+16.9%","d":"up"},{"l":"Mitigações Ativas","v":"5.227","t":"+9.0%","d":"up"},{"l":"Score Risco Geral","v":"93","t":"+1.9%","d":"up"},{"l":"Incidentes YTD","v":"5.210","t":"-2.7%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.005","8.763","8.269","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.895","8.982","6.946","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","667","7.376","6.884","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.126","8.280","5.299","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.094","8.193","7.197","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":735},{"label":"Mar","value":776},{"label":"Abr","value":749},{"label":"Mai","value":726},{"label":"Jun","value":509},{"label":"Jul","value":622},{"label":"Ago","value":619},{"label":"Set","value":619},{"label":"Out","value":558},{"label":"Nov","value":631},{"label":"Dez","value":799}];
const MX = 799;
