...
const PAGE = "IT Strategic Planning";
const KPIS = [{"l":"Riscos Identificados","v":"8.532","t":"-1.0%","d":"down"},{"l":"Mitigações Ativas","v":"3.747","t":"+9.1%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+4.6%","d":"up"},{"l":"Incidentes YTD","v":"5.635","t":"+6.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.268","6.130","1.876","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.375","2.276","5.592","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.170","8.233","3.814","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.029","2.545","4.665","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.418","7.753","259","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":316},{"label":"Mar","value":404},{"label":"Abr","value":498},{"label":"Mai","value":365},{"label":"Jun","value":658},{"label":"Jul","value":545},{"label":"Ago","value":396},{"label":"Set","value":413},{"label":"Out","value":360},{"label":"Nov","value":419},{"label":"Dez","value":616}];
const MX = 661;
