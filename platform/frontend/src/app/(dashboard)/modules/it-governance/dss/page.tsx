...
const PAGE = "DSS (Deliver Service Support)";
const KPIS = [{"l":"Riscos Identificados","v":"753","t":"+11.4%","d":"up"},{"l":"Mitigações Ativas","v":"4.647","t":"-0.4%","d":"down"},{"l":"Score Risco Geral","v":"63","t":"-1.7%","d":"down"},{"l":"Incidentes YTD","v":"5.437","t":"+5.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.363","1.659","5.214","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","7.492","2.229","3.911","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.454","5.578","7.721","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.840","6.613","2.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.353","8.803","8.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":984},{"label":"Fev","value":785},{"label":"Mar","value":702},{"label":"Abr","value":864},{"label":"Mai","value":961},{"label":"Jun","value":849},{"label":"Jul","value":1038},{"label":"Ago","value":821},{"label":"Set","value":1050},{"label":"Out","value":994},{"label":"Nov","value":946},{"label":"Dez","value":711}];
const MX = 1050;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#4338ca'}}>COBIT</span></h1>
                </div>
