...
const PAGE = "IT Budget &amp; Cost";
const KPIS = [{"l":"Riscos Identificados","v":"7.906","t":"-5.1%","d":"down"},{"l":"Mitigações Ativas","v":"1.087","t":"+8.1%","d":"up"},{"l":"Score Risco Geral","v":"87","t":"+3.5%","d":"up"},{"l":"Incidentes YTD","v":"403","t":"+17.7%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.737","3.787","4.736","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.615","1.129","5.241","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.617","4.577","2.003","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","8.924","8.825","1.625","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.624","6.210","1.224","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":526},{"label":"Fev","value":475},{"label":"Mar","value":740},{"label":"Abr","value":831},{"label":"Mai","value":798},{"label":"Jun","value":748},{"label":"Jul","value":628},{"label":"Ago","value":626},{"label":"Set","value":863},{"label":"Out","value":839},{"label":"Nov","value":625},{"label":"Dez","value":592}];
const MX = 863;
