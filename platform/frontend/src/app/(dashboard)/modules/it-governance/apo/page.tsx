...
const PAGE = "APO (Align Plan Organize)";
const KPIS = [{"l":"Riscos Identificados","v":"7.664","t":"-4.5%","d":"down"},{"l":"Mitigações Ativas","v":"6.702","t":"+11.8%","d":"up"},{"l":"Score Risco Geral","v":"68","t":"+14.0%","d":"up"},{"l":"Incidentes YTD","v":"3.374","t":"+17.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.995","8.752","2.265","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.623","6.013","2.974","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.532","8.334","7.666","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.603","4.174","3.563","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.134","4.009","5.462","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":509},{"label":"Mar","value":622},{"label":"Abr","value":798},{"label":"Mai","value":446},{"label":"Jun","value":790},{"label":"Jul","value":674},{"label":"Ago","value":710},{"label":"Set","value":537},{"label":"Out","value":469},{"label":"Nov","value":456},{"label":"Dez","value":766}];
const MX = 798;
