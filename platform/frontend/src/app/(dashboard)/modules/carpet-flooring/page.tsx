...
/* ═══ Carpet & Flooring — Dashboard ═══ */

const ACCENT = "#92400e";

const KPIS = [
    { label: "Total Registos", value: "3347", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4572", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€470K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2070568447", cells: ["CAR-2447", "Carpet & Flooring Item 1", "4/8/2026", "€18 547"], status: "active" as const },
    { id: "2070572018", cells: ["CAR-6018", "Carpet & Flooring Item 2", "19/3/2026", "€22 118"], status: "pending" as const },
    { id: "2070575589", cells: ["CAR-9589", "Carpet & Flooring Item 3", "6/10/2026", "€25 689"], status: "completed" as const },
    { id: "2070579160", cells: ["CAR-4160", "Carpet & Flooring Item 4", "21/5/2026", "€29 260"], status: "warning" as const },
    { id: "2070582731", cells: ["CAR-7731", "Carpet & Flooring Item 5", "8/12/2026", "€32 831"], status: "active" as const },
];
...
export default function CarpetFlooringPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Carpet & Flooring</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Carpet & Flooring</p>
                    </div>
                </div>
