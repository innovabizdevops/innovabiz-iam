...
/* ═══ Fashion Sustainability — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "205", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2263", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€59K", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "-13%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1395177405", cells: ["FAS-7405", "Fashion Sustainability Item 1", "14/10/2026", "€27 505"], status: "active" as const },
    { id: "1395180976", cells: ["FAS-1976", "Fashion Sustainability Item 2", "1/5/2026", "€31 076"], status: "pending" as const },
    { id: "1395184547", cells: ["FAS-5547", "Fashion Sustainability Item 3", "16/12/2026", "€34 647"], status: "completed" as const },
    { id: "1395188118", cells: ["FAS-9118", "Fashion Sustainability Item 4", "3/7/2026", "€38 218"], status: "warning" as const },
    { id: "1395191689", cells: ["FAS-3689", "Fashion Sustainability Item 5", "18/2/2026", "€41 789"], status: "active" as const },
];
...
export default function FashionSustainabilityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fashion Sustainability</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Fashion Sustainability</p>
                    </div>
                </div>
