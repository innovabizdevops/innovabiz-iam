...
const KPIS = [
    { label: "Total Registos", value: "4904", trend: "+5%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3053", trend: "-24%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€288K", trend: "+18%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+12%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1339336204", cells: ["MED-2204", "Medical Council Item 1", "25/5/2026", "€36 304"], status: "active" as const },
    { id: "1339339775", cells: ["MED-5775", "Medical Council Item 2", "12/12/2026", "€39 875"], status: "pending" as const },
    { id: "1339343346", cells: ["MED-9346", "Medical Council Item 3", "27/7/2026", "€43 446"], status: "completed" as const },
    { id: "1339346917", cells: ["MED-3917", "Medical Council Item 4", "14/2/2026", "€47 017"], status: "warning" as const },
    { id: "1339350488", cells: ["MED-7488", "Medical Council Item 5", "1/9/2026", "€588"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Council</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Council</p>
                    </div>
                </div>
