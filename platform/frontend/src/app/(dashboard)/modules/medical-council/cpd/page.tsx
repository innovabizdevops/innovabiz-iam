...
const PAGE = "CPD";
const KPIS = [{"l":"Integrações Ativas","v":"1.789","t":"+14.0%","d":"up"},{"l":"Chamadas/Hora","v":"3354","t":"+1.9%","d":"up"},{"l":"Taxa Sucesso (%)","v":"94.2%","t":"+17.5%","d":"up"},{"l":"Latência Média (ms)","v":"9ms","t":"-2.8%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.942","817","87.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","9.094","4.316","99.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.143","7.988","73.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.392","8.008","79.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.860","6.510","94.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":699},{"label":"Mar","value":677},{"label":"Abr","value":753},{"label":"Mai","value":681},{"label":"Jun","value":716},{"label":"Jul","value":523},{"label":"Ago","value":657},{"label":"Set","value":700},{"label":"Out","value":639},{"label":"Nov","value":629},{"label":"Dez","value":796}];
const MX = 796;
