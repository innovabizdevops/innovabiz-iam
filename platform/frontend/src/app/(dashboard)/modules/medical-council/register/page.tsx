...
const PAGE = "Register";
const KPIS = [{"l":"Integrações Ativas","v":"1.046","t":"+11.3%","d":"up"},{"l":"Chamadas/Hora","v":"1110","t":"+11.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.2%","t":"+5.2%","d":"up"},{"l":"Latência Média (ms)","v":"21ms","t":"+5.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.262","212","71.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.837","5.480","93.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.244","6.013","76.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.988","301","79.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.055","8.072","90.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":976},{"label":"Fev","value":690},{"label":"Mar","value":727},{"label":"Abr","value":672},{"label":"Mai","value":892},{"label":"Jun","value":715},{"label":"Jul","value":731},{"label":"Ago","value":783},{"label":"Set","value":666},{"label":"Out","value":591},{"label":"Nov","value":784},{"label":"Dez","value":831}];
const MX = 976;
