...
const ACCENT = "#0891b2";
const MODULE = "Medical Council";
const PAGE = "Discipline";
const KPIS = [{"l":"Integrações Ativas","v":"3.613","t":"-0.3%","d":"down"},{"l":"Chamadas/Hora","v":"1162","t":"+11.1%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.4%","t":"+7.0%","d":"up"},{"l":"Latência Média (ms)","v":"37ms","t":"+3.4%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.438","7.258","84.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.172","166","86.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","628","5.405","70.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.966","1.929","75.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","406","2.431","80.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":665},{"label":"Mar","value":632},{"label":"Abr","value":680},{"label":"Mai","value":750},{"label":"Jun","value":817},{"label":"Jul","value":587},{"label":"Ago","value":581},{"label":"Set","value":694},{"label":"Out","value":631},{"label":"Nov","value":676},{"label":"Dez","value":832}];
const MX = 832;
