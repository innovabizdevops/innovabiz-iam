...
const PAGE = "Standards";
const KPIS = [{"l":"Integrações Ativas","v":"1.414","t":"+13.1%","d":"up"},{"l":"Chamadas/Hora","v":"2686","t":"-3.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"66.0%","t":"+6.6%","d":"up"},{"l":"Latência Média (ms)","v":"25ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.349","7.711","85.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","198","6.852","89.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.015","6.716","76.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.596","6.029","88.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.563","2.046","70.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":606},{"label":"Fev","value":694},{"label":"Mar","value":841},{"label":"Abr","value":635},{"label":"Mai","value":715},{"label":"Jun","value":636},{"label":"Jul","value":827},{"label":"Ago","value":576},{"label":"Set","value":805},{"label":"Out","value":584},{"label":"Nov","value":725},{"label":"Dez","value":824}];
const MX = 841;
