...
const PAGE = "License";
const KPIS = [{"l":"Integrações Ativas","v":"5.155","t":"+15.7%","d":"up"},{"l":"Chamadas/Hora","v":"1607","t":"+16.6%","d":"up"},{"l":"Taxa Sucesso (%)","v":"73.9%","t":"+0.9%","d":"up"},{"l":"Latência Média (ms)","v":"67ms","t":"+11.7%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.250","4.827","80.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.765","6.905","83.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.154","6.369","91.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.951","1.677","98.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.059","3.961","84.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":457},{"label":"Mar","value":368},{"label":"Abr","value":388},{"label":"Mai","value":403},{"label":"Jun","value":332},{"label":"Jul","value":553},{"label":"Ago","value":614},{"label":"Set","value":468},{"label":"Out","value":292},{"label":"Nov","value":569},{"label":"Dez","value":379}];
const MX = 614;
