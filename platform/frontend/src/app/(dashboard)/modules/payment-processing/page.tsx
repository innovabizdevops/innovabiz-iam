...
/* ═══ Payment Processing Engine — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5145", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "443", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€233K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "355939745", cells: ["PAY-8745", "Payment Processing Engine Item 1", "22/6/2026", "€39 845"], status: "active" as const },
    { id: "355943316", cells: ["PAY-3316", "Payment Processing Engine Item 2", "9/1/2026", "€43 416"], status: "pending" as const },
    { id: "355946887", cells: ["PAY-6887", "Payment Processing Engine Item 3", "24/8/2026", "€46 987"], status: "completed" as const },
    { id: "355950458", cells: ["PAY-1458", "Payment Processing Engine Item 4", "11/3/2026", "€558"], status: "warning" as const },
    { id: "355954029", cells: ["PAY-5029", "Payment Processing Engine Item 5", "26/10/2026", "€4129"], status: "active" as const },
];
...
export default function PaymentProcessingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Payment Processing Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Payment Processing Engine</p>
                    </div>
                </div>
