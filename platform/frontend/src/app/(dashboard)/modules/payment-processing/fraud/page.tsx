...
const ACCENT = "#1e3a5f";
const MODULE = "Payment Processing Engine";
const PAGE = "Fraud";
const KPIS = [{"l":"Total Payment Processing","v":"3.273","t":"+2.6%","d":"up"},{"l":"Fraud Ativos","v":"7.831","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"91.3%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"69","t":"+14.2%","d":"up"}];
const COLS = ["ID","Fraud","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Payment Processing #001","Payment Processing #002","2.558","1.527","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["Payment Processing #002","Payment Processing #003","6.760","4.982","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Payment Processing #003","Payment Processing #004","7.653","8.215","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Payment Processing #004","Payment Processing #005","7.699","8.418","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Payment Processing #005","Payment Processing #001","7.939","756","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":957},{"label":"Fev","value":778},{"label":"Mar","value":955},{"label":"Abr","value":1006},{"label":"Mai","value":745},{"label":"Jun","value":924},{"label":"Jul","value":927},{"label":"Ago","value":658},{"label":"Set","value":807},{"label":"Out","value":650},{"label":"Nov","value":691},{"label":"Dez","value":757}];
const MX = 1006;
