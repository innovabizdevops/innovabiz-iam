...
const KPIS = [{"l":"Utilizadores Ativos","v":"4.214","t":"+16.6%","d":"up"},{"l":"Sessões/Dia","v":"2998","t":"+0.1%","d":"up"},{"l":"MFA Adoção (%)","v":"68.8%","t":"-1.6%","d":"down"},{"l":"Tentativas Bloqueadas","v":"3.735","t":"+6.4%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","5.688","3.103","8.977","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","711","906","966","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.683","904","112","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","6.419","4.372","1.075","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","1.013","2.623","5.380","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":394},{"label":"Mar","value":415},{"label":"Abr","value":454},{"label":"Mai","value":627},{"label":"Jun","value":700},{"label":"Jul","value":618},{"label":"Ago","value":545},{"label":"Set","value":608},{"label":"Out","value":519},{"label":"Nov","value":709},{"label":"Dez","value":558}];
const MX = 782;
