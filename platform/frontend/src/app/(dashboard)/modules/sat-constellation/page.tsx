...
export default function SatConstellationPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Sat Constellation</h1><p className="text-sm text-muted-foreground">Sat Constellation • iBOS Enterprise</p></div>
