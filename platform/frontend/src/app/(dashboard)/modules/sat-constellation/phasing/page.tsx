...
const PAGE = "Phasing";
const KPIS = [{"l":"Total Sat Constellation","v":"6.597","t":"+3.6%","d":"up"},{"l":"Phasing Ativos","v":"8.100","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"93.8%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"83","t":"+12.2%","d":"up"}];
const COLS = ["ID","Phasing","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Constellation #001","Sat Constellation #002","7.425","7.402","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Constellation #002","Sat Constellation #003","5.261","3.575","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Constellation #003","Sat Constellation #004","767","3.468","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Constellation #004","Sat Constellation #005","5.907","5.335","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Constellation #005","Sat Constellation #001","1.273","1.590","2026-02-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":747},{"label":"Fev","value":770},{"label":"Mar","value":411},{"label":"Abr","value":768},{"label":"Mai","value":520},{"label":"Jun","value":536},{"label":"Jul","value":536},{"label":"Ago","value":515},{"label":"Set","value":524},{"label":"Out","value":488},{"label":"Nov","value":745},{"label":"Dez","value":423}];
const MX = 770;
