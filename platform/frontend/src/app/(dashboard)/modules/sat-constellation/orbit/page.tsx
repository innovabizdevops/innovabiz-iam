...
const PAGE = "Orbit Design";
const KPIS = [{"l":"Formulários Ativos","v":"2.730","t":"+16.9%","d":"up"},{"l":"Submissões/Dia","v":"1100","t":"+5.3%","d":"up"},{"l":"Documentos Gerados","v":"6.707","t":"+17.1%","d":"up"},{"l":"Templates","v":"562","t":"+2.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.372","2026-02-21","7.354","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","182","2026-02-10","8.925","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.198","2026-01-08","9.019","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.127","2026-03-05","5.413","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.821","2026-01-05","1.239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":257},{"label":"Mar","value":296},{"label":"Abr","value":595},{"label":"Mai","value":410},{"label":"Jun","value":322},{"label":"Jul","value":469},{"label":"Ago","value":482},{"label":"Set","value":382},{"label":"Out","value":336},{"label":"Nov","value":448},{"label":"Dez","value":516}];
const MX = 595;
