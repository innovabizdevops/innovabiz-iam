...
const ACCENT = "#7c3aed";
const MODULE = "Satellite Constellation";
const PAGE = "Deorbit Plan";
const KPIS = [{"l":"Total Sat Constellation","v":"1.494","t":"+16.2%","d":"up"},{"l":"Deorbit Plan Ativos","v":"3.410","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"91.2%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"90","t":"-2.5%","d":"down"}];
const COLS = ["ID","Deorbit Plan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Constellation #001","Sat Constellation #002","1.121","5.687","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Constellation #002","Sat Constellation #003","5.809","832","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Constellation #003","Sat Constellation #004","8.986","8.587","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Constellation #004","Sat Constellation #005","3.557","5.140","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Constellation #005","Sat Constellation #001","6.406","4.453","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":680},{"label":"Fev","value":607},{"label":"Mar","value":939},{"label":"Abr","value":665},{"label":"Mai","value":634},{"label":"Jun","value":980},{"label":"Jul","value":813},{"label":"Ago","value":757},{"label":"Set","value":722},{"label":"Out","value":617},{"label":"Nov","value":926},{"label":"Dez","value":883}];
const MX = 980;
...
export default function DeorbitPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>ESG</span></h1>
                </div>
