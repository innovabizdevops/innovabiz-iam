...
const PAGE = "Launch Seq";
const KPIS = [{"l":"Total Sat Constellation","v":"794","t":"-0.8%","d":"down"},{"l":"Launch Seq Ativos","v":"9.075","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"85.9%","t":"+6.0%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.9%","d":"down"}];
const COLS = ["ID","Launch Seq","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Sat Constellation #001","Sat Constellation #002","6.475","6.758","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Sat Constellation #002","Sat Constellation #003","1.344","2.784","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Sat Constellation #003","Sat Constellation #004","2.696","5.775","2026-01-13","Concluído"],"status":"done"},{"id":"r3","cells":["Sat Constellation #004","Sat Constellation #005","3.462","529","2026-03-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Sat Constellation #005","Sat Constellation #001","4.666","6.237","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":666},{"label":"Mar","value":723},{"label":"Abr","value":818},{"label":"Mai","value":733},{"label":"Jun","value":862},{"label":"Jul","value":874},{"label":"Ago","value":605},{"label":"Set","value":754},{"label":"Out","value":575},{"label":"Nov","value":822},{"label":"Dez","value":804}];
const MX = 874;
