...
/* ═══ Golf Course Mgmt — Dashboard ═══ */

const ACCENT = "#4f46e5";

const KPIS = [
    { label: "Total Registos", value: "195", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "25", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€239K", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1010582195", cells: ["GOL-9195", "Golf Course Mgmt Item 1", "8/12/2026", "€32 295"], status: "active" as const },
    { id: "1010585766", cells: ["GOL-3766", "Golf Course Mgmt Item 2", "23/7/2026", "€35 866"], status: "pending" as const },
    { id: "1010589337", cells: ["GOL-7337", "Golf Course Mgmt Item 3", "10/2/2026", "€39 437"], status: "completed" as const },
    { id: "1010592908", cells: ["GOL-1908", "Golf Course Mgmt Item 4", "25/9/2026", "€43 008"], status: "warning" as const },
    { id: "1010596479", cells: ["GOL-5479", "Golf Course Mgmt Item 5", "12/4/2026", "€46 579"], status: "active" as const },
];
...
export default function GolfCourseMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Golf Course Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Golf Course Mgmt</p>
                    </div>
                </div>
