...
const ACCENT = "#4f46e5";
const MODULE = "Golf Course Mgmt";
const PAGE = "Membership";
const KPIS = [{"l":"Total Golf Course","v":"8.296","t":"-4.4%","d":"down"},{"l":"Membership Ativos","v":"7.319","t":"+10.0%","d":"up"},{"l":"Eficiência (%)","v":"90.9%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"93","t":"+9.8%","d":"up"}];
const COLS = ["ID","Membership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Course #001","Golf Course #002","2.510","1.874","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Course #002","Golf Course #003","8.023","6.497","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Course #003","Golf Course #004","9.041","6.388","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Course #004","Golf Course #005","3.724","1.241","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Course #005","Golf Course #001","3.397","5.581","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":635},{"label":"Mar","value":607},{"label":"Abr","value":659},{"label":"Mai","value":600},{"label":"Jun","value":593},{"label":"Jul","value":528},{"label":"Ago","value":662},{"label":"Set","value":688},{"label":"Out","value":649},{"label":"Nov","value":712},{"label":"Dez","value":771}];
const MX = 771;
