...
const PAGE = "Event";
const KPIS = [{"l":"Total Golf Course","v":"1.922","t":"+16.1%","d":"up"},{"l":"Event Ativos","v":"3.666","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"+6.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+3.6%","d":"up"}];
const COLS = ["ID","Event","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Course #001","Golf Course #002","7.102","1.668","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Course #002","Golf Course #003","1.827","3.735","2026-03-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Course #003","Golf Course #004","139","5.629","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Course #004","Golf Course #005","5.006","4.216","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Course #005","Golf Course #001","187","3.656","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":539},{"label":"Mar","value":422},{"label":"Abr","value":390},{"label":"Mai","value":516},{"label":"Jun","value":361},{"label":"Jul","value":324},{"label":"Ago","value":578},{"label":"Set","value":262},{"label":"Out","value":458},{"label":"Nov","value":273},{"label":"Dez","value":300}];
const MX = 578;
