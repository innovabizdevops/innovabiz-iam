...
const KPIS = [{"l":"Total Golf Course","v":"3.257","t":"-4.5%","d":"down"},{"l":"Maintenance Ativos","v":"4.070","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"87","t":"-4.9%","d":"down"}];
const COLS = ["ID","Maintenance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Course #001","Golf Course #002","7.071","4.813","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Course #002","Golf Course #003","8.479","100","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Course #003","Golf Course #004","1.301","2.044","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Course #004","Golf Course #005","7.598","1.814","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Course #005","Golf Course #001","3.900","5.065","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":671},{"label":"Mar","value":642},{"label":"Abr","value":655},{"label":"Mai","value":910},{"label":"Jun","value":648},{"label":"Jul","value":611},{"label":"Ago","value":898},{"label":"Set","value":582},{"label":"Out","value":821},{"label":"Nov","value":844},{"label":"Dez","value":942}];
const MX = 942;
