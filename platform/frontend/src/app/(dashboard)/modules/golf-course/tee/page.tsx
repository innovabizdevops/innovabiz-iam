...
const PAGE = "Tee Time";
const KPIS = [{"l":"Total Golf Course","v":"6.359","t":"+13.7%","d":"up"},{"l":"Tee Time Ativos","v":"8.408","t":"+3.5%","d":"up"},{"l":"Eficiência (%)","v":"87.1%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"94","t":"+6.1%","d":"up"}];
const COLS = ["ID","Tee Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Course #001","Golf Course #002","4.539","5.486","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Course #002","Golf Course #003","4.217","7.690","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Course #003","Golf Course #004","5.074","1.757","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Course #004","Golf Course #005","5.290","1.278","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Course #005","Golf Course #001","5.775","6.532","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":284},{"label":"Mar","value":639},{"label":"Abr","value":586},{"label":"Mai","value":580},{"label":"Jun","value":538},{"label":"Jul","value":280},{"label":"Ago","value":450},{"label":"Set","value":536},{"label":"Out","value":353},{"label":"Nov","value":283},{"label":"Dez","value":318}];
const MX = 639;
