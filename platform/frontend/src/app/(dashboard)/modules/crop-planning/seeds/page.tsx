...
const PAGE = "Seed Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"8.386","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"3119","t":"+3.0%","d":"up"},{"l":"Dados Processados (GB)","v":"7.491","t":"+5.0%","d":"up"},{"l":"Utilizadores Analytics","v":"7.417","t":"+7.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","322","2026-02-19","7.870","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3528","2026-01-02","535","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","399","2026-03-09","5.498","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3744","2026-01-20","4.901","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1980","2026-02-10","5.650","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":796},{"label":"Fev","value":521},{"label":"Mar","value":481},{"label":"Abr","value":726},{"label":"Mai","value":777},{"label":"Jun","value":524},{"label":"Jul","value":687},{"label":"Ago","value":580},{"label":"Set","value":557},{"label":"Out","value":535},{"label":"Nov","value":734},{"label":"Dez","value":564}];
const MX = 796;
