...
const KPIS = [{"l":"Integrações Ativas","v":"4.690","t":"+4.7%","d":"up"},{"l":"Chamadas/Hora","v":"1161","t":"+7.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"76.3%","t":"+15.3%","d":"up"},{"l":"Latência Média (ms)","v":"111ms","t":"+5.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.715","1.157","72.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","347","5.044","74.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","285","8.616","85.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.017","8.490","78.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.216","642","92.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":656},{"label":"Fev","value":991},{"label":"Mar","value":725},{"label":"Abr","value":805},{"label":"Mai","value":1026},{"label":"Jun","value":681},{"label":"Jul","value":645},{"label":"Ago","value":726},{"label":"Set","value":745},{"label":"Out","value":989},{"label":"Nov","value":893},{"label":"Dez","value":891}];
const MX = 1026;
