...
const PAGE = "Crop Rotation";
const KPIS = [{"l":"Total Crop Planning","v":"1.163","t":"+17.0%","d":"up"},{"l":"Crop Rotation Ativos","v":"7.526","t":"-3.1%","d":"down"},{"l":"Eficiência (%)","v":"74.5%","t":"-2.4%","d":"down"},{"l":"Score Performance","v":"91","t":"-5.4%","d":"down"}];
const COLS = ["ID","Crop Rotation","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Planning #001","Crop Planning #002","2.944","8.815","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Planning #002","Crop Planning #003","5.286","3.736","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Planning #003","Crop Planning #004","7.918","4.224","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Planning #004","Crop Planning #005","4.768","8.218","2026-01-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Planning #005","Crop Planning #001","7.493","3.401","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":643},{"label":"Mar","value":864},{"label":"Abr","value":921},{"label":"Mai","value":993},{"label":"Jun","value":968},{"label":"Jul","value":789},{"label":"Ago","value":910},{"label":"Set","value":829},{"label":"Out","value":691},{"label":"Nov","value":817},{"label":"Dez","value":648}];
const MX = 993;
