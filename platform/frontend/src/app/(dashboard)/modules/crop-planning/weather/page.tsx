...
const PAGE = "Weather Sync";
const KPIS = [{"l":"Integrações Ativas","v":"6.471","t":"-4.8%","d":"down"},{"l":"Chamadas/Hora","v":"4340","t":"+9.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"91.6%","t":"+2.1%","d":"up"},{"l":"Latência Média (ms)","v":"89ms","t":"+13.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.549","2.988","99.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.236","4.573","78.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.001","1.919","86.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.021","1.737","96.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.095","1.246","88.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":706},{"label":"Mar","value":549},{"label":"Abr","value":903},{"label":"Mai","value":701},{"label":"Jun","value":612},{"label":"Jul","value":657},{"label":"Ago","value":548},{"label":"Set","value":782},{"label":"Out","value":823},{"label":"Nov","value":551},{"label":"Dez","value":910}];
const MX = 910;
