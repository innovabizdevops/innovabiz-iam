...
const PAGE = "Season Calendar";
const KPIS = [{"l":"Total Crop Planning","v":"7.627","t":"-5.4%","d":"down"},{"l":"Season Calendar Ativos","v":"5.694","t":"+6.7%","d":"up"},{"l":"Eficiência (%)","v":"76.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"72","t":"+14.3%","d":"up"}];
const COLS = ["ID","Season Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crop Planning #001","Crop Planning #002","4.801","1.627","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Crop Planning #002","Crop Planning #003","3.503","852","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Crop Planning #003","Crop Planning #004","2.149","6.083","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Crop Planning #004","Crop Planning #005","6.475","3.661","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crop Planning #005","Crop Planning #001","8.800","6.191","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":477},{"label":"Fev","value":227},{"label":"Mar","value":398},{"label":"Abr","value":396},{"label":"Mai","value":475},{"label":"Jun","value":507},{"label":"Jul","value":254},{"label":"Ago","value":567},{"label":"Set","value":521},{"label":"Out","value":479},{"label":"Nov","value":514},{"label":"Dez","value":549}];
const MX = 567;
