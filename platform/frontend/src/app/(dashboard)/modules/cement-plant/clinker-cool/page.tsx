...
/* ═══ Cement Plant — Clinker Cool ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "184", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "6", trend: "+23%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1971", trend: "-17%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "425845778", cells: ["CEM-2778", "Clinker Cool Item 1", "23/3/2026", "€45 878"], status: "active" as const },
    { id: "425849349", cells: ["CEM-6349", "Clinker Cool Item 2", "10/10/2026", "€49 449"], status: "pending" as const },
    { id: "425852920", cells: ["CEM-9920", "Clinker Cool Item 3", "25/5/2026", "€3020"], status: "completed" as const },
    { id: "425856491", cells: ["CEM-4491", "Clinker Cool Item 4", "12/12/2026", "€6591"], status: "warning" as const },
    { id: "425860062", cells: ["CEM-8062", "Clinker Cool Item 5", "27/7/2026", "€10 162"], status: "active" as const },
];
...
export default function CementPlantClinkerCoolPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Clinker Cool</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Clinker Cool</p>
                    </div>
                </div>
