...
/* ═══ Cement Plant — Quarry Mgmt ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2755", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "334", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3171", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "876255274", cells: ["CEM-7274", "Quarry Mgmt Item 1", "7/11/2026", "€5374"], status: "active" as const },
    { id: "876258845", cells: ["CEM-1845", "Quarry Mgmt Item 2", "22/6/2026", "€8945"], status: "pending" as const },
    { id: "876262416", cells: ["CEM-5416", "Quarry Mgmt Item 3", "9/1/2026", "€12 516"], status: "completed" as const },
    { id: "876265987", cells: ["CEM-8987", "Quarry Mgmt Item 4", "24/8/2026", "€16 087"], status: "warning" as const },
    { id: "876269558", cells: ["CEM-3558", "Quarry Mgmt Item 5", "11/3/2026", "€19 658"], status: "active" as const },
];
...
export default function CementPlantQuarryMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quarry Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Quarry Mgmt</p>
                    </div>
                </div>
