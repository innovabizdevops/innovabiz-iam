...
/* ═══ Cement Plant — Maintenance Cem ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "4516", trend: "-22%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "163", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1470", trend: "+10%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "537329871", cells: ["CEM-3871", "Maintenance Cem Item 1", "16/4/2026", "€29 971"], status: "active" as const },
    { id: "537333442", cells: ["CEM-7442", "Maintenance Cem Item 2", "3/11/2026", "€33 542"], status: "pending" as const },
    { id: "537337013", cells: ["CEM-2013", "Maintenance Cem Item 3", "18/6/2026", "€37 113"], status: "completed" as const },
    { id: "537340584", cells: ["CEM-5584", "Maintenance Cem Item 4", "5/1/2026", "€40 684"], status: "warning" as const },
    { id: "537344155", cells: ["CEM-9155", "Maintenance Cem Item 5", "20/8/2026", "€44 255"], status: "active" as const },
];
...
export default function CementPlantMaintenanceCemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Maintenance Cem</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Maintenance Cem</p>
                    </div>
                </div>
