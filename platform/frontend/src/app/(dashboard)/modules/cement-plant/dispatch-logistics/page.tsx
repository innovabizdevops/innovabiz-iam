...
/* ═══ Cement Plant — Dispatch Logistics ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2428", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "224", trend: "+22%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3037", trend: "-16%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "99%", trend: "+10%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1579597052", cells: ["CEM-8052", "Dispatch Logistics Item 1", "13/9/2026", "€47 152"], status: "active" as const },
    { id: "1579600623", cells: ["CEM-2623", "Dispatch Logistics Item 2", "28/4/2026", "€723"], status: "pending" as const },
    { id: "1579604194", cells: ["CEM-6194", "Dispatch Logistics Item 3", "15/11/2026", "€4294"], status: "completed" as const },
    { id: "1579607765", cells: ["CEM-9765", "Dispatch Logistics Item 4", "2/6/2026", "€7865"], status: "warning" as const },
    { id: "1579611336", cells: ["CEM-4336", "Dispatch Logistics Item 5", "17/1/2026", "€11 436"], status: "active" as const },
];
...
export default function CementPlantDispatchLogisticsPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Dispatch Logistics</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Dispatch Logistics</p>
                    </div>
                </div>
