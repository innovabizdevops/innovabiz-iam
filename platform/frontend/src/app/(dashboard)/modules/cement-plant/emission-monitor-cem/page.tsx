...
/* ═══ Cement Plant — Emission Monitor Cem ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "920", trend: "-9%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "9", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2763", trend: "+22%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "70%", trend: "-16%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "825317733", cells: ["CEM-9733", "Emission Monitor Cem Item 1", "10/10/2026", "€17 833"], status: "active" as const },
    { id: "825321304", cells: ["CEM-4304", "Emission Monitor Cem Item 2", "25/5/2026", "€21 404"], status: "pending" as const },
    { id: "825324875", cells: ["CEM-7875", "Emission Monitor Cem Item 3", "12/12/2026", "€24 975"], status: "completed" as const },
    { id: "825328446", cells: ["CEM-2446", "Emission Monitor Cem Item 4", "27/7/2026", "€28 546"], status: "warning" as const },
    { id: "825332017", cells: ["CEM-6017", "Emission Monitor Cem Item 5", "14/2/2026", "€32 117"], status: "active" as const },
];
...
export default function CementPlantEmissionMonitorCemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Emission Monitor Cem</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Emission Monitor Cem</p>
                    </div>
                </div>
