...
/* ═══ Cement Plant — Kiln Control ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "1988", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "168", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3069", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "871338260", cells: ["CEM-4260", "Kiln Control Item 1", "17/9/2026", "€38 360"], status: "active" as const },
    { id: "871341831", cells: ["CEM-7831", "Kiln Control Item 2", "4/4/2026", "€41 931"], status: "pending" as const },
    { id: "871345402", cells: ["CEM-2402", "Kiln Control Item 3", "19/11/2026", "€45 502"], status: "completed" as const },
    { id: "871348973", cells: ["CEM-5973", "Kiln Control Item 4", "6/6/2026", "€49 073"], status: "warning" as const },
    { id: "871352544", cells: ["CEM-9544", "Kiln Control Item 5", "21/1/2026", "€2644"], status: "active" as const },
];
...
export default function CementPlantKilnControlPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Kiln Control</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Kiln Control</p>
                    </div>
                </div>
