...
/* ═══ Cement Plant — Energy Mgmt Cem ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "2605", trend: "+14%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "25", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3554", trend: "-2%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "90%", trend: "+21%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "158338613", cells: ["CEM-2613", "Energy Mgmt Cem Item 1", "14/6/2026", "€38 713"], status: "active" as const },
    { id: "158342184", cells: ["CEM-6184", "Energy Mgmt Cem Item 2", "1/1/2026", "€42 284"], status: "pending" as const },
    { id: "158345755", cells: ["CEM-9755", "Energy Mgmt Cem Item 3", "16/8/2026", "€45 855"], status: "completed" as const },
    { id: "158349326", cells: ["CEM-4326", "Energy Mgmt Cem Item 4", "3/3/2026", "€49 426"], status: "warning" as const },
    { id: "158352897", cells: ["CEM-7897", "Energy Mgmt Cem Item 5", "18/10/2026", "€2997"], status: "active" as const },
];
...
export default function CementPlantEnergyMgmtCemPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Energy Mgmt Cem</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Energy Mgmt Cem</p>
                    </div>
                </div>
