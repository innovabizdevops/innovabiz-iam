...
/* ═══ Cement Plant — Quality Lab Cement ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "103", trend: "-24%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "337", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "540", trend: "+12%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1475820573", cells: ["CEM-1573", "Quality Lab Cement Item 1", "18/10/2026", "€20 673"], status: "active" as const },
    { id: "1475824144", cells: ["CEM-5144", "Quality Lab Cement Item 2", "5/5/2026", "€24 244"], status: "pending" as const },
    { id: "1475827715", cells: ["CEM-8715", "Quality Lab Cement Item 3", "20/12/2026", "€27 815"], status: "completed" as const },
    { id: "1475831286", cells: ["CEM-3286", "Quality Lab Cement Item 4", "7/7/2026", "€31 386"], status: "warning" as const },
    { id: "1475834857", cells: ["CEM-6857", "Quality Lab Cement Item 5", "22/2/2026", "€34 957"], status: "active" as const },
];
...
export default function CementPlantQualityLabCementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Quality Lab Cement</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Quality Lab Cement</p>
                    </div>
                </div>
