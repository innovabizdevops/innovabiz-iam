...
/* ═══ Cement Plant — Cement Mill ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total", value: "3975", trend: "-6%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "97", trend: "+25%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3232", trend: "+19%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "860969805", cells: ["CEM-3805", "Cement Mill Item 1", "18/10/2026", "€19 905"], status: "active" as const },
    { id: "860973376", cells: ["CEM-7376", "Cement Mill Item 2", "5/5/2026", "€23 476"], status: "pending" as const },
    { id: "860976947", cells: ["CEM-1947", "Cement Mill Item 3", "20/12/2026", "€27 047"], status: "completed" as const },
    { id: "860980518", cells: ["CEM-5518", "Cement Mill Item 4", "7/7/2026", "€30 618"], status: "warning" as const },
    { id: "860984089", cells: ["CEM-9089", "Cement Mill Item 5", "22/2/2026", "€34 189"], status: "active" as const },
];
...
export default function CementPlantCementMillPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cement Mill</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Cement Mill</p>
                    </div>
                </div>
