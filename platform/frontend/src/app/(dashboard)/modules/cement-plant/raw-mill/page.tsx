...
const KPIS = [
    { label: "Total", value: "3133", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "423", trend: "-13%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3105", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1078539043", cells: ["CEM-7043", "Raw Mill Item 1", "16/8/2026", "€39 143"], status: "active" as const },
    { id: "1078542614", cells: ["CEM-1614", "Raw Mill Item 2", "3/3/2026", "€42 714"], status: "pending" as const },
    { id: "1078546185", cells: ["CEM-5185", "Raw Mill Item 3", "18/10/2026", "€46 285"], status: "completed" as const },
    { id: "1078549756", cells: ["CEM-8756", "Raw Mill Item 4", "5/5/2026", "€49 856"], status: "warning" as const },
    { id: "1078553327", cells: ["CEM-3327", "Raw Mill Item 5", "20/12/2026", "€3427"], status: "active" as const },
];
...
export default function CementPlantRawMillPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Raw Mill</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Cement Plant • Raw Mill</p>
                    </div>
                </div>
