...
/* ═══ Impact Investing Deep — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "4424", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4832", trend: "-19%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€476K", trend: "+13%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+7%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1058215324", cells: ["IMP-5324", "Impact Investing Deep Item 1", "13/5/2026", "€15 424"], status: "active" as const },
    { id: "1058218895", cells: ["IMP-8895", "Impact Investing Deep Item 2", "28/12/2026", "€18 995"], status: "pending" as const },
    { id: "1058222466", cells: ["IMP-3466", "Impact Investing Deep Item 3", "15/7/2026", "€22 566"], status: "completed" as const },
    { id: "1058226037", cells: ["IMP-7037", "Impact Investing Deep Item 4", "2/2/2026", "€26 137"], status: "warning" as const },
    { id: "1058229608", cells: ["IMP-1608", "Impact Investing Deep Item 5", "17/9/2026", "€29 708"], status: "active" as const },
];
...
export default function ImpactInvestingDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Impact Investing Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Impact Investing Deep</p>
                    </div>
                </div>
