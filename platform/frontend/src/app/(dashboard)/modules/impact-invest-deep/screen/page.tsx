...
const PAGE = "Screen";
const KPIS = [{"l":"Projetos Sociais","v":"8.186","t":"-3.7%","d":"down"},{"l":"Beneficiários","v":"1.216","t":"+7.7%","d":"up"},{"l":"Investimento CSR (€)","v":"€49563","t":"+1.4%","d":"up"},{"l":"Score Impacto","v":"70","t":"+8.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.602","€ 13391.76","7.128","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.078","€ 37169.52","8.101","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","1.191","€ 7010.81","2.342","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.463","€ 31927.05","4.276","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","2.118","€ 24122.39","3.419","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":484},{"label":"Fev","value":265},{"label":"Mar","value":558},{"label":"Abr","value":500},{"label":"Mai","value":592},{"label":"Jun","value":389},{"label":"Jul","value":314},{"label":"Ago","value":593},{"label":"Set","value":406},{"label":"Out","value":536},{"label":"Nov","value":599},{"label":"Dez","value":351}];
const MX = 599;
