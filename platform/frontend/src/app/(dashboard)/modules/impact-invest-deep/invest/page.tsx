...
const PAGE = "Invest";
const KPIS = [{"l":"Projetos Sociais","v":"1.560","t":"+14.1%","d":"up"},{"l":"Beneficiários","v":"3.166","t":"+16.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€41403","t":"+6.6%","d":"up"},{"l":"Score Impacto","v":"94","t":"+9.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","6.917","€ 26398.19","8.448","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","997","€ 24530.74","8.457","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","8.600","€ 26678.76","1.827","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","6.415","€ 22094.98","323","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","4.750","€ 8153.46","3.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":435},{"label":"Fev","value":304},{"label":"Mar","value":275},{"label":"Abr","value":392},{"label":"Mai","value":385},{"label":"Jun","value":408},{"label":"Jul","value":477},{"label":"Ago","value":249},{"label":"Set","value":249},{"label":"Out","value":416},{"label":"Nov","value":560},{"label":"Dez","value":362}];
const MX = 560;
