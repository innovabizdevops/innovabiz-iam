...
const ACCENT = "#9d174d";
const MODULE = "Impact Investing Deep";
const PAGE = "Due Diligence";
const KPIS = [{"l":"Projetos Sociais","v":"3.849","t":"+3.7%","d":"up"},{"l":"Beneficiários","v":"4.054","t":"-1.9%","d":"down"},{"l":"Investimento CSR (€)","v":"€27049","t":"+15.4%","d":"up"},{"l":"Score Impacto","v":"84","t":"+2.8%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.596","€ 19839.08","7.114","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.820","€ 48096.66","5.657","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.027","€ 27223.72","6.295","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","7.521","€ 8659.82","103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.406","€ 12635.31","5.867","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":692},{"label":"Mar","value":545},{"label":"Abr","value":484},{"label":"Mai","value":633},{"label":"Jun","value":602},{"label":"Jul","value":502},{"label":"Ago","value":713},{"label":"Set","value":386},{"label":"Out","value":652},{"label":"Nov","value":634},{"label":"Dez","value":684}];
const MX = 713;
