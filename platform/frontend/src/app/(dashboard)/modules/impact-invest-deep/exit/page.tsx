...
const PAGE = "Exit";
const KPIS = [{"l":"Projetos Sociais","v":"3.288","t":"-4.8%","d":"down"},{"l":"Beneficiários","v":"1.478","t":"-2.5%","d":"down"},{"l":"Investimento CSR (€)","v":"€11767","t":"+7.9%","d":"up"},{"l":"Score Impacto","v":"94","t":"+15.6%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","1.510","€ 5126.17","2.113","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","3.629","€ 42732.27","8.016","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.765","€ 30611.42","5.037","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","8.857","€ 17396.64","2.346","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","6.003","€ 34114.83","7.036","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":660},{"label":"Mar","value":518},{"label":"Abr","value":340},{"label":"Mai","value":584},{"label":"Jun","value":333},{"label":"Jul","value":397},{"label":"Ago","value":541},{"label":"Set","value":520},{"label":"Out","value":660},{"label":"Nov","value":525},{"label":"Dez","value":685}];
const MX = 685;
