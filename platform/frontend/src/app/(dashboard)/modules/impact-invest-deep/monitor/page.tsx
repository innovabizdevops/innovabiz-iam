...
const PAGE = "Monitor";
const KPIS = [{"l":"Projetos Sociais","v":"5.995","t":"+16.3%","d":"up"},{"l":"Beneficiários","v":"4.138","t":"+5.1%","d":"up"},{"l":"Investimento CSR (€)","v":"€63091","t":"+2.6%","d":"up"},{"l":"Score Impacto","v":"66","t":"+16.2%","d":"up"}];
const COLS = ["Projeto","ODS","Beneficiários","Budget (€)","Parceiro","Estado"];
const ROWS = [{"id":"r0","cells":["Educação STEM Angola","Água Limpa Rural","2.883","€ 30432.41","5.326","Ativo"],"status":"active"},{"id":"r1","cells":["Água Limpa Rural","Digital Literacy","5.053","€ 35404.14","511","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Literacy","Microcrédito Mulheres","4.117","€ 49016.84","8.982","Concluído"],"status":"done"},{"id":"r3","cells":["Microcrédito Mulheres","Saúde Comunitária","816","€ 10051.03","8.680","Em Análise"],"status":"risk"},{"id":"r4","cells":["Saúde Comunitária","Educação STEM Angola","7.160","€ 28520.31","1.734","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":580},{"label":"Fev","value":891},{"label":"Mar","value":887},{"label":"Abr","value":807},{"label":"Mai","value":934},{"label":"Jun","value":711},{"label":"Jul","value":779},{"label":"Ago","value":774},{"label":"Set","value":938},{"label":"Out","value":827},{"label":"Nov","value":681},{"label":"Dez","value":578}];
const MX = 938;
