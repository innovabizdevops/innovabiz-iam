...
/* ═══ Census & Population Platform — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4244", trend: "+20%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4265", trend: "-14%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€485K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "97%", trend: "+2%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1318357444", cells: ["CEN-2444", "Census & Population Platform Item 1", "13/5/2026", "€7544"], status: "active" as const },
    { id: "1318361015", cells: ["CEN-6015", "Census & Population Platform Item 2", "28/12/2026", "€11 115"], status: "pending" as const },
    { id: "1318364586", cells: ["CEN-9586", "Census & Population Platform Item 3", "15/7/2026", "€14 686"], status: "completed" as const },
    { id: "1318368157", cells: ["CEN-4157", "Census & Population Platform Item 4", "2/2/2026", "€18 257"], status: "warning" as const },
    { id: "1318371728", cells: ["CEN-7728", "Census & Population Platform Item 5", "17/9/2026", "€21 828"], status: "active" as const },
];
...
export default function CensusPopulationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Census & Population Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Census & Population Platform</p>
                    </div>
                </div>
