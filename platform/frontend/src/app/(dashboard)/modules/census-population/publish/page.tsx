...
const PAGE = "Publish";
const KPIS = [{"l":"Total Census Population","v":"514","t":"+2.9%","d":"up"},{"l":"Publish Ativos","v":"3.466","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"71.5%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"89","t":"-3.6%","d":"down"}];
const COLS = ["ID","Publish","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Census Population #001","Census Population #002","266","1.148","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["Census Population #002","Census Population #003","8.865","5.766","2026-02-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Census Population #003","Census Population #004","5.794","5.691","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Census Population #004","Census Population #005","4.460","9.040","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Census Population #005","Census Population #001","1.092","6.056","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":605},{"label":"Mar","value":547},{"label":"Abr","value":714},{"label":"Mai","value":462},{"label":"Jun","value":740},{"label":"Jul","value":585},{"label":"Ago","value":367},{"label":"Set","value":674},{"label":"Out","value":711},{"label":"Nov","value":426},{"label":"Dez","value":430}];
const MX = 740;
