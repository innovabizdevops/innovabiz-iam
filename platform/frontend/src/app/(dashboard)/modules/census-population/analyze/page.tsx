...
const ACCENT = "#1e3a5f";
const MODULE = "Census & Population Platform";
const PAGE = "Analyze";
const KPIS = [{"l":"Dashboards Ativos","v":"2.545","t":"+7.5%","d":"up"},{"l":"Queries/Dia","v":"2244","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"2.215","t":"+16.5%","d":"up"},{"l":"Utilizadores Analytics","v":"9.005","t":"+3.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","389","2026-03-12","6.285","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4250","2026-03-03","4.682","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2479","2026-01-22","8.490","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3063","2026-03-15","1.831","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","178","2026-01-10","4.221","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":781},{"label":"Fev","value":648},{"label":"Mar","value":1000},{"label":"Abr","value":878},{"label":"Mai","value":749},{"label":"Jun","value":1018},{"label":"Jul","value":957},{"label":"Ago","value":949},{"label":"Set","value":762},{"label":"Out","value":859},{"label":"Nov","value":935},{"label":"Dez","value":691}];
const MX = 1018;
