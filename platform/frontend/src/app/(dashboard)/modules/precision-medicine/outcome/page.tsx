...
const PAGE = "Outcome";
const KPIS = [{"l":"Integrações Ativas","v":"4.782","t":"+17.8%","d":"up"},{"l":"Chamadas/Hora","v":"4680","t":"+12.4%","d":"up"},{"l":"Taxa Sucesso (%)","v":"92.2%","t":"-4.1%","d":"down"},{"l":"Latência Média (ms)","v":"13ms","t":"+8.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.615","6.625","91.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.870","4.011","96.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.915","6.046","88.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.590","7.473","81.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.147","942","99.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":297},{"label":"Fev","value":393},{"label":"Mar","value":584},{"label":"Abr","value":339},{"label":"Mai","value":432},{"label":"Jun","value":587},{"label":"Jul","value":600},{"label":"Ago","value":552},{"label":"Set","value":336},{"label":"Out","value":599},{"label":"Nov","value":281},{"label":"Dez","value":429}];
const MX = 600;
