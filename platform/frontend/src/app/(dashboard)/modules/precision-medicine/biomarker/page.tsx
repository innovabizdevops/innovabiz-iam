...
const KPIS = [{"l":"Integrações Ativas","v":"7.072","t":"+5.6%","d":"up"},{"l":"Chamadas/Hora","v":"3170","t":"-5.2%","d":"down"},{"l":"Taxa Sucesso (%)","v":"88.7%","t":"+14.1%","d":"up"},{"l":"Latência Média (ms)","v":"131ms","t":"+15.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.944","7.424","70.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","7.280","665","96.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.050","8.840","76.8%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.237","757","98.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.768","8.145","82.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":692},{"label":"Fev","value":779},{"label":"Mar","value":727},{"label":"Abr","value":657},{"label":"Mai","value":608},{"label":"Jun","value":686},{"label":"Jul","value":792},{"label":"Ago","value":457},{"label":"Set","value":491},{"label":"Out","value":786},{"label":"Nov","value":613},{"label":"Dez","value":482}];
const MX = 792;
