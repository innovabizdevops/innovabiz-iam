...
const PAGE = "Trial";
const KPIS = [{"l":"Integrações Ativas","v":"3.461","t":"+16.7%","d":"up"},{"l":"Chamadas/Hora","v":"3744","t":"+3.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"88.3%","t":"-0.6%","d":"down"},{"l":"Latência Média (ms)","v":"6ms","t":"+11.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.216","9.048","76.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.501","8.249","85.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.377","5.314","99.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.496","3.534","87.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.652","6.205","75.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":808},{"label":"Fev","value":761},{"label":"Mar","value":909},{"label":"Abr","value":663},{"label":"Mai","value":705},{"label":"Jun","value":662},{"label":"Jul","value":599},{"label":"Ago","value":872},{"label":"Set","value":550},{"label":"Out","value":702},{"label":"Nov","value":717},{"label":"Dez","value":650}];
const MX = 909;
