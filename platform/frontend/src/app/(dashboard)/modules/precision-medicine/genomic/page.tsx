...
const PAGE = "Genomic";
const KPIS = [{"l":"Integrações Ativas","v":"3.023","t":"-2.6%","d":"down"},{"l":"Chamadas/Hora","v":"1780","t":"+6.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"79.0%","t":"-5.0%","d":"down"},{"l":"Latência Média (ms)","v":"165ms","t":"+17.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","3.293","6.481","90.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.468","242","98.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.877","2.144","88.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.184","8.813","83.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.704","2.365","75.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":513},{"label":"Mar","value":296},{"label":"Abr","value":385},{"label":"Mai","value":325},{"label":"Jun","value":529},{"label":"Jul","value":319},{"label":"Ago","value":484},{"label":"Set","value":382},{"label":"Out","value":510},{"label":"Nov","value":636},{"label":"Dez","value":309}];
const MX = 687;
