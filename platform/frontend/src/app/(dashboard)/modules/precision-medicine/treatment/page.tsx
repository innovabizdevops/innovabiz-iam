...
const KPIS = [{"l":"Integrações Ativas","v":"2.361","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"2708","t":"+4.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.3%","t":"-2.9%","d":"down"},{"l":"Latência Média (ms)","v":"70ms","t":"+2.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","8.544","6.565","95.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.840","2.561","71.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.059","8.127","72.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.328","5.384","70.6%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.402","3.507","89.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":555},{"label":"Fev","value":540},{"label":"Mar","value":353},{"label":"Abr","value":347},{"label":"Mai","value":344},{"label":"Jun","value":300},{"label":"Jul","value":246},{"label":"Ago","value":494},{"label":"Set","value":259},{"label":"Out","value":593},{"label":"Nov","value":433},{"label":"Dez","value":361}];
const MX = 593;
