...
const PAGE = "Course";
const KPIS = [{"l":"Total Golf Ops","v":"371","t":"+10.8%","d":"up"},{"l":"Course Ativos","v":"7.755","t":"+2.9%","d":"up"},{"l":"Eficiência (%)","v":"93.5%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"64","t":"+11.5%","d":"up"}];
const COLS = ["ID","Course","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Ops #001","Golf Ops #002","7.677","8.750","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Ops #002","Golf Ops #003","5.308","6.933","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Ops #003","Golf Ops #004","9.034","7.090","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Ops #004","Golf Ops #005","457","2.652","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Ops #005","Golf Ops #001","1.237","1.197","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":590},{"label":"Mar","value":438},{"label":"Abr","value":504},{"label":"Mai","value":381},{"label":"Jun","value":524},{"label":"Jul","value":520},{"label":"Ago","value":495},{"label":"Set","value":605},{"label":"Out","value":349},{"label":"Nov","value":520},{"label":"Dez","value":642}];
const MX = 642;
