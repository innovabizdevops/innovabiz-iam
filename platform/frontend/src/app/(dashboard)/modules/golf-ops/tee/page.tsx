...
const PAGE = "Tee Time";
const KPIS = [{"l":"Total Golf Ops","v":"612","t":"+3.7%","d":"up"},{"l":"Tee Time Ativos","v":"4.109","t":"+5.1%","d":"up"},{"l":"Eficiência (%)","v":"86.2%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"64","t":"-4.4%","d":"down"}];
const COLS = ["ID","Tee Time","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Ops #001","Golf Ops #002","3.642","5.068","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Ops #002","Golf Ops #003","5.944","4.405","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Ops #003","Golf Ops #004","3.298","4.816","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Ops #004","Golf Ops #005","3.029","8.685","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Ops #005","Golf Ops #001","1.443","1.261","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":630},{"label":"Fev","value":621},{"label":"Mar","value":568},{"label":"Abr","value":610},{"label":"Mai","value":812},{"label":"Jun","value":811},{"label":"Jul","value":830},{"label":"Ago","value":672},{"label":"Set","value":818},{"label":"Out","value":904},{"label":"Nov","value":638},{"label":"Dez","value":676}];
const MX = 904;
