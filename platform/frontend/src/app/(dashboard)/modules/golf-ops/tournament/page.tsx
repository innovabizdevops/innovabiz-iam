...
const KPIS = [{"l":"Atletas Registados","v":"5.699","t":"-3.5%","d":"down"},{"l":"Treinos/Semana","v":"2166","t":"+3.9%","d":"up"},{"l":"Competições","v":"6.163","t":"+4.3%","d":"up"},{"l":"Performance Score","v":"63","t":"+15.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.642","9.097","3.029","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.224","2.363","6.910","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.398","5.334","7.103","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","9.038","4.077","4.334","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.920","5.862","8.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":380},{"label":"Fev","value":626},{"label":"Mar","value":537},{"label":"Abr","value":498},{"label":"Mai","value":367},{"label":"Jun","value":601},{"label":"Jul","value":581},{"label":"Ago","value":391},{"label":"Set","value":552},{"label":"Out","value":291},{"label":"Nov","value":607},{"label":"Dez","value":511}];
const MX = 626;
