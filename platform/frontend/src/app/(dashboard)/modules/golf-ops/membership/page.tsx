...
const ACCENT = "#15803d";
const MODULE = "Golf Operations";
const PAGE = "Membership";
const KPIS = [{"l":"Total Golf Ops","v":"4.290","t":"+2.0%","d":"up"},{"l":"Membership Ativos","v":"7.933","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"71.3%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"59","t":"-5.5%","d":"down"}];
const COLS = ["ID","Membership","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Golf Ops #001","Golf Ops #002","7.352","1.805","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Golf Ops #002","Golf Ops #003","2.964","1.493","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Golf Ops #003","Golf Ops #004","7.475","3.249","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Golf Ops #004","Golf Ops #005","5.150","6.679","2026-03-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Golf Ops #005","Golf Ops #001","7.240","251","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":719},{"label":"Mar","value":1013},{"label":"Abr","value":820},{"label":"Mai","value":966},{"label":"Jun","value":813},{"label":"Jul","value":781},{"label":"Ago","value":725},{"label":"Set","value":897},{"label":"Out","value":675},{"label":"Nov","value":826},{"label":"Dez","value":865}];
const MX = 1013;
