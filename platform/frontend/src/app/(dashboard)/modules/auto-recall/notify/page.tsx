...
const ACCENT = "#1e3a5f";
const MODULE = "Auto Recall Management";
const PAGE = "Notify";
const KPIS = [{"l":"Notificações Enviadas","v":"3.176","t":"+4.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"71.6%","t":"-6.0%","d":"down"},{"l":"Taxa Abertura (%)","v":"94.0%","t":"-5.3%","d":"down"},{"l":"Escalações","v":"1.632","t":"-1.6%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","492","100.0%","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.259","99.7%","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.667","95.3%","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.277","77.0%","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.410","86.2%","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":298},{"label":"Mar","value":353},{"label":"Abr","value":495},{"label":"Mai","value":329},{"label":"Jun","value":304},{"label":"Jul","value":233},{"label":"Ago","value":317},{"label":"Set","value":572},{"label":"Out","value":449},{"label":"Nov","value":221},{"label":"Dez","value":615}];
const MX = 615;
