...
/* ═══ Auto Recall Management — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "4870", trend: "-21%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4903", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€49K", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "360750870", cells: ["AUT-4870", "Auto Recall Management Item 1", "19/7/2026", "€970"], status: "active" as const },
    { id: "360754441", cells: ["AUT-8441", "Auto Recall Management Item 2", "6/2/2026", "€4541"], status: "pending" as const },
    { id: "360758012", cells: ["AUT-3012", "Auto Recall Management Item 3", "21/9/2026", "€8112"], status: "completed" as const },
    { id: "360761583", cells: ["AUT-6583", "Auto Recall Management Item 4", "8/4/2026", "€11 683"], status: "warning" as const },
    { id: "360765154", cells: ["AUT-1154", "Auto Recall Management Item 5", "23/11/2026", "€15 254"], status: "active" as const },
];
...
export default function AutoRecallManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Auto Recall Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Auto Recall Management</p>
                    </div>
                </div>
