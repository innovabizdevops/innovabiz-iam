...
const PAGE = "Party";
const KPIS = [{"l":"Total Laser Tag","v":"3.501","t":"+17.0%","d":"up"},{"l":"Party Ativos","v":"9.001","t":"+15.5%","d":"up"},{"l":"Eficiência (%)","v":"68.2%","t":"+13.5%","d":"up"},{"l":"Score Performance","v":"86","t":"+5.1%","d":"up"}];
const COLS = ["ID","Party","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laser Tag #001","Laser Tag #002","5.185","1.645","2026-02-15","Ativo"],"status":"active"},{"id":"r1","cells":["Laser Tag #002","Laser Tag #003","1.404","7.088","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Laser Tag #003","Laser Tag #004","2.099","9.036","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Laser Tag #004","Laser Tag #005","1.855","616","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laser Tag #005","Laser Tag #001","7.870","3.033","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":339},{"label":"Fev","value":420},{"label":"Mar","value":589},{"label":"Abr","value":491},{"label":"Mai","value":609},{"label":"Jun","value":334},{"label":"Jul","value":449},{"label":"Ago","value":508},{"label":"Set","value":357},{"label":"Out","value":313},{"label":"Nov","value":524},{"label":"Dez","value":321}];
const MX = 609;
