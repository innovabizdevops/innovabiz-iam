...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€4.0M","t":"-5.4%","d":"down"},{"l":"MRR (€)","v":"€6601","t":"+3.8%","d":"up"},{"l":"Churn (%)","v":"71.2%","t":"+15.4%","d":"up"},{"l":"ARPU (€)","v":"€35854","t":"+5.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 17446.33","8.368","€ 14662.76","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 42207.59","625","€ 44529.58","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 41848.05","3.436","€ 37116.98","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 17696.92","8.916","€ 11920.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34526.49","5.297","€ 30362.72","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":483},{"label":"Fev","value":479},{"label":"Mar","value":623},{"label":"Abr","value":302},{"label":"Mai","value":369},{"label":"Jun","value":270},{"label":"Jul","value":438},{"label":"Ago","value":355},{"label":"Set","value":392},{"label":"Out","value":555},{"label":"Nov","value":386},{"label":"Dez","value":360}];
const MX = 623;
