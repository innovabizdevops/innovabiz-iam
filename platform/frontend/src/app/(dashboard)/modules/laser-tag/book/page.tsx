...
const PAGE = "Book";
const KPIS = [{"l":"Total Laser Tag","v":"8.655","t":"+5.9%","d":"up"},{"l":"Book Ativos","v":"2.610","t":"+4.4%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"+0.4%","d":"up"},{"l":"Score Performance","v":"60","t":"+16.8%","d":"up"}];
const COLS = ["ID","Book","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Laser Tag #001","Laser Tag #002","7.565","950","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Laser Tag #002","Laser Tag #003","1.746","4.893","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Laser Tag #003","Laser Tag #004","6.599","6.968","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Laser Tag #004","Laser Tag #005","3.705","3.113","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Laser Tag #005","Laser Tag #001","6.811","1.257","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":994},{"label":"Fev","value":732},{"label":"Mar","value":779},{"label":"Abr","value":759},{"label":"Mai","value":789},{"label":"Jun","value":723},{"label":"Jul","value":829},{"label":"Ago","value":1059},{"label":"Set","value":983},{"label":"Out","value":1033},{"label":"Nov","value":858},{"label":"Dez","value":710}];
const MX = 1059;
