...
/* ═══ Laser Tag Arena — Dashboard ═══ */

const ACCENT = "#ef4444";

const KPIS = [
    { label: "Total Registos", value: "7639", trend: "-15%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3123", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€289K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1095591039", cells: ["LAS-4039", "Laser Tag Arena Item 1", "12/4/2026", "€41 139"], status: "active" as const },
    { id: "1095594610", cells: ["LAS-7610", "Laser Tag Arena Item 2", "27/11/2026", "€44 710"], status: "pending" as const },
    { id: "1095598181", cells: ["LAS-2181", "Laser Tag Arena Item 3", "14/6/2026", "€48 281"], status: "completed" as const },
    { id: "1095601752", cells: ["LAS-5752", "Laser Tag Arena Item 4", "1/1/2026", "€1852"], status: "warning" as const },
    { id: "1095605323", cells: ["LAS-9323", "Laser Tag Arena Item 5", "16/8/2026", "€5423"], status: "active" as const },
];
...
export default function LaserTagArenaPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Laser Tag Arena</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Laser Tag Arena</p>
                    </div>
                </div>
