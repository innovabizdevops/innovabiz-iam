...
const ACCENT = "#1e40af";
const MODULE = "DC Operations";
const PAGE = "DCIM Platform";
const KPIS = [{"l":"Formulários Ativos","v":"2.012","t":"+10.7%","d":"up"},{"l":"Submissões/Dia","v":"3447","t":"+15.6%","d":"up"},{"l":"Documentos Gerados","v":"5.796","t":"+10.8%","d":"up"},{"l":"Templates","v":"1.271","t":"+9.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.951","2026-03-03","3.210","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.980","2026-03-06","2.018","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.040","2026-03-24","9.003","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.717","2026-01-05","3.968","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.987","2026-01-14","3.151","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":617},{"label":"Mar","value":793},{"label":"Abr","value":557},{"label":"Mai","value":673},{"label":"Jun","value":710},{"label":"Jul","value":750},{"label":"Ago","value":897},{"label":"Set","value":862},{"label":"Out","value":832},{"label":"Nov","value":846},{"label":"Dez","value":883}];
const MX = 897;
