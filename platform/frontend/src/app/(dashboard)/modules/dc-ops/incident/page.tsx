...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"8.201","t":"+12.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"79.3%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"84h","t":"+2.5%","d":"up"},{"l":"Satisfação (%)","v":"82.3%","t":"-0.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.780","7.561","6.609","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.436","647","783","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.736","8.860","2.532","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.709","1.159","1.700","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.529","7.186","1.265","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":940},{"label":"Mar","value":671},{"label":"Abr","value":972},{"label":"Mai","value":938},{"label":"Jun","value":1032},{"label":"Jul","value":906},{"label":"Ago","value":787},{"label":"Set","value":917},{"label":"Out","value":670},{"label":"Nov","value":666},{"label":"Dez","value":922}];
const MX = 1032;
