...
const PAGE = "Capacity Plan";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.277","t":"-1.8%","d":"down"},{"l":"NC Abertas","v":"2.638","t":"+9.5%","d":"up"},{"l":"Conformidade (%)","v":"88.6%","t":"+9.1%","d":"up"},{"l":"CAPAs Pendentes","v":"8.525","t":"-5.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.684","82.5%","3.971","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.660","88.4%","5.200","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.707","90.9%","5.068","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","1.578","77.3%","1.257","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.689","92.5%","239","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":863},{"label":"Fev","value":963},{"label":"Mar","value":958},{"label":"Abr","value":876},{"label":"Mai","value":734},{"label":"Jun","value":949},{"label":"Jul","value":784},{"label":"Ago","value":914},{"label":"Set","value":972},{"label":"Out","value":782},{"label":"Nov","value":1057},{"label":"Dez","value":781}];
const MX = 1057;
