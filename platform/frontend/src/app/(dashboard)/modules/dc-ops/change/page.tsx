...
const KPIS = [{"l":"Total Dc Ops","v":"185","t":"+17.6%","d":"up"},{"l":"Change Window Ativos","v":"8.188","t":"+14.2%","d":"up"},{"l":"Eficiência (%)","v":"70.6%","t":"+11.9%","d":"up"},{"l":"Score Performance","v":"78","t":"+9.6%","d":"up"}];
const COLS = ["ID","Change Window","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Dc Ops #001","Dc Ops #002","6.533","4.148","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Dc Ops #002","Dc Ops #003","8.257","8.574","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Dc Ops #003","Dc Ops #004","3.600","2.910","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Dc Ops #004","Dc Ops #005","2.984","8.522","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Dc Ops #005","Dc Ops #001","5.761","2.431","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":507},{"label":"Fev","value":445},{"label":"Mar","value":307},{"label":"Abr","value":587},{"label":"Mai","value":329},{"label":"Jun","value":360},{"label":"Jul","value":502},{"label":"Ago","value":430},{"label":"Set","value":307},{"label":"Out","value":509},{"label":"Nov","value":441},{"label":"Dez","value":396}];
const MX = 587;
