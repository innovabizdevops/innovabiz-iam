...
const PAGE = "CDISC Standard";
const KPIS = [{"l":"Dashboards Ativos","v":"6.561","t":"+3.6%","d":"up"},{"l":"Queries/Dia","v":"159","t":"+6.1%","d":"up"},{"l":"Dados Processados (GB)","v":"549","t":"+12.1%","d":"up"},{"l":"Utilizadores Analytics","v":"3.120","t":"+11.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2334","2026-01-07","1.878","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","809","2026-01-01","6.576","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2018","2026-02-21","4.792","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5026","2026-02-06","6.581","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4284","2026-01-17","8.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":401},{"label":"Mar","value":650},{"label":"Abr","value":561},{"label":"Mai","value":645},{"label":"Jun","value":380},{"label":"Jul","value":581},{"label":"Ago","value":350},{"label":"Set","value":355},{"label":"Out","value":499},{"label":"Nov","value":627},{"label":"Dez","value":407}];
const MX = 650;
