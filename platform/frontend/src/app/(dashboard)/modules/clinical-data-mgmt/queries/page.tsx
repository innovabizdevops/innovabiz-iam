...
const PAGE = "Query Mgmt";
const KPIS = [{"l":"Dashboards Ativos","v":"3.499","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"440","t":"-1.1%","d":"down"},{"l":"Dados Processados (GB)","v":"7.759","t":"+15.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.051","t":"+2.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4308","2026-02-07","5.786","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2313","2026-02-07","7.906","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4233","2026-02-16","7.648","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4223","2026-02-20","5.549","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4451","2026-01-12","778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":866},{"label":"Fev","value":1001},{"label":"Mar","value":729},{"label":"Abr","value":981},{"label":"Mai","value":991},{"label":"Jun","value":910},{"label":"Jul","value":835},{"label":"Ago","value":936},{"label":"Set","value":704},{"label":"Out","value":686},{"label":"Nov","value":1021},{"label":"Dez","value":844}];
const MX = 1021;
