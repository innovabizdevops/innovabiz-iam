...
const PAGE = "EDC System";
const KPIS = [{"l":"Dashboards Ativos","v":"3.285","t":"+4.1%","d":"up"},{"l":"Queries/Dia","v":"232","t":"+7.3%","d":"up"},{"l":"Dados Processados (GB)","v":"9.014","t":"+3.1%","d":"up"},{"l":"Utilizadores Analytics","v":"7.979","t":"+8.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2802","2026-01-24","5.977","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1895","2026-01-11","5.667","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3841","2026-03-14","1.819","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4445","2026-03-18","7.103","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2791","2026-02-10","5.757","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":949},{"label":"Fev","value":955},{"label":"Mar","value":745},{"label":"Abr","value":944},{"label":"Mai","value":1027},{"label":"Jun","value":965},{"label":"Jul","value":857},{"label":"Ago","value":854},{"label":"Set","value":943},{"label":"Out","value":736},{"label":"Nov","value":1005},{"label":"Dez","value":923}];
const MX = 1027;
