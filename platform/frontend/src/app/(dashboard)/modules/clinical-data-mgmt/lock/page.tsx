...
const ACCENT = "#059669";
const MODULE = "Clinical Data Mgmt";
const PAGE = "Database Lock";
const KPIS = [{"l":"Dashboards Ativos","v":"2.499","t":"+5.9%","d":"up"},{"l":"Queries/Dia","v":"517","t":"-4.0%","d":"down"},{"l":"Dados Processados (GB)","v":"8.797","t":"+0.9%","d":"up"},{"l":"Utilizadores Analytics","v":"604","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4894","2026-02-26","3.488","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3607","2026-03-16","7.994","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","312","2026-02-20","8.823","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","816","2026-02-16","6.778","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1166","2026-01-03","6.646","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":908},{"label":"Mar","value":856},{"label":"Abr","value":763},{"label":"Mai","value":882},{"label":"Jun","value":776},{"label":"Jul","value":819},{"label":"Ago","value":766},{"label":"Set","value":963},{"label":"Out","value":981},{"label":"Nov","value":736},{"label":"Dez","value":916}];
const MX = 981;
