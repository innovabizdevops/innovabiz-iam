...
const PAGE = "Data Cleaning";
const KPIS = [{"l":"Dashboards Ativos","v":"2.578","t":"+14.7%","d":"up"},{"l":"Queries/Dia","v":"1145","t":"+6.2%","d":"up"},{"l":"Dados Processados (GB)","v":"1.913","t":"+14.2%","d":"up"},{"l":"Utilizadores Analytics","v":"5.440","t":"-5.9%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","960","2026-01-15","738","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1018","2026-02-01","5.320","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1515","2026-02-13","3.346","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","366","2026-03-07","5.145","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3612","2026-02-11","2.775","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":821},{"label":"Mar","value":851},{"label":"Abr","value":945},{"label":"Mai","value":848},{"label":"Jun","value":986},{"label":"Jul","value":792},{"label":"Ago","value":765},{"label":"Set","value":918},{"label":"Out","value":833},{"label":"Nov","value":748},{"label":"Dez","value":866}];
const MX = 986;
