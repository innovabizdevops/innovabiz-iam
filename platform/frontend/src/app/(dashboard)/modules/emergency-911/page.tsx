...
export default function Emergency911Page() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Emergency 911</h1><p className="text-sm text-muted-foreground">Emergency 911 • iBOS Enterprise</p></div>
