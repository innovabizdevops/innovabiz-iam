...
const PAGE = "Call";
const KPIS = [{"l":"Total Emergency 911","v":"6.874","t":"+2.8%","d":"up"},{"l":"Call Ativos","v":"2.462","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"+11.3%","d":"up"},{"l":"Score Performance","v":"56","t":"+0.8%","d":"up"}];
const COLS = ["ID","Call","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency 911 #001","Emergency 911 #002","1.315","1.444","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency 911 #002","Emergency 911 #003","7.585","6.887","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency 911 #003","Emergency 911 #004","8.273","7.096","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency 911 #004","Emergency 911 #005","3.945","5.505","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency 911 #005","Emergency 911 #001","6.566","7.034","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":385},{"label":"Fev","value":228},{"label":"Mar","value":509},{"label":"Abr","value":409},{"label":"Mai","value":318},{"label":"Jun","value":283},{"label":"Jul","value":305},{"label":"Ago","value":274},{"label":"Set","value":580},{"label":"Out","value":400},{"label":"Nov","value":395},{"label":"Dez","value":441}];
const MX = 580;
