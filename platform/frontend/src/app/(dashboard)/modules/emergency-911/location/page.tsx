...
const ACCENT = "#6366f1";
const MODULE = "911 / Emergency Call";
const PAGE = "Location";
const KPIS = [{"l":"Total Emergency 911","v":"339","t":"-0.1%","d":"down"},{"l":"Location Ativos","v":"3.271","t":"+9.7%","d":"up"},{"l":"Eficiência (%)","v":"82.2%","t":"-5.5%","d":"down"},{"l":"Score Performance","v":"58","t":"+0.0%","d":"up"}];
const COLS = ["ID","Location","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency 911 #001","Emergency 911 #002","5.510","6.684","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency 911 #002","Emergency 911 #003","6.309","2.821","2026-03-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency 911 #003","Emergency 911 #004","7.652","4.634","2026-01-17","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency 911 #004","Emergency 911 #005","4.336","2.348","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency 911 #005","Emergency 911 #001","967","5.467","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":790},{"label":"Fev","value":669},{"label":"Mar","value":515},{"label":"Abr","value":437},{"label":"Mai","value":681},{"label":"Jun","value":666},{"label":"Jul","value":720},{"label":"Ago","value":481},{"label":"Set","value":671},{"label":"Out","value":714},{"label":"Nov","value":641},{"label":"Dez","value":501}];
const MX = 790;
