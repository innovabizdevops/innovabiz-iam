...
const PAGE = "Text-to-911";
const KPIS = [{"l":"Total Emergency 911","v":"843","t":"+12.9%","d":"up"},{"l":"Text To 911 Ativos","v":"4.651","t":"+11.0%","d":"up"},{"l":"Eficiência (%)","v":"79.3%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"67","t":"-5.4%","d":"down"}];
const COLS = ["ID","Text To 911","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Emergency 911 #001","Emergency 911 #002","8.624","8.685","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Emergency 911 #002","Emergency 911 #003","9.075","2.173","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Emergency 911 #003","Emergency 911 #004","2.284","4.117","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Emergency 911 #004","Emergency 911 #005","7.429","6.207","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Emergency 911 #005","Emergency 911 #001","7.221","1.838","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":784},{"label":"Fev","value":696},{"label":"Mar","value":995},{"label":"Abr","value":993},{"label":"Mai","value":920},{"label":"Jun","value":649},{"label":"Jul","value":664},{"label":"Ago","value":728},{"label":"Set","value":657},{"label":"Out","value":631},{"label":"Nov","value":937},{"label":"Dez","value":795}];
const MX = 995;
