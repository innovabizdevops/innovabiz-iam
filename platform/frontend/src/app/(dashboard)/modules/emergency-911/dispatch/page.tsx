...
const PAGE = "Dispatch";
const KPIS = [{"l":"Veículos Operação","v":"4.673","t":"+3.7%","d":"up"},{"l":"Viagens/Dia","v":"2312","t":"-4.0%","d":"down"},{"l":"Pontualidade (%)","v":"88.9%","t":"-0.3%","d":"down"},{"l":"Passageiros/Dia","v":"1209","t":"+13.5%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-01-28","2026-01-07","6.530","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-03-12","2026-03-11","8.671","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-04","2026-01-09","2.711","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-03-19","2026-03-15","2.684","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-02","2026-02-26","3.256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":611},{"label":"Fev","value":700},{"label":"Mar","value":767},{"label":"Abr","value":745},{"label":"Mai","value":680},{"label":"Jun","value":578},{"label":"Jul","value":568},{"label":"Ago","value":727},{"label":"Set","value":652},{"label":"Out","value":657},{"label":"Nov","value":678},{"label":"Dez","value":672}];
const MX = 767;
