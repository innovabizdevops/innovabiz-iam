...
const ACCENT = "#06b6d4";
const MODULE = "OCR & Data Extraction";
const PAGE = "Classify";
const KPIS = [{"l":"Total Ocr Extraction","v":"3.344","t":"-4.3%","d":"down"},{"l":"Classify Ativos","v":"4.646","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"73.6%","t":"+13.6%","d":"up"},{"l":"Score Performance","v":"71","t":"+13.0%","d":"up"}];
const COLS = ["ID","Classify","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocr Extraction #001","Ocr Extraction #002","8.032","2.439","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ocr Extraction #002","Ocr Extraction #003","5.925","6.049","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocr Extraction #003","Ocr Extraction #004","6.188","7.063","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Ocr Extraction #004","Ocr Extraction #005","3.387","5.535","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocr Extraction #005","Ocr Extraction #001","7.107","6.379","2026-01-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":878},{"label":"Mar","value":814},{"label":"Abr","value":1012},{"label":"Mai","value":973},{"label":"Jun","value":916},{"label":"Jul","value":709},{"label":"Ago","value":986},{"label":"Set","value":633},{"label":"Out","value":988},{"label":"Nov","value":977},{"label":"Dez","value":842}];
const MX = 1012;
