...
const PAGE = "Validate";
const KPIS = [{"l":"Total Ocr Extraction","v":"2.200","t":"+15.4%","d":"up"},{"l":"Validate Ativos","v":"4.788","t":"+1.7%","d":"up"},{"l":"Eficiência (%)","v":"74.0%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.8%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocr Extraction #001","Ocr Extraction #002","3.366","2.290","2026-01-15","Ativo"],"status":"active"},{"id":"r1","cells":["Ocr Extraction #002","Ocr Extraction #003","2.331","2.128","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocr Extraction #003","Ocr Extraction #004","7.089","4.485","2026-03-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ocr Extraction #004","Ocr Extraction #005","5.434","8.410","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocr Extraction #005","Ocr Extraction #001","5.725","754","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":852},{"label":"Fev","value":708},{"label":"Mar","value":798},{"label":"Abr","value":611},{"label":"Mai","value":791},{"label":"Jun","value":643},{"label":"Jul","value":772},{"label":"Ago","value":651},{"label":"Set","value":658},{"label":"Out","value":703},{"label":"Nov","value":982},{"label":"Dez","value":655}];
const MX = 982;
