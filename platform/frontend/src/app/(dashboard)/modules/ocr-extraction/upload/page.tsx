...
const PAGE = "Upload";
const KPIS = [{"l":"Total Ocr Extraction","v":"5.684","t":"+13.2%","d":"up"},{"l":"Upload Ativos","v":"7.552","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"89","t":"+1.2%","d":"up"}];
const COLS = ["ID","Upload","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocr Extraction #001","Ocr Extraction #002","1.336","2.338","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Ocr Extraction #002","Ocr Extraction #003","5.590","1.691","2026-02-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocr Extraction #003","Ocr Extraction #004","6.434","4.207","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Ocr Extraction #004","Ocr Extraction #005","4.533","686","2026-02-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocr Extraction #005","Ocr Extraction #001","7.722","7.840","2026-01-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":635},{"label":"Mar","value":531},{"label":"Abr","value":617},{"label":"Mai","value":498},{"label":"Jun","value":463},{"label":"Jul","value":466},{"label":"Ago","value":432},{"label":"Set","value":767},{"label":"Out","value":531},{"label":"Nov","value":417},{"label":"Dez","value":664}];
const MX = 767;
