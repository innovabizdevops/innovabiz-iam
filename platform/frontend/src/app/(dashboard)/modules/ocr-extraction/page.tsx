...
/* ═══ OCR & Data Extraction — Dashboard ═══ */

const ACCENT = "#06b6d4";

const KPIS = [
    { label: "Total Registos", value: "7363", trend: "-14%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "742", trend: "+8%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€459K", trend: "+2%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-21%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1152396963", cells: ["OCR-1963", "OCR & Data Extraction Item 1", "12/4/2026", "€47 063"], status: "active" as const },
    { id: "1152400534", cells: ["OCR-5534", "OCR & Data Extraction Item 2", "27/11/2026", "€634"], status: "pending" as const },
    { id: "1152404105", cells: ["OCR-9105", "OCR & Data Extraction Item 3", "14/6/2026", "€4205"], status: "completed" as const },
    { id: "1152407676", cells: ["OCR-3676", "OCR & Data Extraction Item 4", "1/1/2026", "€7776"], status: "warning" as const },
    { id: "1152411247", cells: ["OCR-7247", "OCR & Data Extraction Item 5", "16/8/2026", "€11 347"], status: "active" as const },
];
...
export default function OcrDataExtractionPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OCR & Data Extraction</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OCR & Data Extraction</p>
                    </div>
                </div>
