...
const PAGE = "Export";
const KPIS = [{"l":"Total Ocr Extraction","v":"8.846","t":"+14.7%","d":"up"},{"l":"Export Ativos","v":"2.643","t":"-1.7%","d":"down"},{"l":"Eficiência (%)","v":"75.5%","t":"+8.5%","d":"up"},{"l":"Score Performance","v":"72","t":"-1.6%","d":"down"}];
const COLS = ["ID","Export","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocr Extraction #001","Ocr Extraction #002","3.994","7.185","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Ocr Extraction #002","Ocr Extraction #003","4.083","6.254","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocr Extraction #003","Ocr Extraction #004","3.062","1.868","2026-01-07","Concluído"],"status":"done"},{"id":"r3","cells":["Ocr Extraction #004","Ocr Extraction #005","7.027","6.707","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocr Extraction #005","Ocr Extraction #001","4.625","7.813","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":447},{"label":"Fev","value":486},{"label":"Mar","value":587},{"label":"Abr","value":591},{"label":"Mai","value":422},{"label":"Jun","value":237},{"label":"Jul","value":270},{"label":"Ago","value":447},{"label":"Set","value":578},{"label":"Out","value":215},{"label":"Nov","value":345},{"label":"Dez","value":549}];
const MX = 591;
