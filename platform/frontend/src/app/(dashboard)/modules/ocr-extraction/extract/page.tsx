...
const PAGE = "Extract";
const KPIS = [{"l":"Total Ocr Extraction","v":"1.242","t":"+16.0%","d":"up"},{"l":"Extract Ativos","v":"3.923","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"73.7%","t":"+5.7%","d":"up"},{"l":"Score Performance","v":"71","t":"+10.8%","d":"up"}];
const COLS = ["ID","Extract","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ocr Extraction #001","Ocr Extraction #002","787","7.455","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Ocr Extraction #002","Ocr Extraction #003","2.494","4.358","2026-02-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ocr Extraction #003","Ocr Extraction #004","6.308","7.550","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Ocr Extraction #004","Ocr Extraction #005","603","5.296","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ocr Extraction #005","Ocr Extraction #001","391","5.087","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":636},{"label":"Fev","value":631},{"label":"Mar","value":952},{"label":"Abr","value":757},{"label":"Mai","value":985},{"label":"Jun","value":709},{"label":"Jul","value":633},{"label":"Ago","value":822},{"label":"Set","value":992},{"label":"Out","value":609},{"label":"Nov","value":739},{"label":"Dez","value":610}];
const MX = 992;
