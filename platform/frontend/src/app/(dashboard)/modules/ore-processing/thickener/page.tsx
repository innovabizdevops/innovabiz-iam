...
const ACCENT = "#7c3aed";
const MODULE = "Ore Processing";
const PAGE = "Thickener";
const KPIS = [{"l":"Total Ore Processing","v":"7.893","t":"+1.0%","d":"up"},{"l":"Thickener Ativos","v":"2.514","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"70.3%","t":"+11.2%","d":"up"},{"l":"Score Performance","v":"74","t":"-1.4%","d":"down"}];
const COLS = ["ID","Thickener","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ore Processing #001","Ore Processing #002","6.069","4.803","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Ore Processing #002","Ore Processing #003","4.470","8.316","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Ore Processing #003","Ore Processing #004","7.893","7.186","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ore Processing #004","Ore Processing #005","2.949","5.706","2026-01-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ore Processing #005","Ore Processing #001","1.022","8.696","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":912},{"label":"Fev","value":655},{"label":"Mar","value":674},{"label":"Abr","value":835},{"label":"Mai","value":853},{"label":"Jun","value":810},{"label":"Jul","value":775},{"label":"Ago","value":661},{"label":"Set","value":877},{"label":"Out","value":839},{"label":"Nov","value":767},{"label":"Dez","value":903}];
const MX = 912;
...
export default function ThickenerPage() {
    return (
