...
const PAGE = "Mill Control";
const KPIS = [{"l":"Total Ore Processing","v":"2.569","t":"-3.5%","d":"down"},{"l":"Mill Control Ativos","v":"7.348","t":"-0.9%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"+9.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+1.6%","d":"up"}];
const COLS = ["ID","Mill Control","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ore Processing #001","Ore Processing #002","7.148","6.611","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Ore Processing #002","Ore Processing #003","2.901","6.870","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Ore Processing #003","Ore Processing #004","3.762","8.151","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Ore Processing #004","Ore Processing #005","3.136","5.027","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ore Processing #005","Ore Processing #001","6.717","808","2026-01-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":783},{"label":"Fev","value":696},{"label":"Mar","value":731},{"label":"Abr","value":594},{"label":"Mai","value":578},{"label":"Jun","value":679},{"label":"Jul","value":534},{"label":"Ago","value":867},{"label":"Set","value":525},{"label":"Out","value":488},{"label":"Nov","value":856},{"label":"Dez","value":523}];
const MX = 867;
