...
const PAGE = "Crusher Ops";
const KPIS = [{"l":"Total Ore Processing","v":"933","t":"+14.7%","d":"up"},{"l":"Crusher Ops Ativos","v":"2.243","t":"+7.3%","d":"up"},{"l":"Eficiência (%)","v":"71.5%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"56","t":"+10.8%","d":"up"}];
const COLS = ["ID","Crusher Ops","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Ore Processing #001","Ore Processing #002","3.404","5.971","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Ore Processing #002","Ore Processing #003","2.898","5.652","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Ore Processing #003","Ore Processing #004","1.679","5.715","2026-01-25","Concluído"],"status":"done"},{"id":"r3","cells":["Ore Processing #004","Ore Processing #005","4.973","4.900","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ore Processing #005","Ore Processing #001","1.864","2.784","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":640},{"label":"Mar","value":769},{"label":"Abr","value":707},{"label":"Mai","value":572},{"label":"Jun","value":759},{"label":"Jul","value":643},{"label":"Ago","value":878},{"label":"Set","value":760},{"label":"Out","value":577},{"label":"Nov","value":873},{"label":"Dez","value":825}];
const MX = 944;
