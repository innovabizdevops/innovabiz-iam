...
const PAGE = "Recovery Track";
const KPIS = [{"l":"BCP Plans Ativos","v":"4.445","t":"+16.2%","d":"up"},{"l":"RTO Médio (h)","v":"21h","t":"+17.8%","d":"up"},{"l":"RPO Médio (h)","v":"47h","t":"+17.1%","d":"up"},{"l":"Testes DR (YTD)","v":"1.479","t":"+13.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","196h","47h","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","192h","41h","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","31h","25h","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","146h","153h","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","137h","208h","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":886},{"label":"Fev","value":840},{"label":"Mar","value":691},{"label":"Abr","value":716},{"label":"Mai","value":902},{"label":"Jun","value":767},{"label":"Jul","value":968},{"label":"Ago","value":885},{"label":"Set","value":704},{"label":"Out","value":779},{"label":"Nov","value":743},{"label":"Dez","value":932}];
const MX = 968;
