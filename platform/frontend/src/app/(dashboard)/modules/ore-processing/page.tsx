...
export default function OreProcessingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Ore Processing</h1><p className="text-sm text-muted-foreground">Ore Processing • iBOS Enterprise</p></div>
