...
/* ═══ Toy Manufacturing — Dashboard ═══ */

const ACCENT = "#c026d3";

const KPIS = [
    { label: "Total Registos", value: "7966", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2974", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€305K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "79%", trend: "-24%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "946140966", cells: ["TOY-7966", "Toy Manufacturing Item 1", "23/7/2026", "€41 066"], status: "active" as const },
    { id: "946144537", cells: ["TOY-2537", "Toy Manufacturing Item 2", "10/2/2026", "€44 637"], status: "pending" as const },
    { id: "946148108", cells: ["TOY-6108", "Toy Manufacturing Item 3", "25/9/2026", "€48 208"], status: "completed" as const },
    { id: "946151679", cells: ["TOY-9679", "Toy Manufacturing Item 4", "12/4/2026", "€1779"], status: "warning" as const },
    { id: "946155250", cells: ["TOY-4250", "Toy Manufacturing Item 5", "27/11/2026", "€5350"], status: "active" as const },
];
...
export default function ToyManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Toy Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Toy Manufacturing</p>
                    </div>
                </div>
