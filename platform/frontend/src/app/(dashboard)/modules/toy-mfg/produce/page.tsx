...
const PAGE = "Produce";
const KPIS = [{"l":"Total Toy Mfg","v":"8.693","t":"-5.0%","d":"down"},{"l":"Produce Ativos","v":"5.465","t":"+16.2%","d":"up"},{"l":"Eficiência (%)","v":"79.4%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"85","t":"+5.1%","d":"up"}];
const COLS = ["ID","Produce","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Toy Mfg #001","Toy Mfg #002","6.413","380","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Toy Mfg #002","Toy Mfg #003","3.553","4.584","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Toy Mfg #003","Toy Mfg #004","1.085","7.074","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Toy Mfg #004","Toy Mfg #005","408","7.460","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Toy Mfg #005","Toy Mfg #001","1.427","6.480","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":676},{"label":"Fev","value":572},{"label":"Mar","value":658},{"label":"Abr","value":783},{"label":"Mai","value":603},{"label":"Jun","value":775},{"label":"Jul","value":561},{"label":"Ago","value":608},{"label":"Set","value":770},{"label":"Out","value":741},{"label":"Nov","value":753},{"label":"Dez","value":823}];
const MX = 823;
