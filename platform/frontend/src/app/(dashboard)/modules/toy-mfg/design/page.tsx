...
const ACCENT = "#c026d3";
const MODULE = "Toy Manufacturing";
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.675","t":"+12.6%","d":"up"},{"l":"Submissões/Dia","v":"180","t":"+1.0%","d":"up"},{"l":"Documentos Gerados","v":"8.518","t":"-2.4%","d":"down"},{"l":"Templates","v":"3.197","t":"+3.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.650","2026-03-13","2.654","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.392","2026-01-15","1.822","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","410","2026-02-15","6.990","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.744","2026-02-07","2.291","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.547","2026-02-19","3.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":914},{"label":"Mar","value":974},{"label":"Abr","value":791},{"label":"Mai","value":644},{"label":"Jun","value":739},{"label":"Jul","value":966},{"label":"Ago","value":890},{"label":"Set","value":644},{"label":"Out","value":613},{"label":"Nov","value":620},{"label":"Dez","value":954}];
const MX = 974;
