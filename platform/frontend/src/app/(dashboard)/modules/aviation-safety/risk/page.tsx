...
const PAGE = "Risk Matrix";
const KPIS = [{"l":"Riscos Identificados","v":"1.388","t":"+11.4%","d":"up"},{"l":"Mitigações Ativas","v":"7.420","t":"-2.7%","d":"down"},{"l":"Score Risco Geral","v":"71","t":"+15.8%","d":"up"},{"l":"Incidentes YTD","v":"4.710","t":"+7.1%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","6.566","326","7.643","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","181","4.679","7.202","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.094","3.624","5.729","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","868","8.429","4.524","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","6.866","4.228","5.088","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":570},{"label":"Mar","value":321},{"label":"Abr","value":518},{"label":"Mai","value":331},{"label":"Jun","value":413},{"label":"Jul","value":524},{"label":"Ago","value":309},{"label":"Set","value":602},{"label":"Out","value":536},{"label":"Nov","value":385},{"label":"Dez","value":441}];
const MX = 602;
