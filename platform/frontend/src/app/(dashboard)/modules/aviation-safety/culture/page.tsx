...
const PAGE = "Just Culture";
const KPIS = [{"l":"Total Aviation Safety","v":"6.327","t":"+15.7%","d":"up"},{"l":"Just Culture Ativos","v":"1.846","t":"+15.3%","d":"up"},{"l":"Eficiência (%)","v":"90.3%","t":"+16.5%","d":"up"},{"l":"Score Performance","v":"72","t":"-5.1%","d":"down"}];
const COLS = ["ID","Just Culture","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Safety #001","Aviation Safety #002","6.797","3.332","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Safety #002","Aviation Safety #003","819","1.150","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Safety #003","Aviation Safety #004","3.968","8.530","2026-01-02","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Safety #004","Aviation Safety #005","4.897","5.635","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Safety #005","Aviation Safety #001","1.856","4.961","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":758},{"label":"Mar","value":890},{"label":"Abr","value":1011},{"label":"Mai","value":1004},{"label":"Jun","value":721},{"label":"Jul","value":700},{"label":"Ago","value":988},{"label":"Set","value":982},{"label":"Out","value":760},{"label":"Nov","value":993},{"label":"Dez","value":999}];
const MX = 1011;
