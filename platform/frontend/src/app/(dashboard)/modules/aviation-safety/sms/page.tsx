...
const PAGE = "SMS System";
const KPIS = [{"l":"Total Aviation Safety","v":"937","t":"+15.6%","d":"up"},{"l":"SMS System Ativos","v":"3.510","t":"+13.7%","d":"up"},{"l":"Eficiência (%)","v":"93.9%","t":"-0.3%","d":"down"},{"l":"Score Performance","v":"61","t":"+0.8%","d":"up"}];
const COLS = ["ID","SMS System","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Safety #001","Aviation Safety #002","6.100","5.018","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Safety #002","Aviation Safety #003","3.946","3.706","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Safety #003","Aviation Safety #004","6.796","1.734","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Safety #004","Aviation Safety #005","6.215","1.342","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Safety #005","Aviation Safety #001","7.505","3.074","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":608},{"label":"Fev","value":753},{"label":"Mar","value":680},{"label":"Abr","value":547},{"label":"Mai","value":636},{"label":"Jun","value":534},{"label":"Jul","value":444},{"label":"Ago","value":573},{"label":"Set","value":648},{"label":"Out","value":452},{"label":"Nov","value":744},{"label":"Dez","value":759}];
const MX = 759;
