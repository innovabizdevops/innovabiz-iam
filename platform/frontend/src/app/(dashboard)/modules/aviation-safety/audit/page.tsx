...
const PAGE = "Safety Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.968","t":"+13.5%","d":"up"},{"l":"NC Abertas","v":"7.910","t":"-0.2%","d":"down"},{"l":"Conformidade (%)","v":"84.8%","t":"+13.1%","d":"up"},{"l":"CAPAs Pendentes","v":"102","t":"+6.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.112","94.0%","5.496","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.722","72.2%","1.091","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","8.535","90.4%","5.867","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.421","79.1%","8.857","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.863","87.4%","6.339","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":832},{"label":"Fev","value":906},{"label":"Mar","value":675},{"label":"Abr","value":952},{"label":"Mai","value":918},{"label":"Jun","value":704},{"label":"Jul","value":868},{"label":"Ago","value":882},{"label":"Set","value":604},{"label":"Out","value":891},{"label":"Nov","value":755},{"label":"Dez","value":767}];
const MX = 952;
