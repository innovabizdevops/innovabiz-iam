...
const PAGE = "ASRS Report";
const KPIS = [{"l":"Total Aviation Safety","v":"4.388","t":"-5.0%","d":"down"},{"l":"ASRS Report Ativos","v":"739","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"82.7%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+2.8%","d":"up"}];
const COLS = ["ID","ASRS Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aviation Safety #001","Aviation Safety #002","5.968","7.325","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Aviation Safety #002","Aviation Safety #003","925","8.634","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Aviation Safety #003","Aviation Safety #004","7.664","553","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Aviation Safety #004","Aviation Safety #005","5.058","1.790","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aviation Safety #005","Aviation Safety #001","4.542","5.535","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":664},{"label":"Fev","value":902},{"label":"Mar","value":565},{"label":"Abr","value":936},{"label":"Mai","value":793},{"label":"Jun","value":700},{"label":"Jul","value":673},{"label":"Ago","value":591},{"label":"Set","value":669},{"label":"Out","value":772},{"label":"Nov","value":806},{"label":"Dez","value":925}];
const MX = 936;
