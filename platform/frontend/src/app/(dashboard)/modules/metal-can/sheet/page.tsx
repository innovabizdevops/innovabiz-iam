...
const PAGE = "Sheet";
const KPIS = [{"l":"Total Metal Can","v":"142","t":"+9.4%","d":"up"},{"l":"Sheet Ativos","v":"971","t":"+13.1%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+17.5%","d":"up"},{"l":"Score Performance","v":"67","t":"-0.8%","d":"down"}];
const COLS = ["ID","Sheet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Metal Can #001","Metal Can #002","3.209","8.965","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Metal Can #002","Metal Can #003","6.657","3.508","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Metal Can #003","Metal Can #004","4.489","5.989","2026-03-08","Concluído"],"status":"done"},{"id":"r3","cells":["Metal Can #004","Metal Can #005","7.623","2.452","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Metal Can #005","Metal Can #001","7.440","4.888","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":695},{"label":"Fev","value":699},{"label":"Mar","value":818},{"label":"Abr","value":887},{"label":"Mai","value":758},{"label":"Jun","value":801},{"label":"Jul","value":825},{"label":"Ago","value":915},{"label":"Set","value":592},{"label":"Out","value":672},{"label":"Nov","value":938},{"label":"Dez","value":804}];
const MX = 938;
