...
const ACCENT = "#a16207";
const MODULE = "Metal Can Manufacturing";
const PAGE = "Form";
const KPIS = [{"l":"Formulários Ativos","v":"4.000","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"1658","t":"+7.5%","d":"up"},{"l":"Documentos Gerados","v":"3.708","t":"+4.8%","d":"up"},{"l":"Templates","v":"2.910","t":"-4.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.261","2026-03-23","2.554","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.102","2026-01-05","5.705","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.497","2026-01-14","3.915","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.094","2026-01-05","7.472","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.025","2026-02-25","7.580","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":582},{"label":"Mar","value":757},{"label":"Abr","value":641},{"label":"Mai","value":514},{"label":"Jun","value":471},{"label":"Jul","value":548},{"label":"Ago","value":774},{"label":"Set","value":546},{"label":"Out","value":552},{"label":"Nov","value":579},{"label":"Dez","value":561}];
const MX = 774;
