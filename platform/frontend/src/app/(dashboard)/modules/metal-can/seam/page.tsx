...
const PAGE = "Seam";
const KPIS = [{"l":"Total Metal Can","v":"5.986","t":"+13.8%","d":"up"},{"l":"Seam Ativos","v":"3.410","t":"+3.7%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"-0.4%","d":"down"},{"l":"Score Performance","v":"56","t":"-5.5%","d":"down"}];
const COLS = ["ID","Seam","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Metal Can #001","Metal Can #002","2.142","6.249","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Metal Can #002","Metal Can #003","3.906","4.659","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Metal Can #003","Metal Can #004","4.684","2.264","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Metal Can #004","Metal Can #005","1.988","5.665","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Metal Can #005","Metal Can #001","5.519","4.355","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":472},{"label":"Mar","value":503},{"label":"Abr","value":659},{"label":"Mai","value":624},{"label":"Jun","value":583},{"label":"Jul","value":520},{"label":"Ago","value":635},{"label":"Set","value":452},{"label":"Out","value":518},{"label":"Nov","value":624},{"label":"Dez","value":622}];
const MX = 668;
