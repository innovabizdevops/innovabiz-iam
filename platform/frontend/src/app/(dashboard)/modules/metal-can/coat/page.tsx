...
const PAGE = "Coat";
const KPIS = [{"l":"Total Metal Can","v":"1.967","t":"-2.2%","d":"down"},{"l":"Coat Ativos","v":"6.044","t":"+0.9%","d":"up"},{"l":"Eficiência (%)","v":"87.5%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"81","t":"+1.2%","d":"up"}];
const COLS = ["ID","Coat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Metal Can #001","Metal Can #002","7.038","3.418","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Metal Can #002","Metal Can #003","4.755","7.933","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Metal Can #003","Metal Can #004","978","5.975","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Metal Can #004","Metal Can #005","2.482","2.738","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Metal Can #005","Metal Can #001","2.000","1.312","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":552},{"label":"Fev","value":392},{"label":"Mar","value":629},{"label":"Abr","value":616},{"label":"Mai","value":613},{"label":"Jun","value":591},{"label":"Jul","value":587},{"label":"Ago","value":472},{"label":"Set","value":679},{"label":"Out","value":514},{"label":"Nov","value":387},{"label":"Dez","value":458}];
const MX = 679;
