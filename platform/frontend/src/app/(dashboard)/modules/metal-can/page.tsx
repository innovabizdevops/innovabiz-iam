...
/* ═══ Metal Can Manufacturing — Dashboard ═══ */

const ACCENT = "#a16207";

const KPIS = [
    { label: "Total Registos", value: "6797", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4676", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€355K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "78%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "202026097", cells: ["MET-4097", "Metal Can Manufacturing Item 1", "22/2/2026", "€26 197"], status: "active" as const },
    { id: "202029668", cells: ["MET-7668", "Metal Can Manufacturing Item 2", "9/9/2026", "€29 768"], status: "pending" as const },
    { id: "202033239", cells: ["MET-2239", "Metal Can Manufacturing Item 3", "24/4/2026", "€33 339"], status: "completed" as const },
    { id: "202036810", cells: ["MET-5810", "Metal Can Manufacturing Item 4", "11/11/2026", "€36 910"], status: "warning" as const },
    { id: "202040381", cells: ["MET-9381", "Metal Can Manufacturing Item 5", "26/6/2026", "€40 481"], status: "active" as const },
];
...
export default function MetalCanManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Metal Can Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Metal Can Manufacturing</p>
                    </div>
                </div>
