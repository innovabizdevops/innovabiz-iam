...
const PAGE = "GMO";
const KPIS = [{"l":"Dispositivos Online","v":"776","t":"+4.8%","d":"up"},{"l":"Dados/Min (MB)","v":"1.727","t":"-4.7%","d":"down"},{"l":"Alertas Ativos","v":"2.912","t":"-4.8%","d":"down"},{"l":"Uptime (%)","v":"87.2%","t":"+1.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.619","7.789","6.940","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.794","844","1.218","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","4.272","5.978","5.338","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","128","349","5.352","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.892","3.775","5.598","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":759},{"label":"Mar","value":894},{"label":"Abr","value":863},{"label":"Mai","value":744},{"label":"Jun","value":702},{"label":"Jul","value":858},{"label":"Ago","value":674},{"label":"Set","value":701},{"label":"Out","value":906},{"label":"Nov","value":786},{"label":"Dez","value":768}];
const MX = 906;
