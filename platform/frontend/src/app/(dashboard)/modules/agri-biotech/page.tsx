...
export default function AgriBiotechPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Agri Biotech</h1><p className="text-sm text-muted-foreground">Agri Biotech • iBOS Enterprise</p></div>
