...
const PAGE = "Biopesticide";
const KPIS = [{"l":"Dispositivos Online","v":"1.088","t":"+5.5%","d":"up"},{"l":"Dados/Min (MB)","v":"2.171","t":"-4.4%","d":"down"},{"l":"Alertas Ativos","v":"477","t":"+9.1%","d":"up"},{"l":"Uptime (%)","v":"74.7%","t":"+14.7%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.525","1.934","8.866","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.750","8.578","1.112","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.898","8.386","4.818","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.853","3.765","3.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.080","3.656","8.349","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":963},{"label":"Fev","value":707},{"label":"Mar","value":962},{"label":"Abr","value":806},{"label":"Mai","value":779},{"label":"Jun","value":768},{"label":"Jul","value":844},{"label":"Ago","value":748},{"label":"Set","value":842},{"label":"Out","value":830},{"label":"Nov","value":658},{"label":"Dez","value":631}];
const MX = 963;
...
export default function BiopestPage() {
    return (
