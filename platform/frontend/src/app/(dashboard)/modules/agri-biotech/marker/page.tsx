...
const ACCENT = "#6366f1";
const MODULE = "Agri Biotech";
const PAGE = "Marker Assist";
const KPIS = [{"l":"Dispositivos Online","v":"4.414","t":"+14.5%","d":"up"},{"l":"Dados/Min (MB)","v":"7.630","t":"+4.7%","d":"up"},{"l":"Alertas Ativos","v":"1.335","t":"+10.6%","d":"up"},{"l":"Uptime (%)","v":"67.9%","t":"-0.3%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","1.401","3.856","378","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.230","6.549","5.856","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.543","5.962","5.072","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","114","4.457","2.003","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","7.604","6.406","7.926","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":809},{"label":"Mar","value":740},{"label":"Abr","value":796},{"label":"Mai","value":980},{"label":"Jun","value":872},{"label":"Jul","value":875},{"label":"Ago","value":781},{"label":"Set","value":979},{"label":"Out","value":708},{"label":"Nov","value":604},{"label":"Dez","value":724}];
const MX = 980;
