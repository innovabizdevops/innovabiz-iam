...
const PAGE = "Biostimulant";
const KPIS = [{"l":"Dispositivos Online","v":"5.088","t":"+16.7%","d":"up"},{"l":"Dados/Min (MB)","v":"867","t":"+12.2%","d":"up"},{"l":"Alertas Ativos","v":"1.370","t":"-5.1%","d":"down"},{"l":"Uptime (%)","v":"94.4%","t":"-1.2%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","5.100","6.003","7.981","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.726","1.481","648","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","6.056","8.069","1.572","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","4.009","1.890","5.879","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","8.260","3.161","1.046","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":861},{"label":"Fev","value":864},{"label":"Mar","value":618},{"label":"Abr","value":685},{"label":"Mai","value":593},{"label":"Jun","value":707},{"label":"Jul","value":670},{"label":"Ago","value":957},{"label":"Set","value":635},{"label":"Out","value":857},{"label":"Nov","value":699},{"label":"Dez","value":624}];
const MX = 957;
...
export default function BiostimPage() {
    return (
