...
const KPIS = [{"l":"Dispositivos Online","v":"6.190","t":"+0.0%","d":"up"},{"l":"Dados/Min (MB)","v":"229","t":"+8.8%","d":"up"},{"l":"Alertas Ativos","v":"5.967","t":"+5.7%","d":"up"},{"l":"Uptime (%)","v":"86.6%","t":"+17.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.969","804","8.782","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.739","5.684","1.500","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.350","402","593","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.961","9.046","1.405","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.284","1.812","7.536","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":512},{"label":"Fev","value":597},{"label":"Mar","value":789},{"label":"Abr","value":536},{"label":"Mai","value":419},{"label":"Jun","value":612},{"label":"Jul","value":657},{"label":"Ago","value":752},{"label":"Set","value":664},{"label":"Out","value":503},{"label":"Nov","value":645},{"label":"Dez","value":706}];
const MX = 789;
