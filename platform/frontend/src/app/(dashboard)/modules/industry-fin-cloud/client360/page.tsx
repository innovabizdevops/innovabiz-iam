...
const PAGE = "Client 360";
const KPIS = [{"l":"Total Industry Fin Cloud","v":"1.129","t":"+1.2%","d":"up"},{"l":"Client 360 Ativos","v":"6.379","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"80.9%","t":"+14.6%","d":"up"},{"l":"Score Performance","v":"73","t":"-5.6%","d":"down"}];
const COLS = ["ID","Client 360","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Fin Cloud #001","Industry Fin Cloud #002","6.085","8.263","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Fin Cloud #002","Industry Fin Cloud #003","593","1.909","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Fin Cloud #003","Industry Fin Cloud #004","3.053","1.568","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Fin Cloud #004","Industry Fin Cloud #005","2.098","3.172","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Fin Cloud #005","Industry Fin Cloud #001","291","4.050","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":878},{"label":"Mar","value":763},{"label":"Abr","value":664},{"label":"Mai","value":704},{"label":"Jun","value":840},{"label":"Jul","value":768},{"label":"Ago","value":659},{"label":"Set","value":928},{"label":"Out","value":960},{"label":"Nov","value":692},{"label":"Dez","value":626}];
const MX = 960;
