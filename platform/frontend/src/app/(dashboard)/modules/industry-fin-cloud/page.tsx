...
/* ═══ Financial Services Cloud — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "4011", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2154", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€249K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "486717611", cells: ["IND-7611", "Financial Services Cloud Item 1", "24/12/2026", "€17 711"], status: "active" as const },
    { id: "486721182", cells: ["IND-2182", "Financial Services Cloud Item 2", "11/7/2026", "€21 282"], status: "pending" as const },
    { id: "486724753", cells: ["IND-5753", "Financial Services Cloud Item 3", "26/2/2026", "€24 853"], status: "completed" as const },
    { id: "486728324", cells: ["IND-9324", "Financial Services Cloud Item 4", "13/9/2026", "€28 424"], status: "warning" as const },
    { id: "486731895", cells: ["IND-3895", "Financial Services Cloud Item 5", "28/4/2026", "€31 995"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Financial Services Cloud</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Financial Services Cloud</p>
                    </div>
                </div>
