...
const PAGE = "Comply";
const KPIS = [{"l":"Total Industry Fin Cloud","v":"1.955","t":"+8.3%","d":"up"},{"l":"Comply Ativos","v":"1.263","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"65.2%","t":"-3.2%","d":"down"},{"l":"Score Performance","v":"69","t":"+6.7%","d":"up"}];
const COLS = ["ID","Comply","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Fin Cloud #001","Industry Fin Cloud #002","7.499","585","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Fin Cloud #002","Industry Fin Cloud #003","7.483","1.116","2026-02-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Fin Cloud #003","Industry Fin Cloud #004","1.833","4.531","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Fin Cloud #004","Industry Fin Cloud #005","1.057","3.514","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Fin Cloud #005","Industry Fin Cloud #001","6.692","6.269","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":583},{"label":"Fev","value":473},{"label":"Mar","value":529},{"label":"Abr","value":434},{"label":"Mai","value":531},{"label":"Jun","value":550},{"label":"Jul","value":499},{"label":"Ago","value":447},{"label":"Set","value":367},{"label":"Out","value":481},{"label":"Nov","value":589},{"label":"Dez","value":290}];
const MX = 589;
