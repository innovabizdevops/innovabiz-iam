...
const KPIS = [{"l":"Total Industry Fin Cloud","v":"8.847","t":"+3.0%","d":"up"},{"l":"Insurance Ativos","v":"5.624","t":"-0.1%","d":"down"},{"l":"Eficiência (%)","v":"69.0%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"90","t":"+13.1%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Fin Cloud #001","Industry Fin Cloud #002","463","6.478","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Fin Cloud #002","Industry Fin Cloud #003","1.673","6.966","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Fin Cloud #003","Industry Fin Cloud #004","6.969","1.831","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Fin Cloud #004","Industry Fin Cloud #005","4.901","5.375","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Fin Cloud #005","Industry Fin Cloud #001","7.686","3.079","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":322},{"label":"Mar","value":599},{"label":"Abr","value":462},{"label":"Mai","value":315},{"label":"Jun","value":437},{"label":"Jul","value":617},{"label":"Ago","value":695},{"label":"Set","value":556},{"label":"Out","value":485},{"label":"Nov","value":594},{"label":"Dez","value":627}];
const MX = 695;
