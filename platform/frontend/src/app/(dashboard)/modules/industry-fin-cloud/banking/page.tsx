...
const PAGE = "Banking";
const KPIS = [{"l":"Total Industry Fin Cloud","v":"3.181","t":"-3.0%","d":"down"},{"l":"Banking Ativos","v":"3.407","t":"+5.4%","d":"up"},{"l":"Eficiência (%)","v":"86.3%","t":"-2.5%","d":"down"},{"l":"Score Performance","v":"84","t":"+3.6%","d":"up"}];
const COLS = ["ID","Banking","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Fin Cloud #001","Industry Fin Cloud #002","2.493","1.689","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Fin Cloud #002","Industry Fin Cloud #003","7.305","824","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Fin Cloud #003","Industry Fin Cloud #004","4.177","8.259","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Fin Cloud #004","Industry Fin Cloud #005","2.458","2.504","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Fin Cloud #005","Industry Fin Cloud #001","2.147","8.854","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":983},{"label":"Mar","value":872},{"label":"Abr","value":662},{"label":"Mai","value":812},{"label":"Jun","value":781},{"label":"Jul","value":793},{"label":"Ago","value":807},{"label":"Set","value":687},{"label":"Out","value":939},{"label":"Nov","value":877},{"label":"Dez","value":807}];
const MX = 983;
