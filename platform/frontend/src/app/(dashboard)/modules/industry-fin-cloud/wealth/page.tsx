...
const PAGE = "Wealth";
const KPIS = [{"l":"Total Industry Fin Cloud","v":"2.083","t":"+0.7%","d":"up"},{"l":"Wealth Ativos","v":"6.532","t":"+3.8%","d":"up"},{"l":"Eficiência (%)","v":"88.3%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"86","t":"+9.5%","d":"up"}];
const COLS = ["ID","Wealth","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Industry Fin Cloud #001","Industry Fin Cloud #002","2.059","2.278","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Industry Fin Cloud #002","Industry Fin Cloud #003","7.092","1.486","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Industry Fin Cloud #003","Industry Fin Cloud #004","794","7.437","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Industry Fin Cloud #004","Industry Fin Cloud #005","895","8.966","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Industry Fin Cloud #005","Industry Fin Cloud #001","2.816","5.671","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":596},{"label":"Fev","value":476},{"label":"Mar","value":738},{"label":"Abr","value":526},{"label":"Mai","value":426},{"label":"Jun","value":420},{"label":"Jul","value":409},{"label":"Ago","value":362},{"label":"Set","value":437},{"label":"Out","value":368},{"label":"Nov","value":440},{"label":"Dez","value":602}];
const MX = 738;
