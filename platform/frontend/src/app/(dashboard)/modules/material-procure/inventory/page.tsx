...
const KPIS = [{"l":"Fornecedores Ativos","v":"8.502","t":"+6.4%","d":"up"},{"l":"Contratos (€M)","v":"€32.8M","t":"+10.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"90.6%","t":"+0.3%","d":"up"},{"l":"Score Médio","v":"77","t":"+3.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","76.9%","€ 31454.49","1.696","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","76.2%","€ 39836.68","4.714","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","88.4%","€ 22746.22","8.497","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","92.0%","€ 26495.95","2.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","86.6%","€ 48549.29","1.538","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":746},{"label":"Fev","value":359},{"label":"Mar","value":425},{"label":"Abr","value":547},{"label":"Mai","value":574},{"label":"Jun","value":644},{"label":"Jul","value":400},{"label":"Ago","value":358},{"label":"Set","value":371},{"label":"Out","value":514},{"label":"Nov","value":468},{"label":"Dez","value":363}];
const MX = 746;
