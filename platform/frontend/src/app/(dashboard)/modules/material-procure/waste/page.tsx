...
const ACCENT = "#059669";
const MODULE = "Material Procurement";
const PAGE = "Waste Track";
const KPIS = [{"l":"Fornecedores Ativos","v":"614","t":"+1.4%","d":"up"},{"l":"Contratos (€M)","v":"€14.6M","t":"+16.4%","d":"up"},{"l":"On-Time Delivery (%)","v":"93.6%","t":"-0.2%","d":"down"},{"l":"Score Médio","v":"73","t":"+0.1%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","77.4%","€ 39235.25","1.699","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","97.2%","€ 43255.29","5.897","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","71.8%","€ 20591.29","3.053","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","99.5%","€ 32385.14","2.570","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","71.6%","€ 22875.38","4.344","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":491},{"label":"Fev","value":496},{"label":"Mar","value":582},{"label":"Abr","value":634},{"label":"Mai","value":472},{"label":"Jun","value":390},{"label":"Jul","value":453},{"label":"Ago","value":513},{"label":"Set","value":447},{"label":"Out","value":493},{"label":"Nov","value":555},{"label":"Dez","value":536}];
const MX = 634;
