...
const PAGE = "Purchase Req";
const KPIS = [{"l":"Fornecedores Ativos","v":"431","t":"+11.5%","d":"up"},{"l":"Contratos (€M)","v":"€40.4M","t":"+1.2%","d":"up"},{"l":"On-Time Delivery (%)","v":"75.2%","t":"-1.6%","d":"down"},{"l":"Score Médio","v":"87","t":"+10.6%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","90.0%","€ 49672.32","2.151","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","77.5%","€ 36249.48","1.265","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","87.7%","€ 46830.46","6.971","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","79.3%","€ 7539.31","6.823","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.1%","€ 5058.46","6.304","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":702},{"label":"Mar","value":919},{"label":"Abr","value":920},{"label":"Mai","value":820},{"label":"Jun","value":650},{"label":"Jul","value":809},{"label":"Ago","value":854},{"label":"Set","value":867},{"label":"Out","value":545},{"label":"Nov","value":680},{"label":"Dez","value":671}];
const MX = 920;
