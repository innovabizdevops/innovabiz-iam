...
const PAGE = "Vendor Bid";
const KPIS = [{"l":"Fornecedores Ativos","v":"2.626","t":"+3.8%","d":"up"},{"l":"Contratos (€M)","v":"€26.4M","t":"+14.6%","d":"up"},{"l":"On-Time Delivery (%)","v":"84.5%","t":"+13.5%","d":"up"},{"l":"Score Médio","v":"90","t":"+16.4%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","81.9%","€ 28278.33","4.490","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","71.9%","€ 17418.42","2.608","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","81.7%","€ 17439.62","1.010","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","72.2%","€ 3170.47","805","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","96.6%","€ 14905.66","2.840","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":568},{"label":"Fev","value":401},{"label":"Mar","value":487},{"label":"Abr","value":366},{"label":"Mai","value":321},{"label":"Jun","value":603},{"label":"Jul","value":479},{"label":"Ago","value":554},{"label":"Set","value":347},{"label":"Out","value":510},{"label":"Nov","value":414},{"label":"Dez","value":644}];
const MX = 644;
