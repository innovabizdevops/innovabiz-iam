...
export default function MaterialProcurePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Material Procure</h1><p className="text-sm text-muted-foreground">Material Procure • iBOS Enterprise</p></div>
