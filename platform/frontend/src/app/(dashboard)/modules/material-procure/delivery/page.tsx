...
const PAGE = "Delivery Track";
const KPIS = [{"l":"Fornecedores Ativos","v":"4.643","t":"+11.3%","d":"up"},{"l":"Contratos (€M)","v":"€49.8M","t":"+17.0%","d":"up"},{"l":"On-Time Delivery (%)","v":"84.5%","t":"+3.8%","d":"up"},{"l":"Score Médio","v":"82","t":"+10.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","95.7%","€ 9938.24","7.354","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","70.4%","€ 35464.76","1.028","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","92.4%","€ 40349.42","4.388","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","74.7%","€ 21174.48","423","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","98.7%","€ 41409.45","3.207","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":567},{"label":"Mar","value":764},{"label":"Abr","value":805},{"label":"Mai","value":789},{"label":"Jun","value":788},{"label":"Jul","value":625},{"label":"Ago","value":886},{"label":"Set","value":643},{"label":"Out","value":796},{"label":"Nov","value":587},{"label":"Dez","value":653}];
const MX = 886;
