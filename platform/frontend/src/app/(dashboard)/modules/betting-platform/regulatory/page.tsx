...
const KPIS = [{"l":"Formulários Ativos","v":"1.320","t":"+0.1%","d":"up"},{"l":"Submissões/Dia","v":"1026","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"783","t":"+11.4%","d":"up"},{"l":"Templates","v":"7.409","t":"+15.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.996","2026-03-26","8.632","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.091","2026-01-18","5.213","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.435","2026-03-11","7.186","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.061","2026-02-06","6.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.288","2026-03-28","2.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":750},{"label":"Mar","value":682},{"label":"Abr","value":791},{"label":"Mai","value":791},{"label":"Jun","value":949},{"label":"Jul","value":680},{"label":"Ago","value":1069},{"label":"Set","value":826},{"label":"Out","value":1061},{"label":"Nov","value":941},{"label":"Dez","value":1015}];
const MX = 1069;
