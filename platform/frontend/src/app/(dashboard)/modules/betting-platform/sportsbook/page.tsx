...
const PAGE = "Sports Book";
const KPIS = [{"l":"Formulários Ativos","v":"4.937","t":"+8.6%","d":"up"},{"l":"Submissões/Dia","v":"2823","t":"+18.0%","d":"up"},{"l":"Documentos Gerados","v":"7.911","t":"+13.8%","d":"up"},{"l":"Templates","v":"295","t":"+11.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.229","2026-02-09","3.283","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.162","2026-02-10","7.200","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.126","2026-01-13","2.016","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.665","2026-03-25","5.564","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.635","2026-03-19","8.033","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":954},{"label":"Fev","value":874},{"label":"Mar","value":921},{"label":"Abr","value":691},{"label":"Mai","value":959},{"label":"Jun","value":660},{"label":"Jul","value":661},{"label":"Ago","value":755},{"label":"Set","value":676},{"label":"Out","value":762},{"label":"Nov","value":1018},{"label":"Dez","value":666}];
const MX = 1018;
