...
const KPIS = [{"l":"Riscos Identificados","v":"6.790","t":"+1.2%","d":"up"},{"l":"Mitigações Ativas","v":"8.087","t":"+16.1%","d":"up"},{"l":"Score Risco Geral","v":"81","t":"+6.0%","d":"up"},{"l":"Incidentes YTD","v":"7.146","t":"-5.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.436","2.508","5.003","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.855","5.552","7.437","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","115","6.025","6.272","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.710","2.164","1.579","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.215","541","5.744","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":443},{"label":"Mar","value":683},{"label":"Abr","value":414},{"label":"Mai","value":482},{"label":"Jun","value":593},{"label":"Jul","value":319},{"label":"Ago","value":332},{"label":"Set","value":317},{"label":"Out","value":430},{"label":"Nov","value":354},{"label":"Dez","value":356}];
const MX = 683;
