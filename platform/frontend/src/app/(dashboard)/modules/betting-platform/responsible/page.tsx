...
const PAGE = "Responsible";
const KPIS = [{"l":"Formulários Ativos","v":"7.578","t":"+4.6%","d":"up"},{"l":"Submissões/Dia","v":"4004","t":"+10.2%","d":"up"},{"l":"Documentos Gerados","v":"8.125","t":"-2.4%","d":"down"},{"l":"Templates","v":"8.999","t":"+1.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.642","2026-02-27","1.530","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.666","2026-03-17","6.460","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.627","2026-01-03","4.964","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","706","2026-03-17","6.801","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.471","2026-02-28","2.743","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":798},{"label":"Fev","value":819},{"label":"Mar","value":557},{"label":"Abr","value":740},{"label":"Mai","value":672},{"label":"Jun","value":570},{"label":"Jul","value":714},{"label":"Ago","value":886},{"label":"Set","value":820},{"label":"Out","value":744},{"label":"Nov","value":605},{"label":"Dez","value":515}];
const MX = 886;
