...
const ACCENT = "#b45309";
const MODULE = "Betting Platform";
const PAGE = "Odds Engine";
const KPIS = [{"l":"Formulários Ativos","v":"4.923","t":"+1.5%","d":"up"},{"l":"Submissões/Dia","v":"2771","t":"+0.9%","d":"up"},{"l":"Documentos Gerados","v":"6.742","t":"+9.2%","d":"up"},{"l":"Templates","v":"1.676","t":"+4.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.134","2026-02-27","1.052","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.386","2026-02-18","6.663","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.066","2026-01-24","6.713","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.692","2026-01-01","3.237","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.481","2026-02-19","387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":755},{"label":"Mar","value":637},{"label":"Abr","value":805},{"label":"Mai","value":631},{"label":"Jun","value":666},{"label":"Jul","value":738},{"label":"Ago","value":909},{"label":"Set","value":578},{"label":"Out","value":668},{"label":"Nov","value":879},{"label":"Dez","value":718}];
const MX = 909;
