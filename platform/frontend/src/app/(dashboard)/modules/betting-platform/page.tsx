...
export default function BettingPlatformPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Betting Platform</h1><p className="text-sm text-muted-foreground">Betting Platform • iBOS Enterprise</p></div>
