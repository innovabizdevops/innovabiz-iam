...
const KPIS = [{"l":"Total Wealth Mgmt","v":"1.535","t":"+12.6%","d":"up"},{"l":"Portfolio View Ativos","v":"4.041","t":"-3.0%","d":"down"},{"l":"Eficiência (%)","v":"85.5%","t":"+11.7%","d":"up"},{"l":"Score Performance","v":"82","t":"+11.6%","d":"up"}];
const COLS = ["ID","Portfolio View","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealth Mgmt #001","Wealth Mgmt #002","2.993","1.220","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["Wealth Mgmt #002","Wealth Mgmt #003","6.049","4.537","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealth Mgmt #003","Wealth Mgmt #004","2.942","6.298","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Wealth Mgmt #004","Wealth Mgmt #005","1.489","3.426","2026-01-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealth Mgmt #005","Wealth Mgmt #001","7.492","2.933","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":528},{"label":"Fev","value":442},{"label":"Mar","value":507},{"label":"Abr","value":696},{"label":"Mai","value":579},{"label":"Jun","value":673},{"label":"Jul","value":593},{"label":"Ago","value":510},{"label":"Set","value":558},{"label":"Out","value":469},{"label":"Nov","value":731},{"label":"Dez","value":706}];
const MX = 731;
