...
const PAGE = "Asset Alloc";
const KPIS = [{"l":"Ativos Registados","v":"7.738","t":"+15.7%","d":"up"},{"l":"Valor Total (€M)","v":"€22.9M","t":"+1.6%","d":"up"},{"l":"Depreciação Anual (€)","v":"€1322","t":"+8.8%","d":"up"},{"l":"Ativos em Garantia","v":"6.036","t":"+15.7%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 13819.81","2.150","€ 34748.89","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 40538.18","2.214","€ 25284.19","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 37508.68","4.861","€ 16103.40","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 5841.42","1.450","€ 8052.24","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 6123.07","8.098","€ 2154.64","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":400},{"label":"Fev","value":378},{"label":"Mar","value":501},{"label":"Abr","value":255},{"label":"Mai","value":458},{"label":"Jun","value":509},{"label":"Jul","value":480},{"label":"Ago","value":600},{"label":"Set","value":570},{"label":"Out","value":465},{"label":"Nov","value":567},{"label":"Dez","value":418}];
const MX = 600;
