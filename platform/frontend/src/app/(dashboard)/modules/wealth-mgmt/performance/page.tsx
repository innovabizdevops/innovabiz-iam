...
const KPIS = [{"l":"Formulários Ativos","v":"6.104","t":"+7.2%","d":"up"},{"l":"Submissões/Dia","v":"4470","t":"+9.2%","d":"up"},{"l":"Documentos Gerados","v":"6.133","t":"-3.3%","d":"down"},{"l":"Templates","v":"7.969","t":"+5.4%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.293","2026-03-14","4.746","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.372","2026-02-12","4.694","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.923","2026-03-10","4.194","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.289","2026-03-16","517","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.281","2026-01-25","3.020","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":434},{"label":"Fev","value":559},{"label":"Mar","value":561},{"label":"Abr","value":593},{"label":"Mai","value":791},{"label":"Jun","value":726},{"label":"Jul","value":707},{"label":"Ago","value":443},{"label":"Set","value":730},{"label":"Out","value":642},{"label":"Nov","value":645},{"label":"Dez","value":629}];
const MX = 791;
