...
const PAGE = "Tax Planning";
const KPIS = [{"l":"Total Wealth Mgmt","v":"1.207","t":"+1.4%","d":"up"},{"l":"Tax Planning Ativos","v":"5.512","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+12.2%","d":"up"},{"l":"Score Performance","v":"79","t":"+14.5%","d":"up"}];
const COLS = ["ID","Tax Planning","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealth Mgmt #001","Wealth Mgmt #002","7.703","3.302","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Wealth Mgmt #002","Wealth Mgmt #003","4.253","8.367","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealth Mgmt #003","Wealth Mgmt #004","4.223","2.893","2026-02-25","Concluído"],"status":"done"},{"id":"r3","cells":["Wealth Mgmt #004","Wealth Mgmt #005","3.277","612","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealth Mgmt #005","Wealth Mgmt #001","8.069","1.342","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":686},{"label":"Mar","value":787},{"label":"Abr","value":722},{"label":"Mai","value":686},{"label":"Jun","value":999},{"label":"Jul","value":732},{"label":"Ago","value":985},{"label":"Set","value":951},{"label":"Out","value":918},{"label":"Nov","value":994},{"label":"Dez","value":1024}];
const MX = 1024;
