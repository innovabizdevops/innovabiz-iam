...
const KPIS = [{"l":"Total Wealth Mgmt","v":"5.484","t":"-5.8%","d":"down"},{"l":"Client Report Ativos","v":"5.109","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"91.8%","t":"+10.0%","d":"up"},{"l":"Score Performance","v":"61","t":"-5.2%","d":"down"}];
const COLS = ["ID","Client Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealth Mgmt #001","Wealth Mgmt #002","4.832","1.148","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Wealth Mgmt #002","Wealth Mgmt #003","8.096","637","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealth Mgmt #003","Wealth Mgmt #004","5.988","1.423","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Wealth Mgmt #004","Wealth Mgmt #005","573","8.792","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealth Mgmt #005","Wealth Mgmt #001","1.160","3.726","2026-02-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":519},{"label":"Fev","value":731},{"label":"Mar","value":459},{"label":"Abr","value":496},{"label":"Mai","value":645},{"label":"Jun","value":673},{"label":"Jul","value":741},{"label":"Ago","value":638},{"label":"Set","value":428},{"label":"Out","value":669},{"label":"Nov","value":763},{"label":"Dez","value":583}];
const MX = 763;
