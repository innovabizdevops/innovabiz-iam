...
const KPIS = [{"l":"Total Wealth Mgmt","v":"8.016","t":"-4.1%","d":"down"},{"l":"Rebalance Ativos","v":"3.944","t":"-4.7%","d":"down"},{"l":"Eficiência (%)","v":"69.2%","t":"+0.8%","d":"up"},{"l":"Score Performance","v":"92","t":"+13.4%","d":"up"}];
const COLS = ["ID","Rebalance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealth Mgmt #001","Wealth Mgmt #002","3.546","7.993","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["Wealth Mgmt #002","Wealth Mgmt #003","7.583","2.524","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealth Mgmt #003","Wealth Mgmt #004","4.807","5.444","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Wealth Mgmt #004","Wealth Mgmt #005","3.178","5.316","2026-01-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealth Mgmt #005","Wealth Mgmt #001","7.188","4.830","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":832},{"label":"Mar","value":876},{"label":"Abr","value":697},{"label":"Mai","value":559},{"label":"Jun","value":861},{"label":"Jul","value":668},{"label":"Ago","value":846},{"label":"Set","value":796},{"label":"Out","value":755},{"label":"Nov","value":544},{"label":"Dez","value":621}];
const MX = 876;
