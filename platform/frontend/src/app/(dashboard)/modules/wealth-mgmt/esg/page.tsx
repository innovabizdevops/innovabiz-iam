...
const ACCENT = "#3c5a7f";
const MODULE = "Wealth Management";
const PAGE = "ESG Screening";
const KPIS = [{"l":"Total Wealth Mgmt","v":"1.870","t":"-5.0%","d":"down"},{"l":"ESG Screening Ativos","v":"3.890","t":"+17.6%","d":"up"},{"l":"Eficiência (%)","v":"71.7%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"83","t":"-4.0%","d":"down"}];
const COLS = ["ID","ESG Screening","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Wealth Mgmt #001","Wealth Mgmt #002","2.962","403","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["Wealth Mgmt #002","Wealth Mgmt #003","8.138","644","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Wealth Mgmt #003","Wealth Mgmt #004","8.142","7.862","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["Wealth Mgmt #004","Wealth Mgmt #005","6.068","3.794","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Wealth Mgmt #005","Wealth Mgmt #001","8.090","4.622","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":567},{"label":"Fev","value":861},{"label":"Mar","value":800},{"label":"Abr","value":844},{"label":"Mai","value":652},{"label":"Jun","value":660},{"label":"Jul","value":880},{"label":"Ago","value":720},{"label":"Set","value":511},{"label":"Out","value":845},{"label":"Nov","value":554},{"label":"Dez","value":584}];
const MX = 880;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#3c5a7f'}}>ESG</span></h1>
                </div>
