...
const ACCENT = "#ec4899";
const MODULE = "Luxury Retail";
const PAGE = "Live Shopping";
const KPIS = [{"l":"Pedidos/Dia","v":"1105","t":"+2.2%","d":"up"},{"l":"GMV (€)","v":"€62994","t":"+10.7%","d":"up"},{"l":"Conversão (%)","v":"88.7%","t":"+16.9%","d":"up"},{"l":"AOV (€)","v":"€13195","t":"-0.6%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 23805.21","4.445","8.018","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 23559.45","8.133","3.241","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 43250.05","1.055","3.834","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 21880.90","2.211","2.787","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 13540.61","2.007","7.732","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":887},{"label":"Fev","value":953},{"label":"Mar","value":793},{"label":"Abr","value":832},{"label":"Mai","value":677},{"label":"Jun","value":648},{"label":"Jul","value":660},{"label":"Ago","value":803},{"label":"Set","value":869},{"label":"Out","value":648},{"label":"Nov","value":845},{"label":"Dez","value":807}];
const MX = 953;
