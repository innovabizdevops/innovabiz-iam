...
const PAGE = "Pop-Up";
const KPIS = [{"l":"Pedidos/Dia","v":"169","t":"+3.4%","d":"up"},{"l":"GMV (€)","v":"€19850","t":"+6.6%","d":"up"},{"l":"Conversão (%)","v":"90.8%","t":"-1.9%","d":"down"},{"l":"AOV (€)","v":"€32529","t":"+6.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 10143.17","1.745","8.211","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 9866.73","2.055","6.049","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 39436.91","3.586","5.411","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 41715.45","4.581","1.435","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 23003.88","6.197","6.283","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":731},{"label":"Mar","value":480},{"label":"Abr","value":612},{"label":"Mai","value":831},{"label":"Jun","value":664},{"label":"Jul","value":455},{"label":"Ago","value":802},{"label":"Set","value":547},{"label":"Out","value":555},{"label":"Nov","value":611},{"label":"Dez","value":733}];
const MX = 831;
