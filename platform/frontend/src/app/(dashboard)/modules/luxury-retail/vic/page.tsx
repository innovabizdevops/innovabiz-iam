...
const PAGE = "VIC Program";
const KPIS = [{"l":"Pedidos/Dia","v":"4333","t":"-5.6%","d":"down"},{"l":"GMV (€)","v":"€37323","t":"+3.0%","d":"up"},{"l":"Conversão (%)","v":"83.9%","t":"+8.4%","d":"up"},{"l":"AOV (€)","v":"€54216","t":"+11.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 24358.32","6.658","475","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 18952.57","236","9.075","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 45370.22","8.427","7.225","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 20198.11","3.872","1.389","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 28838.27","1.601","1.569","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":624},{"label":"Mar","value":800},{"label":"Abr","value":665},{"label":"Mai","value":557},{"label":"Jun","value":711},{"label":"Jul","value":765},{"label":"Ago","value":723},{"label":"Set","value":839},{"label":"Out","value":599},{"label":"Nov","value":564},{"label":"Dez","value":818}];
const MX = 839;
