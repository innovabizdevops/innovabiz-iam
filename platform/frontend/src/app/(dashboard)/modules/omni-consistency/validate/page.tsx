...
const PAGE = "Validate";
const KPIS = [{"l":"Total Omni Consistency","v":"6.479","t":"+8.8%","d":"up"},{"l":"Validate Ativos","v":"7.787","t":"+9.3%","d":"up"},{"l":"Eficiência (%)","v":"87.0%","t":"+6.6%","d":"up"},{"l":"Score Performance","v":"59","t":"+17.5%","d":"up"}];
const COLS = ["ID","Validate","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Consistency #001","Omni Consistency #002","4.706","6.631","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Consistency #002","Omni Consistency #003","3.259","3.648","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Consistency #003","Omni Consistency #004","730","5.107","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Consistency #004","Omni Consistency #005","8.057","8.440","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Consistency #005","Omni Consistency #001","3.439","4.634","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":804},{"label":"Mar","value":530},{"label":"Abr","value":589},{"label":"Mai","value":888},{"label":"Jun","value":628},{"label":"Jul","value":803},{"label":"Ago","value":890},{"label":"Set","value":809},{"label":"Out","value":525},{"label":"Nov","value":748},{"label":"Dez","value":692}];
const MX = 890;
