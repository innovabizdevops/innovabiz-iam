...
const KPIS = [{"l":"Total Omni Consistency","v":"3.255","t":"+3.9%","d":"up"},{"l":"Component Ativos","v":"702","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"74.6%","t":"-4.8%","d":"down"},{"l":"Score Performance","v":"86","t":"+14.0%","d":"up"}];
const COLS = ["ID","Component","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Omni Consistency #001","Omni Consistency #002","5.450","8.764","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Omni Consistency #002","Omni Consistency #003","791","6.183","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Omni Consistency #003","Omni Consistency #004","6.469","5.976","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Omni Consistency #004","Omni Consistency #005","5.981","5.160","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Omni Consistency #005","Omni Consistency #001","3.596","1.343","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":685},{"label":"Fev","value":749},{"label":"Mar","value":688},{"label":"Abr","value":682},{"label":"Mai","value":914},{"label":"Jun","value":1034},{"label":"Jul","value":770},{"label":"Ago","value":760},{"label":"Set","value":1048},{"label":"Out","value":798},{"label":"Nov","value":697},{"label":"Dez","value":741}];
const MX = 1048;
