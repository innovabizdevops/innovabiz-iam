...
/* ═══ OMNI Brand Consistency — Dashboard ═══ */

const ACCENT = "#2563eb";

const KPIS = [
    { label: "Total Registos", value: "9285", trend: "+11%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4966", trend: "+5%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€391K", trend: "-24%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+18%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1417679285", cells: ["OMN-9285", "OMNI Brand Consistency Item 1", "2/6/2026", "€29 385"], status: "active" as const },
    { id: "1417682856", cells: ["OMN-3856", "OMNI Brand Consistency Item 2", "17/1/2026", "€32 956"], status: "pending" as const },
    { id: "1417686427", cells: ["OMN-7427", "OMNI Brand Consistency Item 3", "4/8/2026", "€36 527"], status: "completed" as const },
    { id: "1417689998", cells: ["OMN-1998", "OMNI Brand Consistency Item 4", "19/3/2026", "€40 098"], status: "warning" as const },
    { id: "1417693569", cells: ["OMN-5569", "OMNI Brand Consistency Item 5", "6/10/2026", "€43 669"], status: "active" as const },
];
...
export default function OmniBrandConsistencyPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">OMNI Brand Consistency</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • OMNI Brand Consistency</p>
                    </div>
                </div>
