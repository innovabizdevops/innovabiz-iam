...
const ACCENT = "#2563eb";
const MODULE = "OMNI Brand Consistency";
const PAGE = "Design Token";
const KPIS = [{"l":"Formulários Ativos","v":"2.988","t":"-1.3%","d":"down"},{"l":"Submissões/Dia","v":"1565","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"6.020","t":"+8.3%","d":"up"},{"l":"Templates","v":"3.031","t":"+11.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.745","2026-03-09","8.036","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.476","2026-02-17","3.905","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.441","2026-01-16","5.118","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","876","2026-01-13","6.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.498","2026-01-11","5.517","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":825},{"label":"Fev","value":734},{"label":"Mar","value":608},{"label":"Abr","value":844},{"label":"Mai","value":825},{"label":"Jun","value":728},{"label":"Jul","value":753},{"label":"Ago","value":902},{"label":"Set","value":656},{"label":"Out","value":902},{"label":"Nov","value":608},{"label":"Dez","value":649}];
const MX = 902;
