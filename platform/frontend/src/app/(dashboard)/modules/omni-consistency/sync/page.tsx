...
const PAGE = "Sync";
const KPIS = [{"l":"Integrações Ativas","v":"6.738","t":"-5.5%","d":"down"},{"l":"Chamadas/Hora","v":"4481","t":"+9.8%","d":"up"},{"l":"Taxa Sucesso (%)","v":"85.9%","t":"-4.6%","d":"down"},{"l":"Latência Média (ms)","v":"18ms","t":"+7.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.702","9.002","82.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.539","4.213","90.4%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.012","8.098","98.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.929","1.027","92.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.711","683","94.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":450},{"label":"Mar","value":807},{"label":"Abr","value":790},{"label":"Mai","value":670},{"label":"Jun","value":739},{"label":"Jul","value":593},{"label":"Ago","value":522},{"label":"Set","value":788},{"label":"Out","value":811},{"label":"Nov","value":723},{"label":"Dez","value":519}];
const MX = 811;
