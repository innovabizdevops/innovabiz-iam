...
const KPIS = [{"l":"Auditorias Realizadas","v":"8.565","t":"+11.0%","d":"up"},{"l":"NC Abertas","v":"3.548","t":"+6.3%","d":"up"},{"l":"Conformidade (%)","v":"86.2%","t":"-3.6%","d":"down"},{"l":"CAPAs Pendentes","v":"1.106","t":"-4.8%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.754","72.4%","6.125","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.045","96.9%","726","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","876","79.9%","2.076","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.991","73.6%","8.244","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.786","97.0%","4.599","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":880},{"label":"Mar","value":551},{"label":"Abr","value":891},{"label":"Mai","value":680},{"label":"Jun","value":679},{"label":"Jul","value":836},{"label":"Ago","value":669},{"label":"Set","value":726},{"label":"Out","value":703},{"label":"Nov","value":694},{"label":"Dez","value":909}];
const MX = 909;
