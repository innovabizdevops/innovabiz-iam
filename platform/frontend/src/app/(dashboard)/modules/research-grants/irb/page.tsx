...
const PAGE = "IRB Workflow";
const KPIS = [{"l":"Ideias Submetidas","v":"2.782","t":"+4.0%","d":"up"},{"l":"Patentes (YTD)","v":"7.311","t":"+0.8%","d":"up"},{"l":"Projetos Innovation Lab","v":"7.366","t":"+4.2%","d":"up"},{"l":"Budget I&D (€M)","v":"€46.8M","t":"+6.7%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","7.591","77.4%","4.404","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","8.807","84.5%","1.449","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.288","85.2%","3.000","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","3.178","98.0%","2.719","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","4.592","71.9%","1.315","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":480},{"label":"Fev","value":584},{"label":"Mar","value":630},{"label":"Abr","value":349},{"label":"Mai","value":492},{"label":"Jun","value":618},{"label":"Jul","value":669},{"label":"Ago","value":280},{"label":"Set","value":313},{"label":"Out","value":403},{"label":"Nov","value":322},{"label":"Dez","value":574}];
const MX = 669;
