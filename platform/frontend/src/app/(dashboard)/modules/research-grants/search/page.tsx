...
const ACCENT = "#64748b";
const MODULE = "Research Grants";
const PAGE = "Grant Search";
const KPIS = [{"l":"Ideias Submetidas","v":"7.682","t":"+10.2%","d":"up"},{"l":"Patentes (YTD)","v":"5.408","t":"+15.0%","d":"up"},{"l":"Projetos Innovation Lab","v":"3.551","t":"+12.8%","d":"up"},{"l":"Budget I&D (€M)","v":"€22.2M","t":"-5.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","4.073","85.7%","448","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","621","81.1%","2.115","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","1.410","93.7%","3.506","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.581","88.6%","4.834","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","5.386","98.9%","3.058","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":728},{"label":"Fev","value":684},{"label":"Mar","value":932},{"label":"Abr","value":617},{"label":"Mai","value":608},{"label":"Jun","value":647},{"label":"Jul","value":613},{"label":"Ago","value":861},{"label":"Set","value":755},{"label":"Out","value":704},{"label":"Nov","value":751},{"label":"Dez","value":629}];
const MX = 932;
