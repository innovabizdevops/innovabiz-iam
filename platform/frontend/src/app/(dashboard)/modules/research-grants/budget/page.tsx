...
const KPIS = [{"l":"Ideias Submetidas","v":"2.074","t":"+0.4%","d":"up"},{"l":"Patentes (YTD)","v":"8.661","t":"-5.0%","d":"down"},{"l":"Projetos Innovation Lab","v":"228","t":"+0.4%","d":"up"},{"l":"Budget I&D (€M)","v":"€38.8M","t":"-5.8%","d":"down"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","8.902","97.5%","2.079","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","574","79.3%","8.248","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.425","71.5%","2.507","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","896","82.0%","176","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","6.968","72.1%","2.513","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":397},{"label":"Mar","value":553},{"label":"Abr","value":566},{"label":"Mai","value":683},{"label":"Jun","value":482},{"label":"Jul","value":333},{"label":"Ago","value":382},{"label":"Set","value":579},{"label":"Out","value":660},{"label":"Nov","value":651},{"label":"Dez","value":374}];
const MX = 683;
