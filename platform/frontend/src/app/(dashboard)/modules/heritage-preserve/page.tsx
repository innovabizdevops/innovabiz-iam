...
/* ═══ Heritage Preservation — Dashboard ═══ */

const ACCENT = "#713f12";

const KPIS = [
    { label: "Total Registos", value: "5561", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4970", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€258K", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+19%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2126535361", cells: ["HER-7361", "Heritage Preservation Item 1", "14/2/2026", "€35 461"], status: "active" as const },
    { id: "2126538932", cells: ["HER-1932", "Heritage Preservation Item 2", "1/9/2026", "€39 032"], status: "pending" as const },
    { id: "2126542503", cells: ["HER-5503", "Heritage Preservation Item 3", "16/4/2026", "€42 603"], status: "completed" as const },
    { id: "2126546074", cells: ["HER-9074", "Heritage Preservation Item 4", "3/11/2026", "€46 174"], status: "warning" as const },
    { id: "2126549645", cells: ["HER-3645", "Heritage Preservation Item 5", "18/6/2026", "€49 745"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Heritage Preservation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Heritage Preservation</p>
                    </div>
                </div>
