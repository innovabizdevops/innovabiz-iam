...
const ACCENT = "#713f12";
const MODULE = "Heritage Preservation";
const PAGE = "Register";
const KPIS = [{"l":"Total Heritage Preserve","v":"1.823","t":"-0.6%","d":"down"},{"l":"Register Ativos","v":"1.673","t":"-1.9%","d":"down"},{"l":"Eficiência (%)","v":"72.1%","t":"+13.3%","d":"up"},{"l":"Score Performance","v":"72","t":"-5.5%","d":"down"}];
const COLS = ["ID","Register","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Heritage Preserve #001","Heritage Preserve #002","5.732","5.597","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Heritage Preserve #002","Heritage Preserve #003","2.716","5.311","2026-03-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Heritage Preserve #003","Heritage Preserve #004","1.670","2.308","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Heritage Preserve #004","Heritage Preserve #005","5.022","1.334","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Heritage Preserve #005","Heritage Preserve #001","8.199","6.781","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":944},{"label":"Fev","value":671},{"label":"Mar","value":965},{"label":"Abr","value":1001},{"label":"Mai","value":684},{"label":"Jun","value":702},{"label":"Jul","value":915},{"label":"Ago","value":929},{"label":"Set","value":800},{"label":"Out","value":928},{"label":"Nov","value":896},{"label":"Dez","value":903}];
const MX = 1001;
