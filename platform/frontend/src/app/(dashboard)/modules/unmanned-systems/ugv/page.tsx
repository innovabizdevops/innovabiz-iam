...
const PAGE = "UGV";
const KPIS = [{"l":"Total Unmanned Systems","v":"3.930","t":"-1.8%","d":"down"},{"l":"UGV Ativos","v":"1.104","t":"-1.1%","d":"down"},{"l":"Eficiência (%)","v":"78.9%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"60","t":"-3.2%","d":"down"}];
const COLS = ["ID","UGV","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Unmanned Systems #001","Unmanned Systems #002","467","2.015","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Unmanned Systems #002","Unmanned Systems #003","7.084","7.222","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Unmanned Systems #003","Unmanned Systems #004","4.973","3.345","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Unmanned Systems #004","Unmanned Systems #005","6.198","7.011","2026-03-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Unmanned Systems #005","Unmanned Systems #001","3.799","2.994","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":705},{"label":"Mar","value":672},{"label":"Abr","value":763},{"label":"Mai","value":780},{"label":"Jun","value":803},{"label":"Jul","value":450},{"label":"Ago","value":759},{"label":"Set","value":567},{"label":"Out","value":779},{"label":"Nov","value":504},{"label":"Dez","value":726}];
const MX = 803;
...
export default function UgvPage() {
    return (
