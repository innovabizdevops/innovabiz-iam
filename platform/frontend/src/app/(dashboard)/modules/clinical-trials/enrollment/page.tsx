...
const PAGE = "Patient Enroll";
const KPIS = [{"l":"Total Clinical Trials","v":"7.582","t":"+14.8%","d":"up"},{"l":"Patient Enroll Ativos","v":"648","t":"+7.0%","d":"up"},{"l":"Eficiência (%)","v":"69.7%","t":"+13.8%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.0%","d":"up"}];
const COLS = ["ID","Patient Enroll","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Clinical Trials #001","Clinical Trials #002","247","7.917","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Clinical Trials #002","Clinical Trials #003","7.049","8.297","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Clinical Trials #003","Clinical Trials #004","2.585","7.421","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Clinical Trials #004","Clinical Trials #005","5.625","2.726","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Clinical Trials #005","Clinical Trials #001","2.252","7.947","2026-01-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":309},{"label":"Fev","value":482},{"label":"Mar","value":509},{"label":"Abr","value":350},{"label":"Mai","value":631},{"label":"Jun","value":324},{"label":"Jul","value":392},{"label":"Ago","value":567},{"label":"Set","value":425},{"label":"Out","value":447},{"label":"Nov","value":379},{"label":"Dez","value":555}];
const MX = 631;
