...
const PAGE = "Protocol Mgmt";
const KPIS = [{"l":"Integrações Ativas","v":"3.668","t":"+5.1%","d":"up"},{"l":"Chamadas/Hora","v":"4455","t":"+2.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"65.4%","t":"+10.8%","d":"up"},{"l":"Latência Média (ms)","v":"190ms","t":"+1.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","815","3.754","76.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.821","8.298","75.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.412","2.869","85.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.896","6.443","89.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.410","4.050","71.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":637},{"label":"Fev","value":516},{"label":"Mar","value":819},{"label":"Abr","value":751},{"label":"Mai","value":563},{"label":"Jun","value":564},{"label":"Jul","value":687},{"label":"Ago","value":860},{"label":"Set","value":538},{"label":"Out","value":505},{"label":"Nov","value":536},{"label":"Dez","value":516}];
const MX = 860;
