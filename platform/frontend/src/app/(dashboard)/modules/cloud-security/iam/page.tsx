...
const PAGE = "IAM Review";
const KPIS = [{"l":"Utilizadores Ativos","v":"7.077","t":"-5.6%","d":"down"},{"l":"Sessões/Dia","v":"292","t":"+17.6%","d":"up"},{"l":"MFA Adoção (%)","v":"83.6%","t":"+1.5%","d":"up"},{"l":"Tentativas Bloqueadas","v":"2.502","t":"+12.6%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","7.687","4.685","8.971","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.070","7.290","1.430","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","5.894","7.894","3.978","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","5.556","3.286","6.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.756","3.566","4.987","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":890},{"label":"Fev","value":620},{"label":"Mar","value":649},{"label":"Abr","value":674},{"label":"Mai","value":663},{"label":"Jun","value":666},{"label":"Jul","value":998},{"label":"Ago","value":866},{"label":"Set","value":635},{"label":"Out","value":682},{"label":"Nov","value":871},{"label":"Dez","value":671}];
const MX = 998;
