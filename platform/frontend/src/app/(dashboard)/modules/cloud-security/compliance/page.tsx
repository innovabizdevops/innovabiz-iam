...
const KPIS = [{"l":"Auditorias Realizadas","v":"6.517","t":"+6.4%","d":"up"},{"l":"NC Abertas","v":"4.547","t":"+12.9%","d":"up"},{"l":"Conformidade (%)","v":"77.5%","t":"+3.3%","d":"up"},{"l":"CAPAs Pendentes","v":"8.592","t":"-2.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.562","71.5%","6.327","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.754","84.1%","4.989","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.492","78.6%","111","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.302","79.5%","6.942","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.635","70.1%","2.496","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":652},{"label":"Mar","value":856},{"label":"Abr","value":817},{"label":"Mai","value":860},{"label":"Jun","value":715},{"label":"Jul","value":704},{"label":"Ago","value":841},{"label":"Set","value":956},{"label":"Out","value":588},{"label":"Nov","value":677},{"label":"Dez","value":758}];
const MX = 956;
