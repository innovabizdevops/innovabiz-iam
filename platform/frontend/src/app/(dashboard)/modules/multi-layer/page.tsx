...
/* ═══ Multi-Layer Governance — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "9672", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4082", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€259K", trend: "-11%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+5%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2034281372", cells: ["MUL-3372", "Multi-Layer Governance Item 1", "5/9/2026", "€31 472"], status: "active" as const },
    { id: "2034284943", cells: ["MUL-6943", "Multi-Layer Governance Item 2", "20/4/2026", "€35 043"], status: "pending" as const },
    { id: "2034288514", cells: ["MUL-1514", "Multi-Layer Governance Item 3", "7/11/2026", "€38 614"], status: "completed" as const },
    { id: "2034292085", cells: ["MUL-5085", "Multi-Layer Governance Item 4", "22/6/2026", "€42 185"], status: "warning" as const },
    { id: "2034295656", cells: ["MUL-8656", "Multi-Layer Governance Item 5", "9/1/2026", "€45 756"], status: "active" as const },
];
...
export default function MultilayerGovernancePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Layer Governance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Layer Governance</p>
                    </div>
                </div>
