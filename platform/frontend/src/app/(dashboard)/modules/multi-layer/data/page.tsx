...
const PAGE = "Data";
const KPIS = [{"l":"Total Multi Layer","v":"7.447","t":"+0.1%","d":"up"},{"l":"Data Ativos","v":"2.175","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"87.3%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"89","t":"+0.2%","d":"up"}];
const COLS = ["ID","Data","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Layer #001","2026-01-22","1.135","5.003","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Layer #002","2026-03-17","5.570","871","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Layer #003","2026-03-04","6.839","5.806","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Layer #004","2026-02-19","6.511","5.498","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Layer #005","2026-03-25","2.757","2.992","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":602},{"label":"Fev","value":556},{"label":"Mar","value":471},{"label":"Abr","value":443},{"label":"Mai","value":755},{"label":"Jun","value":739},{"label":"Jul","value":540},{"label":"Ago","value":664},{"label":"Set","value":621},{"label":"Out","value":671},{"label":"Nov","value":668},{"label":"Dez","value":710}];
const MX = 755;
