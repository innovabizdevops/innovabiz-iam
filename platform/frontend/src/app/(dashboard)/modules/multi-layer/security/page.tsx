...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Layer Governance";
const PAGE = "Security";
const KPIS = [{"l":"Total Multi Layer","v":"5.812","t":"+14.8%","d":"up"},{"l":"Security Ativos","v":"6.225","t":"+9.0%","d":"up"},{"l":"Eficiência (%)","v":"86.5%","t":"-5.3%","d":"down"},{"l":"Score Performance","v":"70","t":"+14.0%","d":"up"}];
const COLS = ["ID","Security","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Layer #001","Multi Layer #002","6.260","2.139","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Layer #002","Multi Layer #003","2.301","5.674","2026-03-16","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Layer #003","Multi Layer #004","5.321","9.081","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Layer #004","Multi Layer #005","1.977","2.775","2026-01-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Layer #005","Multi Layer #001","2.584","7.360","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":569},{"label":"Mar","value":624},{"label":"Abr","value":577},{"label":"Mai","value":802},{"label":"Jun","value":672},{"label":"Jul","value":542},{"label":"Ago","value":638},{"label":"Set","value":631},{"label":"Out","value":828},{"label":"Nov","value":791},{"label":"Dez","value":553}];
const MX = 828;
