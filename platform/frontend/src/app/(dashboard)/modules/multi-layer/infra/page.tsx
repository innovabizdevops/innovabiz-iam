...
const PAGE = "Infra";
const KPIS = [{"l":"Total Multi Layer","v":"900","t":"+3.6%","d":"up"},{"l":"Infra Ativos","v":"8.739","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"71.9%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"70","t":"-1.7%","d":"down"}];
const COLS = ["ID","Infra","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Layer #001","Multi Layer #002","2.722","9.044","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Layer #002","Multi Layer #003","3.842","3.459","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Layer #003","Multi Layer #004","6.815","4.050","2026-02-06","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Layer #004","Multi Layer #005","1.658","7.455","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Layer #005","Multi Layer #001","7.114","2.231","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":627},{"label":"Mar","value":734},{"label":"Abr","value":788},{"label":"Mai","value":623},{"label":"Jun","value":813},{"label":"Jul","value":861},{"label":"Ago","value":683},{"label":"Set","value":622},{"label":"Out","value":714},{"label":"Nov","value":672},{"label":"Dez","value":692}];
const MX = 861;
