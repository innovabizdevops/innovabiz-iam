...
/* ═══ Justice & Court Management — Dashboard ═══ */

const ACCENT = "#1e3a5f";

const KPIS = [
    { label: "Total Registos", value: "5148", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2883", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€52K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1781618948", cells: ["JUS-6948", "Justice & Court Management Item 1", "5/9/2026", "€19 048"], status: "active" as const },
    { id: "1781622519", cells: ["JUS-1519", "Justice & Court Management Item 2", "20/4/2026", "€22 619"], status: "pending" as const },
    { id: "1781626090", cells: ["JUS-5090", "Justice & Court Management Item 3", "7/11/2026", "€26 190"], status: "completed" as const },
    { id: "1781629661", cells: ["JUS-8661", "Justice & Court Management Item 4", "22/6/2026", "€29 761"], status: "warning" as const },
    { id: "1781633232", cells: ["JUS-3232", "Justice & Court Management Item 5", "9/1/2026", "€33 332"], status: "active" as const },
];
...
export default function JusticeCourtManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Justice & Court Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Justice & Court Management</p>
                    </div>
                </div>
