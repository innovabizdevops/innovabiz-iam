...
const PAGE = "Thermal Scan";
const KPIS = [{"l":"Riscos Identificados","v":"8.883","t":"+17.8%","d":"up"},{"l":"Mitigações Ativas","v":"8.873","t":"-0.1%","d":"down"},{"l":"Score Risco Geral","v":"74","t":"-4.4%","d":"down"},{"l":"Incidentes YTD","v":"4.665","t":"-4.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","9.055","3.377","5.064","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.299","4.779","7.561","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","2.858","2.513","3.469","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","9.087","2.240","8.331","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.021","5.366","5.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1064},{"label":"Fev","value":1039},{"label":"Mar","value":1048},{"label":"Abr","value":1052},{"label":"Mai","value":1067},{"label":"Jun","value":1036},{"label":"Jul","value":1000},{"label":"Ago","value":963},{"label":"Set","value":949},{"label":"Out","value":916},{"label":"Nov","value":905},{"label":"Dez","value":871}];
const MX = 1067;
