...
const KPIS = [{"l":"Total Inspect Drone","v":"5.424","t":"+11.2%","d":"up"},{"l":"LiDAR Scan Ativos","v":"5.836","t":"-0.3%","d":"down"},{"l":"Eficiência (%)","v":"86.6%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"70","t":"+1.6%","d":"up"}];
const COLS = ["ID","LiDAR Scan","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inspect Drone #001","Inspect Drone #002","4.446","4.907","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Inspect Drone #002","Inspect Drone #003","7.259","8.121","2026-02-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Inspect Drone #003","Inspect Drone #004","5.315","5.137","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Inspect Drone #004","Inspect Drone #005","3.985","525","2026-03-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inspect Drone #005","Inspect Drone #001","4.921","4.469","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":382},{"label":"Fev","value":283},{"label":"Mar","value":573},{"label":"Abr","value":370},{"label":"Mai","value":272},{"label":"Jun","value":221},{"label":"Jul","value":303},{"label":"Ago","value":516},{"label":"Set","value":524},{"label":"Out","value":260},{"label":"Nov","value":514},{"label":"Dez","value":283}];
const MX = 573;
