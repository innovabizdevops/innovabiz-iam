...
export default function InspectDronePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Inspect Drone</h1><p className="text-sm text-muted-foreground">Inspect Drone • iBOS Enterprise</p></div>
