...
const ACCENT = "#6366f1";
const MODULE = "Inspection Drones";
const PAGE = "Defect AI";
const KPIS = [{"l":"Total Inspect Drone","v":"6.349","t":"-3.0%","d":"down"},{"l":"Defect AI Ativos","v":"7.663","t":"+8.8%","d":"up"},{"l":"Eficiência (%)","v":"90.6%","t":"+5.4%","d":"up"},{"l":"Score Performance","v":"75","t":"-0.8%","d":"down"}];
const COLS = ["ID","Defect AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Inspect Drone #001","Inspect Drone #002","5.223","453","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Inspect Drone #002","Inspect Drone #003","1.868","7.608","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Inspect Drone #003","Inspect Drone #004","8.521","6.206","2026-03-20","Concluído"],"status":"done"},{"id":"r3","cells":["Inspect Drone #004","Inspect Drone #005","5.479","3.394","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Inspect Drone #005","Inspect Drone #001","1.796","6.775","2026-01-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":769},{"label":"Fev","value":668},{"label":"Mar","value":917},{"label":"Abr","value":927},{"label":"Mai","value":934},{"label":"Jun","value":972},{"label":"Jul","value":913},{"label":"Ago","value":853},{"label":"Set","value":838},{"label":"Out","value":824},{"label":"Nov","value":777},{"label":"Dez","value":800}];
const MX = 972;
