...
const PAGE = "Mobile App Builder";
const KPIS = [{"l":"Total Low Code","v":"7.672","t":"+1.9%","d":"up"},{"l":"Mobile App Builder Ativos","v":"6.460","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"84.2%","t":"+13.0%","d":"up"},{"l":"Score Performance","v":"77","t":"-2.7%","d":"down"}];
const COLS = ["ID","Mobile App Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code #001","Low Code #002","2.544","4.911","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code #002","Low Code #003","3.101","6.999","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code #003","Low Code #004","4.987","8.774","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code #004","Low Code #005","1.607","1.795","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code #005","Low Code #001","8.348","7.880","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":813},{"label":"Mar","value":668},{"label":"Abr","value":635},{"label":"Mai","value":753},{"label":"Jun","value":720},{"label":"Jul","value":763},{"label":"Ago","value":570},{"label":"Set","value":752},{"label":"Out","value":774},{"label":"Nov","value":611},{"label":"Dez","value":835}];
const MX = 835;
