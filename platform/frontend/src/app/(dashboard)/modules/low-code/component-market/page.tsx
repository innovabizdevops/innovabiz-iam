...
const PAGE = "Component Marketplace";
const KPIS = [{"l":"Pedidos/Dia","v":"2662","t":"+8.0%","d":"up"},{"l":"GMV (€)","v":"€72793","t":"+14.6%","d":"up"},{"l":"Conversão (%)","v":"71.9%","t":"+8.9%","d":"up"},{"l":"AOV (€)","v":"€1331","t":"-0.4%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 46645.47","6.690","7.751","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 39415.25","7.881","4.438","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 40342.33","2.402","6.220","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 31219.83","6.998","5.200","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 36611.50","3.637","1.718","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":431},{"label":"Fev","value":514},{"label":"Mar","value":700},{"label":"Abr","value":417},{"label":"Mai","value":721},{"label":"Jun","value":517},{"label":"Jul","value":594},{"label":"Ago","value":693},{"label":"Set","value":682},{"label":"Out","value":625},{"label":"Nov","value":605},{"label":"Dez","value":722}];
const MX = 722;
