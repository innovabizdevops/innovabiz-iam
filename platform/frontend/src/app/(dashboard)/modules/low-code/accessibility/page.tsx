...
const PAGE = "A11y Checker";
const KPIS = [{"l":"Total Low Code","v":"6.469","t":"-5.5%","d":"down"},{"l":"A11y Checker Ativos","v":"9.003","t":"-1.2%","d":"down"},{"l":"Eficiência (%)","v":"85.9%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"62","t":"+17.3%","d":"up"}];
const COLS = ["ID","A11y Checker","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code #001","2026-02-01","5.261","3.357","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code #002","2026-01-07","6.151","1.531","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code #003","2026-02-12","6.853","8.288","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code #004","2026-01-28","5.517","5.686","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code #005","2026-02-21","1.880","6.946","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":231},{"label":"Fev","value":522},{"label":"Mar","value":417},{"label":"Abr","value":373},{"label":"Mai","value":366},{"label":"Jun","value":493},{"label":"Jul","value":296},{"label":"Ago","value":541},{"label":"Set","value":318},{"label":"Out","value":579},{"label":"Nov","value":271},{"label":"Dez","value":531}];
const MX = 579;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>WCAG</span></h1>
                </div>
