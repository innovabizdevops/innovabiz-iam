...
const PAGE = "Logic Builder";
const KPIS = [{"l":"Total Low Code","v":"1.650","t":"+5.3%","d":"up"},{"l":"Logic Builder Ativos","v":"5.697","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"89.6%","t":"+14.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+10.1%","d":"up"}];
const COLS = ["ID","Logic Builder","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code #001","Low Code #002","5.764","6.626","2026-01-18","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code #002","Low Code #003","6.509","6.597","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code #003","Low Code #004","8.430","158","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code #004","Low Code #005","6.849","6.746","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code #005","Low Code #001","8.729","8.039","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":816},{"label":"Fev","value":669},{"label":"Mar","value":960},{"label":"Abr","value":941},{"label":"Mai","value":872},{"label":"Jun","value":680},{"label":"Jul","value":715},{"label":"Ago","value":688},{"label":"Set","value":1038},{"label":"Out","value":943},{"label":"Nov","value":917},{"label":"Dez","value":859}];
const MX = 1038;
