...
const PAGE = "Design Tokens";
const KPIS = [{"l":"Formulários Ativos","v":"4.389","t":"+13.0%","d":"up"},{"l":"Submissões/Dia","v":"2636","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"1.567","t":"+8.3%","d":"up"},{"l":"Templates","v":"1.028","t":"+1.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.896","2026-02-16","1.797","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","775","2026-02-12","2.914","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.259","2026-03-21","4.514","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.969","2026-01-20","7.557","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.593","2026-01-01","5.465","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":923},{"label":"Fev","value":644},{"label":"Mar","value":652},{"label":"Abr","value":992},{"label":"Mai","value":740},{"label":"Jun","value":844},{"label":"Jul","value":636},{"label":"Ago","value":971},{"label":"Set","value":766},{"label":"Out","value":808},{"label":"Nov","value":921},{"label":"Dez","value":926}];
const MX = 992;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#f59e0b'}}>UX</span></h1>
                </div>
