...
const PAGE = "AI Code Assist";
const KPIS = [{"l":"Total Low Code","v":"6.583","t":"+9.7%","d":"up"},{"l":"AI Code Assist Ativos","v":"8.311","t":"-4.8%","d":"down"},{"l":"Eficiência (%)","v":"66.9%","t":"+4.3%","d":"up"},{"l":"Score Performance","v":"95","t":"+4.8%","d":"up"}];
const COLS = ["ID","AI Code Assist","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Low Code #001","Low Code #002","8.435","249","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Low Code #002","Low Code #003","4.055","2.327","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Low Code #003","Low Code #004","6.047","6.281","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Low Code #004","Low Code #005","7.653","6.089","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Low Code #005","Low Code #001","6.845","6.128","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":748},{"label":"Fev","value":520},{"label":"Mar","value":540},{"label":"Abr","value":588},{"label":"Mai","value":425},{"label":"Jun","value":538},{"label":"Jul","value":731},{"label":"Ago","value":578},{"label":"Set","value":440},{"label":"Out","value":751},{"label":"Nov","value":727},{"label":"Dez","value":738}];
const MX = 751;
