...
const KPIS = [{"l":"Dashboards Ativos","v":"1.815","t":"+5.0%","d":"up"},{"l":"Queries/Dia","v":"3626","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.344","t":"+6.7%","d":"up"},{"l":"Utilizadores Analytics","v":"5.990","t":"+10.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4257","2026-02-16","5.444","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","463","2026-03-08","8.335","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1015","2026-03-04","4.876","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4689","2026-01-04","8.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1843","2026-01-02","4.752","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":547},{"label":"Mar","value":689},{"label":"Abr","value":863},{"label":"Mai","value":820},{"label":"Jun","value":822},{"label":"Jul","value":775},{"label":"Ago","value":714},{"label":"Set","value":538},{"label":"Out","value":572},{"label":"Nov","value":873},{"label":"Dez","value":597}];
const MX = 873;
