...
const KPIS = [{"l":"Dashboards Ativos","v":"8.684","t":"+1.8%","d":"up"},{"l":"Queries/Dia","v":"1165","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"4.023","t":"+2.5%","d":"up"},{"l":"Utilizadores Analytics","v":"3.816","t":"-5.8%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5019","2026-01-07","7.112","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2463","2026-03-26","5.809","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3166","2026-01-13","6.831","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2258","2026-02-17","1.186","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2450","2026-01-21","6.205","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":277},{"label":"Fev","value":431},{"label":"Mar","value":592},{"label":"Abr","value":271},{"label":"Mai","value":462},{"label":"Jun","value":391},{"label":"Jul","value":534},{"label":"Ago","value":581},{"label":"Set","value":553},{"label":"Out","value":335},{"label":"Nov","value":309},{"label":"Dez","value":582}];
const MX = 592;
