...
const KPIS = [{"l":"eNPS","v":"76","t":"+12.2%","d":"up"},{"l":"Engagement (%)","v":"92.7%","t":"+2.8%","d":"up"},{"l":"Turnover (%)","v":"80.6%","t":"+15.1%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"8.135","t":"+13.7%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","7.983","2026-02-08","65","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","526","2026-02-15","81","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","4.898","2026-03-14","95","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","1.146","2026-01-27","90","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","2.132","2026-01-03","86","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":481},{"label":"Mar","value":645},{"label":"Abr","value":436},{"label":"Mai","value":530},{"label":"Jun","value":439},{"label":"Jul","value":347},{"label":"Ago","value":401},{"label":"Set","value":594},{"label":"Out","value":642},{"label":"Nov","value":452},{"label":"Dez","value":579}];
const MX = 645;
