...
const ACCENT = "#6366f1";
const MODULE = "Audience Analytics";
const PAGE = "Behavior";
const KPIS = [{"l":"Dashboards Ativos","v":"4.833","t":"+5.6%","d":"up"},{"l":"Queries/Dia","v":"3580","t":"+0.5%","d":"up"},{"l":"Dados Processados (GB)","v":"8.613","t":"+15.0%","d":"up"},{"l":"Utilizadores Analytics","v":"2.944","t":"+4.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4320","2026-03-02","4.736","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4758","2026-02-21","5.375","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3766","2026-02-05","5.499","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3926","2026-03-12","2.366","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2085","2026-03-17","3.839","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":952},{"label":"Fev","value":650},{"label":"Mar","value":991},{"label":"Abr","value":756},{"label":"Mai","value":828},{"label":"Jun","value":938},{"label":"Jul","value":769},{"label":"Ago","value":945},{"label":"Set","value":872},{"label":"Out","value":686},{"label":"Nov","value":636},{"label":"Dez","value":985}];
const MX = 991;
