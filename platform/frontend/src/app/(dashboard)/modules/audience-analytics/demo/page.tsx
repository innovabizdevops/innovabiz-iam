...
const KPIS = [{"l":"Dashboards Ativos","v":"400","t":"+7.6%","d":"up"},{"l":"Queries/Dia","v":"717","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"9.032","t":"+16.3%","d":"up"},{"l":"Utilizadores Analytics","v":"2.997","t":"+16.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3219","2026-01-18","6.863","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3603","2026-03-27","1.070","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","916","2026-01-15","1.092","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1629","2026-01-25","7.870","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2142","2026-03-23","6.171","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":489},{"label":"Fev","value":658},{"label":"Mar","value":343},{"label":"Abr","value":490},{"label":"Mai","value":605},{"label":"Jun","value":576},{"label":"Jul","value":612},{"label":"Ago","value":602},{"label":"Set","value":658},{"label":"Out","value":579},{"label":"Nov","value":386},{"label":"Dez","value":404}];
const MX = 658;
