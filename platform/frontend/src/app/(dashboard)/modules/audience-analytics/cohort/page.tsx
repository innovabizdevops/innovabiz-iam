...
const PAGE = "Cohort";
const KPIS = [{"l":"Dashboards Ativos","v":"3.485","t":"-4.3%","d":"down"},{"l":"Queries/Dia","v":"3523","t":"+11.8%","d":"up"},{"l":"Dados Processados (GB)","v":"5.483","t":"+14.3%","d":"up"},{"l":"Utilizadores Analytics","v":"8.092","t":"-3.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3385","2026-02-09","8.712","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1692","2026-01-07","7.939","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3492","2026-03-01","1.465","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2503","2026-01-09","6.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2593","2026-02-25","3.388","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":225},{"label":"Fev","value":481},{"label":"Mar","value":450},{"label":"Abr","value":441},{"label":"Mai","value":251},{"label":"Jun","value":600},{"label":"Jul","value":346},{"label":"Ago","value":272},{"label":"Set","value":369},{"label":"Out","value":425},{"label":"Nov","value":510},{"label":"Dez","value":357}];
const MX = 600;
