...
const KPIS = [{"l":"ARR (€M)","v":"€6.6M","t":"-5.8%","d":"down"},{"l":"MRR (€)","v":"€77795","t":"+5.5%","d":"up"},{"l":"Churn (%)","v":"69.8%","t":"+7.7%","d":"up"},{"l":"ARPU (€)","v":"€14619","t":"-4.8%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 30499.95","3.804","€ 29097.17","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 22586.68","1.314","€ 26445.50","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 32539.61","8.074","€ 4367.81","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 13476.10","4.327","€ 20183.32","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 13978.19","8.476","€ 29376.56","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":445},{"label":"Mar","value":550},{"label":"Abr","value":605},{"label":"Mai","value":769},{"label":"Jun","value":797},{"label":"Jul","value":784},{"label":"Ago","value":509},{"label":"Set","value":735},{"label":"Out","value":751},{"label":"Nov","value":598},{"label":"Dez","value":787}];
const MX = 797;
