...
const PAGE = "Sales-Marketing Alignment";
const KPIS = [{"l":"Vendas YTD (€)","v":"€79603","t":"+6.0%","d":"up"},{"l":"Pipeline (€)","v":"€75465","t":"-3.0%","d":"down"},{"l":"Atingimento Quota (%)","v":"88.9%","t":"-4.6%","d":"down"},{"l":"Win Rate (%)","v":"78.1%","t":"+4.7%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 48436.41","€ 9259.87","€ 24965.54","91.0%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 24190.26","€ 27743.07","€ 9704.69","74.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 23158.14","€ 783.12","€ 41751.56","96.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 41859.73","€ 43919.74","€ 27039.65","98.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 7631.51","€ 24706.15","€ 23460.78","90.6%"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":862},{"label":"Mar","value":846},{"label":"Abr","value":951},{"label":"Mai","value":1075},{"label":"Jun","value":817},{"label":"Jul","value":755},{"label":"Ago","value":940},{"label":"Set","value":772},{"label":"Out","value":1070},{"label":"Nov","value":722},{"label":"Dez","value":861}];
const MX = 1075;
