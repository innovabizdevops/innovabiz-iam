...
const KPIS = [{"l":"Vendas YTD (€)","v":"€17104","t":"-1.8%","d":"down"},{"l":"Pipeline (€)","v":"€98721","t":"-4.1%","d":"down"},{"l":"Atingimento Quota (%)","v":"86.1%","t":"-5.1%","d":"down"},{"l":"Win Rate (%)","v":"73.7%","t":"+5.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 33490.73","€ 2291.83","€ 31708.21","95.1%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 29716.93","€ 50074.45","€ 33369.06","97.4%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 38285.65","€ 10553.53","€ 2938.47","94.6%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 31501.75","€ 32240.86","€ 28910.50","89.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 35164.27","€ 17532.27","€ 626.46","77.1%"],"status":"active"}];
const CHART = [{"label":"Jan","value":374},{"label":"Fev","value":645},{"label":"Mar","value":466},{"label":"Abr","value":389},{"label":"Mai","value":635},{"label":"Jun","value":716},{"label":"Jul","value":501},{"label":"Ago","value":628},{"label":"Set","value":591},{"label":"Out","value":750},{"label":"Nov","value":408},{"label":"Dez","value":452}];
const MX = 750;
