...
const PAGE = "Pipeline-to-Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€3.0M","t":"+4.5%","d":"up"},{"l":"MRR (€)","v":"€22909","t":"+8.5%","d":"up"},{"l":"Churn (%)","v":"68.8%","t":"+12.9%","d":"up"},{"l":"ARPU (€)","v":"€93024","t":"+14.0%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 27120.66","7.739","€ 38878.33","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 7873.19","120","€ 33302.39","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 4207.96","8.584","€ 32977.88","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 30461.15","558","€ 42293.12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 16978.58","725","€ 36768.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":644},{"label":"Mar","value":632},{"label":"Abr","value":671},{"label":"Mai","value":817},{"label":"Jun","value":762},{"label":"Jul","value":536},{"label":"Ago","value":773},{"label":"Set","value":693},{"label":"Out","value":543},{"label":"Nov","value":696},{"label":"Dez","value":639}];
const MX = 817;
