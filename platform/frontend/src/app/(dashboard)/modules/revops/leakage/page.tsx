...
const PAGE = "Revenue Leakage AI";
const KPIS = [{"l":"ARR (€M)","v":"€41.7M","t":"+8.5%","d":"up"},{"l":"MRR (€)","v":"€67331","t":"-3.4%","d":"down"},{"l":"Churn (%)","v":"77.3%","t":"+15.7%","d":"up"},{"l":"ARPU (€)","v":"€91951","t":"-4.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 25990.52","8.886","€ 24075.52","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 27882.97","1.654","€ 34833.05","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 9184.53","8.602","€ 24173.93","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 17414.06","6.156","€ 4599.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 47162.17","5.369","€ 23211.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":441},{"label":"Fev","value":415},{"label":"Mar","value":586},{"label":"Abr","value":432},{"label":"Mai","value":544},{"label":"Jun","value":744},{"label":"Jul","value":644},{"label":"Ago","value":611},{"label":"Set","value":740},{"label":"Out","value":484},{"label":"Nov","value":624},{"label":"Dez","value":687}];
const MX = 744;
