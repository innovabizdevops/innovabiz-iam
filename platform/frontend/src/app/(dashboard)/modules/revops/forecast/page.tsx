...
const ACCENT = "#059669";
const MODULE = "Revenue Operations (RevOps)";
const PAGE = "Forecast Accuracy AI";
const KPIS = [{"l":"Total Revops","v":"995","t":"+8.8%","d":"up"},{"l":"Forecast Accuracy AI Ativos","v":"3.913","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"73","t":"+13.8%","d":"up"}];
const COLS = ["ID","Forecast Accuracy AI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Revops #001","Revops #002","2.973","3.604","2026-03-05","Ativo"],"status":"active"},{"id":"r1","cells":["Revops #002","Revops #003","7.594","5.999","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Revops #003","Revops #004","2.642","7.182","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Revops #004","Revops #005","4.323","6.231","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Revops #005","Revops #001","3.783","9.010","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":521},{"label":"Mar","value":801},{"label":"Abr","value":581},{"label":"Mai","value":653},{"label":"Jun","value":814},{"label":"Jul","value":831},{"label":"Ago","value":727},{"label":"Set","value":760},{"label":"Out","value":627},{"label":"Nov","value":810},{"label":"Dez","value":797}];
const MX = 831;
