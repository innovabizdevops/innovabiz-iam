...
const PAGE = "Activity Metrics";
const KPIS = [{"l":"Total Revops","v":"7.718","t":"+6.4%","d":"up"},{"l":"Activity Metrics Ativos","v":"1.465","t":"+8.4%","d":"up"},{"l":"Eficiência (%)","v":"73.8%","t":"-0.8%","d":"down"},{"l":"Score Performance","v":"70","t":"+9.2%","d":"up"}];
const COLS = ["ID","Activity Metrics","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Revops #001","Revops #002","2.608","6.355","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Revops #002","Revops #003","7.226","4.263","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Revops #003","Revops #004","2.099","7.171","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Revops #004","Revops #005","6.183","6.107","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Revops #005","Revops #001","2.813","1.537","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":574},{"label":"Mar","value":542},{"label":"Abr","value":465},{"label":"Mai","value":328},{"label":"Jun","value":488},{"label":"Jul","value":460},{"label":"Ago","value":317},{"label":"Set","value":581},{"label":"Out","value":517},{"label":"Nov","value":384},{"label":"Dez","value":339}];
const MX = 585;
