...
const KPIS = [{"l":"Formulários Ativos","v":"1.263","t":"+13.1%","d":"up"},{"l":"Submissões/Dia","v":"1856","t":"-4.8%","d":"down"},{"l":"Documentos Gerados","v":"1.546","t":"+8.3%","d":"up"},{"l":"Templates","v":"7.072","t":"-0.3%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.944","2026-03-14","1.835","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.523","2026-02-26","7.722","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.671","2026-01-28","9.070","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.797","2026-03-22","5.302","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.419","2026-01-03","3.370","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":355},{"label":"Fev","value":613},{"label":"Mar","value":474},{"label":"Abr","value":356},{"label":"Mai","value":384},{"label":"Jun","value":661},{"label":"Jul","value":530},{"label":"Ago","value":634},{"label":"Set","value":555},{"label":"Out","value":432},{"label":"Nov","value":488},{"label":"Dez","value":607}];
const MX = 661;
