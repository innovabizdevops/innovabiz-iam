...
const PAGE = "Headless API";
const KPIS = [{"l":"Pedidos/Dia","v":"5046","t":"+0.1%","d":"up"},{"l":"GMV (€)","v":"€30231","t":"+2.4%","d":"up"},{"l":"Conversão (%)","v":"76.3%","t":"-5.8%","d":"down"},{"l":"AOV (€)","v":"€30220","t":"+10.6%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 43783.66","9.090","8.328","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 19464.08","5.197","8.844","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 41514.56","8.746","6.071","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 34059.91","6.934","8.782","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 27614.43","7.542","5.431","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":742},{"label":"Fev","value":528},{"label":"Mar","value":761},{"label":"Abr","value":450},{"label":"Mai","value":737},{"label":"Jun","value":778},{"label":"Jul","value":757},{"label":"Ago","value":526},{"label":"Set","value":624},{"label":"Out","value":765},{"label":"Nov","value":510},{"label":"Dez","value":717}];
const MX = 778;
...
export default function HeadlessApiContentManagementPage() {
    return (
