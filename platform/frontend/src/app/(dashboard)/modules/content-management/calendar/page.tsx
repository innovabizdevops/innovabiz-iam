...
const KPIS = [{"l":"Projetos Melhoria","v":"502","t":"+2.2%","d":"up"},{"l":"Savings (€)","v":"€64691","t":"-0.7%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"86.6%","t":"-0.9%","d":"down"},{"l":"Ciclos PDCA","v":"4.651","t":"+6.0%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.945","€ 7261.07","7.049","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","8.800","€ 36882.76","5.688","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.223","€ 42695.44","8.294","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.309","€ 46125.49","5.026","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","488","€ 40467.51","2.693","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":465},{"label":"Fev","value":844},{"label":"Mar","value":659},{"label":"Abr","value":786},{"label":"Mai","value":751},{"label":"Jun","value":733},{"label":"Jul","value":813},{"label":"Ago","value":847},{"label":"Set","value":831},{"label":"Out","value":821},{"label":"Nov","value":778},{"label":"Dez","value":745}];
const MX = 847;
