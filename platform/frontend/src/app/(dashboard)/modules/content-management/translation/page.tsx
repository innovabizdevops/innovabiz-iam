...
const PAGE = "Translation AI";
const KPIS = [{"l":"Tickets Abertos","v":"8.858","t":"+15.9%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.1%","t":"+17.2%","d":"up"},{"l":"MTTR (h)","v":"87h","t":"-3.8%","d":"down"},{"l":"Satisfação (%)","v":"91.5%","t":"-5.4%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.328","7.487","4.400","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.591","3.512","5.884","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.228","3.551","5.243","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.265","8.274","6.327","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.468","2.283","2.299","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":831},{"label":"Fev","value":860},{"label":"Mar","value":919},{"label":"Abr","value":787},{"label":"Mai","value":1065},{"label":"Jun","value":829},{"label":"Jul","value":888},{"label":"Ago","value":869},{"label":"Set","value":961},{"label":"Out","value":855},{"label":"Nov","value":747},{"label":"Dez","value":1000}];
const MX = 1065;
