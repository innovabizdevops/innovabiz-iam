...
const PAGE = "Blog Manager";
const KPIS = [{"l":"Projetos Melhoria","v":"2.240","t":"+13.4%","d":"up"},{"l":"Savings (€)","v":"€96039","t":"+0.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"77.3%","t":"-3.2%","d":"down"},{"l":"Ciclos PDCA","v":"183","t":"-0.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.393","€ 34668.58","4.835","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.223","€ 23218.69","3.362","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.730","€ 15535.16","1.420","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","123","€ 32808.59","4.668","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","6.538","€ 46181.88","8.725","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":563},{"label":"Fev","value":364},{"label":"Mar","value":527},{"label":"Abr","value":546},{"label":"Mai","value":609},{"label":"Jun","value":420},{"label":"Jul","value":666},{"label":"Ago","value":667},{"label":"Set","value":548},{"label":"Out","value":661},{"label":"Nov","value":556},{"label":"Dez","value":606}];
const MX = 667;
