...
const PAGE = "Wikis &amp; KB";
const KPIS = [{"l":"Projetos Melhoria","v":"6.173","t":"+16.2%","d":"up"},{"l":"Savings (€)","v":"€5141","t":"-3.6%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"71.6%","t":"-4.9%","d":"down"},{"l":"Ciclos PDCA","v":"6.688","t":"+8.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.998","€ 45816.23","1.528","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.783","€ 34427.90","2.611","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.410","€ 30867.12","5.294","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.685","€ 15925.91","7.993","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","367","€ 37420.84","4.041","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":632},{"label":"Fev","value":488},{"label":"Mar","value":281},{"label":"Abr","value":617},{"label":"Mai","value":502},{"label":"Jun","value":580},{"label":"Jul","value":600},{"label":"Ago","value":474},{"label":"Set","value":347},{"label":"Out","value":612},{"label":"Nov","value":335},{"label":"Dez","value":497}];
const MX = 632;
