...
const KPIS = [{"l":"Formulários Ativos","v":"5.007","t":"+5.8%","d":"up"},{"l":"Submissões/Dia","v":"963","t":"+17.8%","d":"up"},{"l":"Documentos Gerados","v":"2.899","t":"+6.3%","d":"up"},{"l":"Templates","v":"6.048","t":"+15.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.429","2026-02-11","4.644","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.357","2026-03-08","5.108","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.971","2026-02-09","1.034","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.047","2026-01-12","3.592","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","8.823","2026-02-23","8.953","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":595},{"label":"Fev","value":675},{"label":"Mar","value":764},{"label":"Abr","value":442},{"label":"Mai","value":751},{"label":"Jun","value":627},{"label":"Jul","value":603},{"label":"Ago","value":629},{"label":"Set","value":757},{"label":"Out","value":418},{"label":"Nov","value":611},{"label":"Dez","value":377}];
const MX = 764;
