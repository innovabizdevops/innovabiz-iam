...
const PAGE = "AI Content Writer";
const KPIS = [{"l":"Projetos Melhoria","v":"7.030","t":"-1.8%","d":"down"},{"l":"Savings (€)","v":"€83172","t":"+2.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.6%","t":"+10.2%","d":"up"},{"l":"Ciclos PDCA","v":"5.359","t":"-3.1%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.599","€ 25856.48","3.245","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.868","€ 36336.66","6.010","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.104","€ 25142.43","982","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.780","€ 33868.78","2.890","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.146","€ 30722.24","209","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":842},{"label":"Fev","value":916},{"label":"Mar","value":694},{"label":"Abr","value":940},{"label":"Mai","value":599},{"label":"Jun","value":835},{"label":"Jul","value":858},{"label":"Ago","value":806},{"label":"Set","value":885},{"label":"Out","value":833},{"label":"Nov","value":569},{"label":"Dez","value":910}];
const MX = 940;
