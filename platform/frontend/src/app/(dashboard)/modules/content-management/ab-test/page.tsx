...
const KPIS = [{"l":"Projetos Melhoria","v":"671","t":"+16.4%","d":"up"},{"l":"Savings (€)","v":"€45221","t":"+11.2%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.8%","t":"+10.5%","d":"up"},{"l":"Ciclos PDCA","v":"2.813","t":"+6.5%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.787","€ 39725.14","6.209","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","805","€ 47174.07","264","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.055","€ 16789.52","6.761","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.859","€ 24366.74","2.414","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.149","€ 33270.87","2.247","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":981},{"label":"Fev","value":918},{"label":"Mar","value":793},{"label":"Abr","value":1048},{"label":"Mai","value":1037},{"label":"Jun","value":738},{"label":"Jul","value":1043},{"label":"Ago","value":873},{"label":"Set","value":827},{"label":"Out","value":942},{"label":"Nov","value":796},{"label":"Dez","value":888}];
const MX = 1048;
