...
const PAGE = "Media Library";
const KPIS = [{"l":"Integrações Ativas","v":"3.241","t":"+10.8%","d":"up"},{"l":"Chamadas/Hora","v":"3303","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"86.3%","t":"+8.6%","d":"up"},{"l":"Latência Média (ms)","v":"194ms","t":"+3.6%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.259","6.209","79.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.362","6.551","86.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.014","7.190","75.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.891","1.185","92.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.442","1.861","87.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":797},{"label":"Fev","value":696},{"label":"Mar","value":890},{"label":"Abr","value":975},{"label":"Mai","value":1029},{"label":"Jun","value":1073},{"label":"Jul","value":978},{"label":"Ago","value":684},{"label":"Set","value":859},{"label":"Out","value":881},{"label":"Nov","value":888},{"label":"Dez","value":1050}];
const MX = 1073;
