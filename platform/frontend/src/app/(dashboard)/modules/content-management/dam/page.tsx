...
const PAGE = "DAM (Digital Assets)";
const KPIS = [{"l":"Ativos Registados","v":"8.619","t":"+11.9%","d":"up"},{"l":"Valor Total (€M)","v":"€40.3M","t":"+7.9%","d":"up"},{"l":"Depreciação Anual (€)","v":"€9273","t":"-5.0%","d":"down"},{"l":"Ativos em Garantia","v":"3.664","t":"-0.4%","d":"down"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 40828.78","3.293","€ 19891.03","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 25048.28","3.556","€ 29776.09","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 43984.67","8.110","€ 11925.21","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 37405.71","4.329","€ 29709.35","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 30697.56","4.984","€ 7817.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":643},{"label":"Fev","value":400},{"label":"Mar","value":679},{"label":"Abr","value":583},{"label":"Mai","value":465},{"label":"Jun","value":651},{"label":"Jul","value":428},{"label":"Ago","value":731},{"label":"Set","value":536},{"label":"Out","value":496},{"label":"Nov","value":681},{"label":"Dez","value":665}];
const MX = 731;
