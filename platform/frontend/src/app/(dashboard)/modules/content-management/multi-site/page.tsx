...
const PAGE = "Multi-Site Manager";
const KPIS = [{"l":"Projetos Melhoria","v":"450","t":"+1.5%","d":"up"},{"l":"Savings (€)","v":"€18924","t":"+0.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"66.1%","t":"-5.4%","d":"down"},{"l":"Ciclos PDCA","v":"3.944","t":"-4.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.582","€ 18311.68","6.300","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.645","€ 11601.52","1.891","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.937","€ 25854.35","592","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.665","€ 1547.17","8.373","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","854","€ 2883.77","6.883","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":530},{"label":"Fev","value":634},{"label":"Mar","value":506},{"label":"Abr","value":544},{"label":"Mai","value":460},{"label":"Jun","value":473},{"label":"Jul","value":669},{"label":"Ago","value":338},{"label":"Set","value":506},{"label":"Out","value":486},{"label":"Nov","value":371},{"label":"Dez","value":439}];
const MX = 669;
