...
const ACCENT = "#8b5cf6";
const MODULE = "Content Management";
const PAGE = "Intranet Portal";
const KPIS = [{"l":"Projetos Melhoria","v":"5.664","t":"-2.0%","d":"down"},{"l":"Savings (€)","v":"€11810","t":"+3.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"84.3%","t":"-3.7%","d":"down"},{"l":"Ciclos PDCA","v":"3.275","t":"+12.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.636","€ 27991.73","4.259","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.388","€ 7232.39","4.204","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.734","€ 10979.08","6.310","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.796","€ 2919.29","6.651","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.341","€ 402.69","7.333","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":682},{"label":"Mar","value":980},{"label":"Abr","value":986},{"label":"Mai","value":646},{"label":"Jun","value":911},{"label":"Jul","value":646},{"label":"Ago","value":871},{"label":"Set","value":656},{"label":"Out","value":687},{"label":"Nov","value":872},{"label":"Dez","value":692}];
const MX = 986;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>New</span></h1>
                </div>
