...
const KPIS = [{"l":"Projetos Melhoria","v":"7.454","t":"+15.9%","d":"up"},{"l":"Savings (€)","v":"€67124","t":"+5.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.1%","t":"+7.5%","d":"up"},{"l":"Ciclos PDCA","v":"5.672","t":"+8.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.254","€ 8504.59","6.405","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.059","€ 35417.28","7.052","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.081","€ 13051.03","3.271","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.379","€ 12336.48","1.964","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","738","€ 17456.53","7.131","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":546},{"label":"Fev","value":533},{"label":"Mar","value":332},{"label":"Abr","value":436},{"label":"Mai","value":506},{"label":"Jun","value":704},{"label":"Jul","value":627},{"label":"Ago","value":706},{"label":"Set","value":335},{"label":"Out","value":403},{"label":"Nov","value":670},{"label":"Dez","value":414}];
const MX = 706;
