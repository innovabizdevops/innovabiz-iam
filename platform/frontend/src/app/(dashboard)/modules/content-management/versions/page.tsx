...
const PAGE = "Versions &amp; Approval";
const KPIS = [{"l":"Formulários Ativos","v":"3.028","t":"+16.6%","d":"up"},{"l":"Submissões/Dia","v":"1530","t":"+7.6%","d":"up"},{"l":"Documentos Gerados","v":"8.375","t":"+15.4%","d":"up"},{"l":"Templates","v":"6.907","t":"-5.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.936","2026-02-15","2.815","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","563","2026-02-28","8.638","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.539","2026-03-21","1.493","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","4.908","2026-01-13","6.822","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.337","2026-03-19","2.183","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":894},{"label":"Fev","value":951},{"label":"Mar","value":955},{"label":"Abr","value":670},{"label":"Mai","value":892},{"label":"Jun","value":971},{"label":"Jul","value":848},{"label":"Ago","value":638},{"label":"Set","value":833},{"label":"Out","value":808},{"label":"Nov","value":620},{"label":"Dez","value":662}];
const MX = 971;
