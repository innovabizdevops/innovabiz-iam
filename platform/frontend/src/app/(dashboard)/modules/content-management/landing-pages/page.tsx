...
const PAGE = "Landing Pages";
const KPIS = [{"l":"Projetos Melhoria","v":"3.824","t":"+10.0%","d":"up"},{"l":"Savings (€)","v":"€45589","t":"+14.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"89.4%","t":"+15.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.823","t":"+0.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.188","€ 21626.13","8.228","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.129","€ 32704.25","5.797","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","4.536","€ 28683.34","6.528","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.301","€ 11023.96","7.894","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.489","€ 3768.84","8.862","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":434},{"label":"Mar","value":685},{"label":"Abr","value":617},{"label":"Mai","value":695},{"label":"Jun","value":797},{"label":"Jul","value":422},{"label":"Ago","value":599},{"label":"Set","value":721},{"label":"Out","value":600},{"label":"Nov","value":757},{"label":"Dez","value":494}];
const MX = 797;
