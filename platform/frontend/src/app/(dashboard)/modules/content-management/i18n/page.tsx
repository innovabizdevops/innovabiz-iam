...
const KPIS = [{"l":"Projetos Melhoria","v":"3.510","t":"+9.5%","d":"up"},{"l":"Savings (€)","v":"€59781","t":"+3.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"73.6%","t":"-3.4%","d":"down"},{"l":"Ciclos PDCA","v":"2.452","t":"+7.6%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.030","€ 28123.76","5.130","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.818","€ 4660.14","7.244","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","8.989","€ 9861.41","5.710","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.078","€ 13963.65","2.212","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.746","€ 47621.80","5.401","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":559},{"label":"Mar","value":571},{"label":"Abr","value":579},{"label":"Mai","value":657},{"label":"Jun","value":355},{"label":"Jul","value":338},{"label":"Ago","value":410},{"label":"Set","value":624},{"label":"Out","value":565},{"label":"Nov","value":627},{"label":"Dez","value":671}];
const MX = 671;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>i18n</span></h1>
                </div>
