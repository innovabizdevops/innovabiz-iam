...
const PAGE = "Collaboration";
const KPIS = [{"l":"Projetos Melhoria","v":"5.905","t":"+10.8%","d":"up"},{"l":"Savings (€)","v":"€92616","t":"+14.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"68.8%","t":"-4.8%","d":"down"},{"l":"Ciclos PDCA","v":"3.747","t":"+16.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.631","€ 47795.11","1.849","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.364","€ 10418.17","5.522","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.321","€ 30458.65","4.710","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.736","€ 32078.95","2.309","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.650","€ 6904.02","1.710","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":394},{"label":"Mar","value":398},{"label":"Abr","value":502},{"label":"Mai","value":660},{"label":"Jun","value":353},{"label":"Jul","value":476},{"label":"Ago","value":534},{"label":"Set","value":477},{"label":"Out","value":362},{"label":"Nov","value":537},{"label":"Dez","value":566}];
const MX = 660;
