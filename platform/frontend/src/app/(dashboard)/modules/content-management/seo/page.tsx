...
const PAGE = "SEO Optimizer AI";
const KPIS = [{"l":"Projetos Melhoria","v":"7.864","t":"+1.2%","d":"up"},{"l":"Savings (€)","v":"€78124","t":"+0.9%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"86.1%","t":"+15.8%","d":"up"},{"l":"Ciclos PDCA","v":"5.029","t":"+12.4%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.308","€ 39639.72","6.312","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.998","€ 18001.05","7.505","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","190","€ 9964.94","489","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","3.513","€ 30612.34","2.462","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.592","€ 11588.69","417","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":466},{"label":"Fev","value":689},{"label":"Mar","value":704},{"label":"Abr","value":709},{"label":"Mai","value":488},{"label":"Jun","value":670},{"label":"Jul","value":697},{"label":"Ago","value":761},{"label":"Set","value":534},{"label":"Out","value":421},{"label":"Nov","value":759},{"label":"Dez","value":677}];
const MX = 761;
