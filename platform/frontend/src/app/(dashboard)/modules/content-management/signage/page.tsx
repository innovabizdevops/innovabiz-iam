...
const PAGE = "Digital Signage";
const KPIS = [{"l":"Projetos Melhoria","v":"3.221","t":"+1.8%","d":"up"},{"l":"Savings (€)","v":"€26574","t":"+17.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"88.0%","t":"+14.4%","d":"up"},{"l":"Ciclos PDCA","v":"8.077","t":"+9.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.190","€ 39358.37","5.895","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.055","€ 3263.12","310","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","1.484","€ 40912.71","2.902","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","7.238","€ 10718.12","4.693","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.056","€ 48329.79","2.704","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":766},{"label":"Fev","value":919},{"label":"Mar","value":623},{"label":"Abr","value":870},{"label":"Mai","value":944},{"label":"Jun","value":871},{"label":"Jul","value":597},{"label":"Ago","value":974},{"label":"Set","value":969},{"label":"Out","value":729},{"label":"Nov","value":633},{"label":"Dez","value":788}];
const MX = 974;
