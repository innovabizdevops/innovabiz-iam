...
const KPIS = [{"l":"Projetos Melhoria","v":"1.495","t":"+2.9%","d":"up"},{"l":"Savings (€)","v":"€33757","t":"+2.4%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"91.2%","t":"+15.7%","d":"up"},{"l":"Ciclos PDCA","v":"3.213","t":"+8.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","7.342","€ 49794.57","1.024","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","808","€ 37642.74","690","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.903","€ 22846.62","1.646","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.888","€ 18507.45","2.253","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","277","€ 34410.14","5.397","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":462},{"label":"Fev","value":523},{"label":"Mar","value":512},{"label":"Abr","value":468},{"label":"Mai","value":634},{"label":"Jun","value":334},{"label":"Jul","value":348},{"label":"Ago","value":667},{"label":"Set","value":562},{"label":"Out","value":362},{"label":"Nov","value":396},{"label":"Dez","value":670}];
const MX = 670;
