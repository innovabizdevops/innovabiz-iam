...
const KPIS = [{"l":"Projetos Melhoria","v":"7.402","t":"+0.1%","d":"up"},{"l":"Savings (€)","v":"€86910","t":"+4.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.6%","t":"+10.8%","d":"up"},{"l":"Ciclos PDCA","v":"4.199","t":"+3.8%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.277","€ 27918.23","5.030","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.812","€ 35065.58","9.084","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","9.085","€ 28411.55","1.135","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.282","€ 21527.09","5.065","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.397","€ 4708.34","3.742","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":607},{"label":"Fev","value":491},{"label":"Mar","value":709},{"label":"Abr","value":641},{"label":"Mai","value":472},{"label":"Jun","value":428},{"label":"Jul","value":719},{"label":"Ago","value":479},{"label":"Set","value":654},{"label":"Out","value":696},{"label":"Nov","value":689},{"label":"Dez","value":668}];
const MX = 719;
...
export default function CalendarContentManagementPage() {
    return (
