...
const KPIS = [{"l":"Integrações Ativas","v":"793","t":"+12.2%","d":"up"},{"l":"Chamadas/Hora","v":"1943","t":"+13.7%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.6%","t":"+2.8%","d":"up"},{"l":"Latência Média (ms)","v":"92ms","t":"+1.3%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.852","7.513","92.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.830","5.231","75.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.311","1.101","85.7%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","1.192","8.010","85.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.820","1.867","93.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":943},{"label":"Fev","value":778},{"label":"Mar","value":860},{"label":"Abr","value":939},{"label":"Mai","value":854},{"label":"Jun","value":1033},{"label":"Jul","value":992},{"label":"Ago","value":1006},{"label":"Set","value":698},{"label":"Out","value":787},{"label":"Nov","value":701},{"label":"Dez","value":673}];
const MX = 1033;
