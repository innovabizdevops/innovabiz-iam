...
const PAGE = "Brand Portal";
const KPIS = [{"l":"Projetos Melhoria","v":"4.280","t":"+15.3%","d":"up"},{"l":"Savings (€)","v":"€38887","t":"+12.1%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"87.1%","t":"+9.0%","d":"up"},{"l":"Ciclos PDCA","v":"1.829","t":"-4.7%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","3.324","€ 7533.89","5.822","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","1.561","€ 45780.66","159","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.001","€ 28455.15","3.360","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.816","€ 11197.74","7.365","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.330","€ 18384.62","3.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":667},{"label":"Fev","value":447},{"label":"Mar","value":747},{"label":"Abr","value":541},{"label":"Mai","value":568},{"label":"Jun","value":496},{"label":"Jul","value":764},{"label":"Ago","value":673},{"label":"Set","value":697},{"label":"Out","value":692},{"label":"Nov","value":456},{"label":"Dez","value":417}];
const MX = 764;
