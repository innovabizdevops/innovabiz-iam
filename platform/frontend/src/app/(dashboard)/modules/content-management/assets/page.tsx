...
const KPIS = [{"l":"Ativos Registados","v":"8.431","t":"+1.2%","d":"up"},{"l":"Valor Total (€M)","v":"€33.7M","t":"+11.7%","d":"up"},{"l":"Depreciação Anual (€)","v":"€14124","t":"+1.4%","d":"up"},{"l":"Ativos em Garantia","v":"644","t":"+0.5%","d":"up"}];
const COLS = ["Ativo","Tipo","Valor (€)","Localização","Depreciação (€/ano)","Estado"];
const ROWS = [{"id":"r0","cells":["SRV-PROD-001","LAPTOP-DEV-042","€ 23158.42","1.407","€ 10086.08","Ativo"],"status":"active"},{"id":"r1","cells":["LAPTOP-DEV-042","SWITCH-CORE-013","€ 4617.72","3.200","€ 39092.19","Pendente"],"status":"pending"},{"id":"r2","cells":["SWITCH-CORE-013","IMPRESSORA-HQ-007","€ 40002.72","6.055","€ 12955.49","Concluído"],"status":"done"},{"id":"r3","cells":["IMPRESSORA-HQ-007","VEÍCULO-FLEET-028","€ 44624.99","3.906","€ 41563.34","Em Análise"],"status":"risk"},{"id":"r4","cells":["VEÍCULO-FLEET-028","SRV-PROD-001","€ 15896.80","403","€ 1053.07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":745},{"label":"Fev","value":694},{"label":"Mar","value":777},{"label":"Abr","value":741},{"label":"Mai","value":569},{"label":"Jun","value":412},{"label":"Jul","value":488},{"label":"Ago","value":649},{"label":"Set","value":681},{"label":"Out","value":631},{"label":"Nov","value":550},{"label":"Dez","value":567}];
const MX = 777;
