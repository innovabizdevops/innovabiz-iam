...
const PAGE = "BNPL";
const KPIS = [{"l":"Integrações Ativas","v":"7.914","t":"+10.0%","d":"up"},{"l":"Chamadas/Hora","v":"367","t":"+9.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"70.6%","t":"+13.4%","d":"up"},{"l":"Latência Média (ms)","v":"168ms","t":"+4.1%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.829","698","76.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","8.919","184","80.1%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.335","6.570","91.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.408","7.446","71.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","6.302","2.197","79.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":858},{"label":"Mar","value":730},{"label":"Abr","value":1054},{"label":"Mai","value":805},{"label":"Jun","value":717},{"label":"Jul","value":861},{"label":"Ago","value":804},{"label":"Set","value":858},{"label":"Out","value":1076},{"label":"Nov","value":1060},{"label":"Dez","value":846}];
const MX = 1076;
