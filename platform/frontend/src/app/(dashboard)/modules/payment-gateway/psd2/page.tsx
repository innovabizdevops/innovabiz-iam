...
const ACCENT = "#8b5cf6";
const MODULE = "Payment Gateway";
const PAGE = "PSD2 Open Banking";
const KPIS = [{"l":"Integrações Ativas","v":"5.256","t":"+0.4%","d":"up"},{"l":"Chamadas/Hora","v":"4185","t":"+14.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"80.3%","t":"+1.6%","d":"up"},{"l":"Latência Média (ms)","v":"95ms","t":"-0.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.784","3.140","90.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.722","8.353","71.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.497","1.687","77.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","9.061","3.741","88.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.373","6.625","83.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":734},{"label":"Fev","value":671},{"label":"Mar","value":860},{"label":"Abr","value":648},{"label":"Mai","value":672},{"label":"Jun","value":836},{"label":"Jul","value":892},{"label":"Ago","value":636},{"label":"Set","value":647},{"label":"Out","value":548},{"label":"Nov","value":734},{"label":"Dez","value":736}];
const MX = 892;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>PSD2</span></h1>
                </div>
