...
const PAGE = "3DS2 Auth";
const KPIS = [{"l":"Utilizadores Ativos","v":"8.959","t":"+0.0%","d":"up"},{"l":"Sessões/Dia","v":"1589","t":"+7.9%","d":"up"},{"l":"MFA Adoção (%)","v":"88.6%","t":"+8.1%","d":"up"},{"l":"Tentativas Bloqueadas","v":"8.345","t":"+4.3%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","980","8.830","974","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","1.686","8.292","2.594","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","6.334","3.810","1.239","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","4.667","4.058","179","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","5.102","7.313","4.620","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":556},{"label":"Fev","value":556},{"label":"Mar","value":768},{"label":"Abr","value":807},{"label":"Mai","value":533},{"label":"Jun","value":752},{"label":"Jul","value":802},{"label":"Ago","value":627},{"label":"Set","value":516},{"label":"Out","value":738},{"label":"Nov","value":527},{"label":"Dez","value":668}];
const MX = 807;
...
export default function 3ds2Page() {
    return (
