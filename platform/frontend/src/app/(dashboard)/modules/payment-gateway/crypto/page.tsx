...
const PAGE = "Crypto Payments";
const KPIS = [{"l":"Integrações Ativas","v":"1.533","t":"+13.9%","d":"up"},{"l":"Chamadas/Hora","v":"533","t":"+6.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"77.3%","t":"-5.7%","d":"down"},{"l":"Latência Média (ms)","v":"157ms","t":"+10.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.539","5.325","87.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.512","2.083","93.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","173","4.301","80.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.304","2.316","81.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.042","6.836","70.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":637},{"label":"Mar","value":414},{"label":"Abr","value":651},{"label":"Mai","value":552},{"label":"Jun","value":629},{"label":"Jul","value":672},{"label":"Ago","value":454},{"label":"Set","value":550},{"label":"Out","value":488},{"label":"Nov","value":599},{"label":"Dez","value":638}];
const MX = 672;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>Web3</span></h1>
                </div>
