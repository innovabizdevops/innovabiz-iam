...
const PAGE = "SWIFT ISO 20022";
const KPIS = [{"l":"Auditorias Realizadas","v":"5.550","t":"+1.1%","d":"up"},{"l":"NC Abertas","v":"6.817","t":"+13.8%","d":"up"},{"l":"Conformidade (%)","v":"84.1%","t":"+3.8%","d":"up"},{"l":"CAPAs Pendentes","v":"5.348","t":"-0.3%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.626","94.9%","932","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.832","78.6%","2.926","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.390","94.7%","4.814","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","7.694","87.0%","7.104","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","179","91.5%","8.819","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":493},{"label":"Fev","value":593},{"label":"Mar","value":333},{"label":"Abr","value":292},{"label":"Mai","value":487},{"label":"Jun","value":513},{"label":"Jul","value":565},{"label":"Ago","value":358},{"label":"Set","value":262},{"label":"Out","value":610},{"label":"Nov","value":542},{"label":"Dez","value":362}];
const MX = 610;
...
export default function SwiftIsoPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#8b5cf6'}}>ISO</span></h1>
                </div>
