...
/* ═══ Platform Certification — Dashboard ═══ */

const ACCENT = "#312e81";

const KPIS = [
    { label: "Total Registos", value: "425", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "493", trend: "-20%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€290K", trend: "+14%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "86%", trend: "+8%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1677050425", cells: ["PLA-9425", "Platform Certification Item 1", "2/2/2026", "€525"], status: "active" as const },
    { id: "1677053996", cells: ["PLA-3996", "Platform Certification Item 2", "17/9/2026", "€4096"], status: "pending" as const },
    { id: "1677057567", cells: ["PLA-7567", "Platform Certification Item 3", "4/4/2026", "€7667"], status: "completed" as const },
    { id: "1677061138", cells: ["PLA-2138", "Platform Certification Item 4", "19/11/2026", "€11 238"], status: "warning" as const },
    { id: "1677064709", cells: ["PLA-5709", "Platform Certification Item 5", "6/6/2026", "€14 809"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Platform Certification</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Platform Certification</p>
                    </div>
                </div>
