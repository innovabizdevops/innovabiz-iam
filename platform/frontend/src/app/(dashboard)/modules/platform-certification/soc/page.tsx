...
const ACCENT = "#312e81";
const MODULE = "Platform Certification";
const PAGE = "SOC";
const KPIS = [{"l":"Formulários Ativos","v":"3.834","t":"+16.8%","d":"up"},{"l":"Submissões/Dia","v":"4472","t":"+15.8%","d":"up"},{"l":"Documentos Gerados","v":"5.688","t":"+0.7%","d":"up"},{"l":"Templates","v":"7.172","t":"-5.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.529","2026-03-16","2.501","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.937","2026-01-20","5.854","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","835","2026-02-10","8.128","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.400","2026-03-12","4.645","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.151","2026-03-25","8.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":739},{"label":"Mar","value":478},{"label":"Abr","value":683},{"label":"Mai","value":539},{"label":"Jun","value":537},{"label":"Jul","value":716},{"label":"Ago","value":585},{"label":"Set","value":830},{"label":"Out","value":599},{"label":"Nov","value":780},{"label":"Dez","value":740}];
const MX = 830;
