...
const PAGE = "GDPR";
const KPIS = [{"l":"Formulários Ativos","v":"1.492","t":"+17.9%","d":"up"},{"l":"Submissões/Dia","v":"3667","t":"+17.7%","d":"up"},{"l":"Documentos Gerados","v":"6.450","t":"+7.2%","d":"up"},{"l":"Templates","v":"4.183","t":"+7.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.009","2026-03-19","3.710","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","315","2026-03-15","3.706","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.948","2026-03-24","3.773","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.828","2026-02-22","1.322","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.273","2026-01-06","2.118","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":642},{"label":"Mar","value":669},{"label":"Abr","value":435},{"label":"Mai","value":689},{"label":"Jun","value":338},{"label":"Jul","value":340},{"label":"Ago","value":682},{"label":"Set","value":566},{"label":"Out","value":609},{"label":"Nov","value":502},{"label":"Dez","value":655}];
const MX = 689;
