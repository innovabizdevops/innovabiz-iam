...
const PAGE = "PCI";
const KPIS = [{"l":"Formulários Ativos","v":"1.877","t":"+7.6%","d":"up"},{"l":"Submissões/Dia","v":"3745","t":"+8.7%","d":"up"},{"l":"Documentos Gerados","v":"1.611","t":"+16.6%","d":"up"},{"l":"Templates","v":"8.561","t":"+3.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.621","2026-02-01","5.384","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.949","2026-03-18","7.352","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.092","2026-03-28","6.151","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.023","2026-03-03","5.642","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.443","2026-01-12","2.566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":336},{"label":"Fev","value":612},{"label":"Mar","value":441},{"label":"Abr","value":414},{"label":"Mai","value":556},{"label":"Jun","value":458},{"label":"Jul","value":401},{"label":"Ago","value":376},{"label":"Set","value":636},{"label":"Out","value":499},{"label":"Nov","value":420},{"label":"Dez","value":598}];
const MX = 636;
