...
const PAGE = "ISO";
const KPIS = [{"l":"Auditorias Realizadas","v":"545","t":"+11.9%","d":"up"},{"l":"NC Abertas","v":"6.089","t":"-4.5%","d":"down"},{"l":"Conformidade (%)","v":"78.3%","t":"+10.1%","d":"up"},{"l":"CAPAs Pendentes","v":"1.629","t":"-2.6%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.554","89.8%","5.164","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.709","97.9%","8.759","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.674","76.6%","7.715","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.933","91.7%","1.760","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.804","90.8%","4.857","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":867},{"label":"Fev","value":744},{"label":"Mar","value":662},{"label":"Abr","value":696},{"label":"Mai","value":816},{"label":"Jun","value":665},{"label":"Jul","value":516},{"label":"Ago","value":889},{"label":"Set","value":781},{"label":"Out","value":858},{"label":"Nov","value":782},{"label":"Dez","value":578}];
const MX = 889;
