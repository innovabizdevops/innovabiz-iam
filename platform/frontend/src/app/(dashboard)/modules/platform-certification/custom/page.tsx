...
const PAGE = "Custom";
const KPIS = [{"l":"Formulários Ativos","v":"6.069","t":"+17.6%","d":"up"},{"l":"Submissões/Dia","v":"3041","t":"+6.4%","d":"up"},{"l":"Documentos Gerados","v":"671","t":"-5.9%","d":"down"},{"l":"Templates","v":"2.852","t":"+11.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","415","2026-03-28","1.758","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.789","2026-03-12","1.495","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.945","2026-02-12","5.528","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.027","2026-02-16","8.646","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.757","2026-01-23","8.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1012},{"label":"Fev","value":758},{"label":"Mar","value":865},{"label":"Abr","value":740},{"label":"Mai","value":739},{"label":"Jun","value":722},{"label":"Jul","value":964},{"label":"Ago","value":668},{"label":"Set","value":977},{"label":"Out","value":752},{"label":"Nov","value":771},{"label":"Dez","value":806}];
const MX = 1012;
