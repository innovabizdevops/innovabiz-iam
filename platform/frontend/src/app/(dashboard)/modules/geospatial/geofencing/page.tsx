...
const ACCENT = "#1e3a5f";
const MODULE = "Geospatial & GIS";
const PAGE = "Geofencing";
const KPIS = [{"l":"Quartos Ocupados","v":"6.796","t":"+14.1%","d":"up"},{"l":"RevPAR (€)","v":"€25794","t":"+5.0%","d":"up"},{"l":"Ocupação (%)","v":"84.9%","t":"+1.1%","d":"up"},{"l":"Guest Satisfaction","v":"8.691","t":"+11.2%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","6.031","2026-01-18","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.445","2026-01-18","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","536","2026-02-14","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.343","2026-01-18","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.906","2026-03-12","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":711},{"label":"Fev","value":604},{"label":"Mar","value":544},{"label":"Abr","value":566},{"label":"Mai","value":666},{"label":"Jun","value":581},{"label":"Jul","value":516},{"label":"Ago","value":757},{"label":"Set","value":523},{"label":"Out","value":732},{"label":"Nov","value":534},{"label":"Dez","value":408}];
const MX = 757;
