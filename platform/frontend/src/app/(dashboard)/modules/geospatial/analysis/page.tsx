...
const PAGE = "Spatial Analysis";
const KPIS = [{"l":"Dashboards Ativos","v":"2.294","t":"+2.3%","d":"up"},{"l":"Queries/Dia","v":"787","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"6.733","t":"-5.9%","d":"down"},{"l":"Utilizadores Analytics","v":"7.232","t":"+7.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4349","2026-01-14","1.015","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3012","2026-02-07","5.799","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4515","2026-02-03","3.950","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1059","2026-02-24","6.516","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3609","2026-01-25","720","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":691},{"label":"Fev","value":833},{"label":"Mar","value":907},{"label":"Abr","value":839},{"label":"Mai","value":718},{"label":"Jun","value":618},{"label":"Jul","value":941},{"label":"Ago","value":639},{"label":"Set","value":848},{"label":"Out","value":697},{"label":"Nov","value":652},{"label":"Dez","value":852}];
const MX = 941;
