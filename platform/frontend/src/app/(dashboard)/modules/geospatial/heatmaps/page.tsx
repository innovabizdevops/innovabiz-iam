...
const PAGE = "Heatmaps";
const KPIS = [{"l":"Quartos Ocupados","v":"4.885","t":"+1.2%","d":"up"},{"l":"RevPAR (€)","v":"€30965","t":"+0.0%","d":"up"},{"l":"Ocupação (%)","v":"90.8%","t":"+17.2%","d":"up"},{"l":"Guest Satisfaction","v":"2.552","t":"+11.7%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","576","2026-01-01","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.414","2026-03-12","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","6.484","2026-02-25","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","8.635","2026-02-25","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.036","2026-02-08","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":835},{"label":"Mar","value":845},{"label":"Abr","value":497},{"label":"Mai","value":709},{"label":"Jun","value":716},{"label":"Jul","value":497},{"label":"Ago","value":848},{"label":"Set","value":764},{"label":"Out","value":793},{"label":"Nov","value":837},{"label":"Dez","value":702}];
const MX = 848;
