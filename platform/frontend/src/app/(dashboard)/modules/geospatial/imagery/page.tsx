...
const PAGE = "Satellite Imagery";
const KPIS = [{"l":"Quartos Ocupados","v":"124","t":"+1.3%","d":"up"},{"l":"RevPAR (€)","v":"€9726","t":"+6.0%","d":"up"},{"l":"Ocupação (%)","v":"80.3%","t":"+3.3%","d":"up"},{"l":"Guest Satisfaction","v":"3.036","t":"+17.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","732","2026-02-27","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.773","2026-02-09","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.714","2026-03-18","2026-02-19","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.184","2026-01-06","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.358","2026-01-16","2026-01-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":773},{"label":"Fev","value":515},{"label":"Mar","value":596},{"label":"Abr","value":802},{"label":"Mai","value":434},{"label":"Jun","value":790},{"label":"Jul","value":790},{"label":"Ago","value":633},{"label":"Set","value":700},{"label":"Out","value":536},{"label":"Nov","value":521},{"label":"Dez","value":444}];
const MX = 802;
