...
const PAGE = "LiDAR Processing";
const KPIS = [{"l":"Quartos Ocupados","v":"3.103","t":"+6.8%","d":"up"},{"l":"RevPAR (€)","v":"€5458","t":"+16.1%","d":"up"},{"l":"Ocupação (%)","v":"87.7%","t":"+14.4%","d":"up"},{"l":"Guest Satisfaction","v":"2.186","t":"-1.1%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.824","2026-03-08","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","7.699","2026-02-22","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.386","2026-01-12","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","3.567","2026-03-27","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.597","2026-01-13","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":779},{"label":"Fev","value":787},{"label":"Mar","value":673},{"label":"Abr","value":866},{"label":"Mai","value":769},{"label":"Jun","value":834},{"label":"Jul","value":1016},{"label":"Ago","value":808},{"label":"Set","value":708},{"label":"Out","value":951},{"label":"Nov","value":803},{"label":"Dez","value":789}];
const MX = 1016;
