...
const PAGE = "Map Viewer";
const KPIS = [{"l":"Quartos Ocupados","v":"3.091","t":"+12.0%","d":"up"},{"l":"RevPAR (€)","v":"€33050","t":"+6.6%","d":"up"},{"l":"Ocupação (%)","v":"80.3%","t":"+5.0%","d":"up"},{"l":"Guest Satisfaction","v":"2.347","t":"+10.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.971","2026-02-22","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.555","2026-02-13","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.762","2026-03-05","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.199","2026-03-17","2026-03-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","8.087","2026-01-14","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":561},{"label":"Fev","value":605},{"label":"Mar","value":796},{"label":"Abr","value":805},{"label":"Mai","value":524},{"label":"Jun","value":501},{"label":"Jul","value":535},{"label":"Ago","value":596},{"label":"Set","value":687},{"label":"Out","value":738},{"label":"Nov","value":649},{"label":"Dez","value":650}];
const MX = 805;
