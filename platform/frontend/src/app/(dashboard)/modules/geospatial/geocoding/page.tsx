...
const PAGE = "Geocoding";
const KPIS = [{"l":"Quartos Ocupados","v":"921","t":"+9.2%","d":"up"},{"l":"RevPAR (€)","v":"€79893","t":"+13.3%","d":"up"},{"l":"Ocupação (%)","v":"72.1%","t":"+3.7%","d":"up"},{"l":"Guest Satisfaction","v":"6.386","t":"+12.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","7.958","2026-02-11","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","5.711","2026-01-17","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.849","2026-02-02","2026-02-11","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","2.333","2026-03-18","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.796","2026-02-28","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":657},{"label":"Fev","value":536},{"label":"Mar","value":735},{"label":"Abr","value":610},{"label":"Mai","value":823},{"label":"Jun","value":673},{"label":"Jul","value":446},{"label":"Ago","value":734},{"label":"Set","value":752},{"label":"Out","value":527},{"label":"Nov","value":623},{"label":"Dez","value":497}];
const MX = 823;
