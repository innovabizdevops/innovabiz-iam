...
const PAGE = "Indoor Mapping";
const KPIS = [{"l":"Quartos Ocupados","v":"1.058","t":"+2.1%","d":"up"},{"l":"RevPAR (€)","v":"€64712","t":"-1.8%","d":"down"},{"l":"Ocupação (%)","v":"68.8%","t":"+11.7%","d":"up"},{"l":"Guest Satisfaction","v":"4.024","t":"+13.1%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.021","2026-02-13","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.216","2026-02-26","2026-03-07","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","7.667","2026-02-11","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","6.877","2026-01-12","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.051","2026-01-08","2026-02-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":508},{"label":"Fev","value":578},{"label":"Mar","value":758},{"label":"Abr","value":787},{"label":"Mai","value":681},{"label":"Jun","value":646},{"label":"Jul","value":559},{"label":"Ago","value":464},{"label":"Set","value":637},{"label":"Out","value":552},{"label":"Nov","value":535},{"label":"Dez","value":617}];
const MX = 787;
