...
const PAGE = "Decide";
const KPIS = [{"l":"Aprovações Pendentes","v":"2.914","t":"-4.4%","d":"down"},{"l":"SLA Cumprido (%)","v":"82.6%","t":"+0.7%","d":"up"},{"l":"Tempo Médio (h)","v":"143h","t":"+10.8%","d":"up"},{"l":"Rejeitadas (%)","v":"67.9%","t":"+16.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","1.719","€ 17278.06","2.123","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","5.205","€ 19272.19","5.642","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","462","€ 26230.89","5.012","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","2.088","€ 14695.79","6.466","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.900","€ 38625.06","2.125","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":242},{"label":"Mar","value":371},{"label":"Abr","value":465},{"label":"Mai","value":580},{"label":"Jun","value":282},{"label":"Jul","value":312},{"label":"Ago","value":369},{"label":"Set","value":222},{"label":"Out","value":380},{"label":"Nov","value":447},{"label":"Dez","value":404}];
const MX = 580;
