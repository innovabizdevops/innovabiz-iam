...
/* ═══ RTM Real-Time Decisioning — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "1371", trend: "+22%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4202", trend: "+16%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€303K", trend: "-10%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+4%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "625948571", cells: ["RTM-8571", "RTM Real-Time Decisioning Item 1", "4/12/2026", "€48 671"], status: "active" as const },
    { id: "625952142", cells: ["RTM-3142", "RTM Real-Time Decisioning Item 2", "19/7/2026", "€2242"], status: "pending" as const },
    { id: "625955713", cells: ["RTM-6713", "RTM Real-Time Decisioning Item 3", "6/2/2026", "€5813"], status: "completed" as const },
    { id: "625959284", cells: ["RTM-1284", "RTM Real-Time Decisioning Item 4", "21/9/2026", "€9384"], status: "warning" as const },
    { id: "625962855", cells: ["RTM-4855", "RTM Real-Time Decisioning Item 5", "8/4/2026", "€12 955"], status: "active" as const },
];
...
export default function RtmRealtimeDecisioningPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">RTM Real-Time Decisioning</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • RTM Real-Time Decisioning</p>
                    </div>
                </div>
