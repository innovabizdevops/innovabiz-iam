...
const PAGE = "Context";
const KPIS = [{"l":"Aprovações Pendentes","v":"4.388","t":"+8.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"94.7%","t":"-1.8%","d":"down"},{"l":"Tempo Médio (h)","v":"206h","t":"-4.3%","d":"down"},{"l":"Rejeitadas (%)","v":"76.2%","t":"+14.7%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","3.412","€ 49963.66","293","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","4.080","€ 7051.61","972","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","362","€ 586.71","8.691","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","1.419","€ 2763.96","8.708","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","647","€ 24707.32","5.273","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":534},{"label":"Fev","value":532},{"label":"Mar","value":739},{"label":"Abr","value":872},{"label":"Mai","value":652},{"label":"Jun","value":730},{"label":"Jul","value":799},{"label":"Ago","value":817},{"label":"Set","value":735},{"label":"Out","value":779},{"label":"Nov","value":554},{"label":"Dez","value":636}];
const MX = 872;
