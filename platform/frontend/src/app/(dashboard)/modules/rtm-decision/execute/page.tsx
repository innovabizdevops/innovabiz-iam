...
const PAGE = "Execute";
const KPIS = [{"l":"Aprovações Pendentes","v":"7.628","t":"+5.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"85.6%","t":"+4.5%","d":"up"},{"l":"Tempo Médio (h)","v":"164h","t":"+4.4%","d":"up"},{"l":"Rejeitadas (%)","v":"70.2%","t":"-1.7%","d":"down"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.935","€ 40320.84","6.081","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","8.941","€ 31672.63","5.953","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","6.068","€ 38672.54","2.181","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","7.575","€ 23662.35","8.118","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.883","€ 12728.32","6.444","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":741},{"label":"Fev","value":716},{"label":"Mar","value":576},{"label":"Abr","value":821},{"label":"Mai","value":634},{"label":"Jun","value":563},{"label":"Jul","value":598},{"label":"Ago","value":855},{"label":"Set","value":611},{"label":"Out","value":736},{"label":"Nov","value":944},{"label":"Dez","value":559}];
const MX = 944;
