...
const ACCENT = "#dc2626";
const MODULE = "RTM Real-Time Decisioning";
const PAGE = "Score";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.448","t":"+11.8%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.0%","t":"+12.7%","d":"up"},{"l":"Tempo Médio (h)","v":"92h","t":"-1.0%","d":"down"},{"l":"Rejeitadas (%)","v":"87.3%","t":"+11.3%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","789","€ 31713.21","8.675","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","7.769","€ 17296.83","5.712","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","7.493","€ 290.39","2.160","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","8.504","€ 1396.42","1.838","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","6.322","€ 45770.70","8.861","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":345},{"label":"Fev","value":372},{"label":"Mar","value":455},{"label":"Abr","value":649},{"label":"Mai","value":502},{"label":"Jun","value":332},{"label":"Jul","value":675},{"label":"Ago","value":648},{"label":"Set","value":362},{"label":"Out","value":580},{"label":"Nov","value":656},{"label":"Dez","value":401}];
const MX = 675;
