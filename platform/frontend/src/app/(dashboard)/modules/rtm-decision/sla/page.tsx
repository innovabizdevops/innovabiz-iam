...
const PAGE = "<2ms SLA";
const KPIS = [{"l":"Tickets Abertos","v":"5.397","t":"+5.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"92.9%","t":"+12.4%","d":"up"},{"l":"MTTR (h)","v":"146h","t":"+0.4%","d":"up"},{"l":"Satisfação (%)","v":"66.1%","t":"+3.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","3.215","5.229","2.704","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.016","881","7.613","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.139","5.609","1.550","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","594","2.988","8.201","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.394","8.506","4.700","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":533},{"label":"Fev","value":662},{"label":"Mar","value":683},{"label":"Abr","value":790},{"label":"Mai","value":616},{"label":"Jun","value":635},{"label":"Jul","value":645},{"label":"Ago","value":693},{"label":"Set","value":569},{"label":"Out","value":778},{"label":"Nov","value":529},{"label":"Dez","value":744}];
const MX = 790;
