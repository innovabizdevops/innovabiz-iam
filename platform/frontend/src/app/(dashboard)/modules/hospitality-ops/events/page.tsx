...
const PAGE = "Event &amp; Banquet";
const KPIS = [{"l":"Total Hospitality Ops","v":"1.883","t":"+5.0%","d":"up"},{"l":"Event & Banquet Ativos","v":"2.663","t":"+14.1%","d":"up"},{"l":"Eficiência (%)","v":"79.9%","t":"+2.4%","d":"up"},{"l":"Score Performance","v":"83","t":"+7.1%","d":"up"}];
const COLS = ["ID","Event & Banquet","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospitality Ops #001","Hospitality Ops #002","7.014","4.817","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Hospitality Ops #002","Hospitality Ops #003","2.476","8.425","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospitality Ops #003","Hospitality Ops #004","7.505","4.438","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Hospitality Ops #004","Hospitality Ops #005","5.732","1.863","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospitality Ops #005","Hospitality Ops #001","2.250","2.518","2026-02-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":752},{"label":"Fev","value":646},{"label":"Mar","value":644},{"label":"Abr","value":817},{"label":"Mai","value":443},{"label":"Jun","value":592},{"label":"Jul","value":585},{"label":"Ago","value":523},{"label":"Set","value":646},{"label":"Out","value":522},{"label":"Nov","value":457},{"label":"Dez","value":778}];
const MX = 817;
