...
const PAGE = "Room Management";
const KPIS = [{"l":"Projetos Melhoria","v":"3.845","t":"+2.9%","d":"up"},{"l":"Savings (€)","v":"€83460","t":"+16.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.0%","t":"+16.7%","d":"up"},{"l":"Ciclos PDCA","v":"1.075","t":"+6.1%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.202","€ 28474.31","4.294","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","191","€ 32381.33","8.733","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","438","€ 15229.83","4.812","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","2.903","€ 28785.77","1.460","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","4.622","€ 43225.07","3.332","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":702},{"label":"Fev","value":651},{"label":"Mar","value":856},{"label":"Abr","value":650},{"label":"Mai","value":928},{"label":"Jun","value":677},{"label":"Jul","value":991},{"label":"Ago","value":795},{"label":"Set","value":766},{"label":"Out","value":793},{"label":"Nov","value":713},{"label":"Dez","value":876}];
const MX = 991;
