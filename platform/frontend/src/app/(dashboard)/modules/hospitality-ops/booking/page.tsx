...
const PAGE = "Booking Engine";
const KPIS = [{"l":"Quartos Ocupados","v":"5.437","t":"+4.3%","d":"up"},{"l":"RevPAR (€)","v":"€34602","t":"+13.4%","d":"up"},{"l":"Ocupação (%)","v":"81.9%","t":"+8.1%","d":"up"},{"l":"Guest Satisfaction","v":"8.989","t":"+12.3%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","4.847","2026-03-22","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.562","2026-02-07","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","591","2026-03-05","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.856","2026-03-27","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","4.745","2026-01-28","2026-03-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":871},{"label":"Fev","value":961},{"label":"Mar","value":796},{"label":"Abr","value":954},{"label":"Mai","value":843},{"label":"Jun","value":674},{"label":"Jul","value":883},{"label":"Ago","value":611},{"label":"Set","value":757},{"label":"Out","value":639},{"label":"Nov","value":677},{"label":"Dez","value":614}];
const MX = 961;
