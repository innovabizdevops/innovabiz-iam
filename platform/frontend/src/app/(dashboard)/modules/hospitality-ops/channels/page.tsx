...
const PAGE = "Channel Manager";
const KPIS = [{"l":"Total Hospitality Ops","v":"4.356","t":"+12.1%","d":"up"},{"l":"Channel Manager Ativos","v":"2.758","t":"+15.6%","d":"up"},{"l":"Eficiência (%)","v":"84.8%","t":"-5.4%","d":"down"},{"l":"Score Performance","v":"70","t":"+3.6%","d":"up"}];
const COLS = ["ID","Channel Manager","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Hospitality Ops #001","Hospitality Ops #002","4.143","4.382","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Hospitality Ops #002","Hospitality Ops #003","2.380","5.326","2026-03-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Hospitality Ops #003","Hospitality Ops #004","8.002","996","2026-02-27","Concluído"],"status":"done"},{"id":"r3","cells":["Hospitality Ops #004","Hospitality Ops #005","5.112","5.421","2026-03-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hospitality Ops #005","Hospitality Ops #001","2.862","1.915","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":966},{"label":"Fev","value":726},{"label":"Mar","value":762},{"label":"Abr","value":986},{"label":"Mai","value":994},{"label":"Jun","value":951},{"label":"Jul","value":747},{"label":"Ago","value":911},{"label":"Set","value":913},{"label":"Out","value":841},{"label":"Nov","value":854},{"label":"Dez","value":934}];
const MX = 994;
