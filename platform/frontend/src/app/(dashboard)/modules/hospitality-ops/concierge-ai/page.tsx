...
const ACCENT = "#7c3aed";
const MODULE = "Hospitality Operations";
const PAGE = "Concierge AI";
const KPIS = [{"l":"Quartos Ocupados","v":"389","t":"+5.0%","d":"up"},{"l":"RevPAR (€)","v":"€87260","t":"+8.2%","d":"up"},{"l":"Ocupação (%)","v":"79.9%","t":"+7.6%","d":"up"},{"l":"Guest Satisfaction","v":"553","t":"-1.6%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.553","2026-01-12","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.842","2026-03-26","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.490","2026-03-03","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.294","2026-03-06","2026-01-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","1.727","2026-03-26","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":570},{"label":"Fev","value":595},{"label":"Mar","value":583},{"label":"Abr","value":643},{"label":"Mai","value":654},{"label":"Jun","value":325},{"label":"Jul","value":602},{"label":"Ago","value":492},{"label":"Set","value":544},{"label":"Out","value":589},{"label":"Nov","value":620},{"label":"Dez","value":427}];
const MX = 654;
