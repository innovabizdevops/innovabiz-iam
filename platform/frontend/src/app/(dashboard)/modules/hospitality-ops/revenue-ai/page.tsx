...
const PAGE = "Revenue Mgmt AI";
const KPIS = [{"l":"ARR (€M)","v":"€38.8M","t":"+15.4%","d":"up"},{"l":"MRR (€)","v":"€8733","t":"-3.4%","d":"down"},{"l":"Churn (%)","v":"92.1%","t":"-2.0%","d":"down"},{"l":"ARPU (€)","v":"€10576","t":"+9.6%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 11000.80","6.793","€ 15264.02","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 21705.81","4.241","€ 41337.30","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 38852.85","7.740","€ 9752.53","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 46200.40","5.804","€ 16543.92","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 6039.82","1.370","€ 46242.79","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":714},{"label":"Fev","value":687},{"label":"Mar","value":457},{"label":"Abr","value":534},{"label":"Mai","value":529},{"label":"Jun","value":631},{"label":"Jul","value":785},{"label":"Ago","value":743},{"label":"Set","value":521},{"label":"Out","value":717},{"label":"Nov","value":418},{"label":"Dez","value":554}];
const MX = 785;
