...
const PAGE = "Guest Satisfaction NPS";
const KPIS = [{"l":"Perfis Unificados","v":"6.173","t":"+16.9%","d":"up"},{"l":"Segmentos Ativos","v":"9.037","t":"+13.3%","d":"up"},{"l":"NPS Score","v":"81","t":"-0.5%","d":"down"},{"l":"Churn Previsto (%)","v":"65.1%","t":"+5.0%","d":"up"}];
const COLS = ["Perfil","Segmento","Interações","LTV (€)","Score","Estado"];
const ROWS = [{"id":"r0","cells":["PROF-C-89210","PROF-C-45210","2.941","€ 34745.58","86.1%","Ativo"],"status":"active"},{"id":"r1","cells":["PROF-C-45210","PROF-C-32140","1.779","€ 21856.87","80.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["PROF-C-32140","PROF-C-76520","2.852","€ 4392.77","89.2%","Concluído"],"status":"done"},{"id":"r3","cells":["PROF-C-76520","PROF-C-10980","3.070","€ 17482.80","91.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["PROF-C-10980","PROF-C-89210","3.426","€ 37318.10","88.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":369},{"label":"Mar","value":465},{"label":"Abr","value":374},{"label":"Mai","value":368},{"label":"Jun","value":397},{"label":"Jul","value":313},{"label":"Ago","value":228},{"label":"Set","value":608},{"label":"Out","value":485},{"label":"Nov","value":554},{"label":"Dez","value":403}];
const MX = 608;
