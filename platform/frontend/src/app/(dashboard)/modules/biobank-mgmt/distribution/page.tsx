...
const KPIS = [{"l":"Total Biobank Mgmt","v":"7.912","t":"+11.8%","d":"up"},{"l":"Distribution Ativos","v":"2.828","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"65.1%","t":"+3.0%","d":"up"},{"l":"Score Performance","v":"55","t":"-0.1%","d":"down"}];
const COLS = ["ID","Distribution","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biobank Mgmt #001","Biobank Mgmt #002","6.028","1.559","2026-01-22","Ativo"],"status":"active"},{"id":"r1","cells":["Biobank Mgmt #002","Biobank Mgmt #003","8.043","7.791","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Biobank Mgmt #003","Biobank Mgmt #004","701","5.684","2026-01-26","Concluído"],"status":"done"},{"id":"r3","cells":["Biobank Mgmt #004","Biobank Mgmt #005","1.794","3.739","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biobank Mgmt #005","Biobank Mgmt #001","903","4.504","2026-01-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":692},{"label":"Mar","value":928},{"label":"Abr","value":952},{"label":"Mai","value":827},{"label":"Jun","value":694},{"label":"Jul","value":771},{"label":"Ago","value":881},{"label":"Set","value":1022},{"label":"Out","value":1003},{"label":"Nov","value":908},{"label":"Dez","value":947}];
const MX = 1028;
