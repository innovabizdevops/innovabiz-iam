...
const KPIS = [{"l":"Total Biobank Mgmt","v":"4.585","t":"-2.8%","d":"down"},{"l":"Storage Map Ativos","v":"6.371","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"72.2%","t":"+8.4%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.1%","d":"down"}];
const COLS = ["ID","Storage Map","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biobank Mgmt #001","Biobank Mgmt #002","5.918","6.132","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Biobank Mgmt #002","Biobank Mgmt #003","5.569","6.242","2026-01-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Biobank Mgmt #003","Biobank Mgmt #004","8.521","3.908","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["Biobank Mgmt #004","Biobank Mgmt #005","8.840","554","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biobank Mgmt #005","Biobank Mgmt #001","7.251","8.633","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":775},{"label":"Fev","value":770},{"label":"Mar","value":859},{"label":"Abr","value":959},{"label":"Mai","value":780},{"label":"Jun","value":709},{"label":"Jul","value":831},{"label":"Ago","value":756},{"label":"Set","value":963},{"label":"Out","value":1014},{"label":"Nov","value":899},{"label":"Dez","value":1027}];
const MX = 1027;
