...
const PAGE = "QC Monitor";
const KPIS = [{"l":"Total Biobank Mgmt","v":"2.162","t":"-3.1%","d":"down"},{"l":"QC Monitor Ativos","v":"5.640","t":"+17.4%","d":"up"},{"l":"Eficiência (%)","v":"74.2%","t":"+10.9%","d":"up"},{"l":"Score Performance","v":"85","t":"+5.9%","d":"up"}];
const COLS = ["ID","QC Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Biobank Mgmt #001","Biobank Mgmt #002","6.512","1.127","2026-03-20","Ativo"],"status":"active"},{"id":"r1","cells":["Biobank Mgmt #002","Biobank Mgmt #003","112","2.837","2026-01-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Biobank Mgmt #003","Biobank Mgmt #004","5.656","6.632","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Biobank Mgmt #004","Biobank Mgmt #005","2.579","3.117","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Biobank Mgmt #005","Biobank Mgmt #001","3.166","4.680","2026-01-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":822},{"label":"Fev","value":760},{"label":"Mar","value":583},{"label":"Abr","value":952},{"label":"Mai","value":686},{"label":"Jun","value":723},{"label":"Jul","value":695},{"label":"Ago","value":797},{"label":"Set","value":912},{"label":"Out","value":951},{"label":"Nov","value":767},{"label":"Dez","value":575}];
const MX = 952;
