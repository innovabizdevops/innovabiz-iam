...
const ACCENT = "#dc2626";
const MODULE = "Biobank Management";
const PAGE = "Sample Catalog";
const KPIS = [{"l":"Dashboards Ativos","v":"5.900","t":"+6.3%","d":"up"},{"l":"Queries/Dia","v":"2593","t":"+9.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.812","t":"+8.9%","d":"up"},{"l":"Utilizadores Analytics","v":"7.082","t":"+15.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5014","2026-02-09","6.508","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1565","2026-03-13","4.396","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3235","2026-02-03","8.277","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3109","2026-03-07","8.370","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2284","2026-01-06","6.814","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":882},{"label":"Fev","value":837},{"label":"Mar","value":694},{"label":"Abr","value":649},{"label":"Mai","value":818},{"label":"Jun","value":723},{"label":"Jul","value":900},{"label":"Ago","value":764},{"label":"Set","value":755},{"label":"Out","value":739},{"label":"Nov","value":678},{"label":"Dez","value":800}];
const MX = 900;
