...
const ACCENT = "#475569";
const MODULE = "Space Station Ops";
const PAGE = "Life Support";
const KPIS = [{"l":"Tickets Abertos","v":"533","t":"+4.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"89.5%","t":"-0.7%","d":"down"},{"l":"MTTR (h)","v":"147h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"85.7%","t":"+14.1%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.404","4.824","6.061","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.577","6.161","3.213","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.842","3.849","1.067","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","5.430","1.166","4.144","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.823","5.528","6.342","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":603},{"label":"Mar","value":880},{"label":"Abr","value":781},{"label":"Mai","value":745},{"label":"Jun","value":503},{"label":"Jul","value":574},{"label":"Ago","value":681},{"label":"Set","value":636},{"label":"Out","value":577},{"label":"Nov","value":876},{"label":"Dez","value":764}];
const MX = 880;
