...
const PAGE = "EVA Plan";
const KPIS = [{"l":"Quartos Ocupados","v":"723","t":"+9.1%","d":"up"},{"l":"RevPAR (€)","v":"€92890","t":"-4.9%","d":"down"},{"l":"Ocupação (%)","v":"82.4%","t":"+14.2%","d":"up"},{"l":"Guest Satisfaction","v":"5.456","t":"+1.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.984","2026-03-05","2026-02-27","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","4.277","2026-01-11","2026-02-02","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","662","2026-03-24","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.377","2026-02-25","2026-03-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","3.158","2026-02-02","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":403},{"label":"Mar","value":590},{"label":"Abr","value":645},{"label":"Mai","value":487},{"label":"Jun","value":461},{"label":"Jul","value":384},{"label":"Ago","value":438},{"label":"Set","value":709},{"label":"Out","value":682},{"label":"Nov","value":690},{"label":"Dez","value":611}];
const MX = 709;
