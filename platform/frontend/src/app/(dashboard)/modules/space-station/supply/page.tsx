...
const PAGE = "Supply Mgmt";
const KPIS = [{"l":"Quartos Ocupados","v":"1.633","t":"+1.0%","d":"up"},{"l":"RevPAR (€)","v":"€89046","t":"-5.1%","d":"down"},{"l":"Ocupação (%)","v":"65.1%","t":"-0.9%","d":"down"},{"l":"Guest Satisfaction","v":"7.589","t":"-2.7%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","1.605","2026-03-27","2026-03-12","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","8.477","2026-02-28","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.660","2026-03-11","2026-03-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.056","2026-01-15","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","2.747","2026-03-03","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":610},{"label":"Fev","value":858},{"label":"Mar","value":541},{"label":"Abr","value":536},{"label":"Mai","value":579},{"label":"Jun","value":512},{"label":"Jul","value":662},{"label":"Ago","value":840},{"label":"Set","value":848},{"label":"Out","value":842},{"label":"Nov","value":530},{"label":"Dez","value":895}];
const MX = 895;
