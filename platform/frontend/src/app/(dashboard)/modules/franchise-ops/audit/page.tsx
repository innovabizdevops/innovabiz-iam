...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.898","t":"+15.5%","d":"up"},{"l":"NC Abertas","v":"7.101","t":"+10.0%","d":"up"},{"l":"Conformidade (%)","v":"77.5%","t":"+11.2%","d":"up"},{"l":"CAPAs Pendentes","v":"5.322","t":"+3.7%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","3.890","85.3%","8.594","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","616","83.1%","927","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.684","73.6%","5.258","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.945","98.0%","6.238","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.515","70.7%","3.755","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":687},{"label":"Mar","value":613},{"label":"Abr","value":701},{"label":"Mai","value":765},{"label":"Jun","value":507},{"label":"Jul","value":509},{"label":"Ago","value":558},{"label":"Set","value":560},{"label":"Out","value":732},{"label":"Nov","value":528},{"label":"Dez","value":814}];
const MX = 814;
