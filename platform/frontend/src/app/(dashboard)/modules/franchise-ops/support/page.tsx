...
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"7.250","t":"+17.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"66.3%","t":"+3.8%","d":"up"},{"l":"MTTR (h)","v":"188h","t":"+2.4%","d":"up"},{"l":"Satisfação (%)","v":"81.5%","t":"+4.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.461","4.213","2.348","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.080","445","8.411","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.034","6.220","838","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","2.310","7.980","6.811","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.384","4.486","2.780","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":346},{"label":"Mar","value":238},{"label":"Abr","value":434},{"label":"Mai","value":435},{"label":"Jun","value":456},{"label":"Jul","value":259},{"label":"Ago","value":403},{"label":"Set","value":519},{"label":"Out","value":244},{"label":"Nov","value":542},{"label":"Dez","value":390}];
const MX = 542;
