...
const KPIS = [
    { label: "Total Registos", value: "991", trend: "-17%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3604", trend: "+11%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€67K", trend: "+5%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1881050391", cells: ["FRA-6391", "Franchise Operations Item 1", "4/4/2026", "€491"], status: "active" as const },
    { id: "1881053962", cells: ["FRA-9962", "Franchise Operations Item 2", "19/11/2026", "€4062"], status: "pending" as const },
    { id: "1881057533", cells: ["FRA-4533", "Franchise Operations Item 3", "6/6/2026", "€7633"], status: "completed" as const },
    { id: "1881061104", cells: ["FRA-8104", "Franchise Operations Item 4", "21/1/2026", "€11 204"], status: "warning" as const },
    { id: "1881064675", cells: ["FRA-2675", "Franchise Operations Item 5", "8/8/2026", "€14 775"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Franchise Operations</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Franchise Operations</p>
                    </div>
                </div>
