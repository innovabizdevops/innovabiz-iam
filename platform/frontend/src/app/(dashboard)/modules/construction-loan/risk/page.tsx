...
const ACCENT = "#6366f1";
const MODULE = "Construction Lending";
const PAGE = "Risk";
const KPIS = [{"l":"Riscos Identificados","v":"572","t":"+14.4%","d":"up"},{"l":"Mitigações Ativas","v":"8.708","t":"+6.2%","d":"up"},{"l":"Score Risco Geral","v":"61","t":"+12.6%","d":"up"},{"l":"Incidentes YTD","v":"2.301","t":"+6.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.225","1.585","7.001","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","1.105","3.923","7.273","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","9.059","3.134","5.382","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.709","1.838","7.728","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","8.121","7.434","7.661","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":767},{"label":"Fev","value":857},{"label":"Mar","value":698},{"label":"Abr","value":958},{"label":"Mai","value":794},{"label":"Jun","value":639},{"label":"Jul","value":713},{"label":"Ago","value":811},{"label":"Set","value":596},{"label":"Out","value":781},{"label":"Nov","value":979},{"label":"Dez","value":620}];
const MX = 979;
