...
const PAGE = "Inspect";
const KPIS = [{"l":"Total Atomic Energy","v":"7.236","t":"-5.9%","d":"down"},{"l":"Inspect Ativos","v":"4.661","t":"+9.5%","d":"up"},{"l":"Eficiência (%)","v":"89.3%","t":"+6.5%","d":"up"},{"l":"Score Performance","v":"70","t":"+15.4%","d":"up"}];
const COLS = ["ID","Inspect","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atomic Energy #001","Atomic Energy #002","561","6.756","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Atomic Energy #002","Atomic Energy #003","8.622","7.828","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Atomic Energy #003","Atomic Energy #004","6.882","6.350","2026-01-21","Concluído"],"status":"done"},{"id":"r3","cells":["Atomic Energy #004","Atomic Energy #005","8.899","2.834","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atomic Energy #005","Atomic Energy #001","1.205","8.078","2026-03-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":812},{"label":"Fev","value":500},{"label":"Mar","value":790},{"label":"Abr","value":673},{"label":"Mai","value":719},{"label":"Jun","value":682},{"label":"Jul","value":597},{"label":"Ago","value":741},{"label":"Set","value":619},{"label":"Out","value":558},{"label":"Nov","value":488},{"label":"Dez","value":494}];
const MX = 812;
