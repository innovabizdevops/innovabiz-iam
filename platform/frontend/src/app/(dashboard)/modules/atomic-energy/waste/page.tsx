...
const ACCENT = "#f59e0b";
const MODULE = "Atomic Energy Authority";
const PAGE = "Waste";
const KPIS = [{"l":"Total Atomic Energy","v":"2.551","t":"-0.9%","d":"down"},{"l":"Waste Ativos","v":"5.361","t":"-2.2%","d":"down"},{"l":"Eficiência (%)","v":"70.9%","t":"+17.9%","d":"up"},{"l":"Score Performance","v":"77","t":"+3.6%","d":"up"}];
const COLS = ["ID","Waste","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atomic Energy #001","Atomic Energy #002","8.650","5.066","2026-02-26","Ativo"],"status":"active"},{"id":"r1","cells":["Atomic Energy #002","Atomic Energy #003","3.445","7.676","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Atomic Energy #003","Atomic Energy #004","5.633","5.920","2026-03-12","Concluído"],"status":"done"},{"id":"r3","cells":["Atomic Energy #004","Atomic Energy #005","8.295","645","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atomic Energy #005","Atomic Energy #001","1.002","4.591","2026-03-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1016},{"label":"Fev","value":799},{"label":"Mar","value":712},{"label":"Abr","value":771},{"label":"Mai","value":1008},{"label":"Jun","value":976},{"label":"Jul","value":920},{"label":"Ago","value":912},{"label":"Set","value":970},{"label":"Out","value":806},{"label":"Nov","value":690},{"label":"Dez","value":974}];
const MX = 1016;
