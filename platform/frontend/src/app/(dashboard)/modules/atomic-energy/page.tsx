...
/* ═══ Atomic Energy Authority — Dashboard ═══ */

const ACCENT = "#f59e0b";

const KPIS = [
    { label: "Total Registos", value: "561", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4007", trend: "+6%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€125K", trend: "-25%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1156350161", cells: ["ATO-4161", "Atomic Energy Authority Item 1", "2/6/2026", "€261"], status: "active" as const },
    { id: "1156353732", cells: ["ATO-7732", "Atomic Energy Authority Item 2", "17/1/2026", "€3832"], status: "pending" as const },
    { id: "1156357303", cells: ["ATO-2303", "Atomic Energy Authority Item 3", "4/8/2026", "€7403"], status: "completed" as const },
    { id: "1156360874", cells: ["ATO-5874", "Atomic Energy Authority Item 4", "19/3/2026", "€10 974"], status: "warning" as const },
    { id: "1156364445", cells: ["ATO-9445", "Atomic Energy Authority Item 5", "6/10/2026", "€14 545"], status: "active" as const },
];
...
export default function AtomicEnergyAuthorityPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Atomic Energy Authority</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Atomic Energy Authority</p>
                    </div>
                </div>
