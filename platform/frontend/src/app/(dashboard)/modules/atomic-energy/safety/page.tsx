...
const PAGE = "Safety";
const KPIS = [{"l":"Total Atomic Energy","v":"5.669","t":"+10.8%","d":"up"},{"l":"Safety Ativos","v":"961","t":"+13.8%","d":"up"},{"l":"Eficiência (%)","v":"81.5%","t":"+15.1%","d":"up"},{"l":"Score Performance","v":"92","t":"+0.5%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atomic Energy #001","Atomic Energy #002","1.568","1.348","2026-02-06","Ativo"],"status":"active"},{"id":"r1","cells":["Atomic Energy #002","Atomic Energy #003","6.560","969","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Atomic Energy #003","Atomic Energy #004","8.203","3.840","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Atomic Energy #004","Atomic Energy #005","7.383","2.814","2026-02-10","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atomic Energy #005","Atomic Energy #001","8.894","6.155","2026-03-23","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":579},{"label":"Fev","value":546},{"label":"Mar","value":460},{"label":"Abr","value":658},{"label":"Mai","value":633},{"label":"Jun","value":659},{"label":"Jul","value":484},{"label":"Ago","value":535},{"label":"Set","value":363},{"label":"Out","value":548},{"label":"Nov","value":349},{"label":"Dez","value":321}];
const MX = 659;
