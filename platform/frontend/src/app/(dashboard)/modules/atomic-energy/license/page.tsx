...
const PAGE = "License";
const KPIS = [{"l":"Total Atomic Energy","v":"2.271","t":"-5.5%","d":"down"},{"l":"License Ativos","v":"6.643","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"92.5%","t":"+11.1%","d":"up"},{"l":"Score Performance","v":"65","t":"+9.6%","d":"up"}];
const COLS = ["ID","License","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Atomic Energy #001","Atomic Energy #002","7.113","1.137","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["Atomic Energy #002","Atomic Energy #003","7.868","532","2026-02-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Atomic Energy #003","Atomic Energy #004","4.316","8.477","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Atomic Energy #004","Atomic Energy #005","845","3.369","2026-03-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Atomic Energy #005","Atomic Energy #001","4.661","6.413","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":518},{"label":"Mar","value":597},{"label":"Abr","value":602},{"label":"Mai","value":725},{"label":"Jun","value":603},{"label":"Jul","value":554},{"label":"Ago","value":674},{"label":"Set","value":586},{"label":"Out","value":700},{"label":"Nov","value":826},{"label":"Dez","value":698}];
const MX = 826;
