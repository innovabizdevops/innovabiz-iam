...
const PAGE = "Research";
const KPIS = [{"l":"Ideias Submetidas","v":"6.987","t":"-3.3%","d":"down"},{"l":"Patentes (YTD)","v":"5.415","t":"+0.2%","d":"up"},{"l":"Projetos Innovation Lab","v":"978","t":"+6.7%","d":"up"},{"l":"Budget I&D (€M)","v":"€44.3M","t":"+10.9%","d":"up"}];
const COLS = ["Ideia","Autor","Categoria","Score","Fase","Estado"];
const ROWS = [{"id":"r0","cells":["AI Auto-Classify","Green Packaging","2.620","98.8%","2.566","Ativo"],"status":"active"},{"id":"r1","cells":["Green Packaging","Smart Checkout","651","98.7%","8.791","Pendente"],"status":"pending"},{"id":"r2","cells":["Smart Checkout","Voice Commerce","8.679","98.6%","647","Concluído"],"status":"done"},{"id":"r3","cells":["Voice Commerce","Digital Thread","4.080","82.6%","3.849","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Thread","AI Auto-Classify","1.156","97.5%","9.098","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":342},{"label":"Fev","value":518},{"label":"Mar","value":270},{"label":"Abr","value":306},{"label":"Mai","value":576},{"label":"Jun","value":221},{"label":"Jul","value":540},{"label":"Ago","value":288},{"label":"Set","value":568},{"label":"Out","value":438},{"label":"Nov","value":360},{"label":"Dez","value":220}];
const MX = 576;
