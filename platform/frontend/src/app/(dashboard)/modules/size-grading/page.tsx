...
export default function SizeGradingPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Size Grading</h1><p className="text-sm text-muted-foreground">Size Grading • iBOS Enterprise</p></div>
