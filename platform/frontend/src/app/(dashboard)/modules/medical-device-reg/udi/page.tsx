...
const PAGE = "UDI";
const KPIS = [{"l":"Dispositivos Online","v":"5.411","t":"+12.9%","d":"up"},{"l":"Dados/Min (MB)","v":"3.907","t":"+2.2%","d":"up"},{"l":"Alertas Ativos","v":"5.823","t":"+9.9%","d":"up"},{"l":"Uptime (%)","v":"75.6%","t":"+2.5%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","236","7.043","7.756","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.103","8.518","3.819","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.281","8.755","5.467","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.849","6.282","7.094","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.460","5.484","2.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":665},{"label":"Fev","value":572},{"label":"Mar","value":696},{"label":"Abr","value":771},{"label":"Mai","value":741},{"label":"Jun","value":680},{"label":"Jul","value":747},{"label":"Ago","value":841},{"label":"Set","value":814},{"label":"Out","value":824},{"label":"Nov","value":923},{"label":"Dez","value":828}];
const MX = 923;
