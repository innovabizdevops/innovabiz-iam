...
const PAGE = "Post Market";
const KPIS = [{"l":"Pedidos/Dia","v":"2409","t":"-0.5%","d":"down"},{"l":"GMV (€)","v":"€85911","t":"+14.7%","d":"up"},{"l":"Conversão (%)","v":"89.1%","t":"+5.9%","d":"up"},{"l":"AOV (€)","v":"€87855","t":"-5.8%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 6033.64","2.126","7.009","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 27836.40","6.355","2.095","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 33533.66","4.487","564","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 7274.49","2.200","650","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 17134.21","8.675","4.217","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":739},{"label":"Mar","value":726},{"label":"Abr","value":686},{"label":"Mai","value":386},{"label":"Jun","value":601},{"label":"Jul","value":584},{"label":"Ago","value":625},{"label":"Set","value":551},{"label":"Out","value":565},{"label":"Nov","value":377},{"label":"Dez","value":714}];
const MX = 739;
