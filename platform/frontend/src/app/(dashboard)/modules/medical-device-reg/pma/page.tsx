...
const PAGE = "PMA";
const KPIS = [{"l":"Dispositivos Online","v":"2.136","t":"+10.1%","d":"up"},{"l":"Dados/Min (MB)","v":"508","t":"-1.7%","d":"down"},{"l":"Alertas Ativos","v":"3.396","t":"+0.2%","d":"up"},{"l":"Uptime (%)","v":"82.1%","t":"-1.6%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","2.328","7.652","6.346","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","7.803","2.874","3.227","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","9.069","1.733","1.894","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","8.067","2.664","4.773","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.723","8.521","7.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":951},{"label":"Fev","value":715},{"label":"Mar","value":572},{"label":"Abr","value":945},{"label":"Mai","value":652},{"label":"Jun","value":805},{"label":"Jul","value":754},{"label":"Ago","value":922},{"label":"Set","value":934},{"label":"Out","value":756},{"label":"Nov","value":720},{"label":"Dez","value":725}];
const MX = 951;
