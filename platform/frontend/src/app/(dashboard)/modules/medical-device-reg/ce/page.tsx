...
const PAGE = "CE Mark";
const KPIS = [{"l":"Dispositivos Online","v":"1.364","t":"+15.0%","d":"up"},{"l":"Dados/Min (MB)","v":"5.772","t":"+9.1%","d":"up"},{"l":"Alertas Ativos","v":"8.848","t":"+6.3%","d":"up"},{"l":"Uptime (%)","v":"84.1%","t":"+2.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","6.630","1.648","338","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.434","453","4.818","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","8.006","6.202","8.890","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","1.551","3.657","5.139","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","3.204","874","6.815","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":636},{"label":"Mar","value":616},{"label":"Abr","value":696},{"label":"Mai","value":698},{"label":"Jun","value":651},{"label":"Jul","value":881},{"label":"Ago","value":766},{"label":"Set","value":761},{"label":"Out","value":890},{"label":"Nov","value":748},{"label":"Dez","value":948}];
const MX = 948;
