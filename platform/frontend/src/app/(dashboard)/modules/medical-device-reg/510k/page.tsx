...
const ACCENT = "#6d28d9";
const MODULE = "Medical Device Regulatory";
const PAGE = "510k";
const KPIS = [{"l":"Dispositivos Online","v":"2.391","t":"+5.3%","d":"up"},{"l":"Dados/Min (MB)","v":"3.079","t":"+3.1%","d":"up"},{"l":"Alertas Ativos","v":"8.007","t":"+4.7%","d":"up"},{"l":"Uptime (%)","v":"88.8%","t":"+5.3%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.699","6.776","3.978","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","3.859","4.594","6.427","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","5.031","3.492","1.227","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","406","6.853","5.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","4.118","8.531","7.466","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":878},{"label":"Mar","value":1001},{"label":"Abr","value":745},{"label":"Mai","value":851},{"label":"Jun","value":777},{"label":"Jul","value":642},{"label":"Ago","value":655},{"label":"Set","value":692},{"label":"Out","value":695},{"label":"Nov","value":753},{"label":"Dez","value":803}];
const MX = 1001;
...
export default function 510kPage() {
    return (
