...
/* ═══ Medical Device Regulatory — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "1144", trend: "-20%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "1011", trend: "+14%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€199K", trend: "+8%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "-2%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1542668544", cells: ["MED-6544", "Medical Device Regulatory Item 1", "5/1/2026", "€18 644"], status: "active" as const },
    { id: "1542672115", cells: ["MED-1115", "Medical Device Regulatory Item 2", "20/8/2026", "€22 215"], status: "pending" as const },
    { id: "1542675686", cells: ["MED-4686", "Medical Device Regulatory Item 3", "7/3/2026", "€25 786"], status: "completed" as const },
    { id: "1542679257", cells: ["MED-8257", "Medical Device Regulatory Item 4", "22/10/2026", "€29 357"], status: "warning" as const },
    { id: "1542682828", cells: ["MED-2828", "Medical Device Regulatory Item 5", "9/5/2026", "€32 928"], status: "active" as const },
];
...
export default function MedicalDeviceRegulatoryPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Medical Device Regulatory</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Medical Device Regulatory</p>
                    </div>
                </div>
