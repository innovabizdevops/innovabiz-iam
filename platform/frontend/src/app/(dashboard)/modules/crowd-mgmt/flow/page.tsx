...
const PAGE = "Flow";
const KPIS = [{"l":"Total Crowd Mgmt","v":"4.925","t":"+10.2%","d":"up"},{"l":"Flow Ativos","v":"4.115","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"91.6%","t":"+7.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+8.7%","d":"up"}];
const COLS = ["ID","Flow","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowd Mgmt #001","Crowd Mgmt #002","8.560","8.954","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Crowd Mgmt #002","Crowd Mgmt #003","3.573","717","2026-02-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowd Mgmt #003","Crowd Mgmt #004","5.019","2.561","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Crowd Mgmt #004","Crowd Mgmt #005","7.622","8.369","2026-03-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowd Mgmt #005","Crowd Mgmt #001","5.733","6.477","2026-01-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":739},{"label":"Fev","value":743},{"label":"Mar","value":791},{"label":"Abr","value":502},{"label":"Mai","value":718},{"label":"Jun","value":697},{"label":"Jul","value":649},{"label":"Ago","value":581},{"label":"Set","value":548},{"label":"Out","value":759},{"label":"Nov","value":792},{"label":"Dez","value":879}];
const MX = 879;
