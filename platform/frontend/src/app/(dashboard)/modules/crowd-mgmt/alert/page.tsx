...
const ACCENT = "#475569";
const MODULE = "Crowd Management";
const PAGE = "Alert";
const KPIS = [{"l":"Notificações Enviadas","v":"6.605","t":"+15.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"88.5%","t":"+8.9%","d":"up"},{"l":"Taxa Abertura (%)","v":"66.2%","t":"+8.9%","d":"up"},{"l":"Escalações","v":"7.670","t":"-5.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","6.163","87.9%","2026-03-16","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.138","83.8%","2026-02-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.341","82.5%","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","978","74.2%","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","827","72.1%","2026-02-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":681},{"label":"Fev","value":513},{"label":"Mar","value":783},{"label":"Abr","value":711},{"label":"Mai","value":702},{"label":"Jun","value":453},{"label":"Jul","value":690},{"label":"Ago","value":436},{"label":"Set","value":752},{"label":"Out","value":623},{"label":"Nov","value":595},{"label":"Dez","value":586}];
const MX = 783;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#475569'}}>RTM</span></h1>
                </div>
