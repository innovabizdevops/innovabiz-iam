...
const KPIS = [
    { label: "Total Registos", value: "7400", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2365", trend: "-20%", trendDirection: "down" as const, icon: Users },
...
const TABLE_ROWS = [
    { id: "695611000", cells: ["CRO-2000", "Crowd Management Item 1", "1/5/2026", "€11 100"], status: "active" as const },
    { id: "695614571", cells: ["CRO-5571", "Crowd Management Item 2", "16/12/2026", "€14 671"], status: "pending" as const },
    { id: "695618142", cells: ["CRO-9142", "Crowd Management Item 3", "3/7/2026", "€18 242"], status: "completed" as const },
    { id: "695621713", cells: ["CRO-3713", "Crowd Management Item 4", "18/2/2026", "€21 813"], status: "warning" as const },
    { id: "695625284", cells: ["CRO-7284", "Crowd Management Item 5", "5/9/2026", "€25 384"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Crowd Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Crowd Management</p>
                    </div>
                </div>
