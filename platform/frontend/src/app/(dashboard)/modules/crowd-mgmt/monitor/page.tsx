...
const PAGE = "Monitor";
const KPIS = [{"l":"Total Crowd Mgmt","v":"3.095","t":"+2.2%","d":"up"},{"l":"Monitor Ativos","v":"2.814","t":"-4.1%","d":"down"},{"l":"Eficiência (%)","v":"76.6%","t":"+4.9%","d":"up"},{"l":"Score Performance","v":"84","t":"-4.1%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Crowd Mgmt #001","Crowd Mgmt #002","542","3.767","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Crowd Mgmt #002","Crowd Mgmt #003","7.957","3.101","2026-03-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Crowd Mgmt #003","Crowd Mgmt #004","2.595","5.949","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["Crowd Mgmt #004","Crowd Mgmt #005","4.653","1.901","2026-02-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Crowd Mgmt #005","Crowd Mgmt #001","3.014","6.944","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":762},{"label":"Fev","value":529},{"label":"Mar","value":884},{"label":"Abr","value":863},{"label":"Mai","value":624},{"label":"Jun","value":592},{"label":"Jul","value":707},{"label":"Ago","value":508},{"label":"Set","value":734},{"label":"Out","value":736},{"label":"Nov","value":735},{"label":"Dez","value":564}];
const MX = 884;
