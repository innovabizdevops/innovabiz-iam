...
const PAGE = "Source";
const KPIS = [{"l":"Projetos Melhoria","v":"760","t":"+2.1%","d":"up"},{"l":"Savings (€)","v":"€69496","t":"-4.1%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"93.9%","t":"+10.7%","d":"up"},{"l":"Ciclos PDCA","v":"2.750","t":"-4.5%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","159","€ 9380.47","2.182","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.947","€ 18838.68","6.181","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","3.953","€ 21858.41","8.523","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","6.433","€ 11856.62","8.320","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","3.492","€ 44155.19","7.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":750},{"label":"Mar","value":575},{"label":"Abr","value":545},{"label":"Mai","value":719},{"label":"Jun","value":830},{"label":"Jul","value":750},{"label":"Ago","value":817},{"label":"Set","value":659},{"label":"Out","value":637},{"label":"Nov","value":622},{"label":"Dez","value":718}];
const MX = 830;
