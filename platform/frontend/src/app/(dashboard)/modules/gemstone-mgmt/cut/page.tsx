...
const PAGE = "Cut";
const KPIS = [{"l":"Projetos Melhoria","v":"363","t":"+2.4%","d":"up"},{"l":"Savings (€)","v":"€20304","t":"+0.5%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"94.6%","t":"+2.9%","d":"up"},{"l":"Ciclos PDCA","v":"318","t":"-4.6%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","6.434","€ 48325.63","1.528","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","4.372","€ 41416.72","3.005","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","5.807","€ 49164.54","2.819","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.938","€ 46710.49","8.400","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","5.721","€ 44826.55","9.095","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":577},{"label":"Fev","value":705},{"label":"Mar","value":708},{"label":"Abr","value":797},{"label":"Mai","value":842},{"label":"Jun","value":757},{"label":"Jul","value":734},{"label":"Ago","value":817},{"label":"Set","value":741},{"label":"Out","value":615},{"label":"Nov","value":796},{"label":"Dez","value":774}];
const MX = 842;
