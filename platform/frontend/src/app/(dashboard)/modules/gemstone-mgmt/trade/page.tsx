...
const PAGE = "Trade";
const KPIS = [{"l":"Projetos Melhoria","v":"2.773","t":"+3.7%","d":"up"},{"l":"Savings (€)","v":"€4747","t":"+13.8%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"71.6%","t":"-3.0%","d":"down"},{"l":"Ciclos PDCA","v":"2.148","t":"+17.9%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","2.083","€ 21433.47","6.201","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","5.970","€ 1297.89","4.369","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","561","€ 21170.22","4.126","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","5.677","€ 46195.87","7.691","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","7.038","€ 12923.25","7.251","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":854},{"label":"Fev","value":656},{"label":"Mar","value":567},{"label":"Abr","value":610},{"label":"Mai","value":825},{"label":"Jun","value":720},{"label":"Jul","value":625},{"label":"Ago","value":741},{"label":"Set","value":614},{"label":"Out","value":739},{"label":"Nov","value":593},{"label":"Dez","value":782}];
const MX = 854;
