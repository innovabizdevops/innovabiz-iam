...
const KPIS = [{"l":"Projetos Melhoria","v":"8.159","t":"+8.9%","d":"up"},{"l":"Savings (€)","v":"€78134","t":"+15.3%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"67.6%","t":"+9.4%","d":"up"},{"l":"Ciclos PDCA","v":"5.068","t":"+6.3%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","4.546","€ 8829.74","8.311","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","6.960","€ 6600.05","4.893","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","7.366","€ 31563.61","3.488","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.224","€ 48112.87","8.547","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","8.516","€ 26017.92","566","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":679},{"label":"Mar","value":437},{"label":"Abr","value":354},{"label":"Mai","value":703},{"label":"Jun","value":361},{"label":"Jul","value":487},{"label":"Ago","value":462},{"label":"Set","value":346},{"label":"Out","value":611},{"label":"Nov","value":435},{"label":"Dez","value":615}];
const MX = 703;
