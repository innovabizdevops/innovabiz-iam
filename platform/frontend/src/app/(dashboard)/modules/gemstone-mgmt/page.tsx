...
/* ═══ Gemstone Management — Dashboard ═══ */

const ACCENT = "#78350f";

const KPIS = [
    { label: "Total Registos", value: "907", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3357", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€457K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "96%", trend: "-15%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1097653407", cells: ["GEM-5407", "Gemstone Management Item 1", "12/4/2026", "€3507"], status: "active" as const },
    { id: "1097656978", cells: ["GEM-8978", "Gemstone Management Item 2", "27/11/2026", "€7078"], status: "pending" as const },
    { id: "1097660549", cells: ["GEM-3549", "Gemstone Management Item 3", "14/6/2026", "€10 649"], status: "completed" as const },
    { id: "1097664120", cells: ["GEM-7120", "Gemstone Management Item 4", "1/1/2026", "€14 220"], status: "warning" as const },
    { id: "1097667691", cells: ["GEM-1691", "Gemstone Management Item 5", "16/8/2026", "€17 791"], status: "active" as const },
];
...
export default function GemstoneManagementPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Gemstone Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Gemstone Management</p>
                    </div>
                </div>
