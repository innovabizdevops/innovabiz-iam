...
const ACCENT = "#78350f";
const MODULE = "Gemstone Management";
const PAGE = "Certify";
const KPIS = [{"l":"Projetos Melhoria","v":"6.269","t":"-3.1%","d":"down"},{"l":"Savings (€)","v":"€51848","t":"-0.3%","d":"down"},{"l":"Defeitos Reduzidos (%)","v":"80.5%","t":"+15.0%","d":"up"},{"l":"Ciclos PDCA","v":"4.323","t":"+5.7%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","1.434","€ 37203.53","6.416","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","2.019","€ 11855.30","8.736","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.685","€ 3933.92","3.820","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","8.051","€ 49676.74","6.409","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.154","€ 23442.33","4.596","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":652},{"label":"Fev","value":537},{"label":"Mar","value":659},{"label":"Abr","value":908},{"label":"Mai","value":806},{"label":"Jun","value":661},{"label":"Jul","value":728},{"label":"Ago","value":607},{"label":"Set","value":667},{"label":"Out","value":716},{"label":"Nov","value":873},{"label":"Dez","value":718}];
const MX = 908;
