...
const ACCENT = "#6366f1";
const MODULE = "Auto Dealership";
const PAGE = "Sales";
const KPIS = [{"l":"Vendas YTD (€)","v":"€28203","t":"+3.5%","d":"up"},{"l":"Pipeline (€)","v":"€63234","t":"+11.3%","d":"up"},{"l":"Atingimento Quota (%)","v":"90.6%","t":"+14.4%","d":"up"},{"l":"Win Rate (%)","v":"66.0%","t":"+15.1%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 8401.01","€ 6743.86","€ 10968.88","79.8%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 32478.08","€ 5093.19","€ 7942.52","74.7%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 12973.72","€ 18377.65","€ 48872.50","73.5%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 2781.89","€ 39812.73","€ 13159.98","92.8%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 23003.78","€ 6182.41","€ 32034.40","94.8%"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":554},{"label":"Mar","value":426},{"label":"Abr","value":625},{"label":"Mai","value":804},{"label":"Jun","value":618},{"label":"Jul","value":783},{"label":"Ago","value":410},{"label":"Set","value":518},{"label":"Out","value":587},{"label":"Nov","value":534},{"label":"Dez","value":655}];
const MX = 804;
