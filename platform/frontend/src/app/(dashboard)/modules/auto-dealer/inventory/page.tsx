...
const KPIS = [{"l":"Total Auto Dealer","v":"656","t":"+17.1%","d":"up"},{"l":"Inventory Ativos","v":"3.135","t":"+10.8%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+12.4%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.8%","d":"down"}];
const COLS = ["ID","Inventory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Auto Dealer #001","Auto Dealer #002","8.722","3.636","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Auto Dealer #002","Auto Dealer #003","6.633","4.965","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Auto Dealer #003","Auto Dealer #004","5.154","5.616","2026-01-23","Concluído"],"status":"done"},{"id":"r3","cells":["Auto Dealer #004","Auto Dealer #005","7.546","6.459","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Auto Dealer #005","Auto Dealer #001","1.430","4.882","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":839},{"label":"Mar","value":827},{"label":"Abr","value":685},{"label":"Mai","value":979},{"label":"Jun","value":854},{"label":"Jul","value":790},{"label":"Ago","value":853},{"label":"Set","value":695},{"label":"Out","value":837},{"label":"Nov","value":926},{"label":"Dez","value":726}];
const MX = 979;
