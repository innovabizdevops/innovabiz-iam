...
const PAGE = "Parent";
const KPIS = [{"l":"Atletas Registados","v":"8.550","t":"+0.3%","d":"up"},{"l":"Treinos/Semana","v":"3741","t":"+4.1%","d":"up"},{"l":"Competições","v":"6.863","t":"+1.9%","d":"up"},{"l":"Performance Score","v":"69","t":"+9.0%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","7.565","7.124","7.938","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","7.734","2.050","1.873","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.458","4.082","2.435","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","8.762","980","2.916","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","3.223","1.169","4.063","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":478},{"label":"Fev","value":697},{"label":"Mar","value":484},{"label":"Abr","value":402},{"label":"Mai","value":534},{"label":"Jun","value":631},{"label":"Jul","value":524},{"label":"Ago","value":503},{"label":"Set","value":463},{"label":"Out","value":516},{"label":"Nov","value":502},{"label":"Dez","value":593}];
const MX = 697;
