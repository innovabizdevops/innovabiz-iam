...
const PAGE = "Safety";
const KPIS = [{"l":"Atletas Registados","v":"7.195","t":"-3.7%","d":"down"},{"l":"Treinos/Semana","v":"2235","t":"+11.6%","d":"up"},{"l":"Competições","v":"7.729","t":"+1.4%","d":"up"},{"l":"Performance Score","v":"63","t":"+0.6%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.038","7.063","3.690","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","319","7.404","5.680","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","6.510","4.080","3.738","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.103","3.789","1.300","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.048","6.132","1.519","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":320},{"label":"Fev","value":379},{"label":"Mar","value":545},{"label":"Abr","value":555},{"label":"Mai","value":518},{"label":"Jun","value":349},{"label":"Jul","value":363},{"label":"Ago","value":598},{"label":"Set","value":391},{"label":"Out","value":295},{"label":"Nov","value":361},{"label":"Dez","value":535}];
const MX = 598;
