...
const KPIS = [{"l":"Atletas Registados","v":"2.697","t":"+3.9%","d":"up"},{"l":"Treinos/Semana","v":"1332","t":"+7.4%","d":"up"},{"l":"Competições","v":"7.382","t":"+9.1%","d":"up"},{"l":"Performance Score","v":"94","t":"+11.1%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","341","3.177","4.216","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.755","1.895","596","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.672","612","7.093","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","3.798","6.316","5.945","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","2.221","2.351","1.084","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":398},{"label":"Fev","value":682},{"label":"Mar","value":416},{"label":"Abr","value":369},{"label":"Mai","value":286},{"label":"Jun","value":525},{"label":"Jul","value":654},{"label":"Ago","value":433},{"label":"Set","value":500},{"label":"Out","value":326},{"label":"Nov","value":438},{"label":"Dez","value":469}];
const MX = 682;
