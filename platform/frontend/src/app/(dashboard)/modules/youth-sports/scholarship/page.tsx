...
const KPIS = [{"l":"Atletas Registados","v":"8.701","t":"+2.0%","d":"up"},{"l":"Treinos/Semana","v":"2888","t":"-0.3%","d":"down"},{"l":"Competições","v":"4.066","t":"+2.3%","d":"up"},{"l":"Performance Score","v":"87","t":"-3.5%","d":"down"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","3.728","6.974","4.502","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","6.176","3.568","151","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.059","6.065","2.983","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","1.896","4.455","5.129","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","8.264","8.234","5.274","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":658},{"label":"Mar","value":835},{"label":"Abr","value":782},{"label":"Mai","value":600},{"label":"Jun","value":837},{"label":"Jul","value":834},{"label":"Ago","value":881},{"label":"Set","value":770},{"label":"Out","value":924},{"label":"Nov","value":884},{"label":"Dez","value":845}];
const MX = 924;
