...
const ACCENT = "#6366f1";
const MODULE = "Youth Sports";
const PAGE = "Registration";
const KPIS = [{"l":"Eventos Planeados","v":"8.052","t":"+16.0%","d":"up"},{"l":"Participantes","v":"8.393","t":"+6.5%","d":"up"},{"l":"NPS Evento","v":"83","t":"+6.4%","d":"up"},{"l":"Receita (€)","v":"€1511","t":"+17.8%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-17","7.174","4.259","€ 474.96","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-22","4.288","4.445","€ 6451.98","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-06","4.321","1.761","€ 13949.29","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-23","6.420","1.796","€ 44070.26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-21","2.429","965","€ 7731.38","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":799},{"label":"Fev","value":759},{"label":"Mar","value":1025},{"label":"Abr","value":924},{"label":"Mai","value":987},{"label":"Jun","value":882},{"label":"Jul","value":896},{"label":"Ago","value":995},{"label":"Set","value":952},{"label":"Out","value":802},{"label":"Nov","value":912},{"label":"Dez","value":723}];
const MX = 1025;
