...
const PAGE = "Protocol";
const KPIS = [{"l":"Integrações Ativas","v":"8.305","t":"+1.5%","d":"up"},{"l":"Chamadas/Hora","v":"2867","t":"+7.2%","d":"up"},{"l":"Taxa Sucesso (%)","v":"90.7%","t":"+12.4%","d":"up"},{"l":"Latência Média (ms)","v":"33ms","t":"+13.0%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","499","4.138","87.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.028","3.974","98.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","2.319","126","96.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.475","2.030","80.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.371","1.479","86.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":485},{"label":"Mar","value":502},{"label":"Abr","value":630},{"label":"Mai","value":567},{"label":"Jun","value":687},{"label":"Jul","value":333},{"label":"Ago","value":484},{"label":"Set","value":460},{"label":"Out","value":374},{"label":"Nov","value":661},{"label":"Dez","value":531}];
const MX = 687;
