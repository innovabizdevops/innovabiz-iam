...
/* ═══ EDGE3 Edge Gateway — Dashboard ═══ */

const ACCENT = "#0f766e";

const KPIS = [
    { label: "Total Registos", value: "6948", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1326", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€473K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "527884748", cells: ["EDG-8748", "EDGE3 Edge Gateway Item 1", "21/9/2026", "€34 848"], status: "active" as const },
    { id: "527888319", cells: ["EDG-3319", "EDGE3 Edge Gateway Item 2", "8/4/2026", "€38 419"], status: "pending" as const },
    { id: "527891890", cells: ["EDG-6890", "EDGE3 Edge Gateway Item 3", "23/11/2026", "€41 990"], status: "completed" as const },
    { id: "527895461", cells: ["EDG-1461", "EDGE3 Edge Gateway Item 4", "10/6/2026", "€45 561"], status: "warning" as const },
    { id: "527899032", cells: ["EDG-5032", "EDGE3 Edge Gateway Item 5", "25/1/2026", "€49 132"], status: "active" as const },
];
...
export default function Edge3EdgeGatewayPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EDGE3 Edge Gateway</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EDGE3 Edge Gateway</p>
                    </div>
                </div>
