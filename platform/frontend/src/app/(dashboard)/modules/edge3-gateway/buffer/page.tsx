...
const PAGE = "Buffer";
const KPIS = [{"l":"Integrações Ativas","v":"307","t":"+15.7%","d":"up"},{"l":"Chamadas/Hora","v":"3958","t":"+15.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"83.7%","t":"+9.3%","d":"up"},{"l":"Latência Média (ms)","v":"199ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.396","654","98.7%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.188","2.354","92.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","6.081","307","77.1%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.563","2.321","96.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","361","7.531","99.0%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":560},{"label":"Fev","value":383},{"label":"Mar","value":604},{"label":"Abr","value":293},{"label":"Mai","value":308},{"label":"Jun","value":521},{"label":"Jul","value":332},{"label":"Ago","value":370},{"label":"Set","value":268},{"label":"Out","value":565},{"label":"Nov","value":316},{"label":"Dez","value":403}];
const MX = 604;
