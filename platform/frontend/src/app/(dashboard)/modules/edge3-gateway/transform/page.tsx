...
const ACCENT = "#0f766e";
const MODULE = "EDGE3 Edge Gateway";
const PAGE = "Transform";
const KPIS = [{"l":"Formulários Ativos","v":"2.113","t":"+0.0%","d":"up"},{"l":"Submissões/Dia","v":"3928","t":"+17.3%","d":"up"},{"l":"Documentos Gerados","v":"7.978","t":"+8.7%","d":"up"},{"l":"Templates","v":"4.813","t":"+4.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.048","2026-01-21","3.220","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.796","2026-01-28","1.215","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.624","2026-02-24","1.627","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.716","2026-03-07","4.675","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.867","2026-01-13","6.167","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":804},{"label":"Fev","value":747},{"label":"Mar","value":758},{"label":"Abr","value":873},{"label":"Mai","value":672},{"label":"Jun","value":853},{"label":"Jul","value":608},{"label":"Ago","value":936},{"label":"Set","value":692},{"label":"Out","value":649},{"label":"Nov","value":653},{"label":"Dez","value":776}];
const MX = 936;
