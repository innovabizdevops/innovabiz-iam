...
const PAGE = "Filter";
const KPIS = [{"l":"Integrações Ativas","v":"3.900","t":"+7.4%","d":"up"},{"l":"Chamadas/Hora","v":"3493","t":"-3.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"71.8%","t":"+11.4%","d":"up"},{"l":"Latência Média (ms)","v":"151ms","t":"+15.8%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.934","8.702","89.2%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","5.826","7.307","78.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.258","8.565","91.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","8.227","6.729","70.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","4.188","6.301","84.6%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":896},{"label":"Fev","value":742},{"label":"Mar","value":1018},{"label":"Abr","value":971},{"label":"Mai","value":917},{"label":"Jun","value":839},{"label":"Jul","value":916},{"label":"Ago","value":827},{"label":"Set","value":900},{"label":"Out","value":834},{"label":"Nov","value":809},{"label":"Dez","value":766}];
const MX = 1018;
