...
const PAGE = "Secure";
const KPIS = [{"l":"Integrações Ativas","v":"1.604","t":"+8.5%","d":"up"},{"l":"Chamadas/Hora","v":"4133","t":"-5.1%","d":"down"},{"l":"Taxa Sucesso (%)","v":"75.7%","t":"+14.4%","d":"up"},{"l":"Latência Média (ms)","v":"146ms","t":"+3.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","7.309","8.295","90.0%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.823","3.104","82.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.992","365","83.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.507","1.196","97.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","7.498","820","94.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":551},{"label":"Mar","value":779},{"label":"Abr","value":723},{"label":"Mai","value":483},{"label":"Jun","value":650},{"label":"Jul","value":676},{"label":"Ago","value":599},{"label":"Set","value":550},{"label":"Out","value":831},{"label":"Nov","value":720},{"label":"Dez","value":672}];
const MX = 850;
