...
const ACCENT = "#1e293b";
const MODULE = "Capacity Management (ITIL)";
const PAGE = "Optimize";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.002","t":"+11.7%","d":"up"},{"l":"NC Abertas","v":"5.344","t":"-2.9%","d":"down"},{"l":"Conformidade (%)","v":"79.2%","t":"+13.9%","d":"up"},{"l":"CAPAs Pendentes","v":"8.778","t":"+14.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","143","97.5%","7.188","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.473","86.0%","5.532","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.183","80.1%","7.476","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","472","75.4%","6.548","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","2.713","98.3%","5.581","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":397},{"label":"Fev","value":421},{"label":"Mar","value":463},{"label":"Abr","value":673},{"label":"Mai","value":541},{"label":"Jun","value":733},{"label":"Jul","value":627},{"label":"Ago","value":775},{"label":"Set","value":644},{"label":"Out","value":703},{"label":"Nov","value":730},{"label":"Dez","value":767}];
const MX = 775;
