...
const KPIS = [{"l":"Auditorias Realizadas","v":"1.531","t":"+14.6%","d":"up"},{"l":"NC Abertas","v":"1.506","t":"-1.6%","d":"down"},{"l":"Conformidade (%)","v":"77.9%","t":"+13.9%","d":"up"},{"l":"CAPAs Pendentes","v":"5.902","t":"+8.8%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.343","99.5%","6.211","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.587","71.2%","1.592","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.571","97.9%","8.528","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.727","94.3%","8.789","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.240","76.2%","6.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":611},{"label":"Mar","value":534},{"label":"Abr","value":501},{"label":"Mai","value":724},{"label":"Jun","value":686},{"label":"Jul","value":456},{"label":"Ago","value":631},{"label":"Set","value":452},{"label":"Out","value":469},{"label":"Nov","value":590},{"label":"Dez","value":643}];
const MX = 730;
