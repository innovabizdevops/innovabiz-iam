...
/* ═══ Capacity Management (ITIL) — Dashboard ═══ */

const ACCENT = "#1e293b";

const KPIS = [
    { label: "Total Registos", value: "9723", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "326", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€140K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "88%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "446568923", cells: ["CAP-7923", "Capacity Management (ITIL) Item 1", "4/12/2026", "€19 023"], status: "active" as const },
    { id: "446572494", cells: ["CAP-2494", "Capacity Management (ITIL) Item 2", "19/7/2026", "€22 594"], status: "pending" as const },
    { id: "446576065", cells: ["CAP-6065", "Capacity Management (ITIL) Item 3", "6/2/2026", "€26 165"], status: "completed" as const },
    { id: "446579636", cells: ["CAP-9636", "Capacity Management (ITIL) Item 4", "21/9/2026", "€29 736"], status: "warning" as const },
    { id: "446583207", cells: ["CAP-4207", "Capacity Management (ITIL) Item 5", "8/4/2026", "€33 307"], status: "active" as const },
];
...
export default function CapacityManagementItilPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Management (ITIL)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Capacity Management (ITIL)</p>
                    </div>
                </div>
