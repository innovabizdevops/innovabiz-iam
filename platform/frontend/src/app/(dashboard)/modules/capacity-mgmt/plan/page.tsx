...
const PAGE = "Plan";
const KPIS = [{"l":"Auditorias Realizadas","v":"1.055","t":"+7.4%","d":"up"},{"l":"NC Abertas","v":"8.823","t":"+16.3%","d":"up"},{"l":"Conformidade (%)","v":"84.7%","t":"+2.7%","d":"up"},{"l":"CAPAs Pendentes","v":"8.504","t":"+7.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","954","84.4%","2.491","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","1.687","74.9%","3.551","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.911","76.1%","538","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","3.577","81.4%","2.368","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.794","70.5%","3.663","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":422},{"label":"Fev","value":455},{"label":"Mar","value":719},{"label":"Abr","value":378},{"label":"Mai","value":361},{"label":"Jun","value":630},{"label":"Jul","value":571},{"label":"Ago","value":430},{"label":"Set","value":703},{"label":"Out","value":646},{"label":"Nov","value":359},{"label":"Dez","value":494}];
const MX = 719;
