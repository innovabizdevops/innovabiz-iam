...
const PAGE = "Business";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.028","t":"+4.8%","d":"up"},{"l":"NC Abertas","v":"9.032","t":"+13.6%","d":"up"},{"l":"Conformidade (%)","v":"91.2%","t":"+13.7%","d":"up"},{"l":"CAPAs Pendentes","v":"4.720","t":"+17.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","2.747","89.8%","5.818","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.919","91.5%","2.233","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.681","76.0%","5.906","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","958","96.0%","106","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.840","92.1%","3.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":337},{"label":"Fev","value":302},{"label":"Mar","value":568},{"label":"Abr","value":340},{"label":"Mai","value":424},{"label":"Jun","value":499},{"label":"Jul","value":359},{"label":"Ago","value":342},{"label":"Set","value":345},{"label":"Out","value":609},{"label":"Nov","value":612},{"label":"Dez","value":525}];
const MX = 612;
