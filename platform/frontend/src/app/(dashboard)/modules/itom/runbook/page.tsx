...
const PAGE = "Runbook Automation";
const KPIS = [{"l":"BCP Plans Ativos","v":"8.989","t":"+7.6%","d":"up"},{"l":"RTO Médio (h)","v":"193h","t":"+14.4%","d":"up"},{"l":"RPO Médio (h)","v":"13h","t":"+12.5%","d":"up"},{"l":"Testes DR (YTD)","v":"4.705","t":"+7.1%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","206h","175h","2026-01-23","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","92h","27h","2026-01-05","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","64h","80h","2026-01-01","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","34h","31h","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","127h","145h","2026-02-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":463},{"label":"Fev","value":296},{"label":"Mar","value":592},{"label":"Abr","value":554},{"label":"Mai","value":449},{"label":"Jun","value":413},{"label":"Jul","value":465},{"label":"Ago","value":460},{"label":"Set","value":368},{"label":"Out","value":627},{"label":"Nov","value":468},{"label":"Dez","value":329}];
const MX = 627;
