...
const PAGE = "ITIL Service Design";
const KPIS = [{"l":"Tickets Abertos","v":"6.360","t":"+15.5%","d":"up"},{"l":"SLA Cumprido (%)","v":"80.7%","t":"+9.0%","d":"up"},{"l":"MTTR (h)","v":"132h","t":"+10.5%","d":"up"},{"l":"Satisfação (%)","v":"76.2%","t":"+7.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.302","6.413","7.059","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.205","607","3.024","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","8.450","1.213","8.948","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.563","7.925","189","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.127","1.496","322","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":591},{"label":"Fev","value":484},{"label":"Mar","value":564},{"label":"Abr","value":760},{"label":"Mai","value":660},{"label":"Jun","value":406},{"label":"Jul","value":716},{"label":"Ago","value":666},{"label":"Set","value":764},{"label":"Out","value":545},{"label":"Nov","value":716},{"label":"Dez","value":729}];
const MX = 764;
...
export default function ItilServiceDesignPage() {
    return (
