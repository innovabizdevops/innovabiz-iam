...
const PAGE = "Cost Optimization";
const KPIS = [{"l":"Total Itom","v":"4.499","t":"-3.0%","d":"down"},{"l":"Cost Optimization Ativos","v":"5.709","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"83.5%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"87","t":"+15.4%","d":"up"}];
const COLS = ["ID","Cost Optimization","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Itom #001","Itom #002","7.382","1.013","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Itom #002","Itom #003","1.941","2.601","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Itom #003","Itom #004","4.415","8.958","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Itom #004","Itom #005","6.781","9.074","2026-01-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Itom #005","Itom #001","2.669","7.968","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":721},{"label":"Mar","value":702},{"label":"Abr","value":683},{"label":"Mai","value":819},{"label":"Jun","value":454},{"label":"Jul","value":623},{"label":"Ago","value":660},{"label":"Set","value":745},{"label":"Out","value":616},{"label":"Nov","value":555},{"label":"Dez","value":744}];
const MX = 819;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>FinOps</span></h1>
                </div>
