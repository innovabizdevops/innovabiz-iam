...
const PAGE = "SLA Analytics";
const KPIS = [{"l":"Tickets Abertos","v":"6.351","t":"+17.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"93.4%","t":"+2.9%","d":"up"},{"l":"MTTR (h)","v":"91h","t":"-2.7%","d":"down"},{"l":"Satisfação (%)","v":"82.9%","t":"+5.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","165","7.921","8.294","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","5.039","1.666","4.552","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.084","2.718","2.463","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","962","1.670","3.366","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","2.841","6.446","4.023","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":639},{"label":"Mar","value":690},{"label":"Abr","value":686},{"label":"Mai","value":830},{"label":"Jun","value":841},{"label":"Jul","value":671},{"label":"Ago","value":550},{"label":"Set","value":557},{"label":"Out","value":674},{"label":"Nov","value":909},{"label":"Dez","value":632}];
const MX = 909;
