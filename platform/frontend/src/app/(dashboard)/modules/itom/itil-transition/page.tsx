...
const ACCENT = "#2563eb";
const MODULE = "IT Operations (ITOM)";
const PAGE = "ITIL Service Transition";
const KPIS = [{"l":"Tickets Abertos","v":"4.767","t":"+5.0%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.5%","t":"+5.5%","d":"up"},{"l":"MTTR (h)","v":"18h","t":"+12.9%","d":"up"},{"l":"Satisfação (%)","v":"72.4%","t":"+1.4%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","5.618","2.318","8.420","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","2.335","5.191","7.942","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.613","3.923","8.416","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.331","8.316","6.349","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.308","7.749","820","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":671},{"label":"Fev","value":603},{"label":"Mar","value":463},{"label":"Abr","value":471},{"label":"Mai","value":527},{"label":"Jun","value":578},{"label":"Jul","value":595},{"label":"Ago","value":582},{"label":"Set","value":626},{"label":"Out","value":600},{"label":"Nov","value":445},{"label":"Dez","value":630}];
const MX = 671;
...
export default function ItilTransitionPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#2563eb'}}>ITIL</span></h1>
                </div>
