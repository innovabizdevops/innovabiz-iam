...
const PAGE = "Capacity Planning";
const KPIS = [{"l":"Auditorias Realizadas","v":"3.817","t":"+6.9%","d":"up"},{"l":"NC Abertas","v":"1.963","t":"+5.1%","d":"up"},{"l":"Conformidade (%)","v":"89.5%","t":"+11.1%","d":"up"},{"l":"CAPAs Pendentes","v":"3.459","t":"+13.5%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.480","76.1%","7.569","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.603","86.4%","2.351","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","5.178","83.1%","8.526","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.517","71.5%","5.900","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.338","95.3%","1.523","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":631},{"label":"Fev","value":669},{"label":"Mar","value":767},{"label":"Abr","value":870},{"label":"Mai","value":626},{"label":"Jun","value":616},{"label":"Jul","value":792},{"label":"Ago","value":708},{"label":"Set","value":870},{"label":"Out","value":821},{"label":"Nov","value":631},{"label":"Dez","value":684}];
const MX = 870;
