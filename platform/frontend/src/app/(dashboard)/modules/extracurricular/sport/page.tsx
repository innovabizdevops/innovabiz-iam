...
const PAGE = "Sport";
const KPIS = [{"l":"Atletas Registados","v":"5.435","t":"-5.1%","d":"down"},{"l":"Treinos/Semana","v":"4079","t":"+3.2%","d":"up"},{"l":"Competições","v":"2.450","t":"+5.0%","d":"up"},{"l":"Performance Score","v":"58","t":"+12.3%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","6.982","429","2.708","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","1.242","2.915","4.739","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","8.515","8.001","8.805","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","2.616","5.097","7.361","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","7.154","7.827","6.539","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":700},{"label":"Fev","value":652},{"label":"Mar","value":692},{"label":"Abr","value":380},{"label":"Mai","value":635},{"label":"Jun","value":593},{"label":"Jul","value":461},{"label":"Ago","value":402},{"label":"Set","value":463},{"label":"Out","value":686},{"label":"Nov","value":404},{"label":"Dez","value":468}];
const MX = 700;
