...
const PAGE = "Award";
const KPIS = [{"l":"Total Extracurricular","v":"8.600","t":"+4.0%","d":"up"},{"l":"Award Ativos","v":"496","t":"+16.4%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"+9.1%","d":"up"},{"l":"Score Performance","v":"92","t":"-3.4%","d":"down"}];
const COLS = ["ID","Award","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Extracurricular #001","Extracurricular #002","6.654","8.693","2026-02-19","Ativo"],"status":"active"},{"id":"r1","cells":["Extracurricular #002","Extracurricular #003","2.125","5.186","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Extracurricular #003","Extracurricular #004","3.989","6.125","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Extracurricular #004","Extracurricular #005","3.709","8.707","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Extracurricular #005","Extracurricular #001","8.900","2.288","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":619},{"label":"Fev","value":645},{"label":"Mar","value":694},{"label":"Abr","value":380},{"label":"Mai","value":494},{"label":"Jun","value":574},{"label":"Jul","value":396},{"label":"Ago","value":538},{"label":"Set","value":647},{"label":"Out","value":687},{"label":"Nov","value":377},{"label":"Dez","value":422}];
const MX = 694;
