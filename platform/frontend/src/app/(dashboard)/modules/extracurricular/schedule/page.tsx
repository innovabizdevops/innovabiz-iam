...
const PAGE = "Schedule";
const KPIS = [{"l":"Total Extracurricular","v":"4.606","t":"+12.7%","d":"up"},{"l":"Schedule Ativos","v":"7.284","t":"+7.9%","d":"up"},{"l":"Eficiência (%)","v":"77.3%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"89","t":"+4.2%","d":"up"}];
const COLS = ["ID","Schedule","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Extracurricular #001","Extracurricular #002","1.851","3.010","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Extracurricular #002","Extracurricular #003","3.987","7.296","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Extracurricular #003","Extracurricular #004","5.377","4.595","2026-03-22","Concluído"],"status":"done"},{"id":"r3","cells":["Extracurricular #004","Extracurricular #005","4.888","5.351","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Extracurricular #005","Extracurricular #001","709","5.085","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":477},{"label":"Mar","value":678},{"label":"Abr","value":493},{"label":"Mai","value":519},{"label":"Jun","value":727},{"label":"Jul","value":636},{"label":"Ago","value":478},{"label":"Set","value":650},{"label":"Out","value":518},{"label":"Nov","value":363},{"label":"Dez","value":604}];
const MX = 727;
