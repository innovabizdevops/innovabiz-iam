...
const ACCENT = "#6366f1";
const MODULE = "Extracurricular";
const PAGE = "Club";
const KPIS = [{"l":"Total Extracurricular","v":"1.556","t":"+6.9%","d":"up"},{"l":"Club Ativos","v":"1.760","t":"-5.2%","d":"down"},{"l":"Eficiência (%)","v":"79.4%","t":"+12.5%","d":"up"},{"l":"Score Performance","v":"94","t":"-1.9%","d":"down"}];
const COLS = ["ID","Club","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Extracurricular #001","Extracurricular #002","8.563","7.966","2026-02-22","Ativo"],"status":"active"},{"id":"r1","cells":["Extracurricular #002","Extracurricular #003","6.327","3.139","2026-02-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Extracurricular #003","Extracurricular #004","2.959","5.563","2026-03-25","Concluído"],"status":"done"},{"id":"r3","cells":["Extracurricular #004","Extracurricular #005","3.417","6.852","2026-02-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Extracurricular #005","Extracurricular #001","4.249","1.762","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":570},{"label":"Mar","value":918},{"label":"Abr","value":734},{"label":"Mai","value":651},{"label":"Jun","value":892},{"label":"Jul","value":905},{"label":"Ago","value":737},{"label":"Set","value":645},{"label":"Out","value":841},{"label":"Nov","value":601},{"label":"Dez","value":919}];
const MX = 919;
