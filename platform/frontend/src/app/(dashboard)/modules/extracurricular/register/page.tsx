...
const KPIS = [{"l":"Eventos Planeados","v":"4.315","t":"-3.5%","d":"down"},{"l":"Participantes","v":"7.797","t":"-4.0%","d":"down"},{"l":"NPS Evento","v":"62","t":"+3.6%","d":"up"},{"l":"Receita (€)","v":"€99956","t":"+4.0%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-07","6.267","519","€ 26467.82","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-10","3.845","7.804","€ 44846.21","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-07","3.904","5.637","€ 6868.74","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-27","4.955","6.525","€ 3631.68","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-10","8.263","8.175","€ 16407.32","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":331},{"label":"Mar","value":400},{"label":"Abr","value":496},{"label":"Mai","value":371},{"label":"Jun","value":511},{"label":"Jul","value":344},{"label":"Ago","value":669},{"label":"Set","value":601},{"label":"Out","value":490},{"label":"Nov","value":668},{"label":"Dez","value":467}];
const MX = 669;
