...
const PAGE = "Training";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.096","t":"+9.9%","d":"up"},{"l":"NC Abertas","v":"4.843","t":"+11.0%","d":"up"},{"l":"Conformidade (%)","v":"78.8%","t":"+1.5%","d":"up"},{"l":"CAPAs Pendentes","v":"6.113","t":"+3.6%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.905","95.9%","1.161","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.350","83.2%","8.079","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.778","85.6%","6.817","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.769","79.0%","1.981","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.087","75.6%","1.069","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":868},{"label":"Fev","value":827},{"label":"Mar","value":780},{"label":"Abr","value":935},{"label":"Mai","value":961},{"label":"Jun","value":749},{"label":"Jul","value":828},{"label":"Ago","value":967},{"label":"Set","value":1049},{"label":"Out","value":927},{"label":"Nov","value":786},{"label":"Dez","value":843}];
const MX = 1049;
