...
const KPIS = [
    { label: "Total Registos", value: "8528", trend: "+4%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3752", trend: "-23%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€350K", trend: "+17%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "968376928", cells: ["HIP-4928", "HIPAA Compliance Item 1", "9/5/2026", "€27 028"], status: "active" as const },
    { id: "968380499", cells: ["HIP-8499", "HIPAA Compliance Item 2", "24/12/2026", "€30 599"], status: "pending" as const },
    { id: "968384070", cells: ["HIP-3070", "HIPAA Compliance Item 3", "11/7/2026", "€34 170"], status: "completed" as const },
    { id: "968387641", cells: ["HIP-6641", "HIPAA Compliance Item 4", "26/2/2026", "€37 741"], status: "warning" as const },
    { id: "968391212", cells: ["HIP-1212", "HIPAA Compliance Item 5", "13/9/2026", "€41 312"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">HIPAA Compliance</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • HIPAA Compliance</p>
                    </div>
                </div>
