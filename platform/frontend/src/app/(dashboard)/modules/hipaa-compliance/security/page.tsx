...
const ACCENT = "#dc2626";
const MODULE = "HIPAA Compliance";
const PAGE = "Security";
const KPIS = [{"l":"Auditorias Realizadas","v":"2.412","t":"-2.7%","d":"down"},{"l":"NC Abertas","v":"5.668","t":"+11.1%","d":"up"},{"l":"Conformidade (%)","v":"92.8%","t":"+1.1%","d":"up"},{"l":"CAPAs Pendentes","v":"7.834","t":"+5.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","5.380","71.8%","3.292","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.960","93.9%","3.628","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.223","91.4%","7.388","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.082","92.4%","3.269","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","3.926","78.7%","6.223","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":232},{"label":"Mar","value":580},{"label":"Abr","value":443},{"label":"Mai","value":379},{"label":"Jun","value":488},{"label":"Jul","value":375},{"label":"Ago","value":577},{"label":"Set","value":366},{"label":"Out","value":365},{"label":"Nov","value":475},{"label":"Dez","value":567}];
const MX = 613;
