...
const PAGE = "BAA";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.693","t":"+9.1%","d":"up"},{"l":"NC Abertas","v":"5.215","t":"+1.9%","d":"up"},{"l":"Conformidade (%)","v":"65.1%","t":"+12.8%","d":"up"},{"l":"CAPAs Pendentes","v":"8.027","t":"-3.0%","d":"down"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","6.601","83.7%","1.851","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.542","90.4%","6.675","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","7.172","86.9%","4.593","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.000","90.8%","4.574","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.190","79.3%","7.232","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":841},{"label":"Fev","value":875},{"label":"Mar","value":1003},{"label":"Abr","value":1079},{"label":"Mai","value":972},{"label":"Jun","value":1041},{"label":"Jul","value":909},{"label":"Ago","value":982},{"label":"Set","value":714},{"label":"Out","value":921},{"label":"Nov","value":1007},{"label":"Dez","value":855}];
const MX = 1079;
