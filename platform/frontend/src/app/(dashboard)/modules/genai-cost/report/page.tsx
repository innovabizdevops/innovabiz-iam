...
const PAGE = "Report";
const KPIS = [{"l":"Total Genai Cost","v":"2.603","t":"+0.8%","d":"up"},{"l":"Report Ativos","v":"8.523","t":"+10.4%","d":"up"},{"l":"Eficiência (%)","v":"70.1%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"85","t":"+1.4%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Cost #001","Genai Cost #002","8.784","6.884","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Cost #002","Genai Cost #003","2.191","6.219","2026-01-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Cost #003","Genai Cost #004","1.548","3.771","2026-02-18","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Cost #004","Genai Cost #005","5.663","5.275","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Cost #005","Genai Cost #001","2.110","2.987","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":457},{"label":"Fev","value":472},{"label":"Mar","value":758},{"label":"Abr","value":426},{"label":"Mai","value":748},{"label":"Jun","value":609},{"label":"Jul","value":524},{"label":"Ago","value":503},{"label":"Set","value":729},{"label":"Out","value":705},{"label":"Nov","value":389},{"label":"Dez","value":456}];
const MX = 758;
