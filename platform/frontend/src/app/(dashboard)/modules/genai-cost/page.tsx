...
/* ═══ GenAI Cost Optimizer — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "6251", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "117", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€95K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "80%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "2018457751", cells: ["GEN-1751", "GenAI Cost Optimizer Item 1", "24/8/2026", "€7851"], status: "active" as const },
    { id: "2018461322", cells: ["GEN-5322", "GenAI Cost Optimizer Item 2", "11/3/2026", "€11 422"], status: "pending" as const },
    { id: "2018464893", cells: ["GEN-8893", "GenAI Cost Optimizer Item 3", "26/10/2026", "€14 993"], status: "completed" as const },
    { id: "2018468464", cells: ["GEN-3464", "GenAI Cost Optimizer Item 4", "13/5/2026", "€18 564"], status: "warning" as const },
    { id: "2018472035", cells: ["GEN-7035", "GenAI Cost Optimizer Item 5", "28/12/2026", "€22 135"], status: "active" as const },
];
...
export default function GenaiCostOptimizerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">GenAI Cost Optimizer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • GenAI Cost Optimizer</p>
                    </div>
                </div>
