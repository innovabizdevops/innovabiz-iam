...
const PAGE = "Cache";
const KPIS = [{"l":"Total Genai Cost","v":"8.915","t":"+9.8%","d":"up"},{"l":"Cache Ativos","v":"3.140","t":"+16.8%","d":"up"},{"l":"Eficiência (%)","v":"69.3%","t":"+7.5%","d":"up"},{"l":"Score Performance","v":"57","t":"-3.8%","d":"down"}];
const COLS = ["ID","Cache","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Cost #001","Genai Cost #002","356","870","2026-01-06","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Cost #002","Genai Cost #003","5.441","5.222","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Cost #003","Genai Cost #004","3.212","8.375","2026-01-14","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Cost #004","Genai Cost #005","4.579","5.628","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Cost #005","Genai Cost #001","5.049","1.884","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":307},{"label":"Fev","value":464},{"label":"Mar","value":383},{"label":"Abr","value":483},{"label":"Mai","value":341},{"label":"Jun","value":553},{"label":"Jul","value":245},{"label":"Ago","value":456},{"label":"Set","value":339},{"label":"Out","value":241},{"label":"Nov","value":292},{"label":"Dez","value":237}];
const MX = 553;
