...
const PAGE = "Token Track";
const KPIS = [{"l":"Total Genai Cost","v":"4.095","t":"+16.7%","d":"up"},{"l":"Token Track Ativos","v":"6.015","t":"+16.6%","d":"up"},{"l":"Eficiência (%)","v":"94.8%","t":"+13.4%","d":"up"},{"l":"Score Performance","v":"88","t":"+8.8%","d":"up"}];
const COLS = ["ID","Token Track","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Cost #001","Genai Cost #002","8.367","5.040","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Cost #002","Genai Cost #003","5.844","6.884","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Cost #003","Genai Cost #004","2.563","857","2026-03-09","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Cost #004","Genai Cost #005","5.012","3.669","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Cost #005","Genai Cost #001","8.610","5.917","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":997},{"label":"Fev","value":831},{"label":"Mar","value":882},{"label":"Abr","value":708},{"label":"Mai","value":999},{"label":"Jun","value":814},{"label":"Jul","value":626},{"label":"Ago","value":905},{"label":"Set","value":925},{"label":"Out","value":641},{"label":"Nov","value":800},{"label":"Dez","value":660}];
const MX = 999;
