...
const PAGE = "Budget";
const KPIS = [{"l":"Total Genai Cost","v":"2.186","t":"+7.5%","d":"up"},{"l":"Budget Ativos","v":"€4236","t":"-0.5%","d":"down"},{"l":"Eficiência (%)","v":"69.6%","t":"+17.0%","d":"up"},{"l":"Score Performance","v":"87","t":"-0.3%","d":"down"}];
const COLS = ["ID","Budget","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Cost #001","€ 1601.97","1.254","3.388","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Cost #002","€ 3625.57","320","2.453","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Cost #003","€ 48345.63","1.096","283","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Cost #004","€ 22542.13","4.319","296","2026-02-05","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Cost #005","€ 10021.97","7.015","4.841","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":679},{"label":"Mar","value":791},{"label":"Abr","value":964},{"label":"Mai","value":1062},{"label":"Jun","value":679},{"label":"Jul","value":806},{"label":"Ago","value":723},{"label":"Set","value":862},{"label":"Out","value":810},{"label":"Nov","value":1038},{"label":"Dez","value":768}];
const MX = 1062;
