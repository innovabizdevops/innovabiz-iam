...
const ACCENT = "#6d28d9";
const MODULE = "GenAI Cost Optimizer";
const PAGE = "Model Route";
const KPIS = [{"l":"Total Genai Cost","v":"4.981","t":"-2.4%","d":"down"},{"l":"Model Route Ativos","v":"6.736","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"87.3%","t":"+5.0%","d":"up"},{"l":"Score Performance","v":"66","t":"+12.7%","d":"up"}];
const COLS = ["ID","Model Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Genai Cost #001","Genai Cost #002","8.389","8.532","2026-01-25","Ativo"],"status":"active"},{"id":"r1","cells":["Genai Cost #002","Genai Cost #003","1.617","7.044","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Genai Cost #003","Genai Cost #004","2.845","3.644","2026-02-15","Concluído"],"status":"done"},{"id":"r3","cells":["Genai Cost #004","Genai Cost #005","3.713","5.901","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Genai Cost #005","Genai Cost #001","3.867","6.389","2026-02-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":977},{"label":"Fev","value":852},{"label":"Mar","value":932},{"label":"Abr","value":882},{"label":"Mai","value":717},{"label":"Jun","value":954},{"label":"Jul","value":958},{"label":"Ago","value":833},{"label":"Set","value":816},{"label":"Out","value":705},{"label":"Nov","value":970},{"label":"Dez","value":718}];
const MX = 977;
