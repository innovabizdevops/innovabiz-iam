...
const PAGE = "340B";
const KPIS = [{"l":"ARR (€M)","v":"€45.7M","t":"+17.1%","d":"up"},{"l":"MRR (€)","v":"€36951","t":"+14.6%","d":"up"},{"l":"Churn (%)","v":"69.4%","t":"+17.6%","d":"up"},{"l":"ARPU (€)","v":"€69520","t":"+9.5%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1316.60","2.729","€ 24535.32","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 4047.64","1.845","€ 44826.87","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 42247.74","5.389","€ 7455.76","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 49037.20","5.169","€ 32616.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44695.23","7.896","€ 43312.66","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":766},{"label":"Mar","value":622},{"label":"Abr","value":470},{"label":"Mai","value":788},{"label":"Jun","value":649},{"label":"Jul","value":630},{"label":"Ago","value":586},{"label":"Set","value":536},{"label":"Out","value":594},{"label":"Nov","value":545},{"label":"Dez","value":412}];
const MX = 788;
...
export default function 340bPage() {
    return (
