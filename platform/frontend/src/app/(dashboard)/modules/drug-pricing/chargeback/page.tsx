...
const ACCENT = "#6366f1";
const MODULE = "Drug Pricing";
const PAGE = "Chargeback";
const KPIS = [{"l":"ARR (€M)","v":"€40.7M","t":"-4.9%","d":"down"},{"l":"MRR (€)","v":"€12660","t":"+6.0%","d":"up"},{"l":"Churn (%)","v":"67.0%","t":"-0.8%","d":"down"},{"l":"ARPU (€)","v":"€42717","t":"+5.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 3904.96","2.592","€ 8550.79","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 45196.73","5.691","€ 48423.74","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 2875.92","6.726","€ 31689.00","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 15936.16","4.880","€ 28908.39","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4489.24","4.081","€ 1422.58","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":906},{"label":"Fev","value":732},{"label":"Mar","value":1020},{"label":"Abr","value":692},{"label":"Mai","value":664},{"label":"Jun","value":674},{"label":"Jul","value":843},{"label":"Ago","value":688},{"label":"Set","value":762},{"label":"Out","value":832},{"label":"Nov","value":718},{"label":"Dez","value":1021}];
const MX = 1021;
