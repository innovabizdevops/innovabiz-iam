...
const PAGE = "WAC";
const KPIS = [{"l":"ARR (€M)","v":"€44.6M","t":"+7.4%","d":"up"},{"l":"MRR (€)","v":"€17794","t":"+9.5%","d":"up"},{"l":"Churn (%)","v":"69.0%","t":"+3.7%","d":"up"},{"l":"ARPU (€)","v":"€97348","t":"+3.9%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 161.46","7.910","€ 2167.29","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 11640.67","9.068","€ 36722.24","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 45433.31","2.825","€ 23304.92","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 3818.40","4.025","€ 2238.99","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 28848.04","4.977","€ 36767.63","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":741},{"label":"Mar","value":669},{"label":"Abr","value":837},{"label":"Mai","value":699},{"label":"Jun","value":672},{"label":"Jul","value":906},{"label":"Ago","value":785},{"label":"Set","value":588},{"label":"Out","value":746},{"label":"Nov","value":534},{"label":"Dez","value":908}];
const MX = 908;
