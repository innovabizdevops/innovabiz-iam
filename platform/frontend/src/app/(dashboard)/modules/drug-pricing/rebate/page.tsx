...
const PAGE = "Rebate";
const KPIS = [{"l":"ARR (€M)","v":"€33.4M","t":"+8.0%","d":"up"},{"l":"MRR (€)","v":"€35143","t":"-3.3%","d":"down"},{"l":"Churn (%)","v":"72.6%","t":"+1.2%","d":"up"},{"l":"ARPU (€)","v":"€74996","t":"+3.8%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 1406.90","3.744","€ 19172.23","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 15377.13","7.238","€ 30129.49","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 49987.72","2.471","€ 23206.87","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 32415.63","8.827","€ 13559.28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 34135.38","597","€ 45079.54","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":886},{"label":"Mar","value":1006},{"label":"Abr","value":797},{"label":"Mai","value":795},{"label":"Jun","value":1047},{"label":"Jul","value":1037},{"label":"Ago","value":739},{"label":"Set","value":1030},{"label":"Out","value":784},{"label":"Nov","value":814},{"label":"Dez","value":936}];
const MX = 1047;
