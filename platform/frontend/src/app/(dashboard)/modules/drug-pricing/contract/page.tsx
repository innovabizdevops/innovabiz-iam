...
const PAGE = "Contracting";
const KPIS = [{"l":"ARR (€M)","v":"€51.0M","t":"+17.3%","d":"up"},{"l":"MRR (€)","v":"€80134","t":"-0.2%","d":"down"},{"l":"Churn (%)","v":"65.5%","t":"+5.0%","d":"up"},{"l":"ARPU (€)","v":"€32072","t":"+3.3%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 31090.07","159","€ 12662.46","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 49275.46","3.301","€ 47710.23","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 8495.37","2.508","€ 8753.52","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 37107.40","5.675","€ 35977.08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 4950.13","7.549","€ 21121.37","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":440},{"label":"Fev","value":569},{"label":"Mar","value":699},{"label":"Abr","value":360},{"label":"Mai","value":564},{"label":"Jun","value":705},{"label":"Jul","value":453},{"label":"Ago","value":400},{"label":"Set","value":418},{"label":"Out","value":751},{"label":"Nov","value":394},{"label":"Dez","value":557}];
const MX = 751;
