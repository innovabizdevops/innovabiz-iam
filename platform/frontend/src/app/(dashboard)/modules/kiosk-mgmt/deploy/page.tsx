...
const PAGE = "Deploy";
const KPIS = [{"l":"Total Kiosk Mgmt","v":"639","t":"+6.4%","d":"up"},{"l":"Deploy Ativos","v":"1.006","t":"+1.8%","d":"up"},{"l":"Eficiência (%)","v":"88.4%","t":"+1.9%","d":"up"},{"l":"Score Performance","v":"91","t":"+6.0%","d":"up"}];
const COLS = ["ID","Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kiosk Mgmt #001","Kiosk Mgmt #002","5.470","8.764","2026-01-20","Ativo"],"status":"active"},{"id":"r1","cells":["Kiosk Mgmt #002","Kiosk Mgmt #003","5.706","217","2026-01-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Kiosk Mgmt #003","Kiosk Mgmt #004","4.927","5.939","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Kiosk Mgmt #004","Kiosk Mgmt #005","5.384","7.505","2026-02-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kiosk Mgmt #005","Kiosk Mgmt #001","5.165","7.167","2026-03-28","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":525},{"label":"Fev","value":436},{"label":"Mar","value":334},{"label":"Abr","value":646},{"label":"Mai","value":401},{"label":"Jun","value":432},{"label":"Jul","value":300},{"label":"Ago","value":584},{"label":"Set","value":435},{"label":"Out","value":533},{"label":"Nov","value":537},{"label":"Dez","value":635}];
const MX = 646;
