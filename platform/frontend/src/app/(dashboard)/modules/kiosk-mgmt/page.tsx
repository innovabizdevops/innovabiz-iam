...
const KPIS = [
    { label: "Total Registos", value: "5292", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2269", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€326K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "89%", trend: "+25%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1057968692", cells: ["KIO-1692", "Kiosk Management Item 1", "5/9/2026", "€18 792"], status: "active" as const },
    { id: "1057972263", cells: ["KIO-5263", "Kiosk Management Item 2", "20/4/2026", "€22 363"], status: "pending" as const },
    { id: "1057975834", cells: ["KIO-8834", "Kiosk Management Item 3", "7/11/2026", "€25 934"], status: "completed" as const },
    { id: "1057979405", cells: ["KIO-3405", "Kiosk Management Item 4", "22/6/2026", "€29 505"], status: "warning" as const },
    { id: "1057982976", cells: ["KIO-6976", "Kiosk Management Item 5", "9/1/2026", "€33 076"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Kiosk Management</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Kiosk Management</p>
                    </div>
                </div>
