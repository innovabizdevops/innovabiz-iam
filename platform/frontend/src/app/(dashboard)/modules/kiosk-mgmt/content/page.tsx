...
const PAGE = "Content";
const KPIS = [{"l":"Total Kiosk Mgmt","v":"858","t":"+4.1%","d":"up"},{"l":"Content Ativos","v":"1.902","t":"+10.5%","d":"up"},{"l":"Eficiência (%)","v":"86.9%","t":"+10.2%","d":"up"},{"l":"Score Performance","v":"65","t":"+15.0%","d":"up"}];
const COLS = ["ID","Content","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kiosk Mgmt #001","Kiosk Mgmt #002","682","5.027","2026-03-04","Ativo"],"status":"active"},{"id":"r1","cells":["Kiosk Mgmt #002","Kiosk Mgmt #003","6.088","6.003","2026-02-01","Pendente"],"status":"pending"},{"id":"r2","cells":["Kiosk Mgmt #003","Kiosk Mgmt #004","2.857","5.347","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Kiosk Mgmt #004","Kiosk Mgmt #005","7.295","2.058","2026-02-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kiosk Mgmt #005","Kiosk Mgmt #001","8.039","8.996","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":481},{"label":"Mar","value":704},{"label":"Abr","value":390},{"label":"Mai","value":739},{"label":"Jun","value":554},{"label":"Jul","value":683},{"label":"Ago","value":555},{"label":"Set","value":509},{"label":"Out","value":614},{"label":"Nov","value":449},{"label":"Dez","value":643}];
const MX = 739;
