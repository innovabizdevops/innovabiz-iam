...
const PAGE = "Maintain";
const KPIS = [{"l":"Total Kiosk Mgmt","v":"8.877","t":"+10.0%","d":"up"},{"l":"Maintain Ativos","v":"3.638","t":"+9.2%","d":"up"},{"l":"Eficiência (%)","v":"70.4%","t":"-1.9%","d":"down"},{"l":"Score Performance","v":"64","t":"+3.4%","d":"up"}];
const COLS = ["ID","Maintain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kiosk Mgmt #001","Kiosk Mgmt #002","1.238","8.260","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Kiosk Mgmt #002","Kiosk Mgmt #003","2.275","2.795","2026-03-25","Pendente"],"status":"pending"},{"id":"r2","cells":["Kiosk Mgmt #003","Kiosk Mgmt #004","8.098","3.447","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["Kiosk Mgmt #004","Kiosk Mgmt #005","5.438","6.591","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kiosk Mgmt #005","Kiosk Mgmt #001","2.569","6.731","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":542},{"label":"Fev","value":860},{"label":"Mar","value":822},{"label":"Abr","value":566},{"label":"Mai","value":860},{"label":"Jun","value":659},{"label":"Jul","value":772},{"label":"Ago","value":828},{"label":"Set","value":540},{"label":"Out","value":619},{"label":"Nov","value":629},{"label":"Dez","value":595}];
const MX = 860;
