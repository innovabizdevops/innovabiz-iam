...
const PAGE = "Revenue";
const KPIS = [{"l":"ARR (€M)","v":"€47.2M","t":"+0.2%","d":"up"},{"l":"MRR (€)","v":"€39790","t":"+8.6%","d":"up"},{"l":"Churn (%)","v":"74.0%","t":"+0.5%","d":"up"},{"l":"ARPU (€)","v":"€25719","t":"-2.6%","d":"down"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 20216.31","2.126","€ 42393.64","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 36290.76","1.096","€ 12373.91","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 23059.29","6.276","€ 9807.56","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 50023.71","3.134","€ 8375.82","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 24189.10","9.039","€ 35062.93","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":622},{"label":"Fev","value":416},{"label":"Mar","value":663},{"label":"Abr","value":493},{"label":"Mai","value":432},{"label":"Jun","value":662},{"label":"Jul","value":588},{"label":"Ago","value":337},{"label":"Set","value":458},{"label":"Out","value":474},{"label":"Nov","value":555},{"label":"Dez","value":398}];
const MX = 663;
