...
const ACCENT = "#0e7490";
const MODULE = "Kiosk Management";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Kiosk Mgmt","v":"4.593","t":"+7.2%","d":"up"},{"l":"Monitor Ativos","v":"3.183","t":"+3.2%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+1.2%","d":"up"},{"l":"Score Performance","v":"85","t":"+11.3%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Kiosk Mgmt #001","Kiosk Mgmt #002","4.374","177","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Kiosk Mgmt #002","Kiosk Mgmt #003","2.068","516","2026-03-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Kiosk Mgmt #003","Kiosk Mgmt #004","7.803","6.141","2026-02-08","Concluído"],"status":"done"},{"id":"r3","cells":["Kiosk Mgmt #004","Kiosk Mgmt #005","4.909","895","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Kiosk Mgmt #005","Kiosk Mgmt #001","2.133","917","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":683},{"label":"Mar","value":941},{"label":"Abr","value":870},{"label":"Mai","value":771},{"label":"Jun","value":646},{"label":"Jul","value":850},{"label":"Ago","value":957},{"label":"Set","value":829},{"label":"Out","value":912},{"label":"Nov","value":794},{"label":"Dez","value":914}];
const MX = 957;
