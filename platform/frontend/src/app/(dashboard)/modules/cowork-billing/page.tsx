...
/* ═══ Cowork Billing Engine — Dashboard ═══ */

const ACCENT = "#3730a3";

const KPIS = [
    { label: "Total Registos", value: "1918", trend: "-19%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3308", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€312K", trend: "+7%", trendDirection: "up" as const, icon: DollarSign },
    { label: "Eficiência", value: "75%", trend: "-1%", trendDirection: "down" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "343828818", cells: ["COW-2818", "Cowork Billing Engine Item 1", "19/7/2026", "€28 918"], status: "active" as const },
    { id: "343832389", cells: ["COW-6389", "Cowork Billing Engine Item 2", "6/2/2026", "€32 489"], status: "pending" as const },
    { id: "343835960", cells: ["COW-9960", "Cowork Billing Engine Item 3", "21/9/2026", "€36 060"], status: "completed" as const },
    { id: "343839531", cells: ["COW-4531", "Cowork Billing Engine Item 4", "8/4/2026", "€39 631"], status: "warning" as const },
    { id: "343843102", cells: ["COW-8102", "Cowork Billing Engine Item 5", "23/11/2026", "€43 202"], status: "active" as const },
];
...
export default function CoworkBillingEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cowork Billing Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cowork Billing Engine</p>
                    </div>
                </div>
