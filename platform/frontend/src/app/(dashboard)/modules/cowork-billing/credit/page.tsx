...
const PAGE = "Credit";
const KPIS = [{"l":"Integrações Ativas","v":"8.325","t":"+4.7%","d":"up"},{"l":"Chamadas/Hora","v":"3662","t":"+4.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"72.4%","t":"+5.3%","d":"up"},{"l":"Latência Média (ms)","v":"81ms","t":"+7.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.810","5.801","83.6%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","6.992","6.111","73.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.381","789","74.5%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","7.670","7.805","94.1%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","5.697","9.083","86.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":653},{"label":"Fev","value":746},{"label":"Mar","value":568},{"label":"Abr","value":551},{"label":"Mai","value":525},{"label":"Jun","value":467},{"label":"Jul","value":423},{"label":"Ago","value":432},{"label":"Set","value":588},{"label":"Out","value":772},{"label":"Nov","value":564},{"label":"Dez","value":527}];
const MX = 772;
