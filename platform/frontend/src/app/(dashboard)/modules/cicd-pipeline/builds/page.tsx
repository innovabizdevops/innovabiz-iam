...
const PAGE = "Build Jobs";
const KPIS = [{"l":"Total Cicd Pipeline","v":"7.658","t":"-5.9%","d":"down"},{"l":"Build Jobs Ativos","v":"2.916","t":"+12.5%","d":"up"},{"l":"Eficiência (%)","v":"66.4%","t":"+12.1%","d":"up"},{"l":"Score Performance","v":"80","t":"-2.4%","d":"down"}];
const COLS = ["ID","Build Jobs","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","7.478","6.075","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","7.844","5.842","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","8.362","4.659","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","2.409","9.037","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","3.450","6.315","2026-01-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":499},{"label":"Fev","value":635},{"label":"Mar","value":866},{"label":"Abr","value":728},{"label":"Mai","value":546},{"label":"Jun","value":493},{"label":"Jul","value":801},{"label":"Ago","value":716},{"label":"Set","value":822},{"label":"Out","value":731},{"label":"Nov","value":693},{"label":"Dez","value":618}];
const MX = 866;
