...
const PAGE = "Deploy Stages";
const KPIS = [{"l":"Total Cicd Pipeline","v":"4.269","t":"-1.1%","d":"down"},{"l":"Deploy Stages Ativos","v":"9.017","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"83.8%","t":"-1.4%","d":"down"},{"l":"Score Performance","v":"84","t":"+17.4%","d":"up"}];
const COLS = ["ID","Deploy Stages","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","2.526","1.844","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","4.449","6.189","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","2.821","8.374","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","5.146","114","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","263","5.297","2026-03-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":454},{"label":"Fev","value":594},{"label":"Mar","value":481},{"label":"Abr","value":694},{"label":"Mai","value":446},{"label":"Jun","value":634},{"label":"Jul","value":392},{"label":"Ago","value":553},{"label":"Set","value":481},{"label":"Out","value":528},{"label":"Nov","value":514},{"label":"Dez","value":571}];
const MX = 694;
