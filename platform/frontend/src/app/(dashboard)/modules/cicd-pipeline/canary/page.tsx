...
const ACCENT = "#059669";
const MODULE = "CI/CD Pipeline";
const PAGE = "Canary Deploy";
const KPIS = [{"l":"Total Cicd Pipeline","v":"2.623","t":"-2.7%","d":"down"},{"l":"Canary Deploy Ativos","v":"1.480","t":"-1.0%","d":"down"},{"l":"Eficiência (%)","v":"71.3%","t":"-2.3%","d":"down"},{"l":"Score Performance","v":"77","t":"-3.3%","d":"down"}];
const COLS = ["ID","Canary Deploy","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","6.664","2.988","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","8.408","7.800","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","4.082","1.496","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","3.954","3.808","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","7.175","8.745","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":564},{"label":"Mar","value":544},{"label":"Abr","value":624},{"label":"Mai","value":587},{"label":"Jun","value":501},{"label":"Jul","value":373},{"label":"Ago","value":754},{"label":"Set","value":682},{"label":"Out","value":646},{"label":"Nov","value":611},{"label":"Dez","value":469}];
const MX = 754;
