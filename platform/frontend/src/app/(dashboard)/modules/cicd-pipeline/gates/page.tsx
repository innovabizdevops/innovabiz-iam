...
const PAGE = "Test Gates";
const KPIS = [{"l":"Total Cicd Pipeline","v":"5.836","t":"+7.7%","d":"up"},{"l":"Test Gates Ativos","v":"6.156","t":"+6.2%","d":"up"},{"l":"Eficiência (%)","v":"83.2%","t":"+2.2%","d":"up"},{"l":"Score Performance","v":"90","t":"+1.9%","d":"up"}];
const COLS = ["ID","Test Gates","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","437","9.075","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","1.056","2.432","2026-03-02","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","6.200","5.539","2026-03-02","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","6.571","3.910","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","8.675","805","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":750},{"label":"Fev","value":683},{"label":"Mar","value":541},{"label":"Abr","value":569},{"label":"Mai","value":841},{"label":"Jun","value":515},{"label":"Jul","value":704},{"label":"Ago","value":500},{"label":"Set","value":792},{"label":"Out","value":855},{"label":"Nov","value":683},{"label":"Dez","value":693}];
const MX = 855;
