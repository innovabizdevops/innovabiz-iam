...
const PAGE = "Rollback";
const KPIS = [{"l":"Total Cicd Pipeline","v":"2.395","t":"+11.4%","d":"up"},{"l":"Rollback Ativos","v":"3.235","t":"-2.4%","d":"down"},{"l":"Eficiência (%)","v":"93.2%","t":"+12.9%","d":"up"},{"l":"Score Performance","v":"82","t":"+0.0%","d":"up"}];
const COLS = ["ID","Rollback","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","3.936","2.681","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","1.176","1.800","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","6.274","2.498","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","5.935","335","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","3.574","794","2026-02-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":675},{"label":"Fev","value":405},{"label":"Mar","value":407},{"label":"Abr","value":627},{"label":"Mai","value":693},{"label":"Jun","value":589},{"label":"Jul","value":754},{"label":"Ago","value":491},{"label":"Set","value":527},{"label":"Out","value":632},{"label":"Nov","value":590},{"label":"Dez","value":659}];
const MX = 754;
