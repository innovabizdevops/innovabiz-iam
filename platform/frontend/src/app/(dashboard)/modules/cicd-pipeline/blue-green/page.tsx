...
const PAGE = "Blue-Green";
const KPIS = [{"l":"Total Cicd Pipeline","v":"6.269","t":"+12.0%","d":"up"},{"l":"Blue Green Ativos","v":"5.832","t":"-1.8%","d":"down"},{"l":"Eficiência (%)","v":"69.3%","t":"+9.2%","d":"up"},{"l":"Score Performance","v":"66","t":"+11.9%","d":"up"}];
const COLS = ["ID","Blue Green","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","6.435","1.314","2026-03-15","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","1.394","948","2026-03-10","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","3.607","6.819","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","8.481","8.303","2026-01-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","7.556","5.757","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":674},{"label":"Fev","value":550},{"label":"Mar","value":850},{"label":"Abr","value":690},{"label":"Mai","value":681},{"label":"Jun","value":571},{"label":"Jul","value":705},{"label":"Ago","value":467},{"label":"Set","value":720},{"label":"Out","value":617},{"label":"Nov","value":825},{"label":"Dez","value":561}];
const MX = 850;
