...
const PAGE = "Pipeline YAML";
const KPIS = [{"l":"Total Cicd Pipeline","v":"3.315","t":"-0.3%","d":"down"},{"l":"Pipeline YAML Ativos","v":"4.027","t":"+5.5%","d":"up"},{"l":"Eficiência (%)","v":"74.3%","t":"-3.1%","d":"down"},{"l":"Score Performance","v":"86","t":"-3.6%","d":"down"}];
const COLS = ["ID","Pipeline YAML","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cicd Pipeline #001","Cicd Pipeline #002","6.858","1.496","2026-02-11","Ativo"],"status":"active"},{"id":"r1","cells":["Cicd Pipeline #002","Cicd Pipeline #003","2.335","2.212","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Cicd Pipeline #003","Cicd Pipeline #004","4.537","7.421","2026-03-23","Concluído"],"status":"done"},{"id":"r3","cells":["Cicd Pipeline #004","Cicd Pipeline #005","4.915","6.269","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cicd Pipeline #005","Cicd Pipeline #001","4.730","2.845","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":439},{"label":"Fev","value":309},{"label":"Mar","value":473},{"label":"Abr","value":626},{"label":"Mai","value":615},{"label":"Jun","value":564},{"label":"Jul","value":591},{"label":"Ago","value":635},{"label":"Set","value":558},{"label":"Out","value":409},{"label":"Nov","value":641},{"label":"Dez","value":392}];
const MX = 641;
