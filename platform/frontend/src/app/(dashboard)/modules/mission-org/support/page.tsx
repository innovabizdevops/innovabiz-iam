...
const ACCENT = "#5b21b6";
const MODULE = "Mission Organization";
const PAGE = "Support";
const KPIS = [{"l":"Tickets Abertos","v":"7.055","t":"+9.7%","d":"up"},{"l":"SLA Cumprido (%)","v":"87.6%","t":"-0.4%","d":"down"},{"l":"MTTR (h)","v":"45h","t":"+1.6%","d":"up"},{"l":"Satisfação (%)","v":"91.5%","t":"+2.5%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","1.531","6.324","8.734","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","6.596","6.901","2.402","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","1.651","3.604","1.379","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","4.375","6.803","4.503","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","8.982","6.117","6.706","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":663},{"label":"Fev","value":651},{"label":"Mar","value":741},{"label":"Abr","value":854},{"label":"Mai","value":795},{"label":"Jun","value":667},{"label":"Jul","value":636},{"label":"Ago","value":652},{"label":"Set","value":947},{"label":"Out","value":815},{"label":"Nov","value":721},{"label":"Dez","value":683}];
const MX = 947;
