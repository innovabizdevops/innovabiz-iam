...
const PAGE = "Field";
const KPIS = [{"l":"Total Mission Org","v":"3.657","t":"+17.5%","d":"up"},{"l":"Field Ativos","v":"5.640","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"67.1%","t":"+7.8%","d":"up"},{"l":"Score Performance","v":"72","t":"+4.1%","d":"up"}];
const COLS = ["ID","Field","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Org #001","Mission Org #002","1.952","6.560","2026-01-05","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Org #002","Mission Org #003","433","8.924","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Org #003","Mission Org #004","2.852","5.928","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Org #004","Mission Org #005","5.136","4.045","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Org #005","Mission Org #001","1.343","6.669","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":839},{"label":"Fev","value":781},{"label":"Mar","value":825},{"label":"Abr","value":915},{"label":"Mai","value":1017},{"label":"Jun","value":757},{"label":"Jul","value":854},{"label":"Ago","value":852},{"label":"Set","value":963},{"label":"Out","value":885},{"label":"Nov","value":875},{"label":"Dez","value":1023}];
const MX = 1023;
