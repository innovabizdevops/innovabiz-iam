...
/* ═══ Mission Organization — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "3302", trend: "+3%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2161", trend: "-22%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€302K", trend: "+16%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "764976202", cells: ["MIS-4202", "Mission Organization Item 1", "19/11/2026", "€26 302"], status: "active" as const },
    { id: "764979773", cells: ["MIS-7773", "Mission Organization Item 2", "6/6/2026", "€29 873"], status: "pending" as const },
    { id: "764983344", cells: ["MIS-2344", "Mission Organization Item 3", "21/1/2026", "€33 444"], status: "completed" as const },
    { id: "764986915", cells: ["MIS-5915", "Mission Organization Item 4", "8/8/2026", "€37 015"], status: "warning" as const },
    { id: "764990486", cells: ["MIS-9486", "Mission Organization Item 5", "23/3/2026", "€40 586"], status: "active" as const },
];
...
export default function MissionOrganizationPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Mission Organization</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Mission Organization</p>
                    </div>
                </div>
