...
const PAGE = "Report";
const KPIS = [{"l":"Total Mission Org","v":"7.733","t":"-4.7%","d":"down"},{"l":"Report Ativos","v":"5.337","t":"+3.6%","d":"up"},{"l":"Eficiência (%)","v":"94.0%","t":"+12.8%","d":"up"},{"l":"Score Performance","v":"59","t":"+10.3%","d":"up"}];
const COLS = ["ID","Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Mission Org #001","Mission Org #002","4.295","4.248","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Mission Org #002","Mission Org #003","8.393","3.810","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Mission Org #003","Mission Org #004","3.159","6.176","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Mission Org #004","Mission Org #005","2.376","7.239","2026-03-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Mission Org #005","Mission Org #001","8.927","177","2026-01-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":969},{"label":"Fev","value":805},{"label":"Mar","value":1019},{"label":"Abr","value":904},{"label":"Mai","value":764},{"label":"Jun","value":1046},{"label":"Jul","value":696},{"label":"Ago","value":901},{"label":"Set","value":817},{"label":"Out","value":1064},{"label":"Nov","value":721},{"label":"Dez","value":1061}];
const MX = 1064;
