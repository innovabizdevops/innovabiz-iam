...
const PAGE = "Material";
const KPIS = [{"l":"Total Pallet Mfg","v":"4.300","t":"+1.9%","d":"up"},{"l":"Material Ativos","v":"8.605","t":"-5.1%","d":"down"},{"l":"Eficiência (%)","v":"93.3%","t":"-4.9%","d":"down"},{"l":"Score Performance","v":"67","t":"+1.0%","d":"up"}];
const COLS = ["ID","Material","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Mfg #001","Pallet Mfg #002","8.374","338","2026-01-19","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Mfg #002","Pallet Mfg #003","1.225","7.748","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Mfg #003","Pallet Mfg #004","6.595","3.529","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Mfg #004","Pallet Mfg #005","8.905","8.102","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Mfg #005","Pallet Mfg #001","6.338","5.508","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":505},{"label":"Mar","value":491},{"label":"Abr","value":640},{"label":"Mai","value":447},{"label":"Jun","value":428},{"label":"Jul","value":567},{"label":"Ago","value":690},{"label":"Set","value":418},{"label":"Out","value":556},{"label":"Nov","value":596},{"label":"Dez","value":517}];
const MX = 814;
