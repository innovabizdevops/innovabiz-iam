...
const ACCENT = "#166534";
const MODULE = "Pallet Manufacturing";
const PAGE = "Heat Treat";
const KPIS = [{"l":"Total Pallet Mfg","v":"1.076","t":"+2.8%","d":"up"},{"l":"Heat Treat Ativos","v":"9.080","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"94.1%","t":"+4.2%","d":"up"},{"l":"Score Performance","v":"84","t":"+1.2%","d":"up"}];
const COLS = ["ID","Heat Treat","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Mfg #001","Pallet Mfg #002","8.251","690","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Mfg #002","Pallet Mfg #003","499","8.758","2026-02-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Mfg #003","Pallet Mfg #004","3.036","8.663","2026-03-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Mfg #004","Pallet Mfg #005","1.771","1.539","2026-03-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Mfg #005","Pallet Mfg #001","5.199","3.850","2026-03-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":912},{"label":"Mar","value":833},{"label":"Abr","value":790},{"label":"Mai","value":873},{"label":"Jun","value":710},{"label":"Jul","value":798},{"label":"Ago","value":706},{"label":"Set","value":663},{"label":"Out","value":715},{"label":"Nov","value":636},{"label":"Dez","value":909}];
const MX = 912;
