...
const PAGE = "Assemble";
const KPIS = [{"l":"Total Pallet Mfg","v":"235","t":"+6.3%","d":"up"},{"l":"Assemble Ativos","v":"8.273","t":"-4.6%","d":"down"},{"l":"Eficiência (%)","v":"87.3%","t":"+6.3%","d":"up"},{"l":"Score Performance","v":"74","t":"+10.9%","d":"up"}];
const COLS = ["ID","Assemble","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Mfg #001","Pallet Mfg #002","7.752","7.545","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Mfg #002","Pallet Mfg #003","1.188","8.880","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Mfg #003","Pallet Mfg #004","6.494","4.633","2026-03-04","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Mfg #004","Pallet Mfg #005","5.450","2.558","2026-01-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Mfg #005","Pallet Mfg #001","6.907","1.745","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1004},{"label":"Fev","value":1013},{"label":"Mar","value":950},{"label":"Abr","value":980},{"label":"Mai","value":639},{"label":"Jun","value":921},{"label":"Jul","value":724},{"label":"Ago","value":757},{"label":"Set","value":908},{"label":"Out","value":951},{"label":"Nov","value":682},{"label":"Dez","value":838}];
const MX = 1013;
