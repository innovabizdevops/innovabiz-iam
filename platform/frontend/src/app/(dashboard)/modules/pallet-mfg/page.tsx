...
/* ═══ Pallet Manufacturing — Dashboard ═══ */

const ACCENT = "#166534";

const KPIS = [
    { label: "Total Registos", value: "7372", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4765", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€247K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1409450472", cells: ["PAL-6472", "Pallet Manufacturing Item 1", "25/1/2026", "€572"], status: "active" as const },
    { id: "1409454043", cells: ["PAL-1043", "Pallet Manufacturing Item 2", "12/8/2026", "€4143"], status: "pending" as const },
    { id: "1409457614", cells: ["PAL-4614", "Pallet Manufacturing Item 3", "27/3/2026", "€7714"], status: "completed" as const },
    { id: "1409461185", cells: ["PAL-8185", "Pallet Manufacturing Item 4", "14/10/2026", "€11 285"], status: "warning" as const },
    { id: "1409464756", cells: ["PAL-2756", "Pallet Manufacturing Item 5", "1/5/2026", "€14 856"], status: "active" as const },
];
...
export default function PalletManufacturingPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Pallet Manufacturing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Pallet Manufacturing</p>
                    </div>
                </div>
