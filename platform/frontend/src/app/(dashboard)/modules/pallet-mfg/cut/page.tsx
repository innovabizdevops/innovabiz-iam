...
const PAGE = "Cut";
const KPIS = [{"l":"Total Pallet Mfg","v":"2.267","t":"+10.2%","d":"up"},{"l":"Cut Ativos","v":"1.914","t":"+4.0%","d":"up"},{"l":"Eficiência (%)","v":"81.1%","t":"-2.2%","d":"down"},{"l":"Score Performance","v":"70","t":"+13.4%","d":"up"}];
const COLS = ["ID","Cut","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pallet Mfg #001","Pallet Mfg #002","6.301","3.108","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pallet Mfg #002","Pallet Mfg #003","2.431","4.262","2026-03-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Pallet Mfg #003","Pallet Mfg #004","3.961","7.972","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Pallet Mfg #004","Pallet Mfg #005","3.620","4.105","2026-02-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pallet Mfg #005","Pallet Mfg #001","4.115","344","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":545},{"label":"Fev","value":639},{"label":"Mar","value":468},{"label":"Abr","value":502},{"label":"Mai","value":476},{"label":"Jun","value":835},{"label":"Jul","value":736},{"label":"Ago","value":794},{"label":"Set","value":726},{"label":"Out","value":532},{"label":"Nov","value":700},{"label":"Dez","value":691}];
const MX = 835;
