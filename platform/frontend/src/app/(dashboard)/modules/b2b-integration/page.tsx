...
/* ═══ B2B Integration Platform — Dashboard ═══ */

const ACCENT = "#6366f1";

const KPIS = [
    { label: "Total Registos", value: "6000", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4175", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€404K", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "365820800", cells: ["B2B-7800", "B2B Integration Platform Item 1", "17/9/2026", "€20 900"], status: "active" as const },
    { id: "365824371", cells: ["B2B-2371", "B2B Integration Platform Item 2", "4/4/2026", "€24 471"], status: "pending" as const },
    { id: "365827942", cells: ["B2B-5942", "B2B Integration Platform Item 3", "19/11/2026", "€28 042"], status: "completed" as const },
    { id: "365831513", cells: ["B2B-9513", "B2B Integration Platform Item 4", "6/6/2026", "€31 613"], status: "warning" as const },
    { id: "365835084", cells: ["B2B-4084", "B2B Integration Platform Item 5", "21/1/2026", "€35 184"], status: "active" as const },
];
...
export default function B2bIntegrationPlatformPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">B2B Integration Platform</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • B2B Integration Platform</p>
                    </div>
                </div>
