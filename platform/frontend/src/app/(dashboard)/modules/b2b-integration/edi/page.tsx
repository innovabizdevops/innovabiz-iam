...
const PAGE = "EDI";
const KPIS = [{"l":"Pedidos/Dia","v":"3410","t":"+0.8%","d":"up"},{"l":"GMV (€)","v":"€2608","t":"+13.0%","d":"up"},{"l":"Conversão (%)","v":"84.6%","t":"-5.6%","d":"down"},{"l":"AOV (€)","v":"€71470","t":"-3.7%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17374.25","3.943","8.319","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2328.92","6.247","7.922","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 20026.14","2.775","5.218","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 40467.31","6.049","6.750","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 9432.38","2.640","5.894","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":946},{"label":"Fev","value":693},{"label":"Mar","value":741},{"label":"Abr","value":809},{"label":"Mai","value":740},{"label":"Jun","value":802},{"label":"Jul","value":605},{"label":"Ago","value":892},{"label":"Set","value":599},{"label":"Out","value":690},{"label":"Nov","value":691},{"label":"Dez","value":850}];
const MX = 946;
