...
const ACCENT = "#6366f1";
const MODULE = "B2B Integration Platform";
const PAGE = "API";
const KPIS = [{"l":"Pedidos/Dia","v":"4441","t":"+2.3%","d":"up"},{"l":"GMV (€)","v":"€42806","t":"-3.0%","d":"down"},{"l":"Conversão (%)","v":"66.0%","t":"+5.7%","d":"up"},{"l":"AOV (€)","v":"€52001","t":"-2.8%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 34799.95","7.841","8.060","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 35944.07","1.830","3.125","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 39542.55","2.164","1.220","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 28319.04","2.066","8.797","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 41463.14","735","2.439","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":697},{"label":"Fev","value":638},{"label":"Mar","value":807},{"label":"Abr","value":780},{"label":"Mai","value":812},{"label":"Jun","value":862},{"label":"Jul","value":870},{"label":"Ago","value":905},{"label":"Set","value":803},{"label":"Out","value":755},{"label":"Nov","value":805},{"label":"Dez","value":856}];
const MX = 905;
