...
const PAGE = "Comply";
const KPIS = [{"l":"Pedidos/Dia","v":"558","t":"-1.3%","d":"down"},{"l":"GMV (€)","v":"€56956","t":"+8.2%","d":"up"},{"l":"Conversão (%)","v":"81.2%","t":"+0.8%","d":"up"},{"l":"AOV (€)","v":"€80962","t":"+0.1%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 26075.96","7.477","319","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 42696.69","842","1.089","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 39578.59","4.045","3.069","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 16571.94","2.346","3.407","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 7878.10","4.207","2.940","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":342},{"label":"Mar","value":650},{"label":"Abr","value":353},{"label":"Mai","value":404},{"label":"Jun","value":544},{"label":"Jul","value":330},{"label":"Ago","value":484},{"label":"Set","value":668},{"label":"Out","value":576},{"label":"Nov","value":677},{"label":"Dez","value":459}];
const MX = 677;
