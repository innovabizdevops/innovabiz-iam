...
const PAGE = "Clear";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.619","t":"+13.7%","d":"up"},{"l":"RTO Médio (h)","v":"77h","t":"+16.4%","d":"up"},{"l":"RPO Médio (h)","v":"74h","t":"+0.0%","d":"up"},{"l":"Testes DR (YTD)","v":"3.925","t":"+4.3%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","150h","137h","2026-03-18","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","126h","117h","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","192h","106h","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","128h","34h","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","56h","206h","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":860},{"label":"Fev","value":623},{"label":"Mar","value":740},{"label":"Abr","value":953},{"label":"Mai","value":787},{"label":"Jun","value":659},{"label":"Jul","value":564},{"label":"Ago","value":745},{"label":"Set","value":801},{"label":"Out","value":751},{"label":"Nov","value":831},{"label":"Dez","value":942}];
const MX = 953;
