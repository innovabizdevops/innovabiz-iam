...
const PAGE = "Initiate";
const KPIS = [{"l":"BCP Plans Ativos","v":"548","t":"+12.5%","d":"up"},{"l":"RTO Médio (h)","v":"146h","t":"+17.7%","d":"up"},{"l":"RPO Médio (h)","v":"177h","t":"+14.4%","d":"up"},{"l":"Testes DR (YTD)","v":"7.341","t":"+0.8%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","19h","82h","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","10h","81h","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","193h","15h","2026-02-26","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","27h","70h","2026-01-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","176h","165h","2026-03-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":604},{"label":"Fev","value":643},{"label":"Mar","value":779},{"label":"Abr","value":432},{"label":"Mai","value":594},{"label":"Jun","value":516},{"label":"Jul","value":605},{"label":"Ago","value":661},{"label":"Set","value":410},{"label":"Out","value":531},{"label":"Nov","value":696},{"label":"Dez","value":508}];
const MX = 779;
