...
/* ═══ Payments (BIAN) — Dashboard ═══ */

const ACCENT = "#0891b2";

const KPIS = [
    { label: "Total Registos", value: "8367", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4579", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€115K", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1698353267", cells: ["BIA-9267", "Payments (BIAN) Item 1", "24/12/2026", "€3367"], status: "active" as const },
    { id: "1698356838", cells: ["BIA-3838", "Payments (BIAN) Item 2", "11/7/2026", "€6938"], status: "pending" as const },
    { id: "1698360409", cells: ["BIA-7409", "Payments (BIAN) Item 3", "26/2/2026", "€10 509"], status: "completed" as const },
    { id: "1698363980", cells: ["BIA-1980", "Payments (BIAN) Item 4", "13/9/2026", "€14 080"], status: "warning" as const },
    { id: "1698367551", cells: ["BIA-5551", "Payments (BIAN) Item 5", "28/4/2026", "€17 651"], status: "active" as const },
];
...
export default function PaymentsBianPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Payments (BIAN)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Payments (BIAN)</p>
                    </div>
                </div>
