...
const ACCENT = "#0891b2";
const MODULE = "Payments (BIAN)";
const PAGE = "Reconcile";
const KPIS = [{"l":"BCP Plans Ativos","v":"7.171","t":"+0.1%","d":"up"},{"l":"RTO Médio (h)","v":"173h","t":"+10.0%","d":"up"},{"l":"RPO Médio (h)","v":"199h","t":"-3.4%","d":"down"},{"l":"Testes DR (YTD)","v":"1.259","t":"+10.6%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","67h","132h","2026-01-02","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","194h","169h","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","31h","115h","2026-02-28","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","106h","108h","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","37h","60h","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":921},{"label":"Fev","value":840},{"label":"Mar","value":724},{"label":"Abr","value":730},{"label":"Mai","value":921},{"label":"Jun","value":719},{"label":"Jul","value":930},{"label":"Ago","value":682},{"label":"Set","value":640},{"label":"Out","value":835},{"label":"Nov","value":653},{"label":"Dez","value":734}];
const MX = 930;
