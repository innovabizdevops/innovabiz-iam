...
const KPIS = [{"l":"Utilizadores Ativos","v":"3.766","t":"+13.0%","d":"up"},{"l":"Sessões/Dia","v":"1179","t":"+8.0%","d":"up"},{"l":"MFA Adoção (%)","v":"82.0%","t":"+5.9%","d":"up"},{"l":"Tentativas Bloqueadas","v":"5.305","t":"+16.1%","d":"up"}];
const COLS = ["Utilizador","Papel","Último Login","MFA","Sessões","Estado"];
const ROWS = [{"id":"r0","cells":["admin@ibos.pt","joao.silva@corp.pt","6.118","8.771","1.806","Ativo"],"status":"active"},{"id":"r1","cells":["joao.silva@corp.pt","maria@parceiro.com","7.137","6.225","7.733","Pendente"],"status":"pending"},{"id":"r2","cells":["maria@parceiro.com","api-service@sys","4.464","2.735","870","Concluído"],"status":"done"},{"id":"r3","cells":["api-service@sys","audit@ibos.pt","8.098","1.070","8.378","Em Análise"],"status":"risk"},{"id":"r4","cells":["audit@ibos.pt","admin@ibos.pt","6.867","3.924","6.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":503},{"label":"Fev","value":483},{"label":"Mar","value":590},{"label":"Abr","value":369},{"label":"Mai","value":532},{"label":"Jun","value":300},{"label":"Jul","value":474},{"label":"Ago","value":651},{"label":"Set","value":576},{"label":"Out","value":351},{"label":"Nov","value":407},{"label":"Dez","value":295}];
const MX = 651;
