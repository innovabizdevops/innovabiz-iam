...
const PAGE = "Settle";
const KPIS = [{"l":"BCP Plans Ativos","v":"444","t":"+0.9%","d":"up"},{"l":"RTO Médio (h)","v":"61h","t":"+4.5%","d":"up"},{"l":"RPO Médio (h)","v":"41h","t":"+4.4%","d":"up"},{"l":"Testes DR (YTD)","v":"5.511","t":"+11.5%","d":"up"}];
const COLS = ["Plano","Sistema","RTO (h)","RPO (h)","Último Teste","Estado"];
const ROWS = [{"id":"r0","cells":["BCP-Core-Banking","BCP-ERP-Finance","37h","128h","2026-01-17","Ativo"],"status":"active"},{"id":"r1","cells":["BCP-ERP-Finance","BCP-CRM-Platform","73h","137h","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["BCP-CRM-Platform","DR-Database-Primary","204h","159h","2026-02-23","Concluído"],"status":"done"},{"id":"r3","cells":["DR-Database-Primary","DR-API-Gateway","69h","205h","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["DR-API-Gateway","BCP-Core-Banking","82h","93h","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":479},{"label":"Fev","value":638},{"label":"Mar","value":558},{"label":"Abr","value":482},{"label":"Mai","value":670},{"label":"Jun","value":439},{"label":"Jul","value":681},{"label":"Ago","value":354},{"label":"Set","value":721},{"label":"Out","value":404},{"label":"Nov","value":697},{"label":"Dez","value":667}];
const MX = 721;
