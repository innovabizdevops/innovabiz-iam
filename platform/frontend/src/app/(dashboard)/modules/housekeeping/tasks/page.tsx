...
const KPIS = [{"l":"Quartos Ocupados","v":"1.099","t":"+2.9%","d":"up"},{"l":"RevPAR (€)","v":"€35167","t":"+8.3%","d":"up"},{"l":"Ocupação (%)","v":"80.8%","t":"-3.8%","d":"down"},{"l":"Guest Satisfaction","v":"8.900","t":"+2.5%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","971","2026-01-17","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","6.011","2026-03-23","2026-01-10","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","2.604","2026-02-23","2026-01-06","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","7.045","2026-03-24","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","6.780","2026-02-24","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":731},{"label":"Fev","value":1022},{"label":"Mar","value":1001},{"label":"Abr","value":940},{"label":"Mai","value":1087},{"label":"Jun","value":982},{"label":"Jul","value":813},{"label":"Ago","value":835},{"label":"Set","value":962},{"label":"Out","value":762},{"label":"Nov","value":989},{"label":"Dez","value":921}];
const MX = 1087;
