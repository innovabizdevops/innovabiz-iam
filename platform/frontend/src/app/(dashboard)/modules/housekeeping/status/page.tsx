...
const PAGE = "Room Status";
const KPIS = [{"l":"Quartos Ocupados","v":"3.142","t":"+3.0%","d":"up"},{"l":"RevPAR (€)","v":"€12175","t":"-2.1%","d":"down"},{"l":"Ocupação (%)","v":"93.0%","t":"+1.5%","d":"up"},{"l":"Guest Satisfaction","v":"8.934","t":"+13.9%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","2.832","2026-03-26","2026-01-03","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","2.799","2026-02-05","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.313","2026-01-08","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.906","2026-01-27","2026-02-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","7.793","2026-02-02","2026-02-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":802},{"label":"Fev","value":689},{"label":"Mar","value":912},{"label":"Abr","value":836},{"label":"Mai","value":838},{"label":"Jun","value":640},{"label":"Jul","value":859},{"label":"Ago","value":896},{"label":"Set","value":914},{"label":"Out","value":925},{"label":"Nov","value":823},{"label":"Dez","value":897}];
const MX = 925;
