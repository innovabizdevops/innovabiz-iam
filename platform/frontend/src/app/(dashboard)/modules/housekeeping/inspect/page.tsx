...
const KPIS = [{"l":"Auditorias Realizadas","v":"3.131","t":"-4.4%","d":"down"},{"l":"NC Abertas","v":"6.801","t":"+2.7%","d":"up"},{"l":"Conformidade (%)","v":"82.1%","t":"-3.5%","d":"down"},{"l":"CAPAs Pendentes","v":"6.174","t":"+17.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.258","94.4%","6.984","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.039","98.3%","7.935","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","3.812","77.2%","2.991","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","5.108","75.4%","4.195","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","7.508","91.4%","5.249","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":414},{"label":"Fev","value":698},{"label":"Mar","value":420},{"label":"Abr","value":459},{"label":"Mai","value":642},{"label":"Jun","value":644},{"label":"Jul","value":482},{"label":"Ago","value":655},{"label":"Set","value":444},{"label":"Out","value":666},{"label":"Nov","value":746},{"label":"Dez","value":369}];
const MX = 746;
