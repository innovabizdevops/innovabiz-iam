...
const PAGE = "Safety";
const KPIS = [{"l":"Total Cobots Mgmt","v":"7.304","t":"+6.1%","d":"up"},{"l":"Safety Ativos","v":"322","t":"+7.2%","d":"up"},{"l":"Eficiência (%)","v":"92.7%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"76","t":"+14.0%","d":"up"}];
const COLS = ["ID","Safety","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobots Mgmt #001","Cobots Mgmt #002","3.212","2.951","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Cobots Mgmt #002","Cobots Mgmt #003","6.778","2.013","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobots Mgmt #003","Cobots Mgmt #004","4.854","6.070","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Cobots Mgmt #004","Cobots Mgmt #005","996","2.985","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobots Mgmt #005","Cobots Mgmt #001","7.773","3.129","2026-03-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":833},{"label":"Fev","value":803},{"label":"Mar","value":789},{"label":"Abr","value":646},{"label":"Mai","value":558},{"label":"Jun","value":698},{"label":"Jul","value":813},{"label":"Ago","value":576},{"label":"Set","value":673},{"label":"Out","value":713},{"label":"Nov","value":770},{"label":"Dez","value":729}];
const MX = 833;
