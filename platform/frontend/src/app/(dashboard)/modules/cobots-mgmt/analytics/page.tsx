...
const ACCENT = "#b45309";
const MODULE = "Cobots & Human-Robot";
const PAGE = "Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"2.956","t":"+12.4%","d":"up"},{"l":"Queries/Dia","v":"4028","t":"-4.3%","d":"down"},{"l":"Dados Processados (GB)","v":"7.003","t":"+9.0%","d":"up"},{"l":"Utilizadores Analytics","v":"6.058","t":"+4.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","922","2026-01-26","6.670","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3227","2026-02-07","8.286","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1233","2026-03-11","939","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4430","2026-02-16","1.321","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3380","2026-02-20","3.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":541},{"label":"Mar","value":651},{"label":"Abr","value":622},{"label":"Mai","value":525},{"label":"Jun","value":873},{"label":"Jul","value":610},{"label":"Ago","value":558},{"label":"Set","value":782},{"label":"Out","value":597},{"label":"Nov","value":764},{"label":"Dez","value":769}];
const MX = 873;
