...
/* ═══ Cobots & Human-Robot — Dashboard ═══ */

const ACCENT = "#b45309";

const KPIS = [
    { label: "Total Registos", value: "9007", trend: "-8%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "4472", trend: "+2%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€462K", trend: "+21%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "64022307", cells: ["COB-6307", "Cobots & Human-Robot Item 1", "28/4/2026", "€22 407"], status: "active" as const },
    { id: "64025878", cells: ["COB-9878", "Cobots & Human-Robot Item 2", "15/11/2026", "€25 978"], status: "pending" as const },
    { id: "64029449", cells: ["COB-4449", "Cobots & Human-Robot Item 3", "2/6/2026", "€29 549"], status: "completed" as const },
    { id: "64033020", cells: ["COB-8020", "Cobots & Human-Robot Item 4", "17/1/2026", "€33 120"], status: "warning" as const },
    { id: "64036591", cells: ["COB-2591", "Cobots & Human-Robot Item 5", "4/8/2026", "€36 691"], status: "active" as const },
];
...
export default function CobotsHumanrobotPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cobots & Human-Robot</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cobots & Human-Robot</p>
                    </div>
                </div>
