...
const PAGE = "Task";
const KPIS = [{"l":"Total Cobots Mgmt","v":"7.912","t":"-0.8%","d":"down"},{"l":"Task Ativos","v":"3.396","t":"+10.7%","d":"up"},{"l":"Eficiência (%)","v":"70.2%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"79","t":"+5.8%","d":"up"}];
const COLS = ["ID","Task","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cobots Mgmt #001","Cobots Mgmt #002","8.736","8.285","2026-02-08","Ativo"],"status":"active"},{"id":"r1","cells":["Cobots Mgmt #002","Cobots Mgmt #003","4.766","7.143","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Cobots Mgmt #003","Cobots Mgmt #004","5.896","5.707","2026-03-01","Concluído"],"status":"done"},{"id":"r3","cells":["Cobots Mgmt #004","Cobots Mgmt #005","7.180","6.358","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cobots Mgmt #005","Cobots Mgmt #001","2.832","983","2026-03-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":629},{"label":"Mar","value":660},{"label":"Abr","value":729},{"label":"Mai","value":482},{"label":"Jun","value":689},{"label":"Jul","value":715},{"label":"Ago","value":363},{"label":"Set","value":397},{"label":"Out","value":488},{"label":"Nov","value":649},{"label":"Dez","value":681}];
const MX = 729;
