...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"7.796","t":"+3.4%","d":"up"},{"l":"Submissões/Dia","v":"2489","t":"+13.7%","d":"up"},{"l":"Documentos Gerados","v":"286","t":"+16.4%","d":"up"},{"l":"Templates","v":"7.727","t":"+8.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.373","2026-03-22","1.009","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.851","2026-01-21","852","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.106","2026-01-04","1.943","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.418","2026-01-10","727","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","6.963","2026-02-01","791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":373},{"label":"Fev","value":455},{"label":"Mar","value":691},{"label":"Abr","value":717},{"label":"Mai","value":718},{"label":"Jun","value":599},{"label":"Jul","value":434},{"label":"Ago","value":553},{"label":"Set","value":668},{"label":"Out","value":728},{"label":"Nov","value":618},{"label":"Dez","value":712}];
const MX = 728;
