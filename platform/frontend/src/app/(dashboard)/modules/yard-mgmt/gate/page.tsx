...
const PAGE = "Gate Check";
const KPIS = [{"l":"Total Yard Mgmt","v":"2.103","t":"+6.7%","d":"up"},{"l":"Gate Check Ativos","v":"6.895","t":"+15.7%","d":"up"},{"l":"Eficiência (%)","v":"69.4%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"84","t":"+0.1%","d":"up"}];
const COLS = ["ID","Gate Check","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yard Mgmt #001","2026-01-11","7.833","8.407","2026-03-13","Ativo"],"status":"active"},{"id":"r1","cells":["Yard Mgmt #002","2026-01-08","7.705","7.181","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Yard Mgmt #003","2026-01-28","2.408","7.167","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Yard Mgmt #004","2026-03-20","6.273","3.257","2026-03-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yard Mgmt #005","2026-02-26","3.996","6.963","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":620},{"label":"Fev","value":430},{"label":"Mar","value":501},{"label":"Abr","value":371},{"label":"Mai","value":406},{"label":"Jun","value":600},{"label":"Jul","value":653},{"label":"Ago","value":662},{"label":"Set","value":601},{"label":"Out","value":533},{"label":"Nov","value":464},{"label":"Dez","value":373}];
const MX = 662;
