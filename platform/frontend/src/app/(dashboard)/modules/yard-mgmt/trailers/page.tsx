...
const PAGE = "Trailer Track";
const KPIS = [{"l":"Veículos Operação","v":"1.460","t":"+4.2%","d":"up"},{"l":"Viagens/Dia","v":"1549","t":"+6.9%","d":"up"},{"l":"Pontualidade (%)","v":"78.3%","t":"+13.2%","d":"up"},{"l":"Passageiros/Dia","v":"1978","t":"+2.0%","d":"up"}];
const COLS = ["Linha","Veículo","Partida","Chegada","Passageiros","Estado"];
const ROWS = [{"id":"r0","cells":["Metro Linha Azul","Bus Rota 42","2026-03-12","2026-01-18","1.956","Ativo"],"status":"active"},{"id":"r1","cells":["Bus Rota 42","Tram Linha 28","2026-01-08","2026-02-15","3.176","Pendente"],"status":"pending"},{"id":"r2","cells":["Tram Linha 28","Comboio IC 501","2026-02-13","2026-01-03","1.440","Concluído"],"status":"done"},{"id":"r3","cells":["Comboio IC 501","Elétrico Rota 15","2026-01-26","2026-02-22","5.972","Em Análise"],"status":"risk"},{"id":"r4","cells":["Elétrico Rota 15","Metro Linha Azul","2026-03-17","2026-02-23","7.177","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":690},{"label":"Mar","value":749},{"label":"Abr","value":654},{"label":"Mai","value":696},{"label":"Jun","value":622},{"label":"Jul","value":508},{"label":"Ago","value":827},{"label":"Set","value":752},{"label":"Out","value":653},{"label":"Nov","value":741},{"label":"Dez","value":665}];
const MX = 827;
