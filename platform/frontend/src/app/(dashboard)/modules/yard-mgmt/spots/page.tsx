...
const PAGE = "Spot Assign";
const KPIS = [{"l":"Total Yard Mgmt","v":"8.569","t":"+12.3%","d":"up"},{"l":"Spot Assign Ativos","v":"3.863","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"90.4%","t":"-1.1%","d":"down"},{"l":"Score Performance","v":"87","t":"-3.8%","d":"down"}];
const COLS = ["ID","Spot Assign","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yard Mgmt #001","Yard Mgmt #002","8.434","8.304","2026-03-17","Ativo"],"status":"active"},{"id":"r1","cells":["Yard Mgmt #002","Yard Mgmt #003","1.488","5.165","2026-02-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Yard Mgmt #003","Yard Mgmt #004","4.820","6.087","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Yard Mgmt #004","Yard Mgmt #005","2.308","6.041","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yard Mgmt #005","Yard Mgmt #001","1.319","5.883","2026-02-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":685},{"label":"Mar","value":735},{"label":"Abr","value":579},{"label":"Mai","value":776},{"label":"Jun","value":893},{"label":"Jul","value":923},{"label":"Ago","value":636},{"label":"Set","value":897},{"label":"Out","value":617},{"label":"Nov","value":620},{"label":"Dez","value":947}];
const MX = 947;
