...
const PAGE = "Move Request";
const KPIS = [{"l":"Total Yard Mgmt","v":"7.402","t":"-2.9%","d":"down"},{"l":"Move Request Ativos","v":"5.531","t":"+17.1%","d":"up"},{"l":"Eficiência (%)","v":"72.8%","t":"+10.3%","d":"up"},{"l":"Score Performance","v":"57","t":"+7.5%","d":"up"}];
const COLS = ["ID","Move Request","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yard Mgmt #001","Yard Mgmt #002","3.884","4.865","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Yard Mgmt #002","Yard Mgmt #003","1.175","8.961","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Yard Mgmt #003","Yard Mgmt #004","1.697","4.366","2026-02-22","Concluído"],"status":"done"},{"id":"r3","cells":["Yard Mgmt #004","Yard Mgmt #005","4.852","3.397","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yard Mgmt #005","Yard Mgmt #001","6.140","237","2026-03-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":670},{"label":"Mar","value":582},{"label":"Abr","value":476},{"label":"Mai","value":589},{"label":"Jun","value":431},{"label":"Jul","value":447},{"label":"Ago","value":352},{"label":"Set","value":347},{"label":"Out","value":575},{"label":"Nov","value":538},{"label":"Dez","value":551}];
const MX = 670;
