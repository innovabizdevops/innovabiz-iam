...
const ACCENT = "#1d4ed8";
const MODULE = "Yard Management";
const PAGE = "Dwell Report";
const KPIS = [{"l":"Total Yard Mgmt","v":"7.939","t":"+1.1%","d":"up"},{"l":"Dwell Report Ativos","v":"4.980","t":"+8.1%","d":"up"},{"l":"Eficiência (%)","v":"94.6%","t":"+17.7%","d":"up"},{"l":"Score Performance","v":"85","t":"+16.5%","d":"up"}];
const COLS = ["ID","Dwell Report","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Yard Mgmt #001","Yard Mgmt #002","2.166","1.939","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Yard Mgmt #002","Yard Mgmt #003","8.977","3.985","2026-03-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Yard Mgmt #003","Yard Mgmt #004","545","4.152","2026-03-18","Concluído"],"status":"done"},{"id":"r3","cells":["Yard Mgmt #004","Yard Mgmt #005","3.690","7.786","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Yard Mgmt #005","Yard Mgmt #001","3.752","6.904","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":554},{"label":"Fev","value":503},{"label":"Mar","value":532},{"label":"Abr","value":353},{"label":"Mai","value":484},{"label":"Jun","value":639},{"label":"Jul","value":636},{"label":"Ago","value":630},{"label":"Set","value":413},{"label":"Out","value":432},{"label":"Nov","value":407},{"label":"Dez","value":388}];
const MX = 639;
