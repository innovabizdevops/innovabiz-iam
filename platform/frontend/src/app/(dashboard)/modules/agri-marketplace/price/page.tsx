...
const ACCENT = "#6366f1";
const MODULE = "Agri Marketplace";
const PAGE = "Price";
const KPIS = [{"l":"Pedidos/Dia","v":"897","t":"+3.8%","d":"up"},{"l":"GMV (€)","v":"€74508","t":"+5.6%","d":"up"},{"l":"Conversão (%)","v":"79.1%","t":"+5.2%","d":"up"},{"l":"AOV (€)","v":"€57433","t":"+2.8%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 42082.47","2.121","6.108","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 19925.23","8.901","1.414","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 20252.25","2.498","8.468","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 27420.33","3.297","6.307","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 24810.55","1.653","2.737","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1031},{"label":"Fev","value":1010},{"label":"Mar","value":1044},{"label":"Abr","value":988},{"label":"Mai","value":1037},{"label":"Jun","value":750},{"label":"Jul","value":679},{"label":"Ago","value":727},{"label":"Set","value":983},{"label":"Out","value":664},{"label":"Nov","value":1004},{"label":"Dez","value":842}];
const MX = 1044;
