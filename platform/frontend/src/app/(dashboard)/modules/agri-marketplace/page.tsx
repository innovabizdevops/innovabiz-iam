...
export default function AgriMarketplacePage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Agri Marketplace</h1><p className="text-sm text-muted-foreground">Agri Marketplace • iBOS Enterprise</p></div>
