...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"8.762","t":"+3.3%","d":"up"},{"l":"Submissões/Dia","v":"3612","t":"+0.7%","d":"up"},{"l":"Documentos Gerados","v":"1.075","t":"+13.0%","d":"up"},{"l":"Templates","v":"800","t":"+7.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.199","2026-03-18","6.479","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.301","2026-02-22","5.488","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.514","2026-02-28","8.420","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.433","2026-02-26","5.295","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.830","2026-02-05","5.136","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":550},{"label":"Fev","value":590},{"label":"Mar","value":509},{"label":"Abr","value":531},{"label":"Mai","value":537},{"label":"Jun","value":706},{"label":"Jul","value":744},{"label":"Ago","value":414},{"label":"Set","value":590},{"label":"Out","value":468},{"label":"Nov","value":484},{"label":"Dez","value":429}];
const MX = 744;
