...
/* ═══ Multi-Automation Orchestrator — Dashboard ═══ */

const ACCENT = "#0ea5e9";

const KPIS = [
    { label: "Total Registos", value: "6090", trend: "+16%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4432", trend: "+10%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€220K", trend: "-4%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "99%", trend: "+23%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "320459090", cells: ["MUL-6090", "Multi-Automation Orchestrator Item 1", "15/3/2026", "€9190"], status: "active" as const },
    { id: "320462661", cells: ["MUL-9661", "Multi-Automation Orchestrator Item 2", "2/10/2026", "€12 761"], status: "pending" as const },
    { id: "320466232", cells: ["MUL-4232", "Multi-Automation Orchestrator Item 3", "17/5/2026", "€16 332"], status: "completed" as const },
    { id: "320469803", cells: ["MUL-7803", "Multi-Automation Orchestrator Item 4", "4/12/2026", "€19 903"], status: "warning" as const },
    { id: "320473374", cells: ["MUL-2374", "Multi-Automation Orchestrator Item 5", "19/7/2026", "€23 474"], status: "active" as const },
];
...
export default function MultiautomationOrchestratorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Multi-Automation Orchestrator</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Multi-Automation Orchestrator</p>
                    </div>
                </div>
