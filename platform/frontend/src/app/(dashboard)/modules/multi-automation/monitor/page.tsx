...
const ACCENT = "#0ea5e9";
const MODULE = "Multi-Automation Orchestrator";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Multi Automation","v":"3.498","t":"+9.4%","d":"up"},{"l":"Monitor Ativos","v":"8.570","t":"+2.2%","d":"up"},{"l":"Eficiência (%)","v":"71.8%","t":"+8.8%","d":"up"},{"l":"Score Performance","v":"74","t":"+0.2%","d":"up"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Multi Automation #001","Multi Automation #002","5.708","7.776","2026-03-19","Ativo"],"status":"active"},{"id":"r1","cells":["Multi Automation #002","Multi Automation #003","3.764","2.584","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Multi Automation #003","Multi Automation #004","5.268","4.944","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Multi Automation #004","Multi Automation #005","278","5.798","2026-03-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Multi Automation #005","Multi Automation #001","2.507","3.206","2026-02-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":896},{"label":"Mar","value":853},{"label":"Abr","value":849},{"label":"Mai","value":890},{"label":"Jun","value":891},{"label":"Jul","value":777},{"label":"Ago","value":1048},{"label":"Set","value":736},{"label":"Out","value":852},{"label":"Nov","value":931},{"label":"Dez","value":870}];
const MX = 1048;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0ea5e9'}}>RTM</span></h1>
                </div>
