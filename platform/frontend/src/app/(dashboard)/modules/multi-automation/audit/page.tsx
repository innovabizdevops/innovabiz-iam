...
const PAGE = "Audit";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.037","t":"-0.4%","d":"down"},{"l":"NC Abertas","v":"301","t":"+9.8%","d":"up"},{"l":"Conformidade (%)","v":"86.5%","t":"+0.8%","d":"up"},{"l":"CAPAs Pendentes","v":"3.440","t":"+1.9%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","4.536","89.4%","4.891","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","3.811","80.8%","5.643","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","2.727","73.2%","3.588","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.593","73.1%","3.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","5.845","88.5%","5.301","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":416},{"label":"Fev","value":608},{"label":"Mar","value":361},{"label":"Abr","value":464},{"label":"Mai","value":383},{"label":"Jun","value":585},{"label":"Jul","value":553},{"label":"Ago","value":236},{"label":"Set","value":326},{"label":"Out","value":351},{"label":"Nov","value":593},{"label":"Dez","value":382}];
const MX = 608;
