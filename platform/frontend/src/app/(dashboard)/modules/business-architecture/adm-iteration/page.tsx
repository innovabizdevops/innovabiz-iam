...
const ACCENT = "#7c3aed";
const MODULE = "Business Architecture";
const PAGE = "ADM Iteration";
const KPIS = [{"l":"Total Business Architecture","v":"357","t":"+16.7%","d":"up"},{"l":"ADM Iteration Ativos","v":"8.787","t":"+11.2%","d":"up"},{"l":"Eficiência (%)","v":"87.8%","t":"+9.5%","d":"up"},{"l":"Score Performance","v":"87","t":"+7.1%","d":"up"}];
const COLS = ["ID","ADM Iteration","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Business Architecture #001","Business Architecture #002","8.957","6.509","2026-03-26","Ativo"],"status":"active"},{"id":"r1","cells":["Business Architecture #002","Business Architecture #003","3.288","5.342","2026-02-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Business Architecture #003","Business Architecture #004","1.997","4.107","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Business Architecture #004","Business Architecture #005","7.182","4.374","2026-03-02","Em Análise"],"status":"risk"},{"id":"r4","cells":["Business Architecture #005","Business Architecture #001","5.752","2.004","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":690},{"label":"Mar","value":1041},{"label":"Abr","value":986},{"label":"Mai","value":880},{"label":"Jun","value":954},{"label":"Jul","value":1034},{"label":"Ago","value":704},{"label":"Set","value":970},{"label":"Out","value":675},{"label":"Nov","value":692},{"label":"Dez","value":796}];
const MX = 1041;
...
export default function AdmIterationPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c3aed'}}>TOGAF</span></h1>
                </div>
