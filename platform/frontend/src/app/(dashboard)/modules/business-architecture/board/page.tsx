...
const PAGE = "Architecture Board";
const KPIS = [{"l":"Teams Ativos","v":"5.800","t":"+1.3%","d":"up"},{"l":"Reuniões/Semana","v":"1649","t":"+9.4%","d":"up"},{"l":"Mensagens/Dia","v":"3691","t":"+13.9%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.911","t":"-5.3%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","4.305","1483","4.404","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.264","1021","1.002","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","984","1948","2.649","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","8.359","4677","7.866","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","7.515","4316","7.027","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":862},{"label":"Fev","value":1000},{"label":"Mar","value":694},{"label":"Abr","value":921},{"label":"Mai","value":951},{"label":"Jun","value":875},{"label":"Jul","value":795},{"label":"Ago","value":795},{"label":"Set","value":984},{"label":"Out","value":946},{"label":"Nov","value":858},{"label":"Dez","value":928}];
const MX = 1000;
