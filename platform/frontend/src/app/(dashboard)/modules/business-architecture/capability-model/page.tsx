...
const PAGE = "Capability Model";
const KPIS = [{"l":"Auditorias Realizadas","v":"6.470","t":"+0.3%","d":"up"},{"l":"NC Abertas","v":"8.605","t":"+8.0%","d":"up"},{"l":"Conformidade (%)","v":"79.0%","t":"+7.9%","d":"up"},{"l":"CAPAs Pendentes","v":"2.444","t":"+7.1%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","1.779","98.9%","4.948","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","7.350","84.4%","6.739","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.848","89.7%","7.676","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.527","88.9%","5.725","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","8.747","84.0%","4.114","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":640},{"label":"Fev","value":956},{"label":"Mar","value":608},{"label":"Abr","value":600},{"label":"Mai","value":959},{"label":"Jun","value":645},{"label":"Jul","value":819},{"label":"Ago","value":895},{"label":"Set","value":833},{"label":"Out","value":598},{"label":"Nov","value":951},{"label":"Dez","value":764}];
const MX = 959;
