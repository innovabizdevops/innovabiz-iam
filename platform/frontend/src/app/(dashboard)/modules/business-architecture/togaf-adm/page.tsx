...
const PAGE = "TOGAF ADM";
const KPIS = [{"l":"Total Business Architecture","v":"2.974","t":"+0.2%","d":"up"},{"l":"TOGAF ADM Ativos","v":"3.037","t":"+15.1%","d":"up"},{"l":"Eficiência (%)","v":"84.9%","t":"-3.8%","d":"down"},{"l":"Score Performance","v":"83","t":"+14.3%","d":"up"}];
const COLS = ["ID","TOGAF ADM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Business Architecture #001","Business Architecture #002","6.738","5.342","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Business Architecture #002","Business Architecture #003","7.449","4.274","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Business Architecture #003","Business Architecture #004","5.192","2.605","2026-03-13","Concluído"],"status":"done"},{"id":"r3","cells":["Business Architecture #004","Business Architecture #005","4.707","108","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Business Architecture #005","Business Architecture #001","7.663","1.585","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":492},{"label":"Fev","value":684},{"label":"Mar","value":699},{"label":"Abr","value":514},{"label":"Mai","value":426},{"label":"Jun","value":349},{"label":"Jul","value":343},{"label":"Ago","value":505},{"label":"Set","value":331},{"label":"Out","value":665},{"label":"Nov","value":427},{"label":"Dez","value":701}];
const MX = 701;
...
export default function TogafAdmPage() {
    return (
