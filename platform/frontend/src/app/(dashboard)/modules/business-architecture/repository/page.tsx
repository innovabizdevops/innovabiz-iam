...
const PAGE = "Architecture Repository";
const KPIS = [{"l":"Pedidos/Dia","v":"4688","t":"+2.9%","d":"up"},{"l":"GMV (€)","v":"€7500","t":"+12.5%","d":"up"},{"l":"Conversão (%)","v":"68.8%","t":"+14.2%","d":"up"},{"l":"AOV (€)","v":"€7326","t":"-2.6%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 17347.01","6.457","2.506","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 2730.04","4.319","4.605","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 19109.28","4.023","1.764","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 13012.67","3.516","2.028","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 40475.84","1.961","7.203","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":708},{"label":"Fev","value":382},{"label":"Mar","value":657},{"label":"Abr","value":597},{"label":"Mai","value":344},{"label":"Jun","value":531},{"label":"Jul","value":372},{"label":"Ago","value":716},{"label":"Set","value":568},{"label":"Out","value":423},{"label":"Nov","value":660},{"label":"Dez","value":688}];
const MX = 716;
