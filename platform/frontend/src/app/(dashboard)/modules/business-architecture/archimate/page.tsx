...
const PAGE = "ArchiMate Diagrams";
const KPIS = [{"l":"Diagramas Criados","v":"515","t":"+14.0%","d":"up"},{"l":"Templates","v":"4.594","t":"+4.6%","d":"up"},{"l":"Colaboradores","v":"1.968","t":"+4.4%","d":"up"},{"l":"Comentários/Semana","v":"280","t":"-1.9%","d":"down"}];
const COLS = ["Diagrama","Tipo","Criador","Última Edição","Partilhado","Estado"];
const ROWS = [{"id":"r0","cells":["Processo Onboarding BPMN","Org Chart 2026","6.082","2026-02-18","6.954","Ativo"],"status":"active"},{"id":"r1","cells":["Org Chart 2026","Network Topology","4.228","2026-03-28","4.457","Pendente"],"status":"pending"},{"id":"r2","cells":["Network Topology","Data Flow ETL","2.692","2026-03-05","5.658","Concluído"],"status":"done"},{"id":"r3","cells":["Data Flow ETL","User Journey Map","6.716","2026-01-06","8.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["User Journey Map","Processo Onboarding BPMN","2.311","2026-03-18","3.991","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":451},{"label":"Fev","value":636},{"label":"Mar","value":671},{"label":"Abr","value":503},{"label":"Mai","value":713},{"label":"Jun","value":716},{"label":"Jul","value":570},{"label":"Ago","value":657},{"label":"Set","value":698},{"label":"Out","value":647},{"label":"Nov","value":612},{"label":"Dez","value":449}];
const MX = 716;
...
export default function ArchimatePage() {
    return (
