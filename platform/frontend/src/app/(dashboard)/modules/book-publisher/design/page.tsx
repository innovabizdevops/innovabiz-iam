...
const PAGE = "Design";
const KPIS = [{"l":"Formulários Ativos","v":"3.139","t":"+1.2%","d":"up"},{"l":"Submissões/Dia","v":"2158","t":"+11.8%","d":"up"},{"l":"Documentos Gerados","v":"7.270","t":"-3.0%","d":"down"},{"l":"Templates","v":"8.547","t":"-4.8%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.195","2026-01-04","1.036","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","769","2026-01-23","5.747","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.847","2026-01-09","4.682","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.342","2026-01-11","2.415","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.613","2026-02-26","1.972","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":730},{"label":"Fev","value":634},{"label":"Mar","value":411},{"label":"Abr","value":363},{"label":"Mai","value":425},{"label":"Jun","value":420},{"label":"Jul","value":593},{"label":"Ago","value":511},{"label":"Set","value":469},{"label":"Out","value":502},{"label":"Nov","value":447},{"label":"Dez","value":607}];
const MX = 730;
