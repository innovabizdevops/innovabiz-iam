...
const PAGE = "Edit";
const KPIS = [{"l":"Integrações Ativas","v":"4.223","t":"+6.8%","d":"up"},{"l":"Chamadas/Hora","v":"2238","t":"-0.3%","d":"down"},{"l":"Taxa Sucesso (%)","v":"68.5%","t":"+1.1%","d":"up"},{"l":"Latência Média (ms)","v":"195ms","t":"-1.2%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","2.651","7.816","98.8%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","4.042","4.625","78.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","1.733","2.626","81.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","6.427","4.382","84.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.967","4.384","99.3%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":701},{"label":"Fev","value":773},{"label":"Mar","value":744},{"label":"Abr","value":770},{"label":"Mai","value":537},{"label":"Jun","value":479},{"label":"Jul","value":606},{"label":"Ago","value":472},{"label":"Set","value":569},{"label":"Out","value":479},{"label":"Nov","value":597},{"label":"Dez","value":398}];
const MX = 773;
