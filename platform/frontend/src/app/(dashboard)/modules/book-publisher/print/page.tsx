...
const PAGE = "Print";
const KPIS = [{"l":"Total Book Publisher","v":"981","t":"+2.1%","d":"up"},{"l":"Print Ativos","v":"1.259","t":"-3.4%","d":"down"},{"l":"Eficiência (%)","v":"79.8%","t":"-0.9%","d":"down"},{"l":"Score Performance","v":"71","t":"+1.7%","d":"up"}];
const COLS = ["ID","Print","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Book Publisher #001","Book Publisher #002","1.724","1.565","2026-01-08","Ativo"],"status":"active"},{"id":"r1","cells":["Book Publisher #002","Book Publisher #003","8.864","7.843","2026-02-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Book Publisher #003","Book Publisher #004","7.383","1.351","2026-03-26","Concluído"],"status":"done"},{"id":"r3","cells":["Book Publisher #004","Book Publisher #005","8.418","3.044","2026-01-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Book Publisher #005","Book Publisher #001","7.597","3.560","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":723},{"label":"Fev","value":389},{"label":"Mar","value":620},{"label":"Abr","value":732},{"label":"Mai","value":719},{"label":"Jun","value":634},{"label":"Jul","value":420},{"label":"Ago","value":754},{"label":"Set","value":707},{"label":"Out","value":734},{"label":"Nov","value":532},{"label":"Dez","value":596}];
const MX = 754;
