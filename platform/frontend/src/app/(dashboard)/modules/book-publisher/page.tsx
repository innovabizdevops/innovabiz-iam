...
/* ═══ Book Publisher — Dashboard ═══ */

const ACCENT = "#5b21b6";

const KPIS = [
    { label: "Total Registos", value: "5317", trend: "-18%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "3756", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€393K", trend: "+6%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2031247617", cells: ["BOO-2617", "Book Publisher Item 1", "22/10/2026", "€47 717"], status: "active" as const },
    { id: "2031251188", cells: ["BOO-6188", "Book Publisher Item 2", "9/5/2026", "€1288"], status: "pending" as const },
    { id: "2031254759", cells: ["BOO-9759", "Book Publisher Item 3", "24/12/2026", "€4859"], status: "completed" as const },
    { id: "2031258330", cells: ["BOO-4330", "Book Publisher Item 4", "11/7/2026", "€8430"], status: "warning" as const },
    { id: "2031261901", cells: ["BOO-7901", "Book Publisher Item 5", "26/2/2026", "€12 001"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Book Publisher</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Book Publisher</p>
                    </div>
                </div>
