...
const PAGE = "Equity";
const KPIS = [{"l":"Dashboards Ativos","v":"8.695","t":"+13.7%","d":"up"},{"l":"Queries/Dia","v":"4641","t":"+0.4%","d":"up"},{"l":"Dados Processados (GB)","v":"8.336","t":"+18.0%","d":"up"},{"l":"Utilizadores Analytics","v":"1.051","t":"+10.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4747","2026-01-01","119","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","892","2026-02-03","6.310","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","347","2026-03-04","7.847","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3530","2026-01-23","6.244","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3096","2026-01-19","116","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":623},{"label":"Mar","value":667},{"label":"Abr","value":817},{"label":"Mai","value":859},{"label":"Jun","value":927},{"label":"Jul","value":716},{"label":"Ago","value":681},{"label":"Set","value":717},{"label":"Out","value":872},{"label":"Nov","value":723},{"label":"Dez","value":894}];
const MX = 927;
