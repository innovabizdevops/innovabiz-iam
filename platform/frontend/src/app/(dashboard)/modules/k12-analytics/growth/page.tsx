...
const PAGE = "Growth";
const KPIS = [{"l":"Dashboards Ativos","v":"8.535","t":"+3.2%","d":"up"},{"l":"Queries/Dia","v":"3235","t":"+0.8%","d":"up"},{"l":"Dados Processados (GB)","v":"3.863","t":"+2.9%","d":"up"},{"l":"Utilizadores Analytics","v":"8.305","t":"+12.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5057","2026-03-19","2.204","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3027","2026-02-28","5.410","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","903","2026-03-12","167","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4912","2026-02-24","8.610","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2159","2026-03-18","4.842","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":688},{"label":"Fev","value":609},{"label":"Mar","value":925},{"label":"Abr","value":928},{"label":"Mai","value":957},{"label":"Jun","value":652},{"label":"Jul","value":936},{"label":"Ago","value":840},{"label":"Set","value":764},{"label":"Out","value":689},{"label":"Nov","value":907},{"label":"Dez","value":922}];
const MX = 957;
