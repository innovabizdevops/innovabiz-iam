...
const KPIS = [{"l":"Formulários Ativos","v":"2.603","t":"+9.6%","d":"up"},{"l":"Submissões/Dia","v":"3601","t":"+2.7%","d":"up"},{"l":"Documentos Gerados","v":"2.960","t":"-3.5%","d":"down"},{"l":"Templates","v":"7.479","t":"+5.2%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.158","2026-02-13","5.859","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","742","2026-03-28","1.750","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","337","2026-03-10","4.982","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.572","2026-03-18","1.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.425","2026-01-10","5.337","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":643},{"label":"Mar","value":511},{"label":"Abr","value":523},{"label":"Mai","value":610},{"label":"Jun","value":286},{"label":"Jul","value":330},{"label":"Ago","value":480},{"label":"Set","value":663},{"label":"Out","value":535},{"label":"Nov","value":547},{"label":"Dez","value":377}];
const MX = 663;
