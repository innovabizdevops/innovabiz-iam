...
const ACCENT = "#6366f1";
const MODULE = "K-12 Analytics";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"3.335","t":"+12.1%","d":"up"},{"l":"Queries/Dia","v":"3854","t":"+16.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.115","t":"+8.0%","d":"up"},{"l":"Utilizadores Analytics","v":"5.331","t":"+14.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3425","2026-02-22","4.671","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2999","2026-02-02","7.893","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3339","2026-03-07","4.726","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3581","2026-02-08","7.961","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3184","2026-02-10","3.943","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":771},{"label":"Fev","value":753},{"label":"Mar","value":828},{"label":"Abr","value":694},{"label":"Mai","value":841},{"label":"Jun","value":689},{"label":"Jul","value":890},{"label":"Ago","value":542},{"label":"Set","value":821},{"label":"Out","value":931},{"label":"Nov","value":650},{"label":"Dez","value":882}];
const MX = 931;
