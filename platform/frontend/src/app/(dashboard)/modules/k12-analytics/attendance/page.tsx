...
const KPIS = [{"l":"Dashboards Ativos","v":"2.700","t":"+5.6%","d":"up"},{"l":"Queries/Dia","v":"3991","t":"+9.3%","d":"up"},{"l":"Dados Processados (GB)","v":"1.527","t":"-2.8%","d":"down"},{"l":"Utilizadores Analytics","v":"7.812","t":"-0.4%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","134","2026-03-09","3.872","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","322","2026-02-15","4.031","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2004","2026-02-09","600","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","5033","2026-01-19","6.594","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","429","2026-01-07","7.560","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":455},{"label":"Fev","value":327},{"label":"Mar","value":319},{"label":"Abr","value":522},{"label":"Mai","value":343},{"label":"Jun","value":375},{"label":"Jul","value":465},{"label":"Ago","value":553},{"label":"Set","value":710},{"label":"Out","value":419},{"label":"Nov","value":596},{"label":"Dez","value":602}];
const MX = 710;
