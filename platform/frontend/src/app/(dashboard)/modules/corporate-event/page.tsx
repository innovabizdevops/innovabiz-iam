...
/* ═══ Corporate Event — Dashboard ═══ */

const ACCENT = "#be185d";

const KPIS = [
    { label: "Total Registos", value: "6339", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "869", trend: "+9%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€370K", trend: "-3%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "92%", trend: "+22%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "150862439", cells: ["COR-5439", "Corporate Event Item 1", "8/12/2026", "€12 539"], status: "active" as const },
    { id: "150866010", cells: ["COR-9010", "Corporate Event Item 2", "23/7/2026", "€16 110"], status: "pending" as const },
    { id: "150869581", cells: ["COR-3581", "Corporate Event Item 3", "10/2/2026", "€19 681"], status: "completed" as const },
    { id: "150873152", cells: ["COR-7152", "Corporate Event Item 4", "25/9/2026", "€23 252"], status: "warning" as const },
    { id: "150876723", cells: ["COR-1723", "Corporate Event Item 5", "12/4/2026", "€26 823"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Corporate Event</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Corporate Event</p>
                    </div>
                </div>
