...
const PAGE = "Calendar";
const KPIS = [{"l":"Total Case Mgmt Legal","v":"7.172","t":"-0.8%","d":"down"},{"l":"Calendar Ativos","v":"6.116","t":"+16.7%","d":"up"},{"l":"Eficiência (%)","v":"74.1%","t":"+3.6%","d":"up"},{"l":"Score Performance","v":"63","t":"+10.1%","d":"up"}];
const COLS = ["ID","Calendar","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Legal #001","Case Mgmt Legal #002","3.418","8.204","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Legal #002","Case Mgmt Legal #003","7.581","7.157","2026-02-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Legal #003","Case Mgmt Legal #004","942","493","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Legal #004","Case Mgmt Legal #005","5.248","5.196","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Legal #005","Case Mgmt Legal #001","8.206","126","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":710},{"label":"Fev","value":799},{"label":"Mar","value":967},{"label":"Abr","value":671},{"label":"Mai","value":866},{"label":"Jun","value":1019},{"label":"Jul","value":737},{"label":"Ago","value":918},{"label":"Set","value":852},{"label":"Out","value":845},{"label":"Nov","value":868},{"label":"Dez","value":703}];
const MX = 1019;
