...
const PAGE = "Intake";
const KPIS = [{"l":"Total Case Mgmt Legal","v":"4.660","t":"-0.9%","d":"down"},{"l":"Intake Ativos","v":"6.529","t":"-3.5%","d":"down"},{"l":"Eficiência (%)","v":"80.0%","t":"+13.7%","d":"up"},{"l":"Score Performance","v":"77","t":"+16.3%","d":"up"}];
const COLS = ["ID","Intake","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Legal #001","Case Mgmt Legal #002","7.396","2.689","2026-01-10","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Legal #002","Case Mgmt Legal #003","1.108","5.698","2026-01-28","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Legal #003","Case Mgmt Legal #004","7.604","5.903","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Legal #004","Case Mgmt Legal #005","5.830","1.613","2026-02-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Legal #005","Case Mgmt Legal #001","4.114","6.698","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":864},{"label":"Mar","value":802},{"label":"Abr","value":551},{"label":"Mai","value":791},{"label":"Jun","value":578},{"label":"Jul","value":725},{"label":"Ago","value":823},{"label":"Set","value":525},{"label":"Out","value":821},{"label":"Nov","value":564},{"label":"Dez","value":700}];
const MX = 864;
