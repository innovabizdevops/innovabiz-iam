...
const PAGE = "Deadline";
const KPIS = [{"l":"Total Case Mgmt Legal","v":"5.987","t":"+10.0%","d":"up"},{"l":"Deadline Ativos","v":"1.322","t":"+6.1%","d":"up"},{"l":"Eficiência (%)","v":"72.4%","t":"+10.5%","d":"up"},{"l":"Score Performance","v":"92","t":"+6.1%","d":"up"}];
const COLS = ["ID","Deadline","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Legal #001","Case Mgmt Legal #002","3.787","8.339","2026-01-11","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Legal #002","Case Mgmt Legal #003","4.626","2.448","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Legal #003","Case Mgmt Legal #004","6.189","6.449","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Legal #004","Case Mgmt Legal #005","5.934","4.131","2026-01-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Legal #005","Case Mgmt Legal #001","593","7.758","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":617},{"label":"Fev","value":724},{"label":"Mar","value":500},{"label":"Abr","value":554},{"label":"Mai","value":403},{"label":"Jun","value":677},{"label":"Jul","value":621},{"label":"Ago","value":769},{"label":"Set","value":481},{"label":"Out","value":476},{"label":"Nov","value":714},{"label":"Dez","value":649}];
const MX = 769;
