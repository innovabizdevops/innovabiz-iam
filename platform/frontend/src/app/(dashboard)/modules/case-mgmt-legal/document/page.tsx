...
const PAGE = "Document";
const KPIS = [{"l":"Formulários Ativos","v":"3.760","t":"+1.1%","d":"up"},{"l":"Submissões/Dia","v":"996","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"6.978","t":"-2.2%","d":"down"},{"l":"Templates","v":"2.854","t":"+10.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.864","2026-03-22","4.503","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.594","2026-01-11","1.080","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.100","2026-01-16","7.340","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","2.277","2026-01-22","1.569","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","446","2026-02-23","1.982","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":958},{"label":"Fev","value":867},{"label":"Mar","value":732},{"label":"Abr","value":994},{"label":"Mai","value":863},{"label":"Jun","value":964},{"label":"Jul","value":649},{"label":"Ago","value":890},{"label":"Set","value":647},{"label":"Out","value":925},{"label":"Nov","value":912},{"label":"Dez","value":676}];
const MX = 994;
