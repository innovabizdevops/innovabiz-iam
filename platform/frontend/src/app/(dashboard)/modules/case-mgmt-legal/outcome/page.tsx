...
const ACCENT = "#6366f1";
const MODULE = "Case Management";
const PAGE = "Outcome";
const KPIS = [{"l":"Total Case Mgmt Legal","v":"3.792","t":"-4.0%","d":"down"},{"l":"Outcome Ativos","v":"8.646","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"93.2%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"68","t":"+11.3%","d":"up"}];
const COLS = ["ID","Outcome","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Case Mgmt Legal #001","Case Mgmt Legal #002","2.245","1.805","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Case Mgmt Legal #002","Case Mgmt Legal #003","7.997","7.654","2026-03-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Case Mgmt Legal #003","Case Mgmt Legal #004","7.673","9.081","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["Case Mgmt Legal #004","Case Mgmt Legal #005","5.496","342","2026-01-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Case Mgmt Legal #005","Case Mgmt Legal #001","7.387","5.858","2026-01-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":357},{"label":"Fev","value":322},{"label":"Mar","value":606},{"label":"Abr","value":597},{"label":"Mai","value":278},{"label":"Jun","value":568},{"label":"Jul","value":562},{"label":"Ago","value":610},{"label":"Set","value":525},{"label":"Out","value":306},{"label":"Nov","value":588},{"label":"Dez","value":527}];
const MX = 610;
