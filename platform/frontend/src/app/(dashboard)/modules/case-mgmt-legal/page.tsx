...
export default function CaseMgmtLegalPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Case Mgmt Legal</h1><p className="text-sm text-muted-foreground">Case Mgmt Legal • iBOS Enterprise</p></div>
