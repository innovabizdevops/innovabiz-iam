...
const KPIS = [{"l":"Formulários Ativos","v":"5.733","t":"-5.7%","d":"down"},{"l":"Submissões/Dia","v":"2979","t":"+13.6%","d":"up"},{"l":"Documentos Gerados","v":"4.691","t":"+4.8%","d":"up"},{"l":"Templates","v":"5.761","t":"+1.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.868","2026-01-19","3.361","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.826","2026-01-11","3.921","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","3.888","2026-03-18","7.314","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.657","2026-03-27","5.553","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.803","2026-01-19","7.392","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":803},{"label":"Fev","value":930},{"label":"Mar","value":975},{"label":"Abr","value":694},{"label":"Mai","value":901},{"label":"Jun","value":762},{"label":"Jul","value":979},{"label":"Ago","value":902},{"label":"Set","value":668},{"label":"Out","value":709},{"label":"Nov","value":775},{"label":"Dez","value":668}];
const MX = 979;
