...
const PAGE = "Report Gen";
const KPIS = [{"l":"Formulários Ativos","v":"1.153","t":"-5.4%","d":"down"},{"l":"Submissões/Dia","v":"1209","t":"+2.9%","d":"up"},{"l":"Documentos Gerados","v":"1.262","t":"+14.1%","d":"up"},{"l":"Templates","v":"6.403","t":"-1.6%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.797","2026-03-05","4.978","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.190","2026-01-13","8.763","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.011","2026-01-27","2.582","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.675","2026-01-17","5.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.609","2026-01-22","6.129","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":625},{"label":"Fev","value":648},{"label":"Mar","value":509},{"label":"Abr","value":553},{"label":"Mai","value":426},{"label":"Jun","value":707},{"label":"Jul","value":384},{"label":"Ago","value":678},{"label":"Set","value":566},{"label":"Out","value":418},{"label":"Nov","value":526},{"label":"Dez","value":524}];
const MX = 707;
