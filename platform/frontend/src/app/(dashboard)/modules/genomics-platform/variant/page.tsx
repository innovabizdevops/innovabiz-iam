...
const ACCENT = "#7c3aed";
const MODULE = "Genomics Platform";
const PAGE = "Variant Call";
const KPIS = [{"l":"Formulários Ativos","v":"531","t":"-3.8%","d":"down"},{"l":"Submissões/Dia","v":"288","t":"+17.2%","d":"up"},{"l":"Documentos Gerados","v":"2.214","t":"-2.6%","d":"down"},{"l":"Templates","v":"8.531","t":"+6.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.340","2026-03-17","7.555","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","6.727","2026-03-28","9.054","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","2.625","2026-01-03","4.309","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.678","2026-02-08","8.037","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.281","2026-03-11","2.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":217},{"label":"Fev","value":437},{"label":"Mar","value":493},{"label":"Abr","value":294},{"label":"Mai","value":413},{"label":"Jun","value":325},{"label":"Jul","value":305},{"label":"Ago","value":215},{"label":"Set","value":364},{"label":"Out","value":408},{"label":"Nov","value":594},{"label":"Dez","value":388}];
const MX = 594;
