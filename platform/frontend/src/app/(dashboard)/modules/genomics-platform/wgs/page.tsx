...
const PAGE = "WGS Pipeline";
const KPIS = [{"l":"Formulários Ativos","v":"2.064","t":"-4.8%","d":"down"},{"l":"Submissões/Dia","v":"1354","t":"+8.0%","d":"up"},{"l":"Documentos Gerados","v":"6.987","t":"+1.0%","d":"up"},{"l":"Templates","v":"2.872","t":"+6.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","7.077","2026-01-22","4.451","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.952","2026-03-12","4.776","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","251","2026-02-19","880","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","947","2026-02-24","4.316","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","9.084","2026-01-07","2.375","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":925},{"label":"Fev","value":940},{"label":"Mar","value":995},{"label":"Abr","value":1070},{"label":"Mai","value":725},{"label":"Jun","value":739},{"label":"Jul","value":698},{"label":"Ago","value":725},{"label":"Set","value":793},{"label":"Out","value":881},{"label":"Nov","value":715},{"label":"Dez","value":1037}];
const MX = 1070;
...
export default function WgsPage() {
    return (
