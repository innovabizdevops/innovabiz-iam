...
const PAGE = "RNA-Seq AI";
const KPIS = [{"l":"Formulários Ativos","v":"4.675","t":"+13.3%","d":"up"},{"l":"Submissões/Dia","v":"2881","t":"-1.6%","d":"down"},{"l":"Documentos Gerados","v":"5.769","t":"+5.7%","d":"up"},{"l":"Templates","v":"6.382","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.661","2026-02-04","996","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.481","2026-03-25","6.814","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.557","2026-03-24","8.436","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.328","2026-02-13","3.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.359","2026-01-20","3.356","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":789},{"label":"Fev","value":896},{"label":"Mar","value":688},{"label":"Abr","value":830},{"label":"Mai","value":760},{"label":"Jun","value":830},{"label":"Jul","value":650},{"label":"Ago","value":760},{"label":"Set","value":899},{"label":"Out","value":988},{"label":"Nov","value":697},{"label":"Dez","value":863}];
const MX = 988;
