...
const PAGE = "Interpretation";
const KPIS = [{"l":"Formulários Ativos","v":"1.744","t":"+11.5%","d":"up"},{"l":"Submissões/Dia","v":"2343","t":"-1.0%","d":"down"},{"l":"Documentos Gerados","v":"2.442","t":"+4.5%","d":"up"},{"l":"Templates","v":"3.699","t":"+12.0%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.754","2026-01-26","5.500","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","7.578","2026-01-24","3.152","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.825","2026-02-16","5.513","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","1.490","2026-03-26","6.362","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","4.477","2026-01-07","1.210","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":601},{"label":"Fev","value":672},{"label":"Mar","value":630},{"label":"Abr","value":489},{"label":"Mai","value":589},{"label":"Jun","value":450},{"label":"Jul","value":580},{"label":"Ago","value":421},{"label":"Set","value":706},{"label":"Out","value":654},{"label":"Nov","value":573},{"label":"Dez","value":445}];
const MX = 706;
