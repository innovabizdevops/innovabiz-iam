...
const PAGE = "Sequencing";
const KPIS = [{"l":"Formulários Ativos","v":"8.349","t":"-5.6%","d":"down"},{"l":"Submissões/Dia","v":"4862","t":"+10.6%","d":"up"},{"l":"Documentos Gerados","v":"7.220","t":"+12.5%","d":"up"},{"l":"Templates","v":"5.575","t":"+0.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","5.090","2026-02-23","6.365","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","163","2026-03-20","5.332","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.099","2026-01-09","3.994","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.653","2026-03-23","4.499","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.014","2026-02-16","5.064","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":770},{"label":"Fev","value":887},{"label":"Mar","value":849},{"label":"Abr","value":567},{"label":"Mai","value":516},{"label":"Jun","value":565},{"label":"Jul","value":676},{"label":"Ago","value":607},{"label":"Set","value":691},{"label":"Out","value":815},{"label":"Nov","value":760},{"label":"Dez","value":611}];
const MX = 887;
