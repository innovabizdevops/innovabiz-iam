...
const PAGE = "Report";
const KPIS = [{"l":"Dashboards Ativos","v":"127","t":"+13.6%","d":"up"},{"l":"Queries/Dia","v":"1201","t":"+4.4%","d":"up"},{"l":"Dados Processados (GB)","v":"2.182","t":"+17.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.411","t":"+8.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1435","2026-03-24","6.525","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","781","2026-03-27","7.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3816","2026-03-08","7.394","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3399","2026-03-28","4.736","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","955","2026-02-04","6.403","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":292},{"label":"Fev","value":290},{"label":"Mar","value":300},{"label":"Abr","value":340},{"label":"Mai","value":596},{"label":"Jun","value":477},{"label":"Jul","value":442},{"label":"Ago","value":381},{"label":"Set","value":441},{"label":"Out","value":497},{"label":"Nov","value":336},{"label":"Dez","value":444}];
const MX = 596;
