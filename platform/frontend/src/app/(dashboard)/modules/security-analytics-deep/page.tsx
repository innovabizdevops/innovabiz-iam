...
/* ═══ Security Analytics Deep — Dashboard ═══ */

const ACCENT = "#94a3b8";

const KPIS = [
    { label: "Total Registos", value: "5201", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2464", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€139K", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "655474201", cells: ["SEC-5201", "Security Analytics Deep Item 1", "26/2/2026", "€24 301"], status: "active" as const },
    { id: "655477772", cells: ["SEC-8772", "Security Analytics Deep Item 2", "13/9/2026", "€27 872"], status: "pending" as const },
    { id: "655481343", cells: ["SEC-3343", "Security Analytics Deep Item 3", "28/4/2026", "€31 443"], status: "completed" as const },
    { id: "655484914", cells: ["SEC-6914", "Security Analytics Deep Item 4", "15/11/2026", "€35 014"], status: "warning" as const },
    { id: "655488485", cells: ["SEC-1485", "Security Analytics Deep Item 5", "2/6/2026", "€38 585"], status: "active" as const },
];
...
export default function SecurityAnalyticsDeepPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Security Analytics Deep</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Security Analytics Deep</p>
                    </div>
                </div>
