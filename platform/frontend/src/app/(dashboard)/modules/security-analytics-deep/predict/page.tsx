...
const ACCENT = "#94a3b8";
const MODULE = "Security Analytics Deep";
const PAGE = "Predict";
const KPIS = [{"l":"Dashboards Ativos","v":"5.056","t":"-1.9%","d":"down"},{"l":"Queries/Dia","v":"1566","t":"+10.3%","d":"up"},{"l":"Dados Processados (GB)","v":"8.076","t":"+17.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.508","t":"+0.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5087","2026-02-28","7.340","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2003","2026-03-05","915","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3515","2026-03-11","5.204","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1714","2026-03-12","7.359","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1509","2026-03-05","6.605","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":745},{"label":"Mar","value":769},{"label":"Abr","value":757},{"label":"Mai","value":880},{"label":"Jun","value":562},{"label":"Jul","value":609},{"label":"Ago","value":718},{"label":"Set","value":767},{"label":"Out","value":799},{"label":"Nov","value":708},{"label":"Dez","value":674}];
const MX = 880;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#94a3b8'}}>AI</span></h1>
                </div>
