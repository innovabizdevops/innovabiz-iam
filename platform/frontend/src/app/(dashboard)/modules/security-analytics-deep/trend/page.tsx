...
const PAGE = "Trend";
const KPIS = [{"l":"Dashboards Ativos","v":"1.545","t":"+0.8%","d":"up"},{"l":"Queries/Dia","v":"3827","t":"+7.7%","d":"up"},{"l":"Dados Processados (GB)","v":"8.828","t":"+3.7%","d":"up"},{"l":"Utilizadores Analytics","v":"591","t":"+15.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4823","2026-01-10","5.048","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1381","2026-01-09","8.993","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1696","2026-01-17","8.741","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3945","2026-01-14","5.644","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1224","2026-01-28","1.502","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":553},{"label":"Fev","value":671},{"label":"Mar","value":571},{"label":"Abr","value":627},{"label":"Mai","value":626},{"label":"Jun","value":691},{"label":"Jul","value":406},{"label":"Ago","value":661},{"label":"Set","value":698},{"label":"Out","value":564},{"label":"Nov","value":516},{"label":"Dez","value":666}];
const MX = 698;
