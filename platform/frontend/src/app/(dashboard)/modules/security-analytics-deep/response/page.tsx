...
const PAGE = "Response";
const KPIS = [{"l":"Dashboards Ativos","v":"3.177","t":"+15.4%","d":"up"},{"l":"Queries/Dia","v":"628","t":"-5.7%","d":"down"},{"l":"Dados Processados (GB)","v":"8.973","t":"-1.7%","d":"down"},{"l":"Utilizadores Analytics","v":"4.381","t":"+12.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","577","2026-03-07","290","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","782","2026-02-21","6.371","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2987","2026-01-02","4.793","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2485","2026-01-21","4.820","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","834","2026-02-12","6.552","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":561},{"label":"Mar","value":576},{"label":"Abr","value":412},{"label":"Mai","value":706},{"label":"Jun","value":494},{"label":"Jul","value":515},{"label":"Ago","value":715},{"label":"Set","value":657},{"label":"Out","value":481},{"label":"Nov","value":662},{"label":"Dez","value":548}];
const MX = 715;
