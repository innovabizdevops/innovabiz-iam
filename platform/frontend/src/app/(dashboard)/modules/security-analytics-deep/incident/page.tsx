...
const PAGE = "Incident";
const KPIS = [{"l":"Tickets Abertos","v":"1.836","t":"-2.1%","d":"down"},{"l":"SLA Cumprido (%)","v":"94.1%","t":"-4.6%","d":"down"},{"l":"MTTR (h)","v":"124h","t":"+6.7%","d":"up"},{"l":"Satisfação (%)","v":"91.1%","t":"-3.9%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.500","4.819","3.194","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","1.069","3.399","8.180","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","7.723","4.923","8.385","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.071","1.201","8.290","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","5.559","6.781","6.821","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":585},{"label":"Fev","value":785},{"label":"Mar","value":568},{"label":"Abr","value":669},{"label":"Mai","value":712},{"label":"Jun","value":477},{"label":"Jul","value":657},{"label":"Ago","value":702},{"label":"Set","value":617},{"label":"Out","value":565},{"label":"Nov","value":700},{"label":"Dez","value":746}];
const MX = 785;
