...
const KPIS = [{"l":"Dashboards Ativos","v":"7.203","t":"+3.3%","d":"up"},{"l":"Queries/Dia","v":"4650","t":"+11.9%","d":"up"},{"l":"Dados Processados (GB)","v":"5.858","t":"-1.1%","d":"down"},{"l":"Utilizadores Analytics","v":"4.214","t":"-2.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2042","2026-02-22","8.275","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","4984","2026-01-07","6.851","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2549","2026-01-28","8.593","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3101","2026-03-26","1.893","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2985","2026-03-14","6.802","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":809},{"label":"Fev","value":1036},{"label":"Mar","value":987},{"label":"Abr","value":753},{"label":"Mai","value":684},{"label":"Jun","value":920},{"label":"Jul","value":852},{"label":"Ago","value":691},{"label":"Set","value":857},{"label":"Out","value":811},{"label":"Nov","value":891},{"label":"Dez","value":663}];
const MX = 1036;
