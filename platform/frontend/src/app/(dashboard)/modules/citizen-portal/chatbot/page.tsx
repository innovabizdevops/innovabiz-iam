...
const ACCENT = "#3c5a7f";
const MODULE = "Citizen Portal";
const PAGE = "AI Chatbot";
const KPIS = [{"l":"Páginas Publicadas","v":"5.788","t":"+0.9%","d":"up"},{"l":"Visitantes/Dia","v":"4388","t":"-3.4%","d":"down"},{"l":"Conversão (%)","v":"86.1%","t":"+2.2%","d":"up"},{"l":"Performance Score","v":"83","t":"+2.5%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","4420","83.7%","71.8%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","1801","94.7%","83.5%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","5073","87.1%","91.0%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","1643","96.8%","90.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","3856","89.1%","72.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":468},{"label":"Fev","value":662},{"label":"Mar","value":700},{"label":"Abr","value":449},{"label":"Mai","value":588},{"label":"Jun","value":748},{"label":"Jul","value":500},{"label":"Ago","value":502},{"label":"Set","value":671},{"label":"Out","value":710},{"label":"Nov","value":656},{"label":"Dez","value":633}];
const MX = 748;
