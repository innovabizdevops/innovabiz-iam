...
const KPIS = [{"l":"Páginas Publicadas","v":"5.972","t":"-0.2%","d":"down"},{"l":"Visitantes/Dia","v":"3574","t":"+7.9%","d":"up"},{"l":"Conversão (%)","v":"73.3%","t":"+15.0%","d":"up"},{"l":"Performance Score","v":"84","t":"+6.2%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","524","90.6%","91.5%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","2531","82.3%","72.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","1449","93.9%","78.1%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","4881","91.1%","72.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","2444","90.5%","95.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":562},{"label":"Fev","value":770},{"label":"Mar","value":676},{"label":"Abr","value":633},{"label":"Mai","value":529},{"label":"Jun","value":488},{"label":"Jul","value":491},{"label":"Ago","value":561},{"label":"Set","value":734},{"label":"Out","value":619},{"label":"Nov","value":485},{"label":"Dez","value":500}];
const MX = 770;
...
export default function DigitalIdCitizenPortalPage() {
    return (
