...
const KPIS = [{"l":"Notificações Enviadas","v":"6.575","t":"+5.2%","d":"up"},{"l":"Taxa Entrega (%)","v":"77.1%","t":"+14.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"67.9%","t":"-0.3%","d":"down"},{"l":"Escalações","v":"8.974","t":"-5.2%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","8.834","98.5%","2026-01-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","8.528","93.3%","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","6.512","82.8%","2026-02-10","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","841","86.5%","2026-03-11","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.443","72.7%","2026-01-03","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":790},{"label":"Mar","value":960},{"label":"Abr","value":720},{"label":"Mai","value":934},{"label":"Jun","value":734},{"label":"Jul","value":668},{"label":"Ago","value":724},{"label":"Set","value":890},{"label":"Out","value":943},{"label":"Nov","value":759},{"label":"Dez","value":719}];
const MX = 960;
