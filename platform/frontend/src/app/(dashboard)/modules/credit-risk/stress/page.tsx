...
const PAGE = "Stress Test";
const KPIS = [{"l":"Riscos Identificados","v":"8.715","t":"+17.1%","d":"up"},{"l":"Mitigações Ativas","v":"8.473","t":"+11.2%","d":"up"},{"l":"Score Risco Geral","v":"91","t":"-2.0%","d":"down"},{"l":"Incidentes YTD","v":"3.482","t":"+16.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.416","7.960","579","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.873","2.949","5.845","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","1.537","8.226","4.974","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.007","532","2.024","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.034","2.530","208","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":564},{"label":"Fev","value":648},{"label":"Mar","value":504},{"label":"Abr","value":656},{"label":"Mai","value":494},{"label":"Jun","value":678},{"label":"Jul","value":615},{"label":"Ago","value":393},{"label":"Set","value":605},{"label":"Out","value":519},{"label":"Nov","value":460},{"label":"Dez","value":332}];
const MX = 678;
