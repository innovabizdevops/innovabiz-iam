...
const KPIS = [{"l":"Riscos Identificados","v":"969","t":"-0.3%","d":"down"},{"l":"Mitigações Ativas","v":"5.265","t":"+9.6%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+9.9%","d":"up"},{"l":"Incidentes YTD","v":"8.117","t":"+7.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","8.483","3.808","6.583","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","4.266","7.464","245","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","399","232","3.292","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","7.284","2.008","6.955","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","3.671","7.501","665","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":395},{"label":"Fev","value":585},{"label":"Mar","value":584},{"label":"Abr","value":719},{"label":"Mai","value":420},{"label":"Jun","value":527},{"label":"Jul","value":419},{"label":"Ago","value":515},{"label":"Set","value":688},{"label":"Out","value":481},{"label":"Nov","value":594},{"label":"Dez","value":608}];
const MX = 719;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Basel</span></h1>
                </div>
