...
const ACCENT = "#6366f1";
const MODULE = "Credit Risk Engine";
const PAGE = "Scoring";
const KPIS = [{"l":"Riscos Identificados","v":"4.605","t":"+1.4%","d":"up"},{"l":"Mitigações Ativas","v":"3.100","t":"+0.7%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+8.1%","d":"up"},{"l":"Incidentes YTD","v":"6.907","t":"+16.4%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","512","4.977","4.536","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.024","2.966","4.307","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.463","5.097","2.855","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.988","2.231","643","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.011","6.178","5.426","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":401},{"label":"Fev","value":449},{"label":"Mar","value":651},{"label":"Abr","value":562},{"label":"Mai","value":323},{"label":"Jun","value":546},{"label":"Jul","value":522},{"label":"Ago","value":325},{"label":"Set","value":598},{"label":"Out","value":566},{"label":"Nov","value":532},{"label":"Dez","value":596}];
const MX = 651;
