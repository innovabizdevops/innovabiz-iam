...
const KPIS = [{"l":"Riscos Identificados","v":"836","t":"+7.7%","d":"up"},{"l":"Mitigações Ativas","v":"5.819","t":"+16.1%","d":"up"},{"l":"Score Risco Geral","v":"67","t":"+2.5%","d":"up"},{"l":"Incidentes YTD","v":"7.739","t":"-0.4%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.308","798","3.974","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.353","3.845","8.765","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.206","5.390","8.864","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.192","7.908","3.268","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","4.594","4.438","7.211","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":698},{"label":"Fev","value":761},{"label":"Mar","value":591},{"label":"Abr","value":493},{"label":"Mai","value":495},{"label":"Jun","value":705},{"label":"Jul","value":483},{"label":"Ago","value":631},{"label":"Set","value":531},{"label":"Out","value":574},{"label":"Nov","value":715},{"label":"Dez","value":686}];
const MX = 761;
