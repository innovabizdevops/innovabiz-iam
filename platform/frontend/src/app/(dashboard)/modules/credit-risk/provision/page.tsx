...
const KPIS = [{"l":"Riscos Identificados","v":"7.293","t":"+0.3%","d":"up"},{"l":"Mitigações Ativas","v":"825","t":"+4.0%","d":"up"},{"l":"Score Risco Geral","v":"92","t":"+12.4%","d":"up"},{"l":"Incidentes YTD","v":"6.129","t":"-5.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","867","3.765","7.616","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.668","9.074","6.671","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.897","5.887","2.280","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","5.160","1.967","1.081","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","7.551","1.305","4.075","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":587},{"label":"Fev","value":733},{"label":"Mar","value":891},{"label":"Abr","value":662},{"label":"Mai","value":822},{"label":"Jun","value":697},{"label":"Jul","value":631},{"label":"Ago","value":859},{"label":"Set","value":524},{"label":"Out","value":723},{"label":"Nov","value":898},{"label":"Dez","value":785}];
const MX = 898;
