...
const KPIS = [{"l":"Dashboards Ativos","v":"2.661","t":"+-0.0%","d":"up"},{"l":"Queries/Dia","v":"1398","t":"+7.8%","d":"up"},{"l":"Dados Processados (GB)","v":"8.437","t":"+0.6%","d":"up"},{"l":"Utilizadores Analytics","v":"6.506","t":"+7.9%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1602","2026-02-06","1.357","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3735","2026-02-04","7.905","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4923","2026-03-08","1.891","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4032","2026-01-09","1.125","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","223","2026-03-06","6.066","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":293},{"label":"Fev","value":365},{"label":"Mar","value":342},{"label":"Abr","value":587},{"label":"Mai","value":499},{"label":"Jun","value":472},{"label":"Jul","value":453},{"label":"Ago","value":252},{"label":"Set","value":442},{"label":"Out","value":415},{"label":"Nov","value":612},{"label":"Dez","value":500}];
const MX = 612;
