...
const PAGE = "Business Glossary";
const KPIS = [{"l":"Dashboards Ativos","v":"863","t":"+2.1%","d":"up"},{"l":"Queries/Dia","v":"1764","t":"+1.3%","d":"up"},{"l":"Dados Processados (GB)","v":"7.335","t":"+10.2%","d":"up"},{"l":"Utilizadores Analytics","v":"7.764","t":"+10.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4745","2026-01-21","3.135","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1539","2026-03-15","5.416","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3104","2026-03-06","7.825","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3596","2026-03-04","8.739","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2828","2026-02-04","8.893","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":679},{"label":"Fev","value":537},{"label":"Mar","value":754},{"label":"Abr","value":577},{"label":"Mai","value":682},{"label":"Jun","value":872},{"label":"Jul","value":601},{"label":"Ago","value":798},{"label":"Set","value":852},{"label":"Out","value":780},{"label":"Nov","value":508},{"label":"Dez","value":592}];
const MX = 872;
