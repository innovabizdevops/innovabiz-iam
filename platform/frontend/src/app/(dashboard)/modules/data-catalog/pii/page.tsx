...
const PAGE = "PII Scanner";
const KPIS = [{"l":"Dashboards Ativos","v":"2.473","t":"+12.5%","d":"up"},{"l":"Queries/Dia","v":"1048","t":"+9.2%","d":"up"},{"l":"Dados Processados (GB)","v":"6.938","t":"+4.4%","d":"up"},{"l":"Utilizadores Analytics","v":"1.134","t":"+13.4%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2444","2026-01-14","6.472","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2618","2026-03-11","7.761","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3677","2026-02-12","3.466","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1969","2026-02-17","1.161","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3664","2026-01-09","8.031","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":452},{"label":"Fev","value":718},{"label":"Mar","value":782},{"label":"Abr","value":564},{"label":"Mai","value":533},{"label":"Jun","value":752},{"label":"Jul","value":539},{"label":"Ago","value":576},{"label":"Set","value":580},{"label":"Out","value":798},{"label":"Nov","value":516},{"label":"Dez","value":713}];
const MX = 798;
