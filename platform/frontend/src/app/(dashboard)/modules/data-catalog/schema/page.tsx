...
const PAGE = "Schema Explorer";
const KPIS = [{"l":"Dashboards Ativos","v":"2.441","t":"+9.2%","d":"up"},{"l":"Queries/Dia","v":"2256","t":"-5.6%","d":"down"},{"l":"Dados Processados (GB)","v":"5.738","t":"-1.7%","d":"down"},{"l":"Utilizadores Analytics","v":"3.693","t":"+10.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4923","2026-02-06","7.275","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2372","2026-02-09","782","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","457","2026-01-09","7.595","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3546","2026-02-08","695","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4984","2026-03-01","3.787","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":684},{"label":"Fev","value":786},{"label":"Mar","value":679},{"label":"Abr","value":644},{"label":"Mai","value":667},{"label":"Jun","value":727},{"label":"Jul","value":646},{"label":"Ago","value":906},{"label":"Set","value":514},{"label":"Out","value":579},{"label":"Nov","value":859},{"label":"Dez","value":864}];
const MX = 906;
