...
const PAGE = "Stewardship";
const KPIS = [{"l":"Dashboards Ativos","v":"4.145","t":"+13.3%","d":"up"},{"l":"Queries/Dia","v":"4457","t":"+4.2%","d":"up"},{"l":"Dados Processados (GB)","v":"143","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"6.350","t":"-1.7%","d":"down"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4435","2026-02-25","8.180","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1002","2026-01-08","4.387","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","733","2026-03-20","8.047","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","667","2026-03-08","6.033","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1080","2026-02-27","4.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":302},{"label":"Fev","value":332},{"label":"Mar","value":255},{"label":"Abr","value":270},{"label":"Mai","value":465},{"label":"Jun","value":482},{"label":"Jul","value":576},{"label":"Ago","value":545},{"label":"Set","value":601},{"label":"Out","value":388},{"label":"Nov","value":374},{"label":"Dez","value":333}];
const MX = 601;
