...
const ACCENT = "#059669";
const MODULE = "Data Catalog";
const PAGE = "AI Discovery";
const KPIS = [{"l":"Dashboards Ativos","v":"5.756","t":"+12.7%","d":"up"},{"l":"Queries/Dia","v":"2725","t":"+14.2%","d":"up"},{"l":"Dados Processados (GB)","v":"1.795","t":"+13.2%","d":"up"},{"l":"Utilizadores Analytics","v":"3.730","t":"+9.2%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3530","2026-01-26","2.823","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1599","2026-03-03","4.096","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","3640","2026-01-17","1.503","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2707","2026-02-25","6.131","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2079","2026-03-05","1.198","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":645},{"label":"Mar","value":674},{"label":"Abr","value":672},{"label":"Mai","value":506},{"label":"Jun","value":652},{"label":"Jul","value":607},{"label":"Ago","value":788},{"label":"Set","value":534},{"label":"Out","value":769},{"label":"Nov","value":581},{"label":"Dez","value":770}];
const MX = 788;
