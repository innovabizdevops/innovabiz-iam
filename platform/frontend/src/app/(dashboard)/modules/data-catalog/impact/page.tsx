...
const KPIS = [{"l":"Dashboards Ativos","v":"6.238","t":"-5.6%","d":"down"},{"l":"Queries/Dia","v":"5081","t":"+8.5%","d":"up"},{"l":"Dados Processados (GB)","v":"5.490","t":"+3.5%","d":"up"},{"l":"Utilizadores Analytics","v":"8.129","t":"+7.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1025","2026-02-06","2.305","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2405","2026-01-14","7.336","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5080","2026-01-10","2.710","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1846","2026-01-03","5.450","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2717","2026-02-28","1.150","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":763},{"label":"Fev","value":910},{"label":"Mar","value":1054},{"label":"Abr","value":925},{"label":"Mai","value":1058},{"label":"Jun","value":817},{"label":"Jul","value":874},{"label":"Ago","value":835},{"label":"Set","value":709},{"label":"Out","value":856},{"label":"Nov","value":873},{"label":"Dez","value":707}];
const MX = 1058;
