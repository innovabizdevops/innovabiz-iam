...
const PAGE = "Data Profiling";
const KPIS = [{"l":"Dashboards Ativos","v":"8.299","t":"+0.9%","d":"up"},{"l":"Queries/Dia","v":"2178","t":"+6.6%","d":"up"},{"l":"Dados Processados (GB)","v":"5.132","t":"+5.6%","d":"up"},{"l":"Utilizadores Analytics","v":"4.622","t":"+13.6%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4950","2026-03-07","4.973","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","3871","2026-01-01","2.509","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","4033","2026-02-13","4.290","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","2795","2026-03-15","2.298","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2426","2026-03-10","3.888","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":505},{"label":"Fev","value":615},{"label":"Mar","value":586},{"label":"Abr","value":406},{"label":"Mai","value":657},{"label":"Jun","value":608},{"label":"Jul","value":408},{"label":"Ago","value":480},{"label":"Set","value":595},{"label":"Out","value":473},{"label":"Nov","value":676},{"label":"Dez","value":447}];
const MX = 676;
