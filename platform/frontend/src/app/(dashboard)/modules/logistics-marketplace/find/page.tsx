...
const ACCENT = "#6366f1";
const MODULE = "Logistics Marketplace";
const PAGE = "Find Carrier";
const KPIS = [{"l":"Pedidos/Dia","v":"2234","t":"+7.7%","d":"up"},{"l":"GMV (€)","v":"€85338","t":"+14.7%","d":"up"},{"l":"Conversão (%)","v":"77.5%","t":"+3.4%","d":"up"},{"l":"AOV (€)","v":"€90060","t":"-1.2%","d":"down"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 45941.60","8.680","6.996","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 36928.26","3.722","5.594","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 22295.85","396","7.557","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 28645.93","3.780","1.781","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 36205.42","4.910","5.357","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":880},{"label":"Fev","value":879},{"label":"Mar","value":754},{"label":"Abr","value":880},{"label":"Mai","value":916},{"label":"Jun","value":969},{"label":"Jul","value":895},{"label":"Ago","value":698},{"label":"Set","value":684},{"label":"Out","value":786},{"label":"Nov","value":852},{"label":"Dez","value":1012}];
const MX = 1012;
