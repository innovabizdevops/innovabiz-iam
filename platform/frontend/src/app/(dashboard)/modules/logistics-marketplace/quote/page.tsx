...
const PAGE = "Quote";
const KPIS = [{"l":"Pedidos/Dia","v":"4731","t":"+12.2%","d":"up"},{"l":"GMV (€)","v":"€66119","t":"-1.4%","d":"down"},{"l":"Conversão (%)","v":"90.9%","t":"+-0.0%","d":"up"},{"l":"AOV (€)","v":"€37695","t":"+1.5%","d":"up"}];
const COLS = ["Pedido","Cliente","Valor (€)","Canal","Pagamento","Estado"];
const ROWS = [{"id":"r0","cells":["ORD-2026-8921","ORD-2026-8922","€ 728.54","5.244","1.457","Ativo"],"status":"active"},{"id":"r1","cells":["ORD-2026-8922","ORD-2026-8923","€ 20088.73","7.411","5.660","Pendente"],"status":"pending"},{"id":"r2","cells":["ORD-2026-8923","ORD-2026-8924","€ 34657.64","7.230","4.720","Concluído"],"status":"done"},{"id":"r3","cells":["ORD-2026-8924","ORD-2026-8925","€ 47078.32","5.645","6.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["ORD-2026-8925","ORD-2026-8921","€ 12364.00","6.041","4.289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":660},{"label":"Fev","value":697},{"label":"Mar","value":707},{"label":"Abr","value":455},{"label":"Mai","value":418},{"label":"Jun","value":454},{"label":"Jul","value":689},{"label":"Ago","value":746},{"label":"Set","value":631},{"label":"Out","value":628},{"label":"Nov","value":641},{"label":"Dez","value":380}];
const MX = 746;
