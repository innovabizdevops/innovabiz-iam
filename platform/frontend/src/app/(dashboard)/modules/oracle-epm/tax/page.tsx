...
const PAGE = "Tax";
const KPIS = [{"l":"Total Oracle Epm","v":"4.174","t":"+7.4%","d":"up"},{"l":"Tax Ativos","v":"1.799","t":"+6.8%","d":"up"},{"l":"Eficiência (%)","v":"93.6%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"91","t":"+5.6%","d":"up"}];
const COLS = ["ID","Tax","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oracle Epm #001","Oracle Epm #002","6.632","5.332","2026-01-24","Ativo"],"status":"active"},{"id":"r1","cells":["Oracle Epm #002","Oracle Epm #003","1.520","5.895","2026-01-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Oracle Epm #003","Oracle Epm #004","902","4.566","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Epm #004","Oracle Epm #005","2.636","5.829","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oracle Epm #005","Oracle Epm #001","794","8.167","2026-03-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":442},{"label":"Fev","value":752},{"label":"Mar","value":601},{"label":"Abr","value":486},{"label":"Mai","value":598},{"label":"Jun","value":715},{"label":"Jul","value":681},{"label":"Ago","value":768},{"label":"Set","value":502},{"label":"Out","value":487},{"label":"Nov","value":632},{"label":"Dez","value":536}];
const MX = 768;
