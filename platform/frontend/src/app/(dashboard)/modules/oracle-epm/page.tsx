...
/* ═══ EPM Cloud (Oracle) — Dashboard ═══ */

const ACCENT = "#c74634";

const KPIS = [
    { label: "Total Registos", value: "7374", trend: "+25%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "2881", trend: "+19%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€403K", trend: "-13%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "164228474", cells: ["ORA-6474", "EPM Cloud (Oracle) Item 1", "19/3/2026", "€28 574"], status: "active" as const },
    { id: "164232045", cells: ["ORA-1045", "EPM Cloud (Oracle) Item 2", "6/10/2026", "€32 145"], status: "pending" as const },
    { id: "164235616", cells: ["ORA-4616", "EPM Cloud (Oracle) Item 3", "21/5/2026", "€35 716"], status: "completed" as const },
    { id: "164239187", cells: ["ORA-8187", "EPM Cloud (Oracle) Item 4", "8/12/2026", "€39 287"], status: "warning" as const },
    { id: "164242758", cells: ["ORA-2758", "EPM Cloud (Oracle) Item 5", "23/7/2026", "€42 858"], status: "active" as const },
];
...
export default function EpmCloudOraclePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">EPM Cloud (Oracle)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • EPM Cloud (Oracle)</p>
                    </div>
                </div>
