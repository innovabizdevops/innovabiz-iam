...
const ACCENT = "#c74634";
const MODULE = "EPM Cloud (Oracle)";
const PAGE = "Narrative";
const KPIS = [{"l":"ARR (€M)","v":"€13.9M","t":"+14.5%","d":"up"},{"l":"MRR (€)","v":"€74192","t":"-3.8%","d":"down"},{"l":"Churn (%)","v":"91.6%","t":"+17.4%","d":"up"},{"l":"ARPU (€)","v":"€73501","t":"+11.7%","d":"up"}];
const COLS = ["Plano","Tier","Preço (€)","Clientes","MRR (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Enterprise Plus","Professional","€ 38342.14","2.973","€ 40966.55","Ativo"],"status":"active"},{"id":"r1","cells":["Professional","Starter","€ 30333.50","3.541","€ 44707.14","Pendente"],"status":"pending"},{"id":"r2","cells":["Starter","Free Trial","€ 31993.72","2.777","€ 20887.84","Concluído"],"status":"done"},{"id":"r3","cells":["Free Trial","Custom Enterprise","€ 7266.34","1.628","€ 39957.62","Em Análise"],"status":"risk"},{"id":"r4","cells":["Custom Enterprise","Enterprise Plus","€ 44297.57","3.076","€ 26350.84","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":768},{"label":"Fev","value":915},{"label":"Mar","value":772},{"label":"Abr","value":953},{"label":"Mai","value":760},{"label":"Jun","value":818},{"label":"Jul","value":944},{"label":"Ago","value":690},{"label":"Set","value":835},{"label":"Out","value":805},{"label":"Nov","value":764},{"label":"Dez","value":620}];
const MX = 953;
