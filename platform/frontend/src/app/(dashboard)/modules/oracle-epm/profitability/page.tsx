...
const KPIS = [{"l":"Total Oracle Epm","v":"8.096","t":"+8.0%","d":"up"},{"l":"Profitability Ativos","v":"5.695","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"82.4%","t":"-2.1%","d":"down"},{"l":"Score Performance","v":"92","t":"+12.2%","d":"up"}];
const COLS = ["ID","Profitability","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Oracle Epm #001","Oracle Epm #002","1.383","2.133","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Oracle Epm #002","Oracle Epm #003","3.221","8.876","2026-01-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Oracle Epm #003","Oracle Epm #004","3.656","5.325","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Epm #004","Oracle Epm #005","3.874","7.959","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Oracle Epm #005","Oracle Epm #001","7.113","3.246","2026-01-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":590},{"label":"Fev","value":609},{"label":"Mar","value":428},{"label":"Abr","value":515},{"label":"Mai","value":482},{"label":"Jun","value":639},{"label":"Jul","value":526},{"label":"Ago","value":507},{"label":"Set","value":539},{"label":"Out","value":776},{"label":"Nov","value":730},{"label":"Dez","value":697}];
const MX = 776;
