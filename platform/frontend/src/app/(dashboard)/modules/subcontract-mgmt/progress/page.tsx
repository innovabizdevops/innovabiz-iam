...
const ACCENT = "#4338ca";
const MODULE = "Subcontractor Mgmt";
const PAGE = "Progress Pay";
const KPIS = [{"l":"Contratos Ativos","v":"2.593","t":"+0.8%","d":"up"},{"l":"Valor Total (€M)","v":"€33.0M","t":"+9.2%","d":"up"},{"l":"Renovações Próx. 30d","v":"5.342","t":"+16.1%","d":"up"},{"l":"Obrigações Pendentes","v":"2.756","t":"+8.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 19140.50","2026-03-02","2026-03-27","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 44059.85","2026-01-03","2026-03-17","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 11183.41","2026-01-24","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 30883.35","2026-03-10","2026-02-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 34026.40","2026-01-03","2026-02-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":878},{"label":"Fev","value":751},{"label":"Mar","value":843},{"label":"Abr","value":924},{"label":"Mai","value":667},{"label":"Jun","value":757},{"label":"Jul","value":947},{"label":"Ago","value":895},{"label":"Set","value":842},{"label":"Out","value":687},{"label":"Nov","value":789},{"label":"Dez","value":614}];
const MX = 947;
