...
const PAGE = "SOW Builder";
const KPIS = [{"l":"Contratos Ativos","v":"2.876","t":"-4.5%","d":"down"},{"l":"Valor Total (€M)","v":"€40.1M","t":"+11.1%","d":"up"},{"l":"Renovações Próx. 30d","v":"4.022","t":"+10.7%","d":"up"},{"l":"Obrigações Pendentes","v":"7.717","t":"+7.0%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 19448.43","2026-01-17","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 4179.67","2026-01-17","2026-03-04","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 44697.84","2026-01-25","2026-01-05","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 38034.46","2026-02-18","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 20898.86","2026-03-05","2026-02-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":479},{"label":"Mar","value":795},{"label":"Abr","value":829},{"label":"Mai","value":781},{"label":"Jun","value":636},{"label":"Jul","value":490},{"label":"Ago","value":627},{"label":"Set","value":810},{"label":"Out","value":706},{"label":"Nov","value":847},{"label":"Dez","value":472}];
const MX = 847;
