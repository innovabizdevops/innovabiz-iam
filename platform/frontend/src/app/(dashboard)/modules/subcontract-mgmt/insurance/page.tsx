...
const PAGE = "Insurance Track";
const KPIS = [{"l":"Contratos Ativos","v":"5.667","t":"+14.3%","d":"up"},{"l":"Valor Total (€M)","v":"€32.2M","t":"+13.8%","d":"up"},{"l":"Renovações Próx. 30d","v":"1.398","t":"+3.6%","d":"up"},{"l":"Obrigações Pendentes","v":"994","t":"+7.6%","d":"up"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 4572.78","2026-02-27","2026-02-21","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 34193.20","2026-02-07","2026-02-09","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 21192.13","2026-03-02","2026-01-08","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 9299.82","2026-02-04","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 32409.83","2026-02-04","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":650},{"label":"Fev","value":821},{"label":"Mar","value":700},{"label":"Abr","value":914},{"label":"Mai","value":780},{"label":"Jun","value":798},{"label":"Jul","value":581},{"label":"Ago","value":816},{"label":"Set","value":601},{"label":"Out","value":953},{"label":"Nov","value":935},{"label":"Dez","value":863}];
const MX = 953;
