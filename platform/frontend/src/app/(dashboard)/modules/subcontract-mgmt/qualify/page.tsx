...
const PAGE = "Pre-Qualify";
const KPIS = [{"l":"Contratos Ativos","v":"4.602","t":"+9.3%","d":"up"},{"l":"Valor Total (€M)","v":"€5.4M","t":"-1.7%","d":"down"},{"l":"Renovações Próx. 30d","v":"5.366","t":"+14.4%","d":"up"},{"l":"Obrigações Pendentes","v":"4.357","t":"-3.2%","d":"down"}];
const COLS = ["Contrato","Contraparte","Valor (€)","Início","Fim","Estado"];
const ROWS = [{"id":"r0","cells":["CTR-SAP-2026","CTR-AZURE-2026","€ 14898.88","2026-01-23","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["CTR-AZURE-2026","CTR-PARCEIRO-A","€ 3515.56","2026-02-18","2026-03-08","Pendente"],"status":"pending"},{"id":"r2","cells":["CTR-PARCEIRO-A","CTR-FORNECEDOR-B","€ 47376.31","2026-02-26","2026-02-02","Concluído"],"status":"done"},{"id":"r3","cells":["CTR-FORNECEDOR-B","CTR-CLIENTE-C","€ 16390.85","2026-03-03","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["CTR-CLIENTE-C","CTR-SAP-2026","€ 45071.26","2026-01-11","2026-03-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":729},{"label":"Fev","value":767},{"label":"Mar","value":661},{"label":"Abr","value":904},{"label":"Mai","value":966},{"label":"Jun","value":663},{"label":"Jul","value":939},{"label":"Ago","value":704},{"label":"Set","value":651},{"label":"Out","value":838},{"label":"Nov","value":722},{"label":"Dez","value":917}];
const MX = 966;
