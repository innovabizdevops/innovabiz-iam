...
const KPIS = [{"l":"Formulários Ativos","v":"6.872","t":"+1.7%","d":"up"},{"l":"Submissões/Dia","v":"3805","t":"+0.1%","d":"up"},{"l":"Documentos Gerados","v":"4.641","t":"+9.7%","d":"up"},{"l":"Templates","v":"8.361","t":"+2.8%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.354","2026-03-02","5.836","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","4.661","2026-03-02","2.832","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.498","2026-03-01","4.692","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.982","2026-01-09","5.580","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","148","2026-02-27","450","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":709},{"label":"Fev","value":867},{"label":"Mar","value":735},{"label":"Abr","value":612},{"label":"Mai","value":725},{"label":"Jun","value":916},{"label":"Jul","value":558},{"label":"Ago","value":828},{"label":"Set","value":667},{"label":"Out","value":551},{"label":"Nov","value":631},{"label":"Dez","value":707}];
const MX = 916;
