...
/* ═══ Food Truck Mgmt — Dashboard ═══ */

const ACCENT = "#dc2626";

const KPIS = [
    { label: "Total Registos", value: "8301", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "898", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€225K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1998778601", cells: ["FOO-5601", "Food Truck Mgmt Item 1", "2/6/2026", "€28 701"], status: "active" as const },
    { id: "1998782172", cells: ["FOO-9172", "Food Truck Mgmt Item 2", "17/1/2026", "€32 272"], status: "pending" as const },
    { id: "1998785743", cells: ["FOO-3743", "Food Truck Mgmt Item 3", "4/8/2026", "€35 843"], status: "completed" as const },
    { id: "1998789314", cells: ["FOO-7314", "Food Truck Mgmt Item 4", "19/3/2026", "€39 414"], status: "warning" as const },
    { id: "1998792885", cells: ["FOO-1885", "Food Truck Mgmt Item 5", "6/10/2026", "€42 985"], status: "active" as const },
];
...
export default function FoodTruckMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Food Truck Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Food Truck Mgmt</p>
                    </div>
                </div>
