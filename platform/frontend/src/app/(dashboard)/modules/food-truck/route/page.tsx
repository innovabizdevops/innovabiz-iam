...
const PAGE = "Route";
const KPIS = [{"l":"Total Food Truck","v":"4.042","t":"-3.3%","d":"down"},{"l":"Route Ativos","v":"2.163","t":"-0.4%","d":"down"},{"l":"Eficiência (%)","v":"92.2%","t":"+12.3%","d":"up"},{"l":"Score Performance","v":"79","t":"+4.8%","d":"up"}];
const COLS = ["ID","Route","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Food Truck #001","Food Truck #002","8.566","1.210","2026-03-11","Ativo"],"status":"active"},{"id":"r1","cells":["Food Truck #002","Food Truck #003","158","4.532","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Food Truck #003","Food Truck #004","4.696","5.487","2026-02-21","Concluído"],"status":"done"},{"id":"r3","cells":["Food Truck #004","Food Truck #005","3.013","1.424","2026-02-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Food Truck #005","Food Truck #001","7.895","5.839","2026-02-10","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":618},{"label":"Fev","value":508},{"label":"Mar","value":474},{"label":"Abr","value":594},{"label":"Mai","value":473},{"label":"Jun","value":561},{"label":"Jul","value":688},{"label":"Ago","value":562},{"label":"Set","value":751},{"label":"Out","value":473},{"label":"Nov","value":462},{"label":"Dez","value":628}];
const MX = 751;
