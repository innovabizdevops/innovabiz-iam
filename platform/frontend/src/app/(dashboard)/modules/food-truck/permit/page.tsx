...
const PAGE = "Permit";
const KPIS = [{"l":"Riscos Identificados","v":"4.218","t":"+0.6%","d":"up"},{"l":"Mitigações Ativas","v":"2.803","t":"+9.8%","d":"up"},{"l":"Score Risco Geral","v":"88","t":"+1.3%","d":"up"},{"l":"Incidentes YTD","v":"8.793","t":"-5.5%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.520","337","542","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.784","1.343","6.382","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.303","2.090","3.819","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","3.721","5.557","8.179","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.232","4.561","3.546","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":704},{"label":"Fev","value":611},{"label":"Mar","value":702},{"label":"Abr","value":480},{"label":"Mai","value":719},{"label":"Jun","value":683},{"label":"Jul","value":479},{"label":"Ago","value":626},{"label":"Set","value":714},{"label":"Out","value":753},{"label":"Nov","value":473},{"label":"Dez","value":711}];
const MX = 753;
