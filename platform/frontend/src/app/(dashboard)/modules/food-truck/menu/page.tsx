...
const ACCENT = "#dc2626";
const MODULE = "Food Truck Mgmt";
const PAGE = "Menu";
const KPIS = [{"l":"Quartos Ocupados","v":"7.575","t":"-2.4%","d":"down"},{"l":"RevPAR (€)","v":"€11485","t":"+7.4%","d":"up"},{"l":"Ocupação (%)","v":"65.4%","t":"+11.4%","d":"up"},{"l":"Guest Satisfaction","v":"3.794","t":"-1.3%","d":"down"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","5.548","2026-02-01","2026-03-10","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","1.891","2026-01-27","2026-01-12","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","8.509","2026-01-23","2026-01-15","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","1.286","2026-03-10","2026-02-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","5.283","2026-03-11","2026-03-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":876},{"label":"Fev","value":912},{"label":"Mar","value":770},{"label":"Abr","value":678},{"label":"Mai","value":913},{"label":"Jun","value":825},{"label":"Jul","value":837},{"label":"Ago","value":1008},{"label":"Set","value":728},{"label":"Out","value":980},{"label":"Nov","value":702},{"label":"Dez","value":935}];
const MX = 1008;
