...
const KPIS = [{"l":"Atletas Registados","v":"1.094","t":"+12.8%","d":"up"},{"l":"Treinos/Semana","v":"2437","t":"-4.6%","d":"down"},{"l":"Competições","v":"7.627","t":"+5.5%","d":"up"},{"l":"Performance Score","v":"68","t":"+17.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","8.449","7.621","3.635","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","9.052","8.336","2.558","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","2.042","6.440","8.358","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","7.252","4.137","2.254","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","5.815","2.702","7.713","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":383},{"label":"Fev","value":493},{"label":"Mar","value":658},{"label":"Abr","value":569},{"label":"Mai","value":610},{"label":"Jun","value":612},{"label":"Jul","value":665},{"label":"Ago","value":507},{"label":"Set","value":494},{"label":"Out","value":331},{"label":"Nov","value":695},{"label":"Dez","value":614}];
const MX = 695;
