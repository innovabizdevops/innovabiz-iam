...
const KPIS = [{"l":"Dashboards Ativos","v":"4.850","t":"+3.1%","d":"up"},{"l":"Queries/Dia","v":"3612","t":"+15.1%","d":"up"},{"l":"Dados Processados (GB)","v":"8.918","t":"+11.4%","d":"up"},{"l":"Utilizadores Analytics","v":"8.515","t":"+4.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","266","2026-02-18","7.819","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1386","2026-03-27","3.554","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1069","2026-02-15","6.959","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","1427","2026-03-06","1.538","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","2281","2026-02-09","1.340","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":725},{"label":"Fev","value":648},{"label":"Mar","value":1040},{"label":"Abr","value":769},{"label":"Mai","value":752},{"label":"Jun","value":1009},{"label":"Jul","value":758},{"label":"Ago","value":939},{"label":"Set","value":727},{"label":"Out","value":1007},{"label":"Nov","value":867},{"label":"Dez","value":884}];
const MX = 1040;
