...
const PAGE = "Stream";
const KPIS = [{"l":"Atletas Registados","v":"6.518","t":"-4.4%","d":"down"},{"l":"Treinos/Semana","v":"4493","t":"-3.3%","d":"down"},{"l":"Competições","v":"5.923","t":"+9.4%","d":"up"},{"l":"Performance Score","v":"59","t":"+5.8%","d":"up"}];
const COLS = ["Atleta","Modalidade","Treinos","Performance","Lesões","Estado"];
const ROWS = [{"id":"r0","cells":["ATL-FUT-001","ATL-NAT-042","2.482","3.694","2.646","Ativo"],"status":"active"},{"id":"r1","cells":["ATL-NAT-042","ATL-ATL-013","8.992","1.287","1.080","Pendente"],"status":"pending"},{"id":"r2","cells":["ATL-ATL-013","ATL-BAS-007","4.792","4.513","6.237","Concluído"],"status":"done"},{"id":"r3","cells":["ATL-BAS-007","ATL-TEN-028","4.001","4.603","7.431","Em Análise"],"status":"risk"},{"id":"r4","cells":["ATL-TEN-028","ATL-FUT-001","4.540","3.058","4.866","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":538},{"label":"Fev","value":451},{"label":"Mar","value":330},{"label":"Abr","value":235},{"label":"Mai","value":593},{"label":"Jun","value":334},{"label":"Jul","value":569},{"label":"Ago","value":415},{"label":"Set","value":529},{"label":"Out","value":600},{"label":"Nov","value":252},{"label":"Dez","value":268}];
const MX = 600;
