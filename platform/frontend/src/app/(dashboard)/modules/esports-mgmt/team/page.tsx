...
const PAGE = "Team";
const KPIS = [{"l":"Teams Ativos","v":"8.906","t":"-3.2%","d":"down"},{"l":"Reuniões/Semana","v":"2166","t":"+2.2%","d":"up"},{"l":"Mensagens/Dia","v":"4459","t":"-3.2%","d":"down"},{"l":"Ficheiros Partilhados","v":"5.165","t":"-5.9%","d":"down"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","1.859","4418","2.079","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","1.763","5008","3.735","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","6.748","4185","4.546","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","3.762","1023","6.351","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","3.738","4657","8.456","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":717},{"label":"Fev","value":673},{"label":"Mar","value":856},{"label":"Abr","value":780},{"label":"Mai","value":685},{"label":"Jun","value":673},{"label":"Jul","value":571},{"label":"Ago","value":619},{"label":"Set","value":843},{"label":"Out","value":534},{"label":"Nov","value":667},{"label":"Dez","value":809}];
const MX = 856;
