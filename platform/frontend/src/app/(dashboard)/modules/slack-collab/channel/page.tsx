...
const PAGE = "Channel";
const KPIS = [{"l":"Tickets Abertos","v":"1.765","t":"+3.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.6%","t":"-1.5%","d":"down"},{"l":"MTTR (h)","v":"180h","t":"+16.8%","d":"up"},{"l":"Satisfação (%)","v":"89.9%","t":"-0.5%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","7.146","8.597","866","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","332","8.085","6.329","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","5.663","6.511","2.612","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.203","5.211","1.690","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.528","2.759","1.421","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":371},{"label":"Fev","value":616},{"label":"Mar","value":387},{"label":"Abr","value":695},{"label":"Mai","value":438},{"label":"Jun","value":400},{"label":"Jul","value":724},{"label":"Ago","value":650},{"label":"Set","value":734},{"label":"Out","value":516},{"label":"Nov","value":533},{"label":"Dez","value":639}];
const MX = 734;
