...
/* ═══ Team Collaboration Hub — Dashboard ═══ */

const ACCENT = "#00a1e0";

const KPIS = [
    { label: "Total Registos", value: "6539", trend: "+15%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "713", trend: "-9%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€357K", trend: "+3%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1865701039", cells: ["SLA-2039", "Team Collaboration Hub Item 1", "28/8/2026", "€1139"], status: "active" as const },
    { id: "1865704610", cells: ["SLA-5610", "Team Collaboration Hub Item 2", "15/3/2026", "€4710"], status: "pending" as const },
    { id: "1865708181", cells: ["SLA-9181", "Team Collaboration Hub Item 3", "2/10/2026", "€8281"], status: "completed" as const },
    { id: "1865711752", cells: ["SLA-3752", "Team Collaboration Hub Item 4", "17/5/2026", "€11 852"], status: "warning" as const },
    { id: "1865715323", cells: ["SLA-7323", "Team Collaboration Hub Item 5", "4/12/2026", "€15 423"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Team Collaboration Hub</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Team Collaboration Hub</p>
                    </div>
                </div>
