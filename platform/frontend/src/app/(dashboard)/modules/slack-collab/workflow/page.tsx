...
const PAGE = "Workflow";
const KPIS = [{"l":"Tickets Abertos","v":"6.112","t":"-5.7%","d":"down"},{"l":"SLA Cumprido (%)","v":"90.6%","t":"+8.9%","d":"up"},{"l":"MTTR (h)","v":"129h","t":"+9.7%","d":"up"},{"l":"Satisfação (%)","v":"86.8%","t":"+3.6%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.446","2.014","224","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","4.263","5.765","1.697","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","6.808","6.849","2.433","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.763","1.448","2.541","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.629","6.721","2.791","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":589},{"label":"Fev","value":529},{"label":"Mar","value":527},{"label":"Abr","value":603},{"label":"Mai","value":542},{"label":"Jun","value":648},{"label":"Jul","value":679},{"label":"Ago","value":556},{"label":"Set","value":518},{"label":"Out","value":635},{"label":"Nov","value":721},{"label":"Dez","value":513}];
const MX = 721;
