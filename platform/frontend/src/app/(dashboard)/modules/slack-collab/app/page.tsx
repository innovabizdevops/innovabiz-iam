...
const PAGE = "App";
const KPIS = [{"l":"Tickets Abertos","v":"4.731","t":"+14.6%","d":"up"},{"l":"SLA Cumprido (%)","v":"67.0%","t":"-2.4%","d":"down"},{"l":"MTTR (h)","v":"26h","t":"+8.9%","d":"up"},{"l":"Satisfação (%)","v":"87.9%","t":"-0.8%","d":"down"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","2.500","2.784","2.810","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","594","1.717","5.039","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","777","1.034","3.309","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","7.243","5.429","8.639","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","6.494","2.849","5.398","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":782},{"label":"Fev","value":866},{"label":"Mar","value":821},{"label":"Abr","value":854},{"label":"Mai","value":548},{"label":"Jun","value":802},{"label":"Jul","value":734},{"label":"Ago","value":753},{"label":"Set","value":585},{"label":"Out","value":620},{"label":"Nov","value":539},{"label":"Dez","value":596}];
const MX = 866;
