...
const ACCENT = "#00a1e0";
const MODULE = "Team Collaboration Hub";
const PAGE = "Huddle";
const KPIS = [{"l":"Tickets Abertos","v":"7.230","t":"+7.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"72.5%","t":"+7.9%","d":"up"},{"l":"MTTR (h)","v":"45h","t":"+12.0%","d":"up"},{"l":"Satisfação (%)","v":"94.9%","t":"+7.9%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","6.386","8.827","3.009","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","3.492","7.390","2.853","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","2.213","7.462","1.017","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","8.236","3.544","2.794","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","7.478","4.273","7.642","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":668},{"label":"Fev","value":647},{"label":"Mar","value":428},{"label":"Abr","value":477},{"label":"Mai","value":627},{"label":"Jun","value":423},{"label":"Jul","value":391},{"label":"Ago","value":615},{"label":"Set","value":333},{"label":"Out","value":623},{"label":"Nov","value":288},{"label":"Dez","value":675}];
const MX = 675;
