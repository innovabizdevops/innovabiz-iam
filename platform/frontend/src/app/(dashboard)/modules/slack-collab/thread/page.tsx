...
const PAGE = "Thread";
const KPIS = [{"l":"Tickets Abertos","v":"8.978","t":"+11.4%","d":"up"},{"l":"SLA Cumprido (%)","v":"75.0%","t":"+15.0%","d":"up"},{"l":"MTTR (h)","v":"28h","t":"+2.5%","d":"up"},{"l":"Satisfação (%)","v":"67.3%","t":"+17.2%","d":"up"}];
const COLS = ["Ticket","Prioridade","Categoria","Reportado Por","Atribuído","Estado"];
const ROWS = [{"id":"r0","cells":["INC-2026-89210","INC-2026-89211","4.808","409","6.934","Ativo"],"status":"active"},{"id":"r1","cells":["INC-2026-89211","INC-2026-89212","7.879","4.244","5.268","Pendente"],"status":"pending"},{"id":"r2","cells":["INC-2026-89212","INC-2026-89213","4.195","1.038","5.931","Concluído"],"status":"done"},{"id":"r3","cells":["INC-2026-89213","INC-2026-89214","6.400","8.611","5.735","Em Análise"],"status":"risk"},{"id":"r4","cells":["INC-2026-89214","INC-2026-89210","3.165","7.893","5.457","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":859},{"label":"Fev","value":839},{"label":"Mar","value":558},{"label":"Abr","value":751},{"label":"Mai","value":616},{"label":"Jun","value":766},{"label":"Jul","value":865},{"label":"Ago","value":687},{"label":"Set","value":541},{"label":"Out","value":561},{"label":"Nov","value":670},{"label":"Dez","value":534}];
const MX = 865;
