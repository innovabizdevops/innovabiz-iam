...
const ACCENT = "#4338ca";
const MODULE = "Newsletter Management";
const PAGE = "Subscriber";
const KPIS = [{"l":"Total Newsletter Mgmt","v":"8.456","t":"+3.9%","d":"up"},{"l":"Subscriber Ativos","v":"719","t":"+11.1%","d":"up"},{"l":"Eficiência (%)","v":"81.7%","t":"+1.1%","d":"up"},{"l":"Score Performance","v":"83","t":"+8.1%","d":"up"}];
const COLS = ["ID","Subscriber","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Newsletter Mgmt #001","Newsletter Mgmt #002","2.172","509","2026-02-01","Ativo"],"status":"active"},{"id":"r1","cells":["Newsletter Mgmt #002","Newsletter Mgmt #003","4.067","7.011","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Newsletter Mgmt #003","Newsletter Mgmt #004","2.101","6.181","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Newsletter Mgmt #004","Newsletter Mgmt #005","4.785","3.837","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Newsletter Mgmt #005","Newsletter Mgmt #001","625","4.556","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":613},{"label":"Fev","value":633},{"label":"Mar","value":400},{"label":"Abr","value":689},{"label":"Mai","value":685},{"label":"Jun","value":685},{"label":"Jul","value":413},{"label":"Ago","value":404},{"label":"Set","value":486},{"label":"Out","value":316},{"label":"Nov","value":338},{"label":"Dez","value":370}];
const MX = 689;
