...
const PAGE = "Edition Builder";
const KPIS = [{"l":"Integrações Ativas","v":"7.110","t":"+14.5%","d":"up"},{"l":"Chamadas/Hora","v":"5024","t":"+10.5%","d":"up"},{"l":"Taxa Sucesso (%)","v":"75.8%","t":"+13.1%","d":"up"},{"l":"Latência Média (ms)","v":"176ms","t":"-6.0%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","6.965","3.171","95.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.644","5.350","94.7%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","4.715","4.712","90.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.086","6.929","88.4%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","8.260","6.298","88.8%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":413},{"label":"Fev","value":509},{"label":"Mar","value":663},{"label":"Abr","value":343},{"label":"Mai","value":349},{"label":"Jun","value":650},{"label":"Jul","value":437},{"label":"Ago","value":553},{"label":"Set","value":435},{"label":"Out","value":315},{"label":"Nov","value":483},{"label":"Dez","value":315}];
const MX = 663;
