...
const KPIS = [{"l":"Dashboards Ativos","v":"4.115","t":"+7.7%","d":"up"},{"l":"Queries/Dia","v":"4111","t":"-0.9%","d":"down"},{"l":"Dados Processados (GB)","v":"3.083","t":"+8.7%","d":"up"},{"l":"Utilizadores Analytics","v":"7.399","t":"+8.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3925","2026-01-18","2.175","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1397","2026-02-08","5.883","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","646","2026-03-07","4.007","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3742","2026-03-08","7.854","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4889","2026-03-13","2.978","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":368},{"label":"Fev","value":320},{"label":"Mar","value":478},{"label":"Abr","value":506},{"label":"Mai","value":518},{"label":"Jun","value":275},{"label":"Jul","value":582},{"label":"Ago","value":551},{"label":"Set","value":286},{"label":"Out","value":365},{"label":"Nov","value":367},{"label":"Dez","value":580}];
const MX = 582;
