...
const PAGE = "Berth";
const KPIS = [{"l":"Riscos Identificados","v":"4.929","t":"+1.8%","d":"up"},{"l":"Mitigações Ativas","v":"4.542","t":"+5.5%","d":"up"},{"l":"Score Risco Geral","v":"64","t":"+11.4%","d":"up"},{"l":"Incidentes YTD","v":"451","t":"+5.3%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","1.229","4.591","2.248","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.994","3.132","299","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","6.821","8.331","7.964","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.111","1.489","1.369","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","2.932","7.874","3.848","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":795},{"label":"Fev","value":800},{"label":"Mar","value":897},{"label":"Abr","value":744},{"label":"Mai","value":664},{"label":"Jun","value":999},{"label":"Jul","value":912},{"label":"Ago","value":686},{"label":"Set","value":1009},{"label":"Out","value":897},{"label":"Nov","value":660},{"label":"Dez","value":913}];
const MX = 1009;
