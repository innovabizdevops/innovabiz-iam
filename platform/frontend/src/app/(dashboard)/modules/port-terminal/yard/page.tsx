...
const PAGE = "Yard";
const KPIS = [{"l":"Riscos Identificados","v":"3.959","t":"+10.6%","d":"up"},{"l":"Mitigações Ativas","v":"7.025","t":"+12.1%","d":"up"},{"l":"Score Risco Geral","v":"89","t":"-3.9%","d":"down"},{"l":"Incidentes YTD","v":"5.520","t":"+3.6%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.242","8.321","2.727","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","6.845","7.020","1.219","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","5.531","6.902","2.611","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.721","4.557","2.878","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","9.036","6.682","1.175","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":558},{"label":"Fev","value":754},{"label":"Mar","value":585},{"label":"Abr","value":807},{"label":"Mai","value":811},{"label":"Jun","value":598},{"label":"Jul","value":598},{"label":"Ago","value":594},{"label":"Set","value":886},{"label":"Out","value":517},{"label":"Nov","value":566},{"label":"Dez","value":752}];
const MX = 886;
