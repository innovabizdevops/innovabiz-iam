...
const PAGE = "Vessel";
const KPIS = [{"l":"Riscos Identificados","v":"1.386","t":"+9.9%","d":"up"},{"l":"Mitigações Ativas","v":"8.597","t":"+13.8%","d":"up"},{"l":"Score Risco Geral","v":"56","t":"+15.6%","d":"up"},{"l":"Incidentes YTD","v":"637","t":"-3.3%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","7.645","3.551","6.083","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","403","1.370","883","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.720","4.193","3.721","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","6.067","7.695","958","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.385","1.959","4.172","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":311},{"label":"Fev","value":688},{"label":"Mar","value":487},{"label":"Abr","value":610},{"label":"Mai","value":584},{"label":"Jun","value":319},{"label":"Jul","value":476},{"label":"Ago","value":335},{"label":"Set","value":304},{"label":"Out","value":483},{"label":"Nov","value":420},{"label":"Dez","value":345}];
const MX = 688;
