...
const PAGE = "Gate";
const KPIS = [{"l":"Riscos Identificados","v":"740","t":"-4.8%","d":"down"},{"l":"Mitigações Ativas","v":"7.305","t":"+2.3%","d":"up"},{"l":"Score Risco Geral","v":"79","t":"+5.2%","d":"up"},{"l":"Incidentes YTD","v":"8.904","t":"-2.6%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","2.198","2.053","3.817","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","3.631","8.258","4.292","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","7.793","4.005","5.065","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","553","7.386","6.956","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.258","5.440","7.435","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":983},{"label":"Fev","value":996},{"label":"Mar","value":771},{"label":"Abr","value":990},{"label":"Mai","value":900},{"label":"Jun","value":846},{"label":"Jul","value":993},{"label":"Ago","value":780},{"label":"Set","value":815},{"label":"Out","value":965},{"label":"Nov","value":997},{"label":"Dez","value":788}];
const MX = 997;
