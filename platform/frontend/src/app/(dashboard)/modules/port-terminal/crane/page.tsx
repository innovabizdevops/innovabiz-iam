...
const ACCENT = "#6366f1";
const MODULE = "Port & Terminal";
const PAGE = "Crane";
const KPIS = [{"l":"Riscos Identificados","v":"4.403","t":"-2.7%","d":"down"},{"l":"Mitigações Ativas","v":"6.147","t":"+15.5%","d":"up"},{"l":"Score Risco Geral","v":"86","t":"+16.6%","d":"up"},{"l":"Incidentes YTD","v":"1.267","t":"-0.2%","d":"down"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","4.065","6.360","5.981","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","2.215","8.828","8.135","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","8.483","4.182","8.283","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.206","3.708","5.069","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","1.316","6.348","5.689","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":899},{"label":"Fev","value":1021},{"label":"Mar","value":944},{"label":"Abr","value":816},{"label":"Mai","value":935},{"label":"Jun","value":784},{"label":"Jul","value":1032},{"label":"Ago","value":687},{"label":"Set","value":1046},{"label":"Out","value":791},{"label":"Nov","value":955},{"label":"Dez","value":746}];
const MX = 1046;
