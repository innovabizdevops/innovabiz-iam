...
const KPIS = [{"l":"Notificações Enviadas","v":"9.053","t":"+15.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"82.1%","t":"-1.9%","d":"down"},{"l":"Taxa Abertura (%)","v":"77.6%","t":"+14.8%","d":"up"},{"l":"Escalações","v":"7.379","t":"+10.6%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.026","83.3%","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.358","84.3%","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","2.480","84.8%","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","1.276","98.0%","2026-02-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","5.452","76.4%","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":574},{"label":"Fev","value":534},{"label":"Mar","value":230},{"label":"Abr","value":571},{"label":"Mai","value":565},{"label":"Jun","value":419},{"label":"Jul","value":387},{"label":"Ago","value":485},{"label":"Set","value":337},{"label":"Out","value":475},{"label":"Nov","value":337},{"label":"Dez","value":520}];
const MX = 574;
