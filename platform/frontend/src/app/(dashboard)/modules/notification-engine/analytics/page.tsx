...
const PAGE = "Delivery Analytics";
const KPIS = [{"l":"Dashboards Ativos","v":"826","t":"+0.6%","d":"up"},{"l":"Queries/Dia","v":"1742","t":"+1.5%","d":"up"},{"l":"Dados Processados (GB)","v":"4.249","t":"+15.6%","d":"up"},{"l":"Utilizadores Analytics","v":"7.444","t":"+13.5%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3244","2026-01-04","1.269","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","455","2026-02-27","5.292","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1130","2026-03-13","7.555","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","793","2026-02-11","585","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","1499","2026-01-17","7.834","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":572},{"label":"Fev","value":607},{"label":"Mar","value":793},{"label":"Abr","value":879},{"label":"Mai","value":685},{"label":"Jun","value":810},{"label":"Jul","value":872},{"label":"Ago","value":792},{"label":"Set","value":656},{"label":"Out","value":762},{"label":"Nov","value":659},{"label":"Dez","value":806}];
const MX = 879;
