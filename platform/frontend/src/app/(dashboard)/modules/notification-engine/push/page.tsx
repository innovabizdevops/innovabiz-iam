...
const PAGE = "Push Notifications";
const KPIS = [{"l":"Notificações Enviadas","v":"5.801","t":"+4.1%","d":"up"},{"l":"Taxa Entrega (%)","v":"88.8%","t":"+11.7%","d":"up"},{"l":"Taxa Abertura (%)","v":"87.3%","t":"+11.9%","d":"up"},{"l":"Escalações","v":"5.029","t":"+8.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","7.668","89.4%","2026-03-09","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","7.067","91.5%","2026-01-04","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.275","82.5%","2026-02-17","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","7.359","87.2%","2026-02-25","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.953","71.7%","2026-02-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":509},{"label":"Fev","value":585},{"label":"Mar","value":341},{"label":"Abr","value":325},{"label":"Mai","value":593},{"label":"Jun","value":210},{"label":"Jul","value":552},{"label":"Ago","value":549},{"label":"Set","value":309},{"label":"Out","value":408},{"label":"Nov","value":494},{"label":"Dez","value":225}];
const MX = 593;
