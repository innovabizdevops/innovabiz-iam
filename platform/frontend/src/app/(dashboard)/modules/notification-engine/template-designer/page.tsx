...
const ACCENT = "#f59e0b";
const MODULE = "Notification Engine";
const PAGE = "Template Designer";
const KPIS = [{"l":"Formulários Ativos","v":"4.578","t":"+4.3%","d":"up"},{"l":"Submissões/Dia","v":"4799","t":"+15.5%","d":"up"},{"l":"Documentos Gerados","v":"454","t":"+13.8%","d":"up"},{"l":"Templates","v":"6.782","t":"-5.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.003","2026-01-12","3.724","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","339","2026-02-21","6.610","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","630","2026-02-01","5.313","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.768","2026-01-01","7.788","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.562","2026-03-25","6.778","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":527},{"label":"Fev","value":311},{"label":"Mar","value":415},{"label":"Abr","value":390},{"label":"Mai","value":504},{"label":"Jun","value":393},{"label":"Jul","value":416},{"label":"Ago","value":534},{"label":"Set","value":262},{"label":"Out","value":278},{"label":"Nov","value":465},{"label":"Dez","value":530}];
const MX = 534;
