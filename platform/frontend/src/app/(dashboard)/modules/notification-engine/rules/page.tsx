...
const PAGE = "Notification Rules";
const KPIS = [{"l":"Notificações Enviadas","v":"5.299","t":"+1.0%","d":"up"},{"l":"Taxa Entrega (%)","v":"79.0%","t":"-0.8%","d":"down"},{"l":"Taxa Abertura (%)","v":"91.1%","t":"+16.0%","d":"up"},{"l":"Escalações","v":"1.522","t":"-2.0%","d":"down"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","902","88.6%","2026-02-24","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","504","90.9%","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","4.374","88.3%","2026-03-11","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","5.369","84.7%","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","8.809","77.2%","2026-03-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":569},{"label":"Fev","value":530},{"label":"Mar","value":625},{"label":"Abr","value":432},{"label":"Mai","value":449},{"label":"Jun","value":615},{"label":"Jul","value":273},{"label":"Ago","value":305},{"label":"Set","value":309},{"label":"Out","value":372},{"label":"Nov","value":350},{"label":"Dez","value":252}];
const MX = 625;
