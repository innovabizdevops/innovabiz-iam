...
const PAGE = "SMS &amp; WhatsApp";
const KPIS = [{"l":"Notificações Enviadas","v":"7.959","t":"-1.4%","d":"down"},{"l":"Taxa Entrega (%)","v":"74.6%","t":"+4.0%","d":"up"},{"l":"Taxa Abertura (%)","v":"84.5%","t":"+12.1%","d":"up"},{"l":"Escalações","v":"6.617","t":"+17.4%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.899","73.1%","2026-02-23","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","4.358","98.3%","2026-02-21","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.901","79.6%","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","4.129","82.3%","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","2.677","96.9%","2026-03-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":659},{"label":"Mar","value":824},{"label":"Abr","value":779},{"label":"Mai","value":603},{"label":"Jun","value":884},{"label":"Jul","value":735},{"label":"Ago","value":511},{"label":"Set","value":794},{"label":"Out","value":572},{"label":"Nov","value":502},{"label":"Dez","value":655}];
const MX = 884;
