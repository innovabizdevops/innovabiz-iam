...
const PAGE = "Webhook Triggers";
const KPIS = [{"l":"Integrações Ativas","v":"4.976","t":"+8.6%","d":"up"},{"l":"Chamadas/Hora","v":"3776","t":"-4.7%","d":"down"},{"l":"Taxa Sucesso (%)","v":"93.9%","t":"+15.7%","d":"up"},{"l":"Latência Média (ms)","v":"151ms","t":"-0.6%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","198","1.603","97.4%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.722","4.773","85.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.143","8.850","76.9%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.501","6.595","75.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.826","580","85.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":648},{"label":"Fev","value":371},{"label":"Mar","value":547},{"label":"Abr","value":551},{"label":"Mai","value":699},{"label":"Jun","value":369},{"label":"Jul","value":389},{"label":"Ago","value":477},{"label":"Set","value":566},{"label":"Out","value":512},{"label":"Nov","value":591},{"label":"Dez","value":679}];
const MX = 699;
