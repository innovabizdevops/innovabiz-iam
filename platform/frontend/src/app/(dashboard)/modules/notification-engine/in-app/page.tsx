...
const PAGE = "In-App Notifications";
const KPIS = [{"l":"Notificações Enviadas","v":"6.402","t":"+11.7%","d":"up"},{"l":"Taxa Entrega (%)","v":"89.2%","t":"+17.8%","d":"up"},{"l":"Taxa Abertura (%)","v":"93.7%","t":"+17.5%","d":"up"},{"l":"Escalações","v":"3.643","t":"+1.2%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","3.722","85.2%","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","5.674","74.5%","2026-01-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","5.871","90.6%","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.155","86.9%","2026-03-27","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","3.701","70.1%","2026-03-20","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":800},{"label":"Fev","value":729},{"label":"Mar","value":1056},{"label":"Abr","value":666},{"label":"Mai","value":837},{"label":"Jun","value":931},{"label":"Jul","value":1027},{"label":"Ago","value":1027},{"label":"Set","value":843},{"label":"Out","value":981},{"label":"Nov","value":927},{"label":"Dez","value":767}];
const MX = 1056;
