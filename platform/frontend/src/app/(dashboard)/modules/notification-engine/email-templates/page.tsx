...
const KPIS = [{"l":"Formulários Ativos","v":"4.614","t":"+-0.0%","d":"up"},{"l":"Submissões/Dia","v":"1856","t":"+14.8%","d":"up"},{"l":"Documentos Gerados","v":"975","t":"+10.5%","d":"up"},{"l":"Templates","v":"2.804","t":"+10.3%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.969","2026-01-05","8.696","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.524","2026-01-26","2.564","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.706","2026-01-15","6.199","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.776","2026-01-19","6.219","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","2.785","2026-03-16","8.491","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":523},{"label":"Fev","value":681},{"label":"Mar","value":560},{"label":"Abr","value":740},{"label":"Mai","value":576},{"label":"Jun","value":667},{"label":"Jul","value":819},{"label":"Ago","value":880},{"label":"Set","value":790},{"label":"Out","value":844},{"label":"Nov","value":660},{"label":"Dez","value":520}];
const MX = 880;
