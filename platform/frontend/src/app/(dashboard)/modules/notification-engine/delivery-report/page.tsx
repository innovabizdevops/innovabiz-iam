...
const PAGE = "Delivery Report";
const KPIS = [{"l":"Notificações Enviadas","v":"9.014","t":"-5.1%","d":"down"},{"l":"Taxa Entrega (%)","v":"68.4%","t":"-2.0%","d":"down"},{"l":"Taxa Abertura (%)","v":"72.8%","t":"+1.8%","d":"up"},{"l":"Escalações","v":"2.136","t":"+13.1%","d":"up"}];
const COLS = ["Notificação","Canal","Destinatários","Entregue (%)","Data Envio","Estado"];
const ROWS = [{"id":"r0","cells":["Alerta SLA Crítico","Lembrete Renovação","1.292","73.5%","2026-03-22","Ativo"],"status":"active"},{"id":"r1","cells":["Lembrete Renovação","Aprovação Pendente","1.199","72.5%","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Aprovação Pendente","Mudança Planeada","8.184","89.3%","2026-01-24","Concluído"],"status":"done"},{"id":"r3","cells":["Mudança Planeada","Incidente P1","6.247","73.7%","2026-01-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Incidente P1","Alerta SLA Crítico","6.352","89.8%","2026-03-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":539},{"label":"Fev","value":319},{"label":"Mar","value":558},{"label":"Abr","value":630},{"label":"Mai","value":341},{"label":"Jun","value":442},{"label":"Jul","value":406},{"label":"Ago","value":502},{"label":"Set","value":518},{"label":"Out","value":536},{"label":"Nov","value":472},{"label":"Dez","value":340}];
const MX = 630;
