...
const ACCENT = "#ec4899";
const MODULE = "Metaverse Operations";
const PAGE = "World Build";
const KPIS = [{"l":"Twins Ativos","v":"7.354","t":"+12.2%","d":"up"},{"l":"Simulações/Dia","v":"3031","t":"-1.3%","d":"down"},{"l":"Precisão Modelo (%)","v":"86.8%","t":"+5.1%","d":"up"},{"l":"Latência Sync (ms)","v":"188ms","t":"+2.3%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","92.7%","2026-03-16","4.930","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","91.7%","2026-01-03","3.045","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","91.6%","2026-01-26","7.670","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","91.5%","2026-01-20","7.788","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.2%","2026-01-09","387","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":755},{"label":"Fev","value":698},{"label":"Mar","value":806},{"label":"Abr","value":806},{"label":"Mai","value":724},{"label":"Jun","value":871},{"label":"Jul","value":853},{"label":"Ago","value":914},{"label":"Set","value":726},{"label":"Out","value":880},{"label":"Nov","value":782},{"label":"Dez","value":871}];
const MX = 914;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#ec4899'}}>3D</span></h1>
                </div>
