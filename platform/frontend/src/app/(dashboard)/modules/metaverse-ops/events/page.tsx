...
const PAGE = "Events";
const KPIS = [{"l":"Twins Ativos","v":"3.502","t":"+8.2%","d":"up"},{"l":"Simulações/Dia","v":"2877","t":"+6.4%","d":"up"},{"l":"Precisão Modelo (%)","v":"69.2%","t":"+0.9%","d":"up"},{"l":"Latência Sync (ms)","v":"146ms","t":"-3.4%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","99.0%","2026-03-04","848","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","78.0%","2026-01-02","6.609","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","77.4%","2026-01-15","8.382","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","94.3%","2026-01-08","3.738","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","76.3%","2026-03-20","1.399","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":473},{"label":"Fev","value":633},{"label":"Mar","value":727},{"label":"Abr","value":439},{"label":"Mai","value":507},{"label":"Jun","value":602},{"label":"Jul","value":546},{"label":"Ago","value":787},{"label":"Set","value":595},{"label":"Out","value":778},{"label":"Nov","value":701},{"label":"Dez","value":802}];
const MX = 802;
