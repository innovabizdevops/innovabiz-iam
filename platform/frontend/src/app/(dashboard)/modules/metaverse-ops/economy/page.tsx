...
const PAGE = "Economy";
const KPIS = [{"l":"Twins Ativos","v":"491","t":"+0.5%","d":"up"},{"l":"Simulações/Dia","v":"2994","t":"+0.8%","d":"up"},{"l":"Precisão Modelo (%)","v":"83.6%","t":"-2.6%","d":"down"},{"l":"Latência Sync (ms)","v":"95ms","t":"-5.2%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","71.9%","2026-03-15","387","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","98.4%","2026-01-01","5.038","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","75.2%","2026-02-28","2.166","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","99.5%","2026-01-24","8.481","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","92.4%","2026-01-21","1.950","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":598},{"label":"Fev","value":574},{"label":"Mar","value":341},{"label":"Abr","value":543},{"label":"Mai","value":509},{"label":"Jun","value":521},{"label":"Jul","value":628},{"label":"Ago","value":594},{"label":"Set","value":533},{"label":"Out","value":556},{"label":"Nov","value":321},{"label":"Dez","value":485}];
const MX = 628;
