...
const KPIS = [{"l":"Twins Ativos","v":"2.035","t":"+12.9%","d":"up"},{"l":"Simulações/Dia","v":"4312","t":"-1.8%","d":"down"},{"l":"Precisão Modelo (%)","v":"69.2%","t":"-0.5%","d":"down"},{"l":"Latência Sync (ms)","v":"51ms","t":"+6.2%","d":"up"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","82.6%","2026-03-12","3.662","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","77.4%","2026-02-08","7.384","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","90.6%","2026-03-07","1.289","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","97.9%","2026-02-02","8.628","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","88.8%","2026-03-09","1.308","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":559},{"label":"Fev","value":729},{"label":"Mar","value":619},{"label":"Abr","value":513},{"label":"Mai","value":444},{"label":"Jun","value":736},{"label":"Jul","value":769},{"label":"Ago","value":618},{"label":"Set","value":440},{"label":"Out","value":618},{"label":"Nov","value":419},{"label":"Dez","value":570}];
const MX = 769;
