...
export default function MetaverseOpsPage() {
    return (
        <div className="p-6 space-y-6">
            <div><h1 className="text-2xl font-bold">Metaverse Ops</h1><p className="text-sm text-muted-foreground">Metaverse Ops • iBOS</p></div>
