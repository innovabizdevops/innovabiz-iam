...
const PAGE = "Avatar";
const KPIS = [{"l":"Twins Ativos","v":"398","t":"-2.1%","d":"down"},{"l":"Simulações/Dia","v":"4224","t":"-5.4%","d":"down"},{"l":"Precisão Modelo (%)","v":"94.7%","t":"+8.4%","d":"up"},{"l":"Latência Sync (ms)","v":"76ms","t":"-5.8%","d":"down"}];
const COLS = ["Twin","Ativo Físico","Precisão (%)","Última Sync","Simulações","Estado"];
const ROWS = [{"id":"r0","cells":["DT-Turbina-Norte","DT-Linha-Prod-A","79.4%","2026-01-07","6.607","Ativo"],"status":"active"},{"id":"r1","cells":["DT-Linha-Prod-A","DT-Edifício-HQ","92.9%","2026-02-23","6.626","Pendente"],"status":"pending"},{"id":"r2","cells":["DT-Edifício-HQ","DT-Rede-Eléctrica","91.6%","2026-01-03","2.610","Concluído"],"status":"done"},{"id":"r3","cells":["DT-Rede-Eléctrica","DT-Frota-Sul","84.6%","2026-03-02","6.952","Em Análise"],"status":"risk"},{"id":"r4","cells":["DT-Frota-Sul","DT-Turbina-Norte","84.0%","2026-02-18","3.927","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":645},{"label":"Fev","value":632},{"label":"Mar","value":653},{"label":"Abr","value":791},{"label":"Mai","value":757},{"label":"Jun","value":579},{"label":"Jul","value":658},{"label":"Ago","value":580},{"label":"Set","value":628},{"label":"Out","value":645},{"label":"Nov","value":707},{"label":"Dez","value":874}];
const MX = 874;
