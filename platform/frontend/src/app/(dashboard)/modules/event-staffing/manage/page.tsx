...
const PAGE = "Manage";
const KPIS = [{"l":"Eventos Planeados","v":"703","t":"+8.2%","d":"up"},{"l":"Participantes","v":"3.601","t":"+11.2%","d":"up"},{"l":"NPS Evento","v":"76","t":"-0.8%","d":"down"},{"l":"Receita (€)","v":"€98860","t":"+7.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-05","3.759","4.862","€ 38888.47","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-01-07","7.947","3.128","€ 42311.05","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-01-09","7.161","2.864","€ 26085.19","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-27","2.724","1.994","€ 34209.26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-21","2.481","6.161","€ 32997.15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":848},{"label":"Fev","value":614},{"label":"Mar","value":523},{"label":"Abr","value":883},{"label":"Mai","value":526},{"label":"Jun","value":649},{"label":"Jul","value":581},{"label":"Ago","value":814},{"label":"Set","value":613},{"label":"Out","value":579},{"label":"Nov","value":892},{"label":"Dez","value":588}];
const MX = 892;
