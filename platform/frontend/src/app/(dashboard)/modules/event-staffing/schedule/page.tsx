...
const PAGE = "Schedule";
const KPIS = [{"l":"Eventos Planeados","v":"8.754","t":"+10.3%","d":"up"},{"l":"Participantes","v":"624","t":"+17.3%","d":"up"},{"l":"NPS Evento","v":"67","t":"+3.0%","d":"up"},{"l":"Receita (€)","v":"€35540","t":"+10.2%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-03-14","6.246","8.019","€ 3449.16","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-05","6.107","6.684","€ 19439.77","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-02","4.003","6.223","€ 43985.73","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-13","7.944","2.634","€ 26273.79","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-01-20","278","561","€ 14106.78","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":673},{"label":"Fev","value":335},{"label":"Mar","value":446},{"label":"Abr","value":336},{"label":"Mai","value":552},{"label":"Jun","value":500},{"label":"Jul","value":479},{"label":"Ago","value":327},{"label":"Set","value":506},{"label":"Out","value":451},{"label":"Nov","value":503},{"label":"Dez","value":308}];
const MX = 673;
