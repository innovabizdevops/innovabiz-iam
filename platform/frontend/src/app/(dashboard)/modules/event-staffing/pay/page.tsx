...
const PAGE = "Pay";
const KPIS = [{"l":"Eventos Planeados","v":"1.703","t":"+1.9%","d":"up"},{"l":"Participantes","v":"5.618","t":"+13.3%","d":"up"},{"l":"NPS Evento","v":"69","t":"+5.8%","d":"up"},{"l":"Receita (€)","v":"€1218","t":"+2.3%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-02-18","2.370","8.439","€ 30899.90","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-02-10","6.716","5.052","€ 49538.16","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-02-04","5.032","4.040","€ 25159.20","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-02-15","7.041","4.072","€ 22305.01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-02-18","7.292","4.476","€ 8934.01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":363},{"label":"Fev","value":537},{"label":"Mar","value":383},{"label":"Abr","value":457},{"label":"Mai","value":623},{"label":"Jun","value":364},{"label":"Jul","value":458},{"label":"Ago","value":576},{"label":"Set","value":256},{"label":"Out","value":281},{"label":"Nov","value":354},{"label":"Dez","value":368}];
const MX = 623;
