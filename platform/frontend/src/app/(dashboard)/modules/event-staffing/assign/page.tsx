...
const ACCENT = "#9d174d";
const MODULE = "Event Staffing";
const PAGE = "Assign";
const KPIS = [{"l":"Eventos Planeados","v":"8.226","t":"+6.2%","d":"up"},{"l":"Participantes","v":"8.021","t":"+13.7%","d":"up"},{"l":"NPS Evento","v":"92","t":"+16.1%","d":"up"},{"l":"Receita (€)","v":"€14173","t":"+12.1%","d":"up"}];
const COLS = ["Evento","Data","Local","Participantes","Budget (€)","Estado"];
const ROWS = [{"id":"r0","cells":["Summit IA 2026","2026-01-26","4.647","5.440","€ 30048.55","Ativo"],"status":"active"},{"id":"r1","cells":["Webinar Cloud Native","2026-03-12","7.022","1.386","€ 24679.17","Pendente"],"status":"pending"},{"id":"r2","cells":["Workshop Agile","2026-03-08","689","326","€ 23868.40","Concluído"],"status":"done"},{"id":"r3","cells":["Meetup DevOps","2026-03-26","7.566","5.763","€ 31361.95","Em Análise"],"status":"risk"},{"id":"r4","cells":["Hackathon ESG","2026-03-15","9.067","1.609","€ 7553.05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":616},{"label":"Fev","value":433},{"label":"Mar","value":757},{"label":"Abr","value":678},{"label":"Mai","value":617},{"label":"Jun","value":546},{"label":"Jul","value":451},{"label":"Ago","value":775},{"label":"Set","value":638},{"label":"Out","value":507},{"label":"Nov","value":774},{"label":"Dez","value":766}];
const MX = 775;
