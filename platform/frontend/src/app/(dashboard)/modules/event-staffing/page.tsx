...
/* ═══ Event Staffing — Dashboard ═══ */

const ACCENT = "#9d174d";

const KPIS = [
    { label: "Total Registos", value: "8984", trend: "+10%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "472", trend: "-4%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€40K", trend: "+23%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1966346884", cells: ["EVE-9884", "Event Staffing Item 1", "13/5/2026", "€46 984"], status: "active" as const },
    { id: "1966350455", cells: ["EVE-4455", "Event Staffing Item 2", "28/12/2026", "€555"], status: "pending" as const },
    { id: "1966354026", cells: ["EVE-8026", "Event Staffing Item 3", "15/7/2026", "€4126"], status: "completed" as const },
    { id: "1966357597", cells: ["EVE-2597", "Event Staffing Item 4", "2/2/2026", "€7697"], status: "warning" as const },
    { id: "1966361168", cells: ["EVE-6168", "Event Staffing Item 5", "17/9/2026", "€11 268"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Event Staffing</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Event Staffing</p>
                    </div>
                </div>
