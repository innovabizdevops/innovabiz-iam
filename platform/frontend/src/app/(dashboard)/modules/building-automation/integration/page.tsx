...
const KPIS = [{"l":"Integrações Ativas","v":"4.995","t":"+2.5%","d":"up"},{"l":"Chamadas/Hora","v":"4544","t":"-0.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"90.8%","t":"-1.8%","d":"down"},{"l":"Latência Média (ms)","v":"48ms","t":"-2.3%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","9.010","8.378","97.9%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.488","2.193","92.3%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","738","1.772","88.2%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","3.471","2.172","87.0%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","2.954","1.142","89.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":362},{"label":"Fev","value":649},{"label":"Mar","value":582},{"label":"Abr","value":290},{"label":"Mai","value":373},{"label":"Jun","value":487},{"label":"Jul","value":297},{"label":"Ago","value":610},{"label":"Set","value":595},{"label":"Out","value":479},{"label":"Nov","value":307},{"label":"Dez","value":274}];
const MX = 649;
