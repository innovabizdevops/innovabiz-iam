...
const PAGE = "NF-e";
const KPIS = [{"l":"Total Brazil Fiscal","v":"7.216","t":"-3.2%","d":"down"},{"l":"NF E Ativos","v":"5.813","t":"+0.8%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+4.8%","d":"up"},{"l":"Score Performance","v":"74","t":"+10.0%","d":"up"}];
const COLS = ["ID","NF E","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brazil Fiscal #001","Brazil Fiscal #002","7.888","5.520","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Brazil Fiscal #002","Brazil Fiscal #003","5.264","1.880","2026-02-08","Pendente"],"status":"pending"},{"id":"r2","cells":["Brazil Fiscal #003","Brazil Fiscal #004","782","3.026","2026-02-01","Concluído"],"status":"done"},{"id":"r3","cells":["Brazil Fiscal #004","Brazil Fiscal #005","4.977","4.424","2026-01-09","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brazil Fiscal #005","Brazil Fiscal #001","8.312","8.091","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":433},{"label":"Fev","value":240},{"label":"Mar","value":527},{"label":"Abr","value":357},{"label":"Mai","value":535},{"label":"Jun","value":512},{"label":"Jul","value":469},{"label":"Ago","value":585},{"label":"Set","value":361},{"label":"Out","value":486},{"label":"Nov","value":377},{"label":"Dez","value":587}];
const MX = 587;
