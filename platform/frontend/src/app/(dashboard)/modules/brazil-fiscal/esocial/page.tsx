...
const PAGE = "eSocial";
const KPIS = [{"l":"Total Brazil Fiscal","v":"1.601","t":"-2.3%","d":"down"},{"l":"ESocial Ativos","v":"309","t":"+8.5%","d":"up"},{"l":"Eficiência (%)","v":"89.8%","t":"+5.1%","d":"up"},{"l":"Score Performance","v":"78","t":"+14.8%","d":"up"}];
const COLS = ["ID","ESocial","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brazil Fiscal #001","Brazil Fiscal #002","2.576","5.471","2026-03-03","Ativo"],"status":"active"},{"id":"r1","cells":["Brazil Fiscal #002","Brazil Fiscal #003","8.044","5.314","2026-01-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Brazil Fiscal #003","Brazil Fiscal #004","269","9.037","2026-02-07","Concluído"],"status":"done"},{"id":"r3","cells":["Brazil Fiscal #004","Brazil Fiscal #005","7.929","3.063","2026-02-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brazil Fiscal #005","Brazil Fiscal #001","4.465","2.580","2026-03-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":586},{"label":"Fev","value":790},{"label":"Mar","value":610},{"label":"Abr","value":745},{"label":"Mai","value":757},{"label":"Jun","value":831},{"label":"Jul","value":651},{"label":"Ago","value":495},{"label":"Set","value":648},{"label":"Out","value":738},{"label":"Nov","value":493},{"label":"Dez","value":520}];
const MX = 831;
