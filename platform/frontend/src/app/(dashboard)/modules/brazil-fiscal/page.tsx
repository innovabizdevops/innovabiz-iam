...
/* ═══ Brasil Fiscal (RFB) — Dashboard ═══ */

const ACCENT = "#14532d";

const KPIS = [
    { label: "Total Registos", value: "8522", trend: "+23%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "4438", trend: "-17%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€350K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1090750822", cells: ["BRA-5822", "Brasil Fiscal (RFB) Item 1", "15/11/2026", "€922"], status: "active" as const },
    { id: "1090754393", cells: ["BRA-9393", "Brasil Fiscal (RFB) Item 2", "2/6/2026", "€4493"], status: "pending" as const },
    { id: "1090757964", cells: ["BRA-3964", "Brasil Fiscal (RFB) Item 3", "17/1/2026", "€8064"], status: "completed" as const },
    { id: "1090761535", cells: ["BRA-7535", "Brasil Fiscal (RFB) Item 4", "4/8/2026", "€11 635"], status: "warning" as const },
    { id: "1090765106", cells: ["BRA-2106", "Brasil Fiscal (RFB) Item 5", "19/3/2026", "€15 206"], status: "active" as const },
];
...
export default function BrasilFiscalRfbPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Brasil Fiscal (RFB)</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Brasil Fiscal (RFB)</p>
                    </div>
                </div>
