...
const ACCENT = "#14532d";
const MODULE = "Brasil Fiscal (RFB)";
const PAGE = "PIS/COFINS";
const KPIS = [{"l":"Total Brazil Fiscal","v":"3.666","t":"+14.5%","d":"up"},{"l":"PIS/COFINS Ativos","v":"5.185","t":"+11.8%","d":"up"},{"l":"Eficiência (%)","v":"91.3%","t":"-2.6%","d":"down"},{"l":"Score Performance","v":"61","t":"+14.7%","d":"up"}];
const COLS = ["ID","PIS/COFINS","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brazil Fiscal #001","Brazil Fiscal #002","2.969","3.548","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Brazil Fiscal #002","Brazil Fiscal #003","3.588","6.955","2026-03-03","Pendente"],"status":"pending"},{"id":"r2","cells":["Brazil Fiscal #003","Brazil Fiscal #004","8.237","2.281","2026-03-10","Concluído"],"status":"done"},{"id":"r3","cells":["Brazil Fiscal #004","Brazil Fiscal #005","7.811","2.069","2026-02-24","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brazil Fiscal #005","Brazil Fiscal #001","5.689","438","2026-02-02","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":599},{"label":"Fev","value":502},{"label":"Mar","value":622},{"label":"Abr","value":327},{"label":"Mai","value":418},{"label":"Jun","value":359},{"label":"Jul","value":512},{"label":"Ago","value":585},{"label":"Set","value":574},{"label":"Out","value":475},{"label":"Nov","value":335},{"label":"Dez","value":691}];
const MX = 691;
