...
const PAGE = "SPED";
const KPIS = [{"l":"Total Brazil Fiscal","v":"3.993","t":"+3.4%","d":"up"},{"l":"SPED Ativos","v":"1.282","t":"-5.3%","d":"down"},{"l":"Eficiência (%)","v":"67.5%","t":"+2.7%","d":"up"},{"l":"Score Performance","v":"79","t":"-4.5%","d":"down"}];
const COLS = ["ID","SPED","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Brazil Fiscal #001","Brazil Fiscal #002","7.860","6.693","2026-02-10","Ativo"],"status":"active"},{"id":"r1","cells":["Brazil Fiscal #002","Brazil Fiscal #003","5.558","4.891","2026-03-14","Pendente"],"status":"pending"},{"id":"r2","cells":["Brazil Fiscal #003","Brazil Fiscal #004","4.694","6.494","2026-03-03","Concluído"],"status":"done"},{"id":"r3","cells":["Brazil Fiscal #004","Brazil Fiscal #005","6.682","4.881","2026-03-23","Em Análise"],"status":"risk"},{"id":"r4","cells":["Brazil Fiscal #005","Brazil Fiscal #001","187","1.493","2026-01-26","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":962},{"label":"Mar","value":915},{"label":"Abr","value":776},{"label":"Mai","value":806},{"label":"Jun","value":946},{"label":"Jul","value":938},{"label":"Ago","value":926},{"label":"Set","value":737},{"label":"Out","value":951},{"label":"Nov","value":644},{"label":"Dez","value":955}];
const MX = 962;
