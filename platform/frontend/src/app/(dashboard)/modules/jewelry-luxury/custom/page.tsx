...
const PAGE = "Custom Design";
const KPIS = [{"l":"Formulários Ativos","v":"9.049","t":"+7.0%","d":"up"},{"l":"Submissões/Dia","v":"813","t":"-3.3%","d":"down"},{"l":"Documentos Gerados","v":"2.347","t":"+-0.0%","d":"up"},{"l":"Templates","v":"8.168","t":"-4.0%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","2.333","2026-03-09","7.089","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","993","2026-02-11","1.547","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","1.495","2026-03-20","2.900","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","3.750","2026-02-22","7.727","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.416","2026-03-25","4.382","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":612},{"label":"Fev","value":661},{"label":"Mar","value":709},{"label":"Abr","value":611},{"label":"Mai","value":682},{"label":"Jun","value":539},{"label":"Jul","value":432},{"label":"Ago","value":432},{"label":"Set","value":742},{"label":"Out","value":561},{"label":"Nov","value":585},{"label":"Dez","value":698}];
const MX = 742;
