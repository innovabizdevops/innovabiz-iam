...
const PAGE = "3D Rendering";
const KPIS = [{"l":"Total Jewelry Luxury","v":"2.169","t":"+12.3%","d":"up"},{"l":"3D Rendering Ativos","v":"230","t":"+7.8%","d":"up"},{"l":"Eficiência (%)","v":"94.7%","t":"-3.3%","d":"down"},{"l":"Score Performance","v":"78","t":"+12.8%","d":"up"}];
const COLS = ["ID","3D Rendering","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Luxury #001","Jewelry Luxury #002","2.066","1.333","2026-01-07","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Luxury #002","Jewelry Luxury #003","6.459","784","2026-03-15","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Luxury #003","Jewelry Luxury #004","1.680","8.971","2026-01-22","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Luxury #004","Jewelry Luxury #005","8.007","7.515","2026-03-28","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Luxury #005","Jewelry Luxury #001","854","6.808","2026-03-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":814},{"label":"Fev","value":743},{"label":"Mar","value":607},{"label":"Abr","value":477},{"label":"Mai","value":595},{"label":"Jun","value":818},{"label":"Jul","value":843},{"label":"Ago","value":762},{"label":"Set","value":464},{"label":"Out","value":666},{"label":"Nov","value":477},{"label":"Dez","value":525}];
const MX = 843;
...
export default function 3dRenderPage() {
    return (
