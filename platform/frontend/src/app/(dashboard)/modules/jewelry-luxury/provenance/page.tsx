...
const ACCENT = "#92400e";
const MODULE = "Jewelry & Watches";
const PAGE = "Provenance Chain";
const KPIS = [{"l":"Total Jewelry Luxury","v":"5.289","t":"+5.3%","d":"up"},{"l":"Provenance Chain Ativos","v":"389","t":"+7.1%","d":"up"},{"l":"Eficiência (%)","v":"69.0%","t":"+4.5%","d":"up"},{"l":"Score Performance","v":"88","t":"-1.9%","d":"down"}];
const COLS = ["ID","Provenance Chain","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Jewelry Luxury #001","Jewelry Luxury #002","5.955","3.337","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Jewelry Luxury #002","Jewelry Luxury #003","2.254","7.289","2026-03-26","Pendente"],"status":"pending"},{"id":"r2","cells":["Jewelry Luxury #003","Jewelry Luxury #004","3.702","6.055","2026-03-27","Concluído"],"status":"done"},{"id":"r3","cells":["Jewelry Luxury #004","Jewelry Luxury #005","8.143","7.542","2026-03-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Jewelry Luxury #005","Jewelry Luxury #001","999","2.066","2026-03-11","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":516},{"label":"Fev","value":600},{"label":"Mar","value":493},{"label":"Abr","value":462},{"label":"Mai","value":713},{"label":"Jun","value":778},{"label":"Jul","value":779},{"label":"Ago","value":776},{"label":"Set","value":625},{"label":"Out","value":614},{"label":"Nov","value":788},{"label":"Dez","value":683}];
const MX = 788;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#92400e'}}>Chain</span></h1>
                </div>
