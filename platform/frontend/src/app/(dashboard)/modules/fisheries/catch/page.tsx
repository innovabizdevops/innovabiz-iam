...
const PAGE = "Catch Tracking";
const KPIS = [{"l":"Embarcações Ativas","v":"3.905","t":"+16.2%","d":"up"},{"l":"Capturas (ton)","v":"1476","t":"+5.6%","d":"up"},{"l":"Quota Utilizada (%)","v":"93.2%","t":"+3.1%","d":"up"},{"l":"Certificações","v":"2.766","t":"+9.5%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","4018","1.023","92.1%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1596","3.807","71.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","1781","5.096","82.9%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","464","6.490","78.9%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","2999","5.302","74.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":670},{"label":"Fev","value":620},{"label":"Mar","value":579},{"label":"Abr","value":436},{"label":"Mai","value":599},{"label":"Jun","value":494},{"label":"Jul","value":587},{"label":"Ago","value":315},{"label":"Set","value":300},{"label":"Out","value":524},{"label":"Nov","value":550},{"label":"Dez","value":417}];
const MX = 670;
