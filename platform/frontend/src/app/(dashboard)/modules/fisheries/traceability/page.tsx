...
const KPIS = [{"l":"Embarcações Ativas","v":"2.966","t":"+10.0%","d":"up"},{"l":"Capturas (ton)","v":"1310","t":"+14.9%","d":"up"},{"l":"Quota Utilizada (%)","v":"65.2%","t":"+15.0%","d":"up"},{"l":"Certificações","v":"6.212","t":"+7.4%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","2037","6.184","99.0%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1230","8.845","79.8%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3620","885","82.4%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","2838","293","79.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","377","4.817","75.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":372},{"label":"Mar","value":708},{"label":"Abr","value":539},{"label":"Mai","value":475},{"label":"Jun","value":487},{"label":"Jul","value":552},{"label":"Ago","value":703},{"label":"Set","value":715},{"label":"Out","value":416},{"label":"Nov","value":733},{"label":"Dez","value":565}];
const MX = 733;
