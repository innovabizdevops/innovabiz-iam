...
const PAGE = "IUU Detection";
const KPIS = [{"l":"Embarcações Ativas","v":"3.527","t":"+1.4%","d":"up"},{"l":"Capturas (ton)","v":"4129","t":"+8.2%","d":"up"},{"l":"Quota Utilizada (%)","v":"69.5%","t":"+11.1%","d":"up"},{"l":"Certificações","v":"7.425","t":"-4.2%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","3366","6.525","93.2%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1860","7.477","72.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","705","6.107","95.7%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","1319","3.800","76.2%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1905","182","87.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":835},{"label":"Fev","value":659},{"label":"Mar","value":530},{"label":"Abr","value":559},{"label":"Mai","value":715},{"label":"Jun","value":666},{"label":"Jul","value":849},{"label":"Ago","value":677},{"label":"Set","value":578},{"label":"Out","value":784},{"label":"Nov","value":863},{"label":"Dez","value":718}];
const MX = 863;
...
export default function IuuPage() {
    return (
