...
const PAGE = "Stock Assessment";
const KPIS = [{"l":"Embarcações Ativas","v":"1.984","t":"+13.2%","d":"up"},{"l":"Capturas (ton)","v":"2626","t":"-5.2%","d":"down"},{"l":"Quota Utilizada (%)","v":"89.8%","t":"+8.3%","d":"up"},{"l":"Certificações","v":"2.255","t":"+11.9%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","3800","3.645","70.0%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","288","1.365","71.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","781","4.014","81.2%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","3879","7.166","71.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1754","8.960","99.4%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":661},{"label":"Fev","value":565},{"label":"Mar","value":479},{"label":"Abr","value":609},{"label":"Mai","value":692},{"label":"Jun","value":469},{"label":"Jul","value":622},{"label":"Ago","value":586},{"label":"Set","value":799},{"label":"Out","value":637},{"label":"Nov","value":434},{"label":"Dez","value":688}];
const MX = 799;
