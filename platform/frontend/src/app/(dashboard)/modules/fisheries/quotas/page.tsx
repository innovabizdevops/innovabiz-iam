...
const KPIS = [{"l":"Vendas YTD (€)","v":"€79346","t":"+9.1%","d":"up"},{"l":"Pipeline (€)","v":"€1331","t":"+11.2%","d":"up"},{"l":"Atingimento Quota (%)","v":"93.8%","t":"+14.8%","d":"up"},{"l":"Win Rate (%)","v":"84.3%","t":"+8.9%","d":"up"}];
const COLS = ["Vendedor","Território","Quota (€)","Realizado (€)","Pipeline (€)","Atingimento (%)"];
const ROWS = [{"id":"r0","cells":["João Almeida EMEA","Maria Santos APAC","€ 27896.87","€ 12377.88","€ 14252.97","73.2%"],"status":"active"},{"id":"r1","cells":["Maria Santos APAC","Pedro Costa LATAM","€ 42731.71","€ 31819.25","€ 45888.96","83.1%"],"status":"pending"},{"id":"r2","cells":["Pedro Costa LATAM","Ana Ferreira PT","€ 13700.41","€ 27783.76","€ 21738.62","90.0%"],"status":"done"},{"id":"r3","cells":["Ana Ferreira PT","Carlos Rodrigues US","€ 4892.72","€ 2021.82","€ 35367.79","89.0%"],"status":"risk"},{"id":"r4","cells":["Carlos Rodrigues US","João Almeida EMEA","€ 33837.50","€ 36609.20","€ 27818.12","86.5%"],"status":"active"}];
const CHART = [{"label":"Jan","value":621},{"label":"Fev","value":405},{"label":"Mar","value":639},{"label":"Abr","value":608},{"label":"Mai","value":485},{"label":"Jun","value":554},{"label":"Jul","value":430},{"label":"Ago","value":419},{"label":"Set","value":360},{"label":"Out","value":484},{"label":"Nov","value":694},{"label":"Dez","value":466}];
const MX = 694;
