...
const PAGE = "MSC Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.020","t":"+1.7%","d":"up"},{"l":"NC Abertas","v":"3.757","t":"+2.4%","d":"up"},{"l":"Conformidade (%)","v":"91.6%","t":"+15.5%","d":"up"},{"l":"CAPAs Pendentes","v":"2.184","t":"+3.3%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.517","85.8%","4.880","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","6.599","70.3%","6.401","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","576","89.3%","2.145","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","8.395","89.0%","3.436","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","1.043","99.6%","5.944","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":633},{"label":"Fev","value":689},{"label":"Mar","value":648},{"label":"Abr","value":626},{"label":"Mai","value":836},{"label":"Jun","value":794},{"label":"Jul","value":544},{"label":"Ago","value":653},{"label":"Set","value":817},{"label":"Out","value":751},{"label":"Nov","value":605},{"label":"Dez","value":817}];
const MX = 836;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>MSC</span></h1>
                </div>
