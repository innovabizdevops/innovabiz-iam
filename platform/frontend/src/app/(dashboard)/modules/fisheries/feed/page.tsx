...
const PAGE = "Feed Optimization";
const KPIS = [{"l":"Embarcações Ativas","v":"2.542","t":"+16.7%","d":"up"},{"l":"Capturas (ton)","v":"3283","t":"-2.8%","d":"down"},{"l":"Quota Utilizada (%)","v":"71.8%","t":"+3.9%","d":"up"},{"l":"Certificações","v":"4.947","t":"+9.1%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","2803","233","70.3%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3718","5.952","78.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2902","8.422","96.8%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","4493","372","70.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","464","9.065","70.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":788},{"label":"Fev","value":658},{"label":"Mar","value":434},{"label":"Abr","value":492},{"label":"Mai","value":536},{"label":"Jun","value":671},{"label":"Jul","value":612},{"label":"Ago","value":610},{"label":"Set","value":650},{"label":"Out","value":653},{"label":"Nov","value":510},{"label":"Dez","value":708}];
const MX = 788;
