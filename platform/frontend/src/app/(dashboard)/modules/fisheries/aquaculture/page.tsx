...
const PAGE = "Aquaculture Mgmt";
const KPIS = [{"l":"Embarcações Ativas","v":"5.230","t":"+0.6%","d":"up"},{"l":"Capturas (ton)","v":"5064","t":"+12.1%","d":"up"},{"l":"Quota Utilizada (%)","v":"85.7%","t":"-5.7%","d":"down"},{"l":"Certificações","v":"4.917","t":"+7.9%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","3459","2.171","75.7%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","3502","3.515","72.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","3884","6.081","94.4%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","4877","7.447","89.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1821","3.005","91.7%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":753},{"label":"Fev","value":660},{"label":"Mar","value":622},{"label":"Abr","value":578},{"label":"Mai","value":863},{"label":"Jun","value":592},{"label":"Jul","value":660},{"label":"Ago","value":711},{"label":"Set","value":853},{"label":"Out","value":579},{"label":"Nov","value":618},{"label":"Dez","value":610}];
const MX = 863;
