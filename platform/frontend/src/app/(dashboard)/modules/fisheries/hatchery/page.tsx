...
const PAGE = "Hatchery Mgmt";
const KPIS = [{"l":"Embarcações Ativas","v":"7.567","t":"-0.9%","d":"down"},{"l":"Capturas (ton)","v":"2244","t":"+13.2%","d":"up"},{"l":"Quota Utilizada (%)","v":"80.3%","t":"+13.0%","d":"up"},{"l":"Certificações","v":"737","t":"+3.4%","d":"up"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","982","1.896","74.7%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1320","8.061","99.0%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","4037","4.223","96.9%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","1009","4.770","83.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1466","2.388","76.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":719},{"label":"Mar","value":786},{"label":"Abr","value":449},{"label":"Mai","value":507},{"label":"Jun","value":768},{"label":"Jul","value":682},{"label":"Ago","value":442},{"label":"Set","value":425},{"label":"Out","value":592},{"label":"Nov","value":723},{"label":"Dez","value":527}];
const MX = 786;
