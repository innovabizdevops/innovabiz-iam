...
const ACCENT = "#0369a1";
const MODULE = "Fisheries & Aquaculture";
const PAGE = "Marine Protected";
const KPIS = [{"l":"Embarcações Ativas","v":"1.297","t":"+12.3%","d":"up"},{"l":"Capturas (ton)","v":"4208","t":"-3.5%","d":"down"},{"l":"Quota Utilizada (%)","v":"90.0%","t":"-4.9%","d":"down"},{"l":"Certificações","v":"3.416","t":"-5.0%","d":"down"}];
const COLS = ["Embarcação","Espécie","Captura (ton)","Zona","Quota (%)","Estado"];
const ROWS = [{"id":"r0","cells":["NM Oceano Azul","NM Atlântico","190","5.546","72.0%","Ativo"],"status":"active"},{"id":"r1","cells":["NM Atlântico","NM Costa Verde","1379","6.259","71.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["NM Costa Verde","NM Mar Brava","2944","7.425","90.8%","Concluído"],"status":"done"},{"id":"r3","cells":["NM Mar Brava","NM Pescador","3842","1.617","97.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["NM Pescador","NM Oceano Azul","1041","7.094","92.2%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":690},{"label":"Fev","value":810},{"label":"Mar","value":670},{"label":"Abr","value":675},{"label":"Mai","value":733},{"label":"Jun","value":683},{"label":"Jul","value":1006},{"label":"Ago","value":919},{"label":"Set","value":698},{"label":"Out","value":710},{"label":"Nov","value":957},{"label":"Dez","value":795}];
const MX = 1006;
...
export default function MarineProtectPage() {
    return (
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#0369a1'}}>ESG</span></h1>
                </div>
