...
const ACCENT = "#6366f1";
const MODULE = "Digital Publishing";
const PAGE = "Interactive";
const KPIS = [{"l":"Total Digital Publish","v":"472","t":"+0.1%","d":"up"},{"l":"Interactive Ativos","v":"1.611","t":"+11.3%","d":"up"},{"l":"Eficiência (%)","v":"93.4%","t":"+3.2%","d":"up"},{"l":"Score Performance","v":"57","t":"+6.7%","d":"up"}];
const COLS = ["ID","Interactive","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Publish #001","Digital Publish #002","6.096","8.149","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Publish #002","Digital Publish #003","896","4.163","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Publish #003","Digital Publish #004","4.714","1.327","2026-03-17","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Publish #004","Digital Publish #005","7.521","2.009","2026-03-18","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Publish #005","Digital Publish #001","6.200","5.482","2026-01-01","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":522},{"label":"Fev","value":729},{"label":"Mar","value":865},{"label":"Abr","value":544},{"label":"Mai","value":897},{"label":"Jun","value":823},{"label":"Jul","value":874},{"label":"Ago","value":748},{"label":"Set","value":767},{"label":"Out","value":619},{"label":"Nov","value":695},{"label":"Dez","value":878}];
const MX = 897;
