...
const PAGE = "DRM";
const KPIS = [{"l":"Total Digital Publish","v":"2.972","t":"-1.5%","d":"down"},{"l":"DRM Ativos","v":"4.492","t":"+9.4%","d":"up"},{"l":"Eficiência (%)","v":"85.8%","t":"+10.7%","d":"up"},{"l":"Score Performance","v":"92","t":"+8.8%","d":"up"}];
const COLS = ["ID","DRM","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Publish #001","Digital Publish #002","2.588","7.394","2026-01-21","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Publish #002","Digital Publish #003","5.122","7.951","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Publish #003","Digital Publish #004","4.517","6.766","2026-02-04","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Publish #004","Digital Publish #005","8.013","8.039","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Publish #005","Digital Publish #001","3.227","5.150","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":732},{"label":"Fev","value":626},{"label":"Mar","value":401},{"label":"Abr","value":358},{"label":"Mai","value":378},{"label":"Jun","value":732},{"label":"Jul","value":427},{"label":"Ago","value":578},{"label":"Set","value":540},{"label":"Out","value":363},{"label":"Nov","value":754},{"label":"Dez","value":707}];
const MX = 754;
