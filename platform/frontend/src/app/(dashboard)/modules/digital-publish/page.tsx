...
export default function DigitalPublishPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Digital Publish</h1><p className="text-sm text-muted-foreground">Digital Publish • iBOS Enterprise</p></div>
