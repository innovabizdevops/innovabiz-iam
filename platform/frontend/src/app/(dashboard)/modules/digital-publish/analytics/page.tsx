...
const KPIS = [{"l":"Dashboards Ativos","v":"2.437","t":"-3.4%","d":"down"},{"l":"Queries/Dia","v":"2526","t":"+5.1%","d":"up"},{"l":"Dados Processados (GB)","v":"3.531","t":"+4.4%","d":"up"},{"l":"Utilizadores Analytics","v":"3.787","t":"+5.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","4877","2026-02-14","3.148","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1517","2026-02-25","6.614","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1766","2026-03-16","8.278","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3822","2026-02-17","5.623","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","4635","2026-03-02","4.861","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":624},{"label":"Fev","value":821},{"label":"Mar","value":688},{"label":"Abr","value":569},{"label":"Mai","value":835},{"label":"Jun","value":809},{"label":"Jul","value":761},{"label":"Ago","value":569},{"label":"Set","value":778},{"label":"Out","value":619},{"label":"Nov","value":831},{"label":"Dez","value":705}];
const MX = 835;
