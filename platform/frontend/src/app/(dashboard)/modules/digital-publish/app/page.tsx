...
const PAGE = "App";
const KPIS = [{"l":"Total Digital Publish","v":"5.723","t":"+10.7%","d":"up"},{"l":"App Ativos","v":"3.509","t":"-4.3%","d":"down"},{"l":"Eficiência (%)","v":"80.8%","t":"+15.8%","d":"up"},{"l":"Score Performance","v":"69","t":"-3.2%","d":"down"}];
const COLS = ["ID","App","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Digital Publish #001","Digital Publish #002","5.599","9.004","2026-03-23","Ativo"],"status":"active"},{"id":"r1","cells":["Digital Publish #002","Digital Publish #003","4.476","7.571","2026-03-09","Pendente"],"status":"pending"},{"id":"r2","cells":["Digital Publish #003","Digital Publish #004","2.701","2.185","2026-01-09","Concluído"],"status":"done"},{"id":"r3","cells":["Digital Publish #004","Digital Publish #005","5.424","4.270","2026-02-06","Em Análise"],"status":"risk"},{"id":"r4","cells":["Digital Publish #005","Digital Publish #001","3.078","2.421","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":551},{"label":"Fev","value":401},{"label":"Mar","value":679},{"label":"Abr","value":578},{"label":"Mai","value":435},{"label":"Jun","value":617},{"label":"Jul","value":502},{"label":"Ago","value":701},{"label":"Set","value":783},{"label":"Out","value":598},{"label":"Nov","value":397},{"label":"Dez","value":585}];
const MX = 783;
