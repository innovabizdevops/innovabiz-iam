...
const KPIS = [{"l":"Integrações Ativas","v":"3.928","t":"+17.7%","d":"up"},{"l":"Chamadas/Hora","v":"826","t":"-4.4%","d":"down"},{"l":"Taxa Sucesso (%)","v":"72.7%","t":"+13.9%","d":"up"},{"l":"Latência Média (ms)","v":"197ms","t":"+8.5%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","5.480","6.188","82.3%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.621","8.517","92.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","7.015","8.178","92.6%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","2.170","1.796","73.8%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","3.186","8.403","80.1%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":343},{"label":"Fev","value":505},{"label":"Mar","value":551},{"label":"Abr","value":482},{"label":"Mai","value":420},{"label":"Jun","value":598},{"label":"Jul","value":436},{"label":"Ago","value":675},{"label":"Set","value":696},{"label":"Out","value":474},{"label":"Nov","value":634},{"label":"Dez","value":340}];
const MX = 696;
