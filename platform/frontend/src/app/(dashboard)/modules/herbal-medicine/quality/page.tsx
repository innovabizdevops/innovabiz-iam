...
const PAGE = "Quality";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.625","t":"+9.6%","d":"up"},{"l":"NC Abertas","v":"8.948","t":"+10.7%","d":"up"},{"l":"Conformidade (%)","v":"76.6%","t":"-1.8%","d":"down"},{"l":"CAPAs Pendentes","v":"6.582","t":"+8.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","7.137","96.5%","1.845","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","5.074","70.1%","2.805","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","6.089","92.9%","7.541","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","2.042","78.0%","7.963","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","4.374","83.3%","7.483","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":960},{"label":"Fev","value":616},{"label":"Mar","value":964},{"label":"Abr","value":849},{"label":"Mai","value":923},{"label":"Jun","value":804},{"label":"Jul","value":791},{"label":"Ago","value":851},{"label":"Set","value":813},{"label":"Out","value":976},{"label":"Nov","value":830},{"label":"Dez","value":842}];
const MX = 976;
