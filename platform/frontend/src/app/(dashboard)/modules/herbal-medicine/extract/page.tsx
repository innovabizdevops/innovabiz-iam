...
const PAGE = "Extract";
const KPIS = [{"l":"Integrações Ativas","v":"7.202","t":"+13.4%","d":"up"},{"l":"Chamadas/Hora","v":"5086","t":"+5.0%","d":"up"},{"l":"Taxa Sucesso (%)","v":"74.5%","t":"-0.5%","d":"down"},{"l":"Latência Média (ms)","v":"43ms","t":"+12.2%","d":"up"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","115","5.092","83.5%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","3.118","371","86.9%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","5.981","1.601","80.4%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","5.422","8.099","75.7%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","813","8.114","81.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":634},{"label":"Fev","value":801},{"label":"Mar","value":696},{"label":"Abr","value":813},{"label":"Mai","value":752},{"label":"Jun","value":831},{"label":"Jul","value":840},{"label":"Ago","value":966},{"label":"Set","value":670},{"label":"Out","value":602},{"label":"Nov","value":920},{"label":"Dez","value":878}];
const MX = 966;
