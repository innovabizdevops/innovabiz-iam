...
const PAGE = "Source";
const KPIS = [{"l":"Integrações Ativas","v":"8.766","t":"+0.2%","d":"up"},{"l":"Chamadas/Hora","v":"4528","t":"-2.5%","d":"down"},{"l":"Taxa Sucesso (%)","v":"92.9%","t":"+13.7%","d":"up"},{"l":"Latência Média (ms)","v":"168ms","t":"-4.5%","d":"down"}];
const COLS = ["Integração","Sistema","Protocolo","Chamadas/h","Sucesso (%)","Estado"];
const ROWS = [{"id":"r0","cells":["SAP ERP Sync","Salesforce CRM","1.894","4.384","93.1%","Ativo"],"status":"active"},{"id":"r1","cells":["Salesforce CRM","Stripe Payments","2.496","4.860","95.6%","Pendente"],"status":"pending"},{"id":"r2","cells":["Stripe Payments","Twilio SMS","8.996","7.463","79.0%","Concluído"],"status":"done"},{"id":"r3","cells":["Twilio SMS","Slack Notify","4.700","4.700","97.5%","Em Análise"],"status":"risk"},{"id":"r4","cells":["Slack Notify","SAP ERP Sync","1.478","1.201","99.9%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":666},{"label":"Fev","value":541},{"label":"Mar","value":542},{"label":"Abr","value":658},{"label":"Mai","value":776},{"label":"Jun","value":545},{"label":"Jul","value":525},{"label":"Ago","value":694},{"label":"Set","value":481},{"label":"Out","value":781},{"label":"Nov","value":489},{"label":"Dez","value":775}];
const MX = 781;
