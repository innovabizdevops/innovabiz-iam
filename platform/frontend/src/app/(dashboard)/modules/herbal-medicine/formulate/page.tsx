...
const ACCENT = "#059669";
const MODULE = "Herbal Medicine Mfg";
const PAGE = "Formulate";
const KPIS = [{"l":"Formulários Ativos","v":"952","t":"+10.2%","d":"up"},{"l":"Submissões/Dia","v":"696","t":"+13.7%","d":"up"},{"l":"Documentos Gerados","v":"7.745","t":"+11.3%","d":"up"},{"l":"Templates","v":"5.787","t":"+2.9%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","1.662","2026-03-11","2.691","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","1.355","2026-03-07","1.354","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.130","2026-03-13","3.483","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.690","2026-01-02","5.538","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.463","2026-03-19","5.828","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":541},{"label":"Fev","value":426},{"label":"Mar","value":699},{"label":"Abr","value":685},{"label":"Mai","value":457},{"label":"Jun","value":604},{"label":"Jul","value":747},{"label":"Ago","value":523},{"label":"Set","value":649},{"label":"Out","value":589},{"label":"Nov","value":768},{"label":"Dez","value":619}];
const MX = 768;
