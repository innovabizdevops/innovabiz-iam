...
/* ═══ Herbal Medicine Mfg — Dashboard ═══ */

const ACCENT = "#059669";

const KPIS = [
    { label: "Total Registos", value: "662", trend: "+13%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "232", trend: "-7%", trendDirection: "down" as const, icon: Users },
    { label: "Receita Mensal", value: "€302K", trend: "+1%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "784743862", cells: ["HER-7862", "Herbal Medicine Mfg Item 1", "15/11/2026", "€43 962"], status: "active" as const },
    { id: "784747433", cells: ["HER-2433", "Herbal Medicine Mfg Item 2", "2/6/2026", "€47 533"], status: "pending" as const },
    { id: "784751004", cells: ["HER-6004", "Herbal Medicine Mfg Item 3", "17/1/2026", "€1104"], status: "completed" as const },
    { id: "784754575", cells: ["HER-9575", "Herbal Medicine Mfg Item 4", "4/8/2026", "€4675"], status: "warning" as const },
    { id: "784758146", cells: ["HER-4146", "Herbal Medicine Mfg Item 5", "19/3/2026", "€8246"], status: "active" as const },
];
...
export default function HerbalMedicineMfgPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Herbal Medicine Mfg</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Herbal Medicine Mfg</p>
                    </div>
                </div>
