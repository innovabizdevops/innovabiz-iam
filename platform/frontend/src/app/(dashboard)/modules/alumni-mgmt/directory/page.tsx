...
const KPIS = [{"l":"Total Alumni Mgmt","v":"5.900","t":"+12.5%","d":"up"},{"l":"Directory Ativos","v":"2.277","t":"+6.4%","d":"up"},{"l":"Eficiência (%)","v":"65.9%","t":"+0.3%","d":"up"},{"l":"Score Performance","v":"91","t":"+7.7%","d":"up"}];
const COLS = ["ID","Directory","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alumni Mgmt #001","Alumni Mgmt #002","2.546","5.089","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Alumni Mgmt #002","Alumni Mgmt #003","7.118","2.962","2026-02-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Alumni Mgmt #003","Alumni Mgmt #004","5.822","3.418","2026-02-03","Concluído"],"status":"done"},{"id":"r3","cells":["Alumni Mgmt #004","Alumni Mgmt #005","8.106","2.006","2026-02-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alumni Mgmt #005","Alumni Mgmt #001","2.085","1.162","2026-02-15","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":777},{"label":"Fev","value":556},{"label":"Mar","value":706},{"label":"Abr","value":643},{"label":"Mai","value":574},{"label":"Jun","value":773},{"label":"Jul","value":636},{"label":"Ago","value":763},{"label":"Set","value":677},{"label":"Out","value":653},{"label":"Nov","value":645},{"label":"Dez","value":801}];
const MX = 801;
