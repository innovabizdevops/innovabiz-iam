...
const ACCENT = "#6366f1";
const MODULE = "Alumni Management";
const PAGE = "Fundraise";
const KPIS = [{"l":"Total Alumni Mgmt","v":"8.157","t":"-0.3%","d":"down"},{"l":"Fundraise Ativos","v":"1.348","t":"+2.5%","d":"up"},{"l":"Eficiência (%)","v":"76.6%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"64","t":"+1.4%","d":"up"}];
const COLS = ["ID","Fundraise","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alumni Mgmt #001","Alumni Mgmt #002","328","1.479","2026-01-09","Ativo"],"status":"active"},{"id":"r1","cells":["Alumni Mgmt #002","Alumni Mgmt #003","4.282","6.783","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Alumni Mgmt #003","Alumni Mgmt #004","8.745","4.637","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Alumni Mgmt #004","Alumni Mgmt #005","2.835","3.799","2026-01-14","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alumni Mgmt #005","Alumni Mgmt #001","516","3.483","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":410},{"label":"Fev","value":579},{"label":"Mar","value":285},{"label":"Abr","value":480},{"label":"Mai","value":406},{"label":"Jun","value":357},{"label":"Jul","value":297},{"label":"Ago","value":237},{"label":"Set","value":376},{"label":"Out","value":536},{"label":"Nov","value":572},{"label":"Dez","value":252}];
const MX = 579;
