...
const KPIS = [{"l":"eNPS","v":"73","t":"-2.1%","d":"down"},{"l":"Engagement (%)","v":"80.5%","t":"+2.7%","d":"up"},{"l":"Turnover (%)","v":"67.8%","t":"+0.8%","d":"up"},{"l":"Time-to-Productivity (dias)","v":"3.141","t":"+1.9%","d":"up"}];
const COLS = ["Colaborador","Departamento","Cargo","Data Entrada","eNPS","Estado"];
const ROWS = [{"id":"r0","cells":["João Silva Eng","Maria Santos MKT","5.218","2026-02-06","81","Ativo"],"status":"active"},{"id":"r1","cells":["Maria Santos MKT","Pedro Oliveira FIN","4.858","2026-01-22","65","Pendente"],"status":"pending"},{"id":"r2","cells":["Pedro Oliveira FIN","Ana Costa RH","788","2026-03-20","55","Concluído"],"status":"done"},{"id":"r3","cells":["Ana Costa RH","Carlos Prods","2.273","2026-01-07","65","Em Análise"],"status":"risk"},{"id":"r4","cells":["Carlos Prods","João Silva Eng","5.488","2026-03-14","77","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":864},{"label":"Fev","value":684},{"label":"Mar","value":955},{"label":"Abr","value":938},{"label":"Mai","value":783},{"label":"Jun","value":647},{"label":"Jul","value":899},{"label":"Ago","value":992},{"label":"Set","value":762},{"label":"Out","value":936},{"label":"Nov","value":658},{"label":"Dez","value":874}];
const MX = 992;
