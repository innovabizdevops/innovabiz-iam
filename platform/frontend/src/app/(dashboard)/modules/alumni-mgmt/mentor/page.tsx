...
const KPIS = [{"l":"Total Alumni Mgmt","v":"764","t":"+13.7%","d":"up"},{"l":"Mentoring Ativos","v":"4.433","t":"+1.0%","d":"up"},{"l":"Eficiência (%)","v":"67.2%","t":"+5.2%","d":"up"},{"l":"Score Performance","v":"91","t":"-5.9%","d":"down"}];
const COLS = ["ID","Mentoring","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alumni Mgmt #001","Alumni Mgmt #002","4.478","8.118","2026-02-05","Ativo"],"status":"active"},{"id":"r1","cells":["Alumni Mgmt #002","Alumni Mgmt #003","4.821","5.825","2026-01-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Alumni Mgmt #003","Alumni Mgmt #004","3.179","3.183","2026-03-21","Concluído"],"status":"done"},{"id":"r3","cells":["Alumni Mgmt #004","Alumni Mgmt #005","2.596","2.578","2026-01-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alumni Mgmt #005","Alumni Mgmt #001","7.287","8.490","2026-01-27","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":920},{"label":"Fev","value":718},{"label":"Mar","value":690},{"label":"Abr","value":839},{"label":"Mai","value":752},{"label":"Jun","value":909},{"label":"Jul","value":799},{"label":"Ago","value":889},{"label":"Set","value":964},{"label":"Out","value":948},{"label":"Nov","value":870},{"label":"Dez","value":908}];
const MX = 964;
