...
const PAGE = "Events";
const KPIS = [{"l":"Total Alumni Mgmt","v":"6.451","t":"+5.5%","d":"up"},{"l":"Events Ativos","v":"629","t":"+14.8%","d":"up"},{"l":"Eficiência (%)","v":"84.5%","t":"+14.9%","d":"up"},{"l":"Score Performance","v":"76","t":"+8.1%","d":"up"}];
const COLS = ["ID","Events","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Alumni Mgmt #001","Alumni Mgmt #002","5.573","6.905","2026-02-28","Ativo"],"status":"active"},{"id":"r1","cells":["Alumni Mgmt #002","Alumni Mgmt #003","5.621","1.726","2026-02-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Alumni Mgmt #003","Alumni Mgmt #004","6.415","8.875","2026-01-27","Concluído"],"status":"done"},{"id":"r3","cells":["Alumni Mgmt #004","Alumni Mgmt #005","5.216","4.613","2026-02-20","Em Análise"],"status":"risk"},{"id":"r4","cells":["Alumni Mgmt #005","Alumni Mgmt #001","2.495","1.939","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":316},{"label":"Fev","value":664},{"label":"Mar","value":519},{"label":"Abr","value":684},{"label":"Mai","value":391},{"label":"Jun","value":674},{"label":"Jul","value":621},{"label":"Ago","value":527},{"label":"Set","value":334},{"label":"Out","value":407},{"label":"Nov","value":383},{"label":"Dez","value":575}];
const MX = 684;
