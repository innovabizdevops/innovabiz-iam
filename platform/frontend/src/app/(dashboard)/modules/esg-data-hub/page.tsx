...
export default function EsgDataHubPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Esg Data Hub</h1><p className="text-sm text-muted-foreground">Esg Data Hub • iBOS Enterprise</p></div>
