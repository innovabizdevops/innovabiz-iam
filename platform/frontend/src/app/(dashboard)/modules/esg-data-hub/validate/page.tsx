...
const KPIS = [{"l":"Dashboards Ativos","v":"2.720","t":"+9.7%","d":"up"},{"l":"Queries/Dia","v":"4187","t":"+3.5%","d":"up"},{"l":"Dados Processados (GB)","v":"158","t":"+14.9%","d":"up"},{"l":"Utilizadores Analytics","v":"2.107","t":"+14.7%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","5023","2026-02-11","6.487","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2084","2026-03-15","8.355","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5026","2026-02-08","2.107","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","4497","2026-01-12","6.279","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","191","2026-02-17","7.325","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":338},{"label":"Fev","value":478},{"label":"Mar","value":647},{"label":"Abr","value":405},{"label":"Mai","value":645},{"label":"Jun","value":511},{"label":"Jul","value":428},{"label":"Ago","value":429},{"label":"Set","value":578},{"label":"Out","value":514},{"label":"Nov","value":312},{"label":"Dez","value":693}];
const MX = 693;
