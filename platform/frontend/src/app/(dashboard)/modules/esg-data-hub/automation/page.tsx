...
const ACCENT = "#0e7490";
const MODULE = "ESG Data Hub";
const PAGE = "Automation";
const KPIS = [{"l":"Dashboards Ativos","v":"978","t":"-4.0%","d":"down"},{"l":"Queries/Dia","v":"284","t":"-3.2%","d":"down"},{"l":"Dados Processados (GB)","v":"3.648","t":"-4.6%","d":"down"},{"l":"Utilizadores Analytics","v":"8.769","t":"+5.8%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","1476","2026-03-02","6.827","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2173","2026-03-17","3.310","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2372","2026-03-14","5.731","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","933","2026-01-25","2.159","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","817","2026-03-28","741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":547},{"label":"Fev","value":815},{"label":"Mar","value":861},{"label":"Abr","value":791},{"label":"Mai","value":706},{"label":"Jun","value":602},{"label":"Jul","value":740},{"label":"Ago","value":496},{"label":"Set","value":525},{"label":"Out","value":506},{"label":"Nov","value":719},{"label":"Dez","value":631}];
const MX = 861;
