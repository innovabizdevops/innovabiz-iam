...
const KPIS = [{"l":"Dashboards Ativos","v":"7.903","t":"+11.7%","d":"up"},{"l":"Queries/Dia","v":"1766","t":"+13.6%","d":"up"},{"l":"Dados Processados (GB)","v":"414","t":"+11.7%","d":"up"},{"l":"Utilizadores Analytics","v":"3.487","t":"+6.0%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","3006","2026-02-08","3.603","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","2391","2026-01-10","2.441","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","2527","2026-01-06","4.604","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","340","2026-03-02","4.762","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3012","2026-01-18","8.841","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":392},{"label":"Fev","value":463},{"label":"Mar","value":320},{"label":"Abr","value":247},{"label":"Mai","value":526},{"label":"Jun","value":512},{"label":"Jul","value":466},{"label":"Ago","value":574},{"label":"Set","value":552},{"label":"Out","value":543},{"label":"Nov","value":576},{"label":"Dez","value":416}];
const MX = 576;
