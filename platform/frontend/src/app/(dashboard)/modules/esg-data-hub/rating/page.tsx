...
const PAGE = "Rating Agency";
const KPIS = [{"l":"Dashboards Ativos","v":"3.471","t":"-0.4%","d":"down"},{"l":"Queries/Dia","v":"2964","t":"+8.4%","d":"up"},{"l":"Dados Processados (GB)","v":"3.548","t":"-3.6%","d":"down"},{"l":"Utilizadores Analytics","v":"3.605","t":"+1.1%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2581","2026-03-18","4.173","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","1790","2026-01-15","6.550","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","1125","2026-03-27","7.708","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","3380","2026-01-13","181","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3850","2026-01-18","1.966","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":332},{"label":"Fev","value":301},{"label":"Mar","value":202},{"label":"Abr","value":544},{"label":"Mai","value":226},{"label":"Jun","value":429},{"label":"Jul","value":358},{"label":"Ago","value":243},{"label":"Set","value":560},{"label":"Out","value":564},{"label":"Nov","value":296},{"label":"Dez","value":462}];
const MX = 564;
