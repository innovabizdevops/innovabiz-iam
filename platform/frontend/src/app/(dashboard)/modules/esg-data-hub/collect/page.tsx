...
const KPIS = [{"l":"Dashboards Ativos","v":"6.549","t":"-0.2%","d":"down"},{"l":"Queries/Dia","v":"4691","t":"-2.8%","d":"down"},{"l":"Dados Processados (GB)","v":"5.610","t":"+6.7%","d":"up"},{"l":"Utilizadores Analytics","v":"6.997","t":"+17.3%","d":"up"}];
const COLS = ["Dashboard","Fonte Dados","Views/Semana","Última Atualização","Owner","Estado"];
const ROWS = [{"id":"r0","cells":["Exec Summary Q1","Sales Pipeline","2591","2026-02-11","524","Ativo"],"status":"active"},{"id":"r1","cells":["Sales Pipeline","Finance Overview","287","2026-03-07","6.040","Pendente"],"status":"pending"},{"id":"r2","cells":["Finance Overview","HR Headcount","5029","2026-03-23","3.951","Concluído"],"status":"done"},{"id":"r3","cells":["HR Headcount","Ops Performance","754","2026-02-18","6.656","Em Análise"],"status":"risk"},{"id":"r4","cells":["Ops Performance","Exec Summary Q1","3529","2026-02-09","6.030","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":907},{"label":"Fev","value":833},{"label":"Mar","value":575},{"label":"Abr","value":788},{"label":"Mai","value":602},{"label":"Jun","value":584},{"label":"Jul","value":912},{"label":"Ago","value":560},{"label":"Set","value":606},{"label":"Out","value":707},{"label":"Nov","value":666},{"label":"Dez","value":906}];
const MX = 912;
