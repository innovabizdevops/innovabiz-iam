...
/* ═══ Network Ops Center — Fault Mgmt ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "3713", trend: "+19%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "391", trend: "+13%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3526", trend: "-7%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "324515843", cells: ["NET-3843", "Fault Mgmt Item 1", "16/12/2026", "€15 943"], status: "active" as const },
    { id: "324519414", cells: ["NET-7414", "Fault Mgmt Item 2", "3/7/2026", "€19 514"], status: "pending" as const },
    { id: "324522985", cells: ["NET-1985", "Fault Mgmt Item 3", "18/2/2026", "€23 085"], status: "completed" as const },
    { id: "324526556", cells: ["NET-5556", "Fault Mgmt Item 4", "5/9/2026", "€26 656"], status: "warning" as const },
    { id: "324530127", cells: ["NET-9127", "Fault Mgmt Item 5", "20/4/2026", "€30 227"], status: "active" as const },
];
...
export default function NetworkOpsCenterFaultMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Fault Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Fault Mgmt</p>
                    </div>
                </div>
