...
/* ═══ Network Ops Center — Traffic Engineer ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "227", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "308", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "644", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "667200176", cells: ["NET-4176", "Traffic Engineer Item 1", "21/9/2026", "€276"], status: "active" as const },
    { id: "667203747", cells: ["NET-7747", "Traffic Engineer Item 2", "8/4/2026", "€3847"], status: "pending" as const },
    { id: "667207318", cells: ["NET-2318", "Traffic Engineer Item 3", "23/11/2026", "€7418"], status: "completed" as const },
    { id: "667210889", cells: ["NET-5889", "Traffic Engineer Item 4", "10/6/2026", "€10 989"], status: "warning" as const },
    { id: "667214460", cells: ["NET-9460", "Traffic Engineer Item 5", "25/1/2026", "€14 560"], status: "active" as const },
];
...
export default function NetworkOpsCenterTrafficEngineerPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Traffic Engineer</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Traffic Engineer</p>
                    </div>
                </div>
