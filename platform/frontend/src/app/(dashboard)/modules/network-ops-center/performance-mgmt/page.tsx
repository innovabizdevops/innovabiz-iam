...
/* ═══ Network Ops Center — Performance Mgmt ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "2843", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "483", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "3326", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "407448623", cells: ["NET-1623", "Performance Mgmt Item 1", "16/12/2026", "€48 723"], status: "active" as const },
    { id: "407452194", cells: ["NET-5194", "Performance Mgmt Item 2", "3/7/2026", "€2294"], status: "pending" as const },
    { id: "407455765", cells: ["NET-8765", "Performance Mgmt Item 3", "18/2/2026", "€5865"], status: "completed" as const },
    { id: "407459336", cells: ["NET-3336", "Performance Mgmt Item 4", "5/9/2026", "€9436"], status: "warning" as const },
    { id: "407462907", cells: ["NET-6907", "Performance Mgmt Item 5", "20/4/2026", "€13 007"], status: "active" as const },
];
...
export default function NetworkOpsCenterPerformanceMgmtPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Performance Mgmt</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Performance Mgmt</p>
                    </div>
                </div>
