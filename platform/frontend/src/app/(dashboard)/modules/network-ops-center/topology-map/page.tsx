...
/* ═══ Network Ops Center — Topology Map ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "651", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "397", trend: "-15%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1438", trend: "+9%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "747120745", cells: ["NET-4745", "Topology Map Item 1", "22/2/2026", "€20 845"], status: "active" as const },
    { id: "747124316", cells: ["NET-8316", "Topology Map Item 2", "9/9/2026", "€24 416"], status: "pending" as const },
    { id: "747127887", cells: ["NET-2887", "Topology Map Item 3", "24/4/2026", "€27 987"], status: "completed" as const },
    { id: "747131458", cells: ["NET-6458", "Topology Map Item 4", "11/11/2026", "€31 558"], status: "warning" as const },
    { id: "747135029", cells: ["NET-1029", "Topology Map Item 5", "26/6/2026", "€35 129"], status: "active" as const },
];
...
export default function NetworkOpsCenterTopologyMapPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Topology Map</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Topology Map</p>
                    </div>
                </div>
