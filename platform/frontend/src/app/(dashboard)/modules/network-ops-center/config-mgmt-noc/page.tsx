...
/* ═══ Network Ops Center — Config Mgmt Noc ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "361", trend: "+21%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "257", trend: "+15%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2297", trend: "-9%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Taxa Sucesso", value: "72%", trend: "+3%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Estado"];

const TABLE_ROWS = [
    { id: "1481270045", cells: ["NET-6045", "Config Mgmt Noc Item 1", "18/6/2026", "€20 145"], status: "active" as const },
    { id: "1481273616", cells: ["NET-9616", "Config Mgmt Noc Item 2", "5/1/2026", "€23 716"], status: "pending" as const },
    { id: "1481277187", cells: ["NET-4187", "Config Mgmt Noc Item 3", "20/8/2026", "€27 287"], status: "completed" as const },
    { id: "1481280758", cells: ["NET-7758", "Config Mgmt Noc Item 4", "7/3/2026", "€30 858"], status: "warning" as const },
    { id: "1481284329", cells: ["NET-2329", "Config Mgmt Noc Item 5", "22/10/2026", "€34 429"], status: "active" as const },
];
...
export default function NetworkOpsCenterConfigMgmtNocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Config Mgmt Noc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Config Mgmt Noc</p>
                    </div>
                </div>
