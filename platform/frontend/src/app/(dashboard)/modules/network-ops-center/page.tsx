...
export default function NetworkOpsCenterPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Network Ops Center</h1><p className="text-sm text-muted-foreground">Network Ops Center — iBOS Enterprise</p></div>
