...
/* ═══ Network Ops Center — Alarm Correlate ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "4848", trend: "+12%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "290", trend: "-6%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "1012", trend: "+25%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "2142920686", cells: ["NET-3686", "Alarm Correlate Item 1", "19/11/2026", "€20 786"], status: "active" as const },
    { id: "2142924257", cells: ["NET-7257", "Alarm Correlate Item 2", "6/6/2026", "€24 357"], status: "pending" as const },
    { id: "2142927828", cells: ["NET-1828", "Alarm Correlate Item 3", "21/1/2026", "€27 928"], status: "completed" as const },
    { id: "2142931399", cells: ["NET-5399", "Alarm Correlate Item 4", "8/8/2026", "€31 499"], status: "warning" as const },
    { id: "2142934970", cells: ["NET-8970", "Alarm Correlate Item 5", "23/3/2026", "€35 070"], status: "active" as const },
];
...
export default function NetworkOpsCenterAlarmCorrelatePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Alarm Correlate</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Alarm Correlate</p>
                    </div>
                </div>
