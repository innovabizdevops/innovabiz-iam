...
/* ═══ Network Ops Center — Capacity Mgmt Noc ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "1357", trend: "+1%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "217", trend: "+20%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "2409", trend: "-14%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1884552725", cells: ["NET-7725", "Capacity Mgmt Noc Item 1", "14/6/2026", "€2825"], status: "active" as const },
    { id: "1884556296", cells: ["NET-2296", "Capacity Mgmt Noc Item 2", "1/1/2026", "€6396"], status: "pending" as const },
    { id: "1884559867", cells: ["NET-5867", "Capacity Mgmt Noc Item 3", "16/8/2026", "€9967"], status: "completed" as const },
    { id: "1884563438", cells: ["NET-9438", "Capacity Mgmt Noc Item 4", "3/3/2026", "€13 538"], status: "warning" as const },
    { id: "1884567009", cells: ["NET-4009", "Capacity Mgmt Noc Item 5", "18/10/2026", "€17 109"], status: "active" as const },
];
...
export default function NetworkOpsCenterCapacityMgmtNocPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Capacity Mgmt Noc</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Capacity Mgmt Noc</p>
                    </div>
                </div>
