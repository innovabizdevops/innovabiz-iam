...
/* ═══ Network Ops Center — Sla Monitor ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "1906", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "16", trend: "-21%", trendDirection: "down" as const, icon: Users },
    { label: "Concluídos", value: "3242", trend: "+15%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "998144476", cells: ["NET-9476", "Sla Monitor Item 1", "1/5/2026", "€44 576"], status: "active" as const },
    { id: "998148047", cells: ["NET-4047", "Sla Monitor Item 2", "16/12/2026", "€48 147"], status: "pending" as const },
    { id: "998151618", cells: ["NET-7618", "Sla Monitor Item 3", "3/7/2026", "€1718"], status: "completed" as const },
    { id: "998155189", cells: ["NET-2189", "Sla Monitor Item 4", "18/2/2026", "€5289"], status: "warning" as const },
    { id: "998158760", cells: ["NET-5760", "Sla Monitor Item 5", "5/9/2026", "€8860"], status: "active" as const },
];
...
export default function NetworkOpsCenterSlaMonitorPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Sla Monitor</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Sla Monitor</p>
                    </div>
                </div>
