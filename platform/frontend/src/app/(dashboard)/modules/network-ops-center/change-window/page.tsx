...
/* ═══ Network Ops Center — Change Window ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "2857", trend: "+9%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "226", trend: "+3%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "811", trend: "-22%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "732912158", cells: ["NET-7158", "Change Window Item 1", "7/3/2026", "€12 258"], status: "active" as const },
    { id: "732915729", cells: ["NET-1729", "Change Window Item 2", "22/10/2026", "€15 829"], status: "pending" as const },
    { id: "732919300", cells: ["NET-5300", "Change Window Item 3", "9/5/2026", "€19 400"], status: "completed" as const },
    { id: "732922871", cells: ["NET-8871", "Change Window Item 4", "24/12/2026", "€22 971"], status: "warning" as const },
    { id: "732926442", cells: ["NET-3442", "Change Window Item 5", "11/7/2026", "€26 542"], status: "active" as const },
];
...
export default function NetworkOpsCenterChangeWindowPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Change Window</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Change Window</p>
                    </div>
                </div>
