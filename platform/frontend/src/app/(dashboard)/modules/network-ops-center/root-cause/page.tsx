...
/* ═══ Network Ops Center — Root Cause ═══ */

const ACCENT = "#047857";

const KPIS = [
    { label: "Total", value: "776", trend: "+18%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Em Progresso", value: "45", trend: "+12%", trendDirection: "up" as const, icon: Users },
    { label: "Concluídos", value: "1451", trend: "-6%", trendDirection: "down" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "643949417", cells: ["NET-9417", "Root Cause Item 1", "14/6/2026", "€49 517"], status: "active" as const },
    { id: "643952988", cells: ["NET-3988", "Root Cause Item 2", "1/1/2026", "€3088"], status: "pending" as const },
    { id: "643956559", cells: ["NET-7559", "Root Cause Item 3", "16/8/2026", "€6659"], status: "completed" as const },
    { id: "643960130", cells: ["NET-2130", "Root Cause Item 4", "3/3/2026", "€10 230"], status: "warning" as const },
    { id: "643963701", cells: ["NET-5701", "Root Cause Item 5", "18/10/2026", "€13 801"], status: "active" as const },
];
...
export default function NetworkOpsCenterRootCausePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Root Cause</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">Network Ops Center • Root Cause</p>
                    </div>
                </div>
