...
const PAGE = "Access";
const KPIS = [{"l":"Dispositivos Online","v":"2.026","t":"+1.3%","d":"up"},{"l":"Dados/Min (MB)","v":"6.422","t":"+12.9%","d":"up"},{"l":"Alertas Ativos","v":"8.393","t":"+4.8%","d":"up"},{"l":"Uptime (%)","v":"76.3%","t":"+16.2%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","7.673","5.990","5.414","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","5.787","8.203","8.325","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.923","981","3.317","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.031","435","4.792","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","1.506","1.967","1.217","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":678},{"label":"Fev","value":927},{"label":"Mar","value":962},{"label":"Abr","value":636},{"label":"Mai","value":675},{"label":"Jun","value":640},{"label":"Jul","value":822},{"label":"Ago","value":608},{"label":"Set","value":943},{"label":"Out","value":853},{"label":"Nov","value":747},{"label":"Dez","value":760}];
const MX = 962;
