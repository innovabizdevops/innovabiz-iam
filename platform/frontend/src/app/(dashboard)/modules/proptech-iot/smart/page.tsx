...
const ACCENT = "#6366f1";
const MODULE = "PropTech IoT";
const PAGE = "Smart Build";
const KPIS = [{"l":"Dispositivos Online","v":"5.877","t":"+3.4%","d":"up"},{"l":"Dados/Min (MB)","v":"6.348","t":"-2.7%","d":"down"},{"l":"Alertas Ativos","v":"2.343","t":"-4.7%","d":"down"},{"l":"Uptime (%)","v":"71.5%","t":"-0.5%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","3.698","248","7.427","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","547","4.652","2.934","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","3.576","3.445","2.587","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","6.280","6.335","1.910","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.096","594","2.525","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":772},{"label":"Fev","value":673},{"label":"Mar","value":790},{"label":"Abr","value":673},{"label":"Mai","value":615},{"label":"Jun","value":691},{"label":"Jul","value":797},{"label":"Ago","value":768},{"label":"Set","value":641},{"label":"Out","value":871},{"label":"Nov","value":493},{"label":"Dez","value":579}];
const MX = 871;
