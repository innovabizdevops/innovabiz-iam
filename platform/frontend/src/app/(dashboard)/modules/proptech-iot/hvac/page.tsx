...
const PAGE = "HVAC";
const KPIS = [{"l":"Dispositivos Online","v":"1.842","t":"+8.3%","d":"up"},{"l":"Dados/Min (MB)","v":"1.004","t":"+8.5%","d":"up"},{"l":"Alertas Ativos","v":"3.020","t":"+0.9%","d":"up"},{"l":"Uptime (%)","v":"71.6%","t":"-4.2%","d":"down"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","8.571","3.116","424","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","4.128","497","8.708","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","1.417","6.219","5.030","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.270","7.357","539","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","2.672","6.796","1.971","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":423},{"label":"Fev","value":532},{"label":"Mar","value":540},{"label":"Abr","value":398},{"label":"Mai","value":304},{"label":"Jun","value":590},{"label":"Jul","value":379},{"label":"Ago","value":409},{"label":"Set","value":514},{"label":"Out","value":446},{"label":"Nov","value":530},{"label":"Dez","value":390}];
const MX = 590;
