...
const KPIS = [{"l":"Dispositivos Online","v":"7.881","t":"-4.6%","d":"down"},{"l":"Dados/Min (MB)","v":"920","t":"+2.8%","d":"up"},{"l":"Alertas Ativos","v":"2.524","t":"+16.1%","d":"up"},{"l":"Uptime (%)","v":"70.3%","t":"+6.9%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.356","3.087","1.939","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","8.189","7.526","6.082","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","2.986","4.303","4.973","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","3.295","7.476","1.647","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.499","4.134","5.130","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":822},{"label":"Mar","value":785},{"label":"Abr","value":919},{"label":"Mai","value":875},{"label":"Jun","value":784},{"label":"Jul","value":846},{"label":"Ago","value":796},{"label":"Set","value":870},{"label":"Out","value":965},{"label":"Nov","value":781},{"label":"Dez","value":733}];
const MX = 1028;
