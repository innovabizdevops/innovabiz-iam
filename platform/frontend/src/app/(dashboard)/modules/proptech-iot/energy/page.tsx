...
const PAGE = "Energy";
const KPIS = [{"l":"Dispositivos Online","v":"5.221","t":"+10.0%","d":"up"},{"l":"Dados/Min (MB)","v":"744","t":"+8.7%","d":"up"},{"l":"Alertas Ativos","v":"3.376","t":"+4.0%","d":"up"},{"l":"Uptime (%)","v":"68.7%","t":"+4.1%","d":"up"}];
const COLS = ["Dispositivo","Tipo","Localização","Último Sinal","Firmware","Estado"];
const ROWS = [{"id":"r0","cells":["SENS-TEMP-001","SENS-HUM-042","4.023","2.303","3.646","Ativo"],"status":"active"},{"id":"r1","cells":["SENS-HUM-042","ACT-VALVE-013","1.775","8.230","245","Pendente"],"status":"pending"},{"id":"r2","cells":["ACT-VALVE-013","GW-EDGE-007","7.195","8.658","2.611","Concluído"],"status":"done"},{"id":"r3","cells":["GW-EDGE-007","CAM-AI-028","5.253","5.910","7.152","Em Análise"],"status":"risk"},{"id":"r4","cells":["CAM-AI-028","SENS-TEMP-001","6.668","8.386","3.060","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":386},{"label":"Fev","value":441},{"label":"Mar","value":497},{"label":"Abr","value":307},{"label":"Mai","value":533},{"label":"Jun","value":536},{"label":"Jul","value":541},{"label":"Ago","value":382},{"label":"Set","value":456},{"label":"Out","value":224},{"label":"Nov","value":541},{"label":"Dez","value":549}];
const MX = 549;
