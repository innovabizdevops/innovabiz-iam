...
export default function ProptechIotPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Proptech Iot</h1><p className="text-sm text-muted-foreground">Proptech Iot • iBOS Enterprise</p></div>
