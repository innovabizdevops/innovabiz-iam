...
const ACCENT = "#6366f1";
const MODULE = "Pipeline Integrity";
const PAGE = "ECDA";
const KPIS = [{"l":"Total Pipeline Integrity","v":"140","t":"+14.3%","d":"up"},{"l":"ECDA Ativos","v":"2.990","t":"-1.4%","d":"down"},{"l":"Eficiência (%)","v":"66.1%","t":"+8.0%","d":"up"},{"l":"Score Performance","v":"81","t":"+5.4%","d":"up"}];
const COLS = ["ID","ECDA","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pipeline Integrity #001","Pipeline Integrity #002","2.005","1.761","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pipeline Integrity #002","Pipeline Integrity #003","5.827","3.904","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Pipeline Integrity #003","Pipeline Integrity #004","5.690","620","2026-03-06","Concluído"],"status":"done"},{"id":"r3","cells":["Pipeline Integrity #004","Pipeline Integrity #005","4.477","8.753","2026-01-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pipeline Integrity #005","Pipeline Integrity #001","5.978","8.921","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":322},{"label":"Fev","value":504},{"label":"Mar","value":480},{"label":"Abr","value":418},{"label":"Mai","value":402},{"label":"Jun","value":660},{"label":"Jul","value":650},{"label":"Ago","value":555},{"label":"Set","value":410},{"label":"Out","value":635},{"label":"Nov","value":465},{"label":"Dez","value":446}];
const MX = 660;
...
export default function EcdaPage() {
    return (
