...
const PAGE = "ILI";
const KPIS = [{"l":"Total Pipeline Integrity","v":"6.586","t":"+15.1%","d":"up"},{"l":"ILI Ativos","v":"7.994","t":"+8.7%","d":"up"},{"l":"Eficiência (%)","v":"80.8%","t":"-0.2%","d":"down"},{"l":"Score Performance","v":"66","t":"-1.5%","d":"down"}];
const COLS = ["ID","ILI","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pipeline Integrity #001","Pipeline Integrity #002","2.540","6.618","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Pipeline Integrity #002","Pipeline Integrity #003","658","407","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pipeline Integrity #003","Pipeline Integrity #004","2.845","6.610","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Pipeline Integrity #004","Pipeline Integrity #005","140","8.157","2026-03-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pipeline Integrity #005","Pipeline Integrity #001","8.464","8.578","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":989},{"label":"Fev","value":752},{"label":"Mar","value":853},{"label":"Abr","value":1001},{"label":"Mai","value":706},{"label":"Jun","value":739},{"label":"Jul","value":754},{"label":"Ago","value":788},{"label":"Set","value":922},{"label":"Out","value":859},{"label":"Nov","value":866},{"label":"Dez","value":784}];
const MX = 1001;
...
export default function IliPage() {
    return (
