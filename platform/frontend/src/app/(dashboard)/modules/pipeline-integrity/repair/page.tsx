...
const PAGE = "Repair";
const KPIS = [{"l":"Total Pipeline Integrity","v":"8.612","t":"+14.4%","d":"up"},{"l":"Repair Ativos","v":"4.659","t":"+10.9%","d":"up"},{"l":"Eficiência (%)","v":"73.1%","t":"+16.1%","d":"up"},{"l":"Score Performance","v":"71","t":"+14.7%","d":"up"}];
const COLS = ["ID","Repair","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pipeline Integrity #001","Pipeline Integrity #002","1.262","1.210","2026-01-04","Ativo"],"status":"active"},{"id":"r1","cells":["Pipeline Integrity #002","Pipeline Integrity #003","2.722","2.269","2026-03-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Pipeline Integrity #003","Pipeline Integrity #004","5.865","6.607","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Pipeline Integrity #004","Pipeline Integrity #005","8.741","4.030","2026-03-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pipeline Integrity #005","Pipeline Integrity #001","4.416","921","2026-02-25","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":424},{"label":"Fev","value":315},{"label":"Mar","value":389},{"label":"Abr","value":466},{"label":"Mai","value":534},{"label":"Jun","value":603},{"label":"Jul","value":449},{"label":"Ago","value":603},{"label":"Set","value":585},{"label":"Out","value":378},{"label":"Nov","value":270},{"label":"Dez","value":346}];
const MX = 603;
