...
const ACCENT = "#15803d";
const MODULE = "Cannabis Testing Lab";
const PAGE = "Pesticide";
const KPIS = [{"l":"Total Cannabis Lab","v":"2.846","t":"+12.1%","d":"up"},{"l":"Pesticide Ativos","v":"4.633","t":"+15.2%","d":"up"},{"l":"Eficiência (%)","v":"66.9%","t":"-5.1%","d":"down"},{"l":"Score Performance","v":"62","t":"+16.5%","d":"up"}];
const COLS = ["ID","Pesticide","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Cannabis Lab #001","Cannabis Lab #002","8.463","3.908","2026-01-27","Ativo"],"status":"active"},{"id":"r1","cells":["Cannabis Lab #002","Cannabis Lab #003","4.988","1.144","2026-01-06","Pendente"],"status":"pending"},{"id":"r2","cells":["Cannabis Lab #003","Cannabis Lab #004","5.388","8.426","2026-01-20","Concluído"],"status":"done"},{"id":"r3","cells":["Cannabis Lab #004","Cannabis Lab #005","3.964","3.678","2026-01-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Cannabis Lab #005","Cannabis Lab #001","5.154","1.761","2026-02-19","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":549},{"label":"Fev","value":553},{"label":"Mar","value":443},{"label":"Abr","value":556},{"label":"Mai","value":749},{"label":"Jun","value":731},{"label":"Jul","value":666},{"label":"Ago","value":623},{"label":"Set","value":536},{"label":"Out","value":616},{"label":"Nov","value":611},{"label":"Dez","value":765}];
const MX = 765;
