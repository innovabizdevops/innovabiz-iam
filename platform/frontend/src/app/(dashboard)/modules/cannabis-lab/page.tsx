...
/* ═══ Cannabis Testing Lab — Dashboard ═══ */

const ACCENT = "#15803d";

const KPIS = [
    { label: "Total Registos", value: "5076", trend: "+2%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "1816", trend: "+21%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€175K", trend: "-15%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "81%", trend: "+9%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "1478748176", cells: ["CAN-4176", "Cannabis Testing Lab Item 1", "25/9/2026", "€48 276"], status: "active" as const },
    { id: "1478751747", cells: ["CAN-7747", "Cannabis Testing Lab Item 2", "12/4/2026", "€1847"], status: "pending" as const },
    { id: "1478755318", cells: ["CAN-2318", "Cannabis Testing Lab Item 3", "27/11/2026", "€5418"], status: "completed" as const },
    { id: "1478758889", cells: ["CAN-5889", "Cannabis Testing Lab Item 4", "14/6/2026", "€8989"], status: "warning" as const },
    { id: "1478762460", cells: ["CAN-9460", "Cannabis Testing Lab Item 5", "1/1/2026", "€12 560"], status: "active" as const },
];
...
export default function CannabisTestingLabPage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Cannabis Testing Lab</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Cannabis Testing Lab</p>
                    </div>
                </div>
