...
/* ═══ MD: Multi-Workflow Engine — Dashboard ═══ */

const ACCENT = "#7c2d12";

const KPIS = [
    { label: "Total Registos", value: "2973", trend: "+24%", trendDirection: "up" as const, icon: BarChart3 },
    { label: "Ativos", value: "3476", trend: "+18%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€188K", trend: "-12%", trendDirection: "down" as const, icon: DollarSign },
    { label: "Eficiência", value: "98%", trend: "+6%", trendDirection: "up" as const, icon: Activity },
];

const TABLE_COLS = ["Referência","Descrição","Data","Valor"];

const TABLE_ROWS = [
    { id: "939691073", cells: ["MD-2073", "MD: Multi-Workflow Engine Item 1", "14/6/2026", "€41 173"], status: "active" as const },
    { id: "939694644", cells: ["MD-5644", "MD: Multi-Workflow Engine Item 2", "1/1/2026", "€44 744"], status: "pending" as const },
    { id: "939698215", cells: ["MD-9215", "MD: Multi-Workflow Engine Item 3", "16/8/2026", "€48 315"], status: "completed" as const },
    { id: "939701786", cells: ["MD-3786", "MD: Multi-Workflow Engine Item 4", "3/3/2026", "€1886"], status: "warning" as const },
    { id: "939705357", cells: ["MD-7357", "MD: Multi-Workflow Engine Item 5", "18/10/2026", "€5457"], status: "active" as const },
];
...
export default function MdMultiworkflowEnginePage() {
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">MD: Multi-Workflow Engine</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • MD: Multi-Workflow Engine</p>
                    </div>
                </div>
