...
const PAGE = "Approval";
const KPIS = [{"l":"Aprovações Pendentes","v":"5.416","t":"+9.3%","d":"up"},{"l":"SLA Cumprido (%)","v":"84.1%","t":"+2.0%","d":"up"},{"l":"Tempo Médio (h)","v":"77h","t":"+13.9%","d":"up"},{"l":"Rejeitadas (%)","v":"91.3%","t":"+5.5%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","6.195","€ 42283.54","8.648","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","6.524","€ 16819.00","802","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","3.894","€ 4672.50","5.005","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","5.056","€ 3897.64","5.150","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","1.866","€ 12260.88","4.789","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":450},{"label":"Fev","value":357},{"label":"Mar","value":519},{"label":"Abr","value":387},{"label":"Mai","value":549},{"label":"Jun","value":519},{"label":"Jul","value":618},{"label":"Ago","value":697},{"label":"Set","value":693},{"label":"Out","value":507},{"label":"Nov","value":415},{"label":"Dez","value":358}];
const MX = 697;
