...
const PAGE = "Escalate";
const KPIS = [{"l":"Aprovações Pendentes","v":"8.046","t":"+12.1%","d":"up"},{"l":"SLA Cumprido (%)","v":"86.9%","t":"+0.5%","d":"up"},{"l":"Tempo Médio (h)","v":"16h","t":"+5.4%","d":"up"},{"l":"Rejeitadas (%)","v":"75.2%","t":"+9.8%","d":"up"}];
const COLS = ["Pedido","Requerente","Tipo","Valor (€)","Aprovador","Estado"];
const ROWS = [{"id":"r0","cells":["APR-COMPRAS-891","APR-VIAGEM-452","7.001","€ 7063.64","1.302","Ativo"],"status":"active"},{"id":"r1","cells":["APR-VIAGEM-452","APR-RH-321","3.273","€ 32603.57","7.202","Pendente"],"status":"pending"},{"id":"r2","cells":["APR-RH-321","APR-INVEST-765","4.115","€ 47518.52","6.868","Concluído"],"status":"done"},{"id":"r3","cells":["APR-INVEST-765","APR-CHANGE-109","4.805","€ 16478.36","387","Em Análise"],"status":"risk"},{"id":"r4","cells":["APR-CHANGE-109","APR-COMPRAS-891","2.967","€ 17963.58","4.694","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":504},{"label":"Fev","value":817},{"label":"Mar","value":688},{"label":"Abr","value":470},{"label":"Mai","value":538},{"label":"Jun","value":550},{"label":"Jul","value":570},{"label":"Ago","value":474},{"label":"Set","value":721},{"label":"Out","value":785},{"label":"Nov","value":622},{"label":"Dez","value":468}];
const MX = 817;
