...
const ACCENT = "#7c2d12";
const MODULE = "MD: Multi-Workflow Engine";
const PAGE = "Monitor";
const KPIS = [{"l":"Total Md Workflow Engine","v":"2.301","t":"+14.6%","d":"up"},{"l":"Monitor Ativos","v":"6.267","t":"+12.1%","d":"up"},{"l":"Eficiência (%)","v":"91.1%","t":"+4.4%","d":"up"},{"l":"Score Performance","v":"81","t":"-1.2%","d":"down"}];
const COLS = ["ID","Monitor","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Md Workflow Engine #001","Md Workflow Engine #002","2.476","8.049","2026-02-03","Ativo"],"status":"active"},{"id":"r1","cells":["Md Workflow Engine #002","Md Workflow Engine #003","6.829","9.024","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Md Workflow Engine #003","Md Workflow Engine #004","6.757","8.632","2026-03-14","Concluído"],"status":"done"},{"id":"r3","cells":["Md Workflow Engine #004","Md Workflow Engine #005","9.074","7.595","2026-02-13","Em Análise"],"status":"risk"},{"id":"r4","cells":["Md Workflow Engine #005","Md Workflow Engine #001","477","8.754","2026-02-04","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":654},{"label":"Fev","value":973},{"label":"Mar","value":645},{"label":"Abr","value":800},{"label":"Mai","value":950},{"label":"Jun","value":831},{"label":"Jul","value":691},{"label":"Ago","value":752},{"label":"Set","value":949},{"label":"Out","value":927},{"label":"Nov","value":826},{"label":"Dez","value":692}];
const MX = 973;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#7c2d12'}}>RTM</span></h1>
                </div>
