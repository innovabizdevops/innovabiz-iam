...
const PAGE = "Locale";
const KPIS = [{"l":"Configurações","v":"6.833","t":"-5.2%","d":"down"},{"l":"Últimas Alterações","v":"7.674","t":"+17.4%","d":"up"},{"l":"Ambientes","v":"6.814","t":"-4.8%","d":"down"},{"l":"Versão Config","v":"1.293","t":"+14.4%","d":"up"}];
const COLS = ["Configuração","Módulo","Valor","Ambiente","Última Alteração","Estado"];
const ROWS = [{"id":"r0","cells":["DB Connection Pool","API Rate Limit","€ 24523.88","8.239","2026-02-25","Ativo"],"status":"active"},{"id":"r1","cells":["API Rate Limit","Session Timeout","€ 43863.42","8.910","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Session Timeout","Retry Policy","€ 10192.47","8.198","2026-02-16","Concluído"],"status":"done"},{"id":"r3","cells":["Retry Policy","Feature Flag Alpha","€ 33254.14","2.243","2026-01-03","Em Análise"],"status":"risk"},{"id":"r4","cells":["Feature Flag Alpha","DB Connection Pool","€ 45848.82","5.222","2026-01-08","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1055},{"label":"Fev","value":766},{"label":"Mar","value":986},{"label":"Abr","value":948},{"label":"Mai","value":866},{"label":"Jun","value":953},{"label":"Jul","value":695},{"label":"Ago","value":970},{"label":"Set","value":1047},{"label":"Out","value":690},{"label":"Nov","value":844},{"label":"Dez","value":856}];
const MX = 1055;
