...
const ACCENT = "#6366f1";
const MODULE = "Aero Supply Chain";
const PAGE = "Rotable";
const KPIS = [{"l":"Total Aero Supply Chain","v":"5.735","t":"-0.3%","d":"down"},{"l":"Rotable Ativos","v":"822","t":"+4.5%","d":"up"},{"l":"Eficiência (%)","v":"85.4%","t":"+3.3%","d":"up"},{"l":"Score Performance","v":"77","t":"+9.5%","d":"up"}];
const COLS = ["ID","Rotable","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aero Supply Chain #001","Aero Supply Chain #002","2.706","721","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Aero Supply Chain #002","Aero Supply Chain #003","3.018","2.768","2026-01-27","Pendente"],"status":"pending"},{"id":"r2","cells":["Aero Supply Chain #003","Aero Supply Chain #004","5.551","3.686","2026-02-20","Concluído"],"status":"done"},{"id":"r3","cells":["Aero Supply Chain #004","Aero Supply Chain #005","4.284","204","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aero Supply Chain #005","Aero Supply Chain #001","5.590","952","2026-02-09","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":805},{"label":"Fev","value":616},{"label":"Mar","value":826},{"label":"Abr","value":929},{"label":"Mai","value":839},{"label":"Jun","value":918},{"label":"Jul","value":902},{"label":"Ago","value":997},{"label":"Set","value":912},{"label":"Out","value":751},{"label":"Nov","value":708},{"label":"Dez","value":647}];
const MX = 997;
...
export default function RotablePage() {
    return (
