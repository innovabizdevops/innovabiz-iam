...
const KPIS = [{"l":"Fornecedores Ativos","v":"332","t":"+7.6%","d":"up"},{"l":"Contratos (€M)","v":"€10.2M","t":"+6.7%","d":"up"},{"l":"On-Time Delivery (%)","v":"79.5%","t":"+1.4%","d":"up"},{"l":"Score Médio","v":"58","t":"+11.9%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","84.8%","€ 35094.90","2.920","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","82.7%","€ 42800.33","4.628","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","76.5%","€ 37370.99","5.281","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","72.8%","€ 25667.37","6.603","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","91.7%","€ 34278.51","4.132","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":623},{"label":"Fev","value":709},{"label":"Mar","value":801},{"label":"Abr","value":989},{"label":"Mai","value":664},{"label":"Jun","value":746},{"label":"Jul","value":915},{"label":"Ago","value":840},{"label":"Set","value":907},{"label":"Out","value":871},{"label":"Nov","value":832},{"label":"Dez","value":989}];
const MX = 989;
