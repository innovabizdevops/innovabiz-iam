...
const PAGE = "Pool";
const KPIS = [{"l":"Total Aero Supply Chain","v":"5.589","t":"+13.5%","d":"up"},{"l":"Pool Ativos","v":"8.640","t":"+11.7%","d":"up"},{"l":"Eficiência (%)","v":"79.5%","t":"-3.6%","d":"down"},{"l":"Score Performance","v":"75","t":"-3.2%","d":"down"}];
const COLS = ["ID","Pool","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aero Supply Chain #001","Aero Supply Chain #002","7.032","6.653","2026-02-17","Ativo"],"status":"active"},{"id":"r1","cells":["Aero Supply Chain #002","Aero Supply Chain #003","4.100","3.308","2026-02-11","Pendente"],"status":"pending"},{"id":"r2","cells":["Aero Supply Chain #003","Aero Supply Chain #004","7.415","6.625","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Aero Supply Chain #004","Aero Supply Chain #005","8.660","5.345","2026-03-08","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aero Supply Chain #005","Aero Supply Chain #001","4.450","6.601","2026-03-22","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":914},{"label":"Fev","value":564},{"label":"Mar","value":559},{"label":"Abr","value":565},{"label":"Mai","value":838},{"label":"Jun","value":665},{"label":"Jul","value":704},{"label":"Ago","value":808},{"label":"Set","value":822},{"label":"Out","value":676},{"label":"Nov","value":744},{"label":"Dez","value":521}];
const MX = 914;
