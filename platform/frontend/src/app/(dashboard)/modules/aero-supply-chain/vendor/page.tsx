...
const PAGE = "Vendor";
const KPIS = [{"l":"Fornecedores Ativos","v":"161","t":"+11.0%","d":"up"},{"l":"Contratos (€M)","v":"€45.8M","t":"+13.3%","d":"up"},{"l":"On-Time Delivery (%)","v":"74.0%","t":"+11.7%","d":"up"},{"l":"Score Médio","v":"60","t":"+15.5%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","72.6%","€ 25723.39","6.945","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","76.7%","€ 39127.49","8.481","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","89.5%","€ 16150.66","3.628","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","79.4%","€ 46044.17","6.348","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","72.7%","€ 48805.38","6.289","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":438},{"label":"Fev","value":599},{"label":"Mar","value":472},{"label":"Abr","value":632},{"label":"Mai","value":516},{"label":"Jun","value":327},{"label":"Jul","value":302},{"label":"Ago","value":457},{"label":"Set","value":402},{"label":"Out","value":419},{"label":"Nov","value":436},{"label":"Dez","value":447}];
const MX = 632;
