...
const PAGE = "AOG";
const KPIS = [{"l":"Total Aero Supply Chain","v":"2.150","t":"+9.5%","d":"up"},{"l":"AOG Ativos","v":"6.999","t":"-5.9%","d":"down"},{"l":"Eficiência (%)","v":"66.6%","t":"+14.4%","d":"up"},{"l":"Score Performance","v":"92","t":"+1.9%","d":"up"}];
const COLS = ["ID","AOG","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Aero Supply Chain #001","Aero Supply Chain #002","1.250","4.296","2026-02-14","Ativo"],"status":"active"},{"id":"r1","cells":["Aero Supply Chain #002","Aero Supply Chain #003","7.778","4.139","2026-01-22","Pendente"],"status":"pending"},{"id":"r2","cells":["Aero Supply Chain #003","Aero Supply Chain #004","2.103","2.266","2026-02-14","Concluído"],"status":"done"},{"id":"r3","cells":["Aero Supply Chain #004","Aero Supply Chain #005","5.426","5.273","2026-03-21","Em Análise"],"status":"risk"},{"id":"r4","cells":["Aero Supply Chain #005","Aero Supply Chain #001","6.230","6.032","2026-01-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":945},{"label":"Fev","value":942},{"label":"Mar","value":749},{"label":"Abr","value":1022},{"label":"Mai","value":953},{"label":"Jun","value":810},{"label":"Jul","value":971},{"label":"Ago","value":847},{"label":"Set","value":936},{"label":"Out","value":987},{"label":"Nov","value":753},{"label":"Dez","value":740}];
const MX = 1022;
