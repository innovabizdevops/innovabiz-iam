...
export default function AeroSupplyChainPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Aero Supply Chain</h1><p className="text-sm text-muted-foreground">Aero Supply Chain • iBOS Enterprise</p></div>
