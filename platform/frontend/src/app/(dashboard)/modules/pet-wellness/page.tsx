...
export default function PetWellnessPage() {
    return (
        <div className="p-6 space-y-6">
            <div className="flex items-center justify-between">
                <div><h1 className="text-2xl font-bold">Pet Wellness</h1><p className="text-sm text-muted-foreground">Pet Wellness • iBOS Enterprise</p></div>
