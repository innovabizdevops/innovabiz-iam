...
const KPIS = [{"l":"Total Pet Wellness","v":"3.558","t":"+3.9%","d":"up"},{"l":"Nutrition Ativos","v":"1.698","t":"+5.2%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-0.5%","d":"down"},{"l":"Score Performance","v":"91","t":"+4.2%","d":"up"}];
const COLS = ["ID","Nutrition","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Wellness #001","Pet Wellness #002","772","2.398","2026-03-24","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Wellness #002","Pet Wellness #003","3.789","7.803","2026-02-05","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Wellness #003","Pet Wellness #004","4.281","2.968","2026-01-16","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Wellness #004","Pet Wellness #005","477","7.972","2026-02-15","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Wellness #005","Pet Wellness #001","200","5.609","2026-01-21","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":845},{"label":"Fev","value":770},{"label":"Mar","value":899},{"label":"Abr","value":705},{"label":"Mai","value":961},{"label":"Jun","value":966},{"label":"Jul","value":815},{"label":"Ago","value":685},{"label":"Set","value":830},{"label":"Out","value":660},{"label":"Nov","value":837},{"label":"Dez","value":633}];
const MX = 966;
