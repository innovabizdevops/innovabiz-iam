...
const PAGE = "Vet Visit";
const KPIS = [{"l":"Total Pet Wellness","v":"8.099","t":"+4.6%","d":"up"},{"l":"Vet Visit Ativos","v":"3.763","t":"+5.3%","d":"up"},{"l":"Eficiência (%)","v":"80.2%","t":"+11.0%","d":"up"},{"l":"Score Performance","v":"61","t":"-0.1%","d":"down"}];
const COLS = ["ID","Vet Visit","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Wellness #001","Pet Wellness #002","5.299","6.056","2026-03-25","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Wellness #002","Pet Wellness #003","3.798","2.474","2026-03-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Wellness #003","Pet Wellness #004","337","5.161","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Wellness #004","Pet Wellness #005","174","3.207","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Wellness #005","Pet Wellness #001","2.128","802","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":445},{"label":"Fev","value":543},{"label":"Mar","value":536},{"label":"Abr","value":614},{"label":"Mai","value":493},{"label":"Jun","value":637},{"label":"Jul","value":721},{"label":"Ago","value":652},{"label":"Set","value":469},{"label":"Out","value":612},{"label":"Nov","value":489},{"label":"Dez","value":664}];
const MX = 721;
