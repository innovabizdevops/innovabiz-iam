...
const PAGE = "Grooming";
const KPIS = [{"l":"Total Pet Wellness","v":"6.002","t":"-1.8%","d":"down"},{"l":"Grooming Ativos","v":"5.124","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"88.1%","t":"-3.0%","d":"down"},{"l":"Score Performance","v":"58","t":"+7.3%","d":"up"}];
const COLS = ["ID","Grooming","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Wellness #001","Pet Wellness #002","4.997","6.370","2026-02-12","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Wellness #002","Pet Wellness #003","6.998","993","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Wellness #003","Pet Wellness #004","4.808","1.862","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Wellness #004","Pet Wellness #005","153","1.993","2026-02-01","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Wellness #005","Pet Wellness #001","8.323","1.191","2026-03-07","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":334},{"label":"Fev","value":329},{"label":"Mar","value":570},{"label":"Abr","value":337},{"label":"Mai","value":572},{"label":"Jun","value":407},{"label":"Jul","value":531},{"label":"Ago","value":673},{"label":"Set","value":432},{"label":"Out","value":688},{"label":"Nov","value":444},{"label":"Dez","value":537}];
const MX = 688;
