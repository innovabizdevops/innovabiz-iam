...
const ACCENT = "#6366f1";
const MODULE = "Pet Wellness";
const PAGE = "Insurance";
const KPIS = [{"l":"Total Pet Wellness","v":"7.239","t":"+2.7%","d":"up"},{"l":"Insurance Ativos","v":"3.513","t":"-0.6%","d":"down"},{"l":"Eficiência (%)","v":"75.8%","t":"-1.5%","d":"down"},{"l":"Score Performance","v":"77","t":"+17.7%","d":"up"}];
const COLS = ["ID","Insurance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Wellness #001","Pet Wellness #002","1.919","7.930","2026-02-13","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Wellness #002","Pet Wellness #003","2.843","5.862","2026-02-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Wellness #003","Pet Wellness #004","1.773","1.481","2026-02-09","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Wellness #004","Pet Wellness #005","1.147","2.799","2026-01-19","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Wellness #005","Pet Wellness #001","7.806","2.964","2026-02-18","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":460},{"label":"Fev","value":350},{"label":"Mar","value":486},{"label":"Abr","value":508},{"label":"Mai","value":395},{"label":"Jun","value":635},{"label":"Jul","value":377},{"label":"Ago","value":475},{"label":"Set","value":389},{"label":"Out","value":486},{"label":"Nov","value":283},{"label":"Dez","value":631}];
const MX = 635;
