...
const PAGE = "Record";
const KPIS = [{"l":"Total Pet Wellness","v":"3.036","t":"+1.2%","d":"up"},{"l":"Record Ativos","v":"4.256","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"86.9%","t":"-1.8%","d":"down"},{"l":"Score Performance","v":"76","t":"-4.2%","d":"down"}];
const COLS = ["ID","Record","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Pet Wellness #001","Pet Wellness #002","7.839","4.289","2026-01-14","Ativo"],"status":"active"},{"id":"r1","cells":["Pet Wellness #002","Pet Wellness #003","4.481","8.289","2026-02-07","Pendente"],"status":"pending"},{"id":"r2","cells":["Pet Wellness #003","Pet Wellness #004","1.984","6.293","2026-01-11","Concluído"],"status":"done"},{"id":"r3","cells":["Pet Wellness #004","Pet Wellness #005","1.568","3.669","2026-01-12","Em Análise"],"status":"risk"},{"id":"r4","cells":["Pet Wellness #005","Pet Wellness #001","6.714","1.978","2026-02-14","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":787},{"label":"Fev","value":890},{"label":"Mar","value":933},{"label":"Abr","value":772},{"label":"Mai","value":1053},{"label":"Jun","value":814},{"label":"Jul","value":919},{"label":"Ago","value":826},{"label":"Set","value":769},{"label":"Out","value":744},{"label":"Nov","value":912},{"label":"Dez","value":1063}];
const MX = 1063;
