...
const PAGE = "Open Data Standards";
const KPIS = [{"l":"Total Government Services","v":"5.413","t":"-4.4%","d":"down"},{"l":"Open Data Standards Ativos","v":"119","t":"-2.9%","d":"down"},{"l":"Eficiência (%)","v":"77.5%","t":"+0.9%","d":"up"},{"l":"Score Performance","v":"89","t":"+3.8%","d":"up"}];
const COLS = ["ID","Open Data Standards","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","2026-03-21","8.491","8.239","2026-02-09","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","2026-03-03","3.761","8.346","2026-02-23","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","2026-03-08","5.257","5.700","2026-01-12","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","2026-01-18","8.063","4.708","2026-01-16","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","2026-03-07","7.615","2.433","2026-01-24","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":605},{"label":"Fev","value":798},{"label":"Mar","value":723},{"label":"Abr","value":636},{"label":"Mai","value":594},{"label":"Jun","value":701},{"label":"Jul","value":691},{"label":"Ago","value":607},{"label":"Set","value":873},{"label":"Out","value":870},{"label":"Nov","value":653},{"label":"Dez","value":592}];
const MX = 873;
