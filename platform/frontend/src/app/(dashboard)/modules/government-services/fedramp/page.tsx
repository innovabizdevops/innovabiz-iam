...
const PAGE = "FedRAMP Compliance";
const KPIS = [{"l":"Auditorias Realizadas","v":"7.063","t":"+5.0%","d":"up"},{"l":"NC Abertas","v":"8.043","t":"+15.1%","d":"up"},{"l":"Conformidade (%)","v":"68.2%","t":"+10.3%","d":"up"},{"l":"CAPAs Pendentes","v":"146","t":"+0.2%","d":"up"}];
const COLS = ["Auditoria","Norma","Âmbito","Score (%)","Achados","Estado"];
const ROWS = [{"id":"r0","cells":["AUD-ISO9001-Q1","AUD-ISO27001","8.821","70.9%","3.070","Ativo"],"status":"active"},{"id":"r1","cells":["AUD-ISO27001","AUD-SOX-2026","4.491","93.2%","6.721","Pendente"],"status":"pending"},{"id":"r2","cells":["AUD-SOX-2026","AUD-GDPR-Rev","1.477","82.2%","5.355","Concluído"],"status":"done"},{"id":"r3","cells":["AUD-GDPR-Rev","AUD-CE-Mark","6.490","94.9%","6.338","Em Análise"],"status":"risk"},{"id":"r4","cells":["AUD-CE-Mark","AUD-ISO9001-Q1","6.143","83.4%","1.659","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":819},{"label":"Fev","value":801},{"label":"Mar","value":940},{"label":"Abr","value":945},{"label":"Mai","value":907},{"label":"Jun","value":676},{"label":"Jul","value":929},{"label":"Ago","value":771},{"label":"Set","value":799},{"label":"Out","value":915},{"label":"Nov","value":823},{"label":"Dez","value":803}];
const MX = 945;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>FedRAMP</span></h1>
                </div>
