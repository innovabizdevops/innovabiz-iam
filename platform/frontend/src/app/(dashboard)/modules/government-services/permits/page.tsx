...
const PAGE = "Permits &amp; Licenses";
const KPIS = [{"l":"Riscos Identificados","v":"300","t":"-3.5%","d":"down"},{"l":"Mitigações Ativas","v":"1.257","t":"-0.7%","d":"down"},{"l":"Score Risco Geral","v":"80","t":"+3.0%","d":"up"},{"l":"Incidentes YTD","v":"8.587","t":"+15.8%","d":"up"}];
const COLS = ["Risco","Categoria","Probabilidade","Impacto","Mitigação","Estado"];
const ROWS = [{"id":"r0","cells":["RSK-OP-4521","RSK-FIN-3214","3.232","7.224","8.252","Ativo"],"status":"active"},{"id":"r1","cells":["RSK-FIN-3214","RSK-CYBER-7891","8.252","6.938","7.709","Pendente"],"status":"pending"},{"id":"r2","cells":["RSK-CYBER-7891","RSK-REG-1098","892","6.020","5.392","Concluído"],"status":"done"},{"id":"r3","cells":["RSK-REG-1098","RSK-REP-5623","4.370","5.279","8.703","Em Análise"],"status":"risk"},{"id":"r4","cells":["RSK-REP-5623","RSK-OP-4521","5.106","7.416","256","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":687},{"label":"Fev","value":676},{"label":"Mar","value":809},{"label":"Abr","value":794},{"label":"Mai","value":785},{"label":"Jun","value":817},{"label":"Jul","value":525},{"label":"Ago","value":846},{"label":"Set","value":832},{"label":"Out","value":575},{"label":"Nov","value":710},{"label":"Dez","value":701}];
const MX = 846;
