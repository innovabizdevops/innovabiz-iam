...
const PAGE = "Case Management";
const KPIS = [{"l":"Projetos Melhoria","v":"8.871","t":"-5.1%","d":"down"},{"l":"Savings (€)","v":"€40919","t":"+10.0%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"72.4%","t":"+11.2%","d":"up"},{"l":"Ciclos PDCA","v":"7.347","t":"+15.2%","d":"up"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","5.880","€ 4115.53","1.870","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","7.111","€ 28253.48","8.269","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","2.983","€ 45541.62","982","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","4.236","€ 9780.25","749","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","2.146","€ 47583.59","3.741","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":850},{"label":"Fev","value":839},{"label":"Mar","value":811},{"label":"Abr","value":674},{"label":"Mai","value":780},{"label":"Jun","value":570},{"label":"Jul","value":533},{"label":"Ago","value":770},{"label":"Set","value":676},{"label":"Out","value":881},{"label":"Nov","value":689},{"label":"Dez","value":855}];
const MX = 881;
