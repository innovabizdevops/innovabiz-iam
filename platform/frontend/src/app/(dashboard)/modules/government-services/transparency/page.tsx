...
const PAGE = "Transparency";
const KPIS = [{"l":"Quartos Ocupados","v":"8.720","t":"+17.5%","d":"up"},{"l":"RevPAR (€)","v":"€8144","t":"+9.3%","d":"up"},{"l":"Ocupação (%)","v":"90.3%","t":"+8.2%","d":"up"},{"l":"Guest Satisfaction","v":"2.129","t":"+11.6%","d":"up"}];
const COLS = ["Reserva","Hóspede","Quarto","Check-in","Check-out","Estado"];
const ROWS = [{"id":"r0","cells":["RES-2026-8921","RES-2026-8922","8.761","2026-03-11","2026-03-06","Ativo"],"status":"active"},{"id":"r1","cells":["RES-2026-8922","RES-2026-8923","3.705","2026-02-11","2026-03-20","Pendente"],"status":"pending"},{"id":"r2","cells":["RES-2026-8923","RES-2026-8924","4.841","2026-03-06","2026-03-24","Concluído"],"status":"done"},{"id":"r3","cells":["RES-2026-8924","RES-2026-8925","5.200","2026-01-07","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["RES-2026-8925","RES-2026-8921","511","2026-02-06","2026-02-06","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":510},{"label":"Fev","value":711},{"label":"Mar","value":790},{"label":"Abr","value":829},{"label":"Mai","value":777},{"label":"Jun","value":517},{"label":"Jul","value":782},{"label":"Ago","value":804},{"label":"Set","value":665},{"label":"Out","value":791},{"label":"Nov","value":604},{"label":"Dez","value":759}];
const MX = 829;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>Gov</span></h1>
                </div>
