...
const KPIS = [{"l":"Fornecedores Ativos","v":"624","t":"-2.0%","d":"down"},{"l":"Contratos (€M)","v":"€39.3M","t":"+9.8%","d":"up"},{"l":"On-Time Delivery (%)","v":"66.8%","t":"+16.0%","d":"up"},{"l":"Score Médio","v":"86","t":"+11.7%","d":"up"}];
const COLS = ["Fornecedor","Categoria","Score","Volume (€)","Contrato","Estado"];
const ROWS = [{"id":"r0","cells":["AWS Cloud Services","Vodafone Enterprise","73.6%","€ 25480.48","513","Ativo"],"status":"active"},{"id":"r1","cells":["Vodafone Enterprise","SAP SE","84.5%","€ 30025.29","3.027","Pendente"],"status":"pending"},{"id":"r2","cells":["SAP SE","Oracle Cloud","92.4%","€ 38711.81","1.563","Concluído"],"status":"done"},{"id":"r3","cells":["Oracle Cloud","ServiceNow","70.6%","€ 42014.82","2.058","Em Análise"],"status":"risk"},{"id":"r4","cells":["ServiceNow","AWS Cloud Services","79.8%","€ 39219.61","6.187","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":535},{"label":"Fev","value":733},{"label":"Mar","value":721},{"label":"Abr","value":594},{"label":"Mai","value":460},{"label":"Jun","value":502},{"label":"Jul","value":572},{"label":"Ago","value":368},{"label":"Set","value":696},{"label":"Out","value":736},{"label":"Nov","value":737},{"label":"Dez","value":478}];
const MX = 737;
