...
const PAGE = "Grants Management";
const KPIS = [{"l":"Projetos Melhoria","v":"2.845","t":"-4.8%","d":"down"},{"l":"Savings (€)","v":"€43809","t":"+8.7%","d":"up"},{"l":"Defeitos Reduzidos (%)","v":"69.9%","t":"+11.6%","d":"up"},{"l":"Ciclos PDCA","v":"1.626","t":"-3.9%","d":"down"}];
const COLS = ["Projeto","Metodologia","Líder","Saving (€)","Duração","Estado"];
const ROWS = [{"id":"r0","cells":["Lean Line A","6σ Defeitos Assembly","8.829","€ 4438.44","1.193","Ativo"],"status":"active"},{"id":"r1","cells":["6σ Defeitos Assembly","Kaizen Warehouse","3.883","€ 12001.58","3.107","Pendente"],"status":"pending"},{"id":"r2","cells":["Kaizen Warehouse","5S Escritório","6.447","€ 3525.45","2.605","Concluído"],"status":"done"},{"id":"r3","cells":["5S Escritório","PDCA Qualidade","1.032","€ 13014.72","103","Em Análise"],"status":"risk"},{"id":"r4","cells":["PDCA Qualidade","Lean Line A","1.854","€ 17300.36","586","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":372},{"label":"Fev","value":420},{"label":"Mar","value":600},{"label":"Abr","value":492},{"label":"Mai","value":408},{"label":"Jun","value":310},{"label":"Jul","value":579},{"label":"Ago","value":224},{"label":"Set","value":457},{"label":"Out","value":363},{"label":"Nov","value":228},{"label":"Dez","value":450}];
const MX = 600;
