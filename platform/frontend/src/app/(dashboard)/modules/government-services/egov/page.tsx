...
const PAGE = "e-Gov Services";
const KPIS = [{"l":"Total Government Services","v":"448","t":"-2.3%","d":"down"},{"l":"E Gov Services Ativos","v":"939","t":"+1.2%","d":"up"},{"l":"Eficiência (%)","v":"88.6%","t":"+11.4%","d":"up"},{"l":"Score Performance","v":"71","t":"-2.6%","d":"down"}];
const COLS = ["ID","E Gov Services","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","3.819","2.719","2026-03-01","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","6.984","206","2026-01-19","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","3.341","3.521","2026-03-05","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","6.426","8.934","2026-01-22","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","6.756","3.819","2026-03-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":877},{"label":"Fev","value":672},{"label":"Mar","value":964},{"label":"Abr","value":789},{"label":"Mai","value":995},{"label":"Jun","value":975},{"label":"Jul","value":739},{"label":"Ago","value":870},{"label":"Set","value":682},{"label":"Out","value":802},{"label":"Nov","value":949},{"label":"Dez","value":733}];
const MX = 995;
