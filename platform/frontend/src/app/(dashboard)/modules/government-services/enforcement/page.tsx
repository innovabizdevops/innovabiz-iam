...
const PAGE = "Regulatory Enforcement";
const KPIS = [{"l":"Total Government Services","v":"755","t":"+10.2%","d":"up"},{"l":"Regulatory Enforcement Ativos","v":"4.906","t":"+8.3%","d":"up"},{"l":"Eficiência (%)","v":"85.7%","t":"+9.8%","d":"up"},{"l":"Score Performance","v":"83","t":"-0.1%","d":"down"}];
const COLS = ["ID","Regulatory Enforcement","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","5.234","1.266","2026-03-07","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","8.891","114","2026-02-18","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","7.860","8.713","2026-02-24","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","4.100","7.979","2026-02-26","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","1.052","786","2026-01-12","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":849},{"label":"Fev","value":880},{"label":"Mar","value":841},{"label":"Abr","value":642},{"label":"Mai","value":940},{"label":"Jun","value":673},{"label":"Jul","value":997},{"label":"Ago","value":775},{"label":"Set","value":668},{"label":"Out","value":877},{"label":"Nov","value":726},{"label":"Dez","value":980}];
const MX = 997;
