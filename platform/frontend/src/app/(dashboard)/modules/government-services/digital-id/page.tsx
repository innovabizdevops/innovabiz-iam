...
const PAGE = "Digital ID (eIDAS)";
const KPIS = [{"l":"Total Government Services","v":"2.072","t":"+8.7%","d":"up"},{"l":"Digital ID (EIDAS) Ativos","v":"2.818","t":"-5.6%","d":"down"},{"l":"Eficiência (%)","v":"85.6%","t":"+11.6%","d":"up"},{"l":"Score Performance","v":"85","t":"+16.8%","d":"up"}];
const COLS = ["ID","Digital ID (EIDAS)","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","2.904","9.081","2026-02-20","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","8.980","5.502","2026-01-24","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","1.916","5.350","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","4.014","7.783","2026-02-17","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","2.644","7.168","2026-02-05","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":419},{"label":"Fev","value":416},{"label":"Mar","value":686},{"label":"Abr","value":331},{"label":"Mai","value":491},{"label":"Jun","value":689},{"label":"Jul","value":650},{"label":"Ago","value":410},{"label":"Set","value":499},{"label":"Out","value":356},{"label":"Nov","value":368},{"label":"Dez","value":576}];
const MX = 689;
        ...
        <div className="p-6 space-y-6 min-h-screen">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                    ...
                    <h1 className="text-2xl font-bold font-[Outfit] flex items-center">{PAGE}<span className="ml-2 px-2 py-0.5 rounded-full text-[10px] font-semibold text-white" style={{background:'#6366f1'}}>eIDAS</span></h1>
                </div>
