...
const PAGE = "Citizen Services Portal";
const KPIS = [{"l":"Páginas Publicadas","v":"7.013","t":"+15.8%","d":"up"},{"l":"Visitantes/Dia","v":"2345","t":"+1.7%","d":"up"},{"l":"Conversão (%)","v":"81.0%","t":"+9.2%","d":"up"},{"l":"Performance Score","v":"73","t":"+1.4%","d":"up"}];
const COLS = ["Página","URL","Views/Dia","Bounce (%)","Conversão (%)","Estado"];
const ROWS = [{"id":"r0","cells":["/home","/products","3450","95.5%","98.4%","Ativo"],"status":"active"},{"id":"r1","cells":["/products","/pricing","3613","86.2%","96.2%","Pendente"],"status":"pending"},{"id":"r2","cells":["/pricing","/about","4810","93.1%","93.4%","Concluído"],"status":"done"},{"id":"r3","cells":["/about","/contact","2153","85.6%","99.3%","Em Análise"],"status":"risk"},{"id":"r4","cells":["/contact","/home","2127","84.2%","71.5%","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":838},{"label":"Fev","value":696},{"label":"Mar","value":860},{"label":"Abr","value":753},{"label":"Mai","value":841},{"label":"Jun","value":992},{"label":"Jul","value":912},{"label":"Ago","value":620},{"label":"Set","value":858},{"label":"Out","value":676},{"label":"Nov","value":640},{"label":"Dez","value":869}];
const MX = 992;
...
export default function CitizenPortalGovernmentPage() {
    return (
