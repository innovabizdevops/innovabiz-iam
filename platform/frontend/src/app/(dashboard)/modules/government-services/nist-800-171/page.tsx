...
const PAGE = "NIST 800-171";
const KPIS = [{"l":"Total Government Services","v":"4.215","t":"-0.1%","d":"down"},{"l":"NIST 800 171 Ativos","v":"3.273","t":"-4.5%","d":"down"},{"l":"Eficiência (%)","v":"65.2%","t":"+9.3%","d":"up"},{"l":"Score Performance","v":"75","t":"-2.8%","d":"down"}];
const COLS = ["ID","NIST 800 171","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","3.169","5.219","2026-02-07","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","6.961","3.560","2026-03-12","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","3.212","5.399","2026-02-12","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","4.966","574","2026-01-04","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","128","3.274","2026-02-13","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":683},{"label":"Fev","value":737},{"label":"Mar","value":804},{"label":"Abr","value":714},{"label":"Mai","value":579},{"label":"Jun","value":626},{"label":"Jul","value":542},{"label":"Ago","value":624},{"label":"Set","value":815},{"label":"Out","value":662},{"label":"Nov","value":761},{"label":"Dez","value":560}];
const MX = 815;
