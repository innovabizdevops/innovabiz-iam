...
const PAGE = "Smart City Dashboard";
const KPIS = [{"l":"Teams Ativos","v":"626","t":"+7.2%","d":"up"},{"l":"Reuniões/Semana","v":"3344","t":"+6.6%","d":"up"},{"l":"Mensagens/Dia","v":"376","t":"+3.7%","d":"up"},{"l":"Ficheiros Partilhados","v":"3.589","t":"+3.2%","d":"up"}];
const COLS = ["Equipa","Membros","Canal","Mensagens/Semana","Ficheiros","Estado"];
const ROWS = [{"id":"r0","cells":["Engineering Core","Product Design","8.170","1452","5.324","Ativo"],"status":"active"},{"id":"r1","cells":["Product Design","Sales EMEA","2.270","1126","8.790","Pendente"],"status":"pending"},{"id":"r2","cells":["Sales EMEA","Support L2","3.481","3324","2.945","Concluído"],"status":"done"},{"id":"r3","cells":["Support L2","Executive Strategy","5.476","4830","7.180","Em Análise"],"status":"risk"},{"id":"r4","cells":["Executive Strategy","Engineering Core","4.118","4314","8.186","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":366},{"label":"Fev","value":374},{"label":"Mar","value":577},{"label":"Abr","value":372},{"label":"Mai","value":661},{"label":"Jun","value":401},{"label":"Jul","value":636},{"label":"Ago","value":611},{"label":"Set","value":441},{"label":"Out","value":535},{"label":"Nov","value":397},{"label":"Dez","value":625}];
const MX = 661;
