...
const PAGE = "Public Finance";
const KPIS = [{"l":"Total Government Services","v":"1.475","t":"+6.9%","d":"up"},{"l":"Public Finance Ativos","v":"3.124","t":"+11.6%","d":"up"},{"l":"Eficiência (%)","v":"76.0%","t":"-3.9%","d":"down"},{"l":"Score Performance","v":"85","t":"+15.8%","d":"up"}];
const COLS = ["ID","Public Finance","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","2.652","1.067","2026-02-02","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","8.939","3.159","2026-01-17","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","3.668","7.858","2026-02-05","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","8.648","5.222","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","3.784","680","2026-01-16","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":721},{"label":"Fev","value":526},{"label":"Mar","value":789},{"label":"Abr","value":843},{"label":"Mai","value":883},{"label":"Jun","value":726},{"label":"Jul","value":672},{"label":"Ago","value":561},{"label":"Set","value":770},{"label":"Out","value":781},{"label":"Nov","value":847},{"label":"Dez","value":497}];
const MX = 883;
