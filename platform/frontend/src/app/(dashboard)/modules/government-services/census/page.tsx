...
const ACCENT = "#6366f1";
const MODULE = "Government Services";
const PAGE = "Census &amp; Stats";
const KPIS = [{"l":"Total Government Services","v":"3.518","t":"+6.7%","d":"up"},{"l":"Census & Stats Ativos","v":"8.648","t":"+15.4%","d":"up"},{"l":"Eficiência (%)","v":"78.3%","t":"+14.0%","d":"up"},{"l":"Score Performance","v":"63","t":"-2.2%","d":"down"}];
const COLS = ["ID","Census & Stats","Categoria","Responsável","Data","Estado"];
const ROWS = [{"id":"r0","cells":["Government Services #001","Government Services #002","8.468","4.683","2026-03-28","Ativo"],"status":"active"},{"id":"r1","cells":["Government Services #002","Government Services #003","4.146","2.999","2026-01-13","Pendente"],"status":"pending"},{"id":"r2","cells":["Government Services #003","Government Services #004","8.872","851","2026-01-19","Concluído"],"status":"done"},{"id":"r3","cells":["Government Services #004","Government Services #005","5.193","3.388","2026-03-07","Em Análise"],"status":"risk"},{"id":"r4","cells":["Government Services #005","Government Services #001","4.688","1.584","2026-02-17","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":494},{"label":"Fev","value":580},{"label":"Mar","value":342},{"label":"Abr","value":389},{"label":"Mai","value":486},{"label":"Jun","value":655},{"label":"Jul","value":631},{"label":"Ago","value":438},{"label":"Set","value":380},{"label":"Out","value":633},{"label":"Nov","value":645},{"label":"Dez","value":573}];
const MX = 655;
