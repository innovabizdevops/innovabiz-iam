...
const PAGE = "Bioavail";
const KPIS = [{"l":"Formulários Ativos","v":"3.889","t":"+9.4%","d":"up"},{"l":"Submissões/Dia","v":"463","t":"+0.2%","d":"up"},{"l":"Documentos Gerados","v":"1.252","t":"+13.8%","d":"up"},{"l":"Templates","v":"9.057","t":"+17.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","4.421","2026-01-20","2.236","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","5.080","2026-01-14","3.833","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","6.523","2026-02-16","436","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.334","2026-02-12","7.987","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","7.736","2026-03-13","2.594","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1028},{"label":"Fev","value":800},{"label":"Mar","value":737},{"label":"Abr","value":989},{"label":"Mai","value":1011},{"label":"Jun","value":693},{"label":"Jul","value":652},{"label":"Ago","value":938},{"label":"Set","value":799},{"label":"Out","value":996},{"label":"Nov","value":722},{"label":"Dez","value":907}];
const MX = 1028;
...
export default function BioavailPage() {
    return (
