...
const PAGE = "Preformulation";
const KPIS = [{"l":"Formulários Ativos","v":"2.423","t":"+6.7%","d":"up"},{"l":"Submissões/Dia","v":"3930","t":"+16.4%","d":"up"},{"l":"Documentos Gerados","v":"7.669","t":"-3.6%","d":"down"},{"l":"Templates","v":"5.374","t":"+4.7%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","3.677","2026-02-24","6.760","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.456","2026-02-23","5.968","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","5.664","2026-03-28","4.515","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","6.728","2026-01-25","5.206","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.674","2026-01-04","6.669","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":603},{"label":"Fev","value":699},{"label":"Mar","value":588},{"label":"Abr","value":557},{"label":"Mai","value":595},{"label":"Jun","value":598},{"label":"Jul","value":734},{"label":"Ago","value":479},{"label":"Set","value":565},{"label":"Out","value":673},{"label":"Nov","value":466},{"label":"Dez","value":586}];
const MX = 734;
