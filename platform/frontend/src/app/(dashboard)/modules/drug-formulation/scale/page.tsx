...
const PAGE = "Scale";
const KPIS = [{"l":"Formulários Ativos","v":"1.230","t":"+6.2%","d":"up"},{"l":"Submissões/Dia","v":"2149","t":"-0.2%","d":"down"},{"l":"Documentos Gerados","v":"5.865","t":"+13.6%","d":"up"},{"l":"Templates","v":"3.710","t":"+4.5%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.580","2026-01-22","6.273","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","3.280","2026-03-16","5.892","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","7.609","2026-01-26","6.763","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","7.565","2026-02-28","7.358","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","3.272","2026-03-14","881","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":1040},{"label":"Fev","value":970},{"label":"Mar","value":740},{"label":"Abr","value":758},{"label":"Mai","value":718},{"label":"Jun","value":986},{"label":"Jul","value":873},{"label":"Ago","value":999},{"label":"Set","value":1025},{"label":"Out","value":1076},{"label":"Nov","value":993},{"label":"Dez","value":788}];
const MX = 1076;
