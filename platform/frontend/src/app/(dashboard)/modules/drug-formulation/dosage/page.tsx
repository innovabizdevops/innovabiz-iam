...
const PAGE = "Dosage";
const KPIS = [{"l":"Formulários Ativos","v":"1.872","t":"-5.6%","d":"down"},{"l":"Submissões/Dia","v":"1455","t":"-4.6%","d":"down"},{"l":"Documentos Gerados","v":"131","t":"+16.8%","d":"up"},{"l":"Templates","v":"4.553","t":"+4.1%","d":"up"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","6.998","2026-01-14","7.657","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","8.805","2026-03-28","416","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","4.372","2026-03-14","8.662","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","5.317","2026-03-20","5.422","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","5.463","2026-01-21","1.358","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":964},{"label":"Fev","value":1045},{"label":"Mar","value":985},{"label":"Abr","value":687},{"label":"Mai","value":1011},{"label":"Jun","value":867},{"label":"Jul","value":997},{"label":"Ago","value":804},{"label":"Set","value":697},{"label":"Out","value":875},{"label":"Nov","value":976},{"label":"Dez","value":892}];
const MX = 1045;
