...
const ACCENT = "#6d28d9";
const MODULE = "Drug Formulation";
const PAGE = "Excipient";
const KPIS = [{"l":"Formulários Ativos","v":"4.671","t":"+17.1%","d":"up"},{"l":"Submissões/Dia","v":"472","t":"+14.0%","d":"up"},{"l":"Documentos Gerados","v":"1.045","t":"+12.8%","d":"up"},{"l":"Templates","v":"6.298","t":"-0.1%","d":"down"}];
const COLS = ["Formulário","Tipo","Submissões","Última Edição","Criador","Estado"];
const ROWS = [{"id":"r0","cells":["Registo Cliente","Pedido Compras","8.920","2026-01-03","1.435","Ativo"],"status":"active"},{"id":"r1","cells":["Pedido Compras","Avaliação Fornecedor","2.214","2026-02-07","3.802","Pendente"],"status":"pending"},{"id":"r2","cells":["Avaliação Fornecedor","Onboarding Check","8.278","2026-03-16","1.711","Concluído"],"status":"done"},{"id":"r3","cells":["Onboarding Check","Relatório Mensal","8.605","2026-02-05","2.001","Em Análise"],"status":"risk"},{"id":"r4","cells":["Relatório Mensal","Registo Cliente","1.471","2026-03-01","2.343","Aprovado"],"status":"active"}];
const CHART = [{"label":"Jan","value":917},{"label":"Fev","value":1016},{"label":"Mar","value":894},{"label":"Abr","value":1028},{"label":"Mai","value":815},{"label":"Jun","value":957},{"label":"Jul","value":894},{"label":"Ago","value":850},{"label":"Set","value":970},{"label":"Out","value":1025},{"label":"Nov","value":774},{"label":"Dez","value":961}];
const MX = 1028;
...
export default function ExcipientPage() {
    return (
