...
/* ═══ Drug Formulation — Dashboard ═══ */

const ACCENT = "#6d28d9";

const KPIS = [
    { label: "Total Registos", value: "9172", trend: "-23%", trendDirection: "down" as const, icon: BarChart3 },
    { label: "Ativos", value: "2716", trend: "+17%", trendDirection: "up" as const, icon: Users },
    { label: "Receita Mensal", value: "€326K", trend: "+11%", trendDirection: "up" as const, icon: DollarSign },
...
const TABLE_ROWS = [
    { id: "1200888972", cells: ["DRU-1972", "Drug Formulation Item 1", "25/1/2026", "€39 072"], status: "active" as const },
    { id: "1200892543", cells: ["DRU-5543", "Drug Formulation Item 2", "12/8/2026", "€42 643"], status: "pending" as const },
    { id: "1200896114", cells: ["DRU-9114", "Drug Formulation Item 3", "27/3/2026", "€46 214"], status: "completed" as const },
    { id: "1200899685", cells: ["DRU-3685", "Drug Formulation Item 4", "14/10/2026", "€49 785"], status: "warning" as const },
    { id: "1200903256", cells: ["DRU-7256", "Drug Formulation Item 5", "1/5/2026", "€3356"], status: "active" as const },
];
        ...
        <div className="min-h-screen bg-[var(--surface-primary,#0a0e1a)] text-[var(--text-primary,#e2e8f0)] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold font-[Outfit] tracking-tight flex items-center">Drug Formulation</h1>
                        <p className="text-sm text-[var(--text-tertiary,#64748b)] mt-0.5">InnovaBiz • Drug Formulation</p>
                    </div>
                </div>
